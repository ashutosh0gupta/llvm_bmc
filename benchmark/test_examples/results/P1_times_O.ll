...
define dso_local fastcc void @P1_times_O(ptr noundef %p, ptr noundef nonnull %P1, ptr noundef nonnull %O, ptr noundef nonnull %acc) unnamed_addr #0 {
entry:
...
for.body6.i:                                      ; preds = %for.cond4.i.preheader, %m_vec_mul_add.exit
  ...
  %mul8.i = shl nuw nsw i32 %c.0.i9, 3
  %1 = getelementptr i8, ptr %O, i32 %mul8.i
  %arrayidx.i = getelementptr i8, ptr %1, i32 %k.0.i6
  %2 = load i8, ptr %arrayidx.i, align 1
  %mul9.i = shl nuw nsw i32 %r.0.i12, 3
  %add10.i = or disjoint i32 %mul9.i, %k.0.i6
...
m_vec_mul_add.exit:                               ; preds = %for.body.i
  ...
  %exitcond.i.not = icmp eq i32 %add13.i, 8
...
for.inc17.i:                                      ; preds = %for.cond1.i.for.inc17.i_crit_edge
  ...
  br i1 %exitcond2.i.not, label %mul_add_m_upper_triangular_mat_x_mat.exit, label %for.cond1.preheader.i, !llvm.loop !9

mul_add_m_upper_triangular_mat_x_mat.exit:        ; preds = %for.inc17.i
  ret void
}
...
entry:
  ...
  call fastcc void @P1_times_O(ptr nonnull %p_buf, ptr %P, ptr %O, ptr %P1)
  ret i32 0
}
