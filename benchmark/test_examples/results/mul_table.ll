...
define dso_local fastcc i32 @mul_table(i8 noundef zeroext %b) unnamed_addr #0 {
entry:
  %conv = zext i8 %b to i32
  %mul = mul i32 %conv, 134480385
  %and = and i32 %mul, -252645136
...
entry:
  %0 = call fastcc i32 @mul_table(i8 0)
  ret i32 0
}
