...
define dso_local fastcc void @m_vec_add(i32 noundef %m_vec_limbs, ptr noundef nonnull %in, ptr noundef nonnull %acc) unnamed_addr #0 {
entry:
  br label %for.body
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx1 = getelementptr inbounds nuw i64, ptr %acc, i32 %i.01
