...
define dso_local fastcc void @mul_add_m_upper_triangular_mat_x_mat(i32 noundef %m_vec_limbs, ptr noundef nonnull %bs_mat, ptr noundef nonnull %mat, ptr noundef nonnull %acc, i32 noundef %bs_mat_rows, i32 noundef %bs_mat_cols, i32 noundef %mat_cols, i32 noundef %triangular) unnamed_addr #0 {
entry:
...
for.body6:                                        ; preds = %for.cond4.preheader, %m_vec_mul_add.exit
  ...
  %mul8 = shl nuw nsw i32 %c.05, 3
  %1 = getelementptr i8, ptr %mat, i32 %mul8
  %arrayidx = getelementptr i8, ptr %1, i32 %k.02
  %2 = load i8, ptr %arrayidx, align 1
  %mul9 = shl nuw nsw i32 %r.08, 3
  %add10 = or disjoint i32 %mul9, %k.02
...
m_vec_mul_add.exit:                               ; preds = %for.body.i
  ...
  %exitcond.not = icmp eq i32 %add13, 8
