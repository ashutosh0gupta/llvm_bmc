...
define dso_local fastcc void @m_vec_add.18(i32 noundef %m_vec_limbs, ptr noundef %in, ptr noundef %acc) unnamed_addr #0 {
entry:
  br label %for.body
...
entry:
  ...
  call fastcc void @m_vec_add.18(i32 5, ptr nonnull %P3, ptr nonnull %P3_upper)
  ret i32 0
}
