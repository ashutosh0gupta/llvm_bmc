...
define dso_local fastcc zeroext range(i8 0, 16) i8 @add_f.25(i8 noundef zeroext range(i8 0, 16) %a, i8 noundef zeroext range(i8 0, 16) %b) unnamed_addr #0 {
entry:
  %xor1 = xor i8 %a, %b
  ret i8 %xor1
}
...
entry:
  %0 = call fastcc i8 @add_f.25(i8 0, i8 0)
  ret i32 0
}
