...
define dso_local fastcc void @m_vec_mul_add_x(i32 noundef %m_vec_limbs, ptr noundef nonnull %in, ptr noundef nonnull %acc) unnamed_addr #0 {
entry:
  br label %for.body
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %xor = shl i64 %0, 1
  %shl = and i64 %xor, -1229782938247303442
  %and = lshr i64 %0, 3
  %shr = and i64 %and, 1229782938247303441
  %mul = mul nuw nsw i64 %shr, 3
  %xor2 = xor i64 %shl, %mul
...
entry:
  ...
  call fastcc void @m_vec_mul_add_x(i32 5, ptr %accumulator, ptr %accumulator1)
  ret i32 0
}
