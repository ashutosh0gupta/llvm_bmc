...
define dso_local fastcc zeroext range(i8 0, 16) i8 @mul_f(i8 noundef zeroext %a, i8 noundef zeroext %b) unnamed_addr #0 {
entry:
  %0 = load volatile i8, ptr @pqmayo_MAYO_1_ref_unsigned_char_blocker, align 1
  %xor1 = xor i8 %a, %0
  %1 = trunc i8 %xor1 to i1
  %2 = and i8 %xor1, 2
  %mul9 = mul i8 %2, %b
  %conv10 = select i1 %1, i8 %b, i8 0
  %xor11 = xor i8 %conv10, %mul9
  %3 = and i8 %xor1, 4
  %mul16 = mul i8 %3, %b
  %xor18 = xor i8 %mul16, %xor11
  %4 = and i8 %xor1, 8
  %mul23 = mul i8 %4, %b
  %xor25 = xor i8 %mul23, %xor18
  %5 = lshr i8 %xor25, 4
  %6 = lshr i8 %xor25, 3
  %7 = and i8 %6, 14
  %8 = xor i8 %5, %7
  %xor25.masked = and i8 %xor25, 15
  %9 = xor i8 %8, %xor25.masked
  ret i8 %9
}
...
entry:
  %0 = call fastcc i8 @mul_f(i8 0, i8 0)
  ret i32 0
}
