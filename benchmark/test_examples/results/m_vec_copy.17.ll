...
define dso_local fastcc void @m_vec_copy.17(i32 noundef %m_vec_limbs, ptr noundef %in, ptr noundef %out) unnamed_addr #0 {
entry:
  br label %for.body
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx1 = getelementptr inbounds nuw i64, ptr %out, i32 %i.01
...
entry:
  ...
  call fastcc void @m_vec_copy.17(i32 5, ptr nonnull %P3, ptr nonnull %P3_upper)
  ret i32 0
}
