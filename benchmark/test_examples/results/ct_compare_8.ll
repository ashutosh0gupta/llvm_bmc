...
define dso_local fastcc zeroext i8 @ct_compare_8(i8 noundef zeroext %a, i8 noundef zeroext %b) unnamed_addr #0 {
entry:
  %0 = icmp ne i8 %a, 0
  %conv3 = sext i1 %0 to i8
  %1 = load volatile i8, ptr @pqmayo_MAYO_1_ref_unsigned_char_blocker, align 1
  %xor5 = xor i8 %1, %conv3
  ret i8 %xor5
}
...
entry:
  %0 = call fastcc i8 @ct_compare_8(i8 0, i8 0)
  ret i32 0
}
