...
define dso_local fastcc range(i32 0, -2147483648) i32 @mul_table.22(i8 noundef zeroext range(i8 0, 16) %b) unnamed_addr #0 {
entry:
  %conv = zext nneg i8 %b to i32
  %mul = mul nuw nsw i32 %conv, 134480385
  %and = and i32 %mul, 1894838512
  %shr = lshr exact i32 %and, 4
  %shr1 = lshr exact i32 %and, 3
  %0 = xor i32 %shr, %shr1
  %xor2 = xor i32 %0, %mul
  ret i32 %xor2
}
...
entry:
  %0 = call fastcc i32 @mul_table.22(i8 0)
  ret i32 0
}
