...
define dso_local fastcc void @m_vec_copy(i32 noundef %m_vec_limbs, ptr noundef nonnull %in, ptr noundef nonnull %out) unnamed_addr #0 {
entry:
  br label %for.body
...
entry:
  ...
  call fastcc void @m_vec_copy(i32 5, ptr %accumulator, ptr %PS)
  ret i32 0
}
