...
lbl_LC01:;
  ...
  long v9_W7 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  long v10_W8 = v9_W7 ^ v9_W7;
  long v13_W9 = atomic_load_explicit(&vars[0+v10_W8], memory_order_relaxed);
  long v33 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v33, memory_order_seq_cst);
  long v34 = (v6_W4 == 2);
  atomic_store_explicit(&atom_1_X4_2, v34, memory_order_seq_cst);
  long v35 = (v9_W7 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v23 = atomic_load_explicit(&atom_1_X4_2, memory_order_seq_cst);
  long v24 = atomic_load_explicit(&atom_1_X7_1, memory_order_seq_cst);
  long v25 = atomic_load_explicit(&atom_1_X9_0, memory_order_seq_cst);
