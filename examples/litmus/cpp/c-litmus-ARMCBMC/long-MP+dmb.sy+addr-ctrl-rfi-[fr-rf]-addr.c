...
lbl_LC00:;
  ...
  long v14_W9 = v13_W8 ^ v13_W8;
  long v17_W10 = atomic_load_explicit(&vars[0+v14_W9], memory_order_relaxed);
  long v34 = (v3_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v25 = atomic_load_explicit(&atom_1_X7_1, memory_order_seq_cst);
