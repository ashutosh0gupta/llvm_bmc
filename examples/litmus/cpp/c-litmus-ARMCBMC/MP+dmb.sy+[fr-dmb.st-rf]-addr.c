...
label_2:;
  ...
  int v20 = (v6_W2 == 1);
  atomic_store_explicit(&atom_1_X2_1, v20, memory_order_seq_cst);
  int v21 = (v10_W5 == 0);
  atomic_store_explicit(&atom_1_X5_0, v21, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_1_X2_1, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_1_X5_0, memory_order_seq_cst);
