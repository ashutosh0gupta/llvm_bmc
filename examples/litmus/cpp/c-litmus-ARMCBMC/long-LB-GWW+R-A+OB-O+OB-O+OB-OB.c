...
void *t5(void *arg){
label_6:;
  long v15_W0 = atomic_load_explicit(&vars[5], memory_order_relaxed);
  dmbsy();
  long v18_W2 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v30 = (v15_W0 == 1);
  atomic_store_explicit(&atom_5_X0_1, v30, memory_order_seq_cst);
  long v31 = (v18_W2 == 0);
  atomic_store_explicit(&atom_5_X2_0, v31, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v19 = atomic_load_explicit(&atom_5_X0_1, memory_order_seq_cst);
  long v20 = atomic_load_explicit(&atom_5_X2_0, memory_order_seq_cst);
