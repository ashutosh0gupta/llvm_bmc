...
label_2:;
  ...
  long v9_W4 = atomic_load_explicit(&vars[0], memory_order_acquire);
  long v22 = (v6_W2 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v13 = (v12 == 2);
  long v14 = atomic_load_explicit(&atom_0_X4_2, memory_order_seq_cst);
  long v15 = atomic_load_explicit(&atom_1_X2_0, memory_order_seq_cst);
  long v16 = atomic_load_explicit(&atom_1_X4_0, memory_order_seq_cst);
