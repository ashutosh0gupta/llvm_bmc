...
label_2:;
  ...
  long v15 = (v6_W2 == 0);
  atomic_store_explicit(&atom_1_X2_0, v15, memory_order_seq_cst);
  long v17 = (v3_W0 == 1);
...
label_3:;
  ...
  long v16 = (v9_W1 == 0);
  atomic_store_explicit(&atom_2_X1_0, v16, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v11 = atomic_load_explicit(&atom_2_X1_0, memory_order_seq_cst);
