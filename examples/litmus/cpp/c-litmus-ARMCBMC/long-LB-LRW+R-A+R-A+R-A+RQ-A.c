...
void *t3(void *arg){
label_4:;
  long v12_W0 = atomic_load_explicit(&vars[3], memory_order_acquire);
  atomic_store_explicit(&vars[4], 2, memory_order_release);
...
void *t4(void *arg){
label_5:;
  long v15_W0 = atomic_load_explicit(&vars[4], memory_order_acquire);
