...
label_2:;
  ...
  long v14_W8 = atomic_load_explicit(&vars[3+v11_W7], memory_order_relaxed);
...
lbl_LC00:;
  ...
  long v35 = (v6_W2 == 2);
  atomic_store_explicit(&atom_1_X2_2, v35, memory_order_seq_cst);
  long v36 = (v10_W6 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v25 = atomic_load_explicit(&atom_1_X2_2, memory_order_seq_cst);
