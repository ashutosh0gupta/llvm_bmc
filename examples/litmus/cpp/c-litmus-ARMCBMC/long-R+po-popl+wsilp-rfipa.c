...
int main(int argc, char *argv[]){
  ...
  long v14 = (v13 == 4);
  long v15 = atomic_load_explicit(&atom_0_X5_2, memory_order_seq_cst);
  long v16 = atomic_load_explicit(&atom_1_X4_4, memory_order_seq_cst);
  long v17 = atomic_load_explicit(&atom_1_X3_3, memory_order_seq_cst);
