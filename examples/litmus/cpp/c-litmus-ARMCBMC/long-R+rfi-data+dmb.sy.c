...
label_1:;
  ...
  long v18 = (v3_W2 == 1);
  atomic_store_explicit(&atom_0_X2_1, v18, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  dmbsy();
  long v8_W2 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v19 = (v8_W2 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v12 = (v11 == 2);
  long v13 = atomic_load_explicit(&atom_0_X2_1, memory_order_seq_cst);
