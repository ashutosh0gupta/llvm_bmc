...
label_2:;
  ...
  atomic_store_explicit(&vars[3+v9_W5], 1, memory_order_relaxed);
...
lbl_LC00:;
  ...
  long v37 = (v12_W8 == 2);
  atomic_store_explicit(&atom_1_X8_2, v37, memory_order_seq_cst);
  long v38 = (v15_W9 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v26 = atomic_load_explicit(&atom_1_X8_2, memory_order_seq_cst);
