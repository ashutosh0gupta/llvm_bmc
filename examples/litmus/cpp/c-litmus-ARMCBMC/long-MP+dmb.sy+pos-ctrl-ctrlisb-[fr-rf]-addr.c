...
lbl_LC01:;
  isb();
  long v12_W5 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  long v15_W7 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  long v16_W8 = v15_W7 ^ v15_W7;
  long v19_W9 = atomic_load_explicit(&vars[0+v16_W8], memory_order_relaxed);
  long v38 = (v3_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v30 = atomic_load_explicit(&atom_1_X9_0, memory_order_seq_cst);
