...
label_2:;
  ...
  long v17_W9 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  long v18_W10 = v17_W9 ^ v17_W9;
  long v21_W11 = atomic_load_explicit(&vars[0+v18_W10], memory_order_relaxed);
  long v38 = (v3_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v22 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  long v23 = (v22 == 1);
  long v24 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  long v25 = (v24 == 1);
  long v26 = atomic_load_explicit(&vars[1], memory_order_seq_cst);
  long v27 = (v26 == 1);
  long v28 = atomic_load_explicit(&atom_1_X0_1, memory_order_seq_cst);
  long v29 = atomic_load_explicit(&atom_1_X7_0, memory_order_seq_cst);
  long v30 = atomic_load_explicit(&atom_1_X9_1, memory_order_seq_cst);
  long v31 = atomic_load_explicit(&atom_1_X11_0, memory_order_seq_cst);
  long v32_conj = v30 & v31;
  long v33_conj = v29 & v32_conj;
  long v34_conj = v28 & v33_conj;
  long v35_conj = v27 & v34_conj;
  long v36_conj = v25 & v35_conj;
  long v37_conj = v23 & v36_conj;
