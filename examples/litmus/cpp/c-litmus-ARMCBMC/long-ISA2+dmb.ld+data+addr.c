...
void *t2(void *arg){
label_3:;
  long v8_W0 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  long v9_W2 = v8_W0 ^ v8_W0;
  long v12_W3 = atomic_load_explicit(&vars[0+v9_W2], memory_order_relaxed);
  long v19 = (v8_W0 == 1);
  atomic_store_explicit(&atom_2_X0_1, v19, memory_order_seq_cst);
  long v20 = (v12_W3 == 0);
  atomic_store_explicit(&atom_2_X3_0, v20, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v15 = atomic_load_explicit(&atom_2_X3_0, memory_order_seq_cst);
