...
int main(int argc, char *argv[]){
  ...
  long v24 = atomic_load_explicit(&atom_2_X0_1, memory_order_seq_cst);
  long v25 = atomic_load_explicit(&atom_3_X0_1, memory_order_seq_cst);
  long v26 = atomic_load_explicit(&atom_4_X0_1, memory_order_seq_cst);
  long v27 = atomic_load_explicit(&atom_5_X0_1, memory_order_seq_cst);
  long v28 = atomic_load_explicit(&atom_6_X0_1, memory_order_seq_cst);
