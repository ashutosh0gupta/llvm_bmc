...
lbl_LC00:;
  ...
  long v11_W7 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  long v12_W8 = v11_W7 ^ v11_W7;
  long v15_W9 = atomic_load_explicit(&vars[0+v12_W8], memory_order_relaxed);
  long v35 = (v3_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v25 = atomic_load_explicit(&atom_1_X4_1, memory_order_seq_cst);
  long v26 = atomic_load_explicit(&atom_1_X7_2, memory_order_seq_cst);
