...
label_2:;
  ...
  long v14_W9 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  long v15_W10 = v14_W9 ^ v14_W9;
  long v18_W11 = atomic_load_explicit(&vars[0+v15_W10], memory_order_relaxed);
  long v33 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v33, memory_order_seq_cst);
  long v34 = (v14_W9 == 2);
  atomic_store_explicit(&atom_1_X9_2, v34, memory_order_seq_cst);
  long v35 = (v18_W11 == 0);
  atomic_store_explicit(&atom_1_X11_0, v35, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v26 = atomic_load_explicit(&atom_1_X9_2, memory_order_seq_cst);
