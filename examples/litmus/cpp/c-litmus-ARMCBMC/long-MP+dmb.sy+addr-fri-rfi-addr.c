...
label_2:;
  ...
  long v32 = (v7_W3 == 0);
  atomic_store_explicit(&atom_1_X3_0, v32, memory_order_seq_cst);
  long v33 = (v10_W6 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v22 = atomic_load_explicit(&atom_1_X3_0, memory_order_seq_cst);
  long v23 = atomic_load_explicit(&atom_1_X6_1, memory_order_seq_cst);
