...
label_2:;
  ...
  if (v12_W4) goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  long v15_W5 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  ...
  long v38 = (v9_W3 == 2);
  atomic_store_explicit(&atom_1_X3_2, v38, memory_order_seq_cst);
  long v39 = (v12_W4 == 2);
  atomic_store_explicit(&atom_1_X4_2, v39, memory_order_seq_cst);
  long v40 = (v15_W5 == 0);
  atomic_store_explicit(&atom_1_X5_0, v40, memory_order_seq_cst);
  long v41 = (v18_W7 == 0);
  atomic_store_explicit(&atom_1_X7_0, v41, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v25 = atomic_load_explicit(&atom_1_X3_2, memory_order_seq_cst);
  long v26 = atomic_load_explicit(&atom_1_X4_2, memory_order_seq_cst);
