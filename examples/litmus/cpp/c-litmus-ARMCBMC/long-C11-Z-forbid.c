...
void *t1(void *arg){
label_2:;
  long v3_W2 = atomic_load_explicit(&vars[0], memory_order_acquire);
  long v6_W4 = atomic_load_explicit(&vars[1], memory_order_acquire);
  long v16 = (v3_W2 == 4);
  atomic_store_explicit(&atom_1_X2_4, v16, memory_order_seq_cst);
  long v17 = (v6_W4 == 1);
...
label_3:;
  ...
  long v15 = (v9_W4 == 2);
  atomic_store_explicit(&atom_2_X4_2, v15, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v10 = atomic_load_explicit(&atom_2_X4_2, memory_order_seq_cst);
  long v11 = atomic_load_explicit(&atom_1_X2_4, memory_order_seq_cst);
