...
label_2:;
  ...
  long v6_W3 = atomic_load_explicit(&vars[2], memory_order_acquire);
  long v9_W4 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v15 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v15, memory_order_seq_cst);
  long v16 = (v9_W4 == 0);
  atomic_store_explicit(&atom_1_X4_0, v16, memory_order_seq_cst);
  long v17 = (v6_W3 == 1);
  atomic_store_explicit(&atom_1_X3_1, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v11 = atomic_load_explicit(&atom_1_X4_0, memory_order_seq_cst);
  long v12 = atomic_load_explicit(&atom_1_X3_1, memory_order_seq_cst);
