...
label_2:;
  ...
  long v11_W8 = atomic_load_explicit(&vars[0+v8_W7], memory_order_relaxed);
  long v14_W10 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v31 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v31, memory_order_seq_cst);
  long v32 = (v7_W6 == 2);
  atomic_store_explicit(&atom_1_X6_2, v32, memory_order_seq_cst);
  long v33 = (v11_W8 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v22 = atomic_load_explicit(&atom_1_X6_2, memory_order_seq_cst);
  long v23 = atomic_load_explicit(&atom_1_X8_0, memory_order_seq_cst);
  long v24 = atomic_load_explicit(&atom_1_X10_0, memory_order_seq_cst);
