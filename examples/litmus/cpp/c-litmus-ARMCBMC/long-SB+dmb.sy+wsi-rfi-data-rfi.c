...
label_1:;
  ...
  long v23 = (v3_W2 == 0);
  atomic_store_explicit(&atom_0_X2_0, v23, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  long v24 = (v6_W3 == 2);
  atomic_store_explicit(&atom_1_X3_2, v24, memory_order_seq_cst);
  long v25 = (v11_W6 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v15 = (v14 == 2);
  long v16 = atomic_load_explicit(&atom_0_X2_0, memory_order_seq_cst);
  long v17 = atomic_load_explicit(&atom_1_X3_2, memory_order_seq_cst);
  long v18 = atomic_load_explicit(&atom_1_X6_1, memory_order_seq_cst);
