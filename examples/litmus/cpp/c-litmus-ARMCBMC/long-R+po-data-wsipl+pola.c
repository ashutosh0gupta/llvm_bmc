...
label_1:;
  ...
  long v8_W7 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  long v21 = (v8_W7 == 3);
  atomic_store_explicit(&atom_0_X7_3, v21, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v15 = (v14 == 3);
  long v16 = atomic_load_explicit(&atom_0_X7_3, memory_order_seq_cst);
