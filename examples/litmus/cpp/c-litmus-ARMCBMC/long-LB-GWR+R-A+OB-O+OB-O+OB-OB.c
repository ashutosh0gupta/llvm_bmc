...
label_5:;
  ...
  dmbsy();
  long v15_W2 = atomic_load_explicit(&vars[5], memory_order_relaxed);
  long v30 = (v15_W2 == 0);
...
label_6:;
  ...
  dmbsy();
  long v18_W1 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v31 = (v18_W1 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v19 = atomic_load_explicit(&atom_4_X2_0, memory_order_seq_cst);
  long v20 = atomic_load_explicit(&atom_5_X1_0, memory_order_seq_cst);
