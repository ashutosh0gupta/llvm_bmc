...
lbl_LC00:;
  ...
  long v6_W5 = atomic_load_explicit(&vars[0], memory_order_relaxed);
...
int main(int argc, char *argv[]){
  ...
  long v13 = (v12 == 2);
  long v14 = atomic_load_explicit(&atom_1_X2_2, memory_order_seq_cst);
  long v15 = atomic_load_explicit(&atom_1_X5_1, memory_order_seq_cst);
