...
label_2:;
  ...
  long v6_W2 = atomic_load_explicit(&vars[1], memory_order_acquire);
  long v26 = (v3_W0 == 2);
  atomic_store_explicit(&atom_1_X0_2, v26, memory_order_seq_cst);
  long v27 = (v6_W2 == 0);
...
label_4:;
  ...
  long v28 = (v9_W0 == 2);
  atomic_store_explicit(&atom_3_X0_2, v28, memory_order_seq_cst);
  long v29 = (v12_W2 == 0);
  atomic_store_explicit(&atom_3_X2_0, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v16 = (v15 == 2);
  long v17 = atomic_load_explicit(&atom_1_X0_2, memory_order_seq_cst);
  long v18 = atomic_load_explicit(&atom_1_X2_0, memory_order_seq_cst);
  long v19 = atomic_load_explicit(&atom_3_X0_2, memory_order_seq_cst);
  long v20 = atomic_load_explicit(&atom_3_X2_0, memory_order_seq_cst);
