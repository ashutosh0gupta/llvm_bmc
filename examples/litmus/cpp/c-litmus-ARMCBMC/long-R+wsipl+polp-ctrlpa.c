...
lbl_LC00:;
  ...
  long v17 = (v9_W4 == 0);
  atomic_store_explicit(&atom_1_X4_0, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v11 = (v10 == 3);
  long v12 = atomic_load_explicit(&atom_0_X3_3, memory_order_seq_cst);
  long v13 = atomic_load_explicit(&atom_1_X4_0, memory_order_seq_cst);
