...
int main(int argc, char *argv[]){
  ...
  int v22 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  int v23 = (v22 == 1);
  ...
  int v30 = atomic_load_explicit(&atom_1_X10_1, memory_order_seq_cst);
  int v31 = atomic_load_explicit(&atom_1_X12_0, memory_order_seq_cst);
