...
lbl_LC01:;
  ...
  int v38 = (v15_W6 == 0);
  atomic_store_explicit(&atom_1_X6_0, v38, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v23 = atomic_load_explicit(&atom_1_X2_0, memory_order_seq_cst);
  ...
  int v26 = atomic_load_explicit(&atom_1_X6_0, memory_order_seq_cst);
