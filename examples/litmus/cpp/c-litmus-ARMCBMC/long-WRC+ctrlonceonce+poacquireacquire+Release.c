...
label_2:;
  ...
  if (v4_cmpeq)  goto lbl_label53; else goto lbl_label53;
lbl_label53:;
...
void *t2(void *arg){
label_3:;
  long v7_W0 = atomic_load_explicit(&vars[1], memory_order_acquire);
  long v10_W2 = atomic_load_explicit(&vars[0], memory_order_acquire);
  long v17 = (v7_W0 == 1);
