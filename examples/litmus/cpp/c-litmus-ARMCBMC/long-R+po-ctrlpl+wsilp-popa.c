...
lbl_LC00:;
  ...
  long v19 = (v6_W6 == 2);
  atomic_store_explicit(&atom_0_X6_2, v19, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  long v9_W3 = atomic_load_explicit(&vars[0], memory_order_acquire);
  long v20 = (v9_W3 == 0);
  atomic_store_explicit(&atom_1_X3_0, v20, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v13 = (v12 == 3);
  long v14 = atomic_load_explicit(&atom_0_X6_2, memory_order_seq_cst);
  long v15 = atomic_load_explicit(&atom_1_X3_0, memory_order_seq_cst);
