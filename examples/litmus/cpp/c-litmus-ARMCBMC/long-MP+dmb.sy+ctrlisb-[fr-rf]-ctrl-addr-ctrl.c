...
lbl_LC01:;
  ...
  long v13_W7 = v12_W5 ^ v12_W5;
  long v16_W8 = atomic_load_explicit(&vars[4+v13_W7], memory_order_relaxed);
...
int main(int argc, char *argv[]){
  ...
  long v29 = atomic_load_explicit(&atom_1_X10_0, memory_order_seq_cst);
