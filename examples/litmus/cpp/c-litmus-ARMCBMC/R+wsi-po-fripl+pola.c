...
label_1:;
  ...
  int v6_W6 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  int v21 = (v6_W6 == 2);
  atomic_store_explicit(&atom_0_X6_2, v21, memory_order_seq_cst);
  int v22 = (v3_W3 == 0);
  atomic_store_explicit(&atom_0_X3_0, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v13 = (v12 == 2);
  int v14 = atomic_load_explicit(&atom_0_X6_2, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_0_X3_0, memory_order_seq_cst);
