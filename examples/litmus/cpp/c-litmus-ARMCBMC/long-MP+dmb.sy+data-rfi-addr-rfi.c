...
label_2:;
  ...
  atomic_store_explicit(&vars[0+v9_W5], 1, memory_order_relaxed);
...
int main(int argc, char *argv[]){
  ...
  long v20 = atomic_load_explicit(&atom_1_X4_1, memory_order_seq_cst);
  long v21 = atomic_load_explicit(&atom_1_X8_1, memory_order_seq_cst);
