...
label_1:;
  ...
  int v5_W5 = v4_W5 + 1;
  atomic_store_explicit(&vars[2], v5_W5, memory_order_release);
  int v8_W7 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  int v21 = (v8_W7 == 2);
  atomic_store_explicit(&atom_0_X7_2, v21, memory_order_seq_cst);
  return NULL;
}
