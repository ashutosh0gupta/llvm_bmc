...
label_2:;
  ...
  long v11_W9 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v26 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v26, memory_order_seq_cst);
  long v27 = (v7_W5 == 1);
  atomic_store_explicit(&atom_1_X5_1, v27, memory_order_seq_cst);
  long v28 = (v11_W9 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v20 = atomic_load_explicit(&atom_1_X9_1, memory_order_seq_cst);
