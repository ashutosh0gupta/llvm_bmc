...
label_2:;
  ...
  long v11_W8 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v21 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v21, memory_order_seq_cst);
  long v22 = (v11_W8 == 1);
  atomic_store_explicit(&atom_1_X8_1, v22, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v17 = atomic_load_explicit(&atom_1_X8_1, memory_order_seq_cst);
