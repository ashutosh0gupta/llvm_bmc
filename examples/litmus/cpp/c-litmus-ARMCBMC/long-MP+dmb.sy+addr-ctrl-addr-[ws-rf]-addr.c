...
lbl_LC00:;
  ...
  long v34 = (v14_W10 == 2);
  atomic_store_explicit(&atom_1_X10_2, v34, memory_order_seq_cst);
  long v35 = (v18_W12 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v26 = atomic_load_explicit(&atom_1_X10_2, memory_order_seq_cst);
