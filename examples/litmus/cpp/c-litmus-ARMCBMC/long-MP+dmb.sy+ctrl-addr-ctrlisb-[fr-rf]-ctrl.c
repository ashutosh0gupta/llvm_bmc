...
lbl_LC01:;
  ...
  long v16_W9 = atomic_load_explicit(&vars[4], memory_order_relaxed);
...
lbl_LC02:;
  ...
  long v38 = (v16_W9 == 1);
  atomic_store_explicit(&atom_1_X9_1, v38, memory_order_seq_cst);
  long v39 = (v19_W10 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v20 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  long v21 = (v20 == 1);
