...
lbl_LC00:;
  ...
  int v16 = (v3_W2 == 2);
  atomic_store_explicit(&atom_1_X2_2, v16, memory_order_seq_cst);
  int v17 = (v6_W3 == 2);
  atomic_store_explicit(&atom_1_X3_2, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v12 = atomic_load_explicit(&atom_1_X3_2, memory_order_seq_cst);
