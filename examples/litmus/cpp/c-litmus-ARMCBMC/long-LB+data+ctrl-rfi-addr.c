...
lbl_LC00:;
  ...
  long v11_W4 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  long v12_W5 = v11_W4 ^ v11_W4;
  atomic_store_explicit(&vars[0+v12_W5], 1, memory_order_relaxed);
  long v28 = (v8_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v28, memory_order_seq_cst);
  long v29 = (v11_W4 == 1);
  atomic_store_explicit(&atom_1_X4_1, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v21 = atomic_load_explicit(&atom_1_X4_1, memory_order_seq_cst);
