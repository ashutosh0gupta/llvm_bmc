...
label_4:;
  ...
  long v25 = (v6_W0 == 1);
  atomic_store_explicit(&atom_3_X0_1, v25, memory_order_seq_cst);
  return NULL;
}
...
void *t5(void *arg){
label_6:;
  long v9_W0 = atomic_load_explicit(&vars[4], memory_order_acquire);
  atomic_store_explicit(&vars[0], 2, memory_order_relaxed);
  long v26 = (v9_W0 == 1);
  atomic_store_explicit(&atom_5_X0_1, v26, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v12 = (v11 == 2);
  long v13 = atomic_load_explicit(&atom_3_X0_1, memory_order_seq_cst);
  long v14 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  long v15 = (v14 == 2);
  long v16 = atomic_load_explicit(&atom_5_X0_1, memory_order_seq_cst);
  long v17 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  long v18 = (v17 == 1);
  long v19_conj = v16 & v18;
  long v20_conj = v15 & v19_conj;
  long v21_conj = v13 & v20_conj;
  long v22_conj = v12 & v21_conj;
