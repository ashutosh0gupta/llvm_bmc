...
lbl_LC00:;
  ...
  int v15_W10 = v14_W8 ^ v14_W8;
  int v16_W10 = v15_W10 + 1;
  atomic_store_explicit(&vars[0], v16_W10, memory_order_relaxed);
  int v19_W12 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v29 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v29, memory_order_seq_cst);
  int v30 = (v19_W12 == 1);
  atomic_store_explicit(&atom_1_X12_1, v30, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v25 = atomic_load_explicit(&atom_1_X12_1, memory_order_seq_cst);
