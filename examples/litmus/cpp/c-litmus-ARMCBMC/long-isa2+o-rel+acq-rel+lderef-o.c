...
atomic_long vars[3]; 
atomic_long atom_1_X0_4; 
atomic_long atom_2_X0_1; 
atomic_long atom_2_X2_1; 
...
label_2:;
  ...
  long v15 = (v3_W0 == 4);
  atomic_store_explicit(&atom_1_X0_4, v15, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  long v17 = (v9_W2 == 1);
  atomic_store_explicit(&atom_2_X2_1, v17, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  atomic_init(&vars[0], 2);
  atomic_init(&vars[1], 1);
  atomic_init(&atom_1_X0_4, 0); 
  atomic_init(&atom_2_X0_1, 0); 
  atomic_init(&atom_2_X2_1, 0); 
  ...
  long v10 = atomic_load_explicit(&atom_1_X0_4, memory_order_seq_cst);
  long v11 = atomic_load_explicit(&atom_2_X0_1, memory_order_seq_cst);
  long v12 = atomic_load_explicit(&atom_2_X2_1, memory_order_seq_cst);
