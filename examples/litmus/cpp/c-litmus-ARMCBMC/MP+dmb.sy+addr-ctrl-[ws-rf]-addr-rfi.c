...
lbl_LC00:;
  ...
  int v14_W11 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v29 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v29, memory_order_seq_cst);
  int v30 = (v10_W7 == 2);
  atomic_store_explicit(&atom_1_X7_2, v30, memory_order_seq_cst);
  int v31 = (v14_W11 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v22 = atomic_load_explicit(&atom_1_X7_2, memory_order_seq_cst);
  int v23 = atomic_load_explicit(&atom_1_X11_1, memory_order_seq_cst);
