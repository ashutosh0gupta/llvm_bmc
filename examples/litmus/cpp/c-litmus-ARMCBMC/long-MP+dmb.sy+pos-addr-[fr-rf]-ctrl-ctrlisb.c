...
lbl_LC00:;
  long v16_W7 = atomic_load_explicit(&vars[3], memory_order_relaxed);
...
lbl_LC01:;
  ...
  long v40 = (v10_W4 == 0);
  atomic_store_explicit(&atom_1_X4_0, v40, memory_order_seq_cst);
  long v41 = (v13_W6 == 1);
  atomic_store_explicit(&atom_1_X6_1, v41, memory_order_seq_cst);
  long v42 = (v19_W9 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v28 = atomic_load_explicit(&atom_1_X4_0, memory_order_seq_cst);
