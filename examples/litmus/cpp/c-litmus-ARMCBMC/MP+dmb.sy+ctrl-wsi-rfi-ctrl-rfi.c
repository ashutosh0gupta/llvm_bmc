...
lbl_LC01:;
  ...
  int v9_W8 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v24 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v24, memory_order_seq_cst);
  int v25 = (v6_W5 == 2);
  atomic_store_explicit(&atom_1_X5_2, v25, memory_order_seq_cst);
  int v26 = (v9_W8 == 1);
  atomic_store_explicit(&atom_1_X8_1, v26, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_1_X5_2, memory_order_seq_cst);
  int v18 = atomic_load_explicit(&atom_1_X8_1, memory_order_seq_cst);
