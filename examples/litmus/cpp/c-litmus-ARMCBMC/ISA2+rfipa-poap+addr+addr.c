...
label_3:;
  ...
  int v25 = (v14_W3 == 0);
  atomic_store_explicit(&atom_2_X3_0, v25, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v17 = atomic_load_explicit(&atom_2_X0_1, memory_order_seq_cst);
  int v18 = atomic_load_explicit(&atom_2_X3_0, memory_order_seq_cst);
