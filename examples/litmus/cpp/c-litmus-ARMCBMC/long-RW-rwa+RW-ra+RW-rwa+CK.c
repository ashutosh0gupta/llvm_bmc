...
label_4:;
  ...
  dmbsy();
  long v12_W2 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v22 = (v12_W2 == 0);
  atomic_store_explicit(&atom_3_X2_0, v22, memory_order_seq_cst);
  long v23 = (v9_W0 == 1);
  atomic_store_explicit(&atom_3_X0_1, v23, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v15 = atomic_load_explicit(&atom_3_X2_0, memory_order_seq_cst);
  long v16 = atomic_load_explicit(&atom_3_X0_1, memory_order_seq_cst);
