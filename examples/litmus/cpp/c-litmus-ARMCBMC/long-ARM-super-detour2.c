...
void *t3(void *arg){
label_4:;
  long v15_W0 = atomic_load_explicit(&vars[3], memory_order_acquire);
  long v18_W2 = atomic_load_explicit(&vars[5], memory_order_relaxed);
  long v34 = (v15_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v24 = atomic_load_explicit(&atom_3_X2_0, memory_order_seq_cst);
