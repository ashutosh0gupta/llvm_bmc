...
lbl_LC01:;
  ...
  long v13_W8 = v12_W6 ^ v12_W6;
  long v16_W9 = atomic_load_explicit(&vars[0+v13_W8], memory_order_relaxed);
  long v33 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v33, memory_order_seq_cst);
  long v34 = (v6_W2 == 0);
  atomic_store_explicit(&atom_1_X2_0, v34, memory_order_seq_cst);
  long v35 = (v9_W5 == 2);
