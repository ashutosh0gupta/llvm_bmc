...
label_3:;
  ...
  long v7_W2 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v15 = (v7_W2 == 0);
  atomic_store_explicit(&atom_2_X2_0, v15, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v11 = atomic_load_explicit(&atom_2_X2_0, memory_order_seq_cst);
