...
lbl_LC01:;
  ...
  int v10_W7 = v9_W5 ^ v9_W5;
  int v13_W8 = atomic_load_explicit(&vars[0+v10_W7], memory_order_relaxed);
  ...
  int v36 = (v16_W10 == 0);
  atomic_store_explicit(&atom_1_X10_0, v36, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v24 = atomic_load_explicit(&atom_1_X4_2, memory_order_seq_cst);
