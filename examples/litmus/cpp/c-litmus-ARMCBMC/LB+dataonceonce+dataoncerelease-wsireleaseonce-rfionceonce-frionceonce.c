...
label_2:;
  ...
  int v10_W2 = v9_W2 + 1;
  atomic_store_explicit(&vars[1], v10_W2, memory_order_release);
  ...
  int v24 = (v13_W4 == 2);
  atomic_store_explicit(&atom_1_X4_2, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v15 = (v14 == 3);
  int v16 = atomic_load_explicit(&atom_0_X0_3, memory_order_seq_cst);
  int v17 = atomic_load_explicit(&atom_1_X0_1, memory_order_seq_cst);
  int v18 = atomic_load_explicit(&atom_1_X4_2, memory_order_seq_cst);
