...
label_1:;
  ...
  long v3_W5 = atomic_load_explicit(&vars[0], memory_order_relaxed);
...
label_2:;
  ...
  long v9_W4 = atomic_load_explicit(&vars[1], memory_order_acquire);
  long v22 = (v6_W2 == 4);
...
int main(int argc, char *argv[]){
  ...
  long v13 = atomic_load_explicit(&atom_0_X5_1, memory_order_seq_cst);
  long v14 = atomic_load_explicit(&atom_2_X4_3, memory_order_seq_cst);
  long v15 = atomic_load_explicit(&atom_1_X2_4, memory_order_seq_cst);
