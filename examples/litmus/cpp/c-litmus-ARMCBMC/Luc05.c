...
void *t2(void *arg){
label_3:;
  int v9_W0 = atomic_load_explicit(&vars[0], memory_order_acquire);
  atomic_store_explicit(&vars[1], 1, memory_order_relaxed);
  int v20 = (v9_W0 == 2);
  atomic_store_explicit(&atom_2_X0_2, v20, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_2_X0_2, memory_order_seq_cst);
