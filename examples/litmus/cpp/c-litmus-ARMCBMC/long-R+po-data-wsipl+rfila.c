...
int main(int argc, char *argv[]){
  ...
  long v16 = (v15 == 4);
  long v17 = atomic_load_explicit(&atom_0_X6_3, memory_order_seq_cst);
  long v18 = atomic_load_explicit(&atom_1_X3_4, memory_order_seq_cst);
  long v19 = atomic_load_explicit(&atom_1_X2_3, memory_order_seq_cst);
