...
lbl_LC00:;
  ...
  long v15_W10 = v14_W8 ^ v14_W8;
  atomic_store_explicit(&vars[0+v15_W10], 1, memory_order_relaxed);
  long v18_W13 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v28 = (v3_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v24 = atomic_load_explicit(&atom_1_X13_1, memory_order_seq_cst);
