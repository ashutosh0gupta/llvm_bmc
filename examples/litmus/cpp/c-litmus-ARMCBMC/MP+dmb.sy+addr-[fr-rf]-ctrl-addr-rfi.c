...
lbl_LC00:;
  ...
  int v35 = (v7_W3 == 0);
  atomic_store_explicit(&atom_1_X3_0, v35, memory_order_seq_cst);
  int v36 = (v10_W5 == 1);
  atomic_store_explicit(&atom_1_X5_1, v36, memory_order_seq_cst);
  int v37 = (v17_W11 == 1);
  atomic_store_explicit(&atom_1_X11_1, v37, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v27 = atomic_load_explicit(&atom_1_X11_1, memory_order_seq_cst);
