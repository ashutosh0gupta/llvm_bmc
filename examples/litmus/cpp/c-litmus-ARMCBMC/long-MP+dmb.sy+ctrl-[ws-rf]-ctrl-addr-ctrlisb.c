...
lbl_LC01:;
  ...
  long v13_W8 = atomic_load_explicit(&vars[4+v10_W7], memory_order_relaxed);
  if (v13_W8) goto lbl_LC02; else goto lbl_LC02;
lbl_LC02:;
  isb();
  long v16_W10 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v31 = (v3_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v24 = atomic_load_explicit(&atom_1_X4_2, memory_order_seq_cst);
