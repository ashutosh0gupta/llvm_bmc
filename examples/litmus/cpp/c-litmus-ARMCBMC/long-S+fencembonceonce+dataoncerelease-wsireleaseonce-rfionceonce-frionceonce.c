...
label_2:;
  ...
  long v5_W2 = v4_W2 + 1;
  atomic_store_explicit(&vars[1], v5_W2, memory_order_release);
  atomic_store_explicit(&vars[1], 2, memory_order_relaxed);
  long v8_W4 = atomic_load_explicit(&vars[1], memory_order_relaxed);
...
int main(int argc, char *argv[]){
  ...
  long v12 = atomic_load_explicit(&atom_1_X4_2, memory_order_seq_cst);
