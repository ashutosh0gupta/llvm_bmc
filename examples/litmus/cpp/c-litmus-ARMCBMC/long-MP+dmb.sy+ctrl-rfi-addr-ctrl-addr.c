...
lbl_LC01:;
  long v13_W8 = atomic_load_explicit(&vars[4], memory_order_relaxed);
  long v14_W10 = v13_W8 ^ v13_W8;
  long v17_W11 = atomic_load_explicit(&vars[0+v14_W10], memory_order_relaxed);
  long v32 = (v3_W0 == 1);
