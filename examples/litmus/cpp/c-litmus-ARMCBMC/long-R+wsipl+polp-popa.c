...
label_2:;
  ...
  long v6_W4 = atomic_load_explicit(&vars[0], memory_order_acquire);
  long v17 = (v6_W4 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v10 = (v9 == 1);
  long v11 = atomic_load_explicit(&atom_0_X3_3, memory_order_seq_cst);
  long v12 = atomic_load_explicit(&atom_1_X4_0, memory_order_seq_cst);
