...
label_3:;
  ...
  int v19 = (v6_W0 == 2);
  atomic_store_explicit(&atom_2_X0_2, v19, memory_order_seq_cst);
  int v20 = (v9_W2 == 0);
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_2_X0_2, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_2_X2_0, memory_order_seq_cst);
