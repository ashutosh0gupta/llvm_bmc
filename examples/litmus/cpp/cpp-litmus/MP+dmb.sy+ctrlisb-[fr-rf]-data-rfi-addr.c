...
int main(int argc, char *argv[]){
  ...
  int v28 = atomic_load_explicit(&atom_1_X2_0, memory_order_seq_cst);
  int v29 = atomic_load_explicit(&atom_1_X4_1, memory_order_seq_cst);
  int v30 = atomic_load_explicit(&atom_1_X7_1, memory_order_seq_cst);
