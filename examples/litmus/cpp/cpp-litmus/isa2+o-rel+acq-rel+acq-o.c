...
atomic_int vars[3]; 
atomic_int atom_1_X0_4; 
atomic_int atom_2_X0_1; 
atomic_int atom_2_X2_1; 
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_1_X0_4, memory_order_seq_cst);
  int v11 = atomic_load_explicit(&atom_2_X0_1, memory_order_seq_cst);
  int v12 = atomic_load_explicit(&atom_2_X2_1, memory_order_seq_cst);
