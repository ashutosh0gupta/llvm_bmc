...
label_2:;
  ...
  int v19 = (v6_W3 == 2);
  atomic_store_explicit(&atom_1_X3_2, v19, memory_order_seq_cst);
...
int main(int argc, char *argv[]){
  ...
  int v12 = (v11 == 2);
  int v13 = atomic_load_explicit(&atom_1_X2_2, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_1_X3_2, memory_order_seq_cst);
