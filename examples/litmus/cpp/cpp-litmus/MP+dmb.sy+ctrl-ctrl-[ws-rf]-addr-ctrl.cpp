...
lbl_LC01:;
  ...
  int v13_W8 = atomic_load_explicit(&vars[4+v10_W7], memory_order_relaxed);
...
int main(int argc, char *argv[]){
  ...
  int v24 = atomic_load_explicit(&atom_1_X6_2, memory_order_seq_cst);
  int v25 = atomic_load_explicit(&atom_1_X10_0, memory_order_seq_cst);
