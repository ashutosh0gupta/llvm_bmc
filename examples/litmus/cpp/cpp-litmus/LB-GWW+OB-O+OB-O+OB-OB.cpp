...
label_5:;
  ...
  int v25 = (v12_W0 == 1);
  atomic_store_explicit(&atom_4_X0_1, v25, memory_order_seq_cst);
  int v26 = (v15_W2 == 0);
  atomic_store_explicit(&atom_4_X2_0, v26, memory_order_seq_cst);
...
int main(int argc, char *argv[]){
  ...
  int v16 = atomic_load_explicit(&atom_4_X0_1, memory_order_seq_cst);
  int v17 = atomic_load_explicit(&atom_4_X2_0, memory_order_seq_cst);
