...
void *t5(void *arg){
label_6:;
  int v15_W0 = atomic_load_explicit(&vars[5], memory_order_relaxed);
  dmbsy();
...
int main(int argc, char *argv[]){
  ...
  int v19 = atomic_load_explicit(&atom_5_X0_1, memory_order_seq_cst);
  int v20 = atomic_load_explicit(&atom_5_X2_0, memory_order_seq_cst);
