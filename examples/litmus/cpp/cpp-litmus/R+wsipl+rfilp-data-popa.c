...
label_1:;
  ...
  int v23 = (v3_W3 == 3);
  atomic_store_explicit(&atom_0_X3_3, v23, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  int v8_W3 = v7_W3 + 1;
  atomic_store_explicit(&vars[1], v8_W3, memory_order_relaxed);
  int v11_W5 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v24 = (v6_W2 == 3);
  atomic_store_explicit(&atom_1_X2_3, v24, memory_order_seq_cst);
  int v25 = (v11_W5 == 0);
  atomic_store_explicit(&atom_1_X5_0, v25, memory_order_seq_cst);
  return NULL;
}
