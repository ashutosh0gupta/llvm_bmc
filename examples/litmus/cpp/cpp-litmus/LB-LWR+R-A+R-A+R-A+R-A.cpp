...
void *t4(void *arg){
label_5:;
  int v12_W0 = atomic_load_explicit(&vars[4], memory_order_acquire);
  int v15_W2 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  int v25 = (v15_W2 == 0);
...
int main(int argc, char *argv[]){
  ...
  int v16 = atomic_load_explicit(&atom_4_X2_0, memory_order_seq_cst);
  ...
  int v19 = atomic_load_explicit(&atom_3_X0_1, memory_order_seq_cst);
  int v20 = atomic_load_explicit(&atom_4_X0_1, memory_order_seq_cst);
