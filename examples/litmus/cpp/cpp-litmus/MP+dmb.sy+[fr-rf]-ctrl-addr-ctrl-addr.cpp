...
lbl_LC01:;
  int v16_W8 = atomic_load_explicit(&vars[4], memory_order_relaxed);
  ...
  int v33 = (v6_W2 == 2);
  atomic_store_explicit(&atom_1_X2_2, v33, memory_order_seq_cst);
  int v34 = (v20_W11 == 0);
...
int main(int argc, char *argv[]){
  ...
  int v26 = atomic_load_explicit(&atom_1_X2_2, memory_order_seq_cst);
  int v27 = atomic_load_explicit(&atom_1_X11_0, memory_order_seq_cst);
