...
label_1:;
  ...
  atomic_store_explicit(&vars[2+v9_W6], 1, memory_order_relaxed);
  int v27 = (v3_W2 == 1);
  atomic_store_explicit(&atom_0_X2_1, v27, memory_order_seq_cst);
  int v28 = (v8_W5 == 1);
  atomic_store_explicit(&atom_0_X5_1, v28, memory_order_seq_cst);
...
int main(int argc, char *argv[]){
  ...
  int v20 = atomic_load_explicit(&atom_0_X5_1, memory_order_seq_cst);
