...
label_2:;
  ...
  int v19_W11 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v36 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v36, memory_order_seq_cst);
  int v37 = (v12_W7 == 2);
  atomic_store_explicit(&atom_1_X7_2, v37, memory_order_seq_cst);
  int v38 = (v16_W9 == 0);
  atomic_store_explicit(&atom_1_X9_0, v38, memory_order_seq_cst);
  int v39 = (v19_W11 == 0);
  atomic_store_explicit(&atom_1_X11_0, v39, memory_order_seq_cst);
...
int main(int argc, char *argv[]){
  ...
  int v27 = atomic_load_explicit(&atom_1_X7_2, memory_order_seq_cst);
  int v28 = atomic_load_explicit(&atom_1_X9_0, memory_order_seq_cst);
  int v29 = atomic_load_explicit(&atom_1_X11_0, memory_order_seq_cst);
