...
label_3:;
  ...
  int v10_W3 = atomic_load_explicit(&vars[0+v7_W2], memory_order_relaxed);
  int v17 = (v6_W0 == 1);
  atomic_store_explicit(&atom_2_X0_1, v17, memory_order_seq_cst);
  int v18 = (v10_W3 == 0);
  atomic_store_explicit(&atom_2_X3_0, v18, memory_order_seq_cst);
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_2_X3_0, memory_order_seq_cst);
