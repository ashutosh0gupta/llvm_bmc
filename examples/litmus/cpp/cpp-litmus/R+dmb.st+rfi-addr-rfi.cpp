...
label_2:;
  ...
  int v7_W6 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v17 = (v3_W2 == 2);
  atomic_store_explicit(&atom_1_X2_2, v17, memory_order_seq_cst);
  int v18 = (v7_W6 == 1);
  atomic_store_explicit(&atom_1_X6_1, v18, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_1_X6_1, memory_order_seq_cst);
