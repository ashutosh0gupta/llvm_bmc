...
label_2:;
  ...
  int v22 = (v9_W6 == 3);
  atomic_store_explicit(&atom_1_X6_3, v22, memory_order_seq_cst);
  int v23 = (v6_W5 == 2);
  atomic_store_explicit(&atom_1_X5_2, v23, memory_order_seq_cst);
...
int main(int argc, char *argv[]){
  ...
  int v15 = atomic_load_explicit(&atom_1_X6_3, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_1_X5_2, memory_order_seq_cst);
