...
lbl_LC00:;
  ...
  int v28 = (v9_W4 == 0);
  atomic_store_explicit(&atom_0_X4_0, v28, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  int v18 = atomic_load_explicit(&atom_0_X3_1, memory_order_seq_cst);
  int v19 = atomic_load_explicit(&atom_0_X4_0, memory_order_seq_cst);
