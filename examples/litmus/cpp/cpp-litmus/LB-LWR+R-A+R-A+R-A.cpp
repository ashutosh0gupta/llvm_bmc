...
label_3:;
  ...
  int v22 = (v6_W0 == 1);
  atomic_store_explicit(&atom_2_X0_1, v22, memory_order_seq_cst);
...
label_4:;
  ...
  int v20 = (v12_W2 == 0);
  atomic_store_explicit(&atom_3_X2_0, v20, memory_order_seq_cst);
  int v23 = (v9_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v13 = atomic_load_explicit(&atom_3_X2_0, memory_order_seq_cst);
  int v14 = atomic_load_explicit(&atom_1_X0_1, memory_order_seq_cst);
  int v15 = atomic_load_explicit(&atom_2_X0_1, memory_order_seq_cst);
  int v16 = atomic_load_explicit(&atom_3_X0_1, memory_order_seq_cst);
