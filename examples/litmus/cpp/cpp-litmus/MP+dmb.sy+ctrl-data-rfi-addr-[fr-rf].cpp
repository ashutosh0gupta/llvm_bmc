...
lbl_LC00:;
  ...
  int v11_W6 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  int v12_W7 = v11_W6 ^ v11_W6;
  int v15_W8 = atomic_load_explicit(&vars[0+v12_W7], memory_order_relaxed);
  int v18_W10 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v35 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v35, memory_order_seq_cst);
  int v36 = (v11_W6 == 1);
  atomic_store_explicit(&atom_1_X6_1, v36, memory_order_seq_cst);
  int v37 = (v15_W8 == 0);
  atomic_store_explicit(&atom_1_X8_0, v37, memory_order_seq_cst);
  int v38 = (v18_W10 == 1);
  atomic_store_explicit(&atom_1_X10_1, v38, memory_order_seq_cst);
...
int main(int argc, char *argv[]){
  ...
  int v26 = atomic_load_explicit(&atom_1_X6_1, memory_order_seq_cst);
