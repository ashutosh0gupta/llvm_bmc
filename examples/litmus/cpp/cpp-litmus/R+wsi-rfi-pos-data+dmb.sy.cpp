...
label_1:;
  ...
  int v8_W5 = v7_W5 + 1;
  atomic_store_explicit(&vars[1], v8_W5, memory_order_relaxed);
  int v23 = (v3_W3 == 2);
  atomic_store_explicit(&atom_0_X3_2, v23, memory_order_seq_cst);
  int v24 = (v6_W4 == 2);
...
int main(int argc, char *argv[]){
  ...
  int v15 = (v14 == 2);
  int v16 = atomic_load_explicit(&atom_0_X3_2, memory_order_seq_cst);
