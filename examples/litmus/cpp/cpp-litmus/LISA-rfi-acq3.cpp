...
label_2:;
  ...
  int v8_W4 = atomic_load_explicit(&vars[2], memory_order_acquire);
  int v11_W5 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  int v17 = (v3_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_1_X5_0, memory_order_seq_cst);
