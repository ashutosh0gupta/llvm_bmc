...
label_2:;
  ...
  int v12_W5 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  ...
  int v35 = (v12_W5 == 2);
  atomic_store_explicit(&atom_1_X5_2, v35, memory_order_seq_cst);
  int v36 = (v16_W7 == 0);
...
int main(int argc, char *argv[]){
  ...
  int v24 = atomic_load_explicit(&atom_1_X5_2, memory_order_seq_cst);
