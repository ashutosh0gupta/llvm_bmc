 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/S+dmb.sy+data-rfi-fri-wsi.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {7, 3, 10};
...
tt1_0_6: IF(2,6,tt1_0_7)
                                        ...
                                        __cs_local_t1_v17 = __cs_local_t1_v11_W7 == 4;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X7_4 = __cs_local_t1_v17;
