 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/WRW+WR+poacquirerelease+poreleaseacquire+Release.c, 
 *
 */
