 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB+data+ctrl-rfi-addr.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 4, 7};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        static int __cs_local_t0_v27;
                                        __cs_local_t0_v27 = __cs_local_t0_v3_W0 == 1;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X0_1 = __cs_local_t0_v27;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
IF(2,0,tt1_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t1_v8_W0;
tt1_0_1: IF(2,1,tt1_0_2)
                                        __cs_local_t1_v8_W0 = vars[1];
                                        ;
                                                ;
                                        static _Bool __cs_local_t1___cs_tmp_if_cond_0;
                                        __cs_local_t1___cs_tmp_if_cond_0 = __cs_local_t1_v8_W0;
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[2] = 1;
                                        static int __cs_local_t1_v11_W4;
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v11_W4 = vars[2];
                                        static int __cs_local_t1_v12_W5;
                                        __cs_local_t1_v12_W5 = __cs_local_t1_v11_W4 ^ __cs_local_t1_v11_W4;
tt1_0_4: IF(2,4,tt1_0_5)
                                        vars[0 + __cs_local_t1_v12_W5] = 1;
                                        static int __cs_local_t1_v28;
                                        __cs_local_t1_v28 = __cs_local_t1_v8_W0 == 1;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X0_1 = __cs_local_t1_v28;
                                        static int __cs_local_t1_v29;
                                        __cs_local_t1_v29 = __cs_local_t1_v11_W4 == 1;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X4_1 = __cs_local_t1_v29;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_9: IF(0,9,tmain_10)
                                        __cs_local_main_v21 = v_1_X4_1;
                                        static int __cs_local_main_v22_conj;
                                        __cs_local_main_v22_conj = __cs_local_main_v20 & __cs_local_main_v21;
                                        static int __cs_local_main_v23_conj;
                                        __cs_local_main_v23_conj = __cs_local_main_v19 & __cs_local_main_v22_conj;
                                        ...
                                        __cs_local_main_v25_conj = __cs_local_main_v16 & __cs_local_main_v24_conj;
                                        static int __cs_local_main_v26_conj;
                                        __cs_local_main_v26_conj = __cs_local_main_v14 & __cs_local_main_v25_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_1;
                                        __cs_local_main___cs_tmp_if_cond_1 = __cs_local_main_v26_conj == 1;
