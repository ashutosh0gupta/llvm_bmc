 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/3.LB+fencembonceonce+ctrlonceonce+poacquirerelease.c, 
 *
 */
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        static int __cs_local_t1_v7_cmpeq;
                                        __cs_local_t1_v7_cmpeq = __cs_local_t1_v6_W0 == 0;
                                        ;
                                                ;
                                        static _Bool __cs_local_t1___cs_tmp_if_cond_0;
                                        __cs_local_t1___cs_tmp_if_cond_0 = __cs_local_t1_v7_cmpeq;
                                        if (__cs_local_t1___cs_tmp_if_cond_0)
                                                {
                                        goto lbl_label112_t1_0;
                                                        ;
                                                }
                                                else
                                                {
