 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+dmb.st+rfi-ctrl-ctrlisb.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 3, 7};
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        ...
                                        __cs_local_t1___cs_tmp_if_cond_1 = __cs_local_t1_v6_W3;
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v20 = __cs_local_t1_v9_W5 == 0;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X5_0 = __cs_local_t1_v20;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_7: IF(0,7,tmain_8)
                                        ...
                                        __cs_local_main_v18_conj = __cs_local_main_v11 & __cs_local_main_v17_conj;
                                        ;
                                                ;
