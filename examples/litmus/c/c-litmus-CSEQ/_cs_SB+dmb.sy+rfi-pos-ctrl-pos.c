 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/SB+dmb.sy+rfi-pos-ctrl-pos.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {11, 4, 10};
...
tt1_0_6: IF(2,6,tt1_0_7)
                                        ...
                                        __cs_local_t1_v33 = __cs_local_t1_v9_W3 == 1;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X3_1 = __cs_local_t1_v33;
...
tt1_0_8: IF(2,8,tt1_0_9)
                                        ...
                                        __cs_local_t1_v35 = __cs_local_t1_v15_W6 == 0;
tt1_0_9: IF(2,9,tt1_0_10)
                                        v_1_X6_0 = __cs_local_t1_v35;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
