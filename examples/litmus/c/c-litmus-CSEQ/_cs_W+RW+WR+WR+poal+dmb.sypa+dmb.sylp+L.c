 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/W+RW+WR+WR+poal+dmb.sypa+dmb.sylp+L.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {12, 2, 4, 4, 4};
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t2_v6_W2;
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v6_W2 = vars[2];
                                        static int __cs_local_t2_v19;
                                        __cs_local_t2_v19 = __cs_local_t2_v6_W2 == 0;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X2_0 = __cs_local_t2_v19;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
