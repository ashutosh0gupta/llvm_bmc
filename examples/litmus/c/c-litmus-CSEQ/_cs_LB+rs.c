 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB+rs.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 5, 4};
...
tt0_0_1: IF(1,1,tt0_0_2)
                                        ...
                                        __cs_local_t0_v4_W2 = __cs_local_t0_v3_W0 + 0;
tt0_0_2: IF(1,2,tt0_0_3)
                                        vars[1] = 1;
                                        static int __cs_local_t0_v20;
                                        __cs_local_t0_v20 = 1 == 1;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X0_1 = __cs_local_t0_v20;
                                        static int __cs_local_t0_v21;
                                        __cs_local_t0_v21 = __cs_local_t0_v4_W2 == 2;
tt0_0_4: IF(1,4,tt0_0_5)
                                        v_0_X2_2 = __cs_local_t0_v21;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
IF(2,0,tt1_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t1_v7_W0;
tt1_0_1: IF(2,1,tt1_0_2)
                                        __cs_local_t1_v7_W0 = vars[1];
                                        static int __cs_local_t1_v8_W2;
                                        __cs_local_t1_v8_W2 = __cs_local_t1_v7_W0 + 1;
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[0] = __cs_local_t1_v8_W2;
                                        static int __cs_local_t1_v22;
                                        __cs_local_t1_v22 = __cs_local_t1_v8_W2 == 2;
...
tmain_8: IF(0,8,tmain_9)
                                        ...
                                        __cs_local_main_v16_conj = __cs_local_main_v13 & __cs_local_main_v15;
                                        ...
                                        __cs_local_main_v18_conj = __cs_local_main_v10 & __cs_local_main_v17_conj;
                                        static int __cs_local_main_v19_conj;
                                        __cs_local_main_v19_conj = __cs_local_main_v9 & __cs_local_main_v18_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_0;
                                        __cs_local_main___cs_tmp_if_cond_0 = __cs_local_main_v19_conj == 1;
