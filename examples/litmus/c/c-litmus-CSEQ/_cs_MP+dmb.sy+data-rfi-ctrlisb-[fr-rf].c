 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+data-rfi-ctrlisb-[fr-rf].c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {13, 3, 10, 2};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        __cs_local_t1_v11_W5 = vars[0];
                                        static int __cs_local_t1_v14_W7;
tt1_0_5: IF(2,5,tt1_0_6)
                                        __cs_local_t1_v14_W7 = vars[0];
                                        static int __cs_local_t1_v31;
                                        __cs_local_t1_v31 = __cs_local_t1_v3_W0 == 1;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X0_1 = __cs_local_t1_v31;
                                        static int __cs_local_t1_v32;
                                        __cs_local_t1_v32 = __cs_local_t1_v8_W4 == 1;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X4_1 = __cs_local_t1_v32;
                                        static int __cs_local_t1_v33;
                                        __cs_local_t1_v33 = __cs_local_t1_v11_W5 == 0;
tt1_0_8: IF(2,8,tt1_0_9)
                                        v_1_X5_0 = __cs_local_t1_v33;
                                        static int __cs_local_t1_v34;
                                        __cs_local_t1_v34 = __cs_local_t1_v14_W7 == 1;
...
tmain_12: IF(0,12,tmain_13)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_1 = __cs_local_main_v30_conj == 1;
