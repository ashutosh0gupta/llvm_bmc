 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Z6.0+fencembonceonce+ctrlonceonce+poreleaseacquire.c, 
 *
 */
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v14 = __cs_local_t1_v3_W0 == 1;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_1 = __cs_local_t1_v14;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t2_v7_W1;
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v7_W1 = vars[1];
                                        static int __cs_local_t2_v15;
                                        __cs_local_t2_v15 = __cs_local_t2_v7_W1 == 0;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X1_0 = __cs_local_t2_v15;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tmain_8: IF(0,8,tmain_9)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_1 = __cs_local_main_v13_conj == 1;
