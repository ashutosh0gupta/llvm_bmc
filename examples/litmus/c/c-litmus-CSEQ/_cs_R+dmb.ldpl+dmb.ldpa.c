 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+dmb.ldpl+dmb.ldpa.c, 
 *
 */
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v3_W2 = vars[0];
                                        static int __cs_local_t1_v8;
                                        __cs_local_t1_v8 = __cs_local_t1_v3_W2 == 0;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X2_0 = __cs_local_t1_v8;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
