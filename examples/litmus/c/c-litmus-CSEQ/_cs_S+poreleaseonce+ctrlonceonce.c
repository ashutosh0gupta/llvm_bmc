 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/S+poreleaseonce+ctrlonceonce.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {6, 3, 4};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[1] = 1;
                                        static int __cs_local_t1_v9;
                                        __cs_local_t1_v9 = __cs_local_t1_v3_W0 == 1;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_1 = __cs_local_t1_v9;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_5: IF(0,5,tmain_6)
                                        ...
                                        static int __cs_local_main_v8_conj;
                                        __cs_local_main_v8_conj = __cs_local_main_v6 & __cs_local_main_v7;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_1;
                                        __cs_local_main___cs_tmp_if_cond_1 = __cs_local_main_v8_conj == 1;
