 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+addr-ctrl-data-rfi-ctrl.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 3, 10};
...
tt1_0_7: IF(2,7,tt1_0_8)
                                        ...
                                        __cs_local_t1_v34 = __cs_local_t1_v15_W9 == 1;
tt1_0_8: IF(2,8,tt1_0_9)
                                        v_1_X9_1 = __cs_local_t1_v34;
