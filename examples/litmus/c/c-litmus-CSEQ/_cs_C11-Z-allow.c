 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/C11-Z-allow.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {10, 6, 5, 6};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v22 = __cs_local_t1_v6_W2 == 4;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X2_4 = __cs_local_t1_v22;
...
tt2_0_3: IF(3,3,tt2_0_4)
                                        vars[0] = 1;
                                        static int __cs_local_t2_v12_W4;
tt2_0_4: IF(3,4,tt2_0_5)
                                        __cs_local_t2_v12_W4 = vars[0];
                                        static int __cs_local_t2_v21;
                                        __cs_local_t2_v21 = __cs_local_t2_v12_W4 == 3;
tt2_0_5: IF(3,5,tt2_0_6)
                                        v_2_X4_3 = __cs_local_t2_v21;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
