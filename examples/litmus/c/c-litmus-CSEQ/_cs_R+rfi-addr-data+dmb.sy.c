 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+rfi-addr-data+dmb.sy.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 6, 4};
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        ...
                                        __cs_local_t0_v8_W6 = __cs_local_t0_v7_W4 ^ __cs_local_t0_v7_W4;
                                        static int __cs_local_t0_v9_W6;
                                        __cs_local_t0_v9_W6 = __cs_local_t0_v8_W6 + 1;
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[2] = __cs_local_t0_v9_W6;
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v23 = __cs_local_t1_v12_W2 == 0;
