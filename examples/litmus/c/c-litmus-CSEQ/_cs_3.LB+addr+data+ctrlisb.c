 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/3.LB+addr+data+ctrlisb.c, 
 *
 */
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        __cs_local_t1_v8_W2 = __cs_local_t1_v7_W0 ^ __cs_local_t1_v7_W0;
                                        static int __cs_local_t1_v9_W2;
                                        __cs_local_t1_v9_W2 = __cs_local_t1_v8_W2 + 1;
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[2] = __cs_local_t1_v9_W2;
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v12_W0 = vars[2];
                                        ;
                                                ;
                                        static _Bool __cs_local_t2___cs_tmp_if_cond_0;
                                        __cs_local_t2___cs_tmp_if_cond_0 = __cs_local_t2_v12_W0;
                                        if (__cs_local_t2___cs_tmp_if_cond_0)
                                                {
                                        goto lbl_LC00_t2_0;
                                                        ;
                                                }
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        ...
                                        __cs_local_t2_v20 = __cs_local_t2_v12_W0 == 1;
