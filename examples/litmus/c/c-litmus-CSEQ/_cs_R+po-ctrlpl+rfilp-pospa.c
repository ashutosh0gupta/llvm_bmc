 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+po-ctrlpl+rfilp-pospa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 6, 8};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        __cs_local_t1_v15_W4 = vars[0];
                                        static int __cs_local_t1_v27;
                                        __cs_local_t1_v27 = __cs_local_t1_v15_W4 == 3;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X4_3 = __cs_local_t1_v27;
...
tt1_0_6: IF(2,6,tt1_0_7)
                                        ...
                                        __cs_local_t1_v29 = __cs_local_t1_v12_W3 == 2;
...
tmain_5: IF(0,5,tmain_6)
                                        __cs_local_main_v18 = v_0_X5_2;
                                        static int __cs_local_main_v19;
tmain_6: IF(0,6,tmain_7)
                                        __cs_local_main_v19 = v_1_X4_3;
