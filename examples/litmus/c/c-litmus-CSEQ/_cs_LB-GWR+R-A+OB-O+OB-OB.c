 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB-GWR+R-A+OB-O+OB-OB.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[6] = {15, 3, 4, 4, 5, 4};
...
tt3_0_2: IF(4,2,tt3_0_3)
                                        __cs_local_t3_v12_W2 = vars[4];
                                        static int __cs_local_t3_v25;
                                        __cs_local_t3_v25 = __cs_local_t3_v12_W2 == 0;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X2_0 = __cs_local_t3_v25;
...
tt4_0_1: IF(5,1,tt4_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t4_v15_W1;
tt4_0_2: IF(5,2,tt4_0_3)
                                        __cs_local_t4_v15_W1 = vars[1];
                                        static int __cs_local_t4_v26;
                                        __cs_local_t4_v26 = __cs_local_t4_v15_W1 == 0;
tt4_0_3: IF(5,3,tt4_0_4)
                                        v_4_X1_0 = __cs_local_t4_v26;
                                        goto __exit_t4;
                                                ;
                                        __exit_t4:
...
tmain_10: IF(0,10,tmain_11)
                                        __cs_local_main_v16 = v_3_X2_0;
                                        static int __cs_local_main_v17;
tmain_11: IF(0,11,tmain_12)
                                        __cs_local_main_v17 = v_4_X1_0;
