 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+rfi-addr-ctrlpl+rfila.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 8, 6};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        static int __cs_local_t0_v7_W4;
tt0_0_3: IF(1,3,tt0_0_4)
                                        __cs_local_t0_v7_W4 = vars[1 + __cs_local_t0_v4_W3];
                                        ;
                                                ;
                                        static _Bool __cs_local_t0___cs_tmp_if_cond_0;
                                        __cs_local_t0___cs_tmp_if_cond_0 = __cs_local_t0_v7_W4;
...
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[0] = 1;
                                        static int __cs_local_t0_v10_W7;
tt0_0_5: IF(1,5,tt0_0_6)
                                        __cs_local_t0_v10_W7 = vars[0];
                                        static int __cs_local_t0_v27;
                                        __cs_local_t0_v27 = __cs_local_t0_v10_W7 == 2;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X7_2 = __cs_local_t0_v27;
                                        static int __cs_local_t0_v28;
                                        __cs_local_t0_v28 = __cs_local_t0_v3_W2 == 3;
tt0_0_7: IF(1,7,tt0_0_8)
                                        v_0_X2_3 = __cs_local_t0_v28;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v13_W2;
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v13_W2 = vars[0];
                                        static int __cs_local_t1_v16_W3;
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v16_W3 = vars[0];
                                        static int __cs_local_t1_v29;
                                        __cs_local_t1_v29 = __cs_local_t1_v16_W3 == 3;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X3_3 = __cs_local_t1_v29;
                                        static int __cs_local_t1_v30;
                                        __cs_local_t1_v30 = __cs_local_t1_v13_W2 == 2;
...
tmain_4: IF(0,4,tmain_5)
                                        ...
                                        __cs_local_main_v18 = __cs_local_main_v17 == 3;
                                        static int __cs_local_main_v19;
tmain_5: IF(0,5,tmain_6)
                                        __cs_local_main_v19 = v_0_X7_2;
