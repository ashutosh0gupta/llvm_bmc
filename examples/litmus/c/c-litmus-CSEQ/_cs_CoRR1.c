 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/CoRR1.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {6, 2, 5};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v10 = __cs_local_t1_v3_W0 == 2;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_2 = __cs_local_t1_v10;
                                        static int __cs_local_t1_v11;
                                        __cs_local_t1_v11 = __cs_local_t1_v6_W2 == 1;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X2_1 = __cs_local_t1_v11;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_4: IF(0,4,tmain_5)
                                        __cs_local_main_v7 = v_1_X0_2;
                                        static int __cs_local_main_v8;
tmain_5: IF(0,5,tmain_6)
                                        __cs_local_main_v8 = v_1_X2_1;
