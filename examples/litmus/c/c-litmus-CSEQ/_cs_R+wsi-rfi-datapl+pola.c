 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+wsi-rfi-datapl+pola.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 8, 4};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v25 = __cs_local_t1_v11_W2 == 0;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X2_0 = __cs_local_t1_v25;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
