 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+wsipl+polp-data-rfipa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 5, 8};
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        ...
                                        __cs_local_t0_v23 = __cs_local_t0_v3_W3 == 4;
tt0_0_4: IF(1,4,tt0_0_5)
                                        v_0_X3_4 = __cs_local_t0_v23;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v24 = __cs_local_t1_v14_W6 == 2;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X6_2 = __cs_local_t1_v24;
