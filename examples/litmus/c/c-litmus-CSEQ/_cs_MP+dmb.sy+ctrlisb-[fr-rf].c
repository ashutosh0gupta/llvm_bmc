 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+ctrlisb-[fr-rf].c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {11, 3, 7, 2};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v22 = __cs_local_t1_v6_W2 == 0;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X2_0 = __cs_local_t1_v22;
                                        static int __cs_local_t1_v23;
                                        __cs_local_t1_v23 = __cs_local_t1_v9_W4 == 1;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X4_1 = __cs_local_t1_v23;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_9: IF(0,9,tmain_10)
                                        __cs_local_main_v15 = v_1_X2_0;
                                        static int __cs_local_main_v16;
tmain_10: IF(0,10,tmain_11)
                                        __cs_local_main_v16 = v_1_X4_1;
