 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/ISA2+wsilp-rfipa-poap+addr+addr.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {11, 6, 4, 5};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t0_v3_W3;
tt0_0_3: IF(1,3,tt0_0_4)
                                        __cs_local_t0_v3_W3 = vars[0];
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[1] = 1;
                                        static int __cs_local_t0_v25;
                                        __cs_local_t0_v25 = __cs_local_t0_v3_W3 == 2;
tt0_0_5: IF(1,5,tt0_0_6)
                                        v_0_X3_2 = __cs_local_t0_v25;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        __cs_local_t1_v6_W0 = vars[1];
                                        static int __cs_local_t1_v7_W2;
                                        __cs_local_t1_v7_W2 = __cs_local_t1_v6_W0 ^ __cs_local_t1_v6_W0;
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[2 + __cs_local_t1_v7_W2] = 1;
                                        static int __cs_local_t1_v26;
                                        __cs_local_t1_v26 = __cs_local_t1_v6_W0 == 1;
...
IF(3,0,tt2_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t2_v10_W0;
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v10_W0 = vars[2];
                                        static int __cs_local_t2_v11_W2;
                                        __cs_local_t2_v11_W2 = __cs_local_t2_v10_W0 ^ __cs_local_t2_v10_W0;
                                        static int __cs_local_t2_v14_W3;
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v14_W3 = vars[0 + __cs_local_t2_v11_W2];
                                        static int __cs_local_t2_v27;
                                        __cs_local_t2_v27 = __cs_local_t2_v10_W0 == 1;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X0_1 = __cs_local_t2_v27;
                                        static int __cs_local_t2_v28;
                                        __cs_local_t2_v28 = __cs_local_t2_v14_W3 == 0;
tt2_0_4: IF(3,4,tt2_0_5)
                                        v_2_X3_0 = __cs_local_t2_v28;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tmain_9: IF(0,9,tmain_10)
                                        __cs_local_main_v19 = v_2_X0_1;
                                        static int __cs_local_main_v20;
tmain_10: IF(0,10,tmain_11)
                                        __cs_local_main_v20 = v_2_X3_0;
