 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+po-po-ctrlpl+rfila.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 7, 6};
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        ...
                                        __cs_local_t1_v25 = __cs_local_t1_v12_W3 == 3;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X3_3 = __cs_local_t1_v25;
                                        static int __cs_local_t1_v26;
                                        __cs_local_t1_v26 = __cs_local_t1_v9_W2 == 2;
