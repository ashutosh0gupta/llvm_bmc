 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB-GRR+R-A+OB-O+OB-O+OB-OB.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[7] = {18, 4, 4, 4, 4, 5, 3};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        __cs_local_t0_v31 = __cs_local_t0_v3_W0 == 1;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X0_1 = __cs_local_t0_v31;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v32 = __cs_local_t1_v6_W0 == 1;
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        ...
                                        __cs_local_t2_v33 = __cs_local_t2_v9_W0 == 1;
...
tt3_0_2: IF(4,2,tt3_0_3)
                                        ...
                                        __cs_local_t3_v34 = __cs_local_t3_v12_W0 == 1;
...
tt4_0_1: IF(5,1,tt4_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t4_v18_W2;
tt4_0_2: IF(5,2,tt4_0_3)
                                        __cs_local_t4_v18_W2 = vars[5];
                                        static int __cs_local_t4_v30;
                                        __cs_local_t4_v30 = __cs_local_t4_v18_W2 == 0;
tt4_0_3: IF(5,3,tt4_0_4)
                                        v_4_X2_0 = __cs_local_t4_v30;
                                        static int __cs_local_t4_v35;
                                        __cs_local_t4_v35 = __cs_local_t4_v15_W0 == 1;
