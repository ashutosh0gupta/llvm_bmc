 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/z6.3+fencewmbonceonce+fencewmbonceonce+fencermbonceonce.c, 
 *
 */
