 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/WRC+data+ctrl.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 2, 4, 5};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[1] = __cs_local_t1_v5_W2;
                                        static int __cs_local_t1_v17;
                                        __cs_local_t1_v17 = __cs_local_t1_v3_W0 == 1;
...
IF(3,0,tt2_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t2_v8_W0;
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v8_W0 = vars[1];
                                        ;
                                                ;
                                        static _Bool __cs_local_t2___cs_tmp_if_cond_0;
                                        __cs_local_t2___cs_tmp_if_cond_0 = __cs_local_t2_v8_W0;
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v11_W2 = vars[0];
                                        static int __cs_local_t2_v18;
                                        __cs_local_t2_v18 = __cs_local_t2_v8_W0 == 1;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X0_1 = __cs_local_t2_v18;
                                        static int __cs_local_t2_v19;
                                        __cs_local_t2_v19 = __cs_local_t2_v11_W2 == 0;
