 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/2+2W+dmb.sy+rfi-ctrl-pos-ctrl.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {7, 3, 7};
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v17 = __cs_local_t1_v3_W2 == 2;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X2_2 = __cs_local_t1_v17;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_6: IF(0,6,tmain_7)
                                        ...
                                        __cs_local_main_v16_conj = __cs_local_main_v11 & __cs_local_main_v15_conj;
                                        ;
                                                ;
