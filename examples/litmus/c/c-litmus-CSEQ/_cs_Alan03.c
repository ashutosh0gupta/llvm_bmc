 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Alan03.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {10, 3, 5, 5};
...
tmain_9: IF(0,9,tmain_10)
                                        ...
                                        static int __cs_local_main_v18_disj;
                                        __cs_local_main_v18_disj = __cs_local_main_v14 | __cs_local_main_v17_conj;
                                        static int __cs_local_main_v19_conj;
                                        __cs_local_main_v19_conj = __cs_local_main_v13 & __cs_local_main_v18_disj;
                                        ;
                                                ;
