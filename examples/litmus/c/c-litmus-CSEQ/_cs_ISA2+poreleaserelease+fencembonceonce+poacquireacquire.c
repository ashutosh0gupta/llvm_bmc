 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/ISA2+poreleaserelease+fencembonceonce+poacquireacquire.c, 
 *
 */
