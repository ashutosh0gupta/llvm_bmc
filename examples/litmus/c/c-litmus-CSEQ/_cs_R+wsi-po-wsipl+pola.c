 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+wsi-po-wsipl+pola.c, 
 *
 */
...
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[1] = 2;
                                        static int __cs_local_t0_v3_W6;
tt0_0_5: IF(1,5,tt0_0_6)
                                        __cs_local_t0_v3_W6 = vars[1];
                                        static int __cs_local_t0_v16;
                                        __cs_local_t0_v16 = __cs_local_t0_v3_W6 == 3;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X6_3 = __cs_local_t0_v16;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tmain_5: IF(0,5,tmain_6)
                                        ...
                                        __cs_local_main_v10 = __cs_local_main_v9 == 3;
                                        static int __cs_local_main_v11;
tmain_6: IF(0,6,tmain_7)
                                        __cs_local_main_v11 = v_0_X6_3;
