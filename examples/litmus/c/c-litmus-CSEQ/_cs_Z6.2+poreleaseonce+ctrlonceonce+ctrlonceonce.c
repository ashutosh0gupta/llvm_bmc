 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Z6.2+poreleaseonce+ctrlonceonce+ctrlonceonce.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 3, 4, 4};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[2] = 1;
                                        static int __cs_local_t1_v15;
                                        __cs_local_t1_v15 = __cs_local_t1_v3_W0 == 1;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_1 = __cs_local_t1_v15;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
IF(3,0,tt2_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t2_v7_W0;
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v7_W0 = vars[2];
                                        static int __cs_local_t2_v8_cmpeq;
                                        __cs_local_t2_v8_cmpeq = __cs_local_t2_v7_W0 == 0;
                                        ;
                                                ;
                                        static _Bool __cs_local_t2___cs_tmp_if_cond_1;
                                        __cs_local_t2___cs_tmp_if_cond_1 = __cs_local_t2_v8_cmpeq;
                                        if (__cs_local_t2___cs_tmp_if_cond_1)
                                                {
                                        goto lbl_label209_t2_0;
                                                        ;
                                                }
                                                else
                                                {
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        vars[1] = 1;
                                        static int __cs_local_t2_v16;
                                        __cs_local_t2_v16 = __cs_local_t2_v7_W0 == 1;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X0_1 = __cs_local_t2_v16;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tmain_7: IF(0,7,tmain_8)
                                        __cs_local_main_v11 = v_1_X0_1;
                                        static int __cs_local_main_v12;
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v12 = v_2_X0_1;
                                        static int __cs_local_main_v13_conj;
                                        __cs_local_main_v13_conj = __cs_local_main_v11 & __cs_local_main_v12;
                                        static int __cs_local_main_v14_conj;
                                        __cs_local_main_v14_conj = __cs_local_main_v10 & __cs_local_main_v13_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_2;
                                        __cs_local_main___cs_tmp_if_cond_2 = __cs_local_main_v14_conj == 1;
