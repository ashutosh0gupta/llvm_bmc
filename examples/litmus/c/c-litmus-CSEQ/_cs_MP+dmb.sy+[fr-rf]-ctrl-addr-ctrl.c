 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+[fr-rf]-ctrl-addr-ctrl.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {11, 3, 9, 2};
...
tt1_0_6: IF(2,6,tt1_0_7)
                                        ...
                                        __cs_local_t1_v29 = __cs_local_t1_v6_W2 == 2;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X2_2 = __cs_local_t1_v29;
                                        static int __cs_local_t1_v30;
                                        __cs_local_t1_v30 = __cs_local_t1_v16_W8 == 0;
