 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/alt-ww-rw+rel+acq-o+o-rel+acq-o+o-wb-rel+acq-o.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[7] = {18, 2, 4, 3, 4, 3, 4};
...
tt3_0_2: IF(4,2,tt3_0_3)
                                        ...
                                        __cs_local_t3_v25 = __cs_local_t3_v6_W0 == 1;
...
IF(6,0,tt5_0_1)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t5_v9_W0;
tt5_0_1: IF(6,1,tt5_0_2)
                                        __cs_local_t5_v9_W0 = vars[4];
tt5_0_2: IF(6,2,tt5_0_3)
                                        vars[0] = 2;
                                        static int __cs_local_t5_v26;
                                        __cs_local_t5_v26 = __cs_local_t5_v9_W0 == 1;
tt5_0_3: IF(6,3,tt5_0_4)
                                        v_5_X0_1 = __cs_local_t5_v26;
                                        goto __exit_t5;
                                                ;
                                        __exit_t5:
...
tmain_17: IF(0,17,tmain_18)
                                        ...
                                        __cs_local_main_v20_conj = __cs_local_main_v15 & __cs_local_main_v19_conj;
