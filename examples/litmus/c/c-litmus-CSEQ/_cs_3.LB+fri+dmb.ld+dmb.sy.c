 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/3.LB+fri+dmb.ld+dmb.sy.c, 
 *
 */
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v19 = __cs_local_t1_v6_W0 == 2;
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v9_W0 = vars[1];
                                        ;
                                                ;
tt2_0_2: IF(3,2,tt2_0_3)
                                        vars[0] = 1;
                                        static int __cs_local_t2_v20;
                                        __cs_local_t2_v20 = __cs_local_t2_v9_W0 == 1;
