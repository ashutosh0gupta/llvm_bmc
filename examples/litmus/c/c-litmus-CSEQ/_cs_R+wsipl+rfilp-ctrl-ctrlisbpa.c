 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+wsipl+rfilp-ctrl-ctrlisbpa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 5, 7};
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v23 = __cs_local_t1_v12_W5 == 0;
...
tmain_7: IF(0,7,tmain_8)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_2 = __cs_local_main_v20_conj == 1;
