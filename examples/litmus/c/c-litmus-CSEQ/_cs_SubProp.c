 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/SubProp.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {11, 4, 5, 7};
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        vars[1] = 0;
                                        static int __cs_local_t1_v3_W5;
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v3_W5 = vars[2];
                                        static int __cs_local_t1_v4_W7;
                                        __cs_local_t1_v4_W7 = __cs_local_t1_v3_W5 ^ __cs_local_t1_v3_W5;
tt1_0_3: IF(2,3,tt1_0_4)
                                        vars[3 + __cs_local_t1_v4_W7] = 0;
                                        static int __cs_local_t1_v26;
                                        __cs_local_t1_v26 = __cs_local_t1_v3_W5 == 1;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X5_1 = __cs_local_t1_v26;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
IF(3,0,tt2_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t2_v7_W4;
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v7_W4 = vars[1];
                                        static int __cs_local_t2_v8_W7;
                                        __cs_local_t2_v8_W7 = __cs_local_t2_v7_W4 ^ __cs_local_t2_v7_W4;
                                        static int __cs_local_t2_v11_W5;
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v11_W5 = vars[3 + __cs_local_t2_v8_W7];
                                        static int __cs_local_t2_v12_W8;
                                        __cs_local_t2_v12_W8 = __cs_local_t2_v11_W5 ^ __cs_local_t2_v11_W5;
                                        static int __cs_local_t2_v15_W6;
tt2_0_3: IF(3,3,tt2_0_4)
                                        __cs_local_t2_v15_W6 = vars[0 + __cs_local_t2_v12_W8];
                                        static int __cs_local_t2_v27;
                                        __cs_local_t2_v27 = __cs_local_t2_v7_W4 == 2;
tt2_0_4: IF(3,4,tt2_0_5)
                                        v_2_X4_2 = __cs_local_t2_v27;
                                        static int __cs_local_t2_v28;
                                        __cs_local_t2_v28 = __cs_local_t2_v11_W5 == 1;
tt2_0_5: IF(3,5,tt2_0_6)
                                        v_2_X5_1 = __cs_local_t2_v28;
                                        static int __cs_local_t2_v29;
                                        __cs_local_t2_v29 = __cs_local_t2_v15_W6 == 0;
tt2_0_6: IF(3,6,tt2_0_7)
                                        v_2_X6_0 = __cs_local_t2_v29;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tmain_10: IF(0,10,tmain_11)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_0 = __cs_local_main_v25_conj == 1;
