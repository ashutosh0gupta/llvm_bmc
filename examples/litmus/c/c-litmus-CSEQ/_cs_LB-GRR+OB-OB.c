 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB-GRR+OB-OB.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 4, 5, 3};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v15 = __cs_local_t1_v9_W2 == 0;
