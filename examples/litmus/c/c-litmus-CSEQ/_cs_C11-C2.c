 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/C11-C2.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 2, 3, 6};
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v3_W0 = vars[1];
tt2_0_2: IF(3,2,tt2_0_3)
                                        vars[0] = 1;
                                        static int __cs_local_t2_v6_W4;
tt2_0_3: IF(3,3,tt2_0_4)
                                        __cs_local_t2_v6_W4 = vars[0];
...
tt2_0_4: IF(3,4,tt2_0_5)
                                        ...
                                        __cs_local_t2_v14 = __cs_local_t2_v6_W4 == 3;
tt2_0_5: IF(3,5,tt2_0_6)
                                        v_2_X4_3 = __cs_local_t2_v14;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
