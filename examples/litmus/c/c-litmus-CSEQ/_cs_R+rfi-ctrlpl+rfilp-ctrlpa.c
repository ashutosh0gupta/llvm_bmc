 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+rfi-ctrlpl+rfilp-ctrlpa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 7, 6};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        ;
                                                ;
                                        static _Bool __cs_local_t0___cs_tmp_if_cond_0;
                                        __cs_local_t0___cs_tmp_if_cond_0 = __cs_local_t0_v3_W2;
                                        if (__cs_local_t0___cs_tmp_if_cond_0)
                                                {
                                        goto lbl_LC00_t0_0;
                                                        ;
                                                }
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        vars[1] = 1;
                                        static int __cs_local_t0_v6_W5;
tt0_0_4: IF(1,4,tt0_0_5)
                                        __cs_local_t0_v6_W5 = vars[1];
                                        static int __cs_local_t0_v26;
                                        __cs_local_t0_v26 = __cs_local_t0_v6_W5 == 2;
tt0_0_5: IF(1,5,tt0_0_6)
                                        v_0_X5_2 = __cs_local_t0_v26;
                                        static int __cs_local_t0_v27;
                                        __cs_local_t0_v27 = __cs_local_t0_v3_W2 == 1;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X2_1 = __cs_local_t0_v27;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v9_W2 = vars[1];
                                        ;
                                                ;
                                        static _Bool __cs_local_t1___cs_tmp_if_cond_1;
                                        __cs_local_t1___cs_tmp_if_cond_1 = __cs_local_t1_v9_W2;
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        ...
                                        __cs_local_t1_v28 = __cs_local_t1_v9_W2 == 2;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X2_2 = __cs_local_t1_v28;
                                        static int __cs_local_t1_v29;
                                        __cs_local_t1_v29 = __cs_local_t1_v12_W3 == 0;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X3_0 = __cs_local_t1_v29;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_9: IF(0,9,tmain_10)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_2 = __cs_local_main_v25_conj == 1;
