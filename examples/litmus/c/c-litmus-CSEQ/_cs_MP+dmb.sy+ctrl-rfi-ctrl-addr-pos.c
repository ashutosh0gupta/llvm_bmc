 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+ctrl-rfi-ctrl-addr-pos.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {11, 3, 11};
...
tt1_0_9: IF(2,9,tt1_0_10)
                                        ...
                                        __cs_local_t1_v36 = __cs_local_t1_v16_W10 == 0;
tt1_0_10: IF(2,10,tt1_0_11)
                                        v_1_X10_0 = __cs_local_t1_v36;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
