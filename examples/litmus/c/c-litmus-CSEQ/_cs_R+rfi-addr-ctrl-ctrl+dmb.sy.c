 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+rfi-addr-ctrl-ctrl+dmb.sy.c, 
 *
 */
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t0_v10_W6;
tt0_0_4: IF(1,4,tt0_0_5)
                                        __cs_local_t0_v10_W6 = vars[2];
                                        ;
                                                ;
                                        static _Bool __cs_local_t0___cs_tmp_if_cond_1;
                                        __cs_local_t0___cs_tmp_if_cond_1 = __cs_local_t0_v10_W6;
                                        if (__cs_local_t0___cs_tmp_if_cond_1)
                                                {
                                        goto lbl_LC01_t0_0;
                                                        ;
                                                }
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v24 = __cs_local_t1_v13_W2 == 0;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X2_0 = __cs_local_t1_v24;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_7: IF(0,7,tmain_8)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_2 = __cs_local_main_v22_conj == 1;
