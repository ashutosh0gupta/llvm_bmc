 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+addr-wsi-rfi-addr-ctrlisb.c, 
 *
 */
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        __cs_local_t1_v11_W8 = vars[3 + __cs_local_t1_v8_W7];
                                        ;
                                                ;
