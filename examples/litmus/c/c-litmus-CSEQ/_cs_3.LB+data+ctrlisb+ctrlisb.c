 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/3.LB+data+ctrlisb+ctrlisb.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 4, 4, 4};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        static int __cs_local_t0_v17;
                                        __cs_local_t0_v17 = __cs_local_t0_v3_W0 == 1;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X0_1 = __cs_local_t0_v17;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v18 = __cs_local_t1_v8_W0 == 1;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_1 = __cs_local_t1_v18;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
IF(3,0,tt2_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t2_v11_W0;
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v11_W0 = vars[2];
                                        ;
                                                ;
                                        static _Bool __cs_local_t2___cs_tmp_if_cond_1;
                                        __cs_local_t2___cs_tmp_if_cond_1 = __cs_local_t2_v11_W0;
                                        if (__cs_local_t2___cs_tmp_if_cond_1)
                                                {
                                        goto lbl_LC01_t2_0;
                                                        ;
                                                }
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        vars[0] = 1;
                                        static int __cs_local_t2_v19;
                                        __cs_local_t2_v19 = __cs_local_t2_v11_W0 == 1;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X0_1 = __cs_local_t2_v19;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tmain_8: IF(0,8,tmain_9)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_2 = __cs_local_main_v16_conj == 1;
