 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/3.LB+ctrlonceonce+poacquirerelease+ctrlonceonce.c, 
 *
 */
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        static int __cs_local_t2_v11_cmpeq;
                                        __cs_local_t2_v11_cmpeq = __cs_local_t2_v10_W0 == 0;
                                        ;
                                                ;
                                        static _Bool __cs_local_t2___cs_tmp_if_cond_1;
                                        __cs_local_t2___cs_tmp_if_cond_1 = __cs_local_t2_v11_cmpeq;
                                        if (__cs_local_t2___cs_tmp_if_cond_1)
                                                {
                                        goto lbl_label115_t2_0;
                                                        ;
                                                }
                                                else
                                                {
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        ...
                                        __cs_local_t2_v19 = __cs_local_t2_v10_W0 == 1;
