 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB+data+pos-addr-ctrl.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 4, 7};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v12_W3 = __cs_local_t1_v11_W2 ^ __cs_local_t1_v11_W2;
                                        static int __cs_local_t1_v15_W4;
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v15_W4 = vars[2 + __cs_local_t1_v12_W3];
                                        ;
                                                ;
                                        static _Bool __cs_local_t1___cs_tmp_if_cond_0;
                                        __cs_local_t1___cs_tmp_if_cond_0 = __cs_local_t1_v15_W4;
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v29 = __cs_local_t1_v11_W2 == 1;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X2_1 = __cs_local_t1_v29;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
