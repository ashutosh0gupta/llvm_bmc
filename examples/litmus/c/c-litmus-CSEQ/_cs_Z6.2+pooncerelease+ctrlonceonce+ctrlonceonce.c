 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Z6.2+pooncerelease+ctrlonceonce+ctrlonceonce.c, 
 *
 */
