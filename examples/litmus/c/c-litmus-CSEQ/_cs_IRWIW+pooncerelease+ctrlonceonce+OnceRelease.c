 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/IRWIW+pooncerelease+ctrlonceonce+OnceRelease.c, 
 *
 */
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[1] = 1;
                                        static int __cs_local_t1_v17;
                                        __cs_local_t1_v17 = __cs_local_t1_v3_W0 == 2;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_2 = __cs_local_t1_v17;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
IF(4,0,tt3_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t3_v6_W0;
tt3_0_1: IF(4,1,tt3_0_2)
                                        __cs_local_t3_v6_W0 = vars[1];
                                        static int __cs_local_t3_v7_cmpeq;
                                        __cs_local_t3_v7_cmpeq = __cs_local_t3_v6_W0 == 0;
                                        ;
                                                ;
                                        static _Bool __cs_local_t3___cs_tmp_if_cond_0;
                                        __cs_local_t3___cs_tmp_if_cond_0 = __cs_local_t3_v7_cmpeq;
                                        if (__cs_local_t3___cs_tmp_if_cond_0)
                                                {
                                        goto lbl_label218_t3_0;
                                                        ;
                                                }
                                                else
                                                {
...
tt3_0_2: IF(4,2,tt3_0_3)
                                        vars[0] = 1;
                                        static int __cs_local_t3_v18;
                                        __cs_local_t3_v18 = __cs_local_t3_v6_W0 == 2;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X0_2 = __cs_local_t3_v18;
                                        goto __exit_t3;
                                                ;
                                        __exit_t3:
...
tmain_11: IF(0,11,tmain_12)
                                        __cs_local_main_v13 = v_3_X0_2;
                                        static int __cs_local_main_v14_conj;
                                        __cs_local_main_v14_conj = __cs_local_main_v12 & __cs_local_main_v13;
                                        static int __cs_local_main_v15_conj;
                                        __cs_local_main_v15_conj = __cs_local_main_v11 & __cs_local_main_v14_conj;
                                        static int __cs_local_main_v16_conj;
                                        __cs_local_main_v16_conj = __cs_local_main_v9 & __cs_local_main_v15_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_1;
                                        __cs_local_main___cs_tmp_if_cond_1 = __cs_local_main_v16_conj == 1;
