 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/SB+fencembonceonce+poreleaseonce.c, 
 *
 */
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        __cs_local_t0_v10 = __cs_local_t0_v3_W1 == 0;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X1_0 = __cs_local_t0_v10;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v6_W1 = vars[1];
                                        static int __cs_local_t1_v11;
                                        __cs_local_t1_v11 = __cs_local_t1_v6_W1 == 0;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X1_0 = __cs_local_t1_v11;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_4: IF(0,4,tmain_5)
                                        __cs_local_main_v7 = v_0_X1_0;
                                        static int __cs_local_main_v8;
tmain_5: IF(0,5,tmain_6)
                                        __cs_local_main_v8 = v_1_X1_0;
