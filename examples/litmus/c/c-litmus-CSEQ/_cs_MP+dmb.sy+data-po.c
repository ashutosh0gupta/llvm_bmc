 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+data-po.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {6, 3, 6};
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        ...
                                        __cs_local_t1_v12 = __cs_local_t1_v3_W0 == 1;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X0_1 = __cs_local_t1_v12;
                                        static int __cs_local_t1_v13;
                                        __cs_local_t1_v13 = __cs_local_t1_v8_W4 == 0;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X4_0 = __cs_local_t1_v13;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
