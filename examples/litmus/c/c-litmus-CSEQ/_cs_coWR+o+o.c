 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/coWR+o+o.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {6, 4, 2};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        __cs_local_t0_v8 = __cs_local_t0_v3_W1 == 2;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X1_2 = __cs_local_t0_v8;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
