 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+poreleaserelease+fencembonceonce.c, 
 *
 */
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v3_W1 = vars[1];
                                        static int __cs_local_t1_v8;
                                        __cs_local_t1_v8 = __cs_local_t1_v3_W1 == 0;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X1_0 = __cs_local_t1_v8;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_5: IF(0,5,tmain_6)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_0 = __cs_local_main_v7_conj == 1;
