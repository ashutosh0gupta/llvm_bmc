 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+pos-ctrlisb-[fr-rf]-pos-ctrl.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {15, 3, 13, 2};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1___cs_tmp_if_cond_0 = __cs_local_t1_v6_W2;
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v9_W3;
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v9_W3 = vars[2];
                                        static int __cs_local_t1_v12_W5;
tt1_0_4: IF(2,4,tt1_0_5)
                                        __cs_local_t1_v12_W5 = vars[2];
                                        static int __cs_local_t1_v15_W6;
tt1_0_5: IF(2,5,tt1_0_6)
                                        __cs_local_t1_v15_W6 = vars[2];
                                        ;
                                                ;
                                        static _Bool __cs_local_t1___cs_tmp_if_cond_1;
                                        __cs_local_t1___cs_tmp_if_cond_1 = __cs_local_t1_v15_W6;
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v18_W7;
tt1_0_6: IF(2,6,tt1_0_7)
                                        __cs_local_t1_v18_W7 = vars[0];
...
tmain_14: IF(0,14,tmain_15)
                                        ...
                                        __cs_local_main_v36_conj = __cs_local_main_v24 & __cs_local_main_v35_conj;
                                        static int __cs_local_main_v37_conj;
                                        __cs_local_main_v37_conj = __cs_local_main_v22 & __cs_local_main_v36_conj;
                                        static int __cs_local_main_v38_conj;
                                        __cs_local_main_v38_conj = __cs_local_main_v20 & __cs_local_main_v37_conj;
                                        ;
                                                ;
