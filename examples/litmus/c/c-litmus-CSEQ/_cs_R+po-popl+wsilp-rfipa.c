 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+po-popl+wsilp-rfipa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 6, 7};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v22 = __cs_local_t1_v12_W4 == 4;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X4_4 = __cs_local_t1_v22;
                                        static int __cs_local_t1_v23;
                                        __cs_local_t1_v23 = __cs_local_t1_v9_W3 == 3;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X3_3 = __cs_local_t1_v23;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
