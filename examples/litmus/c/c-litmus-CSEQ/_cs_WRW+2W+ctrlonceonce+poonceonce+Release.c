 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/WRW+2W+ctrlonceonce+poonceonce+Release.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 2, 4, 3};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[1] = 1;
                                        static int __cs_local_t1_v12;
                                        __cs_local_t1_v12 = __cs_local_t1_v3_W0 == 2;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_2 = __cs_local_t1_v12;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_5: IF(0,5,tmain_6)
                                        ...
                                        static int __cs_local_main_v5;
tmain_6: IF(0,6,tmain_7)
                                        __cs_local_main_v5 = vars[0];
                                        static int __cs_local_main_v6;
                                        __cs_local_main_v6 = __cs_local_main_v5 == 2;
...
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v9 = v_1_X0_2;
                                        static int __cs_local_main_v10_conj;
                                        __cs_local_main_v10_conj = __cs_local_main_v8 & __cs_local_main_v9;
                                        static int __cs_local_main_v11_conj;
                                        __cs_local_main_v11_conj = __cs_local_main_v6 & __cs_local_main_v10_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_1;
                                        __cs_local_main___cs_tmp_if_cond_1 = __cs_local_main_v11_conj == 1;
