 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/IRWIW+poacquirerelease+ctrlonceonce+ReleaseRelease.c, 
 *
 */
