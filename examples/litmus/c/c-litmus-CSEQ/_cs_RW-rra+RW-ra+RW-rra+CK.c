 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/RW-rra+RW-ra+RW-rra+CK.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {12, 4, 4, 5, 3};
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v12_W2 = vars[3];
                                        static int __cs_local_t2_v21;
                                        __cs_local_t2_v21 = __cs_local_t2_v9_W0 == 1;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X0_1 = __cs_local_t2_v21;
                                        static int __cs_local_t2_v23;
                                        __cs_local_t2_v23 = __cs_local_t2_v12_W2 == 0;
tt2_0_4: IF(3,4,tt2_0_5)
                                        v_2_X2_0 = __cs_local_t2_v23;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tmain_10: IF(0,10,tmain_11)
                                        __cs_local_main_v15 = v_0_X0_1;
                                        static int __cs_local_main_v16;
tmain_11: IF(0,11,tmain_12)
                                        __cs_local_main_v16 = v_2_X2_0;
