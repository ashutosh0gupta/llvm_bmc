 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+data-wsi-[ws-rf]-addr.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {10, 3, 9, 2};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v9_W6 = __cs_local_t1_v8_W5 & 128;
...
tt1_0_6: IF(2,6,tt1_0_7)
                                        ...
                                        __cs_local_t1_v22 = __cs_local_t1_v8_W5 == 3;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X5_3 = __cs_local_t1_v22;
                                        static int __cs_local_t1_v23;
                                        __cs_local_t1_v23 = __cs_local_t1_v12_W7 == 0;
