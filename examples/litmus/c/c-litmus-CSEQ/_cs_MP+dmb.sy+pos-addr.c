 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+pos-addr.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 3, 7};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v23 = __cs_local_t1_v6_W2 == 1;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X2_1 = __cs_local_t1_v23;
