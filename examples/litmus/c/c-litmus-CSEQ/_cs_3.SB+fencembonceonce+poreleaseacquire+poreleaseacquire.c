 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/3.SB+fencembonceonce+poreleaseacquire+poreleaseacquire.c, 
 *
 */
...
tt0_0_1: IF(1,1,tt0_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t0_v3_W1;
tt0_0_2: IF(1,2,tt0_0_3)
                                        __cs_local_t0_v3_W1 = vars[0];
                                        static int __cs_local_t0_v15;
                                        __cs_local_t0_v15 = __cs_local_t0_v3_W1 == 0;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X1_0 = __cs_local_t0_v15;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v6_W1;
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v6_W1 = vars[2];
                                        static int __cs_local_t1_v16;
                                        __cs_local_t1_v16 = __cs_local_t1_v6_W1 == 0;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X1_0 = __cs_local_t1_v16;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t2_v9_W1;
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v9_W1 = vars[1];
                                        static int __cs_local_t2_v17;
                                        __cs_local_t2_v17 = __cs_local_t2_v9_W1 == 0;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X1_0 = __cs_local_t2_v17;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
