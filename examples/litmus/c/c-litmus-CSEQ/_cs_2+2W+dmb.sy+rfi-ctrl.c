 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/2+2W+dmb.sy+rfi-ctrl.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {7, 3, 5};
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        vars[0] = 1;
                                        static int __cs_local_t1_v11;
                                        __cs_local_t1_v11 = __cs_local_t1_v3_W2 == 2;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X2_2 = __cs_local_t1_v11;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_4: IF(0,4,tmain_5)
                                        __cs_local_main_v4 = vars[0];
                                        static int __cs_local_main_v5;
                                        __cs_local_main_v5 = __cs_local_main_v4 == 2;
                                        static int __cs_local_main_v6;
tmain_5: IF(0,5,tmain_6)
                                        __cs_local_main_v6 = vars[1];
                                        static int __cs_local_main_v7;
                                        __cs_local_main_v7 = __cs_local_main_v6 == 2;
                                        static int __cs_local_main_v8;
tmain_6: IF(0,6,tmain_7)
                                        __cs_local_main_v8 = v_1_X2_2;
                                        static int __cs_local_main_v9_conj;
                                        __cs_local_main_v9_conj = __cs_local_main_v7 & __cs_local_main_v8;
                                        static int __cs_local_main_v10_conj;
                                        __cs_local_main_v10_conj = __cs_local_main_v5 & __cs_local_main_v9_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_1;
                                        __cs_local_main___cs_tmp_if_cond_1 = __cs_local_main_v10_conj == 1;
