 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LISA-cpord-obs-failure.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[7] = {19, 7, 4, 4, 3, 3, 3};
...
tt0_0_1: IF(1,1,tt0_0_2)
                                        __cs_local_t0_v3_W0 = vars[3];
tt0_0_2: IF(1,2,tt0_0_3)
                                        vars[2] = __cs_local_t0_v3_W0;
                                        static int __cs_local_t0_v6_W3;
tt0_0_3: IF(1,3,tt0_0_4)
                                        __cs_local_t0_v6_W3 = vars[1];
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[0] = __cs_local_t0_v6_W3;
                                        static int __cs_local_t0_v29;
                                        __cs_local_t0_v29 = __cs_local_t0_v3_W0 == 1;
tt0_0_5: IF(1,5,tt0_0_6)
                                        v_0_X0_1 = __cs_local_t0_v29;
                                        static int __cs_local_t0_v30;
                                        __cs_local_t0_v30 = __cs_local_t0_v6_W3 == 1;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X3_1 = __cs_local_t0_v30;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
IF(2,0,tt1_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t1_v9_W0;
tt1_0_1: IF(2,1,tt1_0_2)
                                        __cs_local_t1_v9_W0 = vars[2];
                                        ;
                                                ;
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[4] = 1;
                                        static int __cs_local_t1_v31;
                                        __cs_local_t1_v31 = __cs_local_t1_v9_W0 == 1;
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t2_v12_W1;
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v12_W1 = vars[5];
                                        static int __cs_local_t2_v32;
                                        __cs_local_t2_v32 = __cs_local_t2_v12_W1 == 0;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X1_0 = __cs_local_t2_v32;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tmain_18: IF(0,18,tmain_19)
                                        __cs_local_main_v21 = vars[6];
                                        static int __cs_local_main_v22;
                                        __cs_local_main_v22 = __cs_local_main_v21 == 2;
                                        static int __cs_local_main_v23_conj;
                                        __cs_local_main_v23_conj = __cs_local_main_v20 & __cs_local_main_v22;
                                        static int __cs_local_main_v24_conj;
                                        __cs_local_main_v24_conj = __cs_local_main_v18 & __cs_local_main_v23_conj;
                                        static int __cs_local_main_v25_conj;
                                        __cs_local_main_v25_conj = __cs_local_main_v17 & __cs_local_main_v24_conj;
                                        static int __cs_local_main_v26_conj;
                                        __cs_local_main_v26_conj = __cs_local_main_v15 & __cs_local_main_v25_conj;
                                        static int __cs_local_main_v27_conj;
                                        __cs_local_main_v27_conj = __cs_local_main_v14 & __cs_local_main_v26_conj;
                                        static int __cs_local_main_v28_conj;
                                        __cs_local_main_v28_conj = __cs_local_main_v13 & __cs_local_main_v27_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_0;
                                        __cs_local_main___cs_tmp_if_cond_0 = __cs_local_main_v28_conj == 1;
