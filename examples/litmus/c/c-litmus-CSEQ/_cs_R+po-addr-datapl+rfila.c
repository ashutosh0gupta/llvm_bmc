 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+po-addr-datapl+rfila.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 7, 6};
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        __cs_local_t0_v7_W5 = vars[2 + __cs_local_t0_v4_W4];
                                        static int __cs_local_t0_v8_W7;
                                        __cs_local_t0_v8_W7 = __cs_local_t0_v7_W5 ^ __cs_local_t0_v7_W5;
                                        static int __cs_local_t0_v9_W7;
                                        __cs_local_t0_v9_W7 = __cs_local_t0_v8_W7 + 1;
                                        ;
                                                ;
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[0] = __cs_local_t0_v9_W7;
                                        static int __cs_local_t0_v12_W8;
tt0_0_5: IF(1,5,tt0_0_6)
                                        __cs_local_t0_v12_W8 = vars[0];
                                        static int __cs_local_t0_v27;
                                        __cs_local_t0_v27 = __cs_local_t0_v12_W8 == 2;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X8_2 = __cs_local_t0_v27;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v15_W2 = vars[0];
                                        static int __cs_local_t1_v18_W3;
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v18_W3 = vars[0];
                                        static int __cs_local_t1_v28;
                                        __cs_local_t1_v28 = __cs_local_t1_v18_W3 == 3;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X3_3 = __cs_local_t1_v28;
                                        static int __cs_local_t1_v29;
                                        __cs_local_t1_v29 = __cs_local_t1_v15_W2 == 2;
