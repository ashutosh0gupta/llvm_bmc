 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB+dataonceonce+dataoncerelease-wsireleaseonce-rfionceonce-frionceonce.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 4, 8};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        vars[0] = __cs_local_t0_v5_W2;
                                        static int __cs_local_t0_v22;
                                        __cs_local_t0_v22 = __cs_local_t0_v3_W0 == 3;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X0_3 = __cs_local_t0_v22;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tmain_4: IF(0,4,tmain_5)
                                        ...
                                        __cs_local_main_v15 = __cs_local_main_v14 == 3;
                                        static int __cs_local_main_v16;
tmain_5: IF(0,5,tmain_6)
                                        __cs_local_main_v16 = v_0_X0_3;
