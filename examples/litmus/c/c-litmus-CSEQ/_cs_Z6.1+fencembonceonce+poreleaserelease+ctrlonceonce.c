 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Z6.1+fencembonceonce+poreleaserelease+ctrlonceonce.c, 
 *
 */
