 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/W+RW+WW+RR+dmb.sy+dmb.sylp+dmb.sypa+L.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {12, 2, 4, 3, 5};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v18 = __cs_local_t1_v3_W0 == 1;
...
tt3_0_1: IF(4,1,tt3_0_2)
                                        __cs_local_t3_v6_W0 = vars[2];
                                        ;
                                                ;
                                        ;
                                                ;
                                        static int __cs_local_t3_v9_W2;
tt3_0_2: IF(4,2,tt3_0_3)
                                        __cs_local_t3_v9_W2 = vars[0];
                                        static int __cs_local_t3_v19;
                                        __cs_local_t3_v19 = __cs_local_t3_v6_W0 == 1;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X0_1 = __cs_local_t3_v19;
                                        static int __cs_local_t3_v20;
                                        __cs_local_t3_v20 = __cs_local_t3_v9_W2 == 0;
