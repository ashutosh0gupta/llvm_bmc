 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/coRW1+o+o.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[2] = {3, 4};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        vars[0] = 1;
                                        static int __cs_local_t0_v5;
                                        __cs_local_t0_v5 = __cs_local_t0_v3_W0 == 1;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X0_1 = __cs_local_t0_v5;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tmain_2: IF(0,2,tmain_3)
                                        __cs_local_main_v4 = v_0_X0_1;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_0;
                                        __cs_local_main___cs_tmp_if_cond_0 = __cs_local_main_v4 == 1;
