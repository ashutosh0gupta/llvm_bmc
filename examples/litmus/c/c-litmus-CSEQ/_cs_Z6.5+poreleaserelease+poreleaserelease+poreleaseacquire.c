 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Z6.5+poreleaserelease+poreleaserelease+poreleaseacquire.c, 
 *
 */
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t2_v3_W1;
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v3_W1 = vars[1];
                                        static int __cs_local_t2_v11;
                                        __cs_local_t2_v11 = __cs_local_t2_v3_W1 == 0;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X1_0 = __cs_local_t2_v11;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tmain_8: IF(0,8,tmain_9)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_0 = __cs_local_main_v10_conj == 1;
