 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/JSV.c, 
 *
 */
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v3_X2;
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v3_X2 = vars[0];
                                        ;
                                                ;
                                        static int __cs_local_t1_v6_X4;
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v6_X4 = vars[2];
                                        ;
                                                ;
                                        static int __cs_local_t1_v9_X6;
tt1_0_4: IF(2,4,tt1_0_5)
                                        __cs_local_t1_v9_X6 = vars[1];
                                        static int __cs_local_t1_v24;
                                        __cs_local_t1_v24 = __cs_local_t1_v3_X2 == 1;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X2_1 = __cs_local_t1_v24;
                                        static int __cs_local_t1_v25;
                                        __cs_local_t1_v25 = __cs_local_t1_v6_X4 == 1;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X4_1 = __cs_local_t1_v25;
                                        static int __cs_local_t1_v26;
                                        __cs_local_t1_v26 = __cs_local_t1_v9_X6 == 2;
...
tmain_9: IF(0,9,tmain_10)
                                        ...
                                        static int __cs_local_main_v19_disj;
                                        __cs_local_main_v19_disj = __cs_local_main_v16 | __cs_local_main_v18;
                                        static int __cs_local_main_v20_conj;
                                        __cs_local_main_v20_conj = __cs_local_main_v14 & __cs_local_main_v19_disj;
                                        ...
                                        __cs_local_main_v22_conj = __cs_local_main_v12 & __cs_local_main_v21_conj;
