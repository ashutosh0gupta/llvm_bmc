 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/WWC+fencembonceonce+ctrlonceonce+Release.c, 
 *
 */
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        static int __cs_local_t2_v7_cmpeq;
                                        __cs_local_t2_v7_cmpeq = __cs_local_t2_v6_W0 == 0;
                                        ;
                                                ;
                                        static _Bool __cs_local_t2___cs_tmp_if_cond_0;
                                        __cs_local_t2___cs_tmp_if_cond_0 = __cs_local_t2_v7_cmpeq;
                                        if (__cs_local_t2___cs_tmp_if_cond_0)
                                                {
                                        goto lbl_label201_t2_0;
                                                        ;
                                                }
                                                else
                                                {
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        ...
                                        __cs_local_t2_v15 = __cs_local_t2_v6_W0 == 1;
