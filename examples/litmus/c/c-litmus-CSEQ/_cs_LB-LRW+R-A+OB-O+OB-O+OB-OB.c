 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB-LRW+R-A+OB-O+OB-O+OB-OB.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[6] = {15, 4, 4, 4, 4, 4};
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        ...
                                        __cs_local_t2_v27 = __cs_local_t2_v9_W0 == 1;
...
tt3_0_2: IF(4,2,tt3_0_3)
                                        ...
                                        __cs_local_t3_v28 = __cs_local_t3_v12_W0 == 1;
...
tt4_0_2: IF(5,2,tt4_0_3)
                                        ...
                                        __cs_local_t4_v29 = __cs_local_t4_v15_W0 == 1;
