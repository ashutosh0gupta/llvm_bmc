 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB-LRR+R-A+OB-O+OB-O+OB-OB.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[7] = {18, 4, 4, 4, 4, 5, 2};
...
tt4_0_2: IF(5,2,tt4_0_3)
                                        __cs_local_t4_v18_W2 = vars[1];
                                        static int __cs_local_t4_v31;
                                        __cs_local_t4_v31 = __cs_local_t4_v18_W2 == 0;
tt4_0_3: IF(5,3,tt4_0_4)
                                        v_4_X2_0 = __cs_local_t4_v31;
