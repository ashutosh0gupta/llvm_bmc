 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+po-wsipl+polp-rfipa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 6, 7};
...
tt0_0_4: IF(1,4,tt0_0_5)
                                        ...
                                        __cs_local_t0_v21 = __cs_local_t0_v3_W5 == 3;
tt0_0_5: IF(1,5,tt0_0_6)
                                        v_0_X5_3 = __cs_local_t0_v21;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v22 = __cs_local_t1_v9_W5 == 2;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X5_2 = __cs_local_t1_v22;
                                        static int __cs_local_t1_v23;
                                        __cs_local_t1_v23 = __cs_local_t1_v6_W4 == 1;
