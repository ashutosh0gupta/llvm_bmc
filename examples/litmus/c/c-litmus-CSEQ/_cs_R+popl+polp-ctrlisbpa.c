 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+popl+polp-ctrlisbpa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 5, 5};
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        ...
                                        __cs_local_t0_v19 = __cs_local_t0_v3_W4 == 2;
tt0_0_4: IF(1,4,tt0_0_5)
                                        v_0_X4_2 = __cs_local_t0_v19;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
