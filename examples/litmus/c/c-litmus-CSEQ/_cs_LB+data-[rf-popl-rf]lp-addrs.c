 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB+data-[rf-popl-rf]lp-addrs.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {14, 7, 4, 7, 4};
...
tt0_0_1: IF(1,1,tt0_0_2)
                                        __cs_local_t0_v3_W0 = vars[0];
                                        static int __cs_local_t0_v4_W2;
                                        __cs_local_t0_v4_W2 = __cs_local_t0_v3_W0 ^ __cs_local_t0_v3_W0;
                                        static int __cs_local_t0_v5_W2;
                                        __cs_local_t0_v5_W2 = __cs_local_t0_v4_W2 + 1;
tt0_0_2: IF(1,2,tt0_0_3)
                                        vars[1] = __cs_local_t0_v5_W2;
                                        static int __cs_local_t0_v8_W4;
tt0_0_3: IF(1,3,tt0_0_4)
                                        __cs_local_t0_v8_W4 = vars[2];
                                        static int __cs_local_t0_v9_W6;
                                        __cs_local_t0_v9_W6 = __cs_local_t0_v8_W4 ^ __cs_local_t0_v8_W4;
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[3 + __cs_local_t0_v9_W6] = 1;
                                        static int __cs_local_t0_v36;
                                        __cs_local_t0_v36 = __cs_local_t0_v3_W0 == 1;
tt0_0_5: IF(1,5,tt0_0_6)
                                        v_0_X0_1 = __cs_local_t0_v36;
                                        static int __cs_local_t0_v37;
                                        __cs_local_t0_v37 = __cs_local_t0_v8_W4 == 1;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X4_1 = __cs_local_t0_v37;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        __cs_local_t1_v12_W0 = vars[1];
                                        ;
                                                ;
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[2] = 1;
                                        static int __cs_local_t1_v38;
                                        __cs_local_t1_v38 = __cs_local_t1_v12_W0 == 1;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_1 = __cs_local_t1_v38;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
IF(3,0,tt2_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t2_v15_W0;
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v15_W0 = vars[3];
                                        static int __cs_local_t2_v16_W2;
                                        __cs_local_t2_v16_W2 = __cs_local_t2_v15_W0 ^ __cs_local_t2_v15_W0;
                                        static int __cs_local_t2_v17_W2;
                                        __cs_local_t2_v17_W2 = __cs_local_t2_v16_W2 + 1;
tt2_0_2: IF(3,2,tt2_0_3)
                                        vars[4] = __cs_local_t2_v17_W2;
                                        static int __cs_local_t2_v20_W4;
tt2_0_3: IF(3,3,tt2_0_4)
                                        __cs_local_t2_v20_W4 = vars[5];
                                        static int __cs_local_t2_v21_W6;
                                        __cs_local_t2_v21_W6 = __cs_local_t2_v20_W4 ^ __cs_local_t2_v20_W4;
tt2_0_4: IF(3,4,tt2_0_5)
                                        vars[0 + __cs_local_t2_v21_W6] = 1;
                                        static int __cs_local_t2_v39;
                                        __cs_local_t2_v39 = __cs_local_t2_v15_W0 == 1;
tt2_0_5: IF(3,5,tt2_0_6)
                                        v_2_X0_1 = __cs_local_t2_v39;
                                        static int __cs_local_t2_v40;
                                        __cs_local_t2_v40 = __cs_local_t2_v20_W4 == 1;
tt2_0_6: IF(3,6,tt2_0_7)
                                        v_2_X4_1 = __cs_local_t2_v40;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
IF(4,0,tt3_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t3_v24_W0;
tt3_0_1: IF(4,1,tt3_0_2)
                                        __cs_local_t3_v24_W0 = vars[4];
                                        ;
                                                ;
tt3_0_2: IF(4,2,tt3_0_3)
                                        vars[5] = 1;
                                        static int __cs_local_t3_v41;
                                        __cs_local_t3_v41 = __cs_local_t3_v24_W0 == 1;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X0_1 = __cs_local_t3_v41;
                                        goto __exit_t3;
                                                ;
                                        __exit_t3:
...
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v25 = v_0_X0_1;
                                        static int __cs_local_main_v26;
tmain_9: IF(0,9,tmain_10)
                                        __cs_local_main_v26 = v_0_X4_1;
...
tmain_11: IF(0,11,tmain_12)
                                        __cs_local_main_v28 = v_2_X0_1;
                                        static int __cs_local_main_v29;
tmain_12: IF(0,12,tmain_13)
                                        __cs_local_main_v29 = v_2_X4_1;
                                        static int __cs_local_main_v30;
tmain_13: IF(0,13,tmain_14)
                                        __cs_local_main_v30 = v_3_X0_1;
                                        static int __cs_local_main_v31_conj;
                                        __cs_local_main_v31_conj = __cs_local_main_v29 & __cs_local_main_v30;
                                        static int __cs_local_main_v32_conj;
                                        __cs_local_main_v32_conj = __cs_local_main_v28 & __cs_local_main_v31_conj;
                                        static int __cs_local_main_v33_conj;
                                        __cs_local_main_v33_conj = __cs_local_main_v27 & __cs_local_main_v32_conj;
                                        static int __cs_local_main_v34_conj;
                                        __cs_local_main_v34_conj = __cs_local_main_v26 & __cs_local_main_v33_conj;
                                        static int __cs_local_main_v35_conj;
                                        __cs_local_main_v35_conj = __cs_local_main_v25 & __cs_local_main_v34_conj;
                                        ;
                                                ;
