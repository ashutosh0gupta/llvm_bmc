 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Z6.4+poreleaserelease+poreleaseacquire+poreleaseacquire.c, 
 *
 */
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v3_W1;
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v3_W1 = vars[2];
                                        static int __cs_local_t1_v13;
                                        __cs_local_t1_v13 = __cs_local_t1_v3_W1 == 0;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X1_0 = __cs_local_t1_v13;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t2_v6_W1;
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v6_W1 = vars[1];
                                        static int __cs_local_t2_v14;
                                        __cs_local_t2_v14 = __cs_local_t2_v6_W1 == 0;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X1_0 = __cs_local_t2_v14;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tmain_7: IF(0,7,tmain_8)
                                        __cs_local_main_v9 = v_1_X1_0;
                                        static int __cs_local_main_v10;
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v10 = v_2_X1_0;
