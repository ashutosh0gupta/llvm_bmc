 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+ctrl-addr-ctrl-ctrlisb.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 3, 8};
...
tt1_0_6: IF(2,6,tt1_0_7)
                                        ...
                                        __cs_local_t1_v27 = __cs_local_t1_v16_W9 == 0;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X9_0 = __cs_local_t1_v27;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_7: IF(0,7,tmain_8)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_3 = __cs_local_main_v25_conj == 1;
