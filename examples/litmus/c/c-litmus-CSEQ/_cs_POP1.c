 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/POP1.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {11, 7, 2, 4};
...
tt0_0_5: IF(1,5,tt0_0_6)
                                        ...
                                        __cs_local_t0_v22 = __cs_local_t0_v6_W5 == 1;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X5_1 = __cs_local_t0_v22;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t2_v9_W3;
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v9_W3 = vars[0];
                                        static int __cs_local_t2_v23;
                                        __cs_local_t2_v23 = __cs_local_t2_v9_W3 == 0;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X3_0 = __cs_local_t2_v23;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
