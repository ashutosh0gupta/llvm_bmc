 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/WRR+2W+ctrlisb+dmb.sy.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 2, 5, 3};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v13 = __cs_local_t1_v3_W0 == 2;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_2 = __cs_local_t1_v13;
                                        static int __cs_local_t1_v14;
                                        __cs_local_t1_v14 = __cs_local_t1_v6_W2 == 0;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X2_0 = __cs_local_t1_v14;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
