 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+po-data-popl+pola.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 7, 4};
...
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[3] = 1;
                                        static int __cs_local_t0_v8_W8;
tt0_0_5: IF(1,5,tt0_0_6)
                                        __cs_local_t0_v8_W8 = vars[3];
                                        static int __cs_local_t0_v24;
                                        __cs_local_t0_v24 = __cs_local_t0_v8_W8 == 2;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X8_2 = __cs_local_t0_v24;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tmain_8: IF(0,8,tmain_9)
                                        ...
                                        __cs_local_main_v23_conj = __cs_local_main_v13 & __cs_local_main_v22_conj;
                                        ;
                                                ;
