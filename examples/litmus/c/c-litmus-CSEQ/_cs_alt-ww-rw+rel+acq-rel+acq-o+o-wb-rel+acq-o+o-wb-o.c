 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/alt-ww-rw+rel+acq-rel+acq-o+o-wb-rel+acq-o+o-wb-o.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[7] = {18, 2, 4, 4, 3, 4, 3};
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v6_W0 = vars[1];
tt2_0_2: IF(3,2,tt2_0_3)
                                        vars[2] = 1;
                                        static int __cs_local_t2_v25;
                                        __cs_local_t2_v25 = __cs_local_t2_v6_W0 == 1;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X0_1 = __cs_local_t2_v25;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
IF(5,0,tt4_0_1)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t4_v9_W0;
tt4_0_1: IF(5,1,tt4_0_2)
                                        __cs_local_t4_v9_W0 = vars[3];
tt4_0_2: IF(5,2,tt4_0_3)
                                        vars[4] = 1;
                                        static int __cs_local_t4_v26;
                                        __cs_local_t4_v26 = __cs_local_t4_v9_W0 == 1;
tt4_0_3: IF(5,3,tt4_0_4)
                                        v_4_X0_1 = __cs_local_t4_v26;
                                        goto __exit_t4;
                                                ;
                                        __exit_t4:
...
tmain_17: IF(0,17,tmain_18)
                                        ...
                                        __cs_local_main_v19_conj = __cs_local_main_v16 & __cs_local_main_v18;
                                        static int __cs_local_main_v20_conj;
                                        __cs_local_main_v20_conj = __cs_local_main_v14 & __cs_local_main_v19_conj;
                                        static int __cs_local_main_v21_conj;
                                        __cs_local_main_v21_conj = __cs_local_main_v13 & __cs_local_main_v20_conj;
                                        static int __cs_local_main_v22_conj;
                                        __cs_local_main_v22_conj = __cs_local_main_v11 & __cs_local_main_v21_conj;
                                        static int __cs_local_main_v23_conj;
                                        __cs_local_main_v23_conj = __cs_local_main_v10 & __cs_local_main_v22_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_0;
                                        __cs_local_main___cs_tmp_if_cond_0 = __cs_local_main_v23_conj == 1;
