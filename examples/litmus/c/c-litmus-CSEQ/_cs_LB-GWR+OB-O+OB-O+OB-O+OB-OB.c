 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB-GWR+OB-O+OB-O+OB-O+OB-OB.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[7] = {18, 3, 4, 4, 4, 5, 4};
...
tt4_0_1: IF(5,1,tt4_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t4_v15_W2;
tt4_0_2: IF(5,2,tt4_0_3)
                                        __cs_local_t4_v15_W2 = vars[5];
                                        static int __cs_local_t4_v30;
                                        __cs_local_t4_v30 = __cs_local_t4_v15_W2 == 0;
tt4_0_3: IF(5,3,tt4_0_4)
                                        v_4_X2_0 = __cs_local_t4_v30;
...
tt5_0_1: IF(6,1,tt5_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t5_v18_W1;
tt5_0_2: IF(6,2,tt5_0_3)
                                        __cs_local_t5_v18_W1 = vars[1];
                                        static int __cs_local_t5_v31;
                                        __cs_local_t5_v31 = __cs_local_t5_v18_W1 == 0;
tt5_0_3: IF(6,3,tt5_0_4)
                                        v_5_X1_0 = __cs_local_t5_v31;
                                        goto __exit_t5;
                                                ;
                                        __exit_t5:
...
tmain_12: IF(0,12,tmain_13)
                                        __cs_local_main_v19 = v_4_X2_0;
                                        static int __cs_local_main_v20;
tmain_13: IF(0,13,tmain_14)
                                        __cs_local_main_v20 = v_5_X1_0;
