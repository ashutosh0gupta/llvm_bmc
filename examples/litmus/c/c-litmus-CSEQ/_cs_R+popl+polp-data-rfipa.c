 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+popl+polp-data-rfipa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 5, 8};
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v27 = __cs_local_t1_v14_W7 == 2;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X7_2 = __cs_local_t1_v27;
                                        static int __cs_local_t1_v28;
                                        __cs_local_t1_v28 = __cs_local_t1_v11_W6 == 1;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X6_1 = __cs_local_t1_v28;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
