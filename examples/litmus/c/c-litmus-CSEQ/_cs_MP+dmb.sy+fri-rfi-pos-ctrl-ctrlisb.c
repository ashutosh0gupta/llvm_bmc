 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+fri-rfi-pos-ctrl-ctrlisb.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 3, 11};
...
tt1_0_8: IF(2,8,tt1_0_9)
                                        ...
                                        __cs_local_t1_v31 = __cs_local_t1_v9_W4 == 2;
tt1_0_9: IF(2,9,tt1_0_10)
                                        v_1_X4_2 = __cs_local_t1_v31;
                                        static int __cs_local_t1_v32;
                                        __cs_local_t1_v32 = __cs_local_t1_v15_W7 == 0;
