 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Z6.3+poll+wsilp+poaa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 5, 3, 5};
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        ...
                                        __cs_local_t0_v15 = __cs_local_t0_v3_W4 == 2;
tt0_0_4: IF(1,4,tt0_0_5)
                                        v_0_X4_2 = __cs_local_t0_v15;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        ...
                                        __cs_local_t2_v16 = __cs_local_t2_v6_W0 == 3;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X0_3 = __cs_local_t2_v16;
...
tmain_6: IF(0,6,tmain_7)
                                        __cs_local_main_v10 = v_0_X4_2;
                                        static int __cs_local_main_v11;
tmain_7: IF(0,7,tmain_8)
                                        __cs_local_main_v11 = v_2_X0_3;
