 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/WWC+ctrlonceonces+Release.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 2, 4, 4};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v15 = __cs_local_t1_v3_W0 == 2;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_2 = __cs_local_t1_v15;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
