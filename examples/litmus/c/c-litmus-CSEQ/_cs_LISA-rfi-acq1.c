 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LISA-rfi-acq1.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {6, 3, 7};
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v14 = __cs_local_t1_v9_W3 == 0;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X3_0 = __cs_local_t1_v14;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
