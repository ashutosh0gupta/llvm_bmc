 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/3.LB+dmb.sy+data+data.c, 
 *
 */
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        vars[1] = 1;
                                        static int __cs_local_t0_v19;
                                        __cs_local_t0_v19 = __cs_local_t0_v3_W0 == 1;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X0_1 = __cs_local_t0_v19;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        __cs_local_t1_v8_W2 = __cs_local_t1_v7_W2 + 1;
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[2] = __cs_local_t1_v8_W2;
                                        static int __cs_local_t1_v20;
                                        __cs_local_t1_v20 = __cs_local_t1_v6_W0 == 1;
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        __cs_local_t2_v12_W2 = __cs_local_t2_v11_W0 ^ __cs_local_t2_v11_W0;
                                        static int __cs_local_t2_v13_W2;
                                        __cs_local_t2_v13_W2 = __cs_local_t2_v12_W2 + 1;
tt2_0_2: IF(3,2,tt2_0_3)
                                        vars[0] = __cs_local_t2_v13_W2;
                                        static int __cs_local_t2_v21;
                                        __cs_local_t2_v21 = __cs_local_t2_v11_W0 == 1;
...
tmain_8: IF(0,8,tmain_9)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_0 = __cs_local_main_v18_conj == 1;
