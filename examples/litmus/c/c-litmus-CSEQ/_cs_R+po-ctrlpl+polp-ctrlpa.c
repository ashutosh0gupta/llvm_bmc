 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+po-ctrlpl+polp-ctrlpa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 6, 5};
...
tt0_0_4: IF(1,4,tt0_0_5)
                                        ...
                                        __cs_local_t0_v22 = __cs_local_t0_v6_W6 == 2;
tt0_0_5: IF(1,5,tt0_0_6)
                                        v_0_X6_2 = __cs_local_t0_v22;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        ...
                                        __cs_local_t1_v23 = __cs_local_t1_v12_W4 == 0;
