 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/SB+dmb.sy+rfi-ctrlisb.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 4, 6};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        __cs_local_t0_v21 = __cs_local_t0_v3_W2 == 0;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X2_0 = __cs_local_t0_v21;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        ...
                                        __cs_local_t1_v22 = __cs_local_t1_v6_W2 == 1;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X2_1 = __cs_local_t1_v22;
...
tmain_6: IF(0,6,tmain_7)
                                        __cs_local_main_v14 = v_0_X2_0;
                                        static int __cs_local_main_v15;
tmain_7: IF(0,7,tmain_8)
                                        __cs_local_main_v15 = v_1_X2_1;
