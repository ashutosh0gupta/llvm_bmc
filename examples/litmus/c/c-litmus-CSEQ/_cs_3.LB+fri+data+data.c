 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/3.LB+fri+data+data.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {10, 4, 4, 4};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[1] = __cs_local_t1_v8_W2;
                                        static int __cs_local_t1_v23;
                                        __cs_local_t1_v23 = __cs_local_t1_v6_W0 == 2;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_2 = __cs_local_t1_v23;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        ...
                                        __cs_local_t2_v24 = __cs_local_t2_v11_W0 == 1;
