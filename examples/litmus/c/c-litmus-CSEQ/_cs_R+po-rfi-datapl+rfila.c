 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+po-rfi-datapl+rfila.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 8, 6};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        vars[1] = 1;
                                        static int __cs_local_t0_v3_W4;
tt0_0_3: IF(1,3,tt0_0_4)
                                        __cs_local_t0_v3_W4 = vars[1];
                                        static int __cs_local_t0_v4_W5;
                                        __cs_local_t0_v4_W5 = __cs_local_t0_v3_W4 ^ __cs_local_t0_v3_W4;
                                        static int __cs_local_t0_v5_W5;
                                        __cs_local_t0_v5_W5 = __cs_local_t0_v4_W5 + 1;
                                        ;
                                                ;
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[0] = __cs_local_t0_v5_W5;
                                        static int __cs_local_t0_v8_W6;
tt0_0_5: IF(1,5,tt0_0_6)
                                        __cs_local_t0_v8_W6 = vars[0];
                                        static int __cs_local_t0_v28;
                                        __cs_local_t0_v28 = __cs_local_t0_v8_W6 == 2;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X6_2 = __cs_local_t0_v28;
                                        static int __cs_local_t0_v29;
                                        __cs_local_t0_v29 = __cs_local_t0_v3_W4 == 1;
tt0_0_7: IF(1,7,tt0_0_8)
                                        v_0_X4_1 = __cs_local_t0_v29;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tmain_4: IF(0,4,tmain_5)
                                        ...
                                        __cs_local_main_v16 = __cs_local_main_v15 == 3;
...
tmain_9: IF(0,9,tmain_10)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_0 = __cs_local_main_v27_conj == 1;
