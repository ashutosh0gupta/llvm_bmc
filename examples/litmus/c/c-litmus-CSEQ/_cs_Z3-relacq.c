 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Z3-relacq.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 5, 3, 3};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        __cs_local_t0_v7_W3 = vars[0 + __cs_local_t0_v4_W2];
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        ...
                                        __cs_local_t0_v15 = __cs_local_t0_v7_W3 == 0;
tt0_0_4: IF(1,4,tt0_0_5)
                                        v_0_X3_0 = __cs_local_t0_v15;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
