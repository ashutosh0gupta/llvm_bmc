 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/ALAN1.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {11, 8, 6, 4};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t0_v6_W2;
tt0_0_3: IF(1,3,tt0_0_4)
                                        __cs_local_t0_v6_W2 = vars[2];
                                        static int __cs_local_t0_v9_W4;
tt0_0_4: IF(1,4,tt0_0_5)
                                        __cs_local_t0_v9_W4 = vars[3];
...
tt0_0_5: IF(1,5,tt0_0_6)
                                        ...
                                        __cs_local_t0_v26 = __cs_local_t0_v6_W2 == 1;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X2_1 = __cs_local_t0_v26;
                                        static int __cs_local_t0_v27;
                                        __cs_local_t0_v27 = __cs_local_t0_v9_W4 == 0;
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v12_W2 = vars[1];
tt1_0_4: IF(2,4,tt1_0_5)
                                        vars[4] = __cs_local_t1_v12_W2;
                                        static int __cs_local_t1_v28;
                                        __cs_local_t1_v28 = __cs_local_t1_v12_W2 == 1;
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        __cs_local_t2_v15_W0 = vars[4];
                                        ;
                                                ;
tt2_0_2: IF(3,2,tt2_0_3)
                                        vars[2] = 1;
                                        static int __cs_local_t2_v29;
                                        __cs_local_t2_v29 = __cs_local_t2_v15_W0 == 1;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X0_1 = __cs_local_t2_v29;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
