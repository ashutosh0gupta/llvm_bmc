 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+ctrl-pos-fri-rfi-pos.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {11, 3, 12};
...
tt1_0_7: IF(2,7,tt1_0_8)
                                        ...
                                        __cs_local_t1_v32 = __cs_local_t1_v6_W2 == 0;
tt1_0_8: IF(2,8,tt1_0_9)
                                        v_1_X2_0 = __cs_local_t1_v32;
