 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+fencewmbonceonce+addronceonce-[fronceonce-rf]onceonce.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {10, 3, 7, 2};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v20 = __cs_local_t1_v7_W3 == 0;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X3_0 = __cs_local_t1_v20;
                                        static int __cs_local_t1_v21;
                                        __cs_local_t1_v21 = __cs_local_t1_v10_W5 == 1;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X5_1 = __cs_local_t1_v21;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v14 = v_1_X3_0;
                                        static int __cs_local_main_v15;
tmain_9: IF(0,9,tmain_10)
                                        __cs_local_main_v15 = v_1_X5_1;
