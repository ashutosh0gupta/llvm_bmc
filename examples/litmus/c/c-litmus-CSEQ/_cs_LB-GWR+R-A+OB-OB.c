 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB-GWR+R-A+OB-OB.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {12, 3, 4, 5, 4};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v22 = __cs_local_t1_v3_W0 == 1;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_1 = __cs_local_t1_v22;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v9_W2 = vars[3];
                                        static int __cs_local_t2_v20;
                                        __cs_local_t2_v20 = __cs_local_t2_v9_W2 == 0;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X2_0 = __cs_local_t2_v20;
                                        static int __cs_local_t2_v23;
                                        __cs_local_t2_v23 = __cs_local_t2_v6_W0 == 1;
tt2_0_4: IF(3,4,tt2_0_5)
                                        v_2_X0_1 = __cs_local_t2_v23;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tt3_0_1: IF(4,1,tt3_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t3_v12_W1;
tt3_0_2: IF(4,2,tt3_0_3)
                                        __cs_local_t3_v12_W1 = vars[1];
                                        static int __cs_local_t3_v21;
                                        __cs_local_t3_v21 = __cs_local_t3_v12_W1 == 0;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X1_0 = __cs_local_t3_v21;
                                        goto __exit_t3;
                                                ;
                                        __exit_t3:
...
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v13 = v_2_X2_0;
                                        static int __cs_local_main_v14;
tmain_9: IF(0,9,tmain_10)
                                        __cs_local_main_v14 = v_3_X1_0;
