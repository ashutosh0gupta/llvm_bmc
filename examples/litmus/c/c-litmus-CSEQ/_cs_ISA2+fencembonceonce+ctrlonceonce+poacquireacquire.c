 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/ISA2+fencembonceonce+ctrlonceonce+poacquireacquire.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 3, 4, 5};
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v16 = __cs_local_t1_v3_W0 == 1;
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t2_v10_W2;
tt2_0_2: IF(3,2,tt2_0_3)
                                        __cs_local_t2_v10_W2 = vars[1];
                                        static int __cs_local_t2_v17;
                                        __cs_local_t2_v17 = __cs_local_t2_v7_W0 == 1;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X0_1 = __cs_local_t2_v17;
                                        static int __cs_local_t2_v18;
                                        __cs_local_t2_v18 = __cs_local_t2_v10_W2 == 0;
tt2_0_4: IF(3,4,tt2_0_5)
                                        v_2_X2_0 = __cs_local_t2_v18;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
...
tmain_8: IF(0,8,tmain_9)
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_1 = __cs_local_main_v15_conj == 1;
