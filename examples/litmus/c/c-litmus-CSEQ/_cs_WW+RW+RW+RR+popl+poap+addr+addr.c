 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/WW+RW+RW+RR+popl+poap+addr+addr.c, 
 *
 */
...
IF(4,0,tt3_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t3_v10_W0;
tt3_0_1: IF(4,1,tt3_0_2)
                                        __cs_local_t3_v10_W0 = vars[3];
                                        static int __cs_local_t3_v11_W2;
                                        __cs_local_t3_v11_W2 = __cs_local_t3_v10_W0 ^ __cs_local_t3_v10_W0;
                                        static int __cs_local_t3_v14_W3;
tt3_0_2: IF(4,2,tt3_0_3)
                                        __cs_local_t3_v14_W3 = vars[0 + __cs_local_t3_v11_W2];
                                        static int __cs_local_t3_v24;
                                        __cs_local_t3_v24 = __cs_local_t3_v10_W0 == 1;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X0_1 = __cs_local_t3_v24;
                                        static int __cs_local_t3_v25;
                                        __cs_local_t3_v25 = __cs_local_t3_v14_W3 == 0;
tt3_0_4: IF(4,4,tt3_0_5)
                                        v_3_X3_0 = __cs_local_t3_v25;
                                        goto __exit_t3;
                                                ;
                                        __exit_t3:
