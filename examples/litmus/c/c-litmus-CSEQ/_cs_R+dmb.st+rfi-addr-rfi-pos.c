 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+dmb.st+rfi-addr-rfi-pos.c, 
 *
 */
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        vars[0 + __cs_local_t1_v4_W3] = 1;
                                        static int __cs_local_t1_v7_W6;
tt1_0_4: IF(2,4,tt1_0_5)
                                        __cs_local_t1_v7_W6 = vars[0];
