 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Z6.1+poreleaserelease+poreleaserelease+ctrlonceonce.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {9, 3, 3, 4};
...
tt2_0_1: IF(3,1,tt2_0_2)
                                        ...
                                        static int __cs_local_t2_v4_cmpeq;
                                        __cs_local_t2_v4_cmpeq = __cs_local_t2_v3_W0 == 0;
                                        ;
                                                ;
                                        static _Bool __cs_local_t2___cs_tmp_if_cond_0;
                                        __cs_local_t2___cs_tmp_if_cond_0 = __cs_local_t2_v4_cmpeq;
                                        if (__cs_local_t2___cs_tmp_if_cond_0)
                                                {
                                        goto lbl_label176_t2_0;
                                                        ;
                                                }
                                                else
                                                {
...
tt2_0_2: IF(3,2,tt2_0_3)
                                        vars[1] = 1;
                                        static int __cs_local_t2_v12;
                                        __cs_local_t2_v12 = __cs_local_t2_v3_W0 == 1;
tt2_0_3: IF(3,3,tt2_0_4)
                                        v_2_X0_1 = __cs_local_t2_v12;
                                        goto __exit_t2;
                                                ;
                                        __exit_t2:
