 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB+data+ctrl-data.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 4, 5};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        __cs_local_t0_v23 = __cs_local_t0_v3_W0 == 1;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X0_1 = __cs_local_t0_v23;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
