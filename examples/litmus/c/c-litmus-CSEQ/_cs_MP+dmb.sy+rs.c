 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+rs.c, 
 *
 */
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        static int __cs_local_t1_v4_W4;
                                        __cs_local_t1_v4_W4 = __cs_local_t1_v3_W0 + 0;
                                        static int __cs_local_t1_v7_W0;
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v7_W0 = vars[0];
                                        static int __cs_local_t1_v11;
                                        __cs_local_t1_v11 = __cs_local_t1_v4_W4 == 1;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X4_1 = __cs_local_t1_v11;
                                        static int __cs_local_t1_v12;
                                        __cs_local_t1_v12 = __cs_local_t1_v7_W0 == 0;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X0_0 = __cs_local_t1_v12;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_4: IF(0,4,tmain_5)
                                        __cs_local_main_v8 = v_1_X4_1;
                                        static int __cs_local_main_v9;
tmain_5: IF(0,5,tmain_6)
                                        __cs_local_main_v9 = v_1_X0_0;
