 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+po-rfi-datapl+pola.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 8, 4};
...
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[2] = __cs_local_t0_v5_W5;
                                        static int __cs_local_t0_v8_W7;
tt0_0_5: IF(1,5,tt0_0_6)
                                        __cs_local_t0_v8_W7 = vars[2];
                                        static int __cs_local_t0_v26;
                                        __cs_local_t0_v26 = __cs_local_t0_v8_W7 == 2;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X7_2 = __cs_local_t0_v26;
                                        static int __cs_local_t0_v27;
                                        __cs_local_t0_v27 = __cs_local_t0_v3_W4 == 1;
tt0_0_7: IF(1,7,tt0_0_8)
                                        v_0_X4_1 = __cs_local_t0_v27;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v28 = __cs_local_t1_v11_W2 == 0;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X2_0 = __cs_local_t1_v28;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_7: IF(0,7,tmain_8)
                                        __cs_local_main_v18 = v_0_X7_2;
                                        static int __cs_local_main_v19;
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v19 = v_0_X4_1;
