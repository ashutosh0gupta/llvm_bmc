 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/2+2w+wmbs+OBS.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {6, 5, 5};
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        ...
                                        __cs_local_t0_v10 = __cs_local_t0_v3_W2 == 2;
tt0_0_4: IF(1,4,tt0_0_5)
                                        v_0_X2_2 = __cs_local_t0_v10;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        ...
                                        __cs_local_t1_v11 = __cs_local_t1_v6_W2 == 2;
