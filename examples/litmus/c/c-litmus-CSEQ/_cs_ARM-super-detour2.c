 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/ARM-super-detour2.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[5] __cs_thread_lines[6] = {16, 7, 5, 3, 5, 3};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        vars[1] = __cs_local_t0_v3_W0;
                                        static int __cs_local_t0_v6_W4;
tt0_0_3: IF(1,3,tt0_0_4)
                                        __cs_local_t0_v6_W4 = vars[2];
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[3] = __cs_local_t0_v6_W4;
                                        static int __cs_local_t0_v30;
                                        __cs_local_t0_v30 = __cs_local_t0_v3_W0 == 1;
tt0_0_5: IF(1,5,tt0_0_6)
                                        v_0_X0_1 = __cs_local_t0_v30;
                                        static int __cs_local_t0_v31;
                                        __cs_local_t0_v31 = __cs_local_t0_v6_W4 == 1;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X4_1 = __cs_local_t0_v31;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        __cs_local_t1_v9_W0 = vars[1];
                                        static int __cs_local_t1_v12_W2;
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v12_W2 = vars[4];
                                        static int __cs_local_t1_v32;
                                        __cs_local_t1_v32 = __cs_local_t1_v9_W0 == 1;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_1 = __cs_local_t1_v32;
                                        static int __cs_local_t1_v33;
                                        __cs_local_t1_v33 = __cs_local_t1_v12_W2 == 0;
...
IF(4,0,tt3_0_1)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t3_v15_W0;
tt3_0_1: IF(4,1,tt3_0_2)
                                        __cs_local_t3_v15_W0 = vars[3];
                                        static int __cs_local_t3_v18_W2;
tt3_0_2: IF(4,2,tt3_0_3)
                                        __cs_local_t3_v18_W2 = vars[5];
                                        static int __cs_local_t3_v34;
                                        __cs_local_t3_v34 = __cs_local_t3_v15_W0 == 1;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X0_1 = __cs_local_t3_v34;
                                        static int __cs_local_t3_v35;
                                        __cs_local_t3_v35 = __cs_local_t3_v18_W2 == 0;
tt3_0_4: IF(4,4,tt3_0_5)
                                        v_3_X2_0 = __cs_local_t3_v35;
                                        goto __exit_t3;
                                                ;
                                        __exit_t3:
