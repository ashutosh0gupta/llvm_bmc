 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/ARM-bigdetour-failure.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {13, 3, 9, 2, 4};
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        __cs_local_t1_v4_W2 = __cs_local_t1_v3_W0 & 128;
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        ...
                                        __cs_local_t1_v11_W7 = __cs_local_t1_v10_W5 & 128;
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v28 = __cs_local_t1_v7_W3 == 0;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X3_0 = __cs_local_t1_v28;
                                        static int __cs_local_t1_v29;
                                        __cs_local_t1_v29 = __cs_local_t1_v10_W5 == 1;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X5_1 = __cs_local_t1_v29;
                                        static int __cs_local_t1_v30;
                                        __cs_local_t1_v30 = __cs_local_t1_v14_W8 == 0;
tt1_0_8: IF(2,8,tt1_0_9)
                                        v_1_X8_0 = __cs_local_t1_v30;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
IF(4,0,tt3_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t3_v17_W0;
tt3_0_1: IF(4,1,tt3_0_2)
                                        __cs_local_t3_v17_W0 = vars[2];
                                        ;
                                                ;
tt3_0_2: IF(4,2,tt3_0_3)
                                        vars[3] = 1;
                                        static int __cs_local_t3_v31;
                                        __cs_local_t3_v31 = __cs_local_t3_v17_W0 == 1;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X0_1 = __cs_local_t3_v31;
                                        goto __exit_t3;
                                                ;
                                        __exit_t3:
