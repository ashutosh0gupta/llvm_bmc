 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB-LRR+OB-O+OB-O+OB-OB.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[6] = {15, 4, 4, 4, 5, 2};
...
tt3_0_1: IF(4,1,tt3_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t3_v15_W2;
tt3_0_2: IF(4,2,tt3_0_3)
                                        __cs_local_t3_v15_W2 = vars[1];
                                        static int __cs_local_t3_v26;
                                        __cs_local_t3_v26 = __cs_local_t3_v15_W2 == 0;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X2_0 = __cs_local_t3_v26;
