 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/C11-B.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {10, 2, 5, 4};
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        ...
                                        __cs_local_t1_v17 = __cs_local_t1_v6_W2 == 1;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X2_1 = __cs_local_t1_v17;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
