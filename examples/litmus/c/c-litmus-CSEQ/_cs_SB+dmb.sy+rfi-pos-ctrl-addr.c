 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/SB+dmb.sy+rfi-pos-ctrl-addr.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 4, 9};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        __cs_local_t0_v30 = __cs_local_t0_v3_W2 == 0;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X2_0 = __cs_local_t0_v30;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v31 = __cs_local_t1_v6_W2 == 1;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X2_1 = __cs_local_t1_v31;
                                        static int __cs_local_t1_v32;
                                        __cs_local_t1_v32 = __cs_local_t1_v9_W3 == 1;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X3_1 = __cs_local_t1_v32;
                                        static int __cs_local_t1_v33;
                                        __cs_local_t1_v33 = __cs_local_t1_v16_W7 == 0;
