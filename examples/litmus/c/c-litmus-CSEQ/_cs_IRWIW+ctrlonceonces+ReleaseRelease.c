 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/IRWIW+ctrlonceonces+ReleaseRelease.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {12, 2, 4, 2, 4};
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        static int __cs_local_t1_v4_cmpeq;
                                        __cs_local_t1_v4_cmpeq = __cs_local_t1_v3_W0 == 0;
                                        ;
                                                ;
                                        static _Bool __cs_local_t1___cs_tmp_if_cond_0;
                                        __cs_local_t1___cs_tmp_if_cond_0 = __cs_local_t1_v4_cmpeq;
                                        if (__cs_local_t1___cs_tmp_if_cond_0)
                                                {
                                        goto lbl_label160_t1_0;
                                                        ;
                                                }
                                                else
                                                {
...
IF(4,0,tt3_0_1)
                                        ;
                                                ;
                                        static int __cs_local_t3_v7_W0;
tt3_0_1: IF(4,1,tt3_0_2)
                                        __cs_local_t3_v7_W0 = vars[1];
                                        static int __cs_local_t3_v8_cmpeq;
                                        __cs_local_t3_v8_cmpeq = __cs_local_t3_v7_W0 == 0;
                                        ;
                                                ;
                                        static _Bool __cs_local_t3___cs_tmp_if_cond_1;
                                        __cs_local_t3___cs_tmp_if_cond_1 = __cs_local_t3_v8_cmpeq;
                                        if (__cs_local_t3___cs_tmp_if_cond_1)
                                                {
                                        goto lbl_label161_t3_0;
                                                        ;
                                                }
                                                else
                                                {
...
tt3_0_2: IF(4,2,tt3_0_3)
                                        vars[0] = 1;
                                        static int __cs_local_t3_v19;
                                        __cs_local_t3_v19 = __cs_local_t3_v7_W0 == 2;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X0_2 = __cs_local_t3_v19;
                                        goto __exit_t3;
                                                ;
                                        __exit_t3:
...
tmain_11: IF(0,11,tmain_12)
                                        ...
                                        __cs_local_main_v17_conj = __cs_local_main_v10 & __cs_local_main_v16_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_2;
                                        __cs_local_main___cs_tmp_if_cond_2 = __cs_local_main_v17_conj == 1;
