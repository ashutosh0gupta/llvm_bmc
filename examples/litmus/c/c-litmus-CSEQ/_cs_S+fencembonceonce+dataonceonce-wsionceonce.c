 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/S+fencembonceonce+dataonceonce-wsionceonce.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {6, 3, 5};
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        vars[1] = 2;
                                        static int __cs_local_t1_v10;
                                        __cs_local_t1_v10 = __cs_local_t1_v3_W0 == 1;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X0_1 = __cs_local_t1_v10;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_4: IF(0,4,tmain_5)
                                        ...
                                        __cs_local_main_v7 = __cs_local_main_v6 == 3;
                                        static int __cs_local_main_v8;
tmain_5: IF(0,5,tmain_6)
                                        __cs_local_main_v8 = v_1_X0_1;
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_0 = __cs_local_main_v9_conj == 1;
