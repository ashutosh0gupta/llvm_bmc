 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/W+RW+RW+RR+poal+dmb.sy+dmb.sypa+L.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[5] = {12, 2, 4, 4, 5};
...
tt3_0_2: IF(4,2,tt3_0_3)
                                        ...
                                        static int __cs_local_t3_v22;
                                        __cs_local_t3_v22 = __cs_local_t3_v9_W0 == 1;
tt3_0_3: IF(4,3,tt3_0_4)
                                        v_3_X0_1 = __cs_local_t3_v22;
