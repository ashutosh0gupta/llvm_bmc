 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+addr-[fr-rf]-addr.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {13, 3, 9, 2};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        __cs_local_t1_v14_W7 = vars[0 + __cs_local_t1_v11_W6];
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v32 = __cs_local_t1_v7_W3 == 0;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X3_0 = __cs_local_t1_v32;
                                        static int __cs_local_t1_v33;
                                        __cs_local_t1_v33 = __cs_local_t1_v10_W5 == 1;
