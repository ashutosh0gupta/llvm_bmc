 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB+data+pos-ctrl-fri.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 4, 8};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        static int __cs_local_t0_v28;
                                        __cs_local_t0_v28 = __cs_local_t0_v3_W0 == 1;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X0_1 = __cs_local_t0_v28;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        static int __cs_local_t1_v11_W2;
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v11_W2 = vars[1];
                                        ;
                                                ;
                                        static _Bool __cs_local_t1___cs_tmp_if_cond_0;
                                        __cs_local_t1___cs_tmp_if_cond_0 = __cs_local_t1_v11_W2;
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v14_W3;
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v14_W3 = vars[0];
tt1_0_4: IF(2,4,tt1_0_5)
                                        vars[0] = 1;
                                        static int __cs_local_t1_v29;
                                        __cs_local_t1_v29 = __cs_local_t1_v8_W0 == 1;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X0_1 = __cs_local_t1_v29;
                                        static int __cs_local_t1_v30;
                                        __cs_local_t1_v30 = __cs_local_t1_v11_W2 == 1;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X2_1 = __cs_local_t1_v30;
                                        static int __cs_local_t1_v31;
                                        __cs_local_t1_v31 = __cs_local_t1_v14_W3 == 0;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X3_0 = __cs_local_t1_v31;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v21 = v_1_X2_1;
                                        static int __cs_local_main_v22;
tmain_9: IF(0,9,tmain_10)
                                        __cs_local_main_v22 = v_1_X3_0;
                                        ...
                                        __cs_local_main___cs_tmp_if_cond_1 = __cs_local_main_v27_conj == 1;
