 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+po-datapl+rfilp-ctrlisbpa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 6, 6};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        static int __cs_local_t0_v4_W4;
                                        __cs_local_t0_v4_W4 = __cs_local_t0_v3_W2 ^ __cs_local_t0_v3_W2;
                                        static int __cs_local_t0_v5_W4;
                                        __cs_local_t0_v5_W4 = __cs_local_t0_v4_W4 + 1;
                                        ;
                                                ;
tt0_0_3: IF(1,3,tt0_0_4)
                                        vars[2] = __cs_local_t0_v5_W4;
                                        static int __cs_local_t0_v8_W6;
tt0_0_4: IF(1,4,tt0_0_5)
                                        __cs_local_t0_v8_W6 = vars[2];
                                        static int __cs_local_t0_v26;
                                        __cs_local_t0_v26 = __cs_local_t0_v8_W6 == 2;
tt0_0_5: IF(1,5,tt0_0_6)
                                        v_0_X6_2 = __cs_local_t0_v26;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        ...
                                        __cs_local_t1_v27 = __cs_local_t1_v11_W2 == 2;
tt1_0_4: IF(2,4,tt1_0_5)
                                        v_1_X2_2 = __cs_local_t1_v27;
                                        static int __cs_local_t1_v28;
                                        __cs_local_t1_v28 = __cs_local_t1_v14_W3 == 0;
