 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+rfi-pos-datapl+pola.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 9, 4};
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        ...
                                        __cs_local_t0_v7_W4 = __cs_local_t0_v6_W3 ^ __cs_local_t0_v6_W3;
                                        static int __cs_local_t0_v8_W4;
                                        __cs_local_t0_v8_W4 = __cs_local_t0_v7_W4 + 1;
                                        ;
                                                ;
tt0_0_4: IF(1,4,tt0_0_5)
                                        vars[1] = __cs_local_t0_v8_W4;
                                        static int __cs_local_t0_v11_W6;
tt0_0_5: IF(1,5,tt0_0_6)
                                        __cs_local_t0_v11_W6 = vars[1];
                                        static int __cs_local_t0_v28;
                                        __cs_local_t0_v28 = __cs_local_t0_v11_W6 == 2;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X6_2 = __cs_local_t0_v28;
                                        static int __cs_local_t0_v29;
                                        __cs_local_t0_v29 = __cs_local_t0_v3_W2 == 1;
tt0_0_7: IF(1,7,tt0_0_8)
                                        v_0_X2_1 = __cs_local_t0_v29;
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v14_W2;
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v14_W2 = vars[0];
                                        static int __cs_local_t1_v31;
                                        __cs_local_t1_v31 = __cs_local_t1_v14_W2 == 0;
...
tmain_7: IF(0,7,tmain_8)
                                        __cs_local_main_v20 = v_0_X2_1;
                                        static int __cs_local_main_v21;
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v21 = v_0_X3_1;
