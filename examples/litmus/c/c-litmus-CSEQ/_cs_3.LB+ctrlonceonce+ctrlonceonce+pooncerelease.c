 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/3.LB+ctrlonceonce+ctrlonceonce+pooncerelease.c, 
 *
 */
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        static int __cs_local_t1_v8_cmpeq;
                                        __cs_local_t1_v8_cmpeq = __cs_local_t1_v7_W0 == 0;
                                        ;
                                                ;
                                        static _Bool __cs_local_t1___cs_tmp_if_cond_1;
                                        __cs_local_t1___cs_tmp_if_cond_1 = __cs_local_t1_v8_cmpeq;
                                        if (__cs_local_t1___cs_tmp_if_cond_1)
                                                {
                                        goto lbl_label246_t1_0;
                                                        ;
                                                }
                                                else
                                                {
