 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+wsipl+polp-data-popa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 5, 6};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v22 = __cs_local_t1_v11_W6 == 0;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X6_0 = __cs_local_t1_v22;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
