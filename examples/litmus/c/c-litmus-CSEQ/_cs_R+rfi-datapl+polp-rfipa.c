 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+rfi-datapl+polp-rfipa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {10, 7, 7};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        static int __cs_local_t0_v5_W3;
                                        __cs_local_t0_v5_W3 = __cs_local_t0_v4_W3 + 1;
                                        ;
                                                ;
tt0_0_3: IF(1,3,tt0_0_4)
                                        vars[1] = __cs_local_t0_v5_W3;
                                        static int __cs_local_t0_v8_W5;
tt0_0_4: IF(1,4,tt0_0_5)
                                        __cs_local_t0_v8_W5 = vars[1];
                                        static int __cs_local_t0_v28;
                                        __cs_local_t0_v28 = __cs_local_t0_v8_W5 == 2;
tt0_0_5: IF(1,5,tt0_0_6)
                                        v_0_X5_2 = __cs_local_t0_v28;
                                        static int __cs_local_t0_v29;
                                        __cs_local_t0_v29 = __cs_local_t0_v3_W2 == 2;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X2_2 = __cs_local_t0_v29;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v11_W4 = vars[0];
                                        static int __cs_local_t1_v14_W5;
tt1_0_4: IF(2,4,tt1_0_5)
                                        __cs_local_t1_v14_W5 = vars[0];
                                        static int __cs_local_t1_v30;
                                        __cs_local_t1_v30 = __cs_local_t1_v14_W5 == 2;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X5_2 = __cs_local_t1_v30;
                                        static int __cs_local_t1_v31;
                                        __cs_local_t1_v31 = __cs_local_t1_v11_W4 == 1;
...
tmain_6: IF(0,6,tmain_7)
                                        __cs_local_main_v19 = v_0_X5_2;
                                        static int __cs_local_main_v20;
tmain_7: IF(0,7,tmain_8)
                                        __cs_local_main_v20 = v_0_X2_2;
