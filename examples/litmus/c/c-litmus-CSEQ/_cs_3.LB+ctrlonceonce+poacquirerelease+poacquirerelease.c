 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/3.LB+ctrlonceonce+poacquirerelease+poacquirerelease.c, 
 *
 */
...
tt0_0_1: IF(1,1,tt0_0_2)
                                        ...
                                        static int __cs_local_t0_v4_cmpeq;
                                        __cs_local_t0_v4_cmpeq = __cs_local_t0_v3_W0 == 0;
                                        ;
                                                ;
                                        static _Bool __cs_local_t0___cs_tmp_if_cond_0;
                                        __cs_local_t0___cs_tmp_if_cond_0 = __cs_local_t0_v4_cmpeq;
                                        if (__cs_local_t0___cs_tmp_if_cond_0)
                                                {
                                        goto lbl_label90_t0_0;
                                                        ;
                                                }
                                                else
                                                {
