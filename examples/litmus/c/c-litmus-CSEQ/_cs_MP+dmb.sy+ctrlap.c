 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+ctrlap.c, 
 *
 */
...
IF(2,0,tt1_0_1)
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v3_X0;
tt1_0_1: IF(2,1,tt1_0_2)
                                        __cs_local_t1_v3_X0 = vars[1];
                                        ;
                                                ;
                                        static _Bool __cs_local_t1___cs_tmp_if_cond_0;
                                        __cs_local_t1___cs_tmp_if_cond_0 = __cs_local_t1_v3_X0;
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v6_X2;
tt1_0_2: IF(2,2,tt1_0_3)
                                        __cs_local_t1_v6_X2 = vars[0];
                                        static int __cs_local_t1_v10;
                                        __cs_local_t1_v10 = __cs_local_t1_v3_X0 == 1;
tt1_0_3: IF(2,3,tt1_0_4)
                                        v_1_X0_1 = __cs_local_t1_v10;
                                        static int __cs_local_t1_v11;
                                        __cs_local_t1_v11 = __cs_local_t1_v6_X2 == 0;
