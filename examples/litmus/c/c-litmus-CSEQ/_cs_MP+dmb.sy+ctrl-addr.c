 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+ctrl-addr.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 3, 6};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v21 = __cs_local_t1_v10_W5 == 0;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X5_0 = __cs_local_t1_v21;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
