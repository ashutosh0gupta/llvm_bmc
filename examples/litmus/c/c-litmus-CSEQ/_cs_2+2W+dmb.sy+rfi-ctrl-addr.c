 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/2+2W+dmb.sy+rfi-ctrl-addr.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[3] __cs_thread_lines[3] = {7, 3, 6};
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v15 = __cs_local_t1_v3_W2 == 2;
tt1_0_5: IF(2,5,tt1_0_6)
                                        v_1_X2_2 = __cs_local_t1_v15;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_6: IF(0,6,tmain_7)
                                        ...
                                        __cs_local_main_v14_conj = __cs_local_main_v9 & __cs_local_main_v13_conj;
                                        ;
                                                ;
