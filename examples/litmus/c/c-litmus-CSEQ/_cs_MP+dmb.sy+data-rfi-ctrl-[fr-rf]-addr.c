 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/MP+dmb.sy+data-rfi-ctrl-[fr-rf]-addr.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {15, 3, 12, 2};
...
tt1_0_1: IF(2,1,tt1_0_2)
                                        ...
                                        static int __cs_local_t1_v4_W2;
                                        __cs_local_t1_v4_W2 = __cs_local_t1_v3_W0 ^ __cs_local_t1_v3_W0;
                                        static int __cs_local_t1_v5_W2;
                                        __cs_local_t1_v5_W2 = __cs_local_t1_v4_W2 + 1;
tt1_0_2: IF(2,2,tt1_0_3)
                                        vars[2] = __cs_local_t1_v5_W2;
                                        static int __cs_local_t1_v8_W4;
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v8_W4 = vars[2];
                                        ;
                                                ;
                                        static _Bool __cs_local_t1___cs_tmp_if_cond_0;
                                        __cs_local_t1___cs_tmp_if_cond_0 = __cs_local_t1_v8_W4;
                                        ...
                                        ;
                                                ;
                                        static int __cs_local_t1_v11_W5;
tt1_0_4: IF(2,4,tt1_0_5)
                                        __cs_local_t1_v11_W5 = vars[3];
                                        static int __cs_local_t1_v14_W7;
tt1_0_5: IF(2,5,tt1_0_6)
                                        __cs_local_t1_v14_W7 = vars[3];
                                        static int __cs_local_t1_v15_W8;
                                        __cs_local_t1_v15_W8 = __cs_local_t1_v14_W7 ^ __cs_local_t1_v14_W7;
                                        static int __cs_local_t1_v18_W9;
tt1_0_6: IF(2,6,tt1_0_7)
                                        __cs_local_t1_v18_W9 = vars[0 + __cs_local_t1_v15_W8];
                                        static int __cs_local_t1_v40;
                                        __cs_local_t1_v40 = __cs_local_t1_v3_W0 == 1;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X0_1 = __cs_local_t1_v40;
                                        static int __cs_local_t1_v41;
                                        __cs_local_t1_v41 = __cs_local_t1_v8_W4 == 1;
tt1_0_8: IF(2,8,tt1_0_9)
                                        v_1_X4_1 = __cs_local_t1_v41;
                                        static int __cs_local_t1_v42;
                                        __cs_local_t1_v42 = __cs_local_t1_v11_W5 == 0;
tt1_0_9: IF(2,9,tt1_0_10)
                                        v_1_X5_0 = __cs_local_t1_v42;
                                        static int __cs_local_t1_v43;
                                        __cs_local_t1_v43 = __cs_local_t1_v14_W7 == 1;
tt1_0_10: IF(2,10,tt1_0_11)
                                        v_1_X7_1 = __cs_local_t1_v43;
                                        static int __cs_local_t1_v44;
                                        __cs_local_t1_v44 = __cs_local_t1_v18_W9 == 0;
tt1_0_11: IF(2,11,tt1_0_12)
                                        v_1_X9_0 = __cs_local_t1_v44;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_6: IF(0,6,tmain_7)
                                        __cs_local_main_v19 = vars[3];
                                        static int __cs_local_main_v20;
                                        __cs_local_main_v20 = __cs_local_main_v19 == 1;
                                        static int __cs_local_main_v21;
tmain_7: IF(0,7,tmain_8)
                                        __cs_local_main_v21 = vars[0];
                                        static int __cs_local_main_v22;
                                        __cs_local_main_v22 = __cs_local_main_v21 == 1;
                                        static int __cs_local_main_v23;
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v23 = vars[1];
                                        static int __cs_local_main_v24;
                                        __cs_local_main_v24 = __cs_local_main_v23 == 1;
                                        static int __cs_local_main_v25;
tmain_9: IF(0,9,tmain_10)
                                        __cs_local_main_v25 = vars[2];
                                        static int __cs_local_main_v26;
                                        __cs_local_main_v26 = __cs_local_main_v25 == 1;
                                        static int __cs_local_main_v27;
tmain_10: IF(0,10,tmain_11)
                                        __cs_local_main_v27 = v_1_X0_1;
                                        static int __cs_local_main_v28;
tmain_11: IF(0,11,tmain_12)
                                        __cs_local_main_v28 = v_1_X4_1;
                                        static int __cs_local_main_v29;
tmain_12: IF(0,12,tmain_13)
                                        __cs_local_main_v29 = v_1_X5_0;
                                        static int __cs_local_main_v30;
tmain_13: IF(0,13,tmain_14)
                                        __cs_local_main_v30 = v_1_X7_1;
                                        static int __cs_local_main_v31;
tmain_14: IF(0,14,tmain_15)
                                        __cs_local_main_v31 = v_1_X9_0;
                                        static int __cs_local_main_v32_conj;
                                        __cs_local_main_v32_conj = __cs_local_main_v30 & __cs_local_main_v31;
                                        static int __cs_local_main_v33_conj;
                                        __cs_local_main_v33_conj = __cs_local_main_v29 & __cs_local_main_v32_conj;
                                        static int __cs_local_main_v34_conj;
                                        __cs_local_main_v34_conj = __cs_local_main_v28 & __cs_local_main_v33_conj;
                                        static int __cs_local_main_v35_conj;
                                        __cs_local_main_v35_conj = __cs_local_main_v27 & __cs_local_main_v34_conj;
                                        static int __cs_local_main_v36_conj;
                                        __cs_local_main_v36_conj = __cs_local_main_v26 & __cs_local_main_v35_conj;
                                        static int __cs_local_main_v37_conj;
                                        __cs_local_main_v37_conj = __cs_local_main_v24 & __cs_local_main_v36_conj;
                                        static int __cs_local_main_v38_conj;
                                        __cs_local_main_v38_conj = __cs_local_main_v22 & __cs_local_main_v37_conj;
                                        static int __cs_local_main_v39_conj;
                                        __cs_local_main_v39_conj = __cs_local_main_v20 & __cs_local_main_v38_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_1;
                                        __cs_local_main___cs_tmp_if_cond_1 = __cs_local_main_v39_conj == 1;
