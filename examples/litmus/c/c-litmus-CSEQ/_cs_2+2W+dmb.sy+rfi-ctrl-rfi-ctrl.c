 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/2+2W+dmb.sy+rfi-ctrl-rfi-ctrl.c, 
 *
 */
...
tt1_0_5: IF(2,5,tt1_0_6)
                                        ...
                                        __cs_local_t1_v19 = __cs_local_t1_v3_W2 == 2;
tt1_0_6: IF(2,6,tt1_0_7)
                                        v_1_X2_2 = __cs_local_t1_v19;
                                        static int __cs_local_t1_v20;
                                        __cs_local_t1_v20 = __cs_local_t1_v6_W5 == 1;
tt1_0_7: IF(2,7,tt1_0_8)
                                        v_1_X5_1 = __cs_local_t1_v20;
                                        goto __exit_t1;
                                                ;
                                        __exit_t1:
...
tmain_3: IF(0,3,tmain_4)
                                        ...
                                        static int __cs_local_main_v7;
tmain_4: IF(0,4,tmain_5)
                                        __cs_local_main_v7 = vars[0];
                                        static int __cs_local_main_v8;
                                        __cs_local_main_v8 = __cs_local_main_v7 == 2;
                                        static int __cs_local_main_v9;
tmain_5: IF(0,5,tmain_6)
                                        __cs_local_main_v9 = vars[1];
...
tmain_7: IF(0,7,tmain_8)
                                        __cs_local_main_v13 = v_1_X2_2;
                                        static int __cs_local_main_v14;
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v14 = v_1_X5_1;
                                        ...
                                        __cs_local_main_v18_conj = __cs_local_main_v8 & __cs_local_main_v17_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_2;
                                        __cs_local_main___cs_tmp_if_cond_2 = __cs_local_main_v18_conj == 1;
