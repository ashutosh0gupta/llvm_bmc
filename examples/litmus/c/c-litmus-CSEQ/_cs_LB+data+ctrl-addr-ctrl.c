 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/LB+data+ctrl-addr-ctrl.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {8, 4, 6};
...
tt0_0_2: IF(1,2,tt0_0_3)
                                        ...
                                        static int __cs_local_t0_v25;
                                        __cs_local_t0_v25 = __cs_local_t0_v3_W0 == 1;
tt0_0_3: IF(1,3,tt0_0_4)
                                        v_0_X0_1 = __cs_local_t0_v25;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_2: IF(2,2,tt1_0_3)
                                        ...
                                        __cs_local_t1_v12_W4 = __cs_local_t1_v11_W2 ^ __cs_local_t1_v11_W2;
                                        static int __cs_local_t1_v15_W5;
tt1_0_3: IF(2,3,tt1_0_4)
                                        __cs_local_t1_v15_W5 = vars[3 + __cs_local_t1_v12_W4];
                                        ;
                                                ;
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v26 = __cs_local_t1_v8_W0 == 1;
...
tmain_7: IF(0,7,tmain_8)
                                        ...
                                        __cs_local_main_v24_conj = __cs_local_main_v17 & __cs_local_main_v23_conj;
                                        ;
                                                ;
                                        static _Bool __cs_local_main___cs_tmp_if_cond_2;
                                        __cs_local_main___cs_tmp_if_cond_2 = __cs_local_main_v24_conj == 1;
