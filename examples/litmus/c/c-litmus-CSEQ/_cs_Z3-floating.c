 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/Z3-floating.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[4] = {10, 7, 3, 3};
...
tt0_0_1: IF(1,1,tt0_0_2)
                                        ...
                                        static int __cs_local_t0_v7_W3;
tt0_0_2: IF(1,2,tt0_0_3)
                                        __cs_local_t0_v7_W3 = vars[1 + __cs_local_t0_v4_W2];
...
tt0_0_4: IF(1,4,tt0_0_5)
                                        ...
                                        __cs_local_t0_v20 = __cs_local_t0_v7_W3 == 0;
tt0_0_5: IF(1,5,tt0_0_6)
                                        v_0_X3_0 = __cs_local_t0_v20;
                                        static int __cs_local_t0_v21;
                                        __cs_local_t0_v21 = __cs_local_t0_v10_W6 == 1;
tt0_0_6: IF(1,6,tt0_0_7)
                                        v_0_X6_1 = __cs_local_t0_v21;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tmain_8: IF(0,8,tmain_9)
                                        __cs_local_main_v14 = v_0_X3_0;
                                        static int __cs_local_main_v15;
tmain_9: IF(0,9,tmain_10)
                                        __cs_local_main_v15 = v_0_X6_1;
