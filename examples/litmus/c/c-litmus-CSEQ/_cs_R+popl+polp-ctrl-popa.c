 ...
 *
 *  params:
 *    -i /home/osboxes/llvm_bmc/llvm_bmc/examples/litmus/c/run-scripts/../c-litmus-CSEQ/R+popl+polp-ctrl-popa.c, 
 *
 */
...
#define IF(T,A,B) if ((__cs_pc[T] > A) | (A >= __cs_pc_cs[T])) goto B;
                                        ...
                                        unsigned __CPROVER_bitvector[4] __cs_thread_lines[3] = {9, 5, 6};
...
tt0_0_3: IF(1,3,tt0_0_4)
                                        ...
                                        __cs_local_t0_v22 = __cs_local_t0_v3_W4 == 2;
tt0_0_4: IF(1,4,tt0_0_5)
                                        v_0_X4_2 = __cs_local_t0_v22;
                                        goto __exit_t0;
                                                ;
                                        __exit_t0:
...
tt1_0_4: IF(2,4,tt1_0_5)
                                        ...
                                        __cs_local_t1_v23 = __cs_local_t1_v9_W6 == 0;
