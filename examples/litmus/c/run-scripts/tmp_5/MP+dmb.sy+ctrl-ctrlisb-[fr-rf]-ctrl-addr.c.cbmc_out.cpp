...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !93), !dbg !127
  ...
  //   %xor = xor i32 %conv22, %conv22, !dbg !112
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !133

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(2,r7);
  cr(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l43_c17
  // Check
