...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !224, metadata !DIExpression()), !dbg !270

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !225, metadata !DIExpression()), !dbg !270

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !226, metadata !DIExpression()), !dbg !272

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !230, metadata !DIExpression()), !dbg !274

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #6, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !231, metadata !DIExpression()), !dbg !276

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #6, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !232, metadata !DIExpression()), !dbg !278

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #6, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !233, metadata !DIExpression()), !dbg !280

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #6, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !234, metadata !DIExpression()), !dbg !282

  //   %6 = bitcast i64* %thr6 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %6) #6, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr6, metadata !235, metadata !DIExpression()), !dbg !284

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 6), metadata !236, metadata !DIExpression()), !dbg !285

  //   call void @llvm.dbg.value(metadata i64 0, metadata !238, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 5), metadata !239, metadata !DIExpression()), !dbg !287

  //   call void @llvm.dbg.value(metadata i64 0, metadata !241, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 4), metadata !242, metadata !DIExpression()), !dbg !289

  //   call void @llvm.dbg.value(metadata i64 0, metadata !244, metadata !DIExpression()), !dbg !289
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 3), metadata !245, metadata !DIExpression()), !dbg !291

  //   call void @llvm.dbg.value(metadata i64 0, metadata !247, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 2), metadata !248, metadata !DIExpression()), !dbg !293

  //   call void @llvm.dbg.value(metadata i64 0, metadata !250, metadata !DIExpression()), !dbg !293
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 1), metadata !251, metadata !DIExpression()), !dbg !295

  //   call void @llvm.dbg.value(metadata i64 0, metadata !253, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 0), metadata !254, metadata !DIExpression()), !dbg !297

  //   call void @llvm.dbg.value(metadata i64 0, metadata !256, metadata !DIExpression()), !dbg !297
  ...
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l109_c15
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l109_c15
  // Check
  ...
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l110_c15
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l110_c15
  // Check
  ...
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l111_c15
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l111_c15
  // Check
  ...
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l112_c15
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l112_c15
  // Check
  ...
  // ST: Guess
  iw(0,12) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l114_c15
  old_cw = cw(0,12);
  cw(0,12) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l114_c15
  // Check
  ...
  // ST: Guess
  iw(0,13) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l115_c15
  old_cw = cw(0,13);
  cw(0,13) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l115_c15
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !136
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !137
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #6, !dbg !138
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #6, !dbg !139
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #6, !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr5, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t5, i8* noundef null) #6, !dbg !141
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_create(i64* noundef %thr6, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t6, i8* noundef null) #6, !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !257, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !258, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !259, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !260, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i32 %18, metadata !261, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i32 %19, metadata !262, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i32 %20, metadata !263, metadata !DIExpression()), !dbg !270

  //   %and = and i32 %19, %20, !dbg !166
  creg_r22 = max(creg_r20,creg_r21);
  r22 = r20 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !264, metadata !DIExpression()), !dbg !270

  //   %and26 = and i32 %18, %and, !dbg !167
  creg_r23 = max(creg_r19,creg_r22);
  r23 = r19 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !265, metadata !DIExpression()), !dbg !270

  //   %and27 = and i32 %17, %and26, !dbg !168
  creg_r24 = max(creg_r18,creg_r23);
  r24 = r18 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !266, metadata !DIExpression()), !dbg !270

  //   %and28 = and i32 %16, %and27, !dbg !169
  creg_r25 = max(creg_r17,creg_r24);
  r25 = r17 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !267, metadata !DIExpression()), !dbg !270

  //   %and29 = and i32 %15, %and28, !dbg !170
  creg_r26 = max(creg_r16,creg_r25);
  r26 = r16 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !268, metadata !DIExpression()), !dbg !270

  //   %and30 = and i32 %14, %and29, !dbg !171
  creg_r27 = max(creg_r15,creg_r26);
  r27 = r15 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !269, metadata !DIExpression()), !dbg !270
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 146, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !175
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %21) #6, !dbg !178

  //   %22 = bitcast i64* %thr5 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %22) #6, !dbg !178

  //   %23 = bitcast i64* %thr4 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %23) #6, !dbg !178

  //   %24 = bitcast i64* %thr3 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %24) #6, !dbg !178

  //   %25 = bitcast i64* %thr2 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %25) #6, !dbg !178

  //   %26 = bitcast i64* %thr1 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %26) #6, !dbg !178

  //   %27 = bitcast i64* %thr0 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %27) #6, !dbg !178
