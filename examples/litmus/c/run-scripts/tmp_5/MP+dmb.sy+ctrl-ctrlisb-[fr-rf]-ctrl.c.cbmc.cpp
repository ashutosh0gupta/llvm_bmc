...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !69, metadata !DIExpression()), !dbg !89
...
T2BLOCK10:
  ...
  //   %cmp24 = icmp eq i32 %conv11, 0, !dbg !113
  ...
  //   store i32 %conv25, i32* @atom_1_X4_0, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv15, 1, !dbg !115
  ...
  //   store i32 %conv27, i32* @atom_1_X6_1, align 4, !dbg !116, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X4_0, align 4, !dbg !109, !tbaa !105
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X6_1, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X7_0, align 4, !dbg !111, !tbaa !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !180, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !185, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !190, metadata !DIExpression()), !dbg !242
  ...
  //   %10 = load i32, i32* @atom_1_X4_0, align 4, !dbg !136, !tbaa !105
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X6_1, align 4, !dbg !137, !tbaa !105
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %12 = load i32, i32* @atom_1_X7_0, align 4, !dbg !138, !tbaa !105
  // LD: Guess
  old_cr = cr(0,7);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 97, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !148
