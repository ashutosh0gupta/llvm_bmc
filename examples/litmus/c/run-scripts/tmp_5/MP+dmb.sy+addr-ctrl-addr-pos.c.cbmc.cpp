...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !69, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !72, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !74, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !73, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !90, metadata !DIExpression()), !dbg !128

  //   %7 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !128

  //   store atomic i64 %7, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !160, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !163, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !181, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !185, metadata !DIExpression()), !dbg !235
