...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !51, metadata !DIExpression()), !dbg !83

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !53, metadata !DIExpression()), !dbg !83
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !146, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !189

  //   store atomic i64 0, i64* @atom_0_X4_0 monotonic, align 8, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !167, metadata !DIExpression()), !dbg !214

  //   %7 = load atomic i64, i64* @atom_0_X4_0 seq_cst, align 8, !dbg !127
  // LD: Guess
  old_cr = cr(0,3);
