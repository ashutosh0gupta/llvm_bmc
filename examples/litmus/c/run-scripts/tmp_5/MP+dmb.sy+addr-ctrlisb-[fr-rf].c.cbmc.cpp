...
T2BLOCK4:
  ...
  //   %conv13 = zext i1 %cmp to i32, !dbg !94
  ...
  //   %cmp15 = icmp eq i32 %conv8, 0, !dbg !97

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !80, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !81, metadata !DIExpression()), !dbg !117

  //   %5 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !83, metadata !DIExpression()), !dbg !117
  ...
  //   %cmp20 = icmp eq i32 %conv12, 1, !dbg !100

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !84, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !85, metadata !DIExpression()), !dbg !120

  //   %6 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !87, metadata !DIExpression()), !dbg !120

  //   store atomic i64 %6, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !102
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !126, metadata !DIExpression()), !dbg !133
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !150, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !151, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !163, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !172, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !177, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !182, metadata !DIExpression()), !dbg !235

  //   %conv26 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !179, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !184, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !186, metadata !DIExpression()), !dbg !238

  //   %conv30 = trunc i64 %9 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !183, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !188, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !190, metadata !DIExpression()), !dbg !241

  //   %conv34 = trunc i64 %10 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !187, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !192, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !193, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !194, metadata !DIExpression()), !dbg !195
