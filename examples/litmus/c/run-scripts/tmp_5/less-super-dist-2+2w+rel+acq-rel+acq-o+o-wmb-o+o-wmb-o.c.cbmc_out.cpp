...
T0BLOCK0:
  ...
  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !108, !tbaa !89
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !142, metadata !DIExpression()), !dbg !157

  //   %9 = load i32, i32* @atom_2_X0_1, align 4, !dbg !109, !tbaa !89
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !143, metadata !DIExpression()), !dbg !157
  ...
  //   %10 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !147, metadata !DIExpression()), !dbg !190

  //   %conv = trunc i64 %10 to i32, !dbg !112
  ...
  //   %conv12 = zext i1 %cmp to i32, !dbg !113
  ...
  //   %11 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !152, metadata !DIExpression()), !dbg !194

  //   %conv16 = trunc i64 %11 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !149, metadata !DIExpression()), !dbg !157

  //   %cmp17 = icmp eq i32 %conv16, 1, !dbg !117
  creg__r10__1_ = max(0,creg_r10);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !153, metadata !DIExpression()), !dbg !157

  //   %and = and i32 %conv12, %conv18, !dbg !118
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([139 x i8], [139 x i8]* @.str.1, i64 0, i64 0), i32 noundef 81, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !124
