...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !89), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !75, metadata !DIExpression()), !dbg !90
  ...
  //   store i32 %conv29, i32* @atom_1_X7_0, align 4, !dbg !118, !tbaa !113
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv26, 1, !dbg !119
  ...
  //   store i32 %conv31, i32* @atom_1_X9_1, align 4, !dbg !120, !tbaa !113
  // ST: Guess
