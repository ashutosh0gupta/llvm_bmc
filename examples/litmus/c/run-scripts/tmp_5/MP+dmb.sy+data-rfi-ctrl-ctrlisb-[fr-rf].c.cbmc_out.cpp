...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv5, 0, !dbg !99
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !134

  //   %conv16 = trunc i64 %3 to i32, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !137

  //   %conv20 = trunc i64 %4 to i32, !dbg !120
  ...
  //   %cmp25 = icmp eq i32 %conv5, 1, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !91, metadata !DIExpression()), !dbg !144

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !144
  ...
  //   %cmp30 = icmp eq i32 %conv16, 0, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !95, metadata !DIExpression()), !dbg !147

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv20, 1, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !99, metadata !DIExpression()), !dbg !150

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %8, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !132
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !173, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !174, metadata !DIExpression()), !dbg !242

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !175, metadata !DIExpression()), !dbg !244

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !179, metadata !DIExpression()), !dbg !246

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !180, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !181, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !184, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !190, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !193, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !196, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !199, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !202, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !206, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !208, metadata !DIExpression()), !dbg !278

  //   %conv = trunc i64 %6 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !205, metadata !DIExpression()), !dbg !242

  //   %cmp = icmp eq i32 %conv, 2, !dbg !152

  //   %conv20 = zext i1 %cmp to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !209, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !211, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !213, metadata !DIExpression()), !dbg !282

  //   %conv24 = trunc i64 %7 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !210, metadata !DIExpression()), !dbg !242

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !156

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !214, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !216, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !218, metadata !DIExpression()), !dbg !286

  //   %conv30 = trunc i64 %8 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !215, metadata !DIExpression()), !dbg !242

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !160

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !219, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !221, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !223, metadata !DIExpression()), !dbg !290

  //   %conv36 = trunc i64 %9 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !220, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !225, metadata !DIExpression()), !dbg !293
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !227, metadata !DIExpression()), !dbg !293

  //   %conv40 = trunc i64 %10 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !224, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !229, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !231, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !233, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !235, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !237, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %and50, metadata !238, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !239, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !240, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !241, metadata !DIExpression()), !dbg !242
