...
T2BLOCK1:
  ...
  //   %add10 = add nsw i32 %xor9, 1, !dbg !90
  creg_r7 = max(0,creg_r6);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !77, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !110

  //   %conv11 = sext i32 %add10 to i64, !dbg !92

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !80, metadata !DIExpression()), !dbg !110

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv8, 1, !dbg !107
  ...
  //   %cmp25 = icmp eq i32 %conv15, 1, !dbg !109
  ...
  //   store i32 %conv26, i32* @atom_1_X8_1, align 4, !dbg !110, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X8_1, align 4, !dbg !110, !tbaa !104
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X8_1, align 4, !dbg !138, !tbaa !104
  // LD: Guess
  old_cr = cr(0,6);
