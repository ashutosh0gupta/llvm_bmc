...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !115

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !66
  // LD: Guess
  old_cr = cr(3,0);
  cr(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l44_c16
  // Check
