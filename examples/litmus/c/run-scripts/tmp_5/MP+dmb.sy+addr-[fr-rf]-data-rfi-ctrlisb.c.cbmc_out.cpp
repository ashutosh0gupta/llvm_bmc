...
T2BLOCK1:
  ...
  //   %add10 = add nsw i32 %xor9, 1, !dbg !91
  creg_r7 = max(0,creg_r6);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !77, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !78, metadata !DIExpression()), !dbg !111

  //   %conv11 = sext i32 %add10 to i64, !dbg !93

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !80, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !82, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !81, metadata !DIExpression()), !dbg !96

  //   %tobool = icmp ne i32 %conv15, 0, !dbg !97
...
T2BLOCK4:
  ...
  //   store i32 %conv22, i32* @atom_1_X3_0, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   store i32 %conv26, i32* @atom_1_X8_1, align 4, !dbg !118, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X3_0, align 4, !dbg !119, !tbaa !115
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X5_1, align 4, !dbg !120, !tbaa !115
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X3_0, align 4, !dbg !151, !tbaa !115
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X5_1, align 4, !dbg !152, !tbaa !115
  // LD: Guess
  old_cr = cr(0,6);
