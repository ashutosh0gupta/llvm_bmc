...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !119

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !71, metadata !DIExpression()), !dbg !119

  //   %conv4 = trunc i64 %1 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !76, metadata !DIExpression()), !dbg !111

  //   %add10 = add nsw i32 %xor9, 1, !dbg !106
  creg_r7 = max(creg_r6,0);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !77, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !78, metadata !DIExpression()), !dbg !126

  //   %conv11 = sext i32 %add10 to i64, !dbg !108

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !80, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !108
  // ST: Guess
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !94, metadata !DIExpression()), !dbg !145

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !96, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %6, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !98, metadata !DIExpression()), !dbg !148
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !200, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !203, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !237, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !241, metadata !DIExpression()), !dbg !320
