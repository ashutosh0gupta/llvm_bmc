...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !148, metadata !DIExpression()), !dbg !161
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !150, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !152, metadata !DIExpression()), !dbg !164

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !149, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !153, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64 1, metadata !155, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !156, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !157, metadata !DIExpression()), !dbg !171

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !159, metadata !DIExpression()), !dbg !171
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !176, metadata !DIExpression()), !dbg !194
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !178, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !180, metadata !DIExpression()), !dbg !197

  //   %conv = trunc i64 %0 to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !177, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !182, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !184, metadata !DIExpression()), !dbg !201

  //   %conv4 = trunc i64 %1 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !181, metadata !DIExpression()), !dbg !194

  //   %cmp = icmp eq i32 %conv, 1, !dbg !73

  //   %conv5 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !185, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !186, metadata !DIExpression()), !dbg !205

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !188, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !189, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !190, metadata !DIExpression()), !dbg !208

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !192, metadata !DIExpression()), !dbg !208
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !247, metadata !DIExpression()), !dbg !319
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !250, metadata !DIExpression()), !dbg !321
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !266, metadata !DIExpression()), !dbg !353
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !270, metadata !DIExpression()), !dbg !356
