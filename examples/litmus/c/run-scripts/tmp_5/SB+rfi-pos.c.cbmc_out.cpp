...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !40, metadata !DIExpression()), !dbg !56
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !59

  //   call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !59
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !46, metadata !DIExpression()), !dbg !61
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !48, metadata !DIExpression()), !dbg !61

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !45, metadata !DIExpression()), !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !49, metadata !DIExpression()), !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !53, metadata !DIExpression()), !dbg !56

  //   store i32 %conv5, i32* @atom_0_X2_1, align 4, !dbg !68, !tbaa !69
  // ST: Guess
  ...
  //   store i32 %conv7, i32* @atom_0_X3_0, align 4, !dbg !74, !tbaa !69
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !83, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !101
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !116, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !117, metadata !DIExpression()), !dbg !136

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !118, metadata !DIExpression()), !dbg !138

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !122, metadata !DIExpression()), !dbg !140
  ...
  //   store i32 0, i32* @atom_0_X2_1, align 4, !dbg !73, !tbaa !74
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X3_0, align 4, !dbg !78, !tbaa !74
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X2_1, align 4, !dbg !79, !tbaa !74
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X3_0, align 4, !dbg !80, !tbaa !74
  // ST: Guess
  ...
  //   %call4 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !86
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call5 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !88
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i32, i32* @atom_0_X2_1, align 4, !dbg !89, !tbaa !74
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !129, metadata !DIExpression()), !dbg !136

  //   %5 = load i32, i32* @atom_0_X3_0, align 4, !dbg !90, !tbaa !74
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !130, metadata !DIExpression()), !dbg !136

  //   %6 = load i32, i32* @atom_1_X2_1, align 4, !dbg !91, !tbaa !74
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %7 = load i32, i32* @atom_1_X3_0, align 4, !dbg !92, !tbaa !74
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %and = and i32 %6, %7, !dbg !93
  creg_r11 = max(creg_r10,creg_r9);
  r11 = r9 & r10;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !133, metadata !DIExpression()), !dbg !136

  //   %and6 = and i32 %5, %and, !dbg !94
  creg_r12 = max(creg_r11,creg_r8);
  r12 = r8 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and6, metadata !134, metadata !DIExpression()), !dbg !136

  //   %and7 = and i32 %4, %and6, !dbg !95
  creg_r13 = max(creg_r12,creg_r7);
  r13 = r7 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and7, metadata !135, metadata !DIExpression()), !dbg !136

  //   %cmp = icmp eq i32 %and7, 1, !dbg !96
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !99
...
T0BLOCK2:
  //   %8 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #7, !dbg !102

  //   %9 = bitcast i64* %thr0 to i8*, !dbg !102

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #7, !dbg !102
