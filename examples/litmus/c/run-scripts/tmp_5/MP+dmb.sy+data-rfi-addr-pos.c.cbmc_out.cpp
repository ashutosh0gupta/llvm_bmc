...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !140, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !141, metadata !DIExpression()), !dbg !205

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !142, metadata !DIExpression()), !dbg !207

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !146, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !147, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !149, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !159, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !162, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !220

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !165, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !169, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !171, metadata !DIExpression()), !dbg !234

  //   %conv = trunc i64 %4 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !168, metadata !DIExpression()), !dbg !205

  //   %cmp = icmp eq i32 %conv, 1, !dbg !141

  //   %conv16 = zext i1 %cmp to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !172, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !176, metadata !DIExpression()), !dbg !238

  //   %conv20 = trunc i64 %5 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !173, metadata !DIExpression()), !dbg !205

  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !145

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !177, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !179, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !178, metadata !DIExpression()), !dbg !205

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !149

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !182, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !184, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !183, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !188, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !187, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !192, metadata !DIExpression()), !dbg !252

  //   %9 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !191, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !196, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !195, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !200, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !201, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !202, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !203, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !204, metadata !DIExpression()), !dbg !205
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 83, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
