...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !79, metadata !DIExpression()), !dbg !118
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X8_0, align 4, !dbg !99, !tbaa !95
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X10_1, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X8_0, align 4, !dbg !121, !tbaa !95
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X10_1, align 4, !dbg !122, !tbaa !95
  // LD: Guess
  old_cr = cr(0,6);
