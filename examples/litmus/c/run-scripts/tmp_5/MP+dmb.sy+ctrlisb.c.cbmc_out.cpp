...
T0BLOCK0:
  ...
  //   %call3 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !84
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !115, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !117, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !118, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !122, metadata !DIExpression()), !dbg !152

  //   %conv10 = trunc i64 %5 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !119, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !123, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !127, metadata !DIExpression()), !dbg !129

  //   %and14 = and i32 %conv6, %and13, !dbg !103
  creg_r11 = max(creg__r5__1_,creg_r10);
  r11 = (r5==1) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !128, metadata !DIExpression()), !dbg !129
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !107
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #6, !dbg !110
