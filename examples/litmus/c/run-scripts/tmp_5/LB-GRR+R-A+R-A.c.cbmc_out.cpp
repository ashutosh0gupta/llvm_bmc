...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !91, metadata !DIExpression()), !dbg !103
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !93, metadata !DIExpression()), !dbg !106
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !60
  // LD: Guess
  old_cr = cr(3,0+3*1);
  cr(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l41_c16
  // Check
  ...
  //   store i32 %conv5, i32* @atom_2_X2_0, align 4, !dbg !63, !tbaa !64
  // ST: Guess
  ...
  //   store i32 %conv7, i32* @atom_2_X0_1, align 4, !dbg !69, !tbaa !64
  // ST: Guess
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !122, metadata !DIExpression()), !dbg !130

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !53
  // ST: Guess
  iw(4,0+3*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l51_c3
  old_cw = cw(4,0+3*1);
  cw(4,0+3*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l51_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !123, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i64 1, metadata !125, metadata !DIExpression()), !dbg !133

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !56
  // ST: Guess
  iw(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l53_c3
  old_cw = cw(4,0+1*1);
  cw(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l53_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !143, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !144, metadata !DIExpression()), !dbg !171

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !145, metadata !DIExpression()), !dbg !173

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !149, metadata !DIExpression()), !dbg !175

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !150, metadata !DIExpression()), !dbg !177

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !151, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !152, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !155, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !161, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !186
  ...
  //   store i32 0, i32* @atom_2_X2_0, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X0_1, align 4, !dbg !94, !tbaa !90
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !95, !tbaa !90
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !96, !tbaa !90
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_2_X2_0, align 4, !dbg !111, !tbaa !90
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %9 = load i32, i32* @atom_0_X0_1, align 4, !dbg !112, !tbaa !90
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_1_X0_1, align 4, !dbg !113, !tbaa !90
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !166, metadata !DIExpression()), !dbg !171

  //   %11 = load i32, i32* @atom_2_X0_1, align 4, !dbg !114, !tbaa !90
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !167, metadata !DIExpression()), !dbg !171

  //   %and = and i32 %10, %11, !dbg !115
  creg_r13 = max(creg_r11,creg_r12);
  r13 = r11 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !168, metadata !DIExpression()), !dbg !171

  //   %and14 = and i32 %9, %and, !dbg !116
  creg_r14 = max(creg_r10,creg_r13);
  r14 = r10 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !169, metadata !DIExpression()), !dbg !171

  //   %and15 = and i32 %8, %and14, !dbg !117
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !170, metadata !DIExpression()), !dbg !171
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
