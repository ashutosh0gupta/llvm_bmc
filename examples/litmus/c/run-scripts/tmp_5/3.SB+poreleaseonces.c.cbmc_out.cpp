...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X1_0, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X1_0, align 4, !dbg !82, !tbaa !78
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_2_X1_0, align 4, !dbg !83, !tbaa !78
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X1_0, align 4, !dbg !95, !tbaa !78
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X1_0, align 4, !dbg !96, !tbaa !78
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %8 = load i32, i32* @atom_2_X1_0, align 4, !dbg !97, !tbaa !78
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !103
