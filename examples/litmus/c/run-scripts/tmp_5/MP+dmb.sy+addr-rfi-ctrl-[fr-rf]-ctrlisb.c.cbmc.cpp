...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !68, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64 1, metadata !70, metadata !DIExpression()), !dbg !103

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !83
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !71, metadata !DIExpression()), !dbg !95
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !93), !dbg !112

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !76, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !113
...
T2BLOCK7:
  ...
  //   store i32 %conv22, i32* @atom_1_X5_1, align 4, !dbg !117, !tbaa !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X5_1, align 4, !dbg !119, !tbaa !115
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X5_1, align 4, !dbg !151, !tbaa !115
  // LD: Guess
  old_cr = cr(0,5);
