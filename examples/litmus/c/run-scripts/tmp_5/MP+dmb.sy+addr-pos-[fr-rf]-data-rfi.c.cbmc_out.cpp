...
T2BLOCK1:
  ...
  //   %xor13 = xor i32 %conv12, %conv12, !dbg !107
  creg_r7 = max(creg_r6,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !80, metadata !DIExpression()), !dbg !110

  //   %add14 = add nsw i32 %xor13, 1, !dbg !108
  creg_r8 = max(creg_r7,0);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add14, metadata !81, metadata !DIExpression()), !dbg !110
  ...
  //   %conv15 = sext i32 %add14 to i64, !dbg !110

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !84, metadata !DIExpression()), !dbg !128

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv8, 0, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !98, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv12, 1, !dbg !123
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !192, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !195, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !225, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !229, metadata !DIExpression()), !dbg !300
