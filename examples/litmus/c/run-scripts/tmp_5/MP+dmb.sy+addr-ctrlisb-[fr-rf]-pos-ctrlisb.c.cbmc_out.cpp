...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X5_0, align 4, !dbg !113, !tbaa !109
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X7_1, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X8_1, align 4, !dbg !115, !tbaa !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !188, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !193, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !198, metadata !DIExpression()), !dbg !253
  ...
  //   %10 = load i32, i32* @atom_1_X5_0, align 4, !dbg !141, !tbaa !109
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X7_1, align 4, !dbg !142, !tbaa !109
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %12 = load i32, i32* @atom_1_X8_1, align 4, !dbg !143, !tbaa !109
  // LD: Guess
  old_cr = cr(0,7);
