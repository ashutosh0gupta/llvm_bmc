...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !55, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64 2, metadata !57, metadata !DIExpression()), !dbg !81

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !83
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !70, metadata !DIExpression()), !dbg !78

  //   %add = add nsw i32 %xor, 1, !dbg !80
  creg_r4 = max(0,creg_r3);
  r4 = r3 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !71, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !100

  //   %conv11 = sext i32 %add to i64, !dbg !82

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !74, metadata !DIExpression()), !dbg !100
  ...
  //   store i32 %conv12, i32* @atom_1_X2_2, align 4, !dbg !84, !tbaa !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !123, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !126, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64 0, metadata !128, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64 0, metadata !131, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !133, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !135, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !136, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !140, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !141, metadata !DIExpression()), !dbg !145
