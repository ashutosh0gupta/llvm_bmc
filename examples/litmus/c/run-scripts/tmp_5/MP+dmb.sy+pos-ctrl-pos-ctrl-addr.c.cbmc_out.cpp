...
T2BLOCK7:
  ...
  //   %xor = xor i32 %conv19, %conv19, !dbg !110
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !131

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,r7);
