...
T2BLOCK7:
  ...
  //   %cmp25 = icmp eq i32 %conv9, 2, !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !91, metadata !DIExpression()), !dbg !143
  ...
  //   store atomic i64 %8, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !131
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !195, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !258

  //   store atomic i64 0, i64* @atom_1_X6_2 monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !201, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !224, metadata !DIExpression()), !dbg !292

  //   %10 = load atomic i64, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !232, metadata !DIExpression()), !dbg !298
