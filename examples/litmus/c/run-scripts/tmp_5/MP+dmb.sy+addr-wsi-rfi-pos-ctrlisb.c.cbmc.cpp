...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !72, metadata !DIExpression()), !dbg !102
...
T2BLOCK4:
  ...
  //   %cmp19 = icmp eq i32 %conv6, 2, !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !89, metadata !DIExpression()), !dbg !133

  //   %5 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %5, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !115
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !168, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !227

  //   store atomic i64 0, i64* @atom_1_X6_2 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !197, metadata !DIExpression()), !dbg !258

  //   %8 = load atomic i64, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !154
  // LD: Guess
  old_cr = cr(0,4);
