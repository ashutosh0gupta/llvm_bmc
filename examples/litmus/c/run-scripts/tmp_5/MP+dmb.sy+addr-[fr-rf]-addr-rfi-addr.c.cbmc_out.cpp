...
T2BLOCK1:
  ...
  //   %cmp26 = icmp eq i32 %conv4, 0, !dbg !105
  ...
  //   store i32 %conv27, i32* @atom_1_X3_0, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv8, 1, !dbg !107
  ...
  //   store i32 %conv29, i32* @atom_1_X5_1, align 4, !dbg !108, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X11_0, align 4, !dbg !122, !tbaa !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !174, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !173, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !177, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !179, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !182, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !184, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !187, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !189, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !192, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !193, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !194, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !195, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !196, metadata !DIExpression()), !dbg !206

  //   %14 = load i32, i32* @atom_1_X11_0, align 4, !dbg !154, !tbaa !115
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !197, metadata !DIExpression()), !dbg !206

  //   %and = and i32 %13, %14, !dbg !155
  creg_r27 = max(creg_r25,creg_r26);
  r27 = r25 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !198, metadata !DIExpression()), !dbg !206

  //   %and31 = and i32 %12, %and, !dbg !156
  creg_r28 = max(creg_r24,creg_r27);
  r28 = r24 & r27;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !199, metadata !DIExpression()), !dbg !206

  //   %and32 = and i32 %11, %and31, !dbg !157
  creg_r29 = max(creg_r23,creg_r28);
  r29 = r23 & r28;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !200, metadata !DIExpression()), !dbg !206
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 103, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
