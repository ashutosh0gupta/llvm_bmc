...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !146, metadata !DIExpression()), !dbg !187
  ...
  //   store i32 0, i32* @atom_1_X4_0, align 4, !dbg !104, !tbaa !100
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X8_0, align 4, !dbg !106, !tbaa !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !159, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !164, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !167, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !169, metadata !DIExpression()), !dbg !217
  ...
  //   %10 = load i32, i32* @atom_1_X4_0, align 4, !dbg !131, !tbaa !100
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %12 = load i32, i32* @atom_1_X8_0, align 4, !dbg !133, !tbaa !100
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !174, metadata !DIExpression()), !dbg !181
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
