...
T2BLOCK1:
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !78, metadata !DIExpression()), !dbg !109

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !97
  ...
  //   store i32 %conv25, i32* @atom_1_X3_2, align 4, !dbg !109, !tbaa !102
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv12, 2, !dbg !110
  ...
  //   store i32 %conv27, i32* @atom_1_X4_2, align 4, !dbg !111, !tbaa !102
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv16, 0, !dbg !112
  ...
  //   store i32 %conv29, i32* @atom_1_X6_0, align 4, !dbg !113, !tbaa !102
  // ST: Guess
  ...
  //   store i32 %conv31, i32* @atom_1_X8_0, align 4, !dbg !115, !tbaa !102
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !139, metadata !DIExpression()), !dbg !146
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X3_2, align 4, !dbg !102, !tbaa !97
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_2, align 4, !dbg !103, !tbaa !97
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X6_0, align 4, !dbg !104, !tbaa !97
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X8_0, align 4, !dbg !105, !tbaa !97
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv12, 2, !dbg !124
  ...
  //   %10 = load i32, i32* @atom_1_X3_2, align 4, !dbg !127, !tbaa !97
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X4_2, align 4, !dbg !128, !tbaa !97
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X6_0, align 4, !dbg !129, !tbaa !97
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %13 = load i32, i32* @atom_1_X8_0, align 4, !dbg !130, !tbaa !97
  // LD: Guess
  old_cr = cr(0,7);
