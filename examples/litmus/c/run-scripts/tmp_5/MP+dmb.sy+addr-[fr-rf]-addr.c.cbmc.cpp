...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !134, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !135, metadata !DIExpression()), !dbg !176

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !136, metadata !DIExpression()), !dbg !178

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !140, metadata !DIExpression()), !dbg !180

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !141, metadata !DIExpression()), !dbg !182
  ...
  //   store i32 0, i32* @atom_1_X7_0, align 4, !dbg !106, !tbaa !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !154, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !155, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !159, metadata !DIExpression()), !dbg !208

  //   %conv14 = trunc i64 %7 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !156, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !160, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !162, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !164, metadata !DIExpression()), !dbg !212

  //   %conv20 = trunc i64 %8 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !161, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !166, metadata !DIExpression()), !dbg !176
  ...
  //   %12 = load i32, i32* @atom_1_X7_0, align 4, !dbg !133, !tbaa !100
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !171, metadata !DIExpression()), !dbg !176

  //   %and24 = and i32 %9, %and23, !dbg !136
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !172, metadata !DIExpression()), !dbg !176

  //   %and25 = and i32 %conv22, %and24, !dbg !137
  creg_r24 = max(creg__r16__1_,creg_r23);
  r24 = (r16==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !173, metadata !DIExpression()), !dbg !176

  //   %and26 = and i32 %conv16, %and25, !dbg !138
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !174, metadata !DIExpression()), !dbg !176

  //   %and27 = and i32 %conv10, %and26, !dbg !139
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !175, metadata !DIExpression()), !dbg !176
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
