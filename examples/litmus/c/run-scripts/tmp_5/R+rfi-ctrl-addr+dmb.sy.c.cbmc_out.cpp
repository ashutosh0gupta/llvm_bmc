...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !55), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !49, metadata !DIExpression()), !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !50, metadata !DIExpression()), !dbg !75
  ...
  // ST: Guess
  iw(1,r4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l26_c3
  old_cw = cw(1,r4);
  cw(1,r4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l26_c3
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !112
