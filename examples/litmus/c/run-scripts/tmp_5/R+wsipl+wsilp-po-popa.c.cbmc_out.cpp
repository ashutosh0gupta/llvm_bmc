...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 4, metadata !75, metadata !DIExpression()), !dbg !90

  //   store atomic i64 4, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !59
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X5_0, align 4, !dbg !82, !tbaa !78
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X5_0, align 4, !dbg !100, !tbaa !78
  // LD: Guess
  old_cr = cr(0,3);
  ...
  creg_r11 = max(creg__r5__4_,creg_r10);
  r11 = (r5==4) & r10;
