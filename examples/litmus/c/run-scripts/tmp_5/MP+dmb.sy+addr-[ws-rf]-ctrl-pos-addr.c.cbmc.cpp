...
T2BLOCK4:
  ...
  //   store i32 %conv23, i32* @atom_1_X5_2, align 4, !dbg !105, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X5_2, align 4, !dbg !105, !tbaa !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !169, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !179, metadata !DIExpression()), !dbg !228
  ...
  //   %10 = load i32, i32* @atom_1_X5_2, align 4, !dbg !131, !tbaa !101
  // LD: Guess
  old_cr = cr(0,5);
