...
T2BLOCK1:
  ...
  //   %arrayidx12 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !83
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !73, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !76, metadata !DIExpression()), !dbg !88
  ...
  //   store i32 %conv23, i32* @atom_1_X9_1, align 4, !dbg !98, !tbaa !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X9_1, align 4, !dbg !91, !tbaa !87
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X9_1, align 4, !dbg !110, !tbaa !87
  // LD: Guess
  old_cr = cr(0,4);
