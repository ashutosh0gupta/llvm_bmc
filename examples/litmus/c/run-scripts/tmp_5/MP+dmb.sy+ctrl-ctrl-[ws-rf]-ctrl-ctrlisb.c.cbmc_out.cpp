...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !94), !dbg !101
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !96), !dbg !119
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !97), !dbg !130
  ...
  //   %tobool19 = icmp ne i32 %conv18, 0, !dbg !115

  //   br i1 %tobool19, label %if.then20, label %if.else21, !dbg !117
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK11:
  //   br label %lbl_LC03, !dbg !118
  goto T2BLOCK13;

T2BLOCK12:
  //   br label %lbl_LC03, !dbg !119
  goto T2BLOCK13;

T2BLOCK13:
  //   call void @llvm.dbg.label(metadata !98), !dbg !139

  //   call void (...) @isb(), !dbg !121
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !141

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !123
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !141

  //   %conv25 = trunc i64 %4 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !78, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 1, !dbg !125

  //   %conv26 = zext i1 %cmp to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !82, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !83, metadata !DIExpression()), !dbg !145

  //   %5 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv11, 2, !dbg !128

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !86, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !87, metadata !DIExpression()), !dbg !148

  //   %6 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %6, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv25, 0, !dbg !131

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !90, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !91, metadata !DIExpression()), !dbg !151

  //   %7 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %7, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !133
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !174, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !175, metadata !DIExpression()), !dbg !238

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !176, metadata !DIExpression()), !dbg !240

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !180, metadata !DIExpression()), !dbg !242

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !181, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !182, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !185, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !197, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !200, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !203, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !259

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !207, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !209, metadata !DIExpression()), !dbg !274

  //   %conv = trunc i64 %6 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !206, metadata !DIExpression()), !dbg !238

  //   %cmp = icmp eq i32 %conv, 2, !dbg !145

  //   %conv20 = zext i1 %cmp to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !210, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !212, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !214, metadata !DIExpression()), !dbg !278

  //   %conv24 = trunc i64 %7 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !211, metadata !DIExpression()), !dbg !238

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !149

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !215, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !217, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !219, metadata !DIExpression()), !dbg !282

  //   %conv30 = trunc i64 %8 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !216, metadata !DIExpression()), !dbg !238

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !153

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !220, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !222, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !224, metadata !DIExpression()), !dbg !286

  //   %conv36 = trunc i64 %9 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !221, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !226, metadata !DIExpression()), !dbg !289
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !228, metadata !DIExpression()), !dbg !289

  //   %conv40 = trunc i64 %10 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !225, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !230, metadata !DIExpression()), !dbg !292

  //   %11 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !161
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !232, metadata !DIExpression()), !dbg !292

  //   %conv44 = trunc i64 %11 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !229, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !233, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !234, metadata !DIExpression()), !dbg !238

  //   %and46 = and i32 %conv32, %and45, !dbg !165
  creg_r17 = max(max(creg_r11,0),creg_r16);
  ASSUME(active[creg_r17] == 0);
  r17 = (r11==1) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !235, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !236, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !237, metadata !DIExpression()), !dbg !238
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 95, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
