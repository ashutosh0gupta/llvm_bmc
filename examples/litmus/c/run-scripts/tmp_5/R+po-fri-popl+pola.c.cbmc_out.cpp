...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !41, metadata !DIExpression()), !dbg !69
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !77
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !53, metadata !DIExpression()), !dbg !66

  //   %cmp = icmp eq i32 %conv8, 2, !dbg !81

  //   %conv9 = zext i1 %cmp to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !57, metadata !DIExpression()), !dbg !66

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !58, metadata !DIExpression()), !dbg !82
  ...
  //   %cmp13 = icmp eq i32 %conv, 0, !dbg !84

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !61, metadata !DIExpression()), !dbg !66

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !62, metadata !DIExpression()), !dbg !85

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !64, metadata !DIExpression()), !dbg !85

  //   store atomic i64 %3, i64* @atom_0_X2_0 seq_cst, align 8, !dbg !86
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !91, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !108
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !138, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !144, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !163, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !171, metadata !DIExpression()), !dbg !224
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
