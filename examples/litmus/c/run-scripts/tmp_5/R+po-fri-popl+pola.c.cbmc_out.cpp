...
T1BLOCK1:
  ...
  //   store i32 %conv11, i32* @atom_0_X2_0, align 4, !dbg !82, !tbaa !77
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X2_0, align 4, !dbg !97, !tbaa !93
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_0_X2_0, align 4, !dbg !120, !tbaa !93
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !130
