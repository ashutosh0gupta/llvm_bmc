...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !164, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !165, metadata !DIExpression()), !dbg !210

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !166, metadata !DIExpression()), !dbg !212

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !170, metadata !DIExpression()), !dbg !214

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !171, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !172, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !221
  ...
  //   store i32 0, i32* @atom_1_X4_1, align 4, !dbg !113, !tbaa !108
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X7_0, align 4, !dbg !115, !tbaa !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !181, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !185, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !186, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !190, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !192, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !191, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !195, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !196, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !197, metadata !DIExpression()), !dbg !210

  //   %11 = load i32, i32* @atom_1_X4_1, align 4, !dbg !142, !tbaa !108
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !198, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !199, metadata !DIExpression()), !dbg !210

  //   %13 = load i32, i32* @atom_1_X7_0, align 4, !dbg !144, !tbaa !108
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !200, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !201, metadata !DIExpression()), !dbg !210

  //   %and = and i32 %13, %14, !dbg !146
  creg_r22 = max(creg_r20,creg_r21);
  r22 = r20 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !202, metadata !DIExpression()), !dbg !210

  //   %and23 = and i32 %12, %and, !dbg !147
  creg_r23 = max(creg_r19,creg_r22);
  r23 = r19 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !203, metadata !DIExpression()), !dbg !210

  //   %and24 = and i32 %11, %and23, !dbg !148
  creg_r24 = max(creg_r18,creg_r23);
  r24 = r18 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !204, metadata !DIExpression()), !dbg !210

  //   %and25 = and i32 %10, %and24, !dbg !149
  creg_r25 = max(creg_r17,creg_r24);
  r25 = r17 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !205, metadata !DIExpression()), !dbg !210

  //   %and26 = and i32 %9, %and25, !dbg !150
  creg_r26 = max(creg_r16,creg_r25);
  r26 = r16 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !206, metadata !DIExpression()), !dbg !210

  //   %and27 = and i32 %conv22, %and26, !dbg !151
  creg_r27 = max(creg__r15__1_,creg_r26);
  r27 = (r15==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !207, metadata !DIExpression()), !dbg !210

  //   %and28 = and i32 %conv16, %and27, !dbg !152
  creg_r28 = max(creg__r14__1_,creg_r27);
  r28 = (r14==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !208, metadata !DIExpression()), !dbg !210

  //   %and29 = and i32 %conv10, %and28, !dbg !153
  creg_r29 = max(creg__r13__1_,creg_r28);
  r29 = (r13==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !209, metadata !DIExpression()), !dbg !210
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 106, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !157
