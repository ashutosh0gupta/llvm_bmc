...
T2BLOCK1:
  ...
  //   %xor14 = xor i32 %conv13, %conv13, !dbg !98
  creg_r8 = max(creg_r7,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor14, metadata !80, metadata !DIExpression()), !dbg !98

  //   %add16 = add nsw i32 0, %xor14, !dbg !99
  creg_r9 = max(0,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = 0 + r8;

  //   %idxprom17 = sext i32 %add16 to i64, !dbg !99

  //   %arrayidx18 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom17, !dbg !99
  r10 = 0+r9*1;
  ASSUME(creg_r10 >= 0);
  ASSUME(creg_r10 >= creg_r9);
  ASSUME(active[creg_r10] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx18, metadata !82, metadata !DIExpression()), !dbg !119

  //   %3 = load atomic i64, i64* %arrayidx18 monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !84, metadata !DIExpression()), !dbg !119
  ...
  //   %cmp26 = icmp eq i32 %conv13, 2, !dbg !105
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !160, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !163, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !186, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !190, metadata !DIExpression()), !dbg !245
