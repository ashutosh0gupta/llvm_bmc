...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !95
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !88), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !67, metadata !DIExpression()), !dbg !89

  //   %xor = xor i32 %conv8, %conv8, !dbg !88
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !71, metadata !DIExpression()), !dbg !89
  ...
  //   %add14 = add nsw i32 0, %xor13, !dbg !93
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !93

  //   %arrayidx16 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !93
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !77, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !113

  //   store atomic i64 1, i64* %arrayidx16 monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !80, metadata !DIExpression()), !dbg !89
  ...
  //   %cmp22 = icmp eq i32 %conv4, 2, !dbg !104
  creg__r1__2_ = max(0,creg_r1);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !85, metadata !DIExpression()), !dbg !89

  //   store i32 %conv23, i32* @atom_1_X2_2, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv20, 1, !dbg !106
  creg__r10__1_ = max(0,creg_r10);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !86, metadata !DIExpression()), !dbg !89

  //   store i32 %conv25, i32* @atom_1_X11_1, align 4, !dbg !107, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !148, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !149, metadata !DIExpression()), !dbg !185

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !150, metadata !DIExpression()), !dbg !187

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !154, metadata !DIExpression()), !dbg !189

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !155, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !156, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64 0, metadata !158, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64 0, metadata !161, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !198
  ...
  //   store i32 0, i32* @atom_1_X11_1, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !169, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !168, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !172, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !176, metadata !DIExpression()), !dbg !218

  //   %conv16 = trunc i64 %7 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !173, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !177, metadata !DIExpression()), !dbg !185
  ...
  //   %10 = load i32, i32* @atom_1_X11_1, align 4, !dbg !122, !tbaa !95
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !181, metadata !DIExpression()), !dbg !185

  //   %and19 = and i32 %8, %and, !dbg !124
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !182, metadata !DIExpression()), !dbg !185

  //   %and20 = and i32 %conv18, %and19, !dbg !125
  creg_r22 = max(creg__r16__2_,creg_r21);
  r22 = (r16==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !183, metadata !DIExpression()), !dbg !185

  //   %and21 = and i32 %conv12, %and20, !dbg !126
  creg_r23 = max(creg__r15__2_,creg_r22);
  r23 = (r15==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !184, metadata !DIExpression()), !dbg !185
