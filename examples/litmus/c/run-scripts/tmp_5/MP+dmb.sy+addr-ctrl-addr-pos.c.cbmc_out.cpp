...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !72, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !74, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !107

  //   %conv16 = trunc i64 %3 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !73, metadata !DIExpression()), !dbg !86
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !109
  ...
  //   %cmp22 = icmp eq i32 %conv16, 0, !dbg !99
  ...
  //   store i32 %conv23, i32* @atom_1_X8_0, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X10_0, align 4, !dbg !102, !tbaa !95
  // ST: Guess
