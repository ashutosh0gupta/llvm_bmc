...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !89

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !63
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !98, metadata !DIExpression()), !dbg !109

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !101, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64 1, metadata !103, metadata !DIExpression()), !dbg !113
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !120, metadata !DIExpression()), !dbg !130
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !122, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !124, metadata !DIExpression()), !dbg !133

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !121, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !125, metadata !DIExpression()), !dbg !137

  //   call void @llvm.dbg.value(metadata i64 1, metadata !127, metadata !DIExpression()), !dbg !137

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !128, metadata !DIExpression()), !dbg !130
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !144, metadata !DIExpression()), !dbg !156
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !146, metadata !DIExpression()), !dbg !159

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(5,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !148, metadata !DIExpression()), !dbg !159

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !145, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !163

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(5,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !152, metadata !DIExpression()), !dbg !163

  //   %conv4 = trunc i64 %1 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !149, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !153, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !154, metadata !DIExpression()), !dbg !156

  //   store i32 %conv7, i32* @atom_4_X0_1, align 4, !dbg !74, !tbaa !69
  // ST: Guess
  iw(5,10) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l69_c15
  old_cw = cw(5,10);
  cw(5,10) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l69_c15
  // Check
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !173, metadata !DIExpression()), !dbg !178

  //   br label %label_6, !dbg !51
  goto T6BLOCK1;

T6BLOCK1:
  //   call void @llvm.dbg.label(metadata !177), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 1, metadata !176, metadata !DIExpression()), !dbg !181
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !191, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !192, metadata !DIExpression()), !dbg !228

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !193, metadata !DIExpression()), !dbg !230

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !197, metadata !DIExpression()), !dbg !232

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !198, metadata !DIExpression()), !dbg !234

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !199, metadata !DIExpression()), !dbg !236

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !200, metadata !DIExpression()), !dbg !238

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !201, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !202, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !241

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !205, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !207, metadata !DIExpression()), !dbg !243

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !208, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !210, metadata !DIExpression()), !dbg !245

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !211, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !213, metadata !DIExpression()), !dbg !247

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !214, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !216, metadata !DIExpression()), !dbg !249

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X0_1, align 4, !dbg !108, !tbaa !109
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l92_c15
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l92_c15
  // Check
  ...
  //   store i32 0, i32* @atom_4_X2_0, align 4, !dbg !113, !tbaa !109
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l93_c15
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l93_c15
  // Check
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !115, !tbaa !109
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_3_X0_1, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_4_X0_1, align 4, !dbg !117, !tbaa !109
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l97_c15
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l97_c15
  // Check
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !119
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !120
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !121
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call12 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #7, !dbg !122
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr5, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t5, i8* noundef null) #7, !dbg !123
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i64, i64* %thr0, align 8, !dbg !124, !tbaa !125
  r7 = local_mem[0];

  //   %call14 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !127
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr1, align 8, !dbg !128, !tbaa !125
  r8 = local_mem[1];

  //   %call15 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !129
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load i64, i64* %thr2, align 8, !dbg !130, !tbaa !125
  r9 = local_mem[2];

  //   %call16 = call i32 @pthread_join(i64 noundef %8, i8** noundef null), !dbg !131
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %9 = load i64, i64* %thr3, align 8, !dbg !132, !tbaa !125
  r10 = local_mem[3];

  //   %call17 = call i32 @pthread_join(i64 noundef %9, i8** noundef null), !dbg !133
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %10 = load i64, i64* %thr4, align 8, !dbg !134, !tbaa !125
  r11 = local_mem[4];

  //   %call18 = call i32 @pthread_join(i64 noundef %10, i8** noundef null), !dbg !135
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %11 = load i64, i64* %thr5, align 8, !dbg !136, !tbaa !125
  r12 = local_mem[5];

  //   %call19 = call i32 @pthread_join(i64 noundef %11, i8** noundef null), !dbg !137
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %12 = load i32, i32* @atom_0_X0_1, align 4, !dbg !138, !tbaa !109
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l113_c13
  // Check
  ...
  //   %13 = load i32, i32* @atom_4_X2_0, align 4, !dbg !139, !tbaa !109
  // LD: Guess
  old_cr = cr(0,9);
  cr(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l114_c13
  // Check
  ...
  //   %14 = load i32, i32* @atom_1_X0_1, align 4, !dbg !140, !tbaa !109
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %15 = load i32, i32* @atom_2_X0_1, align 4, !dbg !141, !tbaa !109
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !220, metadata !DIExpression()), !dbg !228

  //   %16 = load i32, i32* @atom_3_X0_1, align 4, !dbg !142, !tbaa !109
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !221, metadata !DIExpression()), !dbg !228

  //   %17 = load i32, i32* @atom_4_X0_1, align 4, !dbg !143, !tbaa !109
  // LD: Guess
  old_cr = cr(0,10);
  cr(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l118_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !222, metadata !DIExpression()), !dbg !228

  //   %and = and i32 %16, %17, !dbg !144
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !223, metadata !DIExpression()), !dbg !228

  //   %and20 = and i32 %15, %and, !dbg !145
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !224, metadata !DIExpression()), !dbg !228

  //   %and21 = and i32 %14, %and20, !dbg !146
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !225, metadata !DIExpression()), !dbg !228

  //   %and22 = and i32 %13, %and21, !dbg !147
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !226, metadata !DIExpression()), !dbg !228

  //   %and23 = and i32 %12, %and22, !dbg !148
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !227, metadata !DIExpression()), !dbg !228

  //   %cmp = icmp eq i32 %and23, 1, !dbg !149
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 124, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !152
...
T0BLOCK2:
  //   %18 = bitcast i64* %thr5 to i8*, !dbg !155

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %18) #7, !dbg !155

  //   %19 = bitcast i64* %thr4 to i8*, !dbg !155

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %19) #7, !dbg !155

  //   %20 = bitcast i64* %thr3 to i8*, !dbg !155

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %20) #7, !dbg !155

  //   %21 = bitcast i64* %thr2 to i8*, !dbg !155

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %21) #7, !dbg !155

  //   %22 = bitcast i64* %thr1 to i8*, !dbg !155

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %22) #7, !dbg !155

  //   %23 = bitcast i64* %thr0 to i8*, !dbg !155

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %23) #7, !dbg !155
