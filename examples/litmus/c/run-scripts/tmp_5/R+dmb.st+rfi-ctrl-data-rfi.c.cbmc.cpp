...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !69, metadata !DIExpression()), !dbg !87
  ...
  //   %conv7 = sext i32 %add to i64, !dbg !88

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !72, metadata !DIExpression()), !dbg !106

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !73, metadata !DIExpression()), !dbg !87
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !144, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !162, metadata !DIExpression()), !dbg !204
