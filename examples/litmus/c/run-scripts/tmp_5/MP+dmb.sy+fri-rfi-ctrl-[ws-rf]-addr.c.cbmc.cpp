...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !101), !dbg !118
  ...
  //   %xor = xor i32 %conv10, %conv10, !dbg !105
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !102
