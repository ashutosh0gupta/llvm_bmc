...
T3BLOCK1:
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !89, metadata !DIExpression()), !dbg !100
  ...
  //   store i32 %conv5, i32* @atom_2_X0_1, align 4, !dbg !64, !tbaa !65
  // ST: Guess
  ...
  //   store i32 %conv7, i32* @atom_2_X2_0, align 4, !dbg !70, !tbaa !65
  // ST: Guess
