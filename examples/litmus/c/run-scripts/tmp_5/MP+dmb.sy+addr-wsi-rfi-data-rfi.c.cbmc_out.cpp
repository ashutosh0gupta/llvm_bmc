...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !64, metadata !DIExpression()), !dbg !95
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !78
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !70, metadata !DIExpression()), !dbg !87

  //   %xor7 = xor i32 %conv6, %conv6, !dbg !82
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !74, metadata !DIExpression()), !dbg !87

  //   %add8 = add nsw i32 %xor7, 1, !dbg !83
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add8, metadata !75, metadata !DIExpression()), !dbg !87
  ...
  //   %conv11 = sext i32 %add8 to i64, !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !82, metadata !DIExpression()), !dbg !105

  //   %conv15 = trunc i64 %2 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !79, metadata !DIExpression()), !dbg !87
  ...
  //   %cmp17 = icmp eq i32 %conv6, 2, !dbg !95
  ...
  //   store i32 %conv18, i32* @atom_1_X6_2, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv15, 1, !dbg !97
  ...
  //   store i32 %conv20, i32* @atom_1_X9_1, align 4, !dbg !98, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X9_1, align 4, !dbg !98, !tbaa !93
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X9_1, align 4, !dbg !121, !tbaa !93
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !130
