...
T2BLOCK7:
  ...
  //   %cmp26 = icmp eq i32 %conv4, 1, !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !90, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !94, metadata !DIExpression()), !dbg !144

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %8, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !126
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !190, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !193, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !214, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !218, metadata !DIExpression()), !dbg !278
