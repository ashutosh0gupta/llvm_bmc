...
T3BLOCK1:
  ...
  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !55
  // ST: Guess
  iw(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l39_c3
  old_cw = cw(3,r7);
  cw(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l39_c3
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !107
