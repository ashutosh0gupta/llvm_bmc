...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !88, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !92, metadata !DIExpression()), !dbg !104

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !60
  // LD: Guess
  old_cr = cr(3,0+3*1);
  cr(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l39_c15
  // Check
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !115, metadata !DIExpression()), !dbg !127
  ...
  // ST: Guess
  iw(4,0+3*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l49_c3
  old_cw = cw(4,0+3*1);
  cw(4,0+3*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l49_c3
  // Check
  ...
  // LD: Guess
  old_cr = cr(4,0+1*1);
  cr(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l51_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !118, metadata !DIExpression()), !dbg !124
  ...
  //   store i32 %conv1, i32* @atom_3_X1_0, align 4, !dbg !61, !tbaa !62
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_3_X1_0, align 4, !dbg !94, !tbaa !90
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_3_X1_0, align 4, !dbg !112, !tbaa !90
  // LD: Guess
  old_cr = cr(0,7);
