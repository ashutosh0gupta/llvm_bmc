...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !86, metadata !DIExpression()), !dbg !104
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !88, metadata !DIExpression()), !dbg !107

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !63
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !90, metadata !DIExpression()), !dbg !107

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !87, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !92, metadata !DIExpression()), !dbg !110

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !66
  // LD: Guess
  old_cr = cr(3,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !94, metadata !DIExpression()), !dbg !110

  //   %conv4 = trunc i64 %1 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !91, metadata !DIExpression()), !dbg !104

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !68

  //   %conv5 = zext i1 %cmp to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !95, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !96, metadata !DIExpression()), !dbg !114

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !98, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %2, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !70
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !99, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !100, metadata !DIExpression()), !dbg !117

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !102, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %3, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !73
  // ST: Guess
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !122, metadata !DIExpression()), !dbg !135
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !123, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !127, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !130, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X1_0, metadata !131, metadata !DIExpression()), !dbg !145
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !163, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !164, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !167, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !173, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !176, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X1_0, metadata !179, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !182, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !185, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !189, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !191, metadata !DIExpression()), !dbg !248

  //   %conv = trunc i64 %8 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !188, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X1_0, metadata !193, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !195, metadata !DIExpression()), !dbg !251

  //   %conv25 = trunc i64 %9 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !192, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !199, metadata !DIExpression()), !dbg !254

  //   %conv29 = trunc i64 %10 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !196, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !201, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !203, metadata !DIExpression()), !dbg !257

  //   %conv33 = trunc i64 %11 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !200, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !204, metadata !DIExpression()), !dbg !207
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
