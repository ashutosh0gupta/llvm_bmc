...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X7_0, align 4, !dbg !88, !tbaa !82
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X3_0, align 4, !dbg !101, !tbaa !82
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %8 = load i32, i32* @atom_1_X5_1, align 4, !dbg !102, !tbaa !82
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %9 = load i32, i32* @atom_1_X7_0, align 4, !dbg !103, !tbaa !82
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([88 x i8], [88 x i8]* @.str.1, i64 0, i64 0), i32 noundef 81, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !110
