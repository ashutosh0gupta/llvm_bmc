...
T2BLOCK7:
  ...
  //   %cmp19 = icmp eq i32 %conv6, 2, !dbg !109
  ...
  //   store i32 %conv20, i32* @atom_1_X5_2, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv13, 0, !dbg !111
  ...
  //   store i32 %conv22, i32* @atom_1_X6_0, align 4, !dbg !112, !tbaa !105
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv17, 1, !dbg !113
  ...
  //   store i32 %conv24, i32* @atom_1_X8_1, align 4, !dbg !114, !tbaa !105
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !138, metadata !DIExpression()), !dbg !145
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !157, metadata !DIExpression()), !dbg !199

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !161, metadata !DIExpression()), !dbg !201

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !162, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !163, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !169, metadata !DIExpression()), !dbg !208
  ...
  //   store i32 0, i32* @atom_1_X5_2, align 4, !dbg !104, !tbaa !100
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X6_0, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !173, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !175, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !176, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !178, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !180, metadata !DIExpression()), !dbg !229

  //   %conv14 = trunc i64 %7 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !177, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !181, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !183, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !182, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !186, metadata !DIExpression()), !dbg !197
  ...
  //   %10 = load i32, i32* @atom_1_X5_2, align 4, !dbg !131, !tbaa !100
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X6_0, align 4, !dbg !132, !tbaa !100
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !192, metadata !DIExpression()), !dbg !197

  //   %and24 = and i32 %9, %and23, !dbg !136
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !193, metadata !DIExpression()), !dbg !197
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 95, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
