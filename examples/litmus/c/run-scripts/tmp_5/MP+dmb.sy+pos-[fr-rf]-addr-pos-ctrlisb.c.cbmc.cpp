...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !118

  //   %conv12 = trunc i64 %3 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !79, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !120
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !130

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv20 = trunc i64 %5 to i32, !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv4, 1, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !91, metadata !DIExpression()), !dbg !137

  //   %7 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !119
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv8, 2, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !95, metadata !DIExpression()), !dbg !140

  //   %8 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %8, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv20, 0, !dbg !123

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !98, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !99, metadata !DIExpression()), !dbg !143

  //   %9 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !101, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !125
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !156
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !166, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !167, metadata !DIExpression()), !dbg !226

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !168, metadata !DIExpression()), !dbg !228

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !172, metadata !DIExpression()), !dbg !230

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !173, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !174, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !177, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !186, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !189, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !192, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !196, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !199, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !201, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !200, metadata !DIExpression()), !dbg !226

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !145

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !204, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !206, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !205, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !210, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !214, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !216, metadata !DIExpression()), !dbg !274

  //   %conv36 = trunc i64 %10 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !213, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !218, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !220, metadata !DIExpression()), !dbg !277

  //   %conv40 = trunc i64 %11 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !217, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !221, metadata !DIExpression()), !dbg !226
