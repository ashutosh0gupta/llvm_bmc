...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !250, metadata !DIExpression()), !dbg !302

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !251, metadata !DIExpression()), !dbg !302

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !252, metadata !DIExpression()), !dbg !304

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !256, metadata !DIExpression()), !dbg !306

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #6, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !257, metadata !DIExpression()), !dbg !308

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #6, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !258, metadata !DIExpression()), !dbg !310

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #6, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !259, metadata !DIExpression()), !dbg !312

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #6, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !260, metadata !DIExpression()), !dbg !314

  //   %6 = bitcast i64* %thr6 to i8*, !dbg !117

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %6) #6, !dbg !117

  //   call void @llvm.dbg.declare(metadata i64* %thr6, metadata !261, metadata !DIExpression()), !dbg !316

  //   %7 = bitcast i64* %thr7 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %7) #6, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr7, metadata !262, metadata !DIExpression()), !dbg !318

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([8 x i64], [8 x i64]* @vars, i64 0, i64 7), metadata !263, metadata !DIExpression()), !dbg !319

  //   call void @llvm.dbg.value(metadata i64 0, metadata !265, metadata !DIExpression()), !dbg !319
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([8 x i64], [8 x i64]* @vars, i64 0, i64 6), metadata !266, metadata !DIExpression()), !dbg !321

  //   call void @llvm.dbg.value(metadata i64 0, metadata !268, metadata !DIExpression()), !dbg !321
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([8 x i64], [8 x i64]* @vars, i64 0, i64 5), metadata !269, metadata !DIExpression()), !dbg !323

  //   call void @llvm.dbg.value(metadata i64 0, metadata !271, metadata !DIExpression()), !dbg !323
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([8 x i64], [8 x i64]* @vars, i64 0, i64 4), metadata !272, metadata !DIExpression()), !dbg !325

  //   call void @llvm.dbg.value(metadata i64 0, metadata !274, metadata !DIExpression()), !dbg !325
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([8 x i64], [8 x i64]* @vars, i64 0, i64 3), metadata !275, metadata !DIExpression()), !dbg !327

  //   call void @llvm.dbg.value(metadata i64 0, metadata !277, metadata !DIExpression()), !dbg !327
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([8 x i64], [8 x i64]* @vars, i64 0, i64 2), metadata !278, metadata !DIExpression()), !dbg !329

  //   call void @llvm.dbg.value(metadata i64 0, metadata !280, metadata !DIExpression()), !dbg !329
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([8 x i64], [8 x i64]* @vars, i64 0, i64 1), metadata !281, metadata !DIExpression()), !dbg !331

  //   call void @llvm.dbg.value(metadata i64 0, metadata !283, metadata !DIExpression()), !dbg !331
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([8 x i64], [8 x i64]* @vars, i64 0, i64 0), metadata !284, metadata !DIExpression()), !dbg !333
  ...
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l122_c15
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l122_c15
  // Check
  ...
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l123_c15
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l123_c15
  // Check
  ...
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l124_c15
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l124_c15
  // Check
  ...
  // ST: Guess
  iw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l125_c15
  old_cw = cw(0,11);
  cw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l125_c15
  // Check
  ...
  // ST: Guess
  iw(0,12) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l126_c15
  old_cw = cw(0,12);
  cw(0,12) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l126_c15
  // Check
  ...
  // ST: Guess
  iw(0,13) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l127_c15
  old_cw = cw(0,13);
  cw(0,13) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l127_c15
  // Check
  ...
  // ST: Guess
  iw(0,14) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l128_c15
  old_cw = cw(0,14);
  cw(0,14) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l128_c15
  // Check
  ...
  // ST: Guess
  iw(0,15) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l129_c15
  old_cw = cw(0,15);
  cw(0,15) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l129_c15
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !149
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !150
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #6, !dbg !151
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #6, !dbg !152
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #6, !dbg !153
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call19 = call i32 @pthread_create(i64* noundef %thr5, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t5, i8* noundef null) #6, !dbg !154
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call20 = call i32 @pthread_create(i64* noundef %thr6, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t6, i8* noundef null) #6, !dbg !155
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call21 = call i32 @pthread_create(i64* noundef %thr7, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t7, i8* noundef null) #6, !dbg !156
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !287, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !288, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i32 %18, metadata !289, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i32 %19, metadata !290, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i32 %20, metadata !291, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i32 %21, metadata !292, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i32 %22, metadata !293, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i32 %23, metadata !294, metadata !DIExpression()), !dbg !302

  //   %and = and i32 %22, %23, !dbg !183
  creg_r25 = max(creg_r23,creg_r24);
  r25 = r23 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !295, metadata !DIExpression()), !dbg !302

  //   %and30 = and i32 %21, %and, !dbg !184
  creg_r26 = max(creg_r22,creg_r25);
  r26 = r22 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !296, metadata !DIExpression()), !dbg !302

  //   %and31 = and i32 %20, %and30, !dbg !185
  creg_r27 = max(creg_r21,creg_r26);
  r27 = r21 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !297, metadata !DIExpression()), !dbg !302

  //   %and32 = and i32 %19, %and31, !dbg !186
  creg_r28 = max(creg_r20,creg_r27);
  r28 = r20 & r27;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !298, metadata !DIExpression()), !dbg !302

  //   %and33 = and i32 %18, %and32, !dbg !187
  creg_r29 = max(creg_r19,creg_r28);
  r29 = r19 & r28;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !299, metadata !DIExpression()), !dbg !302

  //   %and34 = and i32 %17, %and33, !dbg !188
  creg_r30 = max(creg_r18,creg_r29);
  r30 = r18 & r29;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !300, metadata !DIExpression()), !dbg !302

  //   %and35 = and i32 %16, %and34, !dbg !189
  creg_r31 = max(creg_r17,creg_r30);
  r31 = r17 & r30;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !301, metadata !DIExpression()), !dbg !302
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 164, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !193
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %24) #6, !dbg !196

  //   %25 = bitcast i64* %thr6 to i8*, !dbg !196

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %25) #6, !dbg !196

  //   %26 = bitcast i64* %thr5 to i8*, !dbg !196

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %26) #6, !dbg !196

  //   %27 = bitcast i64* %thr4 to i8*, !dbg !196

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %27) #6, !dbg !196

  //   %28 = bitcast i64* %thr3 to i8*, !dbg !196

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %28) #6, !dbg !196

  //   %29 = bitcast i64* %thr2 to i8*, !dbg !196

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %29) #6, !dbg !196

  //   %30 = bitcast i64* %thr1 to i8*, !dbg !196

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %30) #6, !dbg !196

  //   %31 = bitcast i64* %thr0 to i8*, !dbg !196

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %31) #6, !dbg !196
