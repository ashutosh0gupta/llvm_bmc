...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !113, metadata !DIExpression()), !dbg !132

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !114, metadata !DIExpression()), !dbg !132

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !62

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !62

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !115, metadata !DIExpression()), !dbg !134

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !119, metadata !DIExpression()), !dbg !136

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !120, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !121, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i64 0, metadata !123, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !124, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64 0, metadata !126, metadata !DIExpression()), !dbg !141
  ...
  //   store i32 0, i32* @atom_2_X1_0, align 4, !dbg !78, !tbaa !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !127, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !128, metadata !DIExpression()), !dbg !132

  //   %8 = load i32, i32* @atom_2_X1_0, align 4, !dbg !92, !tbaa !73
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !129, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i32 %and8, metadata !131, metadata !DIExpression()), !dbg !132
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([126 x i8], [126 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !98
