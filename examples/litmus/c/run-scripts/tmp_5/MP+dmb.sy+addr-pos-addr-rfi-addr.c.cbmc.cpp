...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !65, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !67, metadata !DIExpression()), !dbg !106

  //   %conv4 = trunc i64 %1 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !72, metadata !DIExpression()), !dbg !98

  //   %add10 = add nsw i32 3, %xor9, !dbg !93
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 3 + r6;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !93

  //   %arrayidx12 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !93
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !73, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !113

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !77, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !76, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !80, metadata !DIExpression()), !dbg !98
  ...
  //   %arrayidx21 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !99
  r12 = 0+r11*1;
  ASSUME(creg_r12 >= 0);
  ASSUME(creg_r12 >= creg_r11);
  ASSUME(active[creg_r12] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !82, metadata !DIExpression()), !dbg !119

  //   %4 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,r12);
  ...
  //   %conv24 = trunc i64 %4 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !81, metadata !DIExpression()), !dbg !98

  //   %cmp = icmp eq i32 %conv, 1, !dbg !102

  //   %conv25 = zext i1 %cmp to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !85, metadata !DIExpression()), !dbg !98
  ...
  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !104
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv16, 1, !dbg !105

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !89, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !90, metadata !DIExpression()), !dbg !125

  //   %6 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !125

  //   store atomic i64 %6, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !107
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv24, 0, !dbg !108

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !93, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !94, metadata !DIExpression()), !dbg !128

  //   %7 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !96, metadata !DIExpression()), !dbg !128

  //   store atomic i64 %7, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !160, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !213

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !163, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !186, metadata !DIExpression()), !dbg !242

  //   %8 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !190, metadata !DIExpression()), !dbg !245
