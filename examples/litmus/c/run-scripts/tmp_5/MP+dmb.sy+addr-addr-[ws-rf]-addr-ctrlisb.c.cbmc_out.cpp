...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !197

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !199

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !201

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !158, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !159, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !162, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !165, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !171, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !175, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !177, metadata !DIExpression()), !dbg !228

  //   %conv = trunc i64 %6 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !174, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !178, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !182, metadata !DIExpression()), !dbg !232

  //   %conv18 = trunc i64 %7 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !179, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !183, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !187, metadata !DIExpression()), !dbg !236

  //   %conv24 = trunc i64 %8 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !184, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !188, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !189, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !190, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !191, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !193, metadata !DIExpression()), !dbg !197

  //   %and28 = and i32 %conv26, %and27, !dbg !140
  creg_r26 = max(creg__r20__1_,creg_r25);
  r26 = (r20==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !194, metadata !DIExpression()), !dbg !197

  //   %and29 = and i32 %conv20, %and28, !dbg !141
  creg_r27 = max(creg__r19__1_,creg_r26);
  r27 = (r19==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !195, metadata !DIExpression()), !dbg !197

  //   %and30 = and i32 %conv14, %and29, !dbg !142
  creg_r28 = max(creg__r18__2_,creg_r27);
  r28 = (r18==2) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !196, metadata !DIExpression()), !dbg !197
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !146
