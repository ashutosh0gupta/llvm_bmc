...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !70, metadata !DIExpression()), !dbg !105
  ...
  //   %conv5 = sext i32 %add to i64, !dbg !104

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !73, metadata !DIExpression()), !dbg !122

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !77, metadata !DIExpression()), !dbg !124

  //   %conv9 = trunc i64 %2 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !74, metadata !DIExpression()), !dbg !105

  //   %tobool10 = icmp ne i32 %conv9, 0, !dbg !108

  //   br i1 %tobool10, label %if.then11, label %if.else12, !dbg !110
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !133

  //   %conv16 = trunc i64 %3 to i32, !dbg !116
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !136

  //   %conv20 = trunc i64 %4 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !82, metadata !DIExpression()), !dbg !105

  //   %cmp = icmp eq i32 %conv, 1, !dbg !120

  //   %conv21 = zext i1 %cmp to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !86, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !140

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !140
  ...
  //   %cmp25 = icmp eq i32 %conv9, 1, !dbg !123

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !90, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !91, metadata !DIExpression()), !dbg !143

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !94, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !95, metadata !DIExpression()), !dbg !146

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !98, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !99, metadata !DIExpression()), !dbg !149

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !149
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !172, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !173, metadata !DIExpression()), !dbg !241

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !174, metadata !DIExpression()), !dbg !243

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !178, metadata !DIExpression()), !dbg !245

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !179, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !180, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !183, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !192, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !195, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !198, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !260

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !201, metadata !DIExpression()), !dbg !262

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !262

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !205, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !207, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !208, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !210, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !212, metadata !DIExpression()), !dbg !281

  //   %conv24 = trunc i64 %7 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !209, metadata !DIExpression()), !dbg !241

  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !156

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !213, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !215, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !217, metadata !DIExpression()), !dbg !285

  //   %conv30 = trunc i64 %8 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !214, metadata !DIExpression()), !dbg !241

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !160

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !218, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !220, metadata !DIExpression()), !dbg !289
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !222, metadata !DIExpression()), !dbg !289

  //   %conv36 = trunc i64 %9 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !219, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !224, metadata !DIExpression()), !dbg !292

  //   %10 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !226, metadata !DIExpression()), !dbg !292

  //   %conv40 = trunc i64 %10 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !223, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !228, metadata !DIExpression()), !dbg !295

  //   %11 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !168
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !230, metadata !DIExpression()), !dbg !295

  //   %conv44 = trunc i64 %11 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !227, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !232, metadata !DIExpression()), !dbg !298

  //   %12 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !171
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !234, metadata !DIExpression()), !dbg !298

  //   %conv48 = trunc i64 %12 to i32, !dbg !172

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !231, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !236, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %and50, metadata !237, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !238, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !239, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !240, metadata !DIExpression()), !dbg !241
