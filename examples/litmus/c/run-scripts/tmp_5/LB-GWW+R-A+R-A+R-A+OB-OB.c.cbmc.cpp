...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !145, metadata !DIExpression()), !dbg !158
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !147, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !149, metadata !DIExpression()), !dbg !161

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !146, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !150, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64 1, metadata !152, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !153, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !154, metadata !DIExpression()), !dbg !168

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !156, metadata !DIExpression()), !dbg !168
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !173, metadata !DIExpression()), !dbg !191

  //   br label %label_6, !dbg !64
  goto T6BLOCK1;

T6BLOCK1:
  //   call void @llvm.dbg.label(metadata !190), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !175, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !177, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !179, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !181, metadata !DIExpression()), !dbg !198

  //   %conv4 = trunc i64 %1 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !178, metadata !DIExpression()), !dbg !191

  //   %cmp = icmp eq i32 %conv, 1, !dbg !73

  //   %conv5 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !182, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !183, metadata !DIExpression()), !dbg !202

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !185, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !186, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !187, metadata !DIExpression()), !dbg !205

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !189, metadata !DIExpression()), !dbg !205
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !247, metadata !DIExpression()), !dbg !318
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !267, metadata !DIExpression()), !dbg !353
