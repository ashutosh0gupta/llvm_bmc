...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !78, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !82, metadata !DIExpression()), !dbg !92

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !53
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  cr(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l36_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !84, metadata !DIExpression()), !dbg !92
  ...
  // ST: Guess
  iw(3,4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l38_c15
  old_cw = cw(3,4);
  cw(3,4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l38_c15
  // Check
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !103, metadata !DIExpression()), !dbg !111
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !147, metadata !DIExpression()), !dbg !191
