...
T2BLOCK1:
  ...
  //   %conv1 = sext i32 %conv to i64, !dbg !59

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !59, metadata !DIExpression()), !dbg !71

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !59
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !60, metadata !DIExpression()), !dbg !65
