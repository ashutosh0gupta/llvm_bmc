...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X2_1, align 4, !dbg !86, !tbaa !82
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_0_X2_1, align 4, !dbg !105, !tbaa !82
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([100 x i8], [100 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !114
