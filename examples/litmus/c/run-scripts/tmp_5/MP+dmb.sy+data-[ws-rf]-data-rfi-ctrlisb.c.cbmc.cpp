...
T2BLOCK4:
  ...
  //   %cmp23 = icmp eq i32 %conv5, 2, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !92, metadata !DIExpression()), !dbg !139

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !94, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %5, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv14, 1, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !96, metadata !DIExpression()), !dbg !142
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !151, metadata !DIExpression()), !dbg !158
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !191, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !194, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !225, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !229, metadata !DIExpression()), !dbg !301
