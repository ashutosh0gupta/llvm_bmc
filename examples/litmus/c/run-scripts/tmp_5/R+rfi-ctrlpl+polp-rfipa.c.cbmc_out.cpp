...
T1BLOCK4:
  ...
  //   %cmp8 = icmp eq i32 %conv, 2, !dbg !85
  ...
  //   store i32 %conv9, i32* @atom_0_X2_2, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !90, metadata !DIExpression()), !dbg !108
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !91, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !94, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !100, metadata !DIExpression()), !dbg !115

  //   %conv = trunc i64 %0 to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !97, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !102, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !104, metadata !DIExpression()), !dbg !118

  //   %conv6 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !101, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !105, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !106, metadata !DIExpression()), !dbg !108
