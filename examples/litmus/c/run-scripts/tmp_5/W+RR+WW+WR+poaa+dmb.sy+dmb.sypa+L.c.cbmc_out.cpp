...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !140, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !141, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64 0, metadata !146, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !147, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64 0, metadata !149, metadata !DIExpression()), !dbg !174
  ...
  //   store i32 0, i32* @atom_3_X2_0, align 4, !dbg !92, !tbaa !87
  // ST: Guess
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !153, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !154, metadata !DIExpression()), !dbg !161

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !111, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %10 = load i32, i32* @atom_1_X2_0, align 4, !dbg !112, !tbaa !87
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_3_X2_0, align 4, !dbg !113, !tbaa !87
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !159, metadata !DIExpression()), !dbg !161
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !120
