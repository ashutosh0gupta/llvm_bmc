...
T1BLOCK1:
  ...
  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !47
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !63, metadata !DIExpression()), !dbg !77
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !93, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !94, metadata !DIExpression()), !dbg !113

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !59

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !59

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !95, metadata !DIExpression()), !dbg !115

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !61

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !61

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !99, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !100, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64 0, metadata !102, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !103, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64 0, metadata !105, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !107, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !109, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !110, metadata !DIExpression()), !dbg !113
  ...
  creg_r9 = max(creg__r7__3_,creg_r8);
  r9 = (r7==3) & r8;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !89
