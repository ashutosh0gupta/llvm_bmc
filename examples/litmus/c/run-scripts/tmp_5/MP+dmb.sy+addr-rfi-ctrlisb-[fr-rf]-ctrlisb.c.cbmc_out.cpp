...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !142
  ...
  //   %conv19 = trunc i64 %4 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !83, metadata !DIExpression()), !dbg !110

  //   %cmp = icmp eq i32 %conv, 1, !dbg !126

  //   %conv20 = zext i1 %cmp to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !87, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !146

  //   %5 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !128
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv4, 1, !dbg !129

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !91, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !92, metadata !DIExpression()), !dbg !149

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %6, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !96, metadata !DIExpression()), !dbg !152

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %7, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !100, metadata !DIExpression()), !dbg !155

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %8, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !137
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv19, 0, !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !104, metadata !DIExpression()), !dbg !158

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !106, metadata !DIExpression()), !dbg !158

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !140
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !164, metadata !DIExpression()), !dbg !171
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !181, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !182, metadata !DIExpression()), !dbg !264

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !183, metadata !DIExpression()), !dbg !266

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !187, metadata !DIExpression()), !dbg !268

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !188, metadata !DIExpression()), !dbg !270

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !189, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !192, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !195, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !198, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !204, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !207, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !210, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !213, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !217, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !219, metadata !DIExpression()), !dbg !302

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !216, metadata !DIExpression()), !dbg !264

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !220, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !222, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !224, metadata !DIExpression()), !dbg !306

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !221, metadata !DIExpression()), !dbg !264

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !225, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !227, metadata !DIExpression()), !dbg !310
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !229, metadata !DIExpression()), !dbg !310

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !226, metadata !DIExpression()), !dbg !264

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !230, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !232, metadata !DIExpression()), !dbg !314
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !234, metadata !DIExpression()), !dbg !314

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !231, metadata !DIExpression()), !dbg !264

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !235, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !237, metadata !DIExpression()), !dbg !318
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !239, metadata !DIExpression()), !dbg !318

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !236, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !241, metadata !DIExpression()), !dbg !321
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !243, metadata !DIExpression()), !dbg !321

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !240, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !245, metadata !DIExpression()), !dbg !324
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !247, metadata !DIExpression()), !dbg !324

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !244, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !249, metadata !DIExpression()), !dbg !327
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !251, metadata !DIExpression()), !dbg !327

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !248, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !253, metadata !DIExpression()), !dbg !330
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !255, metadata !DIExpression()), !dbg !330

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !252, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !256, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !257, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !258, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !259, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !260, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !261, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !262, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !263, metadata !DIExpression()), !dbg !264
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 107, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
