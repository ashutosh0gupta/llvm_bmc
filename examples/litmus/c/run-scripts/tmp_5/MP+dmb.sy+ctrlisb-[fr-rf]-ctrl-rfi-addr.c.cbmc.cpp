...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !109), !dbg !134

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !135

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv4, 0, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !92, metadata !DIExpression()), !dbg !148

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv8, 1, !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !96, metadata !DIExpression()), !dbg !151

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !133
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !163, metadata !DIExpression()), !dbg !170
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !206, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !240, metadata !DIExpression()), !dbg !320
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !244, metadata !DIExpression()), !dbg !323
