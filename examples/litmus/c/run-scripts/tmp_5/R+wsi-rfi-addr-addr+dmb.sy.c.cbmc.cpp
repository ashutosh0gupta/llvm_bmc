...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !53, metadata !DIExpression()), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx11, metadata !54, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !57, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !58, metadata !DIExpression()), !dbg !80

  //   %2 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !60, metadata !DIExpression()), !dbg !80

  //   store atomic i64 %2, i64* @atom_0_X3_2 seq_cst, align 8, !dbg !81
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !134, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !151, metadata !DIExpression()), !dbg !194
