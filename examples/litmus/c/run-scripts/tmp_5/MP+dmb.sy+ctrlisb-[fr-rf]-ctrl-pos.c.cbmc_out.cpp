...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !131

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !131

  //   %conv15 = trunc i64 %3 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !75, metadata !DIExpression()), !dbg !106
  ...
  //   %cmp32 = icmp eq i32 %conv15, 0, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !96, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !100, metadata !DIExpression()), !dbg !150

  //   %9 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %9, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !132
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !199, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !202, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !233, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !237, metadata !DIExpression()), !dbg !307
