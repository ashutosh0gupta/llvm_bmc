...
T3BLOCK1:
  ...
  //   : Acquire
  old_cr = cr(3,0+1*1);
  cr(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l33_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !73, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !77, metadata !DIExpression()), !dbg !80

  //   store i32 %conv5, i32* @atom_2_X0_1, align 4, !dbg !59, !tbaa !60
  // ST: Guess
  iw(3,2) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l36_c15
  old_cw = cw(3,2);
  cw(3,2) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l36_c15
  // Check
  ASSUME(active[iw(3,2)] == 3);
  ASSUME(active[cw(3,2)] == 3);
  ASSUME(sforbid(2,cw(3,2))== 0);
  ASSUME(iw(3,2) >= creg__r0__1_);
  ASSUME(iw(3,2) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !78, metadata !DIExpression()), !dbg !80

  //   store i32 %conv7, i32* @atom_2_X2_1, align 4, !dbg !65, !tbaa !60
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !74, !tbaa !75
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_2_X2_1, align 4, !dbg !79, !tbaa !75
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_2_X0_1, align 4, !dbg !95, !tbaa !75
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %8 = load i32, i32* @atom_2_X2_1, align 4, !dbg !96, !tbaa !75
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !102
