...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !87, metadata !DIExpression()), !dbg !138

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !91, metadata !DIExpression()), !dbg !141

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !123
  // ST: Guess
