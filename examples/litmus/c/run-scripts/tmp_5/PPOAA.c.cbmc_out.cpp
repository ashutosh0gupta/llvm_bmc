...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X5_1, align 4, !dbg !79, !tbaa !75
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X7_0, align 4, !dbg !80, !tbaa !75
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_1_X5_1, align 4, !dbg !90, !tbaa !75
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %6 = load i32, i32* @atom_1_X7_0, align 4, !dbg !91, !tbaa !75
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !97
