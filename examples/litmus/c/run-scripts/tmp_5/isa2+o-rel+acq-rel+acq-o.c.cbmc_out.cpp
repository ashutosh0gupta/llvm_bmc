...
T1BLOCK1:
  ...
  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !50
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !51

  //   call void @llvm.dbg.value(metadata i64 4, metadata !44, metadata !DIExpression()), !dbg !51

  //   store atomic i64 4, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !52
  // ST: Guess
  //   : Release
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !59, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_4, metadata !66, metadata !DIExpression()), !dbg !79

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !68, metadata !DIExpression()), !dbg !79

  //   store atomic i64 %1, i64* @atom_1_X0_4 seq_cst, align 8, !dbg !62
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !90, metadata !DIExpression()), !dbg !108

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !64
  // LD: Guess
  old_cr = cr(3,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !94, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_1, metadata !98, metadata !DIExpression()), !dbg !115

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !100, metadata !DIExpression()), !dbg !115

  //   store atomic i64 %3, i64* @atom_2_X2_1 seq_cst, align 8, !dbg !71
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !138, metadata !DIExpression()), !dbg !174

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !141, metadata !DIExpression()), !dbg !176

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  caddr[0] = max(caddr[0],0);
  buff(0,0+1*1) = 1;
  mem(0+1*1,cw(0,0+1*1)) = 1;
  co(0+1*1,cw(0,0+1*1))+=1;
  delta(0+1*1,cw(0,0+1*1)) = -1;
  ASSUME(creturn[0] >= cw(0,0+1*1));

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_4, metadata !142, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !178

  //   store atomic i64 0, i64* @atom_1_X0_4 monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !145, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_1, metadata !148, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !182

  //   store atomic i64 0, i64* @atom_2_X2_1 monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_4, metadata !152, metadata !DIExpression()), !dbg !197

  //   %6 = load atomic i64, i64* @atom_1_X0_4 seq_cst, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !154, metadata !DIExpression()), !dbg !197

  //   %conv = trunc i64 %6 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !151, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !156, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !158, metadata !DIExpression()), !dbg !200

  //   %conv19 = trunc i64 %7 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !155, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_1, metadata !160, metadata !DIExpression()), !dbg !203

  //   %8 = load atomic i64, i64* @atom_2_X2_1 seq_cst, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !159, metadata !DIExpression()), !dbg !165
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
