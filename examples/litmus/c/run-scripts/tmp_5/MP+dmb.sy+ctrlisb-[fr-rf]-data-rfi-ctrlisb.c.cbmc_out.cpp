...
T2BLOCK7:
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !126
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !87, metadata !DIExpression()), !dbg !144

  //   %conv20 = trunc i64 %4 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !84, metadata !DIExpression()), !dbg !111

  //   %cmp = icmp eq i32 %conv, 1, !dbg !128

  //   %conv21 = zext i1 %cmp to i32, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv4, 0, !dbg !131

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !92, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !93, metadata !DIExpression()), !dbg !151

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !133
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv8, 1, !dbg !134

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !96, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !97, metadata !DIExpression()), !dbg !154

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !136
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv13, 1, !dbg !137

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !100, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !101, metadata !DIExpression()), !dbg !157

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !103, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %8, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !139
  // ST: Guess
  ...
  //   %cmp40 = icmp eq i32 %conv20, 0, !dbg !140

  //   %conv41 = zext i1 %cmp40 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv41, metadata !104, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !105, metadata !DIExpression()), !dbg !160

  //   %9 = zext i32 %conv41 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !107, metadata !DIExpression()), !dbg !160

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !142
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !166, metadata !DIExpression()), !dbg !173
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !183, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !184, metadata !DIExpression()), !dbg !266

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !185, metadata !DIExpression()), !dbg !268

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !189, metadata !DIExpression()), !dbg !270

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !190, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !191, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !194, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !200, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !203, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !206, metadata !DIExpression()), !dbg !283

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !209, metadata !DIExpression()), !dbg !285

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !212, metadata !DIExpression()), !dbg !287

  //   call void @llvm.dbg.value(metadata i64 0, metadata !214, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !215, metadata !DIExpression()), !dbg !289

  //   call void @llvm.dbg.value(metadata i64 0, metadata !217, metadata !DIExpression()), !dbg !289
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !219, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !221, metadata !DIExpression()), !dbg !304

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !218, metadata !DIExpression()), !dbg !266

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !222, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !224, metadata !DIExpression()), !dbg !308
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !226, metadata !DIExpression()), !dbg !308

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !223, metadata !DIExpression()), !dbg !266

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !227, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !229, metadata !DIExpression()), !dbg !312
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !231, metadata !DIExpression()), !dbg !312

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !228, metadata !DIExpression()), !dbg !266

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !232, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !234, metadata !DIExpression()), !dbg !316
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !236, metadata !DIExpression()), !dbg !316

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !233, metadata !DIExpression()), !dbg !266

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !237, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !241, metadata !DIExpression()), !dbg !320

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !238, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !245, metadata !DIExpression()), !dbg !323

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !242, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !247, metadata !DIExpression()), !dbg !326
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !249, metadata !DIExpression()), !dbg !326

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !246, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !251, metadata !DIExpression()), !dbg !329
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !253, metadata !DIExpression()), !dbg !329

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !250, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !255, metadata !DIExpression()), !dbg !332
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !257, metadata !DIExpression()), !dbg !332

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !254, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !259, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !260, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !261, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !262, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !263, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !264, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !265, metadata !DIExpression()), !dbg !266
