...
T2BLOCK1:
  ...
  //   %xor7 = xor i32 %conv6, %conv6, !dbg !85
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !76, metadata !DIExpression()), !dbg !90

  //   %add9 = add nsw i32 0, %xor7, !dbg !86
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom10 = sext i32 %add9 to i64, !dbg !86

  //   %arrayidx11 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom10, !dbg !86
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx11, metadata !78, metadata !DIExpression()), !dbg !106

  //   %2 = load atomic i64, i64* %arrayidx11 monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   %cmp22 = icmp eq i32 %conv14, 0, !dbg !100
  ...
  //   store i32 %conv23, i32* @atom_1_X8_0, align 4, !dbg !101, !tbaa !94
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X10_0, align 4, !dbg !103, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X8_0, align 4, !dbg !102, !tbaa !97
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X10_0, align 4, !dbg !103, !tbaa !97
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X8_0, align 4, !dbg !126, !tbaa !97
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X10_0, align 4, !dbg !127, !tbaa !97
  // LD: Guess
  old_cr = cr(0,6);
