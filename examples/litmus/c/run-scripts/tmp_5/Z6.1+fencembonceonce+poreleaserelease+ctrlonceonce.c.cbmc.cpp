...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !133, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !134, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !138, metadata !DIExpression()), !dbg !172

  //   %conv14 = trunc i64 %7 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !135, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !139, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !142, metadata !DIExpression()), !dbg !143
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([135 x i8], [135 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
