...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !50
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !53

  //   call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !53

  //   store atomic i64 1, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !54
  // ST: Guess
  ...
  //   store i32 %conv1, i32* @atom_0_X0_2, align 4, !dbg !56, !tbaa !57
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !66, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64 2, metadata !71, metadata !DIExpression()), !dbg !80

  //   store atomic i64 2, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !54
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !92, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !93, metadata !DIExpression()), !dbg !105

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !54

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !54

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !94, metadata !DIExpression()), !dbg !107

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !56

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !56

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !98, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !99, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 0, metadata !101, metadata !DIExpression()), !dbg !110

  //   store atomic i64 0, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !59
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X0_2, align 4, !dbg !60, !tbaa !61
  // ST: Guess
  iw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l41_c15
  old_cw = cw(0,1);
  cw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l41_c15
  // Check
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !65, !tbaa !61
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !66
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call1 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !67
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !68, !tbaa !69
  r3 = local_mem[0];

  //   %call2 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !71
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !72, !tbaa !69
  r4 = local_mem[1];

  //   %call3 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !73
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i32, i32* @atom_0_X0_2, align 4, !dbg !74, !tbaa !61
  // LD: Guess
  old_cr = cr(0,1);
  cr(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l50_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !102, metadata !DIExpression()), !dbg !105

  //   %5 = load i32, i32* @atom_1_X0_1, align 4, !dbg !75, !tbaa !61
  // LD: Guess
  old_cr = cr(0,2);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 53, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !80
...
T0BLOCK2:
  //   %6 = bitcast i64* %thr1 to i8*, !dbg !83

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %6) #7, !dbg !83

  //   %7 = bitcast i64* %thr0 to i8*, !dbg !83

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %7) #7, !dbg !83
