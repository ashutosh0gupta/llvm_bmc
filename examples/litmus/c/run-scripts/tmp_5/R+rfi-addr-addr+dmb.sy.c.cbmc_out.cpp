...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !50, metadata !DIExpression()), !dbg !59

  //   %add7 = add nsw i32 2, %xor5, !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !51, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !54, metadata !DIExpression()), !dbg !59

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !55, metadata !DIExpression()), !dbg !75

  //   %2 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !57, metadata !DIExpression()), !dbg !75

  //   store atomic i64 %2, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !76
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !89, metadata !DIExpression()), !dbg !103
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !129, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !132, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !146, metadata !DIExpression()), !dbg !189
