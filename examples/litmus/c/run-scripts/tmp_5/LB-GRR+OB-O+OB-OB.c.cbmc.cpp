...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !95, metadata !DIExpression()), !dbg !108
  ...
  // LD: Guess
  old_cr = cr(3,0+3*1);
  cr(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l44_c16
  // Check
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !122, metadata !DIExpression()), !dbg !130
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !123, metadata !DIExpression()), !dbg !133
  ...
  // ST: Guess
  iw(4,0+3*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l54_c3
  old_cw = cw(4,0+3*1);
  cw(4,0+3*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l54_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !126, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64 1, metadata !128, metadata !DIExpression()), !dbg !136

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !56
  // ST: Guess
  iw(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l56_c3
  old_cw = cw(4,0+1*1);
  cw(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l56_c3
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !121
