...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64 2, metadata !72, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !76, metadata !DIExpression()), !dbg !82
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !102, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !103, metadata !DIExpression()), !dbg !139

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !104, metadata !DIExpression()), !dbg !141

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !108, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !109, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64 0, metadata !111, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !112, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i64 0, metadata !114, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !115, metadata !DIExpression()), !dbg !148
  ...
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l46_c15
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l46_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !121, metadata !DIExpression()), !dbg !160

  //   %conv = trunc i64 %4 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !118, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !122, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !124, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !126, metadata !DIExpression()), !dbg !164

  //   %conv12 = trunc i64 %5 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !123, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !127, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !129, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !131, metadata !DIExpression()), !dbg !168

  //   %conv18 = trunc i64 %6 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !128, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !132, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !133, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !134, metadata !DIExpression()), !dbg !139

  //   %and = and i32 %7, %8, !dbg !116
  creg_r10 = max(creg_r8,creg_r9);
  r10 = r8 & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !135, metadata !DIExpression()), !dbg !139

  //   %and21 = and i32 %conv20, %and, !dbg !117
  creg_r11 = max(creg__r7__1_,creg_r10);
  r11 = (r7==1) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !136, metadata !DIExpression()), !dbg !139

  //   %and22 = and i32 %conv14, %and21, !dbg !118
  creg_r12 = max(creg__r6__2_,creg_r11);
  r12 = (r6==2) & r11;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !137, metadata !DIExpression()), !dbg !139
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
