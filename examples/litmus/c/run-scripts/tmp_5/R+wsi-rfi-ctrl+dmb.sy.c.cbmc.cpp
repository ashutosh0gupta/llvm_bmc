...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !37, metadata !DIExpression()), !dbg !57
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !43, metadata !DIExpression()), !dbg !59

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !60
  // ST: Guess
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !53), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !48, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !51, metadata !DIExpression()), !dbg !54

  //   store i32 %conv5, i32* @atom_0_X3_2, align 4, !dbg !73, !tbaa !74
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X3_2, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X3_2, align 4, !dbg !99, !tbaa !78
  // LD: Guess
  old_cr = cr(0,2);
