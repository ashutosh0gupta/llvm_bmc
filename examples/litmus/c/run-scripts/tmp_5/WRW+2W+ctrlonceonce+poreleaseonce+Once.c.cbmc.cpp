...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !107, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !108, metadata !DIExpression()), !dbg !134

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !109, metadata !DIExpression()), !dbg !136

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !68

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !68

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !113, metadata !DIExpression()), !dbg !138

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !114, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !124, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !125, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !129, metadata !DIExpression()), !dbg !161

  //   %conv12 = trunc i64 %7 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !126, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !130, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !133, metadata !DIExpression()), !dbg !134
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !106
