...
T2BLOCK1:
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !51
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !55, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64 1, metadata !57, metadata !DIExpression()), !dbg !67
  ...
  //   store i32 %conv1, i32* @atom_1_X0_2, align 4, !dbg !57, !tbaa !58
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !78, metadata !DIExpression()), !dbg !88
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !80, metadata !DIExpression()), !dbg !91

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !51
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !82, metadata !DIExpression()), !dbg !91

  //   %conv = trunc i64 %0 to i32, !dbg !52

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !79, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !83, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64 1, metadata !85, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !86, metadata !DIExpression()), !dbg !88
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !93, !tbaa !89
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_2_X0_1, align 4, !dbg !117, !tbaa !89
  // LD: Guess
  old_cr = cr(0,4);
