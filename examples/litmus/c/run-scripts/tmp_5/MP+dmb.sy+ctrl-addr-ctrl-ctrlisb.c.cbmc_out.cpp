...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !138, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !139, metadata !DIExpression()), !dbg !175

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !140, metadata !DIExpression()), !dbg !177

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !144, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !145, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !148, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !151, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !154, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !157, metadata !DIExpression()), !dbg !188
  ...
  //   store i32 0, i32* @atom_1_X9_0, align 4, !dbg !97, !tbaa !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !161, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !163, metadata !DIExpression()), !dbg !200

  //   %conv = trunc i64 %4 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !160, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !164, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !166, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !168, metadata !DIExpression()), !dbg !204

  //   %conv16 = trunc i64 %5 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !165, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !169, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !170, metadata !DIExpression()), !dbg !175

  //   %7 = load i32, i32* @atom_1_X9_0, align 4, !dbg !115, !tbaa !93
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !171, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !173, metadata !DIExpression()), !dbg !175

  //   %and20 = and i32 %conv12, %and19, !dbg !118
  creg_r17 = max(creg__r11__1_,creg_r16);
  r17 = (r11==1) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !174, metadata !DIExpression()), !dbg !175
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !122
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #6, !dbg !125

  //   %9 = bitcast i64* %thr0 to i8*, !dbg !125

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #6, !dbg !125
