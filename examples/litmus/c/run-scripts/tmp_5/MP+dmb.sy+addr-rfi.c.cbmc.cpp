...
T2BLOCK1:
  ...
  //   %cmp6 = icmp eq i32 %conv4, 1, !dbg !71
  ...
  //   store i32 %conv7, i32* @atom_1_X5_1, align 4, !dbg !72, !tbaa !67
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !114, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !116, metadata !DIExpression()), !dbg !147

  //   %conv = trunc i64 %4 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !113, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !117, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !119, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !121, metadata !DIExpression()), !dbg !151

  //   %conv10 = trunc i64 %5 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !118, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !122, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !123, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !124, metadata !DIExpression()), !dbg !128

  //   %and = and i32 %6, %7, !dbg !101
  creg_r12 = max(creg_r10,creg_r11);
  r12 = r10 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !125, metadata !DIExpression()), !dbg !128

  //   %and13 = and i32 %conv12, %and, !dbg !102
  creg_r13 = max(creg__r9__1_,creg_r12);
  r13 = (r9==1) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !126, metadata !DIExpression()), !dbg !128

  //   %and14 = and i32 %conv6, %and13, !dbg !103
  creg_r14 = max(creg__r8__2_,creg_r13);
  r14 = (r8==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !127, metadata !DIExpression()), !dbg !128
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !107
