...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !65, metadata !DIExpression()), !dbg !82

  //   %xor = xor i32 %conv8, %conv8, !dbg !81
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !82

  //   %add = add nsw i32 %xor, 1, !dbg !82
  creg_r4 = max(0,creg_r3);
  r4 = r3 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !70, metadata !DIExpression()), !dbg !82

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !102

  //   %conv9 = sext i32 %add to i64, !dbg !84

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !73, metadata !DIExpression()), !dbg !102

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !74, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !78, metadata !DIExpression()), !dbg !82

  //   store i32 %conv14, i32* @atom_1_X0_1, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv13, 1, !dbg !94
  ...
  //   store i32 %conv16, i32* @atom_1_X7_1, align 4, !dbg !95, !tbaa !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !123, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !124, metadata !DIExpression()), !dbg !154

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !125, metadata !DIExpression()), !dbg !156

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !129, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !130, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !133, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !136, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !143, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !145, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !144, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !148, metadata !DIExpression()), !dbg !154
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !112
