...
T4BLOCK1:
  ...
  //   : Acquire
  old_cr = cr(4,0);
  cr(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l49_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !113, metadata !DIExpression()), !dbg !124
  ...
  // ST: Guess
  iw(4,6) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l53_c15
  old_cw = cw(4,6);
  cw(4,6) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l53_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !139, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !140, metadata !DIExpression()), !dbg !164

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !141, metadata !DIExpression()), !dbg !166

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !145, metadata !DIExpression()), !dbg !168

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !146, metadata !DIExpression()), !dbg !170

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !147, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !148, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 0, metadata !153, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !154, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %and12, metadata !162, metadata !DIExpression()), !dbg !164

  //   %and13 = and i32 %8, %and12, !dbg !112
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !163, metadata !DIExpression()), !dbg !164
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
