...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !80, metadata !DIExpression()), !dbg !91

  //   %add19 = add nsw i32 0, %xor17, !dbg !104
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom = sext i32 %add19 to i64, !dbg !104

  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !104
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !82, metadata !DIExpression()), !dbg !124

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,r8);
  cr(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l41_c17
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !181, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !186, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !242
