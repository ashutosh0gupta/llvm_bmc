...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_3_X0_1, align 4, !dbg !91, !tbaa !87
  // ST: Guess
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   %10 = load i32, i32* @atom_3_X0_1, align 4, !dbg !112, !tbaa !87
  // LD: Guess
  old_cr = cr(0,4);
