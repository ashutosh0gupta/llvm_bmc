...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X2_1, align 4, !dbg !80, !tbaa !81
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X2_1, align 4, !dbg !97, !tbaa !81
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !124, metadata !DIExpression()), !dbg !139

  //   %7 = load i32, i32* @atom_1_X2_1, align 4, !dbg !98, !tbaa !81
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !125, metadata !DIExpression()), !dbg !139
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !129, metadata !DIExpression()), !dbg !165

  //   %conv = trunc i64 %8 to i32, !dbg !101
  ...
  //   %conv8 = zext i1 %cmp to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !130, metadata !DIExpression()), !dbg !139
  ...
  //   %9 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !134, metadata !DIExpression()), !dbg !169

  //   %conv12 = trunc i64 %9 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !131, metadata !DIExpression()), !dbg !139

  //   %cmp13 = icmp eq i32 %conv12, 2, !dbg !106
  creg__r9__2_ = max(0,creg_r9);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !135, metadata !DIExpression()), !dbg !139

  //   %and = and i32 %conv8, %conv14, !dbg !107
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([91 x i8], [91 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !113
