...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !100, metadata !DIExpression()), !dbg !130

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !101, metadata !DIExpression()), !dbg !130

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !102, metadata !DIExpression()), !dbg !132

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !106, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !107, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64 0, metadata !109, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !137
  ...
  //   store i32 0, i32* @atom_0_X2_2, align 4, !dbg !86, !tbaa !82
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X2_2, align 4, !dbg !87, !tbaa !82
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_0_X0_1, align 4, !dbg !96, !tbaa !82
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !113, metadata !DIExpression()), !dbg !130

  //   %5 = load i32, i32* @atom_0_X2_2, align 4, !dbg !97, !tbaa !82
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !114, metadata !DIExpression()), !dbg !130

  //   %6 = load i32, i32* @atom_1_X2_2, align 4, !dbg !98, !tbaa !82
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !115, metadata !DIExpression()), !dbg !130

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !117, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !119, metadata !DIExpression()), !dbg !153

  //   %conv = trunc i64 %7 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !116, metadata !DIExpression()), !dbg !130

  //   %cmp = icmp eq i32 %conv, 1, !dbg !102
  creg__r10__1_ = max(0,creg_r10);

  //   %conv6 = zext i1 %cmp to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !120, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !124, metadata !DIExpression()), !dbg !157

  //   %conv10 = trunc i64 %8 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !121, metadata !DIExpression()), !dbg !130

  //   %cmp11 = icmp eq i32 %conv10, 2, !dbg !106
  creg__r11__2_ = max(0,creg_r11);

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !125, metadata !DIExpression()), !dbg !130

  //   %and = and i32 %conv6, %conv12, !dbg !107
  creg_r12 = max(creg__r10__1_,creg__r11__2_);
  r12 = (r10==1) & (r11==2);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !126, metadata !DIExpression()), !dbg !130

  //   %and13 = and i32 %6, %and, !dbg !108
  creg_r13 = max(creg_r12,creg_r9);
  r13 = r9 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !127, metadata !DIExpression()), !dbg !130

  //   %and14 = and i32 %5, %and13, !dbg !109
  creg_r14 = max(creg_r13,creg_r8);
  r14 = r8 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !128, metadata !DIExpression()), !dbg !130

  //   %and15 = and i32 %4, %and14, !dbg !110
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !114
