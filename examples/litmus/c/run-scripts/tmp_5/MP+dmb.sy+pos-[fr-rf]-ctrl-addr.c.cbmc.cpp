...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !111

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   store i32 %conv21, i32* @atom_1_X3_2, align 4, !dbg !103, !tbaa !96
  // ST: Guess
  ...
  //   store i32 %conv23, i32* @atom_1_X7_0, align 4, !dbg !105, !tbaa !96
  // ST: Guess
