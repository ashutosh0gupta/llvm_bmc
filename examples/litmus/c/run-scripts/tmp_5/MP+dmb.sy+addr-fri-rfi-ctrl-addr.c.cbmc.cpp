...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !147, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !150, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !195
  ...
  //   store i32 0, i32* @atom_1_X3_0, align 4, !dbg !106, !tbaa !102
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X6_1, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !159, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !163, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !164, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !168, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !169, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !173, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !174, metadata !DIExpression()), !dbg !184

  //   %8 = load i32, i32* @atom_1_X3_0, align 4, !dbg !130, !tbaa !102
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %9 = load i32, i32* @atom_1_X6_1, align 4, !dbg !131, !tbaa !102
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !179, metadata !DIExpression()), !dbg !184

  //   %and24 = and i32 %7, %and23, !dbg !135
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !180, metadata !DIExpression()), !dbg !184

  //   %and25 = and i32 %conv22, %and24, !dbg !136
  creg_r24 = max(creg__r16__1_,creg_r23);
  r24 = (r16==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !181, metadata !DIExpression()), !dbg !184

  //   %and26 = and i32 %conv16, %and25, !dbg !137
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !182, metadata !DIExpression()), !dbg !184

  //   %and27 = and i32 %conv10, %and26, !dbg !138
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !183, metadata !DIExpression()), !dbg !184
