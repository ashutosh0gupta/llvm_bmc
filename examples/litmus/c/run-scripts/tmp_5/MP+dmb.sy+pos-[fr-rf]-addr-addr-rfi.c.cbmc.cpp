...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !78, metadata !DIExpression()), !dbg !103

  //   %add14 = add nsw i32 0, %xor13, !dbg !101
  creg_r8 = max(0,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = 0 + r7;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !101

  //   %arrayidx16 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !101
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !79, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64 1, metadata !81, metadata !DIExpression()), !dbg !121

  //   store atomic i64 1, i64* %arrayidx16 monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv8, 2, !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !95, metadata !DIExpression()), !dbg !132
