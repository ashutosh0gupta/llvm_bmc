...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !160, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !161, metadata !DIExpression()), !dbg !213

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !162, metadata !DIExpression()), !dbg !215

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !166, metadata !DIExpression()), !dbg !217

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !167, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !181, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !183, metadata !DIExpression()), !dbg !244

  //   %conv = trunc i64 %6 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !180, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !184, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !186, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !188, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !189, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !194, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !196, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !199, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !200, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !201, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !202, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !203, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !204, metadata !DIExpression()), !dbg !213

  //   %and = and i32 %13, %14, !dbg !155
  creg_r23 = max(creg_r21,creg_r22);
  r23 = r21 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !205, metadata !DIExpression()), !dbg !213

  //   %and31 = and i32 %12, %and, !dbg !156
  creg_r24 = max(creg_r20,creg_r23);
  r24 = r20 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !206, metadata !DIExpression()), !dbg !213

  //   %and32 = and i32 %11, %and31, !dbg !157
  creg_r25 = max(creg_r19,creg_r24);
  r25 = r19 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !207, metadata !DIExpression()), !dbg !213
