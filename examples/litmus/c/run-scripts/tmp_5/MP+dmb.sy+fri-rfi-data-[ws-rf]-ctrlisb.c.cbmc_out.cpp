...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !73, metadata !DIExpression()), !dbg !103
  ...
  //   %conv7 = sext i32 %add to i64, !dbg !98

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !76, metadata !DIExpression()), !dbg !116

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !98
  // ST: Guess
...
T2BLOCK4:
  ...
  //   %cmp20 = icmp eq i32 %conv4, 2, !dbg !115
  ...
  //   store atomic i64 %5, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !164, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !165, metadata !DIExpression()), !dbg !230

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !166, metadata !DIExpression()), !dbg !232

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !170, metadata !DIExpression()), !dbg !234

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !171, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !172, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !184, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !187, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !190, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !196, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !197, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !199, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !201, metadata !DIExpression()), !dbg !268

  //   %conv22 = trunc i64 %7 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !198, metadata !DIExpression()), !dbg !230

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !151

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !202, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !204, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !206, metadata !DIExpression()), !dbg !272

  //   %conv28 = trunc i64 %8 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !203, metadata !DIExpression()), !dbg !230

  //   %cmp29 = icmp eq i32 %conv28, 2, !dbg !155

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !207, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !209, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !211, metadata !DIExpression()), !dbg !276

  //   %conv34 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !208, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !213, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !215, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !217, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !219, metadata !DIExpression()), !dbg !282

  //   %conv42 = trunc i64 %11 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !216, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !221, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !223, metadata !DIExpression()), !dbg !285

  //   %conv46 = trunc i64 %12 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !220, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !225, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !226, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !227, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and50, metadata !228, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !229, metadata !DIExpression()), !dbg !230
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 95, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
