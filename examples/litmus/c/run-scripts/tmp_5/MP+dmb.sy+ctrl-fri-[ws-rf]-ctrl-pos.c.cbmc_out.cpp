...
T2BLOCK7:
  ...
  //   %cmp29 = icmp eq i32 %conv8, 2, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !95, metadata !DIExpression()), !dbg !148

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %7, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !200, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !268

  //   store atomic i64 0, i64* @atom_1_X5_2 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !203, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !206, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !233, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !237, metadata !DIExpression()), !dbg !308
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !241, metadata !DIExpression()), !dbg !311
