...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !123, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !127, metadata !DIExpression()), !dbg !145
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !176, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !179, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !226

  //   store atomic i64 0, i64* @atom_3_X2_0 monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !189, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !193, metadata !DIExpression()), !dbg !251

  //   %9 = load atomic i64, i64* @atom_3_X2_0 seq_cst, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,5);
