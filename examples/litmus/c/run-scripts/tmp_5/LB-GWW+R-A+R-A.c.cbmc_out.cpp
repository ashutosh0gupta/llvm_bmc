...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_3_X0_1, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_3_X2_0, align 4, !dbg !94, !tbaa !90
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l68_c15
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l68_c15
  // Check
  ...
  //   %8 = load i32, i32* @atom_3_X0_1, align 4, !dbg !111, !tbaa !90
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %9 = load i32, i32* @atom_3_X2_0, align 4, !dbg !112, !tbaa !90
  // LD: Guess
  old_cr = cr(0,7);
