...
T2BLOCK1:
  ...
  //   %xor = xor i32 %conv12, %conv12, !dbg !111
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !115
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !112
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ASSUME(creg_r6 >= creg_r5);
  ASSUME(active[creg_r6] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !132
  ...
  //   %cmp28 = icmp eq i32 %conv8, 2, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !99, metadata !DIExpression()), !dbg !144
  ...
  //   %cmp33 = icmp eq i32 %conv12, 2, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !103, metadata !DIExpression()), !dbg !147

  //   %9 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %9, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp38 = icmp eq i32 %conv16, 0, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !107, metadata !DIExpression()), !dbg !150

  //   %10 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !109, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %10, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !132
  // ST: Guess
  ...
  //   %cmp43 = icmp eq i32 %conv20, 0, !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !111, metadata !DIExpression()), !dbg !153

  //   %11 = zext i32 %conv44 to i64

  //   call void @llvm.dbg.value(metadata i64 %11, metadata !113, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %11, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !135
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !166
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !199, metadata !DIExpression()), !dbg !266
  ...
  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !141
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !205, metadata !DIExpression()), !dbg !270

  //   call void @llvm.dbg.value(metadata i64 0, metadata !207, metadata !DIExpression()), !dbg !270

  //   store atomic i64 0, i64* @atom_1_X8_0 monotonic, align 8, !dbg !143
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !227, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !231, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !235, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !239, metadata !DIExpression()), !dbg !308
