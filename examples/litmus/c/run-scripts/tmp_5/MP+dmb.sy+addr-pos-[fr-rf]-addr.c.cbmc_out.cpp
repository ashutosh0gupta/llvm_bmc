...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !67, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !71, metadata !DIExpression()), !dbg !114

  //   %conv4 = trunc i64 %1 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !116

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !119

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !80, metadata !DIExpression()), !dbg !106

  //   %add15 = add nsw i32 0, %xor13, !dbg !104
  ...
  //   %arrayidx17 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !104
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !82, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !81, metadata !DIExpression()), !dbg !106

  //   %cmp = icmp eq i32 %conv, 1, !dbg !107

  //   %conv21 = zext i1 %cmp to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !85, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !86, metadata !DIExpression()), !dbg !127

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !127
  ...
  //   %cmp23 = icmp eq i32 %conv4, 0, !dbg !110

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !89, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !90, metadata !DIExpression()), !dbg !130

  //   %6 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %6, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !112
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv8, 0, !dbg !113

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !93, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !94, metadata !DIExpression()), !dbg !133

  //   %7 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !96, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv12, 1, !dbg !116

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !97, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !98, metadata !DIExpression()), !dbg !136

  //   %8 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !100, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %8, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp38 = icmp eq i32 %conv20, 0, !dbg !119

  //   %conv39 = zext i1 %cmp38 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv39, metadata !101, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !102, metadata !DIExpression()), !dbg !139

  //   %9 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !104, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !162, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !163, metadata !DIExpression()), !dbg !236

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !164, metadata !DIExpression()), !dbg !238

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !123

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !123

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !168, metadata !DIExpression()), !dbg !240

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !125

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !125

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !169, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !176, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !179, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !182, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !185, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !188, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !255

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !140
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !191, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !195, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !197, metadata !DIExpression()), !dbg !272

  //   %conv = trunc i64 %6 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !194, metadata !DIExpression()), !dbg !236

  //   %cmp = icmp eq i32 %conv, 1, !dbg !159

  //   %conv20 = zext i1 %cmp to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !198, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !200, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !202, metadata !DIExpression()), !dbg !276

  //   %conv24 = trunc i64 %7 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !199, metadata !DIExpression()), !dbg !236

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !163

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !203, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !205, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !207, metadata !DIExpression()), !dbg !280

  //   %conv30 = trunc i64 %8 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !204, metadata !DIExpression()), !dbg !236

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !167

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !208, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !210, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !212, metadata !DIExpression()), !dbg !284

  //   %conv36 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !209, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !214, metadata !DIExpression()), !dbg !287

  //   %10 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !172
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !216, metadata !DIExpression()), !dbg !287

  //   %conv40 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !213, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !218, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !220, metadata !DIExpression()), !dbg !290

  //   %conv44 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !217, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !222, metadata !DIExpression()), !dbg !293

  //   %12 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !178
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !224, metadata !DIExpression()), !dbg !293

  //   %conv48 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !221, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !226, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !228, metadata !DIExpression()), !dbg !296

  //   %conv52 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !225, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !229, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !230, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !231, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !232, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !233, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !234, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !235, metadata !DIExpression()), !dbg !236
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 97, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !193
