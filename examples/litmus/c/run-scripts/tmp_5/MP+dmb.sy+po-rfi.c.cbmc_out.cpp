...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !79
  ...
  //   %cmp6 = icmp eq i32 %conv4, 1, !dbg !69
  ...
  //   store i32 %conv7, i32* @atom_1_X4_1, align 4, !dbg !70, !tbaa !65
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !98, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !99, metadata !DIExpression()), !dbg !120

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !63

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !63

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !100, metadata !DIExpression()), !dbg !122

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !104, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !105, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !108, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 0, metadata !110, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !112, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !114, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !115, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !116, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !117, metadata !DIExpression()), !dbg !120

  //   %and = and i32 %5, %6, !dbg !91
  creg_r8 = max(creg_r6,creg_r7);
  r8 = r6 & r7;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !118, metadata !DIExpression()), !dbg !120

  //   %and7 = and i32 %conv6, %and, !dbg !92
  creg_r9 = max(creg__r5__2_,creg_r8);
  r9 = (r5==2) & r8;

  //   call void @llvm.dbg.value(metadata i32 %and7, metadata !119, metadata !DIExpression()), !dbg !120
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 59, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !96
