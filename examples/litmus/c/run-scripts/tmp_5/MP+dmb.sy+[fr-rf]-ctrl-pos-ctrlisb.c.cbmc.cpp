...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !71, metadata !DIExpression()), !dbg !94
...
T2BLOCK7:
  ...
  //   %cmp22 = icmp eq i32 %conv4, 2, !dbg !109

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !83, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !84, metadata !DIExpression()), !dbg !129
  ...
  //   %cmp27 = icmp eq i32 %conv19, 0, !dbg !112

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !87, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !88, metadata !DIExpression()), !dbg !132
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !145
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !175, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !178, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !196, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !200, metadata !DIExpression()), !dbg !253
