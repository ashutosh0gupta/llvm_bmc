...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !74, metadata !DIExpression()), !dbg !94
...
T3BLOCK4:
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !70
  // LD: Guess
  old_cr = cr(3,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !80, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !72

  //   %conv5 = zext i1 %cmp to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !84, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !85, metadata !DIExpression()), !dbg !111

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !87, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %2, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !74
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !88, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !89, metadata !DIExpression()), !dbg !114

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !91, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %3, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !77
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #6, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !131, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !141, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !175

  //   store atomic i64 0, i64* @atom_2_X0_1 monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !144, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64 0, metadata !146, metadata !DIExpression()), !dbg !177

  //   store atomic i64 0, i64* @atom_2_X2_0 monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !95
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !96
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #6, !dbg !97
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !153, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !157, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !159, metadata !DIExpression()), !dbg !199

  //   %conv22 = trunc i64 %8 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !156, metadata !DIExpression()), !dbg !162
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !123
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #6, !dbg !126

  //   %10 = bitcast i64* %thr1 to i8*, !dbg !126

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #6, !dbg !126

  //   %11 = bitcast i64* %thr0 to i8*, !dbg !126

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #6, !dbg !126
