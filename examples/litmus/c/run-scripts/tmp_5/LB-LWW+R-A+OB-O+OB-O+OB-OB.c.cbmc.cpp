...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !76

  //   call void @llvm.dbg.value(metadata i64 1, metadata !66, metadata !DIExpression()), !dbg !76
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !89, metadata !DIExpression()), !dbg !100

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !55
  // LD: Guess
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !88, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !92, metadata !DIExpression()), !dbg !104
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !135, metadata !DIExpression()), !dbg !145
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !137, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !139, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !143, metadata !DIExpression()), !dbg !145
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !164, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !165, metadata !DIExpression()), !dbg !202

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !166, metadata !DIExpression()), !dbg !204

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !170, metadata !DIExpression()), !dbg !206

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !171, metadata !DIExpression()), !dbg !208

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !172, metadata !DIExpression()), !dbg !210

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !173, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !174, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !177, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !180, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !185, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !186, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !190, metadata !DIExpression()), !dbg !244

  //   %10 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l96_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !192, metadata !DIExpression()), !dbg !244

  //   %conv = trunc i64 %10 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !189, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !193, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !195, metadata !DIExpression()), !dbg !202

  //   %13 = load i32, i32* @atom_3_X0_1, align 4, !dbg !134, !tbaa !104
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l100_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !196, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !197, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !199, metadata !DIExpression()), !dbg !202

  //   %and20 = and i32 %11, %and19, !dbg !138
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !200, metadata !DIExpression()), !dbg !202

  //   %and21 = and i32 %conv18, %and20, !dbg !139
  creg_r18 = max(creg__r10__3_,creg_r17);
  r18 = (r10==3) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !201, metadata !DIExpression()), !dbg !202
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 106, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
