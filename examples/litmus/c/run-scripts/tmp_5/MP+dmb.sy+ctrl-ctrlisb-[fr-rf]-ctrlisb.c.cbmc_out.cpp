...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !97), !dbg !103
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !68, metadata !DIExpression()), !dbg !113
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !70, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !123

  //   %conv11 = trunc i64 %2 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !69, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !126

  //   %conv15 = trunc i64 %3 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !73, metadata !DIExpression()), !dbg !101
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !100), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !136

  //   %conv22 = trunc i64 %4 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !77, metadata !DIExpression()), !dbg !101

  //   %cmp = icmp eq i32 %conv, 1, !dbg !120

  //   %conv23 = zext i1 %cmp to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !81, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !82, metadata !DIExpression()), !dbg !140

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !140
  ...
  //   %cmp25 = icmp eq i32 %conv11, 0, !dbg !123

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !85, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !86, metadata !DIExpression()), !dbg !143

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !88, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %6, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv15, 1, !dbg !126

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !89, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !90, metadata !DIExpression()), !dbg !146

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %7, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !128
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv22, 0, !dbg !129

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !93, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !94, metadata !DIExpression()), !dbg !149

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %8, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !131
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !195, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !198, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !201, metadata !DIExpression()), !dbg !262

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !262

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !224, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !228, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !232, metadata !DIExpression()), !dbg !298

  //   %12 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !171
  // LD: Guess
  old_cr = cr(0,7);
