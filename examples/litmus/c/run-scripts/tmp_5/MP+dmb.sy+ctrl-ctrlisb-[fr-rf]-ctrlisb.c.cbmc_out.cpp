...
T2BLOCK10:
  ...
  //   %cmp24 = icmp eq i32 %conv11, 0, !dbg !114
  ...
  //   store i32 %conv25, i32* @atom_1_X4_0, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv15, 1, !dbg !116
  ...
  //   store i32 %conv27, i32* @atom_1_X6_1, align 4, !dbg !117, !tbaa !110
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !148
