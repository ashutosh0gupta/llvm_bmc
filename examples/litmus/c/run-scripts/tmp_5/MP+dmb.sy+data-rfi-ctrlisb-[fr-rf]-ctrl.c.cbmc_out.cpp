...
T2BLOCK4:
  ...
  //   %tobool14 = icmp ne i32 %conv13, 0, !dbg !118

  //   br i1 %tobool14, label %if.then15, label %if.else16, !dbg !120
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   %cmp25 = icmp eq i32 %conv5, 1, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !93, metadata !DIExpression()), !dbg !150

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %6, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !132
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv9, 0, !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !97, metadata !DIExpression()), !dbg !153

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !135
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !165, metadata !DIExpression()), !dbg !172
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !205, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !208, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !242, metadata !DIExpression()), !dbg !322
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !246, metadata !DIExpression()), !dbg !325
