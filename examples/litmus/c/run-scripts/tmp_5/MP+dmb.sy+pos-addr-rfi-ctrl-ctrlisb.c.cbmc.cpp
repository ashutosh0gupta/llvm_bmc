...
T2BLOCK7:
  ...
  //   %cmp29 = icmp eq i32 %conv8, 1, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !94, metadata !DIExpression()), !dbg !145

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !96, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %7, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv19, 0, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !98, metadata !DIExpression()), !dbg !148

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !100, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %8, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !226

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !228

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !165, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !168, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !171, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !174, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !180, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !183, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !186, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !190, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !192, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !195, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !197, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !200, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !202, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !205, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !207, metadata !DIExpression()), !dbg !269

  //   %conv34 = trunc i64 %7 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !204, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !209, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !211, metadata !DIExpression()), !dbg !272

  //   %conv38 = trunc i64 %8 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !208, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !213, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !215, metadata !DIExpression()), !dbg !275

  //   %conv42 = trunc i64 %9 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !212, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !217, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !219, metadata !DIExpression()), !dbg !278
