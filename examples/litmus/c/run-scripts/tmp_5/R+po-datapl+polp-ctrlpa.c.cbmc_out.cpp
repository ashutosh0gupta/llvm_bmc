...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !91, metadata !DIExpression()), !dbg !109
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X6_2, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_0, align 4, !dbg !92, !tbaa !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !147, metadata !DIExpression()), !dbg !183

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   %cmp15 = icmp eq i32 %conv14, 2, !dbg !108
  ...
  //   %6 = load i32, i32* @atom_0_X6_2, align 4, !dbg !109, !tbaa !88
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %7 = load i32, i32* @atom_1_X4_0, align 4, !dbg !110, !tbaa !88
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !117
