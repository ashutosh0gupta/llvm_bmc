...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !123, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !126, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !129, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !132, metadata !DIExpression()), !dbg !167
  ...
  //   store i32 0, i32* @atom_0_X8_2, align 4, !dbg !93, !tbaa !94
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X2_0, align 4, !dbg !98, !tbaa !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !136, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !139, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !141, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !140, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !145, metadata !DIExpression()), !dbg !156

  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !118
  creg__r8__1_ = max(0,creg_r8);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !149, metadata !DIExpression()), !dbg !156

  //   %7 = load i32, i32* @atom_0_X8_2, align 4, !dbg !119, !tbaa !94
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %8 = load i32, i32* @atom_1_X2_0, align 4, !dbg !120, !tbaa !94
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !153, metadata !DIExpression()), !dbg !156

  //   %and24 = and i32 %conv16, %and23, !dbg !123
  creg_r13 = max(creg__r7__1_,creg_r12);
  r13 = (r7==1) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !154, metadata !DIExpression()), !dbg !156

  //   %and25 = and i32 %conv10, %and24, !dbg !124
  creg_r14 = max(creg__r6__2_,creg_r13);
  r14 = (r6==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !155, metadata !DIExpression()), !dbg !156
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
