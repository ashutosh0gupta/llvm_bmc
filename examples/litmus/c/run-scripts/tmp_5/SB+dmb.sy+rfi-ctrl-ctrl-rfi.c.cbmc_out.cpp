...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !111
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !81, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !87, metadata !DIExpression()), !dbg !126

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !89, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !155, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !158, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !161, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !175, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !179, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !183, metadata !DIExpression()), !dbg !231
