...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !83, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !87, metadata !DIExpression()), !dbg !100

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !89, metadata !DIExpression()), !dbg !100

  //   store atomic i64 %1, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !60
  // ST: Guess
