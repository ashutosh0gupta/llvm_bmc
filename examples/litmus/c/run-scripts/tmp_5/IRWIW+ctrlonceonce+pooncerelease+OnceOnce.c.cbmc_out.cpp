...
T2BLOCK2:
  //   br label %lbl_label252, !dbg !59
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label252, !dbg !60
  goto T2BLOCK4;
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !127, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !128, metadata !DIExpression()), !dbg !157

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !129, metadata !DIExpression()), !dbg !159

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !133, metadata !DIExpression()), !dbg !161

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !134, metadata !DIExpression()), !dbg !163

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !135, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !143, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !145, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !150, metadata !DIExpression()), !dbg !190
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([126 x i8], [126 x i8]* @.str.1, i64 0, i64 0), i32 noundef 81, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !119
