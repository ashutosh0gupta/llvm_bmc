...
T2BLOCK7:
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !113, !tbaa !114
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 0, !dbg !118
  creg__r1__0_ = max(0,creg_r1);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !89, metadata !DIExpression()), !dbg !96

  //   store i32 %conv23, i32* @atom_1_X2_0, align 4, !dbg !119, !tbaa !114
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 1, !dbg !120
  ...
  //   store i32 %conv25, i32* @atom_1_X4_1, align 4, !dbg !121, !tbaa !114
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv13, 1, !dbg !122
  ...
  //   store i32 %conv27, i32* @atom_1_X7_1, align 4, !dbg !123, !tbaa !114
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv20, 0, !dbg !124
  ...
  //   store i32 %conv29, i32* @atom_1_X8_0, align 4, !dbg !125, !tbaa !114
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !166, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !167, metadata !DIExpression()), !dbg !219

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !168, metadata !DIExpression()), !dbg !221

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !172, metadata !DIExpression()), !dbg !223

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !173, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !174, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !177, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !183, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !187, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !189, metadata !DIExpression()), !dbg !250

  //   %conv = trunc i64 %6 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !186, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !190, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !192, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !194, metadata !DIExpression()), !dbg !254

  //   %conv16 = trunc i64 %7 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !191, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !195, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !199, metadata !DIExpression()), !dbg !258

  //   %conv22 = trunc i64 %8 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !196, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !200, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !202, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !204, metadata !DIExpression()), !dbg !262

  //   %conv28 = trunc i64 %9 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !201, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !205, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !206, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !207, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !208, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !209, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !210, metadata !DIExpression()), !dbg !219

  //   %and = and i32 %13, %14, !dbg !155
  creg_r20 = max(creg_r18,creg_r19);
  r20 = r18 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !211, metadata !DIExpression()), !dbg !219

  //   %and31 = and i32 %12, %and, !dbg !156
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !212, metadata !DIExpression()), !dbg !219

  //   %and32 = and i32 %11, %and31, !dbg !157
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !213, metadata !DIExpression()), !dbg !219
