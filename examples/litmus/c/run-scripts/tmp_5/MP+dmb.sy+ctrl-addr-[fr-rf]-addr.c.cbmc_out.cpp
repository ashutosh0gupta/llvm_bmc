...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !100), !dbg !112
  ...
  //   %xor13 = xor i32 %conv12, %conv12, !dbg !104
  ...
  //   %add15 = add nsw i32 0, %xor13, !dbg !105
  creg_r8 = max(0,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = 0 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !105

  //   %arrayidx17 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !105
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !80, metadata !DIExpression()), !dbg !125

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !84, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !88, metadata !DIExpression()), !dbg !131

  //   %6 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %6, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !92, metadata !DIExpression()), !dbg !134

  //   %7 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %7, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv20, 0, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !96, metadata !DIExpression()), !dbg !137

  //   %8 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %8, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !119
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !183, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !186, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !189, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !212, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !216, metadata !DIExpression()), !dbg !283
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 94, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
