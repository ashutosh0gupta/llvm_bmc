...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !58), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !52, metadata !DIExpression()), !dbg !59
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !53, metadata !DIExpression()), !dbg !80
  ...
  // ST: Guess
  iw(1,r4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l27_c3
  old_cw = cw(1,r4);
  cw(1,r4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l27_c3
  // Check
