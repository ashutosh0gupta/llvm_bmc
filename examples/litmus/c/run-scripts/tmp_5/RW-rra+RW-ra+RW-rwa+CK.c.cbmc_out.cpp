...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !182, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !228

  //   store atomic i64 0, i64* @atom_0_X0_1 monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !197, metadata !DIExpression()), !dbg !254

  //   %10 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,6);
