...
T2BLOCK4:
  ...
  //   %cmp18 = icmp eq i32 %conv4, 2, !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !87, metadata !DIExpression()), !dbg !130

  //   %5 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %5, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !179, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !182, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !185, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !208, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !212, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !216, metadata !DIExpression()), !dbg !280
