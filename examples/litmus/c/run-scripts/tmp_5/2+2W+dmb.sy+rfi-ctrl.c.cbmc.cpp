...
T2BLOCK4:
  ...
  //   store i32 %conv3, i32* @atom_1_X2_2, align 4, !dbg !66, !tbaa !67
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !105, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !108, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !112, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !111, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !115, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !116, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !120, metadata !DIExpression()), !dbg !124
  ...
  creg_r7 = max(creg__r5__2_,creg_r6);
  r7 = (r5==2) & r6;
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !123, metadata !DIExpression()), !dbg !124
