...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X7_0, align 4, !dbg !83, !tbaa !79
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X3_0, align 4, !dbg !84, !tbaa !79
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X5_0, align 4, !dbg !85, !tbaa !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !137, metadata !DIExpression()), !dbg !144

  //   %5 = load i32, i32* @atom_1_X7_0, align 4, !dbg !95, !tbaa !79
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %6 = load i32, i32* @atom_1_X3_0, align 4, !dbg !96, !tbaa !79
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %7 = load i32, i32* @atom_1_X5_0, align 4, !dbg !97, !tbaa !79
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and8, metadata !142, metadata !DIExpression()), !dbg !144
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([88 x i8], [88 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !104
