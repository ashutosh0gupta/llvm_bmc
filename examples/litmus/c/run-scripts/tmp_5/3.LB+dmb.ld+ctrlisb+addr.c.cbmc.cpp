...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !76, metadata !DIExpression()), !dbg !97
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !107, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !108, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i64 1, metadata !110, metadata !DIExpression()), !dbg !124

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !60
  // ST: Guess
  iw(3,r5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW 
  old_cw = cw(3,r5);
  cw(3,r5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM 
  // Check
