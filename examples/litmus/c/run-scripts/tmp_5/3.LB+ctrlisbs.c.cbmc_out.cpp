...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !141, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !142, metadata !DIExpression()), !dbg !163

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !143, metadata !DIExpression()), !dbg !165

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !147, metadata !DIExpression()), !dbg !167

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #6, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !148, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !149, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64 0, metadata !151, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !152, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !155, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %and10, metadata !162, metadata !DIExpression()), !dbg !163
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !103
