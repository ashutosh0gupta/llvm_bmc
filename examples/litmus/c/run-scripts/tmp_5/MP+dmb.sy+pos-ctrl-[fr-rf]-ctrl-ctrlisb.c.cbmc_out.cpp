...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv4, 0, !dbg !101
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !108), !dbg !125
...
T2BLOCK10:
  ...
  //   %cmp29 = icmp eq i32 %conv4, 1, !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !92, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !96, metadata !DIExpression()), !dbg !158
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !210, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !213, metadata !DIExpression()), !dbg !283

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !283

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !143
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !242, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !246, metadata !DIExpression()), !dbg !320

  //   %11 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !180
  // LD: Guess
  old_cr = cr(0,6);
