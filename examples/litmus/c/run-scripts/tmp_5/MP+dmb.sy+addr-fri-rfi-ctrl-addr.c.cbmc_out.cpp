...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !174, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !235

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !203, metadata !DIExpression()), !dbg !266

  //   %8 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !159
  // LD: Guess
  old_cr = cr(0,5);
