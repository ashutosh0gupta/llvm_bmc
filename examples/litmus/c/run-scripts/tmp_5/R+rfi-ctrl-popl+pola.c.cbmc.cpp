...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !42, metadata !DIExpression()), !dbg !64

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !65
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !66

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !67
  // LD: Guess
  old_cr = cr(1,0);
...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !47, metadata !DIExpression()), !dbg !75

  //   call void @llvm.dbg.value(metadata i64 1, metadata !49, metadata !DIExpression()), !dbg !75

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !76
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !50, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64 1, metadata !52, metadata !DIExpression()), !dbg !77

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !78
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !54, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !56, metadata !DIExpression()), !dbg !79

  //   %conv8 = trunc i64 %1 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !53, metadata !DIExpression()), !dbg !61
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !57, metadata !DIExpression()), !dbg !61

  //   store i32 %conv9, i32* @atom_0_X7_2, align 4, !dbg !83, !tbaa !84
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv, 1, !dbg !88
  ...
  //   store i32 %conv11, i32* @atom_0_X2_1, align 4, !dbg !89, !tbaa !84
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !94, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !98, metadata !DIExpression()), !dbg !108
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X7_2, align 4, !dbg !92, !tbaa !93
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_0_X7_2, align 4, !dbg !119, !tbaa !93
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !130
