...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !74, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !100

  //   %conv16 = trunc i64 %3 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !73, metadata !DIExpression()), !dbg !85
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !102
  ...
  //   store i32 %conv23, i32* @atom_1_X7_0, align 4, !dbg !93, !tbaa !88
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X9_0, align 4, !dbg !95, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X9_0, align 4, !dbg !92, !tbaa !87
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X9_0, align 4, !dbg !111, !tbaa !87
  // LD: Guess
  old_cr = cr(0,5);
