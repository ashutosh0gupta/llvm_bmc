...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !76, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !124

  //   %conv9 = sext i32 %add to i64, !dbg !106

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !79, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv8, 2, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !98, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !122
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !192, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !225, metadata !DIExpression()), !dbg !297
