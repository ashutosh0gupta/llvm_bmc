...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !167, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !168, metadata !DIExpression()), !dbg !214

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !169, metadata !DIExpression()), !dbg !216

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !173, metadata !DIExpression()), !dbg !218

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !174, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !175, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !178, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !181, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !184, metadata !DIExpression()), !dbg !227
  ...
  //   store i32 0, i32* @atom_1_X9_0, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !190, metadata !DIExpression()), !dbg !245

  //   %conv = trunc i64 %6 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !187, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !191, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !195, metadata !DIExpression()), !dbg !249

  //   %conv16 = trunc i64 %7 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !192, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !196, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !198, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !200, metadata !DIExpression()), !dbg !253

  //   %conv22 = trunc i64 %8 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !197, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !201, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !202, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !203, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !204, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !205, metadata !DIExpression()), !dbg !214

  //   %13 = load i32, i32* @atom_1_X9_0, align 4, !dbg !144, !tbaa !109
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !206, metadata !DIExpression()), !dbg !214

  //   %and = and i32 %12, %13, !dbg !145
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !207, metadata !DIExpression()), !dbg !214

  //   %and25 = and i32 %11, %and, !dbg !146
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !208, metadata !DIExpression()), !dbg !214

  //   %and26 = and i32 %10, %and25, !dbg !147
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !209, metadata !DIExpression()), !dbg !214

  //   %and27 = and i32 %9, %and26, !dbg !148
  creg_r24 = max(creg_r16,creg_r23);
  r24 = r16 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !210, metadata !DIExpression()), !dbg !214

  //   %and28 = and i32 %conv24, %and27, !dbg !149
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !211, metadata !DIExpression()), !dbg !214

  //   %and29 = and i32 %conv18, %and28, !dbg !150
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !212, metadata !DIExpression()), !dbg !214

  //   %and30 = and i32 %conv12, %and29, !dbg !151
  creg_r27 = max(creg__r13__1_,creg_r26);
  r27 = (r13==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !213, metadata !DIExpression()), !dbg !214
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 104, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
