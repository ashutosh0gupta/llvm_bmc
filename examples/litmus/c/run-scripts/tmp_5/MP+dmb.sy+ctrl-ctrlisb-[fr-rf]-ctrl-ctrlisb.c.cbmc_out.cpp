...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !101), !dbg !108
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !102), !dbg !117
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !103), !dbg !126
  ...
  //   %tobool16 = icmp ne i32 %conv15, 0, !dbg !115

  //   br i1 %tobool16, label %if.then17, label %if.else18, !dbg !117
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK9:
  //   br label %lbl_LC02, !dbg !119
  goto T2BLOCK10;

T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !104), !dbg !139

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !78, metadata !DIExpression()), !dbg !140

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !122
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  if(cr(2,0+4*1) < cw(2,0+4*1)) {
    ...
    r4 = mem(0+4*1,cr(2,0+4*1));
  }
  ASSUME(creturn[2] >= cr(2,0+4*1));

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !140

  //   %conv22 = trunc i64 %4 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !77, metadata !DIExpression()), !dbg !106

  //   %tobool23 = icmp ne i32 %conv22, 0, !dbg !124

  //   br i1 %tobool23, label %if.then24, label %if.else25, !dbg !126
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK11:
  //   br label %lbl_LC03, !dbg !127
  goto T2BLOCK13;

T2BLOCK12:
  //   br label %lbl_LC03, !dbg !128
  goto T2BLOCK13;

T2BLOCK13:
  //   call void @llvm.dbg.label(metadata !105), !dbg !148

  //   call void (...) @isb(), !dbg !130
  // isb: Guess
  cisb[2] = get_rng(0,NCONTEXT-1);
  // Check
  ASSUME(cisb[2] >= cdy[2]);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !150

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !150

  //   %conv29 = trunc i64 %5 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !81, metadata !DIExpression()), !dbg !106

  //   %cmp = icmp eq i32 %conv, 1, !dbg !134

  //   %conv30 = zext i1 %cmp to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !85, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !86, metadata !DIExpression()), !dbg !154

  //   %6 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !88, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !136
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv11, 0, !dbg !137

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !89, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !90, metadata !DIExpression()), !dbg !157

  //   %7 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %7, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !139
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv15, 1, !dbg !140

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !93, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !94, metadata !DIExpression()), !dbg !160

  //   %8 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !160

  //   store atomic i64 %8, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !142
  // ST: Guess
  ...
  //   %cmp42 = icmp eq i32 %conv29, 0, !dbg !143

  //   %conv43 = zext i1 %cmp42 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv43, metadata !97, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !98, metadata !DIExpression()), !dbg !163

  //   %9 = zext i32 %conv43 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !100, metadata !DIExpression()), !dbg !163

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !145
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !168, metadata !DIExpression()), !dbg !173
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !169, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64 1, metadata !171, metadata !DIExpression()), !dbg !176
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !186, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !187, metadata !DIExpression()), !dbg !258

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !117

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !117

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !188, metadata !DIExpression()), !dbg !260

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !192, metadata !DIExpression()), !dbg !262

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !193, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !194, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !197, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !200, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !203, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !206, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !209, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !212, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !214, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !215, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i64 0, metadata !217, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !218, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i64 0, metadata !220, metadata !DIExpression()), !dbg !281

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !140
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !222, metadata !DIExpression()), !dbg !296
  ...
  if(cr(0,0+3*1) < cw(0,0+3*1)) {
    ...
    r10 = mem(0+3*1,cr(0,0+3*1));
  }
  ASSUME(creturn[0] >= cr(0,0+3*1));

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !224, metadata !DIExpression()), !dbg !296

  //   %conv = trunc i64 %6 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !221, metadata !DIExpression()), !dbg !258

  //   %cmp = icmp eq i32 %conv, 1, !dbg !157

  //   %conv22 = zext i1 %cmp to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !225, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !227, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !229, metadata !DIExpression()), !dbg !300

  //   %conv26 = trunc i64 %7 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !226, metadata !DIExpression()), !dbg !258

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !161

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !230, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !234, metadata !DIExpression()), !dbg !304

  //   %conv32 = trunc i64 %8 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !231, metadata !DIExpression()), !dbg !258

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !165

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !235, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !237, metadata !DIExpression()), !dbg !308
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !239, metadata !DIExpression()), !dbg !308

  //   %conv38 = trunc i64 %9 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !236, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !241, metadata !DIExpression()), !dbg !311
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !243, metadata !DIExpression()), !dbg !311

  //   %conv42 = trunc i64 %10 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !240, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !245, metadata !DIExpression()), !dbg !314
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !247, metadata !DIExpression()), !dbg !314

  //   %conv46 = trunc i64 %11 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !244, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !249, metadata !DIExpression()), !dbg !317

  //   %12 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !176
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !251, metadata !DIExpression()), !dbg !317

  //   %conv50 = trunc i64 %12 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !248, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !252, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !253, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !254, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !255, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !256, metadata !DIExpression()), !dbg !258

  //   %and55 = and i32 %conv22, %and54, !dbg !183
  creg_r22 = max(max(creg_r10,0),creg_r21);
  ASSUME(active[creg_r22] == 0);
  r22 = (r10==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !257, metadata !DIExpression()), !dbg !258
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([128 x i8], [128 x i8]* @.str.1, i64 0, i64 0), i32 noundef 102, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187
