...
T2BLOCK1:
  ...
  //   %cmp37 = icmp eq i32 %conv24, 1, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !100, metadata !DIExpression()), !dbg !137

  //   %9 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %9, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !119
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !143, metadata !DIExpression()), !dbg !150
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !186, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !212, metadata !DIExpression()), !dbg !271
