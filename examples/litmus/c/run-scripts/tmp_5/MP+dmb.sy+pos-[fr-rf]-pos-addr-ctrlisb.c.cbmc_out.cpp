...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !127
...
T2BLOCK4:
  ...
  //   %cmp28 = icmp eq i32 %conv8, 2, !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !97, metadata !DIExpression()), !dbg !146
  ...
  //   %cmp33 = icmp eq i32 %conv12, 2, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !101, metadata !DIExpression()), !dbg !149

  //   %9 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !103, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %9, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !131
  // ST: Guess
  ...
  //   %cmp38 = icmp eq i32 %conv20, 0, !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !105, metadata !DIExpression()), !dbg !152
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !165
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !198, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !204, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !226, metadata !DIExpression()), !dbg !293
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !230, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !234, metadata !DIExpression()), !dbg !299
