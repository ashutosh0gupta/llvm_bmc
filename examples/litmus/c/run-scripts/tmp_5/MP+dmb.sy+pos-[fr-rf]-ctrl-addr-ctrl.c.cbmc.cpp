...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !160, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !161, metadata !DIExpression()), !dbg !199

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !162, metadata !DIExpression()), !dbg !201

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !166, metadata !DIExpression()), !dbg !203

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !167, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !168, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !171, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !181, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !183, metadata !DIExpression()), !dbg !229

  //   %conv = trunc i64 %6 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !180, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !184, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !188, metadata !DIExpression()), !dbg !233

  //   %conv16 = trunc i64 %7 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !185, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !189, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !193, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !195, metadata !DIExpression()), !dbg !199

  //   %and20 = and i32 %8, %and19, !dbg !131
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !196, metadata !DIExpression()), !dbg !199

  //   %and21 = and i32 %conv18, %and20, !dbg !132
  creg_r22 = max(creg__r14__2_,creg_r21);
  r22 = (r14==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !197, metadata !DIExpression()), !dbg !199

  //   %and22 = and i32 %conv12, %and21, !dbg !133
  creg_r23 = max(creg__r13__1_,creg_r22);
  r23 = (r13==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !198, metadata !DIExpression()), !dbg !199
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !137
