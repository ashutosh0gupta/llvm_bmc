...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !64, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !66, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !82
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !81), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !70, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !73, metadata !DIExpression()), !dbg !82

  //   %add11 = add nsw i32 0, %xor9, !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !75, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !74, metadata !DIExpression()), !dbg !82

  //   %cmp = icmp eq i32 %conv, 2, !dbg !88
  creg__r0__2_ = max(0,creg_r0);

  //   %conv17 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !78, metadata !DIExpression()), !dbg !82

  //   store i32 %conv17, i32* @atom_1_X2_2, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv16, 0, !dbg !94
  creg__r9__0_ = max(0,creg_r9);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !79, metadata !DIExpression()), !dbg !82

  //   store i32 %conv19, i32* @atom_1_X9_0, align 4, !dbg !95, !tbaa !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X2_2, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_1_X2_2, align 4, !dbg !109, !tbaa !88
  // LD: Guess
  old_cr = cr(0,4);
