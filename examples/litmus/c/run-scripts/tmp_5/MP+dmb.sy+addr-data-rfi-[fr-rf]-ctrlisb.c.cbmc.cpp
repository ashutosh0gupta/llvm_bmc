...
T2BLOCK4:
  ...
  //   %cmp21 = icmp eq i32 %conv11, 1, !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X7_1, align 4, !dbg !111, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X7_1, align 4, !dbg !109, !tbaa !105
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X8_2, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !177, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !239
  ...
  //   %10 = load i32, i32* @atom_1_X7_1, align 4, !dbg !136, !tbaa !105
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X8_2, align 4, !dbg !137, !tbaa !105
  // LD: Guess
  old_cr = cr(0,6);
