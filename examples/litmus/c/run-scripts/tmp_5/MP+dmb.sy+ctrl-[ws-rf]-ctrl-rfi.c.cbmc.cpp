...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !57, metadata !DIExpression()), !dbg !92
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !62, metadata !DIExpression()), !dbg !95

  //   %conv = trunc i64 %0 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !58, metadata !DIExpression()), !dbg !92
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !63, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64 1, metadata !65, metadata !DIExpression()), !dbg !104
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i64 1, metadata !72, metadata !DIExpression()), !dbg !115

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !76, metadata !DIExpression()), !dbg !117

  //   %conv13 = trunc i64 %2 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !73, metadata !DIExpression()), !dbg !92

  //   %cmp = icmp eq i32 %conv, 1, !dbg !101

  //   %conv14 = zext i1 %cmp to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !77, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !78, metadata !DIExpression()), !dbg !121

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !121

  //   store atomic i64 %3, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !86, metadata !DIExpression()), !dbg !127
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !170, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !173, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !179, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !182, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !184, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !187, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !189, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !192, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !194, metadata !DIExpression()), !dbg !252

  //   %conv32 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !191, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !196, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !198, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !200, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !202, metadata !DIExpression()), !dbg !258
