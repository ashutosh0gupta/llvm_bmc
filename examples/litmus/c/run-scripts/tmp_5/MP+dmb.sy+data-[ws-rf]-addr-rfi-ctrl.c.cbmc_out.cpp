...
T2BLOCK4:
  ...
  //   %cmp22 = icmp eq i32 %conv5, 2, !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !91, metadata !DIExpression()), !dbg !136

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !93, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %5, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv13, 1, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !95, metadata !DIExpression()), !dbg !139

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !97, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %6, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !148, metadata !DIExpression()), !dbg !155
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !188, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !191, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !259

  //   store atomic i64 0, i64* @atom_1_X8_1 monotonic, align 8, !dbg !139
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !222, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !226, metadata !DIExpression()), !dbg !298

  //   %12 = load atomic i64, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !178
  // LD: Guess
  old_cr = cr(0,6);
