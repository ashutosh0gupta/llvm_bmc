...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !95
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !73, metadata !DIExpression()), !dbg !87
  ...
  //   %conv11 = sext i32 %add to i64, !dbg !91
  ...
  //   %cmp16 = icmp eq i32 %conv4, 2, !dbg !95

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !81, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !82, metadata !DIExpression()), !dbg !115

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !115

  //   store atomic i64 %4, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !144, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !146, metadata !DIExpression()), !dbg !181

  //   store atomic i64 0, i64* @atom_1_X3_2 monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !162, metadata !DIExpression()), !dbg !204

  //   %7 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
