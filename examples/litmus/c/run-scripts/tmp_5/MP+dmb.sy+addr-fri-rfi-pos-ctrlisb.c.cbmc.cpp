...
T2BLOCK1:
  ...
  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !119

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !101
  // ST: Guess
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !134

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv17 = zext i1 %cmp to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !87, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !138

  //   %5 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !138
  ...
  //   %cmp21 = icmp eq i32 %conv4, 0, !dbg !121

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !91, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !92, metadata !DIExpression()), !dbg !141

  //   %6 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %6, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !123
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv8, 1, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !96, metadata !DIExpression()), !dbg !144

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %7, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !126
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv12, 1, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !100, metadata !DIExpression()), !dbg !147

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !147
  ...
  //   %cmp36 = icmp eq i32 %conv16, 0, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !104, metadata !DIExpression()), !dbg !150

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !106, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !132
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !160, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !161, metadata !DIExpression()), !dbg !233

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !162, metadata !DIExpression()), !dbg !235

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !166, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !167, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !173, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !179, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !246

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !182, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !248

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !185, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !250

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !137
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !188, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !192, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !194, metadata !DIExpression()), !dbg !264

  //   %conv = trunc i64 %4 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !191, metadata !DIExpression()), !dbg !233

  //   %cmp = icmp eq i32 %conv, 1, !dbg !153

  //   %conv18 = zext i1 %cmp to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !195, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !199, metadata !DIExpression()), !dbg !268

  //   %conv22 = trunc i64 %5 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !196, metadata !DIExpression()), !dbg !233

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !157

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !200, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !202, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !204, metadata !DIExpression()), !dbg !272

  //   %conv28 = trunc i64 %6 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !201, metadata !DIExpression()), !dbg !233

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !161

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !205, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !207, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !209, metadata !DIExpression()), !dbg !276

  //   %conv34 = trunc i64 %7 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !206, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !211, metadata !DIExpression()), !dbg !279

  //   %8 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !166
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !213, metadata !DIExpression()), !dbg !279

  //   %conv38 = trunc i64 %8 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !210, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !215, metadata !DIExpression()), !dbg !282

  //   %9 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !169
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !217, metadata !DIExpression()), !dbg !282

  //   %conv42 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !214, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !219, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !221, metadata !DIExpression()), !dbg !285

  //   %conv46 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !218, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !223, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !225, metadata !DIExpression()), !dbg !288

  //   %conv50 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !222, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !227, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !228, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !229, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !230, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !231, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !232, metadata !DIExpression()), !dbg !233
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !187
