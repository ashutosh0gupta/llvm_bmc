...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !211, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !214, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !217, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !220, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !223, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !227, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !231, metadata !DIExpression()), !dbg !303
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !235, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !239, metadata !DIExpression()), !dbg !309
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !243, metadata !DIExpression()), !dbg !312
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 108, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
