...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !143, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !144, metadata !DIExpression()), !dbg !183

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !145, metadata !DIExpression()), !dbg !185

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !149, metadata !DIExpression()), !dbg !187

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !150, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !151, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !154, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !157, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64 0, metadata !159, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !163, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !164, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !166, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !168, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !169, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !171, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !173, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !174, metadata !DIExpression()), !dbg !183
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !136
