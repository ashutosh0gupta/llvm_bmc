...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !110

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !75, metadata !DIExpression()), !dbg !95
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !95
  r5 = 0+r4*1;
  creg_r5 = creg_r4;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !115

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !95
  // ST: Guess
  iw(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l37_c3
  old_cw = cw(2,r5);
  cw(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l37_c3
  // Check
