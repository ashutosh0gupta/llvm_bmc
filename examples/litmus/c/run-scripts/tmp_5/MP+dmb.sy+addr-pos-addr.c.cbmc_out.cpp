...
T2BLOCK1:
  ...
  //   %xor9 = xor i32 %conv8, %conv8, !dbg !72
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !70, metadata !DIExpression()), !dbg !78

  //   %add11 = add nsw i32 0, %xor9, !dbg !73
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !73

  //   %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !73
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !72, metadata !DIExpression()), !dbg !93

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !73
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   %conv16 = trunc i64 %3 to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !71, metadata !DIExpression()), !dbg !78

  //   %cmp = icmp eq i32 %conv, 1, !dbg !76
  creg__r0__1_ = max(0,creg_r0);

  //   %conv17 = zext i1 %cmp to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !75, metadata !DIExpression()), !dbg !78

  //   store i32 %conv17, i32* @atom_1_X0_1, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv16, 0, !dbg !82
  creg__r9__0_ = max(0,creg_r9);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !76, metadata !DIExpression()), !dbg !78

  //   store i32 %conv19, i32* @atom_1_X7_0, align 4, !dbg !83, !tbaa !78
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !112
