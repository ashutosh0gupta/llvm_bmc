...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !87, metadata !DIExpression()), !dbg !142

  //   %conv20 = trunc i64 %4 to i32, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !146
  ...
  //   %cmp25 = icmp eq i32 %conv4, 0, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !131
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv8, 1, !dbg !132

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv13, 1, !dbg !135

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !100, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !101, metadata !DIExpression()), !dbg !155

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !103, metadata !DIExpression()), !dbg !155
  ...
  //   %cmp40 = icmp eq i32 %conv20, 0, !dbg !138

  //   %conv41 = zext i1 %cmp40 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv41, metadata !104, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !105, metadata !DIExpression()), !dbg !158

  //   %9 = zext i32 %conv41 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !107, metadata !DIExpression()), !dbg !158

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !140
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !210, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !213, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !241, metadata !DIExpression()), !dbg !321
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !245, metadata !DIExpression()), !dbg !324
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !249, metadata !DIExpression()), !dbg !327
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !253, metadata !DIExpression()), !dbg !330
