...
T2BLOCK4:
  ...
  //   %conv9 = sext i32 %add to i64, !dbg !98

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !79, metadata !DIExpression()), !dbg !116

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   %tobool14 = icmp ne i32 %conv13, 0, !dbg !102
  creg__r5__0_ = max(0,creg_r5);

  //   br i1 %tobool14, label %if.then15, label %if.else16, !dbg !104
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !87, metadata !DIExpression()), !dbg !127

  //   %conv20 = trunc i64 %4 to i32, !dbg !110
  ...
  //   %conv21 = zext i1 %cmp to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !88, metadata !DIExpression()), !dbg !96

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !112, !tbaa !113
  // ST: Guess
  ...
  //   store i32 %conv23, i32* @atom_1_X2_0, align 4, !dbg !118, !tbaa !113
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 1, !dbg !119
  creg__r2__1_ = max(0,creg_r2);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !90, metadata !DIExpression()), !dbg !96

  //   store i32 %conv25, i32* @atom_1_X4_1, align 4, !dbg !120, !tbaa !113
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv13, 1, !dbg !121
  ...
  //   store i32 %conv27, i32* @atom_1_X7_1, align 4, !dbg !122, !tbaa !113
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv20, 0, !dbg !123
  ...
  //   store i32 %conv29, i32* @atom_1_X8_0, align 4, !dbg !124, !tbaa !113
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 106, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
