...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !97, metadata !DIExpression()), !dbg !108

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !51
  // LD: Guess
  old_cr = cr(4,0+2*1);
  cr(4,0+2*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l42_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !100, metadata !DIExpression()), !dbg !112
  ...
  //   store i32 %conv1, i32* @atom_3_X0_1, align 4, !dbg !57, !tbaa !58
  // ST: Guess
