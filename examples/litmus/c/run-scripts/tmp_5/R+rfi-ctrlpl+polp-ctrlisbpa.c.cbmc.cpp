...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !89, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !93, metadata !DIExpression()), !dbg !108
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !97, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !99, metadata !DIExpression()), !dbg !118
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !131, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !132, metadata !DIExpression()), !dbg !164

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !133, metadata !DIExpression()), !dbg !166

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !137, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !150, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !151, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !155, metadata !DIExpression()), !dbg !190

  //   %conv12 = trunc i64 %5 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !152, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !156, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !161, metadata !DIExpression()), !dbg !164

  //   %and16 = and i32 %conv14, %and15, !dbg !114
  creg_r14 = max(creg__r8__2_,creg_r13);
  r14 = (r8==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !162, metadata !DIExpression()), !dbg !164

  //   %and17 = and i32 %conv8, %and16, !dbg !115
  creg_r15 = max(creg__r7__1_,creg_r14);
  r15 = (r7==1) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !163, metadata !DIExpression()), !dbg !164
