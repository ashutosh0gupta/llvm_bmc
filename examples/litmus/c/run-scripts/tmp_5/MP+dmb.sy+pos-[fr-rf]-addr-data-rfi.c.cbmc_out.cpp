...
T2BLOCK1:
  ...
  //   %add14 = add nsw i32 %xor13, 1, !dbg !90
  creg_r8 = max(0,creg_r7);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add14, metadata !79, metadata !DIExpression()), !dbg !92
  ...
  //   %conv15 = sext i32 %add14 to i64, !dbg !92

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !82, metadata !DIExpression()), !dbg !110

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv8, 2, !dbg !104
  ...
  //   store i32 %conv24, i32* @atom_1_X3_2, align 4, !dbg !105, !tbaa !98
  // ST: Guess
