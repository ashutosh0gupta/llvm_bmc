...
T2BLOCK1:
  ...
  //   %add14 = add nsw i32 %xor13, 1, !dbg !102
  creg_r8 = max(creg_r7,0);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add14, metadata !79, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !122

  //   %conv15 = sext i32 %add14 to i64, !dbg !104

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !82, metadata !DIExpression()), !dbg !122

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv4, 1, !dbg !111
  ...
  //   store atomic i64 %6, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv8, 2, !dbg !114
  ...
  //   store atomic i64 %7, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !116
  // ST: Guess
