...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !102
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !101), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !88, metadata !DIExpression()), !dbg !137
  ...
  //   %cmp27 = icmp eq i32 %conv8, 2, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !92, metadata !DIExpression()), !dbg !140

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %6, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !122
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !186, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !189, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !215, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !219, metadata !DIExpression()), !dbg !284
