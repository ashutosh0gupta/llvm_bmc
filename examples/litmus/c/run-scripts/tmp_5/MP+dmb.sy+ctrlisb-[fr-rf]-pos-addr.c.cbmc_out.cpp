...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !105), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !119

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !119
  ...
  //   %cmp19 = icmp eq i32 %conv4, 0, !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !89, metadata !DIExpression()), !dbg !136

  //   %6 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !93, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !188, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !191, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !220, metadata !DIExpression()), !dbg !293

  //   %10 = load atomic i64, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !172
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !224, metadata !DIExpression()), !dbg !296
