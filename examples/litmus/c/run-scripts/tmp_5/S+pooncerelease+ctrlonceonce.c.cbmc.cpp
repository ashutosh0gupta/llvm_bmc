...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !94, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !95, metadata !DIExpression()), !dbg !114

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !59

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !59

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !96, metadata !DIExpression()), !dbg !116

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !61

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !61

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !100, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !101, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 0, metadata !103, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !104, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64 0, metadata !106, metadata !DIExpression()), !dbg !121
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !67, !tbaa !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !108, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !110, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !111, metadata !DIExpression()), !dbg !114

  //   %5 = load i32, i32* @atom_1_X0_1, align 4, !dbg !84, !tbaa !68
  // LD: Guess
  old_cr = cr(0,2);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !89
