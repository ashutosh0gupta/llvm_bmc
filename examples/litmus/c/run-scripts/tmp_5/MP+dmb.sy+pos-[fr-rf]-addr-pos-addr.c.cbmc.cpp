...
T2BLOCK1:
  ...
  //   %xor17 = xor i32 %conv16, %conv16, !dbg !104
  creg_r8 = max(creg_r7,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !82, metadata !DIExpression()), !dbg !104

  //   %add19 = add nsw i32 0, %xor17, !dbg !105
  creg_r9 = max(0,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = 0 + r8;

  //   %idxprom20 = sext i32 %add19 to i64, !dbg !105

  //   %arrayidx21 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !105
  r10 = 0+r9*1;
  ASSUME(creg_r10 >= 0);
  ASSUME(creg_r10 >= creg_r9);
  ASSUME(active[creg_r10] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !84, metadata !DIExpression()), !dbg !125

  //   %5 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   %conv24 = trunc i64 %5 to i32, !dbg !107
  ...
  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !110
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv4, 1, !dbg !111

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !91, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !92, metadata !DIExpression()), !dbg !131

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv8, 2, !dbg !114

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !95, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !96, metadata !DIExpression()), !dbg !134

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %8, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv24, 0, !dbg !117

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !99, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !100, metadata !DIExpression()), !dbg !137

  //   %9 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !119
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !180, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !183, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !186, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !204, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !208, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !212, metadata !DIExpression()), !dbg !271
