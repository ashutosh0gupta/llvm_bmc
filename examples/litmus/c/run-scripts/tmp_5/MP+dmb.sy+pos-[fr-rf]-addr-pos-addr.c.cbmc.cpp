...
T2BLOCK1:
  ...
  //   %arrayidx21 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !93
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !84, metadata !DIExpression()), !dbg !113

  //   %5 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !113
  ...
  //   %cmp28 = icmp eq i32 %conv8, 2, !dbg !104
  ...
  //   store i32 %conv29, i32* @atom_1_X3_2, align 4, !dbg !105, !tbaa !98
  // ST: Guess
  ...
  //   store i32 %conv31, i32* @atom_1_X9_0, align 4, !dbg !107, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X9_0, align 4, !dbg !100, !tbaa !94
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X9_0, align 4, !dbg !123, !tbaa !94
  // LD: Guess
  old_cr = cr(0,6);
