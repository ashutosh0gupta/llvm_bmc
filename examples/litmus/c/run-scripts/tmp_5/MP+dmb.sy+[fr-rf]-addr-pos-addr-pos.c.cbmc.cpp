...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !155, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64 0, metadata !158, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !195
  ...
  //   store i32 0, i32* @atom_1_X8_0, align 4, !dbg !99, !tbaa !94
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X10_0, align 4, !dbg !100, !tbaa !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !168, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !169, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !171, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !173, metadata !DIExpression()), !dbg !216

  //   %conv14 = trunc i64 %7 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !170, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !174, metadata !DIExpression()), !dbg !184
  ...
  //   %10 = load i32, i32* @atom_1_X8_0, align 4, !dbg !122, !tbaa !94
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X10_0, align 4, !dbg !123, !tbaa !94
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !180, metadata !DIExpression()), !dbg !184

  //   %and18 = and i32 %8, %and17, !dbg !126
  creg_r24 = max(creg_r18,creg_r23);
  r24 = r18 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !181, metadata !DIExpression()), !dbg !184

  //   %and19 = and i32 %conv16, %and18, !dbg !127
  creg_r25 = max(creg__r17__2_,creg_r24);
  r25 = (r17==2) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !182, metadata !DIExpression()), !dbg !184

  //   %and20 = and i32 %conv10, %and19, !dbg !128
  creg_r26 = max(creg__r16__1_,creg_r25);
  r26 = (r16==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !183, metadata !DIExpression()), !dbg !184
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !132
