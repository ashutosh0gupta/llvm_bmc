...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !138, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !140, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !141, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !143, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !145, metadata !DIExpression()), !dbg !190

  //   %conv16 = trunc i64 %9 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !142, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !148, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !150, metadata !DIExpression()), !dbg !194

  //   %conv22 = trunc i64 %10 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !147, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !151, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !154, metadata !DIExpression()), !dbg !156

  //   %and26 = and i32 %conv12, %and25, !dbg !124
  creg_r12 = max(creg__r6__2_,creg_r11);
  r12 = (r6==2) & r11;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !155, metadata !DIExpression()), !dbg !156
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
