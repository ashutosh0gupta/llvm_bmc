...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !131, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !132, metadata !DIExpression()), !dbg !155

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !133, metadata !DIExpression()), !dbg !157

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !137, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !141, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !162
  ...
  //   store i32 0, i32* @atom_0_X3_3, align 4, !dbg !75, !tbaa !76
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X2_3, align 4, !dbg !80, !tbaa !76
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X5_0, align 4, !dbg !81, !tbaa !76
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !147, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !148, metadata !DIExpression()), !dbg !155

  //   %5 = load i32, i32* @atom_0_X3_3, align 4, !dbg !94, !tbaa !76
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %6 = load i32, i32* @atom_1_X2_3, align 4, !dbg !95, !tbaa !76
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X5_0, align 4, !dbg !96, !tbaa !76
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and7, metadata !153, metadata !DIExpression()), !dbg !155

  //   %and8 = and i32 %conv6, %and7, !dbg !99
  creg_r13 = max(creg__r7__3_,creg_r12);
  r13 = (r7==3) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and8, metadata !154, metadata !DIExpression()), !dbg !155
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !103
