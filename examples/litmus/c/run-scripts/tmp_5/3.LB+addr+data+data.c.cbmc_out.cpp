...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !101, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !104, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !105, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !106, metadata !DIExpression()), !dbg !122

  //   %conv1 = sext i32 %add to i64, !dbg !63

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !108, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !109, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !110, metadata !DIExpression()), !dbg !125
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !152, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !155, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !158, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !162, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !161, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !166, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !165, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !170, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !172, metadata !DIExpression()), !dbg !213

  //   %conv23 = trunc i64 %8 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !169, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !173, metadata !DIExpression()), !dbg !175
