...
T2BLOCK7:
  ...
  //   %cmp22 = icmp eq i32 %conv4, 2, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !89, metadata !DIExpression()), !dbg !140

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %5, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv10, 1, !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !93, metadata !DIExpression()), !dbg !143

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %6, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !125
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !152, metadata !DIExpression()), !dbg !159
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !192, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !195, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !226, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !230, metadata !DIExpression()), !dbg !302
