...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !122, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !123, metadata !DIExpression()), !dbg !146

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !124, metadata !DIExpression()), !dbg !148

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !128, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !129, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64 0, metadata !131, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !132, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64 0, metadata !134, metadata !DIExpression()), !dbg !153
  ...
  //   store i32 0, i32* @atom_0_X0_3, align 4, !dbg !75, !tbaa !76
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_2, align 4, !dbg !81, !tbaa !76
  // ST: Guess
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !138, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !139, metadata !DIExpression()), !dbg !146

  //   %5 = load i32, i32* @atom_0_X0_3, align 4, !dbg !94, !tbaa !76
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !140, metadata !DIExpression()), !dbg !146

  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !95, !tbaa !76
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X4_2, align 4, !dbg !96, !tbaa !76
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and7, metadata !144, metadata !DIExpression()), !dbg !146

  //   %and8 = and i32 %conv6, %and7, !dbg !99
  creg_r16 = max(creg__r10__3_,creg_r15);
  r16 = (r10==3) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and8, metadata !145, metadata !DIExpression()), !dbg !146
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([149 x i8], [149 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !103
