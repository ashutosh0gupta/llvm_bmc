...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !72, metadata !DIExpression()), !dbg !86
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !75, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !82, metadata !DIExpression()), !dbg !96
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !123, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !127, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !132, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !137, metadata !DIExpression()), !dbg !178
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !118
