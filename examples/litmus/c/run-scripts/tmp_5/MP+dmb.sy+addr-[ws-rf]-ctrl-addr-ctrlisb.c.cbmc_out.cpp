...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !156, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !157, metadata !DIExpression()), !dbg !202

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !158, metadata !DIExpression()), !dbg !204

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !162, metadata !DIExpression()), !dbg !206

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !163, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !164, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !167, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !176, metadata !DIExpression()), !dbg !217
  ...
  //   store i32 0, i32* @atom_1_X5_2, align 4, !dbg !110, !tbaa !106
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X11_0, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !233

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !182, metadata !DIExpression()), !dbg !233

  //   %conv = trunc i64 %6 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !179, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !183, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !237

  //   %7 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !187, metadata !DIExpression()), !dbg !237

  //   %conv18 = trunc i64 %7 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !184, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !188, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !190, metadata !DIExpression()), !dbg !241

  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !192, metadata !DIExpression()), !dbg !241

  //   %conv24 = trunc i64 %8 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !189, metadata !DIExpression()), !dbg !202

  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !134
  creg__r17__2_ = max(0,creg_r17);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !193, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !194, metadata !DIExpression()), !dbg !202

  //   %10 = load i32, i32* @atom_1_X5_2, align 4, !dbg !136, !tbaa !106
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !195, metadata !DIExpression()), !dbg !202

  //   %11 = load i32, i32* @atom_1_X11_0, align 4, !dbg !137, !tbaa !106
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !196, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !198, metadata !DIExpression()), !dbg !202

  //   %and28 = and i32 %conv26, %and27, !dbg !140
  creg_r23 = max(creg__r17__2_,creg_r22);
  r23 = (r17==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !199, metadata !DIExpression()), !dbg !202

  //   %and29 = and i32 %conv20, %and28, !dbg !141
  creg_r24 = max(creg__r16__1_,creg_r23);
  r24 = (r16==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !200, metadata !DIExpression()), !dbg !202

  //   %and30 = and i32 %conv14, %and29, !dbg !142
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !201, metadata !DIExpression()), !dbg !202
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !146
