...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !43, metadata !DIExpression()), !dbg !52
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !57, metadata !DIExpression()), !dbg !78
...
T2BLOCK4:
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !75
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !69, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !73, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !74, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !75, metadata !DIExpression()), !dbg !78
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !116, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !117, metadata !DIExpression()), !dbg !140

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !118, metadata !DIExpression()), !dbg !142

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !122, metadata !DIExpression()), !dbg !144
  ...
  //   store i32 0, i32* @atom_1_X3_2, align 4, !dbg !80, !tbaa !76
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_0, align 4, !dbg !81, !tbaa !76
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !132, metadata !DIExpression()), !dbg !160

  //   %conv = trunc i64 %4 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !129, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !133, metadata !DIExpression()), !dbg !140

  //   %5 = load i32, i32* @atom_1_X0_1, align 4, !dbg !94, !tbaa !76
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !134, metadata !DIExpression()), !dbg !140

  //   %6 = load i32, i32* @atom_1_X3_2, align 4, !dbg !95, !tbaa !76
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X4_0, align 4, !dbg !96, !tbaa !76
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and7, metadata !138, metadata !DIExpression()), !dbg !140
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([91 x i8], [91 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !103
