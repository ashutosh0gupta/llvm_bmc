...
T2BLOCK1:
  ...
  //   %cmp32 = icmp eq i32 %conv14, 1, !dbg !112
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !145, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !146, metadata !DIExpression()), !dbg !219

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !147, metadata !DIExpression()), !dbg !221

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !151, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !152, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !155, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !161, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !164, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !167, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !170, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !173, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !238

  //   store atomic i64 0, i64* @atom_1_X11_0 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !177, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !179, metadata !DIExpression()), !dbg !250

  //   %conv = trunc i64 %4 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !176, metadata !DIExpression()), !dbg !219

  //   %cmp = icmp eq i32 %conv, 1, !dbg !152

  //   %conv18 = zext i1 %cmp to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !180, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !184, metadata !DIExpression()), !dbg !254

  //   %conv22 = trunc i64 %5 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !181, metadata !DIExpression()), !dbg !219

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !156

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !185, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !189, metadata !DIExpression()), !dbg !258

  //   %conv28 = trunc i64 %6 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !186, metadata !DIExpression()), !dbg !219

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !160

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !190, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !192, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !194, metadata !DIExpression()), !dbg !262

  //   %conv34 = trunc i64 %7 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !191, metadata !DIExpression()), !dbg !219

  //   %cmp35 = icmp eq i32 %conv34, 1, !dbg !164

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !195, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !197, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !199, metadata !DIExpression()), !dbg !266

  //   %conv40 = trunc i64 %8 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !196, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !203, metadata !DIExpression()), !dbg !269

  //   %conv44 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !200, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !205, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !207, metadata !DIExpression()), !dbg !272

  //   %conv48 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !204, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !209, metadata !DIExpression()), !dbg !275

  //   %11 = load atomic i64, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !175
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !211, metadata !DIExpression()), !dbg !275

  //   %conv52 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !208, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !213, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !214, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !215, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !216, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !217, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !218, metadata !DIExpression()), !dbg !219
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187
