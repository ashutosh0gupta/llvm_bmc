...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !39, metadata !DIExpression()), !dbg !67

  //   br label %label_1, !dbg !68
  goto T1BLOCK1;

T1BLOCK1:
  //   call void @llvm.dbg.label(metadata !66), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64 1, metadata !43, metadata !DIExpression()), !dbg !70

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !46, metadata !DIExpression()), !dbg !72

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !73
  // LD: Guess
  old_cr = cr(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !48, metadata !DIExpression()), !dbg !72

  //   %conv = trunc i64 %0 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !44, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !49, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !50, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !51, metadata !DIExpression()), !dbg !77

  //   %conv3 = sext i32 %add to i64, !dbg !78

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !53, metadata !DIExpression()), !dbg !77

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !78
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !57, metadata !DIExpression()), !dbg !79

  //   %conv7 = trunc i64 %1 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !54, metadata !DIExpression()), !dbg !67

  //   %cmp = icmp eq i32 %conv7, 2, !dbg !82

  //   %conv8 = zext i1 %cmp to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !58, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !59, metadata !DIExpression()), !dbg !83

  //   %2 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !61, metadata !DIExpression()), !dbg !83

  //   store atomic i64 %2, i64* @atom_0_X5_2 seq_cst, align 8, !dbg !84
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv, 1, !dbg !85

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !62, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !63, metadata !DIExpression()), !dbg !86

  //   %3 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !65, metadata !DIExpression()), !dbg !86

  //   store atomic i64 %3, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !87
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !91, metadata !DIExpression()), !dbg !113

  //   br label %label_2, !dbg !64
  goto T2BLOCK1;

T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !111), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !92, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64 2, metadata !94, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !96, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !98, metadata !DIExpression()), !dbg !118

  //   %conv = trunc i64 %0 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !95, metadata !DIExpression()), !dbg !113
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !112), !dbg !126

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !100, metadata !DIExpression()), !dbg !127

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !78
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !102, metadata !DIExpression()), !dbg !127

  //   %conv4 = trunc i64 %1 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !99, metadata !DIExpression()), !dbg !113

  //   %cmp = icmp eq i32 %conv, 2, !dbg !80

  //   %conv5 = zext i1 %cmp to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !103, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !104, metadata !DIExpression()), !dbg !131

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !106, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %2, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !82
  // ST: Guess
  ...
  //   %cmp9 = icmp eq i32 %conv4, 0, !dbg !83

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !107, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !108, metadata !DIExpression()), !dbg !134

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !110, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %3, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !144, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !145, metadata !DIExpression()), !dbg !200

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !146, metadata !DIExpression()), !dbg !202

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !150, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64 0, metadata !153, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !154, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !157, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !160, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !163, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !166, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !170, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !172, metadata !DIExpression()), !dbg !227

  //   %conv = trunc i64 %4 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !169, metadata !DIExpression()), !dbg !200

  //   %cmp = icmp eq i32 %conv, 1, !dbg !130

  //   %conv14 = zext i1 %cmp to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !173, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !177, metadata !DIExpression()), !dbg !231

  //   %conv18 = trunc i64 %5 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !174, metadata !DIExpression()), !dbg !200

  //   %cmp19 = icmp eq i32 %conv18, 2, !dbg !134

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !178, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !180, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !179, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !184, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !183, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !188, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !190, metadata !DIExpression()), !dbg !241

  //   %conv32 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !187, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !192, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !194, metadata !DIExpression()), !dbg !244

  //   %conv36 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !191, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !196, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !197, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !198, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !199, metadata !DIExpression()), !dbg !200
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
