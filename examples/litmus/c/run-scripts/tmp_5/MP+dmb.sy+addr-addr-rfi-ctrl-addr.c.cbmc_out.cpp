...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X8_1, align 4, !dbg !107, !tbaa !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !160, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !216
  ...
  //   %8 = load i32, i32* @atom_1_X8_1, align 4, !dbg !130, !tbaa !103
  // LD: Guess
  old_cr = cr(0,6);
