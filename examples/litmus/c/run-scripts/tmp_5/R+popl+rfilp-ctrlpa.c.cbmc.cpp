...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !132, metadata !DIExpression()), !dbg !166

  //   %conv = trunc i64 %4 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !129, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !133, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !137, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !138, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !139, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !143, metadata !DIExpression()), !dbg !146

  //   %and14 = and i32 %conv12, %and13, !dbg !109
  creg_r13 = max(creg__r7__2_,creg_r12);
  r13 = (r7==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !144, metadata !DIExpression()), !dbg !146
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !114
