...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !95, metadata !DIExpression()), !dbg !114

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !97, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %3, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !76
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !143, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !146, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !164, metadata !DIExpression()), !dbg !213

  //   %7 = load atomic i64, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !168, metadata !DIExpression()), !dbg !216
