...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !94), !dbg !117
  ...
  //   %cmp21 = icmp eq i32 %conv4, 1, !dbg !116
  ...
  //   store i32 %conv22, i32* @atom_1_X4_1, align 4, !dbg !117, !tbaa !112
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv11, 0, !dbg !118
  ...
  //   store i32 %conv24, i32* @atom_1_X5_0, align 4, !dbg !119, !tbaa !112
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !147, metadata !DIExpression()), !dbg !154
