...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !62, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !65, metadata !DIExpression()), !dbg !82

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !64
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !66, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64 2, metadata !68, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !69, metadata !DIExpression()), !dbg !74

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !70, metadata !DIExpression()), !dbg !87

  //   %1 = zext i32 %conv4 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !72, metadata !DIExpression()), !dbg !87
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !98, metadata !DIExpression()), !dbg !109

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !100, metadata !DIExpression()), !dbg !109

  //   store atomic i64 %1, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !55
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !118
