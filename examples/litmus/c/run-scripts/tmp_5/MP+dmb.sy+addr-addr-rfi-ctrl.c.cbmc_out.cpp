...
T2BLOCK4:
  ...
  //   %cmp18 = icmp eq i32 %conv12, 1, !dbg !97
  ...
  //   store i32 %conv19, i32* @atom_1_X8_1, align 4, !dbg !98, !tbaa !93
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !135
