...
T2BLOCK1:
  ...
  //   %conv1 = sext i32 %conv to i64, !dbg !65

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !63, metadata !DIExpression()), !dbg !83

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !65
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !64, metadata !DIExpression()), !dbg !77

  //   %cmp = icmp eq i32 %conv, 1, !dbg !70

  //   %conv6 = zext i1 %cmp to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !68, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !69, metadata !DIExpression()), !dbg !90
  ...
  //   %cmp10 = icmp eq i32 %conv5, 0, !dbg !73

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !72, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !73, metadata !DIExpression()), !dbg !93

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !93

  //   store atomic i64 %3, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !75
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !110, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i64 0, metadata !112, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !113, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !116, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !119, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !122, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !126, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !128, metadata !DIExpression()), !dbg !159

  //   %conv = trunc i64 %4 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !125, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !130, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !129, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !133, metadata !DIExpression()), !dbg !134
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 58, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !106
