...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X2_2, align 4, !dbg !86, !tbaa !87
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_1_X2_2, align 4, !dbg !109, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !119
