...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !40, metadata !DIExpression()), !dbg !51
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !54
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !59, metadata !DIExpression()), !dbg !78
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !64, metadata !DIExpression()), !dbg !81

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !60, metadata !DIExpression()), !dbg !78

  //   call void (...) @dmbld(), !dbg !65
  // dumbld: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !68, metadata !DIExpression()), !dbg !85

  //   %conv4 = trunc i64 %1 to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !78

  //   %cmp = icmp eq i32 %conv, 1, !dbg !69

  //   %conv5 = zext i1 %cmp to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !69, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !70, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !73, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !74, metadata !DIExpression()), !dbg !92

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !92
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !99, metadata !DIExpression()), !dbg !118
  ...
  //   call void (...) @dmbld(), !dbg !65
  // dumbld: Guess
  cdl[3] = get_rng(0,NCONTEXT-1);
  // Check
  ASSUME(cdl[3] >= cdy[3]);
  ASSUME(cdl[3] >= cr(3,0+0));
  ASSUME(cdl[3] >= cr(3,0+1));
  ASSUME(cdl[3] >= cr(3,6+0));
  ASSUME(cdl[3] >= cr(3,2+0));
  ASSUME(cdl[3] >= cr(3,3+0));
  ASSUME(cdl[3] >= cr(3,4+0));
  ASSUME(cdl[3] >= cr(3,5+0));
  ASSUME(cdl[3] >= cr(3,7+0));
  ASSUME(cdl[3] >= cr(3,8+0));
  ASSUME(creturn[3] >= cdl[3]);

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !103, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !107, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !111, metadata !DIExpression()), !dbg !129
...
T0BLOCK0:
  ...
  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #6, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !146, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !147, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !153, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64 0, metadata !155, metadata !DIExpression()), !dbg !195

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !156, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64 0, metadata !158, metadata !DIExpression()), !dbg !197

  //   store atomic i64 0, i64* @atom_1_X2_0 monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !159, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64 0, metadata !161, metadata !DIExpression()), !dbg !199

  //   store atomic i64 0, i64* @atom_2_X0_1 monotonic, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !162, metadata !DIExpression()), !dbg !201
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !109
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call12 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #6, !dbg !110
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !166, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !168, metadata !DIExpression()), !dbg !216

  //   %conv = trunc i64 %6 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !165, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !170, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !172, metadata !DIExpression()), !dbg !219

  //   %conv19 = trunc i64 %7 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !169, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !174, metadata !DIExpression()), !dbg !222

  //   %8 = load atomic i64, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !176, metadata !DIExpression()), !dbg !222

  //   %conv23 = trunc i64 %8 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !173, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !178, metadata !DIExpression()), !dbg !225

  //   %9 = load atomic i64, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !180, metadata !DIExpression()), !dbg !225

  //   %conv27 = trunc i64 %9 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !177, metadata !DIExpression()), !dbg !184
  ...
  //   %or = or i32 %conv19, %and, !dbg !134
  creg_r13 = max(creg_r9,creg_r12);
  ASSUME(active[creg_r13] == 0);
  r13 = r9 | r12;

  //   call void @llvm.dbg.value(metadata i32 %or, metadata !182, metadata !DIExpression()), !dbg !184

  //   %and28 = and i32 %conv, %or, !dbg !135
  ...
  //   %cmp = icmp eq i32 %and28, 1, !dbg !136
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([91 x i8], [91 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !139
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #6, !dbg !142

  //   %11 = bitcast i64* %thr1 to i8*, !dbg !142

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #6, !dbg !142

  //   %12 = bitcast i64* %thr0 to i8*, !dbg !142

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #6, !dbg !142
