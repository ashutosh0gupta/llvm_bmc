...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !97, metadata !DIExpression()), !dbg !138

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %7, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !120
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !190, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !196, metadata !DIExpression()), !dbg !262

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !262

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !142
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !223, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !231, metadata !DIExpression()), !dbg !301
