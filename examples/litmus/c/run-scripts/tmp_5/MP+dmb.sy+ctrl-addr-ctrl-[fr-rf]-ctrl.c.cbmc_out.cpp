...
T2BLOCK10:
  ...
  //   %cmp29 = icmp eq i32 %conv15, 0, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !91, metadata !DIExpression()), !dbg !150

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !132
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv19, 1, !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !95, metadata !DIExpression()), !dbg !153

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %8, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !135
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !162, metadata !DIExpression()), !dbg !169
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !205, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !208, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !215, metadata !DIExpression()), !dbg !289
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !220, metadata !DIExpression()), !dbg !293
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !225, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !234, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !238, metadata !DIExpression()), !dbg !307
