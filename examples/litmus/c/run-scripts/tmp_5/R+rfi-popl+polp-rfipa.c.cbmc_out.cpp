...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !44, metadata !DIExpression()), !dbg !62
  ...
  //   %cmp8 = icmp eq i32 %conv, 2, !dbg !78
  ...
  //   store i32 %conv9, i32* @atom_0_X2_2, align 4, !dbg !79, !tbaa !74
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !84, metadata !DIExpression()), !dbg !104
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !67
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !90, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !97, metadata !DIExpression()), !dbg !111

  //   %conv6 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !94, metadata !DIExpression()), !dbg !101
  ...
  //   store i32 %conv7, i32* @atom_1_X5_2, align 4, !dbg !73, !tbaa !74
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !99, metadata !DIExpression()), !dbg !101

  //   store i32 %conv9, i32* @atom_1_X4_1, align 4, !dbg !79, !tbaa !74
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X2_2, align 4, !dbg !90, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X5_2, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_1, align 4, !dbg !92, !tbaa !86
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_0_X2_2, align 4, !dbg !110, !tbaa !86
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X5_2, align 4, !dbg !111, !tbaa !86
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X4_1, align 4, !dbg !112, !tbaa !86
  // LD: Guess
  old_cr = cr(0,5);
