...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !74, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !79, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !80, metadata !DIExpression()), !dbg !97

  //   %add7 = add nsw i32 0, %xor5, !dbg !82
  ...
  //   %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !82
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !81, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64 1, metadata !83, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* %arrayidx9 monotonic, align 8, !dbg !82
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !84, metadata !DIExpression()), !dbg !97

  //   %cmp = icmp eq i32 %conv, 1, !dbg !87

  //   %conv15 = zext i1 %cmp to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !88, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !89, metadata !DIExpression()), !dbg !116

  //   %3 = zext i32 %conv15 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !91, metadata !DIExpression()), !dbg !116

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !89
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv14, 1, !dbg !90

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !92, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !93, metadata !DIExpression()), !dbg !119

  //   %4 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !95, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %4, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !145, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !165, metadata !DIExpression()), !dbg !215
