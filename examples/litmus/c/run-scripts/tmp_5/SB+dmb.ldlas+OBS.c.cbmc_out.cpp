...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !94, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !95, metadata !DIExpression()), !dbg !122

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !96, metadata !DIExpression()), !dbg !124

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !100, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !101, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 0, metadata !103, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !106, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !108, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !110, metadata !DIExpression()), !dbg !141

  //   %conv = trunc i64 %4 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !107, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !111, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !115, metadata !DIExpression()), !dbg !145

  //   %conv10 = trunc i64 %5 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !112, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !116, metadata !DIExpression()), !dbg !122

  //   %6 = load i32, i32* @atom_0_X2_0, align 4, !dbg !99, !tbaa !78
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !117, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !118, metadata !DIExpression()), !dbg !122

  //   %and = and i32 %6, %7, !dbg !101
  creg_r9 = max(creg_r7,creg_r8);
  r9 = r7 & r8;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !119, metadata !DIExpression()), !dbg !122

  //   %and13 = and i32 %conv12, %and, !dbg !102
  creg_r10 = max(creg__r6__1_,creg_r9);
  r10 = (r6==1) & r9;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !120, metadata !DIExpression()), !dbg !122

  //   %and14 = and i32 %conv6, %and13, !dbg !103
  creg_r11 = max(creg__r5__1_,creg_r10);
  r11 = (r5==1) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !121, metadata !DIExpression()), !dbg !122
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !107
