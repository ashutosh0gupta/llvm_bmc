...
T2BLOCK7:
  ...
  //   %cmp29 = icmp eq i32 %conv16, 0, !dbg !116
  ...
  //   store i32 %conv30, i32* @atom_1_X8_0, align 4, !dbg !117, !tbaa !112
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv20, 1, !dbg !118
  ...
  //   store i32 %conv32, i32* @atom_1_X10_1, align 4, !dbg !119, !tbaa !112
  // ST: Guess
...
T0BLOCK0:
  ...
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l71_c16
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l71_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !186, metadata !DIExpression()), !dbg !242
