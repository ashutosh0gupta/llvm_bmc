...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !134, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !135, metadata !DIExpression()), !dbg !168

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !136, metadata !DIExpression()), !dbg !170

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !140, metadata !DIExpression()), !dbg !172

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !141, metadata !DIExpression()), !dbg !174
  ...
  //   store i32 0, i32* @atom_1_X9_1, align 4, !dbg !95, !tbaa !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !152, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !155, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !156, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !160, metadata !DIExpression()), !dbg !168
  ...
  //   %10 = load i32, i32* @atom_1_X9_1, align 4, !dbg !117, !tbaa !90
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !165, metadata !DIExpression()), !dbg !168
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !125
