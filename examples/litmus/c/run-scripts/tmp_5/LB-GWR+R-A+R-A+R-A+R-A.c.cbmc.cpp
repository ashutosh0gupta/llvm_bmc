...
T0BLOCK0:
  ...
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l91_c15
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l91_c15
  // Check
  ...
  //   store i32 0, i32* @atom_5_X1_0, align 4, !dbg !118, !tbaa !114
  // ST: Guess
  ...
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l96_c15
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l96_c15
  // Check
  ...
  //   %13 = load i32, i32* @atom_5_X1_0, align 4, !dbg !144, !tbaa !114
  // LD: Guess
  old_cr = cr(0,11);
