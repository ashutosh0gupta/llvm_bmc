...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !160, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !163, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !188, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !192, metadata !DIExpression()), !dbg !253

  //   %8 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !154
  // LD: Guess
  old_cr = cr(0,4);
