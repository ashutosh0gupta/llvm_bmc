...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X3_0, align 4, !dbg !113, !tbaa !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !192, metadata !DIExpression()), !dbg !247
  ...
  //   %10 = load i32, i32* @atom_1_X3_0, align 4, !dbg !141, !tbaa !109
  // LD: Guess
  old_cr = cr(0,5);
