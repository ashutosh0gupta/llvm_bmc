...
T2BLOCK2:
  //   br label %lbl_label204, !dbg !59
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label204, !dbg !60
  goto T2BLOCK4;
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !91, metadata !DIExpression()), !dbg !98
...
T3BLOCK2:
  //   br label %lbl_label205, !dbg !59
  goto T3BLOCK4;

T3BLOCK3:
  //   br label %lbl_label205, !dbg !60
  goto T3BLOCK4;
...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !95, metadata !DIExpression()), !dbg !98
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !123, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !124, metadata !DIExpression()), !dbg !146

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !125, metadata !DIExpression()), !dbg !148

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !129, metadata !DIExpression()), !dbg !150

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !68

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !68

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !130, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !138, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !140, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !141, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32 %and9, metadata !145, metadata !DIExpression()), !dbg !146
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !102
