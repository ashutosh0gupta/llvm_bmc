...
T1BLOCK2:
  //   br label %lbl_label114, !dbg !64
  goto T1BLOCK4;

T1BLOCK3:
  //   br label %lbl_label114, !dbg !65
  goto T1BLOCK4;
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !84, metadata !DIExpression()), !dbg !97
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !102, metadata !DIExpression()), !dbg !117

  //   br label %label_3, !dbg !55
  goto T3BLOCK1;

T3BLOCK1:
  //   call void @llvm.dbg.label(metadata !115), !dbg !119

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !104, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !106, metadata !DIExpression()), !dbg !120

  //   %conv = trunc i64 %0 to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !103, metadata !DIExpression()), !dbg !117

  //   %cmp = icmp eq i32 %conv, 0, !dbg !60

  //   %conv1 = zext i1 %cmp to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !107, metadata !DIExpression()), !dbg !117
...
T3BLOCK2:
  //   br label %lbl_label115, !dbg !64
  goto T3BLOCK4;

T3BLOCK3:
  //   br label %lbl_label115, !dbg !65
  goto T3BLOCK4;

T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !116), !dbg !129

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !108, metadata !DIExpression()), !dbg !130

  //   call void @llvm.dbg.value(metadata i64 1, metadata !110, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !111, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !112, metadata !DIExpression()), !dbg !133

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !114, metadata !DIExpression()), !dbg !133
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([132 x i8], [132 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
