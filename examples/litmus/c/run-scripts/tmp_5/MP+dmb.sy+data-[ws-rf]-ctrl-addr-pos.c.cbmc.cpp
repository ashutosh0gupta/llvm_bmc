...
T2BLOCK4:
  ...
  //   %xor10 = xor i32 %conv9, %conv9, !dbg !108
  ...
  //   %add12 = add nsw i32 0, %xor10, !dbg !109
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add12 to i64, !dbg !109
  ...
  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(2,r7);
