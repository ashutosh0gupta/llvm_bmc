...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !80, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !81, metadata !DIExpression()), !dbg !97

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !56

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !56

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !82, metadata !DIExpression()), !dbg !99

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !58

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !58

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !86, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64 0, metadata !89, metadata !DIExpression()), !dbg !102

  //   store atomic i64 0, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !61
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X0_2, align 4, !dbg !62, !tbaa !63
  // ST: Guess
  iw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l37_c15
  old_cw = cw(0,1);
  cw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l37_c15
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !67
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call1 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !68
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !69, !tbaa !70
  r2 = local_mem[0];

  //   %call2 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !72
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !73, !tbaa !70
  r3 = local_mem[1];

  //   %call3 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !74
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !91, metadata !DIExpression()), !dbg !113

  //   %4 = load atomic i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !76
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !93, metadata !DIExpression()), !dbg !113

  //   %conv = trunc i64 %4 to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !90, metadata !DIExpression()), !dbg !97

  //   %cmp = icmp eq i32 %conv, 2, !dbg !78
  creg__r4__2_ = max(0,creg_r4);

  //   %conv4 = zext i1 %cmp to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !94, metadata !DIExpression()), !dbg !97

  //   %5 = load i32, i32* @atom_0_X0_2, align 4, !dbg !79, !tbaa !63
  // LD: Guess
  old_cr = cr(0,1);
  cr(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l47_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !95, metadata !DIExpression()), !dbg !97

  //   %and = and i32 %conv4, %5, !dbg !80
  creg_r6 = max(creg__r4__2_,creg_r5);
  r6 = (r4==2) & r5;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !96, metadata !DIExpression()), !dbg !97

  //   %cmp5 = icmp eq i32 %and, 1, !dbg !81
  creg__r6__1_ = max(0,creg_r6);

  //   br i1 %cmp5, label %if.then, label %if.end, !dbg !83
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 49, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !84
...
T0BLOCK2:
  //   %6 = bitcast i64* %thr1 to i8*, !dbg !87

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %6) #7, !dbg !87

  //   %7 = bitcast i64* %thr0 to i8*, !dbg !87

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %7) #7, !dbg !87
