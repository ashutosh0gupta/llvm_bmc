...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !82, metadata !DIExpression()), !dbg !94
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !84, metadata !DIExpression()), !dbg !97

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !57
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !88, metadata !DIExpression()), !dbg !100

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !60
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !87, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !91, metadata !DIExpression()), !dbg !94

  //   store i32 %conv5, i32* @atom_2_X0_1, align 4, !dbg !63, !tbaa !64
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !92, metadata !DIExpression()), !dbg !94

  //   store i32 %conv7, i32* @atom_2_X2_0, align 4, !dbg !69, !tbaa !64
  // ST: Guess
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !111, metadata !DIExpression()), !dbg !123
  ...
  // ST: Guess
  //   : Release
  iw(4,0+2*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l49_c3
  old_cw = cw(4,0+2*1);
  cw(4,0+2*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l49_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !115, metadata !DIExpression()), !dbg !125

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !57
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0);
  cr(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l50_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !117, metadata !DIExpression()), !dbg !125

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !114, metadata !DIExpression()), !dbg !120
  ...
  //   store i32 %conv1, i32* @atom_3_X2_0, align 4, !dbg !60, !tbaa !61
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_2_X2_0, align 4, !dbg !90, !tbaa !85
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_2_X2_0, align 4, !dbg !108, !tbaa !85
  // LD: Guess
  old_cr = cr(0,5);
