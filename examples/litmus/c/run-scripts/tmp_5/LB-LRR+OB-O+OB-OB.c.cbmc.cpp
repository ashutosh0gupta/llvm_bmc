...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !46, metadata !DIExpression()), !dbg !61
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !89
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !103, metadata !DIExpression()), !dbg !122
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !160, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !167, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !170, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !173, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !179, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !183, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !185, metadata !DIExpression()), !dbg !240

  //   %conv = trunc i64 %8 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !182, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !187, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !189, metadata !DIExpression()), !dbg !243

  //   %conv23 = trunc i64 %9 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !186, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !191, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !193, metadata !DIExpression()), !dbg !246

  //   %conv27 = trunc i64 %10 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !190, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !195, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !197, metadata !DIExpression()), !dbg !249

  //   %conv31 = trunc i64 %11 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !194, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !199, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !200, metadata !DIExpression()), !dbg !201
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !150
