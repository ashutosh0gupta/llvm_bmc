...
T2BLOCK1:
  ...
  //   %xor9 = xor i32 %conv8, %conv8, !dbg !103
  creg_r6 = max(creg_r5,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !76, metadata !DIExpression()), !dbg !109

  //   %add11 = add nsw i32 0, %xor9, !dbg !104
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 0 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !104

  //   %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !104
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !78, metadata !DIExpression()), !dbg !124

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !77, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !83, metadata !DIExpression()), !dbg !126

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !97, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !101, metadata !DIExpression()), !dbg !141

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !103, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %8, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !123
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !193, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !227, metadata !DIExpression()), !dbg !298
