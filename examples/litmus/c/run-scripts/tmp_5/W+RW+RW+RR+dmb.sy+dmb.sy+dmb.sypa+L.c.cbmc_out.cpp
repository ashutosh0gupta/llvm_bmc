...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !106, metadata !DIExpression()), !dbg !118
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !108, metadata !DIExpression()), !dbg !121

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !57
  // LD: Guess
  old_cr = cr(4,0+2*1);
  cr(4,0+2*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l48_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !107, metadata !DIExpression()), !dbg !118
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !61
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !111, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !115, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !116, metadata !DIExpression()), !dbg !118
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
