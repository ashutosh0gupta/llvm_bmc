...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !66, metadata !DIExpression()), !dbg !99

  //   %conv4 = trunc i64 %1 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !63, metadata !DIExpression()), !dbg !93
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !67, metadata !DIExpression()), !dbg !93
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !79, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !83, metadata !DIExpression()), !dbg !126

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %5, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !87, metadata !DIExpression()), !dbg !129

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %6, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !111
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !152, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !153, metadata !DIExpression()), !dbg !204

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !154, metadata !DIExpression()), !dbg !206

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !158, metadata !DIExpression()), !dbg !208

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !159, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !166, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !172, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !175, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !221

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !181, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !184, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !186, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !189, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !191, metadata !DIExpression()), !dbg !244

  //   %conv26 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !188, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !193, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !195, metadata !DIExpression()), !dbg !247

  //   %conv30 = trunc i64 %9 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !192, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !197, metadata !DIExpression()), !dbg !250

  //   %10 = load atomic i64, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !199, metadata !DIExpression()), !dbg !250
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 84, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !150
