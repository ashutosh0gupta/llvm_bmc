...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !99), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !90, metadata !DIExpression()), !dbg !138

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !120
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !187, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !241

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !212, metadata !DIExpression()), !dbg !272

  //   %10 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !153
  // LD: Guess
  old_cr = cr(0,5);
