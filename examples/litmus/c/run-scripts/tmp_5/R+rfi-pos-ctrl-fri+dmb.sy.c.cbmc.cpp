...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !64), !dbg !81
  ...
  //   store i32 %conv13, i32* @atom_0_X3_1, align 4, !dbg !94, !tbaa !89
  // ST: Guess
  ...
  //   store i32 %conv15, i32* @atom_0_X4_0, align 4, !dbg !96, !tbaa !89
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !136, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !139, metadata !DIExpression()), !dbg !168
  ...
  //   store i32 0, i32* @atom_0_X4_0, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !142, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !146, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !147, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !151, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !152, metadata !DIExpression()), !dbg !161
  ...
  //   %8 = load i32, i32* @atom_0_X4_0, align 4, !dbg !111, !tbaa !86
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !157, metadata !DIExpression()), !dbg !161

  //   %and14 = and i32 %6, %and13, !dbg !115
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !158, metadata !DIExpression()), !dbg !161

  //   %and15 = and i32 %conv12, %and14, !dbg !116
  creg_r16 = max(creg__r8__2_,creg_r15);
  r16 = (r8==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !159, metadata !DIExpression()), !dbg !161
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
