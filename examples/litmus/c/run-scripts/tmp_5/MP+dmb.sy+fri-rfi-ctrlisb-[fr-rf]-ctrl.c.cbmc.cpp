...
T2BLOCK7:
  ...
  //   %cmp24 = icmp eq i32 %conv4, 2, !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !91, metadata !DIExpression()), !dbg !146

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %6, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !128
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !198, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !201, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !204, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !230, metadata !DIExpression()), !dbg !303
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !234, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !238, metadata !DIExpression()), !dbg !309
