...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !152, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !153, metadata !DIExpression()), !dbg !188

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !154, metadata !DIExpression()), !dbg !190

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !158, metadata !DIExpression()), !dbg !192

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !159, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !160, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !166, metadata !DIExpression()), !dbg !199
  ...
  //   store i32 0, i32* @atom_1_X3_2, align 4, !dbg !98, !tbaa !94
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X7_0, align 4, !dbg !99, !tbaa !94
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X9_1, align 4, !dbg !100, !tbaa !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !173, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !177, metadata !DIExpression()), !dbg !220

  //   %conv14 = trunc i64 %7 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !174, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !178, metadata !DIExpression()), !dbg !188
  ...
  //   %9 = load i32, i32* @atom_1_X3_2, align 4, !dbg !121, !tbaa !94
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_1_X7_0, align 4, !dbg !122, !tbaa !94
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X9_1, align 4, !dbg !123, !tbaa !94
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !184, metadata !DIExpression()), !dbg !188

  //   %and18 = and i32 %8, %and17, !dbg !126
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !185, metadata !DIExpression()), !dbg !188

  //   %and19 = and i32 %conv16, %and18, !dbg !127
  creg_r21 = max(creg__r13__2_,creg_r20);
  r21 = (r13==2) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !186, metadata !DIExpression()), !dbg !188

  //   %and20 = and i32 %conv10, %and19, !dbg !128
  creg_r22 = max(creg__r12__2_,creg_r21);
  r22 = (r12==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !187, metadata !DIExpression()), !dbg !188
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !132
