...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !108, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !109, metadata !DIExpression()), !dbg !135

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !110, metadata !DIExpression()), !dbg !137

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !68

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !68

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !114, metadata !DIExpression()), !dbg !139

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !115, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !116, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64 0, metadata !118, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !125, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !126, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !130, metadata !DIExpression()), !dbg !162

  //   %conv12 = trunc i64 %7 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !127, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !131, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !134, metadata !DIExpression()), !dbg !135
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([128 x i8], [128 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !106
