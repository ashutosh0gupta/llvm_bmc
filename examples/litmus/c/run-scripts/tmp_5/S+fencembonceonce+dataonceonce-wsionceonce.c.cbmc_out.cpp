...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !95, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !96, metadata !DIExpression()), !dbg !115

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !59

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !59

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !97, metadata !DIExpression()), !dbg !117

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !61

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !61

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !101, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !102, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64 0, metadata !104, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !109, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !111, metadata !DIExpression()), !dbg !133

  //   %conv = trunc i64 %4 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !108, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !112, metadata !DIExpression()), !dbg !115
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 55, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !89
