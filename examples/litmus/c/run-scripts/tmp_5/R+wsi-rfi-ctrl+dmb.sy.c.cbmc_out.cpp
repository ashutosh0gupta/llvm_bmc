...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !56), !dbg !72
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !74
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !51, metadata !DIExpression()), !dbg !57

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !52, metadata !DIExpression()), !dbg !76

  //   %1 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !54, metadata !DIExpression()), !dbg !76

  //   store atomic i64 %1, i64* @atom_0_X3_2 seq_cst, align 8, !dbg !77
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !90, metadata !DIExpression()), !dbg !104
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !127, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !130, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !144, metadata !DIExpression()), !dbg !185
