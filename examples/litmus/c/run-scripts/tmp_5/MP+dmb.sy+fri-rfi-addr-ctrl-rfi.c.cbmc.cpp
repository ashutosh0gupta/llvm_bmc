...
T2BLOCK4:
  ...
  //   %conv14 = trunc i64 %3 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !78, metadata !DIExpression()), !dbg !96

  //   %cmp = icmp eq i32 %conv, 1, !dbg !103

  //   %conv15 = zext i1 %cmp to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !82, metadata !DIExpression()), !dbg !96
  ...
  //   %cmp19 = icmp eq i32 %conv4, 2, !dbg !106

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !86, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !87, metadata !DIExpression()), !dbg !126
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !155, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !158, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !161, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !179, metadata !DIExpression()), !dbg !228
