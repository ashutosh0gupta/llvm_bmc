...
T2BLOCK4:
  ...
  //   %add11 = add nsw i32 0, %xor9, !dbg !107
  ...
  //   %arrayidx13 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !107
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !79, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !91, metadata !DIExpression()), !dbg !136
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !188, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !217, metadata !DIExpression()), !dbg !285
