...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !105, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !106, metadata !DIExpression()), !dbg !133

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !107, metadata !DIExpression()), !dbg !135

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !111, metadata !DIExpression()), !dbg !137

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !112, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64 0, metadata !114, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !115, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64 0, metadata !117, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !121, metadata !DIExpression()), !dbg !152

  //   %conv = trunc i64 %4 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !118, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !122, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !126, metadata !DIExpression()), !dbg !156

  //   %conv10 = trunc i64 %5 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !123, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !127, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !130, metadata !DIExpression()), !dbg !133

  //   %and13 = and i32 %conv12, %and, !dbg !102
  creg_r14 = max(creg__r10__1_,creg_r13);
  r14 = (r10==1) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !131, metadata !DIExpression()), !dbg !133

  //   %and14 = and i32 %conv6, %and13, !dbg !103
  creg_r15 = max(creg__r9__2_,creg_r14);
  r15 = (r9==2) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !132, metadata !DIExpression()), !dbg !133
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !107
