...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !126, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !127, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64 0, metadata !129, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !130, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64 0, metadata !132, metadata !DIExpression()), !dbg !153
  ...
  //   store i32 0, i32* @atom_0_X0_1, align 4, !dbg !78, !tbaa !79
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X0_2, align 4, !dbg !83, !tbaa !79
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !84, !tbaa !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !136, metadata !DIExpression()), !dbg !169

  //   %conv = trunc i64 %6 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !133, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !137, metadata !DIExpression()), !dbg !144

  //   %7 = load i32, i32* @atom_0_X0_1, align 4, !dbg !100, !tbaa !79
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %8 = load i32, i32* @atom_1_X0_2, align 4, !dbg !101, !tbaa !79
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %9 = load i32, i32* @atom_2_X0_1, align 4, !dbg !102, !tbaa !79
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !140, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i32 %and9, metadata !142, metadata !DIExpression()), !dbg !144

  //   %and10 = and i32 %conv8, %and9, !dbg !105
  creg_r13 = max(creg__r7__2_,creg_r12);
  r13 = (r7==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and10, metadata !143, metadata !DIExpression()), !dbg !144
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !109
