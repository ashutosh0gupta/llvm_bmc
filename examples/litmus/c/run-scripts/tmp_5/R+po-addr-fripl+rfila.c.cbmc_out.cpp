...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !46, metadata !DIExpression()), !dbg !75
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_0, metadata !158, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !203

  //   store atomic i64 0, i64* @atom_0_X5_0 monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_0, metadata !177, metadata !DIExpression()), !dbg !226

  //   %6 = load atomic i64, i64* @atom_0_X5_0 seq_cst, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,3);
