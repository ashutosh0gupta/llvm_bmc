...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !61, metadata !DIExpression()), !dbg !72
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !64
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   %conv8 = trunc i64 %2 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !65, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !69, metadata !DIExpression()), !dbg !72

  //   store i32 %conv9, i32* @atom_1_X0_2, align 4, !dbg !67, !tbaa !68
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv8, 0, !dbg !72
  creg__r2__0_ = max(0,creg_r2);

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !70, metadata !DIExpression()), !dbg !72

  //   store i32 %conv11, i32* @atom_1_X4_0, align 4, !dbg !73, !tbaa !68
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64 9, metadata !110, metadata !DIExpression()), !dbg !122

  //   store atomic i64 9, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !62
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X0_2, align 4, !dbg !65, !tbaa !66
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_0, align 4, !dbg !70, !tbaa !66
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_1_X0_2, align 4, !dbg !79, !tbaa !66
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l54_c13
  // Check
  ...
  //   %5 = load i32, i32* @atom_1_X4_0, align 4, !dbg !80, !tbaa !66
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 57, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !85
