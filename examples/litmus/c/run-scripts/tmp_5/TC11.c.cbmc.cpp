...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !42, metadata !DIExpression()), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !46, metadata !DIExpression()), !dbg !65

  //   %conv1 = sext i32 %conv to i64, !dbg !66

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !48, metadata !DIExpression()), !dbg !65

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !66
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !50, metadata !DIExpression()), !dbg !67

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !68
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !53, metadata !DIExpression()), !dbg !70

  //   %conv8 = sext i32 %conv5 to i64, !dbg !71

  //   call void @llvm.dbg.value(metadata i64 %conv8, metadata !55, metadata !DIExpression()), !dbg !70

  //   store atomic i64 %conv8, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  // ST: Guess
  iw(1,5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l29_c15
  old_cw = cw(1,5);
  cw(1,5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l29_c15
  // Check
  ASSUME(active[iw(1,5)] == 1);
  ASSUME(active[cw(1,5)] == 1);
  ASSUME(sforbid(5,cw(1,5))== 0);
  ASSUME(iw(1,5) >= creg__r1__1_);
  ASSUME(iw(1,5) >= 0);
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !85, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !87, metadata !DIExpression()), !dbg !104

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !84, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !107

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !66
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !91, metadata !DIExpression()), !dbg !107

  //   %conv4 = trunc i64 %1 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !88, metadata !DIExpression()), !dbg !101
  ...
  //   %conv5 = sext i32 %conv4 to i64, !dbg !69

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !94, metadata !DIExpression()), !dbg !110

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !69
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !95, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64 1, metadata !97, metadata !DIExpression()), !dbg !112

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  //   %cmp = icmp eq i32 %conv4, 1, !dbg !72
  creg__r3__1_ = max(0,creg_r3);

  //   %conv8 = zext i1 %cmp to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !98, metadata !DIExpression()), !dbg !101

  //   store i32 %conv8, i32* @atom_1_X2_1, align 4, !dbg !73, !tbaa !74
  // ST: Guess
  iw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l40_c15
  old_cw = cw(2,6);
  cw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l40_c15
  // Check
  ...
  //   %cmp9 = icmp eq i32 %conv, 1, !dbg !78
  creg__r2__1_ = max(0,creg_r2);

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !99, metadata !DIExpression()), !dbg !101

  //   store i32 %conv10, i32* @atom_1_X0_1, align 4, !dbg !79, !tbaa !74
  // ST: Guess
  iw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l42_c15
  old_cw = cw(2,7);
  cw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l42_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !126, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !127, metadata !DIExpression()), !dbg !152

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !128, metadata !DIExpression()), !dbg !154

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !132, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !133, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64 0, metadata !135, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !136, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64 0, metadata !138, metadata !DIExpression()), !dbg !159

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !78
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !139, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 0, metadata !141, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !142, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !163
  ...
  //   store i32 0, i32* @atom_0_X0_1, align 4, !dbg !83, !tbaa !84
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X3_1, align 4, !dbg !88, !tbaa !84
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X2_1, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l56_c15
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l56_c15
  // Check
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !90, !tbaa !84
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l57_c15
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l57_c15
  // Check
  ...
  //   %call7 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !92
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call8 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !96
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !97, !tbaa !94
  r6 = local_mem[1];
  ...
  //   %4 = load i32, i32* @atom_0_X0_1, align 4, !dbg !99, !tbaa !84
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !145, metadata !DIExpression()), !dbg !152

  //   %5 = load i32, i32* @atom_0_X3_1, align 4, !dbg !100, !tbaa !84
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !146, metadata !DIExpression()), !dbg !152

  //   %6 = load i32, i32* @atom_1_X2_1, align 4, !dbg !101, !tbaa !84
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l67_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !147, metadata !DIExpression()), !dbg !152

  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !102, !tbaa !84
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l68_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !148, metadata !DIExpression()), !dbg !152

  //   %and = and i32 %6, %7, !dbg !103
  creg_r11 = max(creg_r10,creg_r9);
  r11 = r9 & r10;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !149, metadata !DIExpression()), !dbg !152

  //   %and10 = and i32 %5, %and, !dbg !104
  creg_r12 = max(creg_r11,creg_r8);
  r12 = r8 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and10, metadata !150, metadata !DIExpression()), !dbg !152

  //   %and11 = and i32 %4, %and10, !dbg !105
  creg_r13 = max(creg_r12,creg_r7);
  r13 = r7 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and11, metadata !151, metadata !DIExpression()), !dbg !152

  //   %cmp = icmp eq i32 %and11, 1, !dbg !106
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !109
...
T0BLOCK2:
  //   %8 = bitcast i64* %thr1 to i8*, !dbg !112

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #7, !dbg !112

  //   %9 = bitcast i64* %thr0 to i8*, !dbg !112

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #7, !dbg !112
