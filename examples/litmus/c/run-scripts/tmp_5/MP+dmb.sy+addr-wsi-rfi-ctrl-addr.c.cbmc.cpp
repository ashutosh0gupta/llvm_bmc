...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X6_2, align 4, !dbg !102, !tbaa !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !163, metadata !DIExpression()), !dbg !207
  ...
  //   %8 = load i32, i32* @atom_1_X6_2, align 4, !dbg !125, !tbaa !98
  // LD: Guess
  old_cr = cr(0,5);
