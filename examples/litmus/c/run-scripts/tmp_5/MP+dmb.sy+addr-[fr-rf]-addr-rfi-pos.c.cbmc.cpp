...
T2BLOCK1:
  ...
  //   %add10 = add nsw i32 0, %xor9, !dbg !104
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 0 + r6;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !104

  //   %arrayidx12 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !104
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !77, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !124

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv16, 1, !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !101, metadata !DIExpression()), !dbg !141
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !193, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !260

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !140
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !227, metadata !DIExpression()), !dbg !298
