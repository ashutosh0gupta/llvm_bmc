...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !83, metadata !DIExpression()), !dbg !101
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !84, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64 2, metadata !86, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !88, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !87, metadata !DIExpression()), !dbg !101
...
T2BLOCK2:
  //   br label %lbl_LC01, !dbg !66
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_LC01, !dbg !67
  goto T2BLOCK4;
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !92, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !94, metadata !DIExpression()), !dbg !116

  //   %conv4 = trunc i64 %1 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !91, metadata !DIExpression()), !dbg !101

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !73

  //   %conv5 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !95, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !96, metadata !DIExpression()), !dbg !120

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !98, metadata !DIExpression()), !dbg !120
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !149, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !152, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !166, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !170, metadata !DIExpression()), !dbg !214
