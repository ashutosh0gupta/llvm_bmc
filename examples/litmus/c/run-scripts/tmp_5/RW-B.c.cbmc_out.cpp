...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !68, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !69, metadata !DIExpression()), !dbg !78

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !49

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !49

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !70, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !76, metadata !DIExpression()), !dbg !81
  ...
  // ST: Guess
  iw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l31_c15
  old_cw = cw(0,1);
  cw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l31_c15
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !58
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 38, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !67
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %3) #6, !dbg !70
