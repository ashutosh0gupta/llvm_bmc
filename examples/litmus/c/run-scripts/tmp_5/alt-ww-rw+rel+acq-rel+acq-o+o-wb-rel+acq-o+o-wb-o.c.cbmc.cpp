...
T2BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !59
  // ST: Guess
  //   : Release
  ...
  ASSUME(cw(2,0+1*1) >= cr(2,11+0));
  ASSUME(cw(2,0+1*1) >= cr(2,12+0));
  ASSUME(cw(2,0+1*1) >= cr(2,13+0));
  ...
  ASSUME(cw(2,0+1*1) >= cw(2,11+0));
  ASSUME(cw(2,0+1*1) >= cw(2,12+0));
  ASSUME(cw(2,0+1*1) >= cw(2,13+0));
  // Update
  caddr[2] = max(caddr[2],0);
  buff(2,0+1*1) = 1;
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !79, metadata !DIExpression()), !dbg !92
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !81, metadata !DIExpression()), !dbg !95

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !56
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !80, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !84, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64 1, metadata !86, metadata !DIExpression()), !dbg !98

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !59
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !87, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !88, metadata !DIExpression()), !dbg !101

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !90, metadata !DIExpression()), !dbg !101

  //   store atomic i64 %1, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !62
  // ST: Guess
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !106, metadata !DIExpression()), !dbg !114

  //   br label %label_4, !dbg !47
  goto T4BLOCK1;

T4BLOCK1:
  //   call void @llvm.dbg.label(metadata !113), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !107, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64 2, metadata !109, metadata !DIExpression()), !dbg !117

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !50
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !110, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64 1, metadata !112, metadata !DIExpression()), !dbg !120

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !53
  // ST: Guess
  //   : Release
  ...
  ASSUME(cw(4,0+3*1) >= cr(4,8+0));
  ASSUME(cw(4,0+3*1) >= cr(4,9+0));
  ASSUME(cw(4,0+3*1) >= cr(4,10+0));
  ASSUME(cw(4,0+3*1) >= cr(4,11+0));
  ASSUME(cw(4,0+3*1) >= cr(4,12+0));
  ASSUME(cw(4,0+3*1) >= cr(4,13+0));
  ...
  ASSUME(cw(4,0+3*1) >= cw(4,8+0));
  ASSUME(cw(4,0+3*1) >= cw(4,9+0));
  ASSUME(cw(4,0+3*1) >= cw(4,10+0));
  ASSUME(cw(4,0+3*1) >= cw(4,11+0));
  ASSUME(cw(4,0+3*1) >= cw(4,12+0));
  ASSUME(cw(4,0+3*1) >= cw(4,13+0));
  // Update
  caddr[4] = max(caddr[4],0);
  buff(4,0+3*1) = 1;
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !125, metadata !DIExpression()), !dbg !138
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !127, metadata !DIExpression()), !dbg !141

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) acquire, align 8, !dbg !56
  // LD: Guess
  //   : Acquire
  old_cr = cr(5,0+3*1);
  cr(5,0+3*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM 
  // Check
  ...
  ASSUME(cr(5,0+3*1) >= cs(5,8+0));
  ASSUME(cr(5,0+3*1) >= cs(5,9+0));
  ASSUME(cr(5,0+3*1) >= cs(5,10+0));
  ASSUME(cr(5,0+3*1) >= cs(5,11+0));
  ASSUME(cr(5,0+3*1) >= cs(5,12+0));
  ASSUME(cr(5,0+3*1) >= cs(5,13+0));
  // Update
  creg_r2 = cr(5,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !129, metadata !DIExpression()), !dbg !141

  //   %conv = trunc i64 %0 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !126, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !130, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64 1, metadata !132, metadata !DIExpression()), !dbg !144

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !59
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !133, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !134, metadata !DIExpression()), !dbg !147

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !136, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %1, i64* @atom_4_X0_1 seq_cst, align 8, !dbg !62
  // ST: Guess
  iw(5,7) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW 
  old_cw = cw(5,7);
  cw(5,7) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM 
  // Check
  ASSUME(active[iw(5,7)] == 5);
  ASSUME(active[cw(5,7)] == 5);
  ASSUME(sforbid(7,cw(5,7))== 0);
  ASSUME(iw(5,7) >= max(creg_r2,0));
  ASSUME(iw(5,7) >= 0);
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !152, metadata !DIExpression()), !dbg !160

  //   br label %label_6, !dbg !47
  goto T6BLOCK1;

T6BLOCK1:
  //   call void @llvm.dbg.label(metadata !159), !dbg !162

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !153, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 2, metadata !155, metadata !DIExpression()), !dbg !163

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !50
  // ST: Guess
  iw(6,0+4*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW 
  old_cw = cw(6,0+4*1);
  cw(6,0+4*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64 2, metadata !158, metadata !DIExpression()), !dbg !166

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !53
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !176, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !177, metadata !DIExpression()), !dbg !243

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !178, metadata !DIExpression()), !dbg !245

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !182, metadata !DIExpression()), !dbg !247

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !183, metadata !DIExpression()), !dbg !249

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !184, metadata !DIExpression()), !dbg !251

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !185, metadata !DIExpression()), !dbg !253

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !186, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !187, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !190, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !193, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !196, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !199, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !202, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !205, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64 0, metadata !207, metadata !DIExpression()), !dbg !268

  //   store atomic i64 0, i64* @atom_2_X0_1 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !208, metadata !DIExpression()), !dbg !270

  //   call void @llvm.dbg.value(metadata i64 0, metadata !210, metadata !DIExpression()), !dbg !270

  //   store atomic i64 0, i64* @atom_4_X0_1 monotonic, align 8, !dbg !137
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !212, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !214, metadata !DIExpression()), !dbg !294

  //   %conv = trunc i64 %12 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !211, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !216, metadata !DIExpression()), !dbg !297

  //   %13 = load atomic i64, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !164
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !218, metadata !DIExpression()), !dbg !297

  //   %conv29 = trunc i64 %13 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !215, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !220, metadata !DIExpression()), !dbg !300

  //   %14 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !167
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   %conv33 = trunc i64 %14 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !219, metadata !DIExpression()), !dbg !243

  //   %cmp = icmp eq i32 %conv33, 2, !dbg !169

  //   %conv34 = zext i1 %cmp to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !223, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !225, metadata !DIExpression()), !dbg !304

  //   %15 = load atomic i64, i64* @atom_4_X0_1 seq_cst, align 8, !dbg !171
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %15, metadata !227, metadata !DIExpression()), !dbg !304

  //   %conv38 = trunc i64 %15 to i32, !dbg !172

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !224, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !229, metadata !DIExpression()), !dbg !307

  //   %16 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) seq_cst, align 8, !dbg !174
  // LD: Guess
  old_cr = cr(0,0+4*1);
  ...
  //   %conv42 = trunc i64 %16 to i32, !dbg !175

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !228, metadata !DIExpression()), !dbg !243

  //   %cmp43 = icmp eq i32 %conv42, 2, !dbg !176

  //   %conv44 = zext i1 %cmp43 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !232, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !234, metadata !DIExpression()), !dbg !311
  ...
  //   call void @llvm.dbg.value(metadata i64 %17, metadata !236, metadata !DIExpression()), !dbg !311

  //   %conv48 = trunc i64 %17 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !233, metadata !DIExpression()), !dbg !243

  //   %cmp49 = icmp eq i32 %conv48, 1, !dbg !180

  //   %conv50 = zext i1 %cmp49 to i32, !dbg !180

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !237, metadata !DIExpression()), !dbg !243

  //   %and = and i32 %conv44, %conv50, !dbg !181
  creg_r16 = max(max(creg_r14,0),max(creg_r15,0));
  ASSUME(active[creg_r16] == 0);
  r16 = (r14==2) & (r15==1);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !238, metadata !DIExpression()), !dbg !243

  //   %and51 = and i32 %conv38, %and, !dbg !182
  creg_r17 = max(creg_r13,creg_r16);
  ASSUME(active[creg_r17] == 0);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !239, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !240, metadata !DIExpression()), !dbg !243

  //   %and53 = and i32 %conv29, %and52, !dbg !184
  creg_r19 = max(creg_r11,creg_r18);
  ASSUME(active[creg_r19] == 0);
  r19 = r11 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !241, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !242, metadata !DIExpression()), !dbg !243
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([134 x i8], [134 x i8]* @.str.1, i64 0, i64 0), i32 noundef 113, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !189
