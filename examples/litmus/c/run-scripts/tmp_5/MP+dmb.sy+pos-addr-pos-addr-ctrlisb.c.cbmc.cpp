...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !105

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !87
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !71, metadata !DIExpression()), !dbg !110

  //   %conv8 = trunc i64 %2 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !112

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !112
  ...
  //   %add15 = add nsw i32 3, %xor13, !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !117
...
T2BLOCK4:
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !126

  //   %conv24 = trunc i64 %5 to i32, !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !88, metadata !DIExpression()), !dbg !130
  ...
  //   %cmp27 = icmp eq i32 %conv4, 1, !dbg !113

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !89, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !90, metadata !DIExpression()), !dbg !133

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv24, 0, !dbg !116

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !93, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !94, metadata !DIExpression()), !dbg !136

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %8, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !118
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !146, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !147, metadata !DIExpression()), !dbg !200

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !148, metadata !DIExpression()), !dbg !202

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !152, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !153, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !165, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !168, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !171, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !217

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !126
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !177, metadata !DIExpression()), !dbg !229

  //   %conv = trunc i64 %4 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !174, metadata !DIExpression()), !dbg !200

  //   %cmp = icmp eq i32 %conv, 1, !dbg !128

  //   %conv16 = zext i1 %cmp to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !178, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !233

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !130
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !182, metadata !DIExpression()), !dbg !233

  //   %conv20 = trunc i64 %5 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !179, metadata !DIExpression()), !dbg !200

  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !132

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !183, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !185, metadata !DIExpression()), !dbg !237
  ...
  //   %conv26 = trunc i64 %6 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !184, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !189, metadata !DIExpression()), !dbg !240

  //   %7 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !191, metadata !DIExpression()), !dbg !240

  //   %conv30 = trunc i64 %7 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !188, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !193, metadata !DIExpression()), !dbg !243

  //   %8 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !140
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !195, metadata !DIExpression()), !dbg !243

  //   %conv34 = trunc i64 %8 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !192, metadata !DIExpression()), !dbg !200

  //   %and = and i32 %conv30, %conv34, !dbg !142
  ...
  //   %and35 = and i32 %conv26, %and, !dbg !143
  creg_r21 = max(creg_r17,creg_r20);
  ASSUME(active[creg_r21] == 0);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !197, metadata !DIExpression()), !dbg !200

  //   %and36 = and i32 %conv22, %and35, !dbg !144
  creg_r22 = max(max(creg_r16,0),creg_r21);
  ASSUME(active[creg_r22] == 0);
  r22 = (r16==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !198, metadata !DIExpression()), !dbg !200

  //   %and37 = and i32 %conv16, %and36, !dbg !145
  creg_r23 = max(max(creg_r15,0),creg_r22);
  ASSUME(active[creg_r23] == 0);
  r23 = (r15==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !199, metadata !DIExpression()), !dbg !200

  //   %cmp38 = icmp eq i32 %and37, 1, !dbg !146

  //   br i1 %cmp38, label %if.then, label %if.end, !dbg !148
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !149
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #6, !dbg !152

  //   %10 = bitcast i64* %thr0 to i8*, !dbg !152

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #6, !dbg !152
