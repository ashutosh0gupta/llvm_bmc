...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !122, metadata !DIExpression()), !dbg !153

  //   %conv = trunc i64 %4 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !119, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !123, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !125, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !127, metadata !DIExpression()), !dbg !157

  //   %conv10 = trunc i64 %5 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !124, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !128, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !131, metadata !DIExpression()), !dbg !134

  //   %and13 = and i32 %conv12, %and, !dbg !102
  creg_r10 = max(creg__r6__2_,creg_r9);
  r10 = (r6==2) & r9;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !132, metadata !DIExpression()), !dbg !134

  //   %and14 = and i32 %conv6, %and13, !dbg !103
  creg_r11 = max(creg__r5__1_,creg_r10);
  r11 = (r5==1) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !133, metadata !DIExpression()), !dbg !134
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !107
