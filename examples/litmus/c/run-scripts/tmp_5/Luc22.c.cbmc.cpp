...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !58, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !61, metadata !DIExpression()), !dbg !80

  //   %add = add nsw i32 2, %and, !dbg !68
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %1, !dbg !68
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ...
  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !68
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   %conv4 = trunc i64 %2 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !62, metadata !DIExpression()), !dbg !80

  //   %and5 = and i32 %conv4, 128, !dbg !71
  creg_r5 = max(creg_r4,0);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and5, metadata !66, metadata !DIExpression()), !dbg !80

  //   %add7 = add nsw i32 1, %and5, !dbg !72
  ...
  //   %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %3, !dbg !72
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !68, metadata !DIExpression()), !dbg !92

  //   %4 = load atomic i64, i64* %arrayidx9 monotonic, align 8, !dbg !72
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !70, metadata !DIExpression()), !dbg !92

  //   %conv12 = trunc i64 %4 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !67, metadata !DIExpression()), !dbg !80

  //   %cmp = icmp eq i32 %conv, 1, !dbg !75

  //   %conv13 = zext i1 %cmp to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !71, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !72, metadata !DIExpression()), !dbg !95

  //   %5 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !74, metadata !DIExpression()), !dbg !95

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !77
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv12, 0, !dbg !78

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !75, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !76, metadata !DIExpression()), !dbg !98

  //   %6 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !78, metadata !DIExpression()), !dbg !98

  //   store atomic i64 %6, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !80
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !115, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !118, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !121, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !124, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !127, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64 0, metadata !129, metadata !DIExpression()), !dbg !152

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !85
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !131, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !133, metadata !DIExpression()), !dbg !164

  //   %conv = trunc i64 %4 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !130, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !135, metadata !DIExpression()), !dbg !167

  //   %5 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !134, metadata !DIExpression()), !dbg !139
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 59, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !106
