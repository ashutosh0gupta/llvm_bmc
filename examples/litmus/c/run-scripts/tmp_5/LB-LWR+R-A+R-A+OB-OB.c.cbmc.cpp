...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !144, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !145, metadata !DIExpression()), !dbg !172

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !146, metadata !DIExpression()), !dbg !174

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !150, metadata !DIExpression()), !dbg !176

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !151, metadata !DIExpression()), !dbg !178

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !152, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !153, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !155, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64 0, metadata !161, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !187
  ...
  //   store i32 0, i32* @atom_3_X2_0, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !94, !tbaa !90
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !95, !tbaa !90
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_3_X0_1, align 4, !dbg !96, !tbaa !90
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_3_X2_0, align 4, !dbg !111, !tbaa !90
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !165, metadata !DIExpression()), !dbg !172

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !112, !tbaa !90
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !166, metadata !DIExpression()), !dbg !172

  //   %10 = load i32, i32* @atom_2_X0_1, align 4, !dbg !113, !tbaa !90
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !167, metadata !DIExpression()), !dbg !172

  //   %11 = load i32, i32* @atom_3_X0_1, align 4, !dbg !114, !tbaa !90
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !168, metadata !DIExpression()), !dbg !172

  //   %and = and i32 %10, %11, !dbg !115
  creg_r13 = max(creg_r11,creg_r12);
  r13 = r11 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !169, metadata !DIExpression()), !dbg !172

  //   %and14 = and i32 %9, %and, !dbg !116
  creg_r14 = max(creg_r10,creg_r13);
  r14 = r10 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !170, metadata !DIExpression()), !dbg !172

  //   %and15 = and i32 %8, %and14, !dbg !117
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !171, metadata !DIExpression()), !dbg !172
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
