...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !75

  //   call void @llvm.dbg.value(metadata i64 1, metadata !46, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !51, metadata !DIExpression()), !dbg !77

  //   %conv = trunc i64 %0 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !47, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !52, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !53, metadata !DIExpression()), !dbg !70
  ...
  //   %conv5 = sext i32 %add to i64, !dbg !83

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !56, metadata !DIExpression()), !dbg !82

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !83
  // ST: Guess
  //   : Release
  iw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !60, metadata !DIExpression()), !dbg !84

  //   %conv9 = trunc i64 %1 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !57, metadata !DIExpression()), !dbg !70

  //   %cmp = icmp eq i32 %conv9, 2, !dbg !87

  //   %conv10 = zext i1 %cmp to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !61, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !62, metadata !DIExpression()), !dbg !88

  //   %2 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !64, metadata !DIExpression()), !dbg !88

  //   store atomic i64 %2, i64* @atom_0_X6_2 seq_cst, align 8, !dbg !89
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv, 1, !dbg !90

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !65, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_1, metadata !66, metadata !DIExpression()), !dbg !91

  //   %3 = zext i32 %conv15 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !68, metadata !DIExpression()), !dbg !91

  //   store atomic i64 %3, i64* @atom_0_X4_1 seq_cst, align 8, !dbg !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !155, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_1, metadata !158, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !209

  //   store atomic i64 0, i64* @atom_0_X4_1 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !161, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !178, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_1, metadata !182, metadata !DIExpression()), !dbg !236

  //   %7 = load atomic i64, i64* @atom_0_X4_1 seq_cst, align 8, !dbg !139
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !186, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !190, metadata !DIExpression()), !dbg !242
