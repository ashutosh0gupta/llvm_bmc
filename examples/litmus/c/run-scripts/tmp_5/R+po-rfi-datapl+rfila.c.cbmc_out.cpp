...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !45, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !71
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !48, metadata !DIExpression()), !dbg !64

  //   %xor = xor i32 %conv, %conv, !dbg !74
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !52, metadata !DIExpression()), !dbg !64

  //   %add = add nsw i32 %xor, 1, !dbg !75
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !53, metadata !DIExpression()), !dbg !64
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !56, metadata !DIExpression()), !dbg !76

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !77
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !60, metadata !DIExpression()), !dbg !78

  //   %conv9 = trunc i64 %1 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !57, metadata !DIExpression()), !dbg !64
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !61, metadata !DIExpression()), !dbg !64

  //   store i32 %conv10, i32* @atom_0_X6_2, align 4, !dbg !82, !tbaa !83
  // ST: Guess
  ...
  //   %cmp11 = icmp eq i32 %conv, 1, !dbg !87
  creg__r0__1_ = max(0,creg_r0);

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !62, metadata !DIExpression()), !dbg !64

  //   store i32 %conv12, i32* @atom_0_X4_1, align 4, !dbg !88, !tbaa !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64 0, metadata !139, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !169
  ...
  //   store i32 0, i32* @atom_0_X6_2, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X4_1, align 4, !dbg !90, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X3_3, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X2_2, align 4, !dbg !92, !tbaa !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !144, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !143, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !147, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !148, metadata !DIExpression()), !dbg !162

  //   %cmp11 = icmp eq i32 %conv10, 1, !dbg !108
  creg__r10__1_ = max(0,creg_r10);

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !152, metadata !DIExpression()), !dbg !162

  //   %6 = load i32, i32* @atom_0_X6_2, align 4, !dbg !109, !tbaa !86
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !153, metadata !DIExpression()), !dbg !162

  //   %7 = load i32, i32* @atom_0_X4_1, align 4, !dbg !110, !tbaa !86
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X3_3, align 4, !dbg !111, !tbaa !86
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X2_2, align 4, !dbg !112, !tbaa !86
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !158, metadata !DIExpression()), !dbg !162

  //   %and14 = and i32 %6, %and13, !dbg !115
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !159, metadata !DIExpression()), !dbg !162
  ...
  creg_r19 = max(creg__r9__3_,creg_r18);
  r19 = (r9==3) & r18;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
