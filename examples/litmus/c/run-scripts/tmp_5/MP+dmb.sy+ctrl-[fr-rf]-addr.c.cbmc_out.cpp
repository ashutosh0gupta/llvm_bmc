...
T2BLOCK4:
  ...
  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   store i32 %conv15, i32* @atom_1_X2_0, align 4, !dbg !94, !tbaa !89
  // ST: Guess
  ...
  //   store i32 %conv17, i32* @atom_1_X4_1, align 4, !dbg !96, !tbaa !89
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
