...
T2BLOCK7:
  ...
  //   %cmp22 = icmp eq i32 %conv6, 2, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !88, metadata !DIExpression()), !dbg !137
  ...
  //   %cmp27 = icmp eq i32 %conv13, 0, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !92, metadata !DIExpression()), !dbg !140

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %6, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !96, metadata !DIExpression()), !dbg !143
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !172, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !231

  //   store atomic i64 0, i64* @atom_1_X5_2 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !175, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !178, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !201, metadata !DIExpression()), !dbg !262

  //   %8 = load atomic i64, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !154
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !205, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !209, metadata !DIExpression()), !dbg !268
