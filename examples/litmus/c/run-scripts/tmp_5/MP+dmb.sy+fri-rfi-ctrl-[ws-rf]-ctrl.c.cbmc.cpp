...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !88, metadata !DIExpression()), !dbg !137

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %5, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !119
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv10, 2, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !92, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !96, metadata !DIExpression()), !dbg !143
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !186, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !189, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !192, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !219, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !223, metadata !DIExpression()), !dbg !287
