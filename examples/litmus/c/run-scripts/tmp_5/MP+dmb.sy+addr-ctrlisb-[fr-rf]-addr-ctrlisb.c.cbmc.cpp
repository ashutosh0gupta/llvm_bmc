...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !140
  ...
  //   %conv27 = trunc i64 %5 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !83, metadata !DIExpression()), !dbg !106

  //   %cmp = icmp eq i32 %conv, 1, !dbg !124

  //   %conv28 = zext i1 %cmp to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !87, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !144

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !126
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv8, 0, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !92, metadata !DIExpression()), !dbg !147

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv12, 1, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !96, metadata !DIExpression()), !dbg !150

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %8, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !132
  // ST: Guess
  ...
  //   %cmp40 = icmp eq i32 %conv27, 0, !dbg !133

  //   %conv41 = zext i1 %cmp40 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv41, metadata !99, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !100, metadata !DIExpression()), !dbg !153

  //   %9 = zext i32 %conv41 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %9, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !135
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !159, metadata !DIExpression()), !dbg !166
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !176, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !177, metadata !DIExpression()), !dbg !248

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !117

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !117

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !178, metadata !DIExpression()), !dbg !250

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !182, metadata !DIExpression()), !dbg !252

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !183, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !184, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !187, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !190, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !193, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !196, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !199, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !202, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !205, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !207, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !208, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !210, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !212, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !214, metadata !DIExpression()), !dbg !286

  //   %conv = trunc i64 %6 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !211, metadata !DIExpression()), !dbg !248

  //   %cmp = icmp eq i32 %conv, 1, !dbg !157

  //   %conv22 = zext i1 %cmp to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !215, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !217, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !219, metadata !DIExpression()), !dbg !290

  //   %conv26 = trunc i64 %7 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !216, metadata !DIExpression()), !dbg !248

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !161

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !220, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !222, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !224, metadata !DIExpression()), !dbg !294

  //   %conv32 = trunc i64 %8 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !221, metadata !DIExpression()), !dbg !248

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !165

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !225, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !227, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !229, metadata !DIExpression()), !dbg !298

  //   %conv38 = trunc i64 %9 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !226, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !231, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !233, metadata !DIExpression()), !dbg !301

  //   %conv42 = trunc i64 %10 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !230, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !235, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !237, metadata !DIExpression()), !dbg !304

  //   %conv46 = trunc i64 %11 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !234, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !239, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !241, metadata !DIExpression()), !dbg !307

  //   %conv50 = trunc i64 %12 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !238, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !242, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !243, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !244, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !245, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !246, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !247, metadata !DIExpression()), !dbg !248
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([128 x i8], [128 x i8]* @.str.1, i64 0, i64 0), i32 noundef 100, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187
