...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !79, metadata !DIExpression()), !dbg !90
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !81, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !83, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !84, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !85, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64 1, metadata !87, metadata !DIExpression()), !dbg !98

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !55
  // ST: Guess
  iw(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l38_c3
  old_cw = cw(3,r7);
  cw(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l38_c3
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !102
