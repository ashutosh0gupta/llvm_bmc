...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !78, metadata !DIExpression()), !dbg !103

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !72
  // LD: Guess
  old_cr = cr(2,0+3*1);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !113

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !82
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X4_2, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X6_0, align 4, !dbg !92, !tbaa !88
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X4_2, align 4, !dbg !109, !tbaa !88
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %7 = load i32, i32* @atom_1_X6_0, align 4, !dbg !110, !tbaa !88
  // LD: Guess
  old_cr = cr(0,5);
