...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X2_2, align 4, !dbg !65, !tbaa !66
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X2_2, align 4, !dbg !70, !tbaa !66
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_0_X2_2, align 4, !dbg !79, !tbaa !66
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %5 = load i32, i32* @atom_1_X2_2, align 4, !dbg !80, !tbaa !66
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i64 0, i64 0), i32 noundef 58, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !85
