...
T2BLOCK1:
  ...
  //   %cmp22 = icmp eq i32 %conv12, 1, !dbg !92
  ...
  //   store i32 %conv23, i32* @atom_1_X8_1, align 4, !dbg !93, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !123, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !124, metadata !DIExpression()), !dbg !165

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !125, metadata !DIExpression()), !dbg !167

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !129, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !130, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !133, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !136, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !139, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !143, metadata !DIExpression()), !dbg !189

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l64_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !145, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !146, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !150, metadata !DIExpression()), !dbg !193

  //   %conv14 = trunc i64 %5 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !147, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !151, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !155, metadata !DIExpression()), !dbg !197

  //   %conv20 = trunc i64 %6 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !152, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !156, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !161, metadata !DIExpression()), !dbg !165

  //   %and24 = and i32 %conv22, %and23, !dbg !129
  creg_r24 = max(creg__r18__1_,creg_r23);
  r24 = (r18==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !162, metadata !DIExpression()), !dbg !165

  //   %and25 = and i32 %conv16, %and24, !dbg !130
  creg_r25 = max(creg__r17__1_,creg_r24);
  r25 = (r17==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !163, metadata !DIExpression()), !dbg !165

  //   %and26 = and i32 %conv10, %and25, !dbg !131
  creg_r26 = max(creg__r16__1_,creg_r25);
  r26 = (r16==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !164, metadata !DIExpression()), !dbg !165
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !135
