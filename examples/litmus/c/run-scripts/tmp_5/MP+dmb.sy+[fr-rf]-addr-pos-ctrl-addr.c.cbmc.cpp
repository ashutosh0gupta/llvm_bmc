...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !103

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !103
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !150, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !151, metadata !DIExpression()), !dbg !187

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !152, metadata !DIExpression()), !dbg !189

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !156, metadata !DIExpression()), !dbg !191

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !157, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !158, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !167, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !200
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !94, !tbaa !95
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X2_2, align 4, !dbg !99, !tbaa !95
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X10_0, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l65_c16
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l65_c16
  // Check
  ...
  //   %call7 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !102
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call8 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !103
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call9 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !107
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !171, metadata !DIExpression()), !dbg !216

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !173, metadata !DIExpression()), !dbg !216
  ...
  //   %conv12 = zext i1 %cmp to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !174, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !176, metadata !DIExpression()), !dbg !220

  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   %conv16 = trunc i64 %7 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !175, metadata !DIExpression()), !dbg !187

  //   %cmp17 = icmp eq i32 %conv16, 2, !dbg !119
  creg__r17__2_ = max(0,creg_r17);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !179, metadata !DIExpression()), !dbg !187

  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !120, !tbaa !95
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X2_2, align 4, !dbg !121, !tbaa !95
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X10_0, align 4, !dbg !122, !tbaa !95
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %and = and i32 %9, %10, !dbg !123
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !183, metadata !DIExpression()), !dbg !187

  //   %and19 = and i32 %8, %and, !dbg !124
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !184, metadata !DIExpression()), !dbg !187

  //   %and20 = and i32 %conv18, %and19, !dbg !125
  creg_r23 = max(creg__r17__2_,creg_r22);
  r23 = (r17==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !185, metadata !DIExpression()), !dbg !187

  //   %and21 = and i32 %conv12, %and20, !dbg !126
  creg_r24 = max(creg__r16__1_,creg_r23);
  r24 = (r16==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !186, metadata !DIExpression()), !dbg !187

  //   %cmp22 = icmp eq i32 %and21, 1, !dbg !127
  creg__r24__1_ = max(0,creg_r24);

  //   br i1 %cmp22, label %if.then, label %if.end, !dbg !129
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !130
...
T0BLOCK2:
  //   %11 = bitcast i64* %thr2 to i8*, !dbg !133

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !133

  //   %12 = bitcast i64* %thr1 to i8*, !dbg !133

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !133

  //   %13 = bitcast i64* %thr0 to i8*, !dbg !133

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !133
