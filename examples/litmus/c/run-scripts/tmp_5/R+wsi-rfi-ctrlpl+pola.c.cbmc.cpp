...
T1BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !47, metadata !DIExpression()), !dbg !68
...
T1BLOCK4:
  ...
  //   store i32 %conv9, i32* @atom_0_X6_2, align 4, !dbg !83, !tbaa !84
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv, 2, !dbg !88
  ...
  //   store i32 %conv11, i32* @atom_0_X3_2, align 4, !dbg !89, !tbaa !84
  // ST: Guess
