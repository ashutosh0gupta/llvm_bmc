...
T1BLOCK4:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !84
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !58, metadata !DIExpression()), !dbg !89

  //   %2 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !60, metadata !DIExpression()), !dbg !89

  //   store atomic i64 %2, i64* @atom_0_X6_2 seq_cst, align 8, !dbg !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !142, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !145, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !162, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !166, metadata !DIExpression()), !dbg !213
