...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !86, metadata !DIExpression()), !dbg !125
  ...
  //   %cmp21 = icmp eq i32 %conv4, 1, !dbg !115
  ...
  //   store i32 %conv22, i32* @atom_1_X4_1, align 4, !dbg !116, !tbaa !111
  // ST: Guess
  ...
  //   store i32 %conv24, i32* @atom_1_X6_0, align 4, !dbg !118, !tbaa !111
  // ST: Guess
  ...
  //   store i32 %conv26, i32* @atom_1_X8_1, align 4, !dbg !120, !tbaa !111
  // ST: Guess
  ...
  //   store i32 %conv28, i32* @atom_1_X9_0, align 4, !dbg !122, !tbaa !111
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !163, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !164, metadata !DIExpression()), !dbg !216

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !165, metadata !DIExpression()), !dbg !218

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !169, metadata !DIExpression()), !dbg !220

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !170, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !171, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !174, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !184, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !183, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !187, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !188, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !192, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !196, metadata !DIExpression()), !dbg !255

  //   %conv22 = trunc i64 %8 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !193, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !197, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !199, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !201, metadata !DIExpression()), !dbg !259

  //   %conv28 = trunc i64 %9 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !198, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !202, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !203, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !204, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !205, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !206, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !207, metadata !DIExpression()), !dbg !216

  //   %and = and i32 %13, %14, !dbg !155
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !208, metadata !DIExpression()), !dbg !216

  //   %and31 = and i32 %12, %and, !dbg !156
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !209, metadata !DIExpression()), !dbg !216

  //   %and32 = and i32 %11, %and31, !dbg !157
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !210, metadata !DIExpression()), !dbg !216

  //   %and33 = and i32 %10, %and32, !dbg !158
  creg_r24 = max(creg_r16,creg_r23);
  r24 = r16 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !211, metadata !DIExpression()), !dbg !216

  //   %and34 = and i32 %conv30, %and33, !dbg !159
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !212, metadata !DIExpression()), !dbg !216

  //   %and35 = and i32 %conv24, %and34, !dbg !160
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !213, metadata !DIExpression()), !dbg !216

  //   %and36 = and i32 %conv18, %and35, !dbg !161
  creg_r27 = max(creg__r13__1_,creg_r26);
  r27 = (r13==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !214, metadata !DIExpression()), !dbg !216

  //   %and37 = and i32 %conv12, %and36, !dbg !162
  creg_r28 = max(creg__r12__1_,creg_r27);
  r28 = (r12==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !215, metadata !DIExpression()), !dbg !216
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 105, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
