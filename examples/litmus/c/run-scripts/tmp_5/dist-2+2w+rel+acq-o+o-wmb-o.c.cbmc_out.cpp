...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !113, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !117, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !118, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !122, metadata !DIExpression()), !dbg !154

  //   %conv12 = trunc i64 %8 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !119, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !123, metadata !DIExpression()), !dbg !126
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !106
