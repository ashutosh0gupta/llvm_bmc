...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !66
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !55, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !59, metadata !DIExpression()), !dbg !82

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !61, metadata !DIExpression()), !dbg !82

  //   store atomic i64 %3, i64* @atom_0_X7_2 seq_cst, align 8, !dbg !83
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !92, metadata !DIExpression()), !dbg !105
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !135, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64 0, metadata !137, metadata !DIExpression()), !dbg !173

  //   store atomic i64 0, i64* @atom_0_X7_2 monotonic, align 8, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !138, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !144, metadata !DIExpression()), !dbg !187

  //   %conv = trunc i64 %4 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !141, metadata !DIExpression()), !dbg !162

  //   %cmp = icmp eq i32 %conv, 1, !dbg !111

  //   %conv12 = zext i1 %cmp to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !145, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !149, metadata !DIExpression()), !dbg !191

  //   %conv16 = trunc i64 %5 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !146, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !152, metadata !DIExpression()), !dbg !195

  //   %6 = load atomic i64, i64* @atom_0_X7_2 seq_cst, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !151, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !155, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !160, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !161, metadata !DIExpression()), !dbg !162
