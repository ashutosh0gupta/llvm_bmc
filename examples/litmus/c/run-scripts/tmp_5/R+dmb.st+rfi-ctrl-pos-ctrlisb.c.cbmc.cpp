...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !87
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !77, metadata !DIExpression()), !dbg !118
  ...
  //   %cmp20 = icmp eq i32 %conv15, 0, !dbg !101

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !80, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !81, metadata !DIExpression()), !dbg !121
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !147, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !150, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !157, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !161, metadata !DIExpression()), !dbg !203

  //   %conv16 = trunc i64 %5 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !158, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !163, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !168, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !167, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !172, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !173, metadata !DIExpression()), !dbg !174
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !128
