...
T0BLOCK0:
  ...
  //   %3 = bitcast i64* %thr3 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !151, metadata !DIExpression()), !dbg !194

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !152, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !203
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !107, !tbaa !103
  // ST: Guess
  ...
  //   %call7 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !109
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call8 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !110
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !111
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #7, !dbg !112
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr0, align 8, !dbg !113, !tbaa !114
  r3 = local_mem[0];
  ...
  //   %6 = load i64, i64* %thr1, align 8, !dbg !117, !tbaa !114
  r4 = local_mem[1];

  //   %call12 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !118
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr2, align 8, !dbg !119, !tbaa !114
  r5 = local_mem[2];

  //   %call13 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !120
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load i64, i64* %thr3, align 8, !dbg !121, !tbaa !114
  r6 = local_mem[3];

  //   %call14 = call i32 @pthread_join(i64 noundef %8, i8** noundef null), !dbg !122
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %9 = load i64, i64* %thr4, align 8, !dbg !123, !tbaa !114
  r7 = local_mem[4];

  //   %call15 = call i32 @pthread_join(i64 noundef %9, i8** noundef null), !dbg !124
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %10 = load i32, i32* @atom_1_X0_1, align 4, !dbg !125, !tbaa !103
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !165, metadata !DIExpression()), !dbg !186

  //   %11 = load i32, i32* @atom_2_X0_1, align 4, !dbg !126, !tbaa !103
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !166, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !168, metadata !DIExpression()), !dbg !226

  //   %12 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !170, metadata !DIExpression()), !dbg !226

  //   %conv = trunc i64 %12 to i32, !dbg !129
  ...
  //   %13 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !175, metadata !DIExpression()), !dbg !230

  //   %conv20 = trunc i64 %13 to i32, !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !234

  //   %14 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !136
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !180, metadata !DIExpression()), !dbg !234

  //   %conv26 = trunc i64 %14 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !177, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !181, metadata !DIExpression()), !dbg !186

  //   %and = and i32 %conv22, %conv28, !dbg !139
  ...
  //   %and29 = and i32 %conv16, %and, !dbg !140
  creg_r14 = max(creg__r10__2_,creg_r13);
  r14 = (r10==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !183, metadata !DIExpression()), !dbg !186

  //   %and30 = and i32 %11, %and29, !dbg !141
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !184, metadata !DIExpression()), !dbg !186

  //   %and31 = and i32 %10, %and30, !dbg !142
  creg_r16 = max(creg_r15,creg_r8);
  r16 = r8 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !185, metadata !DIExpression()), !dbg !186

  //   %cmp32 = icmp eq i32 %and31, 1, !dbg !143
  creg__r16__1_ = max(0,creg_r16);

  //   br i1 %cmp32, label %if.then, label %if.end, !dbg !145
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([134 x i8], [134 x i8]* @.str.1, i64 0, i64 0), i32 noundef 96, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !146
...
T0BLOCK2:
  //   %15 = bitcast i64* %thr4 to i8*, !dbg !149

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %15) #7, !dbg !149

  //   %16 = bitcast i64* %thr3 to i8*, !dbg !149

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %16) #7, !dbg !149

  //   %17 = bitcast i64* %thr2 to i8*, !dbg !149

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %17) #7, !dbg !149

  //   %18 = bitcast i64* %thr1 to i8*, !dbg !149

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %18) #7, !dbg !149

  //   %19 = bitcast i64* %thr0 to i8*, !dbg !149

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %19) #7, !dbg !149
