...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !50, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !52, metadata !DIExpression()), !dbg !86

  //   %conv4 = trunc i64 %1 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !49, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !53, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !54, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !55, metadata !DIExpression()), !dbg !91

  //   %conv7 = sext i32 %add to i64, !dbg !92

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !57, metadata !DIExpression()), !dbg !91

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !92
  // ST: Guess
  //   : Release
  iw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !59, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !61, metadata !DIExpression()), !dbg !93

  //   %conv11 = trunc i64 %2 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !58, metadata !DIExpression()), !dbg !72

  //   %cmp = icmp eq i32 %conv11, 2, !dbg !96

  //   %conv12 = zext i1 %cmp to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !62, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !63, metadata !DIExpression()), !dbg !97

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !65, metadata !DIExpression()), !dbg !97
  ...
  //   %cmp16 = icmp eq i32 %conv, 3, !dbg !99

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !66, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !67, metadata !DIExpression()), !dbg !100

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !69, metadata !DIExpression()), !dbg !100

  //   store atomic i64 %4, i64* @atom_0_X2_3 seq_cst, align 8, !dbg !101
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !105, metadata !DIExpression()), !dbg !126
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !106, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i64 2, metadata !108, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !112, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !118, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !121, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !122, metadata !DIExpression()), !dbg !141

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !124, metadata !DIExpression()), !dbg !141
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !201

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !203

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !164, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !167, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !173, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !180, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !182, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !181, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !186, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !190, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !192, metadata !DIExpression()), !dbg !238

  //   %conv26 = trunc i64 %7 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !189, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !194, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !196, metadata !DIExpression()), !dbg !241

  //   %conv30 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !193, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !198, metadata !DIExpression()), !dbg !201
