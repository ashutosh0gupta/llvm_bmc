...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !72, metadata !DIExpression()), !dbg !89

  //   %tobool10 = icmp ne i32 %conv9, 0, !dbg !92
  creg__r4__0_ = max(0,creg_r4);

  //   br i1 %tobool10, label %if.then11, label %if.else12, !dbg !94
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   %cmp20 = icmp eq i32 %conv9, 2, !dbg !109
