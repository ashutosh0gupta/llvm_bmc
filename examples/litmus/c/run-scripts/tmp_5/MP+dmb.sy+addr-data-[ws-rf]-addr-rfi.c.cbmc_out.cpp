...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !103
  ...
  //   %cmp23 = icmp eq i32 %conv11, 2, !dbg !99
  ...
  //   store i32 %conv24, i32* @atom_1_X7_2, align 4, !dbg !100, !tbaa !95
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !126, metadata !DIExpression()), !dbg !133
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !150, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !151, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !154, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !157, metadata !DIExpression()), !dbg !197
  ...
  //   store i32 0, i32* @atom_1_X7_2, align 4, !dbg !105, !tbaa !101
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X11_1, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !164, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !166, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !167, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !169, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !171, metadata !DIExpression()), !dbg !219

  //   %conv16 = trunc i64 %7 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !168, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !172, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !176, metadata !DIExpression()), !dbg !223

  //   %conv22 = trunc i64 %8 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !173, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !177, metadata !DIExpression()), !dbg !186
  ...
  //   %10 = load i32, i32* @atom_1_X7_2, align 4, !dbg !131, !tbaa !101
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X11_1, align 4, !dbg !132, !tbaa !101
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !182, metadata !DIExpression()), !dbg !186

  //   %and26 = and i32 %conv24, %and25, !dbg !135
  creg_r24 = max(creg__r18__1_,creg_r23);
  r24 = (r18==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !183, metadata !DIExpression()), !dbg !186

  //   %and27 = and i32 %conv18, %and26, !dbg !136
  creg_r25 = max(creg__r17__2_,creg_r24);
  r25 = (r17==2) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !184, metadata !DIExpression()), !dbg !186

  //   %and28 = and i32 %conv12, %and27, !dbg !137
  creg_r26 = max(creg__r16__2_,creg_r25);
  r26 = (r16==2) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !185, metadata !DIExpression()), !dbg !186
