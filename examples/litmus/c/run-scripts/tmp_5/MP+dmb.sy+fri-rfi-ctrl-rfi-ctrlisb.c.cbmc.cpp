...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !149, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !152, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !155, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !192
  ...
  //   store i32 0, i32* @atom_1_X3_2, align 4, !dbg !101, !tbaa !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !161, metadata !DIExpression()), !dbg !206

  //   %conv = trunc i64 %4 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !158, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !162, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !166, metadata !DIExpression()), !dbg !210

  //   %conv12 = trunc i64 %5 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !163, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !167, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !169, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !171, metadata !DIExpression()), !dbg !214

  //   %conv18 = trunc i64 %6 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !168, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !172, metadata !DIExpression()), !dbg !183

  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !124, !tbaa !97
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !173, metadata !DIExpression()), !dbg !183

  //   %8 = load i32, i32* @atom_1_X3_2, align 4, !dbg !125, !tbaa !97
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !177, metadata !DIExpression()), !dbg !183

  //   %and21 = and i32 %8, %and, !dbg !129
  creg_r15 = max(creg_r11,creg_r14);
  r15 = r11 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !178, metadata !DIExpression()), !dbg !183

  //   %and22 = and i32 %7, %and21, !dbg !130
  creg_r16 = max(creg_r10,creg_r15);
  r16 = r10 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !179, metadata !DIExpression()), !dbg !183

  //   %and23 = and i32 %conv20, %and22, !dbg !131
  creg_r17 = max(creg__r9__1_,creg_r16);
  r17 = (r9==1) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !180, metadata !DIExpression()), !dbg !183

  //   %and24 = and i32 %conv14, %and23, !dbg !132
  creg_r18 = max(creg__r8__2_,creg_r17);
  r18 = (r8==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !181, metadata !DIExpression()), !dbg !183

  //   %and25 = and i32 %conv8, %and24, !dbg !133
  creg_r19 = max(creg__r7__1_,creg_r18);
  r19 = (r7==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !182, metadata !DIExpression()), !dbg !183
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !137
