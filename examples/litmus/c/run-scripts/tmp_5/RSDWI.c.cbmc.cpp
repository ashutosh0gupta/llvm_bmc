...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !60, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64 1, metadata !62, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !104

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !67, metadata !DIExpression()), !dbg !104

  //   %conv = trunc i64 %0 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !63, metadata !DIExpression()), !dbg !99

  //   %xor = xor i32 %conv, %conv, !dbg !88
  creg_r1 = max(creg_r0,creg_r0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !68, metadata !DIExpression()), !dbg !99
  ...
  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !69, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !73, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !77, metadata !DIExpression()), !dbg !99

  //   %add11 = add nsw i32 0, %xor9, !dbg !96
  ...
  //   %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !96
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !79, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !116

  //   %conv16 = trunc i64 %3 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !78, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 1, !dbg !99

  //   %conv17 = zext i1 %cmp to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !82, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !83, metadata !DIExpression()), !dbg !119

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !101
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv4, 1, !dbg !102

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !86, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_1, metadata !87, metadata !DIExpression()), !dbg !122

  //   %5 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !122
  ...
  //   %cmp26 = icmp eq i32 %conv8, 2, !dbg !105

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !90, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !91, metadata !DIExpression()), !dbg !125

  //   %6 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !125

  //   store atomic i64 %6, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !107
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv16, 0, !dbg !108

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !94, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !95, metadata !DIExpression()), !dbg !128

  //   %7 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !128
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !205

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !207

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !209

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !158, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !168, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !218

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_1, metadata !171, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !220

  //   store atomic i64 0, i64* @atom_1_X3_1 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !174, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !177, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !224

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !181, metadata !DIExpression()), !dbg !239

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !133
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   %7 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_1, metadata !190, metadata !DIExpression()), !dbg !246

  //   %8 = load atomic i64, i64* @atom_1_X3_1 seq_cst, align 8, !dbg !140
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !189, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !194, metadata !DIExpression()), !dbg !249

  //   %9 = load atomic i64, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !143
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !198, metadata !DIExpression()), !dbg !252

  //   %10 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !146
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !200, metadata !DIExpression()), !dbg !252

  //   %conv34 = trunc i64 %10 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !197, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !202, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !203, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !204, metadata !DIExpression()), !dbg !205
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
