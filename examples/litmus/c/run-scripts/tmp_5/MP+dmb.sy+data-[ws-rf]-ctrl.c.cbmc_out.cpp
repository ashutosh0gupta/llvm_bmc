...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !109
  ...
  //   %cmp14 = icmp eq i32 %conv5, 2, !dbg !96

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !80, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !81, metadata !DIExpression()), !dbg !116

  //   %4 = zext i32 %conv15 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !116
  ...
  //   %cmp19 = icmp eq i32 %conv9, 0, !dbg !99

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !84, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !85, metadata !DIExpression()), !dbg !119

  //   %5 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !87, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %5, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !165, metadata !DIExpression()), !dbg !217
