...
T2BLOCK4:
  ...
  //   %cmp11 = icmp eq i32 %conv5, 2, !dbg !90
  ...
  //   store i32 %conv12, i32* @atom_1_X4_2, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv9, 0, !dbg !92
  ...
  //   store i32 %conv14, i32* @atom_1_X5_0, align 4, !dbg !93, !tbaa !86
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !136
