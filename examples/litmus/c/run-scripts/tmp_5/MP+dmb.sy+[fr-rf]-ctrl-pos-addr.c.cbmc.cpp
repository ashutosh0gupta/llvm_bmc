...
T2BLOCK4:
  ...
  //   %cmp24 = icmp eq i32 %conv16, 0, !dbg !106

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !88, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !89, metadata !DIExpression()), !dbg !126
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !169, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !172, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !190, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !194, metadata !DIExpression()), !dbg !247

  //   %10 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,5);
