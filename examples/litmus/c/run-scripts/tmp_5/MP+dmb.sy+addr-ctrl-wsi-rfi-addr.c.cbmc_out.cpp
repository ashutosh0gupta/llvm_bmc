...
T2BLOCK4:
  ...
  //   %xor11 = xor i32 %conv10, %conv10, !dbg !101
  creg_r6 = max(creg_r5,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor11, metadata !78, metadata !DIExpression()), !dbg !97

  //   %add13 = add nsw i32 0, %xor11, !dbg !102
  ...
  //   %arrayidx15 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom14, !dbg !102
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx15, metadata !80, metadata !DIExpression()), !dbg !122

  //   %3 = load atomic i64, i64* %arrayidx15 monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,r8);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !163, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !189, metadata !DIExpression()), !dbg !245
