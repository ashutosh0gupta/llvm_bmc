...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !52, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !51, metadata !DIExpression()), !dbg !61

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !55, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !58, metadata !DIExpression()), !dbg !61

  //   store i32 %conv9, i32* @atom_0_X3_2, align 4, !dbg !78, !tbaa !79
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv6, 0, !dbg !83
  ...
  //   store i32 %conv11, i32* @atom_0_X5_0, align 4, !dbg !84, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X5_0, align 4, !dbg !86, !tbaa !82
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_0_X5_0, align 4, !dbg !105, !tbaa !82
  // LD: Guess
  old_cr = cr(0,3);
