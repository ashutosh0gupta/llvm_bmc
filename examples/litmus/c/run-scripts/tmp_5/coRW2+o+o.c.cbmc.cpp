...
T0BLOCK0:
  ...
  //   %4 = load i32, i32* @atom_0_X0_2, align 4, !dbg !75, !tbaa !63
  // LD: Guess
  old_cr = cr(0,1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !90, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !92, metadata !DIExpression()), !dbg !114

  //   %5 = load atomic i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !77
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !94, metadata !DIExpression()), !dbg !114

  //   %conv = trunc i64 %5 to i32, !dbg !78
  ...
  //   %conv4 = zext i1 %cmp to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !95, metadata !DIExpression()), !dbg !97

  //   %and = and i32 %4, %conv4, !dbg !80
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 49, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !84
