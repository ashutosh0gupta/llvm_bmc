...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !76, metadata !DIExpression()), !dbg !97
  ...
  //   %conv13 = sext i32 %add10 to i64, !dbg !96

  //   call void @llvm.dbg.value(metadata i64 %conv13, metadata !79, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %conv13, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   %conv17 = trunc i64 %3 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !80, metadata !DIExpression()), !dbg !97

  //   %cmp = icmp eq i32 %conv, 1, !dbg !100

  //   %conv18 = zext i1 %cmp to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !84, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !88, metadata !DIExpression()), !dbg !97
  ...
  //   store atomic i64 %5, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !105
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv17, 1, !dbg !106

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !92, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !93, metadata !DIExpression()), !dbg !126

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %6, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !158, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !180, metadata !DIExpression()), !dbg !228
