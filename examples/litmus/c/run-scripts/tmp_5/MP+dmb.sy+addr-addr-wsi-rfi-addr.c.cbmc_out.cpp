...
T2BLOCK1:
  ...
  //   %xor15 = xor i32 %conv14, %conv14, !dbg !87
  creg_r9 = creg_r8;
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor15, metadata !79, metadata !DIExpression()), !dbg !88

  //   %add17 = add nsw i32 0, %xor15, !dbg !88
  creg_r10 = max(0,creg_r9);
  r10 = 0 + r9;

  //   %idxprom18 = sext i32 %add17 to i64, !dbg !88

  //   %arrayidx19 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom18, !dbg !88
  r11 = 0+r10*1;
  creg_r11 = creg_r10;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx19, metadata !81, metadata !DIExpression()), !dbg !108

  //   %3 = load atomic i64, i64* %arrayidx19 monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,r11);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !83, metadata !DIExpression()), !dbg !108
  ...
  //   %cmp24 = icmp eq i32 %conv14, 2, !dbg !97
  ...
  //   store i32 %conv25, i32* @atom_1_X9_2, align 4, !dbg !98, !tbaa !93
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv22, 0, !dbg !99
  ...
  //   store i32 %conv27, i32* @atom_1_X11_0, align 4, !dbg !100, !tbaa !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !128, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !129, metadata !DIExpression()), !dbg !170

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !130, metadata !DIExpression()), !dbg !172

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !134, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !135, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !138, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !141, metadata !DIExpression()), !dbg !179
  ...
  //   store i32 0, i32* @atom_1_X9_2, align 4, !dbg !102, !tbaa !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !148, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !150, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !151, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !155, metadata !DIExpression()), !dbg !198

  //   %conv14 = trunc i64 %5 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !152, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !156, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !160, metadata !DIExpression()), !dbg !202

  //   %conv20 = trunc i64 %6 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !157, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !161, metadata !DIExpression()), !dbg !170
  ...
  //   %8 = load i32, i32* @atom_1_X9_2, align 4, !dbg !125, !tbaa !98
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !166, metadata !DIExpression()), !dbg !170

  //   %and24 = and i32 %conv22, %and23, !dbg !129
  creg_r24 = max(creg__r18__1_,creg_r23);
  r24 = (r18==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !167, metadata !DIExpression()), !dbg !170

  //   %and25 = and i32 %conv16, %and24, !dbg !130
  creg_r25 = max(creg__r17__1_,creg_r24);
  r25 = (r17==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !168, metadata !DIExpression()), !dbg !170

  //   %and26 = and i32 %conv10, %and25, !dbg !131
  creg_r26 = max(creg__r16__2_,creg_r25);
  r26 = (r16==2) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !169, metadata !DIExpression()), !dbg !170
