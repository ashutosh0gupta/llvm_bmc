...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !97, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !96, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !100, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !104, metadata !DIExpression()), !dbg !117

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !106, metadata !DIExpression()), !dbg !117
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !124, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !126, metadata !DIExpression()), !dbg !138

  //   %conv = trunc i64 %0 to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !123, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !131, metadata !DIExpression()), !dbg !144

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !133, metadata !DIExpression()), !dbg !144
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !175, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !188, metadata !DIExpression()), !dbg !247
