...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !81, metadata !DIExpression()), !dbg !91
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !101, metadata !DIExpression()), !dbg !111

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !53
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0);
  cr(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l44_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !103, metadata !DIExpression()), !dbg !111
  ...
  // ST: Guess
  iw(4,4) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l46_c15
  old_cw = cw(4,4);
  cw(4,4) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l46_c15
  // Check
...
T0BLOCK0:
  ...
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l72_c12
  // Check
