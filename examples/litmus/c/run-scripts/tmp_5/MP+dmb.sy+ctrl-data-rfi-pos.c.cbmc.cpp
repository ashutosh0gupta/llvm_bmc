...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !68, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !102

  //   %conv5 = sext i32 %add to i64, !dbg !84

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !71, metadata !DIExpression()), !dbg !102

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   %conv13 = trunc i64 %3 to i32, !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !80, metadata !DIExpression()), !dbg !85

  //   store i32 %conv14, i32* @atom_1_X0_1, align 4, !dbg !92, !tbaa !93
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv9, 1, !dbg !97
  ...
  //   store i32 %conv16, i32* @atom_1_X6_1, align 4, !dbg !98, !tbaa !93
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv13, 1, !dbg !99
  ...
  //   store i32 %conv18, i32* @atom_1_X7_1, align 4, !dbg !100, !tbaa !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X6_1, align 4, !dbg !91, !tbaa !87
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X6_1, align 4, !dbg !110, !tbaa !87
  // LD: Guess
  old_cr = cr(0,4);
