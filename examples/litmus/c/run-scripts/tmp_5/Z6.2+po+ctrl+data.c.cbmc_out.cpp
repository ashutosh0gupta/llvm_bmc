...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !94, metadata !DIExpression()), !dbg !101

  //   %add = add nsw i32 %xor, 1, !dbg !56
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !95, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !98, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !99, metadata !DIExpression()), !dbg !101
