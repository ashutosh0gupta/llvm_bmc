...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !60, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !64, metadata !DIExpression()), !dbg !84
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !91, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !90, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !94, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !95, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !96, metadata !DIExpression()), !dbg !112

  //   %conv1 = sext i32 %add to i64, !dbg !61

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !98, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !99, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !100, metadata !DIExpression()), !dbg !115
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !125, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !126, metadata !DIExpression()), !dbg !163

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !127, metadata !DIExpression()), !dbg !165

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !131, metadata !DIExpression()), !dbg !167

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !132, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !149, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !151, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !152, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !156, metadata !DIExpression()), !dbg !197

  //   %conv18 = trunc i64 %7 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !153, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !160, metadata !DIExpression()), !dbg !200
