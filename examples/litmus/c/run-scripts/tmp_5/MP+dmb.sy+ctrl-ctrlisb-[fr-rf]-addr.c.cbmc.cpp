...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !100), !dbg !121
  ...
  //   %xor = xor i32 %conv15, %conv15, !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !131
  ...
  //   %cmp22 = icmp eq i32 %conv11, 0, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !87, metadata !DIExpression()), !dbg !137

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %6, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !91, metadata !DIExpression()), !dbg !140
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !189, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !218, metadata !DIExpression()), !dbg !286
