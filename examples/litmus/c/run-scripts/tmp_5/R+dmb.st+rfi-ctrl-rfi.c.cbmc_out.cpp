...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !64, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !67, metadata !DIExpression()), !dbg !81
  ...
  //   %cmp11 = icmp eq i32 %conv6, 1, !dbg !84

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !76, metadata !DIExpression()), !dbg !104
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !130, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !148, metadata !DIExpression()), !dbg !188
