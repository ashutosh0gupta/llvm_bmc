...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !193

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !195

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !197

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !158, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !204
  ...
  //   store i32 0, i32* @atom_1_X2_1, align 4, !dbg !104, !tbaa !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !171, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !172, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !176, metadata !DIExpression()), !dbg !225

  //   %conv14 = trunc i64 %7 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !173, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !177, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !179, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !181, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !182, metadata !DIExpression()), !dbg !193
  ...
  //   %10 = load i32, i32* @atom_1_X2_1, align 4, !dbg !131, !tbaa !100
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !188, metadata !DIExpression()), !dbg !193

  //   %and24 = and i32 %9, %and23, !dbg !136
  creg_r19 = max(creg_r13,creg_r18);
  r19 = r13 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !189, metadata !DIExpression()), !dbg !193

  //   %and25 = and i32 %conv22, %and24, !dbg !137
  creg_r20 = max(creg__r12__2_,creg_r19);
  r20 = (r12==2) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !190, metadata !DIExpression()), !dbg !193

  //   %and26 = and i32 %conv16, %and25, !dbg !138
  creg_r21 = max(creg__r11__1_,creg_r20);
  r21 = (r11==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !191, metadata !DIExpression()), !dbg !193

  //   %and27 = and i32 %conv10, %and26, !dbg !139
  creg_r22 = max(creg__r10__2_,creg_r21);
  r22 = (r10==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !192, metadata !DIExpression()), !dbg !193
