...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !74, metadata !DIExpression()), !dbg !103

  //   %tobool = icmp ne i32 %conv9, 0, !dbg !100
...
T2BLOCK4:
  ...
  //   %cmp20 = icmp eq i32 %conv4, 1, !dbg !114
  ...
  //   store atomic i64 %5, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv9, 2, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !94, metadata !DIExpression()), !dbg !137
  ...
  //   %cmp30 = icmp eq i32 %conv15, 1, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !98, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !122
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !186, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !189, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !212, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !216, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !220, metadata !DIExpression()), !dbg !284
