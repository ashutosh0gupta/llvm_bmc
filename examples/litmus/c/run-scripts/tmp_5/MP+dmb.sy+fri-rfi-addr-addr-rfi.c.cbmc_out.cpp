...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !70, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !87

  //   %xor9 = xor i32 %conv8, %conv8, !dbg !83
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !75, metadata !DIExpression()), !dbg !87
  ...
  //   store atomic i64 1, i64* %arrayidx13 monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   %conv18 = trunc i64 %3 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !79, metadata !DIExpression()), !dbg !87

  //   %cmp = icmp eq i32 %conv, 1, !dbg !89
  creg__r0__1_ = max(0,creg_r0);

  //   %conv19 = zext i1 %cmp to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !83, metadata !DIExpression()), !dbg !87

  //   store i32 %conv19, i32* @atom_1_X0_1, align 4, !dbg !90, !tbaa !91
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv4, 2, !dbg !95
  ...
  //   store i32 %conv21, i32* @atom_1_X3_2, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv18, 1, !dbg !97
  ...
  //   store i32 %conv23, i32* @atom_1_X10_1, align 4, !dbg !98, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X10_1, align 4, !dbg !92, !tbaa !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !185
  ...
  //   %8 = load i32, i32* @atom_1_X10_1, align 4, !dbg !111, !tbaa !87
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !119
