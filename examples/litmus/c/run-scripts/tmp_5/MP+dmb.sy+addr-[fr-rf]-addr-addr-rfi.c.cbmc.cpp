...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !79, metadata !DIExpression()), !dbg !104

  //   %add18 = add nsw i32 0, %xor17, !dbg !103
  ...
  //   %arrayidx20 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !103
  r12 = 0+r11*1;
  ASSUME(creg_r12 >= 0);
  ASSUME(creg_r12 >= creg_r11);
  ASSUME(active[creg_r12] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !80, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 1, metadata !82, metadata !DIExpression()), !dbg !123

  //   store atomic i64 1, i64* %arrayidx20 monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv4, 0, !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !92, metadata !DIExpression()), !dbg !131
  ...
  //   %cmp34 = icmp eq i32 %conv8, 1, !dbg !114
  ...
  //   %cmp39 = icmp eq i32 %conv24, 1, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_1, metadata !100, metadata !DIExpression()), !dbg !137

  //   %8 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %8, i64* @atom_1_X12_1 seq_cst, align 8, !dbg !119
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_1, metadata !189, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !250

  //   store atomic i64 0, i64* @atom_1_X12_1 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_1, metadata !220, metadata !DIExpression()), !dbg !286

  //   %12 = load atomic i64, i64* @atom_1_X12_1 seq_cst, align 8, !dbg !171
  // LD: Guess
  old_cr = cr(0,7);
