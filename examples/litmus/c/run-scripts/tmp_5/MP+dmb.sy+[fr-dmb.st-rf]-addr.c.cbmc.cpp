...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !82
  ...
  //   %cmp10 = icmp eq i32 %conv4, 1, !dbg !76
  ...
  //   store i32 %conv11, i32* @atom_1_X2_1, align 4, !dbg !77, !tbaa !72
  // ST: Guess
  ...
  //   store i32 %conv13, i32* @atom_1_X5_0, align 4, !dbg !79, !tbaa !72
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !103, metadata !DIExpression()), !dbg !113
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X2_1, align 4, !dbg !88, !tbaa !84
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X5_0, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   %8 = load i32, i32* @atom_1_X2_1, align 4, !dbg !106, !tbaa !84
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X5_0, align 4, !dbg !107, !tbaa !84
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !114
