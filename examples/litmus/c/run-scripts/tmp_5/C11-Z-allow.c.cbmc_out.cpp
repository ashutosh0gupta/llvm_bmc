...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64 2, metadata !43, metadata !DIExpression()), !dbg !63

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !64
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !44, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !49, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64 3, metadata !51, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !52, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64 4, metadata !54, metadata !DIExpression()), !dbg !70

  //   store atomic i64 4, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !71
  // ST: Guess
  iw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0);
  cw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !56, metadata !DIExpression()), !dbg !73

  //   %1 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !58, metadata !DIExpression()), !dbg !73

  //   store atomic i64 %1, i64* @atom_0_X5_1 seq_cst, align 8, !dbg !74
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !78, metadata !DIExpression()), !dbg !96
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !82, metadata !DIExpression()), !dbg !99

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !79, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !83, metadata !DIExpression()), !dbg !96

  //   %cmp = icmp eq i32 %conv, 4, !dbg !68

  //   %conv5 = zext i1 %cmp to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !87, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_4, metadata !88, metadata !DIExpression()), !dbg !106

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !90, metadata !DIExpression()), !dbg !106

  //   store atomic i64 %2, i64* @atom_1_X2_4 seq_cst, align 8, !dbg !70
  // ST: Guess
  ...
  //   %cmp7 = icmp eq i32 %conv4, 1, !dbg !71

  //   %conv8 = zext i1 %cmp7 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !91, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !92, metadata !DIExpression()), !dbg !109

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !94, metadata !DIExpression()), !dbg !109

  //   store atomic i64 %3, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !73
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !114, metadata !DIExpression()), !dbg !133
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !115, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64 1, metadata !117, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !118, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64 2, metadata !120, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !121, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64 1, metadata !123, metadata !DIExpression()), !dbg !140

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !68
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !125, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !127, metadata !DIExpression()), !dbg !142

  //   %conv = trunc i64 %0 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !124, metadata !DIExpression()), !dbg !133

  //   %cmp = icmp eq i32 %conv, 3, !dbg !72

  //   %conv5 = zext i1 %cmp to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !128, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X4_3, metadata !129, metadata !DIExpression()), !dbg !146

  //   %1 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !131, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %1, i64* @atom_2_X4_3 seq_cst, align 8, !dbg !74
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !208

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !167, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !210

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !170, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !212

  //   store atomic i64 0, i64* @atom_0_X5_1 monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X4_3, metadata !173, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !214

  //   store atomic i64 0, i64* @atom_2_X4_3 monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_4, metadata !176, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !216

  //   store atomic i64 0, i64* @atom_1_X2_4 monotonic, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !179, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !218

  //   store atomic i64 0, i64* @atom_1_X4_1 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   %call12 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !110
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !116
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !118
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !120
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !183, metadata !DIExpression()), !dbg !233

  //   %6 = load atomic i64, i64* @atom_0_X5_1 seq_cst, align 8, !dbg !122
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X4_3, metadata !187, metadata !DIExpression()), !dbg !236

  //   %7 = load atomic i64, i64* @atom_2_X4_3 seq_cst, align 8, !dbg !125
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %conv19 = trunc i64 %7 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !186, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_4, metadata !191, metadata !DIExpression()), !dbg !239

  //   %8 = load atomic i64, i64* @atom_1_X2_4 seq_cst, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !193, metadata !DIExpression()), !dbg !239

  //   %conv23 = trunc i64 %8 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !190, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !195, metadata !DIExpression()), !dbg !242

  //   %9 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !197, metadata !DIExpression()), !dbg !242

  //   %conv27 = trunc i64 %9 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !194, metadata !DIExpression()), !dbg !201

  //   %and = and i32 %conv23, %conv27, !dbg !133
  creg_r12 = max(creg_r10,creg_r11);
  ASSUME(active[creg_r12] == 0);
  r12 = r10 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !198, metadata !DIExpression()), !dbg !201

  //   %and28 = and i32 %conv19, %and, !dbg !134
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([96 x i8], [96 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !139
