...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv13, 0, !dbg !104
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !103), !dbg !128

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !129

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !85, metadata !DIExpression()), !dbg !129

  //   %conv17 = trunc i64 %3 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !82, metadata !DIExpression()), !dbg !104

  //   %cmp = icmp eq i32 %conv, 1, !dbg !113

  //   %conv18 = zext i1 %cmp to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !86, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !133

  //   %4 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !89, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv5, 1, !dbg !116

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !90, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !91, metadata !DIExpression()), !dbg !136

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !93, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %5, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv13, 2, !dbg !119

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !94, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !95, metadata !DIExpression()), !dbg !139

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !97, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %6, i64* @atom_1_X8_2 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv17, 0, !dbg !122

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !98, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !99, metadata !DIExpression()), !dbg !142

  //   %7 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !101, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %7, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !147, metadata !DIExpression()), !dbg !152
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !148, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64 2, metadata !150, metadata !DIExpression()), !dbg !155
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !165, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !166, metadata !DIExpression()), !dbg !240

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !167, metadata !DIExpression()), !dbg !242

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !171, metadata !DIExpression()), !dbg !244

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !172, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !173, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !176, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !179, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !185, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !188, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !191, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !194, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !198, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !200, metadata !DIExpression()), !dbg !276

  //   %conv = trunc i64 %6 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !197, metadata !DIExpression()), !dbg !240

  //   %cmp = icmp eq i32 %conv, 2, !dbg !158

  //   %conv20 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !201, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !203, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !205, metadata !DIExpression()), !dbg !280

  //   %conv24 = trunc i64 %7 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !202, metadata !DIExpression()), !dbg !240

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !162

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !206, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !208, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !210, metadata !DIExpression()), !dbg !284

  //   %conv30 = trunc i64 %8 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !207, metadata !DIExpression()), !dbg !240

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !166

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !211, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !213, metadata !DIExpression()), !dbg !288
  ...
  if(cr(0,0+2*1) < cw(0,0+2*1)) {
    ...
    r16 = mem(0+2*1,cr(0,0+2*1));
  }
  ASSUME(creturn[0] >= cr(0,0+2*1));

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !215, metadata !DIExpression()), !dbg !288

  //   %conv36 = trunc i64 %9 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !212, metadata !DIExpression()), !dbg !240

  //   %cmp37 = icmp eq i32 %conv36, 1, !dbg !170

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !216, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !218, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !220, metadata !DIExpression()), !dbg !292

  //   %conv42 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !217, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !222, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !224, metadata !DIExpression()), !dbg !295

  //   %conv46 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !221, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !226, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !228, metadata !DIExpression()), !dbg !298

  //   %conv50 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !225, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !230, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !232, metadata !DIExpression()), !dbg !301

  //   %conv54 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !229, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !233, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !234, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !235, metadata !DIExpression()), !dbg !240

  //   %and57 = and i32 %conv38, %and56, !dbg !186
  creg_r24 = max(max(creg_r16,0),creg_r23);
  ASSUME(active[creg_r24] == 0);
  r24 = (r16==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !236, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !237, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !238, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !239, metadata !DIExpression()), !dbg !240
