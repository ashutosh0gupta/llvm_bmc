...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !96), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !75, metadata !DIExpression()), !dbg !97

  //   %add11 = add nsw i32 0, %xor9, !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !120

  //   store atomic i64 1, i64* %arrayidx13 monotonic, align 8, !dbg !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !163, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !189, metadata !DIExpression()), !dbg !245
