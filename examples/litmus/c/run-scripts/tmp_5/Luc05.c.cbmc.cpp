...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !40, metadata !DIExpression()), !dbg !52
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !82

  //   call void @llvm.dbg.value(metadata i64 2, metadata !73, metadata !DIExpression()), !dbg !82
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !94, metadata !DIExpression()), !dbg !105
  ...
  //   store i32 %conv1, i32* @atom_2_X0_2, align 4, !dbg !58, !tbaa !59
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !117, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !118, metadata !DIExpression()), !dbg !142

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !68

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !68

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !119, metadata !DIExpression()), !dbg !144

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !123, metadata !DIExpression()), !dbg !146

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !124, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !125, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !128, metadata !DIExpression()), !dbg !151
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !83, !tbaa !79
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_2_X0_2, align 4, !dbg !84, !tbaa !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !134, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !135, metadata !DIExpression()), !dbg !142
  ...
  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !101, !tbaa !79
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %9 = load i32, i32* @atom_2_X0_2, align 4, !dbg !102, !tbaa !79
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !138, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i32 %and9, metadata !140, metadata !DIExpression()), !dbg !142

  //   %and10 = and i32 %conv8, %and9, !dbg !105
  creg_r13 = max(creg__r7__2_,creg_r12);
  r13 = (r7==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and10, metadata !141, metadata !DIExpression()), !dbg !142
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !109
