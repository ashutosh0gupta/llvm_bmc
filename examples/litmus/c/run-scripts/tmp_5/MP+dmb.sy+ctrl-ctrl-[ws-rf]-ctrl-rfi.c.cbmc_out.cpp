...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !84), !dbg !90
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !63, metadata !DIExpression()), !dbg !88
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !86), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !70, metadata !DIExpression()), !dbg !88

  //   %tobool12 = icmp ne i32 %conv11, 0, !dbg !95
  creg__r2__0_ = max(0,creg_r2);

  //   br i1 %tobool12, label %if.then13, label %if.else14, !dbg !97
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK8:
  //   br label %lbl_LC02, !dbg !98
  goto T2BLOCK10;

T2BLOCK9:
  //   br label %lbl_LC02, !dbg !99
  goto T2BLOCK10;
...
T2BLOCK10:
  ...
  //   %conv20 = trunc i64 %3 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !77, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !81, metadata !DIExpression()), !dbg !88

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !107, !tbaa !108
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv11, 2, !dbg !112
  creg__r2__2_ = max(0,creg_r2);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !82, metadata !DIExpression()), !dbg !88

  //   store i32 %conv23, i32* @atom_1_X6_2, align 4, !dbg !113, !tbaa !108
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv20, 1, !dbg !114
  creg__r3__1_ = max(0,creg_r3);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !83, metadata !DIExpression()), !dbg !88

  //   store i32 %conv25, i32* @atom_1_X9_1, align 4, !dbg !115, !tbaa !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !156, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !157, metadata !DIExpression()), !dbg !199

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !158, metadata !DIExpression()), !dbg !201

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !162, metadata !DIExpression()), !dbg !203

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !163, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !164, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !167, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !173, metadata !DIExpression()), !dbg !212
  ...
  //   store i32 0, i32* @atom_1_X6_2, align 4, !dbg !105, !tbaa !101
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X9_1, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !177, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !179, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !180, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !184, metadata !DIExpression()), !dbg !232

  //   %conv16 = trunc i64 %7 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !181, metadata !DIExpression()), !dbg !199

  //   %cmp17 = icmp eq i32 %conv16, 2, !dbg !125
  creg__r9__2_ = max(0,creg_r9);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !185, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !189, metadata !DIExpression()), !dbg !236

  //   %conv22 = trunc i64 %8 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !186, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !190, metadata !DIExpression()), !dbg !199
  ...
  //   %10 = load i32, i32* @atom_1_X6_2, align 4, !dbg !131, !tbaa !101
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X9_1, align 4, !dbg !132, !tbaa !101
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !195, metadata !DIExpression()), !dbg !199

  //   %and26 = and i32 %conv24, %and25, !dbg !135
  creg_r16 = max(creg__r10__1_,creg_r15);
  r16 = (r10==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !196, metadata !DIExpression()), !dbg !199

  //   %and27 = and i32 %conv18, %and26, !dbg !136
  creg_r17 = max(creg__r9__2_,creg_r16);
  r17 = (r9==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !197, metadata !DIExpression()), !dbg !199

  //   %and28 = and i32 %conv12, %and27, !dbg !137
  creg_r18 = max(creg__r8__2_,creg_r17);
  r18 = (r8==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !198, metadata !DIExpression()), !dbg !199
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !141
