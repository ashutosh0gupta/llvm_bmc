...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !52, metadata !DIExpression()), !dbg !70

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !71
  // ST: Guess
  //   : Release
  ...
  //   store i32 %conv9, i32* @atom_0_X6_3, align 4, !dbg !76, !tbaa !77
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !89, metadata !DIExpression()), !dbg !99
