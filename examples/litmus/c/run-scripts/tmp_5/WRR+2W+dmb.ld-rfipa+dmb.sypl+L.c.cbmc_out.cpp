...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !119, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !120, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64 0, metadata !122, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !123, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i64 0, metadata !125, metadata !DIExpression()), !dbg !150
  ...
  //   store i32 0, i32* @atom_1_X4_1, align 4, !dbg !85, !tbaa !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !130, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !132, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !131, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !135, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !136, metadata !DIExpression()), !dbg !141

  //   %9 = load i32, i32* @atom_1_X4_1, align 4, !dbg !106, !tbaa !81
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !137, metadata !DIExpression()), !dbg !141

  //   %and = and i32 %8, %9, !dbg !107
  creg_r10 = max(creg_r8,creg_r9);
  r10 = r8 & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !138, metadata !DIExpression()), !dbg !141

  //   %and15 = and i32 %conv14, %and, !dbg !108
  creg_r11 = max(creg__r7__2_,creg_r10);
  r11 = (r7==2) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !139, metadata !DIExpression()), !dbg !141

  //   %and16 = and i32 %conv8, %and15, !dbg !109
  creg_r12 = max(creg__r6__2_,creg_r11);
  r12 = (r6==2) & r11;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !140, metadata !DIExpression()), !dbg !141
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !113
