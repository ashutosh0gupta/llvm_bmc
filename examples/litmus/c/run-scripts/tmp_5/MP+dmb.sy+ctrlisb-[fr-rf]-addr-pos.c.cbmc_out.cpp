...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !112

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   %cmp22 = icmp eq i32 %conv12, 0, !dbg !108
  ...
  //   store i32 %conv23, i32* @atom_1_X6_0, align 4, !dbg !109, !tbaa !100
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X8_0, align 4, !dbg !111, !tbaa !100
  // ST: Guess
