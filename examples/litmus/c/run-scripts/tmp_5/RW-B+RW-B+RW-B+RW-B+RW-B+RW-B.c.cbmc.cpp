...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !50, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64 1, metadata !52, metadata !DIExpression()), !dbg !62

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  // ST: Guess
  iw(1,6) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l28_c15
  old_cw = cw(1,6);
  cw(1,6) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l28_c15
  // Check
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !78, metadata !DIExpression()), !dbg !90
  ...
  // ST: Guess
  iw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l38_c15
  old_cw = cw(2,7);
  cw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l38_c15
  // Check
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !99, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !102, metadata !DIExpression()), !dbg !114
  ...
  // ST: Guess
  iw(3,8) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l48_c15
  old_cw = cw(3,8);
  cw(3,8) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l48_c15
  // Check
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !123, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !126, metadata !DIExpression()), !dbg !138
  ...
  // ST: Guess
  iw(4,9) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l58_c15
  old_cw = cw(4,9);
  cw(4,9) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l58_c15
  // Check
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !147, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !150, metadata !DIExpression()), !dbg !162
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !171, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !186
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !198, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !199, metadata !DIExpression()), !dbg !238

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !200, metadata !DIExpression()), !dbg !240

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !204, metadata !DIExpression()), !dbg !242

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #6, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !205, metadata !DIExpression()), !dbg !244

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #6, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !206, metadata !DIExpression()), !dbg !246

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #6, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !207, metadata !DIExpression()), !dbg !248

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #6, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !208, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !209, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !212, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !214, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !215, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !217, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !218, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !220, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !221, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !223, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !224, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !226, metadata !DIExpression()), !dbg !261
  ...
  //   store i32 0, i32* @atom_0_X0_1, align 4, !dbg !113, !tbaa !114
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l96_c15
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l96_c15
  // Check
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !118, !tbaa !114
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l97_c15
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l97_c15
  // Check
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !119, !tbaa !114
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l98_c15
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l98_c15
  // Check
  ...
  //   store i32 0, i32* @atom_3_X0_1, align 4, !dbg !120, !tbaa !114
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l99_c15
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l99_c15
  // Check
  ...
  //   store i32 0, i32* @atom_4_X0_1, align 4, !dbg !121, !tbaa !114
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l100_c15
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l100_c15
  // Check
  ...
  //   store i32 0, i32* @atom_5_X0_1, align 4, !dbg !122, !tbaa !114
  // ST: Guess
  iw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l101_c15
  old_cw = cw(0,11);
  cw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l101_c15
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !123
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !124
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call12 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #6, !dbg !125
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #6, !dbg !126
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #6, !dbg !127
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr5, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t5, i8* noundef null) #6, !dbg !128
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %12 = load i32, i32* @atom_0_X0_1, align 4, !dbg !143, !tbaa !114
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %13 = load i32, i32* @atom_1_X0_1, align 4, !dbg !144, !tbaa !114
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %14 = load i32, i32* @atom_2_X0_1, align 4, !dbg !145, !tbaa !114
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   %15 = load i32, i32* @atom_3_X0_1, align 4, !dbg !146, !tbaa !114
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !230, metadata !DIExpression()), !dbg !238

  //   %16 = load i32, i32* @atom_4_X0_1, align 4, !dbg !147, !tbaa !114
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !231, metadata !DIExpression()), !dbg !238

  //   %17 = load i32, i32* @atom_5_X0_1, align 4, !dbg !148, !tbaa !114
  // LD: Guess
  old_cr = cr(0,11);
  cr(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l122_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !232, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !234, metadata !DIExpression()), !dbg !238

  //   %and23 = and i32 %14, %and22, !dbg !151
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !235, metadata !DIExpression()), !dbg !238

  //   %and24 = and i32 %13, %and23, !dbg !152
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !236, metadata !DIExpression()), !dbg !238

  //   %and25 = and i32 %12, %and24, !dbg !153
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !237, metadata !DIExpression()), !dbg !238
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 128, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !157
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %18) #6, !dbg !160

  //   %19 = bitcast i64* %thr4 to i8*, !dbg !160

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %19) #6, !dbg !160

  //   %20 = bitcast i64* %thr3 to i8*, !dbg !160

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %20) #6, !dbg !160

  //   %21 = bitcast i64* %thr2 to i8*, !dbg !160

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %21) #6, !dbg !160

  //   %22 = bitcast i64* %thr1 to i8*, !dbg !160

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %22) #6, !dbg !160

  //   %23 = bitcast i64* %thr0 to i8*, !dbg !160

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %23) #6, !dbg !160
