...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !124, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !127, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !130, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !133, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !137, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !139, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !140, metadata !DIExpression()), !dbg !157
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !144, metadata !DIExpression()), !dbg !184

  //   %conv14 = trunc i64 %5 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !141, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !149, metadata !DIExpression()), !dbg !188

  //   %conv20 = trunc i64 %6 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !146, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !150, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !154, metadata !DIExpression()), !dbg !157

  //   %and24 = and i32 %conv16, %and23, !dbg !123
  creg_r13 = max(creg__r7__2_,creg_r12);
  r13 = (r7==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !155, metadata !DIExpression()), !dbg !157

  //   %and25 = and i32 %conv10, %and24, !dbg !124
  creg_r14 = max(creg__r6__1_,creg_r13);
  r14 = (r6==1) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !156, metadata !DIExpression()), !dbg !157
