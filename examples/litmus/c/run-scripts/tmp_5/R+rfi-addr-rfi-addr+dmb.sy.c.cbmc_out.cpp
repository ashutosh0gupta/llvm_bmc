...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !48, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !52, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !51, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !55, metadata !DIExpression()), !dbg !68

  //   %add9 = add nsw i32 2, %xor7, !dbg !83
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 1);
  r6 = 2 + r5;

  //   %idxprom10 = sext i32 %add9 to i64, !dbg !83

  //   %arrayidx11 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom10, !dbg !83
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 1);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx11, metadata !56, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64 1, metadata !58, metadata !DIExpression()), !dbg !84

  //   store atomic i64 1, i64* %arrayidx11 monotonic, align 8, !dbg !83
  // ST: Guess
  iw(1,r7) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,r7);
  cw(1,r7) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !59, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !60, metadata !DIExpression()), !dbg !86

  //   %2 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !62, metadata !DIExpression()), !dbg !86

  //   store atomic i64 %2, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !87
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv6, 1, !dbg !88

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !63, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_1, metadata !64, metadata !DIExpression()), !dbg !89

  //   %3 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !66, metadata !DIExpression()), !dbg !89

  //   store atomic i64 %3, i64* @atom_0_X6_1 seq_cst, align 8, !dbg !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !143, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_1, metadata !146, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !149, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !168, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_1, metadata !172, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !176, metadata !DIExpression()), !dbg !229
