...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !131, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !132, metadata !DIExpression()), !dbg !188

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !133, metadata !DIExpression()), !dbg !190

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !137, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !138, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !141, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !144, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !147, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !150, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !153, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64 0, metadata !155, metadata !DIExpression()), !dbg !203

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !157, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !159, metadata !DIExpression()), !dbg !215

  //   %conv = trunc i64 %4 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !156, metadata !DIExpression()), !dbg !188

  //   %cmp = icmp eq i32 %conv, 2, !dbg !129

  //   %conv14 = zext i1 %cmp to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !160, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !164, metadata !DIExpression()), !dbg !219

  //   %conv18 = trunc i64 %5 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !161, metadata !DIExpression()), !dbg !188

  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !133

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !165, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !169, metadata !DIExpression()), !dbg !223

  //   %conv24 = trunc i64 %6 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !166, metadata !DIExpression()), !dbg !188

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !137

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !170, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !174, metadata !DIExpression()), !dbg !227

  //   %conv30 = trunc i64 %7 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !171, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !176, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !178, metadata !DIExpression()), !dbg !230

  //   %conv34 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !175, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !180, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !182, metadata !DIExpression()), !dbg !233

  //   %conv38 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !179, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !184, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !185, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !186, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !187, metadata !DIExpression()), !dbg !188
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
