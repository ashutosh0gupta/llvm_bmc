...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !187

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !189

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !191

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !158, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !172, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !173, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !177, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !183, metadata !DIExpression()), !dbg !187

  //   %and18 = and i32 %8, %and17, !dbg !126
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !184, metadata !DIExpression()), !dbg !187

  //   %and19 = and i32 %conv16, %and18, !dbg !127
  creg_r21 = max(creg__r13__2_,creg_r20);
  r21 = (r13==2) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !185, metadata !DIExpression()), !dbg !187

  //   %and20 = and i32 %conv10, %and19, !dbg !128
  creg_r22 = max(creg__r12__2_,creg_r21);
  r22 = (r12==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !186, metadata !DIExpression()), !dbg !187
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !132
