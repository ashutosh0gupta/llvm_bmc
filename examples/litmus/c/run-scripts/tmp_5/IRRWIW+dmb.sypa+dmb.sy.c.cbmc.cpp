...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !127, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !128, metadata !DIExpression()), !dbg !153

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !129, metadata !DIExpression()), !dbg !155

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !133, metadata !DIExpression()), !dbg !157

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !134, metadata !DIExpression()), !dbg !159

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !135, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !136, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64 0, metadata !138, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !139, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !143, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !145, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !146, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !148, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i32 %and11, metadata !151, metadata !DIExpression()), !dbg !153

  //   %and12 = and i32 %conv10, %and11, !dbg !111
  creg_r14 = max(creg__r8__2_,creg_r13);
  r14 = (r8==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and12, metadata !152, metadata !DIExpression()), !dbg !153
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 83, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !115
