...
T2BLOCK10:
  ...
  //   %cmp28 = icmp eq i32 %conv15, 0, !dbg !121
  ...
  //   store i32 %conv29, i32* @atom_1_X7_0, align 4, !dbg !122, !tbaa !117
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv19, 1, !dbg !123
  ...
  //   store i32 %conv31, i32* @atom_1_X9_1, align 4, !dbg !124, !tbaa !117
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !150, metadata !DIExpression()), !dbg !157
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !191, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !196, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !201, metadata !DIExpression()), !dbg !255
