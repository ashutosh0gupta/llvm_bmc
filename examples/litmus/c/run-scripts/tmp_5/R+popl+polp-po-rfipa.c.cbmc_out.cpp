...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !71, metadata !DIExpression()), !dbg !99
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64 2, metadata !74, metadata !DIExpression()), !dbg !102

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !71
  // ST: Guess
  //   : Release
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !73
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !78, metadata !DIExpression()), !dbg !104

  //   %conv = trunc i64 %0 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !75, metadata !DIExpression()), !dbg !99
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !76
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !109

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !78
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !82, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !89, metadata !DIExpression()), !dbg !112

  //   %conv10 = trunc i64 %2 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !86, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !83

  //   %conv11 = zext i1 %cmp to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !90, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !91, metadata !DIExpression()), !dbg !116

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !93, metadata !DIExpression()), !dbg !116

  //   store atomic i64 %3, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !85
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv6, 1, !dbg !86

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !94, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !95, metadata !DIExpression()), !dbg !119

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !97, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %4, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !145, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !148, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !151, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !160, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !165, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !169, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !173, metadata !DIExpression()), !dbg !221
