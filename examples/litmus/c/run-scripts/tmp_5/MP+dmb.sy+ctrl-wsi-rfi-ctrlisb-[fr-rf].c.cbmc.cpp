...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64 2, metadata !70, metadata !DIExpression()), !dbg !116
  ...
  //   %conv6 = trunc i64 %1 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !71, metadata !DIExpression()), !dbg !102

  //   %tobool7 = icmp ne i32 %conv6, 0, !dbg !102

  //   br i1 %tobool7, label %if.then8, label %if.else9, !dbg !104
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !101), !dbg !126
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp22 = icmp eq i32 %conv6, 2, !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !88, metadata !DIExpression()), !dbg !138

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %5, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !120
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv13, 0, !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !92, metadata !DIExpression()), !dbg !141

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %6, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !123
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv17, 1, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !96, metadata !DIExpression()), !dbg !144

  //   %7 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %7, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !126
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !187, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !190, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !193, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !216, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !220, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !224, metadata !DIExpression()), !dbg !288
