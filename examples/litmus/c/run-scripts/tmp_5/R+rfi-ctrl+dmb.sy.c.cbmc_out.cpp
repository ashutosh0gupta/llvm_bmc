...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !50), !dbg !64
  ...
  //   store i32 %conv3, i32* @atom_0_X2_1, align 4, !dbg !68, !tbaa !69
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !77, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !92
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X2_1, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X2_1, align 4, !dbg !99, !tbaa !78
  // LD: Guess
  old_cr = cr(0,2);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !107
