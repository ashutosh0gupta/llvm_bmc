...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !53), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !49, metadata !DIExpression()), !dbg !71

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !51, metadata !DIExpression()), !dbg !71

  //   store atomic i64 %1, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !72
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !122, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !139, metadata !DIExpression()), !dbg !180
