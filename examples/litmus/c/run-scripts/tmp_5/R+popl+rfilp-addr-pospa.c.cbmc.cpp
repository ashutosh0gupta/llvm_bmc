...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !85, metadata !DIExpression()), !dbg !104

  //   %conv4 = trunc i64 %1 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !82, metadata !DIExpression()), !dbg !94
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !75
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !86, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !90, metadata !DIExpression()), !dbg !94

  //   store i32 %conv9, i32* @atom_1_X2_2, align 4, !dbg !78, !tbaa !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !91, metadata !DIExpression()), !dbg !94

  //   store i32 %conv11, i32* @atom_1_X4_0, align 4, !dbg !84, !tbaa !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !92, metadata !DIExpression()), !dbg !94

  //   store i32 %conv13, i32* @atom_1_X6_0, align 4, !dbg !86, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !130, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !133, metadata !DIExpression()), !dbg !162
  ...
  //   store i32 0, i32* @atom_1_X2_2, align 4, !dbg !90, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_0, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X6_0, align 4, !dbg !92, !tbaa !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !140, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !141, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !145, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !146, metadata !DIExpression()), !dbg !155

  //   %7 = load i32, i32* @atom_1_X2_2, align 4, !dbg !110, !tbaa !86
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !147, metadata !DIExpression()), !dbg !155

  //   %8 = load i32, i32* @atom_1_X4_0, align 4, !dbg !111, !tbaa !86
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X6_0, align 4, !dbg !112, !tbaa !86
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !150, metadata !DIExpression()), !dbg !155

  //   %and13 = and i32 %7, %and, !dbg !114
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !151, metadata !DIExpression()), !dbg !155

  //   %and14 = and i32 %6, %and13, !dbg !115
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !152, metadata !DIExpression()), !dbg !155
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
