...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !107

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,0+1*1);
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !116

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !68, metadata !DIExpression()), !dbg !116

  //   %conv4 = trunc i64 %1 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !119

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !119

  //   %conv8 = trunc i64 %2 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !69, metadata !DIExpression()), !dbg !104

  //   %tobool9 = icmp ne i32 %conv8, 0, !dbg !103

  //   br i1 %tobool9, label %if.then10, label %if.else11, !dbg !105
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !103), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !129

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !129

  //   %conv15 = trunc i64 %3 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !73, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !132

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !132

  //   %conv19 = trunc i64 %4 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !77, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !135

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !135

  //   %conv23 = trunc i64 %5 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !81, metadata !DIExpression()), !dbg !104

  //   %cmp = icmp eq i32 %conv, 1, !dbg !119

  //   %conv24 = zext i1 %cmp to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !85, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !86, metadata !DIExpression()), !dbg !139

  //   %6 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !88, metadata !DIExpression()), !dbg !139
  ...
  //   %cmp26 = icmp eq i32 %conv15, 0, !dbg !122

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !89, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !90, metadata !DIExpression()), !dbg !142

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !124
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv19, 1, !dbg !125

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !93, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !94, metadata !DIExpression()), !dbg !145

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %8, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv23, 1, !dbg !128

  //   %conv37 = zext i1 %cmp36 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv37, metadata !97, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !98, metadata !DIExpression()), !dbg !148

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !100, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %9, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !154, metadata !DIExpression()), !dbg !161
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !171, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !172, metadata !DIExpression()), !dbg !231

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !173, metadata !DIExpression()), !dbg !233

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !177, metadata !DIExpression()), !dbg !235

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !178, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !179, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !182, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !185, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !188, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !191, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !194, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !197, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !200, metadata !DIExpression()), !dbg !231

  //   %cmp = icmp eq i32 %conv, 2, !dbg !141

  //   %conv18 = zext i1 %cmp to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !204, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !205, metadata !DIExpression()), !dbg !231

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !145

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !209, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !211, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !210, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !215, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !217, metadata !DIExpression()), !dbg !276

  //   %conv32 = trunc i64 %9 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !214, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !219, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !221, metadata !DIExpression()), !dbg !279

  //   %conv36 = trunc i64 %10 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !218, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !223, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !225, metadata !DIExpression()), !dbg !282

  //   %conv40 = trunc i64 %11 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !222, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !226, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !227, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !228, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !229, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !230, metadata !DIExpression()), !dbg !231
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
