...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !136, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !139, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !142, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !178
  ...
  //   store i32 0, i32* @atom_1_X2_0, align 4, !dbg !99, !tbaa !95
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_1, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !151, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !152, metadata !DIExpression()), !dbg !165
  ...
  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !156, metadata !DIExpression()), !dbg !198

  //   %conv16 = trunc i64 %7 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !153, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !157, metadata !DIExpression()), !dbg !165
  ...
  //   %9 = load i32, i32* @atom_1_X2_0, align 4, !dbg !121, !tbaa !95
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X4_1, align 4, !dbg !122, !tbaa !95
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !162, metadata !DIExpression()), !dbg !165

  //   %and20 = and i32 %conv18, %and19, !dbg !125
  creg_r14 = max(creg__r8__2_,creg_r13);
  r14 = (r8==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !163, metadata !DIExpression()), !dbg !165

  //   %and21 = and i32 %conv12, %and20, !dbg !126
  creg_r15 = max(creg__r7__2_,creg_r14);
  r15 = (r7==2) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !164, metadata !DIExpression()), !dbg !165
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([91 x i8], [91 x i8]* @.str.1, i64 0, i64 0), i32 noundef 81, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !130
