...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !128, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !136, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !138, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !143, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !144, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !145, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !146, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !148, metadata !DIExpression()), !dbg !150

  //   %and18 = and i32 %conv10, %and17, !dbg !115
  creg_r13 = max(creg__r7__2_,creg_r12);
  r13 = (r7==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !149, metadata !DIExpression()), !dbg !150
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !119
