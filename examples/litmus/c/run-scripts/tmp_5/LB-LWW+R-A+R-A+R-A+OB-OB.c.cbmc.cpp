...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !118, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i64 1, metadata !120, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !122, metadata !DIExpression()), !dbg !136
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !141, metadata !DIExpression()), !dbg !154
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !143, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !145, metadata !DIExpression()), !dbg !157

  //   %conv = trunc i64 %0 to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !142, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 1, metadata !148, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !149, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !150, metadata !DIExpression()), !dbg !164

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !152, metadata !DIExpression()), !dbg !164
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !174, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !175, metadata !DIExpression()), !dbg !236

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !176, metadata !DIExpression()), !dbg !238

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !180, metadata !DIExpression()), !dbg !240

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !181, metadata !DIExpression()), !dbg !242

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !182, metadata !DIExpression()), !dbg !244

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !183, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !184, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !190, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !196, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !199, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !202, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !208, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !212, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !214, metadata !DIExpression()), !dbg !284

  //   %conv = trunc i64 %10 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !211, metadata !DIExpression()), !dbg !236

  //   %cmp = icmp eq i32 %conv, 3, !dbg !157

  //   %conv26 = zext i1 %cmp to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !215, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !217, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !219, metadata !DIExpression()), !dbg !288

  //   %conv30 = trunc i64 %11 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !216, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !221, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !223, metadata !DIExpression()), !dbg !291

  //   %conv34 = trunc i64 %12 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !220, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !225, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !227, metadata !DIExpression()), !dbg !294

  //   %conv38 = trunc i64 %13 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !224, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !229, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !231, metadata !DIExpression()), !dbg !297

  //   %conv42 = trunc i64 %14 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !228, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !232, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !233, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !234, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !235, metadata !DIExpression()), !dbg !236
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 104, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
