...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !41, metadata !DIExpression()), !dbg !62
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !78, metadata !DIExpression()), !dbg !100
...
T2BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !65
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !83, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !85, metadata !DIExpression()), !dbg !105

  //   %conv = trunc i64 %0 to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !82, metadata !DIExpression()), !dbg !100
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !115

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !77
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !89, metadata !DIExpression()), !dbg !115

  //   %conv4 = trunc i64 %1 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !86, metadata !DIExpression()), !dbg !100

  //   %cmp = icmp eq i32 %conv, 2, !dbg !79

  //   %conv5 = zext i1 %cmp to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !90, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !91, metadata !DIExpression()), !dbg !119

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !93, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %2, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !81
  // ST: Guess
  ...
  //   %cmp9 = icmp eq i32 %conv4, 0, !dbg !82

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !94, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !95, metadata !DIExpression()), !dbg !122

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !97, metadata !DIExpression()), !dbg !122

  //   store atomic i64 %3, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !84
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !132, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !133, metadata !DIExpression()), !dbg !183

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !134, metadata !DIExpression()), !dbg !185

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !138, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !139, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64 0, metadata !141, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !142, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !148, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !151, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64 0, metadata !153, metadata !DIExpression()), !dbg !196

  //   store atomic i64 0, i64* @atom_1_X2_2 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !154, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !198

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !160, metadata !DIExpression()), !dbg !210

  //   %conv = trunc i64 %4 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !157, metadata !DIExpression()), !dbg !183

  //   %cmp = icmp eq i32 %conv, 1, !dbg !123

  //   %conv14 = zext i1 %cmp to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !161, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !163, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !165, metadata !DIExpression()), !dbg !214

  //   %conv18 = trunc i64 %5 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !162, metadata !DIExpression()), !dbg !183

  //   %cmp19 = icmp eq i32 %conv18, 2, !dbg !127

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !166, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !168, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !170, metadata !DIExpression()), !dbg !218

  //   %conv24 = trunc i64 %6 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !167, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !172, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !174, metadata !DIExpression()), !dbg !221

  //   %conv28 = trunc i64 %7 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !171, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !176, metadata !DIExpression()), !dbg !224

  //   %8 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !178, metadata !DIExpression()), !dbg !224

  //   %conv32 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !175, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !180, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !181, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !182, metadata !DIExpression()), !dbg !183
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !144
