...
T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !106), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !94, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !96, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !98, metadata !DIExpression()), !dbg !124

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !100, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !101, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !102, metadata !DIExpression()), !dbg !127

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !104, metadata !DIExpression()), !dbg !127
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !154, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !157, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !160, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !168, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !172, metadata !DIExpression()), !dbg !215
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
