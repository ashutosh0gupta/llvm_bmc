...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_0, metadata !69, metadata !DIExpression()), !dbg !96

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !71, metadata !DIExpression()), !dbg !96

  //   store atomic i64 %5, i64* @atom_0_X3_0 seq_cst, align 8, !dbg !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_0, metadata !152, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !202

  //   store atomic i64 0, i64* @atom_0_X3_0 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_0, metadata !177, metadata !DIExpression()), !dbg !230

  //   %8 = load atomic i64, i64* @atom_0_X3_0 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,4);
