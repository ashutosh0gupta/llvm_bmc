...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !222, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !223, metadata !DIExpression()), !dbg !268

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !224, metadata !DIExpression()), !dbg !270

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !228, metadata !DIExpression()), !dbg !272

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !229, metadata !DIExpression()), !dbg !274

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !230, metadata !DIExpression()), !dbg !276

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !231, metadata !DIExpression()), !dbg !278

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !232, metadata !DIExpression()), !dbg !280

  //   %6 = bitcast i64* %thr6 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %6) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr6, metadata !233, metadata !DIExpression()), !dbg !282

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 6), metadata !234, metadata !DIExpression()), !dbg !283

  //   call void @llvm.dbg.value(metadata i64 0, metadata !236, metadata !DIExpression()), !dbg !283

  //   store atomic i64 0, i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 6) monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 5), metadata !237, metadata !DIExpression()), !dbg !285

  //   call void @llvm.dbg.value(metadata i64 0, metadata !239, metadata !DIExpression()), !dbg !285

  //   store atomic i64 0, i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 4), metadata !240, metadata !DIExpression()), !dbg !287

  //   call void @llvm.dbg.value(metadata i64 0, metadata !242, metadata !DIExpression()), !dbg !287

  //   store atomic i64 0, i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 3), metadata !243, metadata !DIExpression()), !dbg !289

  //   call void @llvm.dbg.value(metadata i64 0, metadata !245, metadata !DIExpression()), !dbg !289

  //   store atomic i64 0, i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 2), metadata !246, metadata !DIExpression()), !dbg !291

  //   call void @llvm.dbg.value(metadata i64 0, metadata !248, metadata !DIExpression()), !dbg !291

  //   store atomic i64 0, i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 1), metadata !249, metadata !DIExpression()), !dbg !293

  //   call void @llvm.dbg.value(metadata i64 0, metadata !251, metadata !DIExpression()), !dbg !293

  //   store atomic i64 0, i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 0), metadata !252, metadata !DIExpression()), !dbg !295

  //   call void @llvm.dbg.value(metadata i64 0, metadata !254, metadata !DIExpression()), !dbg !295

  //   store atomic i64 0, i64* getelementptr inbounds ([7 x i64], [7 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !124
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X0_1, align 4, !dbg !125, !tbaa !126
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l107_c15
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l107_c15
  // Check
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !130, !tbaa !126
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l108_c15
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l108_c15
  // Check
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !131, !tbaa !126
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l109_c15
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l109_c15
  // Check
  ...
  //   store i32 0, i32* @atom_3_X0_1, align 4, !dbg !132, !tbaa !126
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l110_c15
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l110_c15
  // Check
  ...
  //   store i32 0, i32* @atom_4_X0_1, align 4, !dbg !133, !tbaa !126
  // ST: Guess
  iw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l111_c15
  old_cw = cw(0,11);
  cw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l111_c15
  // Check
  ...
  //   store i32 0, i32* @atom_5_X0_1, align 4, !dbg !134, !tbaa !126
  // ST: Guess
  iw(0,12) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l112_c15
  old_cw = cw(0,12);
  cw(0,12) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l112_c15
  // Check
  ...
  //   store i32 0, i32* @atom_6_X0_1, align 4, !dbg !135, !tbaa !126
  // ST: Guess
  iw(0,13) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l113_c15
  old_cw = cw(0,13);
  cw(0,13) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l113_c15
  // Check
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !137
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !138
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !139
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #7, !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr5, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t5, i8* noundef null) #7, !dbg !141
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_create(i64* noundef %thr6, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t6, i8* noundef null) #7, !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr0, align 8, !dbg !143, !tbaa !144
  r8 = local_mem[0];

  //   %call19 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !146
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load i64, i64* %thr1, align 8, !dbg !147, !tbaa !144
  r9 = local_mem[1];

  //   %call20 = call i32 @pthread_join(i64 noundef %8, i8** noundef null), !dbg !148
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %9 = load i64, i64* %thr2, align 8, !dbg !149, !tbaa !144
  r10 = local_mem[2];

  //   %call21 = call i32 @pthread_join(i64 noundef %9, i8** noundef null), !dbg !150
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %10 = load i64, i64* %thr3, align 8, !dbg !151, !tbaa !144
  r11 = local_mem[3];

  //   %call22 = call i32 @pthread_join(i64 noundef %10, i8** noundef null), !dbg !152
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %11 = load i64, i64* %thr4, align 8, !dbg !153, !tbaa !144
  r12 = local_mem[4];

  //   %call23 = call i32 @pthread_join(i64 noundef %11, i8** noundef null), !dbg !154
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %12 = load i64, i64* %thr5, align 8, !dbg !155, !tbaa !144
  r13 = local_mem[5];

  //   %call24 = call i32 @pthread_join(i64 noundef %12, i8** noundef null), !dbg !156
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %13 = load i64, i64* %thr6, align 8, !dbg !157, !tbaa !144
  r14 = local_mem[6];

  //   %call25 = call i32 @pthread_join(i64 noundef %13, i8** noundef null), !dbg !158
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %14 = load i32, i32* @atom_0_X0_1, align 4, !dbg !159, !tbaa !126
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !255, metadata !DIExpression()), !dbg !268

  //   %15 = load i32, i32* @atom_1_X0_1, align 4, !dbg !160, !tbaa !126
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !256, metadata !DIExpression()), !dbg !268

  //   %16 = load i32, i32* @atom_2_X0_1, align 4, !dbg !161, !tbaa !126
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !257, metadata !DIExpression()), !dbg !268

  //   %17 = load i32, i32* @atom_3_X0_1, align 4, !dbg !162, !tbaa !126
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !258, metadata !DIExpression()), !dbg !268

  //   %18 = load i32, i32* @atom_4_X0_1, align 4, !dbg !163, !tbaa !126
  // LD: Guess
  old_cr = cr(0,11);
  ...
  //   call void @llvm.dbg.value(metadata i32 %18, metadata !259, metadata !DIExpression()), !dbg !268

  //   %19 = load i32, i32* @atom_5_X0_1, align 4, !dbg !164, !tbaa !126
  // LD: Guess
  old_cr = cr(0,12);
  ...
  //   call void @llvm.dbg.value(metadata i32 %19, metadata !260, metadata !DIExpression()), !dbg !268

  //   %20 = load i32, i32* @atom_6_X0_1, align 4, !dbg !165, !tbaa !126
  // LD: Guess
  old_cr = cr(0,13);
  ...
  //   call void @llvm.dbg.value(metadata i32 %20, metadata !261, metadata !DIExpression()), !dbg !268

  //   %and = and i32 %19, %20, !dbg !166
  creg_r22 = max(creg_r20,creg_r21);
  r22 = r20 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !262, metadata !DIExpression()), !dbg !268

  //   %and26 = and i32 %18, %and, !dbg !167
  creg_r23 = max(creg_r19,creg_r22);
  r23 = r19 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !263, metadata !DIExpression()), !dbg !268

  //   %and27 = and i32 %17, %and26, !dbg !168
  creg_r24 = max(creg_r18,creg_r23);
  r24 = r18 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !264, metadata !DIExpression()), !dbg !268

  //   %and28 = and i32 %16, %and27, !dbg !169
  creg_r25 = max(creg_r17,creg_r24);
  r25 = r17 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !265, metadata !DIExpression()), !dbg !268

  //   %and29 = and i32 %15, %and28, !dbg !170
  creg_r26 = max(creg_r16,creg_r25);
  r26 = r16 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !266, metadata !DIExpression()), !dbg !268

  //   %and30 = and i32 %14, %and29, !dbg !171
  creg_r27 = max(creg_r15,creg_r26);
  r27 = r15 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !267, metadata !DIExpression()), !dbg !268

  //   %cmp = icmp eq i32 %and30, 1, !dbg !172
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 144, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !175
...
T0BLOCK2:
  //   %21 = bitcast i64* %thr6 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %21) #7, !dbg !178

  //   %22 = bitcast i64* %thr5 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %22) #7, !dbg !178

  //   %23 = bitcast i64* %thr4 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %23) #7, !dbg !178

  //   %24 = bitcast i64* %thr3 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %24) #7, !dbg !178

  //   %25 = bitcast i64* %thr2 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %25) #7, !dbg !178

  //   %26 = bitcast i64* %thr1 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %26) #7, !dbg !178

  //   %27 = bitcast i64* %thr0 to i8*, !dbg !178

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %27) #7, !dbg !178
