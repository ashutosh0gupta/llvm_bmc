...
T1BLOCK1:
  ...
  //   store i32 %conv1, i32* @atom_0_X0_1, align 4, !dbg !54, !tbaa !55
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !67, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !68, metadata !DIExpression()), !dbg !77

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !49

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !49

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !69, metadata !DIExpression()), !dbg !79

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64 0, metadata !75, metadata !DIExpression()), !dbg !80

  //   store atomic i64 0, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !52
  // ST: Guess
  iw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l29_c3
  old_cw = cw(0,0);
  cw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l29_c3
  // Check
  ...
  //   store i32 0, i32* @atom_0_X0_1, align 4, !dbg !53, !tbaa !54
  // ST: Guess
  iw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l30_c15
  old_cw = cw(0,1);
  cw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l30_c15
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !58
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %1 = load i64, i64* %thr0, align 8, !dbg !59, !tbaa !60
  r2 = local_mem[0];

  //   %call1 = call i32 @pthread_join(i64 noundef %1, i8** noundef null), !dbg !62
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i32, i32* @atom_0_X0_1, align 4, !dbg !63, !tbaa !54
  // LD: Guess
  old_cr = cr(0,1);
  cr(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l36_c12
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 37, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !67
...
T0BLOCK2:
  //   %3 = bitcast i64* %thr0 to i8*, !dbg !70

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %3) #7, !dbg !70
