...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !53, metadata !DIExpression()), !dbg !70
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !56, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !58, metadata !DIExpression()), !dbg !73

  //   %conv = trunc i64 %0 to i32, !dbg !56

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !54, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !59, metadata !DIExpression()), !dbg !76

  //   call void @llvm.dbg.value(metadata i64 1, metadata !61, metadata !DIExpression()), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !62, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64 2, metadata !64, metadata !DIExpression()), !dbg !78
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !91, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !92, metadata !DIExpression()), !dbg !117

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !93, metadata !DIExpression()), !dbg !119

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !97, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !98, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i64 0, metadata !100, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !103, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !104, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64 0, metadata !106, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !108, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !110, metadata !DIExpression()), !dbg !138

  //   %conv = trunc i64 %4 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !107, metadata !DIExpression()), !dbg !117

  //   %cmp = icmp eq i32 %conv, 3, !dbg !88

  //   %conv8 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !111, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !113, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !115, metadata !DIExpression()), !dbg !142

  //   %conv12 = trunc i64 %5 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !112, metadata !DIExpression()), !dbg !117
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 53, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !96
