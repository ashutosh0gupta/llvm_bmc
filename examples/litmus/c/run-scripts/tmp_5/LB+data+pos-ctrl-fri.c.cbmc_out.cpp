...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !144, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !145, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !149, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !150, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !155, metadata !DIExpression()), !dbg !159

  //   %and14 = and i32 %6, %and13, !dbg !115
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !156, metadata !DIExpression()), !dbg !159

  //   %and15 = and i32 %conv12, %and14, !dbg !116
  creg_r18 = max(creg__r10__1_,creg_r17);
  r18 = (r10==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !157, metadata !DIExpression()), !dbg !159
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
