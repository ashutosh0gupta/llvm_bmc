...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !67, metadata !DIExpression()), !dbg !81
  ...
  //   %cmp17 = icmp eq i32 %conv11, 0, !dbg !96
  ...
  //   store i32 %conv18, i32* @atom_1_X4_0, align 4, !dbg !97, !tbaa !92
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv15, 1, !dbg !98
  ...
  //   store i32 %conv20, i32* @atom_1_X6_1, align 4, !dbg !99, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X4_0, align 4, !dbg !94, !tbaa !90
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X6_1, align 4, !dbg !95, !tbaa !90
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X4_0, align 4, !dbg !116, !tbaa !90
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_1_X6_1, align 4, !dbg !117, !tbaa !90
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 84, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !125
