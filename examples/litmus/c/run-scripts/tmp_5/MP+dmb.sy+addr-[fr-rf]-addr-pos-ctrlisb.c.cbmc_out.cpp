...
T2BLOCK4:
  ...
  //   store i32 %conv27, i32* @atom_1_X3_0, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   store i32 %conv29, i32* @atom_1_X5_1, align 4, !dbg !113, !tbaa !106
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 96, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !148
