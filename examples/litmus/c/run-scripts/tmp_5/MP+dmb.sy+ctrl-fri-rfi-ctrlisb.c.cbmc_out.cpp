...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !168, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !227

  //   store atomic i64 0, i64* @atom_1_X2_0 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !197, metadata !DIExpression()), !dbg !258

  //   %8 = load atomic i64, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !154
  // LD: Guess
  old_cr = cr(0,4);
