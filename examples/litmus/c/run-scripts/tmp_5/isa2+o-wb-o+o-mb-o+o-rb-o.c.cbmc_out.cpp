...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 4, metadata !45, metadata !DIExpression()), !dbg !53

  //   store atomic i64 4, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !54
  // ST: Guess
...
T2BLOCK1:
  ...
  //   store i32 %conv1, i32* @atom_1_X0_4, align 4, !dbg !59, !tbaa !60
  // ST: Guess
...
T3BLOCK1:
  ...
  //   %cmp6 = icmp eq i32 %conv4, 1, !dbg !67
  ...
  //   store i32 %conv7, i32* @atom_2_X2_1, align 4, !dbg !68, !tbaa !63
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !133, metadata !DIExpression()), !dbg !151

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !74
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !136, metadata !DIExpression()), !dbg !153
  ...
  //   store i32 0, i32* @atom_1_X0_4, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_2_X2_1, align 4, !dbg !83, !tbaa !78
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_1_X0_4, align 4, !dbg !95, !tbaa !78
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_2_X2_1, align 4, !dbg !97, !tbaa !78
  // LD: Guess
  old_cr = cr(0,5);
