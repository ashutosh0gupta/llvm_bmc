...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !125, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !126, metadata !DIExpression()), !dbg !159

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !127, metadata !DIExpression()), !dbg !161

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !131, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !132, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64 0, metadata !134, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !135, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !141, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !145, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !147, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !148, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !150, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !152, metadata !DIExpression()), !dbg !186

  //   %conv14 = trunc i64 %5 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !149, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !153, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !157, metadata !DIExpression()), !dbg !159

  //   %and18 = and i32 %conv10, %and17, !dbg !113
  creg_r13 = max(creg__r7__2_,creg_r12);
  r13 = (r7==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !158, metadata !DIExpression()), !dbg !159
