...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !92, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !93, metadata !DIExpression()), !dbg !108

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !57

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !57

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !94, metadata !DIExpression()), !dbg !110

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !59

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !59

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !98, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !99, metadata !DIExpression()), !dbg !113
  ...
  //   store i32 0, i32* @atom_0_X1_0, align 4, !dbg !65, !tbaa !66
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X1_0, align 4, !dbg !70, !tbaa !66
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_0_X1_0, align 4, !dbg !79, !tbaa !66
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !105, metadata !DIExpression()), !dbg !108

  //   %5 = load i32, i32* @atom_1_X1_0, align 4, !dbg !80, !tbaa !66
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !85
