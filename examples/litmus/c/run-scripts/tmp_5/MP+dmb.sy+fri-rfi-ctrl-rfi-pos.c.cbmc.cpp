...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !134, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !135, metadata !DIExpression()), !dbg !166

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !136, metadata !DIExpression()), !dbg !168

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !140, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !141, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !144, metadata !DIExpression()), !dbg !173
  ...
  //   store i32 0, i32* @atom_1_X6_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X7_1, align 4, !dbg !92, !tbaa !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !151, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !152, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !156, metadata !DIExpression()), !dbg !166
  ...
  //   %8 = load i32, i32* @atom_1_X6_1, align 4, !dbg !111, !tbaa !86
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X7_1, align 4, !dbg !112, !tbaa !86
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !162, metadata !DIExpression()), !dbg !166

  //   %and14 = and i32 %6, %and13, !dbg !115
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !163, metadata !DIExpression()), !dbg !166
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
