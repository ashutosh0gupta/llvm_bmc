...
T2BLOCK7:
  ...
  //   %cmp30 = icmp eq i32 %conv4, 1, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !90, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !177, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !226

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !180, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !228

  //   store atomic i64 0, i64* @atom_1_X11_0 monotonic, align 8, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !198, metadata !DIExpression()), !dbg !251

  //   %7 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !202, metadata !DIExpression()), !dbg !254

  //   %8 = load atomic i64, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,7);
