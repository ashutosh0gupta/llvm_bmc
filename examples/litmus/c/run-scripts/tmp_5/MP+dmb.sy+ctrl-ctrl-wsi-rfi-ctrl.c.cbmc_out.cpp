...
T2BLOCK7:
  ...
  //   %tobool14 = icmp ne i32 %conv13, 0, !dbg !106

  //   br i1 %tobool14, label %if.then15, label %if.else16, !dbg !108
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !96), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !90, metadata !DIExpression()), !dbg !141

  //   %6 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %6, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !123
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !173, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !199, metadata !DIExpression()), !dbg !255
