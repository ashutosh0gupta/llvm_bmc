...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X2_0, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X3_1, align 4, !dbg !95, !tbaa !90
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_0, align 4, !dbg !96, !tbaa !90
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X2_0, align 4, !dbg !114, !tbaa !90
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %8 = load i32, i32* @atom_1_X3_1, align 4, !dbg !116, !tbaa !90
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X4_0, align 4, !dbg !117, !tbaa !90
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 84, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
