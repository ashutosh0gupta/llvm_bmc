...
T2BLOCK4:
  ...
  //   %add11 = add nsw i32 0, %xor9, !dbg !90
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !90

  //   %arrayidx13 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !90
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !74, metadata !DIExpression()), !dbg !110

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   %conv16 = trunc i64 %3 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !73, metadata !DIExpression()), !dbg !89
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   store i32 %conv23, i32* @atom_1_X8_0, align 4, !dbg !105, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X8_0, align 4, !dbg !96, !tbaa !92
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X8_0, align 4, !dbg !115, !tbaa !92
  // LD: Guess
  old_cr = cr(0,5);
