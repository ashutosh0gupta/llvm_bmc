...
T2BLOCK4:
  ...
  //   %tobool7 = icmp ne i32 %conv6, 0, !dbg !82
  creg__r2__0_ = max(0,creg_r2);

  //   br i1 %tobool7, label %if.then8, label %if.else9, !dbg !84
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   store i32 %conv14, i32* @atom_1_X3_2, align 4, !dbg !93, !tbaa !94
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv13, 0, !dbg !98
  ...
  //   store i32 %conv16, i32* @atom_1_X6_0, align 4, !dbg !99, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X3_2, align 4, !dbg !91, !tbaa !87
  // ST: Guess
  ...
  //   %call5 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !94
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !151, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !152, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !154, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !156, metadata !DIExpression()), !dbg !191

  //   %conv12 = trunc i64 %5 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !153, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !157, metadata !DIExpression()), !dbg !165
  ...
  //   %7 = load i32, i32* @atom_1_X3_2, align 4, !dbg !110, !tbaa !87
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !162, metadata !DIExpression()), !dbg !165

  //   %and16 = and i32 %conv14, %and15, !dbg !114
  creg_r14 = max(creg__r8__2_,creg_r13);
  r14 = (r8==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !163, metadata !DIExpression()), !dbg !165

  //   %and17 = and i32 %conv8, %and16, !dbg !115
  creg_r15 = max(creg__r7__1_,creg_r14);
  r15 = (r7==1) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !164, metadata !DIExpression()), !dbg !165
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !119
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #6, !dbg !122

  //   %10 = bitcast i64* %thr0 to i8*, !dbg !122

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #6, !dbg !122
