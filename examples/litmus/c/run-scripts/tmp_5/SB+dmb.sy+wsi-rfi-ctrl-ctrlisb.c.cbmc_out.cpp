...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !67, metadata !DIExpression()), !dbg !97
...
T2BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !77, metadata !DIExpression()), !dbg !104

  //   %conv = trunc i64 %0 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !74, metadata !DIExpression()), !dbg !97
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !79, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !81, metadata !DIExpression()), !dbg !113

  //   %conv6 = trunc i64 %1 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !78, metadata !DIExpression()), !dbg !97
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !82, metadata !DIExpression()), !dbg !97

  //   %cmp = icmp eq i32 %conv, 2, !dbg !98

  //   %conv14 = zext i1 %cmp to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !86, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !87, metadata !DIExpression()), !dbg !127

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !89, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %3, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !100
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv13, 0, !dbg !101

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !90, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !91, metadata !DIExpression()), !dbg !130

  //   %4 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !93, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %4, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !156, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !176, metadata !DIExpression()), !dbg !226
