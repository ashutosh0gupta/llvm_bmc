...
T2BLOCK13:
  ...
  //   store i32 %conv28, i32* @atom_1_X6_1, align 4, !dbg !123, !tbaa !118
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !160, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !163, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !166, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !172, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !176, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !178, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !179, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !183, metadata !DIExpression()), !dbg !228

  //   %conv16 = trunc i64 %5 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !180, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !184, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !188, metadata !DIExpression()), !dbg !232

  //   %conv22 = trunc i64 %6 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !185, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !189, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !194, metadata !DIExpression()), !dbg !198

  //   %and26 = and i32 %conv24, %and25, !dbg !134
  creg_r16 = max(creg__r10__1_,creg_r15);
  r16 = (r10==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !195, metadata !DIExpression()), !dbg !198

  //   %and27 = and i32 %conv18, %and26, !dbg !135
  creg_r17 = max(creg__r9__1_,creg_r16);
  r17 = (r9==1) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !196, metadata !DIExpression()), !dbg !198

  //   %and28 = and i32 %conv12, %and27, !dbg !136
  creg_r18 = max(creg__r8__1_,creg_r17);
  r18 = (r8==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !197, metadata !DIExpression()), !dbg !198
