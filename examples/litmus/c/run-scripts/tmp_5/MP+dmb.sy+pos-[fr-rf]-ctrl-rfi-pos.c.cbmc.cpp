...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv8, 0, !dbg !101
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !126

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv12, 1, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !99, metadata !DIExpression()), !dbg !144

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %8, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !126
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !193, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !222, metadata !DIExpression()), !dbg !286
