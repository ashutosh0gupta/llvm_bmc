...
T2BLOCK4:
  ...
  //   store i32 %conv5, i32* @atom_1_X2_1, align 4, !dbg !74, !tbaa !75
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !113, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !114, metadata !DIExpression()), !dbg !143

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !115, metadata !DIExpression()), !dbg !145

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !119, metadata !DIExpression()), !dbg !147
  ...
  //   %call3 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !89
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !129, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !130, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !134, metadata !DIExpression()), !dbg !167

  //   %conv10 = trunc i64 %5 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !131, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !136, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !137, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !138, metadata !DIExpression()), !dbg !143

  //   %and = and i32 %7, %8, !dbg !107
  creg_r11 = max(creg_r10,creg_r9);
  r11 = r9 & r10;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !139, metadata !DIExpression()), !dbg !143

  //   %and13 = and i32 %6, %and, !dbg !108
  creg_r12 = max(creg_r11,creg_r8);
  r12 = r8 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !140, metadata !DIExpression()), !dbg !143

  //   %and14 = and i32 %conv12, %and13, !dbg !109
  creg_r13 = max(creg__r7__1_,creg_r12);
  r13 = (r7==1) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !141, metadata !DIExpression()), !dbg !143
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !114
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #6, !dbg !117

  //   %10 = bitcast i64* %thr0 to i8*, !dbg !117

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #6, !dbg !117
