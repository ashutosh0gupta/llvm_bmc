...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !94
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !79, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !80, metadata !DIExpression()), !dbg !108

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !82, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %2, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !83, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !84, metadata !DIExpression()), !dbg !111
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !121, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !122, metadata !DIExpression()), !dbg !169

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !123, metadata !DIExpression()), !dbg !171

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !127, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !128, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !131, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !134, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !137, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !140, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !144, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !146, metadata !DIExpression()), !dbg !194

  //   %conv = trunc i64 %4 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !143, metadata !DIExpression()), !dbg !169

  //   %cmp = icmp eq i32 %conv, 1, !dbg !118

  //   %conv12 = zext i1 %cmp to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !147, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !151, metadata !DIExpression()), !dbg !198

  //   %conv16 = trunc i64 %5 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !148, metadata !DIExpression()), !dbg !169

  //   %cmp17 = icmp eq i32 %conv16, 1, !dbg !122

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !152, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !154, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !156, metadata !DIExpression()), !dbg !202

  //   %conv22 = trunc i64 %6 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !153, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !158, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !160, metadata !DIExpression()), !dbg !205

  //   %conv26 = trunc i64 %7 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !157, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !162, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !164, metadata !DIExpression()), !dbg !208

  //   %conv30 = trunc i64 %8 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !161, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !166, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !167, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !168, metadata !DIExpression()), !dbg !169
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !139
