...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !105, metadata !DIExpression()), !dbg !132

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !106, metadata !DIExpression()), !dbg !132

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !107, metadata !DIExpression()), !dbg !134

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !68

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !68

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !111, metadata !DIExpression()), !dbg !136

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !112, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !120, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !122, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !123, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !127, metadata !DIExpression()), !dbg !159

  //   %conv12 = trunc i64 %7 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !124, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !128, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !131, metadata !DIExpression()), !dbg !132
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !106
