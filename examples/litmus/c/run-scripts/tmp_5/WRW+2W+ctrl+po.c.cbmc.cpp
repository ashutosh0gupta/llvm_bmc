...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !95
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !105, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !106, metadata !DIExpression()), !dbg !138

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !107, metadata !DIExpression()), !dbg !140

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !111, metadata !DIExpression()), !dbg !142

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !112, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !113, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !116, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !119, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !123, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !125, metadata !DIExpression()), !dbg !164

  //   %conv = trunc i64 %6 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !122, metadata !DIExpression()), !dbg !138

  //   %cmp = icmp eq i32 %conv, 2, !dbg !100

  //   %conv10 = zext i1 %cmp to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !126, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !128, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !130, metadata !DIExpression()), !dbg !168

  //   %conv14 = trunc i64 %7 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !127, metadata !DIExpression()), !dbg !138

  //   %cmp15 = icmp eq i32 %conv14, 2, !dbg !104

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !131, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !133, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !135, metadata !DIExpression()), !dbg !172

  //   %conv20 = trunc i64 %8 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !132, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !137, metadata !DIExpression()), !dbg !138
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !113
