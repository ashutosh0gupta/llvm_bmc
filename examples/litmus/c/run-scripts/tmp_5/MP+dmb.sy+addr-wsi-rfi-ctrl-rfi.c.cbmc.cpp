...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv6, 0, !dbg !81
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !80, metadata !DIExpression()), !dbg !108
  ...
  //   %cmp14 = icmp eq i32 %conv6, 2, !dbg !98
  ...
  //   store i32 %conv15, i32* @atom_1_X6_2, align 4, !dbg !99, !tbaa !94
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv12, 1, !dbg !100
  ...
  //   store i32 %conv17, i32* @atom_1_X9_1, align 4, !dbg !101, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !129, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !130, metadata !DIExpression()), !dbg !168

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !131, metadata !DIExpression()), !dbg !170

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !135, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !136, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !139, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !148, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !149, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !153, metadata !DIExpression()), !dbg !194

  //   %conv12 = trunc i64 %5 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !150, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !154, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !158, metadata !DIExpression()), !dbg !198

  //   %conv18 = trunc i64 %6 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !155, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !159, metadata !DIExpression()), !dbg !168
