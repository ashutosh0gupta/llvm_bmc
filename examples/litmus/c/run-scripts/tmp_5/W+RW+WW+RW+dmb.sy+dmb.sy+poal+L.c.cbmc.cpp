...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !84, metadata !DIExpression()), !dbg !92
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !99, metadata !DIExpression()), !dbg !110

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !51
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+2*1);
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !54
  // ST: Guess
  //   : Release
  ...
  //   store i32 %conv1, i32* @atom_3_X0_1, align 4, !dbg !56, !tbaa !57
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_3_X0_1, align 4, !dbg !93, !tbaa !89
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_3_X0_1, align 4, !dbg !117, !tbaa !89
  // LD: Guess
  old_cr = cr(0,4);
