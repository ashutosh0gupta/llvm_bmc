...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !142, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !145, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !151, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !157, metadata !DIExpression()), !dbg !210

  //   %conv = trunc i64 %4 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !154, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !158, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !162, metadata !DIExpression()), !dbg !214

  //   %conv14 = trunc i64 %5 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !159, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !163, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !165, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !167, metadata !DIExpression()), !dbg !218

  //   %conv20 = trunc i64 %6 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !164, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !168, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !172, metadata !DIExpression()), !dbg !222

  //   %conv26 = trunc i64 %7 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !169, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !178, metadata !DIExpression()), !dbg !185

  //   %and29 = and i32 %9, %and, !dbg !144
  creg_r24 = max(creg_r20,creg_r23);
  r24 = r20 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !179, metadata !DIExpression()), !dbg !185

  //   %and30 = and i32 %8, %and29, !dbg !145
  creg_r25 = max(creg_r19,creg_r24);
  r25 = r19 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !180, metadata !DIExpression()), !dbg !185

  //   %and31 = and i32 %conv28, %and30, !dbg !146
  creg_r26 = max(creg__r18__1_,creg_r25);
  r26 = (r18==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !181, metadata !DIExpression()), !dbg !185

  //   %and32 = and i32 %conv22, %and31, !dbg !147
  creg_r27 = max(creg__r17__1_,creg_r26);
  r27 = (r17==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !182, metadata !DIExpression()), !dbg !185

  //   %and33 = and i32 %conv16, %and32, !dbg !148
  creg_r28 = max(creg__r16__1_,creg_r27);
  r28 = (r16==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !183, metadata !DIExpression()), !dbg !185

  //   %and34 = and i32 %conv10, %and33, !dbg !149
  creg_r29 = max(creg__r15__1_,creg_r28);
  r29 = (r15==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !184, metadata !DIExpression()), !dbg !185
