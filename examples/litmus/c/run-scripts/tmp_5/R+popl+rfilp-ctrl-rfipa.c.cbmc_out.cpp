...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !73, metadata !DIExpression()), !dbg !106
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !74, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !80, metadata !DIExpression()), !dbg !111

  //   %conv = trunc i64 %0 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !77, metadata !DIExpression()), !dbg !106
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64 1, metadata !83, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !122

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !91
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !87, metadata !DIExpression()), !dbg !122

  //   %conv6 = trunc i64 %1 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !84, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !91, metadata !DIExpression()), !dbg !125

  //   %conv10 = trunc i64 %2 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !88, metadata !DIExpression()), !dbg !106

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !96

  //   %conv11 = zext i1 %cmp to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !92, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !93, metadata !DIExpression()), !dbg !129

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !95, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %3, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !98
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv, 2, !dbg !99

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !96, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !97, metadata !DIExpression()), !dbg !132

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !99, metadata !DIExpression()), !dbg !132
  ...
  //   %cmp20 = icmp eq i32 %conv6, 1, !dbg !102

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !100, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !101, metadata !DIExpression()), !dbg !135

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !103, metadata !DIExpression()), !dbg !135
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !158, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !161, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !167, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !181, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !185, metadata !DIExpression()), !dbg !239
