...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !57, metadata !DIExpression()), !dbg !71
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !63, metadata !DIExpression()), !dbg !65

  //   store i32 %conv3, i32* @atom_1_X0_1, align 4, !dbg !64, !tbaa !65
  // ST: Guess
