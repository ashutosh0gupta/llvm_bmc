...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !85, metadata !DIExpression()), !dbg !104
  ...
  //   store i32 %conv11, i32* @atom_1_X2_1, align 4, !dbg !84, !tbaa !79
  // ST: Guess
  ...
  //   store i32 %conv13, i32* @atom_1_X4_0, align 4, !dbg !86, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !129, metadata !DIExpression()), !dbg !159
  ...
  //   store i32 0, i32* @atom_0_X0_1, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !90, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X2_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !139, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !140, metadata !DIExpression()), !dbg !154
  ...
  //   %6 = load i32, i32* @atom_0_X0_1, align 4, !dbg !109, !tbaa !86
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !145, metadata !DIExpression()), !dbg !154

  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !110, !tbaa !86
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !146, metadata !DIExpression()), !dbg !154

  //   %8 = load i32, i32* @atom_1_X2_1, align 4, !dbg !111, !tbaa !86
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !149, metadata !DIExpression()), !dbg !154

  //   %and13 = and i32 %7, %and, !dbg !114
  creg_r19 = max(creg_r15,creg_r18);
  r19 = r15 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !150, metadata !DIExpression()), !dbg !154

  //   %and14 = and i32 %6, %and13, !dbg !115
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !151, metadata !DIExpression()), !dbg !154
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
