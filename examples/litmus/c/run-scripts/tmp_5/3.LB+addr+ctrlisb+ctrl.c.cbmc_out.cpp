...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !103, metadata !DIExpression()), !dbg !117
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !107, metadata !DIExpression()), !dbg !120

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !104, metadata !DIExpression()), !dbg !117
...
T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !116), !dbg !128

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !108, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !111, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !112, metadata !DIExpression()), !dbg !132
