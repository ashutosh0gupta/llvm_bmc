...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !45, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !51, metadata !DIExpression()), !dbg !70

  //   %conv = trunc i64 %0 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !48, metadata !DIExpression()), !dbg !63
...
T1BLOCK4:
  ...
  //   %cmp10 = icmp eq i32 %conv, 1, !dbg !90
  ...
  //   store i32 %conv11, i32* @atom_0_X4_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !133, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !134, metadata !DIExpression()), !dbg !165

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !135, metadata !DIExpression()), !dbg !167

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !139, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !140, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !143, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !147, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !150, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !152, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !151, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !155, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !156, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !161, metadata !DIExpression()), !dbg !165

  //   %and14 = and i32 %6, %and13, !dbg !115
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !162, metadata !DIExpression()), !dbg !165

  //   %and15 = and i32 %conv12, %and14, !dbg !116
  creg_r16 = max(creg__r8__1_,creg_r15);
  r16 = (r8==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !163, metadata !DIExpression()), !dbg !165

  //   %and16 = and i32 %conv6, %and15, !dbg !117
  creg_r17 = max(creg__r7__3_,creg_r16);
  r17 = (r7==3) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !164, metadata !DIExpression()), !dbg !165
