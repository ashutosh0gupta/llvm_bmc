...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !114

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !79, metadata !DIExpression()), !dbg !114

  //   %conv9 = trunc i64 %2 to i32, !dbg !97
  ...
  //   %cmp21 = icmp eq i32 %conv9, 0, !dbg !112
  ...
  //   store i32 %conv22, i32* @atom_1_X5_0, align 4, !dbg !113, !tbaa !106
  // ST: Guess
  ...
  //   store i32 %conv24, i32* @atom_1_X7_0, align 4, !dbg !115, !tbaa !106
  // ST: Guess
