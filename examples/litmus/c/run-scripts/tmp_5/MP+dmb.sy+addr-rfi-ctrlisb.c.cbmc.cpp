...
T2BLOCK4:
  ...
  //   store i32 %conv11, i32* @atom_1_X5_1, align 4, !dbg !90, !tbaa !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !120, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !121, metadata !DIExpression()), !dbg !159

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !122, metadata !DIExpression()), !dbg !161

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !126, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !137, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !139, metadata !DIExpression()), !dbg !181

  //   %conv = trunc i64 %4 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !136, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !140, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !142, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !144, metadata !DIExpression()), !dbg !185

  //   %conv12 = trunc i64 %5 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !141, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !145, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !147, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !149, metadata !DIExpression()), !dbg !189

  //   %conv18 = trunc i64 %6 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !146, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !150, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !151, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !152, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !154, metadata !DIExpression()), !dbg !159

  //   %and21 = and i32 %7, %and, !dbg !123
  creg_r16 = max(creg_r12,creg_r15);
  r16 = r12 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !155, metadata !DIExpression()), !dbg !159

  //   %and22 = and i32 %conv20, %and21, !dbg !124
  creg_r17 = max(creg__r11__1_,creg_r16);
  r17 = (r11==1) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !156, metadata !DIExpression()), !dbg !159

  //   %and23 = and i32 %conv14, %and22, !dbg !125
  creg_r18 = max(creg__r10__1_,creg_r17);
  r18 = (r10==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !157, metadata !DIExpression()), !dbg !159

  //   %and24 = and i32 %conv8, %and23, !dbg !126
  creg_r19 = max(creg__r9__1_,creg_r18);
  r19 = (r9==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !158, metadata !DIExpression()), !dbg !159
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !130
