...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X5_0, align 4, !dbg !91, !tbaa !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !140, metadata !DIExpression()), !dbg !177
  ...
  //   %7 = load i32, i32* @atom_0_X5_0, align 4, !dbg !110, !tbaa !87
  // LD: Guess
  old_cr = cr(0,4);
