...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !59, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !60, metadata !DIExpression()), !dbg !73
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !88, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !89, metadata !DIExpression()), !dbg !108

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !59

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !59

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !90, metadata !DIExpression()), !dbg !110

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !61

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !61

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !94, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !97, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !102, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !104, metadata !DIExpression()), !dbg !126

  //   %conv = trunc i64 %4 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !101, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !105, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !106, metadata !DIExpression()), !dbg !108

  //   %and = and i32 %conv6, %5, !dbg !85
  creg_r9 = max(creg__r7__2_,creg_r8);
  r9 = (r7==2) & r8;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !107, metadata !DIExpression()), !dbg !108
