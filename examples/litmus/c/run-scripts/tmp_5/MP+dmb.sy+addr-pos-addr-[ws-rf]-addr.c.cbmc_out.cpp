...
T2BLOCK1:
  ...
  //   %cmp26 = icmp eq i32 %conv16, 2, !dbg !99
  ...
  //   store i32 %conv27, i32* @atom_1_X9_2, align 4, !dbg !100, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X11_0, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l64_c16
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l64_c16
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l74_c13
  // Check
  ...
  //   %11 = load i32, i32* @atom_1_X11_0, align 4, !dbg !132, !tbaa !101
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !141
