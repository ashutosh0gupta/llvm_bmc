...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !133, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !134, metadata !DIExpression()), !dbg !155

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !135, metadata !DIExpression()), !dbg !157

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !139, metadata !DIExpression()), !dbg !159

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !140, metadata !DIExpression()), !dbg !161

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !141, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !142, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !166
  ...
  //   store i32 0, i32* @atom_1_X2_0, align 4, !dbg !84, !tbaa !80
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_3_X0_1, align 4, !dbg !85, !tbaa !80
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_3_X2_0, align 4, !dbg !86, !tbaa !80
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !101, !tbaa !80
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !148, metadata !DIExpression()), !dbg !155

  //   %9 = load i32, i32* @atom_1_X2_0, align 4, !dbg !102, !tbaa !80
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !149, metadata !DIExpression()), !dbg !155

  //   %10 = load i32, i32* @atom_3_X0_1, align 4, !dbg !103, !tbaa !80
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !150, metadata !DIExpression()), !dbg !155

  //   %11 = load i32, i32* @atom_3_X2_0, align 4, !dbg !104, !tbaa !80
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and10, metadata !153, metadata !DIExpression()), !dbg !155

  //   %and11 = and i32 %8, %and10, !dbg !107
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and11, metadata !154, metadata !DIExpression()), !dbg !155
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([134 x i8], [134 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
