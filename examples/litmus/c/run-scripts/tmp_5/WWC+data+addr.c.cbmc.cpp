...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !86, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !87, metadata !DIExpression()), !dbg !100
  ...
  // ST: Guess
  iw(3,r6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l39_c3
  old_cw = cw(3,r6);
  cw(3,r6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l39_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !111, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !112, metadata !DIExpression()), !dbg !134

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !113, metadata !DIExpression()), !dbg !136

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !117, metadata !DIExpression()), !dbg !138

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !68

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !68

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !118, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !119, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64 0, metadata !121, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !122, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i64 0, metadata !124, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !126, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !128, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %and9, metadata !133, metadata !DIExpression()), !dbg !134
