...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !85, metadata !DIExpression()), !dbg !123

  //   %5 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !87, metadata !DIExpression()), !dbg !123

  //   store atomic i64 %5, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !155, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !158, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !202

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !176, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !180, metadata !DIExpression()), !dbg !228
