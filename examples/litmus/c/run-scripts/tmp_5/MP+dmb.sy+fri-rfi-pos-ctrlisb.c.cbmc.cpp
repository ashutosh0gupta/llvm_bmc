...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X3_2, align 4, !dbg !90, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_2, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X5_0, align 4, !dbg !92, !tbaa !86
  // ST: Guess
  ...
  //   %call3 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !94
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !109, !tbaa !86
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %7 = load i32, i32* @atom_1_X3_2, align 4, !dbg !110, !tbaa !86
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X4_2, align 4, !dbg !111, !tbaa !86
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X5_0, align 4, !dbg !112, !tbaa !86
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !121
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #6, !dbg !124

  //   %11 = bitcast i64* %thr0 to i8*, !dbg !124

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #6, !dbg !124
