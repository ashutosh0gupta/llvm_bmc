...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !104), !dbg !120
  ...
  //   %arrayidx13 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !106
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !76, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !128
  ...
  //   %cmp27 = icmp eq i32 %conv16, 0, !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !92, metadata !DIExpression()), !dbg !138

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %7, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !96, metadata !DIExpression()), !dbg !141

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %8, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !123
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !190, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !247

  //   store atomic i64 0, i64* @atom_1_X8_0 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !193, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !249

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !214, metadata !DIExpression()), !dbg !277

  //   %9 = load atomic i64, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !155
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !218, metadata !DIExpression()), !dbg !280

  //   %10 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !158
  // LD: Guess
  old_cr = cr(0,6);
