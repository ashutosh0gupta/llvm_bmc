...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !64, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !65, metadata !DIExpression()), !dbg !98

  //   %conv1 = sext i32 %add to i64, !dbg !80

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !67, metadata !DIExpression()), !dbg !98

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !100
  ...
  //   %conv5 = trunc i64 %1 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !68, metadata !DIExpression()), !dbg !90

  //   %xor6 = xor i32 %conv5, %conv5, !dbg !84
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !72, metadata !DIExpression()), !dbg !90

  //   %add8 = add nsw i32 0, %xor6, !dbg !85
  creg_r5 = max(0,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = 0 + r4;

  //   %idxprom = sext i32 %add8 to i64, !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !74, metadata !DIExpression()), !dbg !105
  ...
  //   %conv11 = trunc i64 %2 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !73, metadata !DIExpression()), !dbg !90

  //   %cmp = icmp eq i32 %conv, 1, !dbg !88

  //   %conv12 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !77, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !78, metadata !DIExpression()), !dbg !108

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %3, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !90
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv5, 2, !dbg !91

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !81, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !82, metadata !DIExpression()), !dbg !111

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %4, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !93
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv11, 0, !dbg !94

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !85, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !86, metadata !DIExpression()), !dbg !114

  //   %5 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %5, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !96
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !137, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !138, metadata !DIExpression()), !dbg !195

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !139, metadata !DIExpression()), !dbg !197

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !143, metadata !DIExpression()), !dbg !199

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !144, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !154, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !157, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !159, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !160, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !164, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !166, metadata !DIExpression()), !dbg !227

  //   %conv = trunc i64 %6 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !163, metadata !DIExpression()), !dbg !195

  //   %cmp = icmp eq i32 %conv, 1, !dbg !135

  //   %conv16 = zext i1 %cmp to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !167, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !171, metadata !DIExpression()), !dbg !231

  //   %conv20 = trunc i64 %7 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !168, metadata !DIExpression()), !dbg !195

  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !139

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !172, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !174, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !176, metadata !DIExpression()), !dbg !235

  //   %conv26 = trunc i64 %8 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !173, metadata !DIExpression()), !dbg !195

  //   %cmp27 = icmp eq i32 %conv26, 2, !dbg !143

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !177, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !179, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !181, metadata !DIExpression()), !dbg !239

  //   %conv32 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !178, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !185, metadata !DIExpression()), !dbg !242

  //   %conv36 = trunc i64 %10 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !182, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !187, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !189, metadata !DIExpression()), !dbg !245

  //   %conv40 = trunc i64 %11 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !186, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !191, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !192, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !193, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !194, metadata !DIExpression()), !dbg !195
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !161
