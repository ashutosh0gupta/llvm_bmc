...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X4_0, align 4, !dbg !113, !tbaa !109
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X6_1, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X8_0, align 4, !dbg !115, !tbaa !109
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X10_0, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !187, metadata !DIExpression()), !dbg !244

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !192, metadata !DIExpression()), !dbg !248

  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !133
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !252

  //   %8 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   %10 = load i32, i32* @atom_1_X4_0, align 4, !dbg !141, !tbaa !109
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X6_1, align 4, !dbg !142, !tbaa !109
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %12 = load i32, i32* @atom_1_X8_0, align 4, !dbg !143, !tbaa !109
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %13 = load i32, i32* @atom_1_X10_0, align 4, !dbg !144, !tbaa !109
  // LD: Guess
  old_cr = cr(0,8);
