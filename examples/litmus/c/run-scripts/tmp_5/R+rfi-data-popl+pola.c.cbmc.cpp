...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !48, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !72

  //   %conv3 = sext i32 %add to i64, !dbg !73

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !51, metadata !DIExpression()), !dbg !72

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !52, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !56, metadata !DIExpression()), !dbg !76
  ...
  //   store i32 %conv10, i32* @atom_0_X7_2, align 4, !dbg !80, !tbaa !81
  // ST: Guess
  ...
  //   %cmp11 = icmp eq i32 %conv, 1, !dbg !85
  ...
  //   store i32 %conv12, i32* @atom_0_X2_1, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !105
