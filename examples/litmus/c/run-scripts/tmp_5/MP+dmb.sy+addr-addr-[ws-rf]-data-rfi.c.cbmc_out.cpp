...
T2BLOCK1:
  ...
  //   %add6 = add nsw i32 3, %xor5, !dbg !81
  creg_r6 = max(0,creg_r5);
  r6 = 3 + r5;

  //   %idxprom7 = sext i32 %add6 to i64, !dbg !81

  //   %arrayidx8 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom7, !dbg !81
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx8, metadata !69, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64 1, metadata !71, metadata !DIExpression()), !dbg !101

  //   store atomic i64 1, i64* %arrayidx8 monotonic, align 8, !dbg !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !73, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !107

  //   %conv17 = sext i32 %add14 to i64, !dbg !89

  //   call void @llvm.dbg.value(metadata i64 %conv17, metadata !80, metadata !DIExpression()), !dbg !107

  //   store atomic i64 %conv17, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv12, 2, !dbg !99
  ...
  //   store i32 %conv24, i32* @atom_1_X8_2, align 4, !dbg !100, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X8_2, align 4, !dbg !105, !tbaa !101
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X8_2, align 4, !dbg !131, !tbaa !101
  // LD: Guess
  old_cr = cr(0,5);
