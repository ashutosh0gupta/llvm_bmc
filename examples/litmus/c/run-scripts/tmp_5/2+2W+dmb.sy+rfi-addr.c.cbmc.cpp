...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !93, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !94, metadata !DIExpression()), !dbg !119

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !95, metadata !DIExpression()), !dbg !121

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !99, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !100, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i64 0, metadata !102, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !103, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64 0, metadata !105, metadata !DIExpression()), !dbg !126
  ...
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l42_c15
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l42_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !110, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !112, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !111, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !115, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !116, metadata !DIExpression()), !dbg !119

  //   %and = and i32 %conv12, %6, !dbg !95
  creg_r10 = max(creg__r8__2_,creg_r9);
  r10 = (r8==2) & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !117, metadata !DIExpression()), !dbg !119

  //   %and13 = and i32 %conv6, %and, !dbg !96
  creg_r11 = max(creg__r7__2_,creg_r10);
  r11 = (r7==2) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !118, metadata !DIExpression()), !dbg !119
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 57, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !100
