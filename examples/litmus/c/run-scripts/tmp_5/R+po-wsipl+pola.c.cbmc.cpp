...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !77, metadata !DIExpression()), !dbg !87
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X5_3, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X5_3, align 4, !dbg !99, !tbaa !78
  // LD: Guess
  old_cr = cr(0,2);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([100 x i8], [100 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !107
