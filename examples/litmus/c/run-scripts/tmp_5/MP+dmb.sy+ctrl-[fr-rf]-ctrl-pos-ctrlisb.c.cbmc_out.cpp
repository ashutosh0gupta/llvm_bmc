...
T2BLOCK10:
  ...
  //   %cmp29 = icmp eq i32 %conv4, 0, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !90, metadata !DIExpression()), !dbg !149
  ...
  //   %cmp34 = icmp eq i32 %conv8, 1, !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !94, metadata !DIExpression()), !dbg !152
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !168
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !201, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !204, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !211, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !216, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !221, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !230, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !234, metadata !DIExpression()), !dbg !301
