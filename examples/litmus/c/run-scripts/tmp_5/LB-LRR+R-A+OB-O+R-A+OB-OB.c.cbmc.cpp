...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !190, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !191, metadata !DIExpression()), !dbg !227

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !192, metadata !DIExpression()), !dbg !229

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !196, metadata !DIExpression()), !dbg !231

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !197, metadata !DIExpression()), !dbg !233

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !198, metadata !DIExpression()), !dbg !235

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !199, metadata !DIExpression()), !dbg !237

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !200, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !201, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !204, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !207, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !210, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !213, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !248
  ...
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l91_c15
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l91_c15
  // Check
  ...
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l92_c15
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l92_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !219, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !220, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !221, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !223, metadata !DIExpression()), !dbg !227

  //   %and21 = and i32 %14, %and20, !dbg !146
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !224, metadata !DIExpression()), !dbg !227

  //   %and22 = and i32 %13, %and21, !dbg !147
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !225, metadata !DIExpression()), !dbg !227

  //   %and23 = and i32 %12, %and22, !dbg !148
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !226, metadata !DIExpression()), !dbg !227
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 123, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !152
