...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !119, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !120, metadata !DIExpression()), !dbg !138

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !62

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !62

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !121, metadata !DIExpression()), !dbg !140

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !125, metadata !DIExpression()), !dbg !142

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !126, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !127, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i64 0, metadata !129, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !130, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64 0, metadata !132, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32 %and8, metadata !137, metadata !DIExpression()), !dbg !138
