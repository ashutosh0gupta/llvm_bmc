...
T2BLOCK1:
  ...
  //   %cmp20 = icmp eq i32 %conv5, 2, !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !88, metadata !DIExpression()), !dbg !124

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %5, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv15, 0, !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !96, metadata !DIExpression()), !dbg !130

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %7, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !173, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !179, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !202, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !210, metadata !DIExpression()), !dbg !274

  //   %12 = load atomic i64, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !166
  // LD: Guess
  old_cr = cr(0,6);
