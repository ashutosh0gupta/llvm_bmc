...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !123, metadata !DIExpression()), !dbg !159

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !124, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !135, metadata !DIExpression()), !dbg !183

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l67_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !137, metadata !DIExpression()), !dbg !183

  //   %conv = trunc i64 %8 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !134, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !138, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !140, metadata !DIExpression()), !dbg !187

  //   %9 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l69_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !142, metadata !DIExpression()), !dbg !187

  //   %conv16 = trunc i64 %9 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !139, metadata !DIExpression()), !dbg !153
  ...
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l71_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !147, metadata !DIExpression()), !dbg !191

  //   %conv22 = trunc i64 %10 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !144, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !148, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !149, metadata !DIExpression()), !dbg !153

  //   %and = and i32 %conv24, %11, !dbg !122
  creg_r10 = max(creg__r8__2_,creg_r9);
  r10 = (r8==2) & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !150, metadata !DIExpression()), !dbg !153

  //   %and25 = and i32 %conv18, %and, !dbg !123
  creg_r11 = max(creg__r7__2_,creg_r10);
  r11 = (r7==2) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !151, metadata !DIExpression()), !dbg !153

  //   %and26 = and i32 %conv12, %and25, !dbg !124
  creg_r12 = max(creg__r6__2_,creg_r11);
  r12 = (r6==2) & r11;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !152, metadata !DIExpression()), !dbg !153
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
