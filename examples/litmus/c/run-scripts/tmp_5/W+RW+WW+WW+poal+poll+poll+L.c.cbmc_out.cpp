...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !97, metadata !DIExpression()), !dbg !106
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !123, metadata !DIExpression()), !dbg !165

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !124, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !125, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !128, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !131, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !134, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !138, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !140, metadata !DIExpression()), !dbg !192

  //   %conv = trunc i64 %8 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !137, metadata !DIExpression()), !dbg !159

  //   %cmp = icmp eq i32 %conv, 2, !dbg !117

  //   %conv14 = zext i1 %cmp to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !141, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !143, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !145, metadata !DIExpression()), !dbg !196

  //   %conv18 = trunc i64 %9 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !142, metadata !DIExpression()), !dbg !159

  //   %cmp19 = icmp eq i32 %conv18, 2, !dbg !121

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !146, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !150, metadata !DIExpression()), !dbg !200

  //   %conv24 = trunc i64 %10 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !147, metadata !DIExpression()), !dbg !159

  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !125

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !151, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !153, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !155, metadata !DIExpression()), !dbg !204

  //   %conv30 = trunc i64 %11 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !152, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !157, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !158, metadata !DIExpression()), !dbg !159
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !135
