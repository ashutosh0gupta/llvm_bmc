...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !55, metadata !DIExpression()), !dbg !90
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !60, metadata !DIExpression()), !dbg !93

  //   %conv = trunc i64 %0 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !56, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !65, metadata !DIExpression()), !dbg !98

  //   %conv4 = trunc i64 %1 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !62, metadata !DIExpression()), !dbg !90
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !67, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !66, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !70, metadata !DIExpression()), !dbg !90

  //   %add11 = add nsw i32 4, %xor9, !dbg !91
  ...
  //   %arrayidx13 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !91
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !72, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !74, metadata !DIExpression()), !dbg !111

  //   %conv16 = trunc i64 %3 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !71, metadata !DIExpression()), !dbg !90

  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !94

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !96
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !75, metadata !DIExpression()), !dbg !90

  //   %cmp = icmp eq i32 %conv, 1, !dbg !103

  //   %conv24 = zext i1 %cmp to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !79, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !80, metadata !DIExpression()), !dbg !123

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !82, metadata !DIExpression()), !dbg !123
  ...
  //   %cmp26 = icmp eq i32 %conv23, 0, !dbg !106

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !83, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !84, metadata !DIExpression()), !dbg !126

  //   %6 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !86, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %6, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !161, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !179, metadata !DIExpression()), !dbg !225
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
