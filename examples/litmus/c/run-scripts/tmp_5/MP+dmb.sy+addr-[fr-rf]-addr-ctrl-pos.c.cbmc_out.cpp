...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X5_1, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !181, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !191, metadata !DIExpression()), !dbg !246
  ...
  //   %11 = load i32, i32* @atom_1_X5_1, align 4, !dbg !142, !tbaa !109
  // LD: Guess
  old_cr = cr(0,6);
