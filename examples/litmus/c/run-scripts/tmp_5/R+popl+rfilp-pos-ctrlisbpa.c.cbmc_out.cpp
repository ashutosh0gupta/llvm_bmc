...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !112

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !81
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   store i32 %conv9, i32* @atom_1_X2_2, align 4, !dbg !84, !tbaa !85
  // ST: Guess
  ...
  //   store i32 %conv11, i32* @atom_1_X3_2, align 4, !dbg !90, !tbaa !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X3_2, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_0, align 4, !dbg !92, !tbaa !86
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X3_2, align 4, !dbg !111, !tbaa !86
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X4_0, align 4, !dbg !112, !tbaa !86
  // LD: Guess
  old_cr = cr(0,5);
