...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !109, metadata !DIExpression()), !dbg !132

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !110, metadata !DIExpression()), !dbg !132

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !111, metadata !DIExpression()), !dbg !134

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !115, metadata !DIExpression()), !dbg !136

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !68

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !68

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !116, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !117, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !120, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64 0, metadata !122, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !126, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32 %and9, metadata !131, metadata !DIExpression()), !dbg !132
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !102
