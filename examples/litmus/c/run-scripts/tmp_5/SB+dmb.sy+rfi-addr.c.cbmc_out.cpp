...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !114, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !117, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !121, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !123, metadata !DIExpression()), !dbg !157

  //   %conv = trunc i64 %4 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !120, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !124, metadata !DIExpression()), !dbg !137

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !126, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !128, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !129, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !133, metadata !DIExpression()), !dbg !137

  //   %and13 = and i32 %6, %and, !dbg !108
  creg_r15 = max(creg_r11,creg_r14);
  r15 = r11 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !134, metadata !DIExpression()), !dbg !137

  //   %and14 = and i32 %conv12, %and13, !dbg !109
  creg_r16 = max(creg__r10__1_,creg_r15);
  r16 = (r10==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !135, metadata !DIExpression()), !dbg !137

  //   %and15 = and i32 %conv6, %and14, !dbg !110
  creg_r17 = max(creg__r9__1_,creg_r16);
  r17 = (r9==1) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !136, metadata !DIExpression()), !dbg !137
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !114
