...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !106), !dbg !112
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !107), !dbg !121
...
T2BLOCK7:
  ...
  //   %tobool16 = icmp ne i32 %conv15, 0, !dbg !121

  //   br i1 %tobool16, label %if.then17, label %if.else18, !dbg !123
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK8:
  //   br label %lbl_LC02, !dbg !124
  goto T2BLOCK10;

T2BLOCK9:
  //   br label %lbl_LC02, !dbg !125
  goto T2BLOCK10;

T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !109), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !147

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !147

  //   %conv22 = trunc i64 %4 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !82, metadata !DIExpression()), !dbg !110

  //   %cmp = icmp eq i32 %conv, 1, !dbg !131

  //   %conv23 = zext i1 %cmp to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !86, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !151

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !133
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv4, 1, !dbg !134

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !90, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !91, metadata !DIExpression()), !dbg !154

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %6, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !136
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !94, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !95, metadata !DIExpression()), !dbg !157

  //   %7 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !139
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !98, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !99, metadata !DIExpression()), !dbg !160

  //   %8 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !160

  //   store atomic i64 %8, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !142
  // ST: Guess
  ...
  //   %cmp42 = icmp eq i32 %conv22, 0, !dbg !143

  //   %conv43 = zext i1 %cmp42 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv43, metadata !102, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !103, metadata !DIExpression()), !dbg !163

  //   %9 = zext i32 %conv43 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !163

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !145
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !169, metadata !DIExpression()), !dbg !176
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !186, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !187, metadata !DIExpression()), !dbg !269

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !188, metadata !DIExpression()), !dbg !271

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !192, metadata !DIExpression()), !dbg !273

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !193, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !194, metadata !DIExpression()), !dbg !276

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !197, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !200, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !203, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !209, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !212, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !215, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !218, metadata !DIExpression()), !dbg !292

  //   call void @llvm.dbg.value(metadata i64 0, metadata !220, metadata !DIExpression()), !dbg !292

  //   store atomic i64 0, i64* @atom_1_X8_0 monotonic, align 8, !dbg !153
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !222, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !224, metadata !DIExpression()), !dbg !307

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !221, metadata !DIExpression()), !dbg !269

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !225, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !227, metadata !DIExpression()), !dbg !311
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !229, metadata !DIExpression()), !dbg !311

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !226, metadata !DIExpression()), !dbg !269

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !230, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !232, metadata !DIExpression()), !dbg !315
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !234, metadata !DIExpression()), !dbg !315

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !231, metadata !DIExpression()), !dbg !269

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !235, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !237, metadata !DIExpression()), !dbg !319
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !239, metadata !DIExpression()), !dbg !319

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !236, metadata !DIExpression()), !dbg !269

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !240, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !242, metadata !DIExpression()), !dbg !323
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !244, metadata !DIExpression()), !dbg !323

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !241, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !246, metadata !DIExpression()), !dbg !326
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !248, metadata !DIExpression()), !dbg !326

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !245, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !250, metadata !DIExpression()), !dbg !329
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !252, metadata !DIExpression()), !dbg !329

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !249, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !254, metadata !DIExpression()), !dbg !332
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !256, metadata !DIExpression()), !dbg !332

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !253, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !258, metadata !DIExpression()), !dbg !335
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !260, metadata !DIExpression()), !dbg !335

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !257, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !261, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !262, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !263, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !264, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !265, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !266, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !267, metadata !DIExpression()), !dbg !269

  //   %and67 = and i32 %conv22, %and66, !dbg !205
  creg_r25 = max(max(creg_r9,0),creg_r24);
  ASSUME(active[creg_r25] == 0);
  r25 = (r9==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !268, metadata !DIExpression()), !dbg !269
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 108, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
