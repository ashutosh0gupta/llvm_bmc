...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !95, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !96, metadata !DIExpression()), !dbg !111

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !57

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !57

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !97, metadata !DIExpression()), !dbg !113

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !59

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !59

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !101, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !102, metadata !DIExpression()), !dbg !116
  ...
  //   store i32 0, i32* @atom_1_X3_0, align 4, !dbg !70, !tbaa !66
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_1_X3_0, align 4, !dbg !80, !tbaa !66
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([96 x i8], [96 x i8]* @.str.1, i64 0, i64 0), i32 noundef 56, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !85
