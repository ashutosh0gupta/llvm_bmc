...
T2BLOCK10:
  ...
  //   store i32 %conv25, i32* @atom_1_X4_2, align 4, !dbg !116, !tbaa !111
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !159, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !160, metadata !DIExpression()), !dbg !202

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !161, metadata !DIExpression()), !dbg !204

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !165, metadata !DIExpression()), !dbg !206

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !166, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !167, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !176, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !183, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !187, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !188, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !190, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !192, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !193, metadata !DIExpression()), !dbg !202
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !141
