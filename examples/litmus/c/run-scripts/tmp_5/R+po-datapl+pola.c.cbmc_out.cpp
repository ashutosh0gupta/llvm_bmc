...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !125, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !127, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !132, metadata !DIExpression()), !dbg !164
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !112
