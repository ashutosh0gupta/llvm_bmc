...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !59, metadata !DIExpression()), !dbg !105

  //   br label %label_2, !dbg !87
  goto T2BLOCK1;

T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !104), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !108

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !64, metadata !DIExpression()), !dbg !108

  //   %conv = trunc i64 %0 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !60, metadata !DIExpression()), !dbg !105

  //   %xor = xor i32 %conv, %conv, !dbg !92
  creg_r1 = max(creg_r0,creg_r0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !105

  //   %add = add nsw i32 %xor, 1, !dbg !93
  creg_r2 = max(creg_r1,0);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !66, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !113

  //   %conv1 = sext i32 %add to i64, !dbg !95

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !69, metadata !DIExpression()), !dbg !113

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !115

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()), !dbg !115

  //   %conv5 = trunc i64 %1 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !70, metadata !DIExpression()), !dbg !105

  //   %xor6 = xor i32 %conv5, %conv5, !dbg !99
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !74, metadata !DIExpression()), !dbg !105

  //   %add7 = add nsw i32 %xor6, 1, !dbg !100
  creg_r5 = max(creg_r4,0);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add7, metadata !75, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !76, metadata !DIExpression()), !dbg !120

  //   %conv10 = sext i32 %add7 to i64, !dbg !102

  //   call void @llvm.dbg.value(metadata i64 %conv10, metadata !78, metadata !DIExpression()), !dbg !120

  //   store atomic i64 %conv10, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !80, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !82, metadata !DIExpression()), !dbg !122

  //   %conv14 = trunc i64 %2 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !79, metadata !DIExpression()), !dbg !105

  //   %xor15 = xor i32 %conv14, %conv14, !dbg !106
  creg_r7 = max(creg_r6,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor15, metadata !83, metadata !DIExpression()), !dbg !105

  //   %add17 = add nsw i32 0, %xor15, !dbg !107
  creg_r8 = max(0,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = 0 + r7;

  //   %idxprom = sext i32 %add17 to i64, !dbg !107

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !107
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !85, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !87, metadata !DIExpression()), !dbg !127

  //   %conv20 = trunc i64 %3 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !84, metadata !DIExpression()), !dbg !105

  //   %cmp = icmp eq i32 %conv, 1, !dbg !110

  //   %conv21 = zext i1 %cmp to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !88, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !89, metadata !DIExpression()), !dbg !130

  //   %4 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !91, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !112
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv5, 1, !dbg !113

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !92, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !93, metadata !DIExpression()), !dbg !133

  //   %5 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !95, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %5, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv14, 2, !dbg !116

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !96, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !97, metadata !DIExpression()), !dbg !136

  //   %6 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !99, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %6, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv20, 0, !dbg !119

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !100, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !101, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !103, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %7, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !144, metadata !DIExpression()), !dbg !149
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !145, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64 2, metadata !147, metadata !DIExpression()), !dbg !152
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !162, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !163, metadata !DIExpression()), !dbg !237

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !164, metadata !DIExpression()), !dbg !239

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !168, metadata !DIExpression()), !dbg !241

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !169, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !170, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !244

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !173, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !246

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !176, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !248

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !179, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !250

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !182, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !252

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !185, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !254

  //   store atomic i64 0, i64* @atom_1_X4_1 monotonic, align 8, !dbg !137
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !188, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !256

  //   store atomic i64 0, i64* @atom_1_X7_2 monotonic, align 8, !dbg !139
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !191, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !258

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !141
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !143
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !144
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !145, !tbaa !146
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !150
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !151, !tbaa !146
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call18 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !152
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !153, !tbaa !146
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   %call19 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !154
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !195, metadata !DIExpression()), !dbg !273

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) seq_cst, align 8, !dbg !156
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !197, metadata !DIExpression()), !dbg !273

  //   %conv = trunc i64 %6 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !194, metadata !DIExpression()), !dbg !237

  //   %cmp = icmp eq i32 %conv, 2, !dbg !158

  //   %conv20 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !198, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !200, metadata !DIExpression()), !dbg !277

  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !160
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !202, metadata !DIExpression()), !dbg !277

  //   %conv24 = trunc i64 %7 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !199, metadata !DIExpression()), !dbg !237

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !162

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !203, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !205, metadata !DIExpression()), !dbg !281

  //   %8 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !164
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !207, metadata !DIExpression()), !dbg !281

  //   %conv30 = trunc i64 %8 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !204, metadata !DIExpression()), !dbg !237

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !166

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !208, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !210, metadata !DIExpression()), !dbg !285

  //   %9 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !168
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !212, metadata !DIExpression()), !dbg !285

  //   %conv36 = trunc i64 %9 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !209, metadata !DIExpression()), !dbg !237

  //   %cmp37 = icmp eq i32 %conv36, 1, !dbg !170

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !213, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !215, metadata !DIExpression()), !dbg !289

  //   %10 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !172
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !217, metadata !DIExpression()), !dbg !289

  //   %conv42 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !214, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !219, metadata !DIExpression()), !dbg !292

  //   %11 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !175
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !221, metadata !DIExpression()), !dbg !292

  //   %conv46 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !218, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !223, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !225, metadata !DIExpression()), !dbg !295

  //   %conv50 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !222, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !227, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !229, metadata !DIExpression()), !dbg !298

  //   %conv54 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !226, metadata !DIExpression()), !dbg !237

  //   %and = and i32 %conv50, %conv54, !dbg !183
  creg_r23 = max(creg_r21,creg_r22);
  ASSUME(active[creg_r23] == 0);
  r23 = r21 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !230, metadata !DIExpression()), !dbg !237

  //   %and55 = and i32 %conv46, %and, !dbg !184
  creg_r24 = max(creg_r20,creg_r23);
  ASSUME(active[creg_r24] == 0);
  r24 = r20 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !231, metadata !DIExpression()), !dbg !237

  //   %and56 = and i32 %conv42, %and55, !dbg !185
  creg_r25 = max(creg_r19,creg_r24);
  ASSUME(active[creg_r25] == 0);
  r25 = r19 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !232, metadata !DIExpression()), !dbg !237

  //   %and57 = and i32 %conv38, %and56, !dbg !186
  creg_r26 = max(max(creg_r18,0),creg_r25);
  ASSUME(active[creg_r26] == 0);
  r26 = (r18==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !233, metadata !DIExpression()), !dbg !237

  //   %and58 = and i32 %conv32, %and57, !dbg !187
  creg_r27 = max(max(creg_r17,0),creg_r26);
  ASSUME(active[creg_r27] == 0);
  r27 = (r17==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !234, metadata !DIExpression()), !dbg !237

  //   %and59 = and i32 %conv26, %and58, !dbg !188
  creg_r28 = max(max(creg_r16,0),creg_r27);
  ASSUME(active[creg_r28] == 0);
  r28 = (r16==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !235, metadata !DIExpression()), !dbg !237

  //   %and60 = and i32 %conv20, %and59, !dbg !189
  creg_r29 = max(max(creg_r15,0),creg_r28);
  ASSUME(active[creg_r29] == 0);
  r29 = (r15==2) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !236, metadata !DIExpression()), !dbg !237

  //   %cmp61 = icmp eq i32 %and60, 1, !dbg !190

  //   br i1 %cmp61, label %if.then, label %if.end, !dbg !192
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !193
