...
T2BLOCK1:
  ...
  //   %xor15 = xor i32 %conv14, %conv14, !dbg !94
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor15, metadata !83, metadata !DIExpression()), !dbg !93

  //   %add17 = add nsw i32 0, %xor15, !dbg !95
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom = sext i32 %add17 to i64, !dbg !95

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !95
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !85, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !87, metadata !DIExpression()), !dbg !115

  //   %conv20 = trunc i64 %3 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !84, metadata !DIExpression()), !dbg !93

  //   %cmp = icmp eq i32 %conv, 1, !dbg !98
  creg__r0__1_ = max(0,creg_r0);

  //   %conv21 = zext i1 %cmp to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !88, metadata !DIExpression()), !dbg !93

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !99, !tbaa !100
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv5, 1, !dbg !104
  creg__r3__1_ = max(0,creg_r3);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !89, metadata !DIExpression()), !dbg !93

  //   store i32 %conv23, i32* @atom_1_X4_1, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv14, 2, !dbg !106
  creg__r6__2_ = max(0,creg_r6);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !90, metadata !DIExpression()), !dbg !93

  //   store i32 %conv25, i32* @atom_1_X7_2, align 4, !dbg !107, !tbaa !100
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv20, 0, !dbg !108
  creg__r10__0_ = max(0,creg_r10);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !91, metadata !DIExpression()), !dbg !93

  //   store i32 %conv27, i32* @atom_1_X9_0, align 4, !dbg !109, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !150, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !151, metadata !DIExpression()), !dbg !201

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !152, metadata !DIExpression()), !dbg !203

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !156, metadata !DIExpression()), !dbg !205

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !157, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !158, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !167, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !171, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !173, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !174, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !176, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !178, metadata !DIExpression()), !dbg !235

  //   %conv16 = trunc i64 %7 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !175, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !179, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !181, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !183, metadata !DIExpression()), !dbg !239

  //   %conv22 = trunc i64 %8 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !180, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !184, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !186, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !188, metadata !DIExpression()), !dbg !243

  //   %conv28 = trunc i64 %9 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !185, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !189, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !195, metadata !DIExpression()), !dbg !201

  //   %and32 = and i32 %10, %and31, !dbg !151
  creg_r25 = max(creg_r19,creg_r24);
  r25 = r19 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !196, metadata !DIExpression()), !dbg !201

  //   %and33 = and i32 %conv30, %and32, !dbg !152
  creg_r26 = max(creg__r18__1_,creg_r25);
  r26 = (r18==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !197, metadata !DIExpression()), !dbg !201

  //   %and34 = and i32 %conv24, %and33, !dbg !153
  creg_r27 = max(creg__r17__1_,creg_r26);
  r27 = (r17==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !198, metadata !DIExpression()), !dbg !201

  //   %and35 = and i32 %conv18, %and34, !dbg !154
  creg_r28 = max(creg__r16__1_,creg_r27);
  r28 = (r16==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !199, metadata !DIExpression()), !dbg !201

  //   %and36 = and i32 %conv12, %and35, !dbg !155
  creg_r29 = max(creg__r15__2_,creg_r28);
  r29 = (r15==2) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !200, metadata !DIExpression()), !dbg !201
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !159
