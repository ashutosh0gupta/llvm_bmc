...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !70, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !115

  //   %conv5 = sext i32 %add to i64, !dbg !97

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !73, metadata !DIExpression()), !dbg !115

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !74, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor10, metadata !78, metadata !DIExpression()), !dbg !104

  //   %add11 = add nsw i32 %xor10, 1, !dbg !102
  creg_r6 = max(creg_r5,0);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add11, metadata !79, metadata !DIExpression()), !dbg !104
  ...
  //   %conv14 = sext i32 %add11 to i64, !dbg !104

  //   call void @llvm.dbg.value(metadata i64 %conv14, metadata !82, metadata !DIExpression()), !dbg !122

  //   store atomic i64 %conv14, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !86, metadata !DIExpression()), !dbg !124

  //   %conv18 = trunc i64 %3 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !83, metadata !DIExpression()), !dbg !104

  //   %cmp = icmp eq i32 %conv, 1, !dbg !108

  //   %conv19 = zext i1 %cmp to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !87, metadata !DIExpression()), !dbg !104
  ...
  //   %cmp23 = icmp eq i32 %conv4, 2, !dbg !111

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !91, metadata !DIExpression()), !dbg !104
  ...
  //   store atomic i64 %5, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv9, 1, !dbg !114

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !95, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !96, metadata !DIExpression()), !dbg !134

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !98, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %6, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv18, 1, !dbg !117

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !99, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !100, metadata !DIExpression()), !dbg !137
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !160, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !161, metadata !DIExpression()), !dbg !226

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !162, metadata !DIExpression()), !dbg !228

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !166, metadata !DIExpression()), !dbg !230

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !167, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !168, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !171, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !177, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !180, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !183, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !186, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !190, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !192, metadata !DIExpression()), !dbg !260

  //   %conv = trunc i64 %6 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !189, metadata !DIExpression()), !dbg !226

  //   %cmp = icmp eq i32 %conv, 2, !dbg !147

  //   %conv18 = zext i1 %cmp to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !193, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !195, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !197, metadata !DIExpression()), !dbg !264

  //   %conv22 = trunc i64 %7 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !194, metadata !DIExpression()), !dbg !226

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !151

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !198, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !200, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !202, metadata !DIExpression()), !dbg !268

  //   %conv28 = trunc i64 %8 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !199, metadata !DIExpression()), !dbg !226

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !155

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !203, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !207, metadata !DIExpression()), !dbg !272

  //   %conv34 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !204, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !211, metadata !DIExpression()), !dbg !275

  //   %conv38 = trunc i64 %10 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !208, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !213, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !215, metadata !DIExpression()), !dbg !278

  //   %conv42 = trunc i64 %11 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !212, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !217, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !219, metadata !DIExpression()), !dbg !281

  //   %conv46 = trunc i64 %12 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !216, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !220, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !221, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !222, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !223, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %and50, metadata !224, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !225, metadata !DIExpression()), !dbg !226
