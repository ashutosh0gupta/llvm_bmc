...
T1BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv6, 0, !dbg !82
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !67), !dbg !87

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !55, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64 1, metadata !57, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !58, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !59, metadata !DIExpression()), !dbg !91

  //   %2 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !61, metadata !DIExpression()), !dbg !91

  //   store atomic i64 %2, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !62, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_1, metadata !63, metadata !DIExpression()), !dbg !94

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !65, metadata !DIExpression()), !dbg !94

  //   store atomic i64 %3, i64* @atom_0_X6_1 seq_cst, align 8, !dbg !95
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !100, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !104, metadata !DIExpression()), !dbg !118
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !148, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_1, metadata !151, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !154, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !173, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_1, metadata !177, metadata !DIExpression()), !dbg !231
