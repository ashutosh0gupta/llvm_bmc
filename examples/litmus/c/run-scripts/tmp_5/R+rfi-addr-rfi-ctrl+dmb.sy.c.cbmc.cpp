...
T1BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv6, 0, !dbg !76
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !61), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !55, metadata !DIExpression()), !dbg !82

  //   call void @llvm.dbg.value(metadata i64 1, metadata !57, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !58, metadata !DIExpression()), !dbg !62

  //   store i32 %conv9, i32* @atom_0_X2_1, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv6, 1, !dbg !90
  creg__r4__1_ = max(0,creg_r4);

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !59, metadata !DIExpression()), !dbg !62

  //   store i32 %conv11, i32* @atom_0_X6_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !100, metadata !DIExpression()), !dbg !111
