...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !86
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !112, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !114, metadata !DIExpression()), !dbg !145

  //   %conv = trunc i64 %4 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !111, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !115, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !117, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !119, metadata !DIExpression()), !dbg !149

  //   %conv10 = trunc i64 %5 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !116, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !120, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !121, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !122, metadata !DIExpression()), !dbg !126

  //   %and = and i32 %6, %7, !dbg !101
  creg_r14 = max(creg_r12,creg_r13);
  r14 = r12 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !123, metadata !DIExpression()), !dbg !126

  //   %and13 = and i32 %conv12, %and, !dbg !102
  creg_r15 = max(creg__r11__1_,creg_r14);
  r15 = (r11==1) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !124, metadata !DIExpression()), !dbg !126

  //   %and14 = and i32 %conv6, %and13, !dbg !103
  creg_r16 = max(creg__r10__1_,creg_r15);
  r16 = (r10==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !125, metadata !DIExpression()), !dbg !126
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([97 x i8], [97 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !107
