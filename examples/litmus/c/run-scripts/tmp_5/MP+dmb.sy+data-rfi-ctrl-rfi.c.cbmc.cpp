...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !134, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !135, metadata !DIExpression()), !dbg !191

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !136, metadata !DIExpression()), !dbg !193

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !140, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !141, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !147, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !150, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !153, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !156, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !162, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !163, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !165, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !167, metadata !DIExpression()), !dbg !222

  //   %conv18 = trunc i64 %5 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !164, metadata !DIExpression()), !dbg !191

  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !133

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !168, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !169, metadata !DIExpression()), !dbg !191

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !137

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !173, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !175, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !174, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !179, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !181, metadata !DIExpression()), !dbg !233

  //   %conv34 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !178, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !183, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !185, metadata !DIExpression()), !dbg !236

  //   %conv38 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !182, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !187, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !188, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !189, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !190, metadata !DIExpression()), !dbg !191
