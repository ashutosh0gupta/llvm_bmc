...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !95, metadata !DIExpression()), !dbg !112
  ...
  //   store i32 0, i32* @atom_0_X1_0, align 4, !dbg !67, !tbaa !68
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_0_X1_0, align 4, !dbg !84, !tbaa !68
  // LD: Guess
  old_cr = cr(0,2);
