...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !80
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !73, metadata !DIExpression()), !dbg !101

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(2,r5);
