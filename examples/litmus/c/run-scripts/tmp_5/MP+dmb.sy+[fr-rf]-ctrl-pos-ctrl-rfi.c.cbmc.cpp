...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !87, metadata !DIExpression()), !dbg !133
  ...
  //   %cmp29 = icmp eq i32 %conv19, 1, !dbg !116
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !173, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !179, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !182, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !186, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !189, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !194, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !196, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !200, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !202, metadata !DIExpression()), !dbg !254

  //   %conv30 = trunc i64 %9 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !199, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !204, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !206, metadata !DIExpression()), !dbg !257

  //   %conv34 = trunc i64 %10 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !203, metadata !DIExpression()), !dbg !211
