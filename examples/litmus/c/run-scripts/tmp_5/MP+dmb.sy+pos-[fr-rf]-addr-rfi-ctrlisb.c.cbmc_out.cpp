...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !123
...
T2BLOCK4:
  ...
  //   %cmp26 = icmp eq i32 %conv8, 2, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !96, metadata !DIExpression()), !dbg !144

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %7, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !126
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !156, metadata !DIExpression()), !dbg !163
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !196, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !229, metadata !DIExpression()), !dbg !301
