...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X9_1, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X10_1, align 4, !dbg !97, !tbaa !91
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X9_1, align 4, !dbg !116, !tbaa !91
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %9 = load i32, i32* @atom_1_X10_1, align 4, !dbg !117, !tbaa !91
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
