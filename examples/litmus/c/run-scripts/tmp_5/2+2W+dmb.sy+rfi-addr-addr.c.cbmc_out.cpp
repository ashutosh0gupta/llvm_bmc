...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !102, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !103, metadata !DIExpression()), !dbg !131

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !68

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !68

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !104, metadata !DIExpression()), !dbg !133

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !108, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !109, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64 0, metadata !111, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !112, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !115, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !121, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !122, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !126, metadata !DIExpression()), !dbg !155

  //   %conv12 = trunc i64 %5 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !123, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !127, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !130, metadata !DIExpression()), !dbg !131
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 60, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !105
