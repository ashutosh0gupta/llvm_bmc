...
T1BLOCK2:
  //   br label %lbl_label245, !dbg !61
  goto T1BLOCK4;

T1BLOCK3:
  //   br label %lbl_label245, !dbg !62
  goto T1BLOCK4;
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !80, metadata !DIExpression()), !dbg !87
...
T2BLOCK2:
  //   br label %lbl_label246, !dbg !61
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label246, !dbg !62
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !86), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !81, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !84, metadata !DIExpression()), !dbg !87
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !109, metadata !DIExpression()), !dbg !120

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !53
  // LD: Guess
  old_cr = cr(3,0+2*1);
  cr(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l45_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !112, metadata !DIExpression()), !dbg !123
