...
T2BLOCK7:
  ...
  //   store i32 %conv28, i32* @atom_1_X4_0, align 4, !dbg !122, !tbaa !115
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !215

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !217

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !219

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !177, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !183, metadata !DIExpression()), !dbg !226
  ...
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l72_c15
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l72_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !187, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !186, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !190, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !192, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !191, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !195, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !197, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !196, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !200, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !201, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !202, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !203, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !204, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !205, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !206, metadata !DIExpression()), !dbg !215

  //   %and = and i32 %13, %14, !dbg !146
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !207, metadata !DIExpression()), !dbg !215

  //   %and23 = and i32 %12, %and, !dbg !147
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !208, metadata !DIExpression()), !dbg !215

  //   %and24 = and i32 %11, %and23, !dbg !148
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !209, metadata !DIExpression()), !dbg !215

  //   %and25 = and i32 %10, %and24, !dbg !149
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !210, metadata !DIExpression()), !dbg !215

  //   %and26 = and i32 %9, %and25, !dbg !150
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !211, metadata !DIExpression()), !dbg !215

  //   %and27 = and i32 %conv22, %and26, !dbg !151
  creg_r24 = max(creg__r12__1_,creg_r23);
  r24 = (r12==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !212, metadata !DIExpression()), !dbg !215

  //   %and28 = and i32 %conv16, %and27, !dbg !152
  creg_r25 = max(creg__r11__1_,creg_r24);
  r25 = (r11==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !213, metadata !DIExpression()), !dbg !215

  //   %and29 = and i32 %conv10, %and28, !dbg !153
  creg_r26 = max(creg__r10__1_,creg_r25);
  r26 = (r10==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !214, metadata !DIExpression()), !dbg !215
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 107, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !157
