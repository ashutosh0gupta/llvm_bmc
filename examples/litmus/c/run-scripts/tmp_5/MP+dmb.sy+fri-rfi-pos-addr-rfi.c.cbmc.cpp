...
T2BLOCK1:
  ...
  //   %cmp16 = icmp eq i32 %conv4, 2, !dbg !96
  ...
  //   store i32 %conv17, i32* @atom_1_X3_2, align 4, !dbg !97, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X8_1, align 4, !dbg !92, !tbaa !86
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X8_1, align 4, !dbg !112, !tbaa !86
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
