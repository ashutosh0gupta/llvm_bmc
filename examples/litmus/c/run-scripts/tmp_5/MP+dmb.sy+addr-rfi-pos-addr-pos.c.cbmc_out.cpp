...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X8_0, align 4, !dbg !107, !tbaa !101
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X10_0, align 4, !dbg !108, !tbaa !101
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l63_c16
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l63_c16
  // Check
  ...
  //   %10 = load i32, i32* @atom_1_X8_0, align 4, !dbg !132, !tbaa !101
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %11 = load i32, i32* @atom_1_X10_0, align 4, !dbg !133, !tbaa !101
  // LD: Guess
  old_cr = cr(0,7);
