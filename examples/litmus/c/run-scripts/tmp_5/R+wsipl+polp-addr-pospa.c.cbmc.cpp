...
T2BLOCK1:
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !72
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !118, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !119, metadata !DIExpression()), !dbg !142

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !120, metadata !DIExpression()), !dbg !144

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !124, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !125, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64 0, metadata !127, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !128, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i64 0, metadata !130, metadata !DIExpression()), !dbg !149
  ...
  //   store i32 0, i32* @atom_1_X5_0, align 4, !dbg !80, !tbaa !76
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !132, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !134, metadata !DIExpression()), !dbg !162

  //   %conv = trunc i64 %4 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !131, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !135, metadata !DIExpression()), !dbg !142
  ...
  //   %6 = load i32, i32* @atom_1_X5_0, align 4, !dbg !95, !tbaa !76
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and7, metadata !140, metadata !DIExpression()), !dbg !142

  //   %and8 = and i32 %conv6, %and7, !dbg !99
  creg_r16 = max(creg__r10__3_,creg_r15);
  r16 = (r10==3) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and8, metadata !141, metadata !DIExpression()), !dbg !142
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !103
