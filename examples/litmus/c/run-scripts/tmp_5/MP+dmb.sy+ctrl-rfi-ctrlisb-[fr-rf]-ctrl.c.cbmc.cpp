...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !131
  ...
  //   %conv22 = trunc i64 %4 to i32, !dbg !114
  ...
  //   %conv23 = zext i1 %cmp to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !86, metadata !DIExpression()), !dbg !95

  //   store i32 %conv23, i32* @atom_1_X0_1, align 4, !dbg !116, !tbaa !117
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X4_1, align 4, !dbg !122, !tbaa !117
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv11, 0, !dbg !123
  ...
  //   store i32 %conv27, i32* @atom_1_X5_0, align 4, !dbg !124, !tbaa !117
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv15, 1, !dbg !125
  ...
  //   store i32 %conv29, i32* @atom_1_X7_1, align 4, !dbg !126, !tbaa !117
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv22, 0, !dbg !127
  ...
  //   store i32 %conv31, i32* @atom_1_X8_0, align 4, !dbg !128, !tbaa !117
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !152, metadata !DIExpression()), !dbg !159
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !222

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !224

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !226

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !177, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !180, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !186, metadata !DIExpression()), !dbg !235
  ...
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l72_c15
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l72_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !190, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !192, metadata !DIExpression()), !dbg !253

  //   %conv = trunc i64 %6 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !189, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !193, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !195, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !197, metadata !DIExpression()), !dbg !257

  //   %conv16 = trunc i64 %7 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !194, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !198, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !200, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !202, metadata !DIExpression()), !dbg !261

  //   %conv22 = trunc i64 %8 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !199, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !203, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !205, metadata !DIExpression()), !dbg !265

  //   %9 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l92_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !207, metadata !DIExpression()), !dbg !265

  //   %conv28 = trunc i64 %9 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !204, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !208, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !209, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !210, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !211, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !212, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !213, metadata !DIExpression()), !dbg !222

  //   %and = and i32 %13, %14, !dbg !155
  creg_r18 = max(creg_r16,creg_r17);
  r18 = r16 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !214, metadata !DIExpression()), !dbg !222

  //   %and31 = and i32 %12, %and, !dbg !156
  creg_r19 = max(creg_r15,creg_r18);
  r19 = r15 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !215, metadata !DIExpression()), !dbg !222

  //   %and32 = and i32 %11, %and31, !dbg !157
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !216, metadata !DIExpression()), !dbg !222

  //   %and33 = and i32 %10, %and32, !dbg !158
  creg_r21 = max(creg_r13,creg_r20);
  r21 = r13 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !217, metadata !DIExpression()), !dbg !222

  //   %and34 = and i32 %conv30, %and33, !dbg !159
  creg_r22 = max(creg__r12__1_,creg_r21);
  r22 = (r12==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !218, metadata !DIExpression()), !dbg !222

  //   %and35 = and i32 %conv24, %and34, !dbg !160
  creg_r23 = max(creg__r11__1_,creg_r22);
  r23 = (r11==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !219, metadata !DIExpression()), !dbg !222

  //   %and36 = and i32 %conv18, %and35, !dbg !161
  creg_r24 = max(creg__r10__1_,creg_r23);
  r24 = (r10==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !220, metadata !DIExpression()), !dbg !222

  //   %and37 = and i32 %conv12, %and36, !dbg !162
  creg_r25 = max(creg__r9__1_,creg_r24);
  r25 = (r9==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !221, metadata !DIExpression()), !dbg !222
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 107, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
