...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !74, metadata !DIExpression()), !dbg !100

  //   %add10 = add nsw i32 %xor9, 1, !dbg !95
  creg_r7 = max(creg_r6,0);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !75, metadata !DIExpression()), !dbg !100
  ...
  //   %conv11 = sext i32 %add10 to i64, !dbg !97

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !78, metadata !DIExpression()), !dbg !115

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv4, 0, !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !88, metadata !DIExpression()), !dbg !124

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %5, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv8, 1, !dbg !107
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !173, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !202, metadata !DIExpression()), !dbg !268
