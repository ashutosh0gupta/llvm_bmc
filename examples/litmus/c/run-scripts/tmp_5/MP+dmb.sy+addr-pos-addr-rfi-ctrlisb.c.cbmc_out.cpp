...
T2BLOCK4:
  ...
  //   %cmp25 = icmp eq i32 %conv16, 1, !dbg !111

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !88, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !89, metadata !DIExpression()), !dbg !131

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %6, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv20, 0, !dbg !114

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !92, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !93, metadata !DIExpression()), !dbg !134

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !134
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !166, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !169, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !192, metadata !DIExpression()), !dbg !248
