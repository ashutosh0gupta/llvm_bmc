...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64 2, metadata !44, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !47, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !51, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !53, metadata !DIExpression()), !dbg !77

  //   %conv6 = trunc i64 %1 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !50, metadata !DIExpression()), !dbg !67
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !66), !dbg !85
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !58, metadata !DIExpression()), !dbg !89

  //   %2 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !60, metadata !DIExpression()), !dbg !89

  //   store atomic i64 %2, i64* @atom_0_X3_2 seq_cst, align 8, !dbg !90
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !98, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64 2, metadata !100, metadata !DIExpression()), !dbg !113

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !56
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !102, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !106, metadata !DIExpression()), !dbg !120
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !143, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !187

  //   store atomic i64 0, i64* @atom_0_X3_2 monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !146, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !189

  //   store atomic i64 0, i64* @atom_0_X4_2 monotonic, align 8, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !149, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !163, metadata !DIExpression()), !dbg !211

  //   %6 = load atomic i64, i64* @atom_0_X3_2 seq_cst, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !167, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !171, metadata !DIExpression()), !dbg !217
