...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !50, metadata !DIExpression()), !dbg !61
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !60), !dbg !79

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !54, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64 1, metadata !56, metadata !DIExpression()), !dbg !80
  ...
  //   store i32 %conv9, i32* @atom_0_X3_2, align 4, !dbg !83, !tbaa !84
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv6, 2, !dbg !88
  ...
  //   store i32 %conv11, i32* @atom_0_X4_2, align 4, !dbg !89, !tbaa !84
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !98, metadata !DIExpression()), !dbg !109
