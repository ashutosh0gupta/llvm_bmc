...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !96, metadata !DIExpression()), !dbg !108
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !117, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !120, metadata !DIExpression()), !dbg !132
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !141, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !144, metadata !DIExpression()), !dbg !156
  ...
  // ST: Guess
  iw(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l63_c3
  old_cw = cw(5,0+5*1);
  cw(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l63_c3
  // Check
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !163, metadata !DIExpression()), !dbg !175
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !165, metadata !DIExpression()), !dbg !178

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(6,0+5*1);
  cr(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN LDCOM _l71_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !167, metadata !DIExpression()), !dbg !178

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !164, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !182

  //   %1 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(6,0+1*1);
  cr(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN LDCOM _l73_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !171, metadata !DIExpression()), !dbg !182

  //   %conv4 = trunc i64 %1 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !168, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !172, metadata !DIExpression()), !dbg !175

  //   store i32 %conv5, i32* @atom_5_X0_1, align 4, !dbg !68, !tbaa !69
  // ST: Guess
  iw(6,10) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l75_c15
  old_cw = cw(6,10);
  cw(6,10) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l75_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !173, metadata !DIExpression()), !dbg !175
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !197, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !198, metadata !DIExpression()), !dbg !237

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !199, metadata !DIExpression()), !dbg !239

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !203, metadata !DIExpression()), !dbg !241

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !204, metadata !DIExpression()), !dbg !243

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !205, metadata !DIExpression()), !dbg !245

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !206, metadata !DIExpression()), !dbg !247

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !207, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !208, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !210, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !211, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64 0, metadata !213, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !214, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64 0, metadata !216, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !217, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i64 0, metadata !219, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !220, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64 0, metadata !222, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !223, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64 0, metadata !225, metadata !DIExpression()), !dbg !260
  ...
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l95_c15
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l95_c15
  // Check
  ...
  // ST: Guess
  iw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l96_c15
  old_cw = cw(0,11);
  cw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l96_c15
  // Check
  ...
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l97_c15
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l97_c15
  // Check
  ...
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l98_c15
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l98_c15
  // Check
  ...
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l99_c15
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l99_c15
  // Check
  ...
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l100_c15
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l100_c15
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,11);
  cr(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l117_c13
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l118_c13
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l119_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !229, metadata !DIExpression()), !dbg !237

  //   %16 = load i32, i32* @atom_3_X0_1, align 4, !dbg !147, !tbaa !114
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l120_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !230, metadata !DIExpression()), !dbg !237

  //   %17 = load i32, i32* @atom_4_X0_1, align 4, !dbg !148, !tbaa !114
  // LD: Guess
  old_cr = cr(0,9);
  cr(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l121_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !231, metadata !DIExpression()), !dbg !237

  //   %and = and i32 %16, %17, !dbg !149
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !232, metadata !DIExpression()), !dbg !237

  //   %and22 = and i32 %15, %and, !dbg !150
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !233, metadata !DIExpression()), !dbg !237

  //   %and23 = and i32 %14, %and22, !dbg !151
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !234, metadata !DIExpression()), !dbg !237

  //   %and24 = and i32 %13, %and23, !dbg !152
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !235, metadata !DIExpression()), !dbg !237

  //   %and25 = and i32 %12, %and24, !dbg !153
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !236, metadata !DIExpression()), !dbg !237
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 127, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !157
