...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !62), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !56, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64 1, metadata !58, metadata !DIExpression()), !dbg !85

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !84
  // ST: Guess
  iw(1,r5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l28_c3
  old_cw = cw(1,r5);
  cw(1,r5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l28_c3
  // Check
