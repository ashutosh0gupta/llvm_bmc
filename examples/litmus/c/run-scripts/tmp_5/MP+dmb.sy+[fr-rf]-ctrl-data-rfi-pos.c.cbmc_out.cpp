...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !73, metadata !DIExpression()), !dbg !104

  //   %add = add nsw i32 %xor, 1, !dbg !104
  creg_r4 = max(creg_r3,0);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !74, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !124

  //   %conv9 = sext i32 %add to i64, !dbg !106

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !77, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !126
  ...
  //   store atomic i64 %6, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   store atomic i64 %7, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !188, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !213, metadata !DIExpression()), !dbg !273
