...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !118, metadata !DIExpression()), !dbg !131
  ...
  // LD: Guess
  old_cr = cr(4,0+4*1);
  cr(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l51_c16
  // Check
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !147, metadata !DIExpression()), !dbg !155

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !55
  // ST: Guess
  iw(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l61_c3
  old_cw = cw(5,0+4*1);
  cw(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l61_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !158
...
T0BLOCK0:
  ...
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l79_c15
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l79_c15
  // Check
