...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X10_1, align 4, !dbg !107, !tbaa !103
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l61_c16
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l61_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !166, metadata !DIExpression()), !dbg !214
  ...
  //   %8 = load i32, i32* @atom_1_X10_1, align 4, !dbg !130, !tbaa !103
  // LD: Guess
  old_cr = cr(0,6);
