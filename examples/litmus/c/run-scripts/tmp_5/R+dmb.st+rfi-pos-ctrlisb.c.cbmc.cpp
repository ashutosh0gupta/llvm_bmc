...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !134, metadata !DIExpression()), !dbg !168

  //   %conv = trunc i64 %4 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !131, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !135, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !139, metadata !DIExpression()), !dbg !172

  //   %conv10 = trunc i64 %5 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !136, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !144, metadata !DIExpression()), !dbg !148

  //   %and13 = and i32 %6, %and, !dbg !108
  creg_r12 = max(creg_r11,creg_r8);
  r12 = r8 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !145, metadata !DIExpression()), !dbg !148

  //   %and14 = and i32 %conv12, %and13, !dbg !109
  creg_r13 = max(creg__r7__2_,creg_r12);
  r13 = (r7==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !146, metadata !DIExpression()), !dbg !148
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !114
