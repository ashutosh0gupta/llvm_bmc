...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !89, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !93, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !102
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv7, 1, !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !95, metadata !DIExpression()), !dbg !132

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !97, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %4, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !99, metadata !DIExpression()), !dbg !135

  //   %5 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !101, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %5, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !161, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !164, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !167, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !170, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !189, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !193, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !197, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !201, metadata !DIExpression()), !dbg !260
