...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !89, metadata !DIExpression()), !dbg !116
  ...
  //   store i32 %conv12, i32* @atom_1_X2_1, align 4, !dbg !92, !tbaa !93
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv7, 1, !dbg !97
  creg__r4__1_ = max(0,creg_r4);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !91, metadata !DIExpression()), !dbg !95

  //   store i32 %conv14, i32* @atom_1_X5_1, align 4, !dbg !98, !tbaa !93
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv11, 0, !dbg !99
  ...
  //   store i32 %conv16, i32* @atom_1_X6_0, align 4, !dbg !100, !tbaa !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !150, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !149, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !153, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !155, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !154, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !158, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !159, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !163, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !164, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !165, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !168, metadata !DIExpression()), !dbg !174

  //   %and21 = and i32 %8, %and, !dbg !129
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !169, metadata !DIExpression()), !dbg !174

  //   %and22 = and i32 %7, %and21, !dbg !130
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !170, metadata !DIExpression()), !dbg !174

  //   %and23 = and i32 %conv20, %and22, !dbg !131
  creg_r19 = max(creg__r11__1_,creg_r18);
  r19 = (r11==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !171, metadata !DIExpression()), !dbg !174

  //   %and24 = and i32 %conv14, %and23, !dbg !132
  creg_r20 = max(creg__r10__1_,creg_r19);
  r20 = (r10==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !172, metadata !DIExpression()), !dbg !174

  //   %and25 = and i32 %conv8, %and24, !dbg !133
  creg_r21 = max(creg__r9__1_,creg_r20);
  r21 = (r9==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !173, metadata !DIExpression()), !dbg !174
