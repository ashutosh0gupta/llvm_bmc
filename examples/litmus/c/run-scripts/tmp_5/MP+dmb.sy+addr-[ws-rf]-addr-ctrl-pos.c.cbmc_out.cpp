...
T2BLOCK1:
  ...
  //   %add7 = add nsw i32 3, %xor5, !dbg !98
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 3 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !98

  //   %arrayidx9 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !98
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !75, metadata !DIExpression()), !dbg !118

  //   %2 = load atomic i64, i64* %arrayidx9 monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,r7);
...
T2BLOCK4:
  ...
  //   %cmp30 = icmp eq i32 %conv16, 0, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !95, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !99, metadata !DIExpression()), !dbg !142
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !188, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !251

  //   store atomic i64 0, i64* @atom_1_X5_2 monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !191, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !194, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !217, metadata !DIExpression()), !dbg !285

  //   %10 = load atomic i64, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !221, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !225, metadata !DIExpression()), !dbg !291
