...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !102, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !103, metadata !DIExpression()), !dbg !129

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !104, metadata !DIExpression()), !dbg !131

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !68

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !68

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !108, metadata !DIExpression()), !dbg !133

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !109, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !117, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !119, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !120, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !124, metadata !DIExpression()), !dbg !156

  //   %conv12 = trunc i64 %7 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !121, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !125, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !128, metadata !DIExpression()), !dbg !129
