...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !160, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !161, metadata !DIExpression()), !dbg !206

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !162, metadata !DIExpression()), !dbg !208

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !166, metadata !DIExpression()), !dbg !210

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !167, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !168, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !171, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !174, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !177, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !184, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !186, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !187, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !191, metadata !DIExpression()), !dbg !241

  //   %conv18 = trunc i64 %7 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !188, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !192, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !196, metadata !DIExpression()), !dbg !245

  //   %conv24 = trunc i64 %8 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !193, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !197, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !202, metadata !DIExpression()), !dbg !206

  //   %and28 = and i32 %conv26, %and27, !dbg !140
  creg_r20 = max(creg__r14__1_,creg_r19);
  r20 = (r14==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !203, metadata !DIExpression()), !dbg !206

  //   %and29 = and i32 %conv20, %and28, !dbg !141
  creg_r21 = max(creg__r13__1_,creg_r20);
  r21 = (r13==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !204, metadata !DIExpression()), !dbg !206

  //   %and30 = and i32 %conv14, %and29, !dbg !142
  creg_r22 = max(creg__r12__2_,creg_r21);
  r22 = (r12==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !205, metadata !DIExpression()), !dbg !206
