...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X10_2, align 4, !dbg !110, !tbaa !106
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l68_c16
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l68_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !180, metadata !DIExpression()), !dbg !233

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(0,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !185, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !190, metadata !DIExpression()), !dbg !241
  ...
  //   %10 = load i32, i32* @atom_1_X10_2, align 4, !dbg !136, !tbaa !106
  // LD: Guess
  old_cr = cr(0,6);
