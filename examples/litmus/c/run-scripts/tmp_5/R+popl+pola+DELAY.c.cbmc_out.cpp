...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 4, metadata !57, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i32 8, metadata !58, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i32 16, metadata !59, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i32 32, metadata !60, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !62, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !64, metadata !DIExpression()), !dbg !72

  //   %conv = trunc i64 %0 to i32, !dbg !56

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !61, metadata !DIExpression()), !dbg !67

  //   %cmp = icmp eq i32 %conv, 0, !dbg !57
  creg__r0__0_ = max(0,creg_r0);

  //   %conv3 = zext i1 %cmp to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !65, metadata !DIExpression()), !dbg !67

  //   store i32 %conv3, i32* @atom_1_X2_0, align 4, !dbg !58, !tbaa !59
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !103, metadata !DIExpression()), !dbg !127
  ...
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l53_c13
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 55, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !89
