...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !52, metadata !DIExpression()), !dbg !70
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64 2, metadata !55, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i32 4, metadata !56, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i32 8, metadata !58, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i32 16, metadata !59, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i32 32, metadata !60, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !65, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !66, metadata !DIExpression()), !dbg !79
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !102, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !111, metadata !DIExpression()), !dbg !140
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 55, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !96
