...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !79, metadata !DIExpression()), !dbg !93
  ...
  //   %cmp17 = icmp eq i32 %conv8, 0, !dbg !102

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !83, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !84, metadata !DIExpression()), !dbg !122

  //   %5 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !88, metadata !DIExpression()), !dbg !125

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !125

  //   store atomic i64 %6, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !107
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !131, metadata !DIExpression()), !dbg !138
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !148, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !149, metadata !DIExpression()), !dbg !200

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !150, metadata !DIExpression()), !dbg !202

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !154, metadata !DIExpression()), !dbg !204

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !155, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !165, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !168, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !171, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !177, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !182, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !187, metadata !DIExpression()), !dbg !240

  //   %conv26 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !184, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !189, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !191, metadata !DIExpression()), !dbg !243

  //   %conv30 = trunc i64 %9 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !188, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !193, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !195, metadata !DIExpression()), !dbg !246
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 84, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !150
