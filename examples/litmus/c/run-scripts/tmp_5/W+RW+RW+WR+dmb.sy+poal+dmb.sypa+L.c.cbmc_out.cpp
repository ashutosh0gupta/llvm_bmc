...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !108, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 2, metadata !110, metadata !DIExpression()), !dbg !123
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !59
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !114, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !116, metadata !DIExpression()), !dbg !130

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !118, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %1, i64* @atom_3_X2_0 seq_cst, align 8, !dbg !63
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !168, metadata !DIExpression()), !dbg !224

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !127
  // LD: Guess
  old_cr = cr(0,0+2*1);
