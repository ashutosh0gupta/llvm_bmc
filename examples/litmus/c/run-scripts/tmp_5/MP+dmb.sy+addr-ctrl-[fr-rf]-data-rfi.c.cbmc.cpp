...
T2BLOCK4:
  ...
  //   %add14 = add nsw i32 %xor13, 1, !dbg !109
  ...
  //   %conv15 = sext i32 %add14 to i64, !dbg !111

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !82, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !111
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 0, !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !92, metadata !DIExpression()), !dbg !138

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %6, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !120
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !190, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !219, metadata !DIExpression()), !dbg !287
