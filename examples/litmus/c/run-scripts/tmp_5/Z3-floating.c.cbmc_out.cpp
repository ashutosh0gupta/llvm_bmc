...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !43, metadata !DIExpression()), !dbg !60

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !39, metadata !DIExpression()), !dbg !57

  //   %xor = xor i32 %conv, %conv, !dbg !63
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !44, metadata !DIExpression()), !dbg !57
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !64
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !46, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !48, metadata !DIExpression()), !dbg !65

  //   %conv4 = trunc i64 %1 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !45, metadata !DIExpression()), !dbg !57

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !50, metadata !DIExpression()), !dbg !67

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !68
  // LD: Guess
  old_cr = cr(1,0+2*1);
  cr(1,0+2*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l24_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !52, metadata !DIExpression()), !dbg !67

  //   %conv8 = trunc i64 %2 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !49, metadata !DIExpression()), !dbg !57
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !53, metadata !DIExpression()), !dbg !57

  //   store i32 %conv9, i32* @atom_0_X0_1, align 4, !dbg !71, !tbaa !72
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !54, metadata !DIExpression()), !dbg !57

  //   store i32 %conv11, i32* @atom_0_X3_0, align 4, !dbg !77, !tbaa !72
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !55, metadata !DIExpression()), !dbg !57

  //   store i32 %conv13, i32* @atom_0_X6_1, align 4, !dbg !79, !tbaa !72
  // ST: Guess
  iw(1,5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l30_c15
  old_cw = cw(1,5);
  cw(1,5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l30_c15
  // Check
  ASSUME(active[iw(1,5)] == 1);
  ASSUME(active[cw(1,5)] == 1);
  ASSUME(sforbid(5,cw(1,5))== 0);
  ASSUME(iw(1,5) >= creg__r5__1_);
  ASSUME(iw(1,5) >= 0);
...
T3BLOCK1:
  ...
  // ST: Guess
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l44_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l44_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !106, metadata !DIExpression()), !dbg !116
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !126, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !127, metadata !DIExpression()), !dbg !154

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !128, metadata !DIExpression()), !dbg !156

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !132, metadata !DIExpression()), !dbg !158

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !133, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !134, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 0, metadata !136, metadata !DIExpression()), !dbg !161

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !78
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 0, metadata !139, metadata !DIExpression()), !dbg !163

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !165

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !82
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X3_0, align 4, !dbg !88, !tbaa !84
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X6_1, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   %call5 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !91
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call6 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !92
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call7 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !96
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !97, !tbaa !94
  r8 = local_mem[1];

  //   %call8 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !98
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !99, !tbaa !94
  r9 = local_mem[2];

  //   %call9 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !100
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !144, metadata !DIExpression()), !dbg !181

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !146, metadata !DIExpression()), !dbg !181

  //   %conv = trunc i64 %6 to i32, !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !147, metadata !DIExpression()), !dbg !154

  //   %7 = load i32, i32* @atom_0_X0_1, align 4, !dbg !105, !tbaa !84
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_0_X3_0, align 4, !dbg !106, !tbaa !84
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_0_X6_1, align 4, !dbg !107, !tbaa !84
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !150, metadata !DIExpression()), !dbg !154

  //   %and = and i32 %8, %9, !dbg !108
  creg_r14 = max(creg_r12,creg_r13);
  r14 = r12 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !151, metadata !DIExpression()), !dbg !154

  //   %and11 = and i32 %7, %and, !dbg !109
  creg_r15 = max(creg_r11,creg_r14);
  r15 = r11 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and11, metadata !152, metadata !DIExpression()), !dbg !154

  //   %and12 = and i32 %conv10, %and11, !dbg !110
  creg_r16 = max(creg__r10__2_,creg_r15);
  r16 = (r10==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and12, metadata !153, metadata !DIExpression()), !dbg !154

  //   %cmp13 = icmp eq i32 %and12, 1, !dbg !111
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([96 x i8], [96 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !114
...
T0BLOCK2:
  //   %10 = bitcast i64* %thr2 to i8*, !dbg !117

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !117

  //   %11 = bitcast i64* %thr1 to i8*, !dbg !117

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !117

  //   %12 = bitcast i64* %thr0 to i8*, !dbg !117

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !117
