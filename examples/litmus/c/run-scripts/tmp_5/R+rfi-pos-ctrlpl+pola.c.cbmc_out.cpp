...
T1BLOCK4:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !83
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !57, metadata !DIExpression()), !dbg !84

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(1,0+1*1);
  cr(1,0+1*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l28_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !56, metadata !DIExpression()), !dbg !65
  ...
  //   store i32 %conv11, i32* @atom_0_X6_2, align 4, !dbg !88, !tbaa !89
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv, 1, !dbg !93
  ...
  //   store i32 %conv13, i32* @atom_0_X2_1, align 4, !dbg !94, !tbaa !89
  // ST: Guess
  ...
  //   store i32 %conv15, i32* @atom_0_X3_1, align 4, !dbg !96, !tbaa !89
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !105, metadata !DIExpression()), !dbg !115
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !135, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !138, metadata !DIExpression()), !dbg !167
  ...
  //   store i32 0, i32* @atom_0_X3_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !145, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !146, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !150, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !151, metadata !DIExpression()), !dbg !160
  ...
  //   %8 = load i32, i32* @atom_0_X3_1, align 4, !dbg !111, !tbaa !86
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !156, metadata !DIExpression()), !dbg !160

  //   %and14 = and i32 %6, %and13, !dbg !115
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !157, metadata !DIExpression()), !dbg !160
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
