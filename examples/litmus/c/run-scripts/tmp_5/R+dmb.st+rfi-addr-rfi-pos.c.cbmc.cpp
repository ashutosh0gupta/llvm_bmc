...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !70, metadata !DIExpression()), !dbg !82
  ...
  //   %cmp12 = icmp eq i32 %conv6, 1, !dbg !86
  ...
  //   store i32 %conv13, i32* @atom_1_X6_1, align 4, !dbg !87, !tbaa !82
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X6_1, align 4, !dbg !86, !tbaa !82
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X7_1, align 4, !dbg !87, !tbaa !82
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X6_1, align 4, !dbg !105, !tbaa !82
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X7_1, align 4, !dbg !106, !tbaa !82
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !114
