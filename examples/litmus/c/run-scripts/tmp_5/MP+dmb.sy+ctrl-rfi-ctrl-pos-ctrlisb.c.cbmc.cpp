...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !153, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !199
  ...
  //   store i32 0, i32* @atom_1_X4_1, align 4, !dbg !102, !tbaa !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !166, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !169, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !171, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !174, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !176, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !178, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !179, metadata !DIExpression()), !dbg !188
  ...
  //   %8 = load i32, i32* @atom_1_X4_1, align 4, !dbg !125, !tbaa !98
  // LD: Guess
  old_cr = cr(0,5);
