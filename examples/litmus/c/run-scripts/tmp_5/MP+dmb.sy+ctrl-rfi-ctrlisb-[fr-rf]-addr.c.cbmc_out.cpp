...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !108), !dbg !121

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i64 1, metadata !69, metadata !DIExpression()), !dbg !122

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !124

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   %conv4 = trunc i64 %1 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !70, metadata !DIExpression()), !dbg !110

  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !108

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !110
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !109), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !134

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !77, metadata !DIExpression()), !dbg !134

  //   %conv11 = trunc i64 %2 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !74, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !79, metadata !DIExpression()), !dbg !137

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !119
  // LD: Guess
  old_cr = cr(2,0+3*1);
  cr(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !137

  //   %conv15 = trunc i64 %3 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !78, metadata !DIExpression()), !dbg !110

  //   %xor = xor i32 %conv15, %conv15, !dbg !121
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !82, metadata !DIExpression()), !dbg !110
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !122
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ASSUME(creg_r6 >= creg_r5);
  ASSUME(active[creg_r6] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !84, metadata !DIExpression()), !dbg !142

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !122
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !86, metadata !DIExpression()), !dbg !142

  //   %conv19 = trunc i64 %4 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !83, metadata !DIExpression()), !dbg !110

  //   %cmp = icmp eq i32 %conv, 1, !dbg !125

  //   %conv20 = zext i1 %cmp to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !87, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !145

  //   %5 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !145
  ...
  //   %cmp24 = icmp eq i32 %conv4, 1, !dbg !128

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !91, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !92, metadata !DIExpression()), !dbg !148

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %6, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !95, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !96, metadata !DIExpression()), !dbg !151

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !99, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !100, metadata !DIExpression()), !dbg !154

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !154
  ...
  //   %cmp39 = icmp eq i32 %conv19, 0, !dbg !137

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !103, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !104, metadata !DIExpression()), !dbg !157

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !106, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !139
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !163, metadata !DIExpression()), !dbg !170
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !180, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !181, metadata !DIExpression()), !dbg !263

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !182, metadata !DIExpression()), !dbg !265

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !186, metadata !DIExpression()), !dbg !267

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !187, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !188, metadata !DIExpression()), !dbg !270

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !191, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !197, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !203, metadata !DIExpression()), !dbg !280
  ...
  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !149
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !209, metadata !DIExpression()), !dbg !284

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !284

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !151
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !212, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !216, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !218, metadata !DIExpression()), !dbg !301

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !215, metadata !DIExpression()), !dbg !263

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !219, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !221, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !223, metadata !DIExpression()), !dbg !305

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !220, metadata !DIExpression()), !dbg !263

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !224, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !226, metadata !DIExpression()), !dbg !309
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !228, metadata !DIExpression()), !dbg !309

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !225, metadata !DIExpression()), !dbg !263

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !229, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !231, metadata !DIExpression()), !dbg !313
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !233, metadata !DIExpression()), !dbg !313

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !230, metadata !DIExpression()), !dbg !263

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !234, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !236, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !238, metadata !DIExpression()), !dbg !317

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !235, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !240, metadata !DIExpression()), !dbg !320
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !242, metadata !DIExpression()), !dbg !320

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !239, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !244, metadata !DIExpression()), !dbg !323
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !246, metadata !DIExpression()), !dbg !323

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !243, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !248, metadata !DIExpression()), !dbg !326
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !250, metadata !DIExpression()), !dbg !326

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !247, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !252, metadata !DIExpression()), !dbg !329
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !254, metadata !DIExpression()), !dbg !329

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !251, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !255, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !256, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !257, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !258, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !259, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !260, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !261, metadata !DIExpression()), !dbg !263

  //   %and67 = and i32 %conv22, %and66, !dbg !205
  creg_r28 = max(max(creg_r12,0),creg_r27);
  ASSUME(active[creg_r28] == 0);
  r28 = (r12==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !262, metadata !DIExpression()), !dbg !263
