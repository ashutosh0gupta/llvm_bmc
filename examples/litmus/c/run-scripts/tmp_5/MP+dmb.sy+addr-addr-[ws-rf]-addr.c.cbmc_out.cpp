...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !143, metadata !DIExpression()), !dbg !185
  ...
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l63_c16
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l63_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !157, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !160, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !161, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !167, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !169, metadata !DIExpression()), !dbg !216

  //   %conv22 = trunc i64 %8 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !166, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !170, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !175, metadata !DIExpression()), !dbg !179

  //   %and26 = and i32 %conv24, %and25, !dbg !135
  creg_r25 = max(creg__r19__1_,creg_r24);
  r25 = (r19==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !176, metadata !DIExpression()), !dbg !179

  //   %and27 = and i32 %conv18, %and26, !dbg !136
  creg_r26 = max(creg__r18__1_,creg_r25);
  r26 = (r18==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !177, metadata !DIExpression()), !dbg !179

  //   %and28 = and i32 %conv12, %and27, !dbg !137
  creg_r27 = max(creg__r17__2_,creg_r26);
  r27 = (r17==2) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !178, metadata !DIExpression()), !dbg !179
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 87, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !141
