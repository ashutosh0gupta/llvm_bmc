...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !109), !dbg !126
...
T2BLOCK7:
  ...
  //   %cmp26 = icmp eq i32 %conv8, 0, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !93, metadata !DIExpression()), !dbg !149
  ...
  //   %cmp31 = icmp eq i32 %conv12, 1, !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !97, metadata !DIExpression()), !dbg !152
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !204, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !207, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !217, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !222, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !227, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !236, metadata !DIExpression()), !dbg !311
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !240, metadata !DIExpression()), !dbg !314
