...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !121, metadata !DIExpression()), !dbg !133
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !142, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !145, metadata !DIExpression()), !dbg !157
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !203

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !205

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !207

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !209

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !177, metadata !DIExpression()), !dbg !211

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !178, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !179, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !182, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !185, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !188, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !191, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !197, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !198, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !200, metadata !DIExpression()), !dbg !203

  //   %and19 = and i32 %11, %and18, !dbg !134
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !201, metadata !DIExpression()), !dbg !203

  //   %and20 = and i32 %10, %and19, !dbg !135
  creg_r19 = max(creg_r11,creg_r18);
  r19 = r11 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !202, metadata !DIExpression()), !dbg !203
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 107, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !139
