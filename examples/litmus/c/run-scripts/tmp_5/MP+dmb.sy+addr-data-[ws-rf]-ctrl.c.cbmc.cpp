...
T2BLOCK4:
  ...
  //   %cmp17 = icmp eq i32 %conv11, 2, !dbg !99
  ...
  //   store i32 %conv18, i32* @atom_1_X7_2, align 4, !dbg !100, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X8_0, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X8_0, align 4, !dbg !132, !tbaa !101
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !141
