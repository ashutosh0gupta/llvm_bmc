...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !105
  ...
  //   %cmp18 = icmp eq i32 %conv8, 0, !dbg !101
  ...
  //   store i32 %conv19, i32* @atom_1_X5_0, align 4, !dbg !102, !tbaa !97
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv12, 1, !dbg !103
  ...
  //   store i32 %conv21, i32* @atom_1_X7_1, align 4, !dbg !104, !tbaa !97
  // ST: Guess
  ...
  //   store i32 %conv23, i32* @atom_1_X8_1, align 4, !dbg !106, !tbaa !97
  // ST: Guess
