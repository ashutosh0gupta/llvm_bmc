...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !198

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !200

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !202

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !165, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !166, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !169, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !172, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !185, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !186, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !190, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !195, metadata !DIExpression()), !dbg !198

  //   %and22 = and i32 %conv20, %and21, !dbg !130
  creg_r23 = max(creg__r17__1_,creg_r22);
  r23 = (r17==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !196, metadata !DIExpression()), !dbg !198

  //   %and23 = and i32 %conv14, %and22, !dbg !131
  creg_r24 = max(creg__r16__2_,creg_r23);
  r24 = (r16==2) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !197, metadata !DIExpression()), !dbg !198
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !135
