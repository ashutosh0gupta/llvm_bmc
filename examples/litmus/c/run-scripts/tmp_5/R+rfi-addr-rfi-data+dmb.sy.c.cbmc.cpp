...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !48, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !51, metadata !DIExpression()), !dbg !69

  //   %xor7 = xor i32 %conv6, %conv6, !dbg !83
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 1);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !55, metadata !DIExpression()), !dbg !69

  //   %add8 = add nsw i32 %xor7, 1, !dbg !84
  creg_r6 = max(creg_r5,0);
  ASSUME(active[creg_r6] == 1);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add8, metadata !56, metadata !DIExpression()), !dbg !69
  ...
  //   %conv11 = sext i32 %add8 to i64, !dbg !86

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !59, metadata !DIExpression()), !dbg !85

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !60, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !61, metadata !DIExpression()), !dbg !88

  //   %2 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !63, metadata !DIExpression()), !dbg !88

  //   store atomic i64 %2, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !89
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv6, 1, !dbg !90

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !64, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_1, metadata !65, metadata !DIExpression()), !dbg !91

  //   %3 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !67, metadata !DIExpression()), !dbg !91

  //   store atomic i64 %3, i64* @atom_0_X6_1 seq_cst, align 8, !dbg !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !145, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_1, metadata !148, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !199

  //   store atomic i64 0, i64* @atom_0_X6_1 monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !151, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !170, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_1, metadata !174, metadata !DIExpression()), !dbg !228

  //   %8 = load atomic i64, i64* @atom_0_X6_1 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !178, metadata !DIExpression()), !dbg !231
