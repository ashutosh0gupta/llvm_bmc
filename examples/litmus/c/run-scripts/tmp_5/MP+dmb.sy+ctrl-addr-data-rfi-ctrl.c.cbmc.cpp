...
T2BLOCK7:
  ...
  //   %cmp27 = icmp eq i32 %conv15, 1, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !90, metadata !DIExpression()), !dbg !139

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %6, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !177, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !184, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !203, metadata !DIExpression()), !dbg !261
