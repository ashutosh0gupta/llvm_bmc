...
T2BLOCK4:
  ...
  //   %xor14 = xor i32 %conv13, %conv13, !dbg !111
  creg_r6 = max(creg_r5,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor14, metadata !82, metadata !DIExpression()), !dbg !105

  //   %add16 = add nsw i32 0, %xor14, !dbg !112
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 0 + r6;

  //   %idxprom = sext i32 %add16 to i64, !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !84, metadata !DIExpression()), !dbg !132

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !92, metadata !DIExpression()), !dbg !138

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %6, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !120
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv9, 1, !dbg !121
  ...
  //   store atomic i64 %7, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !100, metadata !DIExpression()), !dbg !144

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %8, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !126
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !190, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !196, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !219, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !227, metadata !DIExpression()), !dbg !293
