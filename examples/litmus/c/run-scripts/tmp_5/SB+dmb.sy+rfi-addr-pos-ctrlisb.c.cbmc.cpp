...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !87, metadata !DIExpression()), !dbg !114

  //   %conv12 = trunc i64 %3 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !84, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !88, metadata !DIExpression()), !dbg !92

  //   store i32 %conv13, i32* @atom_1_X2_1, align 4, !dbg !90, !tbaa !91
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv12, 0, !dbg !95
  creg__r7__0_ = max(0,creg_r7);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !89, metadata !DIExpression()), !dbg !92

  //   store i32 %conv15, i32* @atom_1_X7_0, align 4, !dbg !96, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !129, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !130, metadata !DIExpression()), !dbg !162

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !131, metadata !DIExpression()), !dbg !164

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !135, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !146, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !148, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !149, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !153, metadata !DIExpression()), !dbg !188

  //   %conv12 = trunc i64 %5 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !150, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !154, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !159, metadata !DIExpression()), !dbg !162

  //   %and16 = and i32 %conv14, %and15, !dbg !114
  creg_r18 = max(creg__r12__1_,creg_r17);
  r18 = (r12==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !160, metadata !DIExpression()), !dbg !162

  //   %and17 = and i32 %conv8, %and16, !dbg !115
  creg_r19 = max(creg__r11__1_,creg_r18);
  r19 = (r11==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !161, metadata !DIExpression()), !dbg !162
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !119
