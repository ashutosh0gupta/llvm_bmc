...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !166, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !167, metadata !DIExpression()), !dbg !213

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !168, metadata !DIExpression()), !dbg !215

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !172, metadata !DIExpression()), !dbg !217

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !173, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !174, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !177, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !183, metadata !DIExpression()), !dbg !226
  ...
  //   store i32 0, i32* @atom_1_X2_1, align 4, !dbg !113, !tbaa !109
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X3_0, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !187, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !189, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !190, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !192, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !194, metadata !DIExpression()), !dbg !248

  //   %conv16 = trunc i64 %7 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !191, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !195, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !197, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !199, metadata !DIExpression()), !dbg !252

  //   %conv22 = trunc i64 %8 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !196, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !200, metadata !DIExpression()), !dbg !213
  ...
  //   %10 = load i32, i32* @atom_1_X2_1, align 4, !dbg !141, !tbaa !109
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X3_0, align 4, !dbg !142, !tbaa !109
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !207, metadata !DIExpression()), !dbg !213

  //   %and26 = and i32 %10, %and25, !dbg !147
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !208, metadata !DIExpression()), !dbg !213

  //   %and27 = and i32 %9, %and26, !dbg !148
  creg_r24 = max(creg_r16,creg_r23);
  r24 = r16 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !209, metadata !DIExpression()), !dbg !213

  //   %and28 = and i32 %conv24, %and27, !dbg !149
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !210, metadata !DIExpression()), !dbg !213

  //   %and29 = and i32 %conv18, %and28, !dbg !150
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !211, metadata !DIExpression()), !dbg !213

  //   %and30 = and i32 %conv12, %and29, !dbg !151
  creg_r27 = max(creg__r13__1_,creg_r26);
  r27 = (r13==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !212, metadata !DIExpression()), !dbg !213
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 103, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
