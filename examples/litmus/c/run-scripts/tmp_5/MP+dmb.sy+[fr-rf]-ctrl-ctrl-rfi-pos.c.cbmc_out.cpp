...
T2BLOCK4:
  ...
  //   %tobool9 = icmp ne i32 %conv8, 0, !dbg !102

  //   br i1 %tobool9, label %if.then10, label %if.else11, !dbg !104
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !127

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !129

  //   %conv15 = trunc i64 %3 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !76, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !132

  //   %conv19 = trunc i64 %4 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !80, metadata !DIExpression()), !dbg !103

  //   %cmp = icmp eq i32 %conv, 1, !dbg !116

  //   %conv20 = zext i1 %cmp to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !84, metadata !DIExpression()), !dbg !103
  ...
  //   %cmp24 = icmp eq i32 %conv4, 2, !dbg !119

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !88, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !89, metadata !DIExpression()), !dbg !139

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %6, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv15, 1, !dbg !122

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !92, metadata !DIExpression()), !dbg !103
  ...
  //   store atomic i64 %7, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !124
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv19, 1, !dbg !125

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !96, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !97, metadata !DIExpression()), !dbg !145
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !158
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !168, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !169, metadata !DIExpression()), !dbg !228

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !170, metadata !DIExpression()), !dbg !230

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !174, metadata !DIExpression()), !dbg !232

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !175, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !176, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !179, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !185, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !188, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !191, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !194, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !198, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !200, metadata !DIExpression()), !dbg !262

  //   %conv = trunc i64 %6 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !197, metadata !DIExpression()), !dbg !228

  //   %cmp = icmp eq i32 %conv, 2, !dbg !141

  //   %conv18 = zext i1 %cmp to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !201, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !203, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !205, metadata !DIExpression()), !dbg !266

  //   %conv22 = trunc i64 %7 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !202, metadata !DIExpression()), !dbg !228

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !145

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !206, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !208, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !210, metadata !DIExpression()), !dbg !270

  //   %conv28 = trunc i64 %8 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !207, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !212, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !214, metadata !DIExpression()), !dbg !273

  //   %conv32 = trunc i64 %9 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !211, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !216, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !218, metadata !DIExpression()), !dbg !276

  //   %conv36 = trunc i64 %10 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !215, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !220, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !222, metadata !DIExpression()), !dbg !279

  //   %conv40 = trunc i64 %11 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !219, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !224, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !225, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !226, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !227, metadata !DIExpression()), !dbg !228
