...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv16, %conv16, !dbg !109
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !104
  ...
  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,r7);
