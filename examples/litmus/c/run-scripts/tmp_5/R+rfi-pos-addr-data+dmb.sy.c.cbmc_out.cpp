...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !53, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !55, metadata !DIExpression()), !dbg !83

  //   %conv8 = trunc i64 %2 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !52, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !56, metadata !DIExpression()), !dbg !70

  //   %add10 = add nsw i32 %xor9, 1, !dbg !86
  creg_r7 = max(creg_r6,0);
  ASSUME(active[creg_r7] == 1);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !57, metadata !DIExpression()), !dbg !70
  ...
  //   %conv13 = sext i32 %add10 to i64, !dbg !88

  //   call void @llvm.dbg.value(metadata i64 %conv13, metadata !60, metadata !DIExpression()), !dbg !87

  //   store atomic i64 %conv13, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !88
  // ST: Guess
  ...
  //   store atomic i64 %3, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !147, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !150, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !167, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !171, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !175, metadata !DIExpression()), !dbg !223
