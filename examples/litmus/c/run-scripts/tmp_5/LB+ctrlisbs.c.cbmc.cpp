...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !96
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !108, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !109, metadata !DIExpression()), !dbg !124

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !57

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !57

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !110, metadata !DIExpression()), !dbg !126

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !59

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !59

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !114, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !115, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !118, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64 0, metadata !120, metadata !DIExpression()), !dbg !131
  ...
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l58_c12
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([96 x i8], [96 x i8]* @.str.1, i64 0, i64 0), i32 noundef 60, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !85
