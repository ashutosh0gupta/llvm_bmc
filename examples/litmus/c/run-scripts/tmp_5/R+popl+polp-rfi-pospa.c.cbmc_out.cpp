...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !126, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !127, metadata !DIExpression()), !dbg !158

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !128, metadata !DIExpression()), !dbg !160

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !132, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !133, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !136, metadata !DIExpression()), !dbg !165
  ...
  //   store i32 0, i32* @atom_0_X4_2, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X6_2, align 4, !dbg !90, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X5_1, align 4, !dbg !92, !tbaa !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !143, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !144, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !148, metadata !DIExpression()), !dbg !158

  //   %6 = load i32, i32* @atom_0_X4_2, align 4, !dbg !109, !tbaa !86
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !149, metadata !DIExpression()), !dbg !158

  //   %7 = load i32, i32* @atom_1_X6_2, align 4, !dbg !110, !tbaa !86
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X4_1, align 4, !dbg !111, !tbaa !86
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X5_1, align 4, !dbg !112, !tbaa !86
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !154, metadata !DIExpression()), !dbg !158

  //   %and14 = and i32 %6, %and13, !dbg !115
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !155, metadata !DIExpression()), !dbg !158

  //   %and15 = and i32 %conv12, %and14, !dbg !116
  creg_r16 = max(creg__r8__2_,creg_r15);
  r16 = (r8==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !156, metadata !DIExpression()), !dbg !158

  //   %and16 = and i32 %conv6, %and15, !dbg !117
  creg_r17 = max(creg__r7__2_,creg_r16);
  r17 = (r7==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !157, metadata !DIExpression()), !dbg !158
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
