...
T2BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !94
  // ST: Guess
  iw(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0+3*1);
  cw(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !165, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !218

  //   store atomic i64 0, i64* @atom_1_X8_2 monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !191, metadata !DIExpression()), !dbg !247

  //   %8 = load atomic i64, i64* @atom_1_X8_2 seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,5);
