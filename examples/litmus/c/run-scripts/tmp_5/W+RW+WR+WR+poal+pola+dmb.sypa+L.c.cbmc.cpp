...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !82, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !84, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !86, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !88, metadata !DIExpression()), !dbg !101
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !160, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !203

  //   store atomic i64 0, i64* @atom_2_X2_0 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !176, metadata !DIExpression()), !dbg !230

  //   %10 = load atomic i64, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !134
  // LD: Guess
  old_cr = cr(0,4);
