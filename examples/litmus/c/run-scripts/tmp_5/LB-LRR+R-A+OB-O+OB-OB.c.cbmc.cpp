...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !59

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !60
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !48, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64 1, metadata !50, metadata !DIExpression()), !dbg !62

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !63
  // ST: Guess
  //   : Release
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !86

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !60
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !90

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !64
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !79, metadata !DIExpression()), !dbg !93
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !98, metadata !DIExpression()), !dbg !111
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !100, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !99, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !103, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64 1, metadata !105, metadata !DIExpression()), !dbg !118

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !64
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !106, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !107, metadata !DIExpression()), !dbg !121

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !109, metadata !DIExpression()), !dbg !121
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !126, metadata !DIExpression()), !dbg !144
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !128, metadata !DIExpression()), !dbg !147

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(4,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !130, metadata !DIExpression()), !dbg !147

  //   %conv = trunc i64 %0 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !127, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !132, metadata !DIExpression()), !dbg !151

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !69
  // LD: Guess
  old_cr = cr(4,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !134, metadata !DIExpression()), !dbg !151

  //   %conv4 = trunc i64 %1 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !131, metadata !DIExpression()), !dbg !144

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !71

  //   %conv5 = zext i1 %cmp to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !135, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !136, metadata !DIExpression()), !dbg !155

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !138, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !139, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !140, metadata !DIExpression()), !dbg !158

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !142, metadata !DIExpression()), !dbg !158
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64 1, metadata !166, metadata !DIExpression()), !dbg !171

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !51
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !181, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !182, metadata !DIExpression()), !dbg !242

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !183, metadata !DIExpression()), !dbg !244

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !187, metadata !DIExpression()), !dbg !246

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !188, metadata !DIExpression()), !dbg !248

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !189, metadata !DIExpression()), !dbg !250

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !190, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !191, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !253

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !194, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !255

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !257

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !200, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !259

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !203, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !261

  //   store atomic i64 0, i64* @atom_0_X0_1 monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !206, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !263

  //   store atomic i64 0, i64* @atom_3_X2_0 monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !209, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !212, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !214, metadata !DIExpression()), !dbg !267

  //   store atomic i64 0, i64* @atom_2_X0_1 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !215, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !217, metadata !DIExpression()), !dbg !269
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !137
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !138
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call19 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !139
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call20 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #7, !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr0, align 8, !dbg !141, !tbaa !142
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %6 = load i64, i64* %thr1, align 8, !dbg !147, !tbaa !142
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   %call22 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !148
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr2, align 8, !dbg !149, !tbaa !142
  // LD: Guess
  old_cr = cr(0,11);
  ...
  //   %call23 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !150
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load i64, i64* %thr3, align 8, !dbg !151, !tbaa !142
  // LD: Guess
  old_cr = cr(0,12);
  ...
  //   %call24 = call i32 @pthread_join(i64 noundef %8, i8** noundef null), !dbg !152
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %9 = load i64, i64* %thr4, align 8, !dbg !153, !tbaa !142
  // LD: Guess
  old_cr = cr(0,13);
  ...
  //   %call25 = call i32 @pthread_join(i64 noundef %9, i8** noundef null), !dbg !154
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !219, metadata !DIExpression()), !dbg !290

  //   %10 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !156
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !221, metadata !DIExpression()), !dbg !290

  //   %conv = trunc i64 %10 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !218, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !223, metadata !DIExpression()), !dbg !293

  //   %11 = load atomic i64, i64* @atom_3_X2_0 seq_cst, align 8, !dbg !159
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !225, metadata !DIExpression()), !dbg !293

  //   %conv29 = trunc i64 %11 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !222, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !227, metadata !DIExpression()), !dbg !296

  //   %12 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !162
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !229, metadata !DIExpression()), !dbg !296

  //   %conv33 = trunc i64 %12 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !226, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !231, metadata !DIExpression()), !dbg !299

  //   %13 = load atomic i64, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !233, metadata !DIExpression()), !dbg !299

  //   %conv37 = trunc i64 %13 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv37, metadata !230, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !235, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !237, metadata !DIExpression()), !dbg !302

  //   %conv41 = trunc i64 %14 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv41, metadata !234, metadata !DIExpression()), !dbg !242

  //   %and = and i32 %conv37, %conv41, !dbg !170
  creg_r16 = max(creg_r14,creg_r15);
  ASSUME(active[creg_r16] == 0);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !238, metadata !DIExpression()), !dbg !242

  //   %and42 = and i32 %conv33, %and, !dbg !171
  creg_r17 = max(creg_r13,creg_r16);
  ASSUME(active[creg_r17] == 0);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !239, metadata !DIExpression()), !dbg !242

  //   %and43 = and i32 %conv29, %and42, !dbg !172
  creg_r18 = max(creg_r12,creg_r17);
  ASSUME(active[creg_r18] == 0);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !240, metadata !DIExpression()), !dbg !242

  //   %and44 = and i32 %conv, %and43, !dbg !173
  creg_r19 = max(creg_r11,creg_r18);
  ASSUME(active[creg_r19] == 0);
  r19 = r11 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !241, metadata !DIExpression()), !dbg !242

  //   %cmp = icmp eq i32 %and44, 1, !dbg !174
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 106, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %16) #7, !dbg !180

  //   %17 = bitcast i64* %thr2 to i8*, !dbg !180

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %17) #7, !dbg !180
