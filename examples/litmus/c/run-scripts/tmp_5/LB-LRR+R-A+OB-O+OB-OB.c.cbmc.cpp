...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !87
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !96, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !99, metadata !DIExpression()), !dbg !111
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !118, metadata !DIExpression()), !dbg !130
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !120, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !122, metadata !DIExpression()), !dbg !133

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !119, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !124, metadata !DIExpression()), !dbg !137

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(4,0+1*1);
  cr(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l54_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !123, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !127, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !128, metadata !DIExpression()), !dbg !130
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !165, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !166, metadata !DIExpression()), !dbg !196

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !167, metadata !DIExpression()), !dbg !198

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !171, metadata !DIExpression()), !dbg !200

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !172, metadata !DIExpression()), !dbg !202

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !173, metadata !DIExpression()), !dbg !204

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !174, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !175, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !178, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !181, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !184, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !213
  ...
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l79_c15
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l79_c15
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l97_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !190, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !191, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !193, metadata !DIExpression()), !dbg !196

  //   %and17 = and i32 %11, %and16, !dbg !129
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !194, metadata !DIExpression()), !dbg !196

  //   %and18 = and i32 %10, %and17, !dbg !130
  creg_r19 = max(creg_r11,creg_r18);
  r19 = r11 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !195, metadata !DIExpression()), !dbg !196
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 106, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !134
