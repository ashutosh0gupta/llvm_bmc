...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X0_1, align 4, !dbg !72, !tbaa !73
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !77, !tbaa !73
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !78, !tbaa !73
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X0_1, align 4, !dbg !90, !tbaa !73
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !91, !tbaa !73
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_2_X0_1, align 4, !dbg !92, !tbaa !73
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !98
