...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !161, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !163, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !164, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !168, metadata !DIExpression()), !dbg !220

  //   %conv14 = trunc i64 %5 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !165, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !169, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !171, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !173, metadata !DIExpression()), !dbg !224

  //   %conv20 = trunc i64 %6 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !170, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !174, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !176, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !178, metadata !DIExpression()), !dbg !228

  //   %conv26 = trunc i64 %7 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !175, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !185, metadata !DIExpression()), !dbg !191

  //   %and30 = and i32 %8, %and29, !dbg !145
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !186, metadata !DIExpression()), !dbg !191

  //   %and31 = and i32 %conv28, %and30, !dbg !146
  creg_r23 = max(creg__r15__1_,creg_r22);
  r23 = (r15==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !187, metadata !DIExpression()), !dbg !191

  //   %and32 = and i32 %conv22, %and31, !dbg !147
  creg_r24 = max(creg__r14__1_,creg_r23);
  r24 = (r14==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !188, metadata !DIExpression()), !dbg !191

  //   %and33 = and i32 %conv16, %and32, !dbg !148
  creg_r25 = max(creg__r13__1_,creg_r24);
  r25 = (r13==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !189, metadata !DIExpression()), !dbg !191

  //   %and34 = and i32 %conv10, %and33, !dbg !149
  creg_r26 = max(creg__r12__1_,creg_r25);
  r26 = (r12==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !190, metadata !DIExpression()), !dbg !191
