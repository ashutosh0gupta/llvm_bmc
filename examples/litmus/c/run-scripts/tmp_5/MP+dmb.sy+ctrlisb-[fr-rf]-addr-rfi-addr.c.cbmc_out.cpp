...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !94), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !83, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !85, metadata !DIExpression()), !dbg !122

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,r9);
  cr(2,r9) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l41_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !87, metadata !DIExpression()), !dbg !122

  //   %conv20 = trunc i64 %4 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !84, metadata !DIExpression()), !dbg !95

  //   %cmp = icmp eq i32 %conv, 1, !dbg !105
  creg__r0__1_ = max(0,creg_r0);

  //   %conv21 = zext i1 %cmp to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !88, metadata !DIExpression()), !dbg !95

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !106, !tbaa !107
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 0, !dbg !111
  creg__r1__0_ = max(0,creg_r1);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !89, metadata !DIExpression()), !dbg !95

  //   store i32 %conv23, i32* @atom_1_X2_0, align 4, !dbg !112, !tbaa !107
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 1, !dbg !113
  creg__r2__1_ = max(0,creg_r2);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !90, metadata !DIExpression()), !dbg !95

  //   store i32 %conv25, i32* @atom_1_X4_1, align 4, !dbg !114, !tbaa !107
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv12, 1, !dbg !115
  creg__r6__1_ = max(0,creg_r6);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !91, metadata !DIExpression()), !dbg !95

  //   store i32 %conv27, i32* @atom_1_X8_1, align 4, !dbg !116, !tbaa !107
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv20, 0, !dbg !117
  creg__r10__0_ = max(0,creg_r10);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !92, metadata !DIExpression()), !dbg !95

  //   store i32 %conv29, i32* @atom_1_X10_0, align 4, !dbg !118, !tbaa !107
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !159, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !160, metadata !DIExpression()), !dbg !212

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !161, metadata !DIExpression()), !dbg !214

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !165, metadata !DIExpression()), !dbg !216

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !166, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !167, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !176, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !225
  ...
  //   store i32 0, i32* @atom_1_X10_0, align 4, !dbg !122, !tbaa !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !180, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !182, metadata !DIExpression()), !dbg !243

  //   %conv = trunc i64 %6 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !179, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !183, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !185, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !187, metadata !DIExpression()), !dbg !247

  //   %conv16 = trunc i64 %7 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !184, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !188, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !190, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !192, metadata !DIExpression()), !dbg !251

  //   %conv22 = trunc i64 %8 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !189, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !193, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !195, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !197, metadata !DIExpression()), !dbg !255

  //   %conv28 = trunc i64 %9 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !194, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !198, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !199, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !200, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !201, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !202, metadata !DIExpression()), !dbg !212

  //   %14 = load i32, i32* @atom_1_X10_0, align 4, !dbg !154, !tbaa !115
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !203, metadata !DIExpression()), !dbg !212

  //   %and = and i32 %13, %14, !dbg !155
  creg_r24 = max(creg_r22,creg_r23);
  r24 = r22 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !204, metadata !DIExpression()), !dbg !212

  //   %and31 = and i32 %12, %and, !dbg !156
  creg_r25 = max(creg_r21,creg_r24);
  r25 = r21 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !205, metadata !DIExpression()), !dbg !212

  //   %and32 = and i32 %11, %and31, !dbg !157
  creg_r26 = max(creg_r20,creg_r25);
  r26 = r20 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !206, metadata !DIExpression()), !dbg !212

  //   %and33 = and i32 %10, %and32, !dbg !158
  creg_r27 = max(creg_r19,creg_r26);
  r27 = r19 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !207, metadata !DIExpression()), !dbg !212

  //   %and34 = and i32 %conv30, %and33, !dbg !159
  creg_r28 = max(creg__r18__1_,creg_r27);
  r28 = (r18==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !208, metadata !DIExpression()), !dbg !212

  //   %and35 = and i32 %conv24, %and34, !dbg !160
  creg_r29 = max(creg__r17__1_,creg_r28);
  r29 = (r17==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !209, metadata !DIExpression()), !dbg !212

  //   %and36 = and i32 %conv18, %and35, !dbg !161
  creg_r30 = max(creg__r16__1_,creg_r29);
  r30 = (r16==1) & r29;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !210, metadata !DIExpression()), !dbg !212

  //   %and37 = and i32 %conv12, %and36, !dbg !162
  creg_r31 = max(creg__r15__1_,creg_r30);
  r31 = (r15==1) & r30;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !211, metadata !DIExpression()), !dbg !212
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 105, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
