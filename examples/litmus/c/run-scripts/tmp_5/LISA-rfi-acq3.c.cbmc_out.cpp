...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !60, metadata !DIExpression()), !dbg !92
  ...
  //   %and = and i32 %conv, 128, !dbg !76
  creg_r1 = max(creg_r0,0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !63, metadata !DIExpression()), !dbg !89

  //   %add = add nsw i32 %and, 1, !dbg !77
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !81
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+2*1);
  ...
  //   %conv5 = trunc i64 %2 to i32, !dbg !82
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   %conv9 = trunc i64 %3 to i32, !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !76, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !77, metadata !DIExpression()), !dbg !106

  //   %4 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !79, metadata !DIExpression()), !dbg !106

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !80, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !81, metadata !DIExpression()), !dbg !109

  //   %5 = zext i32 %conv15 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !83, metadata !DIExpression()), !dbg !109

  //   store atomic i64 %5, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !84, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !85, metadata !DIExpression()), !dbg !112

  //   %6 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !87, metadata !DIExpression()), !dbg !112

  //   store atomic i64 %6, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !141, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !144, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !150, metadata !DIExpression()), !dbg !188

  //   %conv = trunc i64 %4 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !147, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !152, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !154, metadata !DIExpression()), !dbg !191

  //   %conv17 = trunc i64 %5 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !151, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !156, metadata !DIExpression()), !dbg !194

  //   %6 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !158, metadata !DIExpression()), !dbg !194
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !122
