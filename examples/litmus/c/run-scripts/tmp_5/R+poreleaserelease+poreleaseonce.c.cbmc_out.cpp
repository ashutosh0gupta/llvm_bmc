...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !85, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !86, metadata !DIExpression()), !dbg !105

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !59

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !59

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !87, metadata !DIExpression()), !dbg !107

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !61

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !61

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !91, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !92, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 0, metadata !94, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64 0, metadata !97, metadata !DIExpression()), !dbg !112
  ...
  //   store i32 0, i32* @atom_1_X1_0, align 4, !dbg !67, !tbaa !68
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l39_c15
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l39_c15
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !72
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call3 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !73
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !99, metadata !DIExpression()), !dbg !123

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !101, metadata !DIExpression()), !dbg !123

  //   %conv = trunc i64 %4 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !98, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !102, metadata !DIExpression()), !dbg !105

  //   %5 = load i32, i32* @atom_1_X1_0, align 4, !dbg !84, !tbaa !68
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !103, metadata !DIExpression()), !dbg !105

  //   %and = and i32 %conv6, %5, !dbg !85
  creg_r6 = max(creg__r4__2_,creg_r5);
  r6 = (r4==2) & r5;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !104, metadata !DIExpression()), !dbg !105
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 51, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !89
