...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !60, metadata !DIExpression()), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !63, metadata !DIExpression()), !dbg !73
...
T2BLOCK2:
  //   br label %lbl_label110, !dbg !64
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label110, !dbg !65
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !72), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !67, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !68, metadata !DIExpression()), !dbg !89
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !94, metadata !DIExpression()), !dbg !112
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !96, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !98, metadata !DIExpression()), !dbg !115

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !95, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !100, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !104, metadata !DIExpression()), !dbg !122

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !106, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !108, metadata !DIExpression()), !dbg !125

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !110, metadata !DIExpression()), !dbg !125
