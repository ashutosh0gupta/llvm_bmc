...
T2BLOCK4:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !69, metadata !DIExpression()), !dbg !88

  //   %tobool7 = icmp ne i32 %conv6, 0, !dbg !88
  creg__r1__0_ = max(0,creg_r1);

  //   br i1 %tobool7, label %if.then8, label %if.else9, !dbg !90
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  ...
  //   store i32 %conv23, i32* @atom_1_X5_2, align 4, !dbg !114, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X5_2, align 4, !dbg !102, !tbaa !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !164, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !174, metadata !DIExpression()), !dbg !218
  ...
  //   %cmp21 = icmp eq i32 %conv20, 2, !dbg !123
  ...
  //   %8 = load i32, i32* @atom_1_X5_2, align 4, !dbg !125, !tbaa !98
  // LD: Guess
  old_cr = cr(0,5);
