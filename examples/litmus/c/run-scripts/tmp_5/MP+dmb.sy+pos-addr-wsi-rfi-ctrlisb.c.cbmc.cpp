...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !108

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !68, metadata !DIExpression()), !dbg !108

  //   %conv4 = trunc i64 %1 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !70, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64 1, metadata !72, metadata !DIExpression()), !dbg !113

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64 2, metadata !75, metadata !DIExpression()), !dbg !114

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !96
  // ST: Guess
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !89, metadata !DIExpression()), !dbg !133

  //   %5 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %5, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv10, 2, !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !93, metadata !DIExpression()), !dbg !136
...
T0BLOCK0:
  ...
  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !171, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !229

  //   store atomic i64 0, i64* @atom_1_X7_2 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv26, 2, !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !197, metadata !DIExpression()), !dbg !258

  //   %8 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !154
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !201, metadata !DIExpression()), !dbg !261

  //   %9 = load atomic i64, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,5);
