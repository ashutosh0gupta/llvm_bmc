...
T2BLOCK10:
  ...
  //   %cmp24 = icmp eq i32 %conv13, 1, !dbg !118
  ...
  //   store i32 %conv25, i32* @atom_1_X7_1, align 4, !dbg !119, !tbaa !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !149, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !150, metadata !DIExpression()), !dbg !199

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !151, metadata !DIExpression()), !dbg !201

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !155, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !156, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !169, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !171, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !172, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !176, metadata !DIExpression()), !dbg !228

  //   %conv14 = trunc i64 %5 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !173, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !187, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !193, metadata !DIExpression()), !dbg !199

  //   %and30 = and i32 %8, %and29, !dbg !145
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !194, metadata !DIExpression()), !dbg !199

  //   %and31 = and i32 %conv28, %and30, !dbg !146
  creg_r18 = max(creg__r10__1_,creg_r17);
  r18 = (r10==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !195, metadata !DIExpression()), !dbg !199

  //   %and32 = and i32 %conv22, %and31, !dbg !147
  creg_r19 = max(creg__r9__1_,creg_r18);
  r19 = (r9==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !196, metadata !DIExpression()), !dbg !199

  //   %and33 = and i32 %conv16, %and32, !dbg !148
  creg_r20 = max(creg__r8__1_,creg_r19);
  r20 = (r8==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !197, metadata !DIExpression()), !dbg !199

  //   %and34 = and i32 %conv10, %and33, !dbg !149
  creg_r21 = max(creg__r7__1_,creg_r20);
  r21 = (r7==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !198, metadata !DIExpression()), !dbg !199
