...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !64, metadata !DIExpression()), !dbg !75
  ...
  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !65
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !71, metadata !DIExpression()), !dbg !86

  //   %conv6 = trunc i64 %1 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !68, metadata !DIExpression()), !dbg !75
  ...
  //   store i32 %conv9, i32* @atom_1_X6_1, align 4, !dbg !77, !tbaa !72
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X6_1, align 4, !dbg !82, !tbaa !78
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X6_1, align 4, !dbg !100, !tbaa !78
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !107
