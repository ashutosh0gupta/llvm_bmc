...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !93
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !114

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,r4);
  cr(2,r4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l37_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !114

  //   %conv8 = trunc i64 %2 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !75, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !80, metadata !DIExpression()), !dbg !116

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !79, metadata !DIExpression()), !dbg !95
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !94), !dbg !124

  //   call void (...) @isb(), !dbg !106
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !126

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !86, metadata !DIExpression()), !dbg !126
  ...
  //   %cmp23 = icmp eq i32 %conv8, 0, !dbg !118
  ...
  //   store i32 %conv24, i32* @atom_1_X6_0, align 4, !dbg !119, !tbaa !112
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv12, 1, !dbg !120
  ...
  //   store i32 %conv26, i32* @atom_1_X8_1, align 4, !dbg !121, !tbaa !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X6_0, align 4, !dbg !120, !tbaa !115
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X8_1, align 4, !dbg !121, !tbaa !115
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X6_0, align 4, !dbg !152, !tbaa !115
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %13 = load i32, i32* @atom_1_X8_1, align 4, !dbg !153, !tbaa !115
  // LD: Guess
  old_cr = cr(0,7);
