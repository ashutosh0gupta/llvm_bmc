...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !108
  creg_r2 = max(creg_r1,creg_r1);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !110

  //   %add = add nsw i32 3, %xor, !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !129

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(2,r4);
  ...
  //   %conv8 = trunc i64 %2 to i32, !dbg !111
  ...
  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !115

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !117
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !109), !dbg !139
