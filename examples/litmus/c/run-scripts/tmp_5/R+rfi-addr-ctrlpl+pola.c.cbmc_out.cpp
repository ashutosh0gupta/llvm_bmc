...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !52, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64 1, metadata !54, metadata !DIExpression()), !dbg !81

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !82
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !56, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !55, metadata !DIExpression()), !dbg !63
  ...
  //   store i32 %conv11, i32* @atom_0_X8_2, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv, 1, !dbg !92
  ...
  //   store i32 %conv13, i32* @atom_0_X2_1, align 4, !dbg !93, !tbaa !88
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !102, metadata !DIExpression()), !dbg !112
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !132, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !135, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !138, metadata !DIExpression()), !dbg !167
  ...
  //   store i32 0, i32* @atom_0_X8_2, align 4, !dbg !86, !tbaa !87
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X2_1, align 4, !dbg !91, !tbaa !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !144, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !145, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !147, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !149, metadata !DIExpression()), !dbg !184

  //   %conv12 = trunc i64 %5 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !146, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !150, metadata !DIExpression()), !dbg !158

  //   %6 = load i32, i32* @atom_0_X8_2, align 4, !dbg !109, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_0_X2_1, align 4, !dbg !110, !tbaa !87
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !155, metadata !DIExpression()), !dbg !158

  //   %and16 = and i32 %conv14, %and15, !dbg !114
  creg_r17 = max(creg__r11__2_,creg_r16);
  r17 = (r11==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !156, metadata !DIExpression()), !dbg !158

  //   %and17 = and i32 %conv8, %and16, !dbg !115
  creg_r18 = max(creg__r10__1_,creg_r17);
  r18 = (r10==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !157, metadata !DIExpression()), !dbg !158
