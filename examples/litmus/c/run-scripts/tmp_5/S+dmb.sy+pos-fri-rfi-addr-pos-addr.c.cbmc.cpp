...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !91
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !109

  //   %conv16 = trunc i64 %4 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !79, metadata !DIExpression()), !dbg !91

  //   %xor17 = xor i32 %conv16, %conv16, !dbg !93
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !83, metadata !DIExpression()), !dbg !91
  ...
  //   %arrayidx21 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !94
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !84, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64 1, metadata !86, metadata !DIExpression()), !dbg !114

  //   store atomic i64 1, i64* %arrayidx21 monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   %conv23 = zext i1 %cmp to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv23, i32* @atom_1_X0_1, align 4, !dbg !97, !tbaa !98
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv4, 1, !dbg !102
  ...
  //   store i32 %conv25, i32* @atom_1_X2_1, align 4, !dbg !103, !tbaa !98
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv8, 2, !dbg !104
  ...
  //   store i32 %conv27, i32* @atom_1_X4_2, align 4, !dbg !105, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !133, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !134, metadata !DIExpression()), !dbg !166

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !135, metadata !DIExpression()), !dbg !168

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !139, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !140, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !143, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !146, metadata !DIExpression()), !dbg !175
  ...
  //   store i32 0, i32* @atom_1_X4_2, align 4, !dbg !92, !tbaa !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !150, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !152, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !153, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !155, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !157, metadata !DIExpression()), !dbg !192

  //   %conv12 = trunc i64 %5 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !154, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !158, metadata !DIExpression()), !dbg !166

  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !109, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X4_2, align 4, !dbg !111, !tbaa !87
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !163, metadata !DIExpression()), !dbg !166

  //   %and16 = and i32 %conv14, %and15, !dbg !114
  creg_r21 = max(creg__r15__2_,creg_r20);
  r21 = (r15==2) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !164, metadata !DIExpression()), !dbg !166

  //   %and17 = and i32 %conv8, %and16, !dbg !115
  creg_r22 = max(creg__r14__2_,creg_r21);
  r22 = (r14==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !165, metadata !DIExpression()), !dbg !166
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !119
