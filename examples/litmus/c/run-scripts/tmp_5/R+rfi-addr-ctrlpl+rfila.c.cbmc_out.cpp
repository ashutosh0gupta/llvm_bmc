...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !49, metadata !DIExpression()), !dbg !71

  //   %add = add nsw i32 1, %xor, !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !50, metadata !DIExpression()), !dbg !71
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !70), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !54, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64 1, metadata !56, metadata !DIExpression()), !dbg !89

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !90
  // ST: Guess
  //   : Release
  iw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !58, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !57, metadata !DIExpression()), !dbg !71

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !94

  //   %conv11 = zext i1 %cmp to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !61, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !62, metadata !DIExpression()), !dbg !95

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !64, metadata !DIExpression()), !dbg !95
  ...
  //   %cmp15 = icmp eq i32 %conv, 3, !dbg !97

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !65, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !66, metadata !DIExpression()), !dbg !98

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !68, metadata !DIExpression()), !dbg !98

  //   store atomic i64 %4, i64* @atom_0_X2_3 seq_cst, align 8, !dbg !99
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !103, metadata !DIExpression()), !dbg !124
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !106, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !108, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !107, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !116, metadata !DIExpression()), !dbg !136

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !118, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !119, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !120, metadata !DIExpression()), !dbg !139

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !122, metadata !DIExpression()), !dbg !139
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !156, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !162, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !165, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !171, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !175, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !178, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !180, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !179, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !184, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !186, metadata !DIExpression()), !dbg !233

  //   %conv22 = trunc i64 %6 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !183, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !188, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !190, metadata !DIExpression()), !dbg !236

  //   %conv26 = trunc i64 %7 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !187, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !192, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !194, metadata !DIExpression()), !dbg !239

  //   %conv30 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !191, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !196, metadata !DIExpression()), !dbg !199
