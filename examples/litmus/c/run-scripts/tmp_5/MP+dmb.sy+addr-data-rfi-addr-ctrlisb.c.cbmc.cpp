...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !147, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !150, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !153, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !156, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !159, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !163, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !165, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !166, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !168, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !170, metadata !DIExpression()), !dbg !215

  //   %conv16 = trunc i64 %5 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !167, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !171, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !175, metadata !DIExpression()), !dbg !219

  //   %conv22 = trunc i64 %6 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !172, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !176, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !181, metadata !DIExpression()), !dbg !185

  //   %and26 = and i32 %conv24, %and25, !dbg !134
  creg_r24 = max(creg__r18__1_,creg_r23);
  r24 = (r18==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !182, metadata !DIExpression()), !dbg !185
