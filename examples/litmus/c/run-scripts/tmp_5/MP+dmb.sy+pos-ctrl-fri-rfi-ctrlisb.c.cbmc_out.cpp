...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv4, 0, !dbg !99
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !107), !dbg !123
...
T2BLOCK7:
  ...
  //   %cmp24 = icmp eq i32 %conv4, 1, !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !91, metadata !DIExpression()), !dbg !146

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %6, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !128
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !184, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !251

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !187, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !253

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !216, metadata !DIExpression()), !dbg !284

  //   %8 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !166
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !220, metadata !DIExpression()), !dbg !287

  //   %9 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !169
  // LD: Guess
  old_cr = cr(0,5);
