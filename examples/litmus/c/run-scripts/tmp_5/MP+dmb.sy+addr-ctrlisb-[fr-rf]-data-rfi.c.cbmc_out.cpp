...
T2BLOCK4:
  ...
  //   %add14 = add nsw i32 %xor13, 1, !dbg !98
  creg_r8 = max(0,creg_r7);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add14, metadata !79, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !118

  //   %conv15 = sext i32 %add14 to i64, !dbg !100

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !82, metadata !DIExpression()), !dbg !118

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv8, 0, !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X5_0, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv12, 1, !dbg !112
  ...
  //   store i32 %conv24, i32* @atom_1_X7_1, align 4, !dbg !113, !tbaa !106
  // ST: Guess
