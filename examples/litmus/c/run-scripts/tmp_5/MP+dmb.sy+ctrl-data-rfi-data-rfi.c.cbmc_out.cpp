...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !68, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !69, metadata !DIExpression()), !dbg !107

  //   %conv5 = sext i32 %add to i64, !dbg !89

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !71, metadata !DIExpression()), !dbg !107

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv9, 1, !dbg !106
  ...
  //   store i32 %conv21, i32* @atom_1_X6_1, align 4, !dbg !107, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !144, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !147, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !190
  ...
  //   store i32 0, i32* @atom_1_X6_1, align 4, !dbg !102, !tbaa !98
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X9_1, align 4, !dbg !103, !tbaa !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !167, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !169, metadata !DIExpression()), !dbg !211
  ...
  //   %8 = load i32, i32* @atom_1_X6_1, align 4, !dbg !125, !tbaa !98
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %9 = load i32, i32* @atom_1_X9_1, align 4, !dbg !126, !tbaa !98
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !135
