...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !54, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !55, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64 1, metadata !57, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !58, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !59, metadata !DIExpression()), !dbg !82
