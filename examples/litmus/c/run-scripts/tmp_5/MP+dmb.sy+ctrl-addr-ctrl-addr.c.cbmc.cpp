...
T2BLOCK7:
  ...
  //   %xor16 = xor i32 %conv15, %conv15, !dbg !99
  creg_r7 = max(creg_r6,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !74, metadata !DIExpression()), !dbg !90

  //   %add18 = add nsw i32 0, %xor16, !dbg !100
  ...
  //   %arrayidx20 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !100
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !76, metadata !DIExpression()), !dbg !120

  //   %4 = load atomic i64, i64* %arrayidx20 monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,r9);
