...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !96, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !100, metadata !DIExpression()), !dbg !113

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !102, metadata !DIExpression()), !dbg !113
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !120, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !123, metadata !DIExpression()), !dbg !138
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !146, metadata !DIExpression()), !dbg !159
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !148, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !147, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !151, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64 1, metadata !153, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !154, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !155, metadata !DIExpression()), !dbg !169

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !157, metadata !DIExpression()), !dbg !169
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !174, metadata !DIExpression()), !dbg !192

  //   br label %label_6, !dbg !64
  goto T6BLOCK1;

T6BLOCK1:
  //   call void @llvm.dbg.label(metadata !191), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !176, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !178, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !182, metadata !DIExpression()), !dbg !199

  //   %conv4 = trunc i64 %1 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !179, metadata !DIExpression()), !dbg !192

  //   %cmp = icmp eq i32 %conv, 1, !dbg !73

  //   %conv5 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !183, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !184, metadata !DIExpression()), !dbg !203

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !186, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !187, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !188, metadata !DIExpression()), !dbg !206

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !190, metadata !DIExpression()), !dbg !206
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !248, metadata !DIExpression()), !dbg !319
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !268, metadata !DIExpression()), !dbg !354
