...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !151, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64 0, metadata !153, metadata !DIExpression()), !dbg !196

  //   store atomic i64 0, i64* @atom_0_X2_0 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !172, metadata !DIExpression()), !dbg !221

  //   %7 = load atomic i64, i64* @atom_0_X2_0 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
