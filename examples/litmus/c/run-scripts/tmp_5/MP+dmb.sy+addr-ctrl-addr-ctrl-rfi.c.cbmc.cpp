...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !144, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !147, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !150, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !187
  ...
  //   store i32 0, i32* @atom_1_X12_1, align 4, !dbg !97, !tbaa !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !163, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !165, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !164, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !168, metadata !DIExpression()), !dbg !174
  ...
  //   %7 = load i32, i32* @atom_1_X12_1, align 4, !dbg !115, !tbaa !93
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !172, metadata !DIExpression()), !dbg !174

  //   %and20 = and i32 %conv12, %and19, !dbg !118
  creg_r20 = max(creg__r14__2_,creg_r19);
  r20 = (r14==2) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !173, metadata !DIExpression()), !dbg !174
