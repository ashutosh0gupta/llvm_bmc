...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !47, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !51, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64 1, metadata !53, metadata !DIExpression()), !dbg !78

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !79
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !55, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !54, metadata !DIExpression()), !dbg !67

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !83

  //   %conv11 = zext i1 %cmp to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !58, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !59, metadata !DIExpression()), !dbg !84

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !61, metadata !DIExpression()), !dbg !84
  ...
  //   %cmp15 = icmp eq i32 %conv4, 0, !dbg !86

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !62, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !63, metadata !DIExpression()), !dbg !87

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !65, metadata !DIExpression()), !dbg !87

  //   store atomic i64 %4, i64* @atom_0_X4_0 seq_cst, align 8, !dbg !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !140, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !143, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !188

  //   store atomic i64 0, i64* @atom_0_X4_0 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !146, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !160, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !164, metadata !DIExpression()), !dbg !213

  //   %7 = load atomic i64, i64* @atom_0_X4_0 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !168, metadata !DIExpression()), !dbg !216
