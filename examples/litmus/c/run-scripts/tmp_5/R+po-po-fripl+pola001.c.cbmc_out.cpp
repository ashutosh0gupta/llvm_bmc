...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !51, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64 1, metadata !53, metadata !DIExpression()), !dbg !72

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !73
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !55, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !57, metadata !DIExpression()), !dbg !74
  ...
  //   store i32 %conv11, i32* @atom_0_X7_2, align 4, !dbg !78, !tbaa !79
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv4, 0, !dbg !83
  creg__r1__0_ = max(0,creg_r1);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !59, metadata !DIExpression()), !dbg !61

  //   store i32 %conv13, i32* @atom_0_X4_0, align 4, !dbg !84, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X4_0, align 4, !dbg !91, !tbaa !87
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_0_X4_0, align 4, !dbg !110, !tbaa !87
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !119
