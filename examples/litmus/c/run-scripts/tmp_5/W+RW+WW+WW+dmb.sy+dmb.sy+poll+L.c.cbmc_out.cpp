...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !80, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64 1, metadata !82, metadata !DIExpression()), !dbg !90
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !96, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64 2, metadata !98, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !99, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64 1, metadata !101, metadata !DIExpression()), !dbg !108
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !125, metadata !DIExpression()), !dbg !167

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !126, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !127, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !130, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !136, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !142, metadata !DIExpression()), !dbg !194

  //   %conv = trunc i64 %8 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !139, metadata !DIExpression()), !dbg !161

  //   %cmp = icmp eq i32 %conv, 2, !dbg !117

  //   %conv14 = zext i1 %cmp to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !143, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !147, metadata !DIExpression()), !dbg !198

  //   %conv18 = trunc i64 %9 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !144, metadata !DIExpression()), !dbg !161

  //   %cmp19 = icmp eq i32 %conv18, 2, !dbg !121

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !148, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !150, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !152, metadata !DIExpression()), !dbg !202

  //   %conv24 = trunc i64 %10 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !149, metadata !DIExpression()), !dbg !161

  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !125

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !153, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !155, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !157, metadata !DIExpression()), !dbg !206

  //   %conv30 = trunc i64 %11 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !154, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !159, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !160, metadata !DIExpression()), !dbg !161
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !135
