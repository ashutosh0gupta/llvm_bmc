...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !78, metadata !DIExpression()), !dbg !118

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !80, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !85, metadata !DIExpression()), !dbg !123
  ...
  //   %cmp17 = icmp eq i32 %conv8, 0, !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !95, metadata !DIExpression()), !dbg !132

  //   %5 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !97, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %5, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !99, metadata !DIExpression()), !dbg !135

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !101, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %6, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !108
  // ST: Guess
