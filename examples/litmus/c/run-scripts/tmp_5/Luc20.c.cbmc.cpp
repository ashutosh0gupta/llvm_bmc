...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !57, metadata !DIExpression()), !dbg !68
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !79, metadata !DIExpression()), !dbg !86
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !81, metadata !DIExpression()), !dbg !89

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !50
  // LD: Guess
  old_cr = cr(3,0+1*1);
  ...
  //   store i32 %conv1, i32* @atom_2_X0_1, align 4, !dbg !53, !tbaa !54
  // ST: Guess
...
T4BLOCK1:
  ...
  // ST: Guess
  iw(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l44_c3
  old_cw = cw(4,0+1*1);
  cw(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l44_c3
  // Check
  ...
  //   store i32 %conv1, i32* @atom_3_X1_0, align 4, !dbg !59, !tbaa !60
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !86, !tbaa !82
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_3_X1_0, align 4, !dbg !87, !tbaa !82
  // ST: Guess
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !106, !tbaa !82
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %10 = load i32, i32* @atom_2_X0_1, align 4, !dbg !107, !tbaa !82
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %11 = load i32, i32* @atom_3_X1_0, align 4, !dbg !108, !tbaa !82
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !115
