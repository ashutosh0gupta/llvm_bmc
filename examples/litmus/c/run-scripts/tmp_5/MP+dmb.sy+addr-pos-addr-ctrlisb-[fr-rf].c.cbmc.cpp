...
T2BLOCK1:
  ...
  //   %add11 = add nsw i32 3, %xor9, !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !74, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !73, metadata !DIExpression()), !dbg !99

  //   %tobool = icmp ne i32 %conv16, 0, !dbg !97
...
T2BLOCK4:
  ...
  //   %cmp27 = icmp eq i32 %conv20, 0, !dbg !113

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !89, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !90, metadata !DIExpression()), !dbg !133
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !182, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !185, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !207, metadata !DIExpression()), !dbg !262
