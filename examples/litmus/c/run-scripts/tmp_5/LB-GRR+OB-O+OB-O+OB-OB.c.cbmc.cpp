...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !129, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !133, metadata !DIExpression()), !dbg !152
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !164, metadata !DIExpression()), !dbg !172

  //   br label %label_5, !dbg !51
  goto T5BLOCK1;

T5BLOCK1:
  //   call void @llvm.dbg.label(metadata !171), !dbg !174

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !165, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 1, metadata !167, metadata !DIExpression()), !dbg !175

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !54
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 1, metadata !170, metadata !DIExpression()), !dbg !178

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !57
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !213, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !229, metadata !DIExpression()), !dbg !302
