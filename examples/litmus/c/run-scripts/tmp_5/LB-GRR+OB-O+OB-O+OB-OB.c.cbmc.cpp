...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_3_X2_0, align 4, !dbg !101, !tbaa !102
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_0_X0_1, align 4, !dbg !106, !tbaa !102
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_3_X2_0, align 4, !dbg !127, !tbaa !102
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   %11 = load i32, i32* @atom_0_X0_1, align 4, !dbg !128, !tbaa !102
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 110, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !139
