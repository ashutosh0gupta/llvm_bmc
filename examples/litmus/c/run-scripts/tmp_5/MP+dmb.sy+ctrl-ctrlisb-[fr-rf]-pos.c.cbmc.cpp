...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X6_1, align 4, !dbg !99, !tbaa !94
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X7_1, align 4, !dbg !100, !tbaa !94
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X4_0, align 4, !dbg !121, !tbaa !94
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_1_X6_1, align 4, !dbg !122, !tbaa !94
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X7_1, align 4, !dbg !123, !tbaa !94
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !132
