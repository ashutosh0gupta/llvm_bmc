...
T2BLOCK4:
  ...
  //   %conv13 = sext i32 %add to i64, !dbg !100

  //   call void @llvm.dbg.value(metadata i64 %conv13, metadata !83, metadata !DIExpression()), !dbg !118

  //   store atomic i64 %conv13, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv4, 0, !dbg !110
  ...
  //   store i32 %conv20, i32* @atom_1_X2_0, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv8, 0, !dbg !112
  ...
  //   store i32 %conv22, i32* @atom_1_X4_0, align 4, !dbg !113, !tbaa !106
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv12, 1, !dbg !114
  ...
  //   store i32 %conv24, i32* @atom_1_X5_1, align 4, !dbg !115, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !202

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !204

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !206

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !165, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !166, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !172, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !178, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !179, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !180, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !184, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !188, metadata !DIExpression()), !dbg !239

  //   %conv20 = trunc i64 %8 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !185, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !189, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !190, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !191, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !192, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !193, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !194, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !196, metadata !DIExpression()), !dbg !202

  //   %and24 = and i32 %10, %and23, !dbg !142
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !197, metadata !DIExpression()), !dbg !202

  //   %and25 = and i32 %9, %and24, !dbg !143
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !198, metadata !DIExpression()), !dbg !202

  //   %and26 = and i32 %conv22, %and25, !dbg !144
  creg_r23 = max(creg__r13__1_,creg_r22);
  r23 = (r13==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !199, metadata !DIExpression()), !dbg !202

  //   %and27 = and i32 %conv16, %and26, !dbg !145
  creg_r24 = max(creg__r12__1_,creg_r23);
  r24 = (r12==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !200, metadata !DIExpression()), !dbg !202

  //   %and28 = and i32 %conv10, %and27, !dbg !146
  creg_r25 = max(creg__r11__2_,creg_r24);
  r25 = (r11==2) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !201, metadata !DIExpression()), !dbg !202
