...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !128

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv18 = trunc i64 %3 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !81, metadata !DIExpression()), !dbg !103

  //   %cmp = icmp eq i32 %conv, 1, !dbg !112

  //   %conv19 = zext i1 %cmp to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !85, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !86, metadata !DIExpression()), !dbg !132

  //   %4 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !88, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !114
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv4, 2, !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !90, metadata !DIExpression()), !dbg !135

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !92, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %5, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !117
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv14, 1, !dbg !118

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !93, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !94, metadata !DIExpression()), !dbg !138

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !96, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %6, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !120
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv18, 0, !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !98, metadata !DIExpression()), !dbg !141

  //   %7 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %7, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !123
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !149, metadata !DIExpression()), !dbg !154
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !164, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !165, metadata !DIExpression()), !dbg !239

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !166, metadata !DIExpression()), !dbg !241

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !170, metadata !DIExpression()), !dbg !243

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !171, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !172, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !175, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !178, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !181, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !187, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !190, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !193, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !197, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !199, metadata !DIExpression()), !dbg !275

  //   %conv = trunc i64 %6 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !196, metadata !DIExpression()), !dbg !239

  //   %cmp = icmp eq i32 %conv, 1, !dbg !158

  //   %conv20 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !200, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !202, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !204, metadata !DIExpression()), !dbg !279

  //   %conv24 = trunc i64 %7 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !201, metadata !DIExpression()), !dbg !239

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !162

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !205, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !207, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !209, metadata !DIExpression()), !dbg !283

  //   %conv30 = trunc i64 %8 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !206, metadata !DIExpression()), !dbg !239

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !166

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !210, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !212, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !214, metadata !DIExpression()), !dbg !287

  //   %conv36 = trunc i64 %9 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !211, metadata !DIExpression()), !dbg !239

  //   %cmp37 = icmp eq i32 %conv36, 2, !dbg !170

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !215, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !217, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !219, metadata !DIExpression()), !dbg !291

  //   %conv42 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !216, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !221, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !223, metadata !DIExpression()), !dbg !294

  //   %conv46 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !220, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !225, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !227, metadata !DIExpression()), !dbg !297

  //   %conv50 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !224, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !229, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !231, metadata !DIExpression()), !dbg !300

  //   %conv54 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !228, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !232, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !233, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !234, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !235, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !236, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !237, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !238, metadata !DIExpression()), !dbg !239
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !193
