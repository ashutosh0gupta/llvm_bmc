...
T2BLOCK4:
  ...
  //   %cmp20 = icmp eq i32 %conv4, 2, !dbg !106
  ...
  //   store i32 %conv21, i32* @atom_1_X5_2, align 4, !dbg !107, !tbaa !102
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !135, metadata !DIExpression()), !dbg !142
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !152, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !153, metadata !DIExpression()), !dbg !203

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !154, metadata !DIExpression()), !dbg !205

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !158, metadata !DIExpression()), !dbg !207

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !159, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !160, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !163, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !166, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !169, metadata !DIExpression()), !dbg !216
  ...
  //   store i32 0, i32* @atom_1_X9_1, align 4, !dbg !116, !tbaa !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !175, metadata !DIExpression()), !dbg !233

  //   %conv = trunc i64 %6 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !172, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !176, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !180, metadata !DIExpression()), !dbg !237

  //   %conv16 = trunc i64 %7 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !177, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !181, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !185, metadata !DIExpression()), !dbg !241

  //   %conv22 = trunc i64 %8 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !182, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !186, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !190, metadata !DIExpression()), !dbg !245

  //   %conv28 = trunc i64 %9 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !187, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !191, metadata !DIExpression()), !dbg !203
  ...
  //   %12 = load i32, i32* @atom_1_X9_1, align 4, !dbg !147, !tbaa !111
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !159
