...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv6, 0, !dbg !97
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !101), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !123
  ...
  //   %cmp24 = icmp eq i32 %conv10, 0, !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !93, metadata !DIExpression()), !dbg !136

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %6, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv14, 1, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !97, metadata !DIExpression()), !dbg !139
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !182, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !185, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !188, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !211, metadata !DIExpression()), !dbg !277

  //   %10 = load atomic i64, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !160
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !215, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !219, metadata !DIExpression()), !dbg !283
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 94, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
