...
T2BLOCK4:
  ...
  //   %cmp18 = icmp eq i32 %conv10, 0, !dbg !106
  ...
  //   store i32 %conv19, i32* @atom_1_X7_0, align 4, !dbg !107, !tbaa !100
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv14, 1, !dbg !108
  ...
  //   store i32 %conv21, i32* @atom_1_X9_1, align 4, !dbg !109, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_1_X6_2, align 4, !dbg !104, !tbaa !100
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X7_0, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X6_2, align 4, !dbg !131, !tbaa !100
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X7_0, align 4, !dbg !132, !tbaa !100
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 94, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
