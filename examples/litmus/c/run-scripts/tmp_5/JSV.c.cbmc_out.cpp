...
T1BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !56
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !57
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !45, metadata !DIExpression()), !dbg !59
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !48, metadata !DIExpression()), !dbg !61

  //   call void @llvm.dbg.value(metadata i64 1, metadata !50, metadata !DIExpression()), !dbg !61

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !62
  // ST: Guess
  //   : Release
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !66, metadata !DIExpression()), !dbg !96
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !67, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 2, metadata !69, metadata !DIExpression()), !dbg !99

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !72
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !101

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !74
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !74, metadata !DIExpression()), !dbg !101

  //   %conv = trunc i64 %0 to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !70, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !104

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !77
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !78, metadata !DIExpression()), !dbg !104

  //   %conv4 = trunc i64 %1 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !75, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !80, metadata !DIExpression()), !dbg !107

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !80
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !82, metadata !DIExpression()), !dbg !107

  //   %conv8 = trunc i64 %2 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !79, metadata !DIExpression()), !dbg !96

  //   %cmp = icmp eq i32 %conv, 1, !dbg !82

  //   %conv9 = zext i1 %cmp to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !83, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !84, metadata !DIExpression()), !dbg !111

  //   %3 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !86, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !84
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv4, 1, !dbg !85

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !87, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !88, metadata !DIExpression()), !dbg !114

  //   %4 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !90, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %4, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !87
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv8, 2, !dbg !88

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !91, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !92, metadata !DIExpression()), !dbg !117

  //   %5 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !94, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %5, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !127, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !128, metadata !DIExpression()), !dbg !184

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !129, metadata !DIExpression()), !dbg !186

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !133, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !134, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64 0, metadata !136, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64 0, metadata !139, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !143, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !195

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !146, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !149, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !155, metadata !DIExpression()), !dbg !211

  //   %conv = trunc i64 %4 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !152, metadata !DIExpression()), !dbg !184

  //   %cmp = icmp eq i32 %conv, 2, !dbg !129

  //   %conv14 = zext i1 %cmp to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !156, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !158, metadata !DIExpression()), !dbg !215

  //   %5 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !160, metadata !DIExpression()), !dbg !215

  //   %conv18 = trunc i64 %5 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !157, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !162, metadata !DIExpression()), !dbg !218

  //   %6 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !134
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %conv22 = trunc i64 %6 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !161, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !166, metadata !DIExpression()), !dbg !221

  //   %7 = load atomic i64, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !168, metadata !DIExpression()), !dbg !221

  //   %conv26 = trunc i64 %7 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !165, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !224

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !140
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !172, metadata !DIExpression()), !dbg !224

  //   %conv30 = trunc i64 %8 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !169, metadata !DIExpression()), !dbg !184

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !142

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !173, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !228

  //   %9 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM 
  // Check
  ...
  //   %conv36 = trunc i64 %9 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !174, metadata !DIExpression()), !dbg !184

  //   %cmp37 = icmp eq i32 %conv36, 2, !dbg !146

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !178, metadata !DIExpression()), !dbg !184

  //   %or = or i32 %conv32, %conv38, !dbg !147
  creg_r12 = max(max(creg_r10,0),max(creg_r11,0));
  ASSUME(active[creg_r12] == 0);
  r12 = (r10==1) | (r11==2);

  //   call void @llvm.dbg.value(metadata i32 %or, metadata !179, metadata !DIExpression()), !dbg !184

  //   %and = and i32 %conv26, %or, !dbg !148
  ...
  //   %and39 = and i32 %conv22, %and, !dbg !149
  creg_r14 = max(creg_r8,creg_r13);
  ASSUME(active[creg_r14] == 0);
  r14 = r8 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !181, metadata !DIExpression()), !dbg !184

  //   %and40 = and i32 %conv18, %and39, !dbg !150
  creg_r15 = max(creg_r7,creg_r14);
  ASSUME(active[creg_r15] == 0);
  r15 = r7 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !182, metadata !DIExpression()), !dbg !184

  //   %and41 = and i32 %conv14, %and40, !dbg !151
  creg_r16 = max(max(creg_r6,0),creg_r15);
  ASSUME(active[creg_r16] == 0);
  r16 = (r6==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !183, metadata !DIExpression()), !dbg !184

  //   %cmp42 = icmp eq i32 %and41, 1, !dbg !152

  //   br i1 %cmp42, label %if.then, label %if.end, !dbg !154
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([88 x i8], [88 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
