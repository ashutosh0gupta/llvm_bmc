...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !161, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !162, metadata !DIExpression()), !dbg !208

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !163, metadata !DIExpression()), !dbg !210

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !167, metadata !DIExpression()), !dbg !212

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !168, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !169, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !172, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !221
  ...
  //   store i32 0, i32* @atom_1_X9_0, align 4, !dbg !115, !tbaa !109
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X11_0, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !182, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !184, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !185, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !187, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !189, metadata !DIExpression()), !dbg !243

  //   %conv16 = trunc i64 %7 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !186, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !190, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !192, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !194, metadata !DIExpression()), !dbg !247

  //   %conv22 = trunc i64 %8 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !191, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !195, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !196, metadata !DIExpression()), !dbg !208
  ...
  //   %12 = load i32, i32* @atom_1_X9_0, align 4, !dbg !143, !tbaa !109
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %13 = load i32, i32* @atom_1_X11_0, align 4, !dbg !144, !tbaa !109
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !202, metadata !DIExpression()), !dbg !208

  //   %and26 = and i32 %10, %and25, !dbg !147
  creg_r26 = max(creg_r20,creg_r25);
  r26 = r20 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !203, metadata !DIExpression()), !dbg !208

  //   %and27 = and i32 %9, %and26, !dbg !148
  creg_r27 = max(creg_r19,creg_r26);
  r27 = r19 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !204, metadata !DIExpression()), !dbg !208

  //   %and28 = and i32 %conv24, %and27, !dbg !149
  creg_r28 = max(creg__r18__1_,creg_r27);
  r28 = (r18==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !205, metadata !DIExpression()), !dbg !208

  //   %and29 = and i32 %conv18, %and28, !dbg !150
  creg_r29 = max(creg__r17__1_,creg_r28);
  r29 = (r17==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !206, metadata !DIExpression()), !dbg !208

  //   %and30 = and i32 %conv12, %and29, !dbg !151
  creg_r30 = max(creg__r16__1_,creg_r29);
  r30 = (r16==1) & r29;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !207, metadata !DIExpression()), !dbg !208
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 102, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
