...
T2BLOCK4:
  ...
  //   %cmp19 = icmp eq i32 %conv11, 1, !dbg !108
  ...
  //   store i32 %conv20, i32* @atom_1_X6_1, align 4, !dbg !109, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !139, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !140, metadata !DIExpression()), !dbg !180

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !141, metadata !DIExpression()), !dbg !182

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !145, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !146, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !152, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !159, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !160, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !164, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !165, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !169, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !175, metadata !DIExpression()), !dbg !180

  //   %and22 = and i32 %7, %and21, !dbg !130
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !176, metadata !DIExpression()), !dbg !180

  //   %and23 = and i32 %conv20, %and22, !dbg !131
  creg_r19 = max(creg__r11__1_,creg_r18);
  r19 = (r11==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !177, metadata !DIExpression()), !dbg !180

  //   %and24 = and i32 %conv14, %and23, !dbg !132
  creg_r20 = max(creg__r10__2_,creg_r19);
  r20 = (r10==2) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !178, metadata !DIExpression()), !dbg !180

  //   %and25 = and i32 %conv8, %and24, !dbg !133
  creg_r21 = max(creg__r9__1_,creg_r20);
  r21 = (r9==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !179, metadata !DIExpression()), !dbg !180
