...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !88, metadata !DIExpression()), !dbg !136

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %6, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !118
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !173, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !179, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !185, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !188, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !194, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !195, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !199, metadata !DIExpression()), !dbg !261

  //   %conv22 = trunc i64 %7 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !196, metadata !DIExpression()), !dbg !223

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !144

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !200, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !202, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !204, metadata !DIExpression()), !dbg !265

  //   %conv28 = trunc i64 %8 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !201, metadata !DIExpression()), !dbg !223

  //   %cmp29 = icmp eq i32 %conv28, 2, !dbg !148

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !205, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !207, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !206, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !211, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !210, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !215, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !217, metadata !DIExpression()), !dbg !275

  //   %conv42 = trunc i64 %11 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !214, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !219, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !220, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !221, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !222, metadata !DIExpression()), !dbg !223
