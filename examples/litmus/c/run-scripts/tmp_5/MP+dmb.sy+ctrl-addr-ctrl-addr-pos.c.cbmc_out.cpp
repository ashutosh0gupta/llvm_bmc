...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !94, metadata !DIExpression()), !dbg !142

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %8, i64* @atom_1_X12_0 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !152, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !153, metadata !DIExpression()), !dbg !209

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !154, metadata !DIExpression()), !dbg !211

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !158, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !174, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !177, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !226

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !180, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !228

  //   store atomic i64 0, i64* @atom_1_X12_0 monotonic, align 8, !dbg !119
  // ST: Guess
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !121
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !127
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !128, !tbaa !123
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !184, metadata !DIExpression()), !dbg !240

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !186, metadata !DIExpression()), !dbg !240

  //   %conv = trunc i64 %4 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !183, metadata !DIExpression()), !dbg !209

  //   %cmp = icmp eq i32 %conv, 1, !dbg !133

  //   %conv18 = zext i1 %cmp to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !187, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !189, metadata !DIExpression()), !dbg !244

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !191, metadata !DIExpression()), !dbg !244

  //   %conv22 = trunc i64 %5 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !188, metadata !DIExpression()), !dbg !209

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !137

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !192, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !194, metadata !DIExpression()), !dbg !248

  //   %6 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !139
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !196, metadata !DIExpression()), !dbg !248

  //   %conv28 = trunc i64 %6 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !193, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !198, metadata !DIExpression()), !dbg !251

  //   %7 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !200, metadata !DIExpression()), !dbg !251

  //   %conv32 = trunc i64 %7 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !197, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !202, metadata !DIExpression()), !dbg !254

  //   %8 = load atomic i64, i64* @atom_1_X12_0 seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !204, metadata !DIExpression()), !dbg !254

  //   %conv36 = trunc i64 %8 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !201, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !205, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !206, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !207, metadata !DIExpression()), !dbg !209

  //   %and39 = and i32 %conv18, %and38, !dbg !150
  creg_r23 = max(max(creg_r15,0),creg_r22);
  ASSUME(active[creg_r23] == 0);
  r23 = (r15==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !208, metadata !DIExpression()), !dbg !209

  //   %cmp40 = icmp eq i32 %and39, 1, !dbg !151

  //   br i1 %cmp40, label %if.then, label %if.end, !dbg !153
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154

  //   unreachable, !dbg !154
  r24 = 1;

T0BLOCK2:
  //   %9 = bitcast i64* %thr1 to i8*, !dbg !157

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #7, !dbg !157

  //   %10 = bitcast i64* %thr0 to i8*, !dbg !157

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !157
