...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !81, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !86, metadata !DIExpression()), !dbg !98
...
T0BLOCK0:
  ...
  //   store i32 0, i32* @atom_0_X6_2, align 4, !dbg !82, !tbaa !83
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X3_0, align 4, !dbg !87, !tbaa !83
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X6_2, align 4, !dbg !104, !tbaa !83
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X3_0, align 4, !dbg !105, !tbaa !83
  // LD: Guess
  old_cr = cr(0,4);
