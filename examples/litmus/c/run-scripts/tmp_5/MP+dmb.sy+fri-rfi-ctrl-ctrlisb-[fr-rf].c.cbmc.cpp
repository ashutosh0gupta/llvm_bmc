...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !157, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !158, metadata !DIExpression()), !dbg !193

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !159, metadata !DIExpression()), !dbg !195

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !163, metadata !DIExpression()), !dbg !197

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !164, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !165, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !171, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !178, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !183, metadata !DIExpression()), !dbg !193
