...
T2BLOCK4:
  ...
  //   %cmp20 = icmp eq i32 %conv12, 1, !dbg !102
  ...
  //   store i32 %conv21, i32* @atom_1_X8_1, align 4, !dbg !103, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !140, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !143, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !149, metadata !DIExpression()), !dbg !186
  ...
  //   store i32 0, i32* @atom_1_X11_1, align 4, !dbg !103, !tbaa !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !153, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !155, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !158, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !160, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !165, metadata !DIExpression()), !dbg !207
  ...
  //   %9 = load i32, i32* @atom_1_X11_1, align 4, !dbg !126, !tbaa !98
  // LD: Guess
  old_cr = cr(0,6);
