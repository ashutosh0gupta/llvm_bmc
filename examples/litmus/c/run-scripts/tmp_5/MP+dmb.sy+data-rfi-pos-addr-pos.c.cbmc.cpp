...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !140, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !141, metadata !DIExpression()), !dbg !183

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !142, metadata !DIExpression()), !dbg !185

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !146, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !147, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !192
  ...
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l60_c15
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l60_c15
  // Check
  ...
  //   store i32 0, i32* @atom_1_X4_1, align 4, !dbg !105, !tbaa !101
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l61_c15
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l61_c15
  // Check
  ...
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l62_c15
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l62_c15
  // Check
  ...
  //   store i32 0, i32* @atom_1_X7_0, align 4, !dbg !107, !tbaa !101
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l63_c15
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l63_c15
  // Check
  ...
  //   store i32 0, i32* @atom_1_X9_0, align 4, !dbg !108, !tbaa !101
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l64_c15
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l64_c15
  // Check
  ...
  //   %call5 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !110
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !157, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !159, metadata !DIExpression()), !dbg !207

  //   %conv = trunc i64 %4 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !156, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !160, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !164, metadata !DIExpression()), !dbg !211

  //   %conv12 = trunc i64 %5 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !161, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !165, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !166, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !170, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !171, metadata !DIExpression()), !dbg !183

  //   %8 = load i32, i32* @atom_1_X4_1, align 4, !dbg !130, !tbaa !101
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !172, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !173, metadata !DIExpression()), !dbg !183

  //   %10 = load i32, i32* @atom_1_X7_0, align 4, !dbg !132, !tbaa !101
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !174, metadata !DIExpression()), !dbg !183

  //   %11 = load i32, i32* @atom_1_X9_0, align 4, !dbg !133, !tbaa !101
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !175, metadata !DIExpression()), !dbg !183

  //   %and = and i32 %10, %11, !dbg !134
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !176, metadata !DIExpression()), !dbg !183

  //   %and21 = and i32 %9, %and, !dbg !135
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !177, metadata !DIExpression()), !dbg !183

  //   %and22 = and i32 %8, %and21, !dbg !136
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !178, metadata !DIExpression()), !dbg !183

  //   %and23 = and i32 %7, %and22, !dbg !137
  creg_r24 = max(creg_r16,creg_r23);
  r24 = r16 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !179, metadata !DIExpression()), !dbg !183

  //   %and24 = and i32 %conv20, %and23, !dbg !138
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !180, metadata !DIExpression()), !dbg !183

  //   %and25 = and i32 %conv14, %and24, !dbg !139
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !181, metadata !DIExpression()), !dbg !183

  //   %and26 = and i32 %conv8, %and25, !dbg !140
  creg_r27 = max(creg__r13__1_,creg_r26);
  r27 = (r13==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !182, metadata !DIExpression()), !dbg !183
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !144
