...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !139, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !140, metadata !DIExpression()), !dbg !174

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !141, metadata !DIExpression()), !dbg !176

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !145, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !146, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !152, metadata !DIExpression()), !dbg !183
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !90, !tbaa !91
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X4_2, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   %call5 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !99
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !159, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !160, metadata !DIExpression()), !dbg !174

  //   %cmp13 = icmp eq i32 %conv12, 2, !dbg !113
  creg__r12__2_ = max(0,creg_r12);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !164, metadata !DIExpression()), !dbg !174

  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !114, !tbaa !91
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X4_2, align 4, !dbg !116, !tbaa !91
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !170, metadata !DIExpression()), !dbg !174

  //   %and16 = and i32 %6, %and15, !dbg !120
  creg_r19 = max(creg_r13,creg_r18);
  r19 = r13 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !171, metadata !DIExpression()), !dbg !174

  //   %and17 = and i32 %conv14, %and16, !dbg !121
  creg_r20 = max(creg__r12__2_,creg_r19);
  r20 = (r12==2) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !172, metadata !DIExpression()), !dbg !174

  //   %and18 = and i32 %conv8, %and17, !dbg !122
  creg_r21 = max(creg__r11__1_,creg_r20);
  r21 = (r11==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !173, metadata !DIExpression()), !dbg !174
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !126
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #6, !dbg !129

  //   %11 = bitcast i64* %thr0 to i8*, !dbg !129

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #6, !dbg !129
