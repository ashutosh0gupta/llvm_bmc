...
T3BLOCK1:
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !61
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !85, metadata !DIExpression()), !dbg !103

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !64
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !89, metadata !DIExpression()), !dbg !107

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !91, metadata !DIExpression()), !dbg !107

  //   store atomic i64 %2, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !93, metadata !DIExpression()), !dbg !110

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !95, metadata !DIExpression()), !dbg !110

  //   store atomic i64 %3, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !71
  // ST: Guess
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !116, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i64 1, metadata !121, metadata !DIExpression()), !dbg !128
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !162, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !179, metadata !DIExpression()), !dbg !232
