...
T2BLOCK1:
  ...
  //   %add10 = add nsw i32 %xor9, 1, !dbg !89
  creg_r7 = max(creg_r6,0);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !73, metadata !DIExpression()), !dbg !94
  ...
  //   %conv11 = sext i32 %add10 to i64, !dbg !91

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !76, metadata !DIExpression()), !dbg !109

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !77, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !95

  //   %conv16 = zext i1 %cmp to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !81, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !85, metadata !DIExpression()), !dbg !94
  ...
  //   store atomic i64 %5, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !90, metadata !DIExpression()), !dbg !121

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !121

  //   store atomic i64 %6, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !167, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !189, metadata !DIExpression()), !dbg !242
