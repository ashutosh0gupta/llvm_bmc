...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !41, metadata !DIExpression()), !dbg !52
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !45, metadata !DIExpression()), !dbg !55
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !62, metadata !DIExpression()), !dbg !87
  ...
  //   %and = and i32 %conv, 8, !dbg !71
  creg_r1 = max(0,creg_r0);
  r1 = r0 & 8;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !65, metadata !DIExpression()), !dbg !84

  //   %add = add nsw i32 2, %and, !dbg !72
  creg_r2 = max(0,creg_r1);
  r2 = 2 + r1;

  //   %1 = zext i32 %add to i64

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %1, !dbg !72
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !67, metadata !DIExpression()), !dbg !92

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !72
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   %conv4 = trunc i64 %2 to i32, !dbg !74
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !76
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !73, metadata !DIExpression()), !dbg !94

  //   %conv8 = trunc i64 %3 to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !84

  //   %and9 = and i32 %conv8, 128, !dbg !78
  creg_r6 = max(0,creg_r5);
  r6 = r5 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and9, metadata !74, metadata !DIExpression()), !dbg !84

  //   %add11 = add nsw i32 1, %and9, !dbg !79
  creg_r7 = max(0,creg_r6);
  r7 = 1 + r6;

  //   %4 = zext i32 %add11 to i64

  //   %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %4, !dbg !79
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !76, metadata !DIExpression()), !dbg !99

  //   %5 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !78, metadata !DIExpression()), !dbg !99

  //   %conv16 = trunc i64 %5 to i32, !dbg !81
  ...
  //   %cmp18 = icmp eq i32 %conv16, 0, !dbg !88
  ...
  //   store i32 %conv19, i32* @atom_1_X7_0, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv4, 0, !dbg !90
  ...
  //   store i32 %conv21, i32* @atom_1_X3_0, align 4, !dbg !91, !tbaa !84
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv8, 1, !dbg !92
  ...
  //   store i32 %conv23, i32* @atom_1_X5_1, align 4, !dbg !93, !tbaa !84
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !134, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !135, metadata !DIExpression()), !dbg !158

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !136, metadata !DIExpression()), !dbg !160

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !140, metadata !DIExpression()), !dbg !162

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !141, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !142, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !145, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !169
  ...
  //   store i32 0, i32* @atom_1_X7_0, align 4, !dbg !86, !tbaa !82
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X3_0, align 4, !dbg !87, !tbaa !82
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X5_1, align 4, !dbg !88, !tbaa !82
  // ST: Guess
  ...
  //   %call5 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !90
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call6 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !91
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !92, !tbaa !93
  r11 = local_mem[0];
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !96, !tbaa !93
  r12 = local_mem[1];

  //   %call8 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !97
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !98, !tbaa !93
  r13 = local_mem[2];

  //   %call9 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !99
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !100, !tbaa !82
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X7_0, align 4, !dbg !101, !tbaa !82
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %8 = load i32, i32* @atom_1_X3_0, align 4, !dbg !102, !tbaa !82
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %9 = load i32, i32* @atom_1_X5_1, align 4, !dbg !103, !tbaa !82
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 81, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !110
...
T0BLOCK2:
  //   %10 = bitcast i64* %thr2 to i8*, !dbg !113

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !113

  //   %11 = bitcast i64* %thr1 to i8*, !dbg !113

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !113

  //   %12 = bitcast i64* %thr0 to i8*, !dbg !113

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !113
