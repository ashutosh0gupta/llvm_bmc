...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !97, metadata !DIExpression()), !dbg !104

  //   %add = add nsw i32 %xor, 1, !dbg !58
  creg_r7 = max(0,creg_r6);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !98, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !101, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !102, metadata !DIExpression()), !dbg !104
