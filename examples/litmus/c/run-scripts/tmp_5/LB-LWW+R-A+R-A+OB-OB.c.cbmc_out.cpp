...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !137, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !138, metadata !DIExpression()), !dbg !169

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !139, metadata !DIExpression()), !dbg !171

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !143, metadata !DIExpression()), !dbg !173

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !144, metadata !DIExpression()), !dbg !175

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !145, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !146, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !149, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64 0, metadata !151, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !152, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !155, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !184
  ...
  //   store i32 0, i32* @atom_1_X0_1, align 4, !dbg !91, !tbaa !92
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_2_X0_1, align 4, !dbg !96, !tbaa !92
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_3_X0_1, align 4, !dbg !97, !tbaa !92
  // ST: Guess
  ...
  //   %call8 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !100
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !101
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr0, align 8, !dbg !102, !tbaa !103
  r4 = local_mem[0];

  //   %call10 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !105
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr1, align 8, !dbg !106, !tbaa !103
  r5 = local_mem[1];

  //   %call11 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !107
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i64, i64* %thr2, align 8, !dbg !108, !tbaa !103
  r6 = local_mem[2];

  //   %call12 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !109
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr3, align 8, !dbg !110, !tbaa !103
  r7 = local_mem[3];

  //   %call13 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !111
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !203

  //   %8 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !161, metadata !DIExpression()), !dbg !203

  //   %conv = trunc i64 %8 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !158, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !162, metadata !DIExpression()), !dbg !169

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !116, !tbaa !92
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_2_X0_1, align 4, !dbg !117, !tbaa !92
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_3_X0_1, align 4, !dbg !118, !tbaa !92
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !167, metadata !DIExpression()), !dbg !169

  //   %and16 = and i32 %conv14, %and15, !dbg !121
  creg_r14 = max(creg__r8__3_,creg_r13);
  r14 = (r8==3) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !168, metadata !DIExpression()), !dbg !169

  //   %cmp17 = icmp eq i32 %and16, 1, !dbg !122
  creg__r14__1_ = max(0,creg_r14);

  //   br i1 %cmp17, label %if.then, label %if.end, !dbg !124
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 87, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !125
...
T0BLOCK2:
  //   %12 = bitcast i64* %thr3 to i8*, !dbg !128

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !128

  //   %13 = bitcast i64* %thr2 to i8*, !dbg !128

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !128

  //   %14 = bitcast i64* %thr1 to i8*, !dbg !128

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %14) #7, !dbg !128

  //   %15 = bitcast i64* %thr0 to i8*, !dbg !128

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %15) #7, !dbg !128
