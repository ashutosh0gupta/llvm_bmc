...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !86, metadata !DIExpression()), !dbg !132

  //   %conv18 = trunc i64 %3 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !83, metadata !DIExpression()), !dbg !105

  //   %cmp = icmp eq i32 %conv, 1, !dbg !116

  //   %conv19 = zext i1 %cmp to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !87, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !136

  //   %4 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !90, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv5, 1, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !92, metadata !DIExpression()), !dbg !139

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !94, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %5, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv14, 2, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !96, metadata !DIExpression()), !dbg !142

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !98, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %6, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !124
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv18, 0, !dbg !125

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !99, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !100, metadata !DIExpression()), !dbg !145

  //   %7 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !102, metadata !DIExpression()), !dbg !145
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !151, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i64 2, metadata !153, metadata !DIExpression()), !dbg !158
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !168, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !169, metadata !DIExpression()), !dbg !243

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !170, metadata !DIExpression()), !dbg !245

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !174, metadata !DIExpression()), !dbg !247

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !175, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !176, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !179, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !182, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !185, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !188, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !191, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !194, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !197, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !201, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !203, metadata !DIExpression()), !dbg !279

  //   %conv = trunc i64 %6 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !200, metadata !DIExpression()), !dbg !243

  //   %cmp = icmp eq i32 %conv, 2, !dbg !158

  //   %conv20 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !204, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !206, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !208, metadata !DIExpression()), !dbg !283

  //   %conv24 = trunc i64 %7 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !205, metadata !DIExpression()), !dbg !243

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !162

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !209, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !211, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !213, metadata !DIExpression()), !dbg !287

  //   %conv30 = trunc i64 %8 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !210, metadata !DIExpression()), !dbg !243

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !166

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !214, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !216, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !218, metadata !DIExpression()), !dbg !291

  //   %conv36 = trunc i64 %9 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !215, metadata !DIExpression()), !dbg !243

  //   %cmp37 = icmp eq i32 %conv36, 1, !dbg !170

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !219, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !221, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !223, metadata !DIExpression()), !dbg !295

  //   %conv42 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !220, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !225, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !227, metadata !DIExpression()), !dbg !298

  //   %conv46 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !224, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !229, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !231, metadata !DIExpression()), !dbg !301

  //   %conv50 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !228, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !233, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !235, metadata !DIExpression()), !dbg !304

  //   %conv54 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !232, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !236, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !237, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !238, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !239, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !240, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !241, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !242, metadata !DIExpression()), !dbg !243
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 101, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !193
