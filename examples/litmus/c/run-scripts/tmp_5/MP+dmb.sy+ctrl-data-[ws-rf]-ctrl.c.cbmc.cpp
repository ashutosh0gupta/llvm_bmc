...
T2BLOCK7:
  ...
  //   %cmp18 = icmp eq i32 %conv9, 2, !dbg !104
  ...
  //   store i32 %conv19, i32* @atom_1_X6_2, align 4, !dbg !105, !tbaa !100
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !141
