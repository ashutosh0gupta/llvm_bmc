...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !126
  ...
  //   %cmp25 = icmp eq i32 %conv12, 0, !dbg !116
  ...
  //   store i32 %conv26, i32* @atom_1_X6_0, align 4, !dbg !117, !tbaa !112
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv16, 1, !dbg !118
  ...
  //   store i32 %conv28, i32* @atom_1_X8_1, align 4, !dbg !119, !tbaa !112
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv23, 0, !dbg !120
  ...
  //   store i32 %conv30, i32* @atom_1_X9_0, align 4, !dbg !121, !tbaa !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !162, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !163, metadata !DIExpression()), !dbg !207

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !164, metadata !DIExpression()), !dbg !209

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !168, metadata !DIExpression()), !dbg !211

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !169, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !170, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !173, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !176, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !179, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !183, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !185, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !186, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !188, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !190, metadata !DIExpression()), !dbg !241

  //   %conv16 = trunc i64 %7 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !187, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !191, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !193, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !192, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !196, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !202, metadata !DIExpression()), !dbg !207

  //   %and26 = and i32 %9, %and25, !dbg !141
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !203, metadata !DIExpression()), !dbg !207
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !148
