...
T2BLOCK7:
  ...
  //   %cmp29 = icmp eq i32 %conv4, 1, !dbg !114
  ...
  //   store i32 %conv30, i32* @atom_1_X2_1, align 4, !dbg !115, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !145, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !146, metadata !DIExpression()), !dbg !184

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !147, metadata !DIExpression()), !dbg !186

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !151, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !152, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !189

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !155, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !191

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !158, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !193

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !195

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !164, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !197

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !95
  // ST: Guess
  ...
  //   store i32 0, i32* @atom_1_X11_0, align 4, !dbg !102, !tbaa !97
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l62_c16
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l62_c16
  // Check
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !104
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !108
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !109, !tbaa !106
  r14 = local_mem[1];
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !168, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !170, metadata !DIExpression()), !dbg !210

  //   %conv = trunc i64 %4 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !167, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !171, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !214

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !175, metadata !DIExpression()), !dbg !214

  //   %conv16 = trunc i64 %5 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !172, metadata !DIExpression()), !dbg !184

  //   %cmp17 = icmp eq i32 %conv16, 1, !dbg !118
  creg__r16__1_ = max(0,creg_r16);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !176, metadata !DIExpression()), !dbg !184

  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !119, !tbaa !97
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !177, metadata !DIExpression()), !dbg !184

  //   %7 = load i32, i32* @atom_1_X2_1, align 4, !dbg !120, !tbaa !97
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !178, metadata !DIExpression()), !dbg !184

  //   %8 = load i32, i32* @atom_1_X11_0, align 4, !dbg !121, !tbaa !97
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l76_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !179, metadata !DIExpression()), !dbg !184

  //   %and = and i32 %7, %8, !dbg !122
  creg_r20 = max(creg_r18,creg_r19);
  r20 = r18 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !180, metadata !DIExpression()), !dbg !184

  //   %and19 = and i32 %6, %and, !dbg !123
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !181, metadata !DIExpression()), !dbg !184

  //   %and20 = and i32 %conv18, %and19, !dbg !124
  creg_r22 = max(creg__r16__1_,creg_r21);
  r22 = (r16==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !182, metadata !DIExpression()), !dbg !184

  //   %and21 = and i32 %conv12, %and20, !dbg !125
  creg_r23 = max(creg__r15__1_,creg_r22);
  r23 = (r15==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !183, metadata !DIExpression()), !dbg !184

  //   %cmp22 = icmp eq i32 %and21, 1, !dbg !126
  creg__r23__1_ = max(0,creg_r23);

  //   br i1 %cmp22, label %if.then, label %if.end, !dbg !128
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 81, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !129
...
T0BLOCK2:
  //   %9 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #6, !dbg !132

  //   %10 = bitcast i64* %thr0 to i8*, !dbg !132

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #6, !dbg !132
