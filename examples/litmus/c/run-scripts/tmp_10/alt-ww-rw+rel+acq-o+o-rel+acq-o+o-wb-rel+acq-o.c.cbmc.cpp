...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !46

  //   call void @llvm.dbg.value(metadata i64 1, metadata !41, metadata !DIExpression()), !dbg !46

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !47
  // ST: Guess
  //   : Release
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !51, metadata !DIExpression()), !dbg !65
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !54, metadata !DIExpression()), !dbg !68

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !56
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !56, metadata !DIExpression()), !dbg !68

  //   %conv = trunc i64 %0 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !52, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !57, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64 1, metadata !59, metadata !DIExpression()), !dbg !71

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !59
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !60, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !61, metadata !DIExpression()), !dbg !74

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !63, metadata !DIExpression()), !dbg !74
...
T3BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !50
  // ST: Guess
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !52
  // ST: Guess
  //   : Release
  ...
  ASSUME(cw(3,0+2*1) >= cr(3,8+0));
  ASSUME(cw(3,0+2*1) >= cr(3,9+0));
  ASSUME(cw(3,0+2*1) >= cr(3,6+0));
  ASSUME(cw(3,0+2*1) >= cr(3,7+0));
  ASSUME(cw(3,0+2*1) >= cr(3,10+0));
  ASSUME(cw(3,0+2*1) >= cr(3,11+0));
  ASSUME(cw(3,0+2*1) >= cr(3,12+0));
  ASSUME(cw(3,0+2*1) >= cr(3,13+0));
  ...
  ASSUME(cw(3,0+2*1) >= cw(3,8+0));
  ASSUME(cw(3,0+2*1) >= cw(3,9+0));
  ASSUME(cw(3,0+2*1) >= cw(3,6+0));
  ASSUME(cw(3,0+2*1) >= cw(3,7+0));
  ASSUME(cw(3,0+2*1) >= cw(3,10+0));
  ASSUME(cw(3,0+2*1) >= cw(3,11+0));
  ASSUME(cw(3,0+2*1) >= cw(3,12+0));
  ASSUME(cw(3,0+2*1) >= cw(3,13+0));
  // Update
  caddr[3] = max(caddr[3],0);
  buff(3,0+2*1) = 1;
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !99, metadata !DIExpression()), !dbg !113

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !56
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+2*1);
  cr(4,0+2*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM 
  // Check
  ...
  ASSUME(cr(4,0+2*1) >= cs(4,8+0));
  ASSUME(cr(4,0+2*1) >= cs(4,9+0));
  ASSUME(cr(4,0+2*1) >= cs(4,6+0));
  ASSUME(cr(4,0+2*1) >= cs(4,7+0));
  ASSUME(cr(4,0+2*1) >= cs(4,10+0));
  ASSUME(cr(4,0+2*1) >= cs(4,11+0));
  ASSUME(cr(4,0+2*1) >= cs(4,12+0));
  ASSUME(cr(4,0+2*1) >= cs(4,13+0));
  // Update
  creg_r1 = cr(4,0+2*1);
  ...
  if(cr(4,0+2*1) < cw(4,0+2*1)) {
    ...
    ASSUME((!(( (cw(4,0+2*1) < 5) && (5 < crmax(4,0+2*1)) )))||(sforbid(0+2*1,5)> 0));
    ASSUME((!(( (cw(4,0+2*1) < 6) && (6 < crmax(4,0+2*1)) )))||(sforbid(0+2*1,6)> 0));
    ASSUME((!(( (cw(4,0+2*1) < 7) && (7 < crmax(4,0+2*1)) )))||(sforbid(0+2*1,7)> 0));
    ASSUME((!(( (cw(4,0+2*1) < 8) && (8 < crmax(4,0+2*1)) )))||(sforbid(0+2*1,8)> 0));
    ASSUME((!(( (cw(4,0+2*1) < 9) && (9 < crmax(4,0+2*1)) )))||(sforbid(0+2*1,9)> 0));
  } else {
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !102, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64 1, metadata !104, metadata !DIExpression()), !dbg !116

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !59
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !106, metadata !DIExpression()), !dbg !119
  ...
  // ST: Guess
  iw(4,6) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW 
  old_cw = cw(4,6);
  cw(4,6) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM 
  // Check
  ASSUME(active[iw(4,6)] == 4);
  ASSUME(active[cw(4,6)] == 4);
  ASSUME(sforbid(6,cw(4,6))== 0);
  ASSUME(iw(4,6) >= max(creg_r1,0));
  ASSUME(iw(4,6) >= 0);
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !124, metadata !DIExpression()), !dbg !132

  //   br label %label_5, !dbg !47
  goto T5BLOCK1;

T5BLOCK1:
  //   call void @llvm.dbg.label(metadata !131), !dbg !134

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !125, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64 2, metadata !127, metadata !DIExpression()), !dbg !135

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !50
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !128, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64 1, metadata !130, metadata !DIExpression()), !dbg !138

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) release, align 8, !dbg !53
  // ST: Guess
  //   : Release
  ...
  ASSUME(cw(5,0+4*1) >= cr(5,8+0));
  ASSUME(cw(5,0+4*1) >= cr(5,9+0));
  ASSUME(cw(5,0+4*1) >= cr(5,6+0));
  ASSUME(cw(5,0+4*1) >= cr(5,7+0));
  ASSUME(cw(5,0+4*1) >= cr(5,10+0));
  ASSUME(cw(5,0+4*1) >= cr(5,11+0));
  ASSUME(cw(5,0+4*1) >= cr(5,12+0));
  ASSUME(cw(5,0+4*1) >= cr(5,13+0));
  ...
  ASSUME(cw(5,0+4*1) >= cw(5,8+0));
  ASSUME(cw(5,0+4*1) >= cw(5,9+0));
  ASSUME(cw(5,0+4*1) >= cw(5,6+0));
  ASSUME(cw(5,0+4*1) >= cw(5,7+0));
  ASSUME(cw(5,0+4*1) >= cw(5,10+0));
  ASSUME(cw(5,0+4*1) >= cw(5,11+0));
  ASSUME(cw(5,0+4*1) >= cw(5,12+0));
  ASSUME(cw(5,0+4*1) >= cw(5,13+0));
  // Update
  caddr[5] = max(caddr[5],0);
  buff(5,0+4*1) = 1;
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !143, metadata !DIExpression()), !dbg !156

  //   br label %label_6, !dbg !53
  goto T6BLOCK1;

T6BLOCK1:
  //   call void @llvm.dbg.label(metadata !155), !dbg !158

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !145, metadata !DIExpression()), !dbg !159

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) acquire, align 8, !dbg !56
  // LD: Guess
  //   : Acquire
  old_cr = cr(6,0+4*1);
  cr(6,0+4*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN LDCOM 
  // Check
  ...
  ASSUME(cr(6,0+4*1) >= cs(6,8+0));
  ASSUME(cr(6,0+4*1) >= cs(6,9+0));
  ASSUME(cr(6,0+4*1) >= cs(6,6+0));
  ASSUME(cr(6,0+4*1) >= cs(6,7+0));
  ASSUME(cr(6,0+4*1) >= cs(6,10+0));
  ASSUME(cr(6,0+4*1) >= cs(6,11+0));
  ASSUME(cr(6,0+4*1) >= cs(6,12+0));
  ASSUME(cr(6,0+4*1) >= cs(6,13+0));
  // Update
  creg_r2 = cr(6,0+4*1);
  ...
  if(cr(6,0+4*1) < cw(6,0+4*1)) {
    ...
    ASSUME((!(( (cw(6,0+4*1) < 5) && (5 < crmax(6,0+4*1)) )))||(sforbid(0+4*1,5)> 0));
    ASSUME((!(( (cw(6,0+4*1) < 6) && (6 < crmax(6,0+4*1)) )))||(sforbid(0+4*1,6)> 0));
    ASSUME((!(( (cw(6,0+4*1) < 7) && (7 < crmax(6,0+4*1)) )))||(sforbid(0+4*1,7)> 0));
    ASSUME((!(( (cw(6,0+4*1) < 8) && (8 < crmax(6,0+4*1)) )))||(sforbid(0+4*1,8)> 0));
    ASSUME((!(( (cw(6,0+4*1) < 9) && (9 < crmax(6,0+4*1)) )))||(sforbid(0+4*1,9)> 0));
  } else {
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !147, metadata !DIExpression()), !dbg !159

  //   %conv = trunc i64 %0 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !144, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64 2, metadata !150, metadata !DIExpression()), !dbg !162

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !59
  // ST: Guess
  iw(6,0) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW 
  old_cw = cw(6,0);
  cw(6,0) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !151, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !152, metadata !DIExpression()), !dbg !165

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !154, metadata !DIExpression()), !dbg !165

  //   store atomic i64 %1, i64* @atom_5_X0_1 seq_cst, align 8, !dbg !62
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !175, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !176, metadata !DIExpression()), !dbg !242

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !177, metadata !DIExpression()), !dbg !244

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !181, metadata !DIExpression()), !dbg !246

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !182, metadata !DIExpression()), !dbg !248

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !183, metadata !DIExpression()), !dbg !250

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !184, metadata !DIExpression()), !dbg !252

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !185, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !186, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !255

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !189, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !257

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !192, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !259

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !195, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !261

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !198, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !263

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !201, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !204, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !267

  //   store atomic i64 0, i64* @atom_3_X0_1 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !207, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !269

  //   store atomic i64 0, i64* @atom_5_X0_1 monotonic, align 8, !dbg !137
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !138
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !139
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !141
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #7, !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call19 = call i32 @pthread_create(i64* noundef %thr5, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t5, i8* noundef null) #7, !dbg !143
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i64, i64* %thr0, align 8, !dbg !144, !tbaa !145
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   %call20 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !149
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr1, align 8, !dbg !150, !tbaa !145
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call21 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !151
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load i64, i64* %thr2, align 8, !dbg !152, !tbaa !145
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   %call22 = call i32 @pthread_join(i64 noundef %8, i8** noundef null), !dbg !153
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %9 = load i64, i64* %thr3, align 8, !dbg !154, !tbaa !145
  // LD: Guess
  old_cr = cr(0,11);
  ...
  //   %call23 = call i32 @pthread_join(i64 noundef %9, i8** noundef null), !dbg !155
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %10 = load i64, i64* %thr4, align 8, !dbg !156, !tbaa !145
  // LD: Guess
  old_cr = cr(0,12);
  ...
  //   %call24 = call i32 @pthread_join(i64 noundef %10, i8** noundef null), !dbg !157
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %11 = load i64, i64* %thr5, align 8, !dbg !158, !tbaa !145
  // LD: Guess
  old_cr = cr(0,13);
  ...
  //   %call25 = call i32 @pthread_join(i64 noundef %11, i8** noundef null), !dbg !159
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !211, metadata !DIExpression()), !dbg !293

  //   %12 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !161
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !213, metadata !DIExpression()), !dbg !293

  //   %conv = trunc i64 %12 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !210, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !215, metadata !DIExpression()), !dbg !296

  //   %13 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !164
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !217, metadata !DIExpression()), !dbg !296

  //   %conv29 = trunc i64 %13 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !214, metadata !DIExpression()), !dbg !242

  //   %cmp = icmp eq i32 %conv29, 2, !dbg !166

  //   %conv30 = zext i1 %cmp to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !218, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !220, metadata !DIExpression()), !dbg !300

  //   %14 = load atomic i64, i64* @atom_3_X0_1 seq_cst, align 8, !dbg !168
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !222, metadata !DIExpression()), !dbg !300

  //   %conv34 = trunc i64 %14 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !219, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !224, metadata !DIExpression()), !dbg !303

  //   %15 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) seq_cst, align 8, !dbg !171
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %15, metadata !226, metadata !DIExpression()), !dbg !303

  //   %conv38 = trunc i64 %15 to i32, !dbg !172

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !223, metadata !DIExpression()), !dbg !242

  //   %cmp39 = icmp eq i32 %conv38, 2, !dbg !173

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !227, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !229, metadata !DIExpression()), !dbg !307

  //   %16 = load atomic i64, i64* @atom_5_X0_1 seq_cst, align 8, !dbg !175
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %16, metadata !231, metadata !DIExpression()), !dbg !307

  //   %conv44 = trunc i64 %16 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !228, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !233, metadata !DIExpression()), !dbg !310

  //   %17 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !178
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %17, metadata !235, metadata !DIExpression()), !dbg !310

  //   %conv48 = trunc i64 %17 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !232, metadata !DIExpression()), !dbg !242

  //   %cmp49 = icmp eq i32 %conv48, 1, !dbg !180

  //   %conv50 = zext i1 %cmp49 to i32, !dbg !180

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !236, metadata !DIExpression()), !dbg !242

  //   %and = and i32 %conv44, %conv50, !dbg !181
  creg_r16 = max(creg_r14,max(creg_r15,0));
  ASSUME(active[creg_r16] == 0);
  r16 = r14 & (r15==1);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !237, metadata !DIExpression()), !dbg !242

  //   %and51 = and i32 %conv40, %and, !dbg !182
  creg_r17 = max(max(creg_r13,0),creg_r16);
  ASSUME(active[creg_r17] == 0);
  r17 = (r13==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !238, metadata !DIExpression()), !dbg !242

  //   %and52 = and i32 %conv34, %and51, !dbg !183
  creg_r18 = max(creg_r12,creg_r17);
  ASSUME(active[creg_r18] == 0);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !239, metadata !DIExpression()), !dbg !242

  //   %and53 = and i32 %conv30, %and52, !dbg !184
  creg_r19 = max(max(creg_r11,0),creg_r18);
  ASSUME(active[creg_r19] == 0);
  r19 = (r11==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !240, metadata !DIExpression()), !dbg !242

  //   %and54 = and i32 %conv, %and53, !dbg !185
  creg_r20 = max(creg_r10,creg_r19);
  ASSUME(active[creg_r20] == 0);
  r20 = r10 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !241, metadata !DIExpression()), !dbg !242

  //   %cmp55 = icmp eq i32 %and54, 1, !dbg !186

  //   br i1 %cmp55, label %if.then, label %if.end, !dbg !188
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([131 x i8], [131 x i8]* @.str.1, i64 0, i64 0), i32 noundef 112, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !189

  //   unreachable, !dbg !189
  r21 = 1;

T0BLOCK2:
  //   %18 = bitcast i64* %thr5 to i8*, !dbg !192

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %18) #7, !dbg !192

  //   %19 = bitcast i64* %thr4 to i8*, !dbg !192

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %19) #7, !dbg !192

  //   %20 = bitcast i64* %thr3 to i8*, !dbg !192

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %20) #7, !dbg !192

  //   %21 = bitcast i64* %thr2 to i8*, !dbg !192

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %21) #7, !dbg !192

  //   %22 = bitcast i64* %thr1 to i8*, !dbg !192

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %22) #7, !dbg !192

  //   %23 = bitcast i64* %thr0 to i8*, !dbg !192

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %23) #7, !dbg !192
