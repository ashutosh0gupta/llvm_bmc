...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !167, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !168, metadata !DIExpression()), !dbg !226

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !169, metadata !DIExpression()), !dbg !228

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !173, metadata !DIExpression()), !dbg !230

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !174, metadata !DIExpression()), !dbg !232

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !175, metadata !DIExpression()), !dbg !234

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !176, metadata !DIExpression()), !dbg !236

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !177, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !178, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !181, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !184, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !190, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !193, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !197, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !199, metadata !DIExpression()), !dbg !251

  //   store atomic i32 0, i32* @atom_3_X0_1 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X0_1, metadata !200, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i32 0, metadata !202, metadata !DIExpression()), !dbg !253

  //   store atomic i32 0, i32* @atom_5_X0_1 monotonic, align 4, !dbg !129
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l82_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l82_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !203, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !205, metadata !DIExpression()), !dbg !276

  //   %13 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !156
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !207, metadata !DIExpression()), !dbg !276

  //   %conv = trunc i64 %13 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !204, metadata !DIExpression()), !dbg !226

  //   %cmp = icmp eq i32 %conv, 2, !dbg !158
  creg__r11__2_ = max(0,creg_r11);

  //   %conv26 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !208, metadata !DIExpression()), !dbg !226

  //   %14 = load i32, i32* @atom_3_X0_1, align 4, !dbg !159, !tbaa !153
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !209, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !211, metadata !DIExpression()), !dbg !281

  //   %15 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !161
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %15, metadata !213, metadata !DIExpression()), !dbg !281

  //   %conv30 = trunc i64 %15 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !210, metadata !DIExpression()), !dbg !226

  //   %cmp31 = icmp eq i32 %conv30, 2, !dbg !163
  creg__r13__2_ = max(0,creg_r13);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !214, metadata !DIExpression()), !dbg !226

  //   %16 = load i32, i32* @atom_5_X0_1, align 4, !dbg !164, !tbaa !153
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !215, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !217, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64 %17, metadata !219, metadata !DIExpression()), !dbg !286

  //   %conv36 = trunc i64 %17 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !216, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !220, metadata !DIExpression()), !dbg !226

  //   %and = and i32 %16, %conv38, !dbg !169
  creg_r16 = max(creg__r15__1_,creg_r14);
  r16 = r14 & (r15==1);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !221, metadata !DIExpression()), !dbg !226

  //   %and39 = and i32 %conv32, %and, !dbg !170
  creg_r17 = max(creg__r13__2_,creg_r16);
  r17 = (r13==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !222, metadata !DIExpression()), !dbg !226

  //   %and40 = and i32 %14, %and39, !dbg !171
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !223, metadata !DIExpression()), !dbg !226

  //   %and41 = and i32 %conv26, %and40, !dbg !172
  creg_r19 = max(creg__r11__2_,creg_r18);
  r19 = (r11==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !224, metadata !DIExpression()), !dbg !226

  //   %and42 = and i32 %12, %and41, !dbg !173
  creg_r20 = max(creg_r10,creg_r19);
  r20 = r10 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !225, metadata !DIExpression()), !dbg !226
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([131 x i8], [131 x i8]* @.str.1, i64 0, i64 0), i32 noundef 112, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
