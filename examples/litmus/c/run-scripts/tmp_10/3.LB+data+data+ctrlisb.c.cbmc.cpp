...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !101, metadata !DIExpression()), !dbg !115
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !103, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !105, metadata !DIExpression()), !dbg !118

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !102, metadata !DIExpression()), !dbg !115
...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !106, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !109, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !110, metadata !DIExpression()), !dbg !131

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !112, metadata !DIExpression()), !dbg !131
