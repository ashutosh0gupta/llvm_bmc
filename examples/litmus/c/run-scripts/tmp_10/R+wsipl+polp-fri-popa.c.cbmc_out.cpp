...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !94
  ...
  //   store i32 %conv7, i32* @atom_1_X2_0, align 4, !dbg !71, !tbaa !72
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !131, metadata !DIExpression()), !dbg !165
  ...
  //   %7 = load i32, i32* @atom_1_X2_0, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
