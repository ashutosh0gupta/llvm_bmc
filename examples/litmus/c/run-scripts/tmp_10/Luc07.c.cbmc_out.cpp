...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !123, metadata !DIExpression()), !dbg !141

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !125, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %2, i64* @atom_3_X0_1 seq_cst, align 8, !dbg !70
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !175, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !178, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !181, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !184, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !229

  //   store atomic i64 0, i64* @atom_3_X2_0 monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !188, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !192, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !196, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !200, metadata !DIExpression()), !dbg !256

  //   %11 = load atomic i64, i64* @atom_3_X2_0 seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,7);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
