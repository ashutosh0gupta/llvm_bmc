...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv4, 0, !dbg !106
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !115), !dbg !130
  ...
  //   %cmp23 = icmp eq i32 %conv4, 1, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !95, metadata !DIExpression()), !dbg !148

  //   %7 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !99, metadata !DIExpression()), !dbg !151

  //   %8 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %8, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !133
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !203, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !206, metadata !DIExpression()), !dbg !282

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !282

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !148
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !238, metadata !DIExpression()), !dbg !318
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !242, metadata !DIExpression()), !dbg !321

  //   %11 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !187
  // LD: Guess
  old_cr = cr(0,5);
