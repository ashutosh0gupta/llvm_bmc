...
T2BLOCK4:
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !93, metadata !DIExpression()), !dbg !143

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %6, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv9, 1, !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !97, metadata !DIExpression()), !dbg !146

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %7, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !101, metadata !DIExpression()), !dbg !149

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !103, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %8, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !131
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv17, 0, !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !105, metadata !DIExpression()), !dbg !152

  //   %9 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !107, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %9, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !134
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !162, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !163, metadata !DIExpression()), !dbg !235

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !164, metadata !DIExpression()), !dbg !237

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !168, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !169, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !172, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !175, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !178, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !181, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !184, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !187, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !190, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !196, metadata !DIExpression()), !dbg !266

  //   %conv = trunc i64 %4 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !193, metadata !DIExpression()), !dbg !235

  //   %cmp = icmp eq i32 %conv, 1, !dbg !153

  //   %conv18 = zext i1 %cmp to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !197, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !199, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !201, metadata !DIExpression()), !dbg !270

  //   %conv22 = trunc i64 %5 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !198, metadata !DIExpression()), !dbg !235

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !157

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !202, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !204, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !206, metadata !DIExpression()), !dbg !274

  //   %conv28 = trunc i64 %6 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !203, metadata !DIExpression()), !dbg !235

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !161

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !207, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !209, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !211, metadata !DIExpression()), !dbg !278

  //   %conv34 = trunc i64 %7 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !208, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !213, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !215, metadata !DIExpression()), !dbg !281

  //   %conv38 = trunc i64 %8 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !212, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !217, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !219, metadata !DIExpression()), !dbg !284

  //   %conv42 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !216, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !221, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !223, metadata !DIExpression()), !dbg !287

  //   %conv46 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !220, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !225, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !227, metadata !DIExpression()), !dbg !290

  //   %conv50 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !224, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !229, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !230, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !231, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !232, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !233, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !234, metadata !DIExpression()), !dbg !235
