...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !146, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !147, metadata !DIExpression()), !dbg !205

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !148, metadata !DIExpression()), !dbg !207

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !152, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !153, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !155, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !156, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64 0, metadata !158, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !159, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !162, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !166, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !169, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !172, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !175, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !179, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !181, metadata !DIExpression()), !dbg !234

  //   %conv = trunc i64 %4 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !178, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !182, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !184, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !186, metadata !DIExpression()), !dbg !238

  //   %conv22 = trunc i64 %5 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !183, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !187, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !189, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !191, metadata !DIExpression()), !dbg !242

  //   %conv28 = trunc i64 %6 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !188, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !192, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !193, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !194, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !198, metadata !DIExpression()), !dbg !205

  //   %and31 = and i32 %9, %and, !dbg !156
  creg_r19 = max(creg_r15,creg_r18);
  r19 = r15 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !199, metadata !DIExpression()), !dbg !205

  //   %and32 = and i32 %8, %and31, !dbg !157
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !200, metadata !DIExpression()), !dbg !205

  //   %and33 = and i32 %7, %and32, !dbg !158
  creg_r21 = max(creg_r13,creg_r20);
  r21 = r13 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !201, metadata !DIExpression()), !dbg !205

  //   %and34 = and i32 %conv30, %and33, !dbg !159
  creg_r22 = max(creg__r12__1_,creg_r21);
  r22 = (r12==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !202, metadata !DIExpression()), !dbg !205

  //   %and35 = and i32 %conv24, %and34, !dbg !160
  creg_r23 = max(creg__r11__1_,creg_r22);
  r23 = (r11==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !203, metadata !DIExpression()), !dbg !205

  //   %and36 = and i32 %conv18, %and35, !dbg !161
  creg_r24 = max(creg__r10__1_,creg_r23);
  r24 = (r10==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !204, metadata !DIExpression()), !dbg !205
