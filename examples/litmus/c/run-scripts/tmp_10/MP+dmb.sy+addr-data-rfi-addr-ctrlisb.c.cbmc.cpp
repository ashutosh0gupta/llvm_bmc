...
T2BLOCK4:
  ...
  //   %cmp25 = icmp eq i32 %conv11, 1, !dbg !109
  ...
  //   store i32 %conv26, i32* @atom_1_X7_1, align 4, !dbg !110, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !147, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !150, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !153, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !156, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !159, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !162, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !166, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !169, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !173, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !176, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !177, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !181, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !185, metadata !DIExpression()), !dbg !232

  //   %conv28 = trunc i64 %6 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !182, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !186, metadata !DIExpression()), !dbg !195
