...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !99, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !100, metadata !DIExpression()), !dbg !122

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !101, metadata !DIExpression()), !dbg !124

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !105, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !106, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !112, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i32 0, metadata !115, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !116, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i32 0, metadata !118, metadata !DIExpression()), !dbg !133
