...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !50), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !45, metadata !DIExpression()), !dbg !51

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !46, metadata !DIExpression()), !dbg !66
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !80, metadata !DIExpression()), !dbg !93
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !116, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64 0, metadata !118, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !119, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64 0, metadata !121, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !123, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !125, metadata !DIExpression()), !dbg !154

  //   %conv = trunc i64 %4 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !122, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !127, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !129, metadata !DIExpression()), !dbg !157

  //   %conv13 = trunc i64 %5 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !126, metadata !DIExpression()), !dbg !131
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i64 0, i64 0), i32 noundef 56, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !101
