...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !104
  ...
  //   store i32 %conv12, i32* @atom_1_X0_1, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv4, 2, !dbg !94
  creg__r1__2_ = max(0,creg_r1);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !75, metadata !DIExpression()), !dbg !80

  //   store i32 %conv14, i32* @atom_1_X4_2, align 4, !dbg !95, !tbaa !90
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv11, 0, !dbg !96
  ...
  //   store i32 %conv16, i32* @atom_1_X5_0, align 4, !dbg !97, !tbaa !90
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !121, metadata !DIExpression()), !dbg !128
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !145, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !146, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !152, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !159, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !162, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !168, metadata !DIExpression()), !dbg !218

  //   %conv = trunc i64 %6 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !165, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !169, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !171, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !173, metadata !DIExpression()), !dbg !222

  //   %conv20 = trunc i64 %7 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !170, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !174, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !176, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !178, metadata !DIExpression()), !dbg !226

  //   %conv26 = trunc i64 %8 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !175, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !179, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !184, metadata !DIExpression()), !dbg !188

  //   %and30 = and i32 %conv28, %and29, !dbg !143
  creg_r15 = max(creg__r9__2_,creg_r14);
  r15 = (r9==2) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !185, metadata !DIExpression()), !dbg !188

  //   %and31 = and i32 %conv22, %and30, !dbg !144
  creg_r16 = max(creg__r8__1_,creg_r15);
  r16 = (r8==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !186, metadata !DIExpression()), !dbg !188

  //   %and32 = and i32 %conv16, %and31, !dbg !145
  creg_r17 = max(creg__r7__1_,creg_r16);
  r17 = (r7==1) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !187, metadata !DIExpression()), !dbg !188
