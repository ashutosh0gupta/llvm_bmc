...
T2BLOCK1:
  ...
  //   %xor6 = xor i32 %conv5, %conv5, !dbg !97
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !74, metadata !DIExpression()), !dbg !103

  //   %add8 = add nsw i32 0, %xor6, !dbg !98
  creg_r5 = max(0,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = 0 + r4;

  //   %idxprom = sext i32 %add8 to i64, !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !118

  //   %conv11 = trunc i64 %2 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !75, metadata !DIExpression()), !dbg !103
  ...
  //   %cmp22 = icmp eq i32 %conv5, 2, !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !91, metadata !DIExpression()), !dbg !129
  ...
  //   %cmp27 = icmp eq i32 %conv11, 0, !dbg !112
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !181, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !211, metadata !DIExpression()), !dbg !276
