...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !47, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64 1, metadata !49, metadata !DIExpression()), !dbg !65

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !66
  // ST: Guess
  //   : Release
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !82, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !85, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 3, metadata !87, metadata !DIExpression()), !dbg !99

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !58
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !101
  ...
  //   store i32 %conv3, i32* @atom_1_X3_0, align 4, !dbg !63, !tbaa !64
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_2, metadata !127, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !131, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !165

  //   store atomic i32 0, i32* @atom_0_X2_0 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !134, metadata !DIExpression()), !dbg !167
  ...
  //   %7 = load i32, i32* @atom_0_X2_0, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
