...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X0_1, metadata !227, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X2_0, metadata !231, metadata !DIExpression()), !dbg !284
  ...
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l101_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l101_c3
  // Check
