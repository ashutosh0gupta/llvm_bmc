...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !125, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !126, metadata !DIExpression()), !dbg !165

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !127, metadata !DIExpression()), !dbg !167

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !131, metadata !DIExpression()), !dbg !169

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !132, metadata !DIExpression()), !dbg !171

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !133, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !134, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !143, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !180

  //   store atomic i32 0, i32* @atom_1_X0_2 monotonic, align 4, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !147, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !98
  // ST: Guess
  ...
  //   %call10 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !101
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !102
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call12 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !108
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !110
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !112
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !114
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !153, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !154, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !202

  //   %9 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !158, metadata !DIExpression()), !dbg !202

  //   %conv20 = trunc i64 %9 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !155, metadata !DIExpression()), !dbg !165

  //   %cmp21 = icmp eq i32 %conv20, 2, !dbg !122
  creg__r8__2_ = max(0,creg_r8);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !159, metadata !DIExpression()), !dbg !165

  //   %10 = load i32, i32* @atom_1_X0_2, align 4, !dbg !123, !tbaa !124
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %11 = load i32, i32* @atom_1_X2_0, align 4, !dbg !126, !tbaa !124
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !133
