...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !92

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !60
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !77, metadata !DIExpression()), !dbg !92

  //   %conv4 = trunc i64 %1 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !74, metadata !DIExpression()), !dbg !84

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !63
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !78, metadata !DIExpression()), !dbg !84

  //   %add6 = add nsw i32 0, %xor5, !dbg !64
  creg_r9 = max(0,creg_r8);
  r9 = 0 + r8;

  //   %idxprom7 = sext i32 %add6 to i64, !dbg !64

  //   %arrayidx8 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom7, !dbg !64
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx8, metadata !79, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64 1, metadata !81, metadata !DIExpression()), !dbg !96

  //   store atomic i64 1, i64* %arrayidx8 monotonic, align 8, !dbg !64
  // ST: Guess
  ...
  //   %conv9 = zext i1 %cmp to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !82, metadata !DIExpression()), !dbg !84

  //   store i32 %conv9, i32* @atom_1_X0_1, align 4, !dbg !67, !tbaa !68
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !107, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !108, metadata !DIExpression()), !dbg !145

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !109, metadata !DIExpression()), !dbg !147

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !113, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !114, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i64 0, metadata !116, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !117, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64 0, metadata !119, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !120, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64 0, metadata !122, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !123, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i32 0, metadata !126, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !127, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i32 0, metadata !129, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !131, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !133, metadata !DIExpression()), !dbg !168

  //   %conv = trunc i64 %4 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !130, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !134, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !138, metadata !DIExpression()), !dbg !172

  //   %conv16 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !135, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !139, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !140, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !142, metadata !DIExpression()), !dbg !145

  //   %and19 = and i32 %conv18, %and, !dbg !116
  creg_r19 = max(creg__r15__1_,creg_r18);
  r19 = (r15==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !143, metadata !DIExpression()), !dbg !145

  //   %and20 = and i32 %conv12, %and19, !dbg !117
  creg_r20 = max(creg__r14__1_,creg_r19);
  r20 = (r14==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !144, metadata !DIExpression()), !dbg !145
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
