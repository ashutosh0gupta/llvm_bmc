...
T2BLOCK1:
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !76
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !67, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !69, metadata !DIExpression()), !dbg !96
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !74, metadata !DIExpression()), !dbg !88

  //   %add10 = add nsw i32 %xor9, 1, !dbg !83
  creg_r7 = max(0,creg_r6);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !75, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !103

  //   %conv11 = sext i32 %add10 to i64, !dbg !85

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !78, metadata !DIExpression()), !dbg !103

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !85
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 0, !dbg !95
  ...
  //   store i32 %conv18, i32* @atom_1_X3_0, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv8, 1, !dbg !97
  ...
  //   store i32 %conv20, i32* @atom_1_X5_1, align 4, !dbg !98, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !162, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !165, metadata !DIExpression()), !dbg !213
