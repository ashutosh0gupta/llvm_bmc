...
T1BLOCK1:
  ...
  //   store atomic i64 %conv3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !70
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !71
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !89, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64 3, metadata !91, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !93, metadata !DIExpression()), !dbg !105
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_2, metadata !131, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !135, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i32 0, metadata !137, metadata !DIExpression()), !dbg !169

  //   store atomic i32 0, i32* @atom_0_X2_1 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !138, metadata !DIExpression()), !dbg !171
  ...
  //   %7 = load i32, i32* @atom_0_X2_1, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
  ...
  creg_r15 = max(creg__r9__3_,creg_r14);
  r15 = (r9==3) & r14;
