...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !79), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !72, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !102
  ...
  //   store i32 %conv11, i32* @atom_1_X2_2, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv4, 2, !dbg !90
  ...
  //   store i32 %conv13, i32* @atom_1_X3_2, align 4, !dbg !91, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !135, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !139, metadata !DIExpression()), !dbg !170
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
