...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !68, metadata !DIExpression()), !dbg !85
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !72, metadata !DIExpression()), !dbg !88

  //   %conv = trunc i64 %0 to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !69, metadata !DIExpression()), !dbg !85

  //   %xor = xor i32 %conv, %conv, !dbg !60
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !73, metadata !DIExpression()), !dbg !85

  //   %add = add nsw i32 2, %xor, !dbg !61
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !77, metadata !DIExpression()), !dbg !93

  //   %conv4 = trunc i64 %1 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !74, metadata !DIExpression()), !dbg !85

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !64
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !78, metadata !DIExpression()), !dbg !85

  //   %add6 = add nsw i32 %xor5, 1, !dbg !65
  creg_r9 = max(0,creg_r8);
  r9 = r8 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !79, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !97

  //   %conv7 = sext i32 %add6 to i64, !dbg !67

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !82, metadata !DIExpression()), !dbg !97

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !67
  // ST: Guess
  ...
  //   %conv8 = zext i1 %cmp to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !83, metadata !DIExpression()), !dbg !85

  //   store i32 %conv8, i32* @atom_1_X0_1, align 4, !dbg !69, !tbaa !70
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !125, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !129, metadata !DIExpression()), !dbg !160
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
