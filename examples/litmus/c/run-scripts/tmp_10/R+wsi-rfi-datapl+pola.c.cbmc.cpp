...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !50, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !51, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !52, metadata !DIExpression()), !dbg !80

  //   %conv5 = sext i32 %add to i64, !dbg !81

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !54, metadata !DIExpression()), !dbg !80

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !81
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !56, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !60, metadata !DIExpression()), !dbg !86

  //   %2 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !62, metadata !DIExpression()), !dbg !86

  //   store atomic i64 %2, i64* @atom_0_X6_2 seq_cst, align 8, !dbg !87
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !99, metadata !DIExpression()), !dbg !112
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !139, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !142, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !145, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !159, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !163, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !167, metadata !DIExpression()), !dbg !213
