...
T2BLOCK4:
  ...
  //   %add14 = add nsw i32 %xor13, 1, !dbg !94
  creg_r8 = max(0,creg_r7);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add14, metadata !77, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !114

  //   %conv15 = sext i32 %add14 to i64, !dbg !96

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !80, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv4, 2, !dbg !106
  ...
  //   store i32 %conv22, i32* @atom_1_X2_2, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv19, 1, !dbg !108
  ...
  //   store i32 %conv24, i32* @atom_1_X10_1, align 4, !dbg !109, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !177, metadata !DIExpression()), !dbg !216
