...
T2BLOCK1:
  ...
  //   %add7 = add nsw i32 3, %xor5, !dbg !86
  creg_r6 = max(0,creg_r5);
  r6 = 3 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !86

  //   %arrayidx9 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !86
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !75, metadata !DIExpression()), !dbg !106

  //   %2 = load atomic i64, i64* %arrayidx9 monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,r7);
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !91), !dbg !113

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !114

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   store i32 %conv23, i32* @atom_1_X5_2, align 4, !dbg !108, !tbaa !103
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X9_0, align 4, !dbg !110, !tbaa !103
  // ST: Guess
  ...
  //   store i32 %conv27, i32* @atom_1_X11_0, align 4, !dbg !112, !tbaa !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !177, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !228

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !180, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !183, metadata !DIExpression()), !dbg !232
  ...
  //   %10 = load i32, i32* @atom_1_X5_2, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
