...
T2BLOCK4:
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !112
  r5 = 0+r4*1;
  ASSUME(creg_r5 >= 0);
  ASSUME(creg_r5 >= creg_r4);
  ASSUME(active[creg_r5] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !132

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !132
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !110), !dbg !139
