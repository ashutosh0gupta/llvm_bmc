...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !123

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !75, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !88, metadata !DIExpression()), !dbg !135
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !170, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !173, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !191, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !195, metadata !DIExpression()), !dbg !245
