...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !65, metadata !DIExpression()), !dbg !76
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !67, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !69, metadata !DIExpression()), !dbg !79

  //   %conv = trunc i64 %0 to i32, !dbg !53

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !66, metadata !DIExpression()), !dbg !76
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !72, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !73, metadata !DIExpression()), !dbg !76
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !101, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !102, metadata !DIExpression()), !dbg !124

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !103, metadata !DIExpression()), !dbg !126

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !107, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !108, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i64 0, metadata !110, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !111, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64 0, metadata !113, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !114, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i32 0, metadata !117, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !118, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i32 0, metadata !120, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !121, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !122, metadata !DIExpression()), !dbg !124

  //   %and = and i32 %4, %5, !dbg !90
  creg_r7 = max(creg_r5,creg_r6);
  r7 = r5 & r6;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !123, metadata !DIExpression()), !dbg !124
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 58, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !94
