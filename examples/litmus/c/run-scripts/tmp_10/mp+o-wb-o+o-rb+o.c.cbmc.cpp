...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !107, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i32 0, metadata !110, metadata !DIExpression()), !dbg !126

  //   store atomic i32 0, i32* @atom_1_X0_2 monotonic, align 4, !dbg !73
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_1_X0_2, align 4, !dbg !86, !tbaa !87
  // LD: Guess
  old_cr = cr(0,2);
