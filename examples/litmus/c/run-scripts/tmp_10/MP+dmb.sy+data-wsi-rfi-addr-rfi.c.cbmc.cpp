...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor8, metadata !75, metadata !DIExpression()), !dbg !87

  //   %add10 = add nsw i32 0, %xor8, !dbg !84
  creg_r5 = max(0,creg_r4);
  r5 = 0 + r4;

  //   %idxprom = sext i32 %add10 to i64, !dbg !84
  ...
  //   %cmp17 = icmp eq i32 %conv7, 2, !dbg !95
  ...
  //   store i32 %conv18, i32* @atom_1_X5_2, align 4, !dbg !96, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !146, metadata !DIExpression()), !dbg !188
