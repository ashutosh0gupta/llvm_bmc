...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !80, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !83, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !87, metadata !DIExpression()), !dbg !113

  //   %conv11 = trunc i64 %2 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !84, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !88, metadata !DIExpression()), !dbg !92

  //   store i32 %conv12, i32* @atom_1_X2_1, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv11, 1, !dbg !94
  ...
  //   store i32 %conv14, i32* @atom_1_X7_1, align 4, !dbg !95, !tbaa !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !144, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !148, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !151, metadata !DIExpression()), !dbg !186
