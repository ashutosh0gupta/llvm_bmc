...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !60, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !68, metadata !DIExpression()), !dbg !86

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !70, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !72, metadata !DIExpression()), !dbg !89

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !74, metadata !DIExpression()), !dbg !89
