...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !121

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp22 = icmp eq i32 %conv9, 2, !dbg !114
  ...
  //   store i32 %conv23, i32* @atom_1_X6_2, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv16, 0, !dbg !116
  ...
  //   store i32 %conv25, i32* @atom_1_X7_0, align 4, !dbg !117, !tbaa !110
  // ST: Guess
  ...
  //   store i32 %conv27, i32* @atom_1_X9_0, align 4, !dbg !119, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !184, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !187, metadata !DIExpression()), !dbg !237
