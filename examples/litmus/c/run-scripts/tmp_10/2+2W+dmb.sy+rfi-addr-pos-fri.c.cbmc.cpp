...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !87, metadata !DIExpression()), !dbg !115

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !115

  //   store atomic i64 %5, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !144, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64 0, metadata !146, metadata !DIExpression()), !dbg !186

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !166, metadata !DIExpression()), !dbg !212

  //   %8 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !130
  // LD: Guess
  old_cr = cr(0,4);
