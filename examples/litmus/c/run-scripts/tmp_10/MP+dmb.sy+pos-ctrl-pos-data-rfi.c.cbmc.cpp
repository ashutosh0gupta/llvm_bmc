...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !71, metadata !DIExpression()), !dbg !89

  //   %xor = xor i32 %conv12, %conv12, !dbg !91
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !75, metadata !DIExpression()), !dbg !89

  //   %add = add nsw i32 %xor, 1, !dbg !92
  creg_r5 = max(0,creg_r4);
  r5 = r4 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !76, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !112

  //   %conv13 = sext i32 %add to i64, !dbg !94

  //   call void @llvm.dbg.value(metadata i64 %conv13, metadata !79, metadata !DIExpression()), !dbg !112

  //   store atomic i64 %conv13, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv4, 1, !dbg !104
  ...
  //   store i32 %conv20, i32* @atom_1_X2_1, align 4, !dbg !105, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !155, metadata !DIExpression()), !dbg !191
