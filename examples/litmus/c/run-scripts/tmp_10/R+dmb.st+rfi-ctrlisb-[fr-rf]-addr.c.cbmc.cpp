...
T2BLOCK4:
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !117

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   %cmp = icmp eq i32 %conv, 2, !dbg !105

  //   %conv13 = zext i1 %cmp to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !81, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !82, metadata !DIExpression()), !dbg !125

  //   %4 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !125

  //   store atomic i64 %4, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !107
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 0, !dbg !108

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !85, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !86, metadata !DIExpression()), !dbg !128

  //   %5 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !128

  //   store atomic i64 %5, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !110
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv8, 1, !dbg !111

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !89, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !90, metadata !DIExpression()), !dbg !131

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %6, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv12, 0, !dbg !114

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !93, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !94, metadata !DIExpression()), !dbg !134

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !96, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !116
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !157, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !158, metadata !DIExpression()), !dbg !223

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !159, metadata !DIExpression()), !dbg !225

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !163, metadata !DIExpression()), !dbg !227

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !164, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !165, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !174, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !183, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !187, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !189, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !192, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !194, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !197, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !199, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !202, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !204, metadata !DIExpression()), !dbg !269

  //   %conv34 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !201, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !206, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !208, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !210, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !212, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !214, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !216, metadata !DIExpression()), !dbg !278
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
