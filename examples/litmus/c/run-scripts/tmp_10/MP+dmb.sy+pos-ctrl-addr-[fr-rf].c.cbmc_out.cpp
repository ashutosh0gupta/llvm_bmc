...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !87), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !110

  //   %conv16 = trunc i64 %4 to i32, !dbg !93
  ...
  //   store i32 %conv17, i32* @atom_1_X0_1, align 4, !dbg !95, !tbaa !96
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv4, 1, !dbg !100
  ...
  //   store i32 %conv19, i32* @atom_1_X2_1, align 4, !dbg !101, !tbaa !96
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv12, 0, !dbg !102
  ...
  //   store i32 %conv21, i32* @atom_1_X6_0, align 4, !dbg !103, !tbaa !96
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv16, 1, !dbg !104
  ...
  //   store i32 %conv23, i32* @atom_1_X8_1, align 4, !dbg !105, !tbaa !96
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !167, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !170, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !173, metadata !DIExpression()), !dbg !214
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
