...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !95), !dbg !107
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !92
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !71, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !73, metadata !DIExpression()), !dbg !113

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,r4);
  cr(2,r4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l36_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !113

  //   %conv8 = trunc i64 %2 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !96
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !115

  //   %conv12 = trunc i64 %3 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !96

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !99
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !80, metadata !DIExpression()), !dbg !96

  //   %add15 = add nsw i32 0, %xor13, !dbg !100
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !100

  //   %arrayidx17 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !100
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !82, metadata !DIExpression()), !dbg !120

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   %conv20 = trunc i64 %4 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !81, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !122

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !122

  //   %conv24 = trunc i64 %5 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !85, metadata !DIExpression()), !dbg !96

  //   %cmp = icmp eq i32 %conv, 1, !dbg !106
  creg__r0__1_ = max(0,creg_r0);

  //   %conv25 = zext i1 %cmp to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !89, metadata !DIExpression()), !dbg !96

  //   store i32 %conv25, i32* @atom_1_X0_1, align 4, !dbg !107, !tbaa !108
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv8, 0, !dbg !112
  creg__r5__0_ = max(0,creg_r5);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !90, metadata !DIExpression()), !dbg !96

  //   store i32 %conv27, i32* @atom_1_X5_0, align 4, !dbg !113, !tbaa !108
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv12, 1, !dbg !114
  creg__r6__1_ = max(0,creg_r6);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !91, metadata !DIExpression()), !dbg !96

  //   store i32 %conv29, i32* @atom_1_X7_1, align 4, !dbg !115, !tbaa !108
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv20, 0, !dbg !116
  creg__r10__0_ = max(0,creg_r10);

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !92, metadata !DIExpression()), !dbg !96

  //   store i32 %conv31, i32* @atom_1_X9_0, align 4, !dbg !117, !tbaa !108
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv24, 0, !dbg !118
  creg__r11__0_ = max(0,creg_r11);

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !93, metadata !DIExpression()), !dbg !96

  //   store i32 %conv33, i32* @atom_1_X11_0, align 4, !dbg !119, !tbaa !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !160, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !161, metadata !DIExpression()), !dbg !223

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !162, metadata !DIExpression()), !dbg !225

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !166, metadata !DIExpression()), !dbg !227

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !167, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !168, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !171, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !180, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !184, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !240

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !187, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !242

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !190, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !244

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !193, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !246

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !197, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !199, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !202, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !204, metadata !DIExpression()), !dbg !263

  //   %conv26 = trunc i64 %7 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !201, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !207, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !209, metadata !DIExpression()), !dbg !267

  //   %conv32 = trunc i64 %8 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !206, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !210, metadata !DIExpression()), !dbg !223
  ...
  //   %10 = load i32, i32* @atom_1_X5_0, align 4, !dbg !162, !tbaa !160
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X7_1, align 4, !dbg !163, !tbaa !160
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %12 = load i32, i32* @atom_1_X9_0, align 4, !dbg !164, !tbaa !160
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %13 = load i32, i32* @atom_1_X11_0, align 4, !dbg !165, !tbaa !160
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !217, metadata !DIExpression()), !dbg !223

  //   %and36 = and i32 %10, %and35, !dbg !168
  creg_r26 = max(creg_r20,creg_r25);
  r26 = r20 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !218, metadata !DIExpression()), !dbg !223

  //   %and37 = and i32 %9, %and36, !dbg !169
  creg_r27 = max(creg_r19,creg_r26);
  r27 = r19 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !219, metadata !DIExpression()), !dbg !223

  //   %and38 = and i32 %conv34, %and37, !dbg !170
  creg_r28 = max(creg__r18__1_,creg_r27);
  r28 = (r18==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !220, metadata !DIExpression()), !dbg !223

  //   %and39 = and i32 %conv28, %and38, !dbg !171
  creg_r29 = max(creg__r17__1_,creg_r28);
  r29 = (r17==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !221, metadata !DIExpression()), !dbg !223

  //   %and40 = and i32 %conv22, %and39, !dbg !172
  creg_r30 = max(creg__r16__1_,creg_r29);
  r30 = (r16==1) & r29;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !222, metadata !DIExpression()), !dbg !223
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 101, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !176
