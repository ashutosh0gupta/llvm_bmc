...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !73, metadata !DIExpression()), !dbg !128

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,r4);
