...
T2BLOCK4:
  ...
  //   %xor14 = xor i32 %conv13, %conv13, !dbg !96
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor14, metadata !80, metadata !DIExpression()), !dbg !90

  //   %add16 = add nsw i32 0, %xor14, !dbg !97
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom = sext i32 %add16 to i64, !dbg !97

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !97
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !82, metadata !DIExpression()), !dbg !117
