...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !83, metadata !DIExpression()), !dbg !132

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !132

  //   %conv16 = trunc i64 %4 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !82, metadata !DIExpression()), !dbg !116

  //   %xor17 = xor i32 %conv16, %conv16, !dbg !116
  creg_r8 = max(creg_r7,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !86, metadata !DIExpression()), !dbg !116

  //   %add19 = add nsw i32 0, %xor17, !dbg !117
  creg_r9 = max(0,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = 0 + r8;

  //   %idxprom20 = sext i32 %add19 to i64, !dbg !117

  //   %arrayidx21 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !117
  r10 = 0+r9*1;
  ASSUME(creg_r10 >= 0);
  ASSUME(creg_r10 >= creg_r9);
  ASSUME(active[creg_r10] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !88, metadata !DIExpression()), !dbg !137

  //   %5 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(2,r10);
  cr(2,r10) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  if(cr(2,r10) < cw(2,r10)) {
    ...
    ASSUME((!(( (cw(2,r10) < 5) && (5 < crmax(2,r10)) )))||(sforbid(r10,5)> 0));
    ASSUME((!(( (cw(2,r10) < 6) && (6 < crmax(2,r10)) )))||(sforbid(r10,6)> 0));
    ASSUME((!(( (cw(2,r10) < 7) && (7 < crmax(2,r10)) )))||(sforbid(r10,7)> 0));
    ASSUME((!(( (cw(2,r10) < 8) && (8 < crmax(2,r10)) )))||(sforbid(r10,8)> 0));
    ASSUME((!(( (cw(2,r10) < 9) && (9 < crmax(2,r10)) )))||(sforbid(r10,9)> 0));
  } else {
  ...
  //   %cmp42 = icmp eq i32 %conv16, 1, !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !108, metadata !DIExpression()), !dbg !152

  //   %10 = zext i32 %conv43 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !110, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %10, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !112, metadata !DIExpression()), !dbg !155

  //   %11 = zext i32 %conv48 to i64

  //   call void @llvm.dbg.value(metadata i64 %11, metadata !114, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %11, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !137
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !207, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !281

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !152
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !210, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !245, metadata !DIExpression()), !dbg !322

  //   %13 = load atomic i64, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !193
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !249, metadata !DIExpression()), !dbg !325
