...
T1BLOCK1:
  ...
  //   %cmp8 = icmp eq i32 %conv, 0, !dbg !76
  ...
  //   store i32 %conv9, i32* @atom_0_X2_0, align 4, !dbg !77, !tbaa !72
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !81, metadata !DIExpression()), !dbg !96
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !82, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 2, metadata !84, metadata !DIExpression()), !dbg !99
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !90, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !92, metadata !DIExpression()), !dbg !110
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_2, metadata !139, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !143, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !146, metadata !DIExpression()), !dbg !181
  ...
  //   %7 = load i32, i32* @atom_0_X2_0, align 4, !dbg !123, !tbaa !121
  // LD: Guess
  old_cr = cr(0,4);
