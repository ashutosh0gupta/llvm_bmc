...
T2BLOCK10:
  ...
  //   %cmp27 = icmp eq i32 %conv4, 0, !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !91, metadata !DIExpression()), !dbg !153

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !135
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv8, 1, !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !95, metadata !DIExpression()), !dbg !156

  //   %7 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !156

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !138
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !168, metadata !DIExpression()), !dbg !175
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !211, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !245, metadata !DIExpression()), !dbg !325
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !249, metadata !DIExpression()), !dbg !328
