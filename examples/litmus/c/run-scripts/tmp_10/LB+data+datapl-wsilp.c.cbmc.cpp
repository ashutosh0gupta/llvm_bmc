...
T1BLOCK1:
  ...
  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !61
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !68, metadata !DIExpression()), !dbg !86
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !72, metadata !DIExpression()), !dbg !89

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !69, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !74, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !77, metadata !DIExpression()), !dbg !94

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !64
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64 2, metadata !80, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !81, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !82, metadata !DIExpression()), !dbg !99

  //   %1 = zext i32 %conv4 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !84, metadata !DIExpression()), !dbg !99
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !109, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !110, metadata !DIExpression()), !dbg !143

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !111, metadata !DIExpression()), !dbg !145

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !115, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !116, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64 0, metadata !118, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i64 0, metadata !121, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_2, metadata !122, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64 0, metadata !124, metadata !DIExpression()), !dbg !152

  //   store atomic i64 0, i64* @atom_0_X0_2 monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !125, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64 0, metadata !127, metadata !DIExpression()), !dbg !154

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !131, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_2, metadata !134, metadata !DIExpression()), !dbg !170

  //   %5 = load atomic i64, i64* @atom_0_X0_2 seq_cst, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !136, metadata !DIExpression()), !dbg !170

  //   %conv14 = trunc i64 %5 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !133, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !138, metadata !DIExpression()), !dbg !173

  //   %6 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !140, metadata !DIExpression()), !dbg !173

  //   %conv18 = trunc i64 %6 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !137, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !142, metadata !DIExpression()), !dbg !143
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !112
