...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !159, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !160, metadata !DIExpression()), !dbg !227

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !161, metadata !DIExpression()), !dbg !229

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !165, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !166, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !169, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !172, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !175, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !178, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !181, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !242

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !184, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !244

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !130
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !187, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !246

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !132
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !191, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !193, metadata !DIExpression()), !dbg !258

  //   %conv = trunc i64 %4 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !190, metadata !DIExpression()), !dbg !227

  //   %cmp = icmp eq i32 %conv, 1, !dbg !146

  //   %conv18 = zext i1 %cmp to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !194, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !196, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !198, metadata !DIExpression()), !dbg !262

  //   %conv22 = trunc i64 %5 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !195, metadata !DIExpression()), !dbg !227

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !150

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !199, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !201, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !203, metadata !DIExpression()), !dbg !266

  //   %conv28 = trunc i64 %6 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !200, metadata !DIExpression()), !dbg !227

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !154

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !204, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !208, metadata !DIExpression()), !dbg !270

  //   %conv34 = trunc i64 %7 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !205, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !210, metadata !DIExpression()), !dbg !273

  //   %8 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !159
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !212, metadata !DIExpression()), !dbg !273

  //   %conv38 = trunc i64 %8 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !209, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !214, metadata !DIExpression()), !dbg !276

  //   %9 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !162
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !216, metadata !DIExpression()), !dbg !276

  //   %conv42 = trunc i64 %9 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !213, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !218, metadata !DIExpression()), !dbg !279

  //   %10 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !220, metadata !DIExpression()), !dbg !279

  //   %conv46 = trunc i64 %10 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !217, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !221, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !222, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !223, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !224, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %and50, metadata !225, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !226, metadata !DIExpression()), !dbg !227
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !176
