...
T2BLOCK1:
  ...
  //   %cmp18 = icmp eq i32 %conv10, 1, !dbg !98
  ...
  //   store i32 %conv19, i32* @atom_1_X7_1, align 4, !dbg !99, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !149, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !187

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X7_1, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
