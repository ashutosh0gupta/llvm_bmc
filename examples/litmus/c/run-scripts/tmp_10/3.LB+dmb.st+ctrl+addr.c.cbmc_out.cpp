...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !90
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !102, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !103, metadata !DIExpression()), !dbg !116
  ...
  // ST: Guess
  iw(3,r5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l44_c3
  old_cw = cw(3,r5);
  cw(3,r5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l44_c3
  // Check
