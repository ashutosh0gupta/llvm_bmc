...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 4, metadata !74, metadata !DIExpression()), !dbg !96

  //   store atomic i64 4, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !65
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !106
  ...
  //   store i32 %conv11, i32* @atom_1_X6_2, align 4, !dbg !78, !tbaa !79
  // ST: Guess
  ...
  //   store i32 %conv13, i32* @atom_1_X5_1, align 4, !dbg !84, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_4, metadata !134, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !138, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !141, metadata !DIExpression()), !dbg !168
