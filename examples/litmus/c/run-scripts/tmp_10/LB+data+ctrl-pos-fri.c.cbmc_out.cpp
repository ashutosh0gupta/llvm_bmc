...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !80, metadata !DIExpression()), !dbg !105
  ...
  //   %cmp10 = icmp eq i32 %conv4, 0, !dbg !88
  ...
  //   store i32 %conv11, i32* @atom_1_X2_0, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   store i32 %conv13, i32* @atom_1_X4_0, align 4, !dbg !91, !tbaa !84
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !147, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !150, metadata !DIExpression()), !dbg !187
  ...
  //   %8 = load i32, i32* @atom_1_X2_0, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
