...
T2BLOCK1:
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !83
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !71, metadata !DIExpression()), !dbg !103

  //   %conv4 = trunc i64 %1 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !95
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !108

  //   %conv12 = trunc i64 %3 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !95

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !92
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !80, metadata !DIExpression()), !dbg !95

  //   %add14 = add nsw i32 %xor13, 1, !dbg !93
  creg_r8 = max(0,creg_r7);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add14, metadata !81, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !113

  //   %conv15 = sext i32 %add14 to i64, !dbg !95

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !84, metadata !DIExpression()), !dbg !113

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !95
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv4, 0, !dbg !105
  ...
  //   store i32 %conv22, i32* @atom_1_X3_0, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv8, 0, !dbg !107
  ...
  //   store i32 %conv24, i32* @atom_1_X5_0, align 4, !dbg !108, !tbaa !101
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv12, 1, !dbg !109
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !174, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !177, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !180, metadata !DIExpression()), !dbg !232
