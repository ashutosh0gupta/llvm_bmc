...
T0BLOCK0:
  ...
  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #6, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !146, metadata !DIExpression()), !dbg !187

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #6, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !147, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !160, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !164, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !167, metadata !DIExpression()), !dbg !202
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #6, !dbg !109
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #6, !dbg !110
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !170, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !174, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !177, metadata !DIExpression()), !dbg !181
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !138
