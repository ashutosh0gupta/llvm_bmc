...
T2BLOCK4:
  ...
  //   store i32 %conv27, i32* @atom_1_X6_0, align 4, !dbg !118, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !190, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !247

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !133
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X6_0, align 4, !dbg !168, !tbaa !164
  // LD: Guess
  old_cr = cr(0,6);
