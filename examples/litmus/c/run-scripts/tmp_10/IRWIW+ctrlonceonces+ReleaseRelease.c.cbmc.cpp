...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !49, metadata !DIExpression()), !dbg !65
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !50, metadata !DIExpression()), !dbg !65

  //   %cmp = icmp eq i32 %conv, 0, !dbg !58

  //   %conv1 = zext i1 %cmp to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !55, metadata !DIExpression()), !dbg !65

  //   %tobool = icmp ne i32 %conv1, 0, !dbg !59
...
T2BLOCK2:
  //   br label %lbl_label160, !dbg !62
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label160, !dbg !63
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !64), !dbg !77

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !56, metadata !DIExpression()), !dbg !78
  ...
  //   %cmp2 = icmp eq i32 %conv, 2, !dbg !67

  //   %conv3 = zext i1 %cmp2 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !59, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !60, metadata !DIExpression()), !dbg !81

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !62, metadata !DIExpression()), !dbg !81

  //   store atomic i64 %1, i64* @atom_1_X0_2 seq_cst, align 8, !dbg !69
  // ST: Guess
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !101, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !103, metadata !DIExpression()), !dbg !117

  //   %conv = trunc i64 %0 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !100, metadata !DIExpression()), !dbg !114

  //   %cmp = icmp eq i32 %conv, 0, !dbg !58

  //   %conv1 = zext i1 %cmp to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !104, metadata !DIExpression()), !dbg !114
...
T4BLOCK2:
  //   br label %lbl_label161, !dbg !62
  goto T4BLOCK4;

T4BLOCK3:
  //   br label %lbl_label161, !dbg !63
  goto T4BLOCK4;

T4BLOCK4:
  //   call void @llvm.dbg.label(metadata !113), !dbg !126

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !105, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 1, metadata !107, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !108, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_2, metadata !109, metadata !DIExpression()), !dbg !130

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !111, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %1, i64* @atom_3_X0_2 seq_cst, align 8, !dbg !69
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !148, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !152, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !155, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_2, metadata !158, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !167, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !169, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !172, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !174, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_2, metadata !176, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !178, metadata !DIExpression()), !dbg !226
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 84, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !135
