...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !73, metadata !DIExpression()), !dbg !98
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !74, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64 2, metadata !76, metadata !DIExpression()), !dbg !101

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !70
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !78, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !80, metadata !DIExpression()), !dbg !103

  //   %conv = trunc i64 %0 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !77, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !82, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !108

  //   %conv3 = sext i32 %add to i64, !dbg !77

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !85, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !77
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !110

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !79
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !89, metadata !DIExpression()), !dbg !110

  //   %conv7 = trunc i64 %1 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !86, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !91, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !93, metadata !DIExpression()), !dbg !113

  //   %conv11 = trunc i64 %2 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !90, metadata !DIExpression()), !dbg !98

  //   %cmp = icmp eq i32 %conv11, 2, !dbg !84
  creg__r5__2_ = max(0,creg_r5);

  //   %conv12 = zext i1 %cmp to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !94, metadata !DIExpression()), !dbg !98

  //   store i32 %conv12, i32* @atom_1_X6_2, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv, 2, !dbg !90
  creg__r1__2_ = max(0,creg_r1);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !95, metadata !DIExpression()), !dbg !98

  //   store i32 %conv14, i32* @atom_1_X2_2, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !96, metadata !DIExpression()), !dbg !98

  //   store i32 %conv16, i32* @atom_1_X5_1, align 4, !dbg !93, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !130, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !131, metadata !DIExpression()), !dbg !175

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !132, metadata !DIExpression()), !dbg !177

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !136, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64 0, metadata !139, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !143, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !147, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !150, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !153, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !157, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !159, metadata !DIExpression()), !dbg !200

  //   %conv = trunc i64 %4 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !156, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !160, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !164, metadata !DIExpression()), !dbg !204

  //   %conv18 = trunc i64 %5 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !161, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !165, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !166, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !167, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !168, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !169, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !171, metadata !DIExpression()), !dbg !175

  //   %and22 = and i32 %6, %and21, !dbg !132
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !172, metadata !DIExpression()), !dbg !175

  //   %and23 = and i32 %conv20, %and22, !dbg !133
  creg_r18 = max(creg__r10__2_,creg_r17);
  r18 = (r10==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !173, metadata !DIExpression()), !dbg !175

  //   %and24 = and i32 %conv14, %and23, !dbg !134
  creg_r19 = max(creg__r9__2_,creg_r18);
  r19 = (r9==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !174, metadata !DIExpression()), !dbg !175
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
