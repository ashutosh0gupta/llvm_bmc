...
T2BLOCK1:
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !84
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !76, metadata !DIExpression()), !dbg !89

  //   %add = add nsw i32 0, %xor, !dbg !85
  creg_r4 = max(0,creg_r3);
  r4 = 0 + r3;

  //   %idxprom = sext i32 %add to i64, !dbg !85

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !85
  r5 = 0+r4*1;
  creg_r5 = creg_r4;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !83, metadata !DIExpression()), !dbg !106

  //   %conv14 = trunc i64 %3 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !80, metadata !DIExpression()), !dbg !89

  //   %cmp = icmp eq i32 %conv, 1, !dbg !90
  creg__r0__1_ = max(0,creg_r0);

  //   %conv15 = zext i1 %cmp to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !84, metadata !DIExpression()), !dbg !89

  //   store i32 %conv15, i32* @atom_1_X0_1, align 4, !dbg !91, !tbaa !92
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv4, 1, !dbg !96
  creg__r1__1_ = max(0,creg_r1);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !85, metadata !DIExpression()), !dbg !89

  //   store i32 %conv17, i32* @atom_1_X2_1, align 4, !dbg !97, !tbaa !92
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv8, 2, !dbg !98
  creg__r2__2_ = max(0,creg_r2);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !86, metadata !DIExpression()), !dbg !89

  //   store i32 %conv19, i32* @atom_1_X4_2, align 4, !dbg !99, !tbaa !92
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv14, 1, !dbg !100
  creg__r6__1_ = max(0,creg_r6);

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !87, metadata !DIExpression()), !dbg !89

  //   store i32 %conv21, i32* @atom_1_X8_1, align 4, !dbg !101, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !142, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !146, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !152, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !189

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X8_1, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
