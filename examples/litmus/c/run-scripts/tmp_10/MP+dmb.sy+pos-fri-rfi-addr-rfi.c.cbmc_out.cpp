...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !76, metadata !DIExpression()), !dbg !101
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !97
  r5 = 0+r4*1;
  ASSUME(creg_r5 >= 0);
  ...
  //   %conv14 = trunc i64 %3 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !80, metadata !DIExpression()), !dbg !101

  //   %cmp = icmp eq i32 %conv, 1, !dbg !102

  //   %conv15 = zext i1 %cmp to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !84, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !85, metadata !DIExpression()), !dbg !122
  ...
  //   %cmp19 = icmp eq i32 %conv4, 1, !dbg !105

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !88, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !89, metadata !DIExpression()), !dbg !125

  //   %5 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !125
  ...
  //   %cmp24 = icmp eq i32 %conv8, 2, !dbg !108

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !92, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !93, metadata !DIExpression()), !dbg !128

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !128
  ...
  //   %cmp29 = icmp eq i32 %conv14, 1, !dbg !111

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !96, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !97, metadata !DIExpression()), !dbg !131

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %7, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !113
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !163, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64 0, metadata !165, metadata !DIExpression()), !dbg !212

  //   store atomic i64 0, i64* @atom_1_X8_1 monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !189, metadata !DIExpression()), !dbg !241
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
