...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !66, metadata !DIExpression()), !dbg !107
  ...
  //   %tobool = icmp ne i32 %conv8, 0, !dbg !95
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !98), !dbg !119

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !86, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !90, metadata !DIExpression()), !dbg !130
