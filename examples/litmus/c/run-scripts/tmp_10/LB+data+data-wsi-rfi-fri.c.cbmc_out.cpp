...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !70, metadata !DIExpression()), !dbg !99
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !76, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !79, metadata !DIExpression()), !dbg !107

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !77
  // ST: Guess
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !79
  // ST: Guess
  iw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0);
  cw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !83, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64 3, metadata !89, metadata !DIExpression()), !dbg !114

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !84
  // ST: Guess
  iw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0);
  cw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !90, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !91, metadata !DIExpression()), !dbg !117

  //   %2 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !93, metadata !DIExpression()), !dbg !117
  ...
  //   %cmp14 = icmp eq i32 %conv7, 2, !dbg !88

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !94, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !95, metadata !DIExpression()), !dbg !120

  //   %3 = zext i32 %conv15 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !97, metadata !DIExpression()), !dbg !120

  //   store atomic i64 %3, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_3, metadata !143, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !181

  //   store atomic i64 0, i64* @atom_0_X0_3 monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !146, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !149, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64 0, metadata !151, metadata !DIExpression()), !dbg !185

  //   store atomic i64 0, i64* @atom_1_X5_2 monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !155, metadata !DIExpression()), !dbg !197

  //   %conv = trunc i64 %4 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !152, metadata !DIExpression()), !dbg !172

  //   %cmp = icmp eq i32 %conv, 3, !dbg !112

  //   %conv12 = zext i1 %cmp to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !156, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_3, metadata !158, metadata !DIExpression()), !dbg !201

  //   %5 = load atomic i64, i64* @atom_0_X0_3 seq_cst, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !160, metadata !DIExpression()), !dbg !201

  //   %conv16 = trunc i64 %5 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !157, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !164, metadata !DIExpression()), !dbg !204

  //   %conv20 = trunc i64 %6 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !161, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !166, metadata !DIExpression()), !dbg !207

  //   %7 = load atomic i64, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !168, metadata !DIExpression()), !dbg !207

  //   %conv24 = trunc i64 %7 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !165, metadata !DIExpression()), !dbg !172
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
