...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !63, metadata !DIExpression()), !dbg !89

  //   %add = add nsw i32 %xor, 1, !dbg !77
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !64, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !65, metadata !DIExpression()), !dbg !97

  //   %conv1 = sext i32 %add to i64, !dbg !79

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !67, metadata !DIExpression()), !dbg !97

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !68, metadata !DIExpression()), !dbg !89

  //   %xor6 = xor i32 %conv5, %conv5, !dbg !83
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !72, metadata !DIExpression()), !dbg !89

  //   %add8 = add nsw i32 3, %xor6, !dbg !84
  creg_r5 = max(0,creg_r4);
  r5 = 3 + r4;

  //   %idxprom = sext i32 %add8 to i64, !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !73, metadata !DIExpression()), !dbg !89

  //   %xor12 = xor i32 %conv11, %conv11, !dbg !87
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !77, metadata !DIExpression()), !dbg !89

  //   %add14 = add nsw i32 0, %xor12, !dbg !88
  creg_r9 = max(0,creg_r8);
  r9 = 0 + r8;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !88

  //   %arrayidx16 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !88
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !78, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64 1, metadata !80, metadata !DIExpression()), !dbg !108

  //   store atomic i64 1, i64* %arrayidx16 monotonic, align 8, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !109

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv21 = trunc i64 %3 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !81, metadata !DIExpression()), !dbg !89

  //   %cmp = icmp eq i32 %conv, 1, !dbg !93
  creg__r0__1_ = max(0,creg_r0);

  //   %conv22 = zext i1 %cmp to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !85, metadata !DIExpression()), !dbg !89

  //   store i32 %conv22, i32* @atom_1_X0_1, align 4, !dbg !94, !tbaa !95
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv5, 2, !dbg !99
  creg__r3__2_ = max(0,creg_r3);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !86, metadata !DIExpression()), !dbg !89

  //   store i32 %conv24, i32* @atom_1_X4_2, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv21, 1, !dbg !101
  creg__r11__1_ = max(0,creg_r11);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !87, metadata !DIExpression()), !dbg !89

  //   store i32 %conv26, i32* @atom_1_X11_1, align 4, !dbg !102, !tbaa !95
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !126, metadata !DIExpression()), !dbg !133
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !143, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !144, metadata !DIExpression()), !dbg !196

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !145, metadata !DIExpression()), !dbg !198

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !149, metadata !DIExpression()), !dbg !200

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !150, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !151, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !154, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !157, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !167, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_1, metadata !170, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !215

  //   store atomic i32 0, i32* @atom_1_X11_1 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !130
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !177, metadata !DIExpression()), !dbg !196
  ...
  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !134
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !178, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !182, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !184, metadata !DIExpression()), !dbg !236

  //   %8 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !138
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !183, metadata !DIExpression()), !dbg !196

  //   %cmp29 = icmp eq i32 %conv28, 2, !dbg !140
  creg__r18__2_ = max(0,creg_r18);

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !187, metadata !DIExpression()), !dbg !196
  ...
  //   %10 = load i32, i32* @atom_1_X4_2, align 4, !dbg !144, !tbaa !142
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X11_1, align 4, !dbg !145, !tbaa !142
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !192, metadata !DIExpression()), !dbg !196

  //   %and32 = and i32 %conv30, %and31, !dbg !148
  creg_r24 = max(creg__r18__2_,creg_r23);
  r24 = (r18==2) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !193, metadata !DIExpression()), !dbg !196

  //   %and33 = and i32 %conv24, %and32, !dbg !149
  creg_r25 = max(creg__r17__1_,creg_r24);
  r25 = (r17==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !194, metadata !DIExpression()), !dbg !196

  //   %and34 = and i32 %conv18, %and33, !dbg !150
  creg_r26 = max(creg__r16__2_,creg_r25);
  r26 = (r16==2) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !195, metadata !DIExpression()), !dbg !196
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154
