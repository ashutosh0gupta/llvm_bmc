...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !57, metadata !DIExpression()), !dbg !63
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !57
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !58, metadata !DIExpression()), !dbg !71
  ...
  // ST: Guess
  iw(2,r3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l29_c3
  old_cw = cw(2,r3);
  cw(2,r3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l29_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !61, metadata !DIExpression()), !dbg !63
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !83, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !100

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(3,0);
  cr(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l39_c16
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !136, metadata !DIExpression()), !dbg !159
