...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !58, metadata !DIExpression()), !dbg !68
  ...
  //   : Acquire
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l28_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !62, metadata !DIExpression()), !dbg !70

  //   %conv = trunc i64 %0 to i32, !dbg !54

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !59, metadata !DIExpression()), !dbg !65
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !128, metadata !DIExpression()), !dbg !157
  ...
  //   %7 = load i32, i32* @atom_1_X2_0, align 4, !dbg !107, !tbaa !108
  // LD: Guess
  old_cr = cr(0,3);
