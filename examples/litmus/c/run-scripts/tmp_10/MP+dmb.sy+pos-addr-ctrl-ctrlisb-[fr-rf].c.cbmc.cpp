...
T2BLOCK7:
  ...
  //   %cmp27 = icmp eq i32 %conv19, 0, !dbg !117
  ...
  //   store i32 %conv28, i32* @atom_1_X8_0, align 4, !dbg !118, !tbaa !111
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv23, 1, !dbg !119
  ...
  //   store i32 %conv30, i32* @atom_1_X10_1, align 4, !dbg !120, !tbaa !111
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !188, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !191, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i32 0, metadata !193, metadata !DIExpression()), !dbg !234

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !118
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X10_1, align 4, !dbg !145, !tbaa !141
  // LD: Guess
  old_cr = cr(0,7);
