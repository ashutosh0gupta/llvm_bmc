...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !105

  //   %add = add nsw i32 2, %xor, !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !105

  //   %tobool = icmp ne i32 %conv8, 0, !dbg !99
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !103), !dbg !123

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !124

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !124
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !134

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp31 = icmp eq i32 %conv19, 0, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !95, metadata !DIExpression()), !dbg !147

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %8, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv23, 1, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !99, metadata !DIExpression()), !dbg !150

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !101, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %9, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !132
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 1, metadata !158, metadata !DIExpression()), !dbg !163
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !199, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !202, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !257

  //   store atomic i64 0, i64* @atom_1_X10_1 monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !224, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !228, metadata !DIExpression()), !dbg !289

  //   %11 = load atomic i64, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !161
  // LD: Guess
  old_cr = cr(0,7);
