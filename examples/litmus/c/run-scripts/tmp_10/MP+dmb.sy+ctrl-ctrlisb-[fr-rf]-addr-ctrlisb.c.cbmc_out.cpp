...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !145

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !127
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !145

  //   %conv26 = trunc i64 %5 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !82, metadata !DIExpression()), !dbg !106

  //   %cmp = icmp eq i32 %conv, 1, !dbg !129

  //   %conv27 = zext i1 %cmp to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !86, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !149

  //   %6 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !131
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv11, 0, !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !91, metadata !DIExpression()), !dbg !152

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %7, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv15, 1, !dbg !135

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !94, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !95, metadata !DIExpression()), !dbg !155

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %8, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !137
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv26, 0, !dbg !138

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !98, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !99, metadata !DIExpression()), !dbg !158

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !101, metadata !DIExpression()), !dbg !158

  //   store atomic i64 %9, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !140
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !163, metadata !DIExpression()), !dbg !168

  //   br label %label_3, !dbg !46
  goto T3BLOCK1;

T3BLOCK1:
  //   call void @llvm.dbg.label(metadata !167), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !164, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64 1, metadata !166, metadata !DIExpression()), !dbg !171
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !181, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !182, metadata !DIExpression()), !dbg !253

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !117

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !117

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !183, metadata !DIExpression()), !dbg !255

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !187, metadata !DIExpression()), !dbg !257

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !188, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !189, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !192, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !195, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !198, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !201, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !204, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !207, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !210, metadata !DIExpression()), !dbg !274

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !213, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !217, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !219, metadata !DIExpression()), !dbg !291

  //   %conv = trunc i64 %6 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !216, metadata !DIExpression()), !dbg !253

  //   %cmp = icmp eq i32 %conv, 1, !dbg !157

  //   %conv22 = zext i1 %cmp to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !220, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !222, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !224, metadata !DIExpression()), !dbg !295

  //   %conv26 = trunc i64 %7 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !221, metadata !DIExpression()), !dbg !253

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !161

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !225, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !229, metadata !DIExpression()), !dbg !299

  //   %conv32 = trunc i64 %8 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !226, metadata !DIExpression()), !dbg !253

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !165

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !230, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !232, metadata !DIExpression()), !dbg !303
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !234, metadata !DIExpression()), !dbg !303

  //   %conv38 = trunc i64 %9 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !231, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !236, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !238, metadata !DIExpression()), !dbg !306

  //   %conv42 = trunc i64 %10 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !235, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !240, metadata !DIExpression()), !dbg !309
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !242, metadata !DIExpression()), !dbg !309

  //   %conv46 = trunc i64 %11 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !239, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !244, metadata !DIExpression()), !dbg !312
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !246, metadata !DIExpression()), !dbg !312

  //   %conv50 = trunc i64 %12 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !243, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !247, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !248, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !249, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !250, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !251, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !252, metadata !DIExpression()), !dbg !253
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([128 x i8], [128 x i8]* @.str.1, i64 0, i64 0), i32 noundef 101, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187
