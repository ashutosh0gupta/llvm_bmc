...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !90), !dbg !96
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !91), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !106

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !68, metadata !DIExpression()), !dbg !106

  //   %conv4 = trunc i64 %1 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !94
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !92), !dbg !114

  //   call void (...) @isb(), !dbg !96
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !70, metadata !DIExpression()), !dbg !116

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0+3*1);
  cr(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l37_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !116

  //   %conv11 = trunc i64 %2 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !69, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !119

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !119

  //   %conv15 = trunc i64 %3 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !73, metadata !DIExpression()), !dbg !94

  //   %xor = xor i32 %conv15, %conv15, !dbg !103
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !77, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 4, %xor, !dbg !104
  creg_r5 = max(0,creg_r4);
  r5 = 4 + r4;

  //   %idxprom = sext i32 %add to i64, !dbg !104

  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !104
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !124

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,r6);
  cr(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l40_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !124

  //   %conv19 = trunc i64 %4 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !94

  //   %tobool20 = icmp ne i32 %conv19, 0, !dbg !107
  creg__r7__0_ = max(0,creg_r7);

  //   br i1 %tobool20, label %if.then21, label %if.else22, !dbg !109
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !93), !dbg !131

  //   call void (...) @isb(), !dbg !113
  // isb: Guess
  cisb[2] = get_rng(0,NCONTEXT-1);
  // Check
  ASSUME(cisb[2] >= cdy[2]);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !133

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l44_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !133

  //   %conv26 = trunc i64 %5 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !82, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !117
  creg__r0__1_ = max(0,creg_r0);

  //   %conv27 = zext i1 %cmp to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !86, metadata !DIExpression()), !dbg !94

  //   store i32 %conv27, i32* @atom_1_X0_1, align 4, !dbg !118, !tbaa !119
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv11, 0, !dbg !123
  creg__r2__0_ = max(0,creg_r2);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !87, metadata !DIExpression()), !dbg !94

  //   store i32 %conv29, i32* @atom_1_X4_0, align 4, !dbg !124, !tbaa !119
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv15, 1, !dbg !125
  creg__r3__1_ = max(0,creg_r3);

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !88, metadata !DIExpression()), !dbg !94

  //   store i32 %conv31, i32* @atom_1_X6_1, align 4, !dbg !126, !tbaa !119
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv26, 0, !dbg !127
  creg__r8__0_ = max(0,creg_r8);

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !89, metadata !DIExpression()), !dbg !94

  //   store i32 %conv33, i32* @atom_1_X10_0, align 4, !dbg !128, !tbaa !119
  // ST: Guess
  iw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l52_c16
  old_cw = cw(2,8);
  cw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l52_c16
  // Check
  ASSUME(active[iw(2,8)] == 2);
  ASSUME(active[cw(2,8)] == 2);
  ASSUME(sforbid(8,cw(2,8))== 0);
  ASSUME(iw(2,8) >= creg__r8__0_);
  ASSUME(iw(2,8) >= 0);
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !152, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64 1, metadata !154, metadata !DIExpression()), !dbg !159

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !50
  // ST: Guess
  iw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l58_c3
  old_cw = cw(3,0+3*1);
  cw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l58_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !230

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !232

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !234

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !177, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !180, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !183, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64 0, metadata !185, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !192, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !247

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !123
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l72_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l72_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !196, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !249

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !125
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l73_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l73_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !199, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !201, metadata !DIExpression()), !dbg !251

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !127
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l74_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l74_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !202, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i32 0, metadata !204, metadata !DIExpression()), !dbg !253

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !129
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l75_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l75_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !206, metadata !DIExpression()), !dbg !266

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l85_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !208, metadata !DIExpression()), !dbg !266

  //   %conv = trunc i64 %6 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !205, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !209, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !211, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !213, metadata !DIExpression()), !dbg !270

  //   %conv26 = trunc i64 %7 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !210, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !214, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !216, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !218, metadata !DIExpression()), !dbg !274

  //   %conv32 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !215, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !219, metadata !DIExpression()), !dbg !230

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !155, !tbaa !156
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l91_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !220, metadata !DIExpression()), !dbg !230

  //   %10 = load i32, i32* @atom_1_X4_0, align 4, !dbg !158, !tbaa !156
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l92_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !221, metadata !DIExpression()), !dbg !230

  //   %11 = load i32, i32* @atom_1_X6_1, align 4, !dbg !159, !tbaa !156
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l93_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !222, metadata !DIExpression()), !dbg !230

  //   %12 = load i32, i32* @atom_1_X10_0, align 4, !dbg !160, !tbaa !156
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l94_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !223, metadata !DIExpression()), !dbg !230

  //   %and = and i32 %11, %12, !dbg !161
  creg_r20 = max(creg_r18,creg_r19);
  r20 = r18 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !224, metadata !DIExpression()), !dbg !230

  //   %and35 = and i32 %10, %and, !dbg !162
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !225, metadata !DIExpression()), !dbg !230

  //   %and36 = and i32 %9, %and35, !dbg !163
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !226, metadata !DIExpression()), !dbg !230

  //   %and37 = and i32 %conv34, %and36, !dbg !164
  creg_r23 = max(creg__r15__1_,creg_r22);
  r23 = (r15==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !227, metadata !DIExpression()), !dbg !230

  //   %and38 = and i32 %conv28, %and37, !dbg !165
  creg_r24 = max(creg__r14__1_,creg_r23);
  r24 = (r14==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !228, metadata !DIExpression()), !dbg !230

  //   %and39 = and i32 %conv22, %and38, !dbg !166
  creg_r25 = max(creg__r13__1_,creg_r24);
  r25 = (r13==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !229, metadata !DIExpression()), !dbg !230
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([128 x i8], [128 x i8]* @.str.1, i64 0, i64 0), i32 noundef 101, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !170
