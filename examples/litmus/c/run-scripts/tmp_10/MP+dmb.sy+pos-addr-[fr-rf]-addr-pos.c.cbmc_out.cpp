...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !122

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !72, metadata !DIExpression()), !dbg !122

  //   %conv4 = trunc i64 %1 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !69, metadata !DIExpression()), !dbg !116

  //   %xor = xor i32 %conv4, %conv4, !dbg !106
  creg_r2 = max(creg_r1,creg_r1);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !73, metadata !DIExpression()), !dbg !116

  //   %add = add nsw i32 2, %xor, !dbg !107
  creg_r3 = max(0,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = 2 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !107

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !107
  r4 = 0+r3*1;
  ASSUME(creg_r4 >= 0);
  ASSUME(creg_r4 >= creg_r3);
  ASSUME(active[creg_r4] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !127

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !107
  // LD: Guess
  old_cr = cr(2,r4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !77, metadata !DIExpression()), !dbg !127

  //   %conv8 = trunc i64 %2 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !74, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !79, metadata !DIExpression()), !dbg !129

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !129

  //   %conv12 = trunc i64 %3 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !78, metadata !DIExpression()), !dbg !116

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !113
  creg_r7 = max(creg_r6,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !82, metadata !DIExpression()), !dbg !116

  //   %add15 = add nsw i32 0, %xor13, !dbg !114
  creg_r8 = max(0,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = 0 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !114

  //   %arrayidx17 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !114
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !84, metadata !DIExpression()), !dbg !134

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  if(cr(2,r9) < cw(2,r9)) {
    r10 = buff(2,r9);
    ASSUME((!(( (cw(2,r9) < 1) && (1 < crmax(2,r9)) )))||(sforbid(r9,1)> 0));
    ASSUME((!(( (cw(2,r9) < 2) && (2 < crmax(2,r9)) )))||(sforbid(r9,2)> 0));
    ASSUME((!(( (cw(2,r9) < 3) && (3 < crmax(2,r9)) )))||(sforbid(r9,3)> 0));
    ASSUME((!(( (cw(2,r9) < 4) && (4 < crmax(2,r9)) )))||(sforbid(r9,4)> 0));
    ASSUME((!(( (cw(2,r9) < 5) && (5 < crmax(2,r9)) )))||(sforbid(r9,5)> 0));
    ASSUME((!(( (cw(2,r9) < 6) && (6 < crmax(2,r9)) )))||(sforbid(r9,6)> 0));
    ASSUME((!(( (cw(2,r9) < 7) && (7 < crmax(2,r9)) )))||(sforbid(r9,7)> 0));
    ASSUME((!(( (cw(2,r9) < 8) && (8 < crmax(2,r9)) )))||(sforbid(r9,8)> 0));
    ASSUME((!(( (cw(2,r9) < 9) && (9 < crmax(2,r9)) )))||(sforbid(r9,9)> 0));
  } else {
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !86, metadata !DIExpression()), !dbg !134

  //   %conv20 = trunc i64 %4 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !83, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !88, metadata !DIExpression()), !dbg !136

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !136

  //   %conv24 = trunc i64 %5 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !87, metadata !DIExpression()), !dbg !116

  //   %cmp = icmp eq i32 %conv, 1, !dbg !120

  //   %conv25 = zext i1 %cmp to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !91, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !92, metadata !DIExpression()), !dbg !140

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv4, 1, !dbg !123

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !95, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !96, metadata !DIExpression()), !dbg !143

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv8, 0, !dbg !126

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !99, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !100, metadata !DIExpression()), !dbg !146

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %8, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !128
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv12, 1, !dbg !129

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !103, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !104, metadata !DIExpression()), !dbg !149

  //   %9 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !106, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %9, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !131
  // ST: Guess
  ...
  //   %cmp42 = icmp eq i32 %conv20, 0, !dbg !132

  //   %conv43 = zext i1 %cmp42 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv43, metadata !107, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !108, metadata !DIExpression()), !dbg !152

  //   %10 = zext i32 %conv43 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !110, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %10, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   %cmp47 = icmp eq i32 %conv24, 0, !dbg !135

  //   %conv48 = zext i1 %cmp47 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !111, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !112, metadata !DIExpression()), !dbg !155

  //   %11 = zext i32 %conv48 to i64

  //   call void @llvm.dbg.value(metadata i64 %11, metadata !114, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %11, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !137
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !160, metadata !DIExpression()), !dbg !165
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64 1, metadata !163, metadata !DIExpression()), !dbg !168
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !178, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !179, metadata !DIExpression()), !dbg !260

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !131

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !131

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !180, metadata !DIExpression()), !dbg !262

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !133

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !133

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !184, metadata !DIExpression()), !dbg !264

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !135

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !135

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !185, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !186, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !189, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !192, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !195, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !198, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !275

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !146
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !201, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !204, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !279

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !150
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !207, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !281

  //   store atomic i64 0, i64* @atom_1_X8_0 monotonic, align 8, !dbg !152
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !210, metadata !DIExpression()), !dbg !283

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !283

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !154
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !214, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !216, metadata !DIExpression()), !dbg !298

  //   %conv = trunc i64 %6 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !213, metadata !DIExpression()), !dbg !260

  //   %cmp = icmp eq i32 %conv, 1, !dbg !171

  //   %conv22 = zext i1 %cmp to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !217, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !219, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !221, metadata !DIExpression()), !dbg !302

  //   %conv26 = trunc i64 %7 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !218, metadata !DIExpression()), !dbg !260

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !175

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !175

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !222, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !224, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !226, metadata !DIExpression()), !dbg !306

  //   %conv32 = trunc i64 %8 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !223, metadata !DIExpression()), !dbg !260

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !179

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !227, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !229, metadata !DIExpression()), !dbg !310
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !231, metadata !DIExpression()), !dbg !310

  //   %conv38 = trunc i64 %9 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !228, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !233, metadata !DIExpression()), !dbg !313

  //   %10 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !184
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !235, metadata !DIExpression()), !dbg !313

  //   %conv42 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !232, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !237, metadata !DIExpression()), !dbg !316
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !239, metadata !DIExpression()), !dbg !316

  //   %conv46 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !236, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !241, metadata !DIExpression()), !dbg !319

  //   %12 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !190
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !243, metadata !DIExpression()), !dbg !319

  //   %conv50 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !240, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !245, metadata !DIExpression()), !dbg !322

  //   %13 = load atomic i64, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !193
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !247, metadata !DIExpression()), !dbg !322

  //   %conv54 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !244, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !249, metadata !DIExpression()), !dbg !325
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !251, metadata !DIExpression()), !dbg !325

  //   %conv58 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv58, metadata !248, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !252, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !253, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !254, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !255, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !256, metadata !DIExpression()), !dbg !260

  //   %and63 = and i32 %conv34, %and62, !dbg !203
  creg_r30 = max(max(creg_r18,0),creg_r29);
  ASSUME(active[creg_r30] == 0);
  r30 = (r18==1) & r29;

  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !257, metadata !DIExpression()), !dbg !260

  //   %and64 = and i32 %conv28, %and63, !dbg !204
  creg_r31 = max(max(creg_r17,0),creg_r30);
  ASSUME(active[creg_r31] == 0);
  r31 = (r17==1) & r30;

  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !258, metadata !DIExpression()), !dbg !260

  //   %and65 = and i32 %conv22, %and64, !dbg !205
  creg_r32 = max(max(creg_r16,0),creg_r31);
  ASSUME(active[creg_r32] == 0);
  r32 = (r16==1) & r31;

  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !259, metadata !DIExpression()), !dbg !260
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 104, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
