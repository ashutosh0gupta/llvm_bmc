...
T2BLOCK4:
  ...
  //   %cmp21 = icmp eq i32 %conv4, 1, !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X2_1, align 4, !dbg !111, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !180, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !231

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X2_1, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
