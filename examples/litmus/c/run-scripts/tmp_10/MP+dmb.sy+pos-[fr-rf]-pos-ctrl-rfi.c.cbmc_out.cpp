...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv12, 0, !dbg !104
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !107), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !95, metadata !DIExpression()), !dbg !141

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %7, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !123
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv12, 2, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !99, metadata !DIExpression()), !dbg !144

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %8, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !126
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !160
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !187, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !190, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !214, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !218, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !222, metadata !DIExpression()), !dbg !286
