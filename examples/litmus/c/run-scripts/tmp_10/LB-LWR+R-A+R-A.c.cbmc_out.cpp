...
T3BLOCK1:
  ...
  //   store i32 %conv5, i32* @atom_2_X2_0, align 4, !dbg !61, !tbaa !62
  // ST: Guess
  ...
  //   store i32 %conv7, i32* @atom_2_X0_1, align 4, !dbg !67, !tbaa !62
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !134, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !141, metadata !DIExpression()), !dbg !166
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
