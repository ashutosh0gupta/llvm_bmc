...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !76), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !64, metadata !DIExpression()), !dbg !89

  //   %conv4 = trunc i64 %1 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !61, metadata !DIExpression()), !dbg !77

  //   %xor = xor i32 %conv4, %conv4, !dbg !73
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !66, metadata !DIExpression()), !dbg !94
  ...
  //   store i32 %conv9, i32* @atom_1_X0_1, align 4, !dbg !80, !tbaa !81
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv8, 1, !dbg !85
  ...
  //   store i32 %conv11, i32* @atom_1_X7_1, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !130, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !134, metadata !DIExpression()), !dbg !165
