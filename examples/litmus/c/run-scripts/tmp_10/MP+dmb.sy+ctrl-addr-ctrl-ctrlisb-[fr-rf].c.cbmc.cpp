...
T2BLOCK7:
  ...
  //   %tobool16 = icmp ne i32 %conv15, 0, !dbg !109

  //   br i1 %tobool16, label %if.then17, label %if.else18, !dbg !111
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !99), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !79, metadata !DIExpression()), !dbg !135

  //   %conv22 = trunc i64 %4 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !76, metadata !DIExpression()), !dbg !100
  ...
  //   %cmp29 = icmp eq i32 %conv22, 0, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !89, metadata !DIExpression()), !dbg !145
  ...
  //   %cmp34 = icmp eq i32 %conv26, 1, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !93, metadata !DIExpression()), !dbg !148

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !95, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %8, i64* @atom_1_X11_1 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !154, metadata !DIExpression()), !dbg !161
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !197, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !248

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !200, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !250

  //   store atomic i64 0, i64* @atom_1_X11_1 monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !218, metadata !DIExpression()), !dbg !276

  //   %9 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !222, metadata !DIExpression()), !dbg !279

  //   %10 = load atomic i64, i64* @atom_1_X11_1 seq_cst, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,7);
