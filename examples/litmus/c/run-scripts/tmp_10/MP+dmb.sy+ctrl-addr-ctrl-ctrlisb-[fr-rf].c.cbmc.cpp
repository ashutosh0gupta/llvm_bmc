...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !79, metadata !DIExpression()), !dbg !126

  //   %conv22 = trunc i64 %4 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !76, metadata !DIExpression()), !dbg !91
  ...
  //   %cmp28 = icmp eq i32 %conv22, 0, !dbg !119
  ...
  //   store i32 %conv29, i32* @atom_1_X9_0, align 4, !dbg !120, !tbaa !115
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv26, 1, !dbg !121
  ...
  //   store i32 %conv31, i32* @atom_1_X11_1, align 4, !dbg !122, !tbaa !115
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !146, metadata !DIExpression()), !dbg !153
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !190, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !232

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_1, metadata !193, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !234

  //   store atomic i32 0, i32* @atom_1_X11_1 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X9_0, align 4, !dbg !139, !tbaa !137
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %10 = load i32, i32* @atom_1_X11_1, align 4, !dbg !140, !tbaa !137
  // LD: Guess
  old_cr = cr(0,7);
