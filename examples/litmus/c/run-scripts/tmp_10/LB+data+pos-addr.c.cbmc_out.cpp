...
T2BLOCK1:
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !64
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !97
  ...
  //   %cmp6 = icmp eq i32 %conv4, 1, !dbg !73
  ...
  //   store i32 %conv7, i32* @atom_1_X2_1, align 4, !dbg !74, !tbaa !69
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !130, metadata !DIExpression()), !dbg !163
