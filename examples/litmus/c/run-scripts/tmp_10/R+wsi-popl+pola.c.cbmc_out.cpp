...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !83, metadata !DIExpression()), !dbg !96
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !106, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !107, metadata !DIExpression()), !dbg !146

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !108, metadata !DIExpression()), !dbg !148

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !112, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !113, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64 0, metadata !115, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !116, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64 0, metadata !118, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !119, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !122, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !126, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !128, metadata !DIExpression()), !dbg !169

  //   %conv = trunc i64 %4 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !125, metadata !DIExpression()), !dbg !146

  //   %cmp = icmp eq i32 %conv, 2, !dbg !106

  //   %conv10 = zext i1 %cmp to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !129, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !133, metadata !DIExpression()), !dbg !173

  //   %conv14 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !130, metadata !DIExpression()), !dbg !146

  //   %cmp15 = icmp eq i32 %conv14, 2, !dbg !110

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !134, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !136, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !138, metadata !DIExpression()), !dbg !177

  //   %conv20 = trunc i64 %6 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !135, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !140, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !139, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !144, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !145, metadata !DIExpression()), !dbg !146
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([100 x i8], [100 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
