...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !68, metadata !DIExpression()), !dbg !88
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !72, metadata !DIExpression()), !dbg !91

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !69, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !77, metadata !DIExpression()), !dbg !96

  //   %conv4 = trunc i64 %1 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !74, metadata !DIExpression()), !dbg !88

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !67
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !78, metadata !DIExpression()), !dbg !88

  //   %add6 = add nsw i32 %xor5, 1, !dbg !68
  creg_r9 = max(0,creg_r8);
  r9 = r8 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !79, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !100

  //   %conv7 = sext i32 %add6 to i64, !dbg !70

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !82, metadata !DIExpression()), !dbg !100

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !70
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64 2, metadata !85, metadata !DIExpression()), !dbg !102

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !72
  // ST: Guess
  ...
  //   %conv10 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !86, metadata !DIExpression()), !dbg !88

  //   store i32 %conv10, i32* @atom_1_X0_1, align 4, !dbg !74, !tbaa !75
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !121, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64 0, metadata !123, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !124, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64 0, metadata !126, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 0, metadata !129, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_2, metadata !130, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !134, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i32 0, metadata !136, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !138, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !140, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !141, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !143, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !145, metadata !DIExpression()), !dbg !179

  //   %conv16 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !142, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !146, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !150, metadata !DIExpression()), !dbg !152

  //   %and20 = and i32 %conv12, %and19, !dbg !117
  creg_r19 = max(creg__r13__2_,creg_r18);
  r19 = (r13==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !151, metadata !DIExpression()), !dbg !152
