...
T2BLOCK4:
  ...
  //   %cmp16 = icmp eq i32 %conv12, 0, !dbg !93
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !118, metadata !DIExpression()), !dbg !125
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !159, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !196

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X6_0, align 4, !dbg !130, !tbaa !127
  // LD: Guess
  old_cr = cr(0,5);
