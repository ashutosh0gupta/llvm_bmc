...
T1BLOCK2:
  //   br label %lbl_label107, !dbg !64
  goto T1BLOCK4;

T1BLOCK3:
  //   br label %lbl_label107, !dbg !65
  goto T1BLOCK4;
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !107, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !111, metadata !DIExpression()), !dbg !124
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([130 x i8], [130 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
