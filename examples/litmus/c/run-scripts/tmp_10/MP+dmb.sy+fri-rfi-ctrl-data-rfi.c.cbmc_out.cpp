...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !75, metadata !DIExpression()), !dbg !97
  ...
  //   %conv11 = sext i32 %add to i64, !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !79, metadata !DIExpression()), !dbg !97

  //   %cmp = icmp eq i32 %conv, 1, !dbg !105

  //   %conv16 = zext i1 %cmp to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !83, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !87, metadata !DIExpression()), !dbg !97
  ...
  //   store atomic i64 %5, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !91, metadata !DIExpression()), !dbg !97
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !163, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !185, metadata !DIExpression()), !dbg !233
