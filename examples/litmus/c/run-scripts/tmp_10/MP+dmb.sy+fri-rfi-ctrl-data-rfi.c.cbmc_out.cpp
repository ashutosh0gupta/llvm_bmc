...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !88

  //   %add = add nsw i32 %xor, 1, !dbg !90
  creg_r4 = max(0,creg_r3);
  r4 = r3 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !75, metadata !DIExpression()), !dbg !88
  ...
  //   %conv11 = sext i32 %add to i64, !dbg !92

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !78, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !112
  ...
  //   store i32 %conv16, i32* @atom_1_X0_1, align 4, !dbg !97, !tbaa !98
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 2, !dbg !102
  ...
  //   store i32 %conv18, i32* @atom_1_X3_2, align 4, !dbg !103, !tbaa !98
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv15, 1, !dbg !104
  ...
  //   store i32 %conv20, i32* @atom_1_X8_1, align 4, !dbg !105, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !153, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !156, metadata !DIExpression()), !dbg !191
