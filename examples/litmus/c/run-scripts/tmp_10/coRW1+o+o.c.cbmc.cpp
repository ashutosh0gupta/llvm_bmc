...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !67, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !68, metadata !DIExpression()), !dbg !81

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !53

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !53

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !69, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !76, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i32 0, metadata !79, metadata !DIExpression()), !dbg !86

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !58
  // ST: Guess
  iw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l30_c3
  old_cw = cw(0,1);
  cw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l30_c3
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !59
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 37, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !72
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %3) #7, !dbg !75
