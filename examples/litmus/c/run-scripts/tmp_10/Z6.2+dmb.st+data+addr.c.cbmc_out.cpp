...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !68

  //   %add = add nsw i32 %xor, 1, !dbg !56
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !62, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !65, metadata !DIExpression()), !dbg !76

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !58
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !66, metadata !DIExpression()), !dbg !68

  //   store i32 %conv2, i32* @atom_1_X0_1, align 4, !dbg !60, !tbaa !61
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !88, metadata !DIExpression()), !dbg !98

  //   %xor = xor i32 %conv, %conv, !dbg !54
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !92, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !93, metadata !DIExpression()), !dbg !106
  ...
  // ST: Guess
  iw(3,r6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l41_c3
  old_cw = cw(3,r6);
  cw(3,r6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l41_c3
  // Check
  ASSUME(active[iw(3,r6)] == 3);
  ASSUME(active[cw(3,r6)] == 3);
  ASSUME(sforbid(r6,cw(3,r6))== 0);
  ASSUME(iw(3,r6) >= 0);
  ASSUME(iw(3,r6) >= creg_r6);
  ASSUME(cw(3,r6) >= iw(3,r6));
  ASSUME(cw(3,r6) >= old_cw);
  ASSUME(cw(3,r6) >= cr(3,r6));
  ASSUME(cw(3,r6) >= cl[3]);
  ASSUME(cw(3,r6) >= cisb[3]);
  ASSUME(cw(3,r6) >= cdy[3]);
  ASSUME(cw(3,r6) >= cdl[3]);
  ASSUME(cw(3,r6) >= cds[3]);
  ASSUME(cw(3,r6) >= cctrl[3]);
  ASSUME(cw(3,r6) >= caddr[3]);
  // Update
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !117, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !118, metadata !DIExpression()), !dbg !150

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !119, metadata !DIExpression()), !dbg !152

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !123, metadata !DIExpression()), !dbg !154

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !124, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !125, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !128, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !131, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !134, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i32 0, metadata !137, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !138, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !145, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !149, metadata !DIExpression()), !dbg !150
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
