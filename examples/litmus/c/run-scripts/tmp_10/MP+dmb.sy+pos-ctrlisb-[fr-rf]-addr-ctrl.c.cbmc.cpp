...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !94), !dbg !110

  //   call void (...) @isb(), !dbg !92
  // isb: Guess
  ...
  //   %xor = xor i32 %conv12, %conv12, !dbg !99
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !96

  //   %add = add nsw i32 3, %xor, !dbg !100
  creg_r5 = max(0,creg_r4);
  r5 = 3 + r4;

  //   %idxprom = sext i32 %add to i64, !dbg !100

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !100
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !120

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !120

  //   %conv16 = trunc i64 %4 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !80, metadata !DIExpression()), !dbg !96

  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !103
  creg__r7__0_ = max(0,creg_r7);

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !105
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK6:
  //   br label %lbl_LC01, !dbg !107
  goto T2BLOCK7;

T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !95), !dbg !127
  ...
  //   %cmp25 = icmp eq i32 %conv4, 1, !dbg !118
  ...
  //   store i32 %conv26, i32* @atom_1_X2_1, align 4, !dbg !119, !tbaa !114
  // ST: Guess
  ...
  //   store i32 %conv28, i32* @atom_1_X3_0, align 4, !dbg !121, !tbaa !114
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !190, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !193, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !248

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !129
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X3_0, align 4, !dbg !163, !tbaa !160
  // LD: Guess
  old_cr = cr(0,6);
