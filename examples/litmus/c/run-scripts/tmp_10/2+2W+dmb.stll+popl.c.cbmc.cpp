...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !55, metadata !DIExpression()), !dbg !64
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !75, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !76, metadata !DIExpression()), !dbg !99

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !61

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !61

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !77, metadata !DIExpression()), !dbg !101

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !63

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !63

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !81, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !82, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64 0, metadata !84, metadata !DIExpression()), !dbg !104

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !66
  // ST: Guess
  iw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l35_c3
  old_cw = cw(0,0+1*1);
  cw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l35_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !87, metadata !DIExpression()), !dbg !106
  ...
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l44_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !91, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !92, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !94, metadata !DIExpression()), !dbg !122

  //   %5 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l46_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !96, metadata !DIExpression()), !dbg !122

  //   %conv10 = trunc i64 %5 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !93, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !97, metadata !DIExpression()), !dbg !99

  //   %and = and i32 %conv6, %conv12, !dbg !87
  creg_r5 = max(creg__r3__2_,creg__r4__2_);
  r5 = (r3==2) & (r4==2);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !98, metadata !DIExpression()), !dbg !99
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 49, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !91
