...
T2BLOCK4:
  ...
  //   %tobool9 = icmp ne i32 %conv8, 0, !dbg !89
  creg__r2__0_ = max(0,creg_r2);

  //   br i1 %tobool9, label %if.then10, label %if.else11, !dbg !91
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !87), !dbg !113
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !114
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !88), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !124
  ...
  //   %cmp24 = icmp eq i32 %conv4, 0, !dbg !114
  ...
  //   store i32 %conv25, i32* @atom_1_X2_0, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv8, 1, !dbg !116
  ...
  //   store i32 %conv27, i32* @atom_1_X4_1, align 4, !dbg !117, !tbaa !110
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv22, 0, !dbg !118
  ...
  //   store i32 %conv29, i32* @atom_1_X7_0, align 4, !dbg !119, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !190, metadata !DIExpression()), !dbg !239
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !165
