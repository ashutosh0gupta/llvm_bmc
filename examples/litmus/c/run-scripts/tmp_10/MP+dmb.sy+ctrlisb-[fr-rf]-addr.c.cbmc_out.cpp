...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !83), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !73, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !105

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !105
  ...
  //   %conv13 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !78, metadata !DIExpression()), !dbg !84

  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 0, !dbg !94
  creg__r1__0_ = max(0,creg_r1);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !79, metadata !DIExpression()), !dbg !84

  //   store i32 %conv15, i32* @atom_1_X2_0, align 4, !dbg !95, !tbaa !90
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 1, !dbg !96
  ...
  //   store i32 %conv17, i32* @atom_1_X4_1, align 4, !dbg !97, !tbaa !90
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv12, 0, !dbg !98
  ...
  //   store i32 %conv19, i32* @atom_1_X6_0, align 4, !dbg !99, !tbaa !90
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !125, metadata !DIExpression()), !dbg !130
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !140, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !141, metadata !DIExpression()), !dbg !195

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !142, metadata !DIExpression()), !dbg !197

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !146, metadata !DIExpression()), !dbg !199

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !147, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !148, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !154, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !157, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !161, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !164, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !167, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !171, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !174, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !176, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !178, metadata !DIExpression()), !dbg !231

  //   %conv22 = trunc i64 %7 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !175, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !179, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !181, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !183, metadata !DIExpression()), !dbg !235

  //   %conv28 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !180, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !184, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !190, metadata !DIExpression()), !dbg !195

  //   %and32 = and i32 %9, %and31, !dbg !153
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !191, metadata !DIExpression()), !dbg !195

  //   %and33 = and i32 %conv30, %and32, !dbg !154
  creg_r21 = max(creg__r13__1_,creg_r20);
  r21 = (r13==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !192, metadata !DIExpression()), !dbg !195

  //   %and34 = and i32 %conv24, %and33, !dbg !155
  creg_r22 = max(creg__r12__1_,creg_r21);
  r22 = (r12==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !193, metadata !DIExpression()), !dbg !195

  //   %and35 = and i32 %conv18, %and34, !dbg !156
  creg_r23 = max(creg__r11__1_,creg_r22);
  r23 = (r11==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !194, metadata !DIExpression()), !dbg !195
