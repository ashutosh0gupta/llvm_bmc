...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv5, 0, !dbg !82
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !87), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !77, metadata !DIExpression()), !dbg !107

  //   %conv9 = trunc i64 %2 to i32, !dbg !90
  ...
  //   %cmp17 = icmp eq i32 %conv9, 0, !dbg !102
  ...
  //   store i32 %conv18, i32* @atom_1_X5_0, align 4, !dbg !103, !tbaa !96
  // ST: Guess
  ...
  //   store i32 %conv20, i32* @atom_1_X7_0, align 4, !dbg !105, !tbaa !96
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !156, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !202

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !159, metadata !DIExpression()), !dbg !204
  ...
  //   %9 = load i32, i32* @atom_1_X5_0, align 4, !dbg !143, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
