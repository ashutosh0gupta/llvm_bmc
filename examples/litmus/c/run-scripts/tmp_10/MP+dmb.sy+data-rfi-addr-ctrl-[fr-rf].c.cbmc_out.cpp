...
T2BLOCK4:
  ...
  //   %cmp21 = icmp eq i32 %conv5, 1, !dbg !109
  ...
  //   store i32 %conv22, i32* @atom_1_X4_1, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv19, 1, !dbg !113
  ...
  //   store i32 %conv26, i32* @atom_1_X10_1, align 4, !dbg !114, !tbaa !105
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !138, metadata !DIExpression()), !dbg !145
  ...
  // ST: Guess
  iw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l54_c3
  old_cw = cw(3,0);
  cw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l54_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !179, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !185, metadata !DIExpression()), !dbg !234
