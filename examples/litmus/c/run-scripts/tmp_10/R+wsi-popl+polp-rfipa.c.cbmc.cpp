...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !43, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64 3, metadata !45, metadata !DIExpression()), !dbg !60

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !61
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !48, metadata !DIExpression()), !dbg !62
  ...
  //   store i32 %conv5, i32* @atom_0_X5_2, align 4, !dbg !68, !tbaa !69
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_2, metadata !132, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i32 0, metadata !135, metadata !DIExpression()), !dbg !168

  //   store atomic i32 0, i32* @atom_0_X5_2 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X5_2, align 4, !dbg !115, !tbaa !116
  // LD: Guess
  old_cr = cr(0,2);
