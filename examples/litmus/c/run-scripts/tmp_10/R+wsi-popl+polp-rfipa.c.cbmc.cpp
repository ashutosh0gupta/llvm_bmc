...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !54, metadata !DIExpression()), !dbg !71

  //   %1 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !56, metadata !DIExpression()), !dbg !71

  //   store atomic i64 %1, i64* @atom_0_X5_2 seq_cst, align 8, !dbg !72
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !79, metadata !DIExpression()), !dbg !103
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !140, metadata !DIExpression()), !dbg !184
  ...
  //   %cmp = icmp eq i32 %conv, 3, !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !160, metadata !DIExpression()), !dbg !208
