...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !88, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !89, metadata !DIExpression()), !dbg !102
  ...
  // ST: Guess
  iw(3,r4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l39_c3
  old_cw = cw(3,r4);
  cw(3,r4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l39_c3
  // Check
