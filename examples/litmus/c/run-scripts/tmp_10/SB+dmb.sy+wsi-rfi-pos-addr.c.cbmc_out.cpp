...
T2BLOCK1:
  ...
  //   %xor = xor i32 %conv6, %conv6, !dbg !78
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !84, metadata !DIExpression()), !dbg !93

  //   %add = add nsw i32 0, %xor, !dbg !79
  creg_r4 = max(0,creg_r3);
  r4 = 0 + r3;

  //   %idxprom = sext i32 %add to i64, !dbg !79

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !79
  r5 = 0+r4*1;
  creg_r5 = creg_r4;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !86, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !88, metadata !DIExpression()), !dbg !108

  //   %conv10 = trunc i64 %2 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !85, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !89, metadata !DIExpression()), !dbg !93

  //   store i32 %conv11, i32* @atom_1_X3_2, align 4, !dbg !83, !tbaa !84
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv6, 2, !dbg !88
  creg__r2__2_ = max(0,creg_r2);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !90, metadata !DIExpression()), !dbg !93

  //   store i32 %conv13, i32* @atom_1_X4_2, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv10, 0, !dbg !90
  creg__r6__0_ = max(0,creg_r6);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !91, metadata !DIExpression()), !dbg !93

  //   store i32 %conv15, i32* @atom_1_X6_0, align 4, !dbg !91, !tbaa !84
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !137, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !141, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !144, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !147, metadata !DIExpression()), !dbg !184
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
