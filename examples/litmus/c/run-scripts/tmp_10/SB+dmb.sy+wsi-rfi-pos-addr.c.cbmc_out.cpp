...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !81, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !84, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !86, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !90, metadata !DIExpression()), !dbg !120

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !92, metadata !DIExpression()), !dbg !120

  //   store atomic i64 %3, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !93
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv6, 2, !dbg !94

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !93, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !94, metadata !DIExpression()), !dbg !123
  ...
  //   %cmp20 = icmp eq i32 %conv10, 0, !dbg !97

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !97, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !98, metadata !DIExpression()), !dbg !126
