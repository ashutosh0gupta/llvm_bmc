...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !56, metadata !DIExpression()), !dbg !68
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X1_0, metadata !128, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i32 0, metadata !131, metadata !DIExpression()), !dbg !157

  //   store atomic i32 0, i32* @atom_1_X1_0 monotonic, align 4, !dbg !87
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X1_0, align 4, !dbg !107, !tbaa !108
  // LD: Guess
  old_cr = cr(0,3);
