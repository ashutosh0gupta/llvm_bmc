...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !72, metadata !DIExpression()), !dbg !79
  ...
  ASSUME(cctrl[2] >= creg___r1__0___0_);
  if(((r1==0)!=0)) {
    goto T2BLOCK2;
  } else {
    goto T2BLOCK3;
...
T2BLOCK2:
  //   br label %lbl_label112, !dbg !61
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label112, !dbg !62
  goto T2BLOCK4;
...
T2BLOCK4:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !65
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !76, metadata !DIExpression()), !dbg !79

  //   store i32 %conv3, i32* @atom_1_X0_1, align 4, !dbg !67, !tbaa !68
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !104, metadata !DIExpression()), !dbg !115
