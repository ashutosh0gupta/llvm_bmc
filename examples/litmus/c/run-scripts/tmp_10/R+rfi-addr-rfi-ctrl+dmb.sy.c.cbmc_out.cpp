...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !140, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_1, metadata !144, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !147, metadata !DIExpression()), !dbg !188
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
