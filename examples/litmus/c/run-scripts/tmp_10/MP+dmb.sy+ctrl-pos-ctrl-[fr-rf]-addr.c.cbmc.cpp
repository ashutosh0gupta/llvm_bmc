...
T2BLOCK7:
  ...
  //   %xor = xor i32 %conv19, %conv19, !dbg !116
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !105

  //   %add = add nsw i32 0, %xor, !dbg !117
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !117
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !137

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !91, metadata !DIExpression()), !dbg !143

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv19, 1, !dbg !126
  ...
  //   store atomic i64 %8, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !128
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !195, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !224, metadata !DIExpression()), !dbg !292
