...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !111

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !86, metadata !DIExpression()), !dbg !111

  //   %conv10 = trunc i64 %2 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !83, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv11, i32* @atom_1_X2_1, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv10, 1, !dbg !92
  ...
  //   store i32 %conv13, i32* @atom_1_X8_1, align 4, !dbg !93, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !142, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !146, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !149, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X8_1, align 4, !dbg !124, !tbaa !121
  // LD: Guess
  old_cr = cr(0,5);
