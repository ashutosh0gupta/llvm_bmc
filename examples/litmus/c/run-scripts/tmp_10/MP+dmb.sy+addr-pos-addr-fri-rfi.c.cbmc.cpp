...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !72, metadata !DIExpression()), !dbg !97

  //   %add11 = add nsw i32 0, %xor9, !dbg !92
  ...
  //   %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !92
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !73, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !114

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !80, metadata !DIExpression()), !dbg !97

  //   %cmp = icmp eq i32 %conv, 1, !dbg !100

  //   %conv21 = zext i1 %cmp to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !84, metadata !DIExpression()), !dbg !97
  ...
  //   %cmp25 = icmp eq i32 %conv16, 0, !dbg !103

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !88, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !89, metadata !DIExpression()), !dbg !123

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !123

  //   store atomic i64 %6, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !105
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv20, 1, !dbg !106

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !92, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !93, metadata !DIExpression()), !dbg !126

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %7, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !152, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !155, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !200

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !158, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !202

  //   store atomic i64 0, i64* @atom_1_X10_1 monotonic, align 8, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !172, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !176, metadata !DIExpression()), !dbg !225

  //   %7 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !180, metadata !DIExpression()), !dbg !228

  //   %8 = load atomic i64, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !144
