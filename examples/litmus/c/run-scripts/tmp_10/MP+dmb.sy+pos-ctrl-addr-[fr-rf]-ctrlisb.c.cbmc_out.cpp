...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !95
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !75, metadata !DIExpression()), !dbg !96

  //   %add = add nsw i32 3, %xor, !dbg !96
  creg_r4 = max(0,creg_r3);
  r4 = 3 + r3;

  //   %idxprom = sext i32 %add to i64, !dbg !96

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !96
  r5 = 0+r4*1;
  creg_r5 = creg_r4;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !116

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !116
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !118
...
T2BLOCK7:
  ...
  //   %cmp27 = icmp eq i32 %conv12, 0, !dbg !120
  ...
  //   store i32 %conv28, i32* @atom_1_X6_0, align 4, !dbg !121, !tbaa !114
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv16, 1, !dbg !122
  ...
  //   store i32 %conv30, i32* @atom_1_X8_1, align 4, !dbg !123, !tbaa !114
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !193, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !248

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !196, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !250

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !131
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X6_0, align 4, !dbg !163, !tbaa !160
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %12 = load i32, i32* @atom_1_X8_1, align 4, !dbg !164, !tbaa !160
  // LD: Guess
  old_cr = cr(0,7);
