...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv, 0, !dbg !85
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !110

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !72, metadata !DIExpression()), !dbg !110

  //   %conv4 = trunc i64 %1 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !69, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !76, metadata !DIExpression()), !dbg !113

  //   %conv8 = trunc i64 %2 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !73, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !78, metadata !DIExpression()), !dbg !116

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !116

  //   %conv12 = trunc i64 %3 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !77, metadata !DIExpression()), !dbg !98

  //   %xor = xor i32 %conv12, %conv12, !dbg !100
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !98

  //   %add = add nsw i32 0, %xor, !dbg !101
  creg_r5 = max(0,creg_r4);
  r5 = 0 + r4;

  //   %idxprom = sext i32 %add to i64, !dbg !101

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !101
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !121

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !121

  //   %conv16 = trunc i64 %4 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !82, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !123

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !123

  //   %conv20 = trunc i64 %5 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !86, metadata !DIExpression()), !dbg !98

  //   %cmp = icmp eq i32 %conv, 1, !dbg !107
  creg__r0__1_ = max(0,creg_r0);

  //   %conv21 = zext i1 %cmp to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !90, metadata !DIExpression()), !dbg !98

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !108, !tbaa !109
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 0, !dbg !113
  creg__r1__0_ = max(0,creg_r1);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !91, metadata !DIExpression()), !dbg !98

  //   store i32 %conv23, i32* @atom_1_X2_0, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 0, !dbg !115
  creg__r2__0_ = max(0,creg_r2);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !92, metadata !DIExpression()), !dbg !98

  //   store i32 %conv25, i32* @atom_1_X4_0, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv12, 1, !dbg !117
  creg__r3__1_ = max(0,creg_r3);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !93, metadata !DIExpression()), !dbg !98

  //   store i32 %conv27, i32* @atom_1_X5_1, align 4, !dbg !118, !tbaa !109
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv16, 0, !dbg !119
  creg__r7__0_ = max(0,creg_r7);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !94, metadata !DIExpression()), !dbg !98

  //   store i32 %conv29, i32* @atom_1_X7_0, align 4, !dbg !120, !tbaa !109
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv20, 0, !dbg !121
  creg__r8__0_ = max(0,creg_r8);

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !95, metadata !DIExpression()), !dbg !98

  //   store i32 %conv31, i32* @atom_1_X9_0, align 4, !dbg !122, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !163, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !164, metadata !DIExpression()), !dbg !228

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !165, metadata !DIExpression()), !dbg !230

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !169, metadata !DIExpression()), !dbg !232

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !170, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !171, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !235

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !237

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !239

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !180, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !241

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !184, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !243

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !187, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !245

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !190, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !247

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !193, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !249

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !196, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !251

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !137
  // ST: Guess
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !139
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !141, !tbaa !142
  r10 = local_mem[0];

  //   %call19 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !146
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !147, !tbaa !142
  r11 = local_mem[1];

  //   %call20 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !148
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !149, !tbaa !142
  r12 = local_mem[2];

  //   %call21 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !150
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !200, metadata !DIExpression()), !dbg !264

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !202, metadata !DIExpression()), !dbg !264

  //   %conv = trunc i64 %6 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !199, metadata !DIExpression()), !dbg !228

  //   %cmp = icmp eq i32 %conv, 1, !dbg !154
  creg__r13__1_ = max(0,creg_r13);

  //   %conv22 = zext i1 %cmp to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !203, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !205, metadata !DIExpression()), !dbg !268

  //   %7 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !156
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !207, metadata !DIExpression()), !dbg !268

  //   %conv26 = trunc i64 %7 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !204, metadata !DIExpression()), !dbg !228

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !158
  creg__r14__1_ = max(0,creg_r14);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !208, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !210, metadata !DIExpression()), !dbg !272

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !160
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !212, metadata !DIExpression()), !dbg !272

  //   %conv32 = trunc i64 %8 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !209, metadata !DIExpression()), !dbg !228

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !162
  creg__r15__1_ = max(0,creg_r15);

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !213, metadata !DIExpression()), !dbg !228

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !163, !tbaa !164
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l91_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !214, metadata !DIExpression()), !dbg !228

  //   %10 = load i32, i32* @atom_1_X2_0, align 4, !dbg !166, !tbaa !164
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !215, metadata !DIExpression()), !dbg !228

  //   %11 = load i32, i32* @atom_1_X4_0, align 4, !dbg !167, !tbaa !164
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !216, metadata !DIExpression()), !dbg !228

  //   %12 = load i32, i32* @atom_1_X5_1, align 4, !dbg !168, !tbaa !164
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !217, metadata !DIExpression()), !dbg !228

  //   %13 = load i32, i32* @atom_1_X7_0, align 4, !dbg !169, !tbaa !164
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !218, metadata !DIExpression()), !dbg !228

  //   %14 = load i32, i32* @atom_1_X9_0, align 4, !dbg !170, !tbaa !164
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !219, metadata !DIExpression()), !dbg !228

  //   %and = and i32 %13, %14, !dbg !171
  creg_r22 = max(creg_r20,creg_r21);
  r22 = r20 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !220, metadata !DIExpression()), !dbg !228

  //   %and35 = and i32 %12, %and, !dbg !172
  creg_r23 = max(creg_r19,creg_r22);
  r23 = r19 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !221, metadata !DIExpression()), !dbg !228

  //   %and36 = and i32 %11, %and35, !dbg !173
  creg_r24 = max(creg_r18,creg_r23);
  r24 = r18 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !222, metadata !DIExpression()), !dbg !228

  //   %and37 = and i32 %10, %and36, !dbg !174
  creg_r25 = max(creg_r17,creg_r24);
  r25 = r17 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !223, metadata !DIExpression()), !dbg !228

  //   %and38 = and i32 %9, %and37, !dbg !175
  creg_r26 = max(creg_r16,creg_r25);
  r26 = r16 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !224, metadata !DIExpression()), !dbg !228

  //   %and39 = and i32 %conv34, %and38, !dbg !176
  creg_r27 = max(creg__r15__1_,creg_r26);
  r27 = (r15==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !225, metadata !DIExpression()), !dbg !228

  //   %and40 = and i32 %conv28, %and39, !dbg !177
  creg_r28 = max(creg__r14__1_,creg_r27);
  r28 = (r14==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !226, metadata !DIExpression()), !dbg !228

  //   %and41 = and i32 %conv22, %and40, !dbg !178
  creg_r29 = max(creg__r13__1_,creg_r28);
  r29 = (r13==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !227, metadata !DIExpression()), !dbg !228

  //   %cmp42 = icmp eq i32 %and41, 1, !dbg !179
  creg__r29__1_ = max(0,creg_r29);

  //   br i1 %cmp42, label %if.then, label %if.end, !dbg !181
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 105, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
