...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !128

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !72, metadata !DIExpression()), !dbg !128

  //   %conv4 = trunc i64 %1 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !69, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !131

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   %conv8 = trunc i64 %2 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !73, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !78, metadata !DIExpression()), !dbg !134

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !134

  //   %conv12 = trunc i64 %3 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !77, metadata !DIExpression()), !dbg !116

  //   %xor = xor i32 %conv12, %conv12, !dbg !118
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !119
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ASSUME(creg_r6 >= creg_r5);
  ASSUME(active[creg_r6] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !139

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !119
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !139

  //   %conv16 = trunc i64 %4 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !82, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !141

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !123
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !141

  //   %conv20 = trunc i64 %5 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !86, metadata !DIExpression()), !dbg !116

  //   %cmp = icmp eq i32 %conv, 1, !dbg !125

  //   %conv21 = zext i1 %cmp to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !90, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !91, metadata !DIExpression()), !dbg !145

  //   %6 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv4, 0, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !95, metadata !DIExpression()), !dbg !148

  //   %7 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %7, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv8, 0, !dbg !131

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !98, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !99, metadata !DIExpression()), !dbg !151

  //   %8 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %8, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !133
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv12, 1, !dbg !134

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !102, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !103, metadata !DIExpression()), !dbg !154

  //   %9 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %9, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !136
  // ST: Guess
  ...
  //   %cmp38 = icmp eq i32 %conv16, 0, !dbg !137

  //   %conv39 = zext i1 %cmp38 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv39, metadata !106, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !107, metadata !DIExpression()), !dbg !157

  //   %10 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !109, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %10, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !139
  // ST: Guess
  ...
  //   %cmp43 = icmp eq i32 %conv20, 0, !dbg !140

  //   %conv44 = zext i1 %cmp43 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !110, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !111, metadata !DIExpression()), !dbg !160

  //   %11 = zext i32 %conv44 to i64

  //   call void @llvm.dbg.value(metadata i64 %11, metadata !113, metadata !DIExpression()), !dbg !160

  //   store atomic i64 %11, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !142
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !166, metadata !DIExpression()), !dbg !173
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !183, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !184, metadata !DIExpression()), !dbg !265

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !131

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !131

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !185, metadata !DIExpression()), !dbg !267

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !133

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !133

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !189, metadata !DIExpression()), !dbg !269

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !135

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !135

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !190, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !191, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !274

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !197, metadata !DIExpression()), !dbg !276

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !200, metadata !DIExpression()), !dbg !278

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !203, metadata !DIExpression()), !dbg !280

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !206, metadata !DIExpression()), !dbg !282

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !282

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !148
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !209, metadata !DIExpression()), !dbg !284

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !212, metadata !DIExpression()), !dbg !286

  //   call void @llvm.dbg.value(metadata i64 0, metadata !214, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !215, metadata !DIExpression()), !dbg !288

  //   call void @llvm.dbg.value(metadata i64 0, metadata !217, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !219, metadata !DIExpression()), !dbg !303
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !221, metadata !DIExpression()), !dbg !303

  //   %conv = trunc i64 %6 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !218, metadata !DIExpression()), !dbg !265

  //   %cmp = icmp eq i32 %conv, 1, !dbg !171

  //   %conv22 = zext i1 %cmp to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !222, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !224, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !226, metadata !DIExpression()), !dbg !307

  //   %conv26 = trunc i64 %7 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !223, metadata !DIExpression()), !dbg !265

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !175

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !175

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !227, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !229, metadata !DIExpression()), !dbg !311
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !231, metadata !DIExpression()), !dbg !311

  //   %conv32 = trunc i64 %8 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !228, metadata !DIExpression()), !dbg !265

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !179

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !232, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !234, metadata !DIExpression()), !dbg !315
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !236, metadata !DIExpression()), !dbg !315

  //   %conv38 = trunc i64 %9 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !233, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !238, metadata !DIExpression()), !dbg !318
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !240, metadata !DIExpression()), !dbg !318

  //   %conv42 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !237, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !242, metadata !DIExpression()), !dbg !321

  //   %11 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !187
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !244, metadata !DIExpression()), !dbg !321

  //   %conv46 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !241, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !246, metadata !DIExpression()), !dbg !324
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !248, metadata !DIExpression()), !dbg !324

  //   %conv50 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !245, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !250, metadata !DIExpression()), !dbg !327
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !252, metadata !DIExpression()), !dbg !327

  //   %conv54 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !249, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !254, metadata !DIExpression()), !dbg !330
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !256, metadata !DIExpression()), !dbg !330

  //   %conv58 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv58, metadata !253, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !257, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !258, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !259, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !260, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !261, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !262, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !263, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !264, metadata !DIExpression()), !dbg !265
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 105, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
