...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !54

  //   call void @llvm.dbg.value(metadata i64 1, metadata !42, metadata !DIExpression()), !dbg !54

  //   store atomic i64 1, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !55
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_2, metadata !44, metadata !DIExpression()), !dbg !57

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !46, metadata !DIExpression()), !dbg !57

  //   store atomic i64 %1, i64* @atom_0_X0_2 seq_cst, align 8, !dbg !58
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_2, metadata !90, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 0, metadata !92, metadata !DIExpression()), !dbg !110

  //   store atomic i64 0, i64* @atom_0_X0_2 monotonic, align 8, !dbg !69
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_2, metadata !94, metadata !DIExpression()), !dbg !122

  //   %4 = load atomic i64, i64* @atom_0_X0_2 seq_cst, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(0,1);
  ...
  //   %cmp = icmp eq i32 %conv9, 2, !dbg !86
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 49, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !91
