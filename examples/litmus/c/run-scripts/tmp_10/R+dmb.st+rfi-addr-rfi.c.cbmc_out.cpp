...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !122, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i32 0, metadata !124, metadata !DIExpression()), !dbg !151

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !87
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X6_1, align 4, !dbg !109, !tbaa !107
  // LD: Guess
  old_cr = cr(0,3);
