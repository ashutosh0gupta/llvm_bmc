...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !60, metadata !DIExpression()), !dbg !90
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !64, metadata !DIExpression()), !dbg !93

  //   %conv = trunc i64 %0 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !61, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64 2, metadata !67, metadata !DIExpression()), !dbg !96

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !78
  // ST: Guess
  iw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l31_c3
  old_cw = cw(2,0+1*1);
  cw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l31_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !98

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !71, metadata !DIExpression()), !dbg !98

  //   %conv4 = trunc i64 %1 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !90
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !88), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !109

  //   %conv10 = trunc i64 %2 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !75, metadata !DIExpression()), !dbg !90

  //   %tobool11 = icmp ne i32 %conv10, 0, !dbg !93
  creg__r2__0_ = max(0,creg_r2);

  //   br i1 %tobool11, label %if.then12, label %if.else13, !dbg !95
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !89), !dbg !117

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !118

  //   %conv17 = trunc i64 %3 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !79, metadata !DIExpression()), !dbg !90

  //   %cmp = icmp eq i32 %conv, 1, !dbg !102
  creg__r0__1_ = max(0,creg_r0);

  //   %conv18 = zext i1 %cmp to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !83, metadata !DIExpression()), !dbg !90

  //   store i32 %conv18, i32* @atom_1_X0_1, align 4, !dbg !103, !tbaa !104
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv4, 2, !dbg !108
  creg__r1__2_ = max(0,creg_r1);

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !84, metadata !DIExpression()), !dbg !90

  //   store i32 %conv20, i32* @atom_1_X3_2, align 4, !dbg !109, !tbaa !104
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv10, 2, !dbg !110
  creg__r2__2_ = max(0,creg_r2);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !85, metadata !DIExpression()), !dbg !90

  //   store i32 %conv22, i32* @atom_1_X6_2, align 4, !dbg !111, !tbaa !104
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv17, 0, !dbg !112
  creg__r3__0_ = max(0,creg_r3);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !86, metadata !DIExpression()), !dbg !90

  //   store i32 %conv24, i32* @atom_1_X7_0, align 4, !dbg !113, !tbaa !104
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !137, metadata !DIExpression()), !dbg !144
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !154, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !155, metadata !DIExpression()), !dbg !209

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !156, metadata !DIExpression()), !dbg !211

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !160, metadata !DIExpression()), !dbg !213

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !161, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !162, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !216

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !165, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !218

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !168, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !220

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !171, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !175, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !224

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !178, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !226

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !181, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !228

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !121
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !122
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !128
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !130
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !132
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !185, metadata !DIExpression()), !dbg !241

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !134
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !187, metadata !DIExpression()), !dbg !241

  //   %conv = trunc i64 %6 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !184, metadata !DIExpression()), !dbg !209

  //   %cmp = icmp eq i32 %conv, 1, !dbg !136
  creg__r8__1_ = max(0,creg_r8);

  //   %conv18 = zext i1 %cmp to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !188, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !190, metadata !DIExpression()), !dbg !245

  //   %7 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !138
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !192, metadata !DIExpression()), !dbg !245

  //   %conv22 = trunc i64 %7 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !189, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !193, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !195, metadata !DIExpression()), !dbg !249

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !197, metadata !DIExpression()), !dbg !249

  //   %conv28 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !194, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !198, metadata !DIExpression()), !dbg !209

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !145, !tbaa !146
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !199, metadata !DIExpression()), !dbg !209

  //   %10 = load i32, i32* @atom_1_X3_2, align 4, !dbg !148, !tbaa !146
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !200, metadata !DIExpression()), !dbg !209

  //   %11 = load i32, i32* @atom_1_X6_2, align 4, !dbg !149, !tbaa !146
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !201, metadata !DIExpression()), !dbg !209

  //   %12 = load i32, i32* @atom_1_X7_0, align 4, !dbg !150, !tbaa !146
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !202, metadata !DIExpression()), !dbg !209

  //   %and = and i32 %11, %12, !dbg !151
  creg_r15 = max(creg_r13,creg_r14);
  r15 = r13 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !203, metadata !DIExpression()), !dbg !209

  //   %and31 = and i32 %10, %and, !dbg !152
  creg_r16 = max(creg_r12,creg_r15);
  r16 = r12 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !204, metadata !DIExpression()), !dbg !209

  //   %and32 = and i32 %9, %and31, !dbg !153
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !205, metadata !DIExpression()), !dbg !209

  //   %and33 = and i32 %conv30, %and32, !dbg !154
  creg_r18 = max(creg__r10__2_,creg_r17);
  r18 = (r10==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !206, metadata !DIExpression()), !dbg !209

  //   %and34 = and i32 %conv24, %and33, !dbg !155
  creg_r19 = max(creg__r9__2_,creg_r18);
  r19 = (r9==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !207, metadata !DIExpression()), !dbg !209

  //   %and35 = and i32 %conv18, %and34, !dbg !156
  creg_r20 = max(creg__r8__1_,creg_r19);
  r20 = (r8==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !208, metadata !DIExpression()), !dbg !209

  //   %cmp36 = icmp eq i32 %and35, 1, !dbg !157
  creg__r20__1_ = max(0,creg_r20);

  //   br i1 %cmp36, label %if.then, label %if.end, !dbg !159
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 94, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
