...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !80, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !82, metadata !DIExpression()), !dbg !123
  ...
  //   %cmp21 = icmp eq i32 %conv4, 1, !dbg !112
  ...
  //   %cmp23 = icmp eq i32 %conv8, 2, !dbg !114
  ...
  //   store i32 %conv24, i32* @atom_1_X5_2, align 4, !dbg !115, !tbaa !108
  // ST: Guess
  ...
  //   store i32 %conv26, i32* @atom_1_X9_0, align 4, !dbg !117, !tbaa !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !216

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !218

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !220

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !165, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !166, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !169, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !172, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !175, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !178, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !182, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !185, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !188, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !192, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !194, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !195, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !199, metadata !DIExpression()), !dbg !254

  //   %conv24 = trunc i64 %7 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !196, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !200, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !202, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !204, metadata !DIExpression()), !dbg !258

  //   %conv30 = trunc i64 %8 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !201, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !205, metadata !DIExpression()), !dbg !216
