...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !62, metadata !DIExpression()), !dbg !91
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !66, metadata !DIExpression()), !dbg !94

  //   %conv = trunc i64 %0 to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !63, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !97

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !91

  //   %xor = xor i32 %conv4, %conv4, !dbg !81
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !71, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !73, metadata !DIExpression()), !dbg !102

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(2,r4);
  ...
  //   %conv8 = trunc i64 %2 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !104

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !104

  //   %conv12 = trunc i64 %3 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !91

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !88
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !80, metadata !DIExpression()), !dbg !91

  //   %add15 = add nsw i32 0, %xor13, !dbg !89
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !89

  //   %arrayidx17 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !89
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !82, metadata !DIExpression()), !dbg !109

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   %conv20 = trunc i64 %4 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !81, metadata !DIExpression()), !dbg !91

  //   %cmp = icmp eq i32 %conv, 1, !dbg !92
  creg__r0__1_ = max(0,creg_r0);

  //   %conv21 = zext i1 %cmp to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !85, metadata !DIExpression()), !dbg !91

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !93, !tbaa !94
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !98
  creg__r1__1_ = max(0,creg_r1);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !86, metadata !DIExpression()), !dbg !91

  //   store i32 %conv23, i32* @atom_1_X2_1, align 4, !dbg !99, !tbaa !94
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 0, !dbg !100
  creg__r5__0_ = max(0,creg_r5);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv25, i32* @atom_1_X4_0, align 4, !dbg !101, !tbaa !94
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv12, 1, !dbg !102
  creg__r6__1_ = max(0,creg_r6);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !88, metadata !DIExpression()), !dbg !91

  //   store i32 %conv27, i32* @atom_1_X6_1, align 4, !dbg !103, !tbaa !94
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv20, 0, !dbg !104
  creg__r10__0_ = max(0,creg_r10);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !89, metadata !DIExpression()), !dbg !91

  //   store i32 %conv29, i32* @atom_1_X8_0, align 4, !dbg !105, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !146, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !147, metadata !DIExpression()), !dbg !206

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !148, metadata !DIExpression()), !dbg !208

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !152, metadata !DIExpression()), !dbg !210

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !153, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !154, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !157, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !159, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !163, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !219

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !120
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l65_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l65_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !167, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !170, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !173, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i32 0, metadata !175, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !176, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !178, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !182, metadata !DIExpression()), !dbg !240

  //   %conv = trunc i64 %6 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !179, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !183, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !187, metadata !DIExpression()), !dbg !244

  //   %conv24 = trunc i64 %7 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !184, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !188, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !190, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !192, metadata !DIExpression()), !dbg !248

  //   %conv30 = trunc i64 %8 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !189, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !193, metadata !DIExpression()), !dbg !206

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !154, !tbaa !155
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l85_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !194, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !195, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !196, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !197, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !198, metadata !DIExpression()), !dbg !206

  //   %and = and i32 %12, %13, !dbg !161
  creg_r23 = max(creg_r21,creg_r22);
  r23 = r21 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !199, metadata !DIExpression()), !dbg !206

  //   %and33 = and i32 %11, %and, !dbg !162
  creg_r24 = max(creg_r20,creg_r23);
  r24 = r20 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !200, metadata !DIExpression()), !dbg !206

  //   %and34 = and i32 %10, %and33, !dbg !163
  creg_r25 = max(creg_r19,creg_r24);
  r25 = r19 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !201, metadata !DIExpression()), !dbg !206

  //   %and35 = and i32 %9, %and34, !dbg !164
  creg_r26 = max(creg_r18,creg_r25);
  r26 = r18 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !202, metadata !DIExpression()), !dbg !206

  //   %and36 = and i32 %conv32, %and35, !dbg !165
  creg_r27 = max(creg__r17__1_,creg_r26);
  r27 = (r17==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !203, metadata !DIExpression()), !dbg !206

  //   %and37 = and i32 %conv26, %and36, !dbg !166
  creg_r28 = max(creg__r16__1_,creg_r27);
  r28 = (r16==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !204, metadata !DIExpression()), !dbg !206

  //   %and38 = and i32 %conv20, %and37, !dbg !167
  creg_r29 = max(creg__r15__1_,creg_r28);
  r29 = (r15==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !205, metadata !DIExpression()), !dbg !206
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 97, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
