...
T2BLOCK4:
  ...
  //   %add14 = add nsw i32 0, %xor13, !dbg !97
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !97

  //   %arrayidx16 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !97
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !79, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64 1, metadata !81, metadata !DIExpression()), !dbg !117

  //   store atomic i64 1, i64* %arrayidx16 monotonic, align 8, !dbg !97
  // ST: Guess
  iw(2,r9) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l39_c3
  old_cw = cw(2,r9);
  cw(2,r9) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l39_c3
  // Check
  ...
  //   %cmp22 = icmp eq i32 %conv8, 0, !dbg !108
  ...
  //   store i32 %conv23, i32* @atom_1_X5_0, align 4, !dbg !109, !tbaa !104
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv12, 1, !dbg !110
  ...
  //   store i32 %conv25, i32* @atom_1_X7_1, align 4, !dbg !111, !tbaa !104
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv20, 1, !dbg !112
  ...
  //   store i32 %conv27, i32* @atom_1_X11_1, align 4, !dbg !113, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_1, metadata !184, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !233

  //   store atomic i32 0, i32* @atom_1_X11_1 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X11_1, align 4, !dbg !155, !tbaa !151
  // LD: Guess
  old_cr = cr(0,7);
