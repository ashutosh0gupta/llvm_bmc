...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !44

  //   call void @llvm.dbg.value(metadata i64 2, metadata !39, metadata !DIExpression()), !dbg !44

  //   store atomic i64 2, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !45
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !52, metadata !DIExpression()), !dbg !71
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !56, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !64, metadata !DIExpression()), !dbg !81
...
T0BLOCK0:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !101, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 0, metadata !103, metadata !DIExpression()), !dbg !123

  //   store atomic i64 0, i64* @atom_1_X0_2 monotonic, align 8, !dbg !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !104, metadata !DIExpression()), !dbg !125

  //   call void @llvm.dbg.value(metadata i64 0, metadata !106, metadata !DIExpression()), !dbg !125

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !108, metadata !DIExpression()), !dbg !137

  //   %4 = load atomic i64, i64* @atom_1_X0_2 seq_cst, align 8, !dbg !87
  // LD: Guess
  old_cr = cr(0,1);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !112, metadata !DIExpression()), !dbg !140

  //   %5 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(0,2);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 52, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !96
