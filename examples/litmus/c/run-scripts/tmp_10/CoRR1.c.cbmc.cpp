...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !37, metadata !DIExpression()), !dbg !45

  //   call void @llvm.dbg.value(metadata i64 2, metadata !40, metadata !DIExpression()), !dbg !45

  //   store atomic i64 2, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !46
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !52, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !56, metadata !DIExpression()), !dbg !68
  ...
  // ST: Guess
  iw(2,1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l29_c15
  old_cw = cw(2,1);
  cw(2,1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l29_c15
  // Check
  ASSUME(active[iw(2,1)] == 2);
  ASSUME(active[cw(2,1)] == 2);
  ASSUME(sforbid(1,cw(2,1))== 0);
  ASSUME(iw(2,1) >= creg__r0__2_);
  ASSUME(iw(2,1) >= 0);
...
T0BLOCK0:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !66
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !97, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i32 0, metadata !100, metadata !DIExpression()), !dbg !114

  //   store atomic i32 0, i32* @atom_1_X0_2 monotonic, align 4, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !101, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i32 0, metadata !103, metadata !DIExpression()), !dbg !116

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !70
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_1_X0_2, align 4, !dbg !81, !tbaa !82
  // LD: Guess
  old_cr = cr(0,1);
  ...
  //   %5 = load i32, i32* @atom_1_X2_1, align 4, !dbg !84, !tbaa !82
  // LD: Guess
  old_cr = cr(0,2);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 52, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !89
