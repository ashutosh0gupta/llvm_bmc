...
T2BLOCK7:
  ...
  //   %cmp22 = icmp eq i32 %conv8, 0, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !87, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !91, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !122
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !189, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !192, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !218, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !222, metadata !DIExpression()), !dbg !289
