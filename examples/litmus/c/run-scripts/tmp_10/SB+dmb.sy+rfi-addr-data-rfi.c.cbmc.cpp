...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !80, metadata !DIExpression()), !dbg !92

  //   %add6 = add nsw i32 %xor5, 1, !dbg !77
  creg_r7 = max(0,creg_r6);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !81, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !106

  //   %conv9 = sext i32 %add6 to i64, !dbg !79

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !84, metadata !DIExpression()), !dbg !106

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !85, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !89, metadata !DIExpression()), !dbg !92

  //   store i32 %conv14, i32* @atom_1_X2_1, align 4, !dbg !84, !tbaa !85
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv13, 1, !dbg !89
  creg__r8__1_ = max(0,creg_r8);

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !90, metadata !DIExpression()), !dbg !92

  //   store i32 %conv16, i32* @atom_1_X8_1, align 4, !dbg !90, !tbaa !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !146, metadata !DIExpression()), !dbg !181
