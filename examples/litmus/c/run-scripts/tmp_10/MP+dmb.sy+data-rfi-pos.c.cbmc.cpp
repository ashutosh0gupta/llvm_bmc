...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !64, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !88

  //   %conv1 = sext i32 %add to i64, !dbg !70

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !67, metadata !DIExpression()), !dbg !88

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !70
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !90

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !72
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !71, metadata !DIExpression()), !dbg !90

  //   %conv5 = trunc i64 %1 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !68, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !93

  //   %conv9 = trunc i64 %2 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !72, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !76, metadata !DIExpression()), !dbg !80

  //   store i32 %conv10, i32* @atom_1_X0_1, align 4, !dbg !78, !tbaa !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !77, metadata !DIExpression()), !dbg !80

  //   store i32 %conv12, i32* @atom_1_X4_1, align 4, !dbg !84, !tbaa !79
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv9, 1, !dbg !85
  creg__r4__1_ = max(0,creg_r4);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !78, metadata !DIExpression()), !dbg !80

  //   store i32 %conv14, i32* @atom_1_X5_1, align 4, !dbg !86, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !127, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i32 0, metadata !130, metadata !DIExpression()), !dbg !163

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !131, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !134, metadata !DIExpression()), !dbg !167
  ...
  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !115, !tbaa !116
  // LD: Guess
  old_cr = cr(0,2);
