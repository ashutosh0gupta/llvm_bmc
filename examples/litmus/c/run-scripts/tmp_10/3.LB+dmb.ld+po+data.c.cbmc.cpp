...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !95, metadata !DIExpression()), !dbg !102

  //   %add = add nsw i32 %xor, 1, !dbg !58
  creg_r4 = max(0,creg_r3);
  r4 = r3 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !96, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !99, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !100, metadata !DIExpression()), !dbg !102
