...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !100, metadata !DIExpression()), !dbg !113
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !132, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !142, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !146, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !149, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !154, metadata !DIExpression()), !dbg !157

  //   %and = and i32 %7, %8, !dbg !111
  creg_r18 = max(creg_r16,creg_r17);
  r18 = r16 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !155, metadata !DIExpression()), !dbg !157
