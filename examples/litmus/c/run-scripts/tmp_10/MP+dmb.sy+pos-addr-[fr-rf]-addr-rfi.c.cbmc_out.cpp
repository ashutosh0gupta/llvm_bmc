...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !122
  ...
  //   %xor13 = xor i32 %conv12, %conv12, !dbg !106
  creg_r7 = max(creg_r6,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !80, metadata !DIExpression()), !dbg !109

  //   %add14 = add nsw i32 0, %xor13, !dbg !107
  creg_r8 = max(0,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = 0 + r7;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !107

  //   %arrayidx16 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !107
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !81, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 1, metadata !83, metadata !DIExpression()), !dbg !127

  //   store atomic i64 1, i64* %arrayidx16 monotonic, align 8, !dbg !107
  // ST: Guess
