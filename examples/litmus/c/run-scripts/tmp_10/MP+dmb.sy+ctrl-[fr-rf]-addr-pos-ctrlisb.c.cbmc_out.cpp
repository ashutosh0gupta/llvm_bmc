...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !90), !dbg !95
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !91), !dbg !104
  ...
  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !99
  creg__r7__0_ = max(0,creg_r7);

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !101
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !92), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !125

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !107
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l41_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !125

  //   %conv23 = trunc i64 %5 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !82, metadata !DIExpression()), !dbg !93

  //   %cmp = icmp eq i32 %conv, 1, !dbg !109
  creg__r0__1_ = max(0,creg_r0);

  //   %conv24 = zext i1 %cmp to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !86, metadata !DIExpression()), !dbg !93

  //   store i32 %conv24, i32* @atom_1_X0_1, align 4, !dbg !110, !tbaa !111
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv4, 0, !dbg !115
  creg__r1__0_ = max(0,creg_r1);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !87, metadata !DIExpression()), !dbg !93

  //   store i32 %conv26, i32* @atom_1_X2_0, align 4, !dbg !116, !tbaa !111
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv8, 1, !dbg !117
  creg__r2__1_ = max(0,creg_r2);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !88, metadata !DIExpression()), !dbg !93

  //   store i32 %conv28, i32* @atom_1_X4_1, align 4, !dbg !118, !tbaa !111
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv23, 0, !dbg !119
  creg__r8__0_ = max(0,creg_r8);

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !89, metadata !DIExpression()), !dbg !93

  //   store i32 %conv30, i32* @atom_1_X9_0, align 4, !dbg !120, !tbaa !111
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !143, metadata !DIExpression()), !dbg !148
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !144, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64 1, metadata !146, metadata !DIExpression()), !dbg !151
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !161, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !162, metadata !DIExpression()), !dbg !219

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !163, metadata !DIExpression()), !dbg !221

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !167, metadata !DIExpression()), !dbg !223

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !168, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !169, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !172, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !181, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !185, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !188, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !191, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i32 0, metadata !193, metadata !DIExpression()), !dbg !240

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !195, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !197, metadata !DIExpression()), !dbg !253

  //   %conv = trunc i64 %6 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !194, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !198, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !200, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !202, metadata !DIExpression()), !dbg !257

  //   %conv24 = trunc i64 %7 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !199, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !203, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !205, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !207, metadata !DIExpression()), !dbg !261

  //   %conv30 = trunc i64 %8 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !204, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !208, metadata !DIExpression()), !dbg !219

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !150, !tbaa !151
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l87_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !209, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !210, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !211, metadata !DIExpression()), !dbg !219

  //   %12 = load i32, i32* @atom_1_X9_0, align 4, !dbg !155, !tbaa !151
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !212, metadata !DIExpression()), !dbg !219

  //   %and = and i32 %11, %12, !dbg !156
  creg_r20 = max(creg_r18,creg_r19);
  r20 = r18 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !213, metadata !DIExpression()), !dbg !219

  //   %and33 = and i32 %10, %and, !dbg !157
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !214, metadata !DIExpression()), !dbg !219

  //   %and34 = and i32 %9, %and33, !dbg !158
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !215, metadata !DIExpression()), !dbg !219

  //   %and35 = and i32 %conv32, %and34, !dbg !159
  creg_r23 = max(creg__r15__1_,creg_r22);
  r23 = (r15==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !216, metadata !DIExpression()), !dbg !219

  //   %and36 = and i32 %conv26, %and35, !dbg !160
  creg_r24 = max(creg__r14__1_,creg_r23);
  r24 = (r14==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !217, metadata !DIExpression()), !dbg !219

  //   %and37 = and i32 %conv20, %and36, !dbg !161
  creg_r25 = max(creg__r13__1_,creg_r24);
  r25 = (r13==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !218, metadata !DIExpression()), !dbg !219
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 97, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !165
