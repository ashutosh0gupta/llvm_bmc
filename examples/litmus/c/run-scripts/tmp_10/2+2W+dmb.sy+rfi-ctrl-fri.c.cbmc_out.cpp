...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !55, metadata !DIExpression()), !dbg !81
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !56, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64 2, metadata !58, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !61, metadata !DIExpression()), !dbg !86
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !71, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !72, metadata !DIExpression()), !dbg !101
  ...
  //   %cmp11 = icmp eq i32 %conv4, 0, !dbg !84

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !76, metadata !DIExpression()), !dbg !104
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !127, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !130, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !136, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !137, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !141, metadata !DIExpression()), !dbg !181

  //   %conv14 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !138, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !144, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !146, metadata !DIExpression()), !dbg !185

  //   %conv20 = trunc i64 %6 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !143, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !148, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !150, metadata !DIExpression()), !dbg !188

  //   %conv24 = trunc i64 %7 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !147, metadata !DIExpression()), !dbg !154
