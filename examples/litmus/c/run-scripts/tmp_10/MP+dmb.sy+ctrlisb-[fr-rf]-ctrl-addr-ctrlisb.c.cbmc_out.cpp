...
T2BLOCK10:
  ...
  //   %cmp29 = icmp eq i32 %conv4, 0, !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !91, metadata !DIExpression()), !dbg !152

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %7, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv8, 1, !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !95, metadata !DIExpression()), !dbg !155

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %8, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !137
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !164, metadata !DIExpression()), !dbg !171
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !207, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !210, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !217, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !222, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !227, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !236, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !240, metadata !DIExpression()), !dbg !309
