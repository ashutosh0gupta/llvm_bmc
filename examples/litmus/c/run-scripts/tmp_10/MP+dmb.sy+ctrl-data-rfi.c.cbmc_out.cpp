...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !78

  //   %add = add nsw i32 %xor, 1, !dbg !75
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !66, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !67, metadata !DIExpression()), !dbg !95

  //   %conv5 = sext i32 %add to i64, !dbg !77

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !69, metadata !DIExpression()), !dbg !95

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !77
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !97
  ...
  //   %conv9 = trunc i64 %2 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !70, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !74, metadata !DIExpression()), !dbg !78
  ...
  //   %cmp11 = icmp eq i32 %conv9, 1, !dbg !87
  ...
  //   store i32 %conv12, i32* @atom_1_X6_1, align 4, !dbg !88, !tbaa !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !136, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !167

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X6_1, align 4, !dbg !114, !tbaa !112
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
