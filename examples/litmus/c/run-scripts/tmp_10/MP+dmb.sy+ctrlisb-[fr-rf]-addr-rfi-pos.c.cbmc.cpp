...
T2BLOCK4:
  ...
  // ST: Guess
  iw(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l38_c3
  old_cw = cw(2,r5);
  cw(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l38_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !116

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   store i32 %conv23, i32* @atom_1_X8_1, align 4, !dbg !114, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !184, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !236

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X8_1, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
