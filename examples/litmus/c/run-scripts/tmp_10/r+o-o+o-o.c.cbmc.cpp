...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !34, metadata !DIExpression()), !dbg !51

  //   call void @llvm.dbg.value(metadata i64 2, metadata !37, metadata !DIExpression()), !dbg !51
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !53
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X1_0, metadata !44, metadata !DIExpression()), !dbg !57

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !46, metadata !DIExpression()), !dbg !57

  //   store atomic i64 %1, i64* @atom_0_X1_0 seq_cst, align 8, !dbg !58
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !85, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !86, metadata !DIExpression()), !dbg !111

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !87, metadata !DIExpression()), !dbg !113

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !91, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !92, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X1_0, metadata !98, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64 0, metadata !100, metadata !DIExpression()), !dbg !120

  //   store atomic i64 0, i64* @atom_0_X1_0 monotonic, align 8, !dbg !74
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !104, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X1_0, metadata !107, metadata !DIExpression()), !dbg !136

  //   %5 = load atomic i64, i64* @atom_0_X1_0 seq_cst, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !109, metadata !DIExpression()), !dbg !136
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 51, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !96
