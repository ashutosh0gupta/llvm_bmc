...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !35, metadata !DIExpression()), !dbg !48

  //   call void @llvm.dbg.value(metadata i64 2, metadata !38, metadata !DIExpression()), !dbg !48
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !39, metadata !DIExpression()), !dbg !45
  ...
  //   store i32 %conv1, i32* @atom_0_X1_0, align 4, !dbg !54, !tbaa !55
  // ST: Guess
  iw(1,2) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l22_c15
  old_cw = cw(1,2);
  cw(1,2) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l22_c15
  // Check
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !62, metadata !DIExpression()), !dbg !70
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !63, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64 1, metadata !65, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !75

  //   call void @llvm.dbg.value(metadata i64 1, metadata !68, metadata !DIExpression()), !dbg !75
...
T0BLOCK0:
  ...
  // ST: Guess
  iw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l37_c3
  old_cw = cw(0,0);
  cw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l37_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !95, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X1_0, metadata !98, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i32 0, metadata !101, metadata !DIExpression()), !dbg !118

  //   store atomic i32 0, i32* @atom_0_X1_0 monotonic, align 4, !dbg !72
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_0_X1_0, align 4, !dbg !87, !tbaa !88
  // LD: Guess
  old_cr = cr(0,2);
