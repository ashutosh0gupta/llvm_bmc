...
T2BLOCK10:
  ...
  //   %cmp28 = icmp eq i32 %conv15, 0, !dbg !122
  ...
  //   store i32 %conv29, i32* @atom_1_X7_0, align 4, !dbg !123, !tbaa !118
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv19, 1, !dbg !124
  ...
  //   store i32 %conv31, i32* @atom_1_X9_1, align 4, !dbg !125, !tbaa !118
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !151, metadata !DIExpression()), !dbg !158
  ...
  // ST: Guess
  iw(3,0+4*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l57_c3
  old_cw = cw(3,0+4*1);
  cw(3,0+4*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l57_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !195, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !198, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !205, metadata !DIExpression()), !dbg !265

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,0+4*1);
  cr(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l84_c13
  // Check
