...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !55, metadata !DIExpression()), !dbg !79
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !56, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !67, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !66, metadata !DIExpression()), !dbg !79

  //   %cmp = icmp eq i32 %conv, 1, !dbg !73

  //   %conv6 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !70, metadata !DIExpression()), !dbg !79

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !71, metadata !DIExpression()), !dbg !93
  ...
  //   %cmp10 = icmp eq i32 %conv5, 1, !dbg !76

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !74, metadata !DIExpression()), !dbg !79

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !75, metadata !DIExpression()), !dbg !96

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !96

  //   store atomic i64 %3, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !78
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !119, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !122, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !136, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !140, metadata !DIExpression()), !dbg !180

  //   %7 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
