...
T2BLOCK1:
  ...
  //   %cmp24 = icmp eq i32 %conv20, 1, !dbg !94
  ...
  //   store i32 %conv25, i32* @atom_1_X9_1, align 4, !dbg !95, !tbaa !88
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64 1, metadata !121, metadata !DIExpression()), !dbg !126
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !157, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !195

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !160, metadata !DIExpression()), !dbg !197
  ...
  //   %9 = load i32, i32* @atom_1_X7_0, align 4, !dbg !129, !tbaa !127
  // LD: Guess
  old_cr = cr(0,4);
