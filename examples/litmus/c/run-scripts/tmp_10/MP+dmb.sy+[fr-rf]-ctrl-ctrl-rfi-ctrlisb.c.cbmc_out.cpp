...
T2BLOCK10:
  ...
  //   %cmp24 = icmp eq i32 %conv4, 2, !dbg !118
  ...
  //   store i32 %conv25, i32* @atom_1_X2_2, align 4, !dbg !119, !tbaa !114
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv15, 1, !dbg !120
  ...
  //   store i32 %conv27, i32* @atom_1_X7_1, align 4, !dbg !121, !tbaa !114
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv22, 0, !dbg !122
  ...
  //   store i32 %conv29, i32* @atom_1_X8_0, align 4, !dbg !123, !tbaa !114
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !188, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !191, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !194, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !198, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !203, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !208, metadata !DIExpression()), !dbg !264
