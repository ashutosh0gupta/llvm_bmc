...
T2BLOCK10:
  ...
  //   %cmp27 = icmp eq i32 %conv4, 2, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !89, metadata !DIExpression()), !dbg !147

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %6, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !93, metadata !DIExpression()), !dbg !150

  //   %7 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %7, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !132
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64 2, metadata !161, metadata !DIExpression()), !dbg !166
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !199, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !202, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !205, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !228, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !232, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !236, metadata !DIExpression()), !dbg !302
