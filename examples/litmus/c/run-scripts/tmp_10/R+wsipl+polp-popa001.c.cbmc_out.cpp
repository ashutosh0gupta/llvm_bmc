...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !69, metadata !DIExpression()), !dbg !83
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !72, metadata !DIExpression()), !dbg !86

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !55
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !74, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !77, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !81, metadata !DIExpression()), !dbg !83
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !111, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !114, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_3, metadata !117, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i32 0, metadata !120, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !121, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i32 0, metadata !123, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !125, metadata !DIExpression()), !dbg !154

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l53_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !127, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !128, metadata !DIExpression()), !dbg !133

  //   %5 = load i32, i32* @atom_0_X3_3, align 4, !dbg !96, !tbaa !97
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l55_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !129, metadata !DIExpression()), !dbg !133

  //   %6 = load i32, i32* @atom_1_X4_0, align 4, !dbg !99, !tbaa !97
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l56_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %and11, metadata !132, metadata !DIExpression()), !dbg !133
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 59, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !105
