...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !55
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !58

  //   call void @llvm.dbg.value(metadata i64 2, metadata !46, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !48, metadata !DIExpression()), !dbg !61

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !50, metadata !DIExpression()), !dbg !61

  //   store atomic i64 %1, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !62
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !66, metadata !DIExpression()), !dbg !81
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !68, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !70, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !71, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !72, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !73, metadata !DIExpression()), !dbg !89

  //   %conv1 = sext i32 %add to i64, !dbg !63

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !75, metadata !DIExpression()), !dbg !89

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !76, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !77, metadata !DIExpression()), !dbg !92

  //   %1 = zext i32 %conv2 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !79, metadata !DIExpression()), !dbg !92

  //   store atomic i64 %1, i64* @atom_1_X0_2 seq_cst, align 8, !dbg !66
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !99, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !101, metadata !DIExpression()), !dbg !115

  //   %conv = trunc i64 %0 to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !98, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !102, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !103, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !104, metadata !DIExpression()), !dbg !120

  //   %conv1 = sext i32 %add to i64, !dbg !63

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !106, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !107, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !108, metadata !DIExpression()), !dbg !123
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !140, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !141, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !144, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !147, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64 0, metadata !149, metadata !DIExpression()), !dbg !187

  //   store atomic i64 0, i64* @atom_0_X0_1 monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !150, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64 0, metadata !152, metadata !DIExpression()), !dbg !189

  //   store atomic i64 0, i64* @atom_1_X0_2 monotonic, align 8, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !153, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64 0, metadata !155, metadata !DIExpression()), !dbg !191

  //   store atomic i64 0, i64* @atom_2_X0_1 monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !103
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !104
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !157, metadata !DIExpression()), !dbg !206

  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   %conv = trunc i64 %6 to i32, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !162, metadata !DIExpression()), !dbg !210

  //   %7 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %conv18 = trunc i64 %7 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !161, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !166, metadata !DIExpression()), !dbg !213

  //   %8 = load atomic i64, i64* @atom_1_X0_2 seq_cst, align 8, !dbg !123
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %conv22 = trunc i64 %8 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !165, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !170, metadata !DIExpression()), !dbg !216

  //   %9 = load atomic i64, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !126
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !172, metadata !DIExpression()), !dbg !216

  //   %conv26 = trunc i64 %9 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !169, metadata !DIExpression()), !dbg !176

  //   %and = and i32 %conv22, %conv26, !dbg !128
  ...
  //   %and27 = and i32 %conv18, %and, !dbg !129
  ...
  //   %and28 = and i32 %conv14, %and27, !dbg !130
  ...
  //   %cmp29 = icmp eq i32 %and28, 1, !dbg !131

  //   br i1 %cmp29, label %if.then, label %if.end, !dbg !133
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !134

  //   unreachable, !dbg !134
  r18 = 1;

T0BLOCK2:
  //   %10 = bitcast i64* %thr2 to i8*, !dbg !137

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !137

  //   %11 = bitcast i64* %thr1 to i8*, !dbg !137

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !137

  //   %12 = bitcast i64* %thr0 to i8*, !dbg !137

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !137
