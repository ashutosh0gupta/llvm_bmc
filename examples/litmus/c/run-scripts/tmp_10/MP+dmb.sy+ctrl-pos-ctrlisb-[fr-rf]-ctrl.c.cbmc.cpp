...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !130

  //   %conv26 = trunc i64 %5 to i32, !dbg !113
  ...
  //   %conv27 = zext i1 %cmp to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !85, metadata !DIExpression()), !dbg !93

  //   store i32 %conv27, i32* @atom_1_X0_1, align 4, !dbg !115, !tbaa !116
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv15, 0, !dbg !120
  ...
  //   store i32 %conv29, i32* @atom_1_X5_0, align 4, !dbg !121, !tbaa !116
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv19, 1, !dbg !122
  ...
  //   store i32 %conv31, i32* @atom_1_X7_1, align 4, !dbg !123, !tbaa !116
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv26, 0, !dbg !124
  creg__r5__0_ = max(0,creg_r5);

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !88, metadata !DIExpression()), !dbg !93

  //   store i32 %conv33, i32* @atom_1_X8_0, align 4, !dbg !125, !tbaa !116
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !174, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !177, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !183, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !186, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !190, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !193, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !196, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !200, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !202, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !203, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !205, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !207, metadata !DIExpression()), !dbg !262

  //   %conv24 = trunc i64 %7 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !204, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !208, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !210, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !212, metadata !DIExpression()), !dbg !266

  //   %conv30 = trunc i64 %8 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !209, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !213, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !219, metadata !DIExpression()), !dbg !224

  //   %and34 = and i32 %9, %and33, !dbg !158
  creg_r19 = max(creg_r13,creg_r18);
  r19 = r13 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !220, metadata !DIExpression()), !dbg !224

  //   %and35 = and i32 %conv32, %and34, !dbg !159
  creg_r20 = max(creg__r12__1_,creg_r19);
  r20 = (r12==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !221, metadata !DIExpression()), !dbg !224

  //   %and36 = and i32 %conv26, %and35, !dbg !160
  creg_r21 = max(creg__r11__1_,creg_r20);
  r21 = (r11==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !222, metadata !DIExpression()), !dbg !224

  //   %and37 = and i32 %conv20, %and36, !dbg !161
  creg_r22 = max(creg__r10__1_,creg_r21);
  r22 = (r10==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !223, metadata !DIExpression()), !dbg !224
