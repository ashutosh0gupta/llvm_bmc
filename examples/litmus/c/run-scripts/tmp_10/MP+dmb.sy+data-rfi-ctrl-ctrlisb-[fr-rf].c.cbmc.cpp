...
T2BLOCK4:
  ...
  //   %tobool10 = icmp ne i32 %conv9, 0, !dbg !96
  creg__r4__0_ = max(0,creg_r4);

  //   br i1 %tobool10, label %if.then11, label %if.else12, !dbg !98
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !92), !dbg !120

  //   call void (...) @isb(), !dbg !102
  // isb: Guess
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv16 = trunc i64 %3 to i32, !dbg !105
  ...
  //   %cmp22 = icmp eq i32 %conv5, 1, !dbg !115
  ...
  //   store i32 %conv23, i32* @atom_1_X4_1, align 4, !dbg !116, !tbaa !111
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv16, 0, !dbg !117
  ...
  //   store i32 %conv25, i32* @atom_1_X7_0, align 4, !dbg !118, !tbaa !111
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv20, 1, !dbg !119
  ...
  //   store i32 %conv27, i32* @atom_1_X9_1, align 4, !dbg !120, !tbaa !111
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !144, metadata !DIExpression()), !dbg !151
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !185, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !188, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !238

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !191, metadata !DIExpression()), !dbg !240
  ...
  //   %11 = load i32, i32* @atom_1_X7_0, align 4, !dbg !154, !tbaa !151
  // LD: Guess
  old_cr = cr(0,6);
