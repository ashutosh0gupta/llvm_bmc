...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !73, metadata !DIExpression()), !dbg !86
  ...
  //   %cmp19 = icmp eq i32 %conv4, 2, !dbg !88

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !81, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !82, metadata !DIExpression()), !dbg !108

  //   %4 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %4, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !134, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !137, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !151, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !155, metadata !DIExpression()), !dbg !197
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
