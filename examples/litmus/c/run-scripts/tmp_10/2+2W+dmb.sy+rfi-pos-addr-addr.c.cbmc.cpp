...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !68, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !70, metadata !DIExpression()), !dbg !93

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !73
  // LD: Guess
  old_cr = cr(2,r4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !73, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !74, metadata !DIExpression()), !dbg !97
  ...
  //   store i32 %conv15, i32* @atom_1_X2_2, align 4, !dbg !80, !tbaa !81
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv4, 2, !dbg !85
  ...
  //   store i32 %conv17, i32* @atom_1_X3_2, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !130, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !134, metadata !DIExpression()), !dbg !165
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
