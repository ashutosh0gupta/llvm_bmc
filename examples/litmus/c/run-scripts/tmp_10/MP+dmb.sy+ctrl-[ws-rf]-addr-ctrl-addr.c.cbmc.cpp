...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !63, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64 1, metadata !65, metadata !DIExpression()), !dbg !102

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !104

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !69, metadata !DIExpression()), !dbg !104

  //   %conv4 = trunc i64 %1 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !90

  //   %xor = xor i32 %conv4, %conv4, !dbg !88
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !70, metadata !DIExpression()), !dbg !90
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !89
  r4 = 0+r3*1;
  creg_r4 = creg_r3;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !72, metadata !DIExpression()), !dbg !109
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !89), !dbg !116
  ...
  //   %xor16 = xor i32 %conv15, %conv15, !dbg !101
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !79, metadata !DIExpression()), !dbg !90

  //   %add18 = add nsw i32 0, %xor16, !dbg !102
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom19 = sext i32 %add18 to i64, !dbg !102

  //   %arrayidx20 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !102
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !81, metadata !DIExpression()), !dbg !122

  //   %4 = load atomic i64, i64* %arrayidx20 monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,r9);
  cr(2,r9) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l40_c17
  // Check
  ...
  //   %cmp25 = icmp eq i32 %conv4, 2, !dbg !111
  ...
  //   store i32 %conv26, i32* @atom_1_X4_2, align 4, !dbg !112, !tbaa !107
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !138, metadata !DIExpression()), !dbg !145
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !182, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !199, metadata !DIExpression()), !dbg !253
