...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !40, metadata !DIExpression()), !dbg !61
...
T2BLOCK1:
  ...
  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !57
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64 4, metadata !80, metadata !DIExpression()), !dbg !95

  //   store atomic i64 4, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !59
  // ST: Guess
  iw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0+1*1);
  cw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_3, metadata !124, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64 0, metadata !126, metadata !DIExpression()), !dbg !160

  //   store atomic i64 0, i64* @atom_0_X5_3 monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv14, 4, !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_3, metadata !141, metadata !DIExpression()), !dbg !182

  //   %6 = load atomic i64, i64* @atom_0_X5_3 seq_cst, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(0,2);
