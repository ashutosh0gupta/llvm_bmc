...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !54
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !46, metadata !DIExpression()), !dbg !59

  //   %conv1 = sext i32 %add to i64, !dbg !60

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !48, metadata !DIExpression()), !dbg !59

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !60
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64 2, metadata !77, metadata !DIExpression()), !dbg !96

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !66
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !79, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !81, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !82, metadata !DIExpression()), !dbg !90

  //   %add = add nsw i32 %xor, 1, !dbg !71
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !83, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !103

  //   %conv7 = sext i32 %add to i64, !dbg !73

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !86, metadata !DIExpression()), !dbg !103

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !87, metadata !DIExpression()), !dbg !90

  //   store i32 %conv8, i32* @atom_1_X0_1, align 4, !dbg !75, !tbaa !76
  // ST: Guess
  ...
  //   %cmp9 = icmp eq i32 %conv4, 2, !dbg !80
  creg__r4__2_ = max(0,creg_r4);

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !88, metadata !DIExpression()), !dbg !90

  //   store i32 %conv10, i32* @atom_1_X3_2, align 4, !dbg !81, !tbaa !76
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !117, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !118, metadata !DIExpression()), !dbg !157

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !119, metadata !DIExpression()), !dbg !159

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !123, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !124, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64 0, metadata !126, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64 0, metadata !129, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !130, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !166

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !134, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i32 0, metadata !136, metadata !DIExpression()), !dbg !168

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !137, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !139, metadata !DIExpression()), !dbg !170

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !143, metadata !DIExpression()), !dbg !180

  //   %conv = trunc i64 %4 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !140, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !144, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !148, metadata !DIExpression()), !dbg !184

  //   %conv16 = trunc i64 %5 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !145, metadata !DIExpression()), !dbg !157

  //   %cmp17 = icmp eq i32 %conv16, 2, !dbg !114
  creg__r11__2_ = max(0,creg_r11);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !149, metadata !DIExpression()), !dbg !157

  //   %6 = load i32, i32* @atom_0_X0_1, align 4, !dbg !115, !tbaa !116
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !150, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !151, metadata !DIExpression()), !dbg !157

  //   %8 = load i32, i32* @atom_1_X3_2, align 4, !dbg !119, !tbaa !116
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !152, metadata !DIExpression()), !dbg !157

  //   %and = and i32 %7, %8, !dbg !120
  creg_r15 = max(creg_r13,creg_r14);
  r15 = r13 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !153, metadata !DIExpression()), !dbg !157

  //   %and19 = and i32 %6, %and, !dbg !121
  creg_r16 = max(creg_r12,creg_r15);
  r16 = r12 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !154, metadata !DIExpression()), !dbg !157

  //   %and20 = and i32 %conv18, %and19, !dbg !122
  creg_r17 = max(creg__r11__2_,creg_r16);
  r17 = (r11==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !155, metadata !DIExpression()), !dbg !157

  //   %and21 = and i32 %conv12, %and20, !dbg !123
  creg_r18 = max(creg__r10__1_,creg_r17);
  r18 = (r10==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !156, metadata !DIExpression()), !dbg !157
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !127
