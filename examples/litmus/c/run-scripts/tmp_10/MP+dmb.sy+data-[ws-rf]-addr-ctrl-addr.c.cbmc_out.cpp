...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !49

  //   call void @llvm.dbg.value(metadata i64 1, metadata !41, metadata !DIExpression()), !dbg !49

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !50
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !52
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !57, metadata !DIExpression()), !dbg !100

  //   br label %label_2, !dbg !82
  goto T2BLOCK1;

T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !98), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !103

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !62, metadata !DIExpression()), !dbg !103

  //   %conv = trunc i64 %0 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !58, metadata !DIExpression()), !dbg !100

  //   %xor = xor i32 %conv, %conv, !dbg !87
  creg_r1 = max(creg_r0,creg_r0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !63, metadata !DIExpression()), !dbg !100

  //   %add = add nsw i32 %xor, 1, !dbg !88
  creg_r2 = max(creg_r1,0);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !64, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !65, metadata !DIExpression()), !dbg !108

  //   %conv1 = sext i32 %add to i64, !dbg !90

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !67, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !110

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !71, metadata !DIExpression()), !dbg !110

  //   %conv5 = trunc i64 %1 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !68, metadata !DIExpression()), !dbg !100

  //   %xor6 = xor i32 %conv5, %conv5, !dbg !94
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !72, metadata !DIExpression()), !dbg !100

  //   %add8 = add nsw i32 3, %xor6, !dbg !95
  creg_r5 = max(0,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = 3 + r4;

  //   %idxprom = sext i32 %add8 to i64, !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !74, metadata !DIExpression()), !dbg !115

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   %conv11 = trunc i64 %2 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !73, metadata !DIExpression()), !dbg !100

  //   %tobool = icmp ne i32 %conv11, 0, !dbg !98
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !99), !dbg !122

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !78, metadata !DIExpression()), !dbg !123

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !123

  //   %conv15 = trunc i64 %3 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !77, metadata !DIExpression()), !dbg !100

  //   %xor16 = xor i32 %conv15, %conv15, !dbg !107
  creg_r9 = max(creg_r8,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !81, metadata !DIExpression()), !dbg !100

  //   %add18 = add nsw i32 0, %xor16, !dbg !108
  ...
  //   %arrayidx20 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !108
  r11 = 0+r10*1;
  ASSUME(creg_r11 >= 0);
  ASSUME(creg_r11 >= creg_r10);
  ASSUME(active[creg_r11] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !83, metadata !DIExpression()), !dbg !128

  //   %4 = load atomic i64, i64* %arrayidx20 monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,r11);
  ...
  if(cr(2,r11) < cw(2,r11)) {
    ...
    ASSUME((!(( (cw(2,r11) < 5) && (5 < crmax(2,r11)) )))||(sforbid(r11,5)> 0));
    ASSUME((!(( (cw(2,r11) < 6) && (6 < crmax(2,r11)) )))||(sforbid(r11,6)> 0));
    ASSUME((!(( (cw(2,r11) < 7) && (7 < crmax(2,r11)) )))||(sforbid(r11,7)> 0));
    ASSUME((!(( (cw(2,r11) < 8) && (8 < crmax(2,r11)) )))||(sforbid(r11,8)> 0));
    ASSUME((!(( (cw(2,r11) < 9) && (9 < crmax(2,r11)) )))||(sforbid(r11,9)> 0));
  } else {
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !128

  //   %conv23 = trunc i64 %4 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !82, metadata !DIExpression()), !dbg !100

  //   %cmp = icmp eq i32 %conv, 1, !dbg !111

  //   %conv24 = zext i1 %cmp to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !86, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !131

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv5, 2, !dbg !114

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !90, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !91, metadata !DIExpression()), !dbg !134

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %6, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv23, 0, !dbg !117

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !94, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !95, metadata !DIExpression()), !dbg !137

  //   %7 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %7, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !119
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !143, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i64 2, metadata !145, metadata !DIExpression()), !dbg !150

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !47
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !160, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !161, metadata !DIExpression()), !dbg !224

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !162, metadata !DIExpression()), !dbg !226

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !166, metadata !DIExpression()), !dbg !228

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !167, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !168, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !231

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !171, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !233

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !174, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !235

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !177, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !237

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !239

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !183, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !186, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !243

  //   store atomic i64 0, i64* @atom_1_X4_2 monotonic, align 8, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !189, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !245

  //   store atomic i64 0, i64* @atom_1_X11_0 monotonic, align 8, !dbg !128
  // ST: Guess
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !130
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !131
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !132, !tbaa !133
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !137
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !138, !tbaa !133
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call18 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !139
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !140, !tbaa !133
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   %call19 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !141
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !193, metadata !DIExpression()), !dbg !260

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !143
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !195, metadata !DIExpression()), !dbg !260

  //   %conv = trunc i64 %6 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !192, metadata !DIExpression()), !dbg !224

  //   %cmp = icmp eq i32 %conv, 1, !dbg !145

  //   %conv20 = zext i1 %cmp to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !196, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !198, metadata !DIExpression()), !dbg !264

  //   %7 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !200, metadata !DIExpression()), !dbg !264

  //   %conv24 = trunc i64 %7 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !197, metadata !DIExpression()), !dbg !224

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !149

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !201, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !203, metadata !DIExpression()), !dbg !268

  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  if(cr(0,0+2*1) < cw(0,0+2*1)) {
    ...
    r19 = mem(0+2*1,cr(0,0+2*1));
  }
  ASSUME(creturn[0] >= cr(0,0+2*1));

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !205, metadata !DIExpression()), !dbg !268

  //   %conv30 = trunc i64 %8 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !202, metadata !DIExpression()), !dbg !224

  //   %cmp31 = icmp eq i32 %conv30, 2, !dbg !153

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !206, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !208, metadata !DIExpression()), !dbg !272

  //   %9 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !155
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !210, metadata !DIExpression()), !dbg !272

  //   %conv36 = trunc i64 %9 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !207, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !212, metadata !DIExpression()), !dbg !275

  //   %10 = load atomic i64, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !158
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !214, metadata !DIExpression()), !dbg !275

  //   %conv40 = trunc i64 %10 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !211, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !216, metadata !DIExpression()), !dbg !278

  //   %11 = load atomic i64, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !161
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !218, metadata !DIExpression()), !dbg !278

  //   %conv44 = trunc i64 %11 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !215, metadata !DIExpression()), !dbg !224

  //   %and = and i32 %conv40, %conv44, !dbg !163
  creg_r23 = max(creg_r21,creg_r22);
  ASSUME(active[creg_r23] == 0);
  r23 = r21 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !219, metadata !DIExpression()), !dbg !224

  //   %and45 = and i32 %conv36, %and, !dbg !164
  creg_r24 = max(creg_r20,creg_r23);
  ASSUME(active[creg_r24] == 0);
  r24 = r20 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !220, metadata !DIExpression()), !dbg !224

  //   %and46 = and i32 %conv32, %and45, !dbg !165
  creg_r25 = max(max(creg_r19,0),creg_r24);
  ASSUME(active[creg_r25] == 0);
  r25 = (r19==2) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !221, metadata !DIExpression()), !dbg !224

  //   %and47 = and i32 %conv26, %and46, !dbg !166
  creg_r26 = max(max(creg_r18,0),creg_r25);
  ASSUME(active[creg_r26] == 0);
  r26 = (r18==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !222, metadata !DIExpression()), !dbg !224

  //   %and48 = and i32 %conv20, %and47, !dbg !167
  creg_r27 = max(max(creg_r17,0),creg_r26);
  ASSUME(active[creg_r27] == 0);
  r27 = (r17==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !223, metadata !DIExpression()), !dbg !224

  //   %cmp49 = icmp eq i32 %and48, 1, !dbg !168

  //   br i1 %cmp49, label %if.then, label %if.end, !dbg !170
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171

  //   unreachable, !dbg !171
  r28 = 1;

T0BLOCK2:
  //   %12 = bitcast i64* %thr2 to i8*, !dbg !174

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !174

  //   %13 = bitcast i64* %thr1 to i8*, !dbg !174

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !174

  //   %14 = bitcast i64* %thr0 to i8*, !dbg !174
