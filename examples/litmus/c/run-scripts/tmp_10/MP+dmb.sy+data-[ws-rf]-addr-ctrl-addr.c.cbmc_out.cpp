...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !72, metadata !DIExpression()), !dbg !91
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !86
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !74, metadata !DIExpression()), !dbg !106

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,r6);
  cr(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l35_c16
  // Check
...
T2BLOCK4:
  ...
  //   %cmp25 = icmp eq i32 %conv5, 2, !dbg !108
  ...
  //   store i32 %conv26, i32* @atom_1_X4_2, align 4, !dbg !109, !tbaa !104
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !135, metadata !DIExpression()), !dbg !142
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !152, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !153, metadata !DIExpression()), !dbg !208

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !154, metadata !DIExpression()), !dbg !210

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !158, metadata !DIExpression()), !dbg !212

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !159, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !179, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !182, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !185, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !189, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !194, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !199, metadata !DIExpression()), !dbg !208
  ...
  creg_r25 = max(creg__r19__2_,creg_r24);
  r25 = (r19==2) & r24;
