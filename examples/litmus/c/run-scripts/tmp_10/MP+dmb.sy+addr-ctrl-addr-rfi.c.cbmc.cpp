...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !81), !dbg !97
  ...
  //   %add10 = add nsw i32 0, %xor9, !dbg !83
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !83

  //   %arrayidx12 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !83
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !71, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64 1, metadata !73, metadata !DIExpression()), !dbg !103

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !83
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !104
  ...
  //   store i32 %conv17, i32* @atom_1_X0_1, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv16, 1, !dbg !94
  ...
  //   store i32 %conv19, i32* @atom_1_X10_1, align 4, !dbg !95, !tbaa !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !146, metadata !DIExpression()), !dbg !179
