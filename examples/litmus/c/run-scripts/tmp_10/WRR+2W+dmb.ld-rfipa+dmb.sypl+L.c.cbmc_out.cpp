...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !49, metadata !DIExpression()), !dbg !71
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !52, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !54, metadata !DIExpression()), !dbg !74

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !50, metadata !DIExpression()), !dbg !71

  //   call void (...) @dmbld(), !dbg !64
  // dumbld: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !55, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64 1, metadata !57, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !80

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !68
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !61, metadata !DIExpression()), !dbg !80

  //   %conv4 = trunc i64 %1 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !58, metadata !DIExpression()), !dbg !71

  //   %cmp = icmp eq i32 %conv, 2, !dbg !70

  //   %conv5 = zext i1 %cmp to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !62, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !63, metadata !DIExpression()), !dbg !84

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !65, metadata !DIExpression()), !dbg !84

  //   store atomic i64 %2, i64* @atom_1_X0_2 seq_cst, align 8, !dbg !72
  // ST: Guess
  ...
  //   %cmp9 = icmp eq i32 %conv4, 1, !dbg !73

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !66, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !67, metadata !DIExpression()), !dbg !87

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !69, metadata !DIExpression()), !dbg !87

  //   store atomic i64 %3, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !75
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !92, metadata !DIExpression()), !dbg !100
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !93, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64 2, metadata !95, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !96, metadata !DIExpression()), !dbg !106
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !116, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !117, metadata !DIExpression()), !dbg !157

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !118, metadata !DIExpression()), !dbg !159

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !122, metadata !DIExpression()), !dbg !161

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !123, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !124, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64 0, metadata !126, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !130, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64 0, metadata !132, metadata !DIExpression()), !dbg !168

  //   store atomic i64 0, i64* @atom_1_X0_2 monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !133, metadata !DIExpression()), !dbg !170
  ...
  //   %call7 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !97
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call8 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !98
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call9 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !104
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !106
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call11 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !108
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !137, metadata !DIExpression()), !dbg !185

  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !139, metadata !DIExpression()), !dbg !185

  //   %conv = trunc i64 %6 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !136, metadata !DIExpression()), !dbg !157

  //   %cmp = icmp eq i32 %conv, 2, !dbg !112

  //   %conv12 = zext i1 %cmp to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !140, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !142, metadata !DIExpression()), !dbg !189

  //   %7 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !144, metadata !DIExpression()), !dbg !189

  //   %conv16 = trunc i64 %7 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !141, metadata !DIExpression()), !dbg !157

  //   %cmp17 = icmp eq i32 %conv16, 2, !dbg !116

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !145, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !147, metadata !DIExpression()), !dbg !193

  //   %8 = load atomic i64, i64* @atom_1_X0_2 seq_cst, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !149, metadata !DIExpression()), !dbg !193

  //   %conv22 = trunc i64 %8 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !146, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !151, metadata !DIExpression()), !dbg !196

  //   %9 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !153, metadata !DIExpression()), !dbg !196

  //   %conv26 = trunc i64 %9 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !150, metadata !DIExpression()), !dbg !157

  //   %and = and i32 %conv22, %conv26, !dbg !123
  ...
  //   %and27 = and i32 %conv18, %and, !dbg !124
  creg_r11 = max(max(creg_r7,0),creg_r10);
  ASSUME(active[creg_r11] == 0);
  r11 = (r7==2) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !155, metadata !DIExpression()), !dbg !157

  //   %and28 = and i32 %conv12, %and27, !dbg !125
  creg_r12 = max(max(creg_r6,0),creg_r11);
  ASSUME(active[creg_r12] == 0);
  r12 = (r6==2) & r11;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !156, metadata !DIExpression()), !dbg !157

  //   %cmp29 = icmp eq i32 %and28, 1, !dbg !126

  //   br i1 %cmp29, label %if.then, label %if.end, !dbg !128
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !129

  //   unreachable, !dbg !129
  r13 = 1;

T0BLOCK2:
  //   %10 = bitcast i64* %thr2 to i8*, !dbg !132

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !132

  //   %11 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !132

  //   %12 = bitcast i64* %thr0 to i8*, !dbg !132

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !132
