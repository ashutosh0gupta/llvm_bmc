...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !50, metadata !DIExpression()), !dbg !65
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !52, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !54, metadata !DIExpression()), !dbg !68

  //   %conv = trunc i64 %0 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !51, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !55, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !74

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !62
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !58, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !62, metadata !DIExpression()), !dbg !65

  //   store i32 %conv5, i32* @atom_1_X0_2, align 4, !dbg !65, !tbaa !66
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv4, 1, !dbg !70
  creg__r1__1_ = max(0,creg_r1);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !63, metadata !DIExpression()), !dbg !65

  //   store i32 %conv7, i32* @atom_1_X4_1, align 4, !dbg !71, !tbaa !66
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !89, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 2, metadata !91, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !92, metadata !DIExpression()), !dbg !102
  ...
  // ST: Guess
  //   : Release
  iw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l41_c3
  old_cw = cw(3,0);
  cw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l41_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !120, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !123, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !126, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i32 0, metadata !129, metadata !DIExpression()), !dbg !159

  //   store atomic i32 0, i32* @atom_1_X0_2 monotonic, align 4, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !130, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i32 0, metadata !132, metadata !DIExpression()), !dbg !161
  ...
  //   %call8 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !93
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call9 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !99
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !100, !tbaa !95
  r4 = local_mem[1];

  //   %call10 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !101
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !102, !tbaa !95
  r5 = local_mem[2];

  //   %call11 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !103
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !134, metadata !DIExpression()), !dbg !174

  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !136, metadata !DIExpression()), !dbg !174

  //   %conv = trunc i64 %6 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !133, metadata !DIExpression()), !dbg !148

  //   %cmp = icmp eq i32 %conv, 2, !dbg !107
  creg__r6__2_ = max(0,creg_r6);

  //   %conv12 = zext i1 %cmp to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !137, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !139, metadata !DIExpression()), !dbg !178

  //   %7 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !141, metadata !DIExpression()), !dbg !178

  //   %conv16 = trunc i64 %7 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !138, metadata !DIExpression()), !dbg !148

  //   %cmp17 = icmp eq i32 %conv16, 2, !dbg !111
  creg__r7__2_ = max(0,creg_r7);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !142, metadata !DIExpression()), !dbg !148

  //   %8 = load i32, i32* @atom_1_X0_2, align 4, !dbg !112, !tbaa !113
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !143, metadata !DIExpression()), !dbg !148

  //   %9 = load i32, i32* @atom_1_X4_1, align 4, !dbg !115, !tbaa !113
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !144, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !146, metadata !DIExpression()), !dbg !148

  //   %and20 = and i32 %conv12, %and19, !dbg !118
  creg_r12 = max(creg__r6__2_,creg_r11);
  r12 = (r6==2) & r11;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !147, metadata !DIExpression()), !dbg !148
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !122
