...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !50, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !53, metadata !DIExpression()), !dbg !80

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !81
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv, 3, !dbg !90
  ...
  //   store atomic i64 %3, i64* @atom_0_X2_3 seq_cst, align 8, !dbg !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !158, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !182, metadata !DIExpression()), !dbg !236
