...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !53, metadata !DIExpression()), !dbg !74

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   %cmp11 = icmp eq i32 %conv, 3, !dbg !87
  ...
  //   store i32 %conv12, i32* @atom_0_X2_3, align 4, !dbg !88, !tbaa !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_2, metadata !143, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_3, metadata !147, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_3, metadata !150, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !153, metadata !DIExpression()), !dbg !190
