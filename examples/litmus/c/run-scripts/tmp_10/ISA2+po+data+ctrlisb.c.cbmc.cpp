...
T3BLOCK4:
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !66
  // LD: Guess
  old_cr = cr(3,0);
  cr(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l43_c16
  // Check
  ...
  //   store i32 %conv5, i32* @atom_2_X0_1, align 4, !dbg !69, !tbaa !70
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv4, 0, !dbg !74
  creg__r4__0_ = max(0,creg_r4);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !98, metadata !DIExpression()), !dbg !101

  //   store i32 %conv7, i32* @atom_2_X2_0, align 4, !dbg !75, !tbaa !70
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !146, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !150, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !153, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !178

  //   store atomic i32 0, i32* @atom_2_X2_0 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_2_X2_0, align 4, !dbg !110, !tbaa !107
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
