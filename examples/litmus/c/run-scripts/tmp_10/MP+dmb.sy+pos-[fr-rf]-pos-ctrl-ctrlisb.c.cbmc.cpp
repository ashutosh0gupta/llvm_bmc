...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !107

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l34_c16
  // Check
  ASSUME(active[cr(2,0+1*1)] == 2);
  ASSUME(cr(2,0+1*1) >= iw(2,0+1*1));
  ASSUME(cr(2,0+1*1) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !107

  //   %conv12 = trunc i64 %3 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !95

  //   %tobool = icmp ne i32 %conv12, 0, !dbg !91
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !93), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !80, metadata !DIExpression()), !dbg !116

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !116

  //   %conv16 = trunc i64 %4 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !79, metadata !DIExpression()), !dbg !95

  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !100
  creg__r4__0_ = max(0,creg_r4);

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !102
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !126

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv23 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !83, metadata !DIExpression()), !dbg !95

  //   %cmp = icmp eq i32 %conv, 1, !dbg !110
  creg__r0__1_ = max(0,creg_r0);

  //   %conv24 = zext i1 %cmp to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !87, metadata !DIExpression()), !dbg !95

  //   store i32 %conv24, i32* @atom_1_X0_1, align 4, !dbg !111, !tbaa !112
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv4, 1, !dbg !116
  creg__r1__1_ = max(0,creg_r1);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !88, metadata !DIExpression()), !dbg !95

  //   store i32 %conv26, i32* @atom_1_X2_1, align 4, !dbg !117, !tbaa !112
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv8, 2, !dbg !118
  creg__r2__2_ = max(0,creg_r2);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !89, metadata !DIExpression()), !dbg !95

  //   store i32 %conv28, i32* @atom_1_X3_2, align 4, !dbg !119, !tbaa !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !90, metadata !DIExpression()), !dbg !95

  //   store i32 %conv30, i32* @atom_1_X4_2, align 4, !dbg !121, !tbaa !112
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv23, 0, !dbg !122
  creg__r5__0_ = max(0,creg_r5);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !91, metadata !DIExpression()), !dbg !95

  //   store i32 %conv32, i32* @atom_1_X7_0, align 4, !dbg !123, !tbaa !112
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !147, metadata !DIExpression()), !dbg !154
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !164, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !165, metadata !DIExpression()), !dbg !218

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !166, metadata !DIExpression()), !dbg !220

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !170, metadata !DIExpression()), !dbg !222

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !171, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !172, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !225

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !227

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !229

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !185, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !233

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !188, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !235

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !191, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i32 0, metadata !193, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !194, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !198, metadata !DIExpression()), !dbg !252

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !200, metadata !DIExpression()), !dbg !252

  //   %conv = trunc i64 %6 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !197, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !201, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !203, metadata !DIExpression()), !dbg !256

  //   %7 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !205, metadata !DIExpression()), !dbg !256

  //   %conv24 = trunc i64 %7 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !202, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !206, metadata !DIExpression()), !dbg !218

  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !144, !tbaa !145
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !207, metadata !DIExpression()), !dbg !218

  //   %9 = load i32, i32* @atom_1_X2_1, align 4, !dbg !147, !tbaa !145
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_1_X3_2, align 4, !dbg !148, !tbaa !145
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X4_2, align 4, !dbg !149, !tbaa !145
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %12 = load i32, i32* @atom_1_X7_0, align 4, !dbg !150, !tbaa !145
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %and = and i32 %11, %12, !dbg !151
  creg_r17 = max(creg_r15,creg_r16);
  r17 = r15 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !212, metadata !DIExpression()), !dbg !218

  //   %and27 = and i32 %10, %and, !dbg !152
  creg_r18 = max(creg_r14,creg_r17);
  r18 = r14 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !213, metadata !DIExpression()), !dbg !218

  //   %and28 = and i32 %9, %and27, !dbg !153
  creg_r19 = max(creg_r13,creg_r18);
  r19 = r13 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !214, metadata !DIExpression()), !dbg !218

  //   %and29 = and i32 %8, %and28, !dbg !154
  creg_r20 = max(creg_r12,creg_r19);
  r20 = r12 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !215, metadata !DIExpression()), !dbg !218

  //   %and30 = and i32 %conv26, %and29, !dbg !155
  creg_r21 = max(creg__r11__2_,creg_r20);
  r21 = (r11==2) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !216, metadata !DIExpression()), !dbg !218

  //   %and31 = and i32 %conv20, %and30, !dbg !156
  creg_r22 = max(creg__r10__1_,creg_r21);
  r22 = (r10==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !217, metadata !DIExpression()), !dbg !218

  //   %cmp32 = icmp eq i32 %and31, 1, !dbg !157
  creg__r22__1_ = max(0,creg_r22);

  //   br i1 %cmp32, label %if.then, label %if.end, !dbg !159
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
...
T0BLOCK2:
  //   %13 = bitcast i64* %thr2 to i8*, !dbg !163

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !163

  //   %14 = bitcast i64* %thr1 to i8*, !dbg !163

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %14) #7, !dbg !163

  //   %15 = bitcast i64* %thr0 to i8*, !dbg !163
