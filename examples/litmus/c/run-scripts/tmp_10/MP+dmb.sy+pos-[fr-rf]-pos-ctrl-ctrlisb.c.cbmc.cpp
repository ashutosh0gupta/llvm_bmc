...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !108), !dbg !130
  ...
  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !115

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !117
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   %cmp31 = icmp eq i32 %conv8, 2, !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !96, metadata !DIExpression()), !dbg !151

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %8, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !133
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv12, 2, !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !100, metadata !DIExpression()), !dbg !154

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %9, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !136
  // ST: Guess
  ...
  //   %cmp41 = icmp eq i32 %conv23, 0, !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !104, metadata !DIExpression()), !dbg !157
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64 2, metadata !165, metadata !DIExpression()), !dbg !170
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !203, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !231, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !235, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !239, metadata !DIExpression()), !dbg !304
