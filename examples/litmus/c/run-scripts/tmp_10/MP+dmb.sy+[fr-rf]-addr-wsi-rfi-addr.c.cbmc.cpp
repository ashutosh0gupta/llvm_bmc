...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !90, metadata !DIExpression()), !dbg !127

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !92, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %5, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !176, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !237

  //   store atomic i64 0, i64* @atom_1_X2_2 monotonic, align 8, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !205, metadata !DIExpression()), !dbg !271

  //   %10 = load atomic i64, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !160
  // LD: Guess
  old_cr = cr(0,4);
