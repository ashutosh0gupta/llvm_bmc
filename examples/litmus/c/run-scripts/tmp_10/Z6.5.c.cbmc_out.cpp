...
T3BLOCK1:
  ...
  // LD: Guess
  old_cr = cr(3,0);
  cr(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l34_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !78, metadata !DIExpression()), !dbg !86
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !103, metadata !DIExpression()), !dbg !137

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !104, metadata !DIExpression()), !dbg !137

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !105, metadata !DIExpression()), !dbg !139

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !109, metadata !DIExpression()), !dbg !141

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !110, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !120, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i32 0, metadata !123, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !125, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !124, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !128, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !129, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !133, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !136, metadata !DIExpression()), !dbg !137
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
