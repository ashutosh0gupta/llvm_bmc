...
T2BLOCK7:
  ...
  //   %cmp23 = icmp eq i32 %conv5, 1, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !90, metadata !DIExpression()), !dbg !142

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !92, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %5, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !124
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv11, 2, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !94, metadata !DIExpression()), !dbg !145

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !96, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %6, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !127
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !194, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !197, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !228, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !232, metadata !DIExpression()), !dbg !304
