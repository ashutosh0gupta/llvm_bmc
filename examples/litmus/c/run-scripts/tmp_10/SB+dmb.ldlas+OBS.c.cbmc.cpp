...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !35, metadata !DIExpression()), !dbg !50
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !53

  //   call void @llvm.dbg.value(metadata i64 1, metadata !39, metadata !DIExpression()), !dbg !53
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !40, metadata !DIExpression()), !dbg !50

  //   %cmp = icmp eq i32 %conv, 0, !dbg !59

  //   %conv1 = zext i1 %cmp to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !45, metadata !DIExpression()), !dbg !50

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !46, metadata !DIExpression()), !dbg !60

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !48, metadata !DIExpression()), !dbg !60

  //   store atomic i64 %1, i64* @atom_0_X2_0 seq_cst, align 8, !dbg !61
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !65, metadata !DIExpression()), !dbg !78
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !73, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !74, metadata !DIExpression()), !dbg !88

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !76, metadata !DIExpression()), !dbg !88
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !98, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !99, metadata !DIExpression()), !dbg !138

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !100, metadata !DIExpression()), !dbg !140

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !104, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !105, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i64 0, metadata !107, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !108, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i64 0, metadata !110, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !111, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64 0, metadata !113, metadata !DIExpression()), !dbg !147

  //   store atomic i64 0, i64* @atom_0_X2_0 monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !114, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !118, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !120, metadata !DIExpression()), !dbg !161

  //   %conv = trunc i64 %4 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !117, metadata !DIExpression()), !dbg !138

  //   %cmp = icmp eq i32 %conv, 1, !dbg !106

  //   %conv10 = zext i1 %cmp to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !121, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !123, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !125, metadata !DIExpression()), !dbg !165

  //   %conv14 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !122, metadata !DIExpression()), !dbg !138

  //   %cmp15 = icmp eq i32 %conv14, 1, !dbg !110

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !126, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !128, metadata !DIExpression()), !dbg !169

  //   %6 = load atomic i64, i64* @atom_0_X2_0 seq_cst, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !130, metadata !DIExpression()), !dbg !169

  //   %conv20 = trunc i64 %6 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !127, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !132, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !134, metadata !DIExpression()), !dbg !172

  //   %conv24 = trunc i64 %7 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !131, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !136, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !137, metadata !DIExpression()), !dbg !138
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !123
