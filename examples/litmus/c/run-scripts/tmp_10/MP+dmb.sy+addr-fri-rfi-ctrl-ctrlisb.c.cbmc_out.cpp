...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !169, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !218

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !172, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !220

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X3_0, align 4, !dbg !147, !tbaa !145
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %9 = load i32, i32* @atom_1_X6_1, align 4, !dbg !148, !tbaa !145
  // LD: Guess
  old_cr = cr(0,6);
