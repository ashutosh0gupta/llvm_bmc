...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !109

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !109

  //   %conv8 = trunc i64 %2 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !69, metadata !DIExpression()), !dbg !94

  //   %xor = xor i32 %conv8, %conv8, !dbg !93
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !73, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 3, %xor, !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !114

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,r5);
  cr(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l36_c16
  // Check
  ...
  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !97
  creg__r6__0_ = max(0,creg_r6);

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !99
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !93), !dbg !121

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !79, metadata !DIExpression()), !dbg !122

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,0+4*1);
  cr(2,0+4*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l39_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !122

  //   %conv19 = trunc i64 %4 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !94

  //   %xor20 = xor i32 %conv19, %conv19, !dbg !106
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor20, metadata !82, metadata !DIExpression()), !dbg !94

  //   %add22 = add nsw i32 0, %xor20, !dbg !107
  creg_r9 = max(0,creg_r8);
  r9 = 0 + r8;

  //   %idxprom23 = sext i32 %add22 to i64, !dbg !107

  //   %arrayidx24 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom23, !dbg !107
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx24, metadata !84, metadata !DIExpression()), !dbg !127

  //   %5 = load atomic i64, i64* %arrayidx24 monotonic, align 8, !dbg !107
  // LD: Guess
  old_cr = cr(2,r10);
  cr(2,r10) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l41_c17
  // Check
  ...
  //   %conv27 = trunc i64 %5 to i32, !dbg !109
  ...
  //   %conv28 = zext i1 %cmp to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !87, metadata !DIExpression()), !dbg !94

  //   store i32 %conv28, i32* @atom_1_X0_1, align 4, !dbg !111, !tbaa !112
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv4, 0, !dbg !116
  ...
  //   store i32 %conv30, i32* @atom_1_X2_0, align 4, !dbg !117, !tbaa !112
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv8, 1, !dbg !118
  creg__r2__1_ = max(0,creg_r2);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !89, metadata !DIExpression()), !dbg !94

  //   store i32 %conv32, i32* @atom_1_X4_1, align 4, !dbg !119, !tbaa !112
  // ST: Guess
  iw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l47_c15
  old_cw = cw(2,7);
  cw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l47_c15
  // Check
  ...
  //   %cmp33 = icmp eq i32 %conv27, 0, !dbg !120
  creg__r11__0_ = max(0,creg_r11);

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !90, metadata !DIExpression()), !dbg !94

  //   store i32 %conv34, i32* @atom_1_X11_0, align 4, !dbg !121, !tbaa !112
  // ST: Guess
  iw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l49_c16
  old_cw = cw(2,8);
  cw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l49_c16
  // Check
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !145, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64 1, metadata !147, metadata !DIExpression()), !dbg !152

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !50
  // ST: Guess
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l55_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l55_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !162, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !163, metadata !DIExpression()), !dbg !223

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !164, metadata !DIExpression()), !dbg !225

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !168, metadata !DIExpression()), !dbg !227

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !169, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !170, metadata !DIExpression()), !dbg !230
  ...
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l64_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l64_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !173, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !176, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !179, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !185, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i32 0, metadata !188, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !189, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i32 0, metadata !191, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !192, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i32 0, metadata !194, metadata !DIExpression()), !dbg !244

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !127
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l71_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l71_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !195, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i32 0, metadata !197, metadata !DIExpression()), !dbg !246

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !129
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l72_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l72_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !199, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !201, metadata !DIExpression()), !dbg !259

  //   %conv = trunc i64 %6 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !198, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !202, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !204, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !206, metadata !DIExpression()), !dbg !263

  //   %conv26 = trunc i64 %7 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !203, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !207, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !209, metadata !DIExpression()), !dbg !267

  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l86_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !211, metadata !DIExpression()), !dbg !267

  //   %conv32 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !208, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !212, metadata !DIExpression()), !dbg !223

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !155, !tbaa !156
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l88_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !213, metadata !DIExpression()), !dbg !223

  //   %10 = load i32, i32* @atom_1_X2_0, align 4, !dbg !158, !tbaa !156
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l89_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !214, metadata !DIExpression()), !dbg !223

  //   %11 = load i32, i32* @atom_1_X4_1, align 4, !dbg !159, !tbaa !156
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l90_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !215, metadata !DIExpression()), !dbg !223

  //   %12 = load i32, i32* @atom_1_X11_0, align 4, !dbg !160, !tbaa !156
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l91_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !216, metadata !DIExpression()), !dbg !223

  //   %and = and i32 %11, %12, !dbg !161
  creg_r23 = max(creg_r21,creg_r22);
  r23 = r21 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !217, metadata !DIExpression()), !dbg !223

  //   %and35 = and i32 %10, %and, !dbg !162
  creg_r24 = max(creg_r20,creg_r23);
  r24 = r20 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !218, metadata !DIExpression()), !dbg !223

  //   %and36 = and i32 %9, %and35, !dbg !163
  creg_r25 = max(creg_r19,creg_r24);
  r25 = r19 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !219, metadata !DIExpression()), !dbg !223

  //   %and37 = and i32 %conv34, %and36, !dbg !164
  creg_r26 = max(creg__r18__1_,creg_r25);
  r26 = (r18==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !220, metadata !DIExpression()), !dbg !223

  //   %and38 = and i32 %conv28, %and37, !dbg !165
  creg_r27 = max(creg__r17__1_,creg_r26);
  r27 = (r17==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !221, metadata !DIExpression()), !dbg !223

  //   %and39 = and i32 %conv22, %and38, !dbg !166
  creg_r28 = max(creg__r16__1_,creg_r27);
  r28 = (r16==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !222, metadata !DIExpression()), !dbg !223
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !170
