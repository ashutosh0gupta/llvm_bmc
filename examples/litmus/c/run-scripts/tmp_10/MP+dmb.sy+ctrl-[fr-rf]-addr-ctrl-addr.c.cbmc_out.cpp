...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !118

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !68, metadata !DIExpression()), !dbg !118

  //   %conv4 = trunc i64 %1 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !121

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !106
  r5 = 0+r4*1;
  ASSUME(creg_r5 >= 0);
  ...
  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !126

  //   %conv12 = trunc i64 %3 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !106

  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !109

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !111
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !105), !dbg !133

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !79, metadata !DIExpression()), !dbg !134

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   %add22 = add nsw i32 0, %xor20, !dbg !119
  creg_r9 = max(0,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = 0 + r8;

  //   %idxprom23 = sext i32 %add22 to i64, !dbg !119

  //   %arrayidx24 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom23, !dbg !119
  r10 = 0+r9*1;
  ASSUME(creg_r10 >= 0);
  ASSUME(creg_r10 >= creg_r9);
  ASSUME(active[creg_r10] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx24, metadata !84, metadata !DIExpression()), !dbg !139

  //   %5 = load atomic i64, i64* %arrayidx24 monotonic, align 8, !dbg !119
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   %conv27 = trunc i64 %5 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !83, metadata !DIExpression()), !dbg !106

  //   %cmp = icmp eq i32 %conv, 1, !dbg !122

  //   %conv28 = zext i1 %cmp to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !87, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !142

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !124
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv4, 0, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !92, metadata !DIExpression()), !dbg !145

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %7, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv8, 1, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !96, metadata !DIExpression()), !dbg !148

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %8, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   %cmp40 = icmp eq i32 %conv27, 0, !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !100, metadata !DIExpression()), !dbg !151

  //   %9 = zext i32 %conv41 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %9, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !133
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !157, metadata !DIExpression()), !dbg !164
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !174, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !175, metadata !DIExpression()), !dbg !246

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !117

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !117

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !176, metadata !DIExpression()), !dbg !248

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !180, metadata !DIExpression()), !dbg !250

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !181, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !182, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !185, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !197, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !200, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !203, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !206, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !210, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !212, metadata !DIExpression()), !dbg !284

  //   %conv = trunc i64 %6 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !209, metadata !DIExpression()), !dbg !246

  //   %cmp = icmp eq i32 %conv, 1, !dbg !157

  //   %conv22 = zext i1 %cmp to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !213, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !215, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !217, metadata !DIExpression()), !dbg !288

  //   %conv26 = trunc i64 %7 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !214, metadata !DIExpression()), !dbg !246

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !161

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !218, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !220, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !222, metadata !DIExpression()), !dbg !292

  //   %conv32 = trunc i64 %8 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !219, metadata !DIExpression()), !dbg !246

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !165

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !223, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !225, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !227, metadata !DIExpression()), !dbg !296

  //   %conv38 = trunc i64 %9 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !224, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !229, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !231, metadata !DIExpression()), !dbg !299

  //   %conv42 = trunc i64 %10 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !228, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !233, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !235, metadata !DIExpression()), !dbg !302

  //   %conv46 = trunc i64 %11 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !232, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !237, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !239, metadata !DIExpression()), !dbg !305

  //   %conv50 = trunc i64 %12 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !236, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !240, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !241, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !242, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !243, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !244, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !245, metadata !DIExpression()), !dbg !246
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187
