...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !57

  //   call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !57

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !58
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !46, metadata !DIExpression()), !dbg !59

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !60
  // LD: Guess
  //   : Acquire
  old_cr = cr(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !48, metadata !DIExpression()), !dbg !59

  //   %conv = trunc i64 %0 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !45, metadata !DIExpression()), !dbg !54

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64 1, metadata !51, metadata !DIExpression()), !dbg !62

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   store i32 %conv3, i32* @atom_0_X2_1, align 4, !dbg !65, !tbaa !66
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !73, metadata !DIExpression()), !dbg !84
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !77, metadata !DIExpression()), !dbg !87

  //   %conv = trunc i64 %0 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !74, metadata !DIExpression()), !dbg !84

  //   %xor = xor i32 %conv, %conv, !dbg !58
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !78, metadata !DIExpression()), !dbg !84

  //   %add = add nsw i32 2, %xor, !dbg !59
  creg_r3 = max(0,creg_r2);
  r3 = 2 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !59

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !59
  r4 = 0+r3*1;
  creg_r4 = creg_r3;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !92
  ...
  // ST: Guess
  iw(2,4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l36_c15
  old_cw = cw(2,4);
  cw(2,4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l36_c15
  // Check
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !100, metadata !DIExpression()), !dbg !114

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !58
  // LD: Guess
  old_cr = cr(3,0+2*1);
  cr(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l42_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !103, metadata !DIExpression()), !dbg !111
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !61
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !105, metadata !DIExpression()), !dbg !119

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(3,r8);
  cr(3,r8) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l44_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !104, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !108, metadata !DIExpression()), !dbg !111

  //   store i32 %conv5, i32* @atom_2_X0_1, align 4, !dbg !65, !tbaa !66
  // ST: Guess
  iw(3,5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l46_c15
  old_cw = cw(3,5);
  cw(3,5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l46_c15
  // Check
  ASSUME(active[iw(3,5)] == 3);
  ASSUME(active[cw(3,5)] == 3);
  ASSUME(sforbid(5,cw(3,5))== 0);
  ASSUME(iw(3,5) >= creg__r5__1_);
  ASSUME(iw(3,5) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !109, metadata !DIExpression()), !dbg !111

  //   store i32 %conv7, i32* @atom_2_X3_0, align 4, !dbg !71, !tbaa !66
  // ST: Guess
  iw(3,6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l48_c15
  old_cw = cw(3,6);
  cw(3,6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l48_c15
  // Check
  ASSUME(active[iw(3,6)] == 3);
  ASSUME(active[cw(3,6)] == 3);
  ASSUME(sforbid(6,cw(3,6))== 0);
  ASSUME(iw(3,6) >= creg__r9__0_);
  ASSUME(iw(3,6) >= 0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !133, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !134, metadata !DIExpression()), !dbg !170

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !135, metadata !DIExpression()), !dbg !172

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !139, metadata !DIExpression()), !dbg !174

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !140, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !141, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64 0, metadata !146, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !147, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !149, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !150, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i32 0, metadata !153, metadata !DIExpression()), !dbg !183

  //   store atomic i32 0, i32* @atom_0_X2_1 monotonic, align 4, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !154, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !185

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !157, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !187

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X3_0, metadata !160, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !189

  //   store atomic i32 0, i32* @atom_2_X3_0 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !103
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !104
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !105, !tbaa !106
  r11 = local_mem[0];

  //   %call15 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !110
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !111, !tbaa !106
  r12 = local_mem[1];

  //   %call16 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !112
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !113, !tbaa !106
  r13 = local_mem[2];

  //   %call17 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !114
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i32, i32* @atom_0_X2_1, align 4, !dbg !115, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !163, metadata !DIExpression()), !dbg !170

  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !164, metadata !DIExpression()), !dbg !170

  //   %8 = load i32, i32* @atom_2_X0_1, align 4, !dbg !119, !tbaa !116
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !165, metadata !DIExpression()), !dbg !170

  //   %9 = load i32, i32* @atom_2_X3_0, align 4, !dbg !120, !tbaa !116
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !166, metadata !DIExpression()), !dbg !170

  //   %and = and i32 %8, %9, !dbg !121
  creg_r18 = max(creg_r16,creg_r17);
  r18 = r16 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !167, metadata !DIExpression()), !dbg !170

  //   %and18 = and i32 %7, %and, !dbg !122
  creg_r19 = max(creg_r15,creg_r18);
  r19 = r15 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !168, metadata !DIExpression()), !dbg !170

  //   %and19 = and i32 %6, %and18, !dbg !123
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !169, metadata !DIExpression()), !dbg !170

  //   %cmp = icmp eq i32 %and19, 1, !dbg !124
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !127
...
T0BLOCK2:
  //   %10 = bitcast i64* %thr2 to i8*, !dbg !130

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !130

  //   %11 = bitcast i64* %thr1 to i8*, !dbg !130

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !130

  //   %12 = bitcast i64* %thr0 to i8*, !dbg !130
