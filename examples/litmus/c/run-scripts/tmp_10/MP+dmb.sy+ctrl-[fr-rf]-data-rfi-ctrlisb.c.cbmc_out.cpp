...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !109), !dbg !122
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !110
  ...
  //   %conv9 = sext i32 %add to i64, !dbg !113

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !79, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !81, metadata !DIExpression()), !dbg !133

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   %tobool14 = icmp ne i32 %conv13, 0, !dbg !117

  //   br i1 %tobool14, label %if.then15, label %if.else16, !dbg !119
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !110), !dbg !141

  //   call void (...) @isb(), !dbg !123
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !143

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !125
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !87, metadata !DIExpression()), !dbg !143

  //   %conv20 = trunc i64 %4 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !84, metadata !DIExpression()), !dbg !111

  //   %cmp = icmp eq i32 %conv, 1, !dbg !127

  //   %conv21 = zext i1 %cmp to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !88, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !89, metadata !DIExpression()), !dbg !147

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv4, 0, !dbg !130

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !92, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !93, metadata !DIExpression()), !dbg !150

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !132
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv8, 1, !dbg !133

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !96, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !97, metadata !DIExpression()), !dbg !153

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !135
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv13, 1, !dbg !136

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !100, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !101, metadata !DIExpression()), !dbg !156

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !103, metadata !DIExpression()), !dbg !156

  //   store atomic i64 %8, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !138
  // ST: Guess
  ...
  //   %cmp40 = icmp eq i32 %conv20, 0, !dbg !139

  //   %conv41 = zext i1 %cmp40 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv41, metadata !104, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !105, metadata !DIExpression()), !dbg !159

  //   %9 = zext i32 %conv41 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !107, metadata !DIExpression()), !dbg !159

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !141
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !165, metadata !DIExpression()), !dbg !172
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !182, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !183, metadata !DIExpression()), !dbg !265

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !184, metadata !DIExpression()), !dbg !267

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !188, metadata !DIExpression()), !dbg !269

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !189, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !190, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !193, metadata !DIExpression()), !dbg !274

  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !196, metadata !DIExpression()), !dbg !276

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !199, metadata !DIExpression()), !dbg !278

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !202, metadata !DIExpression()), !dbg !280

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !205, metadata !DIExpression()), !dbg !282

  //   call void @llvm.dbg.value(metadata i64 0, metadata !207, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !208, metadata !DIExpression()), !dbg !284

  //   call void @llvm.dbg.value(metadata i64 0, metadata !210, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !211, metadata !DIExpression()), !dbg !286

  //   call void @llvm.dbg.value(metadata i64 0, metadata !213, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !214, metadata !DIExpression()), !dbg !288

  //   call void @llvm.dbg.value(metadata i64 0, metadata !216, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !218, metadata !DIExpression()), !dbg !303
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !220, metadata !DIExpression()), !dbg !303

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !217, metadata !DIExpression()), !dbg !265

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !221, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !223, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !225, metadata !DIExpression()), !dbg !307

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !222, metadata !DIExpression()), !dbg !265

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !226, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !228, metadata !DIExpression()), !dbg !311
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !230, metadata !DIExpression()), !dbg !311

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !227, metadata !DIExpression()), !dbg !265

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !231, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !233, metadata !DIExpression()), !dbg !315
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !235, metadata !DIExpression()), !dbg !315

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !232, metadata !DIExpression()), !dbg !265

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !236, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !238, metadata !DIExpression()), !dbg !319
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !240, metadata !DIExpression()), !dbg !319

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !237, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !242, metadata !DIExpression()), !dbg !322
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !244, metadata !DIExpression()), !dbg !322

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !241, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !246, metadata !DIExpression()), !dbg !325
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !248, metadata !DIExpression()), !dbg !325

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !245, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !250, metadata !DIExpression()), !dbg !328
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !252, metadata !DIExpression()), !dbg !328

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !249, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !254, metadata !DIExpression()), !dbg !331
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !256, metadata !DIExpression()), !dbg !331

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !253, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !258, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !259, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !260, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !261, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !262, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !263, metadata !DIExpression()), !dbg !265

  //   %and67 = and i32 %conv22, %and66, !dbg !205
  creg_r27 = max(max(creg_r11,0),creg_r26);
  ASSUME(active[creg_r27] == 0);
  r27 = (r11==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !264, metadata !DIExpression()), !dbg !265
