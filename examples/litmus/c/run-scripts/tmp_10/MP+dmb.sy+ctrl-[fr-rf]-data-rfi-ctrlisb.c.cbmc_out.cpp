...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !186, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !190, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !193, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !196, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !199, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i32 0, metadata !201, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !203, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !205, metadata !DIExpression()), !dbg !271

  //   %conv = trunc i64 %6 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !202, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !206, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !208, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !210, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !211, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !213, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !215, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !216, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !218, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !220, metadata !DIExpression()), !dbg !283

  //   %conv38 = trunc i64 %9 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !217, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !222, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !223, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !227, metadata !DIExpression()), !dbg !235

  //   %and41 = and i32 %12, %and, !dbg !177
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !228, metadata !DIExpression()), !dbg !235

  //   %and42 = and i32 %11, %and41, !dbg !178
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !229, metadata !DIExpression()), !dbg !235

  //   %and43 = and i32 %10, %and42, !dbg !179
  creg_r23 = max(creg_r15,creg_r22);
  r23 = r15 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !230, metadata !DIExpression()), !dbg !235

  //   %and44 = and i32 %conv40, %and43, !dbg !180
  creg_r24 = max(creg__r14__1_,creg_r23);
  r24 = (r14==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !231, metadata !DIExpression()), !dbg !235

  //   %and45 = and i32 %conv34, %and44, !dbg !181
  creg_r25 = max(creg__r13__1_,creg_r24);
  r25 = (r13==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !232, metadata !DIExpression()), !dbg !235

  //   %and46 = and i32 %conv28, %and45, !dbg !182
  creg_r26 = max(creg__r12__1_,creg_r25);
  r26 = (r12==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !233, metadata !DIExpression()), !dbg !235

  //   %and47 = and i32 %conv22, %and46, !dbg !183
  creg_r27 = max(creg__r11__1_,creg_r26);
  r27 = (r11==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !234, metadata !DIExpression()), !dbg !235
