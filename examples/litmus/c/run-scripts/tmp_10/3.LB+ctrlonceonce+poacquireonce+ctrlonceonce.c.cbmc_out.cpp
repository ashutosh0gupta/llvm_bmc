...
T1BLOCK1:
  //   call void @llvm.dbg.label(metadata !49), !dbg !53

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !40, metadata !DIExpression()), !dbg !54
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !44, metadata !DIExpression()), !dbg !51
  ...
  ASSUME(cctrl[1] >= creg___r0__0___0_);
  if(((r0==0)!=0)) {
    goto T1BLOCK2;
  } else {
    goto T1BLOCK3;
...
T1BLOCK2:
  //   br label %lbl_label116, !dbg !61
  goto T1BLOCK4;

T1BLOCK3:
  //   br label %lbl_label116, !dbg !62
  goto T1BLOCK4;

T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !50), !dbg !63

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !45, metadata !DIExpression()), !dbg !64

  //   call void @llvm.dbg.value(metadata i64 1, metadata !47, metadata !DIExpression()), !dbg !64
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !48, metadata !DIExpression()), !dbg !51

  //   store i32 %conv3, i32* @atom_0_X0_1, align 4, !dbg !67, !tbaa !68
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !75, metadata !DIExpression()), !dbg !85
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !79, metadata !DIExpression()), !dbg !88

  //   %conv = trunc i64 %0 to i32, !dbg !54

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !76, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !80, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64 1, metadata !82, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !83, metadata !DIExpression()), !dbg !85
...
T3BLOCK1:
  ...
  ASSUME(cctrl[3] >= creg___r2__0___0_);
  if(((r2==0)!=0)) {
    goto T3BLOCK2;
  } else {
    goto T3BLOCK3;
...
T3BLOCK2:
  //   br label %lbl_label117, !dbg !61
  goto T3BLOCK4;

T3BLOCK3:
  //   br label %lbl_label117, !dbg !62
  goto T3BLOCK4;

T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !109), !dbg !122

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !104, metadata !DIExpression()), !dbg !123
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !143, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !149, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 0, metadata !151, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !152, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !159, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !164, metadata !DIExpression()), !dbg !167
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([129 x i8], [129 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
