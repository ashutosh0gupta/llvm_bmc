...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !99), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !67, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !69, metadata !DIExpression()), !dbg !109

  //   %conv4 = trunc i64 %1 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !101
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !100), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !118

  //   %conv8 = trunc i64 %2 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !121

  //   %conv12 = trunc i64 %3 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !101

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !105
  creg_r7 = max(creg_r6,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !78, metadata !DIExpression()), !dbg !101

  //   %add15 = add nsw i32 0, %xor13, !dbg !106
  ...
  //   %arrayidx17 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !106
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !80, metadata !DIExpression()), !dbg !126

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !79, metadata !DIExpression()), !dbg !101

  //   %cmp = icmp eq i32 %conv, 1, !dbg !109

  //   %conv21 = zext i1 %cmp to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !83, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !84, metadata !DIExpression()), !dbg !129

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !87, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !88, metadata !DIExpression()), !dbg !132

  //   %6 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %6, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !91, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !92, metadata !DIExpression()), !dbg !135

  //   %7 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %7, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !117
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv20, 0, !dbg !118

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !95, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !96, metadata !DIExpression()), !dbg !138

  //   %8 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %8, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !120
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !181, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !184, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !187, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !190, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !194, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !196, metadata !DIExpression()), !dbg !266

  //   %conv = trunc i64 %6 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !193, metadata !DIExpression()), !dbg !230

  //   %cmp = icmp eq i32 %conv, 1, !dbg !152

  //   %conv20 = zext i1 %cmp to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !197, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !199, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !201, metadata !DIExpression()), !dbg !270

  //   %conv24 = trunc i64 %7 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !198, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !204, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !206, metadata !DIExpression()), !dbg !274

  //   %conv30 = trunc i64 %8 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !203, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !211, metadata !DIExpression()), !dbg !278

  //   %conv36 = trunc i64 %9 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !208, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !213, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !215, metadata !DIExpression()), !dbg !281

  //   %conv40 = trunc i64 %10 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !212, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !217, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !219, metadata !DIExpression()), !dbg !284

  //   %conv44 = trunc i64 %11 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !216, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !221, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !223, metadata !DIExpression()), !dbg !287

  //   %conv48 = trunc i64 %12 to i32, !dbg !172

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !220, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !225, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and50, metadata !226, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !227, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !228, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !229, metadata !DIExpression()), !dbg !230
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 95, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
