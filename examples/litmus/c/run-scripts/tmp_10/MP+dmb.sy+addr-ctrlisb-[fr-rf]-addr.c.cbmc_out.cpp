...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !88), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !78, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !80, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !114
  ...
  //   %cmp22 = icmp eq i32 %conv8, 0, !dbg !103
  ...
  //   store i32 %conv23, i32* @atom_1_X5_0, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv12, 1, !dbg !105
  ...
  //   store i32 %conv25, i32* @atom_1_X7_1, align 4, !dbg !106, !tbaa !99
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !132, metadata !DIExpression()), !dbg !139
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !173, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !176, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !183, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !188, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !193, metadata !DIExpression()), !dbg !249
