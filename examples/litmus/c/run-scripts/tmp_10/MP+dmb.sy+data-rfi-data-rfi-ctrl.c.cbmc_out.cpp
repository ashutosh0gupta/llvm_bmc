...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !142, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !143, metadata !DIExpression()), !dbg !205

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !144, metadata !DIExpression()), !dbg !207

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !148, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !149, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !151, metadata !DIExpression()), !dbg !210

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !152, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !212

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !155, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !214

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !158, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !216

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !161, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i32 0, metadata !164, metadata !DIExpression()), !dbg !218

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !165, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i32 0, metadata !167, metadata !DIExpression()), !dbg !220

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !168, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i32 0, metadata !170, metadata !DIExpression()), !dbg !222

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !171, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i32 0, metadata !173, metadata !DIExpression()), !dbg !224

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !129
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !135
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !175, metadata !DIExpression()), !dbg !234

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !139
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l72_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !177, metadata !DIExpression()), !dbg !234

  //   %conv = trunc i64 %4 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !174, metadata !DIExpression()), !dbg !205

  //   %cmp = icmp eq i32 %conv, 1, !dbg !141
  creg__r11__1_ = max(0,creg_r11);

  //   %conv18 = zext i1 %cmp to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !178, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !238

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !143
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !182, metadata !DIExpression()), !dbg !238

  //   %conv22 = trunc i64 %5 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !179, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !183, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !242

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !187, metadata !DIExpression()), !dbg !242

  //   %conv28 = trunc i64 %6 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !184, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !188, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !190, metadata !DIExpression()), !dbg !246

  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !192, metadata !DIExpression()), !dbg !246

  //   %conv34 = trunc i64 %7 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !189, metadata !DIExpression()), !dbg !205

  //   %cmp35 = icmp eq i32 %conv34, 1, !dbg !153
  creg__r14__1_ = max(0,creg_r14);

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !193, metadata !DIExpression()), !dbg !205

  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !154, !tbaa !155
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l80_c13
  // Check
  ...
  //   %9 = load i32, i32* @atom_1_X4_1, align 4, !dbg !157, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X7_1, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %11 = load i32, i32* @atom_1_X8_0, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %and = and i32 %10, %11, !dbg !160
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !198, metadata !DIExpression()), !dbg !205

  //   %and37 = and i32 %9, %and, !dbg !161
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !199, metadata !DIExpression()), !dbg !205

  //   %and38 = and i32 %8, %and37, !dbg !162
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !200, metadata !DIExpression()), !dbg !205

  //   %and39 = and i32 %conv36, %and38, !dbg !163
  creg_r22 = max(creg__r14__1_,creg_r21);
  r22 = (r14==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !201, metadata !DIExpression()), !dbg !205

  //   %and40 = and i32 %conv30, %and39, !dbg !164
  creg_r23 = max(creg__r13__1_,creg_r22);
  r23 = (r13==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !202, metadata !DIExpression()), !dbg !205

  //   %and41 = and i32 %conv24, %and40, !dbg !165
  creg_r24 = max(creg__r12__1_,creg_r23);
  r24 = (r12==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !203, metadata !DIExpression()), !dbg !205

  //   %and42 = and i32 %conv18, %and41, !dbg !166
  creg_r25 = max(creg__r11__1_,creg_r24);
  r25 = (r11==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !204, metadata !DIExpression()), !dbg !205

  //   %cmp43 = icmp eq i32 %and42, 1, !dbg !167
  creg__r25__1_ = max(0,creg_r25);

  //   br i1 %cmp43, label %if.then, label %if.end, !dbg !169
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !170
