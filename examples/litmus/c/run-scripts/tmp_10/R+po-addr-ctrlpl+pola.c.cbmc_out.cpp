...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !35, metadata !DIExpression()), !dbg !63
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !66

  //   call void @llvm.dbg.value(metadata i64 1, metadata !39, metadata !DIExpression()), !dbg !66

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !44, metadata !DIExpression()), !dbg !68

  //   %conv = trunc i64 %0 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !40, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !45, metadata !DIExpression()), !dbg !63
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !72
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ASSUME(creg_r3 >= creg_r2);
  ASSUME(active[creg_r3] == 1);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !47, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !49, metadata !DIExpression()), !dbg !73

  //   %conv4 = trunc i64 %1 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !46, metadata !DIExpression()), !dbg !63
...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !50, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64 1, metadata !52, metadata !DIExpression()), !dbg !81

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !82
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !54, metadata !DIExpression()), !dbg !83

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(1,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !56, metadata !DIExpression()), !dbg !83

  //   %conv10 = trunc i64 %2 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !53, metadata !DIExpression()), !dbg !63

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !86

  //   %conv11 = zext i1 %cmp to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !57, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X9_2, metadata !58, metadata !DIExpression()), !dbg !87

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !60, metadata !DIExpression()), !dbg !87

  //   store atomic i64 %3, i64* @atom_0_X9_2 seq_cst, align 8, !dbg !88
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !97, metadata !DIExpression()), !dbg !110
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !124, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !125, metadata !DIExpression()), !dbg !170

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !126, metadata !DIExpression()), !dbg !172

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !130, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !131, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 0, metadata !133, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !134, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64 0, metadata !136, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64 0, metadata !139, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X9_2, metadata !143, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !146, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !150, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !152, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !153, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !155, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !157, metadata !DIExpression()), !dbg !201

  //   %conv18 = trunc i64 %5 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !154, metadata !DIExpression()), !dbg !170

  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !120

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !158, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X9_2, metadata !160, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !159, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !164, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !163, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !168, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !169, metadata !DIExpression()), !dbg !170
