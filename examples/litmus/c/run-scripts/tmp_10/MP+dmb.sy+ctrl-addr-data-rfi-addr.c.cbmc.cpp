...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !99), !dbg !111
  ...
  //   %cmp28 = icmp eq i32 %conv15, 1, !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !91, metadata !DIExpression()), !dbg !134

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %6, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !116
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !172, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !227

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !179, metadata !DIExpression()), !dbg !241

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !184, metadata !DIExpression()), !dbg !245

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !189, metadata !DIExpression()), !dbg !249

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !198, metadata !DIExpression()), !dbg !256

  //   %8 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,6);
