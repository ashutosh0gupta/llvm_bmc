...
T2BLOCK4:
  ...
  //   %cmp16 = icmp eq i32 %conv6, 2, !dbg !104
  ...
  //   store i32 %conv17, i32* @atom_1_X6_2, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv10, 2, !dbg !106
  ...
  //   store i32 %conv19, i32* @atom_1_X7_2, align 4, !dbg !107, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !157, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !204

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_2, metadata !160, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !206

  //   store atomic i32 0, i32* @atom_1_X7_2 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X6_2, align 4, !dbg !142, !tbaa !140
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X7_2, align 4, !dbg !143, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
