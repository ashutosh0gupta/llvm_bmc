...
T2BLOCK4:
  ...
  //   %add = add nsw i32 3, %xor, !dbg !90
  creg_r3 = max(0,creg_r2);
  r3 = 3 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !90

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !90
  r4 = 0+r3*1;
  creg_r4 = creg_r3;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !110
  ...
  //   %cmp21 = icmp eq i32 %conv8, 0, !dbg !109
  ...
  //   store i32 %conv22, i32* @atom_1_X5_0, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv12, 1, !dbg !111
  ...
  //   store i32 %conv24, i32* @atom_1_X7_1, align 4, !dbg !112, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !179, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !182, metadata !DIExpression()), !dbg !232
