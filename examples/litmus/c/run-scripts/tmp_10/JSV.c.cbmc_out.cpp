...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !135, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !142, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i32 0, metadata !144, metadata !DIExpression()), !dbg !183

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_1_X2_1, align 4, !dbg !122, !tbaa !123
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !150, metadata !DIExpression()), !dbg !168

  //   %6 = load i32, i32* @atom_1_X4_1, align 4, !dbg !125, !tbaa !123
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !151, metadata !DIExpression()), !dbg !168

  //   %7 = load i32, i32* @atom_1_X6_2, align 4, !dbg !126, !tbaa !123
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !152, metadata !DIExpression()), !dbg !168
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !156, metadata !DIExpression()), !dbg !200

  //   %conv18 = trunc i64 %8 to i32, !dbg !129
  ...
  //   %9 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !161, metadata !DIExpression()), !dbg !204

  //   %conv24 = trunc i64 %9 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !158, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !162, metadata !DIExpression()), !dbg !168

  //   %or = or i32 %conv20, %conv26, !dbg !135
  creg_r12 = max(creg__r10__1_,creg__r11__2_);
  r12 = (r10==1) | (r11==2);

  //   call void @llvm.dbg.value(metadata i32 %or, metadata !163, metadata !DIExpression()), !dbg !168

  //   %and = and i32 %7, %or, !dbg !136
  creg_r13 = max(creg_r12,creg_r9);
  r13 = r9 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !164, metadata !DIExpression()), !dbg !168

  //   %and27 = and i32 %6, %and, !dbg !137
  creg_r14 = max(creg_r13,creg_r8);
  r14 = r8 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !165, metadata !DIExpression()), !dbg !168

  //   %and28 = and i32 %5, %and27, !dbg !138
  creg_r15 = max(creg_r14,creg_r7);
  r15 = r7 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !166, metadata !DIExpression()), !dbg !168

  //   %and29 = and i32 %conv14, %and28, !dbg !139
  creg_r16 = max(creg__r6__2_,creg_r15);
  r16 = (r6==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !167, metadata !DIExpression()), !dbg !168

  //   %cmp30 = icmp eq i32 %and29, 1, !dbg !140
  creg__r16__1_ = max(0,creg_r16);

  //   br i1 %cmp30, label %if.then, label %if.end, !dbg !142
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([88 x i8], [88 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
