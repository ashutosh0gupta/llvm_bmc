...
T2BLOCK4:
  ...
  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !94

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !96
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !97), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !67, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 1, metadata !69, metadata !DIExpression()), !dbg !119
  ...
  //   %xor = xor i32 %conv11, %conv11, !dbg !105
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !75, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !126

  //   %conv14 = sext i32 %add to i64, !dbg !108

  //   call void @llvm.dbg.value(metadata i64 %conv14, metadata !78, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %conv14, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv18, 1, !dbg !118

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !91, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !92, metadata !DIExpression()), !dbg !138
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !170, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !173, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !196, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !200, metadata !DIExpression()), !dbg !255
