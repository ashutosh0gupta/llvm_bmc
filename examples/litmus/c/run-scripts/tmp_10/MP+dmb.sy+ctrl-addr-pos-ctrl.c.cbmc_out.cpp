...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !77, metadata !DIExpression()), !dbg !111

  //   %conv19 = trunc i64 %4 to i32, !dbg !94
  ...
  //   %conv20 = zext i1 %cmp to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !78, metadata !DIExpression()), !dbg !83

  //   store i32 %conv20, i32* @atom_1_X0_1, align 4, !dbg !96, !tbaa !97
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv19, 0, !dbg !101
  creg__r7__0_ = max(0,creg_r7);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !79, metadata !DIExpression()), !dbg !83

  //   store i32 %conv22, i32* @atom_1_X8_0, align 4, !dbg !102, !tbaa !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !153, metadata !DIExpression()), !dbg !186
