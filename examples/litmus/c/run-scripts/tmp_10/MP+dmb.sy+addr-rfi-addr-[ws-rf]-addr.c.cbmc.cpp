...
T2BLOCK1:
  ...
  //   %xor15 = xor i32 %conv14, %conv14, !dbg !102
  creg_r9 = max(creg_r8,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor15, metadata !81, metadata !DIExpression()), !dbg !103

  //   %add17 = add nsw i32 0, %xor15, !dbg !103
  creg_r10 = max(0,creg_r9);
  ASSUME(active[creg_r10] == 2);
  r10 = 0 + r9;

  //   %idxprom18 = sext i32 %add17 to i64, !dbg !103

  //   %arrayidx19 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom18, !dbg !103
  r11 = 0+r10*1;
  ASSUME(creg_r11 >= 0);
  ASSUME(creg_r11 >= creg_r10);
  ASSUME(active[creg_r11] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx19, metadata !83, metadata !DIExpression()), !dbg !123

  //   %3 = load atomic i64, i64* %arrayidx19 monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,r11);
  ...
  //   %conv22 = trunc i64 %3 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !82, metadata !DIExpression()), !dbg !103

  //   %cmp = icmp eq i32 %conv, 1, !dbg !106

  //   %conv23 = zext i1 %cmp to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !86, metadata !DIExpression()), !dbg !103
  ...
  //   %cmp27 = icmp eq i32 %conv4, 1, !dbg !109

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !90, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !91, metadata !DIExpression()), !dbg !129

  //   %5 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !93, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %5, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !111
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv14, 2, !dbg !112

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !94, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_2, metadata !95, metadata !DIExpression()), !dbg !132

  //   %6 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !97, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %6, i64* @atom_1_X9_2 seq_cst, align 8, !dbg !114
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv22, 0, !dbg !115

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !98, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !99, metadata !DIExpression()), !dbg !135

  //   %7 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !101, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %7, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !233

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !235

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !237

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !165, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !166, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !169, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !172, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !175, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !178, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !181, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_2, metadata !184, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !252

  //   store atomic i64 0, i64* @atom_1_X9_2 monotonic, align 8, !dbg !139
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !187, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !254

  //   store atomic i64 0, i64* @atom_1_X11_0 monotonic, align 8, !dbg !141
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !191, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !193, metadata !DIExpression()), !dbg !269

  //   %conv = trunc i64 %6 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !190, metadata !DIExpression()), !dbg !233

  //   %cmp = icmp eq i32 %conv, 2, !dbg !158

  //   %conv20 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !194, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !196, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !198, metadata !DIExpression()), !dbg !273

  //   %conv24 = trunc i64 %7 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !195, metadata !DIExpression()), !dbg !233

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !162

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !199, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !201, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !203, metadata !DIExpression()), !dbg !277

  //   %conv30 = trunc i64 %8 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !200, metadata !DIExpression()), !dbg !233

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !166

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !204, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !206, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !208, metadata !DIExpression()), !dbg !281

  //   %conv36 = trunc i64 %9 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !205, metadata !DIExpression()), !dbg !233

  //   %cmp37 = icmp eq i32 %conv36, 1, !dbg !170

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !209, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !211, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !213, metadata !DIExpression()), !dbg !285

  //   %conv42 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !210, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !215, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !217, metadata !DIExpression()), !dbg !288

  //   %conv46 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !214, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_2, metadata !219, metadata !DIExpression()), !dbg !291

  //   %12 = load atomic i64, i64* @atom_1_X9_2 seq_cst, align 8, !dbg !178
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !221, metadata !DIExpression()), !dbg !291

  //   %conv50 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !218, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !223, metadata !DIExpression()), !dbg !294

  //   %13 = load atomic i64, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !181
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !225, metadata !DIExpression()), !dbg !294

  //   %conv54 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !222, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !226, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !227, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !228, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !229, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !230, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !231, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !232, metadata !DIExpression()), !dbg !233
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 97, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !193
