...
T2BLOCK1:
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !79
  r3 = 0+r2*1;
  creg_r3 = creg_r2;
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !100

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !73, metadata !DIExpression()), !dbg !91

  //   %add7 = add nsw i32 3, %xor5, !dbg !85
  creg_r6 = max(0,creg_r5);
  r6 = 3 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !85

  //   %arrayidx9 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !85
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !74, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64 1, metadata !76, metadata !DIExpression()), !dbg !105

  //   store atomic i64 1, i64* %arrayidx9 monotonic, align 8, !dbg !85
  // ST: Guess
  iw(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l35_c3
  old_cw = cw(2,r7);
  cw(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l35_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !78, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !80, metadata !DIExpression()), !dbg !106

  //   %conv14 = trunc i64 %2 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !77, metadata !DIExpression()), !dbg !91

  //   %xor15 = xor i32 %conv14, %conv14, !dbg !90
  creg_r9 = creg_r8;
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor15, metadata !81, metadata !DIExpression()), !dbg !91

  //   %add17 = add nsw i32 0, %xor15, !dbg !91
  creg_r10 = max(0,creg_r9);
  r10 = 0 + r9;

  //   %idxprom18 = sext i32 %add17 to i64, !dbg !91

  //   %arrayidx19 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom18, !dbg !91
  r11 = 0+r10*1;
  creg_r11 = creg_r10;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx19, metadata !83, metadata !DIExpression()), !dbg !111

  //   %3 = load atomic i64, i64* %arrayidx19 monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,r11);
  cr(2,r11) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l38_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !85, metadata !DIExpression()), !dbg !111

  //   %conv22 = trunc i64 %3 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !82, metadata !DIExpression()), !dbg !91

  //   %cmp = icmp eq i32 %conv, 1, !dbg !94
  creg__r0__1_ = max(0,creg_r0);

  //   %conv23 = zext i1 %cmp to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !86, metadata !DIExpression()), !dbg !91

  //   store i32 %conv23, i32* @atom_1_X0_1, align 4, !dbg !95, !tbaa !96
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv4, 1, !dbg !100
  ...
  //   store i32 %conv25, i32* @atom_1_X5_1, align 4, !dbg !101, !tbaa !96
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv14, 2, !dbg !102
  ...
  //   store i32 %conv27, i32* @atom_1_X9_2, align 4, !dbg !103, !tbaa !96
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv22, 0, !dbg !104
  ...
  //   store i32 %conv29, i32* @atom_1_X11_0, align 4, !dbg !105, !tbaa !96
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !129, metadata !DIExpression()), !dbg !136
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !146, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !147, metadata !DIExpression()), !dbg !210

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !148, metadata !DIExpression()), !dbg !212

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !152, metadata !DIExpression()), !dbg !214

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !153, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !154, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !157, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !159, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !160, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !163, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !166, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !170, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_2, metadata !173, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i32 0, metadata !175, metadata !DIExpression()), !dbg !229

  //   store atomic i32 0, i32* @atom_1_X9_2 monotonic, align 4, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !176, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i32 0, metadata !178, metadata !DIExpression()), !dbg !231

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !130
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !180, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !182, metadata !DIExpression()), !dbg !244

  //   %conv = trunc i64 %6 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !179, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !183, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !185, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !187, metadata !DIExpression()), !dbg !248

  //   %conv24 = trunc i64 %7 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !184, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !188, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !190, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !192, metadata !DIExpression()), !dbg !252

  //   %conv30 = trunc i64 %8 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !189, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !193, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !197, metadata !DIExpression()), !dbg !256

  //   %conv36 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !194, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !198, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !199, metadata !DIExpression()), !dbg !210

  //   %11 = load i32, i32* @atom_1_X5_1, align 4, !dbg !163, !tbaa !161
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !200, metadata !DIExpression()), !dbg !210

  //   %12 = load i32, i32* @atom_1_X9_2, align 4, !dbg !164, !tbaa !161
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !201, metadata !DIExpression()), !dbg !210

  //   %13 = load i32, i32* @atom_1_X11_0, align 4, !dbg !165, !tbaa !161
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !202, metadata !DIExpression()), !dbg !210

  //   %and = and i32 %12, %13, !dbg !166
  creg_r25 = max(creg_r23,creg_r24);
  r25 = r23 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !203, metadata !DIExpression()), !dbg !210

  //   %and39 = and i32 %11, %and, !dbg !167
  creg_r26 = max(creg_r22,creg_r25);
  r26 = r22 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !204, metadata !DIExpression()), !dbg !210

  //   %and40 = and i32 %10, %and39, !dbg !168
  creg_r27 = max(creg_r21,creg_r26);
  r27 = r21 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !205, metadata !DIExpression()), !dbg !210

  //   %and41 = and i32 %conv38, %and40, !dbg !169
  creg_r28 = max(creg__r20__1_,creg_r27);
  r28 = (r20==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !206, metadata !DIExpression()), !dbg !210

  //   %and42 = and i32 %conv32, %and41, !dbg !170
  creg_r29 = max(creg__r19__1_,creg_r28);
  r29 = (r19==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !207, metadata !DIExpression()), !dbg !210

  //   %and43 = and i32 %conv26, %and42, !dbg !171
  creg_r30 = max(creg__r18__1_,creg_r29);
  r30 = (r18==1) & r29;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !208, metadata !DIExpression()), !dbg !210

  //   %and44 = and i32 %conv20, %and43, !dbg !172
  creg_r31 = max(creg__r17__2_,creg_r30);
  r31 = (r17==2) & r30;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !209, metadata !DIExpression()), !dbg !210
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 97, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !176
