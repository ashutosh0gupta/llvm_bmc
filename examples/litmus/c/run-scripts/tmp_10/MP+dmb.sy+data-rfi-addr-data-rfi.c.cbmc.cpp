...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !77, metadata !DIExpression()), !dbg !90

  //   %add13 = add nsw i32 %xor12, 1, !dbg !89
  creg_r9 = max(0,creg_r8);
  r9 = r8 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add13, metadata !78, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !109

  //   %conv16 = sext i32 %add13 to i64, !dbg !91

  //   call void @llvm.dbg.value(metadata i64 %conv16, metadata !81, metadata !DIExpression()), !dbg !109

  //   store atomic i64 %conv16, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !82, metadata !DIExpression()), !dbg !90
  ...
  //   %cmp22 = icmp eq i32 %conv5, 1, !dbg !101
  ...
  //   store i32 %conv23, i32* @atom_1_X4_1, align 4, !dbg !102, !tbaa !97
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv20, 1, !dbg !103
  ...
  //   store i32 %conv25, i32* @atom_1_X10_1, align 4, !dbg !104, !tbaa !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !132, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !133, metadata !DIExpression()), !dbg !184

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !134, metadata !DIExpression()), !dbg !186

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !138, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !139, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !142, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !145, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !151, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !155, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !158, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !201

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !165, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !166, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !170, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !171, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !175, metadata !DIExpression()), !dbg !184
  ...
  //   %9 = load i32, i32* @atom_1_X10_1, align 4, !dbg !139, !tbaa !136
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !180, metadata !DIExpression()), !dbg !184

  //   %and30 = and i32 %conv28, %and29, !dbg !142
  creg_r22 = max(creg__r16__1_,creg_r21);
  r22 = (r16==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !181, metadata !DIExpression()), !dbg !184

  //   %and31 = and i32 %conv22, %and30, !dbg !143
  creg_r23 = max(creg__r15__1_,creg_r22);
  r23 = (r15==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !182, metadata !DIExpression()), !dbg !184

  //   %and32 = and i32 %conv16, %and31, !dbg !144
  creg_r24 = max(creg__r14__2_,creg_r23);
  r24 = (r14==2) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !183, metadata !DIExpression()), !dbg !184
