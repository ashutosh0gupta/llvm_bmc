...
T2BLOCK1:
  ...
  //   %cmp23 = icmp eq i32 %conv4, 1, !dbg !99
  ...
  //   store i32 %conv24, i32* @atom_1_X5_1, align 4, !dbg !100, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_1, metadata !156, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !199

  //   store atomic i32 0, i32* @atom_1_X11_1 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X11_1, align 4, !dbg !139, !tbaa !136
  // LD: Guess
  old_cr = cr(0,6);
