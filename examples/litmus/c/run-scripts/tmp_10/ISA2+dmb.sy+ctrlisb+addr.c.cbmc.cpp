...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !58, metadata !DIExpression()), !dbg !69
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !62, metadata !DIExpression()), !dbg !72

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !59, metadata !DIExpression()), !dbg !69
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !68), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !63, metadata !DIExpression()), !dbg !82

  //   call void @llvm.dbg.value(metadata i64 1, metadata !65, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !66, metadata !DIExpression()), !dbg !69
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !98, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !100, metadata !DIExpression()), !dbg !114

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(3,r4);
  cr(3,r4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l43_c16
  // Check
  ASSUME(active[cr(3,r4)] == 3);
  ASSUME(cr(3,r4) >= iw(3,r4));
  ASSUME(cr(3,r4) >= creg_r4);
  ASSUME(cr(3,r4) >= cdy[3]);
  ASSUME(cr(3,r4) >= cisb[3]);
  ASSUME(cr(3,r4) >= cdl[3]);
  ASSUME(cr(3,r4) >= cl[3]);
  // Update
  creg_r5 = cr(3,r4);
  crmax(3,r4) = max(crmax(3,r4),cr(3,r4));
  caddr[3] = max(caddr[3],creg_r4);
  if(cr(3,r4) < cw(3,r4)) {
    r5 = buff(3,r4);
    ASSUME((!(( (cw(3,r4) < 1) && (1 < crmax(3,r4)) )))||(sforbid(r4,1)> 0));
    ASSUME((!(( (cw(3,r4) < 2) && (2 < crmax(3,r4)) )))||(sforbid(r4,2)> 0));
    ASSUME((!(( (cw(3,r4) < 3) && (3 < crmax(3,r4)) )))||(sforbid(r4,3)> 0));
    ASSUME((!(( (cw(3,r4) < 4) && (4 < crmax(3,r4)) )))||(sforbid(r4,4)> 0));
    ASSUME((!(( (cw(3,r4) < 5) && (5 < crmax(3,r4)) )))||(sforbid(r4,5)> 0));
    ASSUME((!(( (cw(3,r4) < 6) && (6 < crmax(3,r4)) )))||(sforbid(r4,6)> 0));
    ASSUME((!(( (cw(3,r4) < 7) && (7 < crmax(3,r4)) )))||(sforbid(r4,7)> 0));
    ASSUME((!(( (cw(3,r4) < 8) && (8 < crmax(3,r4)) )))||(sforbid(r4,8)> 0));
    ASSUME((!(( (cw(3,r4) < 9) && (9 < crmax(3,r4)) )))||(sforbid(r4,9)> 0));
  } else {
    if(pw(3,r4) != co(r4,cr(3,r4))) {
      ASSUME(cr(3,r4) >= old_cr);
    }
    pw(3,r4) = co(r4,cr(3,r4));
    r5 = mem(r4,cr(3,r4));
  }
  ASSUME(creturn[3] >= cr(3,r4));
  ...
  // ST: Guess
  iw(3,4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l45_c15
  old_cw = cw(3,4);
  cw(3,4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l45_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !128, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !129, metadata !DIExpression()), !dbg !160

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !130, metadata !DIExpression()), !dbg !162

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !134, metadata !DIExpression()), !dbg !164

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !135, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !136, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !139, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !145, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !149, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X3_0, metadata !152, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !157, metadata !DIExpression()), !dbg !160

  //   %and = and i32 %7, %8, !dbg !111
  creg_r13 = max(creg_r11,creg_r12);
  r13 = r11 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !158, metadata !DIExpression()), !dbg !160
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
