...
T2BLOCK1:
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !92
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !112
...
T2BLOCK4:
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !87, metadata !DIExpression()), !dbg !120

  //   %conv20 = trunc i64 %5 to i32, !dbg !103
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !110
  ...
  //   store i32 %conv23, i32* @atom_1_X2_1, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X3_2, align 4, !dbg !113, !tbaa !106
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv12, 2, !dbg !114
  ...
  //   store i32 %conv27, i32* @atom_1_X4_2, align 4, !dbg !115, !tbaa !106
  // ST: Guess
  ...
  //   store i32 %conv29, i32* @atom_1_X8_0, align 4, !dbg !117, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !212

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !214

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !216

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !165, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !166, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !172, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !175, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i32 0, metadata !178, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !179, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !182, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !185, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !188, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !192, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !194, metadata !DIExpression()), !dbg !246

  //   %conv = trunc i64 %6 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !191, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !195, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !199, metadata !DIExpression()), !dbg !250

  //   %conv24 = trunc i64 %7 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !196, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !200, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !201, metadata !DIExpression()), !dbg !212
  ...
  //   %12 = load i32, i32* @atom_1_X8_0, align 4, !dbg !150, !tbaa !145
  // LD: Guess
  old_cr = cr(0,7);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 96, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
