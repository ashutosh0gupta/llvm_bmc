...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !74, metadata !DIExpression()), !dbg !89

  //   %xor = xor i32 %conv15, %conv15, !dbg !99
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !78, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !120
  ...
  //   %cmp23 = icmp eq i32 %conv19, 0, !dbg !111
  ...
  //   store i32 %conv24, i32* @atom_1_X9_0, align 4, !dbg !112, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !177, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !180, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !189, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !194, metadata !DIExpression()), !dbg !246
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154
