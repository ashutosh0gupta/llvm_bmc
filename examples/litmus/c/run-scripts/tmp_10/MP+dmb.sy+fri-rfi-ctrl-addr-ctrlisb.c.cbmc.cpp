...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !63, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64 2, metadata !65, metadata !DIExpression()), !dbg !104

  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !67, metadata !DIExpression()), !dbg !106

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !98
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !88, metadata !DIExpression()), !dbg !136

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %6, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !118
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !149, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !150, metadata !DIExpression()), !dbg !203

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !151, metadata !DIExpression()), !dbg !205

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !155, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !156, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !161, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !168, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !171, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !174, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !180, metadata !DIExpression()), !dbg !232

  //   %conv = trunc i64 %4 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !177, metadata !DIExpression()), !dbg !203

  //   %cmp = icmp eq i32 %conv, 1, !dbg !128

  //   %conv16 = zext i1 %cmp to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !181, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !185, metadata !DIExpression()), !dbg !236

  //   %conv20 = trunc i64 %5 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !182, metadata !DIExpression()), !dbg !203

  //   %cmp21 = icmp eq i32 %conv20, 2, !dbg !132

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !186, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !190, metadata !DIExpression()), !dbg !240

  //   %conv26 = trunc i64 %6 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !187, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !192, metadata !DIExpression()), !dbg !243

  //   %7 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !194, metadata !DIExpression()), !dbg !243

  //   %conv30 = trunc i64 %7 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !191, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !196, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !198, metadata !DIExpression()), !dbg !246

  //   %conv34 = trunc i64 %8 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !195, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !200, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !201, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !202, metadata !DIExpression()), !dbg !203
