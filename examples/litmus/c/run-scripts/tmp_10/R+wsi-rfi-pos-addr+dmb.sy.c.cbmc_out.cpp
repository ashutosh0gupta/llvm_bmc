...
T1BLOCK1:
  ...
  //   %xor = xor i32 %conv6, %conv6, !dbg !74
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !54, metadata !DIExpression()), !dbg !61
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !55, metadata !DIExpression()), !dbg !76
  ...
  //   %cmp10 = icmp eq i32 %conv6, 2, !dbg !83
  ...
  //   store i32 %conv11, i32* @atom_0_X4_2, align 4, !dbg !84, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_2, metadata !130, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !134, metadata !DIExpression()), !dbg !168
