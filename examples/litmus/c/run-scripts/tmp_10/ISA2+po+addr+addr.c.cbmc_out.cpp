...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !91, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !93, metadata !DIExpression()), !dbg !107

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(3,r7);
  cr(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l40_c16
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !138, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !142, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X3_0, metadata !145, metadata !DIExpression()), !dbg !170
