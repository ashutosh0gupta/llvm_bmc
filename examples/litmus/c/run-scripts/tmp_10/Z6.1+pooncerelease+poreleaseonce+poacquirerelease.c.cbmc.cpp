...
T3BLOCK1:
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !52
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !71, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !80, metadata !DIExpression()), !dbg !93

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !82, metadata !DIExpression()), !dbg !93

  //   store atomic i64 %1, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !58
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !120, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !134, metadata !DIExpression()), !dbg !175
