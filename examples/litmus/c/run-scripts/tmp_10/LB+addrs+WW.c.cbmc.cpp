...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !106, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !107, metadata !DIExpression()), !dbg !135

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !108, metadata !DIExpression()), !dbg !137

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !112, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !113, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64 0, metadata !115, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !116, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !119, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !122, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !125, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i32 0, metadata !128, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !129, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !132, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !133, metadata !DIExpression()), !dbg !135
