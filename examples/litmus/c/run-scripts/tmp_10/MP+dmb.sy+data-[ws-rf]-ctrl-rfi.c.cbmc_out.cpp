...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !62, metadata !DIExpression()), !dbg !87

  //   %conv = trunc i64 %0 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !59, metadata !DIExpression()), !dbg !84

  //   %xor = xor i32 %conv, %conv, !dbg !71
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !63, metadata !DIExpression()), !dbg !84

  //   %add = add nsw i32 %xor, 1, !dbg !72
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !64, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !65, metadata !DIExpression()), !dbg !92

  //   %conv1 = sext i32 %add to i64, !dbg !74

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !67, metadata !DIExpression()), !dbg !92

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !74
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !68, metadata !DIExpression()), !dbg !84

  //   %tobool = icmp ne i32 %conv5, 0, !dbg !78
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !103

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !85
  // ST: Guess
  ...
  //   store i32 %conv12, i32* @atom_1_X0_1, align 4, !dbg !90, !tbaa !91
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv5, 2, !dbg !95
  ...
  //   store i32 %conv14, i32* @atom_1_X4_2, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv11, 1, !dbg !97
  ...
  //   store i32 %conv16, i32* @atom_1_X7_1, align 4, !dbg !98, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !160, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !163, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !206

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !110
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X7_1, align 4, !dbg !140, !tbaa !137
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 87, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
