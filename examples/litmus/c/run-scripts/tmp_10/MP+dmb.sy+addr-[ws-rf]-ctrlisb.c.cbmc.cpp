...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !99

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   store i32 %conv9, i32* @atom_1_X0_1, align 4, !dbg !84, !tbaa !85
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv4, 2, !dbg !89
  ...
  //   store i32 %conv11, i32* @atom_1_X5_2, align 4, !dbg !90, !tbaa !85
  // ST: Guess
  ...
  //   store i32 %conv13, i32* @atom_1_X6_0, align 4, !dbg !92, !tbaa !85
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !115, metadata !DIExpression()), !dbg !120
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !116, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 2, metadata !118, metadata !DIExpression()), !dbg !123
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !133, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !134, metadata !DIExpression()), !dbg !183

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !135, metadata !DIExpression()), !dbg !185

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !139, metadata !DIExpression()), !dbg !187

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !140, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !141, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64 0, metadata !146, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !147, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !150, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i32 0, metadata !153, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !154, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !157, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !161, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !163, metadata !DIExpression()), !dbg !213

  //   %conv = trunc i64 %6 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !160, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !164, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !166, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !168, metadata !DIExpression()), !dbg !217

  //   %conv20 = trunc i64 %7 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !165, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !169, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !171, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !173, metadata !DIExpression()), !dbg !221

  //   %conv26 = trunc i64 %8 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !170, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !174, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !179, metadata !DIExpression()), !dbg !183

  //   %and30 = and i32 %conv28, %and29, !dbg !143
  creg_r18 = max(creg__r12__2_,creg_r17);
  r18 = (r12==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !180, metadata !DIExpression()), !dbg !183

  //   %and31 = and i32 %conv22, %and30, !dbg !144
  creg_r19 = max(creg__r11__1_,creg_r18);
  r19 = (r11==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !181, metadata !DIExpression()), !dbg !183

  //   %and32 = and i32 %conv16, %and31, !dbg !145
  creg_r20 = max(creg__r10__1_,creg_r19);
  r20 = (r10==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !182, metadata !DIExpression()), !dbg !183
