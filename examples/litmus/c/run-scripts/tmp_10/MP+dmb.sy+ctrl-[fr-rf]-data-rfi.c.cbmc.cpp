...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !74, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !108

  //   %conv9 = sext i32 %add to i64, !dbg !90

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !77, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv4, 0, !dbg !100
  ...
  //   store i32 %conv16, i32* @atom_1_X2_0, align 4, !dbg !101, !tbaa !96
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv8, 1, !dbg !102
  ...
  //   store i32 %conv18, i32* @atom_1_X4_1, align 4, !dbg !103, !tbaa !96
  // ST: Guess
