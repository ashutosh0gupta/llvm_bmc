...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !88), !dbg !93
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !89), !dbg !102
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !90), !dbg !113
  ...
  //   %xor = xor i32 %conv13, %conv13, !dbg !100
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !91
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !101
  r5 = 0+r4*1;
  creg_r5 = creg_r4;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !121

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,r5);
  cr(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l40_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !83, metadata !DIExpression()), !dbg !121

  //   %conv17 = trunc i64 %3 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !80, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !84, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !85, metadata !DIExpression()), !dbg !91

  //   store i32 %conv20, i32* @atom_1_X4_2, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv13, 1, !dbg !112
  creg__r2__1_ = max(0,creg_r2);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !86, metadata !DIExpression()), !dbg !91

  //   store i32 %conv22, i32* @atom_1_X7_1, align 4, !dbg !113, !tbaa !106
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv17, 0, !dbg !114
  creg__r6__0_ = max(0,creg_r6);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv24, i32* @atom_1_X9_0, align 4, !dbg !115, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !180, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !183, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !186, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i32 0, metadata !188, metadata !DIExpression()), !dbg !241

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !130
  // ST: Guess
  ...
  //   %13 = load i32, i32* @atom_1_X9_0, align 4, !dbg !165, !tbaa !161
  // LD: Guess
  old_cr = cr(0,7);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !176
