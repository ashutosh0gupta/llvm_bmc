...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !91, metadata !DIExpression()), !dbg !110
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !93, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !95, metadata !DIExpression()), !dbg !113

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !92, metadata !DIExpression()), !dbg !110
...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !97, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !99, metadata !DIExpression()), !dbg !122

  //   %conv4 = trunc i64 %1 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !96, metadata !DIExpression()), !dbg !110

  //   %cmp = icmp eq i32 %conv, 1, !dbg !73

  //   %conv5 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !100, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !101, metadata !DIExpression()), !dbg !126

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !103, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !104, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !105, metadata !DIExpression()), !dbg !129

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !107, metadata !DIExpression()), !dbg !129
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !159, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !162, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !170, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !174, metadata !DIExpression()), !dbg !217
