...
T2BLOCK7:
  ...
  //   store i32 %conv22, i32* @atom_1_X2_1, align 4, !dbg !113, !tbaa !108
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv15, 2, !dbg !114
  ...
  //   store i32 %conv24, i32* @atom_1_X7_2, align 4, !dbg !115, !tbaa !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !182, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_2, metadata !185, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !192, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !197, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !202, metadata !DIExpression()), !dbg !258
