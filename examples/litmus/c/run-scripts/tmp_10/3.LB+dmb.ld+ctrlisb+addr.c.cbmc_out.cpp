...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !77), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !75, metadata !DIExpression()), !dbg !78
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !103, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !104, metadata !DIExpression()), !dbg !117
  ...
  // ST: Guess
  iw(3,r5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l45_c3
  old_cw = cw(3,r5);
  cw(3,r5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l45_c3
  // Check
  ASSUME(active[iw(3,r5)] == 3);
  ASSUME(active[cw(3,r5)] == 3);
  ASSUME(sforbid(r5,cw(3,r5))== 0);
  ASSUME(iw(3,r5) >= 0);
  ASSUME(iw(3,r5) >= creg_r5);
  ASSUME(cw(3,r5) >= iw(3,r5));
  ASSUME(cw(3,r5) >= old_cw);
  ASSUME(cw(3,r5) >= cr(3,r5));
  ASSUME(cw(3,r5) >= cl[3]);
  ASSUME(cw(3,r5) >= cisb[3]);
  ASSUME(cw(3,r5) >= cdy[3]);
  ASSUME(cw(3,r5) >= cdl[3]);
  ASSUME(cw(3,r5) >= cds[3]);
  ASSUME(cw(3,r5) >= cctrl[3]);
  ASSUME(cw(3,r5) >= caddr[3]);
  // Update
  caddr[3] = max(caddr[3],creg_r5);
  buff(3,r5) = 1;
  mem(r5,cw(3,r5)) = 1;
  co(r5,cw(3,r5))+=1;
  delta(r5,cw(3,r5)) = -1;
  ASSUME(creturn[3] >= cw(3,r5));
