...
T2BLOCK4:
  ...
  //   %add15 = add nsw i32 0, %xor13, !dbg !103
  creg_r8 = max(0,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = 0 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !103

  //   %arrayidx17 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !103
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !78, metadata !DIExpression()), !dbg !123

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !125
  ...
  //   %cmp27 = icmp eq i32 %conv20, 0, !dbg !112

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !89, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !90, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !94, metadata !DIExpression()), !dbg !135

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %8, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !167, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !214

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !170, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !216

  //   store atomic i64 0, i64* @atom_1_X11_0 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !188, metadata !DIExpression()), !dbg !239

  //   %7 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !192, metadata !DIExpression()), !dbg !242

  //   %8 = load atomic i64, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !140
  // LD: Guess
  old_cr = cr(0,6);
