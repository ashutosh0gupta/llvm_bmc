...
T2BLOCK4:
  ...
  //   store i32 %conv29, i32* @atom_1_X11_0, align 4, !dbg !109, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !160, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !198

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !163, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !200

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !106
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X9_0, align 4, !dbg !128, !tbaa !126
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %8 = load i32, i32* @atom_1_X11_0, align 4, !dbg !129, !tbaa !126
  // LD: Guess
  old_cr = cr(0,6);
