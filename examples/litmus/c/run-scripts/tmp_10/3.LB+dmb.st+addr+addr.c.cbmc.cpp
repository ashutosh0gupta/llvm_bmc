...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !67, metadata !DIExpression()), !dbg !78
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !71, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !73, metadata !DIExpression()), !dbg !86
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !92, metadata !DIExpression()), !dbg !103
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !96, metadata !DIExpression()), !dbg !106

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !93, metadata !DIExpression()), !dbg !103

  //   %xor = xor i32 %conv, %conv, !dbg !56
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !97, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !98, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64 1, metadata !100, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !57
  // ST: Guess
  iw(3,r8) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l43_c3
  old_cw = cw(3,r8);
  cw(3,r8) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l43_c3
  // Check
  ASSUME(active[iw(3,r8)] == 3);
  ASSUME(active[cw(3,r8)] == 3);
  ASSUME(sforbid(r8,cw(3,r8))== 0);
  ASSUME(iw(3,r8) >= 0);
  ASSUME(iw(3,r8) >= creg_r8);
  ASSUME(cw(3,r8) >= iw(3,r8));
  ASSUME(cw(3,r8) >= old_cw);
  ASSUME(cw(3,r8) >= cr(3,r8));
  ASSUME(cw(3,r8) >= cl[3]);
  ASSUME(cw(3,r8) >= cisb[3]);
  ASSUME(cw(3,r8) >= cdy[3]);
  ASSUME(cw(3,r8) >= cdl[3]);
  ASSUME(cw(3,r8) >= cds[3]);
  ASSUME(cw(3,r8) >= cctrl[3]);
  ASSUME(cw(3,r8) >= caddr[3]);
  // Update
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !122, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !123, metadata !DIExpression()), !dbg !154

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !124, metadata !DIExpression()), !dbg !156

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !128, metadata !DIExpression()), !dbg !158

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !129, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !139, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i32 0, metadata !142, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !143, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !146, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !151, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !153, metadata !DIExpression()), !dbg !154
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
