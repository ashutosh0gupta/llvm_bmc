...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !74

  //   %conv3 = sext i32 %add to i64, !dbg !75

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !51, metadata !DIExpression()), !dbg !74

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !76
  ...
  //   %conv7 = trunc i64 %1 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !52, metadata !DIExpression()), !dbg !64

  //   %xor8 = xor i32 %conv7, %conv7, !dbg !79
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor8, metadata !56, metadata !DIExpression()), !dbg !64

  //   %add9 = add nsw i32 %xor8, 1, !dbg !80
  creg_r5 = max(0,creg_r4);
  r5 = r4 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add9, metadata !57, metadata !DIExpression()), !dbg !64
  ...
  //   %conv12 = sext i32 %add9 to i64, !dbg !82

  //   call void @llvm.dbg.value(metadata i64 %conv12, metadata !60, metadata !DIExpression()), !dbg !81

  //   store atomic i64 %conv12, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !82
  // ST: Guess
  ...
  //   store i32 %conv13, i32* @atom_0_X2_1, align 4, !dbg !84, !tbaa !85
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv7, 1, !dbg !89
  ...
  //   store i32 %conv15, i32* @atom_0_X5_1, align 4, !dbg !90, !tbaa !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !139, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i32 0, metadata !142, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_1, metadata !143, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i32 0, metadata !145, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !146, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !153, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !158, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !163, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !168, metadata !DIExpression()), !dbg !172

  //   %and28 = and i32 %conv26, %and27, !dbg !137
  creg_r18 = max(creg__r12__2_,creg_r17);
  r18 = (r12==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !169, metadata !DIExpression()), !dbg !172
