...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !48, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !80

  //   %conv3 = sext i32 %add to i64, !dbg !81

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !51, metadata !DIExpression()), !dbg !80

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !52, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor8, metadata !56, metadata !DIExpression()), !dbg !70

  //   %add9 = add nsw i32 %xor8, 1, !dbg !86
  creg_r5 = max(creg_r4,0);
  ASSUME(active[creg_r5] == 1);
  r5 = r4 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add9, metadata !57, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !58, metadata !DIExpression()), !dbg !87

  //   %conv12 = sext i32 %add9 to i64, !dbg !88

  //   call void @llvm.dbg.value(metadata i64 %conv12, metadata !60, metadata !DIExpression()), !dbg !87

  //   store atomic i64 %conv12, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !61, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !62, metadata !DIExpression()), !dbg !90

  //   %2 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !64, metadata !DIExpression()), !dbg !90

  //   store atomic i64 %2, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !91
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv7, 1, !dbg !92

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !65, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !66, metadata !DIExpression()), !dbg !93

  //   %3 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !68, metadata !DIExpression()), !dbg !93

  //   store atomic i64 %3, i64* @atom_0_X5_1 seq_cst, align 8, !dbg !94
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !107, metadata !DIExpression()), !dbg !121
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !147, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !150, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !153, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !176, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !180, metadata !DIExpression()), !dbg !233
