...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !102
  creg_r2 = max(creg_r1,creg_r1);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !106

  //   %add = add nsw i32 3, %xor, !dbg !103
  creg_r3 = max(0,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = 3 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !103

  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !103
  r4 = 0+r3*1;
  ASSUME(creg_r4 >= 0);
  ASSUME(creg_r4 >= creg_r3);
  ASSUME(active[creg_r4] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !123

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,r4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !123
