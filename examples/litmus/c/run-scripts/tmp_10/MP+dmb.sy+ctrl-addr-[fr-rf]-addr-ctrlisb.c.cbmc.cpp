...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !90
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 3, %xor, !dbg !91
  creg_r3 = max(0,creg_r2);
  r3 = 3 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !91

  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !91
  r4 = 0+r3*1;
  creg_r4 = creg_r3;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !111

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,r4);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !113

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !113

  //   %conv12 = trunc i64 %3 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !94

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !97
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !78, metadata !DIExpression()), !dbg !94

  //   %add15 = add nsw i32 4, %xor13, !dbg !98
  creg_r8 = max(0,creg_r7);
  r8 = 4 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !98

  //   %arrayidx17 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !98
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !80, metadata !DIExpression()), !dbg !118

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,r9);
  cr(2,r9) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l38_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !118

  //   %conv20 = trunc i64 %4 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !79, metadata !DIExpression()), !dbg !94

  //   %tobool21 = icmp ne i32 %conv20, 0, !dbg !101
  creg__r10__0_ = max(0,creg_r10);

  //   br i1 %tobool21, label %if.then22, label %if.else23, !dbg !103
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !93), !dbg !125
