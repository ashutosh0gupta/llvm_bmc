...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !167, metadata !DIExpression()), !dbg !221
  ...
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l67_c3
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l67_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !174, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !177, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !180, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !229

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !183, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !231

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !186, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !190, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !195, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !199, metadata !DIExpression()), !dbg !212
  ...
  //   %10 = load i32, i32* @atom_1_X4_0, align 4, !dbg !152, !tbaa !149
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X6_0, align 4, !dbg !153, !tbaa !149
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X7_1, align 4, !dbg !154, !tbaa !149
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %13 = load i32, i32* @atom_1_X8_1, align 4, !dbg !155, !tbaa !149
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !206, metadata !DIExpression()), !dbg !212

  //   %and28 = and i32 %10, %and27, !dbg !158
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !207, metadata !DIExpression()), !dbg !212

  //   %and29 = and i32 %9, %and28, !dbg !159
  creg_r24 = max(creg_r16,creg_r23);
  r24 = r16 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !208, metadata !DIExpression()), !dbg !212

  //   %and30 = and i32 %8, %and29, !dbg !160
  creg_r25 = max(creg_r15,creg_r24);
  r25 = r15 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !209, metadata !DIExpression()), !dbg !212

  //   %and31 = and i32 %conv26, %and30, !dbg !161
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !210, metadata !DIExpression()), !dbg !212

  //   %and32 = and i32 %conv20, %and31, !dbg !162
  creg_r27 = max(creg__r13__2_,creg_r26);
  r27 = (r13==2) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !211, metadata !DIExpression()), !dbg !212
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
