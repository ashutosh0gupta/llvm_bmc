...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !89, metadata !DIExpression()), !dbg !135

  //   %6 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !93, metadata !DIExpression()), !dbg !138

  //   %7 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !120
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !187, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !190, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !219, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !223, metadata !DIExpression()), !dbg !295
