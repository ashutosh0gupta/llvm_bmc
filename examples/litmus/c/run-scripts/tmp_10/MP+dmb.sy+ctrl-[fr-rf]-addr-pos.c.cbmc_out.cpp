...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !103
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !90
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !75, metadata !DIExpression()), !dbg !91

  //   %add = add nsw i32 0, %xor, !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !111

  //   %conv12 = trunc i64 %3 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !113
  ...
  //   %cmp18 = icmp eq i32 %conv4, 0, !dbg !103
  ...
  //   store i32 %conv19, i32* @atom_1_X2_0, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv8, 1, !dbg !105
  ...
  //   store i32 %conv21, i32* @atom_1_X4_1, align 4, !dbg !106, !tbaa !99
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv12, 0, !dbg !107
  ...
  //   store i32 %conv23, i32* @atom_1_X6_0, align 4, !dbg !108, !tbaa !99
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X8_0, align 4, !dbg !110, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !172, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !175, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !178, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !181, metadata !DIExpression()), !dbg !232
