...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !67

  //   %add = add nsw i32 2, %xor, !dbg !55
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !62, metadata !DIExpression()), !dbg !75
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !90, metadata !DIExpression()), !dbg !97

  //   %add = add nsw i32 %xor, 1, !dbg !56
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !91, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !94, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !95, metadata !DIExpression()), !dbg !97
