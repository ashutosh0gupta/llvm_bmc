...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !113, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !117, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !121, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !123, metadata !DIExpression()), !dbg !161

  //   %conv13 = trunc i64 %7 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !120, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !126, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !128, metadata !DIExpression()), !dbg !165

  //   %conv18 = trunc i64 %8 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !125, metadata !DIExpression()), !dbg !132

  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !107

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !129, metadata !DIExpression()), !dbg !132
