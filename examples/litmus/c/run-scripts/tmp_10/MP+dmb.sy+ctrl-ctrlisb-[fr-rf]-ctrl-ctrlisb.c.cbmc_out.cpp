...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !89), !dbg !96
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !90), !dbg !105
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !91), !dbg !114
  ...
  //   %tobool16 = icmp ne i32 %conv15, 0, !dbg !103
  creg__r3__0_ = max(0,creg_r3);

  //   br i1 %tobool16, label %if.then17, label %if.else18, !dbg !105
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK8:
  //   br label %lbl_LC02, !dbg !106
  goto T2BLOCK10;

T2BLOCK9:
  //   br label %lbl_LC02, !dbg !107
  goto T2BLOCK10;

T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !92), !dbg !127

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !78, metadata !DIExpression()), !dbg !128

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,0+4*1);
  cr(2,0+4*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l41_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !128

  //   %conv22 = trunc i64 %4 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !77, metadata !DIExpression()), !dbg !94

  //   %tobool23 = icmp ne i32 %conv22, 0, !dbg !112
  creg__r4__0_ = max(0,creg_r4);

  //   br i1 %tobool23, label %if.then24, label %if.else25, !dbg !114
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK11:
  //   br label %lbl_LC03, !dbg !115
  goto T2BLOCK13;

T2BLOCK12:
  //   br label %lbl_LC03, !dbg !116
  goto T2BLOCK13;

T2BLOCK13:
  //   call void @llvm.dbg.label(metadata !93), !dbg !136

  //   call void (...) @isb(), !dbg !118
  // isb: Guess
  cisb[2] = get_rng(0,NCONTEXT-1);
  // Check
  ASSUME(cisb[2] >= cdy[2]);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !138

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l45_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !138

  //   %conv29 = trunc i64 %5 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !81, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !122
  creg__r0__1_ = max(0,creg_r0);

  //   %conv30 = zext i1 %cmp to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !85, metadata !DIExpression()), !dbg !94

  //   store i32 %conv30, i32* @atom_1_X0_1, align 4, !dbg !123, !tbaa !124
  // ST: Guess
  iw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l47_c15
  old_cw = cw(2,5);
  cw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l47_c15
  // Check
  ...
  //   %cmp31 = icmp eq i32 %conv11, 0, !dbg !128
  creg__r2__0_ = max(0,creg_r2);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !86, metadata !DIExpression()), !dbg !94

  //   store i32 %conv32, i32* @atom_1_X4_0, align 4, !dbg !129, !tbaa !124
  // ST: Guess
  iw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l49_c15
  old_cw = cw(2,6);
  cw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l49_c15
  // Check
  ...
  //   %cmp33 = icmp eq i32 %conv15, 1, !dbg !130
  creg__r3__1_ = max(0,creg_r3);

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !87, metadata !DIExpression()), !dbg !94

  //   store i32 %conv34, i32* @atom_1_X6_1, align 4, !dbg !131, !tbaa !124
  // ST: Guess
  iw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l51_c15
  old_cw = cw(2,7);
  cw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l51_c15
  // Check
  ...
  //   %cmp35 = icmp eq i32 %conv29, 0, !dbg !132
  creg__r5__0_ = max(0,creg_r5);

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !88, metadata !DIExpression()), !dbg !94

  //   store i32 %conv36, i32* @atom_1_X9_0, align 4, !dbg !133, !tbaa !124
  // ST: Guess
  iw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l53_c15
  old_cw = cw(2,8);
  cw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l53_c15
  // Check
...
T3BLOCK1:
  ...
  // ST: Guess
  iw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l59_c3
  old_cw = cw(3,0+3*1);
  cw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l59_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !174, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !175, metadata !DIExpression()), !dbg !235

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !176, metadata !DIExpression()), !dbg !237

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !180, metadata !DIExpression()), !dbg !239

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !181, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !182, metadata !DIExpression()), !dbg !242
  ...
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l68_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l68_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !185, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !197, metadata !DIExpression()), !dbg !252
  ...
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l73_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l73_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !201, metadata !DIExpression()), !dbg !254
  ...
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l74_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l74_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !204, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i32 0, metadata !206, metadata !DIExpression()), !dbg !256

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !127
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l75_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l75_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !207, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i32 0, metadata !209, metadata !DIExpression()), !dbg !258

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !129
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l76_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l76_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !211, metadata !DIExpression()), !dbg !271

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l86_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !213, metadata !DIExpression()), !dbg !271

  //   %conv = trunc i64 %6 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !210, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !214, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !216, metadata !DIExpression()), !dbg !275

  //   %7 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l88_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !218, metadata !DIExpression()), !dbg !275

  //   %conv26 = trunc i64 %7 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !215, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !219, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !221, metadata !DIExpression()), !dbg !279

  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l90_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !223, metadata !DIExpression()), !dbg !279

  //   %conv32 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !220, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !224, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !225, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !226, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !227, metadata !DIExpression()), !dbg !235

  //   %12 = load i32, i32* @atom_1_X9_0, align 4, !dbg !160, !tbaa !156
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !228, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !230, metadata !DIExpression()), !dbg !235

  //   %and36 = and i32 %9, %and35, !dbg !163
  creg_r19 = max(creg_r13,creg_r18);
  r19 = r13 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !231, metadata !DIExpression()), !dbg !235

  //   %and37 = and i32 %conv34, %and36, !dbg !164
  creg_r20 = max(creg__r12__1_,creg_r19);
  r20 = (r12==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !232, metadata !DIExpression()), !dbg !235

  //   %and38 = and i32 %conv28, %and37, !dbg !165
  creg_r21 = max(creg__r11__1_,creg_r20);
  r21 = (r11==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !233, metadata !DIExpression()), !dbg !235

  //   %and39 = and i32 %conv22, %and38, !dbg !166
  creg_r22 = max(creg__r10__1_,creg_r21);
  r22 = (r10==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !234, metadata !DIExpression()), !dbg !235
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([128 x i8], [128 x i8]* @.str.1, i64 0, i64 0), i32 noundef 102, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !170
