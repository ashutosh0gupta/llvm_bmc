...
T2BLOCK4:
  ...
  //   %cmp23 = icmp eq i32 %conv4, 2, !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !90, metadata !DIExpression()), !dbg !134

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !92, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %5, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv10, 1, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !94, metadata !DIExpression()), !dbg !137
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !146, metadata !DIExpression()), !dbg !153
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !186, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !255

  //   store atomic i64 0, i64* @atom_1_X5_2 monotonic, align 8, !dbg !137
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !189, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !220, metadata !DIExpression()), !dbg !293

  //   %11 = load atomic i64, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !175
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !224, metadata !DIExpression()), !dbg !296
