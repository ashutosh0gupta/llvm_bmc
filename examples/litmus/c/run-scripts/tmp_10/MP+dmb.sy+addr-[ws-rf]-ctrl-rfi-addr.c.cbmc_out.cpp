...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !90), !dbg !108
  ...
  //   store i32 %conv21, i32* @atom_1_X5_2, align 4, !dbg !106, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !175, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !232

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X5_2, align 4, !dbg !163, !tbaa !161
  // LD: Guess
  old_cr = cr(0,5);
