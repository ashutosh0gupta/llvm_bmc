...
T1BLOCK1:
  ...
  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !72
  // ST: Guess
  //   : Release
  ...
  //   store i32 %conv10, i32* @atom_0_X7_2, align 4, !dbg !77, !tbaa !78
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X7_2, metadata !129, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i32 0, metadata !132, metadata !DIExpression()), !dbg !162

  //   store atomic i32 0, i32* @atom_0_X7_2 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X7_2, align 4, !dbg !111, !tbaa !112
  // LD: Guess
  old_cr = cr(0,3);
