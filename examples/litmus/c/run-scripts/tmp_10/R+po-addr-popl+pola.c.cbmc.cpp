...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !64
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !45, metadata !DIExpression()), !dbg !59
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !47, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !49, metadata !DIExpression()), !dbg !69

  //   %conv4 = trunc i64 %1 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !46, metadata !DIExpression()), !dbg !59
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !72
  // ST: Guess
  //   : Release
  iw(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l24_c3
  old_cw = cw(1,0+3*1);
  cw(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l24_c3
  // Check
  ...
  // LD: Guess
  old_cr = cr(1,0+3*1);
  cr(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l25_c16
  // Check
  ...
  if(cr(1,0+3*1) < cw(1,0+3*1)) {
    ...
    r5 = mem(0+3*1,cr(1,0+3*1));
  }
  ASSUME(creturn[1] >= cr(1,0+3*1));

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !56, metadata !DIExpression()), !dbg !73

  //   %conv10 = trunc i64 %2 to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !53, metadata !DIExpression()), !dbg !59

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !76
  creg__r5__2_ = max(0,creg_r5);

  //   %conv11 = zext i1 %cmp to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !57, metadata !DIExpression()), !dbg !59

  //   store i32 %conv11, i32* @atom_0_X9_2, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  iw(1,4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l27_c15
  old_cw = cw(1,4);
  cw(1,4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l27_c15
  // Check
  ASSUME(active[iw(1,4)] == 1);
  ASSUME(active[cw(1,4)] == 1);
  ASSUME(sforbid(4,cw(1,4))== 0);
  ASSUME(iw(1,4) >= creg__r5__2_);
  ASSUME(iw(1,4) >= 0);
...
T2BLOCK1:
  ...
  // ST: Guess
  //   : Release
  iw(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l33_c3
  old_cw = cw(2,0+3*1);
  cw(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l33_c3
  // Check
  ...
  // ST: Guess
  iw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l36_c15
  old_cw = cw(2,5);
  cw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l36_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !113, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !114, metadata !DIExpression()), !dbg !154

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !115, metadata !DIExpression()), !dbg !156

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !119, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !120, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64 0, metadata !122, metadata !DIExpression()), !dbg !159

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !87
  // ST: Guess
  iw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l44_c3
  old_cw = cw(0,0+3*1);
  cw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l44_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !123, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 0, metadata !125, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !126, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 0, metadata !128, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64 0, metadata !131, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X9_2, metadata !132, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i32 0, metadata !135, metadata !DIExpression()), !dbg !167

  //   store atomic i32 0, i32* @atom_0_X9_2 monotonic, align 4, !dbg !95
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l48_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l48_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !136, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !169

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !97
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l49_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l49_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !140, metadata !DIExpression()), !dbg !179

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l57_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !142, metadata !DIExpression()), !dbg !179

  //   %conv = trunc i64 %4 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !139, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !143, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !147, metadata !DIExpression()), !dbg !183

  //   %conv18 = trunc i64 %5 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !144, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !148, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !149, metadata !DIExpression()), !dbg !154

  //   %7 = load i32, i32* @atom_1_X2_0, align 4, !dbg !119, !tbaa !117
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l62_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !150, metadata !DIExpression()), !dbg !154

  //   %and = and i32 %6, %7, !dbg !120
  creg_r14 = max(creg_r12,creg_r13);
  r14 = r12 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !151, metadata !DIExpression()), !dbg !154

  //   %and21 = and i32 %conv20, %and, !dbg !121
  creg_r15 = max(creg__r11__1_,creg_r14);
  r15 = (r11==1) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !152, metadata !DIExpression()), !dbg !154

  //   %and22 = and i32 %conv14, %and21, !dbg !122
  creg_r16 = max(creg__r10__2_,creg_r15);
  r16 = (r10==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !153, metadata !DIExpression()), !dbg !154
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
