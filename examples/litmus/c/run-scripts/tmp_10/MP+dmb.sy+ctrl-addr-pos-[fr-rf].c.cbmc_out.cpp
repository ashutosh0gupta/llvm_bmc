...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !87), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !105
  ...
  //   %cmp18 = icmp eq i32 %conv8, 0, !dbg !100
  ...
  //   store i32 %conv19, i32* @atom_1_X5_0, align 4, !dbg !101, !tbaa !96
  // ST: Guess
  ...
  //   store i32 %conv21, i32* @atom_1_X7_0, align 4, !dbg !103, !tbaa !96
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !167, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !210

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !170, metadata !DIExpression()), !dbg !212
  ...
  //   %9 = load i32, i32* @atom_1_X5_0, align 4, !dbg !138, !tbaa !136
  // LD: Guess
  old_cr = cr(0,4);
