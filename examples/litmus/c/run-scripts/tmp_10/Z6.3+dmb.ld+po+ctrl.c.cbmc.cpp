...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !84, metadata !DIExpression()), !dbg !109

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !86, metadata !DIExpression()), !dbg !109

  //   store atomic i64 %2, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !88, metadata !DIExpression()), !dbg !112

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !90, metadata !DIExpression()), !dbg !112

  //   store atomic i64 %3, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !76
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !139, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !142, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !151, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !155, metadata !DIExpression()), !dbg !197
