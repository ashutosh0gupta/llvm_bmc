...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !162, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !165, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !223

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !191, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !195, metadata !DIExpression()), !dbg !255

  //   %9 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,5);
