...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !73, metadata !DIExpression()), !dbg !90

  //   %add7 = add nsw i32 0, %xor5, !dbg !84
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !84

  //   %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !84
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !74, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64 1, metadata !76, metadata !DIExpression()), !dbg !104

  //   store atomic i64 1, i64* %arrayidx9 monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !80, metadata !DIExpression()), !dbg !105

  //   %conv14 = trunc i64 %2 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !77, metadata !DIExpression()), !dbg !90
  ...
  //   %cmp22 = icmp eq i32 %conv14, 1, !dbg !100
  ...
  //   store i32 %conv23, i32* @atom_1_X9_1, align 4, !dbg !101, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !154, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !200

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X9_1, align 4, !dbg !143, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
