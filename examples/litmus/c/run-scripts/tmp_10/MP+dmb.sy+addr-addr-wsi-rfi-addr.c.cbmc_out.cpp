...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_2, metadata !151, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !154, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !197

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !158, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !163, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !215
  ...
  //   %9 = load i32, i32* @atom_1_X11_0, align 4, !dbg !139, !tbaa !136
  // LD: Guess
  old_cr = cr(0,6);
