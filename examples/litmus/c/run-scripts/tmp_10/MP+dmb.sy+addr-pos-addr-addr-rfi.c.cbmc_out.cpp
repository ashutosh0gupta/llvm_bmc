...
T1BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !49
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !56, metadata !DIExpression()), !dbg !86
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !60, metadata !DIExpression()), !dbg !89

  //   %conv = trunc i64 %0 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !57, metadata !DIExpression()), !dbg !86

  //   %xor = xor i32 %conv, %conv, !dbg !73
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !86

  //   %add = add nsw i32 2, %xor, !dbg !74
  creg_r2 = max(0,creg_r1);
  r2 = 2 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !74

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !74
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !65, metadata !DIExpression()), !dbg !94

  //   %conv4 = trunc i64 %1 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !62, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !96

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !69, metadata !DIExpression()), !dbg !96

  //   %conv8 = trunc i64 %2 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !66, metadata !DIExpression()), !dbg !86

  //   %xor9 = xor i32 %conv8, %conv8, !dbg !80
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !70, metadata !DIExpression()), !dbg !86

  //   %add11 = add nsw i32 3, %xor9, !dbg !81
  ...
  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !74, metadata !DIExpression()), !dbg !101

  //   %conv16 = trunc i64 %3 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !71, metadata !DIExpression()), !dbg !86

  //   %xor17 = xor i32 %conv16, %conv16, !dbg !84
  creg_r10 = creg_r9;
  r10 = r9 ^ r9;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !75, metadata !DIExpression()), !dbg !86

  //   %add18 = add nsw i32 0, %xor17, !dbg !85
  creg_r11 = max(0,creg_r10);
  r11 = 0 + r10;

  //   %idxprom19 = sext i32 %add18 to i64, !dbg !85

  //   %arrayidx20 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !85
  r12 = 0+r11*1;
  creg_r12 = creg_r11;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !76, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !105

  //   store atomic i64 1, i64* %arrayidx20 monotonic, align 8, !dbg !85
  // ST: Guess
  iw(2,r12) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l35_c3
  old_cw = cw(2,r12);
  cw(2,r12) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l35_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !106

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l36_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !106

  //   %conv24 = trunc i64 %4 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !79, metadata !DIExpression()), !dbg !86

  //   %cmp = icmp eq i32 %conv, 1, !dbg !90
  creg__r0__1_ = max(0,creg_r0);

  //   %conv25 = zext i1 %cmp to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !83, metadata !DIExpression()), !dbg !86

  //   store i32 %conv25, i32* @atom_1_X0_1, align 4, !dbg !91, !tbaa !92
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv24, 1, !dbg !96
  creg__r13__1_ = max(0,creg_r13);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !84, metadata !DIExpression()), !dbg !86

  //   store i32 %conv27, i32* @atom_1_X12_1, align 4, !dbg !97, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !125, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !126, metadata !DIExpression()), !dbg !166

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !127, metadata !DIExpression()), !dbg !168

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !131, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !132, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64 0, metadata !134, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !135, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64 0, metadata !137, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !141, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !144, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !147, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X12_1, metadata !148, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !181

  //   store atomic i32 0, i32* @atom_1_X12_1 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !152, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !154, metadata !DIExpression()), !dbg !191

  //   %conv = trunc i64 %4 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !151, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !155, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !157, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !159, metadata !DIExpression()), !dbg !195

  //   %conv18 = trunc i64 %5 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !156, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !160, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !161, metadata !DIExpression()), !dbg !166

  //   %7 = load i32, i32* @atom_1_X12_1, align 4, !dbg !119, !tbaa !117
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !162, metadata !DIExpression()), !dbg !166

  //   %and = and i32 %6, %7, !dbg !120
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !163, metadata !DIExpression()), !dbg !166

  //   %and21 = and i32 %conv20, %and, !dbg !121
  creg_r22 = max(creg__r18__1_,creg_r21);
  r22 = (r18==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !164, metadata !DIExpression()), !dbg !166

  //   %and22 = and i32 %conv14, %and21, !dbg !122
  creg_r23 = max(creg__r17__2_,creg_r22);
  r23 = (r17==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !165, metadata !DIExpression()), !dbg !166
