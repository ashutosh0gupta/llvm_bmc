...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !55, metadata !DIExpression()), !dbg !71
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !66, metadata !DIExpression()), !dbg !68

  //   store i32 %conv3, i32* @atom_1_X2_2, align 4, !dbg !61, !tbaa !62
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !93, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !94, metadata !DIExpression()), !dbg !123

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !95, metadata !DIExpression()), !dbg !125

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !99, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !100, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i64 0, metadata !102, metadata !DIExpression()), !dbg !128

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !74
  // ST: Guess
  iw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l40_c3
  old_cw = cw(0,0+1*1);
  cw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l40_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !105, metadata !DIExpression()), !dbg !130

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !76
  // ST: Guess
  iw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l41_c3
  old_cw = cw(0,0);
  cw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l41_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !106, metadata !DIExpression()), !dbg !132

  //   call void @llvm.dbg.value(metadata i32 0, metadata !109, metadata !DIExpression()), !dbg !132

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !78
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l42_c3
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l42_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !111, metadata !DIExpression()), !dbg !142

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l50_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !113, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !114, metadata !DIExpression()), !dbg !123
  ...
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l52_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !118, metadata !DIExpression()), !dbg !146

  //   %conv12 = trunc i64 %5 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !115, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !119, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !120, metadata !DIExpression()), !dbg !123

  //   %and = and i32 %conv14, %6, !dbg !100
  creg_r10 = max(creg__r8__2_,creg_r9);
  r10 = (r8==2) & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !121, metadata !DIExpression()), !dbg !123

  //   %and15 = and i32 %conv8, %and, !dbg !101
  creg_r11 = max(creg__r7__2_,creg_r10);
  r11 = (r7==2) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !122, metadata !DIExpression()), !dbg !123
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 57, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !105
