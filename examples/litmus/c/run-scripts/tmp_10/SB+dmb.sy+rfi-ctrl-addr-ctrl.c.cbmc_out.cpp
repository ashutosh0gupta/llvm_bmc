...
T2BLOCK7:
  ...
  //   store i32 %conv16, i32* @atom_1_X2_1, align 4, !dbg !96, !tbaa !97
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv15, 0, !dbg !101
  ...
  //   store i32 %conv18, i32* @atom_1_X8_0, align 4, !dbg !102, !tbaa !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !154, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !161, metadata !DIExpression()), !dbg !198
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !137
