...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !90, metadata !DIExpression()), !dbg !133

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %6, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !115
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !159, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !160, metadata !DIExpression()), !dbg !220

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !161, metadata !DIExpression()), !dbg !222

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !165, metadata !DIExpression()), !dbg !224

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !166, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !176, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !179, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !182, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !185, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !188, metadata !DIExpression()), !dbg !220

  //   %cmp = icmp eq i32 %conv, 1, !dbg !140

  //   %conv18 = zext i1 %cmp to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !192, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !193, metadata !DIExpression()), !dbg !220

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !144

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !197, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !199, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !201, metadata !DIExpression()), !dbg !262

  //   %conv28 = trunc i64 %8 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !198, metadata !DIExpression()), !dbg !220

  //   %cmp29 = icmp eq i32 %conv28, 2, !dbg !148

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !202, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !203, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !208, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !207, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !212, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !214, metadata !DIExpression()), !dbg !272

  //   %conv42 = trunc i64 %11 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !211, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !216, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !217, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !218, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !219, metadata !DIExpression()), !dbg !220
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
