...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv12, %conv12, !dbg !112
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !113
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ASSUME(creg_r6 >= creg_r5);
  ASSUME(active[creg_r6] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i64 1, metadata !82, metadata !DIExpression()), !dbg !133

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !92, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !96, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !100, metadata !DIExpression()), !dbg !147
  ...
  //   %cmp36 = icmp eq i32 %conv16, 1, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !104, metadata !DIExpression()), !dbg !150

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !106, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %9, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !132
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !202, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !237, metadata !DIExpression()), !dbg !307
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 100, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !193
