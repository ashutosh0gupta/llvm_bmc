...
T2BLOCK1:
  ...
  //   %cmp26 = icmp eq i32 %conv12, 2, !dbg !102
  ...
  //   store i32 %conv27, i32* @atom_1_X8_2, align 4, !dbg !103, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_2, metadata !172, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !223

  //   store atomic i32 0, i32* @atom_1_X8_2 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X12_0, metadata !178, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !227

  //   store atomic i32 0, i32* @atom_1_X12_0 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X8_2, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X12_0, align 4, !dbg !155, !tbaa !151
  // LD: Guess
  old_cr = cr(0,7);
