...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !47, metadata !DIExpression()), !dbg !76

  //   call void @llvm.dbg.value(metadata i64 1, metadata !49, metadata !DIExpression()), !dbg !76

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !77
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !51, metadata !DIExpression()), !dbg !78
  ...
  //   %xor = xor i32 %conv6, %conv6, !dbg !81
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !55, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64 1, metadata !57, metadata !DIExpression()), !dbg !83

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !82
  // ST: Guess
  iw(1,r4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l28_c3
  old_cw = cw(1,r4);
  cw(1,r4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l28_c3
  // Check
  ...
  //   store i32 %conv11, i32* @atom_0_X5_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_1, metadata !144, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !186

  //   store atomic i32 0, i32* @atom_0_X5_1 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_0_X5_1, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
