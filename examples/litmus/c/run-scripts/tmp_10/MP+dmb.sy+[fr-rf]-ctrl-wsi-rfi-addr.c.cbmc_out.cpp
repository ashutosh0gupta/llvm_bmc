...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv10, %conv10, !dbg !93
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !83, metadata !DIExpression()), !dbg !114

  //   %conv14 = trunc i64 %3 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !80, metadata !DIExpression()), !dbg !90

  //   %cmp = icmp eq i32 %conv, 1, !dbg !97
  creg__r0__1_ = max(0,creg_r0);

  //   %conv15 = zext i1 %cmp to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !84, metadata !DIExpression()), !dbg !90

  //   store i32 %conv15, i32* @atom_1_X0_1, align 4, !dbg !98, !tbaa !99
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv4, 2, !dbg !103
  creg__r1__2_ = max(0,creg_r1);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !85, metadata !DIExpression()), !dbg !90

  //   store i32 %conv17, i32* @atom_1_X2_2, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv10, 2, !dbg !105
  creg__r2__2_ = max(0,creg_r2);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !86, metadata !DIExpression()), !dbg !90

  //   store i32 %conv19, i32* @atom_1_X6_2, align 4, !dbg !106, !tbaa !99
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv14, 0, !dbg !107
  creg__r6__0_ = max(0,creg_r6);

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !87, metadata !DIExpression()), !dbg !90

  //   store i32 %conv21, i32* @atom_1_X8_0, align 4, !dbg !108, !tbaa !99
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !132, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i64 2, metadata !134, metadata !DIExpression()), !dbg !139
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !149, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !150, metadata !DIExpression()), !dbg !204

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !151, metadata !DIExpression()), !dbg !206

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !155, metadata !DIExpression()), !dbg !208

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !156, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !157, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !160, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !163, metadata !DIExpression()), !dbg !215
  ...
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l64_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l64_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !170, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !173, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !176, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !182, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !187, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !190, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !192, metadata !DIExpression()), !dbg !244
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
