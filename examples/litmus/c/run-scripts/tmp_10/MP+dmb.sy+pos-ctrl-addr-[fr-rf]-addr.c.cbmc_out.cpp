...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !95), !dbg !110
  ...
  //   %xor17 = xor i32 %conv16, %conv16, !dbg !102
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !84, metadata !DIExpression()), !dbg !96

  //   %add19 = add nsw i32 0, %xor17, !dbg !103
  creg_r9 = max(0,creg_r8);
  r9 = 0 + r8;

  //   %idxprom20 = sext i32 %add19 to i64, !dbg !103

  //   %arrayidx21 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !103
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !86, metadata !DIExpression()), !dbg !123

  //   %5 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !123
  ...
  //   %cmp26 = icmp eq i32 %conv4, 1, !dbg !112
  ...
  //   store i32 %conv27, i32* @atom_1_X2_1, align 4, !dbg !113, !tbaa !108
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv12, 0, !dbg !114
  ...
  //   store i32 %conv29, i32* @atom_1_X6_0, align 4, !dbg !115, !tbaa !108
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv16, 1, !dbg !116
  ...
  //   store i32 %conv31, i32* @atom_1_X8_1, align 4, !dbg !117, !tbaa !108
  // ST: Guess
  ...
  //   store i32 %conv33, i32* @atom_1_X10_0, align 4, !dbg !119, !tbaa !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !184, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !187, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !190, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !193, metadata !DIExpression()), !dbg !246
