...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !110), !dbg !125
  ...
  //   %cmp27 = icmp eq i32 %conv4, 1, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !94, metadata !DIExpression()), !dbg !144
  ...
  //   %cmp32 = icmp eq i32 %conv12, 0, !dbg !127
  ...
  //   store atomic i64 %8, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv16, 1, !dbg !130
  ...
  //   store atomic i64 %9, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !132
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !199, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !202, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !205, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !231, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !235, metadata !DIExpression()), !dbg !309
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !239, metadata !DIExpression()), !dbg !312
