...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !171, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i32 0, metadata !173, metadata !DIExpression()), !dbg !205

  //   store atomic i32 0, i32* @atom_2_X2_0 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X1_0, metadata !174, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !207

  //   store atomic i32 0, i32* @atom_3_X1_0 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_2_X2_0, align 4, !dbg !130, !tbaa !127
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %11 = load i32, i32* @atom_3_X1_0, align 4, !dbg !131, !tbaa !127
  // LD: Guess
  old_cr = cr(0,7);
