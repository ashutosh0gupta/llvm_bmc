...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !123, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !126, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !129, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !136, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !162

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !139, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i32 0, metadata !141, metadata !DIExpression()), !dbg !164

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !93
  // ST: Guess
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !95
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call12 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !101
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !102, !tbaa !97
  r6 = local_mem[1];

  //   %call13 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !103
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i32, i32* @atom_0_X2_1, align 4, !dbg !104, !tbaa !105
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %5 = load i32, i32* @atom_0_X3_0, align 4, !dbg !107, !tbaa !105
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %6 = load i32, i32* @atom_1_X2_1, align 4, !dbg !108, !tbaa !105
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %7 = load i32, i32* @atom_1_X3_0, align 4, !dbg !109, !tbaa !105
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
