...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !38, metadata !DIExpression()), !dbg !52
  ...
  //   %xor = xor i32 %conv, 0, !dbg !55
  creg_r1 = max(0,creg_r0);
  r1 = r0 ^ 0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !42, metadata !DIExpression()), !dbg !49

  //   %xor1 = xor i32 %conv, %xor, !dbg !56
  creg_r2 = max(creg_r0,creg_r1);
  r2 = r0 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor1, metadata !43, metadata !DIExpression()), !dbg !49

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !57

  //   %conv2 = sext i32 %xor1 to i64, !dbg !58

  //   call void @llvm.dbg.value(metadata i64 %conv2, metadata !46, metadata !DIExpression()), !dbg !57

  //   store atomic i64 %conv2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !58
  // ST: Guess
  ...
  //   %conv3 = zext i1 %cmp to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !47, metadata !DIExpression()), !dbg !49

  //   store i32 %conv3, i32* @atom_0_X0_1, align 4, !dbg !60, !tbaa !61
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !73, metadata !DIExpression()), !dbg !84

  //   %conv1 = sext i32 %conv to i64, !dbg !54

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !75, metadata !DIExpression()), !dbg !84

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !54
  // ST: Guess
  ...
  //   %conv2 = zext i1 %cmp to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !76, metadata !DIExpression()), !dbg !78

  //   store i32 %conv2, i32* @atom_1_X0_1, align 4, !dbg !56, !tbaa !57
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !91, metadata !DIExpression()), !dbg !96
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !92, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 0, metadata !94, metadata !DIExpression()), !dbg !99

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !46
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !109, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !110, metadata !DIExpression()), !dbg !133

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !111, metadata !DIExpression()), !dbg !135

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !115, metadata !DIExpression()), !dbg !137

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !116, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !117, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64 0, metadata !119, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !120, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64 2, metadata !122, metadata !DIExpression()), !dbg !142
  ...
  caddr[0] = max(caddr[0],0);
  buff(0,0+1*1) = 2;
  mem(0+1*1,cw(0,0+1*1)) = 2;
  co(0+1*1,cw(0,0+1*1))+=1;
  delta(0+1*1,cw(0,0+1*1)) = -1;
  ASSUME(creturn[0] >= cw(0,0+1*1));

  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !123, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i32 0, metadata !126, metadata !DIExpression()), !dbg !144

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !76
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !127, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i32 0, metadata !129, metadata !DIExpression()), !dbg !146

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !78
  // ST: Guess
  ...
  //   %call7 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !80
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call8 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !81
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call9 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !87
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !88, !tbaa !83
  r6 = local_mem[1];

  //   %call10 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !89
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !90, !tbaa !83
  r7 = local_mem[2];

  //   %call11 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !91
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i32, i32* @atom_0_X0_1, align 4, !dbg !92, !tbaa !93
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !130, metadata !DIExpression()), !dbg !133

  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !95, !tbaa !93
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !131, metadata !DIExpression()), !dbg !133

  //   %and = and i32 %6, %7, !dbg !96
  creg_r10 = max(creg_r8,creg_r9);
  r10 = r8 & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !132, metadata !DIExpression()), !dbg !133

  //   %cmp = icmp eq i32 %and, 1, !dbg !97
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !100
...
T0BLOCK2:
  //   %8 = bitcast i64* %thr2 to i8*, !dbg !103

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #7, !dbg !103

  //   %9 = bitcast i64* %thr1 to i8*, !dbg !103

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #7, !dbg !103

  //   %10 = bitcast i64* %thr0 to i8*, !dbg !103

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !103
