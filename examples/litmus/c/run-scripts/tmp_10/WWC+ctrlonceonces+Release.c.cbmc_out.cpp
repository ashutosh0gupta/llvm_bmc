...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !123, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !124, metadata !DIExpression()), !dbg !153

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !125, metadata !DIExpression()), !dbg !155

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !129, metadata !DIExpression()), !dbg !157

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !130, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !131, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !134, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !137, metadata !DIExpression()), !dbg !164
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
