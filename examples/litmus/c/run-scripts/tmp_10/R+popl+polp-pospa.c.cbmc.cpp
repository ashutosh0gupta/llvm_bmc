...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !71, metadata !DIExpression()), !dbg !86
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !74, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !94
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !122, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i32 0, metadata !125, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !126, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i32 0, metadata !128, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !129, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i32 0, metadata !131, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !133, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !135, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !136, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !140, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !141, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !146, metadata !DIExpression()), !dbg !149

  //   %and20 = and i32 %conv18, %and19, !dbg !122
  creg_r13 = max(creg__r7__2_,creg_r12);
  r13 = (r7==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !147, metadata !DIExpression()), !dbg !149

  //   %and21 = and i32 %conv12, %and20, !dbg !123
  creg_r14 = max(creg__r6__1_,creg_r13);
  r14 = (r6==1) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !148, metadata !DIExpression()), !dbg !149
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !127
