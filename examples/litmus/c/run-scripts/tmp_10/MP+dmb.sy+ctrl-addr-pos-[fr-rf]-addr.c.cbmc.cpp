...
T2BLOCK4:
  ...
  //   store i32 %conv29, i32* @atom_1_X7_0, align 4, !dbg !115, !tbaa !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !187, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !242

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !129
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X7_0, align 4, !dbg !163, !tbaa !160
  // LD: Guess
  old_cr = cr(0,6);
