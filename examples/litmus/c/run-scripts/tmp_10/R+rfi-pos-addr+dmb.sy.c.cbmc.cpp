...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !51, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !52, metadata !DIExpression()), !dbg !71
  ...
  // ST: Guess
  iw(1,r4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l25_c3
  old_cw = cw(1,r4);
  cw(1,r4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l25_c3
  // Check
  ...
  //   store i32 %conv9, i32* @atom_0_X3_1, align 4, !dbg !79, !tbaa !74
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_1, metadata !129, metadata !DIExpression()), !dbg !163
