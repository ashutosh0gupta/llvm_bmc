...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !63, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !64, metadata !DIExpression()), !dbg !77
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !92, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !94, metadata !DIExpression()), !dbg !108

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(3,r7);
  cr(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l41_c16
  // Check
  ...
  if(cr(3,r7) < cw(3,r7)) {
    ...
    ASSUME((!(( (cw(3,r7) < 5) && (5 < crmax(3,r7)) )))||(sforbid(r7,5)> 0));
    ASSUME((!(( (cw(3,r7) < 6) && (6 < crmax(3,r7)) )))||(sforbid(r7,6)> 0));
    ASSUME((!(( (cw(3,r7) < 7) && (7 < crmax(3,r7)) )))||(sforbid(r7,7)> 0));
    ASSUME((!(( (cw(3,r7) < 8) && (8 < crmax(3,r7)) )))||(sforbid(r7,8)> 0));
    ASSUME((!(( (cw(3,r7) < 9) && (9 < crmax(3,r7)) )))||(sforbid(r7,9)> 0));
  } else {
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !143, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X3_0, metadata !146, metadata !DIExpression()), !dbg !171
