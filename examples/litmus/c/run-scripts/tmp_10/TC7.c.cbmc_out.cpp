...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !38, metadata !DIExpression()), !dbg !54
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !40, metadata !DIExpression()), !dbg !57

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !58
  // LD: Guess
  old_cr = cr(1,0+2*1);
  cr(1,0+2*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l21_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !39, metadata !DIExpression()), !dbg !54
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !47, metadata !DIExpression()), !dbg !60

  //   %conv4 = trunc i64 %1 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !44, metadata !DIExpression()), !dbg !54

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !48, metadata !DIExpression()), !dbg !63

  //   %conv5 = sext i32 %conv4 to i64, !dbg !64

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !50, metadata !DIExpression()), !dbg !63

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !64
  // ST: Guess
  ...
  //   %conv6 = zext i1 %cmp to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !51, metadata !DIExpression()), !dbg !54

  //   store i32 %conv6, i32* @atom_0_X0_1, align 4, !dbg !66, !tbaa !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !52, metadata !DIExpression()), !dbg !54

  //   store i32 %conv8, i32* @atom_0_X2_1, align 4, !dbg !72, !tbaa !67
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !81, metadata !DIExpression()), !dbg !95

  //   %conv1 = sext i32 %conv to i64, !dbg !59

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !83, metadata !DIExpression()), !dbg !95

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !59
  // ST: Guess
  ...
  //   %conv4 = zext i1 %cmp to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !87, metadata !DIExpression()), !dbg !89

  //   store i32 %conv4, i32* @atom_1_X0_1, align 4, !dbg !63, !tbaa !64
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !122, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !125, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i32 0, metadata !128, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !129, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i32 0, metadata !131, metadata !DIExpression()), !dbg !153

  //   store atomic i32 0, i32* @atom_0_X2_1 monotonic, align 4, !dbg !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !132, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i32 0, metadata !134, metadata !DIExpression()), !dbg !155
  ...
  //   %4 = load i32, i32* @atom_0_X0_1, align 4, !dbg !100, !tbaa !101
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %5 = load i32, i32* @atom_0_X2_1, align 4, !dbg !103, !tbaa !101
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !104, !tbaa !101
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l60_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !139, metadata !DIExpression()), !dbg !140
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([88 x i8], [88 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !110
