...
T2BLOCK1:
  ...
  //   %xor = xor i32 %conv, %conv, !dbg !103
  creg_r1 = max(creg_r0,creg_r0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !116

  //   %add = add nsw i32 2, %xor, !dbg !104
  creg_r2 = max(0,creg_r1);
  ASSUME(active[creg_r2] == 2);
  r2 = 2 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !104

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !104
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ASSUME(creg_r3 >= creg_r2);
  ASSUME(active[creg_r3] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !124

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()), !dbg !124

  //   %conv4 = trunc i64 %1 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !70, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !126

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   %cmp27 = icmp eq i32 %conv4, 0, !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !96, metadata !DIExpression()), !dbg !143

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %7, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !100, metadata !DIExpression()), !dbg !146

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %8, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !128
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !198, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !275

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !146
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !201, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !277

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !148
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !233, metadata !DIExpression()), !dbg !313

  //   %10 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !184
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !237, metadata !DIExpression()), !dbg !316

  //   %11 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !187
  // LD: Guess
  old_cr = cr(0,5);
