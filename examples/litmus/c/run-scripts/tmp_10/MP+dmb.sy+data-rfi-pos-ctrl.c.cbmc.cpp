...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv9, 0, !dbg !85
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !78, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !82, metadata !DIExpression()), !dbg !88

  //   store i32 %conv14, i32* @atom_1_X0_1, align 4, !dbg !95, !tbaa !96
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv5, 1, !dbg !100
  ...
  //   store i32 %conv16, i32* @atom_1_X4_1, align 4, !dbg !101, !tbaa !96
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv9, 1, !dbg !102
  ...
  //   store i32 %conv18, i32* @atom_1_X5_1, align 4, !dbg !103, !tbaa !96
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv13, 0, !dbg !104
  ...
  //   store i32 %conv20, i32* @atom_1_X6_0, align 4, !dbg !105, !tbaa !96
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !153, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !156, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !159, metadata !DIExpression()), !dbg !204
