...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !158, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !198

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !161, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !200

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !110
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X8_0, align 4, !dbg !133, !tbaa !130
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %9 = load i32, i32* @atom_1_X10_0, align 4, !dbg !134, !tbaa !130
  // LD: Guess
  old_cr = cr(0,6);
