...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !52

  //   call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !52

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !53
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !45, metadata !DIExpression()), !dbg !55
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !60, metadata !DIExpression()), !dbg !94

  //   br label %label_2, !dbg !76
  goto T2BLOCK1;

T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !92), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !97

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !64, metadata !DIExpression()), !dbg !97

  //   %conv = trunc i64 %0 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !61, metadata !DIExpression()), !dbg !94

  //   %xor = xor i32 %conv, %conv, !dbg !81
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !94
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !82
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !67, metadata !DIExpression()), !dbg !102

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(2,r3);
  cr(2,r3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l32_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !104

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !104

  //   %conv8 = trunc i64 %2 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !94

  //   %xor9 = xor i32 %conv8, %conv8, !dbg !88
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !74, metadata !DIExpression()), !dbg !94

  //   %add11 = add nsw i32 3, %xor9, !dbg !89
  creg_r7 = max(0,creg_r6);
  r7 = 3 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !89

  //   %arrayidx13 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !89
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !76, metadata !DIExpression()), !dbg !109

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,r8);
  cr(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l35_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !109

  //   %conv16 = trunc i64 %3 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !75, metadata !DIExpression()), !dbg !94

  //   %tobool = icmp ne i32 %conv16, 0, !dbg !92
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !93), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !80, metadata !DIExpression()), !dbg !117

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !117

  //   %conv20 = trunc i64 %4 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !79, metadata !DIExpression()), !dbg !94

  //   %xor21 = xor i32 %conv20, %conv20, !dbg !101
  creg_r11 = creg_r10;
  r11 = r10 ^ r10;

  //   call void @llvm.dbg.value(metadata i32 %xor21, metadata !83, metadata !DIExpression()), !dbg !94

  //   %add23 = add nsw i32 0, %xor21, !dbg !102
  creg_r12 = max(0,creg_r11);
  r12 = 0 + r11;

  //   %idxprom24 = sext i32 %add23 to i64, !dbg !102

  //   %arrayidx25 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom24, !dbg !102
  r13 = 0+r12*1;
  creg_r13 = creg_r12;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx25, metadata !85, metadata !DIExpression()), !dbg !122

  //   %5 = load atomic i64, i64* %arrayidx25 monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,r13);
  cr(2,r13) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l40_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !87, metadata !DIExpression()), !dbg !122

  //   %conv28 = trunc i64 %5 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !84, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !105
  creg__r0__1_ = max(0,creg_r0);

  //   %conv29 = zext i1 %cmp to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !88, metadata !DIExpression()), !dbg !94

  //   store i32 %conv29, i32* @atom_1_X0_1, align 4, !dbg !106, !tbaa !107
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv4, 0, !dbg !111
  creg__r4__0_ = max(0,creg_r4);

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !89, metadata !DIExpression()), !dbg !94

  //   store i32 %conv31, i32* @atom_1_X3_0, align 4, !dbg !112, !tbaa !107
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv8, 1, !dbg !113
  creg__r5__1_ = max(0,creg_r5);

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !90, metadata !DIExpression()), !dbg !94

  //   store i32 %conv33, i32* @atom_1_X5_1, align 4, !dbg !114, !tbaa !107
  // ST: Guess
  iw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l46_c15
  old_cw = cw(2,7);
  cw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l46_c15
  // Check
  ...
  //   %cmp34 = icmp eq i32 %conv28, 0, !dbg !115
  creg__r14__0_ = max(0,creg_r14);

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !91, metadata !DIExpression()), !dbg !94

  //   store i32 %conv35, i32* @atom_1_X12_0, align 4, !dbg !116, !tbaa !107
  // ST: Guess
  iw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l48_c16
  old_cw = cw(2,8);
  cw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l48_c16
  // Check
  ASSUME(active[iw(2,8)] == 2);
  ASSUME(active[cw(2,8)] == 2);
  ASSUME(sforbid(8,cw(2,8))== 0);
  ASSUME(iw(2,8) >= creg__r14__0_);
  ASSUME(iw(2,8) >= 0);
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !139, metadata !DIExpression()), !dbg !144
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !140, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64 1, metadata !142, metadata !DIExpression()), !dbg !147

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !50
  // ST: Guess
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l54_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l54_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !157, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !158, metadata !DIExpression()), !dbg !218

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !159, metadata !DIExpression()), !dbg !220

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !163, metadata !DIExpression()), !dbg !222

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !164, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !165, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !225

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !113
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l63_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l63_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !168, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !227

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !115
  // ST: Guess
  iw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l64_c3
  old_cw = cw(0,0+3*1);
  cw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l64_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !171, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !229

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !117
  // ST: Guess
  iw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l65_c3
  old_cw = cw(0,0+2*1);
  cw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l65_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !231

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !119
  // ST: Guess
  iw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l66_c3
  old_cw = cw(0,0+1*1);
  cw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l66_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !233

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !121
  // ST: Guess
  iw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l67_c3
  old_cw = cw(0,0);
  cw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l67_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !180, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !235

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !123
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l68_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l68_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !184, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !237

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !125
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l69_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l69_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !187, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !239

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !127
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l70_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l70_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X12_0, metadata !190, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !241

  //   store atomic i32 0, i32* @atom_1_X12_0 monotonic, align 4, !dbg !129
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l71_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l71_c3
  // Check
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !131
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !132
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !133, !tbaa !134
  r16 = local_mem[0];

  //   %call19 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !138
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !139, !tbaa !134
  r17 = local_mem[1];

  //   %call20 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !141, !tbaa !134
  r18 = local_mem[2];

  //   %call21 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !254

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !196, metadata !DIExpression()), !dbg !254

  //   %conv = trunc i64 %6 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !193, metadata !DIExpression()), !dbg !218

  //   %cmp = icmp eq i32 %conv, 1, !dbg !146
  creg__r19__1_ = max(0,creg_r19);

  //   %conv22 = zext i1 %cmp to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !197, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !199, metadata !DIExpression()), !dbg !258

  //   %7 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !201, metadata !DIExpression()), !dbg !258

  //   %conv26 = trunc i64 %7 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !198, metadata !DIExpression()), !dbg !218

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !150
  creg__r20__1_ = max(0,creg_r20);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !202, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !204, metadata !DIExpression()), !dbg !262

  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l85_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !206, metadata !DIExpression()), !dbg !262

  //   %conv32 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !203, metadata !DIExpression()), !dbg !218

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !154
  creg__r21__1_ = max(0,creg_r21);

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !207, metadata !DIExpression()), !dbg !218

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !155, !tbaa !156
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !208, metadata !DIExpression()), !dbg !218

  //   %10 = load i32, i32* @atom_1_X3_0, align 4, !dbg !158, !tbaa !156
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !209, metadata !DIExpression()), !dbg !218

  //   %11 = load i32, i32* @atom_1_X5_1, align 4, !dbg !159, !tbaa !156
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !210, metadata !DIExpression()), !dbg !218

  //   %12 = load i32, i32* @atom_1_X12_0, align 4, !dbg !160, !tbaa !156
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l90_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !211, metadata !DIExpression()), !dbg !218

  //   %and = and i32 %11, %12, !dbg !161
  creg_r26 = max(creg_r24,creg_r25);
  r26 = r24 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !212, metadata !DIExpression()), !dbg !218

  //   %and35 = and i32 %10, %and, !dbg !162
  creg_r27 = max(creg_r23,creg_r26);
  r27 = r23 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !213, metadata !DIExpression()), !dbg !218

  //   %and36 = and i32 %9, %and35, !dbg !163
  creg_r28 = max(creg_r22,creg_r27);
  r28 = r22 & r27;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !214, metadata !DIExpression()), !dbg !218

  //   %and37 = and i32 %conv34, %and36, !dbg !164
  creg_r29 = max(creg__r21__1_,creg_r28);
  r29 = (r21==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !215, metadata !DIExpression()), !dbg !218

  //   %and38 = and i32 %conv28, %and37, !dbg !165
  creg_r30 = max(creg__r20__1_,creg_r29);
  r30 = (r20==1) & r29;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !216, metadata !DIExpression()), !dbg !218

  //   %and39 = and i32 %conv22, %and38, !dbg !166
  creg_r31 = max(creg__r19__1_,creg_r30);
  r31 = (r19==1) & r30;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !217, metadata !DIExpression()), !dbg !218

  //   %cmp40 = icmp eq i32 %and39, 1, !dbg !167
  creg__r31__1_ = max(0,creg_r31);

  //   br i1 %cmp40, label %if.then, label %if.end, !dbg !169
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 97, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !170
...
T0BLOCK2:
  //   %13 = bitcast i64* %thr2 to i8*, !dbg !173

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !173

  //   %14 = bitcast i64* %thr1 to i8*, !dbg !173

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %14) #7, !dbg !173

  //   %15 = bitcast i64* %thr0 to i8*, !dbg !173
