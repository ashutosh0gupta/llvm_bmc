...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !51

  //   call void @llvm.dbg.value(metadata i64 1, metadata !43, metadata !DIExpression()), !dbg !51

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !52
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !54

  //   call void @llvm.dbg.value(metadata i64 1, metadata !46, metadata !DIExpression()), !dbg !54

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !55
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !59, metadata !DIExpression()), !dbg !106

  //   br label %label_2, !dbg !88
  goto T2BLOCK1;

T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !104), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !109

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !64, metadata !DIExpression()), !dbg !109

  //   %conv = trunc i64 %0 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !60, metadata !DIExpression()), !dbg !106

  //   %xor = xor i32 %conv, %conv, !dbg !93
  creg_r1 = max(creg_r0,creg_r0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !106

  //   %add = add nsw i32 2, %xor, !dbg !94
  creg_r2 = max(0,creg_r1);
  ASSUME(active[creg_r2] == 2);
  r2 = 2 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !94

  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !94
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ASSUME(creg_r3 >= creg_r2);
  ASSUME(active[creg_r3] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !67, metadata !DIExpression()), !dbg !114

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !69, metadata !DIExpression()), !dbg !114

  //   %conv4 = trunc i64 %1 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !116

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !116

  //   %conv8 = trunc i64 %2 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !106

  //   %xor9 = xor i32 %conv8, %conv8, !dbg !100
  creg_r6 = max(creg_r5,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !74, metadata !DIExpression()), !dbg !106

  //   %add11 = add nsw i32 3, %xor9, !dbg !101
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 3 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !101

  //   %arrayidx13 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !101
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !76, metadata !DIExpression()), !dbg !121

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !121

  //   %conv16 = trunc i64 %3 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !75, metadata !DIExpression()), !dbg !106

  //   %tobool = icmp ne i32 %conv16, 0, !dbg !104

  //   br i1 %tobool, label %if.then, label %if.else, !dbg !106
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
  ASSUME(cctrl[2] >= creg_r9);
  ASSUME(cctrl[2] >= 0);
  if((r9!=0)) {
    goto T2BLOCK2;
  } else {
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !105), !dbg !128

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !80, metadata !DIExpression()), !dbg !129

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  if(cr(2,0+4*1) < cw(2,0+4*1)) {
    ...
    r10 = mem(0+4*1,cr(2,0+4*1));
  }
  ASSUME(creturn[2] >= cr(2,0+4*1));

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !129

  //   %conv20 = trunc i64 %4 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !79, metadata !DIExpression()), !dbg !106

  //   %xor21 = xor i32 %conv20, %conv20, !dbg !113
  creg_r11 = max(creg_r10,creg_r10);
  ASSUME(active[creg_r11] == 2);
  r11 = r10 ^ r10;

  //   call void @llvm.dbg.value(metadata i32 %xor21, metadata !83, metadata !DIExpression()), !dbg !106

  //   %add23 = add nsw i32 0, %xor21, !dbg !114
  creg_r12 = max(0,creg_r11);
  ASSUME(active[creg_r12] == 2);
  r12 = 0 + r11;

  //   %idxprom24 = sext i32 %add23 to i64, !dbg !114

  //   %arrayidx25 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom24, !dbg !114
  r13 = 0+r12*1;
  ASSUME(creg_r13 >= 0);
  ASSUME(creg_r13 >= creg_r12);
  ASSUME(active[creg_r13] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx25, metadata !85, metadata !DIExpression()), !dbg !134

  //   %5 = load atomic i64, i64* %arrayidx25 monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(2,r13);
  cr(2,r13) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ASSUME(active[cr(2,r13)] == 2);
  ASSUME(cr(2,r13) >= iw(2,r13));
  ASSUME(cr(2,r13) >= creg_r13);
  ASSUME(cr(2,r13) >= cdy[2]);
  ASSUME(cr(2,r13) >= cisb[2]);
  ASSUME(cr(2,r13) >= cdl[2]);
  ASSUME(cr(2,r13) >= cl[2]);
  // Update
  creg_r14 = cr(2,r13);
  crmax(2,r13) = max(crmax(2,r13),cr(2,r13));
  caddr[2] = max(caddr[2],creg_r13);
  if(cr(2,r13) < cw(2,r13)) {
    r14 = buff(2,r13);
    ASSUME((!(( (cw(2,r13) < 1) && (1 < crmax(2,r13)) )))||(sforbid(r13,1)> 0));
    ASSUME((!(( (cw(2,r13) < 2) && (2 < crmax(2,r13)) )))||(sforbid(r13,2)> 0));
    ASSUME((!(( (cw(2,r13) < 3) && (3 < crmax(2,r13)) )))||(sforbid(r13,3)> 0));
    ASSUME((!(( (cw(2,r13) < 4) && (4 < crmax(2,r13)) )))||(sforbid(r13,4)> 0));
    ASSUME((!(( (cw(2,r13) < 5) && (5 < crmax(2,r13)) )))||(sforbid(r13,5)> 0));
    ASSUME((!(( (cw(2,r13) < 6) && (6 < crmax(2,r13)) )))||(sforbid(r13,6)> 0));
    ASSUME((!(( (cw(2,r13) < 7) && (7 < crmax(2,r13)) )))||(sforbid(r13,7)> 0));
    ASSUME((!(( (cw(2,r13) < 8) && (8 < crmax(2,r13)) )))||(sforbid(r13,8)> 0));
    ASSUME((!(( (cw(2,r13) < 9) && (9 < crmax(2,r13)) )))||(sforbid(r13,9)> 0));
  } else {
    if(pw(2,r13) != co(r13,cr(2,r13))) {
      ASSUME(cr(2,r13) >= old_cr);
    }
    pw(2,r13) = co(r13,cr(2,r13));
    r14 = mem(r13,cr(2,r13));
  }
  ASSUME(creturn[2] >= cr(2,r13));

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !87, metadata !DIExpression()), !dbg !134

  //   %conv28 = trunc i64 %5 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !84, metadata !DIExpression()), !dbg !106

  //   %cmp = icmp eq i32 %conv, 1, !dbg !117

  //   %conv29 = zext i1 %cmp to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !88, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !89, metadata !DIExpression()), !dbg !137

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !119
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv4, 0, !dbg !120

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !92, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !93, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv8, 1, !dbg !123

  //   %conv37 = zext i1 %cmp36 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv37, metadata !96, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !97, metadata !DIExpression()), !dbg !143

  //   %8 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !99, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %8, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp41 = icmp eq i32 %conv28, 0, !dbg !126

  //   %conv42 = zext i1 %cmp41 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !100, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !101, metadata !DIExpression()), !dbg !146

  //   %9 = zext i32 %conv42 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !103, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %9, i64* @atom_1_X12_0 seq_cst, align 8, !dbg !128
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !151, metadata !DIExpression()), !dbg !156
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !152, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64 1, metadata !154, metadata !DIExpression()), !dbg !159

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !49
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !241

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !117

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !117

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !243

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !245

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !177, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !248

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !180, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !250

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !183, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64 0, metadata !185, metadata !DIExpression()), !dbg !252

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !254

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !130
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !256

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !132
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !192, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !195, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !260

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !136
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !198, metadata !DIExpression()), !dbg !262

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !262

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !201, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !264

  //   store atomic i64 0, i64* @atom_1_X12_0 monotonic, align 8, !dbg !140
  // ST: Guess
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !143
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !144, !tbaa !145
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call19 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !149
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !150, !tbaa !145
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   %call20 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !151
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !152, !tbaa !145
  // LD: Guess
  old_cr = cr(0,11);
  ...
  //   %call21 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !153
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !205, metadata !DIExpression()), !dbg !279

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !155
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !207, metadata !DIExpression()), !dbg !279

  //   %conv = trunc i64 %6 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !204, metadata !DIExpression()), !dbg !241

  //   %cmp = icmp eq i32 %conv, 1, !dbg !157

  //   %conv22 = zext i1 %cmp to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !208, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !210, metadata !DIExpression()), !dbg !283

  //   %7 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !159
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !212, metadata !DIExpression()), !dbg !283

  //   %conv26 = trunc i64 %7 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !209, metadata !DIExpression()), !dbg !241

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !161

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !213, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !215, metadata !DIExpression()), !dbg !287

  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !163
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  if(cr(0,0+2*1) < cw(0,0+2*1)) {
    ...
    r21 = mem(0+2*1,cr(0,0+2*1));
  }
  ASSUME(creturn[0] >= cr(0,0+2*1));

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !217, metadata !DIExpression()), !dbg !287

  //   %conv32 = trunc i64 %8 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !214, metadata !DIExpression()), !dbg !241

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !165

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !218, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !220, metadata !DIExpression()), !dbg !291

  //   %9 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !167
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !222, metadata !DIExpression()), !dbg !291

  //   %conv38 = trunc i64 %9 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !219, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !224, metadata !DIExpression()), !dbg !294

  //   %10 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !170
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !226, metadata !DIExpression()), !dbg !294

  //   %conv42 = trunc i64 %10 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !223, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !228, metadata !DIExpression()), !dbg !297

  //   %11 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !173
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !230, metadata !DIExpression()), !dbg !297

  //   %conv46 = trunc i64 %11 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !227, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !232, metadata !DIExpression()), !dbg !300

  //   %12 = load atomic i64, i64* @atom_1_X12_0 seq_cst, align 8, !dbg !176
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !234, metadata !DIExpression()), !dbg !300

  //   %conv50 = trunc i64 %12 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !231, metadata !DIExpression()), !dbg !241

  //   %and = and i32 %conv46, %conv50, !dbg !178
  creg_r26 = max(creg_r24,creg_r25);
  ASSUME(active[creg_r26] == 0);
  r26 = r24 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !235, metadata !DIExpression()), !dbg !241

  //   %and51 = and i32 %conv42, %and, !dbg !179
  creg_r27 = max(creg_r23,creg_r26);
  ASSUME(active[creg_r27] == 0);
  r27 = r23 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !236, metadata !DIExpression()), !dbg !241

  //   %and52 = and i32 %conv38, %and51, !dbg !180
  creg_r28 = max(creg_r22,creg_r27);
  ASSUME(active[creg_r28] == 0);
  r28 = r22 & r27;

  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !237, metadata !DIExpression()), !dbg !241

  //   %and53 = and i32 %conv34, %and52, !dbg !181
  creg_r29 = max(max(creg_r21,0),creg_r28);
  ASSUME(active[creg_r29] == 0);
  r29 = (r21==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !238, metadata !DIExpression()), !dbg !241

  //   %and54 = and i32 %conv28, %and53, !dbg !182
  creg_r30 = max(max(creg_r20,0),creg_r29);
  ASSUME(active[creg_r30] == 0);
  r30 = (r20==1) & r29;

  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !239, metadata !DIExpression()), !dbg !241

  //   %and55 = and i32 %conv22, %and54, !dbg !183
  creg_r31 = max(max(creg_r19,0),creg_r30);
  ASSUME(active[creg_r31] == 0);
  r31 = (r19==1) & r30;

  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !240, metadata !DIExpression()), !dbg !241

  //   %cmp56 = icmp eq i32 %and55, 1, !dbg !184

  //   br i1 %cmp56, label %if.then, label %if.end, !dbg !186
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 97, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187

  //   unreachable, !dbg !187
  r32 = 1;

T0BLOCK2:
  //   %13 = bitcast i64* %thr2 to i8*, !dbg !190

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !190

  //   %14 = bitcast i64* %thr1 to i8*, !dbg !190

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %14) #7, !dbg !190

  //   %15 = bitcast i64* %thr0 to i8*, !dbg !190
