...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !75, metadata !DIExpression()), !dbg !120

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !120

  //   %conv15 = trunc i64 %3 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !74, metadata !DIExpression()), !dbg !94
...
T2BLOCK10:
  ...
  //   %cmp28 = icmp eq i32 %conv15, 0, !dbg !123
  ...
  //   store i32 %conv29, i32* @atom_1_X7_0, align 4, !dbg !124, !tbaa !119
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv19, 1, !dbg !125
  ...
  //   store i32 %conv31, i32* @atom_1_X9_1, align 4, !dbg !126, !tbaa !119
  // ST: Guess
...
T3BLOCK1:
  ...
  // ST: Guess
  iw(3,0+4*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l58_c3
  old_cw = cw(3,0+4*1);
  cw(3,0+4*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l58_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !196, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !249

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !199, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !201, metadata !DIExpression()), !dbg !251

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !206, metadata !DIExpression()), !dbg !266

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,0+4*1);
  cr(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l85_c13
  // Check
  ...
  //   %10 = load i32, i32* @atom_1_X7_0, align 4, !dbg !158, !tbaa !156
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %11 = load i32, i32* @atom_1_X9_1, align 4, !dbg !159, !tbaa !156
  // LD: Guess
  old_cr = cr(0,7);
