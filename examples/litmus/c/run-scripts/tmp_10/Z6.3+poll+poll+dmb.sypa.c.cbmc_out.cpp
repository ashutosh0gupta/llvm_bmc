...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !72, metadata !DIExpression()), !dbg !91
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !82, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !83, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !87, metadata !DIExpression()), !dbg !105

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !89, metadata !DIExpression()), !dbg !105
