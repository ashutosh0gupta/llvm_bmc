...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !105), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !75, metadata !DIExpression()), !dbg !132

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !132

  //   %conv15 = trunc i64 %3 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !74, metadata !DIExpression()), !dbg !106
  ...
  //   %cmp30 = icmp eq i32 %conv15, 0, !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !92, metadata !DIExpression()), !dbg !146

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !128
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv19, 1, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !96, metadata !DIExpression()), !dbg !149

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %8, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !131
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !158, metadata !DIExpression()), !dbg !165
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !201, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !266

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !136
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !204, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !268

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !211, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !230, metadata !DIExpression()), !dbg !300

  //   %10 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !170
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !234, metadata !DIExpression()), !dbg !303

  //   %11 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !173
  // LD: Guess
  old_cr = cr(0,7);
