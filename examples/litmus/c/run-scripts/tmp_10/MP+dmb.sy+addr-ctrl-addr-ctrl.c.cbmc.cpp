...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !84
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !72
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !62, metadata !DIExpression()), !dbg !84
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !82), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !67, metadata !DIExpression()), !dbg !100

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !70, metadata !DIExpression()), !dbg !84

  //   %add11 = add nsw i32 4, %xor9, !dbg !85
  creg_r7 = max(0,creg_r6);
  r7 = 4 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !85

  //   %arrayidx13 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !85
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !72, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !74, metadata !DIExpression()), !dbg !105

  //   %conv16 = trunc i64 %3 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !71, metadata !DIExpression()), !dbg !84

  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !88
  creg__r9__0_ = max(0,creg_r9);

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !90
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !83), !dbg !112

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !113
  ...
  //   %conv23 = trunc i64 %4 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !75, metadata !DIExpression()), !dbg !84

  //   %cmp = icmp eq i32 %conv, 1, !dbg !97
  creg__r0__1_ = max(0,creg_r0);

  //   %conv24 = zext i1 %cmp to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !79, metadata !DIExpression()), !dbg !84

  //   store i32 %conv24, i32* @atom_1_X0_1, align 4, !dbg !98, !tbaa !99
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv23, 0, !dbg !103
  creg__r10__0_ = max(0,creg_r10);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !80, metadata !DIExpression()), !dbg !84

  //   store i32 %conv26, i32* @atom_1_X10_0, align 4, !dbg !104, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !158, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !193

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !102
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X10_0, align 4, !dbg !124, !tbaa !122
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !131
