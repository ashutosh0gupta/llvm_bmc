...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !58, metadata !DIExpression()), !dbg !78
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !60, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !62, metadata !DIExpression()), !dbg !81

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !59, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !63, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !71, metadata !DIExpression()), !dbg !89

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !71
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !89

  //   %conv8 = trunc i64 %2 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !74, metadata !DIExpression()), !dbg !78

  //   store i32 %conv9, i32* @atom_1_X0_1, align 4, !dbg !74, !tbaa !75
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv8, 0, !dbg !79
  creg__r2__0_ = max(0,creg_r2);

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !75, metadata !DIExpression()), !dbg !78

  //   store i32 %conv11, i32* @atom_1_X4_0, align 4, !dbg !80, !tbaa !75
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv4, 1, !dbg !81
  creg__r1__1_ = max(0,creg_r1);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !76, metadata !DIExpression()), !dbg !78

  //   store i32 %conv13, i32* @atom_1_X3_1, align 4, !dbg !82, !tbaa !75
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !126, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !130, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i32 0, metadata !132, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_1, metadata !133, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i32 0, metadata !135, metadata !DIExpression()), !dbg !156

  //   store atomic i32 0, i32* @atom_1_X3_1 monotonic, align 4, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !136, metadata !DIExpression()), !dbg !141

  //   %5 = load i32, i32* @atom_1_X4_0, align 4, !dbg !103, !tbaa !101
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %6 = load i32, i32* @atom_1_X3_1, align 4, !dbg !104, !tbaa !101
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !140, metadata !DIExpression()), !dbg !141
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !110
