...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !82, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !84, metadata !DIExpression()), !dbg !111
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !94, metadata !DIExpression()), !dbg !127

  //   %4 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !96, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %4, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !98, metadata !DIExpression()), !dbg !130

  //   %5 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !100, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %5, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !159, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !184, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !188, metadata !DIExpression()), !dbg !240
