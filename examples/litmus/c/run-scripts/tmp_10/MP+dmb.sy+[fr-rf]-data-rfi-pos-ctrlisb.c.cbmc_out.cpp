...
T2BLOCK1:
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !85
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !71, metadata !DIExpression()), !dbg !95

  //   %add = add nsw i32 %xor, 1, !dbg !86
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !72, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !106

  //   %conv5 = sext i32 %add to i64, !dbg !88

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !75, metadata !DIExpression()), !dbg !106

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !81, metadata !DIExpression()), !dbg !111
...
T2BLOCK4:
  ...
  //   %cmp19 = icmp eq i32 %conv4, 2, !dbg !111
  ...
  //   store i32 %conv20, i32* @atom_1_X2_2, align 4, !dbg !112, !tbaa !107
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv13, 1, !dbg !115
  ...
  //   store i32 %conv24, i32* @atom_1_X6_1, align 4, !dbg !116, !tbaa !107
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv17, 0, !dbg !117
  ...
  //   store i32 %conv26, i32* @atom_1_X7_0, align 4, !dbg !118, !tbaa !107
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !142, metadata !DIExpression()), !dbg !149
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !180, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !186, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !189, metadata !DIExpression()), !dbg !240
