...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !60, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !83
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !71
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !65, metadata !DIExpression()), !dbg !91

  //   %conv4 = trunc i64 %1 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !62, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !93

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !75
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   %tobool = icmp ne i32 %conv8, 0, !dbg !77
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !82), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !102

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !73, metadata !DIExpression()), !dbg !102

  //   %conv12 = trunc i64 %3 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !70, metadata !DIExpression()), !dbg !83

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !86
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !74, metadata !DIExpression()), !dbg !83

  //   %add15 = add nsw i32 0, %xor13, !dbg !87
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !87

  //   %arrayidx17 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !87
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !76, metadata !DIExpression()), !dbg !107

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !87
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !78, metadata !DIExpression()), !dbg !107

  //   %conv20 = trunc i64 %4 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !75, metadata !DIExpression()), !dbg !83

  //   %cmp = icmp eq i32 %conv, 1, !dbg !90
  creg__r0__1_ = max(0,creg_r0);

  //   %conv21 = zext i1 %cmp to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !79, metadata !DIExpression()), !dbg !83

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !91, !tbaa !92
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv20, 0, !dbg !96
  creg__r10__0_ = max(0,creg_r10);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !80, metadata !DIExpression()), !dbg !83

  //   store i32 %conv23, i32* @atom_1_X9_0, align 4, !dbg !97, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !148, metadata !DIExpression()), !dbg !181
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
