...
T2BLOCK2:
  //   br label %lbl_label152, !dbg !57
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label152, !dbg !58
  goto T2BLOCK4;
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !88, metadata !DIExpression()), !dbg !98
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !108, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !109, metadata !DIExpression()), !dbg !139

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !110, metadata !DIExpression()), !dbg !141

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !114, metadata !DIExpression()), !dbg !143

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !115, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !116, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i64 0, metadata !118, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !122, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i32 0, metadata !125, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !129, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !130, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !134, metadata !DIExpression()), !dbg !167

  //   %conv14 = trunc i64 %7 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !131, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !135, metadata !DIExpression()), !dbg !139

  //   %8 = load i32, i32* @atom_1_X0_2, align 4, !dbg !103, !tbaa !104
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l64_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !138, metadata !DIExpression()), !dbg !139
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([128 x i8], [128 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
