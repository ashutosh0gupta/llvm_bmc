...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !142, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !145, metadata !DIExpression()), !dbg !179

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X2_0, metadata !146, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !181

  //   store atomic i32 0, i32* @atom_3_X2_0 monotonic, align 4, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !197

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   %10 = load i32, i32* @atom_1_X0_1, align 4, !dbg !123, !tbaa !124
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %11 = load i32, i32* @atom_3_X2_0, align 4, !dbg !126, !tbaa !124
  // LD: Guess
  old_cr = cr(0,4);
