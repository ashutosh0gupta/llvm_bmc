...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !57, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !60, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64 1, metadata !62, metadata !DIExpression()), !dbg !71
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !128, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !132, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i32 0, metadata !134, metadata !DIExpression()), !dbg !159

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !89
  // ST: Guess
  ...
  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !107, !tbaa !108
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_2_X0_1, align 4, !dbg !110, !tbaa !108
  // LD: Guess
  old_cr = cr(0,4);
