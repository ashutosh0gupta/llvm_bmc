...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !54, metadata !DIExpression()), !dbg !67
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !56, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !55, metadata !DIExpression()), !dbg !67

  //   %xor = xor i32 %conv, %conv, !dbg !60
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !59, metadata !DIExpression()), !dbg !67

  //   %add = add nsw i32 1, %xor, !dbg !61
  creg_r2 = max(0,creg_r1);
  r2 = 1 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !61

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !61
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !61, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !63, metadata !DIExpression()), !dbg !75

  //   %conv4 = trunc i64 %1 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !60, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !64, metadata !DIExpression()), !dbg !67

  //   store i32 %conv5, i32* @atom_1_X0_1, align 4, !dbg !65, !tbaa !66
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !65, metadata !DIExpression()), !dbg !67

  //   store i32 %conv7, i32* @atom_1_X3_0, align 4, !dbg !71, !tbaa !66
  // ST: Guess
...
T4BLOCK1:
  ...
  // LD: Guess
  old_cr = cr(4,0+1*1);
  cr(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l46_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !106, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !108, metadata !DIExpression()), !dbg !122

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(4,r8);
  cr(4,r8) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l48_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !107, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !111, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !112, metadata !DIExpression()), !dbg !114
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !136, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !137, metadata !DIExpression()), !dbg !171

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !138, metadata !DIExpression()), !dbg !173

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !142, metadata !DIExpression()), !dbg !175

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !143, metadata !DIExpression()), !dbg !177

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !144, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !145, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !151, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !155, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !186

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !158, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X3_0, metadata !161, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !190

  //   store atomic i32 0, i32* @atom_3_X3_0 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X3_0, align 4, !dbg !119, !tbaa !117
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %11 = load i32, i32* @atom_3_X3_0, align 4, !dbg !121, !tbaa !117
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !169, metadata !DIExpression()), !dbg !171

  //   %and19 = and i32 %8, %and18, !dbg !124
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !170, metadata !DIExpression()), !dbg !171
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
