...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !53, metadata !DIExpression()), !dbg !73
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !56, metadata !DIExpression()), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !58, metadata !DIExpression()), !dbg !76

  //   %conv = trunc i64 %0 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !54, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !59, metadata !DIExpression()), !dbg !73

  //   %add = add nsw i32 1, %xor, !dbg !67
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !67
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ASSUME(creg_r3 >= creg_r2);
  ASSUME(active[creg_r3] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !61, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !63, metadata !DIExpression()), !dbg !81

  //   %conv4 = trunc i64 %1 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !60, metadata !DIExpression()), !dbg !73

  //   %cmp = icmp eq i32 %conv, 1, !dbg !70

  //   %conv5 = zext i1 %cmp to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !64, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !65, metadata !DIExpression()), !dbg !84

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !67, metadata !DIExpression()), !dbg !84

  //   store atomic i64 %2, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !72
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !69, metadata !DIExpression()), !dbg !87

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !71, metadata !DIExpression()), !dbg !87

  //   store atomic i64 %3, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !75
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !92, metadata !DIExpression()), !dbg !97
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !93, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64 1, metadata !95, metadata !DIExpression()), !dbg !100
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !105, metadata !DIExpression()), !dbg !124
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !107, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !109, metadata !DIExpression()), !dbg !127

  //   %conv = trunc i64 %0 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !106, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !110, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !112, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !114, metadata !DIExpression()), !dbg !132

  //   %conv4 = trunc i64 %1 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !111, metadata !DIExpression()), !dbg !124

  //   %cmp = icmp eq i32 %conv, 1, !dbg !70

  //   %conv5 = zext i1 %cmp to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !115, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !116, metadata !DIExpression()), !dbg !135

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !118, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !119, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X3_0, metadata !120, metadata !DIExpression()), !dbg !138

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !122, metadata !DIExpression()), !dbg !138
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !155, metadata !DIExpression()), !dbg !200

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !156, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !157, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !205
  ...
  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !169, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X3_0, metadata !172, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !213

  //   store atomic i64 0, i64* @atom_3_X3_0 monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !176, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !178, metadata !DIExpression()), !dbg !231

  //   %conv = trunc i64 %8 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !175, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !180, metadata !DIExpression()), !dbg !234

  //   %9 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !182, metadata !DIExpression()), !dbg !234

  //   %conv21 = trunc i64 %9 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !179, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !184, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !186, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X3_0, metadata !188, metadata !DIExpression()), !dbg !240

  //   %11 = load atomic i64, i64* @atom_3_X3_0 seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !190, metadata !DIExpression()), !dbg !240
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !145
