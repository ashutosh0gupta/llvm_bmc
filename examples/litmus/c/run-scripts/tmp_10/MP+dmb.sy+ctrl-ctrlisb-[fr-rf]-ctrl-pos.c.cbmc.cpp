...
T2BLOCK7:
  ...
  //   %tobool16 = icmp ne i32 %conv15, 0, !dbg !105
  creg__r3__0_ = max(0,creg_r3);

  //   br i1 %tobool16, label %if.then17, label %if.else18, !dbg !107
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !95), !dbg !129

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !130
  ...
  //   %conv22 = trunc i64 %4 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !79, metadata !DIExpression()), !dbg !96
  ...
  //   %cmp32 = icmp eq i32 %conv22, 0, !dbg !127
  ...
  //   store i32 %conv33, i32* @atom_1_X7_0, align 4, !dbg !128, !tbaa !119
  // ST: Guess
  ...
  //   store i32 %conv35, i32* @atom_1_X9_0, align 4, !dbg !130, !tbaa !119
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !201, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i32 0, metadata !203, metadata !DIExpression()), !dbg !255

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !204, metadata !DIExpression()), !dbg !257
  ...
  //   %12 = load i32, i32* @atom_1_X7_0, align 4, !dbg !164, !tbaa !160
  // LD: Guess
  old_cr = cr(0,7);
