...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !110), !dbg !144

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !145

  //   %conv22 = trunc i64 %4 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !79, metadata !DIExpression()), !dbg !111
  ...
  //   %cmp39 = icmp eq i32 %conv22, 0, !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !100, metadata !DIExpression()), !dbg !161

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !161

  //   store atomic i64 %9, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !143
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !104, metadata !DIExpression()), !dbg !164

  //   %10 = zext i32 %conv45 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !106, metadata !DIExpression()), !dbg !164

  //   store atomic i64 %10, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !146
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !216, metadata !DIExpression()), !dbg !285

  //   call void @llvm.dbg.value(metadata i64 0, metadata !218, metadata !DIExpression()), !dbg !285

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !145
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !219, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !250, metadata !DIExpression()), !dbg !323

  //   %12 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !183
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !254, metadata !DIExpression()), !dbg !326
