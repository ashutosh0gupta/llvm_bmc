...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X1_0, metadata !230, metadata !DIExpression()), !dbg !283
  ...
  // ST: Guess
  iw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l96_c3
  old_cw = cw(0,11);
  cw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l96_c3
  // Check
