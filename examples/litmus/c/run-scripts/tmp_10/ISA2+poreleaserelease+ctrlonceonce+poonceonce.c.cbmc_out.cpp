...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !62, metadata !DIExpression()), !dbg !69
...
T2BLOCK2:
  //   br label %lbl_label130, !dbg !61
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label130, !dbg !62
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !68), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !66, metadata !DIExpression()), !dbg !69
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !99, metadata !DIExpression()), !dbg !111

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !58
  // LD: Guess
  old_cr = cr(3,0+1*1);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !143, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !147, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !150, metadata !DIExpression()), !dbg !175
