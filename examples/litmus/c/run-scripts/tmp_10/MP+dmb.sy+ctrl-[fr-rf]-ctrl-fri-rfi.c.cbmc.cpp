...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !81, metadata !DIExpression()), !dbg !121

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv4, 0, !dbg !113
  ...
  //   store i32 %conv22, i32* @atom_1_X2_0, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   store i32 %conv24, i32* @atom_1_X4_1, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   store i32 %conv26, i32* @atom_1_X5_0, align 4, !dbg !118, !tbaa !109
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv19, 1, !dbg !119
  ...
  //   store i32 %conv28, i32* @atom_1_X8_1, align 4, !dbg !120, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !182, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !185, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !188, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !240

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !191, metadata !DIExpression()), !dbg !242
  ...
  //   %12 = load i32, i32* @atom_1_X5_0, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
