...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !49
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !56, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !72

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !60
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !62, metadata !DIExpression()), !dbg !72
  ...
  //   store i32 %conv5, i32* @atom_1_X0_1, align 4, !dbg !63, !tbaa !64
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !86, metadata !DIExpression()), !dbg !91
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !87, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64 1, metadata !89, metadata !DIExpression()), !dbg !94

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !50
  // ST: Guess
  //   : Release
  iw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l39_c3
  old_cw = cw(3,0+1*1);
  cw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l39_c3
  // Check
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !99, metadata !DIExpression()), !dbg !111
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !101, metadata !DIExpression()), !dbg !114

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !57
  // LD: Guess
  old_cr = cr(4,0+1*1);
  cr(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l45_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !103, metadata !DIExpression()), !dbg !114

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !100, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !105, metadata !DIExpression()), !dbg !118

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(4,0);
  cr(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l47_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !107, metadata !DIExpression()), !dbg !118
  ...
  //   store i32 %conv5, i32* @atom_3_X0_1, align 4, !dbg !64, !tbaa !65
  // ST: Guess
  iw(4,4) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l49_c15
  old_cw = cw(4,4);
  cw(4,4) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l49_c15
  // Check
  ASSUME(active[iw(4,4)] == 4);
  ASSUME(active[cw(4,4)] == 4);
  ASSUME(sforbid(4,cw(4,4))== 0);
  ASSUME(iw(4,4) >= creg__r2__1_);
  ASSUME(iw(4,4) >= 0);
  ...
  //   store i32 %conv7, i32* @atom_3_X2_0, align 4, !dbg !70, !tbaa !65
  // ST: Guess
  iw(4,5) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l51_c15
  old_cw = cw(4,5);
  cw(4,5) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l51_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !133, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !134, metadata !DIExpression()), !dbg !168

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !135, metadata !DIExpression()), !dbg !170

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !139, metadata !DIExpression()), !dbg !172

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !140, metadata !DIExpression()), !dbg !174

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !141, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !142, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !148, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !181

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !152, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !183

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !155, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !185

  //   store atomic i32 0, i32* @atom_3_X0_1 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X2_0, metadata !158, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !187

  //   store atomic i32 0, i32* @atom_3_X2_0 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !116, !tbaa !117
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %9 = load i32, i32* @atom_1_X2_0, align 4, !dbg !119, !tbaa !117
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %10 = load i32, i32* @atom_3_X0_1, align 4, !dbg !120, !tbaa !117
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !163, metadata !DIExpression()), !dbg !168

  //   %11 = load i32, i32* @atom_3_X2_0, align 4, !dbg !121, !tbaa !117
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !164, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !166, metadata !DIExpression()), !dbg !168

  //   %and19 = and i32 %8, %and18, !dbg !124
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !167, metadata !DIExpression()), !dbg !168
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([131 x i8], [131 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
