...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !74, metadata !DIExpression()), !dbg !91
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64 2, metadata !77, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !78, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !82, metadata !DIExpression()), !dbg !91

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !65

  //   %conv5 = zext i1 %cmp to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !86, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !87, metadata !DIExpression()), !dbg !103

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !89, metadata !DIExpression()), !dbg !103
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !129, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64 0, metadata !131, metadata !DIExpression()), !dbg !167

  //   store atomic i64 0, i64* @atom_0_X5_2 monotonic, align 8, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !132, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64 0, metadata !134, metadata !DIExpression()), !dbg !169

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !146, metadata !DIExpression()), !dbg !189

  //   %6 = load atomic i64, i64* @atom_0_X5_2 seq_cst, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !150, metadata !DIExpression()), !dbg !192

  //   %7 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,4);
