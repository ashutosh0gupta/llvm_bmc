...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !90), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !70, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64 1, metadata !72, metadata !DIExpression()), !dbg !108

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !90
  // ST: Guess
...
T2BLOCK7:
  ...
  //   store i32 %conv22, i32* @atom_1_X7_1, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv12, 2, !dbg !115
  ...
  //   store i32 %conv24, i32* @atom_1_X8_2, align 4, !dbg !116, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !183, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_2, metadata !186, metadata !DIExpression()), !dbg !236
