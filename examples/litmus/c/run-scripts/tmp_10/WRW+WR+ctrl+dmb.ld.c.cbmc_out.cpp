...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !59, metadata !DIExpression()), !dbg !79
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !85, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !103
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !131, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !134, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !143, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !147, metadata !DIExpression()), !dbg !187
