...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !80, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !84, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !87, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !88, metadata !DIExpression()), !dbg !92

  //   store i32 %conv10, i32* @atom_1_X0_1, align 4, !dbg !84, !tbaa !85
  // ST: Guess
  ...
  //   %cmp11 = icmp eq i32 %conv4, 1, !dbg !89
  creg__r4__1_ = max(0,creg_r4);

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !89, metadata !DIExpression()), !dbg !92

  //   store i32 %conv12, i32* @atom_1_X2_1, align 4, !dbg !90, !tbaa !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !142, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !146, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !149, metadata !DIExpression()), !dbg !184
