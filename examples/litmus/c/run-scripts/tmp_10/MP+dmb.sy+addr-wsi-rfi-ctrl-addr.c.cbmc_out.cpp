...
T2BLOCK4:
  ...
  //   %xor11 = xor i32 %conv10, %conv10, !dbg !92
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor11, metadata !78, metadata !DIExpression()), !dbg !88

  //   %add13 = add nsw i32 0, %xor11, !dbg !93
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom14 = sext i32 %add13 to i64, !dbg !93

  //   %arrayidx15 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom14, !dbg !93
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx15, metadata !80, metadata !DIExpression()), !dbg !113

  //   %3 = load atomic i64, i64* %arrayidx15 monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,r8);
  cr(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l38_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !113
