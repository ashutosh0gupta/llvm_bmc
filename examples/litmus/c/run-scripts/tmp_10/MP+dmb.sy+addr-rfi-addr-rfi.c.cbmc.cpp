...
T2BLOCK1:
  ...
  //   %cmp16 = icmp eq i32 %conv4, 1, !dbg !88
  ...
  //   store i32 %conv17, i32* @atom_1_X5_1, align 4, !dbg !89, !tbaa !84
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !135, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !139, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !142, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i32 0, metadata !144, metadata !DIExpression()), !dbg !183

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X5_1, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X9_1, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
