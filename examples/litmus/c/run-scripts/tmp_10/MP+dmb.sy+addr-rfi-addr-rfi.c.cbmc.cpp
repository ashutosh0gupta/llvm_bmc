...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !146, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !149, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64 0, metadata !151, metadata !DIExpression()), !dbg !199

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !172, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !176, metadata !DIExpression()), !dbg !229

  //   %9 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,5);
