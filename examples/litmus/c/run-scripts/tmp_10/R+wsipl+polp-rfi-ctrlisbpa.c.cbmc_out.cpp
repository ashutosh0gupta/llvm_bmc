...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64 3, metadata !74, metadata !DIExpression()), !dbg !93

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !62
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !95
...
T2BLOCK4:
  ...
  //   store i32 %conv7, i32* @atom_1_X4_1, align 4, !dbg !79, !tbaa !80
  // ST: Guess
  ...
  //   store i32 %conv9, i32* @atom_1_X5_0, align 4, !dbg !85, !tbaa !80
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_3, metadata !135, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !139, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i32 0, metadata !141, metadata !DIExpression()), !dbg !173

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !142, metadata !DIExpression()), !dbg !175
  ...
  //   %7 = load i32, i32* @atom_1_X4_1, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
