...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !95, metadata !DIExpression()), !dbg !113
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !97, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !101, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !103, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !105, metadata !DIExpression()), !dbg !123

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !107, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !108, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !109, metadata !DIExpression()), !dbg !126

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !111, metadata !DIExpression()), !dbg !126
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !132, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !135, metadata !DIExpression()), !dbg !145
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !179, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !193, metadata !DIExpression()), !dbg !251
