...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64 3, metadata !72, metadata !DIExpression()), !dbg !85

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !54
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !73, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !89
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_3, metadata !115, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !119, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i32 0, metadata !121, metadata !DIExpression()), !dbg !148

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !87
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X4_0, align 4, !dbg !109, !tbaa !107
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
