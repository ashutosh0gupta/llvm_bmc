...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !39, metadata !DIExpression()), !dbg !53

  //   call void @llvm.dbg.value(metadata i64 2, metadata !42, metadata !DIExpression()), !dbg !53

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !54
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !43, metadata !DIExpression()), !dbg !55

  //   call void @llvm.dbg.value(metadata i64 3, metadata !45, metadata !DIExpression()), !dbg !55

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !56
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !46, metadata !DIExpression()), !dbg !57

  //   call void @llvm.dbg.value(metadata i64 4, metadata !48, metadata !DIExpression()), !dbg !57

  //   store atomic i64 4, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !58
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !62, metadata !DIExpression()), !dbg !74
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !64, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !66, metadata !DIExpression()), !dbg !77

  //   %conv = trunc i64 %0 to i32, !dbg !56

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !63, metadata !DIExpression()), !dbg !74

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !74

  //   %cmp = icmp eq i32 %conv, 4, !dbg !60
  creg__r0__4_ = max(0,creg_r0);

  //   %conv5 = zext i1 %cmp to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !71, metadata !DIExpression()), !dbg !74

  //   store i32 %conv5, i32* @atom_1_X2_4, align 4, !dbg !61, !tbaa !62
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv4, 1, !dbg !66
  creg__r1__1_ = max(0,creg_r1);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !72, metadata !DIExpression()), !dbg !74

  //   store i32 %conv7, i32* @atom_1_X4_1, align 4, !dbg !67, !tbaa !62
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !94, metadata !DIExpression()), !dbg !110
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !95, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64 1, metadata !97, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !98, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !101, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64 1, metadata !103, metadata !DIExpression()), !dbg !117

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !63
  // ST: Guess
  //   : Release
  iw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l42_c3
  old_cw = cw(3,0);
  cw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l42_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !105, metadata !DIExpression()), !dbg !119

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(3,0);
  cr(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l43_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !108, metadata !DIExpression()), !dbg !110

  //   store i32 %conv5, i32* @atom_2_X4_2, align 4, !dbg !68, !tbaa !69
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !132, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !133, metadata !DIExpression()), !dbg !161

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !134, metadata !DIExpression()), !dbg !163

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !138, metadata !DIExpression()), !dbg !165

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !139, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !140, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !143, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X4_2, metadata !146, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !172

  //   store atomic i32 0, i32* @atom_2_X4_2 monotonic, align 4, !dbg !83
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_4, metadata !150, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !174

  //   store atomic i32 0, i32* @atom_1_X2_4 monotonic, align 4, !dbg !85
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !153, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !176

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !87
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !89
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !90
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !91, !tbaa !92
  r4 = local_mem[0];

  //   %call11 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !96
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !97, !tbaa !92
  r5 = local_mem[1];

  //   %call12 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !98
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !99, !tbaa !92
  r6 = local_mem[2];

  //   %call13 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !100
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i32, i32* @atom_2_X4_2, align 4, !dbg !101, !tbaa !102
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %7 = load i32, i32* @atom_1_X2_4, align 4, !dbg !104, !tbaa !102
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %8 = load i32, i32* @atom_1_X4_1, align 4, !dbg !105, !tbaa !102
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %and = and i32 %7, %8, !dbg !106
  creg_r10 = max(creg_r8,creg_r9);
  r10 = r8 & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !159, metadata !DIExpression()), !dbg !161

  //   %and14 = and i32 %6, %and, !dbg !107
  creg_r11 = max(creg_r10,creg_r7);
  r11 = r7 & r10;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !160, metadata !DIExpression()), !dbg !161

  //   %cmp = icmp eq i32 %and14, 1, !dbg !108
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([97 x i8], [97 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
