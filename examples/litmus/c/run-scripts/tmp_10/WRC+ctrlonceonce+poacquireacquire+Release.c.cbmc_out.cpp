...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !57, metadata !DIExpression()), !dbg !67

  //   %tobool = icmp ne i32 %conv1, 0, !dbg !61

  //   br i1 %tobool, label %if.then, label %if.else, !dbg !63
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
  ASSUME(cctrl[2] >= max(creg_r0,0));
  ASSUME(cctrl[2] >= 0);
  if(((r0==0)!=0)) {
    goto T2BLOCK2;
  } else {
...
T2BLOCK2:
  //   br label %lbl_label53, !dbg !64
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label53, !dbg !65
  goto T2BLOCK4;
...
T2BLOCK4:
  ...
  //   %cmp2 = icmp eq i32 %conv, 1, !dbg !69

  //   %conv3 = zext i1 %cmp2 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !61, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !62, metadata !DIExpression()), !dbg !83

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !64, metadata !DIExpression()), !dbg !83
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !90, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !94, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !96, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !98, metadata !DIExpression()), !dbg !116

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !100, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !102, metadata !DIExpression()), !dbg !119

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !104, metadata !DIExpression()), !dbg !119
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !136, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !143, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !146, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !149, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !153, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !157, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !156, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !161, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !163, metadata !DIExpression()), !dbg !202

  //   %conv21 = trunc i64 %8 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !160, metadata !DIExpression()), !dbg !166
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([126 x i8], [126 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
