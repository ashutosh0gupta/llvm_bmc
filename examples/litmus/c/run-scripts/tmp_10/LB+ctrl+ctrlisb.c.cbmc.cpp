...
T1BLOCK1:
  //   call void @llvm.dbg.label(metadata !46), !dbg !50
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !47), !dbg !59
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !45, metadata !DIExpression()), !dbg !48
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !73, metadata !DIExpression()), !dbg !85
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !107, metadata !DIExpression()), !dbg !130

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !108, metadata !DIExpression()), !dbg !130

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !109, metadata !DIExpression()), !dbg !132

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !113, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !114, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64 0, metadata !116, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !120, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i32 0, metadata !123, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !124, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i32 0, metadata !126, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !127, metadata !DIExpression()), !dbg !130

  //   %5 = load i32, i32* @atom_1_X0_1, align 4, !dbg !89, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l57_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !129, metadata !DIExpression()), !dbg !130
