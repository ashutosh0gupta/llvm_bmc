...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !169, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !221

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !172, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !223

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !121
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X2_0, align 4, !dbg !151, !tbaa !149
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X4_0, align 4, !dbg !152, !tbaa !149
  // LD: Guess
  old_cr = cr(0,5);
