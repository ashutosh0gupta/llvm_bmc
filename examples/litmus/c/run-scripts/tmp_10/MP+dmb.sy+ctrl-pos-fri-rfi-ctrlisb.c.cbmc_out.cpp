...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv, 0, !dbg !96
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !107), !dbg !120

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !121

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !121

  //   %conv4 = trunc i64 %1 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !124

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !124

  //   %conv8 = trunc i64 %2 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !127

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !78, metadata !DIExpression()), !dbg !109

  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !113

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !115
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !108), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !139

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv19 = trunc i64 %4 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !82, metadata !DIExpression()), !dbg !109

  //   %cmp = icmp eq i32 %conv, 1, !dbg !123

  //   %conv20 = zext i1 %cmp to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !86, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !143

  //   %5 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv4, 0, !dbg !126

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !90, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !91, metadata !DIExpression()), !dbg !146

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !128
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv8, 0, !dbg !129

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !94, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !95, metadata !DIExpression()), !dbg !149

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %7, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !131
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv12, 1, !dbg !132

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !98, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !99, metadata !DIExpression()), !dbg !152

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %8, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv19, 0, !dbg !135

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !102, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !103, metadata !DIExpression()), !dbg !155

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %9, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !137
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !165, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !166, metadata !DIExpression()), !dbg !238

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !167, metadata !DIExpression()), !dbg !240

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !171, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !172, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !243

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !245

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !247

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !181, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !249

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !184, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !251

  //   store atomic i64 0, i64* @atom_1_X2_0 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !187, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !253

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !190, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !255

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !137
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !193, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !257

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !139
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !141
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !142, !tbaa !143
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !147
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !148, !tbaa !143
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !149
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !197, metadata !DIExpression()), !dbg !269

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !199, metadata !DIExpression()), !dbg !269

  //   %conv = trunc i64 %4 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !196, metadata !DIExpression()), !dbg !238

  //   %cmp = icmp eq i32 %conv, 1, !dbg !153

  //   %conv18 = zext i1 %cmp to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !200, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !202, metadata !DIExpression()), !dbg !273

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !155
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !204, metadata !DIExpression()), !dbg !273

  //   %conv22 = trunc i64 %5 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !201, metadata !DIExpression()), !dbg !238

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !157

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !205, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !207, metadata !DIExpression()), !dbg !277

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !159
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !209, metadata !DIExpression()), !dbg !277

  //   %conv28 = trunc i64 %6 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !206, metadata !DIExpression()), !dbg !238

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !161

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !210, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !212, metadata !DIExpression()), !dbg !281

  //   %7 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !163
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !214, metadata !DIExpression()), !dbg !281

  //   %conv34 = trunc i64 %7 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !211, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !216, metadata !DIExpression()), !dbg !284

  //   %8 = load atomic i64, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !166
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !218, metadata !DIExpression()), !dbg !284

  //   %conv38 = trunc i64 %8 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !215, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !220, metadata !DIExpression()), !dbg !287

  //   %9 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !169
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !222, metadata !DIExpression()), !dbg !287

  //   %conv42 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !219, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !224, metadata !DIExpression()), !dbg !290

  //   %10 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !172
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !226, metadata !DIExpression()), !dbg !290

  //   %conv46 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !223, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !228, metadata !DIExpression()), !dbg !293

  //   %11 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !175
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !230, metadata !DIExpression()), !dbg !293

  //   %conv50 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !227, metadata !DIExpression()), !dbg !238

  //   %and = and i32 %conv46, %conv50, !dbg !177
  ...
  //   %and51 = and i32 %conv42, %and, !dbg !178
  creg_r17 = max(creg_r13,creg_r16);
  ASSUME(active[creg_r17] == 0);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !232, metadata !DIExpression()), !dbg !238

  //   %and52 = and i32 %conv38, %and51, !dbg !179
  creg_r18 = max(creg_r12,creg_r17);
  ASSUME(active[creg_r18] == 0);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !233, metadata !DIExpression()), !dbg !238

  //   %and53 = and i32 %conv34, %and52, !dbg !180
  creg_r19 = max(creg_r11,creg_r18);
  ASSUME(active[creg_r19] == 0);
  r19 = r11 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !234, metadata !DIExpression()), !dbg !238

  //   %and54 = and i32 %conv30, %and53, !dbg !181
  creg_r20 = max(max(creg_r10,0),creg_r19);
  ASSUME(active[creg_r20] == 0);
  r20 = (r10==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !235, metadata !DIExpression()), !dbg !238

  //   %and55 = and i32 %conv24, %and54, !dbg !182
  creg_r21 = max(max(creg_r9,0),creg_r20);
  ASSUME(active[creg_r21] == 0);
  r21 = (r9==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !236, metadata !DIExpression()), !dbg !238

  //   %and56 = and i32 %conv18, %and55, !dbg !183
  creg_r22 = max(max(creg_r8,0),creg_r21);
  ASSUME(active[creg_r22] == 0);
  r22 = (r8==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !237, metadata !DIExpression()), !dbg !238

  //   %cmp57 = icmp eq i32 %and56, 1, !dbg !184

  //   br i1 %cmp57, label %if.then, label %if.end, !dbg !186
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !187
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #6, !dbg !190

  //   %13 = bitcast i64* %thr0 to i8*, !dbg !190

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #6, !dbg !190
