...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !110), !dbg !134

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !76, metadata !DIExpression()), !dbg !135

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !135

  //   %conv15 = trunc i64 %3 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !75, metadata !DIExpression()), !dbg !111

  //   %xor = xor i32 %conv15, %conv15, !dbg !119
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !111
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !120
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ASSUME(creg_r6 >= creg_r5);
  ASSUME(active[creg_r6] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !80, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !142

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv23 = trunc i64 %5 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !84, metadata !DIExpression()), !dbg !111

  //   %cmp = icmp eq i32 %conv, 1, !dbg !126

  //   %conv24 = zext i1 %cmp to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !88, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !89, metadata !DIExpression()), !dbg !146

  //   %6 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !146
  ...
  //   %cmp26 = icmp eq i32 %conv4, 0, !dbg !129

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !92, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !93, metadata !DIExpression()), !dbg !149

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !149
  ...
  //   %cmp31 = icmp eq i32 %conv8, 1, !dbg !132

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !96, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !97, metadata !DIExpression()), !dbg !152

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !99, metadata !DIExpression()), !dbg !152
  ...
  //   %cmp36 = icmp eq i32 %conv19, 0, !dbg !135

  //   %conv37 = zext i1 %cmp36 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv37, metadata !100, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !101, metadata !DIExpression()), !dbg !155

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !103, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !137
  // ST: Guess
  ...
  //   %cmp41 = icmp eq i32 %conv23, 0, !dbg !138

  //   %conv42 = zext i1 %cmp41 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !104, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !105, metadata !DIExpression()), !dbg !158

  //   %10 = zext i32 %conv42 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !107, metadata !DIExpression()), !dbg !158

  //   store atomic i64 %10, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !140
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !164, metadata !DIExpression()), !dbg !171
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !181, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !182, metadata !DIExpression()), !dbg !258

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !183, metadata !DIExpression()), !dbg !260

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !126

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !126

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !187, metadata !DIExpression()), !dbg !262

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !128

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !128

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !188, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !189, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !192, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !195, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !198, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !201, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !204, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !207, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !210, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !279

  //   store atomic i64 0, i64* @atom_1_X8_0 monotonic, align 8, !dbg !145
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !213, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !281

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !147
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !217, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !219, metadata !DIExpression()), !dbg !296

  //   %conv = trunc i64 %6 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !216, metadata !DIExpression()), !dbg !258

  //   %cmp = icmp eq i32 %conv, 1, !dbg !164

  //   %conv22 = zext i1 %cmp to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !220, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !222, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !224, metadata !DIExpression()), !dbg !300

  //   %conv26 = trunc i64 %7 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !221, metadata !DIExpression()), !dbg !258

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !168

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !225, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !227, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !229, metadata !DIExpression()), !dbg !304

  //   %conv32 = trunc i64 %8 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !226, metadata !DIExpression()), !dbg !258

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !172

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !172

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !230, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !232, metadata !DIExpression()), !dbg !308
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !234, metadata !DIExpression()), !dbg !308

  //   %conv38 = trunc i64 %9 to i32, !dbg !175

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !231, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !236, metadata !DIExpression()), !dbg !311
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !238, metadata !DIExpression()), !dbg !311

  //   %conv42 = trunc i64 %10 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !235, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !240, metadata !DIExpression()), !dbg !314
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !242, metadata !DIExpression()), !dbg !314

  //   %conv46 = trunc i64 %11 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !239, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !244, metadata !DIExpression()), !dbg !317

  //   %12 = load atomic i64, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !183
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !246, metadata !DIExpression()), !dbg !317

  //   %conv50 = trunc i64 %12 to i32, !dbg !184

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !243, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !248, metadata !DIExpression()), !dbg !320

  //   %13 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !186
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !250, metadata !DIExpression()), !dbg !320

  //   %conv54 = trunc i64 %13 to i32, !dbg !187

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !247, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !251, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !252, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !253, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !254, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !255, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !256, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !257, metadata !DIExpression()), !dbg !258
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 102, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !198
