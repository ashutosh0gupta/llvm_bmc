...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !68, metadata !DIExpression()), !dbg !98

  //   %conv8 = trunc i64 %2 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !65, metadata !DIExpression()), !dbg !83

  //   %xor = xor i32 %conv8, %conv8, !dbg !82
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;
  ...
  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !73, metadata !DIExpression()), !dbg !103

  //   %conv12 = trunc i64 %3 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !70, metadata !DIExpression()), !dbg !83

  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !86
  creg__r6__0_ = max(0,creg_r6);

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !88
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !82), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !77, metadata !DIExpression()), !dbg !112

  //   %conv19 = trunc i64 %4 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !74, metadata !DIExpression()), !dbg !83

  //   %cmp = icmp eq i32 %conv, 1, !dbg !96
  creg__r0__1_ = max(0,creg_r0);

  //   %conv20 = zext i1 %cmp to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !78, metadata !DIExpression()), !dbg !83

  //   store i32 %conv20, i32* @atom_1_X0_1, align 4, !dbg !97, !tbaa !98
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv19, 0, !dbg !102
  creg__r7__0_ = max(0,creg_r7);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !79, metadata !DIExpression()), !dbg !83

  //   store i32 %conv22, i32* @atom_1_X8_0, align 4, !dbg !103, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !141, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !150, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i32 0, metadata !153, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !154, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !187

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !160, metadata !DIExpression()), !dbg !197

  //   %conv = trunc i64 %4 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !157, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !161, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !165, metadata !DIExpression()), !dbg !201

  //   %conv18 = trunc i64 %5 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !162, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !166, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !167, metadata !DIExpression()), !dbg !172

  //   %7 = load i32, i32* @atom_1_X8_0, align 4, !dbg !119, !tbaa !117
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !168, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !170, metadata !DIExpression()), !dbg !172

  //   %and22 = and i32 %conv14, %and21, !dbg !122
  creg_r17 = max(creg__r11__1_,creg_r16);
  r17 = (r11==1) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !171, metadata !DIExpression()), !dbg !172
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !126
