...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !71), !dbg !76
...
T2BLOCK4:
  ...
  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !70
  creg__r1__0_ = max(0,creg_r1);

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !72
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !73), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !65, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !69, metadata !DIExpression()), !dbg !74

  //   store i32 %conv12, i32* @atom_1_X0_1, align 4, !dbg !81, !tbaa !82
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv11, 0, !dbg !86
  creg__r2__0_ = max(0,creg_r2);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !70, metadata !DIExpression()), !dbg !74

  //   store i32 %conv14, i32* @atom_1_X4_0, align 4, !dbg !87, !tbaa !82
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !131, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !135, metadata !DIExpression()), !dbg !166
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !121
