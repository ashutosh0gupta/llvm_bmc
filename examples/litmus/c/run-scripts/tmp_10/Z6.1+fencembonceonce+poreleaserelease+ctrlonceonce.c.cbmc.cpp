...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !39, metadata !DIExpression()), !dbg !49
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !55, metadata !DIExpression()), !dbg !65
  ...
  // ST: Guess
  //   : Release
  iw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l27_c3
  old_cw = cw(2,0);
  cw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l27_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !58, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64 1, metadata !60, metadata !DIExpression()), !dbg !67
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !77, metadata !DIExpression()), !dbg !84

  //   %tobool = icmp ne i32 %conv1, 0, !dbg !54
  ...
  ASSUME(cctrl[3] >= creg___r0__0___0_);
  if(((r0==0)!=0)) {
    goto T3BLOCK2;
  } else {
    goto T3BLOCK3;
...
T3BLOCK2:
  //   br label %lbl_label153, !dbg !57
  goto T3BLOCK4;

T3BLOCK3:
  //   br label %lbl_label153, !dbg !58
  goto T3BLOCK4;

T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !83), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !78, metadata !DIExpression()), !dbg !97
  ...
  //   %cmp2 = icmp eq i32 %conv, 1, !dbg !62
  creg__r0__1_ = max(0,creg_r0);

  //   %conv3 = zext i1 %cmp2 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !81, metadata !DIExpression()), !dbg !84

  //   store i32 %conv3, i32* @atom_2_X0_1, align 4, !dbg !63, !tbaa !64
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !120, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !130, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !135, metadata !DIExpression()), !dbg !173

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !137, metadata !DIExpression()), !dbg !173

  //   %conv = trunc i64 %6 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !134, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !138, metadata !DIExpression()), !dbg !147
  ...
  //   %7 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !142, metadata !DIExpression()), !dbg !177

  //   %conv16 = trunc i64 %7 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !139, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !143, metadata !DIExpression()), !dbg !147
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([135 x i8], [135 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
