...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !115, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i32 0, metadata !118, metadata !DIExpression()), !dbg !146

  //   store atomic i32 0, i32* @atom_0_X4_2 monotonic, align 4, !dbg !85
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !119, metadata !DIExpression()), !dbg !148
  ...
  //   %6 = load i32, i32* @atom_0_X4_2, align 4, !dbg !106, !tbaa !107
  // LD: Guess
  old_cr = cr(0,2);
