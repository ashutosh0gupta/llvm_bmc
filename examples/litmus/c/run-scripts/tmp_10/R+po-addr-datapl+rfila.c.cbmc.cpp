...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !42, metadata !DIExpression()), !dbg !66

  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !68
  ...
  //   %xor5 = xor i32 %conv4, %conv4, !dbg !75
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !52, metadata !DIExpression()), !dbg !63

  //   %add6 = add nsw i32 %xor5, 1, !dbg !76
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !53, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !54, metadata !DIExpression()), !dbg !77

  //   %conv9 = sext i32 %add6 to i64, !dbg !78

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !56, metadata !DIExpression()), !dbg !77

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !78
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !58, metadata !DIExpression()), !dbg !79

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(1,0);
  cr(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l28_c16
  // Check
  ...
  //   %conv13 = trunc i64 %2 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !57, metadata !DIExpression()), !dbg !63

  //   %cmp = icmp eq i32 %conv13, 2, !dbg !82
  creg__r7__2_ = max(0,creg_r7);

  //   %conv14 = zext i1 %cmp to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !61, metadata !DIExpression()), !dbg !63

  //   store i32 %conv14, i32* @atom_0_X8_2, align 4, !dbg !83, !tbaa !84
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !91, metadata !DIExpression()), !dbg !106
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !92, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64 2, metadata !94, metadata !DIExpression()), !dbg !109

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !58
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !96, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !95, metadata !DIExpression()), !dbg !106
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !99, metadata !DIExpression()), !dbg !106

  //   %cmp = icmp eq i32 %conv4, 3, !dbg !65
  creg__r9__3_ = max(0,creg_r9);

  //   %conv5 = zext i1 %cmp to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !103, metadata !DIExpression()), !dbg !106

  //   store i32 %conv5, i32* @atom_1_X3_3, align 4, !dbg !66, !tbaa !67
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv, 2, !dbg !71
  creg__r8__2_ = max(0,creg_r8);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !104, metadata !DIExpression()), !dbg !106

  //   store i32 %conv7, i32* @atom_1_X2_2, align 4, !dbg !72, !tbaa !67
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !129, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !130, metadata !DIExpression()), !dbg !166

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !131, metadata !DIExpression()), !dbg !168

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !135, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !136, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64 0, metadata !138, metadata !DIExpression()), !dbg !171

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !85
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !139, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64 0, metadata !141, metadata !DIExpression()), !dbg !173

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !175

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X8_2, metadata !145, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !177

  //   store atomic i32 0, i32* @atom_0_X8_2 monotonic, align 4, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_3, metadata !149, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !179

  //   store atomic i32 0, i32* @atom_1_X3_3 monotonic, align 4, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !152, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !181

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !95
  // ST: Guess
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !97
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !98, !tbaa !99
  r11 = local_mem[1];

  //   %call12 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !103
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !104, !tbaa !99
  r12 = local_mem[0];

  //   %call13 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !105
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !158, metadata !DIExpression()), !dbg !191

  //   %conv = trunc i64 %4 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !155, metadata !DIExpression()), !dbg !166

  //   %cmp = icmp eq i32 %conv, 3, !dbg !109
  creg__r13__3_ = max(0,creg_r13);

  //   %conv14 = zext i1 %cmp to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !159, metadata !DIExpression()), !dbg !166

  //   %5 = load i32, i32* @atom_0_X8_2, align 4, !dbg !110, !tbaa !111
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !160, metadata !DIExpression()), !dbg !166

  //   %6 = load i32, i32* @atom_1_X3_3, align 4, !dbg !113, !tbaa !111
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %7 = load i32, i32* @atom_1_X2_2, align 4, !dbg !114, !tbaa !111
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %and = and i32 %6, %7, !dbg !115
  creg_r17 = max(creg_r15,creg_r16);
  r17 = r15 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !163, metadata !DIExpression()), !dbg !166

  //   %and15 = and i32 %5, %and, !dbg !116
  creg_r18 = max(creg_r14,creg_r17);
  r18 = r14 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !164, metadata !DIExpression()), !dbg !166

  //   %and16 = and i32 %conv14, %and15, !dbg !117
  creg_r19 = max(creg__r13__3_,creg_r18);
  r19 = (r13==3) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !165, metadata !DIExpression()), !dbg !166
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
...
T0BLOCK2:
  //   %8 = bitcast i64* %thr1 to i8*, !dbg !124

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #7, !dbg !124

  //   %9 = bitcast i64* %thr0 to i8*, !dbg !124

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #7, !dbg !124
