...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !63, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64 1, metadata !65, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 2, metadata !68, metadata !DIExpression()), !dbg !110

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !92
  // ST: Guess
  iw(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0+2*1);
  cw(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
  ...
  //   %conv6 = trunc i64 %1 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !69, metadata !DIExpression()), !dbg !96

  //   %xor = xor i32 %conv6, %conv6, !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !74, metadata !DIExpression()), !dbg !96
  ...
  //   %cmp18 = icmp eq i32 %conv6, 2, !dbg !106
