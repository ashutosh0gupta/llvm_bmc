...
T2BLOCK4:
  ...
  //   %conv9 = sext i32 %add to i64, !dbg !97

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !79, metadata !DIExpression()), !dbg !115

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   store i32 %conv22, i32* @atom_1_X4_1, align 4, !dbg !113, !tbaa !106
  // ST: Guess
  ...
  //   store i32 %conv24, i32* @atom_1_X7_1, align 4, !dbg !115, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !179, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !182, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !185, metadata !DIExpression()), !dbg !237
