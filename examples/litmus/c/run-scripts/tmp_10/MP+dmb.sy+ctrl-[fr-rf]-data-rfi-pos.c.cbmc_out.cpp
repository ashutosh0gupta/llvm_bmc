...
T2BLOCK4:
  ...
  //   %conv9 = sext i32 %add to i64, !dbg !112

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !79, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !101, metadata !DIExpression()), !dbg !148
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !200, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !234, metadata !DIExpression()), !dbg !305
