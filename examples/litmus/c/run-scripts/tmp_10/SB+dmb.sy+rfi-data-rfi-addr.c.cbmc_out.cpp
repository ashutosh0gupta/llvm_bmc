...
T2BLOCK1:
  ...
  //   %xor8 = xor i32 %conv7, %conv7, !dbg !91
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor8, metadata !86, metadata !DIExpression()), !dbg !104

  //   %add10 = add nsw i32 0, %xor8, !dbg !92
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add10 to i64, !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !88, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !90, metadata !DIExpression()), !dbg !121

  //   %conv13 = trunc i64 %2 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !87, metadata !DIExpression()), !dbg !104

  //   %cmp = icmp eq i32 %conv, 1, !dbg !95

  //   %conv14 = zext i1 %cmp to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !91, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !92, metadata !DIExpression()), !dbg !124

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !94, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !97
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv7, 1, !dbg !98

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !95, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !96, metadata !DIExpression()), !dbg !127

  //   %4 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !98, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %4, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !100
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv13, 0, !dbg !101

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !99, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !100, metadata !DIExpression()), !dbg !130

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !102, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %5, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !156, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !159, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !162, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !165, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !184, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !192, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !196, metadata !DIExpression()), !dbg !255
