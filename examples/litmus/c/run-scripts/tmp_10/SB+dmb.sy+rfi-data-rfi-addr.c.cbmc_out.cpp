...
T2BLOCK1:
  ...
  //   %xor8 = xor i32 %conv7, %conv7, !dbg !82
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor8, metadata !86, metadata !DIExpression()), !dbg !95

  //   %add10 = add nsw i32 0, %xor8, !dbg !83
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add10 to i64, !dbg !83

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !83
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !88, metadata !DIExpression()), !dbg !112
  ...
  //   %conv13 = trunc i64 %2 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !87, metadata !DIExpression()), !dbg !95

  //   %cmp = icmp eq i32 %conv, 1, !dbg !86
  creg__r1__1_ = max(0,creg_r1);

  //   %conv14 = zext i1 %cmp to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !91, metadata !DIExpression()), !dbg !95

  //   store i32 %conv14, i32* @atom_1_X2_1, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv7, 1, !dbg !92
  creg__r4__1_ = max(0,creg_r4);

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !92, metadata !DIExpression()), !dbg !95

  //   store i32 %conv16, i32* @atom_1_X5_1, align 4, !dbg !93, !tbaa !88
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv13, 0, !dbg !94
  creg__r8__0_ = max(0,creg_r8);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !93, metadata !DIExpression()), !dbg !95

  //   store i32 %conv18, i32* @atom_1_X7_0, align 4, !dbg !95, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !128, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !129, metadata !DIExpression()), !dbg !182

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !130, metadata !DIExpression()), !dbg !184

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !134, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !135, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64 0, metadata !137, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !141, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !144, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i32 0, metadata !147, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !148, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !151, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i32 0, metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !154, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !158, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !160, metadata !DIExpression()), !dbg !209

  //   %conv = trunc i64 %4 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !157, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !161, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !165, metadata !DIExpression()), !dbg !213

  //   %conv20 = trunc i64 %5 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !162, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !166, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !168, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !170, metadata !DIExpression()), !dbg !217

  //   %conv26 = trunc i64 %6 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !167, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !171, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !172, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !173, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !174, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !175, metadata !DIExpression()), !dbg !182

  //   %and = and i32 %9, %10, !dbg !145
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !176, metadata !DIExpression()), !dbg !182

  //   %and29 = and i32 %8, %and, !dbg !146
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !177, metadata !DIExpression()), !dbg !182

  //   %and30 = and i32 %7, %and29, !dbg !147
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !178, metadata !DIExpression()), !dbg !182

  //   %and31 = and i32 %conv28, %and30, !dbg !148
  creg_r22 = max(creg__r14__1_,creg_r21);
  r22 = (r14==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !179, metadata !DIExpression()), !dbg !182

  //   %and32 = and i32 %conv22, %and31, !dbg !149
  creg_r23 = max(creg__r13__1_,creg_r22);
  r23 = (r13==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !180, metadata !DIExpression()), !dbg !182

  //   %and33 = and i32 %conv16, %and32, !dbg !150
  creg_r24 = max(creg__r12__1_,creg_r23);
  r24 = (r12==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !181, metadata !DIExpression()), !dbg !182
