...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !85), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !66, metadata !DIExpression()), !dbg !98

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !69, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !104

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   store i32 %conv15, i32* @atom_1_X2_0, align 4, !dbg !97, !tbaa !92
  // ST: Guess
  ...
  //   store i32 %conv17, i32* @atom_1_X4_0, align 4, !dbg !99, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !146, metadata !DIExpression()), !dbg !185
  ...
  //   %7 = load i32, i32* @atom_1_X2_0, align 4, !dbg !127, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
