...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !51, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !55, metadata !DIExpression()), !dbg !84

  //   %2 = zext i32 %conv7 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !57, metadata !DIExpression()), !dbg !84

  //   store atomic i64 %2, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !85
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !59, metadata !DIExpression()), !dbg !87

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !61, metadata !DIExpression()), !dbg !87

  //   store atomic i64 %3, i64* @atom_0_X3_1 seq_cst, align 8, !dbg !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !138, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !141, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !158, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !162, metadata !DIExpression()), !dbg !209
