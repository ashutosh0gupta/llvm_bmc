...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv12, %conv12, !dbg !113
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !114
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ASSUME(creg_r6 >= creg_r5);
  ASSUME(active[creg_r6] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !134

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !117

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !119
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   %cmp31 = icmp eq i32 %conv8, 0, !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !97, metadata !DIExpression()), !dbg !152

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !99, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %8, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv12, 1, !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !101, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !105, metadata !DIExpression()), !dbg !158

  //   %10 = zext i32 %conv42 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !107, metadata !DIExpression()), !dbg !158

  //   store atomic i64 %10, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !140
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !207, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !210, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !213, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !240, metadata !DIExpression()), !dbg !314
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !244, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !248, metadata !DIExpression()), !dbg !320
