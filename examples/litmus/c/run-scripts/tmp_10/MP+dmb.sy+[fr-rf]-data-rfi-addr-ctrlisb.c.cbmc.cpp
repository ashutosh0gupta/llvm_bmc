...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !99

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   %conv4 = trunc i64 %1 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !93

  //   %xor = xor i32 %conv4, %conv4, !dbg !83
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !93

  //   %add = add nsw i32 %xor, 1, !dbg !84
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !70, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !104

  //   %conv5 = sext i32 %add to i64, !dbg !86

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !73, metadata !DIExpression()), !dbg !104

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !86
  // ST: Guess
...
T2BLOCK4:
  ...
  //   %cmp21 = icmp eq i32 %conv4, 2, !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X2_2, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv9, 1, !dbg !112
  ...
  //   store i32 %conv24, i32* @atom_1_X5_1, align 4, !dbg !113, !tbaa !106
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !139, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i64 2, metadata !141, metadata !DIExpression()), !dbg !146

  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !50
  // ST: Guess
  iw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l55_c3
  old_cw = cw(3,0+1*1);
  cw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l55_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !180, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !231

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !183, metadata !DIExpression()), !dbg !233
  ...
  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !145
  ...
  //   %10 = load i32, i32* @atom_1_X2_2, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X5_1, align 4, !dbg !154, !tbaa !151
  // LD: Guess
  old_cr = cr(0,6);
  ...
  creg_r25 = max(creg__r15__2_,creg_r24);
  r25 = (r15==2) & r24;
