...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor10, metadata !78, metadata !DIExpression()), !dbg !105

  //   %add12 = add nsw i32 3, %xor10, !dbg !103
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 3 + r5;

  //   %idxprom = sext i32 %add12 to i64, !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !123
  ...
  //   %tobool = icmp ne i32 %conv15, 0, !dbg !106
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !92, metadata !DIExpression()), !dbg !139
  ...
  //   %cmp29 = icmp eq i32 %conv9, 1, !dbg !122
  ...
  //   %cmp34 = icmp eq i32 %conv19, 0, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !100, metadata !DIExpression()), !dbg !145

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %8, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !127
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !158
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !191, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !197, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !220, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !228, metadata !DIExpression()), !dbg !294
