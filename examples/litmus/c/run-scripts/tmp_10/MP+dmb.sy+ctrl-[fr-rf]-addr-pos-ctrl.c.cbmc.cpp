...
T2BLOCK7:
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !124

  //   %conv23 = trunc i64 %5 to i32, !dbg !107
  ...
  //   %conv24 = zext i1 %cmp to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !86, metadata !DIExpression()), !dbg !93

  //   store i32 %conv24, i32* @atom_1_X0_1, align 4, !dbg !109, !tbaa !110
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv4, 0, !dbg !114
  ...
  //   store i32 %conv26, i32* @atom_1_X2_0, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv8, 1, !dbg !116
  creg__r2__1_ = max(0,creg_r2);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !88, metadata !DIExpression()), !dbg !93

  //   store i32 %conv28, i32* @atom_1_X4_1, align 4, !dbg !117, !tbaa !110
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv23, 0, !dbg !118
  ...
  //   store i32 %conv30, i32* @atom_1_X9_0, align 4, !dbg !119, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !190, metadata !DIExpression()), !dbg !239
