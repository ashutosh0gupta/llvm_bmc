...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !36, metadata !DIExpression()), !dbg !51
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !37, metadata !DIExpression()), !dbg !54

  //   call void @llvm.dbg.value(metadata i64 1, metadata !40, metadata !DIExpression()), !dbg !54
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !44, metadata !DIExpression()), !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !45, metadata !DIExpression()), !dbg !51
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !46, metadata !DIExpression()), !dbg !61
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !49, metadata !DIExpression()), !dbg !51

  //   store i32 %conv3, i32* @atom_0_X2_1, align 4, !dbg !63, !tbaa !64
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !74, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !75, metadata !DIExpression()), !dbg !81
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !100, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !101, metadata !DIExpression()), !dbg !135

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !102, metadata !DIExpression()), !dbg !137

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !106, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !107, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64 0, metadata !109, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64 0, metadata !112, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !113, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i32 0, metadata !116, metadata !DIExpression()), !dbg !144

  //   store atomic i32 0, i32* @atom_0_X2_1 monotonic, align 4, !dbg !85
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !117, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i32 0, metadata !119, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !121, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !123, metadata !DIExpression()), !dbg !156

  //   %conv = trunc i64 %4 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !120, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !124, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !126, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !128, metadata !DIExpression()), !dbg !160

  //   %conv14 = trunc i64 %5 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !125, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !129, metadata !DIExpression()), !dbg !135

  //   %6 = load i32, i32* @atom_0_X2_1, align 4, !dbg !106, !tbaa !107
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !132, metadata !DIExpression()), !dbg !135

  //   %and17 = and i32 %conv16, %and, !dbg !111
  creg_r13 = max(creg__r9__2_,creg_r12);
  r13 = (r9==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !133, metadata !DIExpression()), !dbg !135

  //   %and18 = and i32 %conv10, %and17, !dbg !112
  creg_r14 = max(creg__r8__1_,creg_r13);
  r14 = (r8==1) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !134, metadata !DIExpression()), !dbg !135
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
