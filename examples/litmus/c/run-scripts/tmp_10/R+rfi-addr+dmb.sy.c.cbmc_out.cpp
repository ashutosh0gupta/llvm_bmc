...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !35, metadata !DIExpression()), !dbg !54
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !57

  //   call void @llvm.dbg.value(metadata i64 1, metadata !39, metadata !DIExpression()), !dbg !57
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !45, metadata !DIExpression()), !dbg !54

  //   %add = add nsw i32 1, %xor, !dbg !63
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !63
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ASSUME(creg_r3 >= creg_r2);
  ASSUME(active[creg_r3] == 1);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !46, metadata !DIExpression()), !dbg !64

  //   call void @llvm.dbg.value(metadata i64 1, metadata !48, metadata !DIExpression()), !dbg !64

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !49, metadata !DIExpression()), !dbg !54

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !50, metadata !DIExpression()), !dbg !66

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !52, metadata !DIExpression()), !dbg !66
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64 2, metadata !74, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !80, metadata !DIExpression()), !dbg !94
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !104, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !105, metadata !DIExpression()), !dbg !144

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !106, metadata !DIExpression()), !dbg !146

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !110, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !111, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i64 0, metadata !113, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !114, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64 0, metadata !116, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !117, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64 0, metadata !119, metadata !DIExpression()), !dbg !153

  //   store atomic i64 0, i64* @atom_0_X2_1 monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !120, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !124, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !126, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !127, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !129, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !131, metadata !DIExpression()), !dbg !171

  //   %conv14 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !128, metadata !DIExpression()), !dbg !144

  //   %cmp15 = icmp eq i32 %conv14, 2, !dbg !110

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !132, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !134, metadata !DIExpression()), !dbg !175

  //   %6 = load atomic i64, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !136, metadata !DIExpression()), !dbg !175

  //   %conv20 = trunc i64 %6 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !133, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !138, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !140, metadata !DIExpression()), !dbg !178

  //   %conv24 = trunc i64 %7 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !137, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !142, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !143, metadata !DIExpression()), !dbg !144
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
