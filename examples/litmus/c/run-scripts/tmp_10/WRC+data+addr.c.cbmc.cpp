...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !57, metadata !DIExpression()), !dbg !64

  //   %add = add nsw i32 %xor, 1, !dbg !58
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !58, metadata !DIExpression()), !dbg !64

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !72

  //   %conv1 = sext i32 %add to i64, !dbg !60

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !61, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !62, metadata !DIExpression()), !dbg !64
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !84, metadata !DIExpression()), !dbg !96

  //   %xor = xor i32 %conv, %conv, !dbg !58
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !88, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !90, metadata !DIExpression()), !dbg !104

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(3,r6);
  cr(3,r6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l40_c16
  // Check
  ...
  // ST: Guess
  iw(3,3) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l42_c15
  old_cw = cw(3,3);
  cw(3,3) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l42_c15
  // Check
  ASSUME(active[iw(3,3)] == 3);
  ASSUME(active[cw(3,3)] == 3);
  ASSUME(sforbid(3,cw(3,3))== 0);
  ASSUME(iw(3,3) >= creg__r3__1_);
  ASSUME(iw(3,3) >= 0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !118, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !119, metadata !DIExpression()), !dbg !147

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !120, metadata !DIExpression()), !dbg !149

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !124, metadata !DIExpression()), !dbg !151

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !125, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !126, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !136, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X3_0, metadata !139, metadata !DIExpression()), !dbg !162
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
