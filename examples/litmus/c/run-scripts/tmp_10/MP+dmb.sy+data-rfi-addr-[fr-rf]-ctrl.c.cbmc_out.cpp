...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !137

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !119
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp24 = icmp eq i32 %conv5, 1, !dbg !124

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !93, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !94, metadata !DIExpression()), !dbg !144

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !96, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %6, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !126
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv11, 0, !dbg !127

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !97, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !98, metadata !DIExpression()), !dbg !147

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %7, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv15, 1, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !102, metadata !DIExpression()), !dbg !150

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !104, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %8, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !132
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv19, 0, !dbg !133

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !105, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !106, metadata !DIExpression()), !dbg !153

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !108, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !135
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !159, metadata !DIExpression()), !dbg !166
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !176, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !177, metadata !DIExpression()), !dbg !259

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !178, metadata !DIExpression()), !dbg !261

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !182, metadata !DIExpression()), !dbg !263

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !183, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !184, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !187, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !190, metadata !DIExpression()), !dbg !270

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !193, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !196, metadata !DIExpression()), !dbg !274

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !199, metadata !DIExpression()), !dbg !276

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !202, metadata !DIExpression()), !dbg !278

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !205, metadata !DIExpression()), !dbg !280

  //   call void @llvm.dbg.value(metadata i64 0, metadata !207, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !208, metadata !DIExpression()), !dbg !282

  //   call void @llvm.dbg.value(metadata i64 0, metadata !210, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !212, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !214, metadata !DIExpression()), !dbg !297

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !211, metadata !DIExpression()), !dbg !259

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !215, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !217, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !219, metadata !DIExpression()), !dbg !301

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !216, metadata !DIExpression()), !dbg !259

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !220, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !222, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !224, metadata !DIExpression()), !dbg !305

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !221, metadata !DIExpression()), !dbg !259

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !225, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !227, metadata !DIExpression()), !dbg !309
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !229, metadata !DIExpression()), !dbg !309

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !226, metadata !DIExpression()), !dbg !259

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !230, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !232, metadata !DIExpression()), !dbg !313
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !234, metadata !DIExpression()), !dbg !313

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !231, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !236, metadata !DIExpression()), !dbg !316
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !238, metadata !DIExpression()), !dbg !316

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !235, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !240, metadata !DIExpression()), !dbg !319
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !242, metadata !DIExpression()), !dbg !319

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !239, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !244, metadata !DIExpression()), !dbg !322
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !246, metadata !DIExpression()), !dbg !322

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !243, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !248, metadata !DIExpression()), !dbg !325
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !250, metadata !DIExpression()), !dbg !325

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !247, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !251, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !252, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !253, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !254, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !255, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !256, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !257, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !258, metadata !DIExpression()), !dbg !259
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 105, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
