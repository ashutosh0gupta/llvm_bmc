...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !97
  ...
  //   store i32 %conv9, i32* @atom_1_X2_2, align 4, !dbg !82, !tbaa !83
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv4, 2, !dbg !87
  ...
  //   store i32 %conv11, i32* @atom_1_X3_2, align 4, !dbg !88, !tbaa !83
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv8, 0, !dbg !89
  creg__r2__0_ = max(0,creg_r2);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !76, metadata !DIExpression()), !dbg !79

  //   store i32 %conv13, i32* @atom_1_X4_0, align 4, !dbg !90, !tbaa !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !131, metadata !DIExpression()), !dbg !167
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !127
