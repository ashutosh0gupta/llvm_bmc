...
T2BLOCK10:
  ...
  //   %cmp29 = icmp eq i32 %conv4, 1, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !89, metadata !DIExpression()), !dbg !145
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !215

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !217

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !186, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !234

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !192, metadata !DIExpression()), !dbg !246

  //   %conv = trunc i64 %4 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !189, metadata !DIExpression()), !dbg !215

  //   %cmp = icmp eq i32 %conv, 1, !dbg !133

  //   %conv18 = zext i1 %cmp to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !193, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !197, metadata !DIExpression()), !dbg !250

  //   %conv22 = trunc i64 %5 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !194, metadata !DIExpression()), !dbg !215

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !137

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !198, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !200, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !202, metadata !DIExpression()), !dbg !254

  //   %conv28 = trunc i64 %6 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !199, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !204, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !206, metadata !DIExpression()), !dbg !257

  //   %conv32 = trunc i64 %7 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !203, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !208, metadata !DIExpression()), !dbg !260

  //   %8 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !210, metadata !DIExpression()), !dbg !260

  //   %conv36 = trunc i64 %8 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !207, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !211, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !212, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !213, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !214, metadata !DIExpression()), !dbg !215
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !154
