...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !74, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !96

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(2,0+2*1);
...
T2BLOCK4:
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !74
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !79, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !108

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !77
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !86, metadata !DIExpression()), !dbg !108

  //   %conv8 = trunc i64 %2 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !83, metadata !DIExpression()), !dbg !91

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !79
  creg__r2__0_ = max(0,creg_r2);

  //   %conv9 = zext i1 %cmp to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv9, i32* @atom_1_X4_0, align 4, !dbg !80, !tbaa !81
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv8, 0, !dbg !85
  creg__r3__0_ = max(0,creg_r3);

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !88, metadata !DIExpression()), !dbg !91

  //   store i32 %conv11, i32* @atom_1_X6_0, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !139, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !143, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !145, metadata !DIExpression()), !dbg !179

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !146, metadata !DIExpression()), !dbg !181
  ...
  //   %7 = load i32, i32* @atom_1_X4_0, align 4, !dbg !123, !tbaa !121
  // LD: Guess
  old_cr = cr(0,4);
