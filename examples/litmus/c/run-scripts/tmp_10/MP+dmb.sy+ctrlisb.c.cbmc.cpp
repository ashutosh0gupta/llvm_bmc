...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !56, metadata !DIExpression()), !dbg !69
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !60, metadata !DIExpression()), !dbg !72

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !57, metadata !DIExpression()), !dbg !69
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !62, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !64, metadata !DIExpression()), !dbg !82

  //   %conv4 = trunc i64 %1 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !61, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !65, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !66, metadata !DIExpression()), !dbg !69
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !101, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !102, metadata !DIExpression()), !dbg !136

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !103, metadata !DIExpression()), !dbg !138

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !107, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !108, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64 0, metadata !110, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !111, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i64 0, metadata !113, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !114, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i32 0, metadata !117, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !118, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i32 0, metadata !120, metadata !DIExpression()), !dbg !147
  ...
  //   %call7 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !89
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !122, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !124, metadata !DIExpression()), !dbg !157

  //   %conv = trunc i64 %4 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !121, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !125, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !127, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !129, metadata !DIExpression()), !dbg !161

  //   %conv14 = trunc i64 %5 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !126, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !130, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !131, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !132, metadata !DIExpression()), !dbg !136

  //   %and = and i32 %6, %7, !dbg !110
  creg_r9 = max(creg_r7,creg_r8);
  r9 = r7 & r8;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !133, metadata !DIExpression()), !dbg !136

  //   %and17 = and i32 %conv16, %and, !dbg !111
  creg_r10 = max(creg__r6__1_,creg_r9);
  r10 = (r6==1) & r9;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !134, metadata !DIExpression()), !dbg !136

  //   %and18 = and i32 %conv10, %and17, !dbg !112
  creg_r11 = max(creg__r5__1_,creg_r10);
  r11 = (r5==1) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !135, metadata !DIExpression()), !dbg !136
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !116
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #6, !dbg !119
