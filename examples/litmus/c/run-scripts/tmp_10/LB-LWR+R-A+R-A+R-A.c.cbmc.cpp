...
T4BLOCK1:
  ...
  //   %cmp = icmp eq i32 %conv4, 0, !dbg !62
  ...
  //   store i32 %conv5, i32* @atom_3_X2_0, align 4, !dbg !63, !tbaa !64
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv, 1, !dbg !68
  ...
  //   store i32 %conv7, i32* @atom_3_X0_1, align 4, !dbg !69, !tbaa !64
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X2_0, metadata !163, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !167, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !170, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !173, metadata !DIExpression()), !dbg !206
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
