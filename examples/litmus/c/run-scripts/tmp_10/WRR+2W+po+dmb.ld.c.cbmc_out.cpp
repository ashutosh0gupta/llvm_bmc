...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !56, metadata !DIExpression()), !dbg !68

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !56
  // LD: Guess
  old_cr = cr(2,0+1*1);
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !83, metadata !DIExpression()), !dbg !93
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !106, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !107, metadata !DIExpression()), !dbg !136

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !108, metadata !DIExpression()), !dbg !138

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !112, metadata !DIExpression()), !dbg !140

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !113, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !114, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !117, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !120, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !124, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i32 0, metadata !126, metadata !DIExpression()), !dbg !149

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !128, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !130, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !131, metadata !DIExpression()), !dbg !136
  ...
  //   %8 = load i32, i32* @atom_1_X2_0, align 4, !dbg !105, !tbaa !103
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !135, metadata !DIExpression()), !dbg !136
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
