...
T2BLOCK1:
  ...
  //   %cmp23 = icmp eq i32 %conv8, 2, !dbg !107
  ...
  //   store i32 %conv24, i32* @atom_1_X3_2, align 4, !dbg !108, !tbaa !101
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !136, metadata !DIExpression()), !dbg !143
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !174, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !177, metadata !DIExpression()), !dbg !230
  ...
  creg_r27 = max(creg__r15__2_,creg_r26);
  r27 = (r15==2) & r26;
