...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !47

  //   call void @llvm.dbg.value(metadata i64 1, metadata !39, metadata !DIExpression()), !dbg !47

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !48
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !40, metadata !DIExpression()), !dbg !50

  //   call void @llvm.dbg.value(metadata i64 1, metadata !42, metadata !DIExpression()), !dbg !50

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !51
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !55, metadata !DIExpression()), !dbg !95
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !98

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !60, metadata !DIExpression()), !dbg !98

  //   %conv = trunc i64 %0 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !56, metadata !DIExpression()), !dbg !95
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !107

  //   %1 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !64, metadata !DIExpression()), !dbg !107

  //   %conv4 = trunc i64 %1 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !61, metadata !DIExpression()), !dbg !95

  //   %xor = xor i32 %conv4, %conv4, !dbg !91
  ...
  //   %arrayidx = getelementptr inbounds [6 x i64], [6 x i64]* @vars, i64 0, i64 %idxprom, !dbg !92
  r4 = 0+r3*1;
  ASSUME(creg_r4 >= 0);
  ...
  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,r4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !69, metadata !DIExpression()), !dbg !112

  //   %conv8 = trunc i64 %2 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !66, metadata !DIExpression()), !dbg !95
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !71, metadata !DIExpression()), !dbg !120

  //   %3 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !73, metadata !DIExpression()), !dbg !120

  //   %conv15 = trunc i64 %3 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !70, metadata !DIExpression()), !dbg !95

  //   %xor16 = xor i32 %conv15, %conv15, !dbg !104
  creg_r7 = max(creg_r6,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !74, metadata !DIExpression()), !dbg !95

  //   %add18 = add nsw i32 5, %xor16, !dbg !105
  ...
  //   %arrayidx20 = getelementptr inbounds [6 x i64], [6 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !105
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !76, metadata !DIExpression()), !dbg !125

  //   %4 = load atomic i64, i64* %arrayidx20 monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !78, metadata !DIExpression()), !dbg !125

  //   %conv23 = trunc i64 %4 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !75, metadata !DIExpression()), !dbg !95

  //   %tobool24 = icmp ne i32 %conv23, 0, !dbg !108

  //   br i1 %tobool24, label %if.then25, label %if.else26, !dbg !110
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !94), !dbg !132

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !133

  //   %5 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !82, metadata !DIExpression()), !dbg !133

  //   %conv30 = trunc i64 %5 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !79, metadata !DIExpression()), !dbg !95

  //   %cmp = icmp eq i32 %conv, 1, !dbg !117

  //   %conv31 = zext i1 %cmp to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !83, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !84, metadata !DIExpression()), !dbg !137

  //   %6 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !86, metadata !DIExpression()), !dbg !137
  ...
  //   %cmp33 = icmp eq i32 %conv30, 0, !dbg !120

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !87, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !88, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !90, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X12_0 seq_cst, align 8, !dbg !122
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !150, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !151, metadata !DIExpression()), !dbg !202

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !152, metadata !DIExpression()), !dbg !204

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !156, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !157, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64 0, metadata !159, metadata !DIExpression()), !dbg !207

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !160, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !209

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !163, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64 0, metadata !165, metadata !DIExpression()), !dbg !211

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !166, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !213

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !215

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !172, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !217

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !175, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !219

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !178, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !221

  //   store atomic i64 0, i64* @atom_1_X12_0 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !114
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !120
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !122
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !233

  //   %4 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !184, metadata !DIExpression()), !dbg !233
  ...
  //   %conv18 = zext i1 %cmp to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !185, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !237

  //   %5 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !189, metadata !DIExpression()), !dbg !237

  //   %conv22 = trunc i64 %5 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !186, metadata !DIExpression()), !dbg !202

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !130

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !190, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !192, metadata !DIExpression()), !dbg !241

  //   %6 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !194, metadata !DIExpression()), !dbg !241

  //   %conv28 = trunc i64 %6 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !191, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !196, metadata !DIExpression()), !dbg !244

  //   %7 = load atomic i64, i64* @atom_1_X12_0 seq_cst, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !198, metadata !DIExpression()), !dbg !244

  //   %conv32 = trunc i64 %7 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !195, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !199, metadata !DIExpression()), !dbg !202

  //   %and33 = and i32 %conv24, %and, !dbg !138
  creg_r20 = max(max(creg_r16,0),creg_r19);
  ASSUME(active[creg_r20] == 0);
  r20 = (r16==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !200, metadata !DIExpression()), !dbg !202

  //   %and34 = and i32 %conv18, %and33, !dbg !139
  creg_r21 = max(max(creg_r15,0),creg_r20);
  ASSUME(active[creg_r21] == 0);
  r21 = (r15==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !201, metadata !DIExpression()), !dbg !202

  //   %cmp35 = icmp eq i32 %and34, 1, !dbg !140

  //   br i1 %cmp35, label %if.then, label %if.end, !dbg !142
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143

  //   unreachable, !dbg !143
  r22 = 1;

T0BLOCK2:
  //   %8 = bitcast i64* %thr1 to i8*, !dbg !146

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #7, !dbg !146

  //   %9 = bitcast i64* %thr0 to i8*, !dbg !146

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #7, !dbg !146
