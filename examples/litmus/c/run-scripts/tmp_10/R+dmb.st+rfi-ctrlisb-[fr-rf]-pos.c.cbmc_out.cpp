...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !60, metadata !DIExpression()), !dbg !86
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !61, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64 2, metadata !63, metadata !DIExpression()), !dbg !89

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !91

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !73
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !67, metadata !DIExpression()), !dbg !91

  //   %conv = trunc i64 %0 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !64, metadata !DIExpression()), !dbg !86
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !85), !dbg !99

  //   call void (...) @isb(), !dbg !81
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !101

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !104

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !107

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !80, metadata !DIExpression()), !dbg !86

  //   store i32 %conv13, i32* @atom_1_X2_2, align 4, !dbg !92, !tbaa !93
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 0, !dbg !97
  creg__r1__0_ = max(0,creg_r1);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !81, metadata !DIExpression()), !dbg !86

  //   store i32 %conv15, i32* @atom_1_X3_0, align 4, !dbg !98, !tbaa !93
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 1, !dbg !99
  creg__r2__1_ = max(0,creg_r2);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !82, metadata !DIExpression()), !dbg !86

  //   store i32 %conv17, i32* @atom_1_X5_1, align 4, !dbg !100, !tbaa !93
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv12, 1, !dbg !101
  creg__r3__1_ = max(0,creg_r3);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !83, metadata !DIExpression()), !dbg !86

  //   store i32 %conv19, i32* @atom_1_X6_1, align 4, !dbg !102, !tbaa !93
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !126, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i64 1, metadata !128, metadata !DIExpression()), !dbg !133

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !50
  // ST: Guess
  iw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l51_c3
  old_cw = cw(3,0);
  cw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l51_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !143, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !144, metadata !DIExpression()), !dbg !189

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !145, metadata !DIExpression()), !dbg !191

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !149, metadata !DIExpression()), !dbg !193

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !150, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !154, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !157, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !200

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !102
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l62_c3
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l62_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !161, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !164, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !167, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !171, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !173, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !174, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !176, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !178, metadata !DIExpression()), !dbg !223

  //   %conv20 = trunc i64 %7 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !175, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !179, metadata !DIExpression()), !dbg !189

  //   %8 = load i32, i32* @atom_1_X2_2, align 4, !dbg !130, !tbaa !131
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l79_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !180, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !181, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !182, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !183, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !185, metadata !DIExpression()), !dbg !189

  //   %and24 = and i32 %8, %and23, !dbg !138
  creg_r16 = max(creg_r10,creg_r15);
  r16 = r10 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !186, metadata !DIExpression()), !dbg !189

  //   %and25 = and i32 %conv22, %and24, !dbg !139
  creg_r17 = max(creg__r9__2_,creg_r16);
  r17 = (r9==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !187, metadata !DIExpression()), !dbg !189

  //   %and26 = and i32 %conv16, %and25, !dbg !140
  creg_r18 = max(creg__r8__2_,creg_r17);
  r18 = (r8==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !188, metadata !DIExpression()), !dbg !189
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !144
