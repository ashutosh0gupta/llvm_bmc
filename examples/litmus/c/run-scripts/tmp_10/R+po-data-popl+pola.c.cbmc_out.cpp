...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !35, metadata !DIExpression()), !dbg !62
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64 1, metadata !39, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !67

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !68
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !44, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !45, metadata !DIExpression()), !dbg !62

  //   %add = add nsw i32 %xor, 1, !dbg !71
  creg_r2 = max(creg_r1,0);
  ASSUME(active[creg_r2] == 1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !46, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !47, metadata !DIExpression()), !dbg !72

  //   %conv3 = sext i32 %add to i64, !dbg !73

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !49, metadata !DIExpression()), !dbg !72

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !73
  // ST: Guess
  ...
  caddr[1] = max(caddr[1],0);
  buff(1,0+2*1) = r2;
  mem(0+2*1,cw(1,0+2*1)) = r2;
  co(0+2*1,cw(1,0+2*1))+=1;
  delta(0+2*1,cw(1,0+2*1)) = -1;
  ASSUME(creturn[1] >= cw(1,0+2*1));

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !50, metadata !DIExpression()), !dbg !74

  //   call void @llvm.dbg.value(metadata i64 1, metadata !52, metadata !DIExpression()), !dbg !74

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !75
  // ST: Guess
  //   : Release
  ...
  ASSUME(cw(1,0+3*1) >= cr(1,4+0));
  ASSUME(cw(1,0+3*1) >= cr(1,5+0));
  ASSUME(cw(1,0+3*1) >= cr(1,6+0));
  ASSUME(cw(1,0+3*1) >= cr(1,7+0));
  ASSUME(cw(1,0+3*1) >= cw(1,0+0));
  ASSUME(cw(1,0+3*1) >= cw(1,0+1));
  ASSUME(cw(1,0+3*1) >= cw(1,0+2));
  ASSUME(cw(1,0+3*1) >= cw(1,0+3));
  ASSUME(cw(1,0+3*1) >= cw(1,4+0));
  ASSUME(cw(1,0+3*1) >= cw(1,5+0));
  ASSUME(cw(1,0+3*1) >= cw(1,6+0));
  ASSUME(cw(1,0+3*1) >= cw(1,7+0));
  // Update
  caddr[1] = max(caddr[1],0);
  buff(1,0+3*1) = 1;
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !54, metadata !DIExpression()), !dbg !76

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !77
  // LD: Guess
  old_cr = cr(1,0+3*1);
  ...
  if(cr(1,0+3*1) < cw(1,0+3*1)) {
    ...
    r3 = mem(0+3*1,cr(1,0+3*1));
  }
  ASSUME(creturn[1] >= cr(1,0+3*1));

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !56, metadata !DIExpression()), !dbg !76

  //   %conv9 = trunc i64 %1 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !53, metadata !DIExpression()), !dbg !62

  //   %cmp = icmp eq i32 %conv9, 2, !dbg !79

  //   %conv10 = zext i1 %cmp to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !57, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X8_2, metadata !58, metadata !DIExpression()), !dbg !80

  //   %2 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !60, metadata !DIExpression()), !dbg !80

  //   store atomic i64 %2, i64* @atom_0_X8_2 seq_cst, align 8, !dbg !81
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !86, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64 2, metadata !88, metadata !DIExpression()), !dbg !101

  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !54
  // ST: Guess
  //   : Release
  ...
  ASSUME(cw(2,0+3*1) >= cr(2,4+0));
  ASSUME(cw(2,0+3*1) >= cr(2,5+0));
  ...
  ASSUME(cw(2,0+3*1) >= cw(2,4+0));
  ASSUME(cw(2,0+3*1) >= cw(2,5+0));
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !90, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !92, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !94, metadata !DIExpression()), !dbg !107

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !96, metadata !DIExpression()), !dbg !107

  //   store atomic i64 %1, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !60
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !117, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !118, metadata !DIExpression()), !dbg !169

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !119, metadata !DIExpression()), !dbg !171

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !123, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !124, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64 0, metadata !126, metadata !DIExpression()), !dbg !174

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !127, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64 0, metadata !129, metadata !DIExpression()), !dbg !176

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !130, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 0, metadata !132, metadata !DIExpression()), !dbg !178

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !133, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64 0, metadata !135, metadata !DIExpression()), !dbg !180

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X8_2, metadata !136, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !138, metadata !DIExpression()), !dbg !182

  //   store atomic i64 0, i64* @atom_0_X8_2 monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !139, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64 0, metadata !141, metadata !DIExpression()), !dbg !184

  //   store atomic i64 0, i64* @atom_1_X2_0 monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   %call12 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !116
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !117, !tbaa !112
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %call13 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !118
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !143, metadata !DIExpression()), !dbg !196

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) seq_cst, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !145, metadata !DIExpression()), !dbg !196

  //   %conv = trunc i64 %4 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !142, metadata !DIExpression()), !dbg !169

  //   %cmp = icmp eq i32 %conv, 2, !dbg !122

  //   %conv14 = zext i1 %cmp to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !146, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !200

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !150, metadata !DIExpression()), !dbg !200

  //   %conv18 = trunc i64 %5 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !147, metadata !DIExpression()), !dbg !169

  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !126

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !151, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !153, metadata !DIExpression()), !dbg !204

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !155, metadata !DIExpression()), !dbg !204

  //   %conv24 = trunc i64 %6 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !152, metadata !DIExpression()), !dbg !169

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !130

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !156, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X8_2, metadata !158, metadata !DIExpression()), !dbg !208

  //   %7 = load atomic i64, i64* @atom_0_X8_2 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !160, metadata !DIExpression()), !dbg !208

  //   %conv30 = trunc i64 %7 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !157, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !162, metadata !DIExpression()), !dbg !211

  //   %8 = load atomic i64, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !164, metadata !DIExpression()), !dbg !211

  //   %conv34 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !161, metadata !DIExpression()), !dbg !169

  //   %and = and i32 %conv30, %conv34, !dbg !137
  creg_r13 = max(creg_r11,creg_r12);
  ASSUME(active[creg_r13] == 0);
  r13 = r11 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !165, metadata !DIExpression()), !dbg !169

  //   %and35 = and i32 %conv26, %and, !dbg !138
  creg_r14 = max(max(creg_r10,0),creg_r13);
  ASSUME(active[creg_r14] == 0);
  r14 = (r10==1) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !166, metadata !DIExpression()), !dbg !169

  //   %and36 = and i32 %conv20, %and35, !dbg !139
  creg_r15 = max(max(creg_r9,0),creg_r14);
  ASSUME(active[creg_r15] == 0);
  r15 = (r9==1) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !167, metadata !DIExpression()), !dbg !169

  //   %and37 = and i32 %conv14, %and36, !dbg !140
  creg_r16 = max(max(creg_r8,0),creg_r15);
  ASSUME(active[creg_r16] == 0);
  r16 = (r8==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !168, metadata !DIExpression()), !dbg !169

  //   %cmp38 = icmp eq i32 %and37, 1, !dbg !141

  //   br i1 %cmp38, label %if.then, label %if.end, !dbg !143
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !144
