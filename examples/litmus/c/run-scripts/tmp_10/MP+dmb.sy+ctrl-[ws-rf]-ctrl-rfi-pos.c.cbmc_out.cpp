...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !65, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64 1, metadata !67, metadata !DIExpression()), !dbg !102

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !104
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !89), !dbg !112

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !113

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !115

  //   %conv13 = trunc i64 %2 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !75, metadata !DIExpression()), !dbg !90
  ...
  //   store i32 %conv20, i32* @atom_1_X4_2, align 4, !dbg !109, !tbaa !104
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv13, 1, !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X7_1, align 4, !dbg !111, !tbaa !104
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv17, 1, !dbg !112
  ...
  //   store i32 %conv24, i32* @atom_1_X8_1, align 4, !dbg !113, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !175, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !178, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !181, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !228

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X4_2, align 4, !dbg !148, !tbaa !146
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X7_1, align 4, !dbg !149, !tbaa !146
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X8_1, align 4, !dbg !150, !tbaa !146
  // LD: Guess
  old_cr = cr(0,6);
  ...
  creg_r20 = max(creg__r8__2_,creg_r19);
  r20 = (r8==2) & r19;
