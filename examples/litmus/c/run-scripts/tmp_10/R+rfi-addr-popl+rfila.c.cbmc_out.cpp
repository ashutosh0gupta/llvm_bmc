...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !40, metadata !DIExpression()), !dbg !64
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64 3, metadata !44, metadata !DIExpression()), !dbg !67

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !46, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !45, metadata !DIExpression()), !dbg !64
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !73
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !51, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !53, metadata !DIExpression()), !dbg !74

  //   %conv4 = trunc i64 %1 to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !50, metadata !DIExpression()), !dbg !64

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !54, metadata !DIExpression()), !dbg !76

  //   call void @llvm.dbg.value(metadata i64 1, metadata !56, metadata !DIExpression()), !dbg !76

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !77
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !58, metadata !DIExpression()), !dbg !78

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(1,0);
  cr(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l27_c16
  // Check
  ASSUME(active[cr(1,0)] == 1);
  ASSUME(cr(1,0) >= iw(1,0));
  ASSUME(cr(1,0) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !60, metadata !DIExpression()), !dbg !78

  //   %conv10 = trunc i64 %2 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !57, metadata !DIExpression()), !dbg !64

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !81
  creg__r5__2_ = max(0,creg_r5);

  //   %conv11 = zext i1 %cmp to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !61, metadata !DIExpression()), !dbg !64

  //   store i32 %conv11, i32* @atom_0_X7_2, align 4, !dbg !82, !tbaa !83
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv, 3, !dbg !87
  creg__r0__3_ = max(0,creg_r0);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !62, metadata !DIExpression()), !dbg !64

  //   store i32 %conv13, i32* @atom_0_X2_3, align 4, !dbg !88, !tbaa !83
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !92, metadata !DIExpression()), !dbg !107
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !93, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 2, metadata !95, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !97, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !96, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !101, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !100, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !104, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !105, metadata !DIExpression()), !dbg !107
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !130, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !131, metadata !DIExpression()), !dbg !169

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !132, metadata !DIExpression()), !dbg !171

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !136, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X7_2, metadata !143, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !178

  //   store atomic i32 0, i32* @atom_0_X7_2 monotonic, align 4, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_3, metadata !147, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !180

  //   store atomic i32 0, i32* @atom_0_X2_3 monotonic, align 4, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_3, metadata !150, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_1_X3_3 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !153, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !102, !tbaa !103
  r9 = local_mem[0];

  //   %call12 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !107
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !108, !tbaa !103
  r10 = local_mem[1];
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !157, metadata !DIExpression()), !dbg !194

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !159, metadata !DIExpression()), !dbg !194

  //   %conv = trunc i64 %4 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !156, metadata !DIExpression()), !dbg !169

  //   %cmp = icmp eq i32 %conv, 3, !dbg !113
  creg__r11__3_ = max(0,creg_r11);

  //   %conv14 = zext i1 %cmp to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !160, metadata !DIExpression()), !dbg !169

  //   %5 = load i32, i32* @atom_0_X7_2, align 4, !dbg !114, !tbaa !115
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l66_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !161, metadata !DIExpression()), !dbg !169

  //   %6 = load i32, i32* @atom_0_X2_3, align 4, !dbg !117, !tbaa !115
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X3_3, align 4, !dbg !118, !tbaa !115
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %8 = load i32, i32* @atom_1_X2_2, align 4, !dbg !119, !tbaa !115
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %and = and i32 %7, %8, !dbg !120
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !165, metadata !DIExpression()), !dbg !169

  //   %and15 = and i32 %6, %and, !dbg !121
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !166, metadata !DIExpression()), !dbg !169

  //   %and16 = and i32 %5, %and15, !dbg !122
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !167, metadata !DIExpression()), !dbg !169

  //   %and17 = and i32 %conv14, %and16, !dbg !123
  creg_r19 = max(creg__r11__3_,creg_r18);
  r19 = (r11==3) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !168, metadata !DIExpression()), !dbg !169

  //   %cmp18 = icmp eq i32 %and17, 1, !dbg !124
  creg__r19__1_ = max(0,creg_r19);

  //   br i1 %cmp18, label %if.then, label %if.end, !dbg !126
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !127
...
T0BLOCK2:
  //   %9 = bitcast i64* %thr1 to i8*, !dbg !130

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #7, !dbg !130

  //   %10 = bitcast i64* %thr0 to i8*, !dbg !130
