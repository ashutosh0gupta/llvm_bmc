...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !107
...
T2BLOCK4:
  ...
  //   %cmp22 = icmp eq i32 %conv16, 0, !dbg !110
  ...
  //   store i32 %conv23, i32* @atom_1_X8_0, align 4, !dbg !111, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !139, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !140, metadata !DIExpression()), !dbg !187

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !141, metadata !DIExpression()), !dbg !189

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !145, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !146, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !152, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !155, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !159, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !162, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i32 0, metadata !164, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !165, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i32 0, metadata !167, metadata !DIExpression()), !dbg !204
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !111
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !112
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !169, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !171, metadata !DIExpression()), !dbg !214

  //   %conv = trunc i64 %4 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !168, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !172, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !176, metadata !DIExpression()), !dbg !218

  //   %conv20 = trunc i64 %5 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !173, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !177, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !178, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !179, metadata !DIExpression()), !dbg !187
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !143
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #6, !dbg !146

  //   %11 = bitcast i64* %thr0 to i8*, !dbg !146

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #6, !dbg !146
