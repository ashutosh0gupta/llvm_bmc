...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !68), !dbg !82

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !48, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !50, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !53, metadata !DIExpression()), !dbg !88
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_0, metadata !153, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64 0, metadata !155, metadata !DIExpression()), !dbg !198

  //   store atomic i64 0, i64* @atom_0_X6_0 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_0, metadata !174, metadata !DIExpression()), !dbg !223

  //   %7 = load atomic i64, i64* @atom_0_X6_0 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
