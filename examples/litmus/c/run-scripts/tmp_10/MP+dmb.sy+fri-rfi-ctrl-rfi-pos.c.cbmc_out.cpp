...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !104

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64 2, metadata !67, metadata !DIExpression()), !dbg !107

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !109

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !101
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !100), !dbg !117

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !118

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !120
  ...
  //   %conv10 = trunc i64 %2 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !75, metadata !DIExpression()), !dbg !101
  ...
  //   %conv14 = trunc i64 %3 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !79, metadata !DIExpression()), !dbg !101

  //   %cmp = icmp eq i32 %conv, 1, !dbg !107

  //   %conv15 = zext i1 %cmp to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !83, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !84, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !87, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !88, metadata !DIExpression()), !dbg !130

  //   %5 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %5, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !112
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv10, 1, !dbg !113

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !91, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !92, metadata !DIExpression()), !dbg !133

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %6, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv14, 1, !dbg !116

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !95, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !96, metadata !DIExpression()), !dbg !136
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !146, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !147, metadata !DIExpression()), !dbg !202

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !148, metadata !DIExpression()), !dbg !204

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !152, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !159, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !162, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !165, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !168, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !172, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !174, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !175, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !177, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !179, metadata !DIExpression()), !dbg !233

  //   %conv18 = trunc i64 %5 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !176, metadata !DIExpression()), !dbg !202

  //   %cmp19 = icmp eq i32 %conv18, 2, !dbg !134

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !180, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !182, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !184, metadata !DIExpression()), !dbg !237

  //   %conv24 = trunc i64 %6 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !181, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !190, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !189, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !194, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !196, metadata !DIExpression()), !dbg !246

  //   %conv36 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !193, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !198, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !199, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !200, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !201, metadata !DIExpression()), !dbg !202
