...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !108
  ...
  //   %conv10 = trunc i64 %2 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !75, metadata !DIExpression()), !dbg !89
  ...
  //   %cmp18 = icmp eq i32 %conv10, 1, !dbg !103
  ...
  //   store i32 %conv19, i32* @atom_1_X6_1, align 4, !dbg !104, !tbaa !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !154, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !192

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X6_1, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
