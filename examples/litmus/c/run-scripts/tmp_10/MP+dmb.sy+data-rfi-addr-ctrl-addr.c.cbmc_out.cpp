...
T2BLOCK4:
  ...
  //   %cmp28 = icmp eq i32 %conv5, 1, !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !91, metadata !DIExpression()), !dbg !134

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %6, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !116
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !147, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !148, metadata !DIExpression()), !dbg !210

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !149, metadata !DIExpression()), !dbg !212

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !153, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !154, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !215

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !157, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !159, metadata !DIExpression()), !dbg !217

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !160, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !219

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !165, metadata !DIExpression()), !dbg !221

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !166, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !223

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !169, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !172, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !227

  //   store atomic i64 0, i64* @atom_1_X4_1 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !175, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !229

  //   store atomic i64 0, i64* @atom_1_X11_0 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !126
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !127
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !128, !tbaa !129
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !133
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !134, !tbaa !129
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !135
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !179, metadata !DIExpression()), !dbg !241

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !181, metadata !DIExpression()), !dbg !241

  //   %conv = trunc i64 %4 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !178, metadata !DIExpression()), !dbg !210

  //   %cmp = icmp eq i32 %conv, 1, !dbg !139

  //   %conv18 = zext i1 %cmp to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !182, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !184, metadata !DIExpression()), !dbg !245

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !186, metadata !DIExpression()), !dbg !245

  //   %conv22 = trunc i64 %5 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !183, metadata !DIExpression()), !dbg !210

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !143

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !187, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !189, metadata !DIExpression()), !dbg !249

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !191, metadata !DIExpression()), !dbg !249

  //   %conv28 = trunc i64 %6 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !188, metadata !DIExpression()), !dbg !210

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !147

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !192, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !194, metadata !DIExpression()), !dbg !253

  //   %7 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !149
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !196, metadata !DIExpression()), !dbg !253

  //   %conv34 = trunc i64 %7 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !193, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !198, metadata !DIExpression()), !dbg !256

  //   %8 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !200, metadata !DIExpression()), !dbg !256

  //   %conv38 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !197, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !202, metadata !DIExpression()), !dbg !259

  //   %9 = load atomic i64, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !155
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !204, metadata !DIExpression()), !dbg !259

  //   %conv42 = trunc i64 %9 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !201, metadata !DIExpression()), !dbg !210

  //   %and = and i32 %conv38, %conv42, !dbg !157
  creg_r22 = max(creg_r20,creg_r21);
  ASSUME(active[creg_r22] == 0);
  r22 = r20 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !205, metadata !DIExpression()), !dbg !210

  //   %and43 = and i32 %conv34, %and, !dbg !158
  creg_r23 = max(creg_r19,creg_r22);
  ASSUME(active[creg_r23] == 0);
  r23 = r19 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !206, metadata !DIExpression()), !dbg !210

  //   %and44 = and i32 %conv30, %and43, !dbg !159
  creg_r24 = max(max(creg_r18,0),creg_r23);
  ASSUME(active[creg_r24] == 0);
  r24 = (r18==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !207, metadata !DIExpression()), !dbg !210

  //   %and45 = and i32 %conv24, %and44, !dbg !160
  creg_r25 = max(max(creg_r17,0),creg_r24);
  ASSUME(active[creg_r25] == 0);
  r25 = (r17==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !208, metadata !DIExpression()), !dbg !210

  //   %and46 = and i32 %conv18, %and45, !dbg !161
  creg_r26 = max(max(creg_r16,0),creg_r25);
  ASSUME(active[creg_r26] == 0);
  r26 = (r16==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !209, metadata !DIExpression()), !dbg !210

  //   %cmp47 = icmp eq i32 %and46, 1, !dbg !162

  //   br i1 %cmp47, label %if.then, label %if.end, !dbg !164
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 83, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !165

  //   unreachable, !dbg !165
  r27 = 1;

T0BLOCK2:
  //   %10 = bitcast i64* %thr1 to i8*, !dbg !168

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !168

  //   %11 = bitcast i64* %thr0 to i8*, !dbg !168

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !168
