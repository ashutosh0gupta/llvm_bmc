...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !135, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !139, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !142, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i32 0, metadata !144, metadata !DIExpression()), !dbg !165

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !89
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_1_X0_1, align 4, !dbg !103, !tbaa !101
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %6 = load i32, i32* @atom_1_X4_1, align 4, !dbg !104, !tbaa !101
  // LD: Guess
  old_cr = cr(0,5);
