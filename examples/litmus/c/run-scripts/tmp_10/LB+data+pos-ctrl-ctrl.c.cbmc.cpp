...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64 1, metadata !85, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !86, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !124

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !89, metadata !DIExpression()), !dbg !124
  ...
  //   %cmp16 = icmp eq i32 %conv4, 1, !dbg !95

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !90, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !91, metadata !DIExpression()), !dbg !127

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !93, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %4, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !153, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !159, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !173, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !177, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !181, metadata !DIExpression()), !dbg !229
