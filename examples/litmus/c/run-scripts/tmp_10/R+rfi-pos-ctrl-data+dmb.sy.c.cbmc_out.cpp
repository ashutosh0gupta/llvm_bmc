...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !48, metadata !DIExpression()), !dbg !72

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !73
  // LD: Guess
  old_cr = cr(1,0);
...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !52, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !54, metadata !DIExpression()), !dbg !81

  //   %conv8 = trunc i64 %2 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !51, metadata !DIExpression()), !dbg !64

  //   %xor = xor i32 %conv8, %conv8, !dbg !84
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !55, metadata !DIExpression()), !dbg !64

  //   %add = add nsw i32 %xor, 1, !dbg !85
  creg_r4 = max(0,creg_r3);
  r4 = r3 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !56, metadata !DIExpression()), !dbg !64

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !57, metadata !DIExpression()), !dbg !86

  //   %conv11 = sext i32 %add to i64, !dbg !87

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !59, metadata !DIExpression()), !dbg !86

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   store i32 %conv12, i32* @atom_0_X2_1, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv4, 1, !dbg !94
  ...
  //   store i32 %conv14, i32* @atom_0_X3_1, align 4, !dbg !95, !tbaa !90
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !104, metadata !DIExpression()), !dbg !115
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !144, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_1, metadata !148, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !151, metadata !DIExpression()), !dbg !186
