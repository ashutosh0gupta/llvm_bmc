...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !48, metadata !DIExpression()), !dbg !60
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !50, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !49, metadata !DIExpression()), !dbg !60

  //   %xor7 = xor i32 %conv6, %conv6, !dbg !74
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !53, metadata !DIExpression()), !dbg !60

  //   %add8 = add nsw i32 %xor7, 1, !dbg !75
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add8, metadata !54, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !55, metadata !DIExpression()), !dbg !76

  //   %conv11 = sext i32 %add8 to i64, !dbg !77

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !57, metadata !DIExpression()), !dbg !76

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !77
  // ST: Guess
  ...
  //   store i32 %conv12, i32* @atom_0_X3_2, align 4, !dbg !79, !tbaa !80
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_2, metadata !132, metadata !DIExpression()), !dbg !165
