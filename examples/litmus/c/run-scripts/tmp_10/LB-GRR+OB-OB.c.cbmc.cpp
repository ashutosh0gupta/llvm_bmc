...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !40, metadata !DIExpression()), !dbg !52
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !56
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !86

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !75, metadata !DIExpression()), !dbg !86

  //   %conv4 = trunc i64 %1 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !72, metadata !DIExpression()), !dbg !79

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !61
  creg__r2__0_ = max(0,creg_r2);

  //   %conv5 = zext i1 %cmp to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !76, metadata !DIExpression()), !dbg !79

  //   store i32 %conv5, i32* @atom_1_X2_0, align 4, !dbg !62, !tbaa !63
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv, 1, !dbg !67
  creg__r1__1_ = max(0,creg_r1);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !77, metadata !DIExpression()), !dbg !79

  //   store i32 %conv7, i32* @atom_1_X0_1, align 4, !dbg !68, !tbaa !63
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !96, metadata !DIExpression()), !dbg !104
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !97, metadata !DIExpression()), !dbg !107
  ...
  // ST: Guess
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l43_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l43_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !100, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 1, metadata !102, metadata !DIExpression()), !dbg !110
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !120, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !121, metadata !DIExpression()), !dbg !152

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !122, metadata !DIExpression()), !dbg !154

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !126, metadata !DIExpression()), !dbg !156

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #6, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !127, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !137, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i32 0, metadata !140, metadata !DIExpression()), !dbg !165

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !141, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !144, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !169
  ...
  //   %6 = load i32, i32* @atom_1_X2_0, align 4, !dbg !106, !tbaa !107
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %7 = load i32, i32* @atom_0_X0_1, align 4, !dbg !109, !tbaa !107
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !110, !tbaa !107
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !149, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !151, metadata !DIExpression()), !dbg !152
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([97 x i8], [97 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !116
