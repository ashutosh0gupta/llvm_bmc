...
T2BLOCK4:
  ...
  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !94, !tbaa !95
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 1, !dbg !99
  ...
  //   store i32 %conv15, i32* @atom_1_X5_1, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 2, !dbg !101
  ...
  //   store i32 %conv17, i32* @atom_1_X6_2, align 4, !dbg !102, !tbaa !95
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !130, metadata !DIExpression()), !dbg !135
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !166, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !169, metadata !DIExpression()), !dbg !217
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
