...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !82, metadata !DIExpression()), !dbg !125
  ...
  //   %cmp17 = icmp eq i32 %conv4, 1, !dbg !108

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !85, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !86, metadata !DIExpression()), !dbg !128
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !177, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !180, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !202, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !206, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !210, metadata !DIExpression()), !dbg !275
