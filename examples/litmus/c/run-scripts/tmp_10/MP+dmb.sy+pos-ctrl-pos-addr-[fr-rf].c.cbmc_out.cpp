...
T2BLOCK4:
  ...
  //   %cmp23 = icmp eq i32 %conv4, 1, !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !91, metadata !DIExpression()), !dbg !136

  //   %7 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv20, 1, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !99, metadata !DIExpression()), !dbg !142

  //   %9 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !101, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %9, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !155
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !185, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !191, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !209, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !217, metadata !DIExpression()), !dbg !276
