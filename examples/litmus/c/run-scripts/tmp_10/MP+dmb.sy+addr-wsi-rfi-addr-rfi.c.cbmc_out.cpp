...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !140, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !144, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !186

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !147, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !188

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !130, !tbaa !131
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X6_2, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X10_1, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
