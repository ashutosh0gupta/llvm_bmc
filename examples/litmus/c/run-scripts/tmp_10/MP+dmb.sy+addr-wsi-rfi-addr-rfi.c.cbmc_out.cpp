...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !64, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !70, metadata !DIExpression()), !dbg !95

  //   %xor7 = xor i32 %conv6, %conv6, !dbg !90
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !74, metadata !DIExpression()), !dbg !95

  //   %add9 = add nsw i32 0, %xor7, !dbg !91
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom10 = sext i32 %add9 to i64, !dbg !91

  //   %arrayidx11 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom10, !dbg !91
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx11, metadata !75, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* %arrayidx11 monotonic, align 8, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !81, metadata !DIExpression()), !dbg !112

  //   %conv16 = trunc i64 %2 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !78, metadata !DIExpression()), !dbg !95

  //   %cmp = icmp eq i32 %conv, 1, !dbg !96

  //   %conv17 = zext i1 %cmp to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !82, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !83, metadata !DIExpression()), !dbg !116

  //   %3 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !85, metadata !DIExpression()), !dbg !116
  ...
  //   %cmp21 = icmp eq i32 %conv6, 2, !dbg !99

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !86, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !87, metadata !DIExpression()), !dbg !119

  //   %4 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !89, metadata !DIExpression()), !dbg !119
  ...
  //   %cmp26 = icmp eq i32 %conv16, 1, !dbg !102

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !90, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !91, metadata !DIExpression()), !dbg !122

  //   %5 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !93, metadata !DIExpression()), !dbg !122

  //   store atomic i64 %5, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !132, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !133, metadata !DIExpression()), !dbg !189

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !134, metadata !DIExpression()), !dbg !191

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !138, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !139, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64 0, metadata !141, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !142, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !148, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !151, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64 0, metadata !153, metadata !DIExpression()), !dbg !202

  //   store atomic i64 0, i64* @atom_1_X6_2 monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !154, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !204

  //   store atomic i64 0, i64* @atom_1_X10_1 monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !158, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !160, metadata !DIExpression()), !dbg !216

  //   %conv = trunc i64 %4 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !157, metadata !DIExpression()), !dbg !189

  //   %cmp = icmp eq i32 %conv, 2, !dbg !129

  //   %conv14 = zext i1 %cmp to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !161, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !165, metadata !DIExpression()), !dbg !220

  //   %conv18 = trunc i64 %5 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !162, metadata !DIExpression()), !dbg !189

  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !133

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !166, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !170, metadata !DIExpression()), !dbg !224

  //   %conv24 = trunc i64 %6 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !167, metadata !DIExpression()), !dbg !189

  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !137

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !171, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !175, metadata !DIExpression()), !dbg !228

  //   %conv30 = trunc i64 %7 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !172, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !177, metadata !DIExpression()), !dbg !231

  //   %8 = load atomic i64, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !179, metadata !DIExpression()), !dbg !231

  //   %conv34 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !176, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !181, metadata !DIExpression()), !dbg !234

  //   %9 = load atomic i64, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !183, metadata !DIExpression()), !dbg !234

  //   %conv38 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !180, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !185, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !186, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !187, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !188, metadata !DIExpression()), !dbg !189
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
