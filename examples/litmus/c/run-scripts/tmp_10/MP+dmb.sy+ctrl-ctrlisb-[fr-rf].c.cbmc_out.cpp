...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !161, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !199

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !164, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !201

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X4_0, align 4, !dbg !129, !tbaa !127
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_1_X6_1, align 4, !dbg !130, !tbaa !127
  // LD: Guess
  old_cr = cr(0,5);
