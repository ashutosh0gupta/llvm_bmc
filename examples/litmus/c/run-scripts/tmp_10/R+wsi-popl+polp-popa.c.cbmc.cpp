...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_2, metadata !123, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i32 0, metadata !126, metadata !DIExpression()), !dbg !162

  //   store atomic i32 0, i32* @atom_0_X5_2 monotonic, align 4, !dbg !96
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_0_X5_2, align 4, !dbg !121, !tbaa !122
  // LD: Guess
  old_cr = cr(0,3);
