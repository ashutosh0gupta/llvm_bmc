...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !71, metadata !DIExpression()), !dbg !82
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !75, metadata !DIExpression()), !dbg !85

  //   %conv = trunc i64 %0 to i32, !dbg !51

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !72, metadata !DIExpression()), !dbg !82

  //   %xor = xor i32 %conv, %conv, !dbg !52
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !76, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !90
  ...
  // ST: Guess
  iw(3,r3) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l35_c3
  old_cw = cw(3,r3);
  cw(3,r3) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l35_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !122, metadata !DIExpression()), !dbg !152
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([100 x i8], [100 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
