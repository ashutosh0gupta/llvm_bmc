...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !61
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !42, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !45, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !48, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !49, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !52, metadata !DIExpression()), !dbg !70

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  //   %conv6 = zext i1 %cmp to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !53, metadata !DIExpression()), !dbg !58

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !54, metadata !DIExpression()), !dbg !73
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !79, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !87, metadata !DIExpression()), !dbg !101
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !124, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !141, metadata !DIExpression()), !dbg !182
