...
T2BLOCK1:
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !73
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !83

  //   %add = add nsw i32 0, %xor, !dbg !74
  creg_r3 = max(0,creg_r2);
  r3 = 0 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !74

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !74
  r4 = 0+r3*1;
  creg_r4 = creg_r3;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !94
  ...
  //   store i32 %conv17, i32* @atom_1_X4_0, align 4, !dbg !89, !tbaa !82
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !153, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !193

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !106
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X4_0, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
