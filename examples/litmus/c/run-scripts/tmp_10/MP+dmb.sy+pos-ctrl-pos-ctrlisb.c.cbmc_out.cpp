...
T2BLOCK7:
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !109

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !83, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !84, metadata !DIExpression()), !dbg !129
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !149, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !158, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !161, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !164, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !170, metadata !DIExpression()), !dbg !220

  //   %conv = trunc i64 %4 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !167, metadata !DIExpression()), !dbg !193

  //   %cmp = icmp eq i32 %conv, 1, !dbg !123

  //   %conv14 = zext i1 %cmp to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !171, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !175, metadata !DIExpression()), !dbg !224

  //   %conv18 = trunc i64 %5 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !172, metadata !DIExpression()), !dbg !193

  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !127

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !176, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !180, metadata !DIExpression()), !dbg !228

  //   %conv24 = trunc i64 %6 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !177, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !182, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !186, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !188, metadata !DIExpression()), !dbg !234

  //   %conv32 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !185, metadata !DIExpression()), !dbg !193
