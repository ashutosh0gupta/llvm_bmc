...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !68, metadata !DIExpression()), !dbg !88

  //   %add6 = add nsw i32 3, %xor5, !dbg !80
  creg_r6 = max(0,creg_r5);
  r6 = 3 + r5;

  //   %idxprom7 = sext i32 %add6 to i64, !dbg !80

  //   %arrayidx8 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom7, !dbg !80
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx8, metadata !69, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64 1, metadata !71, metadata !DIExpression()), !dbg !100

  //   store atomic i64 1, i64* %arrayidx8 monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !73, metadata !DIExpression()), !dbg !101
...
T2BLOCK4:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !79, metadata !DIExpression()), !dbg !88
  ...
  //   %cmp20 = icmp eq i32 %conv12, 2, !dbg !102
  ...
  //   store i32 %conv21, i32* @atom_1_X8_2, align 4, !dbg !103, !tbaa !98
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv18, 1, !dbg !104
  ...
  //   store i32 %conv23, i32* @atom_1_X11_1, align 4, !dbg !105, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !146, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !147, metadata !DIExpression()), !dbg !199

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !148, metadata !DIExpression()), !dbg !201

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !152, metadata !DIExpression()), !dbg !203

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !153, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !154, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !160, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_2, metadata !170, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_1, metadata !173, metadata !DIExpression()), !dbg !218
