...
T2BLOCK1:
  ...
  //   %xor10 = xor i32 %conv9, %conv9, !dbg !88
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor10, metadata !78, metadata !DIExpression()), !dbg !91

  //   %add12 = add nsw i32 0, %xor10, !dbg !89
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add12 to i64, !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !81, metadata !DIExpression()), !dbg !109

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !89
  // ST: Guess
  iw(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l37_c3
  old_cw = cw(2,r7);
  cw(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l37_c3
  // Check
  ...
  //   store i32 %conv20, i32* @atom_1_X2_1, align 4, !dbg !101, !tbaa !96
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv9, 1, !dbg !102
  ...
  //   store i32 %conv22, i32* @atom_1_X5_1, align 4, !dbg !103, !tbaa !96
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !153, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !159, metadata !DIExpression()), !dbg !204
