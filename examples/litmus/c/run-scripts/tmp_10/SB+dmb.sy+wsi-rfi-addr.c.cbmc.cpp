...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !78, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !82, metadata !DIExpression()), !dbg !98

  //   %conv6 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !79, metadata !DIExpression()), !dbg !86
  ...
  //   store i32 %conv7, i32* @atom_1_X3_2, align 4, !dbg !73, !tbaa !74
  // ST: Guess
  ...
  //   %cmp8 = icmp eq i32 %conv6, 0, !dbg !78
  creg__r5__0_ = max(0,creg_r5);

  //   %conv9 = zext i1 %cmp8 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !84, metadata !DIExpression()), !dbg !86

  //   store i32 %conv9, i32* @atom_1_X5_0, align 4, !dbg !79, !tbaa !74
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !125, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !129, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !132, metadata !DIExpression()), !dbg !165
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !127
