...
T2BLOCK4:
  ...
  //   %cmp21 = icmp eq i32 %conv9, 2, !dbg !109
  ...
  //   store i32 %conv22, i32* @atom_1_X6_2, align 4, !dbg !110, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !179, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !230

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X6_2, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
