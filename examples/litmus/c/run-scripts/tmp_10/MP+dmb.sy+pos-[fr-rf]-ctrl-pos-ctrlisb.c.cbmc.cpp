...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !95

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !77
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !101

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !101
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !110

  //   %conv12 = trunc i64 %3 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !73, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !78, metadata !DIExpression()), !dbg !113

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !113

  //   %conv16 = trunc i64 %4 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !77, metadata !DIExpression()), !dbg !92

  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !97
  creg__r4__0_ = max(0,creg_r4);

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !99
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   %conv23 = trunc i64 %5 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !81, metadata !DIExpression()), !dbg !92

  //   %cmp = icmp eq i32 %conv, 1, !dbg !107
  creg__r0__1_ = max(0,creg_r0);

  //   %conv24 = zext i1 %cmp to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !85, metadata !DIExpression()), !dbg !92

  //   store i32 %conv24, i32* @atom_1_X0_1, align 4, !dbg !108, !tbaa !109
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv4, 1, !dbg !113
  creg__r1__1_ = max(0,creg_r1);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !86, metadata !DIExpression()), !dbg !92

  //   store i32 %conv26, i32* @atom_1_X2_1, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv8, 2, !dbg !115
  creg__r2__2_ = max(0,creg_r2);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !87, metadata !DIExpression()), !dbg !92

  //   store i32 %conv28, i32* @atom_1_X3_2, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv23, 0, !dbg !117
  creg__r5__0_ = max(0,creg_r5);

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !88, metadata !DIExpression()), !dbg !92

  //   store i32 %conv30, i32* @atom_1_X7_0, align 4, !dbg !118, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !159, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !160, metadata !DIExpression()), !dbg !208

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !161, metadata !DIExpression()), !dbg !210

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !165, metadata !DIExpression()), !dbg !212

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !166, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !167, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !215

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !217

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !173, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !219

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !176, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !221

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !180, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !223

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !183, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !186, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !188, metadata !DIExpression()), !dbg !227

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !114
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !115
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !116
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !117, !tbaa !118
  r7 = local_mem[0];
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !123, !tbaa !118
  r8 = local_mem[1];

  //   %call16 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !124
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !125, !tbaa !118
  r9 = local_mem[2];

  //   %call17 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !126
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !190, metadata !DIExpression()), !dbg !240

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !192, metadata !DIExpression()), !dbg !240

  //   %conv = trunc i64 %6 to i32, !dbg !129
  ...
  //   %conv18 = zext i1 %cmp to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !193, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !195, metadata !DIExpression()), !dbg !244

  //   %7 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !197, metadata !DIExpression()), !dbg !244

  //   %conv22 = trunc i64 %7 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !194, metadata !DIExpression()), !dbg !208

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !134
  creg__r11__2_ = max(0,creg_r11);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !198, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !199, metadata !DIExpression()), !dbg !208

  //   %9 = load i32, i32* @atom_1_X2_1, align 4, !dbg !138, !tbaa !136
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !200, metadata !DIExpression()), !dbg !208

  //   %10 = load i32, i32* @atom_1_X3_2, align 4, !dbg !139, !tbaa !136
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !201, metadata !DIExpression()), !dbg !208

  //   %11 = load i32, i32* @atom_1_X7_0, align 4, !dbg !140, !tbaa !136
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !202, metadata !DIExpression()), !dbg !208

  //   %and = and i32 %10, %11, !dbg !141
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !203, metadata !DIExpression()), !dbg !208

  //   %and25 = and i32 %9, %and, !dbg !142
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !204, metadata !DIExpression()), !dbg !208

  //   %and26 = and i32 %8, %and25, !dbg !143
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !205, metadata !DIExpression()), !dbg !208

  //   %and27 = and i32 %conv24, %and26, !dbg !144
  creg_r19 = max(creg__r11__2_,creg_r18);
  r19 = (r11==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !206, metadata !DIExpression()), !dbg !208

  //   %and28 = and i32 %conv18, %and27, !dbg !145
  creg_r20 = max(creg__r10__1_,creg_r19);
  r20 = (r10==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !207, metadata !DIExpression()), !dbg !208

  //   %cmp29 = icmp eq i32 %and28, 1, !dbg !146
  creg__r20__1_ = max(0,creg_r20);

  //   br i1 %cmp29, label %if.then, label %if.end, !dbg !148
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
