...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !36, metadata !DIExpression()), !dbg !53
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !37, metadata !DIExpression()), !dbg !56

  //   call void @llvm.dbg.value(metadata i64 1, metadata !40, metadata !DIExpression()), !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !41, metadata !DIExpression()), !dbg !58

  //   call void @llvm.dbg.value(metadata i64 1, metadata !43, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64 2, metadata !46, metadata !DIExpression()), !dbg !60
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !48, metadata !DIExpression()), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !51, metadata !DIExpression()), !dbg !53

  //   store i32 %conv5, i32* @atom_0_X5_3, align 4, !dbg !66, !tbaa !67
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !77, metadata !DIExpression()), !dbg !90

  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !54
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !78, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !84, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !85, metadata !DIExpression()), !dbg !87
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !107, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !108, metadata !DIExpression()), !dbg !151

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !109, metadata !DIExpression()), !dbg !153

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !113, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !114, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64 0, metadata !116, metadata !DIExpression()), !dbg !156

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !90
  // ST: Guess
  iw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l43_c3
  old_cw = cw(0,0+2*1);
  cw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l43_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !117, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i64 0, metadata !119, metadata !DIExpression()), !dbg !158

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !92
  // ST: Guess
  iw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l44_c3
  old_cw = cw(0,0+1*1);
  cw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l44_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !120, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64 0, metadata !122, metadata !DIExpression()), !dbg !160

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !94
  // ST: Guess
  iw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l45_c3
  old_cw = cw(0,0);
  cw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l45_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_3, metadata !123, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i32 0, metadata !126, metadata !DIExpression()), !dbg !162

  //   store atomic i32 0, i32* @atom_0_X5_3 monotonic, align 4, !dbg !96
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l46_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l46_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !127, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i32 0, metadata !129, metadata !DIExpression()), !dbg !164

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !131, metadata !DIExpression()), !dbg !174

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l55_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !133, metadata !DIExpression()), !dbg !174

  //   %conv = trunc i64 %4 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !130, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !134, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !136, metadata !DIExpression()), !dbg !178

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l57_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !138, metadata !DIExpression()), !dbg !178

  //   %conv16 = trunc i64 %5 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !135, metadata !DIExpression()), !dbg !151

  //   %cmp17 = icmp eq i32 %conv16, 3, !dbg !116
  creg__r6__3_ = max(0,creg_r6);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !139, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !141, metadata !DIExpression()), !dbg !182

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l59_c13
  // Check
  ...
  if(cr(0,0+2*1) < cw(0,0+2*1)) {
    ...
    r7 = mem(0+2*1,cr(0,0+2*1));
  }
  ASSUME(creturn[0] >= cr(0,0+2*1));

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !143, metadata !DIExpression()), !dbg !182

  //   %conv22 = trunc i64 %6 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !140, metadata !DIExpression()), !dbg !151

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !120
  creg__r7__1_ = max(0,creg_r7);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !144, metadata !DIExpression()), !dbg !151

  //   %7 = load i32, i32* @atom_0_X5_3, align 4, !dbg !121, !tbaa !122
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !145, metadata !DIExpression()), !dbg !151

  //   %8 = load i32, i32* @atom_1_X4_0, align 4, !dbg !124, !tbaa !122
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !146, metadata !DIExpression()), !dbg !151

  //   %and = and i32 %7, %8, !dbg !125
  creg_r10 = max(creg_r8,creg_r9);
  r10 = r8 & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !147, metadata !DIExpression()), !dbg !151

  //   %and25 = and i32 %conv24, %and, !dbg !126
  creg_r11 = max(creg__r7__1_,creg_r10);
  r11 = (r7==1) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !148, metadata !DIExpression()), !dbg !151

  //   %and26 = and i32 %conv18, %and25, !dbg !127
  creg_r12 = max(creg__r6__3_,creg_r11);
  r12 = (r6==3) & r11;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !149, metadata !DIExpression()), !dbg !151

  //   %and27 = and i32 %conv12, %and26, !dbg !128
  creg_r13 = max(creg__r5__1_,creg_r12);
  r13 = (r5==1) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !150, metadata !DIExpression()), !dbg !151

  //   %cmp28 = icmp eq i32 %and27, 1, !dbg !129
  creg__r13__1_ = max(0,creg_r13);

  //   br i1 %cmp28, label %if.then, label %if.end, !dbg !131
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !132
