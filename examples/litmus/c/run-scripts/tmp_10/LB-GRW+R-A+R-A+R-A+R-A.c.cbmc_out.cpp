...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !155, metadata !DIExpression()), !dbg !169

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4) acquire, align 8, !dbg !62
  // LD: Guess
  //   : Acquire
  old_cr = cr(5,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !158, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64 1, metadata !160, metadata !DIExpression()), !dbg !172

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !65
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !162, metadata !DIExpression()), !dbg !175

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !164, metadata !DIExpression()), !dbg !175

  //   store atomic i64 %1, i64* @atom_4_X0_1 seq_cst, align 8, !dbg !68
  // ST: Guess
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !182, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !184, metadata !DIExpression()), !dbg !196

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !181, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64 1, metadata !187, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !189, metadata !DIExpression()), !dbg !203
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !242, metadata !DIExpression()), !dbg !314
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !261, metadata !DIExpression()), !dbg !348
