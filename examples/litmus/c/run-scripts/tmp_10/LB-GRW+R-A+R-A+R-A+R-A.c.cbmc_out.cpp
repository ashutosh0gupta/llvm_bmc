...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !123, metadata !DIExpression()), !dbg !134
  ...
  // ST: Guess
  iw(4,9) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l54_c15
  old_cw = cw(4,9);
  cw(4,9) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l54_c15
  // Check
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !143, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !146, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64 1, metadata !148, metadata !DIExpression()), !dbg !157
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !166, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !165, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 1, metadata !171, metadata !DIExpression()), !dbg !181
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !226, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i32 0, metadata !228, metadata !DIExpression()), !dbg !279

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !135
  // ST: Guess
  ...
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l95_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l95_c3
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,11);
  cr(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l112_c13
  // Check
  ...
  //   %13 = load i32, i32* @atom_0_X0_1, align 4, !dbg !169, !tbaa !167
  // LD: Guess
  old_cr = cr(0,6);
  ...
  // LD: Guess
  old_cr = cr(0,9);
  cr(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l116_c13
  // Check
