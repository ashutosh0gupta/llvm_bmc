...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !112, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !114, metadata !DIExpression()), !dbg !132

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !116, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !118, metadata !DIExpression()), !dbg !135

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !120, metadata !DIExpression()), !dbg !135
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !145
