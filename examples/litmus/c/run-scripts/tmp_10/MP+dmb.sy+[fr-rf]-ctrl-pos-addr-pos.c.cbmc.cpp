...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv4, 0, !dbg !94
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !103), !dbg !118
  ...
  //   %xor = xor i32 %conv12, %conv12, !dbg !106
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !77, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !129

  //   %conv20 = trunc i64 %5 to i32, !dbg !112
  ...
  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv4, 2, !dbg !116

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !90, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !91, metadata !DIExpression()), !dbg !136

  //   %7 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %7, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !94, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !95, metadata !DIExpression()), !dbg !139

  //   %8 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !139
  ...
  //   %cmp33 = icmp eq i32 %conv20, 0, !dbg !122

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !98, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !99, metadata !DIExpression()), !dbg !142

  //   %9 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !101, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !155
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !165, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !166, metadata !DIExpression()), !dbg !225

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !167, metadata !DIExpression()), !dbg !227

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !171, metadata !DIExpression()), !dbg !229

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !172, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !173, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !176, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !179, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !182, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !185, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !188, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !191, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !195, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !198, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !200, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !199, metadata !DIExpression()), !dbg !225

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !145

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !203, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !205, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !204, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !209, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !211, metadata !DIExpression()), !dbg !270

  //   %conv32 = trunc i64 %9 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !208, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !213, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !215, metadata !DIExpression()), !dbg !273

  //   %conv36 = trunc i64 %10 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !212, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !217, metadata !DIExpression()), !dbg !276

  //   %11 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !156
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !219, metadata !DIExpression()), !dbg !276

  //   %conv40 = trunc i64 %11 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !216, metadata !DIExpression()), !dbg !225
