...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !115
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !117

  //   %conv20 = trunc i64 %5 to i32, !dbg !100
  ...
  //   store i32 %conv25, i32* @atom_1_X7_0, align 4, !dbg !110, !tbaa !103
  // ST: Guess
  ...
  //   store i32 %conv27, i32* @atom_1_X9_0, align 4, !dbg !112, !tbaa !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !174, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !177, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !180, metadata !DIExpression()), !dbg !221
  ...
  //   %11 = load i32, i32* @atom_1_X9_0, align 4, !dbg !140, !tbaa !136
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
