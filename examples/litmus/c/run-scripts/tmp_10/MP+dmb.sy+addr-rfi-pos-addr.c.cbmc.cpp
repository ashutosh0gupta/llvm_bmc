...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !126, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !127, metadata !DIExpression()), !dbg !180

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !128, metadata !DIExpression()), !dbg !182

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !132, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !133, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64 0, metadata !135, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !136, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64 0, metadata !138, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !139, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64 0, metadata !141, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !142, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i32 0, metadata !145, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !146, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !193

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !149, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !152, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !158, metadata !DIExpression()), !dbg !207

  //   %conv = trunc i64 %4 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !155, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !159, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !163, metadata !DIExpression()), !dbg !211

  //   %conv20 = trunc i64 %5 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !160, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !164, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !166, metadata !DIExpression()), !dbg !215

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !136
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l70_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !168, metadata !DIExpression()), !dbg !215

  //   %conv26 = trunc i64 %6 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !165, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !169, metadata !DIExpression()), !dbg !180

  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !139, !tbaa !140
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l72_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !170, metadata !DIExpression()), !dbg !180

  //   %8 = load i32, i32* @atom_1_X5_1, align 4, !dbg !142, !tbaa !140
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !171, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !172, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !173, metadata !DIExpression()), !dbg !180

  //   %and = and i32 %9, %10, !dbg !145
  creg_r20 = max(creg_r18,creg_r19);
  r20 = r18 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !174, metadata !DIExpression()), !dbg !180

  //   %and29 = and i32 %8, %and, !dbg !146
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !175, metadata !DIExpression()), !dbg !180

  //   %and30 = and i32 %7, %and29, !dbg !147
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !176, metadata !DIExpression()), !dbg !180

  //   %and31 = and i32 %conv28, %and30, !dbg !148
  creg_r23 = max(creg__r15__1_,creg_r22);
  r23 = (r15==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !177, metadata !DIExpression()), !dbg !180

  //   %and32 = and i32 %conv22, %and31, !dbg !149
  creg_r24 = max(creg__r14__1_,creg_r23);
  r24 = (r14==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !178, metadata !DIExpression()), !dbg !180

  //   %and33 = and i32 %conv16, %and32, !dbg !150
  creg_r25 = max(creg__r13__1_,creg_r24);
  r25 = (r13==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !179, metadata !DIExpression()), !dbg !180
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154
