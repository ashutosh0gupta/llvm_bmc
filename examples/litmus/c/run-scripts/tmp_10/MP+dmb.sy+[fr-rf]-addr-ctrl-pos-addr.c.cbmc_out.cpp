...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !93

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !75
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !96

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !71, metadata !DIExpression()), !dbg !101
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !109

  //   %conv12 = trunc i64 %3 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !72, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !77, metadata !DIExpression()), !dbg !112

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !79, metadata !DIExpression()), !dbg !112
  ...
  //   %arrayidx21 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !97
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !82, metadata !DIExpression()), !dbg !117

  //   %5 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(2,r10);
  cr(2,r10) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l38_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !117

  //   %conv24 = trunc i64 %5 to i32, !dbg !99
  ...
  //   %cmp26 = icmp eq i32 %conv4, 2, !dbg !106
  ...
  //   store i32 %conv27, i32* @atom_1_X2_2, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   store i32 %conv29, i32* @atom_1_X10_0, align 4, !dbg !109, !tbaa !102
  // ST: Guess
...
T3BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !48
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !150, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !151, metadata !DIExpression()), !dbg !197

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !152, metadata !DIExpression()), !dbg !199

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !156, metadata !DIExpression()), !dbg !201

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !157, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !158, metadata !DIExpression()), !dbg !204
  ...
  // ST: Guess
  iw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l59_c3
  old_cw = cw(0,0+3*1);
  cw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l59_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !167, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !170, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !174, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !214

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !177, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !216

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !111
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !112
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !113, !tbaa !114
  r13 = local_mem[0];

  //   %call15 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !118
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !119, !tbaa !114
  r14 = local_mem[1];

  //   %call16 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !120
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !121, !tbaa !114
  r15 = local_mem[2];

  //   %call17 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !122
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !180, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !184, metadata !DIExpression()), !dbg !197
  ...
  //   %conv22 = trunc i64 %7 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !185, metadata !DIExpression()), !dbg !197

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !130
  creg__r17__2_ = max(0,creg_r17);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !189, metadata !DIExpression()), !dbg !197

  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !131, !tbaa !132
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !190, metadata !DIExpression()), !dbg !197

  //   %9 = load i32, i32* @atom_1_X2_2, align 4, !dbg !134, !tbaa !132
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !191, metadata !DIExpression()), !dbg !197

  //   %10 = load i32, i32* @atom_1_X10_0, align 4, !dbg !135, !tbaa !132
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !192, metadata !DIExpression()), !dbg !197

  //   %and = and i32 %9, %10, !dbg !136
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !193, metadata !DIExpression()), !dbg !197

  //   %and25 = and i32 %8, %and, !dbg !137
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !194, metadata !DIExpression()), !dbg !197

  //   %and26 = and i32 %conv24, %and25, !dbg !138
  creg_r23 = max(creg__r17__2_,creg_r22);
  r23 = (r17==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !195, metadata !DIExpression()), !dbg !197

  //   %and27 = and i32 %conv18, %and26, !dbg !139
  creg_r24 = max(creg__r16__1_,creg_r23);
  r24 = (r16==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !196, metadata !DIExpression()), !dbg !197
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
