...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !105
  ...
  //   store i32 %conv21, i32* @atom_1_X3_0, align 4, !dbg !104, !tbaa !97
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X6_1, align 4, !dbg !108, !tbaa !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !170, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !215

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !176, metadata !DIExpression()), !dbg !219
  ...
  //   %10 = load i32, i32* @atom_1_X3_0, align 4, !dbg !143, !tbaa !140
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %12 = load i32, i32* @atom_1_X6_1, align 4, !dbg !145, !tbaa !140
  // LD: Guess
  old_cr = cr(0,6);
