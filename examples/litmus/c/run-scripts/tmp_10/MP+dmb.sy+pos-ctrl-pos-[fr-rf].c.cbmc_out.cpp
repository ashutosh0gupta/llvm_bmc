...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !61, metadata !DIExpression()), !dbg !105
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !108

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !66, metadata !DIExpression()), !dbg !108

  //   %conv = trunc i64 %0 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !62, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !111

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !111

  //   %conv4 = trunc i64 %1 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !105
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !104), !dbg !119

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !120

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !120

  //   %conv8 = trunc i64 %2 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !123

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !123

  //   %conv12 = trunc i64 %3 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !126

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !126

  //   %conv16 = trunc i64 %4 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !79, metadata !DIExpression()), !dbg !105

  //   %cmp = icmp eq i32 %conv, 1, !dbg !110

  //   %conv17 = zext i1 %cmp to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !83, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !84, metadata !DIExpression()), !dbg !130

  //   %5 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !130
  ...
  //   %cmp19 = icmp eq i32 %conv4, 1, !dbg !113

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !87, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !88, metadata !DIExpression()), !dbg !133

  //   %6 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %6, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !91, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !92, metadata !DIExpression()), !dbg !136

  //   %7 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %7, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv12, 0, !dbg !119

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !95, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !96, metadata !DIExpression()), !dbg !139

  //   %8 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %8, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv16, 1, !dbg !122

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !99, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !100, metadata !DIExpression()), !dbg !142

  //   %9 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %9, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !155
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !165, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !166, metadata !DIExpression()), !dbg !230

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !167, metadata !DIExpression()), !dbg !232

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !171, metadata !DIExpression()), !dbg !234

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !172, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !237

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !176, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !239

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !179, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !182, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !185, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !245

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !188, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !247

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !191, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !249

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !133
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !134
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !135, !tbaa !136
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %call15 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !141, !tbaa !136
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !143, !tbaa !136
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !144
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !195, metadata !DIExpression()), !dbg !264

  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !146
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !197, metadata !DIExpression()), !dbg !264

  //   %conv = trunc i64 %6 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !194, metadata !DIExpression()), !dbg !230

  //   %cmp = icmp eq i32 %conv, 2, !dbg !148

  //   %conv18 = zext i1 %cmp to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !198, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !200, metadata !DIExpression()), !dbg !268

  //   %7 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !150
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !202, metadata !DIExpression()), !dbg !268

  //   %conv22 = trunc i64 %7 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !199, metadata !DIExpression()), !dbg !230

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !152

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !203, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !205, metadata !DIExpression()), !dbg !272

  //   %8 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !154
  // LD: Guess
  old_cr = cr(0,2);
  ...
  if(cr(0,2) < cw(0,2)) {
    ...
    ASSUME((!(( (cw(0,2) < 5) && (5 < crmax(0,2)) )))||(sforbid(2,5)> 0));
    ASSUME((!(( (cw(0,2) < 6) && (6 < crmax(0,2)) )))||(sforbid(2,6)> 0));
    ASSUME((!(( (cw(0,2) < 7) && (7 < crmax(0,2)) )))||(sforbid(2,7)> 0));
    ASSUME((!(( (cw(0,2) < 8) && (8 < crmax(0,2)) )))||(sforbid(2,8)> 0));
    ASSUME((!(( (cw(0,2) < 9) && (9 < crmax(0,2)) )))||(sforbid(2,9)> 0));
  } else {
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !207, metadata !DIExpression()), !dbg !272

  //   %conv28 = trunc i64 %8 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !204, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !209, metadata !DIExpression()), !dbg !275

  //   %9 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !211, metadata !DIExpression()), !dbg !275

  //   %conv32 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !208, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !213, metadata !DIExpression()), !dbg !278

  //   %10 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !160
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !215, metadata !DIExpression()), !dbg !278

  //   %conv36 = trunc i64 %10 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !212, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !217, metadata !DIExpression()), !dbg !281

  //   %11 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !163
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !219, metadata !DIExpression()), !dbg !281

  //   %conv40 = trunc i64 %11 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !216, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !221, metadata !DIExpression()), !dbg !284

  //   %12 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !166
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !223, metadata !DIExpression()), !dbg !284

  //   %conv44 = trunc i64 %12 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !220, metadata !DIExpression()), !dbg !230

  //   %and = and i32 %conv40, %conv44, !dbg !168
  ...
  //   %and45 = and i32 %conv36, %and, !dbg !169
  creg_r17 = max(creg_r13,creg_r16);
  ASSUME(active[creg_r17] == 0);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !225, metadata !DIExpression()), !dbg !230

  //   %and46 = and i32 %conv32, %and45, !dbg !170
  creg_r18 = max(creg_r12,creg_r17);
  ASSUME(active[creg_r18] == 0);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !226, metadata !DIExpression()), !dbg !230

  //   %and47 = and i32 %conv28, %and46, !dbg !171
  creg_r19 = max(creg_r11,creg_r18);
  ASSUME(active[creg_r19] == 0);
  r19 = r11 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !227, metadata !DIExpression()), !dbg !230

  //   %and48 = and i32 %conv24, %and47, !dbg !172
  creg_r20 = max(max(creg_r10,0),creg_r19);
  ASSUME(active[creg_r20] == 0);
  r20 = (r10==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !228, metadata !DIExpression()), !dbg !230

  //   %and49 = and i32 %conv18, %and48, !dbg !173
  creg_r21 = max(max(creg_r9,0),creg_r20);
  ASSUME(active[creg_r21] == 0);
  r21 = (r9==2) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !229, metadata !DIExpression()), !dbg !230

  //   %cmp50 = icmp eq i32 %and49, 1, !dbg !174

  //   br i1 %cmp50, label %if.then, label %if.end, !dbg !176
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
