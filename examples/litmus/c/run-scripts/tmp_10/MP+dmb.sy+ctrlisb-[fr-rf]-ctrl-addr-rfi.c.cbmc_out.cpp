...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !73, metadata !DIExpression()), !dbg !92

  //   %xor = xor i32 %conv15, %conv15, !dbg !101
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !77, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i64 1, metadata !80, metadata !DIExpression()), !dbg !122

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !102
  // ST: Guess
  iw(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l40_c3
  old_cw = cw(2,r6);
  cw(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l40_c3
  // Check
