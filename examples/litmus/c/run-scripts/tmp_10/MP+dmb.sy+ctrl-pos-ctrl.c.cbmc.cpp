...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !75), !dbg !80
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !76), !dbg !89
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !77), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !72, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !73, metadata !DIExpression()), !dbg !78
  ...
  //   %cmp17 = icmp eq i32 %conv15, 0, !dbg !92
  creg__r3__0_ = max(0,creg_r3);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !74, metadata !DIExpression()), !dbg !78

  //   store i32 %conv18, i32* @atom_1_X5_0, align 4, !dbg !93, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !141, metadata !DIExpression()), !dbg !172
