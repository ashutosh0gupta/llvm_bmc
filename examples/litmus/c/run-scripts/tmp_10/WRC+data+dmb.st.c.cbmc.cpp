...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !83, metadata !DIExpression()), !dbg !95
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !85, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !102

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(3,0);
  cr(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l40_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !93, metadata !DIExpression()), !dbg !95
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !117, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !118, metadata !DIExpression()), !dbg !146

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !119, metadata !DIExpression()), !dbg !148

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !123, metadata !DIExpression()), !dbg !150

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !124, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !125, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !128, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !131, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i32 0, metadata !134, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !135, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i32 0, metadata !137, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !138, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i32 0, metadata !140, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !145, metadata !DIExpression()), !dbg !146
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([100 x i8], [100 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
