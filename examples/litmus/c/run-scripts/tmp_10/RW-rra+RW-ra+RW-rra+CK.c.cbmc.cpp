...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !174, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !207

  //   store atomic i32 0, i32* @atom_2_X2_0 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_2_X2_0, align 4, !dbg !131, !tbaa !127
  // LD: Guess
  old_cr = cr(0,7);
