...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !70, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !73, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !74, metadata !DIExpression()), !dbg !92

  //   %cmp = icmp eq i32 %conv, 1, !dbg !96

  //   %conv11 = zext i1 %cmp to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !78, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !79, metadata !DIExpression()), !dbg !116

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !116

  //   store atomic i64 %3, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !98
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv4, 2, !dbg !99

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !82, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !83, metadata !DIExpression()), !dbg !119

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %4, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !145, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !146, metadata !DIExpression()), !dbg !203

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !147, metadata !DIExpression()), !dbg !205

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !151, metadata !DIExpression()), !dbg !207

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !152, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !165, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !168, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !174, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !177, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !179, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !182, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !184, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !187, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !189, metadata !DIExpression()), !dbg !247

  //   %conv32 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !186, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !191, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !193, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !195, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !197, metadata !DIExpression()), !dbg !253
