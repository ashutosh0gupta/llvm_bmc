...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !74, metadata !DIExpression()), !dbg !89
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64 3, metadata !77, metadata !DIExpression()), !dbg !92

  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !56
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !79, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !81, metadata !DIExpression()), !dbg !94
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !82, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !86, metadata !DIExpression()), !dbg !89
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_3, metadata !132, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i32 0, metadata !135, metadata !DIExpression()), !dbg !165

  //   store atomic i32 0, i32* @atom_0_X5_3 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !136, metadata !DIExpression()), !dbg !167
  ...
  //   %6 = load i32, i32* @atom_0_X5_3, align 4, !dbg !111, !tbaa !112
  // LD: Guess
  old_cr = cr(0,3);
