...
T2BLOCK1:
  ...
  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !59
  // ST: Guess
  //   : Release
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_3, metadata !136, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64 0, metadata !138, metadata !DIExpression()), !dbg !174

  //   store atomic i64 0, i64* @atom_0_X5_3 monotonic, align 8, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_3, metadata !153, metadata !DIExpression()), !dbg !196

  //   %6 = load atomic i64, i64* @atom_0_X5_3 seq_cst, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,3);
