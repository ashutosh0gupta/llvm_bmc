...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !179, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !182, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !226

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !116
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X8_0, align 4, !dbg !143, !tbaa !141
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X10_0, align 4, !dbg !144, !tbaa !141
  // LD: Guess
  old_cr = cr(0,6);
