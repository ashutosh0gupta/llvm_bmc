...
T2BLOCK1:
  ...
  //   %xor7 = xor i32 %conv6, %conv6, !dbg !78
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !74, metadata !DIExpression()), !dbg !83

  //   %add9 = add nsw i32 0, %xor7, !dbg !79
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom10 = sext i32 %add9 to i64, !dbg !79

  //   %arrayidx11 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom10, !dbg !79
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx11, metadata !76, metadata !DIExpression()), !dbg !99

  //   %2 = load atomic i64, i64* %arrayidx11 monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !99
  ...
  //   store i32 %conv15, i32* @atom_1_X2_2, align 4, !dbg !83, !tbaa !84
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv6, 2, !dbg !88
  ...
  //   store i32 %conv17, i32* @atom_1_X6_2, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv14, 0, !dbg !90
  ...
  //   store i32 %conv19, i32* @atom_1_X8_0, align 4, !dbg !91, !tbaa !84
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !149, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !156, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !199

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !110
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X8_0, align 4, !dbg !140, !tbaa !137
  // LD: Guess
  old_cr = cr(0,5);
