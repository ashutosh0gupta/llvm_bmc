...
T2BLOCK1:
  ...
  //   store i32 %conv19, i32* @atom_1_X2_2, align 4, !dbg !102, !tbaa !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !167, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !213

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !170, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !215

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X2_2, align 4, !dbg !142, !tbaa !140
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %10 = load i32, i32* @atom_1_X4_0, align 4, !dbg !143, !tbaa !140
  // LD: Guess
  old_cr = cr(0,4);
