...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !123

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !123

  //   %conv4 = trunc i64 %1 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !126

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !126

  //   %conv8 = trunc i64 %2 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !129

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !129
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !109), !dbg !137

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !80, metadata !DIExpression()), !dbg !138

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !138

  //   %conv19 = trunc i64 %4 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !79, metadata !DIExpression()), !dbg !111

  //   %tobool20 = icmp ne i32 %conv19, 0, !dbg !122

  //   br i1 %tobool20, label %if.then21, label %if.else22, !dbg !124
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !110), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !148

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !130
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !148

  //   %conv26 = trunc i64 %5 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !83, metadata !DIExpression()), !dbg !111

  //   %cmp = icmp eq i32 %conv, 1, !dbg !132

  //   %conv27 = zext i1 %cmp to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !87, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !152

  //   %6 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !152
  ...
  //   %cmp29 = icmp eq i32 %conv4, 0, !dbg !135

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !91, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !92, metadata !DIExpression()), !dbg !155

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %7, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !137
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv8, 0, !dbg !138

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !95, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !96, metadata !DIExpression()), !dbg !158

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !158

  //   store atomic i64 %8, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !140
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv12, 1, !dbg !141

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !99, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !100, metadata !DIExpression()), !dbg !161

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !161
  ...
  //   %cmp44 = icmp eq i32 %conv26, 0, !dbg !144

  //   %conv45 = zext i1 %cmp44 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv45, metadata !103, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !104, metadata !DIExpression()), !dbg !164

  //   %10 = zext i32 %conv45 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !106, metadata !DIExpression()), !dbg !164

  //   store atomic i64 %10, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !146
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !177
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !187, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !188, metadata !DIExpression()), !dbg !264

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !189, metadata !DIExpression()), !dbg !266

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !126

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !126

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !193, metadata !DIExpression()), !dbg !268

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !128

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !128

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !194, metadata !DIExpression()), !dbg !270

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !195, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !198, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !201, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !204, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !207, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !210, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !213, metadata !DIExpression()), !dbg !283

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !283

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !143
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !216, metadata !DIExpression()), !dbg !285

  //   call void @llvm.dbg.value(metadata i64 0, metadata !218, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !219, metadata !DIExpression()), !dbg !287

  //   call void @llvm.dbg.value(metadata i64 0, metadata !221, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !223, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !225, metadata !DIExpression()), !dbg !302

  //   %conv = trunc i64 %6 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !222, metadata !DIExpression()), !dbg !264

  //   %cmp = icmp eq i32 %conv, 1, !dbg !164

  //   %conv22 = zext i1 %cmp to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !226, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !228, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !230, metadata !DIExpression()), !dbg !306

  //   %conv26 = trunc i64 %7 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !227, metadata !DIExpression()), !dbg !264

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !168

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !231, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !233, metadata !DIExpression()), !dbg !310
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !235, metadata !DIExpression()), !dbg !310

  //   %conv32 = trunc i64 %8 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !232, metadata !DIExpression()), !dbg !264

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !172

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !172

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !236, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !238, metadata !DIExpression()), !dbg !314
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !240, metadata !DIExpression()), !dbg !314

  //   %conv38 = trunc i64 %9 to i32, !dbg !175

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !237, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !242, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !244, metadata !DIExpression()), !dbg !317

  //   %conv42 = trunc i64 %10 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !241, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !246, metadata !DIExpression()), !dbg !320

  //   %11 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !180
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !248, metadata !DIExpression()), !dbg !320

  //   %conv46 = trunc i64 %11 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !245, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !250, metadata !DIExpression()), !dbg !323
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !252, metadata !DIExpression()), !dbg !323

  //   %conv50 = trunc i64 %12 to i32, !dbg !184

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !249, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !254, metadata !DIExpression()), !dbg !326
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !256, metadata !DIExpression()), !dbg !326

  //   %conv54 = trunc i64 %13 to i32, !dbg !187

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !253, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !257, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !258, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !259, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !260, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !261, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !262, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !263, metadata !DIExpression()), !dbg !264
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 104, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !198
