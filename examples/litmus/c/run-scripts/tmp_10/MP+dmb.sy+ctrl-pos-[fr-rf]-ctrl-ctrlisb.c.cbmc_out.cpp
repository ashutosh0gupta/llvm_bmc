...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !94), !dbg !122

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !80, metadata !DIExpression()), !dbg !123

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !123
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !95), !dbg !131
  ...
  //   store i32 %conv31, i32* @atom_1_X4_0, align 4, !dbg !126, !tbaa !119
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv12, 1, !dbg !127
  ...
  //   store i32 %conv33, i32* @atom_1_X5_1, align 4, !dbg !128, !tbaa !119
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !154, metadata !DIExpression()), !dbg !161
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !195, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !198, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !201, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !208, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !213, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !218, metadata !DIExpression()), !dbg !278
