...
T2BLOCK4:
  ...
  //   %cmp26 = icmp eq i32 %conv4, 2, !dbg !109
  ...
  //   store i32 %conv27, i32* @atom_1_X2_2, align 4, !dbg !110, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !179, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !185, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !228

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !118
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X11_0, align 4, !dbg !145, !tbaa !141
  // LD: Guess
  old_cr = cr(0,7);
