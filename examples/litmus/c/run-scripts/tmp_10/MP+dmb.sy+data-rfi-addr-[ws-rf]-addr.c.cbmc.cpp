...
T2BLOCK1:
  ...
  //   %add = add nsw i32 %xor, 1, !dbg !92
  creg_r2 = max(creg_r1,0);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !66, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !112

  //   %conv1 = sext i32 %add to i64, !dbg !94

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !69, metadata !DIExpression()), !dbg !112

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()), !dbg !114

  //   %conv5 = trunc i64 %1 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !70, metadata !DIExpression()), !dbg !104

  //   %xor6 = xor i32 %conv5, %conv5, !dbg !98
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !74, metadata !DIExpression()), !dbg !104

  //   %add8 = add nsw i32 3, %xor6, !dbg !99
  creg_r5 = max(0,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = 3 + r4;

  //   %idxprom = sext i32 %add8 to i64, !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !119

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !99
  // ST: Guess
  iw(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,r6);
  cw(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
  // Check
  ASSUME(active[iw(2,r6)] == 2);
  ASSUME(active[cw(2,r6)] == 2);
  ASSUME(sforbid(r6,cw(2,r6))== 0);
  ASSUME(iw(2,r6) >= 0);
  ASSUME(iw(2,r6) >= creg_r6);
  ASSUME(cw(2,r6) >= iw(2,r6));
  ASSUME(cw(2,r6) >= old_cw);
  ASSUME(cw(2,r6) >= cr(2,r6));
  ASSUME(cw(2,r6) >= cl[2]);
  ASSUME(cw(2,r6) >= cisb[2]);
  ASSUME(cw(2,r6) >= cdy[2]);
  ASSUME(cw(2,r6) >= cdl[2]);
  ASSUME(cw(2,r6) >= cds[2]);
  ASSUME(cw(2,r6) >= cctrl[2]);
  ASSUME(cw(2,r6) >= caddr[2]);
  // Update
  ...
  co(r6,cw(2,r6))+=1;
  delta(r6,cw(2,r6)) = -1;
  ASSUME(creturn[2] >= cw(2,r6));

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !79, metadata !DIExpression()), !dbg !120

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   %conv13 = trunc i64 %2 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !78, metadata !DIExpression()), !dbg !104

  //   %xor14 = xor i32 %conv13, %conv13, !dbg !104
  creg_r8 = max(creg_r7,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor14, metadata !82, metadata !DIExpression()), !dbg !104

  //   %add16 = add nsw i32 0, %xor14, !dbg !105
  creg_r9 = max(0,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = 0 + r8;

  //   %idxprom17 = sext i32 %add16 to i64, !dbg !105

  //   %arrayidx18 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom17, !dbg !105
  r10 = 0+r9*1;
  ASSUME(creg_r10 >= 0);
  ASSUME(creg_r10 >= creg_r9);
  ASSUME(active[creg_r10] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx18, metadata !84, metadata !DIExpression()), !dbg !125

  //   %3 = load atomic i64, i64* %arrayidx18 monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !86, metadata !DIExpression()), !dbg !125

  //   %conv21 = trunc i64 %3 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !83, metadata !DIExpression()), !dbg !104

  //   %cmp = icmp eq i32 %conv, 1, !dbg !108

  //   %conv22 = zext i1 %cmp to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !87, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !128

  //   %4 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !90, metadata !DIExpression()), !dbg !128
  ...
  //   %cmp26 = icmp eq i32 %conv5, 1, !dbg !111

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !91, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !92, metadata !DIExpression()), !dbg !131

  //   %5 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !94, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %5, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv13, 2, !dbg !114

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !95, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !96, metadata !DIExpression()), !dbg !134

  //   %6 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !98, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %6, i64* @atom_1_X8_2 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv21, 0, !dbg !117

  //   %conv37 = zext i1 %cmp36 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv37, metadata !99, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !100, metadata !DIExpression()), !dbg !137

  //   %7 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !102, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %7, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !119
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !160, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !161, metadata !DIExpression()), !dbg !235

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !162, metadata !DIExpression()), !dbg !237

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !166, metadata !DIExpression()), !dbg !239

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !167, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !168, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !171, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !180, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !183, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !186, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !254

  //   store atomic i64 0, i64* @atom_1_X8_2 monotonic, align 8, !dbg !139
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !189, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !256

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !141
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !193, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !195, metadata !DIExpression()), !dbg !271

  //   %conv = trunc i64 %6 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !192, metadata !DIExpression()), !dbg !235

  //   %cmp = icmp eq i32 %conv, 2, !dbg !158

  //   %conv20 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !196, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !198, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !200, metadata !DIExpression()), !dbg !275

  //   %conv24 = trunc i64 %7 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !197, metadata !DIExpression()), !dbg !235

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !162

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !201, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !203, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !205, metadata !DIExpression()), !dbg !279

  //   %conv30 = trunc i64 %8 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !202, metadata !DIExpression()), !dbg !235

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !166

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !206, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !208, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !210, metadata !DIExpression()), !dbg !283

  //   %conv36 = trunc i64 %9 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !207, metadata !DIExpression()), !dbg !235

  //   %cmp37 = icmp eq i32 %conv36, 1, !dbg !170

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !211, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !213, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !215, metadata !DIExpression()), !dbg !287

  //   %conv42 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !212, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !217, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !219, metadata !DIExpression()), !dbg !290

  //   %conv46 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !216, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !221, metadata !DIExpression()), !dbg !293

  //   %12 = load atomic i64, i64* @atom_1_X8_2 seq_cst, align 8, !dbg !178
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !223, metadata !DIExpression()), !dbg !293

  //   %conv50 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !220, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !225, metadata !DIExpression()), !dbg !296

  //   %13 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !181
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !227, metadata !DIExpression()), !dbg !296

  //   %conv54 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !224, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !229, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !230, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !231, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !232, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !233, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !234, metadata !DIExpression()), !dbg !235
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !193
