...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !141, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !145, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X1_0, metadata !148, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !179

  //   store atomic i32 0, i32* @atom_3_X1_0 monotonic, align 4, !dbg !96
  // ST: Guess
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !117, !tbaa !118
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %10 = load i32, i32* @atom_2_X0_1, align 4, !dbg !120, !tbaa !118
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %11 = load i32, i32* @atom_3_X1_0, align 4, !dbg !121, !tbaa !118
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
