...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !149, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !152, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !155, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !199

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !158, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !201

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !165, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !167, metadata !DIExpression()), !dbg !217

  //   %5 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !126
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !166, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !171, metadata !DIExpression()), !dbg !220

  //   %6 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !175, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !177, metadata !DIExpression()), !dbg !223

  //   %conv26 = trunc i64 %7 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !174, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !179, metadata !DIExpression()), !dbg !226

  //   %8 = load atomic i64, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !181, metadata !DIExpression()), !dbg !226

  //   %conv30 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !178, metadata !DIExpression()), !dbg !186
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !144
