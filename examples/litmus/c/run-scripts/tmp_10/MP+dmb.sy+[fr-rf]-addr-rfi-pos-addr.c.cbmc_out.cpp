...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !100

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !100

  //   %conv4 = trunc i64 %1 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !94

  //   %xor = xor i32 %conv4, %conv4, !dbg !84
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !71, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 2, %xor, !dbg !85
  creg_r3 = max(0,creg_r2);
  r3 = 2 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !85

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !85
  r4 = 0+r3*1;
  creg_r4 = creg_r3;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !72, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !105

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !85
  // ST: Guess
  iw(2,r4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l34_c3
  old_cw = cw(2,r4);
  cw(2,r4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l34_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !106

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l35_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !106

  //   %conv8 = trunc i64 %2 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !75, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !80, metadata !DIExpression()), !dbg !109

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !109

  //   %conv12 = trunc i64 %3 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !79, metadata !DIExpression()), !dbg !94

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !93
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !83, metadata !DIExpression()), !dbg !94

  //   %add15 = add nsw i32 0, %xor13, !dbg !94
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !94

  //   %arrayidx17 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !94
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !85, metadata !DIExpression()), !dbg !114

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !87, metadata !DIExpression()), !dbg !114

  //   %conv20 = trunc i64 %4 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !84, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !97
  creg__r0__1_ = max(0,creg_r0);

  //   %conv21 = zext i1 %cmp to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !88, metadata !DIExpression()), !dbg !94

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !98, !tbaa !99
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 2, !dbg !103
  creg__r1__2_ = max(0,creg_r1);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !89, metadata !DIExpression()), !dbg !94

  //   store i32 %conv23, i32* @atom_1_X2_2, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 1, !dbg !105
  creg__r5__1_ = max(0,creg_r5);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !90, metadata !DIExpression()), !dbg !94

  //   store i32 %conv25, i32* @atom_1_X6_1, align 4, !dbg !106, !tbaa !99
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv12, 1, !dbg !107
  creg__r6__1_ = max(0,creg_r6);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !91, metadata !DIExpression()), !dbg !94

  //   store i32 %conv27, i32* @atom_1_X7_1, align 4, !dbg !108, !tbaa !99
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv20, 0, !dbg !109
  creg__r10__0_ = max(0,creg_r10);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !92, metadata !DIExpression()), !dbg !94

  //   store i32 %conv29, i32* @atom_1_X9_0, align 4, !dbg !110, !tbaa !99
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !134, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64 2, metadata !136, metadata !DIExpression()), !dbg !141

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !52
  // ST: Guess
  iw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l54_c3
  old_cw = cw(3,0+1*1);
  cw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l54_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !211

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !213

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !215

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !158, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64 0, metadata !161, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !168, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !224

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !120
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l66_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l66_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !172, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !226

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !122
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l67_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l67_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !175, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !228

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !178, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !230

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !181, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !232

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !185, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !187, metadata !DIExpression()), !dbg !245

  //   %conv = trunc i64 %6 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !184, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !188, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !190, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !192, metadata !DIExpression()), !dbg !249

  //   %conv24 = trunc i64 %7 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !189, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !193, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !195, metadata !DIExpression()), !dbg !253

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l84_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !197, metadata !DIExpression()), !dbg !253

  //   %conv30 = trunc i64 %8 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !194, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !198, metadata !DIExpression()), !dbg !211

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !154, !tbaa !155
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l86_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !199, metadata !DIExpression()), !dbg !211

  //   %10 = load i32, i32* @atom_1_X2_2, align 4, !dbg !157, !tbaa !155
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !200, metadata !DIExpression()), !dbg !211

  //   %11 = load i32, i32* @atom_1_X6_1, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !201, metadata !DIExpression()), !dbg !211

  //   %12 = load i32, i32* @atom_1_X7_1, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !202, metadata !DIExpression()), !dbg !211

  //   %13 = load i32, i32* @atom_1_X9_0, align 4, !dbg !160, !tbaa !155
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !203, metadata !DIExpression()), !dbg !211

  //   %and = and i32 %12, %13, !dbg !161
  creg_r23 = max(creg_r21,creg_r22);
  r23 = r21 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !204, metadata !DIExpression()), !dbg !211

  //   %and33 = and i32 %11, %and, !dbg !162
  creg_r24 = max(creg_r20,creg_r23);
  r24 = r20 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !205, metadata !DIExpression()), !dbg !211

  //   %and34 = and i32 %10, %and33, !dbg !163
  creg_r25 = max(creg_r19,creg_r24);
  r25 = r19 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !206, metadata !DIExpression()), !dbg !211

  //   %and35 = and i32 %9, %and34, !dbg !164
  creg_r26 = max(creg_r18,creg_r25);
  r26 = r18 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !207, metadata !DIExpression()), !dbg !211

  //   %and36 = and i32 %conv32, %and35, !dbg !165
  creg_r27 = max(creg__r17__1_,creg_r26);
  r27 = (r17==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !208, metadata !DIExpression()), !dbg !211

  //   %and37 = and i32 %conv26, %and36, !dbg !166
  creg_r28 = max(creg__r16__2_,creg_r27);
  r28 = (r16==2) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !209, metadata !DIExpression()), !dbg !211

  //   %and38 = and i32 %conv20, %and37, !dbg !167
  creg_r29 = max(creg__r15__1_,creg_r28);
  r29 = (r15==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !210, metadata !DIExpression()), !dbg !211
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
