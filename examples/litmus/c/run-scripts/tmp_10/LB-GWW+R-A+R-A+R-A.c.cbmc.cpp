...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !140, metadata !DIExpression()), !dbg !153

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(5,0+1*1);
  cr(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l59_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !142, metadata !DIExpression()), !dbg !153
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X0_1, metadata !193, metadata !DIExpression()), !dbg !239
  ...
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l79_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l79_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X2_0, metadata !197, metadata !DIExpression()), !dbg !241
