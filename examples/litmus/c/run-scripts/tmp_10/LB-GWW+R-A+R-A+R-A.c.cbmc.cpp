...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !150, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !152, metadata !DIExpression()), !dbg !171

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !154, metadata !DIExpression()), !dbg !171

  //   store atomic i64 %2, i64* @atom_4_X0_1 seq_cst, align 8, !dbg !73
  // ST: Guess
  ...
  //   %cmp7 = icmp eq i32 %conv4, 0, !dbg !74

  //   %conv8 = zext i1 %cmp7 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !155, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64* @atom_4_X2_0, metadata !156, metadata !DIExpression()), !dbg !174

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !158, metadata !DIExpression()), !dbg !174

  //   store atomic i64 %3, i64* @atom_4_X2_0 seq_cst, align 8, !dbg !76
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X2_0, metadata !212, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !214, metadata !DIExpression()), !dbg !271

  //   store atomic i64 0, i64* @atom_4_X2_0 monotonic, align 8, !dbg !134
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X2_0, metadata !229, metadata !DIExpression()), !dbg !301

  //   %11 = load atomic i64, i64* @atom_4_X2_0 seq_cst, align 8, !dbg !164
  // LD: Guess
  old_cr = cr(0,6);
