...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !149, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !150, metadata !DIExpression()), !dbg !206

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !151, metadata !DIExpression()), !dbg !208

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !155, metadata !DIExpression()), !dbg !210

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !156, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !157, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !166, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !172, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !176, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !178, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !181, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !183, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !186, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !188, metadata !DIExpression()), !dbg !246

  //   %conv26 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !185, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !190, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !192, metadata !DIExpression()), !dbg !249

  //   %conv30 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !189, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !194, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !196, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !198, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !200, metadata !DIExpression()), !dbg !255
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !161
