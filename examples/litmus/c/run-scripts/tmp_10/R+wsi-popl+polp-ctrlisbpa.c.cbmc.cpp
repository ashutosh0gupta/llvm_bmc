...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !74, metadata !DIExpression()), !dbg !92
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !78, metadata !DIExpression()), !dbg !92
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !82, metadata !DIExpression()), !dbg !92

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !73

  //   %conv5 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !86, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !87, metadata !DIExpression()), !dbg !111

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !89, metadata !DIExpression()), !dbg !111
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !140, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !154, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !158, metadata !DIExpression()), !dbg !200
