...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !104
  ...
  //   %conv9 = trunc i64 %2 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !74, metadata !DIExpression()), !dbg !91

  //   %tobool = icmp ne i32 %conv9, 0, !dbg !88
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64 1, metadata !80, metadata !DIExpression()), !dbg !113
  ...
  //   %cmp19 = icmp eq i32 %conv9, 1, !dbg !107
  ...
  //   store i32 %conv20, i32* @atom_1_X5_1, align 4, !dbg !108, !tbaa !101
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 1, !dbg !109
  ...
  //   store i32 %conv22, i32* @atom_1_X8_1, align 4, !dbg !110, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !175, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !178, metadata !DIExpression()), !dbg !225
