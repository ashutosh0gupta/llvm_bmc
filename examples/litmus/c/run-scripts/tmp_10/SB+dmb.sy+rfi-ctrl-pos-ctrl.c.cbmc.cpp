...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !82, metadata !DIExpression()), !dbg !109
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !86, metadata !DIExpression()), !dbg !118

  //   %conv15 = trunc i64 %3 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !83, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !87, metadata !DIExpression()), !dbg !92

  //   store i32 %conv16, i32* @atom_1_X2_1, align 4, !dbg !94, !tbaa !95
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv15, 0, !dbg !99
  creg__r4__0_ = max(0,creg_r4);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !88, metadata !DIExpression()), !dbg !92

  //   store i32 %conv18, i32* @atom_1_X6_0, align 4, !dbg !100, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !149, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !156, metadata !DIExpression()), !dbg !191
