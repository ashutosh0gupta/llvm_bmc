...
T2BLOCK7:
  ...
  //   %xor = xor i32 %conv15, %conv15, !dbg !113
  ...
  //   %add = add nsw i32 %xor, 1, !dbg !114
  creg_r5 = max(creg_r4,0);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !78, metadata !DIExpression()), !dbg !105
  ...
  //   %conv16 = sext i32 %add to i64, !dbg !116

  //   call void @llvm.dbg.value(metadata i64 %conv16, metadata !81, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %conv16, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv4, 0, !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !91, metadata !DIExpression()), !dbg !143

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !95, metadata !DIExpression()), !dbg !146

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !128
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !195, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !198, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !205, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !210, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !215, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !224, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !228, metadata !DIExpression()), !dbg !295
