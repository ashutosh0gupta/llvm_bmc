...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !113
  ...
  //   store i32 %conv17, i32* @atom_1_X0_1, align 4, !dbg !100, !tbaa !101
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv4, 2, !dbg !105
  ...
  //   store i32 %conv19, i32* @atom_1_X3_2, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv12, 0, !dbg !107
  ...
  //   store i32 %conv21, i32* @atom_1_X7_0, align 4, !dbg !108, !tbaa !101
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv16, 1, !dbg !109
  ...
  //   store i32 %conv23, i32* @atom_1_X9_1, align 4, !dbg !110, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !200

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !202

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !204

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !158, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !168, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !172, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !175, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !178, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !185, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !189, metadata !DIExpression()), !dbg !236

  //   %conv22 = trunc i64 %7 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !186, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !190, metadata !DIExpression()), !dbg !200
