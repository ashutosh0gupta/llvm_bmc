...
T2BLOCK4:
  ...
  //   %xor17 = xor i32 %conv16, %conv16, !dbg !118
  ...
  //   %add19 = add nsw i32 0, %xor17, !dbg !119
  creg_r9 = max(0,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = 0 + r8;

  //   %idxprom20 = sext i32 %add19 to i64, !dbg !119

  //   %arrayidx21 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !119
  r10 = 0+r9*1;
  ASSUME(creg_r10 >= 0);
  ASSUME(creg_r10 >= creg_r9);
  ASSUME(active[creg_r10] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !86, metadata !DIExpression()), !dbg !139

  //   %5 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !119
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   %cmp32 = icmp eq i32 %conv12, 0, !dbg !128
  ...
  //   %cmp37 = icmp eq i32 %conv16, 1, !dbg !131
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !203, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !206, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !236, metadata !DIExpression()), !dbg !310
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !240, metadata !DIExpression()), !dbg !313
