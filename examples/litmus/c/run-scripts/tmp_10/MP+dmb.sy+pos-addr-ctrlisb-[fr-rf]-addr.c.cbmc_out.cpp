...
T2BLOCK4:
  ...
  //   %idxprom20 = sext i32 %add19 to i64, !dbg !104

  //   %arrayidx21 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !104
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !86, metadata !DIExpression()), !dbg !124

  //   %5 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !124
  ...
  //   %cmp28 = icmp eq i32 %conv12, 0, !dbg !115
  ...
  //   store i32 %conv29, i32* @atom_1_X6_0, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv16, 1, !dbg !117
  ...
  //   store i32 %conv31, i32* @atom_1_X8_1, align 4, !dbg !118, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !188, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !191, metadata !DIExpression()), !dbg !245
