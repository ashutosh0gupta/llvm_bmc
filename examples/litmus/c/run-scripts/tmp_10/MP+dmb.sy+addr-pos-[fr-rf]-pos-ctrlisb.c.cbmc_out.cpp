...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv16, 0, !dbg !98
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !97), !dbg !122
  ...
  //   store i32 %conv23, i32* @atom_1_X3_0, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X5_0, align 4, !dbg !117, !tbaa !110
  // ST: Guess
  ...
  //   store i32 %conv27, i32* @atom_1_X6_1, align 4, !dbg !119, !tbaa !110
  // ST: Guess
  ...
  //   store i32 %conv29, i32* @atom_1_X7_1, align 4, !dbg !121, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !185, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !188, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !191, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !194, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i32 0, metadata !196, metadata !DIExpression()), !dbg !250

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !135
  // ST: Guess
  ...
  //   %13 = load i32, i32* @atom_1_X7_1, align 4, !dbg !169, !tbaa !164
  // LD: Guess
  old_cr = cr(0,7);
