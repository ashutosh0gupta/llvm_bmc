...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !66, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !67, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64 1, metadata !69, metadata !DIExpression()), !dbg !93

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !73
  // ST: Guess
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !76
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()), !dbg !94

  //   %conv6 = trunc i64 %1 to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !70, metadata !DIExpression()), !dbg !83

  //   %tobool = icmp ne i32 %conv6, 0, !dbg !78
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !82), !dbg !102
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !77, metadata !DIExpression()), !dbg !103
  ...
  //   store i32 %conv13, i32* @atom_1_X6_2, align 4, !dbg !94, !tbaa !89
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !158, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !202

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X6_2, align 4, !dbg !139, !tbaa !137
  // LD: Guess
  old_cr = cr(0,4);
