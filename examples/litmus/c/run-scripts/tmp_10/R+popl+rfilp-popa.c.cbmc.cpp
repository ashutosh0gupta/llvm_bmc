...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !83, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !84, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !87, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !88, metadata !DIExpression()), !dbg !107

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !90, metadata !DIExpression()), !dbg !107
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !117, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !118, metadata !DIExpression()), !dbg !165

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !119, metadata !DIExpression()), !dbg !167

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !123, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !124, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !130, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !133, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !136, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !142, metadata !DIExpression()), !dbg !190

  //   %conv = trunc i64 %4 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !139, metadata !DIExpression()), !dbg !165

  //   %cmp = icmp eq i32 %conv, 1, !dbg !118

  //   %conv12 = zext i1 %cmp to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !143, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !145, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !147, metadata !DIExpression()), !dbg !194

  //   %conv16 = trunc i64 %5 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !144, metadata !DIExpression()), !dbg !165

  //   %cmp17 = icmp eq i32 %conv16, 2, !dbg !122

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !148, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !150, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !152, metadata !DIExpression()), !dbg !198

  //   %conv22 = trunc i64 %6 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !149, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !154, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !156, metadata !DIExpression()), !dbg !201

  //   %conv26 = trunc i64 %7 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !153, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !158, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !160, metadata !DIExpression()), !dbg !204

  //   %conv30 = trunc i64 %8 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !157, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !162, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !163, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !164, metadata !DIExpression()), !dbg !165
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !139
