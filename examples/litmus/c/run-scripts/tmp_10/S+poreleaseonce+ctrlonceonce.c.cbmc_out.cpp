...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !39, metadata !DIExpression()), !dbg !48
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !53, metadata !DIExpression()), !dbg !65
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !55, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !57, metadata !DIExpression()), !dbg !68

  //   %conv = trunc i64 %0 to i32, !dbg !52

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !54, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !58, metadata !DIExpression()), !dbg !65
...
T2BLOCK2:
  //   br label %lbl_label210, !dbg !57
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label210, !dbg !58
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !64), !dbg !77

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64 1, metadata !61, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !62, metadata !DIExpression()), !dbg !65
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !94, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !95, metadata !DIExpression()), !dbg !118

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !63

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !63

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !96, metadata !DIExpression()), !dbg !120

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !100, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !101, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 0, metadata !103, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !107, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i32 0, metadata !110, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !112, metadata !DIExpression()), !dbg !137

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l50_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !114, metadata !DIExpression()), !dbg !137

  //   %conv = trunc i64 %4 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !111, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !115, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !116, metadata !DIExpression()), !dbg !118

  //   %and = and i32 %conv8, %5, !dbg !90
  creg_r6 = max(creg__r4__2_,creg_r5);
  r6 = (r4==2) & r5;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !117, metadata !DIExpression()), !dbg !118
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
