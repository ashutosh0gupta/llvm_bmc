...
T1BLOCK1:
  ...
  //   store atomic i64 4, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !48
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !58, metadata !DIExpression()), !dbg !88
  ...
  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !75
  // ST: Guess
  //   : Release
  ...
  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !82
  // ST: Guess
  iw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0+1*1);
  cw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !81, metadata !DIExpression()), !dbg !106

  //   %3 = zext i32 %conv15 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !83, metadata !DIExpression()), !dbg !106

  //   store atomic i64 %3, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !132, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 0, metadata !134, metadata !DIExpression()), !dbg !161

  //   store atomic i64 0, i64* @atom_1_X4_2 monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !145, metadata !DIExpression()), !dbg !180

  //   %6 = load atomic i64, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([157 x i8], [157 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !112
