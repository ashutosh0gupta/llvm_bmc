...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !57, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !60, metadata !DIExpression()), !dbg !70
...
T2BLOCK2:
  //   br label %lbl_label169, !dbg !62
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label169, !dbg !63
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !69), !dbg !82
  ...
  //   %cmp2 = icmp eq i32 %conv, 1, !dbg !67

  //   %conv3 = zext i1 %cmp2 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !64, metadata !DIExpression()), !dbg !70
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !96, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X1_0, metadata !100, metadata !DIExpression()), !dbg !113
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X1_0, metadata !143, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X1_0, metadata !156, metadata !DIExpression()), !dbg !198
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([130 x i8], [130 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
