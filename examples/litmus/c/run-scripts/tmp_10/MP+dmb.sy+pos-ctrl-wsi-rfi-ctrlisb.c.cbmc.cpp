...
T2BLOCK7:
  ...
  //   store i32 %conv20, i32* @atom_1_X2_1, align 4, !dbg !110, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !162, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !165, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i32 0, metadata !167, metadata !DIExpression()), !dbg !211

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv26, 2, !dbg !138
  ...
  //   %9 = load i32, i32* @atom_1_X6_2, align 4, !dbg !143, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
  ...
  creg_r17 = max(creg__r9__2_,creg_r16);
  r17 = (r9==2) & r16;
