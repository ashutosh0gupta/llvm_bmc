...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !114, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !116, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !118, metadata !DIExpression()), !dbg !136

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !120, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !122, metadata !DIExpression()), !dbg !139

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !124, metadata !DIExpression()), !dbg !139
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !156, metadata !DIExpression()), !dbg !204

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !157, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !158, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !164, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !170, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !176, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !182, metadata !DIExpression()), !dbg !237

  //   %conv = trunc i64 %8 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !179, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !184, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !186, metadata !DIExpression()), !dbg !240

  //   %conv23 = trunc i64 %9 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !183, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !188, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !190, metadata !DIExpression()), !dbg !243

  //   %conv27 = trunc i64 %10 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !187, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !192, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !194, metadata !DIExpression()), !dbg !246

  //   %conv31 = trunc i64 %11 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !191, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !196, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !197, metadata !DIExpression()), !dbg !198
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !150
