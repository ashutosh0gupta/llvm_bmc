...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv9, 0, !dbg !90
...
T2BLOCK4:
  ...
  //   %conv13 = trunc i64 %3 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !78, metadata !DIExpression()), !dbg !93

  //   %xor14 = xor i32 %conv13, %conv13, !dbg !99
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor14, metadata !82, metadata !DIExpression()), !dbg !93

  //   %add16 = add nsw i32 0, %xor14, !dbg !100
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom = sext i32 %add16 to i64, !dbg !100

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !100
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !84, metadata !DIExpression()), !dbg !120

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,r8);
  cr(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l40_c16
  // Check
