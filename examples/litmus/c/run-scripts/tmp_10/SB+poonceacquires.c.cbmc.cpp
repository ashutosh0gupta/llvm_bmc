...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !37, metadata !DIExpression()), !dbg !50
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !44, metadata !DIExpression()), !dbg !52
  ...
  //   store i32 %conv1, i32* @atom_0_X1_0, align 4, !dbg !56, !tbaa !57
  // ST: Guess
  iw(1,2) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l23_c15
  old_cw = cw(1,2);
  cw(1,2) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l23_c15
  // Check
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !68, metadata !DIExpression()), !dbg !74
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !102, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X1_0, metadata !105, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i32 0, metadata !108, metadata !DIExpression()), !dbg !124

  //   store atomic i32 0, i32* @atom_0_X1_0 monotonic, align 4, !dbg !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X1_0, metadata !109, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i32 0, metadata !111, metadata !DIExpression()), !dbg !126

  //   store atomic i32 0, i32* @atom_1_X1_0 monotonic, align 4, !dbg !75
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_0_X1_0, align 4, !dbg !86, !tbaa !87
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %5 = load i32, i32* @atom_1_X1_0, align 4, !dbg !89, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
