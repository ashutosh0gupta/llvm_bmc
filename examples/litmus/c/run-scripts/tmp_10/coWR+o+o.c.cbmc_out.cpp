...
T1BLOCK1:
  ...
  //   store i32 %conv1, i32* @atom_0_X1_2, align 4, !dbg !54, !tbaa !55
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X1_2, metadata !90, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i32 0, metadata !93, metadata !DIExpression()), !dbg !108

  //   store atomic i32 0, i32* @atom_0_X1_2 monotonic, align 4, !dbg !67
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_0_X1_2, align 4, !dbg !78, !tbaa !79
  // LD: Guess
  old_cr = cr(0,1);
  ...
  creg_r6 = max(creg__r5__1_,creg_r4);
  r6 = r4 & (r5==1);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([93 x i8], [93 x i8]* @.str.1, i64 0, i64 0), i32 noundef 49, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !89
