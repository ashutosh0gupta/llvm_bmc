...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !34, metadata !DIExpression()), !dbg !51

  //   call void @llvm.dbg.value(metadata i64 1, metadata !37, metadata !DIExpression()), !dbg !51
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !53
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !42, metadata !DIExpression()), !dbg !53

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !38, metadata !DIExpression()), !dbg !48
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X1_2, metadata !44, metadata !DIExpression()), !dbg !57

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !46, metadata !DIExpression()), !dbg !57

  //   store atomic i64 %1, i64* @atom_0_X1_2 seq_cst, align 8, !dbg !58
  // ST: Guess
...
T2BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !43
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !80, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !81, metadata !DIExpression()), !dbg !103

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !62

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !62

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !82, metadata !DIExpression()), !dbg !105

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !86, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64 0, metadata !89, metadata !DIExpression()), !dbg !108

  //   store atomic i64 0, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X1_2, metadata !90, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 0, metadata !92, metadata !DIExpression()), !dbg !110

  //   store atomic i64 0, i64* @atom_0_X1_2 monotonic, align 8, !dbg !69
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !70
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call3 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !71
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !72, !tbaa !73
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !78, !tbaa !73
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X1_2, metadata !94, metadata !DIExpression()), !dbg !122

  //   %4 = load atomic i64, i64* @atom_0_X1_2 seq_cst, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(0,1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !96, metadata !DIExpression()), !dbg !122

  //   %conv = trunc i64 %4 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !93, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !98, metadata !DIExpression()), !dbg !125

  //   %5 = load atomic i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !100, metadata !DIExpression()), !dbg !125

  //   %conv9 = trunc i64 %5 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !97, metadata !DIExpression()), !dbg !103

  //   %cmp = icmp eq i32 %conv9, 1, !dbg !86

  //   %conv10 = zext i1 %cmp to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !101, metadata !DIExpression()), !dbg !103

  //   %and = and i32 %conv, %conv10, !dbg !87
  creg_r6 = max(creg_r4,max(creg_r5,0));
  ASSUME(active[creg_r6] == 0);
  r6 = r4 & (r5==1);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !102, metadata !DIExpression()), !dbg !103

  //   %cmp11 = icmp eq i32 %and, 1, !dbg !88

  //   br i1 %cmp11, label %if.then, label %if.end, !dbg !90
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([93 x i8], [93 x i8]* @.str.1, i64 0, i64 0), i32 noundef 49, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !91
