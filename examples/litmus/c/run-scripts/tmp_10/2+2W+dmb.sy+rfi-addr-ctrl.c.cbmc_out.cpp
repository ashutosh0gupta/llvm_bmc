...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !72), !dbg !90
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !114, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !117, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !120, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !123, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i32 0, metadata !126, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !128, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !131, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !133, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !132, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !136, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !139, metadata !DIExpression()), !dbg !140
