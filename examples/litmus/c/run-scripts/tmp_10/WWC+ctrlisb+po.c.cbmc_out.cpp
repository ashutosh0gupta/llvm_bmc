...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !120, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !124, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !127, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !131, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !135, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !137, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !138, metadata !DIExpression()), !dbg !143

  //   %7 = load i32, i32* @atom_1_X0_2, align 4, !dbg !102, !tbaa !103
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l65_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !142, metadata !DIExpression()), !dbg !143
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
