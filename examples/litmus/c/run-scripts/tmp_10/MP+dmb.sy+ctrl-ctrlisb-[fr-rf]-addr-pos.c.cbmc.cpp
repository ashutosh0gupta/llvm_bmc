...
T2BLOCK4:
  ...
  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !92
  creg__r1__0_ = max(0,creg_r1);

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !94
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !72, metadata !DIExpression()), !dbg !118

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,0+3*1);
  cr(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l38_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !118

  //   %conv11 = trunc i64 %2 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !71, metadata !DIExpression()), !dbg !96
  ...
  //   %xor = xor i32 %conv15, %conv15, !dbg !105
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !106
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !126

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,r6);
  cr(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l41_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !126

  //   %conv19 = trunc i64 %4 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !80, metadata !DIExpression()), !dbg !96
  ...
  //   %cmp25 = icmp eq i32 %conv11, 0, !dbg !118
  ...
  //   store i32 %conv26, i32* @atom_1_X4_0, align 4, !dbg !119, !tbaa !114
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv15, 1, !dbg !120
  ...
  //   store i32 %conv28, i32* @atom_1_X6_1, align 4, !dbg !121, !tbaa !114
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv19, 0, !dbg !122
  ...
  //   store i32 %conv30, i32* @atom_1_X8_0, align 4, !dbg !123, !tbaa !114
  // ST: Guess
  ...
  //   store i32 %conv32, i32* @atom_1_X10_0, align 4, !dbg !125, !tbaa !114
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !149, metadata !DIExpression()), !dbg !156
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !190, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !246

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !193, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !248

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !196, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !250

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !199, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i32 0, metadata !201, metadata !DIExpression()), !dbg !252

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !203, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !208, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !213, metadata !DIExpression()), !dbg !273
  ...
  //   %10 = load i32, i32* @atom_1_X4_0, align 4, !dbg !162, !tbaa !160
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X6_1, align 4, !dbg !163, !tbaa !160
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %12 = load i32, i32* @atom_1_X8_0, align 4, !dbg !164, !tbaa !160
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %13 = load i32, i32* @atom_1_X10_0, align 4, !dbg !165, !tbaa !160
  // LD: Guess
  old_cr = cr(0,8);
