...
T2BLOCK7:
  ...
  //   %conv20 = trunc i64 %4 to i32, !dbg !108
  ...
  //   %conv21 = zext i1 %cmp to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !86, metadata !DIExpression()), !dbg !93

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !110, !tbaa !111
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 2, !dbg !115
  creg__r1__2_ = max(0,creg_r1);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !87, metadata !DIExpression()), !dbg !93

  //   store i32 %conv23, i32* @atom_1_X2_2, align 4, !dbg !116, !tbaa !111
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv13, 1, !dbg !117
  ...
  //   store i32 %conv25, i32* @atom_1_X7_1, align 4, !dbg !118, !tbaa !111
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv20, 0, !dbg !119
  ...
  //   store i32 %conv27, i32* @atom_1_X8_0, align 4, !dbg !120, !tbaa !111
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !151
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !185, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !188, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !191, metadata !DIExpression()), !dbg !240
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !165
