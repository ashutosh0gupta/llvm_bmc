...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !55
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !48, metadata !DIExpression()), !dbg !58

  //   call void @llvm.dbg.value(metadata i64 1, metadata !50, metadata !DIExpression()), !dbg !58

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !59
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !63, metadata !DIExpression()), !dbg !116

  //   br label %label_2, !dbg !98
  goto T2BLOCK1;

T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !114), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !119

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !68, metadata !DIExpression()), !dbg !119

  //   %conv = trunc i64 %0 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !64, metadata !DIExpression()), !dbg !116

  //   %tobool = icmp ne i32 %conv, 0, !dbg !103
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !115), !dbg !127

  //   call void (...) @isb(), !dbg !109
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !129

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !72, metadata !DIExpression()), !dbg !129

  //   %conv4 = trunc i64 %1 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !69, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !132

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !76, metadata !DIExpression()), !dbg !132

  //   %conv8 = trunc i64 %2 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !73, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !78, metadata !DIExpression()), !dbg !135

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !135

  //   %conv12 = trunc i64 %3 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !77, metadata !DIExpression()), !dbg !116

  //   %xor = xor i32 %conv12, %conv12, !dbg !119
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !116

  //   %add = add nsw i32 0, %xor, !dbg !120
  creg_r5 = max(0,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = 0 + r4;

  //   %idxprom = sext i32 %add to i64, !dbg !120

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !120
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ASSUME(creg_r6 >= creg_r5);
  ASSUME(active[creg_r6] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !140

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  if(cr(2,r6) < cw(2,r6)) {
    r7 = buff(2,r6);
    ASSUME((!(( (cw(2,r6) < 1) && (1 < crmax(2,r6)) )))||(sforbid(r6,1)> 0));
    ASSUME((!(( (cw(2,r6) < 2) && (2 < crmax(2,r6)) )))||(sforbid(r6,2)> 0));
    ASSUME((!(( (cw(2,r6) < 3) && (3 < crmax(2,r6)) )))||(sforbid(r6,3)> 0));
    ASSUME((!(( (cw(2,r6) < 4) && (4 < crmax(2,r6)) )))||(sforbid(r6,4)> 0));
    ASSUME((!(( (cw(2,r6) < 5) && (5 < crmax(2,r6)) )))||(sforbid(r6,5)> 0));
    ASSUME((!(( (cw(2,r6) < 6) && (6 < crmax(2,r6)) )))||(sforbid(r6,6)> 0));
    ASSUME((!(( (cw(2,r6) < 7) && (7 < crmax(2,r6)) )))||(sforbid(r6,7)> 0));
    ASSUME((!(( (cw(2,r6) < 8) && (8 < crmax(2,r6)) )))||(sforbid(r6,8)> 0));
    ASSUME((!(( (cw(2,r6) < 9) && (9 < crmax(2,r6)) )))||(sforbid(r6,9)> 0));
  } else {
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !140

  //   %conv16 = trunc i64 %4 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !82, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !142

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !142

  //   %conv20 = trunc i64 %5 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !86, metadata !DIExpression()), !dbg !116

  //   %cmp = icmp eq i32 %conv, 1, !dbg !126

  //   %conv21 = zext i1 %cmp to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !90, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !91, metadata !DIExpression()), !dbg !146

  //   %6 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !128
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv4, 0, !dbg !129

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !94, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !95, metadata !DIExpression()), !dbg !149

  //   %7 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %7, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !131
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv8, 1, !dbg !132

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !98, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !99, metadata !DIExpression()), !dbg !152

  //   %8 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %8, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv12, 1, !dbg !135

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !102, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !103, metadata !DIExpression()), !dbg !155

  //   %9 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %9, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !137
  // ST: Guess
  ...
  //   %cmp38 = icmp eq i32 %conv16, 0, !dbg !138

  //   %conv39 = zext i1 %cmp38 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv39, metadata !106, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !107, metadata !DIExpression()), !dbg !158

  //   %10 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !109, metadata !DIExpression()), !dbg !158

  //   store atomic i64 %10, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !140
  // ST: Guess
  ...
  //   %cmp43 = icmp eq i32 %conv20, 0, !dbg !141

  //   %conv44 = zext i1 %cmp43 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !110, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !111, metadata !DIExpression()), !dbg !161

  //   %11 = zext i32 %conv44 to i64

  //   call void @llvm.dbg.value(metadata i64 %11, metadata !113, metadata !DIExpression()), !dbg !161

  //   store atomic i64 %11, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !143
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !166, metadata !DIExpression()), !dbg !171
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !167, metadata !DIExpression()), !dbg !174
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !184, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !185, metadata !DIExpression()), !dbg !266

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !131

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !131

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !186, metadata !DIExpression()), !dbg !268

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !133

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !133

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !190, metadata !DIExpression()), !dbg !270

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !135

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !135

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !191, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !192, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !273

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !195, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !275

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !140
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !198, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !277

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !142
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !201, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !279

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !144
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !204, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !281

  //   store atomic i64 0, i64* @atom_1_X2_0 monotonic, align 8, !dbg !146
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !207, metadata !DIExpression()), !dbg !283

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !283

  //   store atomic i64 0, i64* @atom_1_X4_1 monotonic, align 8, !dbg !148
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !210, metadata !DIExpression()), !dbg !285

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !285

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !150
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !213, metadata !DIExpression()), !dbg !287

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !287

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !152
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !216, metadata !DIExpression()), !dbg !289

  //   call void @llvm.dbg.value(metadata i64 0, metadata !218, metadata !DIExpression()), !dbg !289

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !154
  // ST: Guess
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !156
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !157
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !158, !tbaa !159
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call19 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !163
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !164, !tbaa !159
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   %call20 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !165
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !166, !tbaa !159
  // LD: Guess
  old_cr = cr(0,11);
  ...
  //   %call21 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !167
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !220, metadata !DIExpression()), !dbg !304

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !169
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !222, metadata !DIExpression()), !dbg !304

  //   %conv = trunc i64 %6 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !219, metadata !DIExpression()), !dbg !266

  //   %cmp = icmp eq i32 %conv, 1, !dbg !171

  //   %conv22 = zext i1 %cmp to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !223, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !225, metadata !DIExpression()), !dbg !308

  //   %7 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !173
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !227, metadata !DIExpression()), !dbg !308

  //   %conv26 = trunc i64 %7 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !224, metadata !DIExpression()), !dbg !266

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !175

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !175

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !228, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !230, metadata !DIExpression()), !dbg !312

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !177
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !232, metadata !DIExpression()), !dbg !312

  //   %conv32 = trunc i64 %8 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !229, metadata !DIExpression()), !dbg !266

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !179

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !233, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !235, metadata !DIExpression()), !dbg !316

  //   %9 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !181
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !237, metadata !DIExpression()), !dbg !316

  //   %conv38 = trunc i64 %9 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !234, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !239, metadata !DIExpression()), !dbg !319

  //   %10 = load atomic i64, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !184
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !241, metadata !DIExpression()), !dbg !319

  //   %conv42 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !238, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !243, metadata !DIExpression()), !dbg !322

  //   %11 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !187
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !245, metadata !DIExpression()), !dbg !322

  //   %conv46 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !242, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !247, metadata !DIExpression()), !dbg !325

  //   %12 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !190
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !249, metadata !DIExpression()), !dbg !325

  //   %conv50 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !246, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !251, metadata !DIExpression()), !dbg !328

  //   %13 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !193
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !253, metadata !DIExpression()), !dbg !328

  //   %conv54 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !250, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !255, metadata !DIExpression()), !dbg !331

  //   %14 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !196
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !257, metadata !DIExpression()), !dbg !331

  //   %conv58 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv58, metadata !254, metadata !DIExpression()), !dbg !266

  //   %and = and i32 %conv54, %conv58, !dbg !198
  creg_r22 = max(creg_r20,creg_r21);
  ASSUME(active[creg_r22] == 0);
  r22 = r20 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !258, metadata !DIExpression()), !dbg !266

  //   %and59 = and i32 %conv50, %and, !dbg !199
  creg_r23 = max(creg_r19,creg_r22);
  ASSUME(active[creg_r23] == 0);
  r23 = r19 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !259, metadata !DIExpression()), !dbg !266

  //   %and60 = and i32 %conv46, %and59, !dbg !200
  creg_r24 = max(creg_r18,creg_r23);
  ASSUME(active[creg_r24] == 0);
  r24 = r18 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !260, metadata !DIExpression()), !dbg !266

  //   %and61 = and i32 %conv42, %and60, !dbg !201
  creg_r25 = max(creg_r17,creg_r24);
  ASSUME(active[creg_r25] == 0);
  r25 = r17 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !261, metadata !DIExpression()), !dbg !266

  //   %and62 = and i32 %conv38, %and61, !dbg !202
  creg_r26 = max(creg_r16,creg_r25);
  ASSUME(active[creg_r26] == 0);
  r26 = r16 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !262, metadata !DIExpression()), !dbg !266

  //   %and63 = and i32 %conv34, %and62, !dbg !203
  creg_r27 = max(max(creg_r15,0),creg_r26);
  ASSUME(active[creg_r27] == 0);
  r27 = (r15==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !263, metadata !DIExpression()), !dbg !266

  //   %and64 = and i32 %conv28, %and63, !dbg !204
  creg_r28 = max(max(creg_r14,0),creg_r27);
  ASSUME(active[creg_r28] == 0);
  r28 = (r14==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !264, metadata !DIExpression()), !dbg !266

  //   %and65 = and i32 %conv22, %and64, !dbg !205
  creg_r29 = max(max(creg_r13,0),creg_r28);
  ASSUME(active[creg_r29] == 0);
  r29 = (r13==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !265, metadata !DIExpression()), !dbg !266

  //   %cmp66 = icmp eq i32 %and65, 1, !dbg !206

  //   br i1 %cmp66, label %if.then, label %if.end, !dbg !208
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 106, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
