...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !37, metadata !DIExpression()), !dbg !57
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !38, metadata !DIExpression()), !dbg !57

  //   %add = add nsw i32 %conv, 0, !dbg !63
  creg_r1 = max(creg_r0,0);
  ASSUME(active[creg_r1] == 1);
  r1 = r0 + 0;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !44, metadata !DIExpression()), !dbg !57

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !45, metadata !DIExpression()), !dbg !64
  ...
  //   call void @llvm.dbg.value(metadata i32 1, metadata !48, metadata !DIExpression()), !dbg !57

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !49, metadata !DIExpression()), !dbg !66
  ...
  //   %cmp = icmp eq i32 %add, 2, !dbg !68

  //   %conv4 = zext i1 %cmp to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !52, metadata !DIExpression()), !dbg !57

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_2, metadata !53, metadata !DIExpression()), !dbg !69

  //   %1 = zext i32 %conv4 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !55, metadata !DIExpression()), !dbg !69

  //   store atomic i64 %1, i64* @atom_0_X2_2 seq_cst, align 8, !dbg !70
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !74, metadata !DIExpression()), !dbg !88
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !78, metadata !DIExpression()), !dbg !91

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !75, metadata !DIExpression()), !dbg !88

  //   %add = add nsw i32 %conv, 1, !dbg !59
  creg_r3 = max(creg_r2,0);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !79, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !95

  //   %conv1 = sext i32 %add to i64, !dbg !61

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !82, metadata !DIExpression()), !dbg !95

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !61
  // ST: Guess
  ...
  //   %cmp = icmp eq i32 %add, 2, !dbg !62

  //   %conv2 = zext i1 %cmp to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !83, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !84, metadata !DIExpression()), !dbg !98

  //   %1 = zext i32 %conv2 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !86, metadata !DIExpression()), !dbg !98

  //   store atomic i64 %1, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !64
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !108, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !109, metadata !DIExpression()), !dbg !156

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !110, metadata !DIExpression()), !dbg !158

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !114, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !115, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 0, metadata !117, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !118, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 0, metadata !120, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !121, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64 0, metadata !123, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_2, metadata !124, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64 0, metadata !126, metadata !DIExpression()), !dbg !167

  //   store atomic i64 0, i64* @atom_0_X2_2 monotonic, align 8, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !127, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64 0, metadata !129, metadata !DIExpression()), !dbg !169

  //   store atomic i64 0, i64* @atom_1_X2_2 monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !131, metadata !DIExpression()), !dbg !181

  //   %4 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !133, metadata !DIExpression()), !dbg !181

  //   %conv = trunc i64 %4 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !130, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_2, metadata !135, metadata !DIExpression()), !dbg !184

  //   %5 = load atomic i64, i64* @atom_0_X2_2 seq_cst, align 8, !dbg !119
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !137, metadata !DIExpression()), !dbg !184

  //   %conv15 = trunc i64 %5 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !134, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !139, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !141, metadata !DIExpression()), !dbg !187

  //   %conv19 = trunc i64 %6 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !138, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !143, metadata !DIExpression()), !dbg !190

  //   %7 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !125
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !145, metadata !DIExpression()), !dbg !190

  //   %conv23 = trunc i64 %7 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !142, metadata !DIExpression()), !dbg !156

  //   %cmp = icmp eq i32 %conv23, 1, !dbg !127

  //   %conv24 = zext i1 %cmp to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !146, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !194

  //   %8 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !150, metadata !DIExpression()), !dbg !194

  //   %conv28 = trunc i64 %8 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !147, metadata !DIExpression()), !dbg !156

  //   %cmp29 = icmp eq i32 %conv28, 2, !dbg !131

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !151, metadata !DIExpression()), !dbg !156

  //   %and = and i32 %conv24, %conv30, !dbg !132
  ...
  //   %and31 = and i32 %conv19, %and, !dbg !133
  creg_r13 = max(creg_r9,creg_r12);
  ASSUME(active[creg_r13] == 0);
  r13 = r9 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !153, metadata !DIExpression()), !dbg !156

  //   %and32 = and i32 %conv15, %and31, !dbg !134
  creg_r14 = max(creg_r8,creg_r13);
  ASSUME(active[creg_r14] == 0);
  r14 = r8 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !154, metadata !DIExpression()), !dbg !156

  //   %and33 = and i32 %conv, %and32, !dbg !135
  creg_r15 = max(creg_r7,creg_r14);
  ASSUME(active[creg_r15] == 0);
  r15 = r7 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !155, metadata !DIExpression()), !dbg !156
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !139
