...
T2BLOCK1:
  ...
  //   %xor16 = xor i32 %conv15, %conv15, !dbg !97
  creg_r9 = creg_r8;
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !85, metadata !DIExpression()), !dbg !96

  //   %add18 = add nsw i32 0, %xor16, !dbg !98
  creg_r10 = max(0,creg_r9);
  r10 = 0 + r9;

  //   %idxprom19 = sext i32 %add18 to i64, !dbg !98

  //   %arrayidx20 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !98
  r11 = 0+r10*1;
  creg_r11 = creg_r10;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !87, metadata !DIExpression()), !dbg !118

  //   %4 = load atomic i64, i64* %arrayidx20 monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,r11);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !89, metadata !DIExpression()), !dbg !118

  //   %conv23 = trunc i64 %4 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !86, metadata !DIExpression()), !dbg !96

  //   %cmp = icmp eq i32 %conv, 1, !dbg !101
  creg__r0__1_ = max(0,creg_r0);

  //   %conv24 = zext i1 %cmp to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !90, metadata !DIExpression()), !dbg !96

  //   store i32 %conv24, i32* @atom_1_X0_1, align 4, !dbg !102, !tbaa !103
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv4, 0, !dbg !107
  creg__r4__0_ = max(0,creg_r4);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !91, metadata !DIExpression()), !dbg !96

  //   store i32 %conv26, i32* @atom_1_X3_0, align 4, !dbg !108, !tbaa !103
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv8, 1, !dbg !109
  creg__r5__1_ = max(0,creg_r5);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !92, metadata !DIExpression()), !dbg !96

  //   store i32 %conv28, i32* @atom_1_X5_1, align 4, !dbg !110, !tbaa !103
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv15, 1, !dbg !111
  creg__r8__1_ = max(0,creg_r8);

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !93, metadata !DIExpression()), !dbg !96

  //   store i32 %conv30, i32* @atom_1_X8_1, align 4, !dbg !112, !tbaa !103
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv23, 0, !dbg !113
  creg__r12__0_ = max(0,creg_r12);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !94, metadata !DIExpression()), !dbg !96

  //   store i32 %conv32, i32* @atom_1_X10_0, align 4, !dbg !114, !tbaa !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !155, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !156, metadata !DIExpression()), !dbg !224

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !157, metadata !DIExpression()), !dbg !226

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !161, metadata !DIExpression()), !dbg !228

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !162, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !163, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !165, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !166, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !172, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !175, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i32 0, metadata !178, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !179, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !241

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !182, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !243

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !185, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !188, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !192, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !194, metadata !DIExpression()), !dbg !260

  //   %conv = trunc i64 %6 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !191, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !195, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !197, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !199, metadata !DIExpression()), !dbg !264

  //   %conv26 = trunc i64 %7 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !196, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !200, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !202, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !204, metadata !DIExpression()), !dbg !268

  //   %conv32 = trunc i64 %8 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !201, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !205, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !207, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !209, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !210, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !211, metadata !DIExpression()), !dbg !224

  //   %11 = load i32, i32* @atom_1_X3_0, align 4, !dbg !172, !tbaa !170
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !212, metadata !DIExpression()), !dbg !224

  //   %12 = load i32, i32* @atom_1_X5_1, align 4, !dbg !173, !tbaa !170
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !213, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !214, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !215, metadata !DIExpression()), !dbg !224

  //   %and = and i32 %13, %14, !dbg !176
  creg_r26 = max(creg_r24,creg_r25);
  r26 = r24 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !216, metadata !DIExpression()), !dbg !224

  //   %and41 = and i32 %12, %and, !dbg !177
  creg_r27 = max(creg_r23,creg_r26);
  r27 = r23 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !217, metadata !DIExpression()), !dbg !224

  //   %and42 = and i32 %11, %and41, !dbg !178
  creg_r28 = max(creg_r22,creg_r27);
  r28 = r22 & r27;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !218, metadata !DIExpression()), !dbg !224

  //   %and43 = and i32 %10, %and42, !dbg !179
  creg_r29 = max(creg_r21,creg_r28);
  r29 = r21 & r28;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !219, metadata !DIExpression()), !dbg !224

  //   %and44 = and i32 %conv40, %and43, !dbg !180
  creg_r30 = max(creg__r20__1_,creg_r29);
  r30 = (r20==1) & r29;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !220, metadata !DIExpression()), !dbg !224

  //   %and45 = and i32 %conv34, %and44, !dbg !181
  creg_r31 = max(creg__r19__1_,creg_r30);
  r31 = (r19==1) & r30;

  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !221, metadata !DIExpression()), !dbg !224

  //   %and46 = and i32 %conv28, %and45, !dbg !182
  creg_r32 = max(creg__r18__1_,creg_r31);
  r32 = (r18==1) & r31;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !222, metadata !DIExpression()), !dbg !224

  //   %and47 = and i32 %conv22, %and46, !dbg !183
  creg_r33 = max(creg__r17__1_,creg_r32);
  r33 = (r17==1) & r32;

  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !223, metadata !DIExpression()), !dbg !224

  //   %cmp48 = icmp eq i32 %and47, 1, !dbg !184
  creg__r33__1_ = max(0,creg_r33);

  //   br i1 %cmp48, label %if.then, label %if.end, !dbg !186
  old_cctrl = cctrl[0];
  cctrl[0] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[0] >= old_cctrl);
  ASSUME(cctrl[0] >= creg__r33__1_);
  if((r33==1)) {
    goto T0BLOCK1;
  } else {
    goto T0BLOCK2;
