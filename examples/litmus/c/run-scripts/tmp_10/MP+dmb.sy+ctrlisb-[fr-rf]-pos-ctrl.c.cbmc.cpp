...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !104

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !104
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !119
  ...
  //   store i32 %conv22, i32* @atom_1_X2_0, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   store i32 %conv24, i32* @atom_1_X4_1, align 4, !dbg !112, !tbaa !105
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv12, 1, !dbg !113
  ...
  //   store i32 %conv26, i32* @atom_1_X5_1, align 4, !dbg !114, !tbaa !105
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv19, 0, !dbg !115
  creg__r4__0_ = max(0,creg_r4);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv28, i32* @atom_1_X6_0, align 4, !dbg !116, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !187, metadata !DIExpression()), !dbg !238
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 100, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
