...
T2BLOCK4:
  ...
  //   %xor13 = xor i32 %conv12, %conv12, !dbg !90
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !74, metadata !DIExpression()), !dbg !87

  //   %add14 = add nsw i32 %xor13, 1, !dbg !91
  creg_r8 = max(0,creg_r7);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add14, metadata !75, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !111

  //   %conv15 = sext i32 %add14 to i64, !dbg !93

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !78, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !79, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !83, metadata !DIExpression()), !dbg !87
  ...
  //   %cmp21 = icmp eq i32 %conv19, 1, !dbg !103
  creg__r9__1_ = max(0,creg_r9);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !84, metadata !DIExpression()), !dbg !87

  //   store i32 %conv22, i32* @atom_1_X10_1, align 4, !dbg !104, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !155, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !188

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X10_1, align 4, !dbg !119, !tbaa !117
  // LD: Guess
  old_cr = cr(0,5);
  ...
  creg_r18 = max(creg__r14__1_,creg_r17);
  r18 = (r14==1) & r17;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
