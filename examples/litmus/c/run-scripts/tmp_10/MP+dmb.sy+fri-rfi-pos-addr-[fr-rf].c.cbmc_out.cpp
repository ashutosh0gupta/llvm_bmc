...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !67, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64 2, metadata !69, metadata !DIExpression()), !dbg !114

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !71, metadata !DIExpression()), !dbg !116

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !70, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !119

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !74, metadata !DIExpression()), !dbg !108

  //   %xor = xor i32 %conv8, %conv8, !dbg !103
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !78, metadata !DIExpression()), !dbg !108
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !104
  r5 = 0+r4*1;
  ASSUME(creg_r5 >= 0);
  ASSUME(creg_r5 >= creg_r4);
  ASSUME(active[creg_r5] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !79, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !83, metadata !DIExpression()), !dbg !108

  //   %cmp = icmp eq i32 %conv, 1, !dbg !110

  //   %conv17 = zext i1 %cmp to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !87, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !130

  //   %5 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !91, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !92, metadata !DIExpression()), !dbg !133

  //   %6 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !133
  ...
  //   %cmp26 = icmp eq i32 %conv8, 2, !dbg !116

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !95, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !96, metadata !DIExpression()), !dbg !136

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %7, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv12, 0, !dbg !119

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !99, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !100, metadata !DIExpression()), !dbg !139

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %8, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv16, 1, !dbg !122

  //   %conv37 = zext i1 %cmp36 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv37, metadata !103, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !104, metadata !DIExpression()), !dbg !142

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !106, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %9, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !182, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !243

  //   store atomic i64 0, i64* @atom_1_X3_2 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !185, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !245

  //   store atomic i64 0, i64* @atom_1_X4_2 monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !188, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !247

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !191, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !209, metadata !DIExpression()), !dbg !275

  //   %9 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !213, metadata !DIExpression()), !dbg !278

  //   %10 = load atomic i64, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !160
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !217, metadata !DIExpression()), !dbg !281

  //   %11 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !163
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !221, metadata !DIExpression()), !dbg !284

  //   %12 = load atomic i64, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !166
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
