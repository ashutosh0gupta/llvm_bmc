...
T2BLOCK1:
  ...
  //   %cmp18 = icmp eq i32 %conv4, 2, !dbg !101
  ...
  //   store i32 %conv19, i32* @atom_1_X3_2, align 4, !dbg !102, !tbaa !97
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv16, 1, !dbg !107
  ...
  //   store i32 %conv25, i32* @atom_1_X8_1, align 4, !dbg !108, !tbaa !97
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !132, metadata !DIExpression()), !dbg !139
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !149, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !150, metadata !DIExpression()), !dbg !200

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !151, metadata !DIExpression()), !dbg !202

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !155, metadata !DIExpression()), !dbg !204

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !156, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !157, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !163, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !167, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !170, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !173, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i32 0, metadata !175, metadata !DIExpression()), !dbg !217

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !176, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i32 0, metadata !178, metadata !DIExpression()), !dbg !219

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !182, metadata !DIExpression()), !dbg !232

  //   %conv = trunc i64 %6 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !179, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !183, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !187, metadata !DIExpression()), !dbg !236

  //   %conv22 = trunc i64 %7 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !184, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !188, metadata !DIExpression()), !dbg !200

  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !139, !tbaa !140
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l82_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !189, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !190, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !191, metadata !DIExpression()), !dbg !200

  //   %11 = load i32, i32* @atom_1_X6_0, align 4, !dbg !144, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X8_1, align 4, !dbg !145, !tbaa !140
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !195, metadata !DIExpression()), !dbg !200

  //   %and26 = and i32 %9, %and25, !dbg !148
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !196, metadata !DIExpression()), !dbg !200

  //   %and27 = and i32 %8, %and26, !dbg !149
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !197, metadata !DIExpression()), !dbg !200

  //   %and28 = and i32 %conv24, %and27, !dbg !150
  creg_r23 = max(creg__r13__2_,creg_r22);
  r23 = (r13==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !198, metadata !DIExpression()), !dbg !200

  //   %and29 = and i32 %conv18, %and28, !dbg !151
  creg_r24 = max(creg__r12__2_,creg_r23);
  r24 = (r12==2) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !199, metadata !DIExpression()), !dbg !200
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
