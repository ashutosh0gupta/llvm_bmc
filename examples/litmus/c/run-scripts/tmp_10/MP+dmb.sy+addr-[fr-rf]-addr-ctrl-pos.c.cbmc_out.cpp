...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !76, metadata !DIExpression()), !dbg !96

  //   %add11 = add nsw i32 3, %xor9, !dbg !91
  creg_r7 = max(0,creg_r6);
  r7 = 3 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !91

  //   %arrayidx13 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !91
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !78, metadata !DIExpression()), !dbg !111

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,r8);
  cr(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l36_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !111

  //   %conv16 = trunc i64 %3 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !77, metadata !DIExpression()), !dbg !96

  //   %tobool = icmp ne i32 %conv16, 0, !dbg !94
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !95), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !119
  ...
  //   %cmp28 = icmp eq i32 %conv8, 1, !dbg !114
  ...
  //   store i32 %conv29, i32* @atom_1_X5_1, align 4, !dbg !115, !tbaa !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !187, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !242

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !129
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X5_1, align 4, !dbg !163, !tbaa !160
  // LD: Guess
  old_cr = cr(0,6);
