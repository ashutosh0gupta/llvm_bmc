...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !39, metadata !DIExpression()), !dbg !48
...
T2BLOCK1:
  ...
  // ST: Guess
  iw(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l28_c3
  old_cw = cw(2,0+2*1);
  cw(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l28_c3
  // Check
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !72, metadata !DIExpression()), !dbg !84
...
T3BLOCK1:
  ...
  // LD: Guess
  old_cr = cr(3,0+2*1);
  cr(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l34_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !73, metadata !DIExpression()), !dbg !84

  //   %xor = xor i32 %conv, %conv, !dbg !53
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !77, metadata !DIExpression()), !dbg !84

  //   %add = add nsw i32 %xor, 1, !dbg !54
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !78, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !92

  //   %conv1 = sext i32 %add to i64, !dbg !56

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !81, metadata !DIExpression()), !dbg !92

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !56
  // ST: Guess
  ...
  //   %conv2 = zext i1 %cmp to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !82, metadata !DIExpression()), !dbg !84

  //   store i32 %conv2, i32* @atom_2_X0_1, align 4, !dbg !58, !tbaa !59
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !108, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !109, metadata !DIExpression()), !dbg !142

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !110, metadata !DIExpression()), !dbg !144

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !114, metadata !DIExpression()), !dbg !146

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !115, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !116, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i64 0, metadata !118, metadata !DIExpression()), !dbg !149

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !119, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64 0, metadata !121, metadata !DIExpression()), !dbg !151

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !82
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !122, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64 0, metadata !124, metadata !DIExpression()), !dbg !153

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !125, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i32 0, metadata !128, metadata !DIExpression()), !dbg !155

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !86
  // ST: Guess
  ...
  //   %call8 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !89
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !90, !tbaa !91
  r4 = local_mem[0];
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !96, !tbaa !91
  r5 = local_mem[1];

  //   %call10 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !97
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !98, !tbaa !91
  r6 = local_mem[2];

  //   %call11 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !99
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !130, metadata !DIExpression()), !dbg !168

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l61_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !132, metadata !DIExpression()), !dbg !168

  //   %conv = trunc i64 %6 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !129, metadata !DIExpression()), !dbg !142

  //   %cmp = icmp eq i32 %conv, 2, !dbg !103
  creg__r7__2_ = max(0,creg_r7);

  //   %conv12 = zext i1 %cmp to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !133, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !135, metadata !DIExpression()), !dbg !172

  //   %7 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l63_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !137, metadata !DIExpression()), !dbg !172

  //   %conv16 = trunc i64 %7 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !134, metadata !DIExpression()), !dbg !142

  //   %cmp17 = icmp eq i32 %conv16, 2, !dbg !107
  creg__r8__2_ = max(0,creg_r8);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !138, metadata !DIExpression()), !dbg !142

  //   %8 = load i32, i32* @atom_2_X0_1, align 4, !dbg !108, !tbaa !109
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !139, metadata !DIExpression()), !dbg !142

  //   %and = and i32 %conv18, %8, !dbg !111
  creg_r10 = max(creg__r8__2_,creg_r9);
  r10 = (r8==2) & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !140, metadata !DIExpression()), !dbg !142

  //   %and19 = and i32 %conv12, %and, !dbg !112
  creg_r11 = max(creg__r7__2_,creg_r10);
  r11 = (r7==2) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !141, metadata !DIExpression()), !dbg !142

  //   %cmp20 = icmp eq i32 %and19, 1, !dbg !113
  creg__r11__1_ = max(0,creg_r11);

  //   br i1 %cmp20, label %if.then, label %if.end, !dbg !115
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
