...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !69, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !70, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64 1, metadata !72, metadata !DIExpression()), !dbg !94

  //   store atomic i64 1, i64* %arrayidx9 monotonic, align 8, !dbg !74
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !76, metadata !DIExpression()), !dbg !95

  //   %conv14 = trunc i64 %2 to i32, !dbg !78
  ...
  //   %cmp16 = icmp eq i32 %conv14, 1, !dbg !85
  ...
  //   store i32 %conv17, i32* @atom_1_X9_1, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !134, metadata !DIExpression()), !dbg !165
