...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64 1, metadata !69, metadata !DIExpression()), !dbg !106

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()), !dbg !108
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !93), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !121

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !121

  //   %conv15 = trunc i64 %3 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !78, metadata !DIExpression()), !dbg !94
  ...
  //   store i32 %conv22, i32* @atom_1_X4_1, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv15, 0, !dbg !118
  ...
  //   store i32 %conv26, i32* @atom_1_X6_0, align 4, !dbg !119, !tbaa !110
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !152
  ...
  // ST: Guess
  iw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l57_c3
  old_cw = cw(3,0);
  cw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l57_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !183, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !189, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i32 0, metadata !191, metadata !DIExpression()), !dbg !241

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X4_1, align 4, !dbg !157, !tbaa !155
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %12 = load i32, i32* @atom_1_X6_0, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
