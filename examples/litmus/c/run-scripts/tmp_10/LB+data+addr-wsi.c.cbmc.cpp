...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !74, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64 1, metadata !76, metadata !DIExpression()), !dbg !93

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !61
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !80, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !81, metadata !DIExpression()), !dbg !97

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !83, metadata !DIExpression()), !dbg !97
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_2, metadata !120, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64 0, metadata !122, metadata !DIExpression()), !dbg !156

  //   store atomic i64 0, i64* @atom_0_X0_2 monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !123, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !129, metadata !DIExpression()), !dbg !170

  //   %conv = trunc i64 %4 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !126, metadata !DIExpression()), !dbg !147

  //   %cmp = icmp eq i32 %conv, 2, !dbg !106

  //   %conv10 = zext i1 %cmp to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !130, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !132, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !134, metadata !DIExpression()), !dbg !174

  //   %conv14 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !131, metadata !DIExpression()), !dbg !147

  //   %cmp15 = icmp eq i32 %conv14, 1, !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_2, metadata !137, metadata !DIExpression()), !dbg !178

  //   %6 = load atomic i64, i64* @atom_0_X0_2 seq_cst, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !139, metadata !DIExpression()), !dbg !178

  //   %conv20 = trunc i64 %6 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !136, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !141, metadata !DIExpression()), !dbg !181

  //   %7 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !143, metadata !DIExpression()), !dbg !181

  //   %conv24 = trunc i64 %7 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !140, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !145, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !146, metadata !DIExpression()), !dbg !147
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
