...
T2BLOCK1:
  ...
  //   %xor8 = xor i32 %conv7, %conv7, !dbg !87
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor8, metadata !77, metadata !DIExpression()), !dbg !91

  //   %add10 = add nsw i32 0, %xor8, !dbg !88
  creg_r5 = max(0,creg_r4);
  r5 = 0 + r4;

  //   %idxprom = sext i32 %add10 to i64, !dbg !88

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !88
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !78, metadata !DIExpression()), !dbg !91
  ...
  //   %cmp19 = icmp eq i32 %conv7, 2, !dbg !100
  ...
  //   store i32 %conv20, i32* @atom_1_X5_2, align 4, !dbg !101, !tbaa !96
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv13, 0, !dbg !102
  ...
  //   store i32 %conv22, i32* @atom_1_X7_0, align 4, !dbg !103, !tbaa !96
  // ST: Guess
  ...
  //   store i32 %conv24, i32* @atom_1_X9_0, align 4, !dbg !105, !tbaa !96
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !153, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !156, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !159, metadata !DIExpression()), !dbg !204
