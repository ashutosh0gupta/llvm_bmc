...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X1_0, metadata !141, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !167

  //   store atomic i32 0, i32* @atom_2_X1_0 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_2_X1_0, align 4, !dbg !109, !tbaa !107
  // LD: Guess
  old_cr = cr(0,5);
