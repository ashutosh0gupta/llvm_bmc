...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 4, metadata !42, metadata !DIExpression()), !dbg !62

  //   store atomic i64 4, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !64
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !47, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !52, metadata !DIExpression()), !dbg !69

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !70
  // ST: Guess
  //   : Release
  ...
  //   %cmp = icmp eq i32 %conv8, 3, !dbg !74
  ...
  //   store i32 %conv9, i32* @atom_0_X6_3, align 4, !dbg !75, !tbaa !76
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !86, metadata !DIExpression()), !dbg !101
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_3, metadata !134, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i32 0, metadata !137, metadata !DIExpression()), !dbg !164

  //   store atomic i32 0, i32* @atom_0_X6_3 monotonic, align 4, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_4, metadata !138, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i32 0, metadata !140, metadata !DIExpression()), !dbg !166

  //   store atomic i32 0, i32* @atom_1_X3_4 monotonic, align 4, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_3, metadata !141, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !168

  //   store atomic i32 0, i32* @atom_1_X2_3 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_0_X6_3, align 4, !dbg !105, !tbaa !106
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %6 = load i32, i32* @atom_1_X3_4, align 4, !dbg !108, !tbaa !106
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X2_3, align 4, !dbg !109, !tbaa !106
  // LD: Guess
  old_cr = cr(0,4);
