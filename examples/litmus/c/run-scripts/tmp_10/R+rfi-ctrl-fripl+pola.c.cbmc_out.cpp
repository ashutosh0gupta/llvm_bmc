...
T1BLOCK4:
  ...
  //   %cmp14 = icmp eq i32 %conv4, 0, !dbg !95
  ...
  //   store i32 %conv15, i32* @atom_0_X3_0, align 4, !dbg !96, !tbaa !89
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_2, metadata !141, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_0, metadata !148, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !186

  //   store atomic i32 0, i32* @atom_0_X3_0 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !151, metadata !DIExpression()), !dbg !188
  ...
  //   %8 = load i32, i32* @atom_0_X3_0, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
