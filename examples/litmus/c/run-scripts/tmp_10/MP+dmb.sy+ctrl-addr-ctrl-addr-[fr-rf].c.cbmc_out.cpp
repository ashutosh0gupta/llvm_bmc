...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !73, metadata !DIExpression()), !dbg !116

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !116

  //   %conv15 = trunc i64 %3 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !72, metadata !DIExpression()), !dbg !91

  //   %xor16 = xor i32 %conv15, %conv15, !dbg !100
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !76, metadata !DIExpression()), !dbg !91
  ...
  //   %arrayidx20 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !101
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !78, metadata !DIExpression()), !dbg !121
  ...
  //   %cmp29 = icmp eq i32 %conv23, 0, !dbg !113
  ...
  //   store i32 %conv30, i32* @atom_1_X10_0, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv27, 1, !dbg !115
  ...
  //   store i32 %conv32, i32* @atom_1_X12_1, align 4, !dbg !116, !tbaa !109
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !147
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !184, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X12_1, metadata !187, metadata !DIExpression()), !dbg !228
