...
T1BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !50
  // ST: Guess
...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !97), !dbg !102
  ...
  //   %tobool = icmp ne i32 %conv, 0, !dbg !87
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !98), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !112

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !66, metadata !DIExpression()), !dbg !112

  //   %conv4 = trunc i64 %1 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !63, metadata !DIExpression()), !dbg !100

  //   %xor = xor i32 %conv4, %conv4, !dbg !96
  creg_r2 = max(creg_r1,creg_r1);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !67, metadata !DIExpression()), !dbg !100
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !97
  r4 = 0+r3*1;
  ASSUME(creg_r4 >= 0);
  ASSUME(creg_r4 >= creg_r3);
  ASSUME(active[creg_r4] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !117

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(2,r4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !71, metadata !DIExpression()), !dbg !117

  //   %conv8 = trunc i64 %2 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !100

  //   %tobool9 = icmp ne i32 %conv8, 0, !dbg !100

  //   br i1 %tobool9, label %if.then10, label %if.else11, !dbg !102
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !99), !dbg !124

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !73, metadata !DIExpression()), !dbg !125

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !107
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !125

  //   %conv15 = trunc i64 %3 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !72, metadata !DIExpression()), !dbg !100

  //   %xor16 = xor i32 %conv15, %conv15, !dbg !109
  creg_r7 = max(creg_r6,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !76, metadata !DIExpression()), !dbg !100

  //   %add18 = add nsw i32 0, %xor16, !dbg !110
  creg_r8 = max(0,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = 0 + r7;

  //   %idxprom19 = sext i32 %add18 to i64, !dbg !110

  //   %arrayidx20 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !110
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !78, metadata !DIExpression()), !dbg !130

  //   %4 = load atomic i64, i64* %arrayidx20 monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !130

  //   %conv23 = trunc i64 %4 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !77, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !132

  //   %conv27 = trunc i64 %5 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !81, metadata !DIExpression()), !dbg !100

  //   %cmp = icmp eq i32 %conv, 1, !dbg !116

  //   %conv28 = zext i1 %cmp to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !85, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !86, metadata !DIExpression()), !dbg !136

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !88, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv23, 0, !dbg !119

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !89, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !90, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %7, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv27, 1, !dbg !122

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !93, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_1, metadata !94, metadata !DIExpression()), !dbg !142

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %8, i64* @atom_1_X12_1 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64 1, metadata !150, metadata !DIExpression()), !dbg !155

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !47
  // ST: Guess
...
T0BLOCK0:
  ...
  //   %2 = bitcast i64* %thr2 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !172, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !173, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !176, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !179, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !182, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !185, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !188, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !240

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !191, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !242

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_1, metadata !194, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !244

  //   store atomic i64 0, i64* @atom_1_X12_1 monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !124
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !125
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !131
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !132, !tbaa !127
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call18 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !133
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !134, !tbaa !127
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   %call19 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !135
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !198, metadata !DIExpression()), !dbg !259

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !200, metadata !DIExpression()), !dbg !259

  //   %conv = trunc i64 %6 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !197, metadata !DIExpression()), !dbg !223

  //   %cmp = icmp eq i32 %conv, 2, !dbg !139

  //   %conv20 = zext i1 %cmp to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !201, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !203, metadata !DIExpression()), !dbg !263

  //   %7 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !205, metadata !DIExpression()), !dbg !263

  //   %conv24 = trunc i64 %7 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !202, metadata !DIExpression()), !dbg !223

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !143

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !206, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !208, metadata !DIExpression()), !dbg !267

  //   %8 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !210, metadata !DIExpression()), !dbg !267

  //   %conv30 = trunc i64 %8 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !207, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !212, metadata !DIExpression()), !dbg !270

  //   %9 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !214, metadata !DIExpression()), !dbg !270

  //   %conv34 = trunc i64 %9 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !211, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_1, metadata !216, metadata !DIExpression()), !dbg !273

  //   %10 = load atomic i64, i64* @atom_1_X12_1 seq_cst, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !218, metadata !DIExpression()), !dbg !273

  //   %conv38 = trunc i64 %10 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !215, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !219, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !220, metadata !DIExpression()), !dbg !223

  //   %and40 = and i32 %conv26, %and39, !dbg !155
  creg_r23 = max(max(creg_r17,0),creg_r22);
  ASSUME(active[creg_r23] == 0);
  r23 = (r17==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !221, metadata !DIExpression()), !dbg !223

  //   %and41 = and i32 %conv20, %and40, !dbg !156
  creg_r24 = max(max(creg_r16,0),creg_r23);
  ASSUME(active[creg_r24] == 0);
  r24 = (r16==2) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !222, metadata !DIExpression()), !dbg !223

  //   %cmp42 = icmp eq i32 %and41, 1, !dbg !157

  //   br i1 %cmp42, label %if.then, label %if.end, !dbg !159
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160

  //   unreachable, !dbg !160
  r25 = 1;

T0BLOCK2:
  //   %11 = bitcast i64* %thr2 to i8*, !dbg !163

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !163

  //   %12 = bitcast i64* %thr1 to i8*, !dbg !163

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !163

  //   %13 = bitcast i64* %thr0 to i8*, !dbg !163

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !163
