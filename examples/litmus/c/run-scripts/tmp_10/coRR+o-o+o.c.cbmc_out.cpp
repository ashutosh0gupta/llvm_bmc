...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !52

  //   %0 = load atomic i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !53
  // LD: Guess
  old_cr = cr(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !43, metadata !DIExpression()), !dbg !55

  //   %1 = load atomic i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !56
  // LD: Guess
  old_cr = cr(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !45, metadata !DIExpression()), !dbg !55

  //   %conv4 = trunc i64 %1 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !42, metadata !DIExpression()), !dbg !49
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !46, metadata !DIExpression()), !dbg !49

  //   store i32 %conv5, i32* @atom_0_X0_1, align 4, !dbg !59, !tbaa !60
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !47, metadata !DIExpression()), !dbg !49

  //   store i32 %conv7, i32* @atom_0_X2_0, align 4, !dbg !65, !tbaa !60
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !69, metadata !DIExpression()), !dbg !74
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64 1, metadata !72, metadata !DIExpression()), !dbg !77

  //   store atomic i64 1, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !46
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !94, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64 0, metadata !96, metadata !DIExpression()), !dbg !112

  //   store atomic i64 0, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !66
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !97, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i32 0, metadata !100, metadata !DIExpression()), !dbg !114

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !68
  // ST: Guess
  iw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l40_c3
  old_cw = cw(0,1);
  cw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l40_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !101, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i32 0, metadata !103, metadata !DIExpression()), !dbg !116

  //   store atomic i32 0, i32* @atom_0_X2_0 monotonic, align 4, !dbg !70
  // ST: Guess
  ...
  //   %call5 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !72
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call6 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !78
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !79, !tbaa !74
  r4 = local_mem[1];

  //   %call7 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !80
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i32, i32* @atom_0_X0_1, align 4, !dbg !81, !tbaa !82
  // LD: Guess
  old_cr = cr(0,1);
  cr(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l49_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !104, metadata !DIExpression()), !dbg !107

  //   %5 = load i32, i32* @atom_0_X2_0, align 4, !dbg !84, !tbaa !82
  // LD: Guess
  old_cr = cr(0,2);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i64 0, i64 0), i32 noundef 52, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !89
