...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !69, metadata !DIExpression()), !dbg !107

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,0+3*1);
...
T2BLOCK7:
  ...
  //   %cmp24 = icmp eq i32 %conv15, 2, !dbg !114
  ...
  //   store i32 %conv25, i32* @atom_1_X9_2, align 4, !dbg !115, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_2, metadata !185, metadata !DIExpression()), !dbg !233
  ...
  // LD: Guess
  old_cr = cr(0,0+4*1);
  cr(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l80_c13
  // Check
