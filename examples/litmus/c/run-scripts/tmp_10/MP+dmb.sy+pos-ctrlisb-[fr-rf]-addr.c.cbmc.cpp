...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv12, %conv12, !dbg !94
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !115

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !115
  ...
  //   %conv17 = zext i1 %cmp to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !84, metadata !DIExpression()), !dbg !91

  //   store i32 %conv17, i32* @atom_1_X0_1, align 4, !dbg !99, !tbaa !100
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv4, 1, !dbg !104
  creg__r1__1_ = max(0,creg_r1);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !85, metadata !DIExpression()), !dbg !91

  //   store i32 %conv19, i32* @atom_1_X2_1, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv8, 0, !dbg !106
  creg__r2__0_ = max(0,creg_r2);

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !86, metadata !DIExpression()), !dbg !91

  //   store i32 %conv21, i32* @atom_1_X3_0, align 4, !dbg !107, !tbaa !100
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv12, 1, !dbg !108
  creg__r3__1_ = max(0,creg_r3);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv23, i32* @atom_1_X5_1, align 4, !dbg !109, !tbaa !100
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv16, 0, !dbg !110
  creg__r7__0_ = max(0,creg_r7);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !88, metadata !DIExpression()), !dbg !91

  //   store i32 %conv25, i32* @atom_1_X7_0, align 4, !dbg !111, !tbaa !100
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !134, metadata !DIExpression()), !dbg !139
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !135, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64 1, metadata !137, metadata !DIExpression()), !dbg !142
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !152, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !153, metadata !DIExpression()), !dbg !212

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !154, metadata !DIExpression()), !dbg !214

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !158, metadata !DIExpression()), !dbg !216

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !159, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !160, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !166, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !169, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !173, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !175, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !176, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i32 0, metadata !178, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !179, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !182, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !186, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !188, metadata !DIExpression()), !dbg !246

  //   %conv = trunc i64 %6 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !185, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !189, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !193, metadata !DIExpression()), !dbg !250

  //   %conv24 = trunc i64 %7 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !190, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !194, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !196, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !195, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !199, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !200, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !201, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !202, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !203, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !204, metadata !DIExpression()), !dbg !212

  //   %and = and i32 %12, %13, !dbg !161
  creg_r20 = max(creg_r18,creg_r19);
  r20 = r18 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !205, metadata !DIExpression()), !dbg !212

  //   %and33 = and i32 %11, %and, !dbg !162
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !206, metadata !DIExpression()), !dbg !212

  //   %and34 = and i32 %10, %and33, !dbg !163
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !207, metadata !DIExpression()), !dbg !212

  //   %and35 = and i32 %9, %and34, !dbg !164
  creg_r23 = max(creg_r15,creg_r22);
  r23 = r15 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !208, metadata !DIExpression()), !dbg !212

  //   %and36 = and i32 %conv32, %and35, !dbg !165
  creg_r24 = max(creg__r14__1_,creg_r23);
  r24 = (r14==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !209, metadata !DIExpression()), !dbg !212

  //   %and37 = and i32 %conv26, %and36, !dbg !166
  creg_r25 = max(creg__r13__1_,creg_r24);
  r25 = (r13==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !210, metadata !DIExpression()), !dbg !212

  //   %and38 = and i32 %conv20, %and37, !dbg !167
  creg_r26 = max(creg__r12__1_,creg_r25);
  r26 = (r12==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !211, metadata !DIExpression()), !dbg !212
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
