...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !61, metadata !DIExpression()), !dbg !106
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !109

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !66, metadata !DIExpression()), !dbg !109

  //   %conv = trunc i64 %0 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !62, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !112

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !112

  //   %conv4 = trunc i64 %1 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !106
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !105), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !122

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !122

  //   %conv8 = trunc i64 %2 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !125

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !107
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !125

  //   %conv12 = trunc i64 %3 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !106

  //   %xor = xor i32 %conv12, %conv12, !dbg !109
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !106

  //   %add = add nsw i32 0, %xor, !dbg !110
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !110
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ASSUME(creg_r6 >= creg_r5);
  ASSUME(active[creg_r6] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !130

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   %conv16 = trunc i64 %4 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !80, metadata !DIExpression()), !dbg !106

  //   %cmp = icmp eq i32 %conv, 1, !dbg !113

  //   %conv17 = zext i1 %cmp to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !84, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !85, metadata !DIExpression()), !dbg !133

  //   %5 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !87, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv4, 1, !dbg !116

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !88, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !89, metadata !DIExpression()), !dbg !136

  //   %6 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %6, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 0, !dbg !119

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !92, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !93, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %7, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !96, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !97, metadata !DIExpression()), !dbg !142

  //   %8 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !99, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %8, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !124
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv16, 0, !dbg !125

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !100, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !101, metadata !DIExpression()), !dbg !145

  //   %9 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !103, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %9, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !127
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !168, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !169, metadata !DIExpression()), !dbg !242

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !170, metadata !DIExpression()), !dbg !244

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !123

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !123

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !174, metadata !DIExpression()), !dbg !246

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !125

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !125

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !175, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !176, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !179, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !188, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !191, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !259

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !194, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !261

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !140
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !197, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !263

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !142
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !201, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !203, metadata !DIExpression()), !dbg !278

  //   %conv = trunc i64 %6 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !200, metadata !DIExpression()), !dbg !242

  //   %cmp = icmp eq i32 %conv, 1, !dbg !159

  //   %conv20 = zext i1 %cmp to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !204, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !206, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !208, metadata !DIExpression()), !dbg !282

  //   %conv24 = trunc i64 %7 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !205, metadata !DIExpression()), !dbg !242

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !163

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !209, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !211, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !213, metadata !DIExpression()), !dbg !286

  //   %conv30 = trunc i64 %8 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !210, metadata !DIExpression()), !dbg !242

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !167

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !214, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !218, metadata !DIExpression()), !dbg !290

  //   %conv36 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !215, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !220, metadata !DIExpression()), !dbg !293
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !222, metadata !DIExpression()), !dbg !293

  //   %conv40 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !219, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !224, metadata !DIExpression()), !dbg !296

  //   %11 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !175
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !226, metadata !DIExpression()), !dbg !296

  //   %conv44 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !223, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !228, metadata !DIExpression()), !dbg !299

  //   %12 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !178
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !230, metadata !DIExpression()), !dbg !299

  //   %conv48 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !227, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !232, metadata !DIExpression()), !dbg !302

  //   %13 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !181
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !234, metadata !DIExpression()), !dbg !302

  //   %conv52 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !231, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !236, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !237, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !238, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !239, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !240, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !241, metadata !DIExpression()), !dbg !242
