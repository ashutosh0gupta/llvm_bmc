...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !96
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !80, metadata !DIExpression()), !dbg !105
  ...
  //   store i32 %conv9, i32* @atom_1_X2_2, align 4, !dbg !80, !tbaa !81
  // ST: Guess
  ...
  //   store i32 %conv11, i32* @atom_1_X5_0, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !146, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !181

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X5_0, align 4, !dbg !124, !tbaa !121
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !132
