...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !35, metadata !DIExpression()), !dbg !43

  //   call void @llvm.dbg.value(metadata i64 2, metadata !38, metadata !DIExpression()), !dbg !43

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !44
  // ST: Guess
  //   : Release
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !50, metadata !DIExpression()), !dbg !61

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !49
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !64

  //   call void @llvm.dbg.value(metadata i64 1, metadata !55, metadata !DIExpression()), !dbg !64

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !52
  // ST: Guess
  //   : Release
  iw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l26_c3
  old_cw = cw(2,0+1*1);
  cw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l26_c3
  // Check
  ...
  //   store i32 %conv1, i32* @atom_1_X0_2, align 4, !dbg !54, !tbaa !55
  // ST: Guess
  iw(2,3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l28_c15
  old_cw = cw(2,3);
  cw(2,3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l28_c15
  // Check
...
T3BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !49
  // ST: Guess
  //   : Release
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l35_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l35_c3
  // Check
...
T4BLOCK1:
  ...
  // ST: Guess
  iw(4,0+2*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l41_c3
  old_cw = cw(4,0+2*1);
  cw(4,0+2*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l41_c3
  // Check
  ...
  // ST: Guess
  iw(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l43_c3
  old_cw = cw(4,0);
  cw(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l43_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !124, metadata !DIExpression()), !dbg !164

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !125, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !135, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !173

  //   store atomic i32 0, i32* @atom_1_X0_2 monotonic, align 4, !dbg !95
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !99
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr0, align 8, !dbg !100, !tbaa !101
  r2 = local_mem[0];
  ...
  //   %5 = load i64, i64* %thr1, align 8, !dbg !106, !tbaa !101
  r3 = local_mem[1];
  ...
  //   %6 = load i64, i64* %thr2, align 8, !dbg !108, !tbaa !101
  r4 = local_mem[2];
  ...
  //   %7 = load i64, i64* %thr3, align 8, !dbg !110, !tbaa !101
  r5 = local_mem[3];
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !189

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l68_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !142, metadata !DIExpression()), !dbg !189

  //   %conv = trunc i64 %8 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !139, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !143, metadata !DIExpression()), !dbg !158
  ...
  //   %9 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l70_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !147, metadata !DIExpression()), !dbg !193

  //   %conv18 = trunc i64 %9 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !144, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !148, metadata !DIExpression()), !dbg !158
  ...
  //   %10 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l72_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !152, metadata !DIExpression()), !dbg !197

  //   %conv24 = trunc i64 %10 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !149, metadata !DIExpression()), !dbg !158

  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !123
  creg__r8__2_ = max(0,creg_r8);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !153, metadata !DIExpression()), !dbg !158

  //   %11 = load i32, i32* @atom_1_X0_2, align 4, !dbg !124, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %and = and i32 %conv26, %11, !dbg !127
  creg_r10 = max(creg__r8__2_,creg_r9);
  r10 = (r8==2) & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !155, metadata !DIExpression()), !dbg !158

  //   %and27 = and i32 %conv20, %and, !dbg !128
  creg_r11 = max(creg__r7__2_,creg_r10);
  r11 = (r7==2) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !156, metadata !DIExpression()), !dbg !158

  //   %and28 = and i32 %conv14, %and27, !dbg !129
  creg_r12 = max(creg__r6__2_,creg_r11);
  r12 = (r6==2) & r11;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !157, metadata !DIExpression()), !dbg !158
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !133
