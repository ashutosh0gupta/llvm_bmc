...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !79, metadata !DIExpression()), !dbg !97
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !86, metadata !DIExpression()), !dbg !118

  //   %conv10 = trunc i64 %2 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !83, metadata !DIExpression()), !dbg !97

  //   %cmp = icmp eq i32 %conv, 2, !dbg !93

  //   %conv11 = zext i1 %cmp to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !87, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !88, metadata !DIExpression()), !dbg !122

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !90, metadata !DIExpression()), !dbg !122

  //   store atomic i64 %3, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !95
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv10, 0, !dbg !96

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !91, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !92, metadata !DIExpression()), !dbg !125

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !94, metadata !DIExpression()), !dbg !125

  //   store atomic i64 %4, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !151, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !171, metadata !DIExpression()), !dbg !221
