...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !38, metadata !DIExpression()), !dbg !50
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !53
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !43, metadata !DIExpression()), !dbg !53

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !39, metadata !DIExpression()), !dbg !50

  //   %xor = xor i32 %conv, %conv, !dbg !56
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !44, metadata !DIExpression()), !dbg !50

  //   %add = add nsw i32 1, %xor, !dbg !57
  creg_r2 = max(0,creg_r1);
  r2 = 1 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !57

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !57
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !45, metadata !DIExpression()), !dbg !58

  //   call void @llvm.dbg.value(metadata i64 1, metadata !47, metadata !DIExpression()), !dbg !58

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !57
  // ST: Guess
  iw(1,r3) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l23_c3
  old_cw = cw(1,r3);
  cw(1,r3) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l23_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !48, metadata !DIExpression()), !dbg !50
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !68, metadata !DIExpression()), !dbg !80
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !72, metadata !DIExpression()), !dbg !83

  //   %conv = trunc i64 %0 to i32, !dbg !56

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !69, metadata !DIExpression()), !dbg !80

  //   %xor = xor i32 %conv, %conv, !dbg !57
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !73, metadata !DIExpression()), !dbg !80

  //   %add = add nsw i32 %xor, 1, !dbg !58
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !74, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !88

  //   %conv1 = sext i32 %add to i64, !dbg !60

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !77, metadata !DIExpression()), !dbg !88

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !60
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !78, metadata !DIExpression()), !dbg !80

  //   store i32 %conv2, i32* @atom_1_X0_1, align 4, !dbg !62, !tbaa !63
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !95, metadata !DIExpression()), !dbg !106
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !97, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !99, metadata !DIExpression()), !dbg !109

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !96, metadata !DIExpression()), !dbg !106
...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !100, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 1, metadata !102, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !103, metadata !DIExpression()), !dbg !106

  //   store i32 %conv1, i32* @atom_2_X0_1, align 4, !dbg !66, !tbaa !67
  // ST: Guess
  iw(3,5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l48_c15
  old_cw = cw(3,5);
  cw(3,5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l48_c15
  // Check
  ASSUME(active[iw(3,5)] == 3);
  ASSUME(active[cw(3,5)] == 3);
  ASSUME(sforbid(5,cw(3,5))== 0);
  ASSUME(iw(3,5) >= creg__r7__1_);
  ASSUME(iw(3,5) >= 0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !131, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !132, metadata !DIExpression()), !dbg !163

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !133, metadata !DIExpression()), !dbg !165

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !137, metadata !DIExpression()), !dbg !167

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !138, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !139, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !142, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !148, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !176

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !152, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !178

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !155, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !180

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !94
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call12 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !95
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !96, !tbaa !97
  r9 = local_mem[2];

  //   %call13 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !101
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !102, !tbaa !97
  r10 = local_mem[0];

  //   %call14 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !103
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !104, !tbaa !97
  r11 = local_mem[1];

  //   %call15 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !105
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i32, i32* @atom_0_X0_1, align 4, !dbg !106, !tbaa !107
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !158, metadata !DIExpression()), !dbg !163

  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !109, !tbaa !107
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !159, metadata !DIExpression()), !dbg !163

  //   %8 = load i32, i32* @atom_2_X0_1, align 4, !dbg !110, !tbaa !107
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !160, metadata !DIExpression()), !dbg !163

  //   %and = and i32 %7, %8, !dbg !111
  creg_r15 = max(creg_r13,creg_r14);
  r15 = r13 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !161, metadata !DIExpression()), !dbg !163

  //   %and16 = and i32 %6, %and, !dbg !112
  creg_r16 = max(creg_r12,creg_r15);
  r16 = r12 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !162, metadata !DIExpression()), !dbg !163

  //   %cmp = icmp eq i32 %and16, 1, !dbg !113
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
...
T0BLOCK2:
  //   %9 = bitcast i64* %thr2 to i8*, !dbg !119

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #7, !dbg !119

  //   %10 = bitcast i64* %thr1 to i8*, !dbg !119

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !119

  //   %11 = bitcast i64* %thr0 to i8*, !dbg !119

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !119
