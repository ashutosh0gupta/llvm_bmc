...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !111
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !98), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !73, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !119

  //   %conv12 = trunc i64 %3 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !72, metadata !DIExpression()), !dbg !100

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !103
  creg_r7 = max(creg_r6,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !76, metadata !DIExpression()), !dbg !100

  //   %add15 = add nsw i32 4, %xor13, !dbg !104
  creg_r8 = max(0,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = 4 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !104

  //   %arrayidx17 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !104
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !78, metadata !DIExpression()), !dbg !124

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !124

  //   %conv20 = trunc i64 %4 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !77, metadata !DIExpression()), !dbg !100

  //   %tobool21 = icmp ne i32 %conv20, 0, !dbg !107

  //   br i1 %tobool21, label %if.then22, label %if.else23, !dbg !109
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK6:
  //   br label %lbl_LC01, !dbg !111
  goto T2BLOCK7;

T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !99), !dbg !131
