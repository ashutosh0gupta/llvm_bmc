...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !43, metadata !DIExpression()), !dbg !66

  //   call void @llvm.dbg.value(metadata i64 1, metadata !45, metadata !DIExpression()), !dbg !66
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !47, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !49, metadata !DIExpression()), !dbg !68

  //   %conv = trunc i64 %0 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !46, metadata !DIExpression()), !dbg !61

  //   %xor = xor i32 %conv, %conv, !dbg !71
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !50, metadata !DIExpression()), !dbg !61

  //   %add = add nsw i32 %xor, 1, !dbg !72
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !51, metadata !DIExpression()), !dbg !61
  ...
  //   %conv5 = sext i32 %add to i64, !dbg !74

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !54, metadata !DIExpression()), !dbg !73

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !74
  // ST: Guess
  //   : Release
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !76
  // LD: Guess
  old_cr = cr(1,0);
  ...
  //   %cmp = icmp eq i32 %conv9, 2, !dbg !78
  ...
  //   store i32 %conv10, i32* @atom_0_X7_2, align 4, !dbg !79, !tbaa !80
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X7_2, metadata !141, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_3, metadata !145, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !148, metadata !DIExpression()), !dbg !183
  ...
  creg_r17 = max(creg__r9__3_,creg_r16);
  r17 = (r9==3) & r16;
