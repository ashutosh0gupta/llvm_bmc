...
T1BLOCK1:
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !49
  // ST: Guess
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !52
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !56, metadata !DIExpression()), !dbg !74
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !57, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !63, metadata !DIExpression()), !dbg !80

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !62
  // ST: Guess
  iw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l29_c3
  old_cw = cw(2,0);
  cw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l29_c3
  // Check
  ASSUME(active[iw(2,0)] == 2);
  ASSUME(active[cw(2,0)] == 2);
  ASSUME(sforbid(0,cw(2,0))== 0);
  ASSUME(iw(2,0) >= creg_r0);
  ASSUME(iw(2,0) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !67, metadata !DIExpression()), !dbg !82

  //   %conv5 = trunc i64 %1 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !64, metadata !DIExpression()), !dbg !74

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !68, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64 0, metadata !70, metadata !DIExpression()), !dbg !85

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !74
  ...
  //   %cmp9 = icmp eq i32 %conv5, 1, !dbg !74
  creg__r1__1_ = max(0,creg_r1);

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !72, metadata !DIExpression()), !dbg !74

  //   store i32 %conv10, i32* @atom_1_X2_1, align 4, !dbg !75, !tbaa !70
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !103, metadata !DIExpression()), !dbg !132

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !104, metadata !DIExpression()), !dbg !132

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !105, metadata !DIExpression()), !dbg !134

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !109, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !110, metadata !DIExpression()), !dbg !137

  //   call void @llvm.dbg.value(metadata i64 0, metadata !112, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !113, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i64 0, metadata !115, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !116, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i32 0, metadata !119, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !120, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i32 0, metadata !122, metadata !DIExpression()), !dbg !143

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !81
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_1_X0_1, align 4, !dbg !92, !tbaa !93
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l54_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !123, metadata !DIExpression()), !dbg !132

  //   %5 = load i32, i32* @atom_1_X2_1, align 4, !dbg !95, !tbaa !93
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l55_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !124, metadata !DIExpression()), !dbg !132
  ...
  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !128, metadata !DIExpression()), !dbg !155

  //   %conv = trunc i64 %6 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !125, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !129, metadata !DIExpression()), !dbg !132

  //   %and = and i32 %5, %conv10, !dbg !100
  creg_r8 = max(creg__r7__3_,creg_r6);
  r8 = r6 & (r7==3);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !130, metadata !DIExpression()), !dbg !132

  //   %and11 = and i32 %4, %and, !dbg !101
  creg_r9 = max(creg_r5,creg_r8);
  r9 = r5 & r8;

  //   call void @llvm.dbg.value(metadata i32 %and11, metadata !131, metadata !DIExpression()), !dbg !132
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 60, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !105
