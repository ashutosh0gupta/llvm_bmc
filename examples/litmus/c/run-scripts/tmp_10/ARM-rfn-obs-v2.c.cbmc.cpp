...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !39, metadata !DIExpression()), !dbg !47

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !48
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !42, metadata !DIExpression()), !dbg !50

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !51
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !55, metadata !DIExpression()), !dbg !80
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !60, metadata !DIExpression()), !dbg !83

  //   %conv = trunc i64 %0 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !56, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !61, metadata !DIExpression()), !dbg !86

  //   %conv1 = sext i32 %conv to i64, !dbg !68

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !63, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !64, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !70, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !72, metadata !DIExpression()), !dbg !94
  ...
  //   %cmp12 = icmp eq i32 %conv5, 1, !dbg !77

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !75, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !76, metadata !DIExpression()), !dbg !97

  //   %3 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !97

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !107, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !108, metadata !DIExpression()), !dbg !141

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !109, metadata !DIExpression()), !dbg !143

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !113, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !114, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !117, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !120, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !123, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64 0, metadata !125, metadata !DIExpression()), !dbg !152

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !127, metadata !DIExpression()), !dbg !164

  //   %4 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !129, metadata !DIExpression()), !dbg !164

  //   %conv = trunc i64 %4 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !126, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !131, metadata !DIExpression()), !dbg !167

  //   %5 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !133, metadata !DIExpression()), !dbg !167

  //   %conv13 = trunc i64 %5 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !130, metadata !DIExpression()), !dbg !141
  ...
  //   %conv17 = trunc i64 %6 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !134, metadata !DIExpression()), !dbg !141

  //   %cmp = icmp eq i32 %conv17, 3, !dbg !106

  //   %conv18 = zext i1 %cmp to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !138, metadata !DIExpression()), !dbg !141

  //   %and = and i32 %conv13, %conv18, !dbg !107
  creg_r8 = max(creg_r6,max(creg_r7,0));
  ASSUME(active[creg_r8] == 0);
  r8 = r6 & (r7==3);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !139, metadata !DIExpression()), !dbg !141

  //   %and19 = and i32 %conv, %and, !dbg !108
  creg_r9 = max(creg_r5,creg_r8);
  ASSUME(active[creg_r9] == 0);
  r9 = r5 & r8;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !140, metadata !DIExpression()), !dbg !141
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 60, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !112
