...
T2BLOCK7:
  ...
  //   %cmp26 = icmp eq i32 %conv12, 0, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !91, metadata !DIExpression()), !dbg !144

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %7, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !126
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv16, 1, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !95, metadata !DIExpression()), !dbg !147

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %8, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !129
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !196, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !199, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !202, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !225, metadata !DIExpression()), !dbg !293
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !229, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !233, metadata !DIExpression()), !dbg !299
