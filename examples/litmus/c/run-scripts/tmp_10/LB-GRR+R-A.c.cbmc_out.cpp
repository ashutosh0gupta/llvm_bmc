...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !66, metadata !DIExpression()), !dbg !84
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !68, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !70, metadata !DIExpression()), !dbg !87

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !67, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !71, metadata !DIExpression()), !dbg !84

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !66

  //   %conv5 = zext i1 %cmp to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !75, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !76, metadata !DIExpression()), !dbg !94

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !94

  //   store atomic i64 %2, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !79, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !80, metadata !DIExpression()), !dbg !97

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !97

  //   store atomic i64 %3, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !71
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !106, metadata !DIExpression()), !dbg !116
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !143, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !179

  //   store atomic i64 0, i64* @atom_1_X2_0 monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !153, metadata !DIExpression()), !dbg !198

  //   %6 = load atomic i64, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,3);
