...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !68, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !71, metadata !DIExpression()), !dbg !78

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !60
  creg__r2__0_ = max(0,creg_r2);

  //   %conv5 = zext i1 %cmp to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !75, metadata !DIExpression()), !dbg !78

  //   store i32 %conv5, i32* @atom_1_X2_0, align 4, !dbg !61, !tbaa !62
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv, 1, !dbg !66
  creg__r1__1_ = max(0,creg_r1);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !76, metadata !DIExpression()), !dbg !78

  //   store i32 %conv7, i32* @atom_1_X0_1, align 4, !dbg !67, !tbaa !62
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !98, metadata !DIExpression()), !dbg !108
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !135, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !139, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !142, metadata !DIExpression()), !dbg !167
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
