...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !73, metadata !DIExpression()), !dbg !97
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !74, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !80, metadata !DIExpression()), !dbg !102

  //   %conv = trunc i64 %0 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !77, metadata !DIExpression()), !dbg !97
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !84, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !92, metadata !DIExpression()), !dbg !97

  //   store i32 %conv11, i32* @atom_1_X6_2, align 4, !dbg !88, !tbaa !89
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv, 2, !dbg !93
  creg__r1__2_ = max(0,creg_r1);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !93, metadata !DIExpression()), !dbg !97

  //   store i32 %conv13, i32* @atom_1_X2_2, align 4, !dbg !94, !tbaa !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !94, metadata !DIExpression()), !dbg !97

  //   store i32 %conv15, i32* @atom_1_X5_1, align 4, !dbg !96, !tbaa !89
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !146, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !150, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !156, metadata !DIExpression()), !dbg !193
