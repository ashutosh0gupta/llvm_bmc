...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !152, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !155, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !159, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !162, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i32 0, metadata !164, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !168, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !169, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !171, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !173, metadata !DIExpression()), !dbg !211

  //   %conv18 = trunc i64 %5 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !170, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !174, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !179, metadata !DIExpression()), !dbg !182

  //   %and22 = and i32 %conv20, %and21, !dbg !127
  creg_r15 = max(creg__r9__2_,creg_r14);
  r15 = (r9==2) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !180, metadata !DIExpression()), !dbg !182

  //   %and23 = and i32 %conv14, %and22, !dbg !128
  creg_r16 = max(creg__r8__1_,creg_r15);
  r16 = (r8==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !181, metadata !DIExpression()), !dbg !182
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !132
