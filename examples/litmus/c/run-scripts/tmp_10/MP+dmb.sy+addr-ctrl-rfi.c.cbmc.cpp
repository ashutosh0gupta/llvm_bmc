...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !76), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !66, metadata !DIExpression()), !dbg !93
