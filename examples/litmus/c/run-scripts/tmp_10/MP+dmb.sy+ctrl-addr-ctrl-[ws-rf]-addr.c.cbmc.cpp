...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !89), !dbg !114
  ...
  //   %cmp25 = icmp eq i32 %conv15, 2, !dbg !111
  ...
  //   store i32 %conv26, i32* @atom_1_X9_2, align 4, !dbg !112, !tbaa !107
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_2, metadata !182, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !230

  //   store atomic i32 0, i32* @atom_1_X9_2 monotonic, align 4, !dbg !118
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X9_2, align 4, !dbg !149, !tbaa !147
  // LD: Guess
  old_cr = cr(0,6);
