...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !66, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !81
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !75
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !69, metadata !DIExpression()), !dbg !81
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !80), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !73, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !77, metadata !DIExpression()), !dbg !81

  //   store i32 %conv13, i32* @atom_1_X2_2, align 4, !dbg !88, !tbaa !89
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv12, 0, !dbg !93
  creg__r6__0_ = max(0,creg_r6);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !78, metadata !DIExpression()), !dbg !81

  //   store i32 %conv15, i32* @atom_1_X7_0, align 4, !dbg !94, !tbaa !89
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !122, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !123, metadata !DIExpression()), !dbg !160

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !124, metadata !DIExpression()), !dbg !162

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !128, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !129, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !132, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !135, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !138, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i32 0, metadata !141, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !142, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i32 0, metadata !144, metadata !DIExpression()), !dbg !173

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !94
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !154, metadata !DIExpression()), !dbg !160

  //   %6 = load i32, i32* @atom_1_X2_2, align 4, !dbg !111, !tbaa !112
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X7_0, align 4, !dbg !114, !tbaa !112
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !158, metadata !DIExpression()), !dbg !160

  //   %and20 = and i32 %conv12, %and19, !dbg !117
  creg_r16 = max(creg__r10__1_,creg_r15);
  r16 = (r10==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !159, metadata !DIExpression()), !dbg !160
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !121
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #6, !dbg !124

  //   %9 = bitcast i64* %thr0 to i8*, !dbg !124

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #6, !dbg !124
