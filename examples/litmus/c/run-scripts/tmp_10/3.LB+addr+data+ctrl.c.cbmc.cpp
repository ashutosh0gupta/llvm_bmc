...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !106, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !108, metadata !DIExpression()), !dbg !128
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !155, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !158, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !161, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !165, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !164, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !169, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !168, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !173, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !175, metadata !DIExpression()), !dbg !216

  //   %conv23 = trunc i64 %8 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !172, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !176, metadata !DIExpression()), !dbg !178
