...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !76

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !64
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+1*1);
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !88, metadata !DIExpression()), !dbg !96
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !89, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !92, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64 1, metadata !94, metadata !DIExpression()), !dbg !101
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !159, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !175, metadata !DIExpression()), !dbg !229
