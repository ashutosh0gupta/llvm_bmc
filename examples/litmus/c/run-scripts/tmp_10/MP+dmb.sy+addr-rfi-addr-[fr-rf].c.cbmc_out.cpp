...
T2BLOCK1:
  ...
  //   %xor5 = xor i32 %conv4, %conv4, !dbg !80
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !73, metadata !DIExpression()), !dbg !87

  //   %add7 = add nsw i32 0, %xor5, !dbg !81
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !81

  //   %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !81
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !75, metadata !DIExpression()), !dbg !101

  //   %2 = load atomic i64, i64* %arrayidx9 monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(2,r7);
  cr(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l35_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !77, metadata !DIExpression()), !dbg !101

  //   %conv12 = trunc i64 %2 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !103

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp20 = icmp eq i32 %conv12, 0, !dbg !95
  ...
  //   store i32 %conv21, i32* @atom_1_X7_0, align 4, !dbg !96, !tbaa !89
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv16, 1, !dbg !97
  ...
  //   store i32 %conv23, i32* @atom_1_X9_1, align 4, !dbg !98, !tbaa !89
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !122, metadata !DIExpression()), !dbg !129
  ...
  // ST: Guess
  iw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l50_c3
  old_cw = cw(3,0);
  cw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l50_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !163, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !211

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !166, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i32 0, metadata !168, metadata !DIExpression()), !dbg !213

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X7_0, align 4, !dbg !149, !tbaa !146
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X9_1, align 4, !dbg !150, !tbaa !146
  // LD: Guess
  old_cr = cr(0,6);
