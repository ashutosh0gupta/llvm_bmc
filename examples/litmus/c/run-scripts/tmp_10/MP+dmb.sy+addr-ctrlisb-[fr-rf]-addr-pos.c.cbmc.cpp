...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !73, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !82, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !94, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !98, metadata !DIExpression()), !dbg !148
  ...
  //   %cmp37 = icmp eq i32 %conv20, 0, !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !102, metadata !DIExpression()), !dbg !151

  //   %9 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !104, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !106, metadata !DIExpression()), !dbg !154

  //   %10 = zext i32 %conv43 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !108, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %10, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !136
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !200, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !203, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !206, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !209, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !213, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !218, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !223, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !232, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !236, metadata !DIExpression()), !dbg !310
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !240, metadata !DIExpression()), !dbg !313
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !244, metadata !DIExpression()), !dbg !316
