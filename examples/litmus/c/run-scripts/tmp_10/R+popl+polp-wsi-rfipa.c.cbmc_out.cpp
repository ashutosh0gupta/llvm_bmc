...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !42, metadata !DIExpression()), !dbg !55
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !80, metadata !DIExpression()), !dbg !99
  ...
  //   store i32 %conv9, i32* @atom_1_X6_3, align 4, !dbg !76, !tbaa !77
  // ST: Guess
  ...
  //   store i32 %conv11, i32* @atom_1_X5_2, align 4, !dbg !82, !tbaa !77
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_3, metadata !136, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !170

  //   store atomic i32 0, i32* @atom_1_X6_3 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !139, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i32 0, metadata !141, metadata !DIExpression()), !dbg !172

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !96
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X6_3, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X5_2, align 4, !dbg !119, !tbaa !116
  // LD: Guess
  old_cr = cr(0,4);
