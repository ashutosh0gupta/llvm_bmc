...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !98), !dbg !110
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !95
  creg_r2 = max(creg_r1,creg_r1);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !67, metadata !DIExpression()), !dbg !99
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !96
  r4 = 0+r3*1;
  ASSUME(creg_r4 >= 0);
  ASSUME(creg_r4 >= creg_r3);
  ASSUME(active[creg_r4] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !116

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,r4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !72, metadata !DIExpression()), !dbg !99

  //   %add10 = add nsw i32 4, %xor9, !dbg !100
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 4 + r6;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !100

  //   %arrayidx12 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !100
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !73, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !120

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !100
  // ST: Guess
  iw(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,r8);
  cw(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !170, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !225

  //   store atomic i64 0, i64* @atom_1_X10_1 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !177, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !196, metadata !DIExpression()), !dbg !254

  //   %8 = load atomic i64, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,6);
