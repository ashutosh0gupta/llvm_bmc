...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !56
  ...
  //   store i32 %conv1, i32* @atom_0_X0_1, align 4, !dbg !59, !tbaa !60
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !67, metadata !DIExpression()), !dbg !79
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !71, metadata !DIExpression()), !dbg !82

  //   %conv = trunc i64 %0 to i32, !dbg !56

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !68, metadata !DIExpression()), !dbg !79

  //   %xor = xor i32 %conv, %conv, !dbg !57
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !72, metadata !DIExpression()), !dbg !79

  //   %add = add nsw i32 %xor, 1, !dbg !58
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !73, metadata !DIExpression()), !dbg !79

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !87

  //   %conv1 = sext i32 %add to i64, !dbg !60

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !76, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !77, metadata !DIExpression()), !dbg !79
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !94, metadata !DIExpression()), !dbg !105
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !95, metadata !DIExpression()), !dbg !105

  //   %xor = xor i32 %conv, %conv, !dbg !56
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !99, metadata !DIExpression()), !dbg !105

  //   %add = add nsw i32 0, %xor, !dbg !57
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !100, metadata !DIExpression()), !dbg !113
  ...
  // ST: Guess
  iw(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l44_c3
  old_cw = cw(3,r7);
  cw(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l44_c3
  // Check
  ASSUME(active[iw(3,r7)] == 3);
  ASSUME(active[cw(3,r7)] == 3);
  ASSUME(sforbid(r7,cw(3,r7))== 0);
  ASSUME(iw(3,r7) >= 0);
  ASSUME(iw(3,r7) >= creg_r7);
  ASSUME(cw(3,r7) >= iw(3,r7));
  ASSUME(cw(3,r7) >= old_cw);
  ASSUME(cw(3,r7) >= cr(3,r7));
  ASSUME(cw(3,r7) >= cl[3]);
  ASSUME(cw(3,r7) >= cisb[3]);
  ASSUME(cw(3,r7) >= cdy[3]);
  ASSUME(cw(3,r7) >= cdl[3]);
  ASSUME(cw(3,r7) >= cds[3]);
  ASSUME(cw(3,r7) >= cctrl[3]);
  ASSUME(cw(3,r7) >= caddr[3]);
  // Update
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !124, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !125, metadata !DIExpression()), !dbg !156

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !126, metadata !DIExpression()), !dbg !158

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !130, metadata !DIExpression()), !dbg !160

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !131, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !141, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !145, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i32 0, metadata !147, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !148, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !153, metadata !DIExpression()), !dbg !156

  //   %and = and i32 %7, %8, !dbg !111
  creg_r15 = max(creg_r13,creg_r14);
  r15 = r13 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !154, metadata !DIExpression()), !dbg !156

  //   %and16 = and i32 %6, %and, !dbg !112
  creg_r16 = max(creg_r12,creg_r15);
  r16 = r12 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !155, metadata !DIExpression()), !dbg !156
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
