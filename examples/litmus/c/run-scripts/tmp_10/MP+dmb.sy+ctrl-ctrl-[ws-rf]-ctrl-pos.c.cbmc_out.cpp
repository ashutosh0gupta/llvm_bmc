...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !69, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64 1, metadata !71, metadata !DIExpression()), !dbg !113

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !95
  // ST: Guess
...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !124

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !124

  //   %conv18 = trunc i64 %3 to i32, !dbg !107
  ...
  //   %cmp24 = icmp eq i32 %conv11, 2, !dbg !117
  ...
  //   store i32 %conv25, i32* @atom_1_X6_2, align 4, !dbg !118, !tbaa !113
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv18, 0, !dbg !119
  ...
  //   store i32 %conv27, i32* @atom_1_X7_0, align 4, !dbg !120, !tbaa !113
  // ST: Guess
  ...
  //   store i32 %conv29, i32* @atom_1_X9_0, align 4, !dbg !122, !tbaa !113
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !187, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !190, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !193, metadata !DIExpression()), !dbg !242
