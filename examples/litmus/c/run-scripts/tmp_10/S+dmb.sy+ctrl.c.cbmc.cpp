...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !54, metadata !DIExpression()), !dbg !65
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !58, metadata !DIExpression()), !dbg !68

  //   %conv = trunc i64 %0 to i32, !dbg !51

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !55, metadata !DIExpression()), !dbg !65
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !59, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64 1, metadata !61, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !62, metadata !DIExpression()), !dbg !65
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !93, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !94, metadata !DIExpression()), !dbg !117

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !63

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !63

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !95, metadata !DIExpression()), !dbg !119

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !99, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !100, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !106, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i32 0, metadata !109, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !113, metadata !DIExpression()), !dbg !136

  //   %conv = trunc i64 %4 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !110, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !114, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !116, metadata !DIExpression()), !dbg !117
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
