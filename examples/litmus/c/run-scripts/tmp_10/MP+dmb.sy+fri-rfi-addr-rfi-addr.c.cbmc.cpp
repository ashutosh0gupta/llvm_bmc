...
T2BLOCK1:
  ...
  //   %cmp22 = icmp eq i32 %conv10, 1, !dbg !100
  ...
  //   store i32 %conv23, i32* @atom_1_X7_1, align 4, !dbg !101, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !147, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !151, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !154, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !157, metadata !DIExpression()), !dbg !202
  ...
  //   %10 = load i32, i32* @atom_1_X9_0, align 4, !dbg !144, !tbaa !140
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 83, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154
