...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !67, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !102

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(2,r3);
  cr(2,r3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l33_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !71, metadata !DIExpression()), !dbg !102

  //   %conv4 = trunc i64 %1 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !104

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !104

  //   %conv8 = trunc i64 %2 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64 2, metadata !78, metadata !DIExpression()), !dbg !107

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 0, !dbg !103
  ...
  //   store i32 %conv23, i32* @atom_1_X3_0, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X5_1, align 4, !dbg !106, !tbaa !99
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv12, 2, !dbg !107
  ...
  //   store i32 %conv27, i32* @atom_1_X7_2, align 4, !dbg !108, !tbaa !99
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !134, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64 1, metadata !136, metadata !DIExpression()), !dbg !141
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !172, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !226

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !175, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !228

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_2, metadata !178, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !230

  //   store atomic i32 0, i32* @atom_1_X7_2 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X3_0, align 4, !dbg !157, !tbaa !155
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X5_1, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X7_2, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
  ...
  creg_r27 = max(creg__r17__2_,creg_r26);
  r27 = (r17==2) & r26;
