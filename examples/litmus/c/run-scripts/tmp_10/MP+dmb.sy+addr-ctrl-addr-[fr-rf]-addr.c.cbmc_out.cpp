...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv4, 0, !dbg !85
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !93), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !110

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !110

  //   %conv8 = trunc i64 %2 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !94

  //   %xor9 = xor i32 %conv8, %conv8, !dbg !94
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !74, metadata !DIExpression()), !dbg !94

  //   %add11 = add nsw i32 4, %xor9, !dbg !95
  creg_r7 = max(0,creg_r6);
  r7 = 4 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !95

  //   %arrayidx13 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !95
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !76, metadata !DIExpression()), !dbg !115

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,r8);
  cr(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l37_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !115

  //   %conv16 = trunc i64 %3 to i32, !dbg !97
  ...
  // LD: Guess
  old_cr = cr(2,0+4*1);
  cr(2,0+4*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l38_c17
  // Check
  ...
  //   %cmp30 = icmp eq i32 %conv16, 0, !dbg !111
  ...
  //   store i32 %conv31, i32* @atom_1_X8_0, align 4, !dbg !112, !tbaa !107
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv20, 1, !dbg !113
  ...
  //   store i32 %conv33, i32* @atom_1_X10_1, align 4, !dbg !114, !tbaa !107
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !140, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64 1, metadata !142, metadata !DIExpression()), !dbg !147

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !50
  // ST: Guess
  iw(3,0+4*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l54_c3
  old_cw = cw(3,0+4*1);
  cw(3,0+4*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l54_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !184, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !237

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !187, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !239

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !194, metadata !DIExpression()), !dbg !254

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,0+4*1);
  cr(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l81_c13
  // Check
  ...
  //   %7 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l83_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !204, metadata !DIExpression()), !dbg !262

  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l85_c13
  // Check
  ...
  //   %10 = load i32, i32* @atom_1_X8_0, align 4, !dbg !158, !tbaa !156
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %11 = load i32, i32* @atom_1_X10_1, align 4, !dbg !159, !tbaa !156
  // LD: Guess
  old_cr = cr(0,7);
