...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv4, 0, !dbg !97
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !105), !dbg !121

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !122

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   %add11 = add nsw i32 4, %xor9, !dbg !107
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 4 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !107

  //   %arrayidx13 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !107
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !76, metadata !DIExpression()), !dbg !127

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !107
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !127

  //   %conv16 = trunc i64 %3 to i32, !dbg !109
  ...
  //   %cmp31 = icmp eq i32 %conv16, 0, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !93, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv20, 1, !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !97, metadata !DIExpression()), !dbg !143

  //   %8 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !99, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %8, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !125
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !152, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64 1, metadata !154, metadata !DIExpression()), !dbg !159

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !49
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !195, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !198, metadata !DIExpression()), !dbg !262

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !262

  //   store atomic i64 0, i64* @atom_1_X10_1 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !205, metadata !DIExpression()), !dbg !279

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) seq_cst, align 8, !dbg !155
  // LD: Guess
  old_cr = cr(0,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !210, metadata !DIExpression()), !dbg !283

  //   %7 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !159
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !163
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !224, metadata !DIExpression()), !dbg !294

  //   %10 = load atomic i64, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !170
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !228, metadata !DIExpression()), !dbg !297

  //   %11 = load atomic i64, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !173
  // LD: Guess
  old_cr = cr(0,7);
