...
T2BLOCK1:
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !84
  r4 = 0+r3*1;
  creg_r4 = creg_r3;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !74, metadata !DIExpression()), !dbg !104
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !90), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !77, metadata !DIExpression()), !dbg !91
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !81, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !85, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !86, metadata !DIExpression()), !dbg !91
  ...
  //   %cmp20 = icmp eq i32 %conv12, 0, !dbg !108
  creg__r6__0_ = max(0,creg_r6);

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv21, i32* @atom_1_X7_0, align 4, !dbg !109, !tbaa !102
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv16, 1, !dbg !110
  creg__r7__1_ = max(0,creg_r7);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !88, metadata !DIExpression()), !dbg !91

  //   store i32 %conv23, i32* @atom_1_X9_1, align 4, !dbg !111, !tbaa !102
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !135, metadata !DIExpression()), !dbg !142
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !152, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !153, metadata !DIExpression()), !dbg !201

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !154, metadata !DIExpression()), !dbg !203

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !158, metadata !DIExpression()), !dbg !205

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !159, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !160, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !165, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !166, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !169, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !173, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i32 0, metadata !175, metadata !DIExpression()), !dbg !216

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !176, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i32 0, metadata !178, metadata !DIExpression()), !dbg !218

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !179, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !220

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !183, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !185, metadata !DIExpression()), !dbg !233

  //   %conv = trunc i64 %6 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !182, metadata !DIExpression()), !dbg !201

  //   %cmp = icmp eq i32 %conv, 2, !dbg !130
  creg__r12__2_ = max(0,creg_r12);

  //   %conv18 = zext i1 %cmp to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !186, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !188, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !190, metadata !DIExpression()), !dbg !237

  //   %conv22 = trunc i64 %7 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !187, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !191, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !192, metadata !DIExpression()), !dbg !201

  //   %9 = load i32, i32* @atom_1_X3_2, align 4, !dbg !138, !tbaa !136
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !193, metadata !DIExpression()), !dbg !201

  //   %10 = load i32, i32* @atom_1_X7_0, align 4, !dbg !139, !tbaa !136
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !194, metadata !DIExpression()), !dbg !201

  //   %11 = load i32, i32* @atom_1_X9_1, align 4, !dbg !140, !tbaa !136
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !195, metadata !DIExpression()), !dbg !201
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
