...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !91
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !84), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !68, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !71, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !72, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !76, metadata !DIExpression()), !dbg !108

  //   %4 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !78, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %4, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !90
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 0, !dbg !91

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !79, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !80, metadata !DIExpression()), !dbg !111

  //   %5 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !82, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %5, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !134, metadata !DIExpression()), !dbg !178
