...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !50
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !41, metadata !DIExpression()), !dbg !50

  //   %conv = trunc i64 %0 to i32, !dbg !52

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !37, metadata !DIExpression()), !dbg !47
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !54

  //   call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !54

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !55
  // ST: Guess
  //   : Release
  ...
  //   store i32 %conv1, i32* @atom_0_X0_1, align 4, !dbg !57, !tbaa !58
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !65, metadata !DIExpression()), !dbg !77
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !67, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !66, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !71, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !85

  //   %conv1 = sext i32 %add to i64, !dbg !58

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !74, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !75, metadata !DIExpression()), !dbg !77
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !97, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !98, metadata !DIExpression()), !dbg !120

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !99, metadata !DIExpression()), !dbg !122

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !103, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !104, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !110, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i32 0, metadata !113, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !114, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i32 0, metadata !116, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !117, metadata !DIExpression()), !dbg !120

  //   %5 = load i32, i32* @atom_1_X0_1, align 4, !dbg !89, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l55_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !118, metadata !DIExpression()), !dbg !120
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 57, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
