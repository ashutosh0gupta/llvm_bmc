...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !41, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64 1, metadata !43, metadata !DIExpression()), !dbg !63

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !64
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !47, metadata !DIExpression()), !dbg !65
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !57), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !48, metadata !DIExpression()), !dbg !74

  //   call void @llvm.dbg.value(metadata i64 1, metadata !50, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !52, metadata !DIExpression()), !dbg !76
  ...
  //   %conv8 = trunc i64 %1 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !51, metadata !DIExpression()), !dbg !58

  //   %cmp = icmp eq i32 %conv8, 2, !dbg !79
  ...
  //   store i32 %conv9, i32* @atom_0_X8_2, align 4, !dbg !80, !tbaa !81
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !93, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !95, metadata !DIExpression()), !dbg !103
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !116, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !117, metadata !DIExpression()), !dbg !163

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !118, metadata !DIExpression()), !dbg !165

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !122, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !123, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64 0, metadata !125, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !126, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !129, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !132, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X8_2, metadata !135, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !139, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !143, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !160, metadata !DIExpression()), !dbg !163

  //   %and28 = and i32 %conv20, %and27, !dbg !132
  creg_r13 = max(creg__r7__1_,creg_r12);
  r13 = (r7==1) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !161, metadata !DIExpression()), !dbg !163

  //   %and29 = and i32 %conv14, %and28, !dbg !133
  creg_r14 = max(creg__r6__2_,creg_r13);
  r14 = (r6==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !162, metadata !DIExpression()), !dbg !163
