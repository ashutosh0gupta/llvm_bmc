...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !161, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !201

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X8_1, align 4, !dbg !133, !tbaa !130
  // LD: Guess
  old_cr = cr(0,5);
