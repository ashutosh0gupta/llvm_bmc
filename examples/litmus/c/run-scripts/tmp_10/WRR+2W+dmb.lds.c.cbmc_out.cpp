...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !97
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !107, metadata !DIExpression()), !dbg !137

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !108, metadata !DIExpression()), !dbg !137

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !109, metadata !DIExpression()), !dbg !139

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !113, metadata !DIExpression()), !dbg !141

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !114, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !115, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !118, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !121, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i32 0, metadata !124, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !125, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i32 0, metadata !127, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !131, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !132, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !136, metadata !DIExpression()), !dbg !137
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
