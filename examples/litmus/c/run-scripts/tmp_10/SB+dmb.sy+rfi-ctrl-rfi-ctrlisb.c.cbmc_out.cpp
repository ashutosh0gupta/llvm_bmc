...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !87, metadata !DIExpression()), !dbg !129
  ...
  //   %conv14 = zext i1 %cmp to i32, !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !91, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv6, 1, !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !93, metadata !DIExpression()), !dbg !136

  //   %4 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !95, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %4, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !109
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv13, 0, !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !97, metadata !DIExpression()), !dbg !139

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !99, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %5, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !193, metadata !DIExpression()), !dbg !255
