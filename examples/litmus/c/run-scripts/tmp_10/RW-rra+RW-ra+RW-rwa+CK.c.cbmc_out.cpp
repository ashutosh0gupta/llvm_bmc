...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !119, metadata !DIExpression()), !dbg !131
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !171, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i32 0, metadata !173, metadata !DIExpression()), !dbg !205

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_0_X0_1, align 4, !dbg !130, !tbaa !127
  // LD: Guess
  old_cr = cr(0,4);
