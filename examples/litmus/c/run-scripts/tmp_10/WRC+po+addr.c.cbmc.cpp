...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !121, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !128, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i32 0, metadata !131, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !132, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X3_0, metadata !135, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !142, metadata !DIExpression()), !dbg !143
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([96 x i8], [96 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
