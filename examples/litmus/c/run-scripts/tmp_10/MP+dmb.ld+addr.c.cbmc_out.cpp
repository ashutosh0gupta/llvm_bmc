...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !71, metadata !DIExpression()), !dbg !89
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !112, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !115, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64 0, metadata !117, metadata !DIExpression()), !dbg !138

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !119, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !123, metadata !DIExpression()), !dbg !153

  //   %5 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(0,3);
