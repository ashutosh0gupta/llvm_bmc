...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !48, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !79

  //   %conv3 = sext i32 %add to i64, !dbg !80

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !51, metadata !DIExpression()), !dbg !79

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !52, metadata !DIExpression()), !dbg !69

  //   %xor8 = xor i32 %conv7, %conv7, !dbg !84
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 1);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor8, metadata !56, metadata !DIExpression()), !dbg !69

  //   %add10 = add nsw i32 2, %xor8, !dbg !85
  creg_r5 = max(0,creg_r4);
  ASSUME(active[creg_r5] == 1);
  r5 = 2 + r4;

  //   %idxprom = sext i32 %add10 to i64, !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !57, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !65, metadata !DIExpression()), !dbg !91

  //   %3 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !67, metadata !DIExpression()), !dbg !91

  //   store atomic i64 %3, i64* @atom_0_X5_1 seq_cst, align 8, !dbg !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !148, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !174, metadata !DIExpression()), !dbg !228
