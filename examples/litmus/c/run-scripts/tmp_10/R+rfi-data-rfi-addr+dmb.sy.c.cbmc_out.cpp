...
T1BLOCK1:
  ...
  //   %xor8 = xor i32 %conv7, %conv7, !dbg !78
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor8, metadata !56, metadata !DIExpression()), !dbg !63

  //   %add10 = add nsw i32 2, %xor8, !dbg !79
  creg_r5 = max(0,creg_r4);
  r5 = 2 + r4;

  //   %idxprom = sext i32 %add10 to i64, !dbg !79

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !79
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !57, metadata !DIExpression()), !dbg !80
  ...
  //   store i32 %conv14, i32* @atom_0_X5_1, align 4, !dbg !88, !tbaa !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !137, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_1, metadata !141, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !144, metadata !DIExpression()), !dbg !185
