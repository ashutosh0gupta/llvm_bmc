...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !82), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !67, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !71, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !104

  //   %conv11 = sext i32 %add10 to i64, !dbg !86

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !74, metadata !DIExpression()), !dbg !104

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv15 = trunc i64 %3 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !75, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !79, metadata !DIExpression()), !dbg !83

  //   store i32 %conv16, i32* @atom_1_X0_1, align 4, !dbg !91, !tbaa !92
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv15, 1, !dbg !96
  creg__r8__1_ = max(0,creg_r8);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !80, metadata !DIExpression()), !dbg !83

  //   store i32 %conv18, i32* @atom_1_X9_1, align 4, !dbg !97, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !148, metadata !DIExpression()), !dbg !181
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
