...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !49, metadata !DIExpression()), !dbg !58

  //   call void @llvm.dbg.value(metadata i64 1, metadata !51, metadata !DIExpression()), !dbg !58

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !59
  // ST: Guess
  //   : Release
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !63, metadata !DIExpression()), !dbg !73
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !67, metadata !DIExpression()), !dbg !76

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !64, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !79

  //   call void @llvm.dbg.value(metadata i64 1, metadata !70, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !71, metadata !DIExpression()), !dbg !73

  //   store i32 %conv1, i32* @atom_1_X0_1, align 4, !dbg !64, !tbaa !65
  // ST: Guess
  iw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l34_c15
  old_cw = cw(2,6);
  cw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l34_c15
  // Check
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !92, metadata !DIExpression()), !dbg !103

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !59
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  cr(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l40_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !95, metadata !DIExpression()), !dbg !106
  ...
  // ST: Guess
  //   : Release
  iw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l41_c3
  old_cw = cw(3,0+3*1);
  cw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l41_c3
  // Check
  ...
  // ST: Guess
  iw(3,7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l43_c15
  old_cw = cw(3,7);
  cw(3,7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l43_c15
  // Check
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !113, metadata !DIExpression()), !dbg !123
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !115, metadata !DIExpression()), !dbg !126

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3) acquire, align 8, !dbg !59
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+3*1);
  cr(4,0+3*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l49_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !117, metadata !DIExpression()), !dbg !126

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !114, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !118, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i64 1, metadata !120, metadata !DIExpression()), !dbg !129

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4) release, align 8, !dbg !62
  // ST: Guess
  //   : Release
  iw(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l50_c3
  old_cw = cw(4,0+4*1);
  cw(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l50_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !121, metadata !DIExpression()), !dbg !123

  //   store i32 %conv1, i32* @atom_3_X0_1, align 4, !dbg !64, !tbaa !65
  // ST: Guess
  iw(4,8) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l52_c15
  old_cw = cw(4,8);
  cw(4,8) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l52_c15
  // Check
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !136, metadata !DIExpression()), !dbg !146
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !138, metadata !DIExpression()), !dbg !149

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4) acquire, align 8, !dbg !59
  // LD: Guess
  //   : Acquire
  old_cr = cr(5,0+4*1);
  cr(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l58_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !137, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !141, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64 1, metadata !143, metadata !DIExpression()), !dbg !152

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !62
  // ST: Guess
  iw(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l59_c3
  old_cw = cw(5,0+5*1);
  cw(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l59_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !144, metadata !DIExpression()), !dbg !146

  //   store i32 %conv1, i32* @atom_4_X0_1, align 4, !dbg !64, !tbaa !65
  // ST: Guess
  iw(5,9) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l61_c15
  old_cw = cw(5,9);
  cw(5,9) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l61_c15
  // Check
  ASSUME(active[iw(5,9)] == 5);
  ASSUME(active[cw(5,9)] == 5);
  ASSUME(sforbid(9,cw(5,9))== 0);
  ASSUME(iw(5,9) >= creg__r3__1_);
  ASSUME(iw(5,9) >= 0);
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !159, metadata !DIExpression()), !dbg !171
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !161, metadata !DIExpression()), !dbg !174

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(6,0+5*1);
  cr(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN LDCOM _l67_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !163, metadata !DIExpression()), !dbg !174

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !160, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !165, metadata !DIExpression()), !dbg !178

  //   %1 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(6,0+1*1);
  cr(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN LDCOM _l69_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !167, metadata !DIExpression()), !dbg !178

  //   %conv4 = trunc i64 %1 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !164, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !168, metadata !DIExpression()), !dbg !171

  //   store i32 %conv5, i32* @atom_5_X0_1, align 4, !dbg !68, !tbaa !69
  // ST: Guess
  iw(6,10) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l71_c15
  old_cw = cw(6,10);
  cw(6,10) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l71_c15
  // Check
  ASSUME(active[iw(6,10)] == 6);
  ASSUME(active[cw(6,10)] == 6);
  ASSUME(sforbid(10,cw(6,10))== 0);
  ASSUME(iw(6,10) >= creg__r4__1_);
  ASSUME(iw(6,10) >= 0);
  ASSUME(cw(6,10) >= iw(6,10));
  ASSUME(cw(6,10) >= old_cw);
  ASSUME(cw(6,10) >= cr(6,10));
  ASSUME(cw(6,10) >= cl[6]);
  ASSUME(cw(6,10) >= cisb[6]);
  ASSUME(cw(6,10) >= cdy[6]);
  ASSUME(cw(6,10) >= cdl[6]);
  ASSUME(cw(6,10) >= cds[6]);
  ASSUME(cw(6,10) >= cctrl[6]);
  ASSUME(cw(6,10) >= caddr[6]);
  // Update
  caddr[6] = max(caddr[6],0);
  buff(6,10) = (r4==1);
  mem(10,cw(6,10)) = (r4==1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !169, metadata !DIExpression()), !dbg !171

  //   store i32 %conv7, i32* @atom_5_X2_0, align 4, !dbg !74, !tbaa !69
  // ST: Guess
  iw(6,11) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l73_c15
  old_cw = cw(6,11);
  cw(6,11) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l73_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !193, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !194, metadata !DIExpression()), !dbg !252

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !195, metadata !DIExpression()), !dbg !254

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !199, metadata !DIExpression()), !dbg !256

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !200, metadata !DIExpression()), !dbg !258

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !201, metadata !DIExpression()), !dbg !260

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !202, metadata !DIExpression()), !dbg !262

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !203, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !204, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !265

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !121
  // ST: Guess
  iw(0,0+5*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l85_c3
  old_cw = cw(0,0+5*1);
  cw(0,0+5*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l85_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !207, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !267

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !123
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l86_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l86_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !210, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !269

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !125
  // ST: Guess
  iw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l87_c3
  old_cw = cw(0,0+3*1);
  cw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l87_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !213, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !271

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !127
  // ST: Guess
  iw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l88_c3
  old_cw = cw(0,0+2*1);
  cw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l88_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !216, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !218, metadata !DIExpression()), !dbg !273

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !129
  // ST: Guess
  iw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l89_c3
  old_cw = cw(0,0+1*1);
  cw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l89_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !219, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !221, metadata !DIExpression()), !dbg !275

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !131
  // ST: Guess
  iw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l90_c3
  old_cw = cw(0,0);
  cw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l90_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X0_1, metadata !222, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i32 0, metadata !225, metadata !DIExpression()), !dbg !277

  //   store atomic i32 0, i32* @atom_5_X0_1 monotonic, align 4, !dbg !133
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l91_c3
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l91_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X2_0, metadata !226, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i32 0, metadata !228, metadata !DIExpression()), !dbg !279

  //   store atomic i32 0, i32* @atom_5_X2_0 monotonic, align 4, !dbg !135
  // ST: Guess
  iw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l92_c3
  old_cw = cw(0,11);
  cw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l92_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !229, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i32 0, metadata !231, metadata !DIExpression()), !dbg !281

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !137
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l93_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l93_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !232, metadata !DIExpression()), !dbg !283

  //   call void @llvm.dbg.value(metadata i32 0, metadata !234, metadata !DIExpression()), !dbg !283

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !139
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l94_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l94_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !235, metadata !DIExpression()), !dbg !285

  //   call void @llvm.dbg.value(metadata i32 0, metadata !237, metadata !DIExpression()), !dbg !285

  //   store atomic i32 0, i32* @atom_3_X0_1 monotonic, align 4, !dbg !141
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l95_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l95_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X0_1, metadata !238, metadata !DIExpression()), !dbg !287

  //   call void @llvm.dbg.value(metadata i32 0, metadata !240, metadata !DIExpression()), !dbg !287
  ...
  //   %call23 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !145
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call24 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !146
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call25 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !147
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call26 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #7, !dbg !148
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call27 = call i32 @pthread_create(i64* noundef %thr5, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t5, i8* noundef null) #7, !dbg !149
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %12 = load i32, i32* @atom_5_X0_1, align 4, !dbg !166, !tbaa !167
  // LD: Guess
  old_cr = cr(0,10);
  cr(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l112_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !241, metadata !DIExpression()), !dbg !252

  //   %13 = load i32, i32* @atom_5_X2_0, align 4, !dbg !169, !tbaa !167
  // LD: Guess
  old_cr = cr(0,11);
  cr(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l113_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !242, metadata !DIExpression()), !dbg !252

  //   %14 = load i32, i32* @atom_1_X0_1, align 4, !dbg !170, !tbaa !167
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l114_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !243, metadata !DIExpression()), !dbg !252

  //   %15 = load i32, i32* @atom_2_X0_1, align 4, !dbg !171, !tbaa !167
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l115_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !244, metadata !DIExpression()), !dbg !252

  //   %16 = load i32, i32* @atom_3_X0_1, align 4, !dbg !172, !tbaa !167
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l116_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !245, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !246, metadata !DIExpression()), !dbg !252

  //   %and = and i32 %16, %17, !dbg !174
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !247, metadata !DIExpression()), !dbg !252

  //   %and34 = and i32 %15, %and, !dbg !175
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !248, metadata !DIExpression()), !dbg !252

  //   %and35 = and i32 %14, %and34, !dbg !176
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !249, metadata !DIExpression()), !dbg !252

  //   %and36 = and i32 %13, %and35, !dbg !177
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !250, metadata !DIExpression()), !dbg !252

  //   %and37 = and i32 %12, %and36, !dbg !178
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !251, metadata !DIExpression()), !dbg !252
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 123, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %20) #7, !dbg !185

  //   %21 = bitcast i64* %thr2 to i8*, !dbg !185

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %21) #7, !dbg !185

  //   %22 = bitcast i64* %thr1 to i8*, !dbg !185

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %22) #7, !dbg !185

  //   %23 = bitcast i64* %thr0 to i8*, !dbg !185

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %23) #7, !dbg !185
