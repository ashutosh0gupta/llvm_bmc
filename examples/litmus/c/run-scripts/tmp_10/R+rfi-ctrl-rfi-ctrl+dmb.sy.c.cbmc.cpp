...
T1BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !54, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64 1, metadata !56, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !57, metadata !DIExpression()), !dbg !62

  //   store i32 %conv12, i32* @atom_0_X2_1, align 4, !dbg !90, !tbaa !91
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv6, 1, !dbg !95
  ...
  //   store i32 %conv14, i32* @atom_0_X5_1, align 4, !dbg !96, !tbaa !91
  // ST: Guess
...
T2BLOCK1:
  ...
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l41_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !145, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_1, metadata !149, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !152, metadata !DIExpression()), !dbg !193
