...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !41, metadata !DIExpression()), !dbg !66

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !67
  // ST: Guess
  //   : Release
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !69
  // ST: Guess
  iw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0);
  cw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !51, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !55, metadata !DIExpression()), !dbg !77

  //   %2 = zext i32 %conv7 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !57, metadata !DIExpression()), !dbg !77

  //   store atomic i64 %2, i64* @atom_0_X4_2 seq_cst, align 8, !dbg !78
  // ST: Guess
...
T2BLOCK1:
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !47
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !99, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64 0, metadata !101, metadata !DIExpression()), !dbg !114

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !56
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !103, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !107, metadata !DIExpression()), !dbg !121

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !109, metadata !DIExpression()), !dbg !121

  //   store atomic i64 %1, i64* @atom_2_X3_0 seq_cst, align 8, !dbg !63
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !131, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !132, metadata !DIExpression()), !dbg !180

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !133, metadata !DIExpression()), !dbg !182

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !137, metadata !DIExpression()), !dbg !184

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !138, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !139, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !189
  ...
  //   store atomic i64 0, i64* @atom_0_X4_2 monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !148, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !193

  //   store atomic i64 0, i64* @atom_0_X5_1 monotonic, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !151, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64 0, metadata !153, metadata !DIExpression()), !dbg !195

  //   store atomic i64 0, i64* @atom_2_X3_0 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !157, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !160, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !162, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !165, metadata !DIExpression()), !dbg !218

  //   %8 = load atomic i64, i64* @atom_0_X4_2 seq_cst, align 8, !dbg !130
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !167, metadata !DIExpression()), !dbg !218

  //   %conv24 = trunc i64 %8 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !164, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !169, metadata !DIExpression()), !dbg !221

  //   %9 = load atomic i64, i64* @atom_0_X5_1 seq_cst, align 8, !dbg !133
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !171, metadata !DIExpression()), !dbg !221

  //   %conv28 = trunc i64 %9 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !168, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !173, metadata !DIExpression()), !dbg !224

  //   %10 = load atomic i64, i64* @atom_2_X3_0 seq_cst, align 8, !dbg !136
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !175, metadata !DIExpression()), !dbg !224
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !145
