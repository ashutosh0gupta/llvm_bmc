...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !45, metadata !DIExpression()), !dbg !60
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64 3, metadata !72, metadata !DIExpression()), !dbg !95

  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !64
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !74, metadata !DIExpression()), !dbg !97
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !146, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !178

  //   store atomic i64 0, i64* @atom_0_X3_3 monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !149, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64 0, metadata !151, metadata !DIExpression()), !dbg !180

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !91
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !93
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !99
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !100, !tbaa !95
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %call11 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !101
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   %conv = trunc i64 %4 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !152, metadata !DIExpression()), !dbg !167

  //   %cmp = icmp eq i32 %conv, 3, !dbg !105

  //   %conv12 = zext i1 %cmp to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !156, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !158, metadata !DIExpression()), !dbg !196

  //   %5 = load atomic i64, i64* @atom_0_X3_3 seq_cst, align 8, !dbg !107
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %conv16 = trunc i64 %5 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !157, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !162, metadata !DIExpression()), !dbg !199

  //   %6 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !164, metadata !DIExpression()), !dbg !199

  //   %conv20 = trunc i64 %6 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !161, metadata !DIExpression()), !dbg !167

  //   %and = and i32 %conv16, %conv20, !dbg !112
  creg_r10 = max(creg_r8,creg_r9);
  ASSUME(active[creg_r10] == 0);
  r10 = r8 & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !165, metadata !DIExpression()), !dbg !167

  //   %and21 = and i32 %conv12, %and, !dbg !113
  creg_r11 = max(max(creg_r7,0),creg_r10);
  ASSUME(active[creg_r11] == 0);
  r11 = (r7==3) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !166, metadata !DIExpression()), !dbg !167

  //   %cmp22 = icmp eq i32 %and21, 1, !dbg !114

  //   br i1 %cmp22, label %if.then, label %if.end, !dbg !116
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !117

  //   unreachable, !dbg !117
  r12 = 1;

T0BLOCK2:
  //   %7 = bitcast i64* %thr1 to i8*, !dbg !120

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %7) #7, !dbg !120

  //   %8 = bitcast i64* %thr0 to i8*, !dbg !120
