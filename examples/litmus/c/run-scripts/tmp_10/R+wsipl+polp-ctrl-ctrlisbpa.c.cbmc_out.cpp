...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64 3, metadata !72, metadata !DIExpression()), !dbg !92

  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !61
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !74, metadata !DIExpression()), !dbg !94
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !77, metadata !DIExpression()), !dbg !89

  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !74
  creg__r2__0_ = max(0,creg_r2);

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !76
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !82
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !84, metadata !DIExpression()), !dbg !113

  //   %conv11 = trunc i64 %2 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !81, metadata !DIExpression()), !dbg !89

  //   %cmp = icmp eq i32 %conv11, 0, !dbg !84
  ...
  //   store i32 %conv12, i32* @atom_1_X6_0, align 4, !dbg !85, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !133, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !136, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !139, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64 0, metadata !141, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_3, metadata !142, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i32 0, metadata !145, metadata !DIExpression()), !dbg !169

  //   store atomic i32 0, i32* @atom_0_X3_3 monotonic, align 4, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !146, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !171

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !86
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !88
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !94
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !95, !tbaa !90
  r6 = local_mem[1];
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !150, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !152, metadata !DIExpression()), !dbg !181

  //   %conv = trunc i64 %4 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !149, metadata !DIExpression()), !dbg !158

  //   %cmp = icmp eq i32 %conv, 3, !dbg !100
  creg__r7__3_ = max(0,creg_r7);

  //   %conv12 = zext i1 %cmp to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !153, metadata !DIExpression()), !dbg !158

  //   %5 = load i32, i32* @atom_0_X3_3, align 4, !dbg !101, !tbaa !102
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %6 = load i32, i32* @atom_1_X6_0, align 4, !dbg !104, !tbaa !102
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !155, metadata !DIExpression()), !dbg !158

  //   %and = and i32 %5, %6, !dbg !105
  creg_r10 = max(creg_r8,creg_r9);
  r10 = r8 & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !156, metadata !DIExpression()), !dbg !158

  //   %and13 = and i32 %conv12, %and, !dbg !106
  creg_r11 = max(creg__r7__3_,creg_r10);
  r11 = (r7==3) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !157, metadata !DIExpression()), !dbg !158

  //   %cmp14 = icmp eq i32 %and13, 1, !dbg !107
  creg__r11__1_ = max(0,creg_r11);

  //   br i1 %cmp14, label %if.then, label %if.end, !dbg !109
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !110
