...
T2BLOCK1:
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !100
  creg_r2 = max(creg_r1,creg_r1);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !71, metadata !DIExpression()), !dbg !110

  //   %add = add nsw i32 %xor, 1, !dbg !101
  creg_r3 = max(creg_r2,0);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !72, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !121

  //   %conv5 = sext i32 %add to i64, !dbg !103

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !75, metadata !DIExpression()), !dbg !121

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !123

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   %conv9 = trunc i64 %2 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !76, metadata !DIExpression()), !dbg !110

  //   %xor10 = xor i32 %conv9, %conv9, !dbg !107
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor10, metadata !80, metadata !DIExpression()), !dbg !110

  //   %add12 = add nsw i32 0, %xor10, !dbg !108
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add12 to i64, !dbg !108

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !108
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !82, metadata !DIExpression()), !dbg !128

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   %conv15 = trunc i64 %3 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !81, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !130

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !88, metadata !DIExpression()), !dbg !130

  //   %conv19 = trunc i64 %4 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !85, metadata !DIExpression()), !dbg !110

  //   %cmp = icmp eq i32 %conv, 1, !dbg !114

  //   %conv20 = zext i1 %cmp to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !89, metadata !DIExpression()), !dbg !110
  ...
  //   %cmp24 = icmp eq i32 %conv4, 1, !dbg !117

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !93, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !94, metadata !DIExpression()), !dbg !137

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !96, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %6, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !119
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv9, 1, !dbg !120

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !97, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !98, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv15, 0, !dbg !123

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !101, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !102, metadata !DIExpression()), !dbg !143

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !104, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %8, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv19, 0, !dbg !126

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !105, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !106, metadata !DIExpression()), !dbg !146

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !108, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !128
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !156, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !157, metadata !DIExpression()), !dbg !229

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !158, metadata !DIExpression()), !dbg !231

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !162, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !163, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !165, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !166, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !169, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !172, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !175, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !178, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !181, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !246

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !137
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !184, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !248

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !139
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !188, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !190, metadata !DIExpression()), !dbg !260

  //   %conv = trunc i64 %4 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !187, metadata !DIExpression()), !dbg !229

  //   %cmp = icmp eq i32 %conv, 1, !dbg !153

  //   %conv18 = zext i1 %cmp to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !191, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !193, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !195, metadata !DIExpression()), !dbg !264

  //   %conv22 = trunc i64 %5 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !192, metadata !DIExpression()), !dbg !229

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !157

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !196, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !198, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !200, metadata !DIExpression()), !dbg !268

  //   %conv28 = trunc i64 %6 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !197, metadata !DIExpression()), !dbg !229

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !161

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !201, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !203, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !205, metadata !DIExpression()), !dbg !272

  //   %conv34 = trunc i64 %7 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !202, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !207, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !209, metadata !DIExpression()), !dbg !275

  //   %conv38 = trunc i64 %8 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !206, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !211, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !213, metadata !DIExpression()), !dbg !278

  //   %conv42 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !210, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !215, metadata !DIExpression()), !dbg !281

  //   %10 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !172
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !217, metadata !DIExpression()), !dbg !281

  //   %conv46 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !214, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !219, metadata !DIExpression()), !dbg !284

  //   %11 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !175
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !221, metadata !DIExpression()), !dbg !284

  //   %conv50 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !218, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !223, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !224, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !225, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !226, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !227, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !228, metadata !DIExpression()), !dbg !229
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187
