...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64 1, metadata !80, metadata !DIExpression()), !dbg !134

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv11, 0, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !90, metadata !DIExpression()), !dbg !142
  ...
  //   %cmp29 = icmp eq i32 %conv15, 1, !dbg !125
