...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !91), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !70, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !69, metadata !DIExpression()), !dbg !92
  ...
  //   %cmp21 = icmp eq i32 %conv11, 0, !dbg !113
  ...
  //   store i32 %conv22, i32* @atom_1_X4_0, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv15, 1, !dbg !115
  ...
  //   store i32 %conv24, i32* @atom_1_X6_1, align 4, !dbg !116, !tbaa !109
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !142, metadata !DIExpression()), !dbg !149
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !183, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !234

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !186, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i32 0, metadata !188, metadata !DIExpression()), !dbg !236

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !193, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !198, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !203, metadata !DIExpression()), !dbg !259
  ...
  //   %10 = load i32, i32* @atom_1_X4_0, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X6_1, align 4, !dbg !154, !tbaa !151
  // LD: Guess
  old_cr = cr(0,6);
