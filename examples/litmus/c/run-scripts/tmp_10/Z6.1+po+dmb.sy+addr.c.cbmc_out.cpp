...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !77, metadata !DIExpression()), !dbg !83

  //   %add = add nsw i32 0, %xor, !dbg !53
  creg_r2 = max(0,creg_r1);
  r2 = 0 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !53

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !53
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64 1, metadata !80, metadata !DIExpression()), !dbg !91

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !53
  // ST: Guess
  iw(3,r3) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l36_c3
  old_cw = cw(3,r3);
  cw(3,r3) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l36_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !106, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !107, metadata !DIExpression()), !dbg !140

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !108, metadata !DIExpression()), !dbg !142

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !112, metadata !DIExpression()), !dbg !144

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !113, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !123, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !128, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !130, metadata !DIExpression()), !dbg !166

  //   %conv = trunc i64 %6 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !127, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !131, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !133, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !135, metadata !DIExpression()), !dbg !170

  //   %conv16 = trunc i64 %7 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !132, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !136, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !139, metadata !DIExpression()), !dbg !140
