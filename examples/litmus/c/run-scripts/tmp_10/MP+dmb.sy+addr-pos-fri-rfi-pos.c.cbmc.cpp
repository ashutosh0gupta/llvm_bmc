...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !67, metadata !DIExpression()), !dbg !93

  //   %add = add nsw i32 0, %xor, !dbg !81
  creg_r2 = max(0,creg_r1);
  r2 = 0 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !81

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !81
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !103

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l34_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !106

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !108
  ...
  //   %cmp18 = icmp eq i32 %conv4, 0, !dbg !101
  ...
  //   store i32 %conv19, i32* @atom_1_X3_0, align 4, !dbg !102, !tbaa !97
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv8, 0, !dbg !103
  ...
  //   store i32 %conv21, i32* @atom_1_X5_0, align 4, !dbg !104, !tbaa !97
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv12, 1, !dbg !105
  ...
  //   store i32 %conv23, i32* @atom_1_X7_1, align 4, !dbg !106, !tbaa !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !153, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !197

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !156, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !199

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !159, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !201

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !162, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i32 0, metadata !164, metadata !DIExpression()), !dbg !203

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   %cmp = icmp eq i32 %conv, 2, !dbg !128
  ...
  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !132
  ...
  //   %7 = load i32, i32* @atom_1_X3_0, align 4, !dbg !136, !tbaa !134
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X5_0, align 4, !dbg !137, !tbaa !134
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X7_1, align 4, !dbg !138, !tbaa !134
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X8_1, align 4, !dbg !139, !tbaa !134
  // LD: Guess
  old_cr = cr(0,6);
