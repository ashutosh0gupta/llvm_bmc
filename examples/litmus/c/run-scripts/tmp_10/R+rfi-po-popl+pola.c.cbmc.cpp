...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !71
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !62, metadata !DIExpression()), !dbg !85

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !64, metadata !DIExpression()), !dbg !85

  //   store atomic i64 %3, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !86
  // ST: Guess
