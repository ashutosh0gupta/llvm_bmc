...
T2BLOCK7:
  ...
  //   store i32 %conv16, i32* @atom_1_X2_2, align 4, !dbg !100, !tbaa !101
  // ST: Guess
  ...
  //   store i32 %conv18, i32* @atom_1_X3_0, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   store i32 %conv22, i32* @atom_1_X6_0, align 4, !dbg !110, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !168, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !172, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !178, metadata !DIExpression()), !dbg !225
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 95, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
