...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !82

  //   call void @llvm.dbg.value(metadata i64 1, metadata !72, metadata !DIExpression()), !dbg !82
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !94, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !95, metadata !DIExpression()), !dbg !117

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !96, metadata !DIExpression()), !dbg !119

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !100, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !101, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !104, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !107, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i32 0, metadata !110, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !111, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i32 0, metadata !113, metadata !DIExpression()), !dbg !128
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 56, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !94
