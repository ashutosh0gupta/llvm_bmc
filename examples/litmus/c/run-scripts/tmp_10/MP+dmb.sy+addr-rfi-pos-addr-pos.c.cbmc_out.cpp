...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !158, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !210

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X5_1, align 4, !dbg !151, !tbaa !149
  // LD: Guess
  old_cr = cr(0,4);
