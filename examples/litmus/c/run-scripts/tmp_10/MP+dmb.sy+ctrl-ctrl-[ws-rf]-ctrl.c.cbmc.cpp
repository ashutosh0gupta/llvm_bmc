...
T2BLOCK10:
  ...
  //   %conv18 = trunc i64 %3 to i32, !dbg !100
  ...
  //   %conv19 = zext i1 %cmp to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !85

  //   store i32 %conv19, i32* @atom_1_X0_1, align 4, !dbg !102, !tbaa !103
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv11, 2, !dbg !107
  ...
  //   store i32 %conv21, i32* @atom_1_X6_2, align 4, !dbg !108, !tbaa !103
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv18, 0, !dbg !109
  ...
  //   store i32 %conv23, i32* @atom_1_X7_0, align 4, !dbg !110, !tbaa !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !175, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !178, metadata !DIExpression()), !dbg !223
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154
