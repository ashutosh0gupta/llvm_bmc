...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !45, metadata !DIExpression()), !dbg !57
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !47, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !46, metadata !DIExpression()), !dbg !57

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !69
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !50, metadata !DIExpression()), !dbg !57

  //   %add6 = add nsw i32 %xor5, 1, !dbg !70
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !51, metadata !DIExpression()), !dbg !57

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !52, metadata !DIExpression()), !dbg !71

  //   %conv9 = sext i32 %add6 to i64, !dbg !72

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !54, metadata !DIExpression()), !dbg !71

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !72
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !55, metadata !DIExpression()), !dbg !57

  //   store i32 %conv10, i32* @atom_0_X2_1, align 4, !dbg !74, !tbaa !75
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !127, metadata !DIExpression()), !dbg !160
