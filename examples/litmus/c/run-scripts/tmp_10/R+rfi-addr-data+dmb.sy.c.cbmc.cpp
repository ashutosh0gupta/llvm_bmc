...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !50, metadata !DIExpression()), !dbg !60
  ...
  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !51, metadata !DIExpression()), !dbg !60
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !54, metadata !DIExpression()), !dbg !74

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !55, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !56, metadata !DIExpression()), !dbg !77

  //   %2 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !58, metadata !DIExpression()), !dbg !77

  //   store atomic i64 %2, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !78
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !91, metadata !DIExpression()), !dbg !105
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !131, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !148, metadata !DIExpression()), !dbg !191
