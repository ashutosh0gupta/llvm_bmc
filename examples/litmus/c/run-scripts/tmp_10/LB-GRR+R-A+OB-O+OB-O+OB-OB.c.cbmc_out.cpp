...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !105, metadata !DIExpression()), !dbg !120
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !130, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !133, metadata !DIExpression()), !dbg !148
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !158, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !162, metadata !DIExpression()), !dbg !181
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !193, metadata !DIExpression()), !dbg !201

  //   br label %label_6, !dbg !53
  goto T6BLOCK1;

T6BLOCK1:
  //   call void @llvm.dbg.label(metadata !200), !dbg !203

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !194, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64 1, metadata !196, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64 1, metadata !199, metadata !DIExpression()), !dbg !207
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X2_0, metadata !246, metadata !DIExpression()), !dbg !318
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !249, metadata !DIExpression()), !dbg !320
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X2_0, metadata !265, metadata !DIExpression()), !dbg !352
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !269, metadata !DIExpression()), !dbg !355
