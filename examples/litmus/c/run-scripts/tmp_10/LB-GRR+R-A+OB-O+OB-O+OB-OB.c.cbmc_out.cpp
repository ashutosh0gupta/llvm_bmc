...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !101, metadata !DIExpression()), !dbg !113
  ...
  // ST: Guess
  iw(3,8) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l47_c15
  old_cw = cw(3,8);
  cw(3,8) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l47_c15
  // Check
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !122, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !125, metadata !DIExpression()), !dbg !137
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !146, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !150, metadata !DIExpression()), !dbg !163

  //   %1 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(5,0+5*1);
  cr(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l65_c16
  // Check
  ...
  // ST: Guess
  iw(5,11) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l69_c15
  old_cw = cw(5,11);
  cw(5,11) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l69_c15
  // Check
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !173, metadata !DIExpression()), !dbg !181
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !174, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64 1, metadata !176, metadata !DIExpression()), !dbg !184

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !57
  // ST: Guess
  iw(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l75_c3
  old_cw = cw(6,0+5*1);
  cw(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l75_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !177, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64 1, metadata !179, metadata !DIExpression()), !dbg !187

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !60
  // ST: Guess
  iw(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l77_c3
  old_cw = cw(6,0+1*1);
  cw(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l77_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !197, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !198, metadata !DIExpression()), !dbg !256

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !199, metadata !DIExpression()), !dbg !258

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !203, metadata !DIExpression()), !dbg !260

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !204, metadata !DIExpression()), !dbg !262

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !205, metadata !DIExpression()), !dbg !264

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !206, metadata !DIExpression()), !dbg !266

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !207, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !208, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !210, metadata !DIExpression()), !dbg !269

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !121
  // ST: Guess
  iw(0,0+5*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l89_c3
  old_cw = cw(0,0+5*1);
  cw(0,0+5*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l89_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !211, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !213, metadata !DIExpression()), !dbg !271

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !123
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l90_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l90_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !214, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !216, metadata !DIExpression()), !dbg !273

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !125
  // ST: Guess
  iw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l91_c3
  old_cw = cw(0,0+3*1);
  cw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l91_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !217, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !219, metadata !DIExpression()), !dbg !275

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !127
  // ST: Guess
  iw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l92_c3
  old_cw = cw(0,0+2*1);
  cw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l92_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !220, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !222, metadata !DIExpression()), !dbg !277

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !129
  // ST: Guess
  iw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l93_c3
  old_cw = cw(0,0+1*1);
  cw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l93_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !223, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i64 0, metadata !225, metadata !DIExpression()), !dbg !279

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !131
  // ST: Guess
  iw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l94_c3
  old_cw = cw(0,0);
  cw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l94_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X2_0, metadata !226, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i32 0, metadata !229, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !230, metadata !DIExpression()), !dbg !283

  //   call void @llvm.dbg.value(metadata i32 0, metadata !232, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !233, metadata !DIExpression()), !dbg !285

  //   call void @llvm.dbg.value(metadata i32 0, metadata !235, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !236, metadata !DIExpression()), !dbg !287

  //   call void @llvm.dbg.value(metadata i32 0, metadata !238, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !239, metadata !DIExpression()), !dbg !289

  //   call void @llvm.dbg.value(metadata i32 0, metadata !241, metadata !DIExpression()), !dbg !289
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X0_1, metadata !242, metadata !DIExpression()), !dbg !291
  ...
  // ST: Guess
  iw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l100_c3
  old_cw = cw(0,11);
  cw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l100_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !245, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !246, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !247, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !248, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !249, metadata !DIExpression()), !dbg !256

  //   %17 = load i32, i32* @atom_4_X0_1, align 4, !dbg !173, !tbaa !167
  // LD: Guess
  old_cr = cr(0,11);
  cr(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l121_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !250, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !252, metadata !DIExpression()), !dbg !256

  //   %and35 = and i32 %14, %and34, !dbg !176
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !253, metadata !DIExpression()), !dbg !256

  //   %and36 = and i32 %13, %and35, !dbg !177
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !254, metadata !DIExpression()), !dbg !256

  //   %and37 = and i32 %12, %and36, !dbg !178
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !255, metadata !DIExpression()), !dbg !256
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 127, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
