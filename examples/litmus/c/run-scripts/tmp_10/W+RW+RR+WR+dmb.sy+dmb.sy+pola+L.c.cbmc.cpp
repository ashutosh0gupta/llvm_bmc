...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !84, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !86, metadata !DIExpression()), !dbg !103

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !83, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !88, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !90, metadata !DIExpression()), !dbg !107

  //   %conv4 = trunc i64 %1 to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !87, metadata !DIExpression()), !dbg !100

  //   %cmp = icmp eq i32 %conv, 1, !dbg !69

  //   %conv5 = zext i1 %cmp to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !91, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !92, metadata !DIExpression()), !dbg !111

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !94, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !95, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !96, metadata !DIExpression()), !dbg !114

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !98, metadata !DIExpression()), !dbg !114
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !120, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !124, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !126, metadata !DIExpression()), !dbg !137

  //   %conv = trunc i64 %0 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !123, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !128, metadata !DIExpression()), !dbg !141

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !130, metadata !DIExpression()), !dbg !141
