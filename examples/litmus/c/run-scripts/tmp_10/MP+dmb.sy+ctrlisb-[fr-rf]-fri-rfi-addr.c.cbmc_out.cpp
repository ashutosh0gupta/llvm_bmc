...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !93), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !82, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 0, %xor, !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !83, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !103
  creg__r0__1_ = max(0,creg_r0);

  //   %conv17 = zext i1 %cmp to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !87, metadata !DIExpression()), !dbg !94

  //   store i32 %conv17, i32* @atom_1_X0_1, align 4, !dbg !104, !tbaa !105
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv4, 0, !dbg !109
  creg__r1__0_ = max(0,creg_r1);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !88, metadata !DIExpression()), !dbg !94

  //   store i32 %conv19, i32* @atom_1_X2_0, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv8, 1, !dbg !111
  creg__r2__1_ = max(0,creg_r2);

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !89, metadata !DIExpression()), !dbg !94

  //   store i32 %conv21, i32* @atom_1_X4_1, align 4, !dbg !112, !tbaa !105
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv12, 2, !dbg !113
  creg__r3__2_ = max(0,creg_r3);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !90, metadata !DIExpression()), !dbg !94

  //   store i32 %conv23, i32* @atom_1_X6_2, align 4, !dbg !114, !tbaa !105
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv16, 0, !dbg !115
  creg__r7__0_ = max(0,creg_r7);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !91, metadata !DIExpression()), !dbg !94

  //   store i32 %conv25, i32* @atom_1_X8_0, align 4, !dbg !116, !tbaa !105
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !140, metadata !DIExpression()), !dbg !147
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !157, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !158, metadata !DIExpression()), !dbg !217

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !159, metadata !DIExpression()), !dbg !219

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !163, metadata !DIExpression()), !dbg !221

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !164, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !165, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !171, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !174, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !178, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !181, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !184, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !187, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !191, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !193, metadata !DIExpression()), !dbg !251

  //   %conv = trunc i64 %6 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !190, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !194, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !196, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !198, metadata !DIExpression()), !dbg !255

  //   %conv24 = trunc i64 %7 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !195, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !199, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !201, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !203, metadata !DIExpression()), !dbg !259

  //   %conv30 = trunc i64 %8 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !200, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !204, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !205, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !206, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !207, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !208, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !209, metadata !DIExpression()), !dbg !217

  //   %and = and i32 %12, %13, !dbg !161
  creg_r20 = max(creg_r18,creg_r19);
  r20 = r18 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !210, metadata !DIExpression()), !dbg !217

  //   %and33 = and i32 %11, %and, !dbg !162
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !211, metadata !DIExpression()), !dbg !217

  //   %and34 = and i32 %10, %and33, !dbg !163
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !212, metadata !DIExpression()), !dbg !217

  //   %and35 = and i32 %9, %and34, !dbg !164
  creg_r23 = max(creg_r15,creg_r22);
  r23 = r15 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !213, metadata !DIExpression()), !dbg !217

  //   %and36 = and i32 %conv32, %and35, !dbg !165
  creg_r24 = max(creg__r14__2_,creg_r23);
  r24 = (r14==2) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !214, metadata !DIExpression()), !dbg !217

  //   %and37 = and i32 %conv26, %and36, !dbg !166
  creg_r25 = max(creg__r13__1_,creg_r24);
  r25 = (r13==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !215, metadata !DIExpression()), !dbg !217

  //   %and38 = and i32 %conv20, %and37, !dbg !167
  creg_r26 = max(creg__r12__1_,creg_r25);
  r26 = (r12==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !216, metadata !DIExpression()), !dbg !217
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 100, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
