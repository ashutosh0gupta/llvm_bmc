...
T2BLOCK4:
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !115
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ASSUME(creg_r6 >= creg_r5);
  ASSUME(active[creg_r6] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !84, metadata !DIExpression()), !dbg !135
  ...
  //   %cmp31 = icmp eq i32 %conv12, 2, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !100, metadata !DIExpression()), !dbg !147

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %8, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !129
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !199, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !202, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !233, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !237, metadata !DIExpression()), !dbg !307
