...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !79, metadata !DIExpression()), !dbg !121
...
T2BLOCK7:
  ...
  //   %cmp26 = icmp eq i32 %conv4, 1, !dbg !117

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !88, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !89, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !93, metadata !DIExpression()), !dbg !140
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !172, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !175, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !221

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !193, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !197, metadata !DIExpression()), !dbg !247

  //   %8 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !140
  // LD: Guess
  old_cr = cr(0,6);
