...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !98, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !99, metadata !DIExpression()), !dbg !133

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !100, metadata !DIExpression()), !dbg !135

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !104, metadata !DIExpression()), !dbg !137

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !105, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64 0, metadata !107, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !108, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !111, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i32 0, metadata !114, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !115, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i32 0, metadata !117, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !121, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !122, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !126, metadata !DIExpression()), !dbg !158

  //   %conv14 = trunc i64 %5 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !123, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !127, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !131, metadata !DIExpression()), !dbg !133

  //   %and18 = and i32 %conv10, %and17, !dbg !112
  creg_r16 = max(creg__r10__1_,creg_r15);
  r16 = (r10==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !132, metadata !DIExpression()), !dbg !133
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([97 x i8], [97 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
