...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !101

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !64
  // LD: Guess
  old_cr = cr(3,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !80, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !84, metadata !DIExpression()), !dbg !88

  //   store i32 %conv5, i32* @atom_2_X0_1, align 4, !dbg !67, !tbaa !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !85, metadata !DIExpression()), !dbg !88

  //   store i32 %conv7, i32* @atom_2_X2_0, align 4, !dbg !73, !tbaa !68
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !137, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !141, metadata !DIExpression()), !dbg !168
  ...
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l67_c12
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l69_c12
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !116
