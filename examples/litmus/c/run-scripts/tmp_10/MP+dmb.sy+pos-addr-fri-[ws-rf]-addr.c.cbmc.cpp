...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !73, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !107

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   store i32 %conv23, i32* @atom_1_X2_1, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 0, !dbg !105
  ...
  //   store i32 %conv25, i32* @atom_1_X4_0, align 4, !dbg !106, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !172, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !175, metadata !DIExpression()), !dbg !228
