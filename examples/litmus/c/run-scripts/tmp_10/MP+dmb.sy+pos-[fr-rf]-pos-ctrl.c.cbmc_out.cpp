...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !114

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !114

  //   %conv8 = trunc i64 %2 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !117

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !104), !dbg !125
  ...
  //   %cmp24 = icmp eq i32 %conv8, 2, !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !92, metadata !DIExpression()), !dbg !136

  //   %7 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %7, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv12, 2, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !96, metadata !DIExpression()), !dbg !139

  //   %8 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %8, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv16, 0, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !100, metadata !DIExpression()), !dbg !142

  //   %9 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %9, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !155
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !185, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !188, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !247

  //   store atomic i64 0, i64* @atom_1_X4_2 monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !191, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !249

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   %cmp = icmp eq i32 %conv, 1, !dbg !148
  ...
  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !213, metadata !DIExpression()), !dbg !278

  //   %10 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !160
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !217, metadata !DIExpression()), !dbg !281

  //   %11 = load atomic i64, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !163
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !221, metadata !DIExpression()), !dbg !284

  //   %12 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !166
  // LD: Guess
  old_cr = cr(0,6);
