...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !87), !dbg !92
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !102

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !67, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !72, metadata !DIExpression()), !dbg !90

  //   %add10 = add nsw i32 4, %xor9, !dbg !91
  creg_r7 = max(0,creg_r6);
  r7 = 4 + r6;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !91

  //   %arrayidx12 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !91
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !73, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !91
  // ST: Guess
  ...
  // LD: Guess
  old_cr = cr(2,0+4*1);
  cr(2,0+4*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l37_c17
  // Check
  ...
  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !96
  creg__r9__0_ = max(0,creg_r9);

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !98
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !89), !dbg !120

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !121

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv23 = trunc i64 %4 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !80, metadata !DIExpression()), !dbg !90

  //   %cmp = icmp eq i32 %conv, 1, !dbg !105
  creg__r0__1_ = max(0,creg_r0);

  //   %conv24 = zext i1 %cmp to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !84, metadata !DIExpression()), !dbg !90

  //   store i32 %conv24, i32* @atom_1_X0_1, align 4, !dbg !106, !tbaa !107
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv16, 2, !dbg !111
  creg__r9__2_ = max(0,creg_r9);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !85, metadata !DIExpression()), !dbg !90

  //   store i32 %conv26, i32* @atom_1_X10_2, align 4, !dbg !112, !tbaa !107
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv23, 0, !dbg !113
  creg__r10__0_ = max(0,creg_r10);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !86, metadata !DIExpression()), !dbg !90

  //   store i32 %conv28, i32* @atom_1_X11_0, align 4, !dbg !114, !tbaa !107
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !138, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i64 2, metadata !140, metadata !DIExpression()), !dbg !145

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !48
  // ST: Guess
  iw(3,0+4*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l52_c3
  old_cw = cw(3,0+4*1);
  cw(3,0+4*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l52_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !155, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !156, metadata !DIExpression()), !dbg !211

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !157, metadata !DIExpression()), !dbg !213

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !161, metadata !DIExpression()), !dbg !215

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !162, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !163, metadata !DIExpression()), !dbg !218
  ...
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l61_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l61_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !166, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !169, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !172, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !175, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !178, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_2, metadata !182, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !230

  //   store atomic i32 0, i32* @atom_1_X10_2 monotonic, align 4, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !185, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !232

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !189, metadata !DIExpression()), !dbg !245

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,0+4*1);
  cr(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l78_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !191, metadata !DIExpression()), !dbg !245

  //   %conv = trunc i64 %6 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !188, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !192, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !196, metadata !DIExpression()), !dbg !249

  //   %conv24 = trunc i64 %7 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !193, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !197, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !199, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !201, metadata !DIExpression()), !dbg !253

  //   %conv30 = trunc i64 %8 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !198, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !202, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !203, metadata !DIExpression()), !dbg !211

  //   %10 = load i32, i32* @atom_1_X10_2, align 4, !dbg !149, !tbaa !147
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !204, metadata !DIExpression()), !dbg !211

  //   %11 = load i32, i32* @atom_1_X11_0, align 4, !dbg !150, !tbaa !147
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !205, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !207, metadata !DIExpression()), !dbg !211

  //   %and34 = and i32 %conv32, %and33, !dbg !153
  creg_r23 = max(creg__r17__1_,creg_r22);
  r23 = (r17==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !208, metadata !DIExpression()), !dbg !211

  //   %and35 = and i32 %conv26, %and34, !dbg !154
  creg_r24 = max(creg__r16__1_,creg_r23);
  r24 = (r16==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !209, metadata !DIExpression()), !dbg !211

  //   %and36 = and i32 %conv20, %and35, !dbg !155
  creg_r25 = max(creg__r15__2_,creg_r24);
  r25 = (r15==2) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !210, metadata !DIExpression()), !dbg !211
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !159
