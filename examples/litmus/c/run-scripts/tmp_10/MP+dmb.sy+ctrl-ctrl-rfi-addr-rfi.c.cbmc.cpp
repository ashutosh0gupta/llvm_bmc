...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !95), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !66, metadata !DIExpression()), !dbg !109

  //   %conv4 = trunc i64 %1 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !63, metadata !DIExpression()), !dbg !97
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !96), !dbg !117

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !67, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64 1, metadata !69, metadata !DIExpression()), !dbg !118

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !120

  //   %conv11 = trunc i64 %2 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !70, metadata !DIExpression()), !dbg !97

  //   %xor = xor i32 %conv11, %conv11, !dbg !104
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !126
  ...
  //   %conv17 = trunc i64 %3 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !78, metadata !DIExpression()), !dbg !97

  //   %cmp = icmp eq i32 %conv, 1, !dbg !110

  //   %conv18 = zext i1 %cmp to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !82, metadata !DIExpression()), !dbg !97
  ...
  //   %cmp22 = icmp eq i32 %conv11, 1, !dbg !113

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !86, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !87, metadata !DIExpression()), !dbg !133

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %5, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv17, 1, !dbg !116

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !90, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !91, metadata !DIExpression()), !dbg !136

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %6, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !118
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !168, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !171, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !194, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !198, metadata !DIExpression()), !dbg !253
