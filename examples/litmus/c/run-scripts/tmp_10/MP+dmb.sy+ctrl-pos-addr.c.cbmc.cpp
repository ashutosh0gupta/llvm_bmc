...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !64, metadata !DIExpression()), !dbg !90

  //   %conv4 = trunc i64 %1 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !61, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !68, metadata !DIExpression()), !dbg !93

  //   %conv8 = trunc i64 %2 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !65, metadata !DIExpression()), !dbg !78

  //   %xor = xor i32 %conv8, %conv8, !dbg !77
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !98

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   %conv12 = trunc i64 %3 to i32, !dbg !80
  ...
  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !82, !tbaa !83
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv12, 0, !dbg !87
  ...
  //   store i32 %conv15, i32* @atom_1_X6_0, align 4, !dbg !88, !tbaa !83
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
