...
T2BLOCK1:
  ...
  //   store i32 %conv21, i32* @atom_1_X2_1, align 4, !dbg !99, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !157, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !202

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !116
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X10_1, align 4, !dbg !144, !tbaa !140
  // LD: Guess
  old_cr = cr(0,6);
