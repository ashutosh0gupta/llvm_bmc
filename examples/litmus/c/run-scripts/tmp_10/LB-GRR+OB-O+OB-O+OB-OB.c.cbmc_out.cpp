...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !48, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64 1, metadata !50, metadata !DIExpression()), !dbg !60

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !61
  // ST: Guess
  ...
  //   store i32 %conv1, i32* @atom_0_X0_1, align 4, !dbg !63, !tbaa !64
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !88
  ...
  // ST: Guess
  iw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l37_c15
  old_cw = cw(2,6);
  cw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l37_c15
  // Check
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !100, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64 1, metadata !102, metadata !DIExpression()), !dbg !112
  ...
  // ST: Guess
  iw(3,7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l47_c15
  old_cw = cw(3,7);
  cw(3,7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l47_c15
  // Check
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !119, metadata !DIExpression()), !dbg !131
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !121, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !123, metadata !DIExpression()), !dbg !134

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !120, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !125, metadata !DIExpression()), !dbg !138

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(4,0+4*1);
  cr(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l55_c16
  // Check
  ...
  if(cr(4,0+4*1) < cw(4,0+4*1)) {
    ...
    r4 = mem(0+4*1,cr(4,0+4*1));
  }
  ASSUME(creturn[4] >= cr(4,0+4*1));

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !127, metadata !DIExpression()), !dbg !138

  //   %conv4 = trunc i64 %1 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !124, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !128, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !129, metadata !DIExpression()), !dbg !131

  //   store i32 %conv7, i32* @atom_3_X0_1, align 4, !dbg !72, !tbaa !67
  // ST: Guess
  iw(4,9) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l59_c15
  old_cw = cw(4,9);
  cw(4,9) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l59_c15
  // Check
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !148, metadata !DIExpression()), !dbg !156
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !149, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64 1, metadata !151, metadata !DIExpression()), !dbg !159

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !55
  // ST: Guess
  iw(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l65_c3
  old_cw = cw(5,0+4*1);
  cw(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l65_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !152, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64 1, metadata !154, metadata !DIExpression()), !dbg !162

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !58
  // ST: Guess
  iw(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l67_c3
  old_cw = cw(5,0+1*1);
  cw(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l67_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !201, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !203, metadata !DIExpression()), !dbg !245

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_0_X0_1, align 4, !dbg !149, !tbaa !147
  // LD: Guess
  old_cr = cr(0,5);
