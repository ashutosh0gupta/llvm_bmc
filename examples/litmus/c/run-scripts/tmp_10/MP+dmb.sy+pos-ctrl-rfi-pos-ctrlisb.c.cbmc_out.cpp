...
T2BLOCK7:
  ...
  //   %cmp21 = icmp eq i32 %conv4, 1, !dbg !114
  ...
  //   store i32 %conv22, i32* @atom_1_X2_1, align 4, !dbg !115, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !149, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !150, metadata !DIExpression()), !dbg !208

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !151, metadata !DIExpression()), !dbg !210

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !155, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !158, metadata !DIExpression()), !dbg !213

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !161, metadata !DIExpression()), !dbg !215

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !217

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !165, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i32 0, metadata !168, metadata !DIExpression()), !dbg !219

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !117
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l62_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l62_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !169, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !221

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !119
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l63_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l63_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !172, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !223

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !121
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l64_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l64_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !175, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !225

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !123
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l65_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l65_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !178, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !227

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !125
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l66_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l66_c3
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !126
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !127
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !237

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !184, metadata !DIExpression()), !dbg !237

  //   %conv = trunc i64 %4 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !181, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !185, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !241

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !189, metadata !DIExpression()), !dbg !241

  //   %conv22 = trunc i64 %5 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !186, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !190, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !192, metadata !DIExpression()), !dbg !245

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l78_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !194, metadata !DIExpression()), !dbg !245

  //   %conv28 = trunc i64 %6 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !191, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !195, metadata !DIExpression()), !dbg !208

  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !148, !tbaa !149
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l80_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !196, metadata !DIExpression()), !dbg !208

  //   %8 = load i32, i32* @atom_1_X2_1, align 4, !dbg !151, !tbaa !149
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l81_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !197, metadata !DIExpression()), !dbg !208

  //   %9 = load i32, i32* @atom_1_X5_1, align 4, !dbg !152, !tbaa !149
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l82_c13
  // Check
  ...
  //   %10 = load i32, i32* @atom_1_X6_1, align 4, !dbg !153, !tbaa !149
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l83_c13
  // Check
  ...
  //   %11 = load i32, i32* @atom_1_X7_0, align 4, !dbg !154, !tbaa !149
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l84_c13
  // Check
  ...
  //   %and = and i32 %10, %11, !dbg !155
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !201, metadata !DIExpression()), !dbg !208

  //   %and31 = and i32 %9, %and, !dbg !156
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !202, metadata !DIExpression()), !dbg !208

  //   %and32 = and i32 %8, %and31, !dbg !157
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !203, metadata !DIExpression()), !dbg !208

  //   %and33 = and i32 %7, %and32, !dbg !158
  creg_r19 = max(creg_r11,creg_r18);
  r19 = r11 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !204, metadata !DIExpression()), !dbg !208

  //   %and34 = and i32 %conv30, %and33, !dbg !159
  creg_r20 = max(creg__r10__1_,creg_r19);
  r20 = (r10==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !205, metadata !DIExpression()), !dbg !208

  //   %and35 = and i32 %conv24, %and34, !dbg !160
  creg_r21 = max(creg__r9__1_,creg_r20);
  r21 = (r9==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !206, metadata !DIExpression()), !dbg !208

  //   %and36 = and i32 %conv18, %and35, !dbg !161
  creg_r22 = max(creg__r8__1_,creg_r21);
  r22 = (r8==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !207, metadata !DIExpression()), !dbg !208

  //   %cmp37 = icmp eq i32 %and36, 1, !dbg !162
  creg__r22__1_ = max(0,creg_r22);

  //   br i1 %cmp37, label %if.then, label %if.end, !dbg !164
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !165
...
T0BLOCK2:
  //   %12 = bitcast i64* %thr1 to i8*, !dbg !168

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #6, !dbg !168

  //   %13 = bitcast i64* %thr0 to i8*, !dbg !168

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #6, !dbg !168
