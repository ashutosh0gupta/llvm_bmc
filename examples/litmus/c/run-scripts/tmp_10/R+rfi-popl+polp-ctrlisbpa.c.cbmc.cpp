...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !92, metadata !DIExpression()), !dbg !111
  ...
  //   store i32 %conv5, i32* @atom_1_X4_0, align 4, !dbg !73, !tbaa !74
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_2, metadata !140, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !144, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !147, metadata !DIExpression()), !dbg !182
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !132
