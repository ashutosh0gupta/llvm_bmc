...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !84), !dbg !89
  ...
  //   %tobool = icmp ne i32 %conv, 0, !dbg !74
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !85), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !65, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 1, metadata !67, metadata !DIExpression()), !dbg !99

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !87

  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !85
  creg__r1__0_ = max(0,creg_r1);

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !87
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !86), !dbg !109
  ...
  //   %conv11 = trunc i64 %2 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !72, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !76, metadata !DIExpression()), !dbg !87

  //   %cmp = icmp eq i32 %conv, 1, !dbg !98
  creg__r0__1_ = max(0,creg_r0);

  //   %conv16 = zext i1 %cmp to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !80, metadata !DIExpression()), !dbg !87

  //   store i32 %conv16, i32* @atom_1_X0_1, align 4, !dbg !99, !tbaa !100
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 1, !dbg !104
  creg__r1__1_ = max(0,creg_r1);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !81, metadata !DIExpression()), !dbg !87

  //   store i32 %conv18, i32* @atom_1_X4_1, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv11, 0, !dbg !106
  creg__r2__0_ = max(0,creg_r2);

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !82, metadata !DIExpression()), !dbg !87

  //   store i32 %conv20, i32* @atom_1_X5_0, align 4, !dbg !107, !tbaa !100
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 1, !dbg !108
  creg__r3__1_ = max(0,creg_r3);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !83, metadata !DIExpression()), !dbg !87

  //   store i32 %conv22, i32* @atom_1_X7_1, align 4, !dbg !109, !tbaa !100
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !133, metadata !DIExpression()), !dbg !140
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !150, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !151, metadata !DIExpression()), !dbg !205

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !152, metadata !DIExpression()), !dbg !207

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !156, metadata !DIExpression()), !dbg !209

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !157, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !158, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !167, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !171, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i32 0, metadata !173, metadata !DIExpression()), !dbg !220

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !174, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !222

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !177, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !224

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !181, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !184, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !185, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !189, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !191, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !190, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !194, metadata !DIExpression()), !dbg !205
  ...
  //   %10 = load i32, i32* @atom_1_X4_1, align 4, !dbg !148, !tbaa !146
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X5_0, align 4, !dbg !149, !tbaa !146
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X7_1, align 4, !dbg !150, !tbaa !146
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !200, metadata !DIExpression()), !dbg !205

  //   %and32 = and i32 %9, %and31, !dbg !153
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !201, metadata !DIExpression()), !dbg !205

  //   %and33 = and i32 %conv30, %and32, !dbg !154
  creg_r18 = max(creg__r10__1_,creg_r17);
  r18 = (r10==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !202, metadata !DIExpression()), !dbg !205

  //   %and34 = and i32 %conv24, %and33, !dbg !155
  creg_r19 = max(creg__r9__1_,creg_r18);
  r19 = (r9==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !203, metadata !DIExpression()), !dbg !205

  //   %and35 = and i32 %conv18, %and34, !dbg !156
  creg_r20 = max(creg__r8__2_,creg_r19);
  r20 = (r8==2) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !204, metadata !DIExpression()), !dbg !205
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 94, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
