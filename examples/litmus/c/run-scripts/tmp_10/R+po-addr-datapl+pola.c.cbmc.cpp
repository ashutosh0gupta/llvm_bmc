...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !36, metadata !DIExpression()), !dbg !61
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !37, metadata !DIExpression()), !dbg !64

  //   call void @llvm.dbg.value(metadata i64 1, metadata !40, metadata !DIExpression()), !dbg !64

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !65
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !66

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !67
  // LD: Guess
  old_cr = cr(1,0+1*1);
  cr(1,0+1*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l21_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !44, metadata !DIExpression()), !dbg !66

  //   %conv = trunc i64 %0 to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !41, metadata !DIExpression()), !dbg !61

  //   %xor = xor i32 %conv, %conv, !dbg !69
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !45, metadata !DIExpression()), !dbg !61

  //   %add = add nsw i32 2, %xor, !dbg !70
  creg_r2 = max(0,creg_r1);
  r2 = 2 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !70

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !70
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !47, metadata !DIExpression()), !dbg !71

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !70
  // LD: Guess
  old_cr = cr(1,r3);
  cr(1,r3) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l23_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !49, metadata !DIExpression()), !dbg !71

  //   %conv4 = trunc i64 %1 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !46, metadata !DIExpression()), !dbg !61

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !73
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !50, metadata !DIExpression()), !dbg !61

  //   %add6 = add nsw i32 %xor5, 1, !dbg !74
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !51, metadata !DIExpression()), !dbg !61

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !52, metadata !DIExpression()), !dbg !75

  //   %conv9 = sext i32 %add6 to i64, !dbg !76

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !54, metadata !DIExpression()), !dbg !75

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !76
  // ST: Guess
  //   : Release
  iw(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l26_c3
  old_cw = cw(1,0+3*1);
  cw(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l26_c3
  // Check
  ASSUME(active[iw(1,0+3*1)] == 1);
  ASSUME(active[cw(1,0+3*1)] == 1);
  ASSUME(sforbid(0+3*1,cw(1,0+3*1))== 0);
  ASSUME(iw(1,0+3*1) >= creg_r6);
  ASSUME(iw(1,0+3*1) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !56, metadata !DIExpression()), !dbg !77

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(1,0+3*1);
  cr(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l27_c16
  // Check
  ...
  if(cr(1,0+3*1) < cw(1,0+3*1)) {
    ...
    r7 = mem(0+3*1,cr(1,0+3*1));
  }
  ASSUME(creturn[1] >= cr(1,0+3*1));

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !58, metadata !DIExpression()), !dbg !77

  //   %conv13 = trunc i64 %2 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !55, metadata !DIExpression()), !dbg !61

  //   %cmp = icmp eq i32 %conv13, 2, !dbg !80
  creg__r7__2_ = max(0,creg_r7);

  //   %conv14 = zext i1 %cmp to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !59, metadata !DIExpression()), !dbg !61

  //   store i32 %conv14, i32* @atom_0_X9_2, align 4, !dbg !81, !tbaa !82
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !90, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64 2, metadata !92, metadata !DIExpression()), !dbg !102

  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !51
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !94, metadata !DIExpression()), !dbg !104

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !53
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !96, metadata !DIExpression()), !dbg !104

  //   %conv = trunc i64 %0 to i32, !dbg !54

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !93, metadata !DIExpression()), !dbg !99
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !117, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !118, metadata !DIExpression()), !dbg !158

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !119, metadata !DIExpression()), !dbg !160

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !123, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !124, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 0, metadata !126, metadata !DIExpression()), !dbg !163

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !87
  // ST: Guess
  iw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l46_c3
  old_cw = cw(0,0+3*1);
  cw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l46_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !127, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64 0, metadata !129, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !130, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64 0, metadata !132, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !133, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64 0, metadata !135, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X9_2, metadata !136, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i32 0, metadata !139, metadata !DIExpression()), !dbg !171

  //   store atomic i32 0, i32* @atom_0_X9_2 monotonic, align 4, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !140, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i32 0, metadata !142, metadata !DIExpression()), !dbg !173

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !144, metadata !DIExpression()), !dbg !183

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l59_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !146, metadata !DIExpression()), !dbg !183

  //   %conv = trunc i64 %4 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !143, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !147, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !149, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !151, metadata !DIExpression()), !dbg !187

  //   %conv18 = trunc i64 %5 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !148, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !152, metadata !DIExpression()), !dbg !158

  //   %6 = load i32, i32* @atom_0_X9_2, align 4, !dbg !116, !tbaa !117
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l63_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !153, metadata !DIExpression()), !dbg !158

  //   %7 = load i32, i32* @atom_1_X2_0, align 4, !dbg !119, !tbaa !117
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l64_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !154, metadata !DIExpression()), !dbg !158

  //   %and = and i32 %6, %7, !dbg !120
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !155, metadata !DIExpression()), !dbg !158

  //   %and21 = and i32 %conv20, %and, !dbg !121
  creg_r17 = max(creg__r13__1_,creg_r16);
  r17 = (r13==1) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !156, metadata !DIExpression()), !dbg !158

  //   %and22 = and i32 %conv14, %and21, !dbg !122
  creg_r18 = max(creg__r12__2_,creg_r17);
  r18 = (r12==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !157, metadata !DIExpression()), !dbg !158
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
