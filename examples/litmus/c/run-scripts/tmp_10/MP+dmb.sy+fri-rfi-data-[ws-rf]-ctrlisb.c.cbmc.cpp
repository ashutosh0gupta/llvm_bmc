...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64 2, metadata !67, metadata !DIExpression()), !dbg !97

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !99

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !73, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !104

  //   %conv7 = sext i32 %add to i64, !dbg !86

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !76, metadata !DIExpression()), !dbg !104

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !78, metadata !DIExpression()), !dbg !106
  ...
  //   %conv11 = trunc i64 %2 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !77, metadata !DIExpression()), !dbg !91

  //   %tobool = icmp ne i32 %conv11, 0, !dbg !90
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !81, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !85, metadata !DIExpression()), !dbg !91

  //   store i32 %conv16, i32* @atom_1_X0_1, align 4, !dbg !101, !tbaa !102
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 2, !dbg !106
  creg__r1__2_ = max(0,creg_r1);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !86, metadata !DIExpression()), !dbg !91

  //   store i32 %conv18, i32* @atom_1_X3_2, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv11, 2, !dbg !108
  ...
  //   store i32 %conv20, i32* @atom_1_X6_2, align 4, !dbg !109, !tbaa !102
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 0, !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X7_0, align 4, !dbg !111, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !152, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !153, metadata !DIExpression()), !dbg !207

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !154, metadata !DIExpression()), !dbg !209

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !158, metadata !DIExpression()), !dbg !211

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !159, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !160, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !165, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !166, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !169, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !173, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !176, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !179, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !183, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !185, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !186, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !188, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !190, metadata !DIExpression()), !dbg !243

  //   %conv22 = trunc i64 %7 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !187, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !191, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !193, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !195, metadata !DIExpression()), !dbg !247

  //   %conv28 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !192, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !196, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !202, metadata !DIExpression()), !dbg !207

  //   %and32 = and i32 %9, %and31, !dbg !153
  creg_r19 = max(creg_r13,creg_r18);
  r19 = r13 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !203, metadata !DIExpression()), !dbg !207

  //   %and33 = and i32 %conv30, %and32, !dbg !154
  creg_r20 = max(creg__r12__2_,creg_r19);
  r20 = (r12==2) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !204, metadata !DIExpression()), !dbg !207

  //   %and34 = and i32 %conv24, %and33, !dbg !155
  creg_r21 = max(creg__r11__2_,creg_r20);
  r21 = (r11==2) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !205, metadata !DIExpression()), !dbg !207

  //   %and35 = and i32 %conv18, %and34, !dbg !156
  creg_r22 = max(creg__r10__1_,creg_r21);
  r22 = (r10==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !206, metadata !DIExpression()), !dbg !207
