...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !53, metadata !DIExpression()), !dbg !60
...
T2BLOCK2:
  //   br label %lbl_label179, !dbg !57
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label179, !dbg !58
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !59), !dbg !72

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !54, metadata !DIExpression()), !dbg !73
  ...
  //   %cmp2 = icmp eq i32 %conv, 2, !dbg !62
  creg__r0__2_ = max(0,creg_r0);

  //   %conv3 = zext i1 %cmp2 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !57, metadata !DIExpression()), !dbg !60

  //   store i32 %conv3, i32* @atom_1_X0_2, align 4, !dbg !63, !tbaa !64
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !85, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64 2, metadata !87, metadata !DIExpression()), !dbg !95

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !47
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !88, metadata !DIExpression()), !dbg !97
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !107, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !108, metadata !DIExpression()), !dbg !138

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !109, metadata !DIExpression()), !dbg !140

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !113, metadata !DIExpression()), !dbg !142

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !114, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !115, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !118, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !121, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i32 0, metadata !124, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !128, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !133, metadata !DIExpression()), !dbg !166

  //   %conv14 = trunc i64 %7 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !130, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !134, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !137, metadata !DIExpression()), !dbg !138
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([126 x i8], [126 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
