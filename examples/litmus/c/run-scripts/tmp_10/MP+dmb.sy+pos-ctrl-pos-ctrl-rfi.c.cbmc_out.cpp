...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !82, metadata !DIExpression()), !dbg !88
  ...
  //   %cmp21 = icmp eq i32 %conv4, 1, !dbg !107
  creg__r1__1_ = max(0,creg_r1);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !83, metadata !DIExpression()), !dbg !88

  //   store i32 %conv22, i32* @atom_1_X2_1, align 4, !dbg !108, !tbaa !103
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv19, 1, !dbg !109
  creg__r4__1_ = max(0,creg_r4);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !84, metadata !DIExpression()), !dbg !88

  //   store i32 %conv24, i32* @atom_1_X8_1, align 4, !dbg !110, !tbaa !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !154, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !158, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !161, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !167, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !168, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !172, metadata !DIExpression()), !dbg !210

  //   %conv18 = trunc i64 %5 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !169, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !173, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !178, metadata !DIExpression()), !dbg !181

  //   %and22 = and i32 %conv20, %and21, !dbg !127
  creg_r15 = max(creg__r9__1_,creg_r14);
  r15 = (r9==1) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !179, metadata !DIExpression()), !dbg !181

  //   %and23 = and i32 %conv14, %and22, !dbg !128
  creg_r16 = max(creg__r8__2_,creg_r15);
  r16 = (r8==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !180, metadata !DIExpression()), !dbg !181
