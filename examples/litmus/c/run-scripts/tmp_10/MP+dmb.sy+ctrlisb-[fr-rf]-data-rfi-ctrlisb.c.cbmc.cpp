...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !167, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !168, metadata !DIExpression()), !dbg !236

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !169, metadata !DIExpression()), !dbg !238

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !173, metadata !DIExpression()), !dbg !240

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !174, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !175, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !178, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !181, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !184, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !187, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !191, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i32 0, metadata !193, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !194, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i32 0, metadata !196, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !197, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i32 0, metadata !199, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !200, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i32 0, metadata !202, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !204, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !206, metadata !DIExpression()), !dbg !272

  //   %conv = trunc i64 %6 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !203, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !207, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !209, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !211, metadata !DIExpression()), !dbg !276

  //   %conv26 = trunc i64 %7 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !208, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !212, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !214, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !216, metadata !DIExpression()), !dbg !280

  //   %conv32 = trunc i64 %8 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !213, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !217, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !219, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !221, metadata !DIExpression()), !dbg !284

  //   %conv38 = trunc i64 %9 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !218, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !222, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !223, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !224, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !228, metadata !DIExpression()), !dbg !236

  //   %and41 = and i32 %12, %and, !dbg !177
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !229, metadata !DIExpression()), !dbg !236

  //   %and42 = and i32 %11, %and41, !dbg !178
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !230, metadata !DIExpression()), !dbg !236

  //   %and43 = and i32 %10, %and42, !dbg !179
  creg_r23 = max(creg_r15,creg_r22);
  r23 = r15 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !231, metadata !DIExpression()), !dbg !236

  //   %and44 = and i32 %conv40, %and43, !dbg !180
  creg_r24 = max(creg__r14__1_,creg_r23);
  r24 = (r14==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !232, metadata !DIExpression()), !dbg !236

  //   %and45 = and i32 %conv34, %and44, !dbg !181
  creg_r25 = max(creg__r13__1_,creg_r24);
  r25 = (r13==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !233, metadata !DIExpression()), !dbg !236

  //   %and46 = and i32 %conv28, %and45, !dbg !182
  creg_r26 = max(creg__r12__1_,creg_r25);
  r26 = (r12==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !234, metadata !DIExpression()), !dbg !236

  //   %and47 = and i32 %conv22, %and46, !dbg !183
  creg_r27 = max(creg__r11__1_,creg_r26);
  r27 = (r11==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !235, metadata !DIExpression()), !dbg !236
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 108, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187
