...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !120

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !82, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !84, metadata !DIExpression()), !dbg !124

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !86, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv24, 0, !dbg !107

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !87, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !88, metadata !DIExpression()), !dbg !127

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !90, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %7, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !137, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !138, metadata !DIExpression()), !dbg !183

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !139, metadata !DIExpression()), !dbg !185

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !143, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !144, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64 0, metadata !146, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !147, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64 0, metadata !149, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !159, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64 0, metadata !161, metadata !DIExpression()), !dbg !198

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !102
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !103
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !104
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !163, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !165, metadata !DIExpression()), !dbg !210

  //   %conv = trunc i64 %4 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !162, metadata !DIExpression()), !dbg !183

  //   %cmp = icmp eq i32 %conv, 1, !dbg !116

  //   %conv14 = zext i1 %cmp to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !166, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !170, metadata !DIExpression()), !dbg !214

  //   %conv18 = trunc i64 %5 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !167, metadata !DIExpression()), !dbg !183

  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !120

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !171, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !173, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !175, metadata !DIExpression()), !dbg !218

  //   %conv24 = trunc i64 %6 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !172, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !177, metadata !DIExpression()), !dbg !221

  //   %7 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !125
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !179, metadata !DIExpression()), !dbg !221

  //   %conv28 = trunc i64 %7 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !176, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !180, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !181, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !182, metadata !DIExpression()), !dbg !183
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !133
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #6, !dbg !136

  //   %9 = bitcast i64* %thr0 to i8*, !dbg !136

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #6, !dbg !136
