...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !75, metadata !DIExpression()), !dbg !87

  //   %add = add nsw i32 %xor, 1, !dbg !68
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !76, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !79, metadata !DIExpression()), !dbg !97

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !70
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !80, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !84, metadata !DIExpression()), !dbg !87

  //   store i32 %conv8, i32* @atom_1_X2_1, align 4, !dbg !75, !tbaa !76
  // ST: Guess
  ...
  //   %cmp9 = icmp eq i32 %conv7, 1, !dbg !80
  creg__r4__1_ = max(0,creg_r4);

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !85, metadata !DIExpression()), !dbg !87

  //   store i32 %conv10, i32* @atom_1_X5_1, align 4, !dbg !81, !tbaa !76
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !127, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !131, metadata !DIExpression()), !dbg !165
