...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !113
...
T2BLOCK10:
  ...
  //   store i32 %conv27, i32* @atom_1_X8_0, align 4, !dbg !117, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !178, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_2, metadata !182, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !185, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !189, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !191, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !192, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !196, metadata !DIExpression()), !dbg !247

  //   %conv22 = trunc i64 %7 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !193, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !197, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !199, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !201, metadata !DIExpression()), !dbg !251

  //   %conv28 = trunc i64 %8 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !198, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !202, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !207, metadata !DIExpression()), !dbg !211

  //   %and32 = and i32 %conv30, %and31, !dbg !148
  creg_r17 = max(creg__r11__1_,creg_r16);
  r17 = (r11==1) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !208, metadata !DIExpression()), !dbg !211

  //   %and33 = and i32 %conv24, %and32, !dbg !149
  creg_r18 = max(creg__r10__1_,creg_r17);
  r18 = (r10==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !209, metadata !DIExpression()), !dbg !211

  //   %and34 = and i32 %conv18, %and33, !dbg !150
  creg_r19 = max(creg__r9__2_,creg_r18);
  r19 = (r9==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !210, metadata !DIExpression()), !dbg !211
