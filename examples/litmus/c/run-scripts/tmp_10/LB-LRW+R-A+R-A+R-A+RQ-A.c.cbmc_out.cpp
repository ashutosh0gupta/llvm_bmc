...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !56

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !57
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !48, metadata !DIExpression()), !dbg !59

  //   call void @llvm.dbg.value(metadata i64 1, metadata !50, metadata !DIExpression()), !dbg !59

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !60
  // ST: Guess
  //   : Release
  ...
  // ST: Guess
  iw(1,5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l26_c15
  old_cw = cw(1,5);
  cw(1,5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l26_c15
  // Check
  ASSUME(active[iw(1,5)] == 1);
  ASSUME(active[cw(1,5)] == 1);
  ASSUME(sforbid(5,cw(1,5))== 0);
  ASSUME(iw(1,5) >= creg__r0__1_);
  ASSUME(iw(1,5) >= 0);
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !83

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !57
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !86

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !60
  // ST: Guess
  //   : Release
  ...
  // ST: Guess
  iw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l35_c15
  old_cw = cw(2,6);
  cw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l35_c15
  // Check
  ASSUME(active[iw(2,6)] == 2);
  ASSUME(active[cw(2,6)] == 2);
  ASSUME(sforbid(6,cw(2,6))== 0);
  ASSUME(iw(2,6) >= creg__r1__1_);
  ASSUME(iw(2,6) >= 0);
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !95, metadata !DIExpression()), !dbg !106

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !57
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !98, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64 1, metadata !100, metadata !DIExpression()), !dbg !109

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !60
  // ST: Guess
  //   : Release
  iw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l42_c3
  old_cw = cw(3,0+3*1);
  cw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l42_c3
  // Check
  ...
  //   store i32 %conv1, i32* @atom_2_X0_1, align 4, !dbg !62, !tbaa !63
  // ST: Guess
  iw(3,7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l44_c15
  old_cw = cw(3,7);
  cw(3,7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l44_c15
  // Check
  ASSUME(active[iw(3,7)] == 3);
  ASSUME(active[cw(3,7)] == 3);
  ASSUME(sforbid(7,cw(3,7))== 0);
  ASSUME(iw(3,7) >= creg__r2__1_);
  ASSUME(iw(3,7) >= 0);
...
T4BLOCK1:
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) acquire, align 8, !dbg !60
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+3*1);
  cr(4,0+3*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l50_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !121, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64 2, metadata !123, metadata !DIExpression()), !dbg !135

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) release, align 8, !dbg !63
  // ST: Guess
  //   : Release
  iw(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l51_c3
  old_cw = cw(4,0+4*1);
  cw(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l51_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !124, metadata !DIExpression()), !dbg !137

  //   call void @llvm.dbg.value(metadata i64 1, metadata !126, metadata !DIExpression()), !dbg !137

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !65
  // ST: Guess
  iw(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l52_c3
  old_cw = cw(4,0+4*1);
  cw(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l52_c3
  // Check
  ASSUME(active[iw(4,0+4*1)] == 4);
  ASSUME(active[cw(4,0+4*1)] == 4);
  ASSUME(sforbid(0+4*1,cw(4,0+4*1))== 0);
  ...
  //   %conv3 = zext i1 %cmp to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !127, metadata !DIExpression()), !dbg !129

  //   store i32 %conv3, i32* @atom_3_X0_1, align 4, !dbg !67, !tbaa !68
  // ST: Guess
  iw(4,8) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l54_c15
  old_cw = cw(4,8);
  cw(4,8) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l54_c15
  // Check
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !144, metadata !DIExpression()), !dbg !154
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !146, metadata !DIExpression()), !dbg !157

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) acquire, align 8, !dbg !57
  // LD: Guess
  //   : Acquire
  old_cr = cr(5,0+4*1);
  cr(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l60_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !148, metadata !DIExpression()), !dbg !157

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !145, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64 1, metadata !151, metadata !DIExpression()), !dbg !160

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !60
  // ST: Guess
  iw(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l61_c3
  old_cw = cw(5,0+1*1);
  cw(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l61_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !152, metadata !DIExpression()), !dbg !154

  //   store i32 %conv1, i32* @atom_4_X0_1, align 4, !dbg !62, !tbaa !63
  // ST: Guess
  iw(5,9) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l63_c15
  old_cw = cw(5,9);
  cw(5,9) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l63_c15
  // Check
  ASSUME(active[iw(5,9)] == 5);
  ASSUME(active[cw(5,9)] == 5);
  ASSUME(sforbid(9,cw(5,9))== 0);
  ASSUME(iw(5,9) >= creg__r4__1_);
  ASSUME(iw(5,9) >= 0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !172, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !173, metadata !DIExpression()), !dbg !222

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !174, metadata !DIExpression()), !dbg !224

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !178, metadata !DIExpression()), !dbg !226

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !179, metadata !DIExpression()), !dbg !228

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !180, metadata !DIExpression()), !dbg !230

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !181, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !182, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !233

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !108
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l74_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l74_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !185, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !235

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !110
  // ST: Guess
  iw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l75_c3
  old_cw = cw(0,0+3*1);
  cw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l75_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !237

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !112
  // ST: Guess
  iw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l76_c3
  old_cw = cw(0,0+2*1);
  cw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l76_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !239

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !114
  // ST: Guess
  iw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l77_c3
  old_cw = cw(0,0+1*1);
  cw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l77_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !241

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !116
  // ST: Guess
  iw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l78_c3
  old_cw = cw(0,0);
  cw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l78_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !197, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i32 0, metadata !200, metadata !DIExpression()), !dbg !243

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !118
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l79_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l79_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !201, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !203, metadata !DIExpression()), !dbg !245

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !120
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l80_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l80_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !204, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !206, metadata !DIExpression()), !dbg !247

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !122
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l81_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l81_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !207, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i32 0, metadata !209, metadata !DIExpression()), !dbg !249

  //   store atomic i32 0, i32* @atom_3_X0_1 monotonic, align 4, !dbg !124
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l82_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l82_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X0_1, metadata !210, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !212, metadata !DIExpression()), !dbg !251

  //   store atomic i32 0, i32* @atom_4_X0_1 monotonic, align 4, !dbg !126
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l83_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l83_c3
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !127
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call19 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !128
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call20 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !129
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call21 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !130
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call22 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #7, !dbg !131
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr0, align 8, !dbg !132, !tbaa !133
  r6 = local_mem[2];

  //   %call23 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !137
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i64, i64* %thr1, align 8, !dbg !138, !tbaa !133
  r7 = local_mem[3];

  //   %call24 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !139
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr2, align 8, !dbg !140, !tbaa !133
  r8 = local_mem[4];

  //   %call25 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !141
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load i64, i64* %thr3, align 8, !dbg !142, !tbaa !133
  r9 = local_mem[0];

  //   %call26 = call i32 @pthread_join(i64 noundef %8, i8** noundef null), !dbg !143
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %9 = load i64, i64* %thr4, align 8, !dbg !144, !tbaa !133
  r10 = local_mem[1];

  //   %call27 = call i32 @pthread_join(i64 noundef %9, i8** noundef null), !dbg !145
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %10 = load i32, i32* @atom_0_X0_1, align 4, !dbg !146, !tbaa !147
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l97_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !213, metadata !DIExpression()), !dbg !222

  //   %11 = load i32, i32* @atom_1_X0_1, align 4, !dbg !149, !tbaa !147
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l98_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !214, metadata !DIExpression()), !dbg !222

  //   %12 = load i32, i32* @atom_2_X0_1, align 4, !dbg !150, !tbaa !147
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l99_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !215, metadata !DIExpression()), !dbg !222

  //   %13 = load i32, i32* @atom_3_X0_1, align 4, !dbg !151, !tbaa !147
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !216, metadata !DIExpression()), !dbg !222

  //   %14 = load i32, i32* @atom_4_X0_1, align 4, !dbg !152, !tbaa !147
  // LD: Guess
  old_cr = cr(0,9);
  cr(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l101_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !217, metadata !DIExpression()), !dbg !222

  //   %and = and i32 %13, %14, !dbg !153
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !218, metadata !DIExpression()), !dbg !222

  //   %and28 = and i32 %12, %and, !dbg !154
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !219, metadata !DIExpression()), !dbg !222

  //   %and29 = and i32 %11, %and28, !dbg !155
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !220, metadata !DIExpression()), !dbg !222

  //   %and30 = and i32 %10, %and29, !dbg !156
  creg_r19 = max(creg_r11,creg_r18);
  r19 = r11 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !221, metadata !DIExpression()), !dbg !222

  //   %cmp = icmp eq i32 %and30, 1, !dbg !157
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 106, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
...
T0BLOCK2:
  //   %15 = bitcast i64* %thr4 to i8*, !dbg !163

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %15) #7, !dbg !163

  //   %16 = bitcast i64* %thr3 to i8*, !dbg !163

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %16) #7, !dbg !163

  //   %17 = bitcast i64* %thr2 to i8*, !dbg !163

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %17) #7, !dbg !163

  //   %18 = bitcast i64* %thr1 to i8*, !dbg !163

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %18) #7, !dbg !163

  //   %19 = bitcast i64* %thr0 to i8*, !dbg !163

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %19) #7, !dbg !163
