...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64 2, metadata !43, metadata !DIExpression()), !dbg !60

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !61
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64 1, metadata !46, metadata !DIExpression()), !dbg !62

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !63
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !64
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !53, metadata !DIExpression()), !dbg !68

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !55, metadata !DIExpression()), !dbg !68

  //   store atomic i64 %1, i64* @atom_0_X4_2 seq_cst, align 8, !dbg !69
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !73, metadata !DIExpression()), !dbg !107
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !74, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 2, metadata !76, metadata !DIExpression()), !dbg !110

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !79
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !78, metadata !DIExpression()), !dbg !112

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !80, metadata !DIExpression()), !dbg !112

  //   %conv = trunc i64 %0 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !77, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !82, metadata !DIExpression()), !dbg !107
  ...
  //   %conv3 = sext i32 %add to i64, !dbg !86

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !85, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !119

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !88
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !89, metadata !DIExpression()), !dbg !119

  //   %conv7 = trunc i64 %1 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !86, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !91, metadata !DIExpression()), !dbg !122

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !93, metadata !DIExpression()), !dbg !122

  //   %conv11 = trunc i64 %2 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !90, metadata !DIExpression()), !dbg !107

  //   %cmp = icmp eq i32 %conv11, 2, !dbg !93

  //   %conv12 = zext i1 %cmp to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !94, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !95, metadata !DIExpression()), !dbg !126

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !97, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %3, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !95
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv, 2, !dbg !96

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !98, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !99, metadata !DIExpression()), !dbg !129

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !101, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %4, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !98
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv7, 1, !dbg !99

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !102, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !103, metadata !DIExpression()), !dbg !132

  //   %5 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !105, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %5, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !142, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !143, metadata !DIExpression()), !dbg !198

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !144, metadata !DIExpression()), !dbg !200

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !148, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !152, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !155, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !207

  //   store atomic i64 0, i64* @atom_0_X4_2 monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !158, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !209

  //   store atomic i64 0, i64* @atom_1_X6_2 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !161, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !164, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !213

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !168, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !170, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !171, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !175, metadata !DIExpression()), !dbg !229

  //   %conv18 = trunc i64 %5 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !172, metadata !DIExpression()), !dbg !198

  //   %cmp19 = icmp eq i32 %conv18, 2, !dbg !134

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !176, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !178, metadata !DIExpression()), !dbg !233

  //   %6 = load atomic i64, i64* @atom_0_X4_2 seq_cst, align 8, !dbg !136
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !180, metadata !DIExpression()), !dbg !233

  //   %conv24 = trunc i64 %6 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !177, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !182, metadata !DIExpression()), !dbg !236

  //   %7 = load atomic i64, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !139
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !181, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !186, metadata !DIExpression()), !dbg !239

  //   %8 = load atomic i64, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !185, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !190, metadata !DIExpression()), !dbg !242

  //   %9 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !192, metadata !DIExpression()), !dbg !242

  //   %conv36 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !189, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !194, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !195, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !196, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !197, metadata !DIExpression()), !dbg !198
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
