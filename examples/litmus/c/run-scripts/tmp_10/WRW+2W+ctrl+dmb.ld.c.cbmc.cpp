...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !50, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !52, metadata !DIExpression()), !dbg !65
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !61), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !56, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !57, metadata !DIExpression()), !dbg !77

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !59, metadata !DIExpression()), !dbg !77

  //   store atomic i64 %1, i64* @atom_1_X0_2 seq_cst, align 8, !dbg !65
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !106, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !107, metadata !DIExpression()), !dbg !139

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !108, metadata !DIExpression()), !dbg !141

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !112, metadata !DIExpression()), !dbg !143

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !113, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !120, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !124, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !126, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !129, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !131, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !134, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !136, metadata !DIExpression()), !dbg !173
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !113
