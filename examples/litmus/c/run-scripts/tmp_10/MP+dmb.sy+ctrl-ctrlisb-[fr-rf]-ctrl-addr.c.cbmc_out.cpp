...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !105), !dbg !139
  ...
  //   %xor = xor i32 %conv22, %conv22, !dbg !124
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !106

  //   %add = add nsw i32 0, %xor, !dbg !125
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add to i64, !dbg !125

  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !125
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !145

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !125
  // LD: Guess
  old_cr = cr(2,r7);
