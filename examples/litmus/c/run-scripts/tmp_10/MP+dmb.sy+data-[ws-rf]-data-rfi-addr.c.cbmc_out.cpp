...
T2BLOCK1:
  ...
  //   %cmp22 = icmp eq i32 %conv5, 2, !dbg !104
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !150, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !151, metadata !DIExpression()), !dbg !214

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !152, metadata !DIExpression()), !dbg !216

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !156, metadata !DIExpression()), !dbg !218

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !157, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !158, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !170, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i32 0, metadata !173, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !174, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !177, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !180, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !184, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !186, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !191, metadata !DIExpression()), !dbg !252

  //   %conv24 = trunc i64 %7 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !188, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !196, metadata !DIExpression()), !dbg !256

  //   %conv30 = trunc i64 %8 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !193, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !199, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !201, metadata !DIExpression()), !dbg !260

  //   %conv36 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !198, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !202, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !208, metadata !DIExpression()), !dbg !214

  //   %and40 = and i32 %10, %and39, !dbg !168
  creg_r25 = max(creg_r19,creg_r24);
  r25 = r19 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !209, metadata !DIExpression()), !dbg !214
