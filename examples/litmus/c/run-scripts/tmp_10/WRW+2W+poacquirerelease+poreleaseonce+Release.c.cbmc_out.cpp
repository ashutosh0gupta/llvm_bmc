...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !98, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !99, metadata !DIExpression()), !dbg !129

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !100, metadata !DIExpression()), !dbg !131

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !104, metadata !DIExpression()), !dbg !133

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !105, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !106, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64 0, metadata !108, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !109, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !112, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i32 0, metadata !115, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !117, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !119, metadata !DIExpression()), !dbg !153

  //   %conv = trunc i64 %6 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !116, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !120, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !122, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !124, metadata !DIExpression()), !dbg !157

  //   %conv14 = trunc i64 %7 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !121, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !125, metadata !DIExpression()), !dbg !129

  //   %8 = load i32, i32* @atom_1_X0_2, align 4, !dbg !103, !tbaa !104
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l60_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !128, metadata !DIExpression()), !dbg !129
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([130 x i8], [130 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
