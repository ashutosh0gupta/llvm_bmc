...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !78, metadata !DIExpression()), !dbg !93

  //   %add14 = add nsw i32 %xor13, 1, !dbg !97
  creg_r8 = max(0,creg_r7);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add14, metadata !79, metadata !DIExpression()), !dbg !93
  ...
  //   %conv15 = sext i32 %add14 to i64, !dbg !99

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !82, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !99
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv4, 0, !dbg !109
  ...
  //   store i32 %conv22, i32* @atom_1_X3_0, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv8, 1, !dbg !111
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !179, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !230

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X3_0, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
