...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !51, metadata !DIExpression()), !dbg !72
  ...
  //   %conv6 = trunc i64 %1 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !50, metadata !DIExpression()), !dbg !62

  //   %xor = xor i32 %conv6, %conv6, !dbg !75
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !54, metadata !DIExpression()), !dbg !62

  //   %add = add nsw i32 %xor, 1, !dbg !76
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !55, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !56, metadata !DIExpression()), !dbg !77

  //   %conv9 = sext i32 %add to i64, !dbg !78

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !58, metadata !DIExpression()), !dbg !77

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !78
  // ST: Guess
  ...
  //   store i32 %conv10, i32* @atom_0_X3_2, align 4, !dbg !80, !tbaa !81
  // ST: Guess
  ...
  //   %cmp11 = icmp eq i32 %conv6, 2, !dbg !85
  ...
  //   store i32 %conv12, i32* @atom_0_X4_2, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_2, metadata !132, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i32 0, metadata !135, metadata !DIExpression()), !dbg !168

  //   store atomic i32 0, i32* @atom_0_X3_2 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !136, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !170

  //   store atomic i32 0, i32* @atom_0_X4_2 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !139, metadata !DIExpression()), !dbg !172
  ...
  //   %6 = load i32, i32* @atom_0_X3_2, align 4, !dbg !115, !tbaa !116
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %7 = load i32, i32* @atom_0_X4_2, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
