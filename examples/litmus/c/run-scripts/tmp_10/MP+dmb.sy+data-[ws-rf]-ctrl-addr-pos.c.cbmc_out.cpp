...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv5, 0, !dbg !87
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !92), !dbg !111
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,0+3*1);
