...
T2BLOCK4:
  ...
  //   %cmp18 = icmp eq i32 %conv4, 1, !dbg !106
  ...
  //   store i32 %conv19, i32* @atom_1_X2_1, align 4, !dbg !107, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !172, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !218

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !111
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X2_1, align 4, !dbg !142, !tbaa !140
  // LD: Guess
  old_cr = cr(0,3);
