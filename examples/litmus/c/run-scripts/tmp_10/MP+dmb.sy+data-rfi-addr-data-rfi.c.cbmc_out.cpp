...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !77, metadata !DIExpression()), !dbg !99

  //   %add13 = add nsw i32 %xor12, 1, !dbg !98
  creg_r9 = max(creg_r8,0);
  ASSUME(active[creg_r9] == 2);
  r9 = r8 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add13, metadata !78, metadata !DIExpression()), !dbg !99
  ...
  //   %conv16 = sext i32 %add13 to i64, !dbg !100

  //   call void @llvm.dbg.value(metadata i64 %conv16, metadata !81, metadata !DIExpression()), !dbg !118

  //   store atomic i64 %conv16, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !85, metadata !DIExpression()), !dbg !120

  //   %conv20 = trunc i64 %3 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !82, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 1, !dbg !104

  //   %conv21 = zext i1 %cmp to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !86, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !124

  //   %4 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !89, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv5, 1, !dbg !107

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !90, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !91, metadata !DIExpression()), !dbg !127

  //   %5 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !93, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %5, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !109
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv20, 1, !dbg !110

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !94, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !95, metadata !DIExpression()), !dbg !130

  //   %6 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !97, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %6, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !140, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !141, metadata !DIExpression()), !dbg !200

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !142, metadata !DIExpression()), !dbg !202

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !146, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !147, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64 0, metadata !149, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !150, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !159, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !161, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !162, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !165, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !217

  //   store atomic i64 0, i64* @atom_1_X10_1 monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !169, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !171, metadata !DIExpression()), !dbg !229

  //   %conv = trunc i64 %4 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !168, metadata !DIExpression()), !dbg !200

  //   %cmp = icmp eq i32 %conv, 2, !dbg !134

  //   %conv16 = zext i1 %cmp to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !172, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !176, metadata !DIExpression()), !dbg !233

  //   %conv20 = trunc i64 %5 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !173, metadata !DIExpression()), !dbg !200

  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !138

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !177, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !179, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !181, metadata !DIExpression()), !dbg !237

  //   %conv26 = trunc i64 %6 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !178, metadata !DIExpression()), !dbg !200

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !142

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !182, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !184, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !186, metadata !DIExpression()), !dbg !241

  //   %conv32 = trunc i64 %7 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !183, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !188, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !190, metadata !DIExpression()), !dbg !244

  //   %conv36 = trunc i64 %8 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !187, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !192, metadata !DIExpression()), !dbg !247

  //   %9 = load atomic i64, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !150
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !194, metadata !DIExpression()), !dbg !247

  //   %conv40 = trunc i64 %9 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !191, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !196, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !197, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !198, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !199, metadata !DIExpression()), !dbg !200
