...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !55, metadata !DIExpression()), !dbg !71
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !58, metadata !DIExpression()), !dbg !68
...
T2BLOCK2:
  //   br label %lbl_label230, !dbg !60
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label230, !dbg !61
  goto T2BLOCK4;
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !62, metadata !DIExpression()), !dbg !68
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !96
