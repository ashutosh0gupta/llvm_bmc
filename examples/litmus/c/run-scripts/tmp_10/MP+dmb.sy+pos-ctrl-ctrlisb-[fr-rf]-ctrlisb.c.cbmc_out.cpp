...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !102

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,0+1*1);
...
T2BLOCK3:
  //   br label %lbl_LC00, !dbg !90
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !93), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !111

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !111

  //   %conv8 = trunc i64 %2 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !96

  //   %tobool9 = icmp ne i32 %conv8, 0, !dbg !95
  creg__r2__0_ = max(0,creg_r2);

  //   br i1 %tobool9, label %if.then10, label %if.else11, !dbg !97
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
  ASSUME(cctrl[2] >= creg__r2__0_);
  if((r2!=0)) {
    goto T2BLOCK5;
  } else {
    goto T2BLOCK6;
...
T2BLOCK6:
  //   br label %lbl_LC01, !dbg !99
  goto T2BLOCK7;

T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !94), !dbg !119

  //   call void (...) @isb(), !dbg !101
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !76, metadata !DIExpression()), !dbg !121

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !75, metadata !DIExpression()), !dbg !96
...
T2BLOCK10:
  ...
  //   %cmp28 = icmp eq i32 %conv4, 1, !dbg !124
  ...
  //   store i32 %conv29, i32* @atom_1_X2_1, align 4, !dbg !125, !tbaa !120
  // ST: Guess
  ...
  //   store i32 %conv31, i32* @atom_1_X5_0, align 4, !dbg !127, !tbaa !120
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv19, 1, !dbg !128
  ...
  //   store i32 %conv33, i32* @atom_1_X7_1, align 4, !dbg !129, !tbaa !120
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !155, metadata !DIExpression()), !dbg !162
  ...
  // ST: Guess
  iw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l60_c3
  old_cw = cw(3,0+3*1);
  cw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l60_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !196, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !252

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !199, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i32 0, metadata !201, metadata !DIExpression()), !dbg !254

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !202, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i32 0, metadata !204, metadata !DIExpression()), !dbg !256

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !209, metadata !DIExpression()), !dbg !271

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l87_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !214, metadata !DIExpression()), !dbg !275

  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l89_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !219, metadata !DIExpression()), !dbg !279

  //   %8 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !156
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l91_c13
  // Check
  ...
  //   %10 = load i32, i32* @atom_1_X2_1, align 4, !dbg !162, !tbaa !160
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X5_0, align 4, !dbg !163, !tbaa !160
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %12 = load i32, i32* @atom_1_X7_1, align 4, !dbg !164, !tbaa !160
  // LD: Guess
  old_cr = cr(0,7);
