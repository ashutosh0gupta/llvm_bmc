...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !128, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_3, metadata !131, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i32 0, metadata !134, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !135, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i32 0, metadata !137, metadata !DIExpression()), !dbg !163

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !138, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !145, metadata !DIExpression()), !dbg !152
  ...
  //   %6 = load i32, i32* @atom_1_X5_0, align 4, !dbg !108, !tbaa !106
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !150, metadata !DIExpression()), !dbg !152
