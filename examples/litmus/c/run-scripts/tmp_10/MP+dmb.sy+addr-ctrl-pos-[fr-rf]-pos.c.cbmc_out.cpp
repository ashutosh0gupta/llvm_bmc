...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !111

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !111
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !117
  ...
  //   %cmp22 = icmp eq i32 %conv8, 0, !dbg !110
  ...
  //   store i32 %conv23, i32* @atom_1_X5_0, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X7_0, align 4, !dbg !113, !tbaa !106
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv20, 1, !dbg !116
  ...
  //   store i32 %conv29, i32* @atom_1_X9_1, align 4, !dbg !117, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !179, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !227

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !116
  // ST: Guess
  ...
  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !185, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !188, metadata !DIExpression()), !dbg !233
  ...
  //   %9 = load i32, i32* @atom_1_X5_0, align 4, !dbg !147, !tbaa !145
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_1_X7_0, align 4, !dbg !148, !tbaa !145
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X8_1, align 4, !dbg !149, !tbaa !145
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %12 = load i32, i32* @atom_1_X9_1, align 4, !dbg !150, !tbaa !145
  // LD: Guess
  old_cr = cr(0,7);
