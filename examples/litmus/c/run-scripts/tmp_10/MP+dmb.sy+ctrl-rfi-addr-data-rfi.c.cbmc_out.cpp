...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !75, metadata !DIExpression()), !dbg !89

  //   %add10 = add nsw i32 %xor9, 1, !dbg !92
  creg_r7 = max(0,creg_r6);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !76, metadata !DIExpression()), !dbg !89
  ...
  //   %conv13 = sext i32 %add10 to i64, !dbg !94

  //   call void @llvm.dbg.value(metadata i64 %conv13, metadata !79, metadata !DIExpression()), !dbg !112

  //   store atomic i64 %conv13, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   store i32 %conv20, i32* @atom_1_X4_1, align 4, !dbg !105, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !158, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !161, metadata !DIExpression()), !dbg !204
