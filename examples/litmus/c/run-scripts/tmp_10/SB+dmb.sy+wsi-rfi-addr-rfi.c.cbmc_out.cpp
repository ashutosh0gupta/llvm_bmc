...
T2BLOCK1:
  ...
  //   %add = add nsw i32 0, %xor, !dbg !72
  creg_r3 = max(0,creg_r2);
  r3 = 0 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !72

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !72
  r4 = 0+r3*1;
  creg_r4 = creg_r3;
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !82, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !86, metadata !DIExpression()), !dbg !89

  //   store i32 %conv9, i32* @atom_1_X3_2, align 4, !dbg !78, !tbaa !79
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv8, 1, !dbg !83
  creg__r5__1_ = max(0,creg_r5);

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !87, metadata !DIExpression()), !dbg !89

  //   store i32 %conv11, i32* @atom_1_X7_1, align 4, !dbg !84, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !130, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !134, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !137, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !139, metadata !DIExpression()), !dbg !170

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !96
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X7_1, align 4, !dbg !119, !tbaa !116
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !127
