...
T2BLOCK7:
  ...
  //   store i32 %conv16, i32* @atom_1_X2_2, align 4, !dbg !98, !tbaa !99
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 0, !dbg !103
  ...
  //   store i32 %conv18, i32* @atom_1_X3_0, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv8, 1, !dbg !105
  ...
  //   store i32 %conv20, i32* @atom_1_X5_1, align 4, !dbg !106, !tbaa !99
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 0, !dbg !107
  ...
  //   store i32 %conv22, i32* @atom_1_X6_0, align 4, !dbg !108, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !166, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !176, metadata !DIExpression()), !dbg !223
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
