...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !92), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !108

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv8, 0, !dbg !108
  ...
  //   store i32 %conv21, i32* @atom_1_X3_0, align 4, !dbg !109, !tbaa !102
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv12, 1, !dbg !110
  ...
  //   store i32 %conv23, i32* @atom_1_X6_1, align 4, !dbg !111, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !161, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !204

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !164, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !206

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !167, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !208

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X3_0, align 4, !dbg !137, !tbaa !134
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X6_1, align 4, !dbg !138, !tbaa !134
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X7_1, align 4, !dbg !139, !tbaa !134
  // LD: Guess
  old_cr = cr(0,6);
