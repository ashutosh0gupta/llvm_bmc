...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !85, metadata !DIExpression()), !dbg !121
  ...
  //   store i32 %conv23, i32* @atom_1_X2_0, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X4_1, align 4, !dbg !113, !tbaa !106
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv12, 1, !dbg !114
  ...
  //   store i32 %conv27, i32* @atom_1_X8_1, align 4, !dbg !115, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !227

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !229

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !231

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !165, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !166, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !169, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !172, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !175, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !178, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !182, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !185, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !188, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !191, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i32 0, metadata !193, metadata !DIExpression()), !dbg !250

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !139
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !195, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !197, metadata !DIExpression()), !dbg !263

  //   %conv = trunc i64 %6 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !194, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !198, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !200, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !202, metadata !DIExpression()), !dbg !267

  //   %conv26 = trunc i64 %7 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !199, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !203, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !205, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !207, metadata !DIExpression()), !dbg !271

  //   %conv32 = trunc i64 %8 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !204, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !208, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !210, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !212, metadata !DIExpression()), !dbg !275

  //   %conv38 = trunc i64 %9 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !209, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !213, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !214, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !215, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !216, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !217, metadata !DIExpression()), !dbg !227

  //   %14 = load i32, i32* @atom_1_X10_0, align 4, !dbg !175, !tbaa !170
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !218, metadata !DIExpression()), !dbg !227

  //   %and = and i32 %13, %14, !dbg !176
  creg_r24 = max(creg_r22,creg_r23);
  r24 = r22 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !219, metadata !DIExpression()), !dbg !227

  //   %and41 = and i32 %12, %and, !dbg !177
  creg_r25 = max(creg_r21,creg_r24);
  r25 = r21 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !220, metadata !DIExpression()), !dbg !227

  //   %and42 = and i32 %11, %and41, !dbg !178
  creg_r26 = max(creg_r20,creg_r25);
  r26 = r20 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !221, metadata !DIExpression()), !dbg !227

  //   %and43 = and i32 %10, %and42, !dbg !179
  creg_r27 = max(creg_r19,creg_r26);
  r27 = r19 & r26;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !222, metadata !DIExpression()), !dbg !227

  //   %and44 = and i32 %conv40, %and43, !dbg !180
  creg_r28 = max(creg__r18__1_,creg_r27);
  r28 = (r18==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !223, metadata !DIExpression()), !dbg !227

  //   %and45 = and i32 %conv34, %and44, !dbg !181
  creg_r29 = max(creg__r17__1_,creg_r28);
  r29 = (r17==1) & r28;

  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !224, metadata !DIExpression()), !dbg !227

  //   %and46 = and i32 %conv28, %and45, !dbg !182
  creg_r30 = max(creg__r16__1_,creg_r29);
  r30 = (r16==1) & r29;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !225, metadata !DIExpression()), !dbg !227

  //   %and47 = and i32 %conv22, %and46, !dbg !183
  creg_r31 = max(creg__r15__1_,creg_r30);
  r31 = (r15==1) & r30;

  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !226, metadata !DIExpression()), !dbg !227
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 104, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187
