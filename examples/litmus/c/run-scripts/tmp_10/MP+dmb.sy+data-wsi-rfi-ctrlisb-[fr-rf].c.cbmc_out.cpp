...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !66, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !99

  //   %conv1 = sext i32 %add to i64, !dbg !81

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !69, metadata !DIExpression()), !dbg !99

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64 2, metadata !72, metadata !DIExpression()), !dbg !101

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !83
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !76, metadata !DIExpression()), !dbg !103

  //   %conv7 = trunc i64 %1 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !73, metadata !DIExpression()), !dbg !91

  //   %tobool = icmp ne i32 %conv7, 0, !dbg !87
...
T2BLOCK4:
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp17 = icmp eq i32 %conv7, 2, !dbg !106
  ...
  //   store i32 %conv18, i32* @atom_1_X5_2, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv11, 0, !dbg !108
  ...
  //   store i32 %conv20, i32* @atom_1_X6_0, align 4, !dbg !109, !tbaa !102
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 1, !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X8_1, align 4, !dbg !111, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !173, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !176, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !179, metadata !DIExpression()), !dbg !226
