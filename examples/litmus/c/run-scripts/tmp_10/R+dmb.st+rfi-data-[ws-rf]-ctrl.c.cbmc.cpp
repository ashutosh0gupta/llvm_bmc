...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !58, metadata !DIExpression()), !dbg !84
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64 2, metadata !61, metadata !DIExpression()), !dbg !87

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !69
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !63, metadata !DIExpression()), !dbg !89

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !71
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !65, metadata !DIExpression()), !dbg !89

  //   %conv = trunc i64 %0 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !62, metadata !DIExpression()), !dbg !84

  //   %xor = xor i32 %conv, %conv, !dbg !73
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !66, metadata !DIExpression()), !dbg !84

  //   %add = add nsw i32 %xor, 1, !dbg !74
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !67, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !94

  //   %conv3 = sext i32 %add to i64, !dbg !76

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !70, metadata !DIExpression()), !dbg !94

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !76
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !74, metadata !DIExpression()), !dbg !96

  //   %conv7 = trunc i64 %1 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !71, metadata !DIExpression()), !dbg !84

  //   %tobool = icmp ne i32 %conv7, 0, !dbg !80
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !83), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !105

  //   %conv11 = trunc i64 %2 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !75, metadata !DIExpression()), !dbg !84

  //   %cmp = icmp eq i32 %conv, 2, !dbg !89
  creg__r0__2_ = max(0,creg_r0);

  //   %conv12 = zext i1 %cmp to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !79, metadata !DIExpression()), !dbg !84

  //   store i32 %conv12, i32* @atom_1_X2_2, align 4, !dbg !90, !tbaa !91
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv7, 2, !dbg !95
  creg__r3__2_ = max(0,creg_r3);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !80, metadata !DIExpression()), !dbg !84

  //   store i32 %conv14, i32* @atom_1_X5_2, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv11, 0, !dbg !97
  creg__r4__0_ = max(0,creg_r4);

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !81, metadata !DIExpression()), !dbg !84

  //   store i32 %conv16, i32* @atom_1_X6_0, align 4, !dbg !98, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !139, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !140, metadata !DIExpression()), !dbg !189

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !141, metadata !DIExpression()), !dbg !191

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !145, metadata !DIExpression()), !dbg !193

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !146, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !147, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64 0, metadata !149, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64 0, metadata !152, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !156, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !160, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !163, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !206

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !169, metadata !DIExpression()), !dbg !219

  //   %conv = trunc i64 %6 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !166, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !170, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !174, metadata !DIExpression()), !dbg !223

  //   %conv20 = trunc i64 %7 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !171, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !177, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !179, metadata !DIExpression()), !dbg !227

  //   %conv26 = trunc i64 %8 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !176, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !180, metadata !DIExpression()), !dbg !189
  ...
  //   %11 = load i32, i32* @atom_1_X6_0, align 4, !dbg !140, !tbaa !137
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !185, metadata !DIExpression()), !dbg !189

  //   %and30 = and i32 %conv28, %and29, !dbg !143
  creg_r17 = max(creg__r11__2_,creg_r16);
  r17 = (r11==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !186, metadata !DIExpression()), !dbg !189

  //   %and31 = and i32 %conv22, %and30, !dbg !144
  creg_r18 = max(creg__r10__2_,creg_r17);
  r18 = (r10==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !187, metadata !DIExpression()), !dbg !189

  //   %and32 = and i32 %conv16, %and31, !dbg !145
  creg_r19 = max(creg__r9__1_,creg_r18);
  r19 = (r9==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !188, metadata !DIExpression()), !dbg !189
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 87, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
