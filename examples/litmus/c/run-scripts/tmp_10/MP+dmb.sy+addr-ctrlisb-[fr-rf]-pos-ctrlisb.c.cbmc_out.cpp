...
T2BLOCK7:
  ...
  //   %cmp25 = icmp eq i32 %conv8, 0, !dbg !119
  ...
  //   store i32 %conv26, i32* @atom_1_X5_0, align 4, !dbg !120, !tbaa !115
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv12, 1, !dbg !121
  ...
  //   store i32 %conv28, i32* @atom_1_X7_1, align 4, !dbg !122, !tbaa !115
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv16, 1, !dbg !123
  ...
  //   store i32 %conv30, i32* @atom_1_X8_1, align 4, !dbg !124, !tbaa !115
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !191, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !194, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !197, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !204, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !209, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !214, metadata !DIExpression()), !dbg !274
