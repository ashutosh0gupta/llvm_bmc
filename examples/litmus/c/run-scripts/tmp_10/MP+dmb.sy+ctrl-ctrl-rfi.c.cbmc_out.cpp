...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !75), !dbg !88
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !76), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !98
  ...
  //   store i32 %conv12, i32* @atom_1_X0_1, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv11, 1, !dbg !90
  ...
  //   store i32 %conv14, i32* @atom_1_X6_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !135, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !139, metadata !DIExpression()), !dbg !170
