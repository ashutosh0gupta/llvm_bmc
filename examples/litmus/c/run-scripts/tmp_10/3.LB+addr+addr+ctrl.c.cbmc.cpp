...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !102, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 1, metadata !104, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !105, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !106, metadata !DIExpression()), !dbg !126

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !108, metadata !DIExpression()), !dbg !126
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !136, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !137, metadata !DIExpression()), !dbg !176

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !138, metadata !DIExpression()), !dbg !178

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !142, metadata !DIExpression()), !dbg !180

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !143, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !153, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !159, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !162, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !166, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !171, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !173, metadata !DIExpression()), !dbg !214

  //   %conv23 = trunc i64 %8 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !170, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !174, metadata !DIExpression()), !dbg !176
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
