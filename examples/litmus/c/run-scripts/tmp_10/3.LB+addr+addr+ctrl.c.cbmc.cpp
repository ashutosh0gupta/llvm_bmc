...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !73, metadata !DIExpression()), !dbg !79

  //   %add = add nsw i32 2, %xor, !dbg !57
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !74, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64 1, metadata !76, metadata !DIExpression()), !dbg !87
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !93, metadata !DIExpression()), !dbg !104
...
T3BLOCK1:
  ...
  // LD: Guess
  old_cr = cr(3,0+2*1);
  cr(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l41_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !94, metadata !DIExpression()), !dbg !104
...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !98, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64 1, metadata !100, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !101, metadata !DIExpression()), !dbg !104
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !145, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !149, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !152, metadata !DIExpression()), !dbg !177
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
