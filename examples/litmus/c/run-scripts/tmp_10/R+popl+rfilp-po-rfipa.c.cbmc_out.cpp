...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !78, metadata !DIExpression()), !dbg !101

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !70
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !77, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64 1, metadata !83, metadata !DIExpression()), !dbg !104

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !73
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv, 2, !dbg !86
  ...
  //   store i32 %conv13, i32* @atom_1_X2_2, align 4, !dbg !87, !tbaa !82
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !146, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X2_2, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
