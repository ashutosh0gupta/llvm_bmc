...
T0BLOCK0:
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(0,0+1*1);
