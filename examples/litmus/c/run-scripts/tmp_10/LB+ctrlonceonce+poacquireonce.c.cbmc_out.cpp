...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !42, metadata !DIExpression()), !dbg !52
...
T1BLOCK2:
  //   br label %lbl_label100, !dbg !62
  goto T1BLOCK4;

T1BLOCK3:
  //   br label %lbl_label100, !dbg !63
  goto T1BLOCK4;

T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !51), !dbg !64
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !46, metadata !DIExpression()), !dbg !52

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !47, metadata !DIExpression()), !dbg !68
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !89
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !118, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !121, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !125, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !127, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !131, metadata !DIExpression()), !dbg !159

  //   %conv13 = trunc i64 %5 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !128, metadata !DIExpression()), !dbg !133
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 57, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !101
