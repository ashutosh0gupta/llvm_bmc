...
T1BLOCK1:
  //   call void @llvm.dbg.label(metadata !47), !dbg !51
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !42, metadata !DIExpression()), !dbg !49
...
T1BLOCK2:
  //   br label %lbl_label100, !dbg !59
  goto T1BLOCK4;

T1BLOCK3:
  //   br label %lbl_label100, !dbg !60
  goto T1BLOCK4;

T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !48), !dbg !61
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !45, metadata !DIExpression()), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !46, metadata !DIExpression()), !dbg !49

  //   store i32 %conv3, i32* @atom_0_X0_1, align 4, !dbg !65, !tbaa !66
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !78, metadata !DIExpression()), !dbg !89
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 57, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
