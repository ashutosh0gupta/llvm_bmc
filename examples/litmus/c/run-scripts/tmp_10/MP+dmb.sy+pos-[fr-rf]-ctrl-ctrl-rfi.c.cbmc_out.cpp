...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !130

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv4, 1, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !89, metadata !DIExpression()), !dbg !139
  ...
  //   %cmp29 = icmp eq i32 %conv8, 2, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !93, metadata !DIExpression()), !dbg !142

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %7, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !188, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !191, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !212, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !216, metadata !DIExpression()), !dbg !276
