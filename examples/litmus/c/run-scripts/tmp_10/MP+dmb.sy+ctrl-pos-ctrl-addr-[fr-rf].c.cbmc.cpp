...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !71, metadata !DIExpression()), !dbg !90

  //   %xor = xor i32 %conv15, %conv15, !dbg !98
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !119
  ...
  //   store i32 %conv26, i32* @atom_1_X8_0, align 4, !dbg !112, !tbaa !107
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv23, 1, !dbg !113
  ...
  //   store i32 %conv28, i32* @atom_1_X10_1, align 4, !dbg !114, !tbaa !107
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !179, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !182, metadata !DIExpression()), !dbg !221
