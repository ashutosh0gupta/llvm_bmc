...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !86), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !72, metadata !DIExpression()), !dbg !111

  //   %conv15 = trunc i64 %3 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !69, metadata !DIExpression()), !dbg !87
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !76, metadata !DIExpression()), !dbg !114

  //   %conv19 = trunc i64 %4 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !73, metadata !DIExpression()), !dbg !87

  //   %xor = xor i32 %conv19, %conv19, !dbg !98
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !77, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !119

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !81, metadata !DIExpression()), !dbg !119
