...
T2BLOCK1:
  ...
  //   %cmp24 = icmp eq i32 %conv12, 2, !dbg !97
  ...
  //   store i32 %conv25, i32* @atom_1_X8_2, align 4, !dbg !98, !tbaa !93
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !124, metadata !DIExpression()), !dbg !131
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_2, metadata !165, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X12_1, metadata !168, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i32 0, metadata !170, metadata !DIExpression()), !dbg !213

  //   store atomic i32 0, i32* @atom_1_X12_1 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !182, metadata !DIExpression()), !dbg !234
  ...
  //   %11 = load i32, i32* @atom_1_X12_1, align 4, !dbg !145, !tbaa !142
  // LD: Guess
  old_cr = cr(0,6);
  ...
  creg_r26 = max(creg__r18__2_,creg_r25);
  r26 = (r18==2) & r25;
