...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !96
  ...
  //   store i32 %conv9, i32* @atom_1_X6_0, align 4, !dbg !77, !tbaa !72
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !134, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !137, metadata !DIExpression()), !dbg !178
  ...
  //   %8 = load i32, i32* @atom_1_X4_0, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
