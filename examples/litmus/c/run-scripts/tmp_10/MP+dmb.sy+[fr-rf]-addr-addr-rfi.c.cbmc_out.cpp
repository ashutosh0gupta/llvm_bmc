...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !72, metadata !DIExpression()), !dbg !84

  //   %add10 = add nsw i32 0, %xor9, !dbg !79
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !79

  //   %arrayidx12 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !79
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !73, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !99

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !79
  // ST: Guess
  ...
  //   store i32 %conv19, i32* @atom_1_X2_2, align 4, !dbg !91, !tbaa !86
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !117, metadata !DIExpression()), !dbg !124
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !141, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !151, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !155, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !158, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !164, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !165, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !167, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !169, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !170, metadata !DIExpression()), !dbg !178
