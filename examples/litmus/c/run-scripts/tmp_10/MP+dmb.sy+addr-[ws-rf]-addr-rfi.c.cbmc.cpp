...
T2BLOCK1:
  ...
  //   %xor5 = xor i32 %conv4, %conv4, !dbg !76
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !71, metadata !DIExpression()), !dbg !83

  //   %add7 = add nsw i32 0, %xor5, !dbg !77
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !77

  //   %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !77
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !72, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !97

  //   store atomic i64 1, i64* %arrayidx9 monotonic, align 8, !dbg !77
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !98

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !98

  //   %conv14 = trunc i64 %2 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !75, metadata !DIExpression()), !dbg !83

  //   %cmp = icmp eq i32 %conv, 1, !dbg !82
  creg__r0__1_ = max(0,creg_r0);

  //   %conv15 = zext i1 %cmp to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !79, metadata !DIExpression()), !dbg !83

  //   store i32 %conv15, i32* @atom_1_X0_1, align 4, !dbg !83, !tbaa !84
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv4, 2, !dbg !88
  ...
  //   store i32 %conv17, i32* @atom_1_X5_2, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv14, 1, !dbg !90
  ...
  //   store i32 %conv19, i32* @atom_1_X9_1, align 4, !dbg !91, !tbaa !84
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !115, metadata !DIExpression()), !dbg !122
  ...
  // ST: Guess
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l47_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l47_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !132, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !133, metadata !DIExpression()), !dbg !182

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !134, metadata !DIExpression()), !dbg !184

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !138, metadata !DIExpression()), !dbg !186

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !139, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !140, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !143, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !146, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !156, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !199

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !162, metadata !DIExpression()), !dbg !212

  //   %conv = trunc i64 %6 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !159, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !163, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !165, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !167, metadata !DIExpression()), !dbg !216

  //   %conv20 = trunc i64 %7 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !164, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !168, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !172, metadata !DIExpression()), !dbg !220

  //   %conv26 = trunc i64 %8 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !169, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !173, metadata !DIExpression()), !dbg !182
  ...
  //   %11 = load i32, i32* @atom_1_X9_1, align 4, !dbg !140, !tbaa !137
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !176, metadata !DIExpression()), !dbg !182

  //   %and = and i32 %10, %11, !dbg !141
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !177, metadata !DIExpression()), !dbg !182

  //   %and29 = and i32 %9, %and, !dbg !142
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !178, metadata !DIExpression()), !dbg !182

  //   %and30 = and i32 %conv28, %and29, !dbg !143
  creg_r21 = max(creg__r15__2_,creg_r20);
  r21 = (r15==2) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !179, metadata !DIExpression()), !dbg !182

  //   %and31 = and i32 %conv22, %and30, !dbg !144
  creg_r22 = max(creg__r14__1_,creg_r21);
  r22 = (r14==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !180, metadata !DIExpression()), !dbg !182

  //   %and32 = and i32 %conv16, %and31, !dbg !145
  creg_r23 = max(creg__r13__2_,creg_r22);
  r23 = (r13==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !181, metadata !DIExpression()), !dbg !182
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
