...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !52
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !57

  //   %conv1 = sext i32 %add to i64, !dbg !58

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !46, metadata !DIExpression()), !dbg !57

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !58
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !92
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !69
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  if(cr(2,0+2*1) < cw(2,0+2*1)) {
    ...
    r8 = mem(0+2*1,cr(2,0+2*1));
  }
  ASSUME(creturn[2] >= cr(2,0+2*1));

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !81, metadata !DIExpression()), !dbg !99

  //   %conv8 = trunc i64 %2 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !78, metadata !DIExpression()), !dbg !89

  //   %xor9 = xor i32 %conv8, %conv8, !dbg !71
  creg_r9 = creg_r8;
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !82, metadata !DIExpression()), !dbg !89

  //   %add10 = add nsw i32 %xor9, 1, !dbg !72
  creg_r10 = max(0,creg_r9);
  r10 = r9 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !83, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !104

  //   %conv11 = sext i32 %add10 to i64, !dbg !74

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !86, metadata !DIExpression()), !dbg !104

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !74
  // ST: Guess
  ...
  //   %conv12 = zext i1 %cmp to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !87, metadata !DIExpression()), !dbg !89

  //   store i32 %conv12, i32* @atom_1_X0_1, align 4, !dbg !76, !tbaa !77
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !116, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !117, metadata !DIExpression()), !dbg !154

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !118, metadata !DIExpression()), !dbg !156

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !122, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !123, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64 0, metadata !125, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !126, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 0, metadata !128, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 0, metadata !131, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !132, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i32 0, metadata !135, metadata !DIExpression()), !dbg !165

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !136, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !167
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !94
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !100
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !142, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !143, metadata !DIExpression()), !dbg !154
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !147, metadata !DIExpression()), !dbg !181

  //   %conv16 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !144, metadata !DIExpression()), !dbg !154

  //   %cmp17 = icmp eq i32 %conv16, 1, !dbg !110
  creg__r15__1_ = max(0,creg_r15);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !148, metadata !DIExpression()), !dbg !154

  //   %6 = load i32, i32* @atom_0_X0_1, align 4, !dbg !111, !tbaa !112
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !114, !tbaa !112
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %and19 = and i32 %conv18, %and, !dbg !116
  creg_r19 = max(creg__r15__1_,creg_r18);
  r19 = (r15==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !152, metadata !DIExpression()), !dbg !154

  //   %and20 = and i32 %conv12, %and19, !dbg !117
  creg_r20 = max(creg__r14__1_,creg_r19);
  r20 = (r14==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !153, metadata !DIExpression()), !dbg !154

  //   %cmp21 = icmp eq i32 %and20, 1, !dbg !118
  creg__r20__1_ = max(0,creg_r20);

  //   br i1 %cmp21, label %if.then, label %if.end, !dbg !120
  old_cctrl = cctrl[0];
