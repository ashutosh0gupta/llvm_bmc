...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !57, metadata !DIExpression()), !dbg !64
...
T2BLOCK2:
  //   br label %lbl_label137, !dbg !61
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label137, !dbg !62
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !63), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !61, metadata !DIExpression()), !dbg !64
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !90, metadata !DIExpression()), !dbg !103
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !143, metadata !DIExpression()), !dbg !166
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
