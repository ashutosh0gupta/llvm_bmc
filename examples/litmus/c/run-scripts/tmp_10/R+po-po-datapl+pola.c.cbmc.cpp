...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !40, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64 1, metadata !42, metadata !DIExpression()), !dbg !67

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !45, metadata !DIExpression()), !dbg !69

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !70
  // LD: Guess
  old_cr = cr(1,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !43, metadata !DIExpression()), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !48, metadata !DIExpression()), !dbg !62

  //   %add = add nsw i32 %xor, 1, !dbg !73
  creg_r2 = max(creg_r1,0);
  ASSUME(active[creg_r2] == 1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !49, metadata !DIExpression()), !dbg !62
  ...
  //   %conv5 = sext i32 %add to i64, !dbg !75

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !52, metadata !DIExpression()), !dbg !74

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !75
  // ST: Guess
  //   : Release
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !204

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,0+1*1);
