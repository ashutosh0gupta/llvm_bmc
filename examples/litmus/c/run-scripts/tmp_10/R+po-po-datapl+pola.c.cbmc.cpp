...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !36, metadata !DIExpression()), !dbg !59
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !37, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64 1, metadata !40, metadata !DIExpression()), !dbg !62

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !41, metadata !DIExpression()), !dbg !64

  //   call void @llvm.dbg.value(metadata i64 1, metadata !43, metadata !DIExpression()), !dbg !64

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !65
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !45, metadata !DIExpression()), !dbg !66

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !67
  // LD: Guess
  old_cr = cr(1,0+2*1);
  cr(1,0+2*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l22_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !44, metadata !DIExpression()), !dbg !59

  //   %xor = xor i32 %conv, %conv, !dbg !69
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !48, metadata !DIExpression()), !dbg !59

  //   %add = add nsw i32 %xor, 1, !dbg !70
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !49, metadata !DIExpression()), !dbg !59

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !50, metadata !DIExpression()), !dbg !71

  //   %conv5 = sext i32 %add to i64, !dbg !72

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !52, metadata !DIExpression()), !dbg !71

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !72
  // ST: Guess
  //   : Release
  iw(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l25_c3
  old_cw = cw(1,0+3*1);
  cw(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l25_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !54, metadata !DIExpression()), !dbg !73

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !74
  // LD: Guess
  old_cr = cr(1,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !56, metadata !DIExpression()), !dbg !73

  //   %conv9 = trunc i64 %1 to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !53, metadata !DIExpression()), !dbg !59

  //   %cmp = icmp eq i32 %conv9, 2, !dbg !76
  creg__r3__2_ = max(0,creg_r3);

  //   %conv10 = zext i1 %cmp to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !57, metadata !DIExpression()), !dbg !59

  //   store i32 %conv10, i32* @atom_0_X8_2, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  iw(1,4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l28_c15
  old_cw = cw(1,4);
  cw(1,4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l28_c15
  // Check
  ASSUME(active[iw(1,4)] == 1);
  ASSUME(active[cw(1,4)] == 1);
  ASSUME(sforbid(4,cw(1,4))== 0);
  ASSUME(iw(1,4) >= creg__r3__2_);
  ASSUME(iw(1,4) >= 0);
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !85, metadata !DIExpression()), !dbg !95
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !86, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64 2, metadata !88, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !90, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !92, metadata !DIExpression()), !dbg !100

  //   %conv = trunc i64 %0 to i32, !dbg !54

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !89, metadata !DIExpression()), !dbg !95
  ...
  // ST: Guess
  iw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l37_c15
  old_cw = cw(2,5);
  cw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l37_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !113, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !114, metadata !DIExpression()), !dbg !160

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !115, metadata !DIExpression()), !dbg !162

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !119, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !120, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64 0, metadata !122, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !123, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64 0, metadata !125, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !126, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X8_2, metadata !132, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i32 0, metadata !135, metadata !DIExpression()), !dbg !173

  //   store atomic i32 0, i32* @atom_0_X8_2 monotonic, align 4, !dbg !101
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l49_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l49_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !136, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !175

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !103
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l50_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l50_c3
  // Check
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !105
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call12 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !111
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !140, metadata !DIExpression()), !dbg !185

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l58_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !142, metadata !DIExpression()), !dbg !185

  //   %conv = trunc i64 %4 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !139, metadata !DIExpression()), !dbg !160

  //   %cmp = icmp eq i32 %conv, 2, !dbg !117
  creg__r8__2_ = max(0,creg_r8);

  //   %conv14 = zext i1 %cmp to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !143, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !147, metadata !DIExpression()), !dbg !189

  //   %conv18 = trunc i64 %5 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !144, metadata !DIExpression()), !dbg !160

  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !121
  creg__r9__1_ = max(0,creg_r9);

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !148, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !193

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !123
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !152, metadata !DIExpression()), !dbg !193

  //   %conv24 = trunc i64 %6 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !149, metadata !DIExpression()), !dbg !160

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !125
  creg__r10__1_ = max(0,creg_r10);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !153, metadata !DIExpression()), !dbg !160

  //   %7 = load i32, i32* @atom_0_X8_2, align 4, !dbg !126, !tbaa !127
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l64_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !154, metadata !DIExpression()), !dbg !160

  //   %8 = load i32, i32* @atom_1_X2_0, align 4, !dbg !129, !tbaa !127
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l65_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !155, metadata !DIExpression()), !dbg !160

  //   %and = and i32 %7, %8, !dbg !130
  creg_r13 = max(creg_r11,creg_r12);
  r13 = r11 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !156, metadata !DIExpression()), !dbg !160

  //   %and27 = and i32 %conv26, %and, !dbg !131
  creg_r14 = max(creg__r10__1_,creg_r13);
  r14 = (r10==1) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !157, metadata !DIExpression()), !dbg !160

  //   %and28 = and i32 %conv20, %and27, !dbg !132
  creg_r15 = max(creg__r9__1_,creg_r14);
  r15 = (r9==1) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !158, metadata !DIExpression()), !dbg !160

  //   %and29 = and i32 %conv14, %and28, !dbg !133
  creg_r16 = max(creg__r8__2_,creg_r15);
  r16 = (r8==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !159, metadata !DIExpression()), !dbg !160

  //   %cmp30 = icmp eq i32 %and29, 1, !dbg !134
  creg__r16__1_ = max(0,creg_r16);

  //   br i1 %cmp30, label %if.then, label %if.end, !dbg !136
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !137
...
T0BLOCK2:
  //   %9 = bitcast i64* %thr1 to i8*, !dbg !140

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #7, !dbg !140

  //   %10 = bitcast i64* %thr0 to i8*, !dbg !140

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !140
