...
T2BLOCK1:
  ...
  //   %xor9 = xor i32 %conv8, %conv8, !dbg !97
  creg_r6 = max(creg_r5,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !74, metadata !DIExpression()), !dbg !103

  //   %add10 = add nsw i32 0, %xor9, !dbg !98
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 0 + r6;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !98

  //   %arrayidx12 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !98
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !75, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !118

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !78, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !82, metadata !DIExpression()), !dbg !103

  //   %cmp = icmp eq i32 %conv, 1, !dbg !106

  //   %conv21 = zext i1 %cmp to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !86, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !126

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !126
  ...
  //   %cmp25 = icmp eq i32 %conv4, 2, !dbg !109

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !90, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !91, metadata !DIExpression()), !dbg !129

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !129
  ...
  //   %cmp30 = icmp eq i32 %conv16, 1, !dbg !112

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !94, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !95, metadata !DIExpression()), !dbg !132

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %7, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !114
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv20, 1, !dbg !115

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !98, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !99, metadata !DIExpression()), !dbg !135

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %8, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !181, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !235

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !184, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !237

  //   store atomic i64 0, i64* @atom_1_X10_1 monotonic, align 8, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !206, metadata !DIExpression()), !dbg !266

  //   %10 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !153
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !210, metadata !DIExpression()), !dbg !269

  //   %11 = load atomic i64, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !156
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
