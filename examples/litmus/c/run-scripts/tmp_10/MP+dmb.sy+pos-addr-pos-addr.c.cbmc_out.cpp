...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !67, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !71, metadata !DIExpression()), !dbg !96

  //   %conv8 = trunc i64 %2 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !98

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !98

  //   %conv12 = trunc i64 %3 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !72, metadata !DIExpression()), !dbg !85

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !82
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !76, metadata !DIExpression()), !dbg !85

  //   %add15 = add nsw i32 0, %xor13, !dbg !83
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !83

  //   %arrayidx17 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !83
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !78, metadata !DIExpression()), !dbg !103

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !103

  //   %conv20 = trunc i64 %4 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !77, metadata !DIExpression()), !dbg !85

  //   %cmp = icmp eq i32 %conv, 1, !dbg !86
  creg__r0__1_ = max(0,creg_r0);

  //   %conv21 = zext i1 %cmp to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !81, metadata !DIExpression()), !dbg !85

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !92
  creg__r1__1_ = max(0,creg_r1);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !82, metadata !DIExpression()), !dbg !85

  //   store i32 %conv23, i32* @atom_1_X2_1, align 4, !dbg !93, !tbaa !88
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv20, 0, !dbg !94
  creg__r10__0_ = max(0,creg_r10);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !83, metadata !DIExpression()), !dbg !85

  //   store i32 %conv25, i32* @atom_1_X8_0, align 4, !dbg !95, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !139, metadata !DIExpression()), !dbg !177
