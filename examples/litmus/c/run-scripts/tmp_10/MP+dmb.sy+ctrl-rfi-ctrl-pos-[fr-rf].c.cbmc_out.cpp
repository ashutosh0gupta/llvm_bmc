...
T2BLOCK7:
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !74, metadata !DIExpression()), !dbg !94
  ...
  //   %cmp23 = icmp eq i32 %conv11, 0, !dbg !115
  ...
  //   store i32 %conv24, i32* @atom_1_X5_0, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   store i32 %conv26, i32* @atom_1_X7_0, align 4, !dbg !118, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !185, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !188, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !240

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X7_0, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
