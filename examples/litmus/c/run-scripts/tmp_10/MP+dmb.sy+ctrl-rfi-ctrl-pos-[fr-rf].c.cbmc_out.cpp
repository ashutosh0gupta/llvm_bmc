...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !108), !dbg !131

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !132

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !77, metadata !DIExpression()), !dbg !132

  //   %conv11 = trunc i64 %2 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !74, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !95, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !99, metadata !DIExpression()), !dbg !151

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %8, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !133
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !200, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !203, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !233, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !237, metadata !DIExpression()), !dbg !308
