...
T2BLOCK7:
  ...
  //   store i32 %conv22, i32* @atom_1_X3_0, align 4, !dbg !116, !tbaa !111
  // ST: Guess
  ...
  //   store i32 %conv24, i32* @atom_1_X5_1, align 4, !dbg !118, !tbaa !111
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !163, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !164, metadata !DIExpression()), !dbg !232

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !165, metadata !DIExpression()), !dbg !234

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !169, metadata !DIExpression()), !dbg !236

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !170, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !171, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !174, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !177, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !183, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !187, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !190, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !193, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !196, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !200, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !202, metadata !DIExpression()), !dbg !268

  //   %conv = trunc i64 %6 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !199, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !203, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !205, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !207, metadata !DIExpression()), !dbg !272

  //   %conv26 = trunc i64 %7 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !204, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !208, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !210, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !212, metadata !DIExpression()), !dbg !276

  //   %conv32 = trunc i64 %8 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !209, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !213, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !215, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !214, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !219, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !220, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !221, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !222, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !223, metadata !DIExpression()), !dbg !232

  //   %and = and i32 %13, %14, !dbg !176
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !224, metadata !DIExpression()), !dbg !232

  //   %and41 = and i32 %12, %and, !dbg !177
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !225, metadata !DIExpression()), !dbg !232

  //   %and42 = and i32 %11, %and41, !dbg !178
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !226, metadata !DIExpression()), !dbg !232

  //   %and43 = and i32 %10, %and42, !dbg !179
  creg_r24 = max(creg_r16,creg_r23);
  r24 = r16 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !227, metadata !DIExpression()), !dbg !232

  //   %and44 = and i32 %conv40, %and43, !dbg !180
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !228, metadata !DIExpression()), !dbg !232

  //   %and45 = and i32 %conv34, %and44, !dbg !181
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !229, metadata !DIExpression()), !dbg !232

  //   %and46 = and i32 %conv28, %and45, !dbg !182
  creg_r27 = max(creg__r13__1_,creg_r26);
  r27 = (r13==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !230, metadata !DIExpression()), !dbg !232

  //   %and47 = and i32 %conv22, %and46, !dbg !183
  creg_r28 = max(creg__r12__1_,creg_r27);
  r28 = (r12==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !231, metadata !DIExpression()), !dbg !232
