...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !78), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !63, metadata !DIExpression()), !dbg !91
  ...
  //   %cmp10 = icmp eq i32 %conv4, 1, !dbg !86
  ...
  //   store i32 %conv11, i32* @atom_1_X4_1, align 4, !dbg !87, !tbaa !82
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !130, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !134, metadata !DIExpression()), !dbg !168
