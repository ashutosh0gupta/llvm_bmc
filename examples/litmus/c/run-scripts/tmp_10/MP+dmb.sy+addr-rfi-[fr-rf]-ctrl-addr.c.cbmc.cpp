...
T2BLOCK4:
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !107
  ...
  //   store i32 %conv23, i32* @atom_1_X5_1, align 4, !dbg !108, !tbaa !103
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 2, !dbg !109
  ...
  //   store i32 %conv25, i32* @atom_1_X6_2, align 4, !dbg !110, !tbaa !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !177, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !228

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !180, metadata !DIExpression()), !dbg !230
  ...
  //   %10 = load i32, i32* @atom_1_X5_1, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
