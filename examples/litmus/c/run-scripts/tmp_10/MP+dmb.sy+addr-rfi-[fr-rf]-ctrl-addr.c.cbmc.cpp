...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !188, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !251

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !217, metadata !DIExpression()), !dbg !285

  //   %10 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,5);
