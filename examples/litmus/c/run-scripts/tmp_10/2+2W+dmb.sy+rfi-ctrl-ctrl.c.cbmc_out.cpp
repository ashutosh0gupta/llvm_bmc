...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !73), !dbg !78
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !74), !dbg !89
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !75), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !66, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !69, metadata !DIExpression()), !dbg !76

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !70, metadata !DIExpression()), !dbg !102

  //   %2 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !102

  //   store atomic i64 %2, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !84
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !112, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !113, metadata !DIExpression()), !dbg !147

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !114, metadata !DIExpression()), !dbg !149

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !118, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !128, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !132, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !134, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !139, metadata !DIExpression()), !dbg !174

  //   %conv14 = trunc i64 %5 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !136, metadata !DIExpression()), !dbg !147

  //   %cmp15 = icmp eq i32 %conv14, 2, !dbg !103

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !140, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !142, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !144, metadata !DIExpression()), !dbg !178

  //   %conv20 = trunc i64 %6 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !141, metadata !DIExpression()), !dbg !147
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !112
