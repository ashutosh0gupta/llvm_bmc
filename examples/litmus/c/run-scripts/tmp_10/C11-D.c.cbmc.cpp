...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !39, metadata !DIExpression()), !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !40, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !45, metadata !DIExpression()), !dbg !60
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X9_1, metadata !49, metadata !DIExpression()), !dbg !64

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !51, metadata !DIExpression()), !dbg !64

  //   store atomic i64 %1, i64* @atom_0_X9_1 seq_cst, align 8, !dbg !65
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !81, metadata !DIExpression()), !dbg !96

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !83, metadata !DIExpression()), !dbg !96

  //   store atomic i64 %1, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !65
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X9_1, metadata !119, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64 0, metadata !121, metadata !DIExpression()), !dbg !155

  //   store atomic i64 0, i64* @atom_0_X9_1 monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !122, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64 0, metadata !124, metadata !DIExpression()), !dbg !157

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X9_1, metadata !136, metadata !DIExpression()), !dbg !177

  //   %6 = load atomic i64, i64* @atom_0_X9_1 seq_cst, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !140, metadata !DIExpression()), !dbg !180

  //   %7 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
