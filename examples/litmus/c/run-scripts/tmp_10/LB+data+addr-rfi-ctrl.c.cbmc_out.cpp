...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !79, metadata !DIExpression()), !dbg !96
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64 1, metadata !85, metadata !DIExpression()), !dbg !114

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !117

  //   %2 = zext i32 %conv7 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !89, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %2, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !87
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !146, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !149, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !152, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !171, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !175, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !179, metadata !DIExpression()), !dbg !232
