...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64 1, metadata !85, metadata !DIExpression()), !dbg !108

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !78
  // ST: Guess
  ...
  //   store i32 %conv9, i32* @atom_1_X5_1, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !122, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !123, metadata !DIExpression()), !dbg !171

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !124, metadata !DIExpression()), !dbg !173

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !128, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !129, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !132, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !135, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !138, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !141, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !142, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !144, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !145, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !147, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !148, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !152, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !153, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !157, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !158, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !162, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !167, metadata !DIExpression()), !dbg !171

  //   %and28 = and i32 %conv26, %and27, !dbg !137
  creg_r19 = max(creg__r13__1_,creg_r18);
  r19 = (r13==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !168, metadata !DIExpression()), !dbg !171
