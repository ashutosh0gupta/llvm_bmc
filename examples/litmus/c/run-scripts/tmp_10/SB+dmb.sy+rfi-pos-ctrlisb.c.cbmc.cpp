...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !84, metadata !DIExpression()), !dbg !108

  //   %conv8 = trunc i64 %2 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !81, metadata !DIExpression()), !dbg !90

  //   %cmp = icmp eq i32 %conv, 1, !dbg !83
  creg__r1__1_ = max(0,creg_r1);

  //   %conv9 = zext i1 %cmp to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !85, metadata !DIExpression()), !dbg !90

  //   store i32 %conv9, i32* @atom_1_X2_1, align 4, !dbg !84, !tbaa !85
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv4, 1, !dbg !89
  creg__r2__1_ = max(0,creg_r2);

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !86, metadata !DIExpression()), !dbg !90

  //   store i32 %conv11, i32* @atom_1_X3_1, align 4, !dbg !90, !tbaa !85
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv8, 0, !dbg !91
  creg__r3__0_ = max(0,creg_r3);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !87, metadata !DIExpression()), !dbg !90

  //   store i32 %conv13, i32* @atom_1_X4_0, align 4, !dbg !92, !tbaa !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !138, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !142, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_1, metadata !145, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !148, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !185

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X4_0, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !138
