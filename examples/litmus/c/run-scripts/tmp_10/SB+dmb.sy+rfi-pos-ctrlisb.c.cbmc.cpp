...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !81, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 1, !dbg !92

  //   %conv9 = zext i1 %cmp to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !85, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !86, metadata !DIExpression()), !dbg !121

  //   %3 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !88, metadata !DIExpression()), !dbg !121

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !94
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv4, 1, !dbg !95

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !89, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_1, metadata !90, metadata !DIExpression()), !dbg !124

  //   %4 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !92, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !93, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !94, metadata !DIExpression()), !dbg !127

  //   %5 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !96, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %5, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !150, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !153, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_1, metadata !156, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !173, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !177, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_1, metadata !181, metadata !DIExpression()), !dbg !234
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !155
