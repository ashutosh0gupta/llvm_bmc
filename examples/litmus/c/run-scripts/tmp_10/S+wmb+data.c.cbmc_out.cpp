...
T2BLOCK1:
  ...
  //   %and = and i32 %conv, 128, !dbg !53
  creg_r1 = max(0,creg_r0);
  r1 = r0 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !59, metadata !DIExpression()), !dbg !66

  //   %add = add nsw i32 %and, 1, !dbg !54
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !60, metadata !DIExpression()), !dbg !66

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !61, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !64, metadata !DIExpression()), !dbg !66
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !90, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !91, metadata !DIExpression()), !dbg !114

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !63

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !63

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !92, metadata !DIExpression()), !dbg !116

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !96, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !97, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 0, metadata !99, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !100, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64 0, metadata !102, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !103, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i32 0, metadata !106, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !108, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !110, metadata !DIExpression()), !dbg !133

  //   %conv = trunc i64 %4 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !107, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !111, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !112, metadata !DIExpression()), !dbg !114

  //   %and = and i32 %conv8, %5, !dbg !90
  creg_r8 = max(creg__r6__2_,creg_r7);
  r8 = (r6==2) & r7;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !113, metadata !DIExpression()), !dbg !114
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
