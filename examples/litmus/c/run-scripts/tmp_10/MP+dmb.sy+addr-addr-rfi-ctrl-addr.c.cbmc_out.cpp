...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !170, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !225

  //   store atomic i64 0, i64* @atom_1_X8_1 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !177, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !196, metadata !DIExpression()), !dbg !254

  //   %8 = load atomic i64, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,6);
