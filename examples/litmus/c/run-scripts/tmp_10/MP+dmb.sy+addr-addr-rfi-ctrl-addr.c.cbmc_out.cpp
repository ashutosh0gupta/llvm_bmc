...
T2BLOCK4:
  ...
  //   %cmp26 = icmp eq i32 %conv12, 1, !dbg !106
  ...
  //   store i32 %conv27, i32* @atom_1_X8_1, align 4, !dbg !107, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !163, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !209

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !170, metadata !DIExpression()), !dbg !221

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !175, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !229
  ...
  //   %8 = load i32, i32* @atom_1_X8_1, align 4, !dbg !143, !tbaa !141
  // LD: Guess
  old_cr = cr(0,6);
