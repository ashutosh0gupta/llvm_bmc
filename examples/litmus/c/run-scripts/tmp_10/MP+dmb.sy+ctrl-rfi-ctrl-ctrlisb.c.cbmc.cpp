...
T2BLOCK10:
  ...
  //   store i32 %conv21, i32* @atom_1_X4_1, align 4, !dbg !109, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !139, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !140, metadata !DIExpression()), !dbg !191

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !141, metadata !DIExpression()), !dbg !193

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !145, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !146, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !149, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !152, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !158, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !162, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !165, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !171, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !172, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !173, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !177, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !179, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !181, metadata !DIExpression()), !dbg !226

  //   %conv26 = trunc i64 %6 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !178, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !182, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !183, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !184, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !185, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !187, metadata !DIExpression()), !dbg !191

  //   %and30 = and i32 %conv28, %and29, !dbg !142
  creg_r15 = max(creg__r9__1_,creg_r14);
  r15 = (r9==1) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !188, metadata !DIExpression()), !dbg !191
