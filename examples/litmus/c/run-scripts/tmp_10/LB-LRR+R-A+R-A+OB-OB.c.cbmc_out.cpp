...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !89
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !99, metadata !DIExpression()), !dbg !113

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !60
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !102, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64 1, metadata !104, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !106, metadata !DIExpression()), !dbg !120
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !125, metadata !DIExpression()), !dbg !143
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !127, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !129, metadata !DIExpression()), !dbg !146

  //   %conv = trunc i64 %0 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !126, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !131, metadata !DIExpression()), !dbg !150
  ...
  if(cr(4,0+1*1) < cw(4,0+1*1)) {
    ...
    ASSUME((!(( (cw(4,0+1*1) < 5) && (5 < crmax(4,0+1*1)) )))||(sforbid(0+1*1,5)> 0));
    ASSUME((!(( (cw(4,0+1*1) < 6) && (6 < crmax(4,0+1*1)) )))||(sforbid(0+1*1,6)> 0));
    ASSUME((!(( (cw(4,0+1*1) < 7) && (7 < crmax(4,0+1*1)) )))||(sforbid(0+1*1,7)> 0));
    ASSUME((!(( (cw(4,0+1*1) < 8) && (8 < crmax(4,0+1*1)) )))||(sforbid(0+1*1,8)> 0));
    ASSUME((!(( (cw(4,0+1*1) < 9) && (9 < crmax(4,0+1*1)) )))||(sforbid(0+1*1,9)> 0));
  } else {
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !133, metadata !DIExpression()), !dbg !150

  //   %conv4 = trunc i64 %1 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !130, metadata !DIExpression()), !dbg !143

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !71

  //   %conv5 = zext i1 %cmp to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !134, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !135, metadata !DIExpression()), !dbg !154

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !137, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !138, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !139, metadata !DIExpression()), !dbg !157

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !141, metadata !DIExpression()), !dbg !157
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !170
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !180, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !181, metadata !DIExpression()), !dbg !241

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !182, metadata !DIExpression()), !dbg !243

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !186, metadata !DIExpression()), !dbg !245

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !187, metadata !DIExpression()), !dbg !247

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !188, metadata !DIExpression()), !dbg !249

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !189, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !190, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !193, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !196, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !199, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !202, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !205, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !208, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !211, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !214, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64 0, metadata !216, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !218, metadata !DIExpression()), !dbg !289
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !220, metadata !DIExpression()), !dbg !289

  //   %conv = trunc i64 %10 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !217, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !222, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !224, metadata !DIExpression()), !dbg !292

  //   %conv29 = trunc i64 %11 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !221, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !226, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !228, metadata !DIExpression()), !dbg !295

  //   %conv33 = trunc i64 %12 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !225, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !230, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !232, metadata !DIExpression()), !dbg !298

  //   %conv37 = trunc i64 %13 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv37, metadata !229, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !234, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !236, metadata !DIExpression()), !dbg !301

  //   %conv41 = trunc i64 %14 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv41, metadata !233, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !237, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !238, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !239, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !240, metadata !DIExpression()), !dbg !241
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 105, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
