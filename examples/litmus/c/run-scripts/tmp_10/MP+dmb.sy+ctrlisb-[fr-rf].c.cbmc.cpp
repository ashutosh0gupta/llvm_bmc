...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !74), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !79
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !64, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !66, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !70, metadata !DIExpression()), !dbg !92

  //   %conv8 = trunc i64 %2 to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !67, metadata !DIExpression()), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !71, metadata !DIExpression()), !dbg !76

  //   store i32 %conv9, i32* @atom_1_X0_1, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv4, 0, !dbg !82
  creg__r1__0_ = max(0,creg_r1);

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !72, metadata !DIExpression()), !dbg !76

  //   store i32 %conv11, i32* @atom_1_X2_0, align 4, !dbg !83, !tbaa !78
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv8, 1, !dbg !84
  creg__r2__1_ = max(0,creg_r2);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !73, metadata !DIExpression()), !dbg !76

  //   store i32 %conv13, i32* @atom_1_X4_1, align 4, !dbg !85, !tbaa !78
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !108, metadata !DIExpression()), !dbg !113
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !109, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64 1, metadata !111, metadata !DIExpression()), !dbg !116
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !133, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !134, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !140, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !144, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !147, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !151, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !153, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !156, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !158, metadata !DIExpression()), !dbg !199
  ...
  //   %10 = load i32, i32* @atom_1_X4_1, align 4, !dbg !125, !tbaa !122
  // LD: Guess
  old_cr = cr(0,4);
