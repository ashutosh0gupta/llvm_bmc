...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !114

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp18 = icmp eq i32 %conv4, 0, !dbg !104
  ...
  //   store i32 %conv19, i32* @atom_1_X3_0, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   store i32 %conv21, i32* @atom_1_X5_0, align 4, !dbg !107, !tbaa !100
  // ST: Guess
  ...
  //   store i32 %conv23, i32* @atom_1_X6_1, align 4, !dbg !109, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !173, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !176, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !179, metadata !DIExpression()), !dbg !231
