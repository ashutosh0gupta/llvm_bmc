...
T2BLOCK1:
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !78
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !108

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !85, metadata !DIExpression()), !dbg !108

  //   %conv8 = trunc i64 %2 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !82, metadata !DIExpression()), !dbg !95

  //   %tobool = icmp ne i32 %conv8, 0, !dbg !82
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !89, metadata !DIExpression()), !dbg !116
