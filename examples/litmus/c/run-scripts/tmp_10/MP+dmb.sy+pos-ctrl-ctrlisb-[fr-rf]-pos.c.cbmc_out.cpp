...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !108), !dbg !124
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !75, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !79, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !141

  //   %conv23 = trunc i64 %5 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !83, metadata !DIExpression()), !dbg !110

  //   %cmp = icmp eq i32 %conv, 1, !dbg !125

  //   %conv24 = zext i1 %cmp to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !87, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !145

  //   %6 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !145
  ...
  //   %cmp26 = icmp eq i32 %conv4, 1, !dbg !128

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !91, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !92, metadata !DIExpression()), !dbg !148

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !148
  ...
  //   %cmp31 = icmp eq i32 %conv15, 0, !dbg !131

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !95, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !96, metadata !DIExpression()), !dbg !151

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !151
  ...
  //   %cmp36 = icmp eq i32 %conv19, 1, !dbg !134

  //   %conv37 = zext i1 %cmp36 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv37, metadata !99, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !100, metadata !DIExpression()), !dbg !154

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %9, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !136
  // ST: Guess
  ...
  //   %cmp41 = icmp eq i32 %conv23, 1, !dbg !137

  //   %conv42 = zext i1 %cmp41 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !103, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !104, metadata !DIExpression()), !dbg !157

  //   %10 = zext i32 %conv42 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !106, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %10, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !139
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !163, metadata !DIExpression()), !dbg !170
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !180, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !181, metadata !DIExpression()), !dbg !248

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !182, metadata !DIExpression()), !dbg !250

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !117

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !117

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !186, metadata !DIExpression()), !dbg !252

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !187, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !203, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !265

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !132
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !206, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !267

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !134
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !209, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !213, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !215, metadata !DIExpression()), !dbg !284

  //   %conv = trunc i64 %6 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !212, metadata !DIExpression()), !dbg !248

  //   %cmp = icmp eq i32 %conv, 2, !dbg !153

  //   %conv20 = zext i1 %cmp to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !216, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !218, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !220, metadata !DIExpression()), !dbg !288

  //   %conv24 = trunc i64 %7 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !217, metadata !DIExpression()), !dbg !248

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !157

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !221, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !223, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !225, metadata !DIExpression()), !dbg !292

  //   %conv30 = trunc i64 %8 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !222, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !227, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !229, metadata !DIExpression()), !dbg !295

  //   %conv34 = trunc i64 %9 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !226, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !231, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !233, metadata !DIExpression()), !dbg !298

  //   %conv38 = trunc i64 %10 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !230, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !235, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !237, metadata !DIExpression()), !dbg !301

  //   %conv42 = trunc i64 %11 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !234, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !239, metadata !DIExpression()), !dbg !304

  //   %12 = load atomic i64, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !171
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !241, metadata !DIExpression()), !dbg !304

  //   %conv46 = trunc i64 %12 to i32, !dbg !172

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !238, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !243, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !244, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !245, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and50, metadata !246, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !247, metadata !DIExpression()), !dbg !248
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
