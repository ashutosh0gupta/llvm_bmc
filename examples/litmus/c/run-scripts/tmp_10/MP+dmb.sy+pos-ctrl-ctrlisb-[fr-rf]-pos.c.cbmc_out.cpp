...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !94), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !75, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !79, metadata !DIExpression()), !dbg !95
  ...
  //   %cmp27 = icmp eq i32 %conv15, 0, !dbg !118
  ...
  //   store i32 %conv28, i32* @atom_1_X5_0, align 4, !dbg !119, !tbaa !112
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv19, 1, !dbg !120
  ...
  //   store i32 %conv30, i32* @atom_1_X7_1, align 4, !dbg !121, !tbaa !112
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv23, 1, !dbg !122
  ...
  //   store i32 %conv32, i32* @atom_1_X8_1, align 4, !dbg !123, !tbaa !112
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !147, metadata !DIExpression()), !dbg !154
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !188, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !235

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !191, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !194, metadata !DIExpression()), !dbg !239
  ...
  //   %10 = load i32, i32* @atom_1_X5_0, align 4, !dbg !148, !tbaa !145
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X7_1, align 4, !dbg !149, !tbaa !145
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %12 = load i32, i32* @atom_1_X8_1, align 4, !dbg !150, !tbaa !145
  // LD: Guess
  old_cr = cr(0,7);
