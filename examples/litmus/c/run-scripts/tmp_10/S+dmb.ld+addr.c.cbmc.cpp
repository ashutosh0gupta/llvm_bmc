...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !88, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !89, metadata !DIExpression()), !dbg !112

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !63

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !63

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !90, metadata !DIExpression()), !dbg !114

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !94, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !95, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64 0, metadata !97, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !98, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 0, metadata !100, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !101, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i32 0, metadata !104, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !108, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !109, metadata !DIExpression()), !dbg !112
