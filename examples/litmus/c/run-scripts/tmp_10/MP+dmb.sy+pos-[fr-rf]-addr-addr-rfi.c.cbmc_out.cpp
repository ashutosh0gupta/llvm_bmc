...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !78, metadata !DIExpression()), !dbg !91

  //   %add14 = add nsw i32 0, %xor13, !dbg !89
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !89

  //   %arrayidx16 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !89
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !79, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64 1, metadata !81, metadata !DIExpression()), !dbg !109

  //   store atomic i64 1, i64* %arrayidx16 monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 2, !dbg !102
  ...
  //   store i32 %conv25, i32* @atom_1_X3_2, align 4, !dbg !103, !tbaa !96
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !170, metadata !DIExpression()), !dbg !212
