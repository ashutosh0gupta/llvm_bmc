...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !127

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv17 = zext i1 %cmp to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !83, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !84, metadata !DIExpression()), !dbg !131

  //   %5 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !131
  ...
  //   %cmp19 = icmp eq i32 %conv4, 1, !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !88, metadata !DIExpression()), !dbg !134

  //   %6 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %6, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 2, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !92, metadata !DIExpression()), !dbg !137

  //   %7 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %7, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !119
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv12, 2, !dbg !120

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !95, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !96, metadata !DIExpression()), !dbg !140

  //   %8 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %8, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv16, 0, !dbg !123

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !99, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !100, metadata !DIExpression()), !dbg !143

  //   %9 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %9, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !125
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !156
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !166, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !167, metadata !DIExpression()), !dbg !231

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !168, metadata !DIExpression()), !dbg !233

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !172, metadata !DIExpression()), !dbg !235

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !173, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !180, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !183, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !186, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !189, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !192, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !196, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !198, metadata !DIExpression()), !dbg !265

  //   %conv = trunc i64 %6 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !195, metadata !DIExpression()), !dbg !231

  //   %cmp = icmp eq i32 %conv, 1, !dbg !148

  //   %conv18 = zext i1 %cmp to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !199, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !201, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !203, metadata !DIExpression()), !dbg !269

  //   %conv22 = trunc i64 %7 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !200, metadata !DIExpression()), !dbg !231

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !152

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !204, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !206, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !208, metadata !DIExpression()), !dbg !273

  //   %conv28 = trunc i64 %8 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !205, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !210, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !212, metadata !DIExpression()), !dbg !276

  //   %conv32 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !209, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !214, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !216, metadata !DIExpression()), !dbg !279

  //   %conv36 = trunc i64 %10 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !213, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !218, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !220, metadata !DIExpression()), !dbg !282

  //   %conv40 = trunc i64 %11 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !217, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !222, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !224, metadata !DIExpression()), !dbg !285

  //   %conv44 = trunc i64 %12 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !221, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !226, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !227, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !228, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !229, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !230, metadata !DIExpression()), !dbg !231
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 94, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
