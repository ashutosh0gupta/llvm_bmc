...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !101
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !88), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !67, metadata !DIExpression()), !dbg !110
  ...
  //   %xor = xor i32 %conv11, %conv11, !dbg !96
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !89

  //   %add = add nsw i32 %xor, 1, !dbg !97
  creg_r4 = max(0,creg_r3);
  r4 = r3 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !75, metadata !DIExpression()), !dbg !89
  ...
  //   %conv14 = sext i32 %add to i64, !dbg !99

  //   call void @llvm.dbg.value(metadata i64 %conv14, metadata !78, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %conv14, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !79, metadata !DIExpression()), !dbg !89
  ...
  //   %cmp20 = icmp eq i32 %conv11, 2, !dbg !109
  ...
  //   store i32 %conv21, i32* @atom_1_X6_2, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv18, 1, !dbg !111
  ...
  //   store i32 %conv23, i32* @atom_1_X9_1, align 4, !dbg !112, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !153, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !154, metadata !DIExpression()), !dbg !206

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !155, metadata !DIExpression()), !dbg !208

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !159, metadata !DIExpression()), !dbg !210

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !160, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !161, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !164, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !167, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !170, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !173, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !177, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !223

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !180, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !184, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !186, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !187, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !188, metadata !DIExpression()), !dbg !206

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !136
  creg__r11__2_ = max(0,creg_r11);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !192, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !196, metadata !DIExpression()), !dbg !246

  //   %conv28 = trunc i64 %8 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !193, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !197, metadata !DIExpression()), !dbg !206
  ...
  //   %10 = load i32, i32* @atom_1_X6_2, align 4, !dbg !144, !tbaa !142
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X9_1, align 4, !dbg !145, !tbaa !142
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !202, metadata !DIExpression()), !dbg !206

  //   %and32 = and i32 %conv30, %and31, !dbg !148
  creg_r18 = max(creg__r12__1_,creg_r17);
  r18 = (r12==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !203, metadata !DIExpression()), !dbg !206

  //   %and33 = and i32 %conv24, %and32, !dbg !149
  creg_r19 = max(creg__r11__2_,creg_r18);
  r19 = (r11==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !204, metadata !DIExpression()), !dbg !206

  //   %and34 = and i32 %conv18, %and33, !dbg !150
  creg_r20 = max(creg__r10__2_,creg_r19);
  r20 = (r10==2) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !205, metadata !DIExpression()), !dbg !206
