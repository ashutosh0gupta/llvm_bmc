...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !136, metadata !DIExpression()), !dbg !148
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !138, metadata !DIExpression()), !dbg !151

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4) acquire, align 8, !dbg !61
  // LD: Guess
  //   : Acquire
  old_cr = cr(5,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !137, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !142, metadata !DIExpression()), !dbg !154

  //   %1 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !64
  // LD: Guess
  old_cr = cr(5,0+5*1);
  cr(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l59_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !144, metadata !DIExpression()), !dbg !154

  //   %conv4 = trunc i64 %1 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !141, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !145, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !146, metadata !DIExpression()), !dbg !148

  //   store i32 %conv7, i32* @atom_4_X0_1, align 4, !dbg !73, !tbaa !68
  // ST: Guess
  iw(5,10) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l63_c15
  old_cw = cw(5,10);
  cw(5,10) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l63_c15
  // Check
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !164, metadata !DIExpression()), !dbg !174
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !165, metadata !DIExpression()), !dbg !177
  ...
  // ST: Guess
  iw(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l69_c3
  old_cw = cw(6,0+5*1);
  cw(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l69_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !180

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !62
  // LD: Guess
  old_cr = cr(6,0+1*1);
  cr(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN LDCOM _l71_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !168, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !172, metadata !DIExpression()), !dbg !174
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X2_0, metadata !222, metadata !DIExpression()), !dbg !277
  ...
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l91_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l91_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X1_0, metadata !226, metadata !DIExpression()), !dbg !279
  ...
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l96_c3
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l96_c3
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,9);
  cr(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l112_c13
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,10);
  cr(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l117_c13
  // Check
