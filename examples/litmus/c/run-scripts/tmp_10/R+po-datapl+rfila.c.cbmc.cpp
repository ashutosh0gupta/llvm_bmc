...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !41, metadata !DIExpression()), !dbg !64
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !95, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !99, metadata !DIExpression()), !dbg !118
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !135, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !141, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !144, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !147, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !153, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !154, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_2, metadata !156, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !158, metadata !DIExpression()), !dbg !199

  //   %conv16 = trunc i64 %5 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !155, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !160, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !162, metadata !DIExpression()), !dbg !202

  //   %conv20 = trunc i64 %6 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !159, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !164, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !166, metadata !DIExpression()), !dbg !205

  //   %conv24 = trunc i64 %7 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !163, metadata !DIExpression()), !dbg !170
