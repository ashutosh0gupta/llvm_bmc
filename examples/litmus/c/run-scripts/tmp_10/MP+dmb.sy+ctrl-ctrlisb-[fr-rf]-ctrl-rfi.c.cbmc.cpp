...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !91), !dbg !125

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !126

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv11, 0, !dbg !118
  ...
  //   store i32 %conv25, i32* @atom_1_X4_0, align 4, !dbg !119, !tbaa !114
  // ST: Guess
  ...
  //   store i32 %conv27, i32* @atom_1_X6_1, align 4, !dbg !121, !tbaa !114
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !188, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !191, metadata !DIExpression()), !dbg !241
