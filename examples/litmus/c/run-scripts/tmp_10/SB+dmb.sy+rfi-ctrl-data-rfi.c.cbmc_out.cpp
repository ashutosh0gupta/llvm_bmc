...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !80, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !83, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !84, metadata !DIExpression()), !dbg !98

  //   %cmp = icmp eq i32 %conv, 1, !dbg !94

  //   %conv12 = zext i1 %cmp to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !88, metadata !DIExpression()), !dbg !98
  ...
  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !96
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv11, 1, !dbg !97

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !92, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !93, metadata !DIExpression()), !dbg !126

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !95, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %4, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !152, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !172, metadata !DIExpression()), !dbg !222
