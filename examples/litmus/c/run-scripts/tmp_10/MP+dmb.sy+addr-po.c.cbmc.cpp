...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !75
  ...
  //   %and = and i32 %conv, 128, !dbg !59
  creg_r1 = max(0,creg_r0);
  r1 = r0 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !61, metadata !DIExpression()), !dbg !72

  //   %add = add nsw i32 2, %and, !dbg !60
  creg_r2 = max(0,creg_r1);
  r2 = 2 + r1;

  //   %1 = zext i32 %add to i64

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %1, !dbg !60
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !62, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !66, metadata !DIExpression()), !dbg !81

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !68, metadata !DIExpression()), !dbg !81
  ...
  //   store i32 %conv7, i32* @atom_1_X5_0, align 4, !dbg !72, !tbaa !67
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !100, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !101, metadata !DIExpression()), !dbg !126

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !102, metadata !DIExpression()), !dbg !128

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !106, metadata !DIExpression()), !dbg !130

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !107, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64 0, metadata !109, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !110, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !115, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !116, metadata !DIExpression()), !dbg !137

  //   call void @llvm.dbg.value(metadata i32 0, metadata !119, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !120, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i32 0, metadata !122, metadata !DIExpression()), !dbg !139

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !123, metadata !DIExpression()), !dbg !126

  //   %5 = load i32, i32* @atom_1_X5_0, align 4, !dbg !94, !tbaa !92
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l56_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !124, metadata !DIExpression()), !dbg !126
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 58, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !99
