...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !84), !dbg !107
  ...
  //   %xor = xor i32 %conv11, %conv11, !dbg !92
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !85
  ...
  //   store i32 %conv18, i32* @atom_1_X4_1, align 4, !dbg !103, !tbaa !98
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv15, 0, !dbg !104
  ...
  //   store i32 %conv20, i32* @atom_1_X8_0, align 4, !dbg !105, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !156, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !159, metadata !DIExpression()), !dbg !202
