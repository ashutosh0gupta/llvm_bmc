...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !85, metadata !DIExpression()), !dbg !116

  //   %conv13 = trunc i64 %2 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !82, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !86, metadata !DIExpression()), !dbg !91

  //   store i32 %conv14, i32* @atom_1_X2_1, align 4, !dbg !92, !tbaa !93
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv13, 1, !dbg !97
  creg__r3__1_ = max(0,creg_r3);

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv16, i32* @atom_1_X7_1, align 4, !dbg !98, !tbaa !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !147, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !151, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !154, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !189

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X7_1, align 4, !dbg !124, !tbaa !121
  // LD: Guess
  old_cr = cr(0,5);
