...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !119
...
T2BLOCK4:
  ...
  //   %cmp26 = icmp eq i32 %conv8, 0, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !96, metadata !DIExpression()), !dbg !144
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !182, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !248

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !215, metadata !DIExpression()), !dbg !282

  //   %9 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !169
  // LD: Guess
  old_cr = cr(0,5);
