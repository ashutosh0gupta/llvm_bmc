...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !82

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !64
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !62, metadata !DIExpression()), !dbg !82

  //   %conv = trunc i64 %0 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !59, metadata !DIExpression()), !dbg !79

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !85

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !67
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !66, metadata !DIExpression()), !dbg !85

  //   %conv4 = trunc i64 %1 to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !63, metadata !DIExpression()), !dbg !79
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !78), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !67, metadata !DIExpression()), !dbg !94
  ...
  //   store i32 %conv9, i32* @atom_1_X0_1, align 4, !dbg !81, !tbaa !82
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv4, 2, !dbg !86
  ...
  //   store i32 %conv11, i32* @atom_1_X2_2, align 4, !dbg !87, !tbaa !82
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !113, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64 2, metadata !115, metadata !DIExpression()), !dbg !120

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !48
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !144, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !148, metadata !DIExpression()), !dbg !184
  ...
  //   %9 = load i32, i32* @atom_1_X2_2, align 4, !dbg !124, !tbaa !122
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !133
