...
T2BLOCK4:
  ...
  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !84
  creg__r1__0_ = max(0,creg_r1);

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !86
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !87), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !69, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !73, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !116

  //   %conv19 = trunc i64 %4 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !77, metadata !DIExpression()), !dbg !88

  //   %cmp = icmp eq i32 %conv, 1, !dbg !100
  creg__r0__1_ = max(0,creg_r0);

  //   %conv20 = zext i1 %cmp to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !81, metadata !DIExpression()), !dbg !88

  //   store i32 %conv20, i32* @atom_1_X0_1, align 4, !dbg !101, !tbaa !102
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv11, 0, !dbg !106
  creg__r2__0_ = max(0,creg_r2);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !82, metadata !DIExpression()), !dbg !88

  //   store i32 %conv22, i32* @atom_1_X4_0, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv15, 1, !dbg !108
  creg__r3__1_ = max(0,creg_r3);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !83, metadata !DIExpression()), !dbg !88

  //   store i32 %conv24, i32* @atom_1_X6_1, align 4, !dbg !109, !tbaa !102
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv19, 1, !dbg !110
  creg__r4__1_ = max(0,creg_r4);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !84, metadata !DIExpression()), !dbg !88

  //   store i32 %conv26, i32* @atom_1_X7_1, align 4, !dbg !111, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !173, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i32 0, metadata !175, metadata !DIExpression()), !dbg !216

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !176, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i32 0, metadata !178, metadata !DIExpression()), !dbg !218

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !179, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !220

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X4_0, align 4, !dbg !138, !tbaa !136
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_1_X6_1, align 4, !dbg !139, !tbaa !136
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X7_1, align 4, !dbg !140, !tbaa !136
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
