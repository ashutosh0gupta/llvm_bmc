...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !35, metadata !DIExpression()), !dbg !65
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64 1, metadata !39, metadata !DIExpression()), !dbg !68

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !69
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !44, metadata !DIExpression()), !dbg !70
...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !46, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !48, metadata !DIExpression()), !dbg !79

  //   %conv4 = trunc i64 %1 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !45, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !51, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !53, metadata !DIExpression()), !dbg !84

  //   %conv8 = trunc i64 %2 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !50, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !54, metadata !DIExpression()), !dbg !65

  //   %add10 = add nsw i32 %xor9, 1, !dbg !87
  creg_r7 = max(creg_r6,0);
  ASSUME(active[creg_r7] == 1);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !55, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !56, metadata !DIExpression()), !dbg !88

  //   %conv13 = sext i32 %add10 to i64, !dbg !89

  //   call void @llvm.dbg.value(metadata i64 %conv13, metadata !58, metadata !DIExpression()), !dbg !88

  //   store atomic i64 %conv13, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !59, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !60, metadata !DIExpression()), !dbg !91

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !62, metadata !DIExpression()), !dbg !91

  //   store atomic i64 %3, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !92
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !97, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64 2, metadata !99, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !101, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !105, metadata !DIExpression()), !dbg !119
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !148, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !151, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !155, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !165, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !169, metadata !DIExpression()), !dbg !213
