...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !67, metadata !DIExpression()), !dbg !80

  //   %add = add nsw i32 %xor, 1, !dbg !71
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !68, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !91

  //   %conv5 = sext i32 %add to i64, !dbg !73

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !71, metadata !DIExpression()), !dbg !91

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !73
  // ST: Guess
  ...
  //   %cmp11 = icmp eq i32 %conv4, 1, !dbg !83
  ...
  //   store i32 %conv12, i32* @atom_1_X2_1, align 4, !dbg !84, !tbaa !79
  // ST: Guess
