...
T2BLOCK1:
  ...
  //   %xor6 = xor i32 %conv5, %conv5, !dbg !80
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !72, metadata !DIExpression()), !dbg !86

  //   %add8 = add nsw i32 3, %xor6, !dbg !81
  creg_r5 = max(0,creg_r4);
  r5 = 3 + r4;

  //   %idxprom = sext i32 %add8 to i64, !dbg !81

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !81
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !74, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !73, metadata !DIExpression()), !dbg !86

  //   %tobool = icmp ne i32 %conv11, 0, !dbg !84
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !77, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !81, metadata !DIExpression()), !dbg !86
  ...
  //   %cmp17 = icmp eq i32 %conv5, 1, !dbg !99
  creg__r3__1_ = max(0,creg_r3);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !82, metadata !DIExpression()), !dbg !86

  //   store i32 %conv18, i32* @atom_1_X4_1, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv15, 0, !dbg !101
  creg__r8__0_ = max(0,creg_r8);

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !83, metadata !DIExpression()), !dbg !86

  //   store i32 %conv20, i32* @atom_1_X8_0, align 4, !dbg !102, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !130, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !131, metadata !DIExpression()), !dbg !182

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !132, metadata !DIExpression()), !dbg !184

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !136, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !137, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64 0, metadata !139, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !140, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !143, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !146, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !153, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !197

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !110
  // ST: Guess
  ...
  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !162, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !167, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !174, metadata !DIExpression()), !dbg !182

  //   %8 = load i32, i32* @atom_1_X4_1, align 4, !dbg !138, !tbaa !136
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !175, metadata !DIExpression()), !dbg !182

  //   %9 = load i32, i32* @atom_1_X8_0, align 4, !dbg !139, !tbaa !136
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !176, metadata !DIExpression()), !dbg !182
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !148
