...
T2BLOCK7:
  ...
  //   %cmp25 = icmp eq i32 %conv12, 2, !dbg !118
  ...
  //   store i32 %conv26, i32* @atom_1_X6_2, align 4, !dbg !119, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !189, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i32 0, metadata !191, metadata !DIExpression()), !dbg !241

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X6_2, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
