...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !78, metadata !DIExpression()), !dbg !83
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !79, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64 2, metadata !81, metadata !DIExpression()), !dbg !86
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !93, metadata !DIExpression()), !dbg !104

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !51
  // LD: Guess
  old_cr = cr(4,0+1*1);
  cr(4,0+1*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l42_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !96, metadata !DIExpression()), !dbg !108
  ...
  //   store i32 %conv1, i32* @atom_3_X0_2, align 4, !dbg !57, !tbaa !58
  // ST: Guess
  iw(4,3) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l46_c15
  old_cw = cw(4,3);
  cw(4,3) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l46_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !120, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !121, metadata !DIExpression()), !dbg !157

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !122, metadata !DIExpression()), !dbg !159

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !126, metadata !DIExpression()), !dbg !161

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !127, metadata !DIExpression()), !dbg !163

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !128, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !129, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !132, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !135, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_2, metadata !139, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !143, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !146, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !147, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !151, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !155, metadata !DIExpression()), !dbg !157

  //   %and22 = and i32 %conv14, %and21, !dbg !124
  creg_r13 = max(creg__r7__2_,creg_r12);
  r13 = (r7==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !156, metadata !DIExpression()), !dbg !157
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
