...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !96, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_2, metadata !100, metadata !DIExpression()), !dbg !114
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !131, metadata !DIExpression()), !dbg !172

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !132, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !139, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_2, metadata !142, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !148, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !149, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !153, metadata !DIExpression()), !dbg !203

  //   %conv18 = trunc i64 %9 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !150, metadata !DIExpression()), !dbg !166

  //   %cmp19 = icmp eq i32 %conv18, 2, !dbg !122

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !154, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !158, metadata !DIExpression()), !dbg !207

  //   %conv24 = trunc i64 %10 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !155, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_2, metadata !160, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !162, metadata !DIExpression()), !dbg !210

  //   %conv28 = trunc i64 %11 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !159, metadata !DIExpression()), !dbg !166
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !135
