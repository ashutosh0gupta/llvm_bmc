...
T2BLOCK1:
  ...
  //   %cmp25 = icmp eq i32 %conv4, 2, !dbg !104
  ...
  //   store i32 %conv26, i32* @atom_1_X2_2, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv15, 1, !dbg !106
  ...
  //   store i32 %conv28, i32* @atom_1_X8_1, align 4, !dbg !107, !tbaa !100
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !133, metadata !DIExpression()), !dbg !140
  ...
  // ST: Guess
  iw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l53_c3
  old_cw = cw(3,0+1*1);
  cw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l53_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !174, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !177, metadata !DIExpression()), !dbg !227
  ...
  creg_r27 = max(creg__r19__2_,creg_r26);
  r27 = (r19==2) & r26;
