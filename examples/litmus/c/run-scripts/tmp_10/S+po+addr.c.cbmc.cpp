...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !58, metadata !DIExpression()), !dbg !64
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !59, metadata !DIExpression()), !dbg !72
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !87, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !88, metadata !DIExpression()), !dbg !111

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !63

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !63

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !89, metadata !DIExpression()), !dbg !113

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !93, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !94, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64 0, metadata !96, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !100, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i32 0, metadata !103, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !105, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !107, metadata !DIExpression()), !dbg !130

  //   %conv = trunc i64 %4 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !104, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !108, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !109, metadata !DIExpression()), !dbg !111

  //   %and = and i32 %conv8, %5, !dbg !90
  creg_r9 = max(creg__r7__2_,creg_r8);
  r9 = (r7==2) & r8;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !110, metadata !DIExpression()), !dbg !111
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 52, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
