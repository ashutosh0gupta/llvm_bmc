...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !82), !dbg !88
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !72, metadata !DIExpression()), !dbg !110

  //   %conv15 = trunc i64 %3 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !69, metadata !DIExpression()), !dbg !86

  //   %tobool16 = icmp ne i32 %conv15, 0, !dbg !94
  creg__r3__0_ = max(0,creg_r3);

  //   br i1 %tobool16, label %if.then17, label %if.else18, !dbg !96
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !85), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !119
  ...
  //   %conv22 = trunc i64 %4 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !76, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !80, metadata !DIExpression()), !dbg !86

  //   store i32 %conv23, i32* @atom_1_X0_1, align 4, !dbg !106, !tbaa !107
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv22, 1, !dbg !111
  creg__r4__1_ = max(0,creg_r4);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !81, metadata !DIExpression()), !dbg !86

  //   store i32 %conv25, i32* @atom_1_X9_1, align 4, !dbg !112, !tbaa !107
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !140, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !141, metadata !DIExpression()), !dbg !181

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !142, metadata !DIExpression()), !dbg !183

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !146, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !159, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !163, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !170, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !172, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !171, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !175, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !179, metadata !DIExpression()), !dbg !181

  //   %and22 = and i32 %conv14, %and21, !dbg !122
  creg_r14 = max(creg__r8__2_,creg_r13);
  r14 = (r8==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !180, metadata !DIExpression()), !dbg !181
