...
T2BLOCK1:
  ...
  //   %add10 = add nsw i32 %xor9, 1, !dbg !85
  creg_r7 = max(0,creg_r6);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !73, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !105

  //   %conv11 = sext i32 %add10 to i64, !dbg !87

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !76, metadata !DIExpression()), !dbg !105

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   %xor16 = xor i32 %conv15, %conv15, !dbg !91
  creg_r9 = creg_r8;
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !81, metadata !DIExpression()), !dbg !90

  //   %add18 = add nsw i32 0, %xor16, !dbg !92
  creg_r10 = max(0,creg_r9);
  r10 = 0 + r9;

  //   %idxprom19 = sext i32 %add18 to i64, !dbg !92

  //   %arrayidx20 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !92
  r11 = 0+r10*1;
  creg_r11 = creg_r10;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !83, metadata !DIExpression()), !dbg !112

  //   %4 = load atomic i64, i64* %arrayidx20 monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,r11);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !112

  //   %conv23 = trunc i64 %4 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !82, metadata !DIExpression()), !dbg !90

  //   %cmp = icmp eq i32 %conv, 1, !dbg !95
  creg__r0__1_ = max(0,creg_r0);

  //   %conv24 = zext i1 %cmp to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !86, metadata !DIExpression()), !dbg !90

  //   store i32 %conv24, i32* @atom_1_X0_1, align 4, !dbg !96, !tbaa !97
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv15, 1, !dbg !101
  creg__r8__1_ = max(0,creg_r8);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !87, metadata !DIExpression()), !dbg !90

  //   store i32 %conv26, i32* @atom_1_X8_1, align 4, !dbg !102, !tbaa !97
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv23, 0, !dbg !103
  creg__r12__0_ = max(0,creg_r12);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !88, metadata !DIExpression()), !dbg !90

  //   store i32 %conv28, i32* @atom_1_X10_0, align 4, !dbg !104, !tbaa !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !155, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !158, metadata !DIExpression()), !dbg !201
