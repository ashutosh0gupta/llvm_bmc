...
T2BLOCK1:
  ...
  //   %add10 = add nsw i32 %xor9, 1, !dbg !94
  creg_r7 = max(creg_r6,0);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !73, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !114

  //   %conv11 = sext i32 %add10 to i64, !dbg !96

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !76, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   %xor16 = xor i32 %conv15, %conv15, !dbg !100
  creg_r9 = max(creg_r8,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !81, metadata !DIExpression()), !dbg !99

  //   %add18 = add nsw i32 0, %xor16, !dbg !101
  creg_r10 = max(0,creg_r9);
  ASSUME(active[creg_r10] == 2);
  r10 = 0 + r9;

  //   %idxprom19 = sext i32 %add18 to i64, !dbg !101

  //   %arrayidx20 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !101
  r11 = 0+r10*1;
  ASSUME(creg_r11 >= 0);
  ASSUME(creg_r11 >= creg_r10);
  ASSUME(active[creg_r11] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !83, metadata !DIExpression()), !dbg !121

  //   %4 = load atomic i64, i64* %arrayidx20 monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,r11);
  ...
  //   %conv23 = trunc i64 %4 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !82, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 1, !dbg !104

  //   %conv24 = zext i1 %cmp to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !86, metadata !DIExpression()), !dbg !99
  ...
  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv15, 1, !dbg !107

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !90, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !91, metadata !DIExpression()), !dbg !127

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %6, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !109
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv23, 0, !dbg !110

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !94, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !95, metadata !DIExpression()), !dbg !130

  //   %7 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %7, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !162, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !215

  //   store atomic i64 0, i64* @atom_1_X8_1 monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !165, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !169, metadata !DIExpression()), !dbg !229

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !174, metadata !DIExpression()), !dbg !233

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !136
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !179, metadata !DIExpression()), !dbg !237

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !140
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !188, metadata !DIExpression()), !dbg !244

  //   %8 = load atomic i64, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !192, metadata !DIExpression()), !dbg !247

  //   %9 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !150
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
