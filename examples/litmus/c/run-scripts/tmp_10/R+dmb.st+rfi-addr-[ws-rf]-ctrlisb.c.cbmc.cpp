...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !104
  ...
  //   store i32 %conv11, i32* @atom_1_X2_2, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv6, 2, !dbg !94
  creg__r4__2_ = max(0,creg_r4);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !79, metadata !DIExpression()), !dbg !83

  //   store i32 %conv13, i32* @atom_1_X6_2, align 4, !dbg !95, !tbaa !90
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv10, 0, !dbg !96
  ...
  //   store i32 %conv15, i32* @atom_1_X7_0, align 4, !dbg !97, !tbaa !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !155, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !159, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !162, metadata !DIExpression()), !dbg !205
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 87, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
