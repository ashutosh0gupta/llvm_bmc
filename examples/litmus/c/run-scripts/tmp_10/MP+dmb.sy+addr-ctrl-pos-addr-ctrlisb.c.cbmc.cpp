...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !86), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !107

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !70, metadata !DIExpression()), !dbg !88

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !91
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !74, metadata !DIExpression()), !dbg !88

  //   %add15 = add nsw i32 4, %xor13, !dbg !92
  creg_r8 = max(0,creg_r7);
  r8 = 4 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !92

  //   %arrayidx17 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !92
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !76, metadata !DIExpression()), !dbg !112

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !78, metadata !DIExpression()), !dbg !112

  //   %conv20 = trunc i64 %4 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !75, metadata !DIExpression()), !dbg !88

  //   %tobool21 = icmp ne i32 %conv20, 0, !dbg !95
  creg__r10__0_ = max(0,creg_r10);

  //   br i1 %tobool21, label %if.then22, label %if.else23, !dbg !97
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !87), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !121

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv27 = trunc i64 %5 to i32, !dbg !104
  ...
  //   %conv28 = zext i1 %cmp to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !83, metadata !DIExpression()), !dbg !88

  //   store i32 %conv28, i32* @atom_1_X0_1, align 4, !dbg !106, !tbaa !107
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv27, 0, !dbg !111
  ...
  //   store i32 %conv30, i32* @atom_1_X11_0, align 4, !dbg !112, !tbaa !107
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !140, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !141, metadata !DIExpression()), !dbg !184

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !142, metadata !DIExpression()), !dbg !186

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !146, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !147, metadata !DIExpression()), !dbg !189
  ...
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l52_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l52_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !150, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !153, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !156, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !159, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !162, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !166, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !168, metadata !DIExpression()), !dbg !201

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !102
  // ST: Guess
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !104
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !172, metadata !DIExpression()), !dbg !211

  //   %conv = trunc i64 %4 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !169, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !173, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !177, metadata !DIExpression()), !dbg !215

  //   %conv20 = trunc i64 %5 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !174, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !178, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !179, metadata !DIExpression()), !dbg !184

  //   %7 = load i32, i32* @atom_1_X11_0, align 4, !dbg !124, !tbaa !122
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l71_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !180, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !182, metadata !DIExpression()), !dbg !184

  //   %and24 = and i32 %conv16, %and23, !dbg !127
  creg_r21 = max(creg__r15__1_,creg_r20);
  r21 = (r15==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !183, metadata !DIExpression()), !dbg !184
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !131
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #6, !dbg !134

  //   %9 = bitcast i64* %thr0 to i8*, !dbg !134

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #6, !dbg !134
