...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !86, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv27, 0, !dbg !114

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !87, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !88, metadata !DIExpression()), !dbg !134

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !90, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %7, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !116
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !144, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !145, metadata !DIExpression()), !dbg !193

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !146, metadata !DIExpression()), !dbg !195

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !150, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !151, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !154, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !157, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !160, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !163, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !166, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !169, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !173, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !175, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !176, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !178, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !180, metadata !DIExpression()), !dbg !226

  //   %conv20 = trunc i64 %5 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !177, metadata !DIExpression()), !dbg !193

  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !125

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !181, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !185, metadata !DIExpression()), !dbg !230

  //   %conv26 = trunc i64 %6 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !182, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !187, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !189, metadata !DIExpression()), !dbg !233

  //   %conv30 = trunc i64 %7 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !186, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !191, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !192, metadata !DIExpression()), !dbg !193
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !138
