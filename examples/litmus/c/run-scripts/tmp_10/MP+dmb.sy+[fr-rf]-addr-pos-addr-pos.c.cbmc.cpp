...
T2BLOCK1:
  ...
  //   %arrayidx17 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !102
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !124
  ...
  //   %cmp27 = icmp eq i32 %conv4, 2, !dbg !111
  ...
  //   store atomic i64 %7, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !96, metadata !DIExpression()), !dbg !134

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %8, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   store atomic i64 %9, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !119
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !183, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !185, metadata !DIExpression()), !dbg !237

  //   store atomic i64 0, i64* @atom_1_X8_0 monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !186, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !239

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !208, metadata !DIExpression()), !dbg !268

  //   %10 = load atomic i64, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !153
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !212, metadata !DIExpression()), !dbg !271

  //   %11 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !156
  // LD: Guess
  old_cr = cr(0,6);
