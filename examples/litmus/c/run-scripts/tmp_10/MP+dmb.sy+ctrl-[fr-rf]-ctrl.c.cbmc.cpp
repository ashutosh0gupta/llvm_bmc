...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !108
  ...
  //   %cmp17 = icmp eq i32 %conv4, 0, !dbg !98
  ...
  //   store i32 %conv18, i32* @atom_1_X2_0, align 4, !dbg !99, !tbaa !94
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv8, 1, !dbg !100
  ...
  //   store i32 %conv20, i32* @atom_1_X4_1, align 4, !dbg !101, !tbaa !94
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 0, !dbg !102
  ...
  //   store i32 %conv22, i32* @atom_1_X5_0, align 4, !dbg !103, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !171, metadata !DIExpression()), !dbg !218
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
