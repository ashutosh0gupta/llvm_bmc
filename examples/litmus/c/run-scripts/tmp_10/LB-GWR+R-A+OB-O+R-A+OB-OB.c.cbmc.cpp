...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !80
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !93, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !96, metadata !DIExpression()), !dbg !107
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !140, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !144, metadata !DIExpression()), !dbg !157

  //   %1 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(5,0+5*1);
  cr(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l62_c16
  // Check
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !168, metadata !DIExpression()), !dbg !180
  ...
  // ST: Guess
  iw(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l72_c3
  old_cw = cw(6,0+5*1);
  cw(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l72_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !172, metadata !DIExpression()), !dbg !183

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !62
  // LD: Guess
  old_cr = cr(6,0+1*1);
  cr(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN LDCOM _l74_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !174, metadata !DIExpression()), !dbg !183

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !171, metadata !DIExpression()), !dbg !177
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X2_0, metadata !225, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X1_0, metadata !229, metadata !DIExpression()), !dbg !282
  ...
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l99_c3
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l99_c3
  // Check
