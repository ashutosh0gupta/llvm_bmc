...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !117
  ...
  //   %cmp23 = icmp eq i32 %conv15, 0, !dbg !112
  ...
  //   store i32 %conv24, i32* @atom_1_X8_0, align 4, !dbg !113, !tbaa !106
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv19, 1, !dbg !114
  ...
  //   store i32 %conv26, i32* @atom_1_X10_1, align 4, !dbg !115, !tbaa !106
  // ST: Guess
  iw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l49_c16
  old_cw = cw(2,7);
  cw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l49_c16
  // Check
  ASSUME(active[iw(2,7)] == 2);
  ASSUME(active[cw(2,7)] == 2);
  ASSUME(sforbid(7,cw(2,7))== 0);
  ASSUME(iw(2,7) >= creg__r9__1_);
  ASSUME(iw(2,7) >= 0);
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !139, metadata !DIExpression()), !dbg !146
  ...
  // ST: Guess
  iw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l55_c3
  old_cw = cw(3,0);
  cw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l55_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !183, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !186, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i32 0, metadata !188, metadata !DIExpression()), !dbg !235

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X10_1, align 4, !dbg !155, !tbaa !151
  // LD: Guess
  old_cr = cr(0,7);
  ...
  creg_r24 = max(creg__r16__1_,creg_r23);
  r24 = (r16==1) & r23;
  ...
  creg_r26 = max(creg__r14__2_,creg_r25);
  r26 = (r14==2) & r25;
