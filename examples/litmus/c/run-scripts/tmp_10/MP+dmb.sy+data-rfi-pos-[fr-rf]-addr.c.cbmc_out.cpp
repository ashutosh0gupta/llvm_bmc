...
T2BLOCK1:
  ...
  //   %xor14 = xor i32 %conv13, %conv13, !dbg !95
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor14, metadata !84, metadata !DIExpression()), !dbg !95

  //   %add16 = add nsw i32 0, %xor14, !dbg !96
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom = sext i32 %add16 to i64, !dbg !96

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !96
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !86, metadata !DIExpression()), !dbg !116

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,r8);
  cr(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l39_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !88, metadata !DIExpression()), !dbg !116
  ...
  //   %cmp25 = icmp eq i32 %conv13, 2, !dbg !109
  ...
  //   store i32 %conv26, i32* @atom_1_X6_2, align 4, !dbg !110, !tbaa !101
  // ST: Guess
  ...
  //   store i32 %conv28, i32* @atom_1_X8_0, align 4, !dbg !112, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !177, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !180, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !183, metadata !DIExpression()), !dbg !234
