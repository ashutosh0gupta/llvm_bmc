...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !146, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !149, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 1, metadata !151, metadata !DIExpression()), !dbg !161
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !168, metadata !DIExpression()), !dbg !178
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !170, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !169, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64 1, metadata !175, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !176, metadata !DIExpression()), !dbg !178

  //   store i32 %conv1, i32* @atom_5_X0_1, align 4, !dbg !65, !tbaa !66
  // ST: Guess
  iw(6,11) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l77_c15
  old_cw = cw(6,11);
  cw(6,11) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l77_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X0_1, metadata !226, metadata !DIExpression()), !dbg !281
  ...
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l100_c3
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l100_c3
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,10);
  cr(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l121_c13
  // Check
