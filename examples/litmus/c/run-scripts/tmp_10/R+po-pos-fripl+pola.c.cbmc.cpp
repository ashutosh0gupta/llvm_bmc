...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !39, metadata !DIExpression()), !dbg !73

  //   br label %label_1, !dbg !74
  goto T1BLOCK1;

T1BLOCK1:
  //   call void @llvm.dbg.label(metadata !72), !dbg !75

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !76

  //   call void @llvm.dbg.value(metadata i64 1, metadata !43, metadata !DIExpression()), !dbg !76

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !77
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !46, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !48, metadata !DIExpression()), !dbg !78

  //   %conv = trunc i64 %0 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !44, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !50, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !49, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64 1, metadata !55, metadata !DIExpression()), !dbg !84

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !85
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !57, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !56, metadata !DIExpression()), !dbg !73

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !89

  //   %conv11 = zext i1 %cmp to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !60, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !61, metadata !DIExpression()), !dbg !90

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !63, metadata !DIExpression()), !dbg !90

  //   store atomic i64 %3, i64* @atom_0_X6_2 seq_cst, align 8, !dbg !91
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv, 0, !dbg !92

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !64, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !65, metadata !DIExpression()), !dbg !93

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !67, metadata !DIExpression()), !dbg !93

  //   store atomic i64 %4, i64* @atom_0_X2_0 seq_cst, align 8, !dbg !94
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv4, 0, !dbg !95

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !68, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !69, metadata !DIExpression()), !dbg !96

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !71, metadata !DIExpression()), !dbg !96

  //   store atomic i64 %5, i64* @atom_0_X4_0 seq_cst, align 8, !dbg !97
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !102, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !108, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !110, metadata !DIExpression()), !dbg !123
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !146, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !152, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !155, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !169, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !177, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !181, metadata !DIExpression()), !dbg !233
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
