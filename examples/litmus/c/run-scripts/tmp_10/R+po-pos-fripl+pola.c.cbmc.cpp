...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !75

  //   call void @llvm.dbg.value(metadata i64 1, metadata !55, metadata !DIExpression()), !dbg !75

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !76
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !57, metadata !DIExpression()), !dbg !77
  ...
  //   store i32 %conv11, i32* @atom_0_X6_2, align 4, !dbg !81, !tbaa !82
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv, 0, !dbg !86
  ...
  //   store i32 %conv13, i32* @atom_0_X2_0, align 4, !dbg !87, !tbaa !82
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 0, !dbg !88
  creg__r1__0_ = max(0,creg_r1);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !62, metadata !DIExpression()), !dbg !64

  //   store i32 %conv15, i32* @atom_0_X4_0, align 4, !dbg !89, !tbaa !82
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !94, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64 2, metadata !96, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !98, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !100, metadata !DIExpression()), !dbg !108

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !97, metadata !DIExpression()), !dbg !103
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_2, metadata !134, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !138, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_0, metadata !141, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !144, metadata !DIExpression()), !dbg !181
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
