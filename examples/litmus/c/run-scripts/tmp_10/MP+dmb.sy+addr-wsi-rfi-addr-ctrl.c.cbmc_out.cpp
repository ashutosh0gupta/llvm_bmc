...
T2BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()), !dbg !99

  //   %conv6 = trunc i64 %1 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !70, metadata !DIExpression()), !dbg !88

  //   %xor7 = xor i32 %conv6, %conv6, !dbg !83
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !74, metadata !DIExpression()), !dbg !88

  //   %add9 = add nsw i32 3, %xor7, !dbg !84
  creg_r6 = max(0,creg_r5);
  r6 = 3 + r5;

  //   %idxprom10 = sext i32 %add9 to i64, !dbg !84

  //   %arrayidx11 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom10, !dbg !84
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx11, metadata !76, metadata !DIExpression()), !dbg !104

  //   %2 = load atomic i64, i64* %arrayidx11 monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !104
...
T2BLOCK4:
  ...
  //   %cmp20 = icmp eq i32 %conv6, 2, !dbg !102
  ...
  //   store i32 %conv21, i32* @atom_1_X6_2, align 4, !dbg !103, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !156, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !200

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !110
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X6_2, align 4, !dbg !138, !tbaa !136
  // LD: Guess
  old_cr = cr(0,5);
