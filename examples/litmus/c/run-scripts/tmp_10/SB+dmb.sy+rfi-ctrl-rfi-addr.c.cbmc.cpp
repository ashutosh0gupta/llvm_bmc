...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !81, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !83, metadata !DIExpression()), !dbg !119

  //   %conv6 = trunc i64 %1 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !80, metadata !DIExpression()), !dbg !103

  //   %xor = xor i32 %conv6, %conv6, !dbg !94
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !84, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !92, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !100
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv6, 1, !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !94, metadata !DIExpression()), !dbg !130

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !96, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %4, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !103
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv10, 0, !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !98, metadata !DIExpression()), !dbg !133

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !100, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %5, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !159, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !187, metadata !DIExpression()), !dbg !249
