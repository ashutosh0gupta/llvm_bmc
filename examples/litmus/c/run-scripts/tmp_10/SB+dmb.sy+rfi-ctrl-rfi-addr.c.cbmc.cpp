...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv6, %conv6, !dbg !85
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !84, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 0, %xor, !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !86, metadata !DIExpression()), !dbg !115

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,r5);
  cr(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l39_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !88, metadata !DIExpression()), !dbg !115

  //   %conv10 = trunc i64 %2 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !85, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !89
  creg__r1__1_ = max(0,creg_r1);

  //   %conv11 = zext i1 %cmp to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !89, metadata !DIExpression()), !dbg !94

  //   store i32 %conv11, i32* @atom_1_X2_1, align 4, !dbg !90, !tbaa !91
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv6, 1, !dbg !95
  creg__r2__1_ = max(0,creg_r2);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !90, metadata !DIExpression()), !dbg !94

  //   store i32 %conv13, i32* @atom_1_X5_1, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv10, 0, !dbg !97
  creg__r6__0_ = max(0,creg_r6);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !91, metadata !DIExpression()), !dbg !94

  //   store i32 %conv15, i32* @atom_1_X7_0, align 4, !dbg !98, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !131, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !132, metadata !DIExpression()), !dbg !185

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !133, metadata !DIExpression()), !dbg !187

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !137, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !138, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !141, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !144, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64 0, metadata !146, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !147, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !196

  //   store atomic i32 0, i32* @atom_0_X2_0 monotonic, align 4, !dbg !110
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l56_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l56_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !151, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i32 0, metadata !153, metadata !DIExpression()), !dbg !198

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !112
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l57_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l57_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !154, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !200

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !114
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l58_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l58_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !157, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !202

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !116
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l59_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l59_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !161, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !163, metadata !DIExpression()), !dbg !212

  //   %conv = trunc i64 %4 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !160, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !164, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !166, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !168, metadata !DIExpression()), !dbg !216

  //   %conv20 = trunc i64 %5 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !165, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !169, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !171, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !173, metadata !DIExpression()), !dbg !220

  //   %conv26 = trunc i64 %6 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !170, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !174, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !175, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !179, metadata !DIExpression()), !dbg !185

  //   %and29 = and i32 %8, %and, !dbg !146
  creg_r18 = max(creg_r14,creg_r17);
  r18 = r14 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !180, metadata !DIExpression()), !dbg !185

  //   %and30 = and i32 %7, %and29, !dbg !147
  creg_r19 = max(creg_r13,creg_r18);
  r19 = r13 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !181, metadata !DIExpression()), !dbg !185

  //   %and31 = and i32 %conv28, %and30, !dbg !148
  creg_r20 = max(creg__r12__1_,creg_r19);
  r20 = (r12==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !182, metadata !DIExpression()), !dbg !185

  //   %and32 = and i32 %conv22, %and31, !dbg !149
  creg_r21 = max(creg__r11__1_,creg_r20);
  r21 = (r11==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !183, metadata !DIExpression()), !dbg !185

  //   %and33 = and i32 %conv16, %and32, !dbg !150
  creg_r22 = max(creg__r10__1_,creg_r21);
  r22 = (r10==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !184, metadata !DIExpression()), !dbg !185
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 83, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154
