...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !89, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !92, metadata !DIExpression()), !dbg !99

  //   %add = add nsw i32 %xor, 1, !dbg !56
  creg_r5 = max(0,creg_r4);
  r5 = r4 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !93, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !96, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !97, metadata !DIExpression()), !dbg !99
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !144, metadata !DIExpression()), !dbg !180
