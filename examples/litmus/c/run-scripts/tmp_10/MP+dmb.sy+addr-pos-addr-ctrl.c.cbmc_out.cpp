...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !70, metadata !DIExpression()), !dbg !83

  //   %add11 = add nsw i32 3, %xor9, !dbg !78
  creg_r7 = max(0,creg_r6);
  r7 = 3 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !78

  //   %arrayidx13 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !78
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !72, metadata !DIExpression()), !dbg !98

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !74, metadata !DIExpression()), !dbg !98

  //   %conv16 = trunc i64 %3 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !71, metadata !DIExpression()), !dbg !83

  //   %tobool = icmp ne i32 %conv16, 0, !dbg !81
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !78, metadata !DIExpression()), !dbg !106
