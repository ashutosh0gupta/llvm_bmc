...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !80, metadata !DIExpression()), !dbg !111
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !83
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  ...
  //   %cmp = icmp eq i32 %conv, 3, !dbg !85

  //   %conv9 = zext i1 %cmp to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !87, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_3, metadata !88, metadata !DIExpression()), !dbg !118

  //   %3 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !90, metadata !DIExpression()), !dbg !118

  //   store atomic i64 %3, i64* @atom_1_X2_3 seq_cst, align 8, !dbg !87
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv8, 0, !dbg !88

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !91, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !92, metadata !DIExpression()), !dbg !121

  //   %4 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !94, metadata !DIExpression()), !dbg !121

  //   store atomic i64 %4, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !144, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_3, metadata !147, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !150, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !159, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_3, metadata !163, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !167, metadata !DIExpression()), !dbg !208
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
