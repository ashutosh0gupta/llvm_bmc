...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !123

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !126

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,0+3*1);
  cr(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   %xor13 = xor i32 %conv12, %conv12, !dbg !110
  ...
  //   %add15 = add nsw i32 4, %xor13, !dbg !111
  ...
  //   %arrayidx17 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !111
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !80, metadata !DIExpression()), !dbg !131

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   %tobool21 = icmp ne i32 %conv20, 0, !dbg !114

  //   br i1 %tobool21, label %if.then22, label %if.else23, !dbg !116
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK6:
  //   br label %lbl_LC01, !dbg !118
  goto T2BLOCK7;

T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !105), !dbg !138
