...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !111

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !111

  //   %conv8 = trunc i64 %2 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !114

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !114

  //   %conv12 = trunc i64 %3 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !94

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !98
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !78, metadata !DIExpression()), !dbg !94

  //   %add15 = add nsw i32 4, %xor13, !dbg !99
  creg_r8 = max(0,creg_r7);
  r8 = 4 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !99

  //   %arrayidx17 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !99
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !80, metadata !DIExpression()), !dbg !119

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,r9);
  cr(2,r9) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l39_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !119

  //   %conv20 = trunc i64 %4 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !79, metadata !DIExpression()), !dbg !94

  //   %tobool21 = icmp ne i32 %conv20, 0, !dbg !102
  creg__r10__0_ = max(0,creg_r10);

  //   br i1 %tobool21, label %if.then22, label %if.else23, !dbg !104
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
  ASSUME(cctrl[2] >= creg__r10__0_);
  if((r10!=0)) {
    goto T2BLOCK5;
  } else {
    goto T2BLOCK6;
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !93), !dbg !126

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !127

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !127
  ...
  //   %cmp29 = icmp eq i32 %conv8, 0, !dbg !117
  ...
  //   store i32 %conv30, i32* @atom_1_X5_0, align 4, !dbg !118, !tbaa !113
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv12, 1, !dbg !119
  ...
  //   store i32 %conv32, i32* @atom_1_X7_1, align 4, !dbg !120, !tbaa !113
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !146, metadata !DIExpression()), !dbg !153
  ...
  // ST: Guess
  iw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l56_c3
  old_cw = cw(3,0+3*1);
  cw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l56_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !190, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !243

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !193, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !245

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !200, metadata !DIExpression()), !dbg !260

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l83_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !205, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !210, metadata !DIExpression()), !dbg !268
  ...
  //   %10 = load i32, i32* @atom_1_X5_0, align 4, !dbg !158, !tbaa !156
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %11 = load i32, i32* @atom_1_X7_1, align 4, !dbg !159, !tbaa !156
  // LD: Guess
  old_cr = cr(0,7);
