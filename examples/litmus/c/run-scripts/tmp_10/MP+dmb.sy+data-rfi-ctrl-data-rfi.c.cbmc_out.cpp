...
T2BLOCK4:
  ...
  //   %xor10 = xor i32 %conv9, %conv9, !dbg !93
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor10, metadata !76, metadata !DIExpression()), !dbg !90

  //   %add11 = add nsw i32 %xor10, 1, !dbg !94
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add11, metadata !77, metadata !DIExpression()), !dbg !90
  ...
  //   %conv14 = sext i32 %add11 to i64, !dbg !96

  //   call void @llvm.dbg.value(metadata i64 %conv14, metadata !80, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %conv14, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   store i32 %conv21, i32* @atom_1_X4_1, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv18, 1, !dbg !108
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !163, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !206

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X9_1, align 4, !dbg !139, !tbaa !136
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !148
