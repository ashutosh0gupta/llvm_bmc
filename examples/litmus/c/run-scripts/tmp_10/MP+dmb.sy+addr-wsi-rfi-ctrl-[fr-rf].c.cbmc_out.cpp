...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !66, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 2, metadata !71, metadata !DIExpression()), !dbg !99

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !75, metadata !DIExpression()), !dbg !101

  //   %conv6 = trunc i64 %1 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !72, metadata !DIExpression()), !dbg !90

  //   %tobool = icmp ne i32 %conv6, 0, !dbg !85
...
T2BLOCK4:
  ...
  //   store i32 %conv17, i32* @atom_1_X6_2, align 4, !dbg !104, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !170, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !219

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X6_2, align 4, !dbg !148, !tbaa !146
  // LD: Guess
  old_cr = cr(0,4);
