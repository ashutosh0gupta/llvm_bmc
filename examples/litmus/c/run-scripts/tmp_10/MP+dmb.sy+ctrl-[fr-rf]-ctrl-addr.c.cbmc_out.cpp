...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !87), !dbg !100
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !88), !dbg !112
  ...
  //   %xor = xor i32 %conv15, %conv15, !dbg !97
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !77, metadata !DIExpression()), !dbg !89
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !98
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !118

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !118

  //   %conv19 = trunc i64 %4 to i32, !dbg !100
  ...
  //   %conv20 = zext i1 %cmp to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !82, metadata !DIExpression()), !dbg !89

  //   store i32 %conv20, i32* @atom_1_X0_1, align 4, !dbg !102, !tbaa !103
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv4, 0, !dbg !107
  creg__r1__0_ = max(0,creg_r1);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !83, metadata !DIExpression()), !dbg !89

  //   store i32 %conv22, i32* @atom_1_X2_0, align 4, !dbg !108, !tbaa !103
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv8, 1, !dbg !109
  ...
  //   store i32 %conv24, i32* @atom_1_X4_1, align 4, !dbg !110, !tbaa !103
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv19, 0, !dbg !111
  ...
  //   store i32 %conv26, i32* @atom_1_X8_0, align 4, !dbg !112, !tbaa !103
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !136, metadata !DIExpression()), !dbg !143
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !153, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !154, metadata !DIExpression()), !dbg !211

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !155, metadata !DIExpression()), !dbg !213

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !159, metadata !DIExpression()), !dbg !215

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !160, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !161, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !164, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !167, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !170, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !173, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !177, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !180, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !183, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !187, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !189, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !190, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !192, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !194, metadata !DIExpression()), !dbg !249

  //   %conv24 = trunc i64 %7 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !191, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !195, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !197, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !199, metadata !DIExpression()), !dbg !253

  //   %conv30 = trunc i64 %8 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !196, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !200, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !206, metadata !DIExpression()), !dbg !211

  //   %and34 = and i32 %9, %and33, !dbg !158
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !207, metadata !DIExpression()), !dbg !211

  //   %and35 = and i32 %conv32, %and34, !dbg !159
  creg_r22 = max(creg__r14__1_,creg_r21);
  r22 = (r14==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !208, metadata !DIExpression()), !dbg !211

  //   %and36 = and i32 %conv26, %and35, !dbg !160
  creg_r23 = max(creg__r13__1_,creg_r22);
  r23 = (r13==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !209, metadata !DIExpression()), !dbg !211

  //   %and37 = and i32 %conv20, %and36, !dbg !161
  creg_r24 = max(creg__r12__1_,creg_r23);
  r24 = (r12==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !210, metadata !DIExpression()), !dbg !211
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 95, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !165
