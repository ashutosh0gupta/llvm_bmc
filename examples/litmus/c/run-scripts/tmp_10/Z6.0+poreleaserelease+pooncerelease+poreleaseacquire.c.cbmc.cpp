...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !85, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !89, metadata !DIExpression()), !dbg !97

  //   %conv = trunc i64 %0 to i32, !dbg !54

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !86, metadata !DIExpression()), !dbg !92
  ...
  //   store i32 %conv1, i32* @atom_2_X1_0, align 4, !dbg !56, !tbaa !57
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X1_0, metadata !131, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !158

  //   store atomic i32 0, i32* @atom_2_X1_0 monotonic, align 4, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !135, metadata !DIExpression()), !dbg !171
  ...
  //   %8 = load i32, i32* @atom_2_X1_0, align 4, !dbg !110, !tbaa !108
  // LD: Guess
  old_cr = cr(0,4);
