...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !81), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !78, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !79, metadata !DIExpression()), !dbg !82

  //   store i32 %conv3, i32* @atom_1_X0_1, align 4, !dbg !68, !tbaa !69
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !108, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !109, metadata !DIExpression()), !dbg !143

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !110, metadata !DIExpression()), !dbg !145

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !114, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !115, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64 0, metadata !117, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !118, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_2, metadata !121, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i32 0, metadata !124, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !125, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i32 0, metadata !127, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !132, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !134, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !133, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !137, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !141, metadata !DIExpression()), !dbg !143

  //   %and18 = and i32 %conv10, %and17, !dbg !112
  creg_r13 = max(creg__r7__2_,creg_r12);
  r13 = (r7==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !142, metadata !DIExpression()), !dbg !143
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
