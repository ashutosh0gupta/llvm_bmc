...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !79, metadata !DIExpression()), !dbg !82
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !110, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !111, metadata !DIExpression()), !dbg !144

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !73

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !73

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !112, metadata !DIExpression()), !dbg !146

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !116, metadata !DIExpression()), !dbg !148

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !117, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !127, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i32 0, metadata !130, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !134, metadata !DIExpression()), !dbg !170

  //   %conv = trunc i64 %6 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !131, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !135, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !139, metadata !DIExpression()), !dbg !174

  //   %conv16 = trunc i64 %7 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !136, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !140, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !143, metadata !DIExpression()), !dbg !144
