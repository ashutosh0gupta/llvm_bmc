...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !105, metadata !DIExpression()), !dbg !115
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !107, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64 1, metadata !112, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !113, metadata !DIExpression()), !dbg !115
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
