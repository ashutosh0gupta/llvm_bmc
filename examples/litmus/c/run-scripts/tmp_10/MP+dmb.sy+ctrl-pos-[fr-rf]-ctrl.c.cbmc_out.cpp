...
T2BLOCK7:
  ...
  //   %cmp23 = icmp eq i32 %conv8, 0, !dbg !110
  ...
  //   store i32 %conv24, i32* @atom_1_X4_0, align 4, !dbg !111, !tbaa !104
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv12, 1, !dbg !112
  ...
  //   store i32 %conv26, i32* @atom_1_X5_1, align 4, !dbg !113, !tbaa !104
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv19, 0, !dbg !114
  ...
  //   store i32 %conv28, i32* @atom_1_X6_0, align 4, !dbg !115, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !183, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !186, metadata !DIExpression()), !dbg !237
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
