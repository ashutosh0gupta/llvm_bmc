...
T4BLOCK1:
  ...
  //   call void (...) @dmbld(), !dbg !59
  // dumbld: Guess
  cdl[4] = get_rng(0,NCONTEXT-1);
  // Check
  ASSUME(cdl[4] >= cdy[4]);
  ASSUME(cdl[4] >= cr(4,0+0));
  ASSUME(cdl[4] >= cr(4,0+1));
  ASSUME(cdl[4] >= cr(4,2+0));
  ASSUME(cdl[4] >= cr(4,3+0));
  ASSUME(cdl[4] >= cr(4,4+0));
  ASSUME(cdl[4] >= cr(4,5+0));
  ASSUME(creturn[4] >= cdl[4]);

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !106, metadata !DIExpression()), !dbg !119
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !143, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !146, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !153, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !156, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X2_0, metadata !159, metadata !DIExpression()), !dbg !188
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
