...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !94, metadata !DIExpression()), !dbg !99
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !104, metadata !DIExpression()), !dbg !122
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !106, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !108, metadata !DIExpression()), !dbg !125
  ...
  ASSUME(cdl[4] >= cr(4,6+0));
  ASSUME(cdl[4] >= cr(4,7+0));
  ASSUME(cdl[4] >= cr(4,8+0));
  ASSUME(cdl[4] >= cr(4,9+0));
  ASSUME(creturn[4] >= cdl[4]);

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !114, metadata !DIExpression()), !dbg !133

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !116, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !117, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !118, metadata !DIExpression()), !dbg !136

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !120, metadata !DIExpression()), !dbg !136
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !155, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !158, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !161, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !164, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !167, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !170, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !186, metadata !DIExpression()), !dbg !238
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !145
