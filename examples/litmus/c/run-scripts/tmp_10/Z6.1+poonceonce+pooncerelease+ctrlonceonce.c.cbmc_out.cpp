...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !76, metadata !DIExpression()), !dbg !83
...
T3BLOCK2:
  //   br label %lbl_label226, !dbg !57
  goto T3BLOCK4;

T3BLOCK3:
  //   br label %lbl_label226, !dbg !58
  goto T3BLOCK4;

T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !82), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !77, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !80, metadata !DIExpression()), !dbg !83
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !134, metadata !DIExpression()), !dbg !172
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
