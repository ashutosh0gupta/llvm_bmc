...
T2BLOCK7:
  ...
  //   %xor = xor i32 %conv15, %conv15, !dbg !95
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !74, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !116

  //   %conv16 = sext i32 %add to i64, !dbg !98

  //   call void @llvm.dbg.value(metadata i64 %conv16, metadata !77, metadata !DIExpression()), !dbg !116

  //   store atomic i64 %conv16, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !78, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !82, metadata !DIExpression()), !dbg !87
  ...
  //   %cmp22 = icmp eq i32 %conv20, 1, !dbg !108
  creg__r6__1_ = max(0,creg_r6);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !83, metadata !DIExpression()), !dbg !87

  //   store i32 %conv23, i32* @atom_1_X9_1, align 4, !dbg !109, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !160, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !193

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X9_1, align 4, !dbg !119, !tbaa !117
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
