...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !78, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 0, %xor, !dbg !96
  creg_r4 = max(0,creg_r3);
  r4 = 0 + r3;

  //   %idxprom = sext i32 %add to i64, !dbg !96

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !96
  r5 = 0+r4*1;
  creg_r5 = creg_r4;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !118

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !86, metadata !DIExpression()), !dbg !118
  ...
  //   store i32 %conv19, i32* @atom_1_X4_1, align 4, !dbg !109, !tbaa !104
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv12, 0, !dbg !112
  ...
  //   store i32 %conv23, i32* @atom_1_X7_0, align 4, !dbg !113, !tbaa !104
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X9_0, align 4, !dbg !115, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !163, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !169, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !172, metadata !DIExpression()), !dbg !221
