...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64 2, metadata !71, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !73, metadata !DIExpression()), !dbg !97

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !97
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !85), !dbg !105
  ...
  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !92, !tbaa !93
  // ST: Guess
  ...
  //   store i32 %conv15, i32* @atom_1_X2_1, align 4, !dbg !98, !tbaa !93
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 2, !dbg !99
  ...
  //   store i32 %conv17, i32* @atom_1_X4_2, align 4, !dbg !100, !tbaa !93
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv12, 0, !dbg !101
  ...
  //   store i32 %conv19, i32* @atom_1_X5_0, align 4, !dbg !102, !tbaa !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !143, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !147, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !150, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !153, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !190

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !106
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !107
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %9 = load i32, i32* @atom_1_X5_0, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !138
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #6, !dbg !141

  //   %11 = bitcast i64* %thr0 to i8*, !dbg !141

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #6, !dbg !141
