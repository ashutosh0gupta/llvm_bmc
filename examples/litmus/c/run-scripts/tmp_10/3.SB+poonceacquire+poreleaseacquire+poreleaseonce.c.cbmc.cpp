...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !38, metadata !DIExpression()), !dbg !55
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !57
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !46, metadata !DIExpression()), !dbg !57
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X1_0, metadata !48, metadata !DIExpression()), !dbg !61

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !50, metadata !DIExpression()), !dbg !61

  //   store atomic i64 %1, i64* @atom_0_X1_0 seq_cst, align 8, !dbg !62
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !67, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !73, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X1_0, metadata !75, metadata !DIExpression()), !dbg !88

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !77, metadata !DIExpression()), !dbg !88

  //   store atomic i64 %1, i64* @atom_1_X1_0 seq_cst, align 8, !dbg !62
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !94, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X1_0, metadata !102, metadata !DIExpression()), !dbg !115

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !104, metadata !DIExpression()), !dbg !115

  //   store atomic i64 %1, i64* @atom_2_X1_0 seq_cst, align 8, !dbg !62
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X1_0, metadata !142, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !178

  //   store atomic i64 0, i64* @atom_0_X1_0 monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X1_0, metadata !145, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !180

  //   store atomic i64 0, i64* @atom_1_X1_0 monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X1_0, metadata !148, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !182

  //   store atomic i64 0, i64* @atom_2_X1_0 monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X1_0, metadata !152, metadata !DIExpression()), !dbg !197

  //   %6 = load atomic i64, i64* @atom_0_X1_0 seq_cst, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X1_0, metadata !156, metadata !DIExpression()), !dbg !200

  //   %7 = load atomic i64, i64* @atom_1_X1_0 seq_cst, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X1_0, metadata !160, metadata !DIExpression()), !dbg !203

  //   %8 = load atomic i64, i64* @atom_2_X1_0 seq_cst, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([134 x i8], [134 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
