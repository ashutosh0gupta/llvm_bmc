...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !64, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !103
  ...
  //   %xor5 = xor i32 %conv4, %conv4, !dbg !87
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !71, metadata !DIExpression()), !dbg !94

  //   %add7 = add nsw i32 3, %xor5, !dbg !88
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 3 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !88

  //   %arrayidx9 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !88
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !73, metadata !DIExpression()), !dbg !108

  //   %2 = load atomic i64, i64* %arrayidx9 monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,r7);
...
T2BLOCK4:
  ...
  //   %cmp21 = icmp eq i32 %conv4, 1, !dbg !103

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !84, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !85, metadata !DIExpression()), !dbg !123
