...
T1BLOCK1:
  ...
  //   store i32 %conv1, i32* @atom_0_X1_0, align 4, !dbg !57, !tbaa !58
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !66, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !80
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X1_0, metadata !106, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X1_0, metadata !110, metadata !DIExpression()), !dbg !127
