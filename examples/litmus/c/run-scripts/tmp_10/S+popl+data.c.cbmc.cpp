...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !38, metadata !DIExpression()), !dbg !47
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !52, metadata !DIExpression()), !dbg !68
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !57, metadata !DIExpression()), !dbg !71

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !53, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !58, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !59, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !60, metadata !DIExpression()), !dbg !76

  //   %conv1 = sext i32 %add to i64, !dbg !59

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !62, metadata !DIExpression()), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !63, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !64, metadata !DIExpression()), !dbg !79
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !89, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !90, metadata !DIExpression()), !dbg !115

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !91, metadata !DIExpression()), !dbg !117

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !95, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !96, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64 0, metadata !98, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !102, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !106, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !108, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !109, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !111, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !113, metadata !DIExpression()), !dbg !140
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([96 x i8], [96 x i8]* @.str.1, i64 0, i64 0), i32 noundef 53, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !96
