...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !102), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !111

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !114

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !114

  //   %conv8 = trunc i64 %2 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !69, metadata !DIExpression()), !dbg !105

  //   %tobool = icmp ne i32 %conv8, 0, !dbg !98
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !123

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !123

  //   %conv12 = trunc i64 %3 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !73, metadata !DIExpression()), !dbg !105

  //   %xor = xor i32 %conv12, %conv12, !dbg !107
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !77, metadata !DIExpression()), !dbg !105

  //   %add = add nsw i32 3, %xor, !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !128

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !128

  //   %conv16 = trunc i64 %4 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !78, metadata !DIExpression()), !dbg !105

  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !111

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !113
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK6:
  //   br label %lbl_LC01, !dbg !115
  goto T2BLOCK7;

T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !104), !dbg !135

  //   call void (...) @isb(), !dbg !117
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !137

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !119
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !137

  //   %conv23 = trunc i64 %5 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !82, metadata !DIExpression()), !dbg !105

  //   %cmp = icmp eq i32 %conv, 1, !dbg !121

  //   %conv24 = zext i1 %cmp to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !86, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !141

  //   %6 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !123
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv4, 1, !dbg !124

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !90, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !91, metadata !DIExpression()), !dbg !144

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !126
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv8, 2, !dbg !127

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !94, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !95, metadata !DIExpression()), !dbg !147

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %8, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv23, 0, !dbg !130

  //   %conv37 = zext i1 %cmp36 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv37, metadata !98, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !99, metadata !DIExpression()), !dbg !150

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !101, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !132
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !155, metadata !DIExpression()), !dbg !160
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !156, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 2, metadata !158, metadata !DIExpression()), !dbg !163

  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !49
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !173, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !174, metadata !DIExpression()), !dbg !236

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !175, metadata !DIExpression()), !dbg !238

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !179, metadata !DIExpression()), !dbg !240

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !180, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !181, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !243

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !184, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !245

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !247

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !190, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !249

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !193, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !251

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !196, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !253

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !199, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !255

  //   store atomic i64 0, i64* @atom_1_X3_2 monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !202, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !257

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !138
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call19 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !206, metadata !DIExpression()), !dbg !272

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !208, metadata !DIExpression()), !dbg !272

  //   %conv = trunc i64 %6 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !205, metadata !DIExpression()), !dbg !236

  //   %cmp = icmp eq i32 %conv, 1, !dbg !146

  //   %conv20 = zext i1 %cmp to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !209, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !211, metadata !DIExpression()), !dbg !276

  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !213, metadata !DIExpression()), !dbg !276

  //   %conv24 = trunc i64 %7 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !210, metadata !DIExpression()), !dbg !236

  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !150

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !214, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !216, metadata !DIExpression()), !dbg !280

  //   %8 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !218, metadata !DIExpression()), !dbg !280

  //   %conv30 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !215, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !220, metadata !DIExpression()), !dbg !283

  //   %9 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !155
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !222, metadata !DIExpression()), !dbg !283

  //   %conv34 = trunc i64 %9 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !219, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !224, metadata !DIExpression()), !dbg !286

  //   %10 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !158
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !226, metadata !DIExpression()), !dbg !286

  //   %conv38 = trunc i64 %10 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !223, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !228, metadata !DIExpression()), !dbg !289
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !230, metadata !DIExpression()), !dbg !289

  //   %conv42 = trunc i64 %11 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !227, metadata !DIExpression()), !dbg !236

  //   %and = and i32 %conv38, %conv42, !dbg !163
  ...
  //   %and43 = and i32 %conv34, %and, !dbg !164
  creg_r20 = max(creg_r16,creg_r19);
  ASSUME(active[creg_r20] == 0);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !232, metadata !DIExpression()), !dbg !236

  //   %and44 = and i32 %conv30, %and43, !dbg !165
  creg_r21 = max(creg_r15,creg_r20);
  ASSUME(active[creg_r21] == 0);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !233, metadata !DIExpression()), !dbg !236

  //   %and45 = and i32 %conv26, %and44, !dbg !166
  creg_r22 = max(max(creg_r14,0),creg_r21);
  ASSUME(active[creg_r22] == 0);
  r22 = (r14==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !234, metadata !DIExpression()), !dbg !236

  //   %and46 = and i32 %conv20, %and45, !dbg !167
  creg_r23 = max(max(creg_r13,0),creg_r22);
  ASSUME(active[creg_r23] == 0);
  r23 = (r13==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !235, metadata !DIExpression()), !dbg !236

  //   %cmp47 = icmp eq i32 %and46, 1, !dbg !168

  //   br i1 %cmp47, label %if.then, label %if.end, !dbg !170
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 94, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
