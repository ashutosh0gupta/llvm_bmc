...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !108
...
T2BLOCK7:
  ...
  //   %cmp21 = icmp eq i32 %conv8, 0, !dbg !108
  ...
  //   store i32 %conv22, i32* @atom_1_X5_0, align 4, !dbg !109, !tbaa !104
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv12, 1, !dbg !110
  ...
  //   store i32 %conv24, i32* @atom_1_X7_1, align 4, !dbg !111, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !178, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !181, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !188, metadata !DIExpression()), !dbg !246
