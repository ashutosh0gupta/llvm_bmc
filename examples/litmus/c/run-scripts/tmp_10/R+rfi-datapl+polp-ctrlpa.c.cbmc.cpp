...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !42, metadata !DIExpression()), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !64
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !46, metadata !DIExpression()), !dbg !64

  //   %conv = trunc i64 %0 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !43, metadata !DIExpression()), !dbg !59

  //   %xor = xor i32 %conv, %conv, !dbg !67
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !47, metadata !DIExpression()), !dbg !59

  //   %add = add nsw i32 %xor, 1, !dbg !68
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !48, metadata !DIExpression()), !dbg !59

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !69

  //   %conv3 = sext i32 %add to i64, !dbg !70

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !51, metadata !DIExpression()), !dbg !69

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !70
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !71

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !72
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !52, metadata !DIExpression()), !dbg !59
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !56, metadata !DIExpression()), !dbg !59

  //   store i32 %conv8, i32* @atom_0_X5_2, align 4, !dbg !75, !tbaa !76
  // ST: Guess
  ...
  //   %cmp9 = icmp eq i32 %conv, 1, !dbg !80
  ...
  //   store i32 %conv10, i32* @atom_0_X2_1, align 4, !dbg !81, !tbaa !76
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !86, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64 2, metadata !88, metadata !DIExpression()), !dbg !103

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !58
  // ST: Guess
  //   : Release
  ...
  //   %tobool = icmp ne i32 %conv, 0, !dbg !62
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !99), !dbg !113

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !94, metadata !DIExpression()), !dbg !114

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !69
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   store i32 %conv5, i32* @atom_1_X4_0, align 4, !dbg !72, !tbaa !73
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_2, metadata !143, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !181

  //   store atomic i32 0, i32* @atom_0_X5_2 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !147, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !150, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !185

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X5_2, align 4, !dbg !120, !tbaa !121
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X4_0, align 4, !dbg !124, !tbaa !121
  // LD: Guess
  old_cr = cr(0,5);
