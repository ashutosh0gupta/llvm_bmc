...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !74, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64 1, metadata !76, metadata !DIExpression()), !dbg !112

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !92
  // ST: Guess
  iw(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l36_c3
  old_cw = cw(2,r5);
  cw(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l36_c3
  // Check
...
T2BLOCK7:
  ...
  //   store i32 %conv24, i32* @atom_1_X8_1, align 4, !dbg !116, !tbaa !109
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !142, metadata !DIExpression()), !dbg !149
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !183, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !186, metadata !DIExpression()), !dbg !236
