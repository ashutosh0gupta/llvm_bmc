...
T2BLOCK1:
  ...
  //   %cmp22 = icmp eq i32 %conv4, 2, !dbg !92
  ...
  //   store i32 %conv23, i32* @atom_1_X2_2, align 4, !dbg !93, !tbaa !88
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !119, metadata !DIExpression()), !dbg !126
  ...
  // ST: Guess
  iw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l47_c3
  old_cw = cw(3,0+1*1);
  cw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l47_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !136, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !137, metadata !DIExpression()), !dbg !180

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !138, metadata !DIExpression()), !dbg !182

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !142, metadata !DIExpression()), !dbg !184

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !143, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !153, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !157, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !160, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !166, metadata !DIExpression()), !dbg !210

  //   %conv = trunc i64 %6 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !163, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !167, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !171, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !172, metadata !DIExpression()), !dbg !180
  ...
  //   %10 = load i32, i32* @atom_1_X8_0, align 4, !dbg !130, !tbaa !127
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !175, metadata !DIExpression()), !dbg !180
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
