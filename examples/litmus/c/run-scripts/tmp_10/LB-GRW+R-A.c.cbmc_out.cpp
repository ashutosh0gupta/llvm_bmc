...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !98, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !102, metadata !DIExpression()), !dbg !116
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !146, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !181

  //   store atomic i64 0, i64* @atom_0_X0_1 monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   %7 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(0,4);
