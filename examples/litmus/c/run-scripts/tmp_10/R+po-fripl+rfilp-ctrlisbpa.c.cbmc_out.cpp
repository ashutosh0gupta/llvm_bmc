...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !46, metadata !DIExpression()), !dbg !64

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !48, metadata !DIExpression()), !dbg !64

  //   %conv = trunc i64 %0 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !45, metadata !DIExpression()), !dbg !59

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64 1, metadata !51, metadata !DIExpression()), !dbg !67

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !68
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !69

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !70
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !55, metadata !DIExpression()), !dbg !69

  //   %conv6 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !52, metadata !DIExpression()), !dbg !59

  //   %cmp = icmp eq i32 %conv6, 2, !dbg !72
  creg__r1__2_ = max(0,creg_r1);

  //   %conv7 = zext i1 %cmp to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !56, metadata !DIExpression()), !dbg !59

  //   store i32 %conv7, i32* @atom_0_X5_2, align 4, !dbg !73, !tbaa !74
  // ST: Guess
  ...
  //   %cmp8 = icmp eq i32 %conv, 0, !dbg !78
  creg__r0__0_ = max(0,creg_r0);

  //   %conv9 = zext i1 %cmp8 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !57, metadata !DIExpression()), !dbg !59

  //   store i32 %conv9, i32* @atom_0_X2_0, align 4, !dbg !79, !tbaa !74
  // ST: Guess
  iw(1,3) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l29_c15
  old_cw = cw(1,3);
  cw(1,3) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l29_c15
  // Check
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !83, metadata !DIExpression()), !dbg !99
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !84, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64 2, metadata !86, metadata !DIExpression()), !dbg !102

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !61
  // ST: Guess
  //   : Release
  iw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l35_c3
  old_cw = cw(2,0+1*1);
  cw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l35_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !88, metadata !DIExpression()), !dbg !104

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l36_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !90, metadata !DIExpression()), !dbg !104

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !87, metadata !DIExpression()), !dbg !99

  //   %tobool = icmp ne i32 %conv, 0, !dbg !65
  creg__r2__0_ = max(0,creg_r2);

  //   br i1 %tobool, label %if.then, label %if.else, !dbg !67
  old_cctrl = cctrl[2];
...
T2BLOCK3:
  //   br label %lbl_LC00, !dbg !69
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !98), !dbg !112

  //   call void (...) @isb(), !dbg !71
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !92, metadata !DIExpression()), !dbg !114

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !73
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !94, metadata !DIExpression()), !dbg !114

  //   %conv4 = trunc i64 %1 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !91, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 2, !dbg !75
  creg__r2__2_ = max(0,creg_r2);

  //   %conv5 = zext i1 %cmp to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !95, metadata !DIExpression()), !dbg !99

  //   store i32 %conv5, i32* @atom_1_X2_2, align 4, !dbg !76, !tbaa !77
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv4, 0, !dbg !81
  creg__r3__0_ = max(0,creg_r3);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !96, metadata !DIExpression()), !dbg !99

  //   store i32 %conv7, i32* @atom_1_X3_0, align 4, !dbg !82, !tbaa !77
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_2, metadata !142, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i32 0, metadata !145, metadata !DIExpression()), !dbg !183

  //   store atomic i32 0, i32* @atom_0_X5_2 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !146, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !185

  //   store atomic i32 0, i32* @atom_0_X2_0 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !149, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !152, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !189

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X5_2, align 4, !dbg !124, !tbaa !125
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %7 = load i32, i32* @atom_0_X2_0, align 4, !dbg !127, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %9 = load i32, i32* @atom_1_X3_0, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
