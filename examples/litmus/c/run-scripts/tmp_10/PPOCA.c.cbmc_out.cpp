...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !146, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !149, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !155, metadata !DIExpression()), !dbg !193

  //   %conv = trunc i64 %4 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !152, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !157, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !159, metadata !DIExpression()), !dbg !196

  //   %conv17 = trunc i64 %5 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !156, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !161, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !163, metadata !DIExpression()), !dbg !199
