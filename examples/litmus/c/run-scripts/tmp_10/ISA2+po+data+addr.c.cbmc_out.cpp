...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !61, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !62, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !63, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !80

  //   %conv1 = sext i32 %add to i64, !dbg !63

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !66, metadata !DIExpression()), !dbg !80

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !67, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !68, metadata !DIExpression()), !dbg !83
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !88, metadata !DIExpression()), !dbg !107
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !90, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !92, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !93, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !95, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !97, metadata !DIExpression()), !dbg !115

  //   %conv4 = trunc i64 %1 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !94, metadata !DIExpression()), !dbg !107

  //   %cmp = icmp eq i32 %conv, 1, !dbg !68

  //   %conv5 = zext i1 %cmp to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !98, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !99, metadata !DIExpression()), !dbg !118

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !101, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !102, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !103, metadata !DIExpression()), !dbg !121

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !105, metadata !DIExpression()), !dbg !121
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !148, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !151, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !154, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !162, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !166, metadata !DIExpression()), !dbg !209
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
