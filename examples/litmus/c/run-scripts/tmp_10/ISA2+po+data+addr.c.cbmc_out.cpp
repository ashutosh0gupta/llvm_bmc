...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !43, metadata !DIExpression()), !dbg !52
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !57, metadata !DIExpression()), !dbg !69
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !61, metadata !DIExpression()), !dbg !72

  //   %conv = trunc i64 %0 to i32, !dbg !56

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !58, metadata !DIExpression()), !dbg !69

  //   %xor = xor i32 %conv, %conv, !dbg !57
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !62, metadata !DIExpression()), !dbg !69

  //   %add = add nsw i32 %xor, 1, !dbg !58
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !63, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !77

  //   %conv1 = sext i32 %add to i64, !dbg !60

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !66, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !67, metadata !DIExpression()), !dbg !69
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !93, metadata !DIExpression()), !dbg !101

  //   %add = add nsw i32 0, %xor, !dbg !59
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !95, metadata !DIExpression()), !dbg !109

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(3,r6);
  cr(3,r6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l41_c16
  // Check
  ASSUME(active[cr(3,r6)] == 3);
  ASSUME(cr(3,r6) >= iw(3,r6));
  ASSUME(cr(3,r6) >= creg_r6);
  ASSUME(cr(3,r6) >= cdy[3]);
  ASSUME(cr(3,r6) >= cisb[3]);
  ASSUME(cr(3,r6) >= cdl[3]);
  ASSUME(cr(3,r6) >= cl[3]);
  // Update
  creg_r7 = cr(3,r6);
  crmax(3,r6) = max(crmax(3,r6),cr(3,r6));
  caddr[3] = max(caddr[3],creg_r6);
  if(cr(3,r6) < cw(3,r6)) {
    r7 = buff(3,r6);
    ASSUME((!(( (cw(3,r6) < 1) && (1 < crmax(3,r6)) )))||(sforbid(r6,1)> 0));
    ASSUME((!(( (cw(3,r6) < 2) && (2 < crmax(3,r6)) )))||(sforbid(r6,2)> 0));
    ASSUME((!(( (cw(3,r6) < 3) && (3 < crmax(3,r6)) )))||(sforbid(r6,3)> 0));
    ASSUME((!(( (cw(3,r6) < 4) && (4 < crmax(3,r6)) )))||(sforbid(r6,4)> 0));
    ASSUME((!(( (cw(3,r6) < 5) && (5 < crmax(3,r6)) )))||(sforbid(r6,5)> 0));
    ASSUME((!(( (cw(3,r6) < 6) && (6 < crmax(3,r6)) )))||(sforbid(r6,6)> 0));
    ASSUME((!(( (cw(3,r6) < 7) && (7 < crmax(3,r6)) )))||(sforbid(r6,7)> 0));
    ASSUME((!(( (cw(3,r6) < 8) && (8 < crmax(3,r6)) )))||(sforbid(r6,8)> 0));
    ASSUME((!(( (cw(3,r6) < 9) && (9 < crmax(3,r6)) )))||(sforbid(r6,9)> 0));
  } else {
    if(pw(3,r6) != co(r6,cr(3,r6))) {
      ASSUME(cr(3,r6) >= old_cr);
    }
    pw(3,r6) = co(r6,cr(3,r6));
    r7 = mem(r6,cr(3,r6));
  }
  ASSUME(creturn[3] >= cr(3,r6));

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !97, metadata !DIExpression()), !dbg !109

  //   %conv4 = trunc i64 %1 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !94, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !98, metadata !DIExpression()), !dbg !101

  //   store i32 %conv5, i32* @atom_2_X0_1, align 4, !dbg !63, !tbaa !64
  // ST: Guess
  iw(3,4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l43_c15
  old_cw = cw(3,4);
  cw(3,4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l43_c15
  // Check
  ASSUME(active[iw(3,4)] == 3);
  ASSUME(active[cw(3,4)] == 3);
  ASSUME(sforbid(4,cw(3,4))== 0);
  ASSUME(iw(3,4) >= creg__r3__1_);
  ASSUME(iw(3,4) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !99, metadata !DIExpression()), !dbg !101

  //   store i32 %conv7, i32* @atom_2_X3_0, align 4, !dbg !69, !tbaa !64
  // ST: Guess
  iw(3,5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l45_c15
  old_cw = cw(3,5);
  cw(3,5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l45_c15
  // Check
  ASSUME(active[iw(3,5)] == 3);
  ASSUME(active[cw(3,5)] == 3);
  ASSUME(sforbid(5,cw(3,5))== 0);
  ASSUME(iw(3,5) >= creg__r7__0_);
  ASSUME(iw(3,5) >= 0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !123, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !124, metadata !DIExpression()), !dbg !155

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !125, metadata !DIExpression()), !dbg !157

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !129, metadata !DIExpression()), !dbg !159

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !130, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !140, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !144, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !170

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X3_0, metadata !147, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !172

  //   store atomic i32 0, i32* @atom_2_X3_0 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !106, !tbaa !107
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_2_X0_1, align 4, !dbg !109, !tbaa !107
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %8 = load i32, i32* @atom_2_X3_0, align 4, !dbg !110, !tbaa !107
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !152, metadata !DIExpression()), !dbg !155

  //   %and = and i32 %7, %8, !dbg !111
  creg_r15 = max(creg_r13,creg_r14);
  r15 = r13 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !153, metadata !DIExpression()), !dbg !155
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
