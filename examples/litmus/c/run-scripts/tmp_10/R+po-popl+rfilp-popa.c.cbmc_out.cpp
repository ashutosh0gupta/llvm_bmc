...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !78, metadata !DIExpression()), !dbg !99
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !81, metadata !DIExpression()), !dbg !102

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !64
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !83, metadata !DIExpression()), !dbg !104

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !66
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !85, metadata !DIExpression()), !dbg !104

  //   %conv = trunc i64 %0 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !82, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !89, metadata !DIExpression()), !dbg !107

  //   %conv4 = trunc i64 %1 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !86, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 2, !dbg !71

  //   %conv5 = zext i1 %cmp to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !90, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !91, metadata !DIExpression()), !dbg !111

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !93, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %2, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !73
  // ST: Guess
  ...
  //   %cmp9 = icmp eq i32 %conv4, 0, !dbg !74

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !94, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !95, metadata !DIExpression()), !dbg !114

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !97, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %3, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !76
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !124, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !125, metadata !DIExpression()), !dbg !175

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !126, metadata !DIExpression()), !dbg !177

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !130, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !131, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !134, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !137, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !140, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !143, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !146, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !150, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !152, metadata !DIExpression()), !dbg !202

  //   %conv = trunc i64 %4 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !149, metadata !DIExpression()), !dbg !175

  //   %cmp = icmp eq i32 %conv, 1, !dbg !123

  //   %conv14 = zext i1 %cmp to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !153, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !157, metadata !DIExpression()), !dbg !206

  //   %conv18 = trunc i64 %5 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !154, metadata !DIExpression()), !dbg !175

  //   %cmp19 = icmp eq i32 %conv18, 2, !dbg !127

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !158, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !160, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !162, metadata !DIExpression()), !dbg !210

  //   %conv24 = trunc i64 %6 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !159, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !164, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !166, metadata !DIExpression()), !dbg !213

  //   %conv28 = trunc i64 %7 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !163, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !168, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !170, metadata !DIExpression()), !dbg !216

  //   %conv32 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !167, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !172, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !173, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !174, metadata !DIExpression()), !dbg !175
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !144
