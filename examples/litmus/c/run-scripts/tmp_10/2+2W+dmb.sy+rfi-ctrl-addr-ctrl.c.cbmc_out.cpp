...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !76), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !63, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !66, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !68, metadata !DIExpression()), !dbg !97
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !77), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !73, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !74, metadata !DIExpression()), !dbg !78

  //   store i32 %conv14, i32* @atom_1_X2_2, align 4, !dbg !89, !tbaa !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !128, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !131, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !134, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !137, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !140, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !170

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !88
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !90
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !91, !tbaa !92
  r7 = local_mem[0];

  //   %call10 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !96
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !97, !tbaa !92
  r8 = local_mem[1];
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !147, metadata !DIExpression()), !dbg !180

  //   %conv = trunc i64 %4 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !144, metadata !DIExpression()), !dbg !157

  //   %cmp = icmp eq i32 %conv, 2, !dbg !102
  creg__r9__2_ = max(0,creg_r9);

  //   %conv12 = zext i1 %cmp to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !148, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !184

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !152, metadata !DIExpression()), !dbg !184

  //   %conv16 = trunc i64 %5 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !149, metadata !DIExpression()), !dbg !157

  //   %cmp17 = icmp eq i32 %conv16, 2, !dbg !106
  creg__r10__2_ = max(0,creg_r10);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !153, metadata !DIExpression()), !dbg !157

  //   %6 = load i32, i32* @atom_1_X2_2, align 4, !dbg !107, !tbaa !108
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !115
...
T0BLOCK2:
  //   %7 = bitcast i64* %thr1 to i8*, !dbg !118

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %7) #7, !dbg !118

  //   %8 = bitcast i64* %thr0 to i8*, !dbg !118

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #7, !dbg !118
