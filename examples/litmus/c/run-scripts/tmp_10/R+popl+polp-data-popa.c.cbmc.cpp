...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !79, metadata !DIExpression()), !dbg !98

  //   %conv3 = sext i32 %add to i64, !dbg !67

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !81, metadata !DIExpression()), !dbg !98

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !67
  // ST: Guess
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !69
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !132, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !136, metadata !DIExpression()), !dbg !175
