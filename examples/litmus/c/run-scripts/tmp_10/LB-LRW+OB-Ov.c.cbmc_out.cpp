...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !38, metadata !DIExpression()), !dbg !50
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !67, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !69, metadata !DIExpression()), !dbg !78

  //   %conv = trunc i64 %0 to i32, !dbg !52

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !66, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !72, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !73, metadata !DIExpression()), !dbg !75
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !93, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !94, metadata !DIExpression()), !dbg !116

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !95, metadata !DIExpression()), !dbg !118

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !99, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !100, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !105, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !106, metadata !DIExpression()), !dbg !125

  //   call void @llvm.dbg.value(metadata i32 0, metadata !109, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !110, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i32 0, metadata !112, metadata !DIExpression()), !dbg !127

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !75
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l44_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l44_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !113, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !114, metadata !DIExpression()), !dbg !116
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([97 x i8], [97 x i8]* @.str.1, i64 0, i64 0), i32 noundef 55, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
