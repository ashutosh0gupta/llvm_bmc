...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !84, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64 1, metadata !86, metadata !DIExpression()), !dbg !94
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !99, metadata !DIExpression()), !dbg !117
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !101, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !103, metadata !DIExpression()), !dbg !120

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !100, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !105, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !107, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !109, metadata !DIExpression()), !dbg !127

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !111, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !112, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !113, metadata !DIExpression()), !dbg !130

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !115, metadata !DIExpression()), !dbg !130
