...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !58, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !56, metadata !DIExpression()), !dbg !78
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !66
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64 1, metadata !68, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !70, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !73, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !74, metadata !DIExpression()), !dbg !94

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !94
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !111, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !114, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !117, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64 0, metadata !119, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !120, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i64 0, metadata !122, metadata !DIExpression()), !dbg !149

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !124, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !126, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !129, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !131, metadata !DIExpression()), !dbg !165

  //   %conv14 = trunc i64 %5 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !128, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !133, metadata !DIExpression()), !dbg !168

  //   %6 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !135, metadata !DIExpression()), !dbg !168

  //   %conv18 = trunc i64 %6 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !132, metadata !DIExpression()), !dbg !138
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([128 x i8], [128 x i8]* @.str.1, i64 0, i64 0), i32 noundef 60, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !112
