...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !58, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !65, metadata !DIExpression()), !dbg !80

  //   %conv4 = trunc i64 %1 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !62, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !82
  ...
  //   store i32 %conv5, i32* @atom_1_X0_1, align 4, !dbg !66, !tbaa !67
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !100, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !101, metadata !DIExpression()), !dbg !129

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !70

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !70

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !102, metadata !DIExpression()), !dbg !131

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !106, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !107, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64 0, metadata !109, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !113, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i32 0, metadata !116, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !117, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i32 0, metadata !119, metadata !DIExpression()), !dbg !140

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !121, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !123, metadata !DIExpression()), !dbg !150
  ...
  //   %6 = load i32, i32* @atom_1_X3_0, align 4, !dbg !99, !tbaa !97
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and11, metadata !128, metadata !DIExpression()), !dbg !129
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([128 x i8], [128 x i8]* @.str.1, i64 0, i64 0), i32 noundef 60, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !105
