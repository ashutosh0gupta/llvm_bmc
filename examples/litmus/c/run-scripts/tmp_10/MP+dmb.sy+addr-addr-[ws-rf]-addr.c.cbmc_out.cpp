...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !68, metadata !DIExpression()), !dbg !85

  //   %add6 = add nsw i32 3, %xor5, !dbg !77
  creg_r6 = max(0,creg_r5);
  r6 = 3 + r5;

  //   %idxprom7 = sext i32 %add6 to i64, !dbg !77

  //   %arrayidx8 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom7, !dbg !77
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx8, metadata !69, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64 1, metadata !71, metadata !DIExpression()), !dbg !97

  //   store atomic i64 1, i64* %arrayidx8 monotonic, align 8, !dbg !77
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !73, metadata !DIExpression()), !dbg !98
  ...
  //   %conv12 = trunc i64 %2 to i32, !dbg !81
  ...
  //   %arrayidx17 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !83
  r11 = 0+r10*1;
  creg_r11 = creg_r10;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !78, metadata !DIExpression()), !dbg !103

  //   %3 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,r11);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !103

  //   %conv20 = trunc i64 %3 to i32, !dbg !85
  ...
  //   %cmp22 = icmp eq i32 %conv12, 2, !dbg !92
  ...
  //   store i32 %conv23, i32* @atom_1_X8_2, align 4, !dbg !93, !tbaa !88
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X10_0, align 4, !dbg !95, !tbaa !88
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !119, metadata !DIExpression()), !dbg !126
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !136, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !137, metadata !DIExpression()), !dbg !189

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !138, metadata !DIExpression()), !dbg !191

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !142, metadata !DIExpression()), !dbg !193

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !143, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !144, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !147, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_2, metadata !160, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !206

  //   store atomic i32 0, i32* @atom_1_X8_2 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !163, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !169, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !170, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !172, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !174, metadata !DIExpression()), !dbg !225

  //   %conv22 = trunc i64 %7 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !171, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !175, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !179, metadata !DIExpression()), !dbg !229

  //   %conv28 = trunc i64 %8 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !176, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !180, metadata !DIExpression()), !dbg !189
  ...
  //   %10 = load i32, i32* @atom_1_X8_2, align 4, !dbg !144, !tbaa !142
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !185, metadata !DIExpression()), !dbg !189

  //   %and32 = and i32 %conv30, %and31, !dbg !148
  creg_r25 = max(creg__r19__1_,creg_r24);
  r25 = (r19==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !186, metadata !DIExpression()), !dbg !189

  //   %and33 = and i32 %conv24, %and32, !dbg !149
  creg_r26 = max(creg__r18__1_,creg_r25);
  r26 = (r18==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !187, metadata !DIExpression()), !dbg !189

  //   %and34 = and i32 %conv18, %and33, !dbg !150
  creg_r27 = max(creg__r17__2_,creg_r26);
  r27 = (r17==2) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !188, metadata !DIExpression()), !dbg !189
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 87, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154
