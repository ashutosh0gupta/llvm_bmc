...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !40, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !45, metadata !DIExpression()), !dbg !60
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !73, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64 3, metadata !75, metadata !DIExpression()), !dbg !93

  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !62
  // ST: Guess
  iw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0+1*1);
  cw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !82, metadata !DIExpression()), !dbg !97

  //   %conv = trunc i64 %0 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !79, metadata !DIExpression()), !dbg !88

  //   %cmp = icmp eq i32 %conv, 0, !dbg !68

  //   %conv5 = zext i1 %cmp to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !83, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !84, metadata !DIExpression()), !dbg !101

  //   %1 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !86, metadata !DIExpression()), !dbg !101

  //   store atomic i64 %1, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !70
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !127, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64 0, metadata !129, metadata !DIExpression()), !dbg !171

  //   store atomic i64 0, i64* @atom_0_X4_2 monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !130, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64 0, metadata !132, metadata !DIExpression()), !dbg !173

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv16, 3, !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !149, metadata !DIExpression()), !dbg !197

  //   %7 = load atomic i64, i64* @atom_0_X4_2 seq_cst, align 8, !dbg !127
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !153, metadata !DIExpression()), !dbg !200
