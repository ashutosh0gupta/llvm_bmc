...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !50, metadata !DIExpression()), !dbg !77

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !49, metadata !DIExpression()), !dbg !60

  //   %xor = xor i32 %conv8, %conv8, !dbg !80
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !53, metadata !DIExpression()), !dbg !60
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !54, metadata !DIExpression()), !dbg !82
  ...
  // ST: Guess
  iw(1,r5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l27_c3
  old_cw = cw(1,r5);
  cw(1,r5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l27_c3
  // Check
