...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !119, metadata !DIExpression()), !dbg !143

  //   call void @llvm.dbg.value(metadata i32 0, metadata !122, metadata !DIExpression()), !dbg !143

  //   store atomic i32 0, i32* @atom_0_X2_1 monotonic, align 4, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !123, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i32 0, metadata !125, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !126, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i32 0, metadata !128, metadata !DIExpression()), !dbg !147
  ...
  //   %4 = load i32, i32* @atom_0_X2_1, align 4, !dbg !95, !tbaa !96
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !129, metadata !DIExpression()), !dbg !134
  ...
  //   %6 = load i32, i32* @atom_1_X3_0, align 4, !dbg !99, !tbaa !96
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and12, metadata !133, metadata !DIExpression()), !dbg !134
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !105
