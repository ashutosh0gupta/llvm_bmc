...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !175, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !228

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X6_2, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
