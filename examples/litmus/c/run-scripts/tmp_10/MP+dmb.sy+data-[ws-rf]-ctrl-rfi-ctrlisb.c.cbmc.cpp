...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !102), !dbg !122
  ...
  //   %tobool12 = icmp ne i32 %conv11, 0, !dbg !109

  //   br i1 %tobool12, label %if.then13, label %if.else14, !dbg !111
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !103), !dbg !133

  //   call void (...) @isb(), !dbg !115
  // isb: Guess
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !84, metadata !DIExpression()), !dbg !135

  //   %conv18 = trunc i64 %3 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !81, metadata !DIExpression()), !dbg !104

  //   %cmp = icmp eq i32 %conv, 1, !dbg !119

  //   %conv19 = zext i1 %cmp to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !85, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !86, metadata !DIExpression()), !dbg !139

  //   %4 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !88, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv5, 2, !dbg !122

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !89, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !90, metadata !DIExpression()), !dbg !142

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !92, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %5, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !124
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv11, 1, !dbg !125

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !93, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !94, metadata !DIExpression()), !dbg !145

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !96, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %6, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv18, 0, !dbg !128

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !97, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !98, metadata !DIExpression()), !dbg !148

  //   %7 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %7, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !156, metadata !DIExpression()), !dbg !161
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !171, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !172, metadata !DIExpression()), !dbg !246

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !173, metadata !DIExpression()), !dbg !248

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !177, metadata !DIExpression()), !dbg !250

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !178, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !179, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !182, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !188, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !191, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !194, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !197, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !200, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !204, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !206, metadata !DIExpression()), !dbg !282

  //   %conv = trunc i64 %6 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !203, metadata !DIExpression()), !dbg !246

  //   %cmp = icmp eq i32 %conv, 1, !dbg !158

  //   %conv20 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !207, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !209, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !211, metadata !DIExpression()), !dbg !286

  //   %conv24 = trunc i64 %7 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !208, metadata !DIExpression()), !dbg !246

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !162

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !212, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !214, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !216, metadata !DIExpression()), !dbg !290

  //   %conv30 = trunc i64 %8 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !213, metadata !DIExpression()), !dbg !246

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !166

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !217, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !219, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !221, metadata !DIExpression()), !dbg !294

  //   %conv36 = trunc i64 %9 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !218, metadata !DIExpression()), !dbg !246

  //   %cmp37 = icmp eq i32 %conv36, 2, !dbg !170

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !222, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !224, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !226, metadata !DIExpression()), !dbg !298

  //   %conv42 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !223, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !228, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !230, metadata !DIExpression()), !dbg !301

  //   %conv46 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !227, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !232, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !234, metadata !DIExpression()), !dbg !304

  //   %conv50 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !231, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !236, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !238, metadata !DIExpression()), !dbg !307

  //   %conv54 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !235, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !240, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !241, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !242, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !243, metadata !DIExpression()), !dbg !246

  //   %and59 = and i32 %conv26, %and58, !dbg !188
  creg_r23 = max(max(creg_r11,0),creg_r22);
  ASSUME(active[creg_r23] == 0);
  r23 = (r11==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !244, metadata !DIExpression()), !dbg !246

  //   %and60 = and i32 %conv20, %and59, !dbg !189
  creg_r24 = max(max(creg_r10,0),creg_r23);
  ASSUME(active[creg_r24] == 0);
  r24 = (r10==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !245, metadata !DIExpression()), !dbg !246
