...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !81, metadata !DIExpression()), !dbg !98

  //   %conv8 = trunc i64 %2 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !78, metadata !DIExpression()), !dbg !88

  //   %xor9 = xor i32 %conv8, %conv8, !dbg !70
  creg_r9 = creg_r8;
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !82, metadata !DIExpression()), !dbg !88

  //   %add10 = add nsw i32 0, %xor9, !dbg !71
  creg_r10 = max(0,creg_r9);
  r10 = 0 + r9;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !71

  //   %arrayidx12 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !71
  r11 = 0+r10*1;
  creg_r11 = creg_r10;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !83, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64 1, metadata !85, metadata !DIExpression()), !dbg !103

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  //   %conv13 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !86, metadata !DIExpression()), !dbg !88

  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !74, !tbaa !75
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !130, metadata !DIExpression()), !dbg !163
