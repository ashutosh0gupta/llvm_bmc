...
T1BLOCK1:
  ...
  //   store i32 %conv11, i32* @atom_0_X8_2, align 4, !dbg !80, !tbaa !81
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv4, 0, !dbg !85
  creg__r4__0_ = max(0,creg_r4);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !60, metadata !DIExpression()), !dbg !62

  //   store i32 %conv13, i32* @atom_0_X5_0, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X8_2, metadata !134, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i32 0, metadata !137, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_0, metadata !138, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i32 0, metadata !140, metadata !DIExpression()), !dbg !174

  //   store atomic i32 0, i32* @atom_0_X5_0 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !141, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !147, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !148, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !150, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !152, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !153, metadata !DIExpression()), !dbg !161
  ...
  //   %7 = load i32, i32* @atom_0_X5_0, align 4, !dbg !123, !tbaa !121
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !158, metadata !DIExpression()), !dbg !161

  //   %and22 = and i32 %conv20, %and21, !dbg !127
  creg_r17 = max(creg__r11__2_,creg_r16);
  r17 = (r11==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !159, metadata !DIExpression()), !dbg !161

  //   %and23 = and i32 %conv14, %and22, !dbg !128
  creg_r18 = max(creg__r10__1_,creg_r17);
  r18 = (r10==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !160, metadata !DIExpression()), !dbg !161
