...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !146, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !181

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !98
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_2_X0_1, align 4, !dbg !126, !tbaa !124
  // LD: Guess
  old_cr = cr(0,4);
