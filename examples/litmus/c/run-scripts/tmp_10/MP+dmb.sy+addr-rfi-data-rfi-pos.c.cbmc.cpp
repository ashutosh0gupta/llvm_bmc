...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !74, metadata !DIExpression()), !dbg !103
  ...
  //   %conv9 = sext i32 %add6 to i64, !dbg !99

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !77, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !164, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !193, metadata !DIExpression()), !dbg !254
