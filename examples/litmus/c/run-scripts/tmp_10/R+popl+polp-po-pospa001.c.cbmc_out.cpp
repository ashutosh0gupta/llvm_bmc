...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !83, metadata !DIExpression()), !dbg !90
  ...
  //   store i32 %conv9, i32* @atom_1_X4_0, align 4, !dbg !73, !tbaa !74
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv8, 0, !dbg !78
  creg__r3__0_ = max(0,creg_r3);

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !88, metadata !DIExpression()), !dbg !90

  //   store i32 %conv11, i32* @atom_1_X6_0, align 4, !dbg !79, !tbaa !74
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !132, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !136, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !139, metadata !DIExpression()), !dbg !174
