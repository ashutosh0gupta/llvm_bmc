...
T2BLOCK1:
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   store i32 %conv5, i32* @atom_1_X0_2, align 4, !dbg !62, !tbaa !63
  // ST: Guess
  ...
  //   store i32 %conv7, i32* @atom_1_X2_0, align 4, !dbg !68, !tbaa !63
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !85, metadata !DIExpression()), !dbg !90
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !86, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64 1, metadata !88, metadata !DIExpression()), !dbg !93
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !98, metadata !DIExpression()), !dbg !110
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !100, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !102, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !103, metadata !DIExpression()), !dbg !110
...
T4BLOCK2:
  //   br label %lbl_label184, !dbg !61
  goto T4BLOCK4;

T4BLOCK3:
  //   br label %lbl_label184, !dbg !62
  goto T4BLOCK4;

T4BLOCK4:
  //   call void @llvm.dbg.label(metadata !109), !dbg !122

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !104, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 1, metadata !106, metadata !DIExpression()), !dbg !123

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !65
  // ST: Guess
  iw(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l49_c3
  old_cw = cw(4,0);
  cw(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l49_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !107, metadata !DIExpression()), !dbg !110

  //   store i32 %conv3, i32* @atom_3_X0_1, align 4, !dbg !67, !tbaa !68
  // ST: Guess
  iw(4,4) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l51_c15
  old_cw = cw(4,4);
  cw(4,4) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l51_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !135, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !136, metadata !DIExpression()), !dbg !171

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !137, metadata !DIExpression()), !dbg !173

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !141, metadata !DIExpression()), !dbg !175

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !142, metadata !DIExpression()), !dbg !177

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !143, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !147, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !149, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !150, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !154, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !157, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !164, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !169, metadata !DIExpression()), !dbg !171

  //   %and18 = and i32 %conv16, %and17, !dbg !124
  creg_r14 = max(creg__r8__2_,creg_r13);
  r14 = (r8==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !170, metadata !DIExpression()), !dbg !171
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([132 x i8], [132 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
