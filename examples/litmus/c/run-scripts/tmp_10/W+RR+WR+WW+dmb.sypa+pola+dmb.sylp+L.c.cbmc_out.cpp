...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !86, metadata !DIExpression()), !dbg !98
  ...
  //   store i32 %conv1, i32* @atom_2_X2_0, align 4, !dbg !58, !tbaa !59
  // ST: Guess
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !112, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i64 1, metadata !114, metadata !DIExpression()), !dbg !122

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !54
  // ST: Guess
  iw(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l50_c3
  old_cw = cw(4,0);
  cw(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l50_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !157, metadata !DIExpression()), !dbg !190
