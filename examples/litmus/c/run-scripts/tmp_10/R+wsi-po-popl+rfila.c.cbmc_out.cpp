...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64 4, metadata !44, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !47, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !58, metadata !DIExpression()), !dbg !78
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !142, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !180

  //   store atomic i64 0, i64* @atom_0_X6_2 monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !145, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !182

  //   store atomic i64 0, i64* @atom_1_X3_3 monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !148, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !184

  //   store atomic i64 0, i64* @atom_1_X2_2 monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !157, metadata !DIExpression()), !dbg !200

  //   %5 = load atomic i64, i64* @atom_0_X6_2 seq_cst, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !161, metadata !DIExpression()), !dbg !203

  //   %6 = load atomic i64, i64* @atom_1_X3_3 seq_cst, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !165, metadata !DIExpression()), !dbg !206

  //   %7 = load atomic i64, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,4);
