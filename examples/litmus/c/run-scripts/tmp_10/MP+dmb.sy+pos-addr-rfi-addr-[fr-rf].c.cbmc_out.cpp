...
T2BLOCK1:
  ...
  //   %cmp28 = icmp eq i32 %conv20, 1, !dbg !109
  ...
  //   store i32 %conv29, i32* @atom_1_X10_1, align 4, !dbg !110, !tbaa !99
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !134, metadata !DIExpression()), !dbg !141
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !181, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !232

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !128
  // ST: Guess
  ...
  //   %13 = load i32, i32* @atom_1_X10_1, align 4, !dbg !160, !tbaa !155
  // LD: Guess
  old_cr = cr(0,7);
  ...
  creg_r29 = max(creg__r15__2_,creg_r28);
  r29 = (r15==2) & r28;
