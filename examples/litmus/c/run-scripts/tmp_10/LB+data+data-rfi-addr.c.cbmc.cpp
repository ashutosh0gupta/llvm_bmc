...
T2BLOCK1:
  ...
  //   %xor6 = xor i32 %conv5, %conv5, !dbg !73
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !84, metadata !DIExpression()), !dbg !91

  //   %add8 = add nsw i32 0, %xor6, !dbg !74
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom = sext i32 %add8 to i64, !dbg !74

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !74
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !85, metadata !DIExpression()), !dbg !106
  ...
  //   %cmp11 = icmp eq i32 %conv5, 1, !dbg !82
  ...
  //   store i32 %conv12, i32* @atom_1_X4_1, align 4, !dbg !83, !tbaa !78
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !142, metadata !DIExpression()), !dbg !183
