...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !58, metadata !DIExpression()), !dbg !81
  ...
  //   %and = and i32 %conv, 8, !dbg !65
  creg_r1 = max(0,creg_r0);
  r1 = r0 & 8;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !61, metadata !DIExpression()), !dbg !78

  //   %add = add nsw i32 2, %and, !dbg !66
  creg_r2 = max(0,creg_r1);
  r2 = 2 + r1;

  //   %1 = zext i32 %add to i64

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %1, !dbg !66
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !86

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !66
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !65, metadata !DIExpression()), !dbg !86

  //   %conv4 = trunc i64 %2 to i32, !dbg !68
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !70
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !69, metadata !DIExpression()), !dbg !88

  //   %conv8 = trunc i64 %3 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !66, metadata !DIExpression()), !dbg !78

  //   %and9 = and i32 %conv8, 128, !dbg !72
  creg_r6 = max(0,creg_r5);
  r6 = r5 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and9, metadata !70, metadata !DIExpression()), !dbg !78

  //   %add11 = add nsw i32 1, %and9, !dbg !73
  creg_r7 = max(0,creg_r6);
  r7 = 1 + r6;

  //   %4 = zext i32 %add11 to i64

  //   %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %4, !dbg !73
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !72, metadata !DIExpression()), !dbg !93

  //   %5 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !73
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !74, metadata !DIExpression()), !dbg !93

  //   %conv16 = trunc i64 %5 to i32, !dbg !75
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !111, metadata !DIExpression()), !dbg !137

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !112, metadata !DIExpression()), !dbg !137

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !113, metadata !DIExpression()), !dbg !139

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !117, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !118, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64 0, metadata !120, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !121, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64 0, metadata !123, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !124, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !127, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i32 0, metadata !130, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !131, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !150

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !80
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !82
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !88
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call11 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !90
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i32, i32* @atom_1_X0_1, align 4, !dbg !91, !tbaa !92
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %5 = load i32, i32* @atom_1_X7_0, align 4, !dbg !94, !tbaa !92
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l58_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !135, metadata !DIExpression()), !dbg !137

  //   %and = and i32 %4, %5, !dbg !95
  creg_r15 = max(creg_r13,creg_r14);
  r15 = r13 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !136, metadata !DIExpression()), !dbg !137

  //   %cmp = icmp eq i32 %and, 1, !dbg !96
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 60, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !99
...
T0BLOCK2:
  //   %6 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %6) #7, !dbg !102

  //   %7 = bitcast i64* %thr0 to i8*, !dbg !102

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %7) #7, !dbg !102
