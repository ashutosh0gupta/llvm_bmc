...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !58, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !61, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !65, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !69, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %and9, metadata !70, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !74, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !78, metadata !DIExpression()), !dbg !102

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !82, metadata !DIExpression()), !dbg !105

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !87
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !131, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64 0, metadata !133, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !134, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64 0, metadata !136, metadata !DIExpression()), !dbg !159

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !85
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !87
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !93
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call11 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !95
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !138, metadata !DIExpression()), !dbg !171

  //   %4 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !140, metadata !DIExpression()), !dbg !171

  //   %conv = trunc i64 %4 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !137, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !142, metadata !DIExpression()), !dbg !174

  //   %5 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !144, metadata !DIExpression()), !dbg !174

  //   %conv15 = trunc i64 %5 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !141, metadata !DIExpression()), !dbg !146

  //   %and = and i32 %conv, %conv15, !dbg !102
  creg_r15 = max(creg_r13,creg_r14);
  ASSUME(active[creg_r15] == 0);
  r15 = r13 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !145, metadata !DIExpression()), !dbg !146

  //   %cmp = icmp eq i32 %and, 1, !dbg !103
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 60, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !106

  //   unreachable, !dbg !106
  r16 = 1;

T0BLOCK2:
  //   %6 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %6) #7, !dbg !109

  //   %7 = bitcast i64* %thr0 to i8*, !dbg !109

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %7) #7, !dbg !109
