...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !68, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64 1, metadata !71, metadata !DIExpression()), !dbg !88

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !68
  // ST: Guess
  iw(2,r4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l32_c3
  old_cw = cw(2,r4);
  cw(2,r4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l32_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !72, metadata !DIExpression()), !dbg !75
  ...
  //   %cmp8 = icmp eq i32 %conv4, 2, !dbg !76
  creg__r1__2_ = max(0,creg_r1);

  //   %conv9 = zext i1 %cmp8 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !73, metadata !DIExpression()), !dbg !75

  //   store i32 %conv9, i32* @atom_1_X3_2, align 4, !dbg !77, !tbaa !72
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !118, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !122, metadata !DIExpression()), !dbg !151
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
