...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !69, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !72, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !73, metadata !DIExpression()), !dbg !96

  //   %2 = zext i32 %conv7 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !96
  ...
  //   %cmp11 = icmp eq i32 %conv4, 2, !dbg !79

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !77, metadata !DIExpression()), !dbg !99

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !99

  //   store atomic i64 %3, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !81
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !122, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !125, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !139, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !143, metadata !DIExpression()), !dbg !183
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
