...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !66, metadata !DIExpression()), !dbg !90

  //   %conv4 = trunc i64 %1 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !63, metadata !DIExpression()), !dbg !84
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !83), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !70, metadata !DIExpression()), !dbg !99

  //   %conv8 = trunc i64 %2 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !67, metadata !DIExpression()), !dbg !84

  //   %xor = xor i32 %conv8, %conv8, !dbg !83
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !71, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !72, metadata !DIExpression()), !dbg !104
  ...
  //   store i32 %conv15, i32* @atom_1_X2_1, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv12, 1, !dbg !97
  ...
  //   store i32 %conv17, i32* @atom_1_X8_1, align 4, !dbg !98, !tbaa !91
  // ST: Guess
