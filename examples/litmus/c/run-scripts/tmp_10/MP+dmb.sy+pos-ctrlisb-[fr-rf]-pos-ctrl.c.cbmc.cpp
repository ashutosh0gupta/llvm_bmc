...
T2BLOCK7:
  ...
  //   %cmp26 = icmp eq i32 %conv4, 1, !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !94, metadata !DIExpression()), !dbg !154

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !96, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !136
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv8, 0, !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !98, metadata !DIExpression()), !dbg !157

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !100, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %8, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !139
  // ST: Guess
  ...
  //   %cmp41 = icmp eq i32 %conv16, 1, !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !106, metadata !DIExpression()), !dbg !163

  //   %10 = zext i32 %conv42 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !108, metadata !DIExpression()), !dbg !163

  //   store atomic i64 %10, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !145
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !110, metadata !DIExpression()), !dbg !166

  //   %11 = zext i32 %conv47 to i64

  //   call void @llvm.dbg.value(metadata i64 %11, metadata !112, metadata !DIExpression()), !dbg !166

  //   store atomic i64 %11, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !148
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !209, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !212, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !218, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !221, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !244, metadata !DIExpression()), !dbg !324
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !248, metadata !DIExpression()), !dbg !327
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !256, metadata !DIExpression()), !dbg !333
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !260, metadata !DIExpression()), !dbg !336
