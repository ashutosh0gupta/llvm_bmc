...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !82, metadata !DIExpression()), !dbg !120

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l39_c16
  // Check
  ASSUME(active[cr(2,0+2*1)] == 2);
  ASSUME(cr(2,0+2*1) >= iw(2,0+2*1));
  ASSUME(cr(2,0+2*1) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !120

  //   %conv16 = trunc i64 %4 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !81, metadata !DIExpression()), !dbg !98

  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !104
  creg__r4__0_ = max(0,creg_r4);

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !106
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !97), !dbg !128

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !129

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !129
  ...
  //   %cmp31 = icmp eq i32 %conv16, 1, !dbg !125
  ...
  //   store i32 %conv32, i32* @atom_1_X6_1, align 4, !dbg !126, !tbaa !115
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv23, 0, !dbg !127
  ...
  //   store i32 %conv34, i32* @atom_1_X7_0, align 4, !dbg !128, !tbaa !115
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !152, metadata !DIExpression()), !dbg !159
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !234

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !236

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !238

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !177, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !183, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !185, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !186, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !247

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !127
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l72_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l72_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !190, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !193, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !196, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !199, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i32 0, metadata !201, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !202, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i32 0, metadata !204, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !206, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !208, metadata !DIExpression()), !dbg !270

  //   %conv = trunc i64 %6 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !205, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !209, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !211, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !213, metadata !DIExpression()), !dbg !274

  //   %conv26 = trunc i64 %7 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !210, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !214, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !216, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !218, metadata !DIExpression()), !dbg !278

  //   %conv32 = trunc i64 %8 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !215, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !219, metadata !DIExpression()), !dbg !234

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !163, !tbaa !164
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l93_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !220, metadata !DIExpression()), !dbg !234

  //   %10 = load i32, i32* @atom_1_X2_1, align 4, !dbg !166, !tbaa !164
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l94_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !221, metadata !DIExpression()), !dbg !234

  //   %11 = load i32, i32* @atom_1_X3_0, align 4, !dbg !167, !tbaa !164
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l95_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !222, metadata !DIExpression()), !dbg !234

  //   %12 = load i32, i32* @atom_1_X5_1, align 4, !dbg !168, !tbaa !164
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l96_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !223, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !224, metadata !DIExpression()), !dbg !234

  //   %14 = load i32, i32* @atom_1_X7_0, align 4, !dbg !170, !tbaa !164
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l98_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !225, metadata !DIExpression()), !dbg !234

  //   %and = and i32 %13, %14, !dbg !171
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !226, metadata !DIExpression()), !dbg !234

  //   %and35 = and i32 %12, %and, !dbg !172
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !227, metadata !DIExpression()), !dbg !234

  //   %and36 = and i32 %11, %and35, !dbg !173
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !228, metadata !DIExpression()), !dbg !234

  //   %and37 = and i32 %10, %and36, !dbg !174
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !229, metadata !DIExpression()), !dbg !234

  //   %and38 = and i32 %9, %and37, !dbg !175
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !230, metadata !DIExpression()), !dbg !234

  //   %and39 = and i32 %conv34, %and38, !dbg !176
  creg_r24 = max(creg__r12__1_,creg_r23);
  r24 = (r12==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !231, metadata !DIExpression()), !dbg !234

  //   %and40 = and i32 %conv28, %and39, !dbg !177
  creg_r25 = max(creg__r11__1_,creg_r24);
  r25 = (r11==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !232, metadata !DIExpression()), !dbg !234

  //   %and41 = and i32 %conv22, %and40, !dbg !178
  creg_r26 = max(creg__r10__1_,creg_r25);
  r26 = (r10==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !233, metadata !DIExpression()), !dbg !234
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 107, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
