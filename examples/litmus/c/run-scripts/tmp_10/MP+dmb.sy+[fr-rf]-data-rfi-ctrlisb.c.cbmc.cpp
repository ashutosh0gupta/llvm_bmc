...
T2BLOCK4:
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   store i32 %conv14, i32* @atom_1_X0_1, align 4, !dbg !96, !tbaa !97
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv4, 2, !dbg !101
  ...
  //   store i32 %conv16, i32* @atom_1_X2_2, align 4, !dbg !102, !tbaa !97
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv9, 1, !dbg !103
  ...
  //   store i32 %conv18, i32* @atom_1_X5_1, align 4, !dbg !104, !tbaa !97
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv13, 0, !dbg !105
  ...
  //   store i32 %conv20, i32* @atom_1_X6_0, align 4, !dbg !106, !tbaa !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !155, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !168, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !174, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !180, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !185, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !190, metadata !DIExpression()), !dbg !242
