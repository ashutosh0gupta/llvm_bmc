...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !78, metadata !DIExpression()), !dbg !93

  //   %add = add nsw i32 0, %xor, !dbg !89
  creg_r4 = max(0,creg_r3);
  r4 = 0 + r3;

  //   %idxprom = sext i32 %add to i64, !dbg !89

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !89
  r5 = 0+r4*1;
  creg_r5 = creg_r4;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !79, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !111

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !86, metadata !DIExpression()), !dbg !111
  ...
  //   %cmp22 = icmp eq i32 %conv12, 0, !dbg !105
  ...
  //   store i32 %conv23, i32* @atom_1_X6_0, align 4, !dbg !106, !tbaa !97
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X8_0, align 4, !dbg !108, !tbaa !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !159, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !201

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !162, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i32 0, metadata !164, metadata !DIExpression()), !dbg !203

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X6_0, align 4, !dbg !138, !tbaa !134
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X8_0, align 4, !dbg !139, !tbaa !134
  // LD: Guess
  old_cr = cr(0,6);
