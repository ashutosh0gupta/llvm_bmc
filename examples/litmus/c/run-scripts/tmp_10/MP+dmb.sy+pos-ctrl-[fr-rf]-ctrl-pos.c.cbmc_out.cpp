...
T2BLOCK4:
  ...
  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !100
  creg__r3__0_ = max(0,creg_r3);

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !102
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !97), !dbg !124

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !125

  //   %conv19 = trunc i64 %4 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !81, metadata !DIExpression()), !dbg !98
  ...
  //   %cmp31 = icmp eq i32 %conv19, 0, !dbg !124
  ...
  //   store i32 %conv32, i32* @atom_1_X6_0, align 4, !dbg !125, !tbaa !114
  // ST: Guess
  ...
  //   store i32 %conv34, i32* @atom_1_X8_0, align 4, !dbg !127, !tbaa !114
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !195, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !198, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i32 0, metadata !200, metadata !DIExpression()), !dbg !254

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !201, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i32 0, metadata !203, metadata !DIExpression()), !dbg !256

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !137
  // ST: Guess
  ...
  //   %13 = load i32, i32* @atom_1_X6_0, align 4, !dbg !169, !tbaa !164
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %14 = load i32, i32* @atom_1_X8_0, align 4, !dbg !170, !tbaa !164
  // LD: Guess
  old_cr = cr(0,8);
