...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !42, metadata !DIExpression()), !dbg !52
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !67, metadata !DIExpression()), !dbg !91
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64 1, metadata !70, metadata !DIExpression()), !dbg !94

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !74, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !76, metadata !DIExpression()), !dbg !91

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !75
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !80, metadata !DIExpression()), !dbg !91

  //   %add7 = add nsw i32 0, %xor5, !dbg !76
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !76

  //   %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !76
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !81, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64 1, metadata !83, metadata !DIExpression()), !dbg !105

  //   store atomic i64 1, i64* %arrayidx9 monotonic, align 8, !dbg !76
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !87, metadata !DIExpression()), !dbg !106

  //   %conv14 = trunc i64 %2 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !84, metadata !DIExpression()), !dbg !91

  //   %cmp = icmp eq i32 %conv, 1, !dbg !81
  creg__r1__1_ = max(0,creg_r1);

  //   %conv15 = zext i1 %cmp to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !88, metadata !DIExpression()), !dbg !91

  //   store i32 %conv15, i32* @atom_1_X2_1, align 4, !dbg !82, !tbaa !83
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv14, 1, !dbg !87
  creg__r9__1_ = max(0,creg_r9);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !89, metadata !DIExpression()), !dbg !91

  //   store i32 %conv17, i32* @atom_1_X9_1, align 4, !dbg !88, !tbaa !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !137, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !141, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !144, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !179

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X9_1, align 4, !dbg !124, !tbaa !121
  // LD: Guess
  old_cr = cr(0,5);
