...
T2BLOCK7:
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !115
  ...
  //   store i32 %conv23, i32* @atom_1_X2_1, align 4, !dbg !116, !tbaa !111
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv13, 2, !dbg !117
  ...
  //   store i32 %conv25, i32* @atom_1_X7_2, align 4, !dbg !118, !tbaa !111
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !185, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_2, metadata !188, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !238

  //   store atomic i32 0, i32* @atom_1_X7_2 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X7_2, align 4, !dbg !154, !tbaa !151
  // LD: Guess
  old_cr = cr(0,6);
  ...
  creg_r23 = max(creg__r11__2_,creg_r22);
  r23 = (r11==2) & r22;
