...
T2BLOCK7:
  ...
  //   store atomic i64 %6, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !126
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv13, 2, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !95, metadata !DIExpression()), !dbg !147

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %7, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !129
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !156, metadata !DIExpression()), !dbg !163
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !196, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !199, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !261

  //   store atomic i64 0, i64* @atom_1_X7_2 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !225, metadata !DIExpression()), !dbg !293
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !229, metadata !DIExpression()), !dbg !296

  //   %11 = load atomic i64, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !168
  // LD: Guess
  old_cr = cr(0,6);
