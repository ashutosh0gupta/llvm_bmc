...
T2BLOCK4:
  ...
  //   store i32 %conv25, i32* @atom_1_X8_1, align 4, !dbg !110, !tbaa !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !140, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !141, metadata !DIExpression()), !dbg !197

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !142, metadata !DIExpression()), !dbg !199

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !146, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !147, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !150, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !159, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !163, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !166, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i32 0, metadata !168, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !169, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !173, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !175, metadata !DIExpression()), !dbg !226

  //   %conv = trunc i64 %4 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !172, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !180, metadata !DIExpression()), !dbg !230

  //   %conv22 = trunc i64 %5 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !177, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !185, metadata !DIExpression()), !dbg !234

  //   %conv28 = trunc i64 %6 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !182, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !186, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !187, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !192, metadata !DIExpression()), !dbg !197

  //   %and32 = and i32 %7, %and31, !dbg !152
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !193, metadata !DIExpression()), !dbg !197
