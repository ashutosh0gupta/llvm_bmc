...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !72, metadata !DIExpression()), !dbg !85

  //   %add10 = add nsw i32 %xor9, 1, !dbg !80
  creg_r7 = max(0,creg_r6);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !73, metadata !DIExpression()), !dbg !85
  ...
  //   %conv11 = sext i32 %add10 to i64, !dbg !82

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !76, metadata !DIExpression()), !dbg !100

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !82
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 1, !dbg !92
  ...
  //   store i32 %conv18, i32* @atom_1_X2_1, align 4, !dbg !93, !tbaa !88
  // ST: Guess
