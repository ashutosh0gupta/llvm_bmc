...
T2BLOCK1:
  ...
  //   %cmp14 = icmp eq i32 %conv4, 1, !dbg !83
  ...
  //   store i32 %conv15, i32* @atom_1_X5_1, align 4, !dbg !84, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !134, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !137, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i32 0, metadata !139, metadata !DIExpression()), !dbg !160

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !89
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_1_X5_1, align 4, !dbg !103, !tbaa !101
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %6 = load i32, i32* @atom_1_X7_0, align 4, !dbg !104, !tbaa !101
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !110
