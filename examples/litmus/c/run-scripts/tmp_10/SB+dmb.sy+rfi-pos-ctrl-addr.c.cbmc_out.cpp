...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !78, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !80, metadata !DIExpression()), !dbg !103

  //   %conv4 = trunc i64 %1 to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !77, metadata !DIExpression()), !dbg !95
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !82, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !84, metadata !DIExpression()), !dbg !112

  //   %conv8 = trunc i64 %2 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !81, metadata !DIExpression()), !dbg !95

  //   %xor = xor i32 %conv8, %conv8, !dbg !87
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !85, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !87, metadata !DIExpression()), !dbg !117

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !89, metadata !DIExpression()), !dbg !117

  //   %conv12 = trunc i64 %3 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !86, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !90, metadata !DIExpression()), !dbg !95

  //   store i32 %conv13, i32* @atom_1_X2_1, align 4, !dbg !92, !tbaa !93
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 1, !dbg !97
  creg__r2__1_ = max(0,creg_r2);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !91, metadata !DIExpression()), !dbg !95

  //   store i32 %conv15, i32* @atom_1_X3_1, align 4, !dbg !98, !tbaa !93
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv12, 0, !dbg !99
  creg__r7__0_ = max(0,creg_r7);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !92, metadata !DIExpression()), !dbg !95

  //   store i32 %conv17, i32* @atom_1_X7_0, align 4, !dbg !100, !tbaa !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !133, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !134, metadata !DIExpression()), !dbg !181

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !135, metadata !DIExpression()), !dbg !183

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !139, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !140, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !143, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !146, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !149, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !192

  //   store atomic i32 0, i32* @atom_0_X2_0 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !153, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !194

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_1, metadata !156, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !196

  //   store atomic i32 0, i32* @atom_1_X3_1 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !159, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !198
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !112
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !118
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !120
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !163, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !165, metadata !DIExpression()), !dbg !208

  //   %conv = trunc i64 %4 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !162, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !166, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !212

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !126
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !170, metadata !DIExpression()), !dbg !212

  //   %conv20 = trunc i64 %5 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !167, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !171, metadata !DIExpression()), !dbg !181

  //   %6 = load i32, i32* @atom_0_X2_0, align 4, !dbg !129, !tbaa !130
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !172, metadata !DIExpression()), !dbg !181

  //   %7 = load i32, i32* @atom_1_X2_1, align 4, !dbg !132, !tbaa !130
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !173, metadata !DIExpression()), !dbg !181

  //   %8 = load i32, i32* @atom_1_X3_1, align 4, !dbg !133, !tbaa !130
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %9 = load i32, i32* @atom_1_X7_0, align 4, !dbg !134, !tbaa !130
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !176, metadata !DIExpression()), !dbg !181

  //   %and23 = and i32 %7, %and, !dbg !136
  creg_r18 = max(creg_r14,creg_r17);
  r18 = r14 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !177, metadata !DIExpression()), !dbg !181

  //   %and24 = and i32 %6, %and23, !dbg !137
  creg_r19 = max(creg_r13,creg_r18);
  r19 = r13 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !178, metadata !DIExpression()), !dbg !181

  //   %and25 = and i32 %conv22, %and24, !dbg !138
  creg_r20 = max(creg__r12__1_,creg_r19);
  r20 = (r12==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !179, metadata !DIExpression()), !dbg !181

  //   %and26 = and i32 %conv16, %and25, !dbg !139
  creg_r21 = max(creg__r11__1_,creg_r20);
  r21 = (r11==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !180, metadata !DIExpression()), !dbg !181

  //   %cmp27 = icmp eq i32 %and26, 1, !dbg !140
  creg__r21__1_ = max(0,creg_r21);

  //   br i1 %cmp27, label %if.then, label %if.end, !dbg !142
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
