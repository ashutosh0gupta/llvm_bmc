...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !86, metadata !DIExpression()), !dbg !93

  //   %add = add nsw i32 %xor, 1, !dbg !56
  creg_r5 = max(0,creg_r4);
  r5 = r4 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !87, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !88, metadata !DIExpression()), !dbg !101

  //   %conv1 = sext i32 %add to i64, !dbg !58

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !90, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !91, metadata !DIExpression()), !dbg !93
