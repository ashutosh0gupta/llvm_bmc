...
T2BLOCK1:
  ...
  //   %xor5 = xor i32 %conv4, %conv4, !dbg !88
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !75, metadata !DIExpression()), !dbg !95

  //   %add7 = add nsw i32 3, %xor5, !dbg !89
  creg_r6 = max(0,creg_r5);
  r6 = 3 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !89

  //   %arrayidx9 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !89
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !77, metadata !DIExpression()), !dbg !109

  //   %2 = load atomic i64, i64* %arrayidx9 monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,r7);
  cr(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l36_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !79, metadata !DIExpression()), !dbg !109

  //   %conv12 = trunc i64 %2 to i32, !dbg !91
  ...
  //   %xor17 = xor i32 %conv16, %conv16, !dbg !95
  creg_r10 = creg_r9;
  r10 = r9 ^ r9;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !84, metadata !DIExpression()), !dbg !95

  //   %add19 = add nsw i32 0, %xor17, !dbg !96
  creg_r11 = max(0,creg_r10);
  r11 = 0 + r10;

  //   %idxprom20 = sext i32 %add19 to i64, !dbg !96

  //   %arrayidx21 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !96
  r12 = 0+r11*1;
  creg_r12 = creg_r11;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !86, metadata !DIExpression()), !dbg !116

  //   %4 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,r12);
  ...
  //   %conv24 = trunc i64 %4 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !85, metadata !DIExpression()), !dbg !95

  //   %cmp = icmp eq i32 %conv, 1, !dbg !99
  creg__r0__1_ = max(0,creg_r0);

  //   %conv25 = zext i1 %cmp to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !89, metadata !DIExpression()), !dbg !95

  //   store i32 %conv25, i32* @atom_1_X0_1, align 4, !dbg !100, !tbaa !101
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv4, 1, !dbg !105
  creg__r4__1_ = max(0,creg_r4);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !90, metadata !DIExpression()), !dbg !95

  //   store i32 %conv27, i32* @atom_1_X5_1, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv12, 0, !dbg !107
  creg__r8__0_ = max(0,creg_r8);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !91, metadata !DIExpression()), !dbg !95

  //   store i32 %conv29, i32* @atom_1_X7_0, align 4, !dbg !108, !tbaa !101
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv16, 1, !dbg !109
  creg__r9__1_ = max(0,creg_r9);

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !92, metadata !DIExpression()), !dbg !95

  //   store i32 %conv31, i32* @atom_1_X9_1, align 4, !dbg !110, !tbaa !101
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv24, 0, !dbg !111
  creg__r13__0_ = max(0,creg_r13);

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !93, metadata !DIExpression()), !dbg !95

  //   store i32 %conv33, i32* @atom_1_X11_0, align 4, !dbg !112, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !153, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !154, metadata !DIExpression()), !dbg !222

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !155, metadata !DIExpression()), !dbg !224

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !159, metadata !DIExpression()), !dbg !226

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !160, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !161, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !164, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !167, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !170, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !173, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !177, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !180, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !183, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !243

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !137
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !186, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !188, metadata !DIExpression()), !dbg !245

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !139
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !190, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !192, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !193, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !197, metadata !DIExpression()), !dbg !262

  //   %conv26 = trunc i64 %7 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !194, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !198, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !202, metadata !DIExpression()), !dbg !266

  //   %conv32 = trunc i64 %8 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !199, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !203, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !207, metadata !DIExpression()), !dbg !270

  //   %conv38 = trunc i64 %9 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !204, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !208, metadata !DIExpression()), !dbg !222
  ...
  //   %12 = load i32, i32* @atom_1_X7_0, align 4, !dbg !173, !tbaa !170
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %13 = load i32, i32* @atom_1_X9_1, align 4, !dbg !174, !tbaa !170
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %14 = load i32, i32* @atom_1_X11_0, align 4, !dbg !175, !tbaa !170
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !215, metadata !DIExpression()), !dbg !222

  //   %and42 = and i32 %11, %and41, !dbg !178
  creg_r29 = max(creg_r23,creg_r28);
  r29 = r23 & r28;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !216, metadata !DIExpression()), !dbg !222

  //   %and43 = and i32 %10, %and42, !dbg !179
  creg_r30 = max(creg_r22,creg_r29);
  r30 = r22 & r29;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !217, metadata !DIExpression()), !dbg !222

  //   %and44 = and i32 %conv40, %and43, !dbg !180
  creg_r31 = max(creg__r21__1_,creg_r30);
  r31 = (r21==1) & r30;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !218, metadata !DIExpression()), !dbg !222

  //   %and45 = and i32 %conv34, %and44, !dbg !181
  creg_r32 = max(creg__r20__1_,creg_r31);
  r32 = (r20==1) & r31;

  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !219, metadata !DIExpression()), !dbg !222

  //   %and46 = and i32 %conv28, %and45, !dbg !182
  creg_r33 = max(creg__r19__1_,creg_r32);
  r33 = (r19==1) & r32;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !220, metadata !DIExpression()), !dbg !222

  //   %and47 = and i32 %conv22, %and46, !dbg !183
  creg_r34 = max(creg__r18__1_,creg_r33);
  r34 = (r18==1) & r33;

  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !221, metadata !DIExpression()), !dbg !222

  //   %cmp48 = icmp eq i32 %and47, 1, !dbg !184
  creg__r34__1_ = max(0,creg_r34);

  //   br i1 %cmp48, label %if.then, label %if.end, !dbg !186
  old_cctrl = cctrl[0];
  cctrl[0] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[0] >= old_cctrl);
  ASSUME(cctrl[0] >= creg__r34__1_);
  if((r34==1)) {
    goto T0BLOCK1;
  } else {
    goto T0BLOCK2;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 103, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187
