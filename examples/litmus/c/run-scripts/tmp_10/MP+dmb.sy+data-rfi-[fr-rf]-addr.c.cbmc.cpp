...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !101
  ...
  //   %xor10 = xor i32 %conv9, %conv9, !dbg !85
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor10, metadata !78, metadata !DIExpression()), !dbg !88

  //   %add12 = add nsw i32 0, %xor10, !dbg !86
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add12 to i64, !dbg !86

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !86
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !106

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !106
  ...
  //   %cmp19 = icmp eq i32 %conv9, 2, !dbg !97
  ...
  //   store i32 %conv20, i32* @atom_1_X5_2, align 4, !dbg !98, !tbaa !91
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 0, !dbg !99
  ...
  //   store i32 %conv22, i32* @atom_1_X7_0, align 4, !dbg !100, !tbaa !91
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !124, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64 2, metadata !126, metadata !DIExpression()), !dbg !131
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !165, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !168, metadata !DIExpression()), !dbg !215
