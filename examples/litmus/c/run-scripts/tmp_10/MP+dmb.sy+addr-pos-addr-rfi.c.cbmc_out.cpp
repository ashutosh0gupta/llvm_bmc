...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !60, metadata !DIExpression()), !dbg !84

  //   %conv = trunc i64 %0 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !57, metadata !DIExpression()), !dbg !81

  //   %xor = xor i32 %conv, %conv, !dbg !68
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !65, metadata !DIExpression()), !dbg !89

  //   %conv4 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !62, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !69, metadata !DIExpression()), !dbg !91

  //   %conv8 = trunc i64 %2 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !66, metadata !DIExpression()), !dbg !81

  //   %xor9 = xor i32 %conv8, %conv8, !dbg !75
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !70, metadata !DIExpression()), !dbg !81

  //   %add10 = add nsw i32 0, %xor9, !dbg !76
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !76

  //   %arrayidx12 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !76
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !71, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64 1, metadata !73, metadata !DIExpression()), !dbg !96

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !76
  // ST: Guess
  iw(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l33_c3
  old_cw = cw(2,r8);
  cw(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l33_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !97

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !74, metadata !DIExpression()), !dbg !81

  //   %cmp = icmp eq i32 %conv, 1, !dbg !81
  creg__r0__1_ = max(0,creg_r0);

  //   %conv17 = zext i1 %cmp to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !78, metadata !DIExpression()), !dbg !81

  //   store i32 %conv17, i32* @atom_1_X0_1, align 4, !dbg !82, !tbaa !83
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv16, 1, !dbg !87
  creg__r9__1_ = max(0,creg_r9);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !79, metadata !DIExpression()), !dbg !81

  //   store i32 %conv19, i32* @atom_1_X9_1, align 4, !dbg !88, !tbaa !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !132, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !136, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !167

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !111, !tbaa !112
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X9_1, align 4, !dbg !114, !tbaa !112
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
