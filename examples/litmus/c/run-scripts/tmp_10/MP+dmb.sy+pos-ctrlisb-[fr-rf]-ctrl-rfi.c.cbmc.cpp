...
T1BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !55
  // ST: Guess
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !110

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !110

  //   %conv8 = trunc i64 %2 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !113

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !94
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i64 1, metadata !81, metadata !DIExpression()), !dbg !122

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !104
  // ST: Guess
  iw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l40_c3
  old_cw = cw(2,0);
  cw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l40_c3
  // Check
  ...
  //   store i32 %conv24, i32* @atom_1_X3_0, align 4, !dbg !117, !tbaa !110
  // ST: Guess
  ...
  //   store i32 %conv26, i32* @atom_1_X5_1, align 4, !dbg !119, !tbaa !110
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv19, 1, !dbg !120
  ...
  //   store i32 %conv28, i32* @atom_1_X8_1, align 4, !dbg !121, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !183, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !237

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !186, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i32 0, metadata !188, metadata !DIExpression()), !dbg !239

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !189, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i32 0, metadata !191, metadata !DIExpression()), !dbg !241

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !192, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i32 0, metadata !194, metadata !DIExpression()), !dbg !243

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !128
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X2_1, align 4, !dbg !157, !tbaa !155
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X3_0, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X5_1, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %13 = load i32, i32* @atom_1_X8_1, align 4, !dbg !160, !tbaa !155
  // LD: Guess
  old_cr = cr(0,7);
  ...
  creg_r23 = max(creg__r9__2_,creg_r22);
  r23 = (r9==2) & r22;
