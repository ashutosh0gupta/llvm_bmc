...
T2BLOCK4:
  ...
  //   %tobool7 = icmp ne i32 %conv6, 0, !dbg !86
  creg__r1__0_ = max(0,creg_r1);

  //   br i1 %tobool7, label %if.then8, label %if.else9, !dbg !88
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !79, metadata !DIExpression()), !dbg !113

  //   %conv15 = trunc i64 %2 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !76, metadata !DIExpression()), !dbg !86
  ...
  //   %cmp17 = icmp eq i32 %conv6, 2, !dbg !103
  creg__r1__2_ = max(0,creg_r1);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !81, metadata !DIExpression()), !dbg !86
  ...
  //   %cmp19 = icmp eq i32 %conv15, 1, !dbg !105
  ...
  //   store i32 %conv20, i32* @atom_1_X8_1, align 4, !dbg !106, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !141, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !150, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !154, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !157, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !161, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !164, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !166, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !165, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !170, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !174, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !179, metadata !DIExpression()), !dbg !183

  //   %and28 = and i32 %conv26, %and27, !dbg !137
  creg_r14 = max(creg__r8__2_,creg_r13);
  r14 = (r8==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !180, metadata !DIExpression()), !dbg !183
