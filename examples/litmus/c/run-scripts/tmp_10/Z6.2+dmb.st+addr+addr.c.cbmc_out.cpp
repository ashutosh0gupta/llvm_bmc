...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !90, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !91, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64 1, metadata !93, metadata !DIExpression()), !dbg !104

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !55
  // ST: Guess
  iw(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l40_c3
  old_cw = cw(3,r7);
  cw(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l40_c3
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
