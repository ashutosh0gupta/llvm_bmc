...
T2BLOCK4:
  ...
  //   %cmp24 = icmp eq i32 %conv16, 2, !dbg !110
  ...
  //   store i32 %conv25, i32* @atom_1_X9_2, align 4, !dbg !111, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_2, metadata !181, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !231

  //   store atomic i32 0, i32* @atom_1_X9_2 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X9_2, align 4, !dbg !154, !tbaa !151
  // LD: Guess
  old_cr = cr(0,6);
