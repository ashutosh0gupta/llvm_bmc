...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !77, metadata !DIExpression()), !dbg !92
  ...
  //   %arrayidx13 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !89
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !79, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !109
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !118
  ...
  //   %conv21 = zext i1 %cmp to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !86, metadata !DIExpression()), !dbg !92

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !103, !tbaa !104
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !108
  ...
  //   store i32 %conv23, i32* @atom_1_X2_1, align 4, !dbg !109, !tbaa !104
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 2, !dbg !110
  ...
  //   store i32 %conv25, i32* @atom_1_X6_2, align 4, !dbg !111, !tbaa !104
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv20, 0, !dbg !112
  ...
  //   store i32 %conv27, i32* @atom_1_X10_0, align 4, !dbg !113, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !178, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !181, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !184, metadata !DIExpression()), !dbg !233
