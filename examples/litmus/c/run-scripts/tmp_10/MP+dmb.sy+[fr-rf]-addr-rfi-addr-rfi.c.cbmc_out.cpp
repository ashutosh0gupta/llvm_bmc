...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !77, metadata !DIExpression()), !dbg !90

  //   %add11 = add nsw i32 0, %xor9, !dbg !87
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !87

  //   %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !87
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !78, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64 1, metadata !80, metadata !DIExpression()), !dbg !107

  //   store atomic i64 1, i64* %arrayidx13 monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !84, metadata !DIExpression()), !dbg !108
  ...
  //   store i32 %conv21, i32* @atom_1_X2_2, align 4, !dbg !99, !tbaa !94
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv8, 1, !dbg !100
  ...
  //   store i32 %conv23, i32* @atom_1_X6_1, align 4, !dbg !101, !tbaa !94
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv18, 1, !dbg !102
  ...
  //   store i32 %conv25, i32* @atom_1_X10_1, align 4, !dbg !103, !tbaa !94
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !127, metadata !DIExpression()), !dbg !134
  ...
  // ST: Guess
  iw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l51_c3
  old_cw = cw(3,0+1*1);
  cw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l51_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !165, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !168, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !171, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i32 0, metadata !173, metadata !DIExpression()), !dbg !218

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X10_1, align 4, !dbg !150, !tbaa !146
  // LD: Guess
  old_cr = cr(0,6);
