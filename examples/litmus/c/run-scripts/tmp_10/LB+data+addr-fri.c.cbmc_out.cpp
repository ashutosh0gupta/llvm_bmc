...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !70, metadata !DIExpression()), !dbg !86
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !89

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !74, metadata !DIExpression()), !dbg !89

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !71, metadata !DIExpression()), !dbg !86

  //   %xor = xor i32 %conv, %conv, !dbg !61
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !75, metadata !DIExpression()), !dbg !86

  //   %add = add nsw i32 0, %xor, !dbg !62
  creg_r5 = max(0,creg_r4);
  r5 = 0 + r4;

  //   %idxprom = sext i32 %add to i64, !dbg !62

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !62
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !94

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !62
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !76, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64 1, metadata !82, metadata !DIExpression()), !dbg !96

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !66
  // ST: Guess
  ...
  //   store i32 %conv5, i32* @atom_1_X0_1, align 4, !dbg !68, !tbaa !69
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !110, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !111, metadata !DIExpression()), !dbg !150

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !112, metadata !DIExpression()), !dbg !152

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !116, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !117, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64 0, metadata !119, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !120, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64 0, metadata !122, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !123, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i32 0, metadata !126, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !127, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i32 0, metadata !129, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !130, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i32 0, metadata !132, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !136, metadata !DIExpression()), !dbg !173

  //   %conv = trunc i64 %4 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !133, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !137, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !139, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !141, metadata !DIExpression()), !dbg !177

  //   %conv16 = trunc i64 %5 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !138, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !142, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !143, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !144, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !145, metadata !DIExpression()), !dbg !150

  //   %and = and i32 %7, %8, !dbg !120
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !146, metadata !DIExpression()), !dbg !150

  //   %and19 = and i32 %6, %and, !dbg !121
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !147, metadata !DIExpression()), !dbg !150

  //   %and20 = and i32 %conv18, %and19, !dbg !122
  creg_r18 = max(creg__r12__1_,creg_r17);
  r18 = (r12==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !148, metadata !DIExpression()), !dbg !150

  //   %and21 = and i32 %conv12, %and20, !dbg !123
  creg_r19 = max(creg__r11__1_,creg_r18);
  r19 = (r11==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !149, metadata !DIExpression()), !dbg !150
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !127
