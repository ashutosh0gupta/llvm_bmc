...
T2BLOCK1:
  ...
  //   store i32 %conv27, i32* @atom_1_X7_0, align 4, !dbg !103, !tbaa !98
  // ST: Guess
  ...
  //   store i32 %conv29, i32* @atom_1_X9_0, align 4, !dbg !105, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !169, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !212

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !172, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !214

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !175, metadata !DIExpression()), !dbg !216
  ...
  //   %9 = load i32, i32* @atom_1_X7_0, align 4, !dbg !138, !tbaa !136
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_1_X9_0, align 4, !dbg !139, !tbaa !136
  // LD: Guess
  old_cr = cr(0,5);
