...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !91, metadata !DIExpression()), !dbg !113

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !71
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !93, metadata !DIExpression()), !dbg !113
  ...
  //   store i32 %conv5, i32* @atom_1_X2_2, align 4, !dbg !74, !tbaa !75
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv4, 0, !dbg !79
  ...
  //   store i32 %conv7, i32* @atom_1_X3_0, align 4, !dbg !80, !tbaa !75
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !151, metadata !DIExpression()), !dbg !186
