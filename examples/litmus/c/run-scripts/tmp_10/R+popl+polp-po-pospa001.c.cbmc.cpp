...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !83, metadata !DIExpression()), !dbg !96

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !78

  //   %conv9 = zext i1 %cmp to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !87, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !88, metadata !DIExpression()), !dbg !111

  //   %3 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !90, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %3, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !80
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv8, 0, !dbg !81

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !91, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !92, metadata !DIExpression()), !dbg !114

  //   %4 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !94, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %4, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !143, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !146, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !160, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !164, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !168, metadata !DIExpression()), !dbg !216
