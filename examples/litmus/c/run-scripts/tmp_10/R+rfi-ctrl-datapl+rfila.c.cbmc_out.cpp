...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !139, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !140, metadata !DIExpression()), !dbg !178

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !141, metadata !DIExpression()), !dbg !180

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !145, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !149, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_2, metadata !152, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_3, metadata !156, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_3, metadata !159, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !162, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i32 0, metadata !164, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !166, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !168, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !169, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !175, metadata !DIExpression()), !dbg !178
