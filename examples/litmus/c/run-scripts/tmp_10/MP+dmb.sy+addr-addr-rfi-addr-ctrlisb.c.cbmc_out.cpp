...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !146, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !147, metadata !DIExpression()), !dbg !209

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !148, metadata !DIExpression()), !dbg !211

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !152, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !153, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64 0, metadata !155, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !156, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !158, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !168, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !171, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !174, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !178, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !180, metadata !DIExpression()), !dbg !240

  //   %conv = trunc i64 %4 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !177, metadata !DIExpression()), !dbg !209

  //   %cmp = icmp eq i32 %conv, 1, !dbg !139

  //   %conv18 = zext i1 %cmp to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !181, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !183, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !185, metadata !DIExpression()), !dbg !244

  //   %conv22 = trunc i64 %5 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !182, metadata !DIExpression()), !dbg !209

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !143

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !186, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !188, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !190, metadata !DIExpression()), !dbg !248

  //   %conv28 = trunc i64 %6 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !187, metadata !DIExpression()), !dbg !209

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !147

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !191, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !193, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !195, metadata !DIExpression()), !dbg !252

  //   %conv34 = trunc i64 %7 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !192, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !197, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !199, metadata !DIExpression()), !dbg !255

  //   %conv38 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !196, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !201, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !203, metadata !DIExpression()), !dbg !258

  //   %conv42 = trunc i64 %9 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !200, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !204, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !205, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !206, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !207, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !208, metadata !DIExpression()), !dbg !209
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 83, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !165
