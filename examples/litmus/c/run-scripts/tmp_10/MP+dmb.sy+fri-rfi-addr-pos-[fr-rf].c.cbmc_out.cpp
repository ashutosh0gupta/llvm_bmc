...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !93
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !86
  r4 = 0+r3*1;
  creg_r4 = creg_r3;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !75, metadata !DIExpression()), !dbg !93
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !170, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !215

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !173, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i32 0, metadata !175, metadata !DIExpression()), !dbg !217

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X5_0, align 4, !dbg !143, !tbaa !140
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X7_0, align 4, !dbg !144, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
