...
T2BLOCK4:
  ...
  //   store i32 %conv21, i32* @atom_1_X5_0, align 4, !dbg !111, !tbaa !104
  // ST: Guess
  ...
  //   store i32 %conv23, i32* @atom_1_X7_1, align 4, !dbg !113, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !166, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i32 0, metadata !168, metadata !DIExpression()), !dbg !217

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !169, metadata !DIExpression()), !dbg !219
  ...
  //   %9 = load i32, i32* @atom_1_X5_0, align 4, !dbg !152, !tbaa !149
  // LD: Guess
  old_cr = cr(0,5);
