...
T2BLOCK4:
  ...
  //   %cmp33 = icmp eq i32 %conv12, 0, !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !103, metadata !DIExpression()), !dbg !154

  //   %9 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %9, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !136
  // ST: Guess
  ...
  //   %cmp38 = icmp eq i32 %conv16, 1, !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !107, metadata !DIExpression()), !dbg !157

  //   %10 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !109, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %10, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !139
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !111, metadata !DIExpression()), !dbg !160

  //   %11 = zext i32 %conv44 to i64

  //   call void @llvm.dbg.value(metadata i64 %11, metadata !113, metadata !DIExpression()), !dbg !160

  //   store atomic i64 %11, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !142
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !209, metadata !DIExpression()), !dbg !284

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !284

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !150
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !212, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !215, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !246, metadata !DIExpression()), !dbg !324

  //   %12 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !190
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !250, metadata !DIExpression()), !dbg !327
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !254, metadata !DIExpression()), !dbg !330
