...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !36, metadata !DIExpression()), !dbg !48
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !51
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !37, metadata !DIExpression()), !dbg !48

  //   %xor = xor i32 %conv, %conv, !dbg !54
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !42, metadata !DIExpression()), !dbg !48
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !43, metadata !DIExpression()), !dbg !56

  //   call void @llvm.dbg.value(metadata i64 1, metadata !45, metadata !DIExpression()), !dbg !56

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !55
  // ST: Guess
  iw(1,r3) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l22_c3
  old_cw = cw(1,r3);
  cw(1,r3) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l22_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !46, metadata !DIExpression()), !dbg !48
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !66, metadata !DIExpression()), !dbg !77
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !70, metadata !DIExpression()), !dbg !80

  //   %conv = trunc i64 %0 to i32, !dbg !53

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !67, metadata !DIExpression()), !dbg !77
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64 1, metadata !73, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !74, metadata !DIExpression()), !dbg !77
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !102, metadata !DIExpression()), !dbg !125

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !103, metadata !DIExpression()), !dbg !125

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !104, metadata !DIExpression()), !dbg !127

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !108, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !109, metadata !DIExpression()), !dbg !130

  //   call void @llvm.dbg.value(metadata i64 0, metadata !111, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !112, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !115, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i32 0, metadata !118, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !119, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i32 0, metadata !121, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !122, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !123, metadata !DIExpression()), !dbg !125

  //   %and = and i32 %4, %5, !dbg !90
  creg_r10 = max(creg_r8,creg_r9);
  r10 = r8 & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !124, metadata !DIExpression()), !dbg !125
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([100 x i8], [100 x i8]* @.str.1, i64 0, i64 0), i32 noundef 58, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
