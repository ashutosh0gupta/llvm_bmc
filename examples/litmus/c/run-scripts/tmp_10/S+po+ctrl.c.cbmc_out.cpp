...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !62, metadata !DIExpression()), !dbg !82
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !92, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !93, metadata !DIExpression()), !dbg !118

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !94, metadata !DIExpression()), !dbg !120

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !98, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !101, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !105, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 0, metadata !107, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !108, metadata !DIExpression()), !dbg !118

  //   %cmp = icmp eq i32 %conv, 2, !dbg !88

  //   %conv8 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !112, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !114, metadata !DIExpression()), !dbg !143
