...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !106, metadata !DIExpression()), !dbg !114
...
T0BLOCK0:
  ...
  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !115, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l72_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !149, metadata !DIExpression()), !dbg !164

  //   %9 = load i32, i32* @atom_2_X0_1, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l73_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !150, metadata !DIExpression()), !dbg !164
  ...
  //   %10 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   %conv = trunc i64 %10 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !151, metadata !DIExpression()), !dbg !164

  //   %cmp = icmp eq i32 %conv, 2, !dbg !122
  creg__r9__2_ = max(0,creg_r9);

  //   %conv16 = zext i1 %cmp to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !155, metadata !DIExpression()), !dbg !164
  ...
  //   %11 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !159, metadata !DIExpression()), !dbg !203

  //   %conv20 = trunc i64 %11 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !156, metadata !DIExpression()), !dbg !164

  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !126
  creg__r10__1_ = max(0,creg_r10);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !160, metadata !DIExpression()), !dbg !164

  //   %and = and i32 %conv16, %conv22, !dbg !127
  creg_r11 = max(creg__r10__1_,creg__r9__2_);
  r11 = (r9==2) & (r10==1);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !161, metadata !DIExpression()), !dbg !164

  //   %and23 = and i32 %9, %and, !dbg !128
  creg_r12 = max(creg_r11,creg_r8);
  r12 = r8 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !162, metadata !DIExpression()), !dbg !164

  //   %and24 = and i32 %8, %and23, !dbg !129
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([139 x i8], [139 x i8]* @.str.1, i64 0, i64 0), i32 noundef 81, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !133
