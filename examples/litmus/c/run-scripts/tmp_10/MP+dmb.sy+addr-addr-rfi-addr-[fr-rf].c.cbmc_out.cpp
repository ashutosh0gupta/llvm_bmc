...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !186, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !248

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !216, metadata !DIExpression()), !dbg !283

  //   %11 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !168
  // LD: Guess
  old_cr = cr(0,6);
