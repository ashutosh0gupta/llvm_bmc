...
T2BLOCK1:
  ...
  //   store i32 %conv5, i32* @atom_1_X0_1, align 4, !dbg !62, !tbaa !63
  // ST: Guess
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !104, metadata !DIExpression()), !dbg !116
  ...
  // ST: Guess
  //   : Release
  iw(4,0+2*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l46_c3
  old_cw = cw(4,0+2*1);
  cw(4,0+2*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l46_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !108, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !110, metadata !DIExpression()), !dbg !118

  //   %conv = trunc i64 %0 to i32, !dbg !56

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !107, metadata !DIExpression()), !dbg !113
  ...
  //   store i32 %conv1, i32* @atom_3_X2_0, align 4, !dbg !58, !tbaa !59
  // ST: Guess
