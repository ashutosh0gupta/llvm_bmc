...
T1BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !62
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !47, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !49, metadata !DIExpression()), !dbg !65

  //   %conv = trunc i64 %0 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !45, metadata !DIExpression()), !dbg !58

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !50, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64 1, metadata !52, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !54, metadata !DIExpression()), !dbg !71
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !76, metadata !DIExpression()), !dbg !95
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !77, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !82, metadata !DIExpression()), !dbg !95

  //   %cmp = icmp eq i32 %conv, 1, !dbg !68

  //   %conv5 = zext i1 %cmp to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !86, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !90, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !91, metadata !DIExpression()), !dbg !109

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !93, metadata !DIExpression()), !dbg !109

  //   store atomic i64 %3, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !73
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !119, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !120, metadata !DIExpression()), !dbg !161

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !121, metadata !DIExpression()), !dbg !163

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !125, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !126, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !132, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64 0, metadata !134, metadata !DIExpression()), !dbg !170

  //   store atomic i64 0, i64* @atom_0_X3_2 monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !138, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !174

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !141, metadata !DIExpression()), !dbg !161

  //   %cmp = icmp eq i32 %conv, 2, !dbg !112

  //   %conv12 = zext i1 %cmp to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !145, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !147, metadata !DIExpression()), !dbg !190

  //   %5 = load atomic i64, i64* @atom_0_X3_2 seq_cst, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !146, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !151, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !150, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !155, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !157, metadata !DIExpression()), !dbg !196

  //   %conv24 = trunc i64 %7 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !154, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !159, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !160, metadata !DIExpression()), !dbg !161
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
