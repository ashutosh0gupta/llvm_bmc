...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !46, metadata !DIExpression()), !dbg !55

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !50, metadata !DIExpression()), !dbg !65
  ...
  //   store i32 %conv5, i32* @atom_0_X3_2, align 4, !dbg !68, !tbaa !69
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !87, metadata !DIExpression()), !dbg !89

  //   store i32 %conv7, i32* @atom_1_X3_0, align 4, !dbg !69, !tbaa !64
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !118, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !121, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_2, metadata !124, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i32 0, metadata !127, metadata !DIExpression()), !dbg !154

  //   store atomic i32 0, i32* @atom_0_X3_2 monotonic, align 4, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !128, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i32 0, metadata !130, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !131, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !158

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !137, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !138, metadata !DIExpression()), !dbg !145

  //   %5 = load i32, i32* @atom_0_X3_2, align 4, !dbg !105, !tbaa !106
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %7 = load i32, i32* @atom_1_X3_0, align 4, !dbg !109, !tbaa !106
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !143, metadata !DIExpression()), !dbg !145
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
