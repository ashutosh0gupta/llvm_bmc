...
T2BLOCK4:
  ...
  //   %cmp23 = icmp eq i32 %conv15, 1, !dbg !112
  ...
  //   store i32 %conv24, i32* @atom_1_X8_1, align 4, !dbg !113, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !169, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !176, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !181, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !237
  ...
  //   %9 = load i32, i32* @atom_1_X8_1, align 4, !dbg !148, !tbaa !145
  // LD: Guess
  old_cr = cr(0,6);
