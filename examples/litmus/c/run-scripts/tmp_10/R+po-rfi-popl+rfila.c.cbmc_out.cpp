...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64 3, metadata !44, metadata !DIExpression()), !dbg !65

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !66
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !45, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64 1, metadata !47, metadata !DIExpression()), !dbg !67

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !51, metadata !DIExpression()), !dbg !69

  //   %conv = trunc i64 %0 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !48, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !52, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64 1, metadata !54, metadata !DIExpression()), !dbg !72

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !73
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !56, metadata !DIExpression()), !dbg !74

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !75
  // LD: Guess
  old_cr = cr(1,0);
  cr(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l26_c15
  // Check
  ...
  //   %conv8 = trunc i64 %1 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !55, metadata !DIExpression()), !dbg !62

  //   %cmp = icmp eq i32 %conv8, 2, !dbg !77
  creg__r1__2_ = max(0,creg_r1);

  //   %conv9 = zext i1 %cmp to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !59, metadata !DIExpression()), !dbg !62

  //   store i32 %conv9, i32* @atom_0_X6_2, align 4, !dbg !78, !tbaa !79
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv, 1, !dbg !83
  creg__r0__1_ = max(0,creg_r0);

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !60, metadata !DIExpression()), !dbg !62

  //   store i32 %conv11, i32* @atom_0_X4_1, align 4, !dbg !84, !tbaa !79
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !88, metadata !DIExpression()), !dbg !103
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64 2, metadata !91, metadata !DIExpression()), !dbg !106

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !60
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !93, metadata !DIExpression()), !dbg !108

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !62
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !95, metadata !DIExpression()), !dbg !108

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !92, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !97, metadata !DIExpression()), !dbg !111

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !96, metadata !DIExpression()), !dbg !103

  //   %cmp = icmp eq i32 %conv4, 3, !dbg !67
  creg__r3__3_ = max(0,creg_r3);

  //   %conv5 = zext i1 %cmp to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !100, metadata !DIExpression()), !dbg !103

  //   store i32 %conv5, i32* @atom_1_X3_3, align 4, !dbg !68, !tbaa !69
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv, 2, !dbg !73
  creg__r2__2_ = max(0,creg_r2);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !101, metadata !DIExpression()), !dbg !103

  //   store i32 %conv7, i32* @atom_1_X2_2, align 4, !dbg !74, !tbaa !69
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_2, metadata !139, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_1, metadata !143, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !145, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_0_X4_1 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_3, metadata !146, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_1_X3_3 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !149, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !186

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   %cmp = icmp eq i32 %conv, 3, !dbg !119
  creg__r7__3_ = max(0,creg_r7);
  ...
  //   %7 = load i32, i32* @atom_0_X4_1, align 4, !dbg !127, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X3_3, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X2_2, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
  ...
  creg_r17 = max(creg__r7__3_,creg_r16);
  r17 = (r7==3) & r16;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
