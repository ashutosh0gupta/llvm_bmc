...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !98
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !86
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !106

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,r3);
  cr(2,r3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l34_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()), !dbg !106

  //   %conv4 = trunc i64 %1 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !70, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !108
  ...
  //   %tobool = icmp ne i32 %conv12, 0, !dbg !95
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !120
  ...
  //   store i32 %conv23, i32* @atom_1_X3_0, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   store i32 %conv25, i32* @atom_1_X5_0, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   store i32 %conv27, i32* @atom_1_X6_1, align 4, !dbg !118, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !184, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !187, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !245

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !190, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !247

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !133
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X3_0, align 4, !dbg !166, !tbaa !164
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X5_0, align 4, !dbg !167, !tbaa !164
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X6_1, align 4, !dbg !168, !tbaa !164
  // LD: Guess
  old_cr = cr(0,6);
