...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !99, metadata !DIExpression()), !dbg !125

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !100, metadata !DIExpression()), !dbg !125

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !101, metadata !DIExpression()), !dbg !127

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !105, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !106, metadata !DIExpression()), !dbg !130

  //   call void @llvm.dbg.value(metadata i64 0, metadata !108, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !109, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !114, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !115, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i32 0, metadata !118, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !119, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i32 0, metadata !121, metadata !DIExpression()), !dbg !138

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !80
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_1_X4_0, align 4, !dbg !94, !tbaa !92
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 58, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !99
