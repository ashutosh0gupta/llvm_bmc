...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !50, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !53, metadata !DIExpression()), !dbg !65

  //   %add = add nsw i32 1, %xor, !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !55, metadata !DIExpression()), !dbg !78

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !77
  // LD: Guess
  old_cr = cr(1,r4);
  cr(1,r4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l26_c16
  // Check
  ASSUME(active[cr(1,r4)] == 1);
  ASSUME(cr(1,r4) >= iw(1,r4));
  ASSUME(cr(1,r4) >= creg_r4);
  ASSUME(cr(1,r4) >= cdy[1]);
  ASSUME(cr(1,r4) >= cisb[1]);
  ASSUME(cr(1,r4) >= cdl[1]);
  ASSUME(cr(1,r4) >= cl[1]);
  // Update
  creg_r5 = cr(1,r4);
  crmax(1,r4) = max(crmax(1,r4),cr(1,r4));
  caddr[1] = max(caddr[1],creg_r4);
  if(cr(1,r4) < cw(1,r4)) {
    r5 = buff(1,r4);
    ASSUME((!(( (cw(1,r4) < 1) && (1 < crmax(1,r4)) )))||(sforbid(r4,1)> 0));
    ASSUME((!(( (cw(1,r4) < 2) && (2 < crmax(1,r4)) )))||(sforbid(r4,2)> 0));
    ASSUME((!(( (cw(1,r4) < 3) && (3 < crmax(1,r4)) )))||(sforbid(r4,3)> 0));
    ASSUME((!(( (cw(1,r4) < 4) && (4 < crmax(1,r4)) )))||(sforbid(r4,4)> 0));
    ASSUME((!(( (cw(1,r4) < 5) && (5 < crmax(1,r4)) )))||(sforbid(r4,5)> 0));
    ASSUME((!(( (cw(1,r4) < 6) && (6 < crmax(1,r4)) )))||(sforbid(r4,6)> 0));
    ASSUME((!(( (cw(1,r4) < 7) && (7 < crmax(1,r4)) )))||(sforbid(r4,7)> 0));
    ASSUME((!(( (cw(1,r4) < 8) && (8 < crmax(1,r4)) )))||(sforbid(r4,8)> 0));
    ASSUME((!(( (cw(1,r4) < 9) && (9 < crmax(1,r4)) )))||(sforbid(r4,9)> 0));
  } else {
    if(pw(1,r4) != co(r4,cr(1,r4))) {
      ASSUME(cr(1,r4) >= old_cr);
    }
    pw(1,r4) = co(r4,cr(1,r4));
    r5 = mem(r4,cr(1,r4));
  }
  ASSUME(creturn[1] >= cr(1,r4));

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !57, metadata !DIExpression()), !dbg !78

  //   %conv8 = trunc i64 %2 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !54, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64 1, metadata !60, metadata !DIExpression()), !dbg !80

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !81
  // ST: Guess
  iw(1,0+1*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l27_c3
  old_cw = cw(1,0+1*1);
  cw(1,0+1*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l27_c3
  // Check
  ...
  //   store i32 %conv11, i32* @atom_0_X2_1, align 4, !dbg !83, !tbaa !84
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv4, 1, !dbg !88
  ...
  //   store i32 %conv13, i32* @atom_0_X3_1, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv8, 0, !dbg !90
  ...
  //   store i32 %conv15, i32* @atom_0_X5_0, align 4, !dbg !91, !tbaa !84
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !100, metadata !DIExpression()), !dbg !111
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !124, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !125, metadata !DIExpression()), !dbg !169

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !126, metadata !DIExpression()), !dbg !171

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !130, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !131, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64 0, metadata !133, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !134, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64 0, metadata !136, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !137, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i32 0, metadata !140, metadata !DIExpression()), !dbg !178

  //   store atomic i32 0, i32* @atom_0_X2_1 monotonic, align 4, !dbg !99
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l53_c3
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l53_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_1, metadata !141, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !180

  //   store atomic i32 0, i32* @atom_0_X3_1 monotonic, align 4, !dbg !101
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l54_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l54_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_0, metadata !144, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !147, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !151, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !153, metadata !DIExpression()), !dbg !194

  //   %conv = trunc i64 %4 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !150, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !154, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !156, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !158, metadata !DIExpression()), !dbg !198

  //   %conv18 = trunc i64 %5 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !155, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !159, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !160, metadata !DIExpression()), !dbg !169

  //   %7 = load i32, i32* @atom_0_X3_1, align 4, !dbg !127, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !161, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !162, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !163, metadata !DIExpression()), !dbg !169

  //   %and = and i32 %8, %9, !dbg !130
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !164, metadata !DIExpression()), !dbg !169

  //   %and21 = and i32 %7, %and, !dbg !131
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !165, metadata !DIExpression()), !dbg !169

  //   %and22 = and i32 %6, %and21, !dbg !132
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !166, metadata !DIExpression()), !dbg !169

  //   %and23 = and i32 %conv20, %and22, !dbg !133
  creg_r19 = max(creg__r11__2_,creg_r18);
  r19 = (r11==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !167, metadata !DIExpression()), !dbg !169

  //   %and24 = and i32 %conv14, %and23, !dbg !134
  creg_r20 = max(creg__r10__1_,creg_r19);
  r20 = (r10==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !168, metadata !DIExpression()), !dbg !169
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
