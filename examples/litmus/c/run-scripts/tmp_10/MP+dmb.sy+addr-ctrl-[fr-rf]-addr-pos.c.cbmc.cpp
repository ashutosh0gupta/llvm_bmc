...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv4, 0, !dbg !102
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !110), !dbg !126

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !73, metadata !DIExpression()), !dbg !127

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !127
  ...
  //   %xor13 = xor i32 %conv12, %conv12, !dbg !114
  ...
  //   %add15 = add nsw i32 0, %xor13, !dbg !115
  creg_r8 = max(0,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = 0 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !115

  //   %arrayidx17 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !115
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !82, metadata !DIExpression()), !dbg !135

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   %conv20 = trunc i64 %4 to i32, !dbg !117
  ...
  //   %cmp27 = icmp eq i32 %conv8, 0, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !94, metadata !DIExpression()), !dbg !144

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !96, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !98, metadata !DIExpression()), !dbg !147

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !100, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %8, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv20, 0, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !102, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !106, metadata !DIExpression()), !dbg !153

  //   %10 = zext i32 %conv43 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !108, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %10, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !135
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !199, metadata !DIExpression()), !dbg !270

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !270

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !141
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !202, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !272

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !143
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !205, metadata !DIExpression()), !dbg !274

  //   call void @llvm.dbg.value(metadata i64 0, metadata !207, metadata !DIExpression()), !dbg !274

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !145
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !208, metadata !DIExpression()), !dbg !276

  //   call void @llvm.dbg.value(metadata i64 0, metadata !210, metadata !DIExpression()), !dbg !276

  //   store atomic i64 0, i64* @atom_1_X11_0 monotonic, align 8, !dbg !147
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !212, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !217, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !222, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !231, metadata !DIExpression()), !dbg !306

  //   %10 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !177
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !235, metadata !DIExpression()), !dbg !309

  //   %11 = load atomic i64, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !180
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !239, metadata !DIExpression()), !dbg !312

  //   %12 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !183
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !243, metadata !DIExpression()), !dbg !315

  //   %13 = load atomic i64, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !186
  // LD: Guess
  old_cr = cr(0,8);
