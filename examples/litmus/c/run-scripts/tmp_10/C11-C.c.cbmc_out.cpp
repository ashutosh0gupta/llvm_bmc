...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !119, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_1, metadata !123, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i32 0, metadata !125, metadata !DIExpression()), !dbg !148

  //   store atomic i32 0, i32* @atom_2_X2_1 monotonic, align 4, !dbg !84
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_2_X2_1, align 4, !dbg !105, !tbaa !103
  // LD: Guess
  old_cr = cr(0,3);
