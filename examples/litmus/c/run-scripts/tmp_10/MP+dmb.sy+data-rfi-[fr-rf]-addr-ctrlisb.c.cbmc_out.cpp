...
T2BLOCK1:
  ...
  //   %add = add nsw i32 %xor, 1, !dbg !81
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !66, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !101

  //   %conv1 = sext i32 %add to i64, !dbg !83

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !69, metadata !DIExpression()), !dbg !101

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !83
  // ST: Guess
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()), !dbg !103

  //   %conv5 = trunc i64 %1 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !70, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !106

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !77, metadata !DIExpression()), !dbg !106

  //   %conv9 = trunc i64 %2 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !74, metadata !DIExpression()), !dbg !93

  //   %xor10 = xor i32 %conv9, %conv9, !dbg !90
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor10, metadata !78, metadata !DIExpression()), !dbg !93

  //   %add12 = add nsw i32 3, %xor10, !dbg !91
  creg_r6 = max(0,creg_r5);
  r6 = 3 + r5;

  //   %idxprom = sext i32 %add12 to i64, !dbg !91

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !91
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !111

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,r7);
  cr(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l37_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !111

  //   %conv15 = trunc i64 %3 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !79, metadata !DIExpression()), !dbg !93

  //   %tobool = icmp ne i32 %conv15, 0, !dbg !94
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !120

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !86, metadata !DIExpression()), !dbg !120

  //   %conv19 = trunc i64 %4 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !83, metadata !DIExpression()), !dbg !93

  //   %cmp = icmp eq i32 %conv, 1, !dbg !104
  creg__r0__1_ = max(0,creg_r0);

  //   %conv20 = zext i1 %cmp to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !87, metadata !DIExpression()), !dbg !93

  //   store i32 %conv20, i32* @atom_1_X0_1, align 4, !dbg !105, !tbaa !106
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv5, 1, !dbg !110
  creg__r3__1_ = max(0,creg_r3);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !88, metadata !DIExpression()), !dbg !93

  //   store i32 %conv22, i32* @atom_1_X4_1, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv9, 2, !dbg !112
  creg__r4__2_ = max(0,creg_r4);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !89, metadata !DIExpression()), !dbg !93

  //   store i32 %conv24, i32* @atom_1_X5_2, align 4, !dbg !113, !tbaa !106
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv19, 0, !dbg !114
  creg__r9__0_ = max(0,creg_r9);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !90, metadata !DIExpression()), !dbg !93

  //   store i32 %conv26, i32* @atom_1_X9_0, align 4, !dbg !115, !tbaa !106
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !139, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i64 2, metadata !141, metadata !DIExpression()), !dbg !146

  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !50
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !156, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !157, metadata !DIExpression()), !dbg !214

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !158, metadata !DIExpression()), !dbg !216

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !162, metadata !DIExpression()), !dbg !218

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !163, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !164, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !167, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !173, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !176, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !180, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !231

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !183, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !233

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !186, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i32 0, metadata !188, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !190, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !192, metadata !DIExpression()), !dbg !248

  //   %conv = trunc i64 %6 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !189, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !193, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !195, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !197, metadata !DIExpression()), !dbg !252

  //   %conv24 = trunc i64 %7 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !194, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !198, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !200, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !202, metadata !DIExpression()), !dbg !256

  //   %conv30 = trunc i64 %8 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !199, metadata !DIExpression()), !dbg !214

  //   %cmp31 = icmp eq i32 %conv30, 2, !dbg !149
  creg__r16__2_ = max(0,creg_r16);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !203, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !204, metadata !DIExpression()), !dbg !214

  //   %10 = load i32, i32* @atom_1_X4_1, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !205, metadata !DIExpression()), !dbg !214

  //   %11 = load i32, i32* @atom_1_X5_2, align 4, !dbg !154, !tbaa !151
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !206, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !207, metadata !DIExpression()), !dbg !214

  //   %and = and i32 %11, %12, !dbg !156
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !208, metadata !DIExpression()), !dbg !214

  //   %and33 = and i32 %10, %and, !dbg !157
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !209, metadata !DIExpression()), !dbg !214

  //   %and34 = and i32 %9, %and33, !dbg !158
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !210, metadata !DIExpression()), !dbg !214

  //   %and35 = and i32 %conv32, %and34, !dbg !159
  creg_r24 = max(creg__r16__2_,creg_r23);
  r24 = (r16==2) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !211, metadata !DIExpression()), !dbg !214

  //   %and36 = and i32 %conv26, %and35, !dbg !160
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !212, metadata !DIExpression()), !dbg !214

  //   %and37 = and i32 %conv20, %and36, !dbg !161
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !213, metadata !DIExpression()), !dbg !214
