...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !121

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !109

  //   %add = add nsw i32 %xor, 1, !dbg !106
  creg_r5 = max(creg_r4,0);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !80, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !126

  //   %conv13 = sext i32 %add to i64, !dbg !108

  //   call void @llvm.dbg.value(metadata i64 %conv13, metadata !83, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %conv13, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv12, 2, !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !101, metadata !DIExpression()), !dbg !141

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !103, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %8, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !123
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !190, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !219, metadata !DIExpression()), !dbg !283
