...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !97

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !100

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !103

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !106

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !106

  //   %conv12 = trunc i64 %3 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !94

  //   %xor = xor i32 %conv12, %conv12, !dbg !90
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !80, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !111

  //   %conv13 = sext i32 %add to i64, !dbg !93

  //   call void @llvm.dbg.value(metadata i64 %conv13, metadata !83, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %conv13, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !113
  ...
  //   %conv17 = trunc i64 %4 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !84, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !97
  creg__r0__1_ = max(0,creg_r0);

  //   %conv18 = zext i1 %cmp to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !88, metadata !DIExpression()), !dbg !94

  //   store i32 %conv18, i32* @atom_1_X0_1, align 4, !dbg !98, !tbaa !99
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv4, 1, !dbg !103
  creg__r1__1_ = max(0,creg_r1);

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !89, metadata !DIExpression()), !dbg !94

  //   store i32 %conv20, i32* @atom_1_X2_1, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv8, 2, !dbg !105
  creg__r2__2_ = max(0,creg_r2);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !90, metadata !DIExpression()), !dbg !94

  //   store i32 %conv22, i32* @atom_1_X3_2, align 4, !dbg !106, !tbaa !99
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv12, 2, !dbg !107
  creg__r3__2_ = max(0,creg_r3);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !91, metadata !DIExpression()), !dbg !94

  //   store i32 %conv24, i32* @atom_1_X4_2, align 4, !dbg !108, !tbaa !99
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv17, 1, !dbg !109
  creg__r6__1_ = max(0,creg_r6);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !92, metadata !DIExpression()), !dbg !94

  //   store i32 %conv26, i32* @atom_1_X7_1, align 4, !dbg !110, !tbaa !99
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !134, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64 2, metadata !136, metadata !DIExpression()), !dbg !141

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !52
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !202

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !204

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !206

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !158, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !165, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i32 0, metadata !168, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !169, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !172, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !217

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !175, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !219

  //   store atomic i32 0, i32* @atom_1_X4_2 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !178, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !184, metadata !DIExpression()), !dbg !234

  //   %conv = trunc i64 %6 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !181, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !185, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !189, metadata !DIExpression()), !dbg !238

  //   %conv22 = trunc i64 %7 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !186, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !190, metadata !DIExpression()), !dbg !202
  ...
  //   %10 = load i32, i32* @atom_1_X3_2, align 4, !dbg !143, !tbaa !140
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X4_2, align 4, !dbg !144, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !196, metadata !DIExpression()), !dbg !202

  //   %and25 = and i32 %10, %and, !dbg !147
  creg_r19 = max(creg_r15,creg_r18);
  r19 = r15 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !197, metadata !DIExpression()), !dbg !202

  //   %and26 = and i32 %9, %and25, !dbg !148
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !198, metadata !DIExpression()), !dbg !202

  //   %and27 = and i32 %8, %and26, !dbg !149
  creg_r21 = max(creg_r13,creg_r20);
  r21 = r13 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !199, metadata !DIExpression()), !dbg !202

  //   %and28 = and i32 %conv24, %and27, !dbg !150
  creg_r22 = max(creg__r12__2_,creg_r21);
  r22 = (r12==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !200, metadata !DIExpression()), !dbg !202

  //   %and29 = and i32 %conv18, %and28, !dbg !151
  creg_r23 = max(creg__r11__2_,creg_r22);
  r23 = (r11==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !201, metadata !DIExpression()), !dbg !202
