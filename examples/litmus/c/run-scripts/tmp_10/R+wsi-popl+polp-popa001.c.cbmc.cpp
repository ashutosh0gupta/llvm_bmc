...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64 2, metadata !77, metadata !DIExpression()), !dbg !91

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !55
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !79, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !78, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !82, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !86, metadata !DIExpression()), !dbg !88
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_2, metadata !125, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i32 0, metadata !128, metadata !DIExpression()), !dbg !158

  //   store atomic i32 0, i32* @atom_0_X5_2 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !129, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i32 0, metadata !131, metadata !DIExpression()), !dbg !160

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l57_c13
  // Check
  ...
  //   %6 = load i32, i32* @atom_0_X5_2, align 4, !dbg !111, !tbaa !112
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X4_0, align 4, !dbg !114, !tbaa !112
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
