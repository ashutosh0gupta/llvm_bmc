...
T2BLOCK1:
  ...
  //   %cmp28 = icmp eq i32 %conv11, 1, !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !93, metadata !DIExpression()), !dbg !133

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %6, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !115
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !149, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !150, metadata !DIExpression()), !dbg !217

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !151, metadata !DIExpression()), !dbg !219

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !155, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !156, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64 0, metadata !158, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64 0, metadata !161, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !168, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !171, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !174, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !234

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !130
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !177, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !236

  //   store atomic i64 0, i64* @atom_1_X11_0 monotonic, align 8, !dbg !132
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !181, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !183, metadata !DIExpression()), !dbg !248

  //   %conv = trunc i64 %4 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !180, metadata !DIExpression()), !dbg !217

  //   %cmp = icmp eq i32 %conv, 1, !dbg !146

  //   %conv18 = zext i1 %cmp to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !184, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !186, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !188, metadata !DIExpression()), !dbg !252

  //   %conv22 = trunc i64 %5 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !185, metadata !DIExpression()), !dbg !217

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !150

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !189, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !193, metadata !DIExpression()), !dbg !256

  //   %conv28 = trunc i64 %6 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !190, metadata !DIExpression()), !dbg !217

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !154

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !194, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !196, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !198, metadata !DIExpression()), !dbg !260

  //   %conv34 = trunc i64 %7 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !195, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !200, metadata !DIExpression()), !dbg !263

  //   %8 = load atomic i64, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !159
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !202, metadata !DIExpression()), !dbg !263

  //   %conv38 = trunc i64 %8 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !199, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !204, metadata !DIExpression()), !dbg !266

  //   %9 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !162
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !206, metadata !DIExpression()), !dbg !266

  //   %conv42 = trunc i64 %9 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !203, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !208, metadata !DIExpression()), !dbg !269

  //   %10 = load atomic i64, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !210, metadata !DIExpression()), !dbg !269

  //   %conv46 = trunc i64 %10 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !207, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !212, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !213, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !214, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %and50, metadata !215, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !216, metadata !DIExpression()), !dbg !217
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !176
