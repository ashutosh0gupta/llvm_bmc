...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !60, metadata !DIExpression()), !dbg !87

  //   br label %label_2, !dbg !69
  goto T2BLOCK1;

T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !86), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !90

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !72
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !64, metadata !DIExpression()), !dbg !90

  //   %conv = trunc i64 %0 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !61, metadata !DIExpression()), !dbg !87

  //   %xor = xor i32 %conv, %conv, !dbg !74
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !87

  //   %add = add nsw i32 2, %xor, !dbg !75
  creg_r2 = max(0,creg_r1);
  r2 = 2 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !75

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !75
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !67, metadata !DIExpression()), !dbg !95

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !75
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !69, metadata !DIExpression()), !dbg !95

  //   %conv4 = trunc i64 %1 to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64 1, metadata !72, metadata !DIExpression()), !dbg !97

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !99

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !76, metadata !DIExpression()), !dbg !99

  //   %conv8 = trunc i64 %2 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !73, metadata !DIExpression()), !dbg !87

  //   %xor9 = xor i32 %conv8, %conv8, !dbg !83
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !77, metadata !DIExpression()), !dbg !87

  //   %add11 = add nsw i32 0, %xor9, !dbg !84
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !84

  //   %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !84
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !79, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !104

  //   %conv16 = trunc i64 %3 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !78, metadata !DIExpression()), !dbg !87

  //   %cmp = icmp eq i32 %conv, 1, !dbg !87
  creg__r0__1_ = max(0,creg_r0);

  //   %conv17 = zext i1 %cmp to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !82, metadata !DIExpression()), !dbg !87

  //   store i32 %conv17, i32* @atom_1_X0_1, align 4, !dbg !88, !tbaa !89
  // ST: Guess
  iw(2,3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l38_c15
  old_cw = cw(2,3);
  cw(2,3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l38_c15
  // Check
  ...
  //   %cmp18 = icmp eq i32 %conv4, 0, !dbg !93
  creg__r4__0_ = max(0,creg_r4);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !83, metadata !DIExpression()), !dbg !87

  //   store i32 %conv19, i32* @atom_1_X3_0, align 4, !dbg !94, !tbaa !89
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv8, 2, !dbg !95
  creg__r5__2_ = max(0,creg_r5);

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !84, metadata !DIExpression()), !dbg !87

  //   store i32 %conv21, i32* @atom_1_X6_2, align 4, !dbg !96, !tbaa !89
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv16, 0, !dbg !97
  creg__r9__0_ = max(0,creg_r9);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !85, metadata !DIExpression()), !dbg !87

  //   store i32 %conv23, i32* @atom_1_X8_0, align 4, !dbg !98, !tbaa !89
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !122, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i64 2, metadata !124, metadata !DIExpression()), !dbg !129
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !139, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !140, metadata !DIExpression()), !dbg !194

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !141, metadata !DIExpression()), !dbg !196

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !145, metadata !DIExpression()), !dbg !198

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !146, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !147, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !160, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !209

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !163, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !166, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !170, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !172, metadata !DIExpression()), !dbg !226

  //   %conv = trunc i64 %6 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !169, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !173, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !177, metadata !DIExpression()), !dbg !230

  //   %conv22 = trunc i64 %7 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !174, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !178, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !180, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !182, metadata !DIExpression()), !dbg !234

  //   %conv28 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !179, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !183, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !184, metadata !DIExpression()), !dbg !194

  //   %10 = load i32, i32* @atom_1_X3_0, align 4, !dbg !148, !tbaa !146
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !185, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !186, metadata !DIExpression()), !dbg !194

  //   %12 = load i32, i32* @atom_1_X8_0, align 4, !dbg !150, !tbaa !146
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !187, metadata !DIExpression()), !dbg !194

  //   %and = and i32 %11, %12, !dbg !151
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !188, metadata !DIExpression()), !dbg !194

  //   %and31 = and i32 %10, %and, !dbg !152
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !189, metadata !DIExpression()), !dbg !194

  //   %and32 = and i32 %9, %and31, !dbg !153
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !190, metadata !DIExpression()), !dbg !194

  //   %and33 = and i32 %conv30, %and32, !dbg !154
  creg_r24 = max(creg__r16__2_,creg_r23);
  r24 = (r16==2) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !191, metadata !DIExpression()), !dbg !194

  //   %and34 = and i32 %conv24, %and33, !dbg !155
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !192, metadata !DIExpression()), !dbg !194

  //   %and35 = and i32 %conv18, %and34, !dbg !156
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !193, metadata !DIExpression()), !dbg !194
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
