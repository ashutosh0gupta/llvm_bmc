...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !82, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !98, metadata !DIExpression()), !dbg !123

  //   %5 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !100, metadata !DIExpression()), !dbg !123

  //   store atomic i64 %5, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !152, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !202

  //   store atomic i64 0, i64* @atom_1_X3_2 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !155, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !204

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !177, metadata !DIExpression()), !dbg !230

  //   %8 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !181, metadata !DIExpression()), !dbg !233

  //   %9 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,5);
