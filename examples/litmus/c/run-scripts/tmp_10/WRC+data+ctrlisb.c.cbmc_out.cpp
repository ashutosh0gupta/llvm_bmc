...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !91, metadata !DIExpression()), !dbg !115

  //   %conv4 = trunc i64 %1 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !88, metadata !DIExpression()), !dbg !102

  //   %cmp = icmp eq i32 %conv, 1, !dbg !74

  //   %conv5 = zext i1 %cmp to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !92, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !93, metadata !DIExpression()), !dbg !119

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !95, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %2, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !76
  // ST: Guess
  ...
  //   %cmp7 = icmp eq i32 %conv4, 0, !dbg !77

  //   %conv8 = zext i1 %cmp7 to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !96, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !97, metadata !DIExpression()), !dbg !122

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !99, metadata !DIExpression()), !dbg !122

  //   store atomic i64 %3, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !139, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !140, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !146, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !149, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !151, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !152, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !184

  //   store atomic i64 0, i64* @atom_2_X2_0 monotonic, align 8, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !158, metadata !DIExpression()), !dbg !199

  //   %conv = trunc i64 %6 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !155, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !160, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !162, metadata !DIExpression()), !dbg !202

  //   %conv17 = trunc i64 %7 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !159, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !164, metadata !DIExpression()), !dbg !205

  //   %8 = load atomic i64, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !166, metadata !DIExpression()), !dbg !205

  //   %conv21 = trunc i64 %8 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !163, metadata !DIExpression()), !dbg !169
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
