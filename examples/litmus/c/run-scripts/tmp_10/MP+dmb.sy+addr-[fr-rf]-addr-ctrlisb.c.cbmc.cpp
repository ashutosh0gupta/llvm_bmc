...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !74, metadata !DIExpression()), !dbg !101

  //   %add11 = add nsw i32 3, %xor9, !dbg !96
  ...
  //   %arrayidx13 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !96
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !76, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !75, metadata !DIExpression()), !dbg !101

  //   %tobool = icmp ne i32 %conv16, 0, !dbg !99
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !100), !dbg !123
  ...
  //   %cmp23 = icmp eq i32 %conv4, 0, !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !88, metadata !DIExpression()), !dbg !132

  //   %6 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %6, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !114
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv8, 1, !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !92, metadata !DIExpression()), !dbg !135

  //   %7 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %7, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !184, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !187, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !199, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !204, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !213, metadata !DIExpression()), !dbg !281
