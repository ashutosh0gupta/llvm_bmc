...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !119, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !122, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i64 0, metadata !124, metadata !DIExpression()), !dbg !157

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !136, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !140, metadata !DIExpression()), !dbg !180

  //   %7 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
