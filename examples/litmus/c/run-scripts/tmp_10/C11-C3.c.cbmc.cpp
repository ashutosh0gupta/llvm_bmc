...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !40, metadata !DIExpression()), !dbg !50

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !51
  // ST: Guess
  //   : Release
  ...
  //   store i32 %conv1, i32* @atom_0_X2_1, align 4, !dbg !56, !tbaa !57
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !67, metadata !DIExpression()), !dbg !77
  ...
  //   store i32 %conv1, i32* @atom_1_X2_1, align 4, !dbg !56, !tbaa !57
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !91, metadata !DIExpression()), !dbg !100
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !118, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !121, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !124, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i32 0, metadata !127, metadata !DIExpression()), !dbg !157

  //   store atomic i32 0, i32* @atom_0_X2_1 monotonic, align 4, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !128, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i32 0, metadata !130, metadata !DIExpression()), !dbg !159

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X2_1, align 4, !dbg !104, !tbaa !105
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !131, metadata !DIExpression()), !dbg !146

  //   %7 = load i32, i32* @atom_1_X2_1, align 4, !dbg !107, !tbaa !105
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !132, metadata !DIExpression()), !dbg !146
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !136, metadata !DIExpression()), !dbg !174
  ...
  //   %9 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !141, metadata !DIExpression()), !dbg !178
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([91 x i8], [91 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !122
