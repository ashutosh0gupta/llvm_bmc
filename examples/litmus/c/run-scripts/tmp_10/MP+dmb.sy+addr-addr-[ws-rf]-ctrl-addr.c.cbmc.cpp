...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !68, metadata !DIExpression()), !dbg !90

  //   %add6 = add nsw i32 3, %xor5, !dbg !82
  creg_r6 = max(0,creg_r5);
  r6 = 3 + r5;

  //   %idxprom7 = sext i32 %add6 to i64, !dbg !82

  //   %arrayidx8 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom7, !dbg !82
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx8, metadata !69, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64 1, metadata !71, metadata !DIExpression()), !dbg !102

  //   store atomic i64 1, i64* %arrayidx8 monotonic, align 8, !dbg !82
  // ST: Guess
  iw(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l33_c3
  old_cw = cw(2,r7);
  cw(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l33_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !73, metadata !DIExpression()), !dbg !103

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !103

  //   %conv12 = trunc i64 %2 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !72, metadata !DIExpression()), !dbg !90

  //   %tobool = icmp ne i32 %conv12, 0, !dbg !87
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !89), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !77, metadata !DIExpression()), !dbg !112

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !112

  //   %conv16 = trunc i64 %3 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !76, metadata !DIExpression()), !dbg !90

  //   %xor17 = xor i32 %conv16, %conv16, !dbg !96
  creg_r10 = creg_r9;
  r10 = r9 ^ r9;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !80, metadata !DIExpression()), !dbg !90

  //   %add19 = add nsw i32 0, %xor17, !dbg !97
  creg_r11 = max(0,creg_r10);
  r11 = 0 + r10;

  //   %idxprom20 = sext i32 %add19 to i64, !dbg !97

  //   %arrayidx21 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !97
  r12 = 0+r11*1;
  creg_r12 = creg_r11;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !82, metadata !DIExpression()), !dbg !117

  //   %4 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(2,r12);
  cr(2,r12) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l39_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !117

  //   %conv24 = trunc i64 %4 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !81, metadata !DIExpression()), !dbg !90

  //   %cmp = icmp eq i32 %conv, 1, !dbg !100
  creg__r0__1_ = max(0,creg_r0);

  //   %conv25 = zext i1 %cmp to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !85, metadata !DIExpression()), !dbg !90

  //   store i32 %conv25, i32* @atom_1_X0_1, align 4, !dbg !101, !tbaa !102
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv12, 2, !dbg !106
  creg__r8__2_ = max(0,creg_r8);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !86, metadata !DIExpression()), !dbg !90

  //   store i32 %conv27, i32* @atom_1_X8_2, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  iw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l43_c15
  old_cw = cw(2,6);
  cw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l43_c15
  // Check
  ...
  //   %cmp28 = icmp eq i32 %conv24, 0, !dbg !108
  creg__r13__0_ = max(0,creg_r13);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !87, metadata !DIExpression()), !dbg !90

  //   store i32 %conv29, i32* @atom_1_X12_0, align 4, !dbg !109, !tbaa !102
  // ST: Guess
  iw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l45_c16
  old_cw = cw(2,7);
  cw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l45_c16
  // Check
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !133, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64 2, metadata !135, metadata !DIExpression()), !dbg !140

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !48
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !150, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !151, metadata !DIExpression()), !dbg !206

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !152, metadata !DIExpression()), !dbg !208

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !156, metadata !DIExpression()), !dbg !210

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !157, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !158, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !213

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !106
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l60_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l60_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !161, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !215

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !164, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !217

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !167, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !219

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !170, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !221

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !173, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !223

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_2, metadata !177, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !225

  //   store atomic i32 0, i32* @atom_1_X8_2 monotonic, align 4, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X12_0, metadata !180, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !227

  //   store atomic i32 0, i32* @atom_1_X12_0 monotonic, align 4, !dbg !120
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l67_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l67_c3
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !122
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !123
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !129
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !131
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call19 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !133
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !184, metadata !DIExpression()), !dbg !240

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l77_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !186, metadata !DIExpression()), !dbg !240

  //   %conv = trunc i64 %6 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !183, metadata !DIExpression()), !dbg !206

  //   %cmp = icmp eq i32 %conv, 2, !dbg !137
  creg__r18__2_ = max(0,creg_r18);

  //   %conv20 = zext i1 %cmp to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !187, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !244

  //   %7 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !139
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !191, metadata !DIExpression()), !dbg !244

  //   %conv24 = trunc i64 %7 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !188, metadata !DIExpression()), !dbg !206

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !141
  creg__r19__1_ = max(0,creg_r19);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !192, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !248

  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !143
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !196, metadata !DIExpression()), !dbg !248

  //   %conv30 = trunc i64 %8 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !193, metadata !DIExpression()), !dbg !206

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !145
  creg__r20__1_ = max(0,creg_r20);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !197, metadata !DIExpression()), !dbg !206

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !146, !tbaa !147
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !198, metadata !DIExpression()), !dbg !206

  //   %10 = load i32, i32* @atom_1_X8_2, align 4, !dbg !149, !tbaa !147
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !199, metadata !DIExpression()), !dbg !206

  //   %11 = load i32, i32* @atom_1_X12_0, align 4, !dbg !150, !tbaa !147
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l85_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !200, metadata !DIExpression()), !dbg !206

  //   %and = and i32 %10, %11, !dbg !151
  creg_r24 = max(creg_r22,creg_r23);
  r24 = r22 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !201, metadata !DIExpression()), !dbg !206

  //   %and33 = and i32 %9, %and, !dbg !152
  creg_r25 = max(creg_r21,creg_r24);
  r25 = r21 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !202, metadata !DIExpression()), !dbg !206

  //   %and34 = and i32 %conv32, %and33, !dbg !153
  creg_r26 = max(creg__r20__1_,creg_r25);
  r26 = (r20==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !203, metadata !DIExpression()), !dbg !206

  //   %and35 = and i32 %conv26, %and34, !dbg !154
  ...
  //   %and36 = and i32 %conv20, %and35, !dbg !155
  creg_r28 = max(creg__r18__2_,creg_r27);
  r28 = (r18==2) & r27;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !159
...
T0BLOCK2:
  //   %12 = bitcast i64* %thr2 to i8*, !dbg !162

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !162

  //   %13 = bitcast i64* %thr1 to i8*, !dbg !162

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !162

  //   %14 = bitcast i64* %thr0 to i8*, !dbg !162
