...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !97), !dbg !101
  ...
  //   %xor = xor i32 %conv, %conv, !dbg !86
  creg_r1 = max(creg_r0,creg_r0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !63, metadata !DIExpression()), !dbg !99

  //   %add = add nsw i32 2, %xor, !dbg !87
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !87
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ASSUME(creg_r3 >= creg_r2);
  ASSUME(active[creg_r3] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !65, metadata !DIExpression()), !dbg !107

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !87
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !67, metadata !DIExpression()), !dbg !107

  //   %conv4 = trunc i64 %1 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !99

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !90
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !68, metadata !DIExpression()), !dbg !99

  //   %add6 = add nsw i32 3, %xor5, !dbg !91
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 3 + r5;

  //   %idxprom7 = sext i32 %add6 to i64, !dbg !91

  //   %arrayidx8 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom7, !dbg !91
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx8, metadata !69, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64 1, metadata !71, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* %arrayidx8 monotonic, align 8, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !73, metadata !DIExpression()), !dbg !112

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   %conv12 = trunc i64 %2 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !72, metadata !DIExpression()), !dbg !99

  //   %tobool = icmp ne i32 %conv12, 0, !dbg !96
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !98), !dbg !120

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !77, metadata !DIExpression()), !dbg !121

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  if(cr(2,0+4*1) < cw(2,0+4*1)) {
    ...
    r9 = mem(0+4*1,cr(2,0+4*1));
  }
  ASSUME(creturn[2] >= cr(2,0+4*1));

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !121

  //   %conv16 = trunc i64 %3 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !76, metadata !DIExpression()), !dbg !99

  //   %xor17 = xor i32 %conv16, %conv16, !dbg !105
  creg_r10 = max(creg_r9,creg_r9);
  ASSUME(active[creg_r10] == 2);
  r10 = r9 ^ r9;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !80, metadata !DIExpression()), !dbg !99

  //   %add19 = add nsw i32 0, %xor17, !dbg !106
  creg_r11 = max(0,creg_r10);
  ASSUME(active[creg_r11] == 2);
  r11 = 0 + r10;

  //   %idxprom20 = sext i32 %add19 to i64, !dbg !106

  //   %arrayidx21 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !106
  r12 = 0+r11*1;
  ASSUME(creg_r12 >= 0);
  ASSUME(creg_r12 >= creg_r11);
  ASSUME(active[creg_r12] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !82, metadata !DIExpression()), !dbg !126

  //   %4 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,r12);
  cr(2,r12) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  if(cr(2,r12) < cw(2,r12)) {
    ...
    ASSUME((!(( (cw(2,r12) < 5) && (5 < crmax(2,r12)) )))||(sforbid(r12,5)> 0));
    ASSUME((!(( (cw(2,r12) < 6) && (6 < crmax(2,r12)) )))||(sforbid(r12,6)> 0));
    ASSUME((!(( (cw(2,r12) < 7) && (7 < crmax(2,r12)) )))||(sforbid(r12,7)> 0));
    ASSUME((!(( (cw(2,r12) < 8) && (8 < crmax(2,r12)) )))||(sforbid(r12,8)> 0));
    ASSUME((!(( (cw(2,r12) < 9) && (9 < crmax(2,r12)) )))||(sforbid(r12,9)> 0));
  } else {
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !126

  //   %conv24 = trunc i64 %4 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !81, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 1, !dbg !109

  //   %conv25 = zext i1 %cmp to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !85, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !86, metadata !DIExpression()), !dbg !129

  //   %5 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !111
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv12, 2, !dbg !112

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !89, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !90, metadata !DIExpression()), !dbg !132

  //   %6 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %6, i64* @atom_1_X8_2 seq_cst, align 8, !dbg !114
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv24, 0, !dbg !115

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !93, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !94, metadata !DIExpression()), !dbg !135

  //   %7 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !96, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %7, i64* @atom_1_X12_0 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !141, metadata !DIExpression()), !dbg !148
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !222

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !224

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !226

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !165, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !166, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !169, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !172, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !181, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !184, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !241

  //   store atomic i64 0, i64* @atom_1_X8_2 monotonic, align 8, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !187, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !243

  //   store atomic i64 0, i64* @atom_1_X12_0 monotonic, align 8, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !191, metadata !DIExpression()), !dbg !258
  ...
  if(cr(0,0+3*1) < cw(0,0+3*1)) {
    ...
    r18 = mem(0+3*1,cr(0,0+3*1));
  }
  ASSUME(creturn[0] >= cr(0,0+3*1));

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !193, metadata !DIExpression()), !dbg !258

  //   %conv = trunc i64 %6 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !190, metadata !DIExpression()), !dbg !222

  //   %cmp = icmp eq i32 %conv, 2, !dbg !145

  //   %conv20 = zext i1 %cmp to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !194, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !196, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !198, metadata !DIExpression()), !dbg !262

  //   %conv24 = trunc i64 %7 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !195, metadata !DIExpression()), !dbg !222

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !149

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !199, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !201, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !203, metadata !DIExpression()), !dbg !266

  //   %conv30 = trunc i64 %8 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !200, metadata !DIExpression()), !dbg !222

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !153

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !204, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !206, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !208, metadata !DIExpression()), !dbg !270

  //   %conv36 = trunc i64 %9 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !205, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !210, metadata !DIExpression()), !dbg !273

  //   %10 = load atomic i64, i64* @atom_1_X8_2 seq_cst, align 8, !dbg !158
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !212, metadata !DIExpression()), !dbg !273

  //   %conv40 = trunc i64 %10 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !209, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !214, metadata !DIExpression()), !dbg !276

  //   %11 = load atomic i64, i64* @atom_1_X12_0 seq_cst, align 8, !dbg !161
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !216, metadata !DIExpression()), !dbg !276

  //   %conv44 = trunc i64 %11 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !213, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !217, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !218, metadata !DIExpression()), !dbg !222

  //   %and46 = and i32 %conv32, %and45, !dbg !165
  creg_r26 = max(max(creg_r20,0),creg_r25);
  ASSUME(active[creg_r26] == 0);
  r26 = (r20==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !219, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !220, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !221, metadata !DIExpression()), !dbg !222
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
