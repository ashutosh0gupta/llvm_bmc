...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !78
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !83, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !84, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64 1, metadata !86, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !79
  // ST: Guess
  iw(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l38_c3
  old_cw = cw(2,r8);
  cw(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l38_c3
  // Check
