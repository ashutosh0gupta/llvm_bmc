...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64 1, metadata !80, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !82, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !84, metadata !DIExpression()), !dbg !105

  //   %conv6 = trunc i64 %1 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !81, metadata !DIExpression()), !dbg !94

  //   %tobool = icmp ne i32 %conv6, 0, !dbg !80
...
T2BLOCK4:
  ...
  //   store i32 %conv13, i32* @atom_1_X6_1, align 4, !dbg !96, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !154, metadata !DIExpression()), !dbg !200
