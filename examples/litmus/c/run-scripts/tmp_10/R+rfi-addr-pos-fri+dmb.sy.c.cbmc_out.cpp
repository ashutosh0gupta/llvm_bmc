...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !55, metadata !DIExpression()), !dbg !77

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(1,0+1*1);
  cr(1,0+1*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l26_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !57, metadata !DIExpression()), !dbg !77
  ...
  //   %cmp12 = icmp eq i32 %conv4, 0, !dbg !88
  ...
  //   store i32 %conv13, i32* @atom_0_X4_0, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   store i32 %conv15, i32* @atom_0_X6_0, align 4, !dbg !91, !tbaa !84
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_0, metadata !141, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !180

  //   store atomic i32 0, i32* @atom_0_X4_0 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_0, metadata !144, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_0_X6_0 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_0_X4_0, align 4, !dbg !127, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_0_X6_0, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
