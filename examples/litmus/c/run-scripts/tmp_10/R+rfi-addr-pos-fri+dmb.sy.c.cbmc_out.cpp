...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !55, metadata !DIExpression()), !dbg !86

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !87
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !57, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_0, metadata !70, metadata !DIExpression()), !dbg !98

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !72, metadata !DIExpression()), !dbg !98

  //   store atomic i64 %5, i64* @atom_0_X6_0 seq_cst, align 8, !dbg !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !152, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !203

  //   store atomic i64 0, i64* @atom_0_X4_0 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_0, metadata !155, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !205

  //   store atomic i64 0, i64* @atom_0_X6_0 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !176, metadata !DIExpression()), !dbg !230

  //   %7 = load atomic i64, i64* @atom_0_X4_0 seq_cst, align 8, !dbg !139
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_0, metadata !180, metadata !DIExpression()), !dbg !233

  //   %8 = load atomic i64, i64* @atom_0_X6_0 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,4);
