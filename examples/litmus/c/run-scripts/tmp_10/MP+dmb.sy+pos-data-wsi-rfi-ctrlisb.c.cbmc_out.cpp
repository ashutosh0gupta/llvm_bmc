...
T2BLOCK1:
  ...
  //   %add = add nsw i32 %xor, 1, !dbg !94
  creg_r3 = max(creg_r2,0);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !70, metadata !DIExpression()), !dbg !103
  ...
  //   %conv5 = sext i32 %add to i64, !dbg !96

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !73, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64 2, metadata !76, metadata !DIExpression()), !dbg !116

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !98
  // ST: Guess
  iw(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0+2*1);
  cw(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !77, metadata !DIExpression()), !dbg !103

  //   %tobool = icmp ne i32 %conv11, 0, !dbg !102
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !81, metadata !DIExpression()), !dbg !103

  //   %cmp = icmp eq i32 %conv, 1, !dbg !112

  //   %conv16 = zext i1 %cmp to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !85, metadata !DIExpression()), !dbg !103
  ...
  //   %cmp20 = icmp eq i32 %conv4, 1, !dbg !115

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !89, metadata !DIExpression()), !dbg !103
  ...
  //   store atomic i64 %5, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !117
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv11, 2, !dbg !118

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !93, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !94, metadata !DIExpression()), !dbg !138
  ...
  //   %cmp30 = icmp eq i32 %conv15, 0, !dbg !121

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !97, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !98, metadata !DIExpression()), !dbg !141

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !123
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !216

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !218

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !158, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !164, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !167, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !170, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !173, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !231

  //   store atomic i64 0, i64* @atom_1_X6_2 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !176, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !233

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !182, metadata !DIExpression()), !dbg !245

  //   %conv = trunc i64 %4 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !179, metadata !DIExpression()), !dbg !216

  //   %cmp = icmp eq i32 %conv, 1, !dbg !141

  //   %conv16 = zext i1 %cmp to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !183, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !187, metadata !DIExpression()), !dbg !249

  //   %conv20 = trunc i64 %5 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !184, metadata !DIExpression()), !dbg !216

  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !145

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !188, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !190, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !189, metadata !DIExpression()), !dbg !216

  //   %cmp27 = icmp eq i32 %conv26, 2, !dbg !149

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !193, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !195, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !194, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !199, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !198, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !203, metadata !DIExpression()), !dbg !263

  //   %9 = load atomic i64, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !202, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !207, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !209, metadata !DIExpression()), !dbg !266

  //   %conv44 = trunc i64 %10 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !206, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !211, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !212, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !213, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !214, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !215, metadata !DIExpression()), !dbg !216
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !171
