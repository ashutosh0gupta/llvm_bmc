...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !65, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !67, metadata !DIExpression()), !dbg !100
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !71, metadata !DIExpression()), !dbg !86

  //   %cmp = icmp eq i32 %conv, 2, !dbg !95

  //   %conv14 = zext i1 %cmp to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !75, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !76, metadata !DIExpression()), !dbg !115

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !115

  //   store atomic i64 %3, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !97
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv13, 1, !dbg !98

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !79, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !80, metadata !DIExpression()), !dbg !118

  //   %4 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !118

  //   store atomic i64 %4, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !144, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !147, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !161, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !165, metadata !DIExpression()), !dbg !207
