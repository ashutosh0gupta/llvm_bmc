...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !36, metadata !DIExpression()), !dbg !60

  //   br label %label_1, !dbg !61
  goto T1BLOCK1;

T1BLOCK1:
  //   call void @llvm.dbg.label(metadata !57), !dbg !62

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !37, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64 1, metadata !40, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !41, metadata !DIExpression()), !dbg !60
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !58), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !46, metadata !DIExpression()), !dbg !74

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !75
  // LD: Guess
  old_cr = cr(1,0+2*1);
  cr(1,0+2*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l24_c15
  // Check
  ...
  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !77
  creg__r1__0_ = max(0,creg_r1);

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !79
  old_cctrl = cctrl[1];
  cctrl[1] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[1] >= old_cctrl);
...
T1BLOCK7:
  //   call void @llvm.dbg.label(metadata !59), !dbg !82

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !49, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64 1, metadata !51, metadata !DIExpression()), !dbg !83

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !84
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !53, metadata !DIExpression()), !dbg !85

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(1,0+3*1);
  cr(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l28_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !55, metadata !DIExpression()), !dbg !85

  //   %conv13 = trunc i64 %2 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !52, metadata !DIExpression()), !dbg !60

  //   %cmp = icmp eq i32 %conv13, 2, !dbg !88
  creg__r2__2_ = max(0,creg_r2);

  //   %conv14 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !56, metadata !DIExpression()), !dbg !60

  //   store i32 %conv14, i32* @atom_0_X8_2, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  iw(1,4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l30_c15
  old_cw = cw(1,4);
  cw(1,4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l30_c15
  // Check
  ASSUME(active[iw(1,4)] == 1);
  ASSUME(active[cw(1,4)] == 1);
  ASSUME(sforbid(4,cw(1,4))== 0);
  ASSUME(iw(1,4) >= creg__r2__2_);
  ASSUME(iw(1,4) >= 0);
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !102, metadata !DIExpression()), !dbg !112
...
T0BLOCK0:
  ...
  // ST: Guess
  iw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l47_c3
  old_cw = cw(0,0+3*1);
  cw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l47_c3
  // Check
  ...
  // ST: Guess
  iw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l48_c3
  old_cw = cw(0,0+2*1);
  cw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l48_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X8_2, metadata !144, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !147, metadata !DIExpression()), !dbg !179

  //   store atomic i32 0, i32* @atom_0_X8_2 monotonic, align 4, !dbg !95
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l51_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l51_c3
  // Check
  ...
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l52_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l52_c3
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,0+3*1);
  cr(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l60_c13
  // Check
  ...
  //   %6 = load i32, i32* @atom_0_X8_2, align 4, !dbg !116, !tbaa !117
  // LD: Guess
  old_cr = cr(0,4);
  ...
  creg_r12 = max(creg__r8__1_,creg_r11);
  r12 = (r8==1) & r11;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
