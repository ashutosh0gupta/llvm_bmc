...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !54, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !71

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !59
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+1*1);
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !85, metadata !DIExpression()), !dbg !93
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !86, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64 1, metadata !88, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !89, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64 1, metadata !91, metadata !DIExpression()), !dbg !98

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !53
  // ST: Guess
  //   : Release
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l40_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l40_c3
  // Check
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !103, metadata !DIExpression()), !dbg !113
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !105, metadata !DIExpression()), !dbg !116

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !53
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+2*1);
  cr(4,0+2*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l46_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !104, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !108, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 1, metadata !110, metadata !DIExpression()), !dbg !119

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !56
  // ST: Guess
  //   : Release
  iw(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l47_c3
  old_cw = cw(4,0);
  cw(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l47_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !111, metadata !DIExpression()), !dbg !113

  //   store i32 %conv1, i32* @atom_3_X0_1, align 4, !dbg !58, !tbaa !59
  // ST: Guess
  iw(4,5) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l49_c15
  old_cw = cw(4,5);
  cw(4,5) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l49_c15
  // Check
  ASSUME(active[iw(4,5)] == 4);
  ASSUME(active[cw(4,5)] == 4);
  ASSUME(sforbid(5,cw(4,5))== 0);
  ASSUME(iw(4,5) >= creg__r2__1_);
  ASSUME(iw(4,5) >= 0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !131, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !132, metadata !DIExpression()), !dbg !170

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !133, metadata !DIExpression()), !dbg !172

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !137, metadata !DIExpression()), !dbg !174

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !138, metadata !DIExpression()), !dbg !176

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !139, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !149, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !185

  //   store atomic i32 0, i32* @atom_1_X0_2 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !153, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !156, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !189

  //   store atomic i32 0, i32* @atom_3_X0_1 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   %call12 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !104
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !105
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr1, align 8, !dbg !112, !tbaa !107
  r5 = local_mem[1];
  ...
  //   %6 = load i64, i64* %thr2, align 8, !dbg !114, !tbaa !107
  r6 = local_mem[2];

  //   %call16 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !115
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr3, align 8, !dbg !116, !tbaa !107
  r7 = local_mem[3];

  //   %call17 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !117
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !119
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !162, metadata !DIExpression()), !dbg !205

  //   %conv = trunc i64 %8 to i32, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !163, metadata !DIExpression()), !dbg !170

  //   %9 = load i32, i32* @atom_1_X0_2, align 4, !dbg !122, !tbaa !123
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %10 = load i32, i32* @atom_1_X2_0, align 4, !dbg !125, !tbaa !123
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_3_X0_1, align 4, !dbg !126, !tbaa !123
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %and19 = and i32 %9, %and, !dbg !128
  creg_r13 = max(creg_r12,creg_r9);
  r13 = r9 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !168, metadata !DIExpression()), !dbg !170

  //   %and20 = and i32 %conv18, %and19, !dbg !129
  creg_r14 = max(creg__r8__2_,creg_r13);
  r14 = (r8==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !169, metadata !DIExpression()), !dbg !170
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 84, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !133
