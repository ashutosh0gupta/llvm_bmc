...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !59), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !51, metadata !DIExpression()), !dbg !79

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(1,0+2*1);
  cr(1,0+2*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l26_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !53, metadata !DIExpression()), !dbg !79
