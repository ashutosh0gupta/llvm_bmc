...
T2BLOCK7:
  ...
  //   %cmp17 = icmp eq i32 %conv4, 2, !dbg !96
  ...
  //   store i32 %conv18, i32* @atom_1_X2_2, align 4, !dbg !97, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !147, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !148, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !157, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !161, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !164, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !201

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !170, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !171, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !175, metadata !DIExpression()), !dbg !218

  //   %conv20 = trunc i64 %7 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !172, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !176, metadata !DIExpression()), !dbg !184
  ...
  //   %10 = load i32, i32* @atom_1_X5_0, align 4, !dbg !130, !tbaa !127
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !181, metadata !DIExpression()), !dbg !184

  //   %and24 = and i32 %conv22, %and23, !dbg !133
  creg_r15 = max(creg__r9__2_,creg_r14);
  r15 = (r9==2) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !182, metadata !DIExpression()), !dbg !184

  //   %and25 = and i32 %conv16, %and24, !dbg !134
  creg_r16 = max(creg__r8__1_,creg_r15);
  r16 = (r8==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !183, metadata !DIExpression()), !dbg !184
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 84, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
