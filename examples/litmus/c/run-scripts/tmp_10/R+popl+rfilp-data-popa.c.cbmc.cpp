...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !118, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !119, metadata !DIExpression()), !dbg !167

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !120, metadata !DIExpression()), !dbg !169

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !124, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !125, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64 0, metadata !127, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !128, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64 0, metadata !130, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !131, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64 0, metadata !133, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !134, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i32 0, metadata !137, metadata !DIExpression()), !dbg !178

  //   store atomic i32 0, i32* @atom_0_X4_2 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !138, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !140, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !141, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !148, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !149, metadata !DIExpression()), !dbg !167

  //   %cmp19 = icmp eq i32 %conv18, 2, !dbg !125
  creg__r9__2_ = max(0,creg_r9);

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !153, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !154, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !158, metadata !DIExpression()), !dbg !167

  //   %7 = load i32, i32* @atom_0_X4_2, align 4, !dbg !130, !tbaa !131
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X2_2, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X5_0, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !163, metadata !DIExpression()), !dbg !167

  //   %and28 = and i32 %conv26, %and27, !dbg !137
  creg_r16 = max(creg__r10__1_,creg_r15);
  r16 = (r10==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !164, metadata !DIExpression()), !dbg !167
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
