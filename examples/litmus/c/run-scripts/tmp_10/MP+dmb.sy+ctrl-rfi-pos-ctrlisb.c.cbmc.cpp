...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !126

  //   %conv15 = trunc i64 %3 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !76, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 1, !dbg !110

  //   %conv16 = zext i1 %cmp to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !80, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !81, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !85, metadata !DIExpression()), !dbg !133
  ...
  //   %cmp30 = icmp eq i32 %conv15, 0, !dbg !119

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !92, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !93, metadata !DIExpression()), !dbg !139
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !168, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !171, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !229

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !174, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !231

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !197, metadata !DIExpression()), !dbg !258

  //   %8 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !154
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !201, metadata !DIExpression()), !dbg !261

  //   %9 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !205, metadata !DIExpression()), !dbg !264
  ...
  creg_r19 = max(max(creg_r7,0),creg_r18);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !171
