...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !157, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !204

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !160, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !163, metadata !DIExpression()), !dbg !208
  ...
  //   %8 = load i32, i32* @atom_1_X4_1, align 4, !dbg !142, !tbaa !140
  // LD: Guess
  old_cr = cr(0,4);
