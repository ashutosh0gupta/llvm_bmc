...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64 2, metadata !43, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !45, metadata !DIExpression()), !dbg !67
...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !48, metadata !DIExpression()), !dbg !60

  //   %xor = xor i32 %conv6, %conv6, !dbg !79
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !52, metadata !DIExpression()), !dbg !60

  //   %add = add nsw i32 %xor, 1, !dbg !80
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !53, metadata !DIExpression()), !dbg !60
  ...
  //   %conv9 = sext i32 %add to i64, !dbg !82

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !56, metadata !DIExpression()), !dbg !81

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !82
  // ST: Guess
  ...
  //   %conv10 = zext i1 %cmp to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !57, metadata !DIExpression()), !dbg !60

  //   store i32 %conv10, i32* @atom_0_X3_2, align 4, !dbg !84, !tbaa !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_2, metadata !137, metadata !DIExpression()), !dbg !170
