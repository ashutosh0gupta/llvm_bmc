...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !155, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !165, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !169, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !172, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !179, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !184, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !189, metadata !DIExpression()), !dbg !192

  //   %and24 = and i32 %conv22, %and23, !dbg !133
  creg_r18 = max(creg__r12__2_,creg_r17);
  r18 = (r12==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !190, metadata !DIExpression()), !dbg !192

  //   %and25 = and i32 %conv16, %and24, !dbg !134
  creg_r19 = max(creg__r11__2_,creg_r18);
  r19 = (r11==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !191, metadata !DIExpression()), !dbg !192
