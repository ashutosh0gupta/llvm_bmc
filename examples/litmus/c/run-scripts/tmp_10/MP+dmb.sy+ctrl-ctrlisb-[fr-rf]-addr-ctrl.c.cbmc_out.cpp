...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !102), !dbg !108
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !103), !dbg !117
  ...
  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !102

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !104
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK6:
  //   br label %lbl_LC01, !dbg !106
  goto T2BLOCK7;

T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !104), !dbg !126

  //   call void (...) @isb(), !dbg !108
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !70, metadata !DIExpression()), !dbg !128

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !128

  //   %conv11 = trunc i64 %2 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !69, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !131

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(2,0+3*1);
  cr(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   %conv15 = trunc i64 %3 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !73, metadata !DIExpression()), !dbg !106

  //   %xor = xor i32 %conv15, %conv15, !dbg !115
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !77, metadata !DIExpression()), !dbg !106

  //   %add = add nsw i32 4, %xor, !dbg !116
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !116
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ASSUME(creg_r6 >= creg_r5);
  ASSUME(active[creg_r6] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !136

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !136

  //   %conv19 = trunc i64 %4 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !106

  //   %tobool20 = icmp ne i32 %conv19, 0, !dbg !119

  //   br i1 %tobool20, label %if.then21, label %if.else22, !dbg !121
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK8:
  //   br label %lbl_LC02, !dbg !122
  goto T2BLOCK10;

T2BLOCK9:
  //   br label %lbl_LC02, !dbg !123
  goto T2BLOCK10;

T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !105), !dbg !143

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !144

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !126
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !144

  //   %conv26 = trunc i64 %5 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !82, metadata !DIExpression()), !dbg !106

  //   %cmp = icmp eq i32 %conv, 1, !dbg !128

  //   %conv27 = zext i1 %cmp to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !86, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !148

  //   %6 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !148
  ...
  //   %cmp29 = icmp eq i32 %conv11, 0, !dbg !131

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !90, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !91, metadata !DIExpression()), !dbg !151

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %7, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !133
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv15, 1, !dbg !134

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !94, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !95, metadata !DIExpression()), !dbg !154

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %8, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !136
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv26, 0, !dbg !137

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !98, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !99, metadata !DIExpression()), !dbg !157

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !101, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %9, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !139
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !162, metadata !DIExpression()), !dbg !167
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !163, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64 1, metadata !165, metadata !DIExpression()), !dbg !170
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !180, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !181, metadata !DIExpression()), !dbg !252

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !117

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !117

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !182, metadata !DIExpression()), !dbg !254

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !186, metadata !DIExpression()), !dbg !256

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !187, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !188, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !191, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !194, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !200, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !203, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !206, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !271

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !136
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !209, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !212, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !214, metadata !DIExpression()), !dbg !275

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !140
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !216, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !218, metadata !DIExpression()), !dbg !290

  //   %conv = trunc i64 %6 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !215, metadata !DIExpression()), !dbg !252

  //   %cmp = icmp eq i32 %conv, 1, !dbg !157

  //   %conv22 = zext i1 %cmp to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !219, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !221, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !223, metadata !DIExpression()), !dbg !294

  //   %conv26 = trunc i64 %7 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !220, metadata !DIExpression()), !dbg !252

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !161

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !224, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !226, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !228, metadata !DIExpression()), !dbg !298

  //   %conv32 = trunc i64 %8 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !225, metadata !DIExpression()), !dbg !252

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !165

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !229, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !231, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !233, metadata !DIExpression()), !dbg !302

  //   %conv38 = trunc i64 %9 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !230, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !235, metadata !DIExpression()), !dbg !305

  //   %10 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !170
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !237, metadata !DIExpression()), !dbg !305

  //   %conv42 = trunc i64 %10 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !234, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !239, metadata !DIExpression()), !dbg !308

  //   %11 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !173
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !241, metadata !DIExpression()), !dbg !308

  //   %conv46 = trunc i64 %11 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !238, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !243, metadata !DIExpression()), !dbg !311

  //   %12 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !176
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !245, metadata !DIExpression()), !dbg !311

  //   %conv50 = trunc i64 %12 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !242, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !246, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !247, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !248, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !249, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !250, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !251, metadata !DIExpression()), !dbg !252
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 100, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !187
