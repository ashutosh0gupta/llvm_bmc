...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !106

  //   %conv8 = trunc i64 %2 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !109

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   %add15 = add nsw i32 3, %xor13, !dbg !94
  creg_r8 = max(0,creg_r7);
  r8 = 3 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !94

  //   %arrayidx17 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !94
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !82, metadata !DIExpression()), !dbg !114

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,r9);
  cr(2,r9) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l37_c16
  // Check
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !95), !dbg !121
  ...
  //   %cmp26 = icmp eq i32 %conv4, 0, !dbg !112
  ...
  //   store i32 %conv27, i32* @atom_1_X3_0, align 4, !dbg !113, !tbaa !108
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv8, 0, !dbg !114
  ...
  //   store i32 %conv29, i32* @atom_1_X5_0, align 4, !dbg !115, !tbaa !108
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv12, 1, !dbg !116
  ...
  //   store i32 %conv31, i32* @atom_1_X6_1, align 4, !dbg !117, !tbaa !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !184, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !240

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !187, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !190, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !244

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !197, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !202, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !207, metadata !DIExpression()), !dbg !267
  ...
  //   %10 = load i32, i32* @atom_1_X3_0, align 4, !dbg !162, !tbaa !160
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X6_1, align 4, !dbg !164, !tbaa !160
  // LD: Guess
  old_cr = cr(0,7);
