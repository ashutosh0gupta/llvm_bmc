...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !84), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !71, metadata !DIExpression()), !dbg !85
  ...
  //   store i32 %conv22, i32* @atom_1_X5_0, align 4, !dbg !103, !tbaa !98
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv19, 0, !dbg !104
  ...
  //   store i32 %conv24, i32* @atom_1_X7_0, align 4, !dbg !105, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !153, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !156, metadata !DIExpression()), !dbg !191
