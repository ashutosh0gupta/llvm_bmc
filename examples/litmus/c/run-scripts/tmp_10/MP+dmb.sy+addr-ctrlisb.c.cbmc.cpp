...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !88
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !67, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !71, metadata !DIExpression()), !dbg !101

  //   %3 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !73, metadata !DIExpression()), !dbg !101
  ...
  //   %cmp11 = icmp eq i32 %conv8, 0, !dbg !84

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !75, metadata !DIExpression()), !dbg !104

  //   %4 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !77, metadata !DIExpression()), !dbg !104

  //   store atomic i64 %4, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !114, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !115, metadata !DIExpression()), !dbg !157

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !116, metadata !DIExpression()), !dbg !159

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !120, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !121, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !130, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !133, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !139, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !144, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !151, metadata !DIExpression()), !dbg !193
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !128
