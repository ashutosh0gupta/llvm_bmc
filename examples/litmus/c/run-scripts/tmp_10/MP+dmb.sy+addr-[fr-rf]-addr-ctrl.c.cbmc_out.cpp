...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !124
  ...
  //   %cmp23 = icmp eq i32 %conv4, 0, !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !88, metadata !DIExpression()), !dbg !131

  //   %6 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %6, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !92, metadata !DIExpression()), !dbg !134

  //   %7 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %7, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !116
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !183, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !186, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !212, metadata !DIExpression()), !dbg !280
