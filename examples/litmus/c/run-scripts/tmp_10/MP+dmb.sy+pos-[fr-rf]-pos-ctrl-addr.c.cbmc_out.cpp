...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !94), !dbg !115
  ...
  //   %xor = xor i32 %conv16, %conv16, !dbg !100
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !83, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !85, metadata !DIExpression()), !dbg !121

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !87, metadata !DIExpression()), !dbg !121
