...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !60, metadata !DIExpression()), !dbg !83
  ...
  //   %and = and i32 %conv, 128, !dbg !67
  creg_r1 = max(0,creg_r0);
  r1 = r0 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !63, metadata !DIExpression()), !dbg !80

  //   %add = add nsw i32 %and, 1, !dbg !68
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !64, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !65, metadata !DIExpression()), !dbg !88
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !72
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !71, metadata !DIExpression()), !dbg !90

  //   %conv5 = trunc i64 %2 to i32, !dbg !73
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !75
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   %conv9 = trunc i64 %3 to i32, !dbg !76
  ...
  //   store i32 %conv14, i32* @atom_1_X5_0, align 4, !dbg !86, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !130, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !134, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i32 0, metadata !136, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !137, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i32 0, metadata !139, metadata !DIExpression()), !dbg !160

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !140, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !141, metadata !DIExpression()), !dbg !145

  //   %6 = load i32, i32* @atom_1_X5_0, align 4, !dbg !104, !tbaa !101
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !142, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !144, metadata !DIExpression()), !dbg !145
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !110
