...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !80, metadata !DIExpression()), !dbg !100
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !123, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !126, metadata !DIExpression()), !dbg !149
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !130, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !132, metadata !DIExpression()), !dbg !161

  //   %conv = trunc i64 %4 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !129, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !134, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !136, metadata !DIExpression()), !dbg !164

  //   %conv13 = trunc i64 %5 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !133, metadata !DIExpression()), !dbg !138
