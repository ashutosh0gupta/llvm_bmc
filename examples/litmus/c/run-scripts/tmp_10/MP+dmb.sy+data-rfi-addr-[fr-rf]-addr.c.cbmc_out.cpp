...
T2BLOCK1:
  ...
  //   %xor6 = xor i32 %conv5, %conv5, !dbg !90
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !76, metadata !DIExpression()), !dbg !96

  //   %add8 = add nsw i32 3, %xor6, !dbg !91
  creg_r5 = max(0,creg_r4);
  r5 = 3 + r4;

  //   %idxprom = sext i32 %add8 to i64, !dbg !91

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !91
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !80, metadata !DIExpression()), !dbg !111

  //   %conv11 = trunc i64 %2 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !77, metadata !DIExpression()), !dbg !96
  ...
  //   store i32 %conv26, i32* @atom_1_X4_1, align 4, !dbg !108, !tbaa !103
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv11, 0, !dbg !109
  ...
  //   store i32 %conv28, i32* @atom_1_X6_0, align 4, !dbg !110, !tbaa !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !179, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !182, metadata !DIExpression()), !dbg !243
