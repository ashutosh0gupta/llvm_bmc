...
T2BLOCK1:
  ...
  //   %xor16 = xor i32 %conv15, %conv15, !dbg !112
  creg_r9 = max(creg_r8,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !85, metadata !DIExpression()), !dbg !111

  //   %add18 = add nsw i32 0, %xor16, !dbg !113
  creg_r10 = max(0,creg_r9);
  ASSUME(active[creg_r10] == 2);
  r10 = 0 + r9;

  //   %idxprom19 = sext i32 %add18 to i64, !dbg !113

  //   %arrayidx20 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !113
  r11 = 0+r10*1;
  ASSUME(creg_r11 >= 0);
  ASSUME(creg_r11 >= creg_r10);
  ASSUME(active[creg_r11] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !87, metadata !DIExpression()), !dbg !133

  //   %4 = load atomic i64, i64* %arrayidx20 monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(2,r11);
  ...
  //   %conv23 = trunc i64 %4 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !86, metadata !DIExpression()), !dbg !111

  //   %cmp = icmp eq i32 %conv, 1, !dbg !116

  //   %conv24 = zext i1 %cmp to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !90, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !91, metadata !DIExpression()), !dbg !136
  ...
  //   %cmp28 = icmp eq i32 %conv5, 1, !dbg !119

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !94, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !95, metadata !DIExpression()), !dbg !139

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !97, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %6, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv11, 0, !dbg !122

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !98, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !99, metadata !DIExpression()), !dbg !142

  //   %7 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !101, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %7, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !124
  // ST: Guess
  ...
  //   %cmp38 = icmp eq i32 %conv15, 1, !dbg !125

  //   %conv39 = zext i1 %cmp38 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv39, metadata !102, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !103, metadata !DIExpression()), !dbg !145

  //   %8 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !105, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %8, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp43 = icmp eq i32 %conv23, 0, !dbg !128

  //   %conv44 = zext i1 %cmp43 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !106, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !107, metadata !DIExpression()), !dbg !148

  //   %9 = zext i32 %conv44 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !109, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %9, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !171, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !172, metadata !DIExpression()), !dbg !254

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !173, metadata !DIExpression()), !dbg !256

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !177, metadata !DIExpression()), !dbg !258

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !178, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !179, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !182, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !188, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !191, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !194, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !197, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !200, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !203, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !207, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !209, metadata !DIExpression()), !dbg !292

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !206, metadata !DIExpression()), !dbg !254

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !210, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !212, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !214, metadata !DIExpression()), !dbg !296

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !211, metadata !DIExpression()), !dbg !254

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !215, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !217, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !219, metadata !DIExpression()), !dbg !300

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !216, metadata !DIExpression()), !dbg !254

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !220, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !222, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !224, metadata !DIExpression()), !dbg !304

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !221, metadata !DIExpression()), !dbg !254

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !225, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !227, metadata !DIExpression()), !dbg !308
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !229, metadata !DIExpression()), !dbg !308

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !226, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !231, metadata !DIExpression()), !dbg !311
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !233, metadata !DIExpression()), !dbg !311

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !230, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !235, metadata !DIExpression()), !dbg !314
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !237, metadata !DIExpression()), !dbg !314

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !234, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !239, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !241, metadata !DIExpression()), !dbg !317

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !238, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !243, metadata !DIExpression()), !dbg !320
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !245, metadata !DIExpression()), !dbg !320

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !242, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !246, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !247, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !248, metadata !DIExpression()), !dbg !254

  //   %and63 = and i32 %conv44, %and62, !dbg !201
  creg_r29 = max(creg_r21,creg_r28);
  ASSUME(active[creg_r29] == 0);
  r29 = r21 & r28;

  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !249, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !250, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !251, metadata !DIExpression()), !dbg !254

  //   %and66 = and i32 %conv28, %and65, !dbg !204
  creg_r32 = max(max(creg_r18,0),creg_r31);
  ASSUME(active[creg_r32] == 0);
  r32 = (r18==1) & r31;

  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !252, metadata !DIExpression()), !dbg !254

  //   %and67 = and i32 %conv22, %and66, !dbg !205
  creg_r33 = max(max(creg_r17,0),creg_r32);
  ASSUME(active[creg_r33] == 0);
  r33 = (r17==1) & r32;

  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !253, metadata !DIExpression()), !dbg !254
