...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !87, metadata !DIExpression()), !dbg !124

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,r7);
  cr(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l40_c16
  // Check
  ...
  //   %cmp26 = icmp eq i32 %conv12, 0, !dbg !117
  ...
  //   store i32 %conv27, i32* @atom_1_X5_0, align 4, !dbg !118, !tbaa !109
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv16, 1, !dbg !119
  ...
  //   store i32 %conv29, i32* @atom_1_X6_1, align 4, !dbg !120, !tbaa !109
  // ST: Guess
  ...
  //   store i32 %conv31, i32* @atom_1_X8_0, align 4, !dbg !122, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !190, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !193, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !196, metadata !DIExpression()), !dbg !251
