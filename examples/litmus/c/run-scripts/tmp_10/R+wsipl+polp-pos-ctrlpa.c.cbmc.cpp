...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !36, metadata !DIExpression()), !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !45, metadata !DIExpression()), !dbg !60
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !94
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !86, metadata !DIExpression()), !dbg !112
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !135, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64 0, metadata !137, metadata !DIExpression()), !dbg !165

  //   store atomic i64 0, i64* @atom_0_X3_3 monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !138, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !167

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   %call7 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !88
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call8 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !94
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call9 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !96
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !179

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !147, metadata !DIExpression()), !dbg !183

  //   %5 = load atomic i64, i64* @atom_0_X3_3 seq_cst, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %conv14 = trunc i64 %5 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !146, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !151, metadata !DIExpression()), !dbg !186

  //   %6 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !153, metadata !DIExpression()), !dbg !186

  //   %conv18 = trunc i64 %6 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !150, metadata !DIExpression()), !dbg !156

  //   %and = and i32 %conv14, %conv18, !dbg !107
  ...
  //   %and19 = and i32 %conv10, %and, !dbg !108
  creg_r11 = max(max(creg_r7,0),creg_r10);
  ASSUME(active[creg_r11] == 0);
  r11 = (r7==3) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !155, metadata !DIExpression()), !dbg !156

  //   %cmp20 = icmp eq i32 %and19, 1, !dbg !109

  //   br i1 %cmp20, label %if.then, label %if.end, !dbg !111
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 62, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !112

  //   unreachable, !dbg !112
  r12 = 1;

T0BLOCK2:
  //   %7 = bitcast i64* %thr1 to i8*, !dbg !115

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %7) #7, !dbg !115

  //   %8 = bitcast i64* %thr0 to i8*, !dbg !115
