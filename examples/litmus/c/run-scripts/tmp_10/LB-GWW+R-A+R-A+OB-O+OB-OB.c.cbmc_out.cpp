...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !95, metadata !DIExpression()), !dbg !107
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !116, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !119, metadata !DIExpression()), !dbg !131
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !138, metadata !DIExpression()), !dbg !148
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !140, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !142, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !143, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64 1, metadata !145, metadata !DIExpression()), !dbg !155

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !63
  // ST: Guess
  iw(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l62_c3
  old_cw = cw(5,0+5*1);
  cw(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l62_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !146, metadata !DIExpression()), !dbg !148
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !162, metadata !DIExpression()), !dbg !174
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !164, metadata !DIExpression()), !dbg !177

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(6,0+5*1);
  cr(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN LDCOM _l70_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !163, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !181

  //   %1 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(6,0+1*1);
  cr(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN LDCOM _l72_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !170, metadata !DIExpression()), !dbg !181

  //   %conv4 = trunc i64 %1 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !167, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !171, metadata !DIExpression()), !dbg !174

  //   store i32 %conv5, i32* @atom_5_X0_1, align 4, !dbg !68, !tbaa !69
  // ST: Guess
  iw(6,10) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l74_c15
  old_cw = cw(6,10);
  cw(6,10) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l74_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !172, metadata !DIExpression()), !dbg !174
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !196, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !197, metadata !DIExpression()), !dbg !255

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !198, metadata !DIExpression()), !dbg !257

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !202, metadata !DIExpression()), !dbg !259

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !203, metadata !DIExpression()), !dbg !261

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !204, metadata !DIExpression()), !dbg !263

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !205, metadata !DIExpression()), !dbg !265

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !206, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !207, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !210, metadata !DIExpression()), !dbg !270

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !213, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !216, metadata !DIExpression()), !dbg !274

  //   call void @llvm.dbg.value(metadata i64 0, metadata !218, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !219, metadata !DIExpression()), !dbg !276

  //   call void @llvm.dbg.value(metadata i64 0, metadata !221, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !222, metadata !DIExpression()), !dbg !278

  //   call void @llvm.dbg.value(metadata i64 0, metadata !224, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X0_1, metadata !225, metadata !DIExpression()), !dbg !280

  //   call void @llvm.dbg.value(metadata i32 0, metadata !228, metadata !DIExpression()), !dbg !280

  //   store atomic i32 0, i32* @atom_5_X0_1 monotonic, align 4, !dbg !133
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l94_c3
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l94_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X2_0, metadata !229, metadata !DIExpression()), !dbg !282

  //   call void @llvm.dbg.value(metadata i32 0, metadata !231, metadata !DIExpression()), !dbg !282

  //   store atomic i32 0, i32* @atom_5_X2_0 monotonic, align 4, !dbg !135
  // ST: Guess
  iw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l95_c3
  old_cw = cw(0,11);
  cw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l95_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !232, metadata !DIExpression()), !dbg !284

  //   call void @llvm.dbg.value(metadata i32 0, metadata !234, metadata !DIExpression()), !dbg !284

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !137
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l96_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l96_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !235, metadata !DIExpression()), !dbg !286

  //   call void @llvm.dbg.value(metadata i32 0, metadata !237, metadata !DIExpression()), !dbg !286

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !139
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l97_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l97_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !238, metadata !DIExpression()), !dbg !288

  //   call void @llvm.dbg.value(metadata i32 0, metadata !240, metadata !DIExpression()), !dbg !288

  //   store atomic i32 0, i32* @atom_3_X0_1 monotonic, align 4, !dbg !141
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l98_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l98_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X0_1, metadata !241, metadata !DIExpression()), !dbg !290

  //   call void @llvm.dbg.value(metadata i32 0, metadata !243, metadata !DIExpression()), !dbg !290

  //   store atomic i32 0, i32* @atom_4_X0_1 monotonic, align 4, !dbg !143
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l99_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l99_c3
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,10);
  cr(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l115_c13
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,11);
  cr(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l116_c13
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l117_c13
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l118_c13
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l119_c13
  // Check
  ...
  // LD: Guess
  old_cr = cr(0,9);
  cr(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l120_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !249, metadata !DIExpression()), !dbg !255

  //   %and = and i32 %16, %17, !dbg !174
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !250, metadata !DIExpression()), !dbg !255

  //   %and34 = and i32 %15, %and, !dbg !175
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !251, metadata !DIExpression()), !dbg !255

  //   %and35 = and i32 %14, %and34, !dbg !176
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !252, metadata !DIExpression()), !dbg !255

  //   %and36 = and i32 %13, %and35, !dbg !177
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !253, metadata !DIExpression()), !dbg !255

  //   %and37 = and i32 %12, %and36, !dbg !178
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !254, metadata !DIExpression()), !dbg !255
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 126, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
