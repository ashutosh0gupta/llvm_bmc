...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !44, metadata !DIExpression()), !dbg !64
  ...
  //   %cmp9 = icmp eq i32 %conv, 2, !dbg !82
  ...
  //   store i32 %conv10, i32* @atom_0_X2_2, align 4, !dbg !83, !tbaa !78
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !90, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !91, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !99, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !101, metadata !DIExpression()), !dbg !115

  //   %conv6 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !98, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !103, metadata !DIExpression()), !dbg !105
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_2, metadata !143, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_2, metadata !147, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !186

  //   store atomic i32 0, i32* @atom_0_X2_2 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !150, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !188

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !153, metadata !DIExpression()), !dbg !190
  ...
  //   %7 = load i32, i32* @atom_0_X2_2, align 4, !dbg !127, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X5_2, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X4_1, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
