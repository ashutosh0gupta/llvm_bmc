...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !65, metadata !DIExpression()), !dbg !79
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !67, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !69, metadata !DIExpression()), !dbg !82

  //   %conv = trunc i64 %0 to i32, !dbg !56

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !66, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !87

  //   call void @llvm.dbg.value(metadata i64 1, metadata !73, metadata !DIExpression()), !dbg !87
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !99, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !100, metadata !DIExpression()), !dbg !127

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !101, metadata !DIExpression()), !dbg !129

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !71

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !71

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !105, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !106, metadata !DIExpression()), !dbg !132

  //   call void @llvm.dbg.value(metadata i64 0, metadata !108, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !109, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64 0, metadata !111, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !112, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64 0, metadata !114, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !115, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64 0, metadata !117, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !119, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !121, metadata !DIExpression()), !dbg !150

  //   %conv = trunc i64 %4 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !118, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !123, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !125, metadata !DIExpression()), !dbg !153

  //   %conv13 = trunc i64 %5 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !122, metadata !DIExpression()), !dbg !127
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 56, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !101
