...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !96, metadata !DIExpression()), !dbg !110
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !97, metadata !DIExpression()), !dbg !110
...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !101, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 1, metadata !103, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !104, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !105, metadata !DIExpression()), !dbg !126

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !107, metadata !DIExpression()), !dbg !126
