...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !40, metadata !DIExpression()), !dbg !65
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !68

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !69
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !46, metadata !DIExpression()), !dbg !70

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !71
  // LD: Guess
  old_cr = cr(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !48, metadata !DIExpression()), !dbg !70

  //   %conv = trunc i64 %0 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !45, metadata !DIExpression()), !dbg !65

  //   %xor = xor i32 %conv, %conv, !dbg !73
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !49, metadata !DIExpression()), !dbg !65

  //   %add = add nsw i32 1, %xor, !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !51, metadata !DIExpression()), !dbg !75

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !74
  // LD: Guess
  old_cr = cr(1,r3);
  cr(1,r3) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l25_c15
  // Check
  ...
  if(cr(1,r3) < cw(1,r3)) {
    r4 = buff(1,r3);
    ASSUME((!(( (cw(1,r3) < 1) && (1 < crmax(1,r3)) )))||(sforbid(r3,1)> 0));
    ASSUME((!(( (cw(1,r3) < 2) && (2 < crmax(1,r3)) )))||(sforbid(r3,2)> 0));
    ASSUME((!(( (cw(1,r3) < 3) && (3 < crmax(1,r3)) )))||(sforbid(r3,3)> 0));
    ASSUME((!(( (cw(1,r3) < 4) && (4 < crmax(1,r3)) )))||(sforbid(r3,4)> 0));
    ASSUME((!(( (cw(1,r3) < 5) && (5 < crmax(1,r3)) )))||(sforbid(r3,5)> 0));
    ASSUME((!(( (cw(1,r3) < 6) && (6 < crmax(1,r3)) )))||(sforbid(r3,6)> 0));
    ASSUME((!(( (cw(1,r3) < 7) && (7 < crmax(1,r3)) )))||(sforbid(r3,7)> 0));
    ASSUME((!(( (cw(1,r3) < 8) && (8 < crmax(1,r3)) )))||(sforbid(r3,8)> 0));
    ASSUME((!(( (cw(1,r3) < 9) && (9 < crmax(1,r3)) )))||(sforbid(r3,9)> 0));
  } else {
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !50, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !54, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64 1, metadata !56, metadata !DIExpression()), !dbg !77

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !78
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !79

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  if(cr(1,0+1*1) < cw(1,0+1*1)) {
    ...
    r5 = mem(0+1*1,cr(1,0+1*1));
  }
  ASSUME(creturn[1] >= cr(1,0+1*1));

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !60, metadata !DIExpression()), !dbg !79

  //   %conv10 = trunc i64 %2 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !57, metadata !DIExpression()), !dbg !65

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !82
  creg__r5__2_ = max(0,creg_r5);

  //   %conv11 = zext i1 %cmp to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !61, metadata !DIExpression()), !dbg !65

  //   store i32 %conv11, i32* @atom_0_X7_2, align 4, !dbg !83, !tbaa !84
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv, 1, !dbg !88
  creg__r0__1_ = max(0,creg_r0);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !62, metadata !DIExpression()), !dbg !65

  //   store i32 %conv13, i32* @atom_0_X2_1, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 0, !dbg !90
  creg__r4__0_ = max(0,creg_r4);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !63, metadata !DIExpression()), !dbg !65

  //   store i32 %conv15, i32* @atom_0_X4_0, align 4, !dbg !91, !tbaa !84
  // ST: Guess
  iw(1,4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l33_c15
  old_cw = cw(1,4);
  cw(1,4) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l33_c15
  // Check
  ASSUME(active[iw(1,4)] == 1);
  ASSUME(active[cw(1,4)] == 1);
  ASSUME(sforbid(4,cw(1,4))== 0);
  ASSUME(iw(1,4) >= creg__r4__0_);
  ASSUME(iw(1,4) >= 0);
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !96, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64 2, metadata !98, metadata !DIExpression()), !dbg !108

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !55
  // ST: Guess
  //   : Release
  iw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l39_c3
  old_cw = cw(2,0+1*1);
  cw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l39_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !100, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !102, metadata !DIExpression()), !dbg !110

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !99, metadata !DIExpression()), !dbg !105
  ...
  //   store i32 %conv1, i32* @atom_1_X2_0, align 4, !dbg !60, !tbaa !61
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !123, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !124, metadata !DIExpression()), !dbg !168

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !125, metadata !DIExpression()), !dbg !170

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !129, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !130, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64 0, metadata !132, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !133, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 0, metadata !135, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X7_2, metadata !136, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i32 0, metadata !139, metadata !DIExpression()), !dbg !177

  //   store atomic i32 0, i32* @atom_0_X7_2 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !140, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !142, metadata !DIExpression()), !dbg !179

  //   store atomic i32 0, i32* @atom_0_X2_1 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_0, metadata !143, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i32 0, metadata !145, metadata !DIExpression()), !dbg !181

  //   store atomic i32 0, i32* @atom_0_X4_0 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !146, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !183

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !150, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !152, metadata !DIExpression()), !dbg !193

  //   %conv = trunc i64 %4 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !149, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !153, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !155, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !157, metadata !DIExpression()), !dbg !197

  //   %conv18 = trunc i64 %5 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !154, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !158, metadata !DIExpression()), !dbg !168

  //   %6 = load i32, i32* @atom_0_X7_2, align 4, !dbg !124, !tbaa !125
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !159, metadata !DIExpression()), !dbg !168

  //   %7 = load i32, i32* @atom_0_X2_1, align 4, !dbg !127, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !160, metadata !DIExpression()), !dbg !168

  //   %8 = load i32, i32* @atom_0_X4_0, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !161, metadata !DIExpression()), !dbg !168

  //   %9 = load i32, i32* @atom_1_X2_0, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !162, metadata !DIExpression()), !dbg !168

  //   %and = and i32 %8, %9, !dbg !130
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !163, metadata !DIExpression()), !dbg !168

  //   %and21 = and i32 %7, %and, !dbg !131
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !164, metadata !DIExpression()), !dbg !168

  //   %and22 = and i32 %6, %and21, !dbg !132
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !165, metadata !DIExpression()), !dbg !168

  //   %and23 = and i32 %conv20, %and22, !dbg !133
  creg_r19 = max(creg__r11__2_,creg_r18);
  r19 = (r11==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !166, metadata !DIExpression()), !dbg !168
