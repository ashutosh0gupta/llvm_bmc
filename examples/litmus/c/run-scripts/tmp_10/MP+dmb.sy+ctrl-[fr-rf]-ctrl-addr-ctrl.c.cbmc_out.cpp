...
T2BLOCK4:
  ...
  //   %tobool9 = icmp ne i32 %conv8, 0, !dbg !93
  creg__r2__0_ = max(0,creg_r2);

  //   br i1 %tobool9, label %if.then10, label %if.else11, !dbg !95
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !92), !dbg !117

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !118

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !118

  //   %conv15 = trunc i64 %3 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !73, metadata !DIExpression()), !dbg !94

  //   %xor = xor i32 %conv15, %conv15, !dbg !102
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !77, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 4, %xor, !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !123

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,r6);
  cr(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l39_c16
  // Check
  ...
  //   %tobool20 = icmp ne i32 %conv19, 0, !dbg !106
  creg__r7__0_ = max(0,creg_r7);

  //   br i1 %tobool20, label %if.then21, label %if.else22, !dbg !108
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !93), !dbg !130

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !131

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !131

  //   %conv26 = trunc i64 %5 to i32, !dbg !114
  ...
  //   %conv27 = zext i1 %cmp to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !86, metadata !DIExpression()), !dbg !94

  //   store i32 %conv27, i32* @atom_1_X0_1, align 4, !dbg !116, !tbaa !117
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv4, 0, !dbg !121
  creg__r1__0_ = max(0,creg_r1);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !87, metadata !DIExpression()), !dbg !94

  //   store i32 %conv29, i32* @atom_1_X2_0, align 4, !dbg !122, !tbaa !117
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv8, 1, !dbg !123
  creg__r2__1_ = max(0,creg_r2);

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !88, metadata !DIExpression()), !dbg !94

  //   store i32 %conv31, i32* @atom_1_X4_1, align 4, !dbg !124, !tbaa !117
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv26, 0, !dbg !125
  creg__r8__0_ = max(0,creg_r8);

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !89, metadata !DIExpression()), !dbg !94

  //   store i32 %conv33, i32* @atom_1_X10_0, align 4, !dbg !126, !tbaa !117
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !150, metadata !DIExpression()), !dbg !157
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !167, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !168, metadata !DIExpression()), !dbg !228

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !169, metadata !DIExpression()), !dbg !230

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !173, metadata !DIExpression()), !dbg !232

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !174, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !175, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !178, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !181, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !184, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !187, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !190, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !193, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !194, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !196, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !197, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i32 0, metadata !199, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !200, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !202, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !204, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !206, metadata !DIExpression()), !dbg !264

  //   %conv = trunc i64 %6 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !203, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !207, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !209, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !211, metadata !DIExpression()), !dbg !268

  //   %conv26 = trunc i64 %7 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !208, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !212, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !214, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !216, metadata !DIExpression()), !dbg !272

  //   %conv32 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !213, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !217, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !218, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !219, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !220, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !221, metadata !DIExpression()), !dbg !228

  //   %and = and i32 %11, %12, !dbg !161
  creg_r20 = max(creg_r18,creg_r19);
  r20 = r18 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !222, metadata !DIExpression()), !dbg !228

  //   %and35 = and i32 %10, %and, !dbg !162
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !223, metadata !DIExpression()), !dbg !228

  //   %and36 = and i32 %9, %and35, !dbg !163
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !224, metadata !DIExpression()), !dbg !228

  //   %and37 = and i32 %conv34, %and36, !dbg !164
  creg_r23 = max(creg__r15__1_,creg_r22);
  r23 = (r15==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !225, metadata !DIExpression()), !dbg !228

  //   %and38 = and i32 %conv28, %and37, !dbg !165
  creg_r24 = max(creg__r14__1_,creg_r23);
  r24 = (r14==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !226, metadata !DIExpression()), !dbg !228

  //   %and39 = and i32 %conv22, %and38, !dbg !166
  creg_r25 = max(creg__r13__1_,creg_r24);
  r25 = (r13==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !227, metadata !DIExpression()), !dbg !228
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !170
