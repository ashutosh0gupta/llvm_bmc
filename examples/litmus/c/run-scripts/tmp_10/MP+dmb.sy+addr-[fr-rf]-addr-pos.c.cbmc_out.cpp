...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !76, metadata !DIExpression()), !dbg !106

  //   %add11 = add nsw i32 0, %xor9, !dbg !101
  ...
  //   %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !101
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !78, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !121

  //   %conv16 = trunc i64 %3 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !77, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !123
  ...
  //   %cmp28 = icmp eq i32 %conv8, 1, !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !94, metadata !DIExpression()), !dbg !133

  //   %7 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !96, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %7, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv16, 0, !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !98, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !102, metadata !DIExpression()), !dbg !139

  //   %9 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !104, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !185, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !188, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !255

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !140
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !191, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !218, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !222, metadata !DIExpression()), !dbg !293

  //   %12 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !178
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !226, metadata !DIExpression()), !dbg !296
