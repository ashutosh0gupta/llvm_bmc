...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !80, metadata !DIExpression()), !dbg !94
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !81, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64 2, metadata !83, metadata !DIExpression()), !dbg !97

  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !55
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !85, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !87, metadata !DIExpression()), !dbg !99

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !84, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !102

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !60
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !91, metadata !DIExpression()), !dbg !102

  //   %conv4 = trunc i64 %1 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !88, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !92, metadata !DIExpression()), !dbg !94

  //   store i32 %conv5, i32* @atom_1_X4_0, align 4, !dbg !63, !tbaa !64
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_2, metadata !134, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !138, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !181
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
