...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !83), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !72, metadata !DIExpression()), !dbg !103
  ...
  //   store i32 %conv13, i32* @atom_1_X2_2, align 4, !dbg !90, !tbaa !91
  // ST: Guess
  ...
  //   store i32 %conv15, i32* @atom_1_X6_0, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   store i32 %conv17, i32* @atom_1_X8_0, align 4, !dbg !98, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !142, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !146, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !149, metadata !DIExpression()), !dbg !184
  ...
  //   %7 = load i32, i32* @atom_1_X6_0, align 4, !dbg !123, !tbaa !121
  // LD: Guess
  old_cr = cr(0,4);
