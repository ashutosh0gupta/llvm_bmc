...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !72, metadata !DIExpression()), !dbg !112
  ...
  //   store atomic i64 %4, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !100
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv12, 0, !dbg !104

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !87, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !88, metadata !DIExpression()), !dbg !124

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !124
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !150, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !153, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64 0, metadata !155, metadata !DIExpression()), !dbg !198

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !156, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !170, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !174, metadata !DIExpression()), !dbg !223

  //   %7 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !178, metadata !DIExpression()), !dbg !226
