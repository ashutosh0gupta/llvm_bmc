...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !107), !dbg !130
  ...
  //   %cmp31 = icmp eq i32 %conv12, 2, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !99, metadata !DIExpression()), !dbg !145

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %8, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv16, 0, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !103, metadata !DIExpression()), !dbg !148

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %9, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !165, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !168, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !171, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !174, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !177, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !180, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !183, metadata !DIExpression()), !dbg !239
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !129
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !130
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !187, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !189, metadata !DIExpression()), !dbg !251

  //   %conv = trunc i64 %4 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !186, metadata !DIExpression()), !dbg !222

  //   %cmp = icmp eq i32 %conv, 1, !dbg !142

  //   %conv16 = zext i1 %cmp to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !190, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !192, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !194, metadata !DIExpression()), !dbg !255

  //   %conv20 = trunc i64 %5 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !191, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !196, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !203, metadata !DIExpression()), !dbg !262

  //   %conv30 = trunc i64 %7 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !200, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !205, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !207, metadata !DIExpression()), !dbg !265

  //   %conv34 = trunc i64 %8 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !204, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !209, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !211, metadata !DIExpression()), !dbg !268

  //   %conv38 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !208, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !213, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !215, metadata !DIExpression()), !dbg !271

  //   %conv42 = trunc i64 %10 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !212, metadata !DIExpression()), !dbg !222
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !171
