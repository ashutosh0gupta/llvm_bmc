...
T2BLOCK4:
  ...
  //   %cmp28 = icmp eq i32 %conv16, 0, !dbg !117
  ...
  //   store i32 %conv29, i32* @atom_1_X5_0, align 4, !dbg !118, !tbaa !107
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv20, 0, !dbg !119
  ...
  //   store i32 %conv31, i32* @atom_1_X7_0, align 4, !dbg !120, !tbaa !107
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !151
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !182, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !232

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !185, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !234

  //   store atomic i32 0, i32* @atom_1_X4_2 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !188, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !191, metadata !DIExpression()), !dbg !238
  ...
  //   %cmp = icmp eq i32 %conv, 1, !dbg !143
  ...
  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !147
  ...
  //   %10 = load i32, i32* @atom_1_X3_2, align 4, !dbg !152, !tbaa !149
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X4_2, align 4, !dbg !153, !tbaa !149
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X5_0, align 4, !dbg !154, !tbaa !149
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %13 = load i32, i32* @atom_1_X7_0, align 4, !dbg !155, !tbaa !149
  // LD: Guess
  old_cr = cr(0,7);
