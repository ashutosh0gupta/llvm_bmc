...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !75, metadata !DIExpression()), !dbg !92

  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !61
  // ST: Guess
...
T2BLOCK4:
  ...
  //   store i32 %conv7, i32* @atom_1_X5_0, align 4, !dbg !76, !tbaa !77
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !133, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !137, metadata !DIExpression()), !dbg !168
