...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !51, metadata !DIExpression()), !dbg !71
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !56, metadata !DIExpression()), !dbg !74

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !52, metadata !DIExpression()), !dbg !71
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !57, metadata !DIExpression()), !dbg !71

  //   %cmp = icmp eq i32 %conv, 1, !dbg !74

  //   %conv5 = zext i1 %cmp to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !61, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !62, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !65, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !66, metadata !DIExpression()), !dbg !91

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !68, metadata !DIExpression()), !dbg !91

  //   store atomic i64 %3, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !79
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !97, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !101, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !105, metadata !DIExpression()), !dbg !118
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !128, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !129, metadata !DIExpression()), !dbg !165

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !130, metadata !DIExpression()), !dbg !167

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !134, metadata !DIExpression()), !dbg !169

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !135, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !142, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !145, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !178

  //   store atomic i64 0, i64* @atom_1_X2_0 monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !148, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !152, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !154, metadata !DIExpression()), !dbg !195

  //   %conv = trunc i64 %6 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !151, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !156, metadata !DIExpression()), !dbg !198

  //   %7 = load atomic i64, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !158, metadata !DIExpression()), !dbg !198

  //   %conv17 = trunc i64 %7 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !155, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !160, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !162, metadata !DIExpression()), !dbg !201

  //   %conv21 = trunc i64 %8 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !159, metadata !DIExpression()), !dbg !165
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
