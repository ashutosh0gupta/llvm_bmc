...
T2BLOCK1:
  ...
  //   %xor6 = xor i32 %conv5, %conv5, !dbg !87
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !74, metadata !DIExpression()), !dbg !93

  //   %add8 = add nsw i32 3, %xor6, !dbg !88
  creg_r5 = max(0,creg_r4);
  r5 = 3 + r4;

  //   %idxprom = sext i32 %add8 to i64, !dbg !88

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !88
  r6 = 0+r5*1;
  creg_r6 = creg_r5;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !108

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,r6);
  cr(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l36_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !108

  //   %conv11 = trunc i64 %2 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !75, metadata !DIExpression()), !dbg !93

  //   %tobool = icmp ne i32 %conv11, 0, !dbg !91
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !92), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !116

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !116

  //   %conv15 = trunc i64 %3 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !79, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !119

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !86, metadata !DIExpression()), !dbg !119

  //   %conv19 = trunc i64 %4 to i32, !dbg !102
  ...
  //   %conv20 = zext i1 %cmp to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !87, metadata !DIExpression()), !dbg !93

  //   store i32 %conv20, i32* @atom_1_X0_1, align 4, !dbg !104, !tbaa !105
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv5, 2, !dbg !109
  ...
  //   store i32 %conv22, i32* @atom_1_X4_2, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv15, 0, !dbg !111
  ...
  //   store i32 %conv24, i32* @atom_1_X8_0, align 4, !dbg !112, !tbaa !105
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv19, 0, !dbg !113
  ...
  //   store i32 %conv26, i32* @atom_1_X10_0, align 4, !dbg !114, !tbaa !105
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !140, metadata !DIExpression()), !dbg !145
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !179, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !230

  //   store atomic i32 0, i32* @atom_1_X4_2 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !182, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !232

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X4_2, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X8_0, align 4, !dbg !154, !tbaa !151
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 96, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !165
