...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !86, metadata !DIExpression()), !dbg !131
  ...
  //   %conv20 = zext i1 %cmp to i32, !dbg !115
  ...
  //   %cmp24 = icmp eq i32 %conv5, 2, !dbg !118
  ...
  //   store atomic i64 %6, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !120
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv15, 0, !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !96, metadata !DIExpression()), !dbg !141

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !141
  ...
  //   %cmp34 = icmp eq i32 %conv19, 0, !dbg !124

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %8, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !126
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !190, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !253

  //   store atomic i64 0, i64* @atom_1_X4_2 monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !193, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !219, metadata !DIExpression()), !dbg !287

  //   %10 = load atomic i64, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !223, metadata !DIExpression()), !dbg !290
