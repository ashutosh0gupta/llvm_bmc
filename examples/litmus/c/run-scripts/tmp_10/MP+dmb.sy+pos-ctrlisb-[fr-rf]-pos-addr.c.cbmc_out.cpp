...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv16, %conv16, !dbg !122
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !85, metadata !DIExpression()), !dbg !116

  //   %add = add nsw i32 0, %xor, !dbg !123
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add to i64, !dbg !123

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !123
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !87, metadata !DIExpression()), !dbg !143

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !123
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !143
  ...
  //   %cmp23 = icmp eq i32 %conv4, 1, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !95, metadata !DIExpression()), !dbg !149

  //   %7 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !99, metadata !DIExpression()), !dbg !152

  //   %8 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %8, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !107, metadata !DIExpression()), !dbg !158

  //   %10 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !109, metadata !DIExpression()), !dbg !158

  //   store atomic i64 %10, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !140
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !204, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !207, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !213, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !239, metadata !DIExpression()), !dbg !319
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !243, metadata !DIExpression()), !dbg !322
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !251, metadata !DIExpression()), !dbg !328
