...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv16, %conv16, !dbg !104
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !85, metadata !DIExpression()), !dbg !98
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !105
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !87, metadata !DIExpression()), !dbg !125

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,r7);
  cr(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l41_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !125
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !114
  ...
  //   store i32 %conv23, i32* @atom_1_X2_1, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 0, !dbg !116
  ...
  //   store i32 %conv25, i32* @atom_1_X3_0, align 4, !dbg !117, !tbaa !110
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv16, 1, !dbg !120
  ...
  //   store i32 %conv29, i32* @atom_1_X6_1, align 4, !dbg !121, !tbaa !110
  // ST: Guess
  ...
  //   store i32 %conv31, i32* @atom_1_X8_0, align 4, !dbg !123, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !185, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !188, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !194, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !197, metadata !DIExpression()), !dbg !252
