...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !116, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i64 1, metadata !118, metadata !DIExpression()), !dbg !128
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !135, metadata !DIExpression()), !dbg !147
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !137, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !139, metadata !DIExpression()), !dbg !150

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !136, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !141, metadata !DIExpression()), !dbg !154

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(5,0+1*1);
  cr(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l60_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !143, metadata !DIExpression()), !dbg !154

  //   %conv4 = trunc i64 %1 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !140, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !144, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !145, metadata !DIExpression()), !dbg !147

  //   store i32 %conv7, i32* @atom_4_X0_1, align 4, !dbg !72, !tbaa !67
  // ST: Guess
  iw(5,9) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l64_c15
  old_cw = cw(5,9);
  cw(5,9) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l64_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !219

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !221

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !223

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !225

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !177, metadata !DIExpression()), !dbg !227

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !178, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X2_0, metadata !194, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i32 0, metadata !197, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !198, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i32 0, metadata !200, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !201, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i32 0, metadata !203, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !204, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i32 0, metadata !206, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X0_1, metadata !207, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i32 0, metadata !209, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !213, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !214, metadata !DIExpression()), !dbg !219

  //   %and = and i32 %13, %14, !dbg !153
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !215, metadata !DIExpression()), !dbg !219
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 107, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
