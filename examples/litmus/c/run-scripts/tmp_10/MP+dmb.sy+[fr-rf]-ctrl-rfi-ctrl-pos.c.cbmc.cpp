...
T2BLOCK7:
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !120
  ...
  //   store i32 %conv22, i32* @atom_1_X2_2, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv15, 0, !dbg !117
  ...
  //   store i32 %conv26, i32* @atom_1_X6_0, align 4, !dbg !118, !tbaa !109
  // ST: Guess
  ...
  //   store i32 %conv28, i32* @atom_1_X8_0, align 4, !dbg !120, !tbaa !109
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !151
  ...
  // ST: Guess
  iw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l56_c3
  old_cw = cw(3,0+1*1);
  cw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l56_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !182, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !188, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !191, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i32 0, metadata !193, metadata !DIExpression()), !dbg !242

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !128
  // ST: Guess
  ...
  //   %13 = load i32, i32* @atom_1_X8_0, align 4, !dbg !160, !tbaa !155
  // LD: Guess
  old_cr = cr(0,7);
