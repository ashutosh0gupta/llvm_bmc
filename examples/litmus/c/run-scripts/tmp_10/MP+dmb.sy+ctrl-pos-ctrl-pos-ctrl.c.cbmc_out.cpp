...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !80, metadata !DIExpression()), !dbg !123

  //   %conv26 = trunc i64 %5 to i32, !dbg !106
  ...
  //   %conv27 = zext i1 %cmp to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !81, metadata !DIExpression()), !dbg !87

  //   store i32 %conv27, i32* @atom_1_X0_1, align 4, !dbg !108, !tbaa !109
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv26, 0, !dbg !113
  ...
  //   store i32 %conv29, i32* @atom_1_X8_0, align 4, !dbg !114, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !149, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !152, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !155, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !158, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !161, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i32 0, metadata !164, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !165, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i32 0, metadata !167, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !171, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !172, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !176, metadata !DIExpression()), !dbg !212

  //   %conv18 = trunc i64 %5 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !173, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !177, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !181, metadata !DIExpression()), !dbg !183

  //   %and22 = and i32 %conv14, %and21, !dbg !122
  creg_r15 = max(creg__r9__1_,creg_r14);
  r15 = (r9==1) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !182, metadata !DIExpression()), !dbg !183
