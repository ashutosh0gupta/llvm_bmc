...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !72, metadata !DIExpression()), !dbg !98
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !91
  r4 = 0+r3*1;
  ASSUME(creg_r4 >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !113
  ...
  //   %conv13 = zext i1 %cmp to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !81, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !82, metadata !DIExpression()), !dbg !117

  //   %4 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %4, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !99
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 2, !dbg !100

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !85, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !86, metadata !DIExpression()), !dbg !120

  //   %5 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !120

  //   store atomic i64 %5, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !89, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !90, metadata !DIExpression()), !dbg !123

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !123

  //   store atomic i64 %6, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !105
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv12, 0, !dbg !106

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !93, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !94, metadata !DIExpression()), !dbg !126

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !96, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !149, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !152, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !155, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !205

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !158, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !207

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !172, metadata !DIExpression()), !dbg !227

  //   %6 = load atomic i64, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !136
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !176, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !180, metadata !DIExpression()), !dbg !233

  //   %8 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !184, metadata !DIExpression()), !dbg !236

  //   %9 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,5);
