...
T2BLOCK1:
  ...
  //   %cmp18 = icmp eq i32 %conv12, 0, !dbg !95
  ...
  //   store i32 %conv19, i32* @atom_1_X7_0, align 4, !dbg !96, !tbaa !87
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !137, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !144, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !147, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_1_X2_2, align 4, !dbg !124, !tbaa !125
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %8 = load i32, i32* @atom_1_X5_0, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X7_0, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
