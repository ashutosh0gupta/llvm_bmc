...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !89), !dbg !103
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !116

  //   %conv15 = trunc i64 %3 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !73, metadata !DIExpression()), !dbg !92

  //   %tobool16 = icmp ne i32 %conv15, 0, !dbg !100
  creg__r3__0_ = max(0,creg_r3);

  //   br i1 %tobool16, label %if.then17, label %if.else18, !dbg !102
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !91), !dbg !124

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !125

  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !125

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv4, 0, !dbg !117
  ...
  //   store i32 %conv25, i32* @atom_1_X2_0, align 4, !dbg !118, !tbaa !113
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv8, 1, !dbg !119
  ...
  //   store i32 %conv27, i32* @atom_1_X4_1, align 4, !dbg !120, !tbaa !113
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv22, 1, !dbg !121
  ...
  //   store i32 %conv29, i32* @atom_1_X9_1, align 4, !dbg !122, !tbaa !113
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !187, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !190, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !193, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !197, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !202, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !207, metadata !DIExpression()), !dbg !263
  ...
  creg_r21 = max(creg__r9__2_,creg_r20);
  r21 = (r9==2) & r20;
