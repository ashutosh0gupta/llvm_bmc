...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !74, metadata !DIExpression()), !dbg !88

  //   %add17 = add nsw i32 %xor16, 1, !dbg !98
  creg_r8 = max(0,creg_r7);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add17, metadata !75, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !118

  //   %conv18 = sext i32 %add17 to i64, !dbg !100

  //   call void @llvm.dbg.value(metadata i64 %conv18, metadata !78, metadata !DIExpression()), !dbg !118

  //   store atomic i64 %conv18, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   %conv22 = trunc i64 %4 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !79, metadata !DIExpression()), !dbg !88

  //   %cmp = icmp eq i32 %conv, 1, !dbg !104
  creg__r0__1_ = max(0,creg_r0);

  //   %conv23 = zext i1 %cmp to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !83, metadata !DIExpression()), !dbg !88

  //   store i32 %conv23, i32* @atom_1_X0_1, align 4, !dbg !105, !tbaa !106
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv22, 1, !dbg !110
  creg__r9__1_ = max(0,creg_r9);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !84, metadata !DIExpression()), !dbg !88

  //   store i32 %conv25, i32* @atom_1_X11_1, align 4, !dbg !111, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_1, metadata !165, metadata !DIExpression()), !dbg !200
