...
T4BLOCK1:
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !59
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0);
  cr(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l46_c15
  // Check
  ...
  //   store i32 %conv5, i32* @atom_3_X0_1, align 4, !dbg !62, !tbaa !63
  // ST: Guess
  ...
  //   store i32 %conv7, i32* @atom_3_X2_0, align 4, !dbg !68, !tbaa !63
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !154, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !206
