...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !109
  ...
  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !93, !tbaa !94
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 2, !dbg !98
  ...
  //   store i32 %conv15, i32* @atom_1_X2_2, align 4, !dbg !99, !tbaa !94
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 1, !dbg !100
  ...
  //   store i32 %conv17, i32* @atom_1_X5_1, align 4, !dbg !101, !tbaa !94
  // ST: Guess
  ...
  //   store i32 %conv19, i32* @atom_1_X7_0, align 4, !dbg !103, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !171, metadata !DIExpression()), !dbg !218
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
