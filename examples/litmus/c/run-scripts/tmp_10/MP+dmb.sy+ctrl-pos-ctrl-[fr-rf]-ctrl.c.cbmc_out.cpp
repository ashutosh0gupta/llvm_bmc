...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !101), !dbg !107
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !102), !dbg !116
  ...
  //   %tobool9 = icmp ne i32 %conv8, 0, !dbg !104

  //   br i1 %tobool9, label %if.then10, label %if.else11, !dbg !106
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !129

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !73, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !78, metadata !DIExpression()), !dbg !132

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(2,0+3*1);
  cr(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !77, metadata !DIExpression()), !dbg !105

  //   %tobool20 = icmp ne i32 %conv19, 0, !dbg !116

  //   br i1 %tobool20, label %if.then21, label %if.else22, !dbg !118
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK9:
  //   br label %lbl_LC02, !dbg !120
  goto T2BLOCK10;

T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !104), !dbg !140

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !141

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !123
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !141

  //   %conv26 = trunc i64 %5 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !81, metadata !DIExpression()), !dbg !105

  //   %cmp = icmp eq i32 %conv, 1, !dbg !125

  //   %conv27 = zext i1 %cmp to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !85, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !86, metadata !DIExpression()), !dbg !145

  //   %6 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !88, metadata !DIExpression()), !dbg !145
  ...
  //   %cmp29 = icmp eq i32 %conv15, 0, !dbg !128

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !89, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !90, metadata !DIExpression()), !dbg !148

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !148
  ...
  //   %cmp34 = icmp eq i32 %conv19, 1, !dbg !131

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !93, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !94, metadata !DIExpression()), !dbg !151

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !151
  ...
  //   %cmp39 = icmp eq i32 %conv26, 0, !dbg !134

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !97, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !98, metadata !DIExpression()), !dbg !154

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !100, metadata !DIExpression()), !dbg !154
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !177, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !178, metadata !DIExpression()), !dbg !246

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !179, metadata !DIExpression()), !dbg !248

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !183, metadata !DIExpression()), !dbg !250

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !184, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !185, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !197, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !200, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !203, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !265

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !206, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !210, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !212, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !213, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !215, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !217, metadata !DIExpression()), !dbg !286

  //   %conv24 = trunc i64 %7 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !214, metadata !DIExpression()), !dbg !246

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !156

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !218, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !220, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !222, metadata !DIExpression()), !dbg !290

  //   %conv30 = trunc i64 %8 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !219, metadata !DIExpression()), !dbg !246

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !160

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !223, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !225, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !227, metadata !DIExpression()), !dbg !294

  //   %conv36 = trunc i64 %9 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !224, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !229, metadata !DIExpression()), !dbg !297

  //   %10 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !231, metadata !DIExpression()), !dbg !297

  //   %conv40 = trunc i64 %10 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !228, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !233, metadata !DIExpression()), !dbg !300

  //   %11 = load atomic i64, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !168
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !235, metadata !DIExpression()), !dbg !300

  //   %conv44 = trunc i64 %11 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !232, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !237, metadata !DIExpression()), !dbg !303
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !239, metadata !DIExpression()), !dbg !303

  //   %conv48 = trunc i64 %12 to i32, !dbg !172

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !236, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !241, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and50, metadata !242, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and51, metadata !243, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and52, metadata !244, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !245, metadata !DIExpression()), !dbg !246
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 97, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
