...
T2BLOCK4:
  ...
  //   %cmp20 = icmp eq i32 %conv5, 1, !dbg !109
  ...
  //   store i32 %conv21, i32* @atom_1_X4_1, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv14, 2, !dbg !111
  ...
  //   store i32 %conv23, i32* @atom_1_X7_2, align 4, !dbg !112, !tbaa !105
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !138, metadata !DIExpression()), !dbg !145
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !179, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !236

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_2, metadata !182, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !238

  //   store atomic i32 0, i32* @atom_1_X7_2 monotonic, align 4, !dbg !128
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv36, 1, !dbg !159
  ...
  //   %11 = load i32, i32* @atom_1_X4_1, align 4, !dbg !163, !tbaa !161
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X7_2, align 4, !dbg !164, !tbaa !161
  // LD: Guess
  old_cr = cr(0,6);
