...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !109, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !110, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !115, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !116, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !120, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !122, metadata !DIExpression()), !dbg !161

  //   %conv = trunc i64 %6 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !119, metadata !DIExpression()), !dbg !135

  //   %cmp = icmp eq i32 %conv, 2, !dbg !100

  //   %conv10 = zext i1 %cmp to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !123, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !125, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !127, metadata !DIExpression()), !dbg !165

  //   %conv14 = trunc i64 %7 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !124, metadata !DIExpression()), !dbg !135

  //   %cmp15 = icmp eq i32 %conv14, 2, !dbg !104

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !128, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !130, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !132, metadata !DIExpression()), !dbg !169

  //   %conv20 = trunc i64 %8 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !129, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !134, metadata !DIExpression()), !dbg !135
