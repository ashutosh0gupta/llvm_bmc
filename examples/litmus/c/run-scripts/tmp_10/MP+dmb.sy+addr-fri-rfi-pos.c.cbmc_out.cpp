...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !67, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !96
  ...
  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !86, !tbaa !87
  // ST: Guess
  ...
  //   store i32 %conv15, i32* @atom_1_X3_0, align 4, !dbg !92, !tbaa !87
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !137, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !141, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !180

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X3_0, align 4, !dbg !127, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
