...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !101

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !64, metadata !DIExpression()), !dbg !101

  //   %conv = trunc i64 %0 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !60, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64 1, metadata !72, metadata !DIExpression()), !dbg !108

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !110

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !82, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !86, metadata !DIExpression()), !dbg !120

  //   %5 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !120

  //   store atomic i64 %5, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !149, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !152, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !203

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !155, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !158, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !176, metadata !DIExpression()), !dbg !230

  //   %7 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !139
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !180, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !184, metadata !DIExpression()), !dbg !236
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
