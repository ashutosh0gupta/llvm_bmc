...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !109, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64 1, metadata !111, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !113, metadata !DIExpression()), !dbg !134

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !115, metadata !DIExpression()), !dbg !134
