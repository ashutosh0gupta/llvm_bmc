...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !67, metadata !DIExpression()), !dbg !105
  ...
  //   store i32 %conv18, i32* @atom_1_X6_1, align 4, !dbg !101, !tbaa !96
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !147, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !151, metadata !DIExpression()), !dbg !187
  ...
  //   %7 = load i32, i32* @atom_1_X6_1, align 4, !dbg !123, !tbaa !121
  // LD: Guess
  old_cr = cr(0,4);
