...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !45, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !50, metadata !DIExpression()), !dbg !70

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !71
  // ST: Guess
  //   : Release
  iw(1,0+2*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_3, metadata !56, metadata !DIExpression()), !dbg !76

  //   %2 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !58, metadata !DIExpression()), !dbg !76

  //   store atomic i64 %2, i64* @atom_0_X7_3 seq_cst, align 8, !dbg !77
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !84, metadata !DIExpression()), !dbg !97
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_3, metadata !129, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_3, metadata !146, metadata !DIExpression()), !dbg !189
