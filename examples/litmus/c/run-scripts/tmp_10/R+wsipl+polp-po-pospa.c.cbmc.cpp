...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !94

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !96
  ...
  //   store i32 %conv7, i32* @atom_1_X4_0, align 4, !dbg !71, !tbaa !72
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !131, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !165

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X4_0, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
