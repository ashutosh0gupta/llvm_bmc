...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !60
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !47, metadata !DIExpression()), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !51, metadata !DIExpression()), !dbg !66

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !53, metadata !DIExpression()), !dbg !66

  //   store atomic i64 %1, i64* @atom_0_X3_3 seq_cst, align 8, !dbg !67
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64 3, metadata !74, metadata !DIExpression()), !dbg !98

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !67
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !105

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !74
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !122, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !123, metadata !DIExpression()), !dbg !170

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !124, metadata !DIExpression()), !dbg !172

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !128, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !129, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !132, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !135, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64 0, metadata !137, metadata !DIExpression()), !dbg !179

  //   store atomic i64 0, i64* @atom_0_X3_3 monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !138, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !141, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !183

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !145, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !147, metadata !DIExpression()), !dbg !195

  //   %conv = trunc i64 %4 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !144, metadata !DIExpression()), !dbg !170

  //   %cmp = icmp eq i32 %conv, 3, !dbg !118

  //   %conv12 = zext i1 %cmp to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !148, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !152, metadata !DIExpression()), !dbg !199

  //   %conv16 = trunc i64 %5 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !149, metadata !DIExpression()), !dbg !170

  //   %cmp17 = icmp eq i32 %conv16, 1, !dbg !122

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !153, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_3, metadata !155, metadata !DIExpression()), !dbg !203

  //   %6 = load atomic i64, i64* @atom_0_X3_3 seq_cst, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !157, metadata !DIExpression()), !dbg !203

  //   %conv22 = trunc i64 %6 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !154, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !159, metadata !DIExpression()), !dbg !206

  //   %7 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !127
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !161, metadata !DIExpression()), !dbg !206

  //   %conv26 = trunc i64 %7 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !158, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !163, metadata !DIExpression()), !dbg !209

  //   %8 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !130
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !165, metadata !DIExpression()), !dbg !209

  //   %conv30 = trunc i64 %8 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !162, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !167, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !168, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !169, metadata !DIExpression()), !dbg !170
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !139
