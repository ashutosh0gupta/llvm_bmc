...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !61, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64 2, metadata !63, metadata !DIExpression()), !dbg !90

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !72
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !67, metadata !DIExpression()), !dbg !92

  //   %conv = trunc i64 %0 to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !64, metadata !DIExpression()), !dbg !87
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !85), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !87
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !86), !dbg !113
  ...
  //   store i32 %conv16, i32* @atom_1_X2_2, align 4, !dbg !99, !tbaa !100
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 0, !dbg !104
  ...
  //   store i32 %conv18, i32* @atom_1_X3_0, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv8, 1, !dbg !106
  ...
  //   store i32 %conv20, i32* @atom_1_X5_1, align 4, !dbg !107, !tbaa !100
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 0, !dbg !108
  ...
  //   store i32 %conv22, i32* @atom_1_X6_0, align 4, !dbg !109, !tbaa !100
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !133, metadata !DIExpression()), !dbg !140
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !167, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i32 0, metadata !170, metadata !DIExpression()), !dbg !218

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !171, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !174, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !177, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !224

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X2_2, align 4, !dbg !145, !tbaa !146
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %12 = load i32, i32* @atom_1_X6_0, align 4, !dbg !150, !tbaa !146
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 94, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
