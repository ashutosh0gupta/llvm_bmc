...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !39, metadata !DIExpression()), !dbg !61

  //   call void @llvm.dbg.value(metadata i64 2, metadata !42, metadata !DIExpression()), !dbg !61

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !62
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !47, metadata !DIExpression()), !dbg !58

  //   %add = add nsw i32 %xor, 1, !dbg !67
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !48, metadata !DIExpression()), !dbg !58

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !49, metadata !DIExpression()), !dbg !68

  //   %conv3 = sext i32 %add to i64, !dbg !69

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !51, metadata !DIExpression()), !dbg !68

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !69
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !53, metadata !DIExpression()), !dbg !70

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !71
  // LD: Guess
  old_cr = cr(1,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !55, metadata !DIExpression()), !dbg !70

  //   %conv7 = trunc i64 %1 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !52, metadata !DIExpression()), !dbg !58

  //   %cmp = icmp eq i32 %conv7, 2, !dbg !73
  creg__r3__2_ = max(0,creg_r3);

  //   %conv8 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !56, metadata !DIExpression()), !dbg !58

  //   store i32 %conv8, i32* @atom_0_X6_2, align 4, !dbg !74, !tbaa !75
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !82, metadata !DIExpression()), !dbg !100
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !83, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64 2, metadata !85, metadata !DIExpression()), !dbg !103

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !61
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64 1, metadata !88, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !90, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !92, metadata !DIExpression()), !dbg !107

  //   %conv = trunc i64 %0 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !89, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !94, metadata !DIExpression()), !dbg !110

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !68
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !96, metadata !DIExpression()), !dbg !110

  //   %conv6 = trunc i64 %1 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !93, metadata !DIExpression()), !dbg !100

  //   %cmp = icmp eq i32 %conv6, 2, !dbg !70
  creg__r5__2_ = max(0,creg_r5);

  //   %conv7 = zext i1 %cmp to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !97, metadata !DIExpression()), !dbg !100

  //   store i32 %conv7, i32* @atom_1_X5_2, align 4, !dbg !71, !tbaa !72
  // ST: Guess
  ...
  //   %cmp8 = icmp eq i32 %conv, 1, !dbg !76
  creg__r4__1_ = max(0,creg_r4);

  //   %conv9 = zext i1 %cmp8 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !98, metadata !DIExpression()), !dbg !100

  //   store i32 %conv9, i32* @atom_1_X4_1, align 4, !dbg !77, !tbaa !72
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_2, metadata !141, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !144, metadata !DIExpression()), !dbg !179

  //   store atomic i32 0, i32* @atom_0_X6_2 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !145, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i32 0, metadata !147, metadata !DIExpression()), !dbg !181

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !148, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !183

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !157, metadata !DIExpression()), !dbg !197

  //   %5 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l64_c13
  // Check
  ...
  //   %6 = load i32, i32* @atom_0_X6_2, align 4, !dbg !120, !tbaa !121
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %7 = load i32, i32* @atom_1_X5_2, align 4, !dbg !123, !tbaa !121
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %8 = load i32, i32* @atom_1_X4_1, align 4, !dbg !124, !tbaa !121
  // LD: Guess
  old_cr = cr(0,5);
