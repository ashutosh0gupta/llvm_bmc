...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !82, metadata !DIExpression()), !dbg !131

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !96, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !100, metadata !DIExpression()), !dbg !146
  ...
  //   %cmp36 = icmp eq i32 %conv16, 1, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !104, metadata !DIExpression()), !dbg !149

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !106, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %9, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !131
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !198, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !201, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !232, metadata !DIExpression()), !dbg !303
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !236, metadata !DIExpression()), !dbg !306
