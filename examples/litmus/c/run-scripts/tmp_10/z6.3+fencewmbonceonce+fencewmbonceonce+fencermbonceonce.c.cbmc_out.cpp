...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !50
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !74, metadata !DIExpression()), !dbg !93
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !80, metadata !DIExpression()), !dbg !93

  //   %cmp = icmp eq i32 %conv, 1, !dbg !65

  //   %conv5 = zext i1 %cmp to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !84, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !85, metadata !DIExpression()), !dbg !104

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !87, metadata !DIExpression()), !dbg !104

  //   store atomic i64 %2, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !88, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !89, metadata !DIExpression()), !dbg !107

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !91, metadata !DIExpression()), !dbg !107

  //   store atomic i64 %3, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !70
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !124, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !134, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !137, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !143, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !144, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !146, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !148, metadata !DIExpression()), !dbg !189

  //   %conv18 = trunc i64 %7 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !145, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !150, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !152, metadata !DIExpression()), !dbg !192

  //   %conv22 = trunc i64 %8 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !149, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !154, metadata !DIExpression()), !dbg !155
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([140 x i8], [140 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !123
