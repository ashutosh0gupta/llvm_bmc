...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !81), !dbg !85
  ...
  //   %tobool = icmp ne i32 %conv8, 0, !dbg !76
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !82), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !102

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !102

  //   %conv12 = trunc i64 %3 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !73, metadata !DIExpression()), !dbg !83

  //   %cmp = icmp eq i32 %conv, 1, !dbg !86
  creg__r0__1_ = max(0,creg_r0);

  //   %conv13 = zext i1 %cmp to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !77, metadata !DIExpression()), !dbg !83

  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 1, !dbg !92
  creg__r1__1_ = max(0,creg_r1);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !78, metadata !DIExpression()), !dbg !83

  //   store i32 %conv15, i32* @atom_1_X2_1, align 4, !dbg !93, !tbaa !88
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 2, !dbg !94
  creg__r2__2_ = max(0,creg_r2);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !79, metadata !DIExpression()), !dbg !83

  //   store i32 %conv17, i32* @atom_1_X3_2, align 4, !dbg !95, !tbaa !88
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv12, 0, !dbg !96
  creg__r3__0_ = max(0,creg_r3);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !80, metadata !DIExpression()), !dbg !83

  //   store i32 %conv19, i32* @atom_1_X4_0, align 4, !dbg !97, !tbaa !88
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !120, metadata !DIExpression()), !dbg !125

  //   br label %label_3, !dbg !47
  goto T3BLOCK1;

T3BLOCK1:
  //   call void @llvm.dbg.label(metadata !124), !dbg !127

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !121, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i64 2, metadata !123, metadata !DIExpression()), !dbg !128
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !138, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !139, metadata !DIExpression()), !dbg !184

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !140, metadata !DIExpression()), !dbg !186

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !144, metadata !DIExpression()), !dbg !188

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !145, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !149, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64 0, metadata !151, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !152, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !156, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !159, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !162, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !164, metadata !DIExpression()), !dbg !201

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !166, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !168, metadata !DIExpression()), !dbg !214

  //   %conv = trunc i64 %6 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !165, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !169, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !171, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !173, metadata !DIExpression()), !dbg !218

  //   %conv20 = trunc i64 %7 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !170, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !174, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !175, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !176, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !177, metadata !DIExpression()), !dbg !184

  //   %11 = load i32, i32* @atom_1_X4_0, align 4, !dbg !135, !tbaa !131
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !178, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !180, metadata !DIExpression()), !dbg !184

  //   %and24 = and i32 %8, %and23, !dbg !138
  creg_r16 = max(creg_r10,creg_r15);
  r16 = r10 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !181, metadata !DIExpression()), !dbg !184

  //   %and25 = and i32 %conv22, %and24, !dbg !139
  creg_r17 = max(creg__r9__2_,creg_r16);
  r17 = (r9==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !182, metadata !DIExpression()), !dbg !184

  //   %and26 = and i32 %conv16, %and25, !dbg !140
  creg_r18 = max(creg__r8__1_,creg_r17);
  r18 = (r8==1) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !183, metadata !DIExpression()), !dbg !184
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 87, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !144
