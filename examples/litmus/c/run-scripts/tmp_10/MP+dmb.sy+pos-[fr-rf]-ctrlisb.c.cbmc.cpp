...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !69, metadata !DIExpression()), !dbg !95
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !73, metadata !DIExpression()), !dbg !95

  //   %cmp = icmp eq i32 %conv, 1, !dbg !98

  //   %conv13 = zext i1 %cmp to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !77, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !78, metadata !DIExpression()), !dbg !118

  //   %4 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !118

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !100
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv4, 1, !dbg !101

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !81, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !82, metadata !DIExpression()), !dbg !121

  //   %5 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !121

  //   store atomic i64 %5, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !86, metadata !DIExpression()), !dbg !124

  //   %6 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !88, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %6, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv12, 0, !dbg !107

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !89, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !90, metadata !DIExpression()), !dbg !127

  //   %7 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %7, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !157, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !161, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !167, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !170, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !173, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !224

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !179, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !180, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !182, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !184, metadata !DIExpression()), !dbg !243

  //   %conv20 = trunc i64 %7 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !181, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !189, metadata !DIExpression()), !dbg !247

  //   %conv26 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !186, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !191, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !193, metadata !DIExpression()), !dbg !250

  //   %conv30 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !190, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !195, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !197, metadata !DIExpression()), !dbg !253

  //   %conv34 = trunc i64 %10 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !194, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !199, metadata !DIExpression()), !dbg !256

  //   %11 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !201, metadata !DIExpression()), !dbg !256

  //   %conv38 = trunc i64 %11 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !198, metadata !DIExpression()), !dbg !207
