...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !76, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !108

  //   %conv9 = sext i32 %add to i64, !dbg !90

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !79, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !83, metadata !DIExpression()), !dbg !110

  //   %conv13 = trunc i64 %3 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !80, metadata !DIExpression()), !dbg !94
  ...
  //   %cmp23 = icmp eq i32 %conv13, 1, !dbg !107
  ...
  //   store i32 %conv24, i32* @atom_1_X6_1, align 4, !dbg !108, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !175, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !219

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X6_1, align 4, !dbg !144, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
