...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !46, metadata !DIExpression()), !dbg !62

  //   %conv1 = sext i32 %add to i64, !dbg !63

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !48, metadata !DIExpression()), !dbg !62

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !50, metadata !DIExpression()), !dbg !65
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !70, metadata !DIExpression()), !dbg !97
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !74, metadata !DIExpression()), !dbg !100

  //   %conv = trunc i64 %0 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !71, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !75, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !83, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !84, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !87, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !81
  // ST: Guess
  ...
  //   %conv10 = zext i1 %cmp to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !88, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !89, metadata !DIExpression()), !dbg !114

  //   %2 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !91, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %2, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !84
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 1, !dbg !85

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !92, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !93, metadata !DIExpression()), !dbg !117

  //   %3 = zext i32 %conv15 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !95, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %3, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !87
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !143, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !195

  //   store atomic i64 0, i64* @atom_0_X0_1 monotonic, align 8, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !146, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !149, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !161, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !163, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !165, metadata !DIExpression()), !dbg !219

  //   %conv24 = trunc i64 %6 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !162, metadata !DIExpression()), !dbg !184

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !137

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !166, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !168, metadata !DIExpression()), !dbg !223

  //   %7 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !139
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !170, metadata !DIExpression()), !dbg !223

  //   %conv30 = trunc i64 %7 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !167, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !174, metadata !DIExpression()), !dbg !226

  //   %conv34 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !171, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !176, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !178, metadata !DIExpression()), !dbg !229

  //   %conv38 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !175, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !180, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !181, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !182, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !183, metadata !DIExpression()), !dbg !184
