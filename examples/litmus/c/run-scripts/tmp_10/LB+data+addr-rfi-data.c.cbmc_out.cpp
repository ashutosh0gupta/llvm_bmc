...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !99

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !80, metadata !DIExpression()), !dbg !100

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !70
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !82, metadata !DIExpression()), !dbg !100

  //   %conv4 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !79, metadata !DIExpression()), !dbg !91

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !72
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !83, metadata !DIExpression()), !dbg !91

  //   %add6 = add nsw i32 %xor5, 1, !dbg !73
  creg_r9 = max(0,creg_r8);
  r9 = r8 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !84, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !105

  //   %conv9 = sext i32 %add6 to i64, !dbg !75

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !87, metadata !DIExpression()), !dbg !105

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !88, metadata !DIExpression()), !dbg !91

  //   store i32 %conv10, i32* @atom_1_X0_1, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  ...
  //   %cmp11 = icmp eq i32 %conv4, 1, !dbg !82
  creg__r7__1_ = max(0,creg_r7);

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !89, metadata !DIExpression()), !dbg !91

  //   store i32 %conv12, i32* @atom_1_X5_1, align 4, !dbg !83, !tbaa !78
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !119, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !120, metadata !DIExpression()), !dbg !168

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !121, metadata !DIExpression()), !dbg !170

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !125, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !126, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64 0, metadata !128, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !129, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 0, metadata !131, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !132, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64 0, metadata !134, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !135, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !139, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i32 0, metadata !141, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !142, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i32 0, metadata !144, metadata !DIExpression()), !dbg !183

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !148, metadata !DIExpression()), !dbg !193

  //   %conv = trunc i64 %4 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !145, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !149, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !153, metadata !DIExpression()), !dbg !197

  //   %conv18 = trunc i64 %5 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !150, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !154, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !201

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !127
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l67_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !158, metadata !DIExpression()), !dbg !201

  //   %conv24 = trunc i64 %6 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !155, metadata !DIExpression()), !dbg !168

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !129
  creg__r15__1_ = max(0,creg_r15);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !159, metadata !DIExpression()), !dbg !168

  //   %7 = load i32, i32* @atom_0_X0_1, align 4, !dbg !130, !tbaa !131
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X5_1, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !164, metadata !DIExpression()), !dbg !168

  //   %and28 = and i32 %conv26, %and27, !dbg !137
  creg_r21 = max(creg__r15__1_,creg_r20);
  r21 = (r15==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !165, metadata !DIExpression()), !dbg !168
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
