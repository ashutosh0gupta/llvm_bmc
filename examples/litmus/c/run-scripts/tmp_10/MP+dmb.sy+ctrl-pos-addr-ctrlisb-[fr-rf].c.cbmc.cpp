...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !76, metadata !DIExpression()), !dbg !90
  ...
  //   store i32 %conv26, i32* @atom_1_X8_0, align 4, !dbg !113, !tbaa !108
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv23, 1, !dbg !114
  ...
  //   store i32 %conv28, i32* @atom_1_X10_1, align 4, !dbg !115, !tbaa !108
  // ST: Guess
  iw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l46_c16
  old_cw = cw(2,6);
  cw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l46_c16
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !180, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !220

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !183, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !222

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X8_0, align 4, !dbg !134, !tbaa !132
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X10_1, align 4, !dbg !135, !tbaa !132
  // LD: Guess
  old_cr = cr(0,6);
