...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !75, metadata !DIExpression()), !dbg !88

  //   %add10 = add nsw i32 %xor9, 1, !dbg !85
  creg_r7 = max(0,creg_r6);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !76, metadata !DIExpression()), !dbg !88
  ...
  //   %conv13 = sext i32 %add10 to i64, !dbg !87

  //   call void @llvm.dbg.value(metadata i64 %conv13, metadata !79, metadata !DIExpression()), !dbg !105

  //   store atomic i64 %conv13, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   %conv17 = trunc i64 %3 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !80, metadata !DIExpression()), !dbg !88

  //   %cmp = icmp eq i32 %conv, 1, !dbg !91
  creg__r0__1_ = max(0,creg_r0);

  //   %conv18 = zext i1 %cmp to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !84, metadata !DIExpression()), !dbg !88

  //   store i32 %conv18, i32* @atom_1_X0_1, align 4, !dbg !92, !tbaa !93
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv4, 2, !dbg !97
  ...
  //   store i32 %conv20, i32* @atom_1_X3_2, align 4, !dbg !98, !tbaa !93
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv17, 1, !dbg !99
  ...
  //   store i32 %conv22, i32* @atom_1_X9_1, align 4, !dbg !100, !tbaa !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !151, metadata !DIExpression()), !dbg !186
