...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !84
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !96, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !97, metadata !DIExpression()), !dbg !119

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !98, metadata !DIExpression()), !dbg !121

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !102, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !103, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !106, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64 0, metadata !108, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !109, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i32 0, metadata !112, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !113, metadata !DIExpression()), !dbg !130

  //   call void @llvm.dbg.value(metadata i32 0, metadata !115, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !116, metadata !DIExpression()), !dbg !119

  //   %5 = load i32, i32* @atom_1_X0_1, align 4, !dbg !89, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l54_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !117, metadata !DIExpression()), !dbg !119

  //   %and = and i32 %4, %5, !dbg !90
  creg_r9 = max(creg_r7,creg_r8);
  r9 = r7 & r8;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !118, metadata !DIExpression()), !dbg !119
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 56, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
