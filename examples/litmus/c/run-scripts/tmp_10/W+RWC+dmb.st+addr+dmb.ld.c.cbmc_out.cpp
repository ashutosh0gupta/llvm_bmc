...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !57, metadata !DIExpression()), !dbg !77
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !62, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !63, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !65, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !69, metadata !DIExpression()), !dbg !88

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !71, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !73, metadata !DIExpression()), !dbg !91
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !146, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !149, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64 0, metadata !151, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !152, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !160, metadata !DIExpression()), !dbg !204

  //   %7 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !162, metadata !DIExpression()), !dbg !204

  //   %conv19 = trunc i64 %7 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !159, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !164, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !166, metadata !DIExpression()), !dbg !207

  //   %conv23 = trunc i64 %8 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !163, metadata !DIExpression()), !dbg !169
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
