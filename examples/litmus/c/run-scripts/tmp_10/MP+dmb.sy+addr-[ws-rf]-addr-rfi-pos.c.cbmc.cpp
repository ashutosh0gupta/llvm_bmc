...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !168, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i32 0, metadata !170, metadata !DIExpression()), !dbg !216

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X9_1, align 4, !dbg !149, !tbaa !146
  // LD: Guess
  old_cr = cr(0,5);
