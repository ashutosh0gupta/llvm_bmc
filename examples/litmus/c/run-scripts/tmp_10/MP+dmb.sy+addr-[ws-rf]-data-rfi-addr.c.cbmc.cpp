...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !66, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64 1, metadata !68, metadata !DIExpression()), !dbg !112

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !113

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !69, metadata !DIExpression()), !dbg !104

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !97
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !73, metadata !DIExpression()), !dbg !104

  //   %add6 = add nsw i32 %xor5, 1, !dbg !98
  creg_r6 = max(creg_r5,0);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !74, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !118

  //   %conv9 = sext i32 %add6 to i64, !dbg !100

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !77, metadata !DIExpression()), !dbg !118

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv4, 2, !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !92, metadata !DIExpression()), !dbg !131

  //   %5 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !94, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %5, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !113
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !183, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !217, metadata !DIExpression()), !dbg !290
