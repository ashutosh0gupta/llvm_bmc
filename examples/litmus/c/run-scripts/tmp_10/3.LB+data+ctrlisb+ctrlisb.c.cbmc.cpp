...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !70, metadata !DIExpression()), !dbg !81
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !74, metadata !DIExpression()), !dbg !84

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !71, metadata !DIExpression()), !dbg !81
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !80), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !78, metadata !DIExpression()), !dbg !81
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !101, metadata !DIExpression()), !dbg !112

  //   br label %label_3, !dbg !51
  goto T3BLOCK1;

T3BLOCK1:
  //   call void @llvm.dbg.label(metadata !110), !dbg !114
  ...
  // LD: Guess
  old_cr = cr(3,0+2*1);
  cr(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l44_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !105, metadata !DIExpression()), !dbg !115
...
T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !111), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !106, metadata !DIExpression()), !dbg !125

  //   call void @llvm.dbg.value(metadata i64 1, metadata !108, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !109, metadata !DIExpression()), !dbg !112

  //   store i32 %conv1, i32* @atom_2_X0_1, align 4, !dbg !66, !tbaa !67
  // ST: Guess
  iw(3,5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l50_c15
  old_cw = cw(3,5);
  cw(3,5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l50_c15
  // Check
  ASSUME(active[iw(3,5)] == 3);
  ASSUME(active[cw(3,5)] == 3);
  ASSUME(sforbid(5,cw(3,5))== 0);
  ASSUME(iw(3,5) >= creg__r4__1_);
  ASSUME(iw(3,5) >= 0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !145, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !151, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !154, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !158, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !161, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !166, metadata !DIExpression()), !dbg !169

  //   %and = and i32 %7, %8, !dbg !111
  creg_r12 = max(creg_r10,creg_r11);
  r12 = r10 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !167, metadata !DIExpression()), !dbg !169
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
