...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !38, metadata !DIExpression()), !dbg !49
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !52
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !60, metadata !DIExpression()), !dbg !93
  ...
  //   %and = and i32 %conv, 128, !dbg !77
  creg_r1 = max(creg_r0,0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !63, metadata !DIExpression()), !dbg !90

  //   %add = add nsw i32 %and, 1, !dbg !78
  ...
  //   store atomic i64 %1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   %conv5 = trunc i64 %2 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !68, metadata !DIExpression()), !dbg !90

  //   %and6 = and i32 %conv5, 128, !dbg !84
  creg_r4 = max(creg_r3,0);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and6, metadata !72, metadata !DIExpression()), !dbg !90

  //   %add8 = add nsw i32 1, %and6, !dbg !85
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %3, !dbg !85
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ...
  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !76, metadata !DIExpression()), !dbg !105

  //   %conv11 = trunc i64 %4 to i32, !dbg !87
  ...
  //   %5 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !80, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !90
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv5, 1, !dbg !91

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !81, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !82, metadata !DIExpression()), !dbg !111

  //   %6 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !84, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %6, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !93
  // ST: Guess
  ...
  //   %7 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !88, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %7, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !96
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !143, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !146, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !178

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   %4 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !154, metadata !DIExpression()), !dbg !193

  //   %5 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !156, metadata !DIExpression()), !dbg !193

  //   %conv17 = trunc i64 %5 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !153, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !158, metadata !DIExpression()), !dbg !196

  //   %6 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !160, metadata !DIExpression()), !dbg !196

  //   %conv21 = trunc i64 %6 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !157, metadata !DIExpression()), !dbg !163

  //   %and = and i32 %conv17, %conv21, !dbg !117
  ...
  //   %and22 = and i32 %conv, %and, !dbg !118
  ...
  //   %cmp = icmp eq i32 %and22, 1, !dbg !119
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !122

  //   unreachable, !dbg !122
  r16 = 1;

T0BLOCK2:
  //   %7 = bitcast i64* %thr1 to i8*, !dbg !125

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %7) #7, !dbg !125

  //   %8 = bitcast i64* %thr0 to i8*, !dbg !125
