...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !96), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !76, metadata !DIExpression()), !dbg !112

  //   %conv8 = trunc i64 %2 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !73, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !115

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !115

  //   %conv12 = trunc i64 %3 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !77, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !118

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !118

  //   %conv16 = trunc i64 %4 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !81, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !121

  //   %5 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !121

  //   %conv20 = trunc i64 %5 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !85, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !89, metadata !DIExpression()), !dbg !97

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !106, !tbaa !107
  // ST: Guess
  iw(2,2) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l41_c15
  old_cw = cw(2,2);
  cw(2,2) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l41_c15
  // Check
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !111
  creg__r1__1_ = max(0,creg_r1);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !90, metadata !DIExpression()), !dbg !97

  //   store i32 %conv23, i32* @atom_1_X2_1, align 4, !dbg !112, !tbaa !107
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 0, !dbg !113
  creg__r2__0_ = max(0,creg_r2);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !91, metadata !DIExpression()), !dbg !97

  //   store i32 %conv25, i32* @atom_1_X3_0, align 4, !dbg !114, !tbaa !107
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv12, 0, !dbg !115
  creg__r3__0_ = max(0,creg_r3);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !92, metadata !DIExpression()), !dbg !97

  //   store i32 %conv27, i32* @atom_1_X5_0, align 4, !dbg !116, !tbaa !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !93, metadata !DIExpression()), !dbg !97

  //   store i32 %conv29, i32* @atom_1_X6_1, align 4, !dbg !118, !tbaa !107
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv20, 1, !dbg !119
  creg__r5__1_ = max(0,creg_r5);

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !94, metadata !DIExpression()), !dbg !97

  //   store i32 %conv31, i32* @atom_1_X7_1, align 4, !dbg !120, !tbaa !107
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !144, metadata !DIExpression()), !dbg !151
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !161, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !162, metadata !DIExpression()), !dbg !217

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !163, metadata !DIExpression()), !dbg !219

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !167, metadata !DIExpression()), !dbg !221

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !168, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !224

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !172, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !226

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l68_c3
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l68_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !182, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !185, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !234

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !188, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !191, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !193, metadata !DIExpression()), !dbg !238
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !128
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !129
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !130, !tbaa !131
  r7 = local_mem[0];
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !136, !tbaa !131
  r8 = local_mem[1];

  //   %call18 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !137
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !138, !tbaa !131
  r9 = local_mem[2];

  //   %call19 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !139
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !195, metadata !DIExpression()), !dbg !251

  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !197, metadata !DIExpression()), !dbg !251

  //   %conv = trunc i64 %6 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !194, metadata !DIExpression()), !dbg !217

  //   %cmp = icmp eq i32 %conv, 2, !dbg !143
  creg__r10__2_ = max(0,creg_r10);

  //   %conv20 = zext i1 %cmp to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !198, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !200, metadata !DIExpression()), !dbg !255

  //   %7 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !202, metadata !DIExpression()), !dbg !255

  //   %conv24 = trunc i64 %7 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !199, metadata !DIExpression()), !dbg !217

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !147
  creg__r11__1_ = max(0,creg_r11);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !203, metadata !DIExpression()), !dbg !217

  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !148, !tbaa !149
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l87_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !204, metadata !DIExpression()), !dbg !217

  //   %9 = load i32, i32* @atom_1_X2_1, align 4, !dbg !151, !tbaa !149
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %10 = load i32, i32* @atom_1_X3_0, align 4, !dbg !152, !tbaa !149
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X5_0, align 4, !dbg !153, !tbaa !149
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X6_1, align 4, !dbg !154, !tbaa !149
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %13 = load i32, i32* @atom_1_X7_1, align 4, !dbg !155, !tbaa !149
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %and = and i32 %12, %13, !dbg !156
  creg_r18 = max(creg_r16,creg_r17);
  r18 = r16 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !210, metadata !DIExpression()), !dbg !217

  //   %and27 = and i32 %11, %and, !dbg !157
  creg_r19 = max(creg_r15,creg_r18);
  r19 = r15 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !211, metadata !DIExpression()), !dbg !217

  //   %and28 = and i32 %10, %and27, !dbg !158
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !212, metadata !DIExpression()), !dbg !217

  //   %and29 = and i32 %9, %and28, !dbg !159
  creg_r21 = max(creg_r13,creg_r20);
  r21 = r13 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !213, metadata !DIExpression()), !dbg !217

  //   %and30 = and i32 %8, %and29, !dbg !160
  creg_r22 = max(creg_r12,creg_r21);
  r22 = r12 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !214, metadata !DIExpression()), !dbg !217

  //   %and31 = and i32 %conv26, %and30, !dbg !161
  creg_r23 = max(creg__r11__1_,creg_r22);
  r23 = (r11==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !215, metadata !DIExpression()), !dbg !217

  //   %and32 = and i32 %conv20, %and31, !dbg !162
  creg_r24 = max(creg__r10__2_,creg_r23);
  r24 = (r10==2) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !216, metadata !DIExpression()), !dbg !217

  //   %cmp33 = icmp eq i32 %and32, 1, !dbg !163
  creg__r24__1_ = max(0,creg_r24);

  //   br i1 %cmp33, label %if.then, label %if.end, !dbg !165
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 100, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
