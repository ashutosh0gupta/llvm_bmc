...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !56, metadata !DIExpression()), !dbg !64
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !57, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64 2, metadata !59, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !60, metadata !DIExpression()), !dbg !70
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !80, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !82, metadata !DIExpression()), !dbg !96

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !57
  // LD: Guess
  old_cr = cr(3,r3);
  cr(3,r3) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l38_c15
  // Check
  ASSUME(active[cr(3,r3)] == 3);
  ASSUME(cr(3,r3) >= iw(3,r3));
  ASSUME(cr(3,r3) >= creg_r3);
  ASSUME(cr(3,r3) >= cdy[3]);
  ASSUME(cr(3,r3) >= cisb[3]);
  ASSUME(cr(3,r3) >= cdl[3]);
  ASSUME(cr(3,r3) >= cl[3]);
  // Update
  creg_r4 = cr(3,r3);
  crmax(3,r3) = max(crmax(3,r3),cr(3,r3));
  caddr[3] = max(caddr[3],creg_r3);
  if(cr(3,r3) < cw(3,r3)) {
    r4 = buff(3,r3);
    ASSUME((!(( (cw(3,r3) < 1) && (1 < crmax(3,r3)) )))||(sforbid(r3,1)> 0));
    ASSUME((!(( (cw(3,r3) < 2) && (2 < crmax(3,r3)) )))||(sforbid(r3,2)> 0));
    ASSUME((!(( (cw(3,r3) < 3) && (3 < crmax(3,r3)) )))||(sforbid(r3,3)> 0));
    ASSUME((!(( (cw(3,r3) < 4) && (4 < crmax(3,r3)) )))||(sforbid(r3,4)> 0));
    ASSUME((!(( (cw(3,r3) < 5) && (5 < crmax(3,r3)) )))||(sforbid(r3,5)> 0));
    ASSUME((!(( (cw(3,r3) < 6) && (6 < crmax(3,r3)) )))||(sforbid(r3,6)> 0));
    ASSUME((!(( (cw(3,r3) < 7) && (7 < crmax(3,r3)) )))||(sforbid(r3,7)> 0));
    ASSUME((!(( (cw(3,r3) < 8) && (8 < crmax(3,r3)) )))||(sforbid(r3,8)> 0));
    ASSUME((!(( (cw(3,r3) < 9) && (9 < crmax(3,r3)) )))||(sforbid(r3,9)> 0));
  } else {
    if(pw(3,r3) != co(r3,cr(3,r3))) {
      ASSUME(cr(3,r3) >= old_cr);
    }
    pw(3,r3) = co(r3,cr(3,r3));
    r4 = mem(r3,cr(3,r3));
  }
  ASSUME(creturn[3] >= cr(3,r3));

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !84, metadata !DIExpression()), !dbg !96

  //   %conv4 = trunc i64 %1 to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !81, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !85, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !86, metadata !DIExpression()), !dbg !88

  //   store i32 %conv7, i32* @atom_2_X3_0, align 4, !dbg !67, !tbaa !62
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !114, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !115, metadata !DIExpression()), !dbg !147

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !116, metadata !DIExpression()), !dbg !149

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !120, metadata !DIExpression()), !dbg !151

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !121, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !122, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !125, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !128, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !131, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i32 0, metadata !134, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X3_0, metadata !135, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i32 0, metadata !137, metadata !DIExpression()), !dbg !162

  //   store atomic i32 0, i32* @atom_2_X3_0 monotonic, align 4, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !142, metadata !DIExpression()), !dbg !147
  ...
  //   %8 = load i32, i32* @atom_2_X3_0, align 4, !dbg !110, !tbaa !108
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
