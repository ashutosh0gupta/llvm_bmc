...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !85
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !92, metadata !DIExpression()), !dbg !104
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !98, metadata !DIExpression()), !dbg !111

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(3,0+1*1);
  cr(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l43_c16
  // Check
  ...
  // ST: Guess
  iw(3,6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l47_c15
  old_cw = cw(3,6);
  cw(3,6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l47_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !157, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !161, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !194

  //   store atomic i32 0, i32* @atom_2_X2_0 monotonic, align 4, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !164, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !167, metadata !DIExpression()), !dbg !198
  ...
  //   %8 = load i32, i32* @atom_0_X0_1, align 4, !dbg !121, !tbaa !122
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %9 = load i32, i32* @atom_2_X2_0, align 4, !dbg !124, !tbaa !122
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X0_1, align 4, !dbg !125, !tbaa !122
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_2_X0_1, align 4, !dbg !126, !tbaa !122
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !133
