...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !72, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !79, metadata !DIExpression()), !dbg !97
  ...
  //   %arrayidx17 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !97
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !81, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !89, metadata !DIExpression()), !dbg !123
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !155, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !158, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !202

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !176, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !180, metadata !DIExpression()), !dbg !228

  //   %8 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,5);
