...
T2BLOCK1:
  ...
  //   %add7 = add nsw i32 3, %xor5, !dbg !83
  creg_r6 = max(0,creg_r5);
  r6 = 3 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !83

  //   %arrayidx9 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !83
  r7 = 0+r6*1;
  creg_r7 = creg_r6;
  ...
  //   %xor17 = xor i32 %conv16, %conv16, !dbg !89
  creg_r10 = creg_r9;
  r10 = r9 ^ r9;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !80, metadata !DIExpression()), !dbg !89

  //   %add19 = add nsw i32 0, %xor17, !dbg !90
  creg_r11 = max(0,creg_r10);
  r11 = 0 + r10;

  //   %idxprom20 = sext i32 %add19 to i64, !dbg !90

  //   %arrayidx21 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !90
  r12 = 0+r11*1;
  creg_r12 = creg_r11;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !82, metadata !DIExpression()), !dbg !110

  //   %4 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,r12);
  cr(2,r12) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l37_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !110

  //   %conv24 = trunc i64 %4 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !81, metadata !DIExpression()), !dbg !89

  //   %cmp = icmp eq i32 %conv, 1, !dbg !93
  creg__r0__1_ = max(0,creg_r0);

  //   %conv25 = zext i1 %cmp to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !85, metadata !DIExpression()), !dbg !89

  //   store i32 %conv25, i32* @atom_1_X0_1, align 4, !dbg !94, !tbaa !95
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv4, 2, !dbg !99
  ...
  //   store i32 %conv27, i32* @atom_1_X5_2, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv24, 0, !dbg !101
  creg__r13__0_ = max(0,creg_r13);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !87, metadata !DIExpression()), !dbg !89

  //   store i32 %conv29, i32* @atom_1_X11_0, align 4, !dbg !102, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !167, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !170, metadata !DIExpression()), !dbg !215
  ...
  //   %11 = load i32, i32* @atom_1_X11_0, align 4, !dbg !145, !tbaa !142
  // LD: Guess
  old_cr = cr(0,6);
  ...
  creg_r26 = max(creg__r20__2_,creg_r25);
  r26 = (r20==2) & r25;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154
