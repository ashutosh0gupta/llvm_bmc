...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !39, metadata !DIExpression()), !dbg !59
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !62
  ...
  ASSUME(cdl[1] >= cr(1,9+0));
  ASSUME(creturn[1] >= cdl[1]);

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !47, metadata !DIExpression()), !dbg !66
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !49, metadata !DIExpression()), !dbg !66
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !50, metadata !DIExpression()), !dbg !59

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !51, metadata !DIExpression()), !dbg !70

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !53, metadata !DIExpression()), !dbg !70

  //   store atomic i64 %2, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !71
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !55, metadata !DIExpression()), !dbg !73

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !57, metadata !DIExpression()), !dbg !73

  //   store atomic i64 %3, i64* @atom_0_X2_0 seq_cst, align 8, !dbg !74
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !86, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !107

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !90, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !92, metadata !DIExpression()), !dbg !110

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !94, metadata !DIExpression()), !dbg !110
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !116, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 1, metadata !118, metadata !DIExpression()), !dbg !123
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !136
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !146, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !147, metadata !DIExpression()), !dbg !192

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !148, metadata !DIExpression()), !dbg !194

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !152, metadata !DIExpression()), !dbg !196

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !153, metadata !DIExpression()), !dbg !198

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !154, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !155, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !161, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !205

  //   store atomic i64 0, i64* @atom_0_X0_1 monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !164, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !207

  //   store atomic i64 0, i64* @atom_0_X2_0 monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !167, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !170, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !211

  //   store atomic i64 0, i64* @atom_1_X2_0 monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !174, metadata !DIExpression()), !dbg !229

  //   %8 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !176, metadata !DIExpression()), !dbg !229

  //   %conv = trunc i64 %8 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !173, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !178, metadata !DIExpression()), !dbg !232

  //   %9 = load atomic i64, i64* @atom_0_X2_0 seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !180, metadata !DIExpression()), !dbg !232

  //   %conv21 = trunc i64 %9 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !177, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !182, metadata !DIExpression()), !dbg !235

  //   %10 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !134
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !184, metadata !DIExpression()), !dbg !235

  //   %conv25 = trunc i64 %10 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !181, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !186, metadata !DIExpression()), !dbg !238

  //   %11 = load atomic i64, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !188, metadata !DIExpression()), !dbg !238

  //   %conv29 = trunc i64 %11 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !185, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !190, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !191, metadata !DIExpression()), !dbg !192
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !145
