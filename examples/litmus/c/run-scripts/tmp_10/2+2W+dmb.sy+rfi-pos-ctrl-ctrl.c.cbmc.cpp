...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !88

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !70
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !67, metadata !DIExpression()), !dbg !88

  //   %conv4 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !80
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !78), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !80
...
T2BLOCK7:
  ...
  //   store i32 %conv14, i32* @atom_1_X2_2, align 4, !dbg !90, !tbaa !91
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv4, 2, !dbg !95
  ...
  //   store i32 %conv16, i32* @atom_1_X3_2, align 4, !dbg !96, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !140, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !144, metadata !DIExpression()), !dbg !175
