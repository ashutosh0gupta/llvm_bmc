...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !48, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !78

  //   %conv7 = sext i32 %add to i64, !dbg !79

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !55, metadata !DIExpression()), !dbg !78

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !57, metadata !DIExpression()), !dbg !81

  //   %2 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !59, metadata !DIExpression()), !dbg !81

  //   store atomic i64 %2, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !82
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !90, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !98, metadata !DIExpression()), !dbg !112
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !135, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !138, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !181

  //   store atomic i64 0, i64* @atom_0_X3_1 monotonic, align 8, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !141, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !155, metadata !DIExpression()), !dbg !203

  //   %6 = load atomic i64, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !159, metadata !DIExpression()), !dbg !206

  //   %7 = load atomic i64, i64* @atom_0_X3_1 seq_cst, align 8, !dbg !127
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !163, metadata !DIExpression()), !dbg !209
