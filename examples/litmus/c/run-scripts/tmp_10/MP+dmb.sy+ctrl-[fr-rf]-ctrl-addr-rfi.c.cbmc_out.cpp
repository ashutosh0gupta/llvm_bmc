...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !91), !dbg !115
  ...
  //   %xor = xor i32 %conv15, %conv15, !dbg !100
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64 1, metadata !80, metadata !DIExpression()), !dbg !121

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   store i32 %conv24, i32* @atom_1_X4_1, align 4, !dbg !115, !tbaa !108
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv19, 1, !dbg !116
  ...
  //   store i32 %conv26, i32* @atom_1_X10_1, align 4, !dbg !117, !tbaa !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !185, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !188, metadata !DIExpression()), !dbg !237
