...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !87, metadata !DIExpression()), !dbg !118

  //   %6 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !118

  //   store atomic i64 %6, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !91, metadata !DIExpression()), !dbg !121

  //   %7 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !121

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !161, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !164, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !167, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !185, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !189, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !193, metadata !DIExpression()), !dbg !250
