...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !104), !dbg !130
...
T2BLOCK10:
  ...
  //   %cmp29 = icmp eq i32 %conv4, 0, !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !91, metadata !DIExpression()), !dbg !151

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %7, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !133
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv8, 1, !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !95, metadata !DIExpression()), !dbg !154

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %8, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !136
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !163, metadata !DIExpression()), !dbg !170
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !206, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !209, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !216, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !221, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !226, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !235, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !239, metadata !DIExpression()), !dbg !308
