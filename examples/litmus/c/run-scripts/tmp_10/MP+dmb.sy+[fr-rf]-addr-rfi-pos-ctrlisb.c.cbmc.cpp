...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv12, 0, !dbg !93
...
T2BLOCK4:
  ...
  //   %cmp18 = icmp eq i32 %conv4, 2, !dbg !109
  ...
  //   store i32 %conv19, i32* @atom_1_X2_2, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   store i32 %conv21, i32* @atom_1_X6_1, align 4, !dbg !112, !tbaa !105
  // ST: Guess
  ...
  //   store i32 %conv23, i32* @atom_1_X7_1, align 4, !dbg !114, !tbaa !105
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !140, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64 2, metadata !142, metadata !DIExpression()), !dbg !147
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !178, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !181, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !184, metadata !DIExpression()), !dbg !236
