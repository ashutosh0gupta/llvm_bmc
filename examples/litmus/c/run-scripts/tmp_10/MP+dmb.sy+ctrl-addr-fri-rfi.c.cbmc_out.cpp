...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !96
  ...
  //   store i32 %conv15, i32* @atom_1_X5_0, align 4, !dbg !96, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !146, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X5_0, align 4, !dbg !123, !tbaa !121
  // LD: Guess
  old_cr = cr(0,4);
