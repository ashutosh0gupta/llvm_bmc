...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !112, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !116, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !119, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !121, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !120, metadata !DIExpression()), !dbg !131

  //   %cmp15 = icmp eq i32 %conv14, 2, !dbg !104

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !124, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !126, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !125, metadata !DIExpression()), !dbg !131
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !113
