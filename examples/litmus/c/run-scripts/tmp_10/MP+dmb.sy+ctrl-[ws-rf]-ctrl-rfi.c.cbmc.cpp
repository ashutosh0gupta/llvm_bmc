...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !81), !dbg !94
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !106
  ...
  //   store i32 %conv14, i32* @atom_1_X0_1, align 4, !dbg !93, !tbaa !94
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv4, 2, !dbg !98
  ...
  //   store i32 %conv16, i32* @atom_1_X4_2, align 4, !dbg !99, !tbaa !94
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv13, 1, !dbg !100
  ...
  //   store i32 %conv18, i32* @atom_1_X7_1, align 4, !dbg !101, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !159, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !163, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !166, metadata !DIExpression()), !dbg !209
