...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !80, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 0, %xor, !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !82, metadata !DIExpression()), !dbg !102

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(3,r3);
  cr(3,r3) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !85, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !86, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !89, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !90, metadata !DIExpression()), !dbg !108

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !92, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %3, i64* @atom_2_X3_0 seq_cst, align 8, !dbg !71
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !125, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !135, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !138, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !171

  //   store atomic i64 0, i64* @atom_2_X3_0 monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !144, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !147, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !149, metadata !DIExpression()), !dbg !190

  //   %conv18 = trunc i64 %7 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !146, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !151, metadata !DIExpression()), !dbg !193
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
