...
T1BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !45
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !55, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !56, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !57, metadata !DIExpression()), !dbg !73

  //   %conv1 = sext i32 %add to i64, !dbg !61

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !59, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !61, metadata !DIExpression()), !dbg !76
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !90, metadata !DIExpression()), !dbg !104
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !128, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64 0, metadata !130, metadata !DIExpression()), !dbg !160

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !131, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64 0, metadata !133, metadata !DIExpression()), !dbg !162

  //   store atomic i64 0, i64* @atom_2_X2_0 monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !140, metadata !DIExpression()), !dbg !181

  //   %7 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !144, metadata !DIExpression()), !dbg !184
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !118
