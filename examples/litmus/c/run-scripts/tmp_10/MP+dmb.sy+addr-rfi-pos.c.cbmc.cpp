...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !63, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !64, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !68, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !88
  ...
  //   store i32 %conv9, i32* @atom_1_X0_1, align 4, !dbg !76, !tbaa !77
  // ST: Guess
  ...
  //   %cmp10 = icmp eq i32 %conv4, 1, !dbg !81
  ...
  //   store i32 %conv11, i32* @atom_1_X5_1, align 4, !dbg !82, !tbaa !77
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv8, 1, !dbg !83
  ...
  //   store i32 %conv13, i32* @atom_1_X6_1, align 4, !dbg !84, !tbaa !77
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !125, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !129, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i32 0, metadata !131, metadata !DIExpression()), !dbg !163

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !132, metadata !DIExpression()), !dbg !165
  ...
  //   %7 = load i32, i32* @atom_1_X5_1, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
