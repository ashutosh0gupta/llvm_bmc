...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !92), !dbg !98
  ...
  //   %tobool = icmp ne i32 %conv, 0, !dbg !83
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !93), !dbg !107

  //   call void (...) @isb(), !dbg !89
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !109

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !109

  //   %conv4 = trunc i64 %1 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !112

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l36_c15
  // Check
  ASSUME(active[cr(2,0+2*1)] == 2);
  ASSUME(cr(2,0+2*1) >= iw(2,0+2*1));
  ASSUME(cr(2,0+2*1) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !112

  //   %conv8 = trunc i64 %2 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !115

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   %conv12 = trunc i64 %3 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !96

  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !99
  creg__r3__0_ = max(0,creg_r3);

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !101
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK5:
  //   br label %lbl_LC01, !dbg !102
  goto T2BLOCK7;

T2BLOCK6:
  //   br label %lbl_LC01, !dbg !103
  goto T2BLOCK7;

T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !94), !dbg !123

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !80, metadata !DIExpression()), !dbg !124

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,0+3*1);
  cr(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l40_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !124

  //   %conv19 = trunc i64 %4 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !79, metadata !DIExpression()), !dbg !96

  //   %tobool20 = icmp ne i32 %conv19, 0, !dbg !108
  creg__r4__0_ = max(0,creg_r4);

  //   br i1 %tobool20, label %if.then21, label %if.else22, !dbg !110
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK8:
  //   br label %lbl_LC02, !dbg !111
  goto T2BLOCK10;

T2BLOCK9:
  //   br label %lbl_LC02, !dbg !112
  goto T2BLOCK10;

T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !95), !dbg !132

  //   call void (...) @isb(), !dbg !114
  // isb: Guess
  cisb[2] = get_rng(0,NCONTEXT-1);
  // Check
  ASSUME(cisb[2] >= cdy[2]);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !134

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l44_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !134

  //   %conv26 = trunc i64 %5 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !83, metadata !DIExpression()), !dbg !96

  //   %cmp = icmp eq i32 %conv, 1, !dbg !118
  creg__r0__1_ = max(0,creg_r0);

  //   %conv27 = zext i1 %cmp to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !87, metadata !DIExpression()), !dbg !96

  //   store i32 %conv27, i32* @atom_1_X0_1, align 4, !dbg !119, !tbaa !120
  // ST: Guess
  iw(2,4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l46_c15
  old_cw = cw(2,4);
  cw(2,4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l46_c15
  // Check
  ...
  //   %cmp28 = icmp eq i32 %conv4, 0, !dbg !124
  creg__r1__0_ = max(0,creg_r1);

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !88, metadata !DIExpression()), !dbg !96

  //   store i32 %conv29, i32* @atom_1_X2_0, align 4, !dbg !125, !tbaa !120
  // ST: Guess
  iw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l48_c15
  old_cw = cw(2,5);
  cw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l48_c15
  // Check
  ASSUME(active[iw(2,5)] == 2);
  ASSUME(active[cw(2,5)] == 2);
  ASSUME(sforbid(5,cw(2,5))== 0);
  ASSUME(iw(2,5) >= creg__r1__0_);
  ASSUME(iw(2,5) >= 0);
  ...
  //   %cmp30 = icmp eq i32 %conv8, 1, !dbg !126
  creg__r2__1_ = max(0,creg_r2);

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !89, metadata !DIExpression()), !dbg !96

  //   store i32 %conv31, i32* @atom_1_X4_1, align 4, !dbg !127, !tbaa !120
  // ST: Guess
  iw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l50_c15
  old_cw = cw(2,6);
  cw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l50_c15
  // Check
  ASSUME(active[iw(2,6)] == 2);
  ASSUME(active[cw(2,6)] == 2);
  ASSUME(sforbid(6,cw(2,6))== 0);
  ASSUME(iw(2,6) >= creg__r2__1_);
  ASSUME(iw(2,6) >= 0);
  ...
  //   %cmp32 = icmp eq i32 %conv12, 1, !dbg !128
  creg__r3__1_ = max(0,creg_r3);

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !90, metadata !DIExpression()), !dbg !96

  //   store i32 %conv33, i32* @atom_1_X5_1, align 4, !dbg !129, !tbaa !120
  // ST: Guess
  iw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l52_c15
  old_cw = cw(2,7);
  cw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l52_c15
  // Check
  ASSUME(active[iw(2,7)] == 2);
  ASSUME(active[cw(2,7)] == 2);
  ASSUME(sforbid(7,cw(2,7))== 0);
  ASSUME(iw(2,7) >= creg__r3__1_);
  ASSUME(iw(2,7) >= 0);
  ...
  //   %cmp34 = icmp eq i32 %conv26, 0, !dbg !130
  creg__r5__0_ = max(0,creg_r5);

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !91, metadata !DIExpression()), !dbg !96

  //   store i32 %conv35, i32* @atom_1_X8_0, align 4, !dbg !131, !tbaa !120
  // ST: Guess
  iw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l54_c15
  old_cw = cw(2,8);
  cw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l54_c15
  // Check
  ASSUME(active[iw(2,8)] == 2);
  ASSUME(active[cw(2,8)] == 2);
  ASSUME(sforbid(8,cw(2,8))== 0);
  ASSUME(iw(2,8) >= creg__r5__0_);
  ASSUME(iw(2,8) >= 0);
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !155, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64 1, metadata !157, metadata !DIExpression()), !dbg !162

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !52
  // ST: Guess
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l60_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l60_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !172, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !173, metadata !DIExpression()), !dbg !235

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !174, metadata !DIExpression()), !dbg !237

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !178, metadata !DIExpression()), !dbg !239

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !179, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !180, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !242

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !117
  // ST: Guess
  iw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l69_c3
  old_cw = cw(0,0+3*1);
  cw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l69_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !183, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !185, metadata !DIExpression()), !dbg !244

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !119
  // ST: Guess
  iw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l70_c3
  old_cw = cw(0,0+2*1);
  cw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l70_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !246

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !121
  // ST: Guess
  iw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l71_c3
  old_cw = cw(0,0+1*1);
  cw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l71_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !248

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !123
  // ST: Guess
  iw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l72_c3
  old_cw = cw(0,0);
  cw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l72_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !192, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !250

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !125
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l73_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l73_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !196, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !252

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !127
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l74_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l74_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !199, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i32 0, metadata !201, metadata !DIExpression()), !dbg !254

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !129
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l75_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l75_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !202, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i32 0, metadata !204, metadata !DIExpression()), !dbg !256

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !131
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l76_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l76_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !205, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i32 0, metadata !207, metadata !DIExpression()), !dbg !258

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !133
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l77_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l77_c3
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !134
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !135
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !136
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !137, !tbaa !138
  r7 = local_mem[0];

  //   %call19 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !143, !tbaa !138
  r8 = local_mem[1];

  //   %call20 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !144
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !145, !tbaa !138
  r9 = local_mem[2];

  //   %call21 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !146
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !209, metadata !DIExpression()), !dbg !271

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l87_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !211, metadata !DIExpression()), !dbg !271

  //   %conv = trunc i64 %6 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !208, metadata !DIExpression()), !dbg !235

  //   %cmp = icmp eq i32 %conv, 1, !dbg !150
  creg__r10__1_ = max(0,creg_r10);

  //   %conv22 = zext i1 %cmp to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !212, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !214, metadata !DIExpression()), !dbg !275

  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l89_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !216, metadata !DIExpression()), !dbg !275

  //   %conv26 = trunc i64 %7 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !213, metadata !DIExpression()), !dbg !235

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !154
  creg__r11__1_ = max(0,creg_r11);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !217, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !219, metadata !DIExpression()), !dbg !279

  //   %8 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !156
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l91_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !221, metadata !DIExpression()), !dbg !279

  //   %conv32 = trunc i64 %8 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !218, metadata !DIExpression()), !dbg !235

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !158
  creg__r12__1_ = max(0,creg_r12);

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !222, metadata !DIExpression()), !dbg !235

  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !159, !tbaa !160
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l93_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !223, metadata !DIExpression()), !dbg !235

  //   %10 = load i32, i32* @atom_1_X2_0, align 4, !dbg !162, !tbaa !160
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l94_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !224, metadata !DIExpression()), !dbg !235

  //   %11 = load i32, i32* @atom_1_X4_1, align 4, !dbg !163, !tbaa !160
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l95_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !225, metadata !DIExpression()), !dbg !235

  //   %12 = load i32, i32* @atom_1_X5_1, align 4, !dbg !164, !tbaa !160
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l96_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !226, metadata !DIExpression()), !dbg !235

  //   %13 = load i32, i32* @atom_1_X8_0, align 4, !dbg !165, !tbaa !160
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l97_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !227, metadata !DIExpression()), !dbg !235

  //   %and = and i32 %12, %13, !dbg !166
  creg_r18 = max(creg_r16,creg_r17);
  r18 = r16 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !228, metadata !DIExpression()), !dbg !235

  //   %and35 = and i32 %11, %and, !dbg !167
  creg_r19 = max(creg_r15,creg_r18);
  r19 = r15 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !229, metadata !DIExpression()), !dbg !235

  //   %and36 = and i32 %10, %and35, !dbg !168
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !230, metadata !DIExpression()), !dbg !235

  //   %and37 = and i32 %9, %and36, !dbg !169
  creg_r21 = max(creg_r13,creg_r20);
  r21 = r13 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !231, metadata !DIExpression()), !dbg !235

  //   %and38 = and i32 %conv34, %and37, !dbg !170
  creg_r22 = max(creg__r12__1_,creg_r21);
  r22 = (r12==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !232, metadata !DIExpression()), !dbg !235

  //   %and39 = and i32 %conv28, %and38, !dbg !171
  creg_r23 = max(creg__r11__1_,creg_r22);
  r23 = (r11==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !233, metadata !DIExpression()), !dbg !235

  //   %and40 = and i32 %conv22, %and39, !dbg !172
  creg_r24 = max(creg__r10__1_,creg_r23);
  r24 = (r10==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !234, metadata !DIExpression()), !dbg !235

  //   %cmp41 = icmp eq i32 %and40, 1, !dbg !173
  creg__r24__1_ = max(0,creg_r24);

  //   br i1 %cmp41, label %if.then, label %if.end, !dbg !175
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 105, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !176
...
T0BLOCK2:
  //   %14 = bitcast i64* %thr2 to i8*, !dbg !179

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %14) #7, !dbg !179

  //   %15 = bitcast i64* %thr1 to i8*, !dbg !179

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %15) #7, !dbg !179

  //   %16 = bitcast i64* %thr0 to i8*, !dbg !179

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %16) #7, !dbg !179
