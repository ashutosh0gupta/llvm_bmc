...
T2BLOCK1:
  ...
  //   %xor = xor i32 %conv, %conv, !dbg !70
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !83

  //   %add = add nsw i32 0, %xor, !dbg !71
  creg_r2 = max(0,creg_r1);
  r2 = 0 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !71

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !71
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !67, metadata !DIExpression()), !dbg !91

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !71
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !69, metadata !DIExpression()), !dbg !91

  //   %conv4 = trunc i64 %1 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !93

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !75
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l33_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !93

  //   %conv8 = trunc i64 %2 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !96

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !96
  ...
  //   %cmp14 = icmp eq i32 %conv4, 0, !dbg !86
  ...
  //   store i32 %conv15, i32* @atom_1_X3_0, align 4, !dbg !87, !tbaa !82
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 0, !dbg !88
  ...
  //   store i32 %conv17, i32* @atom_1_X5_0, align 4, !dbg !89, !tbaa !82
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv12, 1, !dbg !90
  ...
  //   store i32 %conv19, i32* @atom_1_X6_1, align 4, !dbg !91, !tbaa !82
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !115, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i64 1, metadata !117, metadata !DIExpression()), !dbg !122

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !50
  // ST: Guess
  iw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l48_c3
  old_cw = cw(3,0);
  cw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l48_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !150, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !191

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !153, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !193

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !156, metadata !DIExpression()), !dbg !195
  ...
  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !129
  ...
  //   %9 = load i32, i32* @atom_1_X3_0, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %10 = load i32, i32* @atom_1_X5_0, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
