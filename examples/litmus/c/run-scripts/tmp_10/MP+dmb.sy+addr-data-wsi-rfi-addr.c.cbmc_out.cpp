...
T2BLOCK1:
  ...
  //   %xor14 = xor i32 %conv13, %conv13, !dbg !89
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor14, metadata !80, metadata !DIExpression()), !dbg !89

  //   %add16 = add nsw i32 0, %xor14, !dbg !90
  creg_r9 = max(0,creg_r8);
  r9 = 0 + r8;

  //   %idxprom17 = sext i32 %add16 to i64, !dbg !90

  //   %arrayidx18 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom17, !dbg !90
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx18, metadata !82, metadata !DIExpression()), !dbg !110

  //   %3 = load atomic i64, i64* %arrayidx18 monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !84, metadata !DIExpression()), !dbg !110
  ...
  //   %cmp23 = icmp eq i32 %conv13, 2, !dbg !99
  ...
  //   %cmp25 = icmp eq i32 %conv21, 0, !dbg !101
  ...
  //   store i32 %conv26, i32* @atom_1_X10_0, align 4, !dbg !102, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_2, metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !156, metadata !DIExpression()), !dbg !199
