...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !55, metadata !DIExpression()), !dbg !78
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !56, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64 2, metadata !58, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !61, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !63, metadata !DIExpression()), !dbg !83

  //   %conv = trunc i64 %0 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !59, metadata !DIExpression()), !dbg !78
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !77), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !78

  //   %cmp = icmp eq i32 %conv, 2, !dbg !77

  //   %conv5 = zext i1 %cmp to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !68, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !69, metadata !DIExpression()), !dbg !97
  ...
  //   %cmp9 = icmp eq i32 %conv4, 0, !dbg !80

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !72, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !73, metadata !DIExpression()), !dbg !100

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !100

  //   store atomic i64 %3, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !82
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !123, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !126, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !130, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !132, metadata !DIExpression()), !dbg !173

  //   %conv = trunc i64 %4 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !129, metadata !DIExpression()), !dbg !150

  //   %cmp = icmp eq i32 %conv, 1, !dbg !106

  //   %conv10 = zext i1 %cmp to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !133, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !137, metadata !DIExpression()), !dbg !177

  //   %conv14 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !134, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !140, metadata !DIExpression()), !dbg !181

  //   %6 = load atomic i64, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !139, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !144, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !146, metadata !DIExpression()), !dbg !184

  //   %conv24 = trunc i64 %7 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !143, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !148, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !149, metadata !DIExpression()), !dbg !150
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !123
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #6, !dbg !126
