...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !71), !dbg !85

  //   call void (...) @isb(), !dbg !67
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !67, metadata !DIExpression()), !dbg !87
  ...
  //   store i32 %conv5, i32* @atom_1_X2_2, align 4, !dbg !72, !tbaa !73
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv4, 0, !dbg !77
  creg__r1__0_ = max(0,creg_r1);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !77

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !69, metadata !DIExpression()), !dbg !72

  //   store i32 %conv7, i32* @atom_1_X3_0, align 4, !dbg !78, !tbaa !73
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !106, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !107, metadata !DIExpression()), !dbg !141

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !108, metadata !DIExpression()), !dbg !143

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !112, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !113, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !116, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !119, metadata !DIExpression()), !dbg !150

  //   call void @llvm.dbg.value(metadata i32 0, metadata !122, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !123, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !129, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !130, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !134, metadata !DIExpression()), !dbg !166

  //   %conv14 = trunc i64 %5 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !131, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !135, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !139, metadata !DIExpression()), !dbg !141

  //   %and18 = and i32 %conv10, %and17, !dbg !112
  creg_r11 = max(creg__r5__1_,creg_r10);
  r11 = (r5==1) & r10;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !140, metadata !DIExpression()), !dbg !141
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 65, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !116
