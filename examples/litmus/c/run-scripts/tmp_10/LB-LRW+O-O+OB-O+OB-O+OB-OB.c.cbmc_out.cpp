...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !103, metadata !DIExpression()), !dbg !118
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !156, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !174
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !212, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !215, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !218, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !221, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !224, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !228, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !232, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !236, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !240, metadata !DIExpression()), !dbg !310
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !244, metadata !DIExpression()), !dbg !313
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 109, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
