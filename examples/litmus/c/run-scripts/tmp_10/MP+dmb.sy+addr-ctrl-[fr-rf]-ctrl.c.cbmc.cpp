...
T2BLOCK7:
  ...
  //   %cmp21 = icmp eq i32 %conv8, 0, !dbg !107
  ...
  //   store i32 %conv22, i32* @atom_1_X5_0, align 4, !dbg !108, !tbaa !103
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv12, 1, !dbg !109
  ...
  //   store i32 %conv24, i32* @atom_1_X7_1, align 4, !dbg !110, !tbaa !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !177, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !180, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !187, metadata !DIExpression()), !dbg !245
