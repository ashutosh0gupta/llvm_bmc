...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !58, metadata !DIExpression()), !dbg !72
  ...
  //   %and = and i32 %conv, 128, !dbg !56
  creg_r1 = max(0,creg_r0);
  r1 = r0 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !61, metadata !DIExpression()), !dbg !69

  //   %add = add nsw i32 1, %and, !dbg !57
  creg_r2 = max(0,creg_r1);
  r2 = 1 + r1;

  //   %1 = zext i32 %add to i64

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %1, !dbg !57
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !63, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !65, metadata !DIExpression()), !dbg !77
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !95, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !96, metadata !DIExpression()), !dbg !118

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !97, metadata !DIExpression()), !dbg !120

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !101, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !102, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64 0, metadata !107, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !108, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i32 0, metadata !111, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !112, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i32 0, metadata !114, metadata !DIExpression()), !dbg !129

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !75
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_1_X3_0, align 4, !dbg !89, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 56, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
