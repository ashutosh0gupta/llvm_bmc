...
T2BLOCK1:
  ...
  //   %and = and i32 %conv, 128, !dbg !62
  creg_r1 = max(creg_r0,0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !61, metadata !DIExpression()), !dbg !75

  //   %add = add nsw i32 1, %and, !dbg !63
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %1, !dbg !63
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !65, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !69, metadata !DIExpression()), !dbg !86

  //   store atomic i64 %3, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !73, metadata !DIExpression()), !dbg !89

  //   store atomic i64 %4, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !71
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 56, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !101
