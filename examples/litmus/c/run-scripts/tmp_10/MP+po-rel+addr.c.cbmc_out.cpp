...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !55, metadata !DIExpression()), !dbg !68
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !56, metadata !DIExpression()), !dbg !68

  //   %xor = xor i32 %conv, %conv, !dbg !56
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !60, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !62, metadata !DIExpression()), !dbg !76
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !107, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !111, metadata !DIExpression()), !dbg !128
