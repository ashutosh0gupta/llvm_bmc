...
T2BLOCK4:
  ...
  //   %cmp13 = icmp eq i32 %conv7, 1, !dbg !96
  ...
  //   store i32 %conv14, i32* @atom_1_X5_1, align 4, !dbg !97, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !127, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !128, metadata !DIExpression()), !dbg !176

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !129, metadata !DIExpression()), !dbg !178

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !133, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !134, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !136, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !143, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !147, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !150, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !157, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !158, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !162, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !163, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !167, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !172, metadata !DIExpression()), !dbg !176

  //   %and28 = and i32 %conv26, %and27, !dbg !137
  creg_r16 = max(creg__r10__1_,creg_r15);
  r16 = (r10==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !173, metadata !DIExpression()), !dbg !176
