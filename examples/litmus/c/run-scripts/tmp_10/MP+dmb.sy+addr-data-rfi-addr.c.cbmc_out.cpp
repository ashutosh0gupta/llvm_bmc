...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !65, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !95

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !86
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !68, metadata !DIExpression()), !dbg !95

  //   %add6 = add nsw i32 %xor5, 1, !dbg !87
  creg_r6 = max(creg_r5,0);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !69, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !70, metadata !DIExpression()), !dbg !107

  //   %conv7 = sext i32 %add6 to i64, !dbg !89

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !72, metadata !DIExpression()), !dbg !107

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !76, metadata !DIExpression()), !dbg !109

  //   %conv11 = trunc i64 %2 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !73, metadata !DIExpression()), !dbg !95

  //   %xor12 = xor i32 %conv11, %conv11, !dbg !93
  creg_r8 = max(creg_r7,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !77, metadata !DIExpression()), !dbg !95

  //   %add14 = add nsw i32 0, %xor12, !dbg !94
  creg_r9 = max(0,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = 0 + r8;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !94

  //   %arrayidx16 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !94
  r10 = 0+r9*1;
  ASSUME(creg_r10 >= 0);
  ASSUME(creg_r10 >= creg_r9);
  ASSUME(active[creg_r10] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !79, metadata !DIExpression()), !dbg !114

  //   %3 = load atomic i64, i64* %arrayidx16 monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   %conv19 = trunc i64 %3 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !95

  //   %cmp = icmp eq i32 %conv, 1, !dbg !97

  //   %conv20 = zext i1 %cmp to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !82, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !83, metadata !DIExpression()), !dbg !117

  //   %4 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !99
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv11, 1, !dbg !100

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !86, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !87, metadata !DIExpression()), !dbg !120

  //   %5 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !120

  //   store atomic i64 %5, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !102
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv19, 0, !dbg !103

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !90, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !91, metadata !DIExpression()), !dbg !123

  //   %6 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !123

  //   store atomic i64 %6, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !133, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !134, metadata !DIExpression()), !dbg !193

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !135, metadata !DIExpression()), !dbg !195

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !139, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !140, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !143, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !149, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !152, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !155, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !158, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !164, metadata !DIExpression()), !dbg !222

  //   %conv = trunc i64 %4 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !161, metadata !DIExpression()), !dbg !193

  //   %cmp = icmp eq i32 %conv, 1, !dbg !134

  //   %conv16 = zext i1 %cmp to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !165, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !167, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !169, metadata !DIExpression()), !dbg !226

  //   %conv20 = trunc i64 %5 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !166, metadata !DIExpression()), !dbg !193

  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !138

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !170, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !174, metadata !DIExpression()), !dbg !230

  //   %conv26 = trunc i64 %6 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !171, metadata !DIExpression()), !dbg !193

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !142

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !175, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !177, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !179, metadata !DIExpression()), !dbg !234

  //   %conv32 = trunc i64 %7 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !176, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !181, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !183, metadata !DIExpression()), !dbg !237

  //   %conv36 = trunc i64 %8 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !180, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !185, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !187, metadata !DIExpression()), !dbg !240

  //   %conv40 = trunc i64 %9 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !184, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !188, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !189, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !190, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !191, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !192, metadata !DIExpression()), !dbg !193
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
