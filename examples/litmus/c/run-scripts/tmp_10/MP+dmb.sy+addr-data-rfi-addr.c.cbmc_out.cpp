...
T2BLOCK1:
  ...
  //   %xor12 = xor i32 %conv11, %conv11, !dbg !84
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !77, metadata !DIExpression()), !dbg !86

  //   %add14 = add nsw i32 0, %xor12, !dbg !85
  creg_r9 = max(0,creg_r8);
  r9 = 0 + r8;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !85

  //   %arrayidx16 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !85
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !79, metadata !DIExpression()), !dbg !105

  //   %3 = load atomic i64, i64* %arrayidx16 monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !105

  //   %conv19 = trunc i64 %3 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !86

  //   %cmp = icmp eq i32 %conv, 1, !dbg !88
  creg__r0__1_ = max(0,creg_r0);

  //   %conv20 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !82, metadata !DIExpression()), !dbg !86

  //   store i32 %conv20, i32* @atom_1_X0_1, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv11, 1, !dbg !94
  creg__r7__1_ = max(0,creg_r7);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !83, metadata !DIExpression()), !dbg !86

  //   store i32 %conv22, i32* @atom_1_X7_1, align 4, !dbg !95, !tbaa !90
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv19, 0, !dbg !96
  creg__r11__0_ = max(0,creg_r11);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !84, metadata !DIExpression()), !dbg !86

  //   store i32 %conv24, i32* @atom_1_X9_0, align 4, !dbg !97, !tbaa !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !125, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !126, metadata !DIExpression()), !dbg !177

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !127, metadata !DIExpression()), !dbg !179

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !131, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !132, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !134, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !135, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !144, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !148, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !151, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !158, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !159, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !163, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !164, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !168, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !173, metadata !DIExpression()), !dbg !177

  //   %and30 = and i32 %conv28, %and29, !dbg !142
  creg_r23 = max(creg__r17__1_,creg_r22);
  r23 = (r17==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !174, metadata !DIExpression()), !dbg !177

  //   %and31 = and i32 %conv22, %and30, !dbg !143
  creg_r24 = max(creg__r16__1_,creg_r23);
  r24 = (r16==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !175, metadata !DIExpression()), !dbg !177

  //   %and32 = and i32 %conv16, %and31, !dbg !144
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !176, metadata !DIExpression()), !dbg !177
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([113 x i8], [113 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !148
