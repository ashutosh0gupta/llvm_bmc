...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !75, metadata !DIExpression()), !dbg !131

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !131
  ...
  //   %cmp30 = icmp eq i32 %conv15, 0, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !92, metadata !DIExpression()), !dbg !145

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv19, 1, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !96, metadata !DIExpression()), !dbg !148

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %8, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !157, metadata !DIExpression()), !dbg !164
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !200, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !203, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !210, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !229, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !233, metadata !DIExpression()), !dbg !302
