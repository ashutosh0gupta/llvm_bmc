...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !75, metadata !DIExpression()), !dbg !119

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !119
  ...
  //   %cmp29 = icmp eq i32 %conv15, 0, !dbg !116
  ...
  //   store i32 %conv30, i32* @atom_1_X7_0, align 4, !dbg !117, !tbaa !112
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv19, 1, !dbg !118
  ...
  //   store i32 %conv32, i32* @atom_1_X9_1, align 4, !dbg !119, !tbaa !112
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !145, metadata !DIExpression()), !dbg !152
  ...
  // ST: Guess
  iw(3,0+4*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l55_c3
  old_cw = cw(3,0+4*1);
  cw(3,0+4*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l55_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !189, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !192, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !199, metadata !DIExpression()), !dbg !259

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,0+4*1);
  cr(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l82_c13
  // Check
