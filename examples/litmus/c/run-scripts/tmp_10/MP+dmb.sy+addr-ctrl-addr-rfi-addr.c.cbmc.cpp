...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv4, 0, !dbg !90
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !98), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !69, metadata !DIExpression()), !dbg !115

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !71, metadata !DIExpression()), !dbg !115
