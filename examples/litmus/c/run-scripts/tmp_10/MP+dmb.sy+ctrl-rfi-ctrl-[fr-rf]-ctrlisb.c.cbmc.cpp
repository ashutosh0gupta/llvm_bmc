...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !133

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !77, metadata !DIExpression()), !dbg !133

  //   %conv11 = trunc i64 %2 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !74, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !79, metadata !DIExpression()), !dbg !136

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(2,0+3*1);
  cr(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !136

  //   %conv15 = trunc i64 %3 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !78, metadata !DIExpression()), !dbg !110

  //   %tobool16 = icmp ne i32 %conv15, 0, !dbg !120

  //   br i1 %tobool16, label %if.then17, label %if.else18, !dbg !122
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !109), !dbg !144

  //   call void (...) @isb(), !dbg !126
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !146

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !146

  //   %conv22 = trunc i64 %4 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !82, metadata !DIExpression()), !dbg !110

  //   %cmp = icmp eq i32 %conv, 1, !dbg !130

  //   %conv23 = zext i1 %cmp to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !86, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !150

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !132
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv4, 1, !dbg !133

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !90, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !91, metadata !DIExpression()), !dbg !153

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %6, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !135
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv11, 0, !dbg !136

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !94, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !95, metadata !DIExpression()), !dbg !156

  //   %7 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !156

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !138
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv15, 1, !dbg !139

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !98, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !99, metadata !DIExpression()), !dbg !159

  //   %8 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !159

  //   store atomic i64 %8, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !141
  // ST: Guess
  ...
  //   %cmp42 = icmp eq i32 %conv22, 0, !dbg !142

  //   %conv43 = zext i1 %cmp42 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv43, metadata !102, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !103, metadata !DIExpression()), !dbg !162

  //   %9 = zext i32 %conv43 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !162

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !144
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !167, metadata !DIExpression()), !dbg !172
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !168, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 1, metadata !170, metadata !DIExpression()), !dbg !175
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !185, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !186, metadata !DIExpression()), !dbg !268

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !187, metadata !DIExpression()), !dbg !270

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !191, metadata !DIExpression()), !dbg !272

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !192, metadata !DIExpression()), !dbg !274

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !193, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !196, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !199, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !202, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !208, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !211, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !214, metadata !DIExpression()), !dbg !289
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !217, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !221, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !223, metadata !DIExpression()), !dbg !306

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !220, metadata !DIExpression()), !dbg !268

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !224, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !226, metadata !DIExpression()), !dbg !310
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !228, metadata !DIExpression()), !dbg !310

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !225, metadata !DIExpression()), !dbg !268

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !229, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !231, metadata !DIExpression()), !dbg !314
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !233, metadata !DIExpression()), !dbg !314

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !230, metadata !DIExpression()), !dbg !268

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !234, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !236, metadata !DIExpression()), !dbg !318
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !238, metadata !DIExpression()), !dbg !318

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !235, metadata !DIExpression()), !dbg !268

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !239, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !243, metadata !DIExpression()), !dbg !322

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !240, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !245, metadata !DIExpression()), !dbg !325
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !247, metadata !DIExpression()), !dbg !325

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !244, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !249, metadata !DIExpression()), !dbg !328
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !251, metadata !DIExpression()), !dbg !328

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !248, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !253, metadata !DIExpression()), !dbg !331
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !255, metadata !DIExpression()), !dbg !331

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !252, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !257, metadata !DIExpression()), !dbg !334
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !259, metadata !DIExpression()), !dbg !334

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !256, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !260, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !261, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !262, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !263, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !264, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !265, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !266, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !267, metadata !DIExpression()), !dbg !268
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 107, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
