...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !65
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !46, metadata !DIExpression()), !dbg !68
  ...
  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !74
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !55, metadata !DIExpression()), !dbg !75
  ...
  //   store i32 %conv12, i32* @atom_0_X7_2, align 4, !dbg !79, !tbaa !80
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !92, metadata !DIExpression()), !dbg !102
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !122, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !125, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !128, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X7_2, metadata !131, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i32 0, metadata !134, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !135, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !141, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !142, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !144, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !146, metadata !DIExpression()), !dbg !180

  //   %conv16 = trunc i64 %5 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !143, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !147, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !151, metadata !DIExpression()), !dbg !153

  //   %and20 = and i32 %conv12, %and19, !dbg !117
  creg_r15 = max(creg__r9__1_,creg_r14);
  r15 = (r9==1) & r14;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !152, metadata !DIExpression()), !dbg !153
