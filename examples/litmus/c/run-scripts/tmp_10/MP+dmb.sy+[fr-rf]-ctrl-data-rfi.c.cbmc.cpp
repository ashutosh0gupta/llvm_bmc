...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !72, metadata !DIExpression()), !dbg !94
  ...
  //   %conv9 = sext i32 %add to i64, !dbg !96

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !75, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !76, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !100

  //   %conv14 = zext i1 %cmp to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !80, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !84, metadata !DIExpression()), !dbg !94
  ...
  //   store atomic i64 %5, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !172, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !194, metadata !DIExpression()), !dbg !247
