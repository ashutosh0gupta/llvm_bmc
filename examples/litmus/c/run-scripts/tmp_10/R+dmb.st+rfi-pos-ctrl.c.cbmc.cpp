...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !67, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !69, metadata !DIExpression()), !dbg !87
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !78), !dbg !95
  ...
  //   store i32 %conv11, i32* @atom_1_X3_2, align 4, !dbg !87, !tbaa !82
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv8, 0, !dbg !88
  ...
  //   store i32 %conv13, i32* @atom_1_X4_0, align 4, !dbg !89, !tbaa !82
  // ST: Guess
