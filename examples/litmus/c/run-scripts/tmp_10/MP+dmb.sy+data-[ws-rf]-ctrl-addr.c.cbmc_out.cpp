...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor10, metadata !76, metadata !DIExpression()), !dbg !86

  //   %add12 = add nsw i32 0, %xor10, !dbg !90
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add12 to i64, !dbg !90
  ...
  //   %cmp17 = icmp eq i32 %conv5, 2, !dbg !99
  ...
  //   store i32 %conv18, i32* @atom_1_X4_2, align 4, !dbg !100, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !170, metadata !DIExpression()), !dbg !215
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154
