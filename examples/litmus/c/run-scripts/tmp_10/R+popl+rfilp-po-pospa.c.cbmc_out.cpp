...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !101

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !70
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp10 = icmp eq i32 %conv4, 0, !dbg !81
  ...
  //   store i32 %conv11, i32* @atom_1_X3_0, align 4, !dbg !82, !tbaa !77
  // ST: Guess
  ...
  //   store i32 %conv13, i32* @atom_1_X5_0, align 4, !dbg !84, !tbaa !77
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !141, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !179

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !144, metadata !DIExpression()), !dbg !181
  ...
  //   %8 = load i32, i32* @atom_1_X3_0, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
