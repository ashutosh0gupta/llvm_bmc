...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !56, metadata !DIExpression()), !dbg !79

  //   br label %label_2, !dbg !61
  goto T2BLOCK1;

T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !76), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !60, metadata !DIExpression()), !dbg !82

  //   %conv = trunc i64 %0 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !57, metadata !DIExpression()), !dbg !79
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !77), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !91

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !73
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !64, metadata !DIExpression()), !dbg !91

  //   %conv4 = trunc i64 %1 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !61, metadata !DIExpression()), !dbg !79

  //   %xor = xor i32 %conv4, %conv4, !dbg !75
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !66, metadata !DIExpression()), !dbg !79

  //   %tobool9 = icmp ne i32 %conv8, 0, !dbg !79
  creg__r5__0_ = max(0,creg_r5);

  //   br i1 %tobool9, label %if.then10, label %if.else11, !dbg !81
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !78), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !104

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !86
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !73, metadata !DIExpression()), !dbg !104

  //   %conv15 = trunc i64 %3 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !70, metadata !DIExpression()), !dbg !79

  //   %cmp = icmp eq i32 %conv, 1, !dbg !88
  creg__r0__1_ = max(0,creg_r0);

  //   %conv16 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !74, metadata !DIExpression()), !dbg !79

  //   store i32 %conv16, i32* @atom_1_X0_1, align 4, !dbg !89, !tbaa !90
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv15, 0, !dbg !94
  creg__r6__0_ = max(0,creg_r6);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !75, metadata !DIExpression()), !dbg !79

  //   store i32 %conv18, i32* @atom_1_X7_0, align 4, !dbg !95, !tbaa !90
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !142, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !146, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !179

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !97
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X7_0, align 4, !dbg !119, !tbaa !117
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
