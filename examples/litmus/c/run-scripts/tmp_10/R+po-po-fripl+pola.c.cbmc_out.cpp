...
T1BLOCK1:
  ...
  //   store i32 %conv11, i32* @atom_0_X4_0, align 4, !dbg !82, !tbaa !77
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_0, metadata !134, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i32 0, metadata !136, metadata !DIExpression()), !dbg !176

  //   store atomic i32 0, i32* @atom_0_X4_0 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_0_X4_0, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
