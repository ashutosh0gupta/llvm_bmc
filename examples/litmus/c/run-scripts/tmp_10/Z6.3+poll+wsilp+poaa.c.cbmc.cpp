...
T2BLOCK1:
  ...
  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !53
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !91, metadata !DIExpression()), !dbg !104
  ...
  //   store i32 %conv5, i32* @atom_2_X0_3, align 4, !dbg !61, !tbaa !62
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !136, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i32 0, metadata !139, metadata !DIExpression()), !dbg !162

  //   store atomic i32 0, i32* @atom_0_X4_2 monotonic, align 4, !dbg !83
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_3, metadata !140, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i32 0, metadata !142, metadata !DIExpression()), !dbg !164

  //   store atomic i32 0, i32* @atom_2_X0_3 monotonic, align 4, !dbg !85
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X4_2, align 4, !dbg !101, !tbaa !102
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %7 = load i32, i32* @atom_2_X0_3, align 4, !dbg !104, !tbaa !102
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
