...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !102), !dbg !125
  ...
  //   %xor = xor i32 %conv13, %conv13, !dbg !112
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !103

  //   %add = add nsw i32 0, %xor, !dbg !113
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !113
  r5 = 0+r4*1;
  ASSUME(creg_r5 >= 0);
  ASSUME(creg_r5 >= creg_r4);
  ASSUME(active[creg_r5] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !133

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   %cmp27 = icmp eq i32 %conv13, 2, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !93, metadata !DIExpression()), !dbg !142
