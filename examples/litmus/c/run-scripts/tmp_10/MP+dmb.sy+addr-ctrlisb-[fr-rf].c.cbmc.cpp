...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !98
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp14 = icmp eq i32 %conv8, 0, !dbg !91
  ...
  //   store i32 %conv15, i32* @atom_1_X5_0, align 4, !dbg !92, !tbaa !87
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv12, 1, !dbg !93
  ...
  //   store i32 %conv17, i32* @atom_1_X7_1, align 4, !dbg !94, !tbaa !87
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !118, metadata !DIExpression()), !dbg !125
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !142, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !143, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !152, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !156, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !194

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !159, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !196

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !165, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !166, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !170, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !171, metadata !DIExpression()), !dbg !179
  ...
  //   %9 = load i32, i32* @atom_1_X5_0, align 4, !dbg !129, !tbaa !127
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %10 = load i32, i32* @atom_1_X7_1, align 4, !dbg !130, !tbaa !127
  // LD: Guess
  old_cr = cr(0,5);
