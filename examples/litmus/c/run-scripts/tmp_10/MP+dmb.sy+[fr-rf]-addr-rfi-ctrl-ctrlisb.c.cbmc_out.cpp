...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !70, metadata !DIExpression()), !dbg !103
  ...
  // ST: Guess
  iw(2,r4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l33_c3
  old_cw = cw(2,r4);
  cw(2,r4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l33_c3
  // Check
