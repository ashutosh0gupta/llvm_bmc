...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !78, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64 1, metadata !80, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !81, metadata !DIExpression()), !dbg !84
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !104, metadata !DIExpression()), !dbg !115
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !106, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !108, metadata !DIExpression()), !dbg !118

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !105, metadata !DIExpression()), !dbg !115
...
T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !114), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !109, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !112, metadata !DIExpression()), !dbg !115
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !140, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !141, metadata !DIExpression()), !dbg !172

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !142, metadata !DIExpression()), !dbg !174

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !146, metadata !DIExpression()), !dbg !176

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !147, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !148, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !153, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !154, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !157, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !161, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !164, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !169, metadata !DIExpression()), !dbg !172

  //   %and = and i32 %7, %8, !dbg !111
  creg_r10 = max(creg_r8,creg_r9);
  r10 = r8 & r9;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !170, metadata !DIExpression()), !dbg !172

  //   %and16 = and i32 %6, %and, !dbg !112
  creg_r11 = max(creg_r10,creg_r7);
  r11 = r7 & r10;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !171, metadata !DIExpression()), !dbg !172
