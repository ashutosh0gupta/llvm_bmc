...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv11, 0, !dbg !87
...
T2BLOCK4:
  ...
  //   %cmp19 = icmp eq i32 %conv5, 2, !dbg !104
  ...
  //   store i32 %conv20, i32* @atom_1_X4_2, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   store i32 %conv22, i32* @atom_1_X10_1, align 4, !dbg !107, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !175, metadata !DIExpression()), !dbg !220
  ...
  //   %11 = load i32, i32* @atom_1_X10_1, align 4, !dbg !145, !tbaa !142
  // LD: Guess
  old_cr = cr(0,6);
