...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 4, metadata !75, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !77, metadata !DIExpression()), !dbg !93
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !116, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_3, metadata !122, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i32 0, metadata !125, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !126, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i32 0, metadata !128, metadata !DIExpression()), !dbg !149
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 60, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !105
