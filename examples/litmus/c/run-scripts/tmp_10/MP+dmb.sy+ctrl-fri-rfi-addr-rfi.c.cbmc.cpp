...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !156, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !203

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X2_0, align 4, !dbg !142, !tbaa !140
  // LD: Guess
  old_cr = cr(0,4);
