...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv4, %conv4, !dbg !94
  creg_r2 = max(creg_r1,creg_r1);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !67, metadata !DIExpression()), !dbg !98

  //   %add = add nsw i32 %xor, 1, !dbg !95
  creg_r3 = max(creg_r2,0);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !68, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !69, metadata !DIExpression()), !dbg !115

  //   %conv5 = sext i32 %add to i64, !dbg !97

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !71, metadata !DIExpression()), !dbg !115

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !99
  // ST: Guess
  iw(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0+3*1);
  cw(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !75, metadata !DIExpression()), !dbg !98

  //   %tobool12 = icmp ne i32 %conv11, 0, !dbg !103

  //   br i1 %tobool12, label %if.then13, label %if.else14, !dbg !105
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !128

  //   %conv18 = trunc i64 %3 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !79, metadata !DIExpression()), !dbg !98

  //   %cmp = icmp eq i32 %conv, 1, !dbg !112

  //   %conv19 = zext i1 %cmp to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !83, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !84, metadata !DIExpression()), !dbg !132

  //   %4 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !86, metadata !DIExpression()), !dbg !132
  ...
  //   %cmp23 = icmp eq i32 %conv11, 2, !dbg !115

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !87, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !88, metadata !DIExpression()), !dbg !135

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %5, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !117
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv18, 0, !dbg !118

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !91, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !92, metadata !DIExpression()), !dbg !138

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %6, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !120
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !170, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !223

  //   store atomic i64 0, i64* @atom_1_X7_2 monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !173, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !196, metadata !DIExpression()), !dbg !252

  //   %8 = load atomic i64, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !200, metadata !DIExpression()), !dbg !255
