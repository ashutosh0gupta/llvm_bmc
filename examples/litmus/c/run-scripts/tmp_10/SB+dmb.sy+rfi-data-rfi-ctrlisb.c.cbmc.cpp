...
T2BLOCK1:
  ...
  //   %conv3 = sext i32 %add to i64, !dbg !87

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !81, metadata !DIExpression()), !dbg !114

  //   store atomic i64 %conv3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !83, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !85, metadata !DIExpression()), !dbg !116

  //   %conv7 = trunc i64 %1 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !82, metadata !DIExpression()), !dbg !104

  //   %tobool = icmp ne i32 %conv7, 0, !dbg !91
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !89, metadata !DIExpression()), !dbg !126

  //   %conv11 = trunc i64 %2 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !86, metadata !DIExpression()), !dbg !104

  //   %cmp = icmp eq i32 %conv, 1, !dbg !101

  //   %conv12 = zext i1 %cmp to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !90, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !91, metadata !DIExpression()), !dbg !130

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !93, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !103
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv7, 1, !dbg !104

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !94, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !95, metadata !DIExpression()), !dbg !133

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !97, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %4, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv11, 0, !dbg !107

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !98, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !99, metadata !DIExpression()), !dbg !136

  //   %5 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !101, metadata !DIExpression()), !dbg !136
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !162, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !190, metadata !DIExpression()), !dbg !252
