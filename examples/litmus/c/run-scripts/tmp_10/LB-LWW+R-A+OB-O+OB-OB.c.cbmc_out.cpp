...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !145, metadata !DIExpression()), !dbg !186

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !146, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !159, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !163, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !166, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !169, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !173, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !176, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !178, metadata !DIExpression()), !dbg !180

  //   %and22 = and i32 %conv20, %and21, !dbg !134
  creg_r14 = max(creg__r8__3_,creg_r13);
  r14 = (r8==3) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !179, metadata !DIExpression()), !dbg !180
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
