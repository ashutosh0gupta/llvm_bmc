...
T2BLOCK10:
  ...
  //   store i32 %conv25, i32* @atom_1_X4_1, align 4, !dbg !117, !tbaa !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !173, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !190, metadata !DIExpression()), !dbg !239
  ...
  //   %8 = load i32, i32* @atom_1_X4_1, align 4, !dbg !143, !tbaa !141
  // LD: Guess
  old_cr = cr(0,6);
