...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !75, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !97, metadata !DIExpression()), !dbg !134

  //   %8 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !99, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %8, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !101, metadata !DIExpression()), !dbg !137

  //   %9 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !103, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %9, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !119
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !186, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !212, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !216, metadata !DIExpression()), !dbg !279
