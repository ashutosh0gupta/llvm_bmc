...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !83
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !96, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !98, metadata !DIExpression()), !dbg !112

  //   %conv = trunc i64 %0 to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !95, metadata !DIExpression()), !dbg !109

  //   %cmp = icmp eq i32 %conv, 0, !dbg !60

  //   %conv1 = zext i1 %cmp to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !99, metadata !DIExpression()), !dbg !109
...
T3BLOCK2:
  //   br label %lbl_label84, !dbg !64
  goto T3BLOCK4;

T3BLOCK3:
  //   br label %lbl_label84, !dbg !65
  goto T3BLOCK4;

T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !108), !dbg !121

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !100, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !103, metadata !DIExpression()), !dbg !109
