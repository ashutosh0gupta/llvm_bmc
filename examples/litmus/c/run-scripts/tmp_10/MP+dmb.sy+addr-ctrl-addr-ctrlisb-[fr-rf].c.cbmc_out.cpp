...
T1BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !51
  // ST: Guess
...
T2BLOCK4:
  ...
  //   %add11 = add nsw i32 4, %xor9, !dbg !92
  creg_r7 = max(0,creg_r6);
  r7 = 4 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !92

  //   %arrayidx13 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !92
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !74, metadata !DIExpression()), !dbg !112

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !112

  //   %conv16 = trunc i64 %3 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !73, metadata !DIExpression()), !dbg !91

  //   %tobool17 = icmp ne i32 %conv16, 0, !dbg !95
  creg__r9__0_ = max(0,creg_r9);

  //   br i1 %tobool17, label %if.then18, label %if.else19, !dbg !97
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !77, metadata !DIExpression()), !dbg !91
  ...
  //   %cmp29 = icmp eq i32 %conv23, 0, !dbg !114
  ...
  //   store i32 %conv30, i32* @atom_1_X10_0, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv27, 1, !dbg !116
  ...
  //   store i32 %conv32, i32* @atom_1_X12_1, align 4, !dbg !117, !tbaa !110
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !141, metadata !DIExpression()), !dbg !148
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !185, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !227

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X12_1, metadata !188, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !229

  //   store atomic i32 0, i32* @atom_1_X12_1 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !135
  ...
  //   %9 = load i32, i32* @atom_1_X10_0, align 4, !dbg !139, !tbaa !137
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %10 = load i32, i32* @atom_1_X12_1, align 4, !dbg !140, !tbaa !137
  // LD: Guess
  old_cr = cr(0,7);
