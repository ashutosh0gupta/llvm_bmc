...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !130
  ...
  //   %cmp30 = icmp eq i32 %conv23, 0, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !90, metadata !DIExpression()), !dbg !140
  ...
  //   %cmp35 = icmp eq i32 %conv27, 1, !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_1, metadata !94, metadata !DIExpression()), !dbg !143

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %8, i64* @atom_1_X12_1 seq_cst, align 8, !dbg !125
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !149, metadata !DIExpression()), !dbg !156
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !192, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_1, metadata !195, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !213, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_1, metadata !217, metadata !DIExpression()), !dbg !274
