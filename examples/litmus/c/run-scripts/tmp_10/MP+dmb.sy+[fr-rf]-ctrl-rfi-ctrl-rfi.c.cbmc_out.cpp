...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !90
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !116
  ...
  //   %cmp21 = icmp eq i32 %conv8, 1, !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X5_1, align 4, !dbg !111, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !178, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !226

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X5_1, align 4, !dbg !149, !tbaa !146
  // LD: Guess
  old_cr = cr(0,5);
