...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !78, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !114
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !116
  ...
  //   store i32 %conv27, i32* @atom_1_X9_0, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv24, 1, !dbg !108
  ...
  //   store i32 %conv29, i32* @atom_1_X11_1, align 4, !dbg !109, !tbaa !102
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !133, metadata !DIExpression()), !dbg !140
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !174, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !214

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_1, metadata !177, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !216

  //   store atomic i32 0, i32* @atom_1_X11_1 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X9_0, align 4, !dbg !134, !tbaa !132
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X11_1, align 4, !dbg !135, !tbaa !132
  // LD: Guess
  old_cr = cr(0,6);
