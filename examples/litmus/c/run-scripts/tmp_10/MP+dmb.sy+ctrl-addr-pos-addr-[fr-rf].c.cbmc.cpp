...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !213

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !215

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !217

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !165, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !166, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !169, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !172, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !175, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !178, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !181, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !230

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !184, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !232

  //   store atomic i64 0, i64* @atom_1_X11_1 monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !190, metadata !DIExpression()), !dbg !247

  //   %conv = trunc i64 %6 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !187, metadata !DIExpression()), !dbg !213

  //   %cmp = icmp eq i32 %conv, 2, !dbg !134

  //   %conv18 = zext i1 %cmp to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !191, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !195, metadata !DIExpression()), !dbg !251

  //   %conv22 = trunc i64 %7 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !192, metadata !DIExpression()), !dbg !213

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !138

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !196, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !200, metadata !DIExpression()), !dbg !255

  //   %conv28 = trunc i64 %8 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !197, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !202, metadata !DIExpression()), !dbg !258

  //   %9 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !143
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !204, metadata !DIExpression()), !dbg !258

  //   %conv32 = trunc i64 %9 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !201, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !206, metadata !DIExpression()), !dbg !261

  //   %10 = load atomic i64, i64* @atom_1_X11_1 seq_cst, align 8, !dbg !146
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !208, metadata !DIExpression()), !dbg !261

  //   %conv36 = trunc i64 %10 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !205, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !210, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !211, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !212, metadata !DIExpression()), !dbg !213
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
