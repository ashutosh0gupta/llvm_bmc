...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv8, 0, !dbg !100
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !104), !dbg !124

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !75, metadata !DIExpression()), !dbg !125

  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !107
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !125

  //   %conv12 = trunc i64 %3 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !106

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !109
  creg_r7 = max(creg_r6,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !78, metadata !DIExpression()), !dbg !106

  //   %add15 = add nsw i32 4, %xor13, !dbg !110
  ...
  //   %arrayidx17 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !110
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !80, metadata !DIExpression()), !dbg !130

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !130

  //   %conv20 = trunc i64 %4 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !79, metadata !DIExpression()), !dbg !106

  //   %tobool21 = icmp ne i32 %conv20, 0, !dbg !113

  //   br i1 %tobool21, label %if.then22, label %if.else23, !dbg !115
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
  ASSUME(cctrl[2] >= creg_r10);
  ASSUME(cctrl[2] >= 0);
  if((r10!=0)) {
    goto T2BLOCK5;
  } else {
...
T2BLOCK5:
  //   br label %lbl_LC01, !dbg !116
  goto T2BLOCK7;

T2BLOCK6:
  //   br label %lbl_LC01, !dbg !117
  goto T2BLOCK7;

T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !105), !dbg !137

  //   call void (...) @isb(), !dbg !119
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !139

  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !92, metadata !DIExpression()), !dbg !146

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %7, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !96, metadata !DIExpression()), !dbg !149

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %8, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !131
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !201, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !204, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !230, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !234, metadata !DIExpression()), !dbg !303
