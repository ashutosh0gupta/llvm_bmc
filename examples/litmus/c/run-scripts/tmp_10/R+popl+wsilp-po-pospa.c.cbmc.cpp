...
T2BLOCK1:
  ...
  //   store i32 %conv7, i32* @atom_1_X3_0, align 4, !dbg !71, !tbaa !72
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !131, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !165

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X3_0, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
