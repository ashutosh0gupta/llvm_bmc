...
T2BLOCK7:
  ...
  //   %cmp23 = icmp eq i32 %conv19, 1, !dbg !104
  ...
  //   store i32 %conv24, i32* @atom_1_X7_1, align 4, !dbg !105, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !163, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !167, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !170, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !177, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !182, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !187, metadata !DIExpression()), !dbg !190

  //   %and24 = and i32 %conv22, %and23, !dbg !133
  creg_r16 = max(creg__r10__1_,creg_r15);
  r16 = (r10==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !188, metadata !DIExpression()), !dbg !190

  //   %and25 = and i32 %conv16, %and24, !dbg !134
  creg_r17 = max(creg__r9__2_,creg_r16);
  r17 = (r9==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !189, metadata !DIExpression()), !dbg !190
