...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv20, 0, !dbg !94
...
T2BLOCK4:
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !119
  ...
  //   %cmp26 = icmp eq i32 %conv16, 0, !dbg !109
  ...
  //   store i32 %conv27, i32* @atom_1_X7_0, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv20, 1, !dbg !111
  ...
  //   store i32 %conv29, i32* @atom_1_X9_1, align 4, !dbg !112, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !179, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !182, metadata !DIExpression()), !dbg !232
