...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !213, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !273

  //   store atomic i64 0, i64* @atom_4_X0_1 monotonic, align 8, !dbg !132
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !216, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !218, metadata !DIExpression()), !dbg !275

  //   store atomic i64 0, i64* @atom_0_X0_1 monotonic, align 8, !dbg !134
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !219, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !222, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !225, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !229, metadata !DIExpression()), !dbg !302

  //   %10 = load atomic i64, i64* @atom_4_X0_1 seq_cst, align 8, !dbg !161
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !233, metadata !DIExpression()), !dbg !305

  //   %11 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !164
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !241, metadata !DIExpression()), !dbg !311
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !245, metadata !DIExpression()), !dbg !314
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 110, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !182
