...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !100

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !71, metadata !DIExpression()), !dbg !100
  ...
  //   %conv13 = zext i1 %cmp to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !80, metadata !DIExpression()), !dbg !86

  //   store i32 %conv13, i32* @atom_1_X2_2, align 4, !dbg !91, !tbaa !92
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 0, !dbg !96
  creg__r1__0_ = max(0,creg_r1);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !81, metadata !DIExpression()), !dbg !86

  //   store i32 %conv15, i32* @atom_1_X3_0, align 4, !dbg !97, !tbaa !92
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 0, !dbg !98
  ...
  //   store i32 %conv17, i32* @atom_1_X5_0, align 4, !dbg !99, !tbaa !92
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv12, 1, !dbg !100
  ...
  //   store i32 %conv19, i32* @atom_1_X6_1, align 4, !dbg !101, !tbaa !92
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !125, metadata !DIExpression()), !dbg !132

  //   call void @llvm.dbg.value(metadata i64 1, metadata !127, metadata !DIExpression()), !dbg !132
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !142, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !143, metadata !DIExpression()), !dbg !188

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !91

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !91

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !144, metadata !DIExpression()), !dbg !190

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !148, metadata !DIExpression()), !dbg !192

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !149, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !156, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !160, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !163, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !166, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !170, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !169, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !173, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !177, metadata !DIExpression()), !dbg !222

  //   %conv20 = trunc i64 %7 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !174, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !178, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !183, metadata !DIExpression()), !dbg !188

  //   %and23 = and i32 %9, %and, !dbg !137
  creg_r15 = max(creg_r11,creg_r14);
  r15 = r11 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !184, metadata !DIExpression()), !dbg !188

  //   %and24 = and i32 %8, %and23, !dbg !138
  creg_r16 = max(creg_r10,creg_r15);
  r16 = r10 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !185, metadata !DIExpression()), !dbg !188

  //   %and25 = and i32 %conv22, %and24, !dbg !139
  creg_r17 = max(creg__r9__2_,creg_r16);
  r17 = (r9==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !186, metadata !DIExpression()), !dbg !188

  //   %and26 = and i32 %conv16, %and25, !dbg !140
  creg_r18 = max(creg__r8__2_,creg_r17);
  r18 = (r8==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !187, metadata !DIExpression()), !dbg !188
