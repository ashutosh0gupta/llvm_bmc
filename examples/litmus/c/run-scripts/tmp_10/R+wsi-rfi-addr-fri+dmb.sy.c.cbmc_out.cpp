...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_0, metadata !134, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i32 0, metadata !136, metadata !DIExpression()), !dbg !168

  //   store atomic i32 0, i32* @atom_0_X5_0 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_0_X5_0, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
