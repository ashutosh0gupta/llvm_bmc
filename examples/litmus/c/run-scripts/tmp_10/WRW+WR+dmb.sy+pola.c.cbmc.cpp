...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !96
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !110, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !111, metadata !DIExpression()), !dbg !145

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !112, metadata !DIExpression()), !dbg !147

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !116, metadata !DIExpression()), !dbg !149

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !117, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !118, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !124, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !127, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !133, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !138, metadata !DIExpression()), !dbg !177

  //   %conv16 = trunc i64 %7 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !135, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !140, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !142, metadata !DIExpression()), !dbg !180

  //   %conv20 = trunc i64 %8 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !139, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !144, metadata !DIExpression()), !dbg !145
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !118
