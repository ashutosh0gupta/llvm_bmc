...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !96, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !97, metadata !DIExpression()), !dbg !110
  ...
  // ST: Guess
  iw(3,r5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l43_c3
  old_cw = cw(3,r5);
  cw(3,r5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l43_c3
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
