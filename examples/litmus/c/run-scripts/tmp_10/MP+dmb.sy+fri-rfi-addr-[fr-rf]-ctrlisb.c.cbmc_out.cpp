...
T2BLOCK1:
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !87
  r4 = 0+r3*1;
  creg_r4 = creg_r3;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !107
...
T2BLOCK4:
  ...
  //   store i32 %conv19, i32* @atom_1_X3_2, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   store i32 %conv21, i32* @atom_1_X5_0, align 4, !dbg !112, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !178, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !181, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !234

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X5_0, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
