...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !66, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64 1, metadata !68, metadata !DIExpression()), !dbg !95

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !96

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !72, metadata !DIExpression()), !dbg !96

  //   %conv4 = trunc i64 %1 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !69, metadata !DIExpression()), !dbg !87
  ...
  //   %cmp18 = icmp eq i32 %conv4, 1, !dbg !93
  ...
  //   store i32 %conv19, i32* @atom_1_X5_1, align 4, !dbg !94, !tbaa !89
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !160, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i32 0, metadata !162, metadata !DIExpression()), !dbg !209

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X5_1, align 4, !dbg !148, !tbaa !146
  // LD: Guess
  old_cr = cr(0,4);
