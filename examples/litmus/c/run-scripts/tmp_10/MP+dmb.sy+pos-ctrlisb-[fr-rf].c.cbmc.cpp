...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv4, 0, !dbg !73
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !82), !dbg !97

  //   call void (...) @isb(), !dbg !79
  // isb: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 0, !dbg !94
  ...
  //   store i32 %conv17, i32* @atom_1_X3_0, align 4, !dbg !95, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !159, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !199

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !106
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X3_0, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
