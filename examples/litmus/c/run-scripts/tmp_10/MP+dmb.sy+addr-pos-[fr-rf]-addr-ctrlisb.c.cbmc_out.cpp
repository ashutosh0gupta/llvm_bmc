...
T2BLOCK4:
  ...
  //   %cmp26 = icmp eq i32 %conv4, 0, !dbg !113
  ...
  //   store i32 %conv27, i32* @atom_1_X3_0, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv8, 0, !dbg !115
  ...
  //   store i32 %conv29, i32* @atom_1_X5_0, align 4, !dbg !116, !tbaa !109
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv12, 1, !dbg !117
  ...
  //   store i32 %conv31, i32* @atom_1_X6_1, align 4, !dbg !118, !tbaa !109
  // ST: Guess
  ...
  //   store i32 %conv33, i32* @atom_1_X10_0, align 4, !dbg !120, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !185, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !188, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !191, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !194, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !198, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !203, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !208, metadata !DIExpression()), !dbg !268
