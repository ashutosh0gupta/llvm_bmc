...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !124

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !80, metadata !DIExpression()), !dbg !111

  //   %add15 = add nsw i32 3, %xor13, !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !82, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !129

  //   %conv20 = trunc i64 %4 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !81, metadata !DIExpression()), !dbg !111

  //   %tobool = icmp ne i32 %conv20, 0, !dbg !112
...
T2BLOCK4:
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv24 = trunc i64 %5 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !85, metadata !DIExpression()), !dbg !111

  //   %cmp = icmp eq i32 %conv, 1, !dbg !122

  //   %conv25 = zext i1 %cmp to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !89, metadata !DIExpression()), !dbg !111
  ...
  //   %cmp27 = icmp eq i32 %conv4, 0, !dbg !125

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !93, metadata !DIExpression()), !dbg !111
  ...
  //   %cmp32 = icmp eq i32 %conv8, 0, !dbg !128

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !97, metadata !DIExpression()), !dbg !111
  ...
  //   store atomic i64 %8, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv12, 1, !dbg !131

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !101, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !102, metadata !DIExpression()), !dbg !151

  //   %9 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !104, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %9, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !133
  // ST: Guess
  ...
  //   %cmp42 = icmp eq i32 %conv24, 0, !dbg !134

  //   %conv43 = zext i1 %cmp42 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv43, metadata !105, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !106, metadata !DIExpression()), !dbg !154

  //   %10 = zext i32 %conv43 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !108, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %10, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !136
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !177, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !178, metadata !DIExpression()), !dbg !254

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !179, metadata !DIExpression()), !dbg !256

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !126

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !126

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !183, metadata !DIExpression()), !dbg !258

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !128

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !128

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !184, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !185, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !197, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !200, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !271

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !141
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !203, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !273

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !143
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !206, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !275

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !145
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !209, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !213, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !215, metadata !DIExpression()), !dbg !292

  //   %conv = trunc i64 %6 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !212, metadata !DIExpression()), !dbg !254

  //   %cmp = icmp eq i32 %conv, 1, !dbg !164

  //   %conv22 = zext i1 %cmp to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !216, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !218, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !220, metadata !DIExpression()), !dbg !296

  //   %conv26 = trunc i64 %7 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !217, metadata !DIExpression()), !dbg !254

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !168

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !221, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !223, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !225, metadata !DIExpression()), !dbg !300

  //   %conv32 = trunc i64 %8 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !222, metadata !DIExpression()), !dbg !254

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !172

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !172

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !226, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !228, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !230, metadata !DIExpression()), !dbg !304

  //   %conv38 = trunc i64 %9 to i32, !dbg !175

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !227, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !232, metadata !DIExpression()), !dbg !307

  //   %10 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !177
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !234, metadata !DIExpression()), !dbg !307

  //   %conv42 = trunc i64 %10 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !231, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !236, metadata !DIExpression()), !dbg !310

  //   %11 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !180
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !238, metadata !DIExpression()), !dbg !310

  //   %conv46 = trunc i64 %11 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !235, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !240, metadata !DIExpression()), !dbg !313

  //   %12 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !183
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !242, metadata !DIExpression()), !dbg !313

  //   %conv50 = trunc i64 %12 to i32, !dbg !184

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !239, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !244, metadata !DIExpression()), !dbg !316
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !246, metadata !DIExpression()), !dbg !316

  //   %conv54 = trunc i64 %13 to i32, !dbg !187

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !243, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !247, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !248, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !249, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !250, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !251, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !252, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !253, metadata !DIExpression()), !dbg !254
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 102, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !198
