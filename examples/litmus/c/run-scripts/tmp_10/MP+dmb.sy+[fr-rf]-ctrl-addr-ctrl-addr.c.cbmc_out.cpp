...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !106

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !115

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !97
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !70, metadata !DIExpression()), !dbg !115

  //   %conv8 = trunc i64 %2 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !67, metadata !DIExpression()), !dbg !100

  //   %xor = xor i32 %conv8, %conv8, !dbg !99
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !71, metadata !DIExpression()), !dbg !100
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !100
  r5 = 0+r4*1;
  ASSUME(creg_r5 >= 0);
  ...
  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,r5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !120

  //   %conv12 = trunc i64 %3 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !72, metadata !DIExpression()), !dbg !100

  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !103

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !105
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !99), !dbg !127

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !77, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !79, metadata !DIExpression()), !dbg !128

  //   %conv19 = trunc i64 %4 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !76, metadata !DIExpression()), !dbg !100

  //   %xor20 = xor i32 %conv19, %conv19, !dbg !112
  creg_r8 = max(creg_r7,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor20, metadata !80, metadata !DIExpression()), !dbg !100

  //   %add22 = add nsw i32 0, %xor20, !dbg !113
  creg_r9 = max(0,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = 0 + r8;

  //   %idxprom23 = sext i32 %add22 to i64, !dbg !113

  //   %arrayidx24 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom23, !dbg !113
  r10 = 0+r9*1;
  ASSUME(creg_r10 >= 0);
  ASSUME(creg_r10 >= creg_r9);
  ASSUME(active[creg_r10] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx24, metadata !82, metadata !DIExpression()), !dbg !133

  //   %5 = load atomic i64, i64* %arrayidx24 monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !133
  ...
  //   %cmp30 = icmp eq i32 %conv4, 2, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !90, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %7, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv27, 0, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !94, metadata !DIExpression()), !dbg !142

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %8, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64 2, metadata !150, metadata !DIExpression()), !dbg !155

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !47
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !191, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !242

  //   store atomic i64 0, i64* @atom_1_X2_2 monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !194, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !244

  //   store atomic i64 0, i64* @atom_1_X11_0 monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !212, metadata !DIExpression()), !dbg !270

  //   %9 = load atomic i64, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !216, metadata !DIExpression()), !dbg !273

  //   %10 = load atomic i64, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,7);
