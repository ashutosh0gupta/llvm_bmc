...
T2BLOCK7:
  ...
  //   %xor20 = xor i32 %conv19, %conv19, !dbg !103
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor20, metadata !80, metadata !DIExpression()), !dbg !91

  //   %add22 = add nsw i32 0, %xor20, !dbg !104
  creg_r9 = max(0,creg_r8);
  r9 = 0 + r8;

  //   %idxprom23 = sext i32 %add22 to i64, !dbg !104

  //   %arrayidx24 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom23, !dbg !104
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx24, metadata !82, metadata !DIExpression()), !dbg !124

  //   %5 = load atomic i64, i64* %arrayidx24 monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !84, metadata !DIExpression()), !dbg !124

  //   %conv27 = trunc i64 %5 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !81, metadata !DIExpression()), !dbg !91

  //   %cmp = icmp eq i32 %conv, 1, !dbg !107
  creg__r0__1_ = max(0,creg_r0);

  //   %conv28 = zext i1 %cmp to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !85, metadata !DIExpression()), !dbg !91

  //   store i32 %conv28, i32* @atom_1_X0_1, align 4, !dbg !108, !tbaa !109
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv4, 2, !dbg !113
  creg__r1__2_ = max(0,creg_r1);

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !86, metadata !DIExpression()), !dbg !91

  //   store i32 %conv30, i32* @atom_1_X2_2, align 4, !dbg !114, !tbaa !109
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv27, 0, !dbg !115
  creg__r11__0_ = max(0,creg_r11);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv32, i32* @atom_1_X11_0, align 4, !dbg !116, !tbaa !109
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !140, metadata !DIExpression()), !dbg !147
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !157, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !158, metadata !DIExpression()), !dbg !207

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !159, metadata !DIExpression()), !dbg !209

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !163, metadata !DIExpression()), !dbg !211

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !164, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !165, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !168, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !171, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !174, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !180, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !184, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !187, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !228

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !191, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !193, metadata !DIExpression()), !dbg !241

  //   %conv = trunc i64 %6 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !190, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !194, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !196, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !198, metadata !DIExpression()), !dbg !245

  //   %conv24 = trunc i64 %7 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !195, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !199, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !200, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !201, metadata !DIExpression()), !dbg !207

  //   %10 = load i32, i32* @atom_1_X11_0, align 4, !dbg !140, !tbaa !137
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !202, metadata !DIExpression()), !dbg !207

  //   %and = and i32 %9, %10, !dbg !141
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !203, metadata !DIExpression()), !dbg !207

  //   %and27 = and i32 %8, %and, !dbg !142
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !204, metadata !DIExpression()), !dbg !207

  //   %and28 = and i32 %conv26, %and27, !dbg !143
  creg_r23 = max(creg__r17__2_,creg_r22);
  r23 = (r17==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !205, metadata !DIExpression()), !dbg !207

  //   %and29 = and i32 %conv20, %and28, !dbg !144
  creg_r24 = max(creg__r16__1_,creg_r23);
  r24 = (r16==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !206, metadata !DIExpression()), !dbg !207
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([122 x i8], [122 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !148
