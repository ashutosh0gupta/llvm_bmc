...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !46, metadata !DIExpression()), !dbg !70

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !71
  // LD: Guess
  old_cr = cr(1,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !48, metadata !DIExpression()), !dbg !70
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !61), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !49, metadata !DIExpression()), !dbg !79

  //   call void @llvm.dbg.value(metadata i64 1, metadata !51, metadata !DIExpression()), !dbg !79

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !80
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !53, metadata !DIExpression()), !dbg !81

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(1,0+3*1);
  ...
  //   %conv10 = trunc i64 %2 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !52, metadata !DIExpression()), !dbg !62

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !84

  //   %conv11 = zext i1 %cmp to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !56, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X8_2, metadata !57, metadata !DIExpression()), !dbg !85

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !59, metadata !DIExpression()), !dbg !85

  //   store atomic i64 %3, i64* @atom_0_X8_2 seq_cst, align 8, !dbg !86
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !93, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !99, metadata !DIExpression()), !dbg !112
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !122, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !123, metadata !DIExpression()), !dbg !168

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !124, metadata !DIExpression()), !dbg !170

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !89

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !89

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !128, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !129, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64 0, metadata !131, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !132, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !135, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !138, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X8_2, metadata !141, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !181

  //   store atomic i64 0, i64* @atom_0_X8_2 monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !144, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !148, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !150, metadata !DIExpression()), !dbg !195

  //   %conv = trunc i64 %4 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !147, metadata !DIExpression()), !dbg !168

  //   %cmp = icmp eq i32 %conv, 2, !dbg !116

  //   %conv14 = zext i1 %cmp to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !151, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !155, metadata !DIExpression()), !dbg !199

  //   %conv18 = trunc i64 %5 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !152, metadata !DIExpression()), !dbg !168

  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !120

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !156, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X8_2, metadata !158, metadata !DIExpression()), !dbg !203

  //   %6 = load atomic i64, i64* @atom_0_X8_2 seq_cst, align 8, !dbg !122
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !160, metadata !DIExpression()), !dbg !203

  //   %conv24 = trunc i64 %6 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !157, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !162, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !164, metadata !DIExpression()), !dbg !206

  //   %conv28 = trunc i64 %7 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !161, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !166, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !167, metadata !DIExpression()), !dbg !168
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !133
