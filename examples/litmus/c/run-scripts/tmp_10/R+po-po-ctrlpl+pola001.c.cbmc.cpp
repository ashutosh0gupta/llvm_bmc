...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !46, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !48, metadata !DIExpression()), !dbg !67
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !58), !dbg !75

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !49, metadata !DIExpression()), !dbg !76

  //   call void @llvm.dbg.value(metadata i64 1, metadata !51, metadata !DIExpression()), !dbg !76

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !77
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !53, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !52, metadata !DIExpression()), !dbg !59
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !56, metadata !DIExpression()), !dbg !59

  //   store i32 %conv11, i32* @atom_0_X8_2, align 4, !dbg !82, !tbaa !83
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !105
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X8_2, metadata !137, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !141, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !145, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !150, metadata !DIExpression()), !dbg !188
