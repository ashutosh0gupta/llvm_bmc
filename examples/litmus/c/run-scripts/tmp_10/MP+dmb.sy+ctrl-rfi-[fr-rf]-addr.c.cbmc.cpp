...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !59, metadata !DIExpression()), !dbg !99
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !102

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !64, metadata !DIExpression()), !dbg !102

  //   %conv = trunc i64 %0 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !60, metadata !DIExpression()), !dbg !99
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !65, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64 1, metadata !67, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !113

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !99

  //   %xor = xor i32 %conv8, %conv8, !dbg !100
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !76, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !77, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 1, !dbg !104

  //   %conv13 = zext i1 %cmp to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !81, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !82, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !85, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !86, metadata !DIExpression()), !dbg !127
  ...
  //   %cmp22 = icmp eq i32 %conv8, 2, !dbg !110

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !89, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !90, metadata !DIExpression()), !dbg !130

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %6, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !93, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !94, metadata !DIExpression()), !dbg !133
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !179, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !239

  //   store atomic i64 0, i64* @atom_1_X5_2 monotonic, align 8, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !182, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !205, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !209, metadata !DIExpression()), !dbg !274

  //   %11 = load atomic i64, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !163
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !213, metadata !DIExpression()), !dbg !277

  //   %12 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !166
  // LD: Guess
  old_cr = cr(0,6);
