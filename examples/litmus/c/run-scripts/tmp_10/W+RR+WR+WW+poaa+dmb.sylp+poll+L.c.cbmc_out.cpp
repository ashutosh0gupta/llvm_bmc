...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !85, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !89, metadata !DIExpression()), !dbg !100
  ...
  //   store i32 %conv1, i32* @atom_2_X2_0, align 4, !dbg !59, !tbaa !60
  // ST: Guess
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !108, metadata !DIExpression()), !dbg !116
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !109, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 1, metadata !111, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !112, metadata !DIExpression()), !dbg !121
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !156, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !189

  //   store atomic i32 0, i32* @atom_2_X2_0 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_2_X2_0, align 4, !dbg !126, !tbaa !123
  // LD: Guess
  old_cr = cr(0,5);
