...
T1BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !55
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !67, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 2, metadata !69, metadata !DIExpression()), !dbg !99

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !71, metadata !DIExpression()), !dbg !101

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()), !dbg !101

  //   %conv4 = trunc i64 %1 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !70, metadata !DIExpression()), !dbg !93
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !113

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !113

  //   %conv12 = trunc i64 %3 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !78, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !116

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !116
  ...
  //   %conv17 = zext i1 %cmp to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !86, metadata !DIExpression()), !dbg !93

  //   store i32 %conv17, i32* @atom_1_X0_1, align 4, !dbg !101, !tbaa !102
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv4, 2, !dbg !106
  ...
  //   store i32 %conv19, i32* @atom_1_X3_2, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv8, 2, !dbg !108
  ...
  //   store i32 %conv21, i32* @atom_1_X4_2, align 4, !dbg !109, !tbaa !102
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv12, 0, !dbg !110
  ...
  //   store i32 %conv23, i32* @atom_1_X5_0, align 4, !dbg !111, !tbaa !102
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv16, 1, !dbg !112
  ...
  //   store i32 %conv25, i32* @atom_1_X7_1, align 4, !dbg !113, !tbaa !102
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !137, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64 1, metadata !139, metadata !DIExpression()), !dbg !144

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !52
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !154, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !155, metadata !DIExpression()), !dbg !205

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !156, metadata !DIExpression()), !dbg !207

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !160, metadata !DIExpression()), !dbg !209

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !161, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !212

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !214

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !168, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !216

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !109
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l65_c3
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l65_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !172, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !218

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !175, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !220

  //   store atomic i32 0, i32* @atom_1_X4_2 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !178, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !222

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !181, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !224

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !185, metadata !DIExpression()), !dbg !237

  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !187, metadata !DIExpression()), !dbg !237

  //   %conv = trunc i64 %6 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !184, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !188, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !190, metadata !DIExpression()), !dbg !241

  //   %7 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !136
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !192, metadata !DIExpression()), !dbg !241

  //   %conv22 = trunc i64 %7 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !189, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !193, metadata !DIExpression()), !dbg !205

  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !139, !tbaa !140
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l83_c13
  // Check
  ...
  //   %9 = load i32, i32* @atom_1_X3_2, align 4, !dbg !142, !tbaa !140
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l84_c13
  // Check
  ...
  //   %10 = load i32, i32* @atom_1_X4_2, align 4, !dbg !143, !tbaa !140
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X5_0, align 4, !dbg !144, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X7_1, align 4, !dbg !145, !tbaa !140
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %and = and i32 %11, %12, !dbg !146
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !199, metadata !DIExpression()), !dbg !205

  //   %and25 = and i32 %10, %and, !dbg !147
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !200, metadata !DIExpression()), !dbg !205

  //   %and26 = and i32 %9, %and25, !dbg !148
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !201, metadata !DIExpression()), !dbg !205

  //   %and27 = and i32 %8, %and26, !dbg !149
  creg_r19 = max(creg_r11,creg_r18);
  r19 = r11 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !202, metadata !DIExpression()), !dbg !205

  //   %and28 = and i32 %conv24, %and27, !dbg !150
  creg_r20 = max(creg__r10__2_,creg_r19);
  r20 = (r10==2) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !203, metadata !DIExpression()), !dbg !205

  //   %and29 = and i32 %conv18, %and28, !dbg !151
  creg_r21 = max(creg__r9__2_,creg_r20);
  r21 = (r9==2) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !204, metadata !DIExpression()), !dbg !205

  //   %cmp30 = icmp eq i32 %and29, 1, !dbg !152
  creg__r21__1_ = max(0,creg_r21);

  //   br i1 %cmp30, label %if.then, label %if.end, !dbg !154
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 94, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
