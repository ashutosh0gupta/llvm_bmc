...
T2BLOCK7:
  ...
  //   %xor = xor i32 %conv13, %conv13, !dbg !97
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !118
  ...
  //   %cmp19 = icmp eq i32 %conv13, 2, !dbg !107
  ...
  //   store i32 %conv20, i32* @atom_1_X7_2, align 4, !dbg !108, !tbaa !103
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv17, 0, !dbg !109
  ...
  //   store i32 %conv22, i32* @atom_1_X9_0, align 4, !dbg !110, !tbaa !103
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_2, metadata !161, metadata !DIExpression()), !dbg !205
