...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !77), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64 1, metadata !66, metadata !DIExpression()), !dbg !93

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !67, metadata !DIExpression()), !dbg !79

  //   %tobool7 = icmp ne i32 %conv6, 0, !dbg !79
  creg__r1__0_ = max(0,creg_r1);

  //   br i1 %tobool7, label %if.then8, label %if.else9, !dbg !81
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !79
  ...
  //   %cmp13 = icmp eq i32 %conv6, 1, !dbg !93
  creg__r1__1_ = max(0,creg_r1);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !75, metadata !DIExpression()), !dbg !79

  //   store i32 %conv14, i32* @atom_1_X5_1, align 4, !dbg !94, !tbaa !89
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !122, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !123, metadata !DIExpression()), !dbg !166

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !124, metadata !DIExpression()), !dbg !168

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !128, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !129, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !132, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !135, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !142, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !146, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !145, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !149, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !150, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !158, metadata !DIExpression()), !dbg !197

  //   %conv22 = trunc i64 %6 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !155, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !159, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !163, metadata !DIExpression()), !dbg !166

  //   %and26 = and i32 %conv18, %and25, !dbg !127
  creg_r12 = max(creg__r6__2_,creg_r11);
  r12 = (r6==2) & r11;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !164, metadata !DIExpression()), !dbg !166

  //   %and27 = and i32 %conv12, %and26, !dbg !128
  creg_r13 = max(creg__r5__2_,creg_r12);
  r13 = (r5==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !165, metadata !DIExpression()), !dbg !166
