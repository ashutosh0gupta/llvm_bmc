...
T1BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv6, 0, !dbg !73
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !58), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !53, metadata !DIExpression()), !dbg !79
  ...
  //   store i32 %conv9, i32* @atom_0_X3_2, align 4, !dbg !82, !tbaa !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_2, metadata !135, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !168

  //   store atomic i32 0, i32* @atom_0_X3_2 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !139, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !148, metadata !DIExpression()), !dbg !184
  ...
  //   %6 = load i32, i32* @atom_0_X3_2, align 4, !dbg !111, !tbaa !112
  // LD: Guess
  old_cr = cr(0,3);
