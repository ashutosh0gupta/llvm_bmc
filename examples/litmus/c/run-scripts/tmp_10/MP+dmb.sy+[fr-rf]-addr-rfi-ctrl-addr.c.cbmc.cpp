...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !81, metadata !DIExpression()), !dbg !92

  //   %add15 = add nsw i32 0, %xor13, !dbg !98
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !98

  //   %arrayidx17 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !98
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !83, metadata !DIExpression()), !dbg !118

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,r9);
  cr(2,r9) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l39_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !118
  ...
  //   %cmp22 = icmp eq i32 %conv4, 2, !dbg !107
  ...
  //   store i32 %conv23, i32* @atom_1_X2_2, align 4, !dbg !108, !tbaa !103
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 1, !dbg !109
  ...
  //   store i32 %conv25, i32* @atom_1_X6_1, align 4, !dbg !110, !tbaa !103
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv20, 0, !dbg !111
  ...
  //   store i32 %conv27, i32* @atom_1_X10_0, align 4, !dbg !112, !tbaa !103
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !136, metadata !DIExpression()), !dbg !143
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !177, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !180, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !183, metadata !DIExpression()), !dbg !232
