...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !65, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !67, metadata !DIExpression()), !dbg !89

  //   %conv4 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !81
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !80), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !100

  //   %conv12 = trunc i64 %3 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !72, metadata !DIExpression()), !dbg !81

  //   %cmp = icmp eq i32 %conv, 1, !dbg !84
  creg__r0__1_ = max(0,creg_r0);

  //   %conv13 = zext i1 %cmp to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !76, metadata !DIExpression()), !dbg !81

  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !77, metadata !DIExpression()), !dbg !81

  //   store i32 %conv15, i32* @atom_1_X5_0, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv12, 0, !dbg !92
  creg__r6__0_ = max(0,creg_r6);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !78, metadata !DIExpression()), !dbg !81

  //   store i32 %conv17, i32* @atom_1_X7_0, align 4, !dbg !93, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !141, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !144, metadata !DIExpression()), !dbg !179
