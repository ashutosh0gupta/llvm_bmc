...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !111

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !111
  ...
  //   store i32 %conv23, i32* @atom_1_X4_0, align 4, !dbg !111, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !178, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !222

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X4_0, align 4, !dbg !144, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
