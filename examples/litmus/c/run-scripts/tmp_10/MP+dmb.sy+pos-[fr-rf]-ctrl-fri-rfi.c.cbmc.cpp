...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !193, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !252

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !222, metadata !DIExpression()), !dbg !286

  //   %11 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !163
  // LD: Guess
  old_cr = cr(0,5);
