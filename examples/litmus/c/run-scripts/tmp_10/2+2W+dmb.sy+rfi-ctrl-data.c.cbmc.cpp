...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !66, metadata !DIExpression()), !dbg !74

  //   %add = add nsw i32 %xor, 1, !dbg !73
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !67, metadata !DIExpression()), !dbg !74

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !68, metadata !DIExpression()), !dbg !93

  //   %conv7 = sext i32 %add to i64, !dbg !75

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !70, metadata !DIExpression()), !dbg !93

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   store i32 %conv8, i32* @atom_1_X2_2, align 4, !dbg !77, !tbaa !78
  // ST: Guess
