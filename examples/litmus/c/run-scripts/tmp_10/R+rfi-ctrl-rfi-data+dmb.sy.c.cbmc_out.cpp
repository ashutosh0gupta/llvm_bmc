...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !47, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64 1, metadata !49, metadata !DIExpression()), !dbg !77

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !78
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !51, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !54, metadata !DIExpression()), !dbg !63

  //   %add = add nsw i32 %xor, 1, !dbg !83
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !55, metadata !DIExpression()), !dbg !63
  ...
  //   %conv9 = sext i32 %add to i64, !dbg !85

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !58, metadata !DIExpression()), !dbg !84

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !85
  // ST: Guess
  ...
  //   %cmp11 = icmp eq i32 %conv6, 1, !dbg !92
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !126, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !127, metadata !DIExpression()), !dbg !175

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !128, metadata !DIExpression()), !dbg !177

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !132, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !133, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !136, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !139, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !142, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !145, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_1, metadata !146, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !149, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !156, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !157, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !161, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !162, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !166, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !171, metadata !DIExpression()), !dbg !175

  //   %and28 = and i32 %conv26, %and27, !dbg !137
  creg_r16 = max(creg__r10__2_,creg_r15);
  r16 = (r10==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !172, metadata !DIExpression()), !dbg !175
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 78, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
