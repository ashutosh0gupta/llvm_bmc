...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !47, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64 1, metadata !49, metadata !DIExpression()), !dbg !83

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !51, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !50, metadata !DIExpression()), !dbg !69

  //   %xor = xor i32 %conv6, %conv6, !dbg !88
  creg_r2 = max(creg_r1,creg_r1);
  ASSUME(active[creg_r2] == 1);
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !54, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !55, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !58, metadata !DIExpression()), !dbg !90
  ...
  //   %cmp14 = icmp eq i32 %conv6, 1, !dbg !95
