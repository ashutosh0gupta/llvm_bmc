...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !56, metadata !DIExpression()), !dbg !71
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !59, metadata !DIExpression()), !dbg !68

  //   %add = add nsw i32 2, %xor, !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !60, metadata !DIExpression()), !dbg !76

  //   call void @llvm.dbg.value(metadata i64 1, metadata !62, metadata !DIExpression()), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !63, metadata !DIExpression()), !dbg !77
  ...
  //   store i32 %conv3, i32* @atom_1_X0_1, align 4, !dbg !61, !tbaa !62
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !93, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !94, metadata !DIExpression()), !dbg !120

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !95, metadata !DIExpression()), !dbg !122

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !68

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !68

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !99, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !100, metadata !DIExpression()), !dbg !125

  //   call void @llvm.dbg.value(metadata i64 0, metadata !102, metadata !DIExpression()), !dbg !125

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !71
  // ST: Guess
  iw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l40_c3
  old_cw = cw(0,0+2*1);
  cw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l40_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !103, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 0, metadata !105, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !106, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i64 0, metadata !108, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !109, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i32 0, metadata !112, metadata !DIExpression()), !dbg !131

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !77
  // ST: Guess
  ...
  //   %call7 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !79
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call8 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !85
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !86, !tbaa !81
  r6 = local_mem[1];
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !114, metadata !DIExpression()), !dbg !141
  ...
  //   %conv = trunc i64 %4 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !113, metadata !DIExpression()), !dbg !120

  //   %cmp = icmp eq i32 %conv, 2, !dbg !91
  creg__r7__2_ = max(0,creg_r7);

  //   %conv10 = zext i1 %cmp to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !117, metadata !DIExpression()), !dbg !120

  //   %5 = load i32, i32* @atom_1_X0_1, align 4, !dbg !92, !tbaa !93
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 55, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !99
