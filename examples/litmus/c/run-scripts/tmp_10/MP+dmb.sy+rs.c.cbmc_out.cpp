...
T2BLOCK1:
  ...
  //   %add = add nsw i32 %conv, 0, !dbg !56
  creg_r1 = max(0,creg_r0);
  r1 = r0 + 0;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !61, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !63, metadata !DIExpression()), !dbg !76
  ...
  //   store i32 %conv5, i32* @atom_1_X4_1, align 4, !dbg !61, !tbaa !62
  // ST: Guess
  ...
  //   store i32 %conv7, i32* @atom_1_X0_0, align 4, !dbg !67, !tbaa !62
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !108, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i32 0, metadata !111, metadata !DIExpression()), !dbg !127

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_0, metadata !112, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i32 0, metadata !114, metadata !DIExpression()), !dbg !129

  //   store atomic i32 0, i32* @atom_1_X0_0 monotonic, align 4, !dbg !75
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_1_X4_1, align 4, !dbg !86, !tbaa !87
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %5 = load i32, i32* @atom_1_X0_0, align 4, !dbg !89, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
