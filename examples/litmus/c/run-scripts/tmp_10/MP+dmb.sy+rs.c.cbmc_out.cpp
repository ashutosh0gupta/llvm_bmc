...
T2BLOCK1:
  ...
  //   %add = add nsw i32 %conv, 0, !dbg !62
  creg_r1 = max(creg_r0,0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 + 0;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !61, metadata !DIExpression()), !dbg !75

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !63, metadata !DIExpression()), !dbg !82
  ...
  //   %cmp = icmp eq i32 %add, 1, !dbg !66

  //   %conv5 = zext i1 %cmp to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !66, metadata !DIExpression()), !dbg !75

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !67, metadata !DIExpression()), !dbg !86

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !69, metadata !DIExpression()), !dbg !86

  //   store atomic i64 %2, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_0, metadata !71, metadata !DIExpression()), !dbg !89

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !73, metadata !DIExpression()), !dbg !89

  //   store atomic i64 %3, i64* @atom_1_X0_0 seq_cst, align 8, !dbg !71
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !112, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64 0, metadata !114, metadata !DIExpression()), !dbg !136

  //   store atomic i64 0, i64* @atom_1_X4_1 monotonic, align 8, !dbg !78
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_0, metadata !115, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i64 0, metadata !117, metadata !DIExpression()), !dbg !138

  //   store atomic i64 0, i64* @atom_1_X0_0 monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !119, metadata !DIExpression()), !dbg !150

  //   %4 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_0, metadata !123, metadata !DIExpression()), !dbg !153

  //   %5 = load atomic i64, i64* @atom_1_X0_0 seq_cst, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([97 x i8], [97 x i8]* @.str.1, i64 0, i64 0), i32 noundef 56, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !101
