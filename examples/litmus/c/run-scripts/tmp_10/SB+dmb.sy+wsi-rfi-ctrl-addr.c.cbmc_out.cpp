...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !71, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !98
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !79, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !81, metadata !DIExpression()), !dbg !107

  //   %conv6 = trunc i64 %1 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !78, metadata !DIExpression()), !dbg !91

  //   %xor = xor i32 %conv6, %conv6, !dbg !82
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !82, metadata !DIExpression()), !dbg !91
  ...
  //   store i32 %conv11, i32* @atom_1_X3_2, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv10, 0, !dbg !92
  ...
  //   store i32 %conv13, i32* @atom_1_X7_0, align 4, !dbg !93, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !146, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !149, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X3_2, align 4, !dbg !123, !tbaa !121
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %8 = load i32, i32* @atom_1_X7_0, align 4, !dbg !124, !tbaa !121
  // LD: Guess
  old_cr = cr(0,5);
