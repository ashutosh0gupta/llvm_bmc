...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !84, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !90, metadata !DIExpression()), !dbg !121

  //   store atomic i64 %3, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !94
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv10, 0, !dbg !95

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !91, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !92, metadata !DIExpression()), !dbg !124

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !94, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %4, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !97
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !150, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !170, metadata !DIExpression()), !dbg !220
