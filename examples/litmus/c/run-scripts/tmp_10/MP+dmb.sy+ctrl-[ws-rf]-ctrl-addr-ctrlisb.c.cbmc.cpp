...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !63, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64 1, metadata !65, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !113

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !69, metadata !DIExpression()), !dbg !113

  //   %conv4 = trunc i64 %1 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !99

  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !97

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !99
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !97), !dbg !121
  ...
  //   %xor = xor i32 %conv11, %conv11, !dbg !106
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !99

  //   %add = add nsw i32 4, %xor, !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !127
  ...
  //   %conv15 = trunc i64 %3 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !75, metadata !DIExpression()), !dbg !99

  //   %tobool16 = icmp ne i32 %conv15, 0, !dbg !110

  //   br i1 %tobool16, label %if.then17, label %if.else18, !dbg !112
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK8:
  //   br label %lbl_LC02, !dbg !113
  goto T2BLOCK10;

T2BLOCK9:
  //   br label %lbl_LC02, !dbg !114
  goto T2BLOCK10;

T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !98), !dbg !134

  //   call void (...) @isb(), !dbg !116
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !136

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(2,0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !233

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !235

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !237

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !177, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !180, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !183, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !192, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !195, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !198, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !202, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !204, metadata !DIExpression()), !dbg !269

  //   %conv = trunc i64 %6 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !201, metadata !DIExpression()), !dbg !233

  //   %cmp = icmp eq i32 %conv, 1, !dbg !145

  //   %conv20 = zext i1 %cmp to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !205, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !207, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !209, metadata !DIExpression()), !dbg !273

  //   %conv24 = trunc i64 %7 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !206, metadata !DIExpression()), !dbg !233

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !149

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !210, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !212, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !214, metadata !DIExpression()), !dbg !277

  //   %conv30 = trunc i64 %8 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !211, metadata !DIExpression()), !dbg !233

  //   %cmp31 = icmp eq i32 %conv30, 2, !dbg !153

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !215, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !217, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !219, metadata !DIExpression()), !dbg !281

  //   %conv36 = trunc i64 %9 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !216, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !221, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !223, metadata !DIExpression()), !dbg !284

  //   %conv40 = trunc i64 %10 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !220, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !225, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !227, metadata !DIExpression()), !dbg !287

  //   %conv44 = trunc i64 %11 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !224, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !229, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !230, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !231, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !232, metadata !DIExpression()), !dbg !233
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 94, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
