...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !78, metadata !DIExpression()), !dbg !85

  //   %add = add nsw i32 %xor, 1, !dbg !54
  creg_r2 = max(0,creg_r1);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !79, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !93

  //   %conv1 = sext i32 %add to i64, !dbg !56

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !82, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !83, metadata !DIExpression()), !dbg !85
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !116, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !117, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !120, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !123, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !126, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i32 0, metadata !129, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !133, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !134, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !138, metadata !DIExpression()), !dbg !173

  //   %conv16 = trunc i64 %7 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !135, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !139, metadata !DIExpression()), !dbg !143
