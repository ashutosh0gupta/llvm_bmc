...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !39, metadata !DIExpression()), !dbg !50
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !43, metadata !DIExpression()), !dbg !53
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !58, metadata !DIExpression()), !dbg !76
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !60, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !59, metadata !DIExpression()), !dbg !76

  //   %xor = xor i32 %conv, %conv, !dbg !63
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !63, metadata !DIExpression()), !dbg !76

  //   %add = add nsw i32 1, %xor, !dbg !64
  creg_r2 = max(0,creg_r1);
  r2 = 1 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !64

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !64
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !65, metadata !DIExpression()), !dbg !84

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !64
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !67, metadata !DIExpression()), !dbg !84

  //   %conv4 = trunc i64 %1 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !76

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !86

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !68
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l32_c16
  // Check
  ...
  if(cr(2,0+1*1) < cw(2,0+1*1)) {
    ...
    r5 = mem(0+1*1,cr(2,0+1*1));
  }
  ASSUME(creturn[2] >= cr(2,0+1*1));

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !71, metadata !DIExpression()), !dbg !86

  //   %conv8 = trunc i64 %2 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !76

  //   %cmp = icmp eq i32 %conv, 1, !dbg !70
  creg__r0__1_ = max(0,creg_r0);

  //   %conv9 = zext i1 %cmp to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !72, metadata !DIExpression()), !dbg !76

  //   store i32 %conv9, i32* @atom_1_X0_1, align 4, !dbg !71, !tbaa !72
  // ST: Guess
  iw(2,2) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l34_c15
  old_cw = cw(2,2);
  cw(2,2) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l34_c15
  // Check
  ...
  //   %cmp10 = icmp eq i32 %conv4, 0, !dbg !76
  creg__r4__0_ = max(0,creg_r4);

  //   %conv11 = zext i1 %cmp10 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !73, metadata !DIExpression()), !dbg !76

  //   store i32 %conv11, i32* @atom_1_X3_0, align 4, !dbg !77, !tbaa !72
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv8, 1, !dbg !78
  creg__r5__1_ = max(0,creg_r5);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !74, metadata !DIExpression()), !dbg !76

  //   store i32 %conv13, i32* @atom_1_X5_1, align 4, !dbg !79, !tbaa !72
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !102, metadata !DIExpression()), !dbg !107
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !103, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 1, metadata !105, metadata !DIExpression()), !dbg !110
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !120, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !121, metadata !DIExpression()), !dbg !155

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !122, metadata !DIExpression()), !dbg !157

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !126, metadata !DIExpression()), !dbg !159

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !127, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !128, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64 0, metadata !130, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !131, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64 0, metadata !133, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !134, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i32 0, metadata !137, metadata !DIExpression()), !dbg !166

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !138, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i32 0, metadata !140, metadata !DIExpression()), !dbg !168

  //   store atomic i32 0, i32* @atom_1_X3_0 monotonic, align 4, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !141, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !170

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !93
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !95
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !96
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call11 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !102
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !103, !tbaa !98
  r8 = local_mem[1];

  //   %call12 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !104
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !105, !tbaa !98
  r9 = local_mem[2];

  //   %call13 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !106
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !147, metadata !DIExpression()), !dbg !183
  ...
  //   %conv14 = zext i1 %cmp to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !148, metadata !DIExpression()), !dbg !155

  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !111, !tbaa !112
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %8 = load i32, i32* @atom_1_X3_0, align 4, !dbg !114, !tbaa !112
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %9 = load i32, i32* @atom_1_X5_1, align 4, !dbg !115, !tbaa !112
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !151, metadata !DIExpression()), !dbg !155

  //   %and = and i32 %8, %9, !dbg !116
  creg_r14 = max(creg_r12,creg_r13);
  r14 = r12 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !152, metadata !DIExpression()), !dbg !155

  //   %and15 = and i32 %7, %and, !dbg !117
  creg_r15 = max(creg_r11,creg_r14);
  r15 = r11 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !153, metadata !DIExpression()), !dbg !155

  //   %and16 = and i32 %conv14, %and15, !dbg !118
  creg_r16 = max(creg__r10__2_,creg_r15);
  r16 = (r10==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !154, metadata !DIExpression()), !dbg !155

  //   %cmp17 = icmp eq i32 %and16, 1, !dbg !119
  creg__r16__1_ = max(0,creg_r16);

  //   br i1 %cmp17, label %if.then, label %if.end, !dbg !121
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([141 x i8], [141 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !122
...
T0BLOCK2:
  //   %10 = bitcast i64* %thr2 to i8*, !dbg !125

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !125

  //   %11 = bitcast i64* %thr1 to i8*, !dbg !125

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #7, !dbg !125

  //   %12 = bitcast i64* %thr0 to i8*, !dbg !125

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !125
