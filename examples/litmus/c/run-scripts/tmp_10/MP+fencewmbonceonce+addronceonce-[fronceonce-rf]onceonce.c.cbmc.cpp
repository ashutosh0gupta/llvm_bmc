...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !52
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !57, metadata !DIExpression()), !dbg !85
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !58, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !72, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !73, metadata !DIExpression()), !dbg !99

  //   %3 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !99

  //   store atomic i64 %3, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !77, metadata !DIExpression()), !dbg !102

  //   %4 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !79, metadata !DIExpression()), !dbg !102

  //   store atomic i64 %4, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !81, metadata !DIExpression()), !dbg !105

  //   %5 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !83, metadata !DIExpression()), !dbg !105

  //   store atomic i64 %5, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !87
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !110, metadata !DIExpression()), !dbg !115
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !111, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64 1, metadata !113, metadata !DIExpression()), !dbg !118
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !135, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !136, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !139, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !142, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !145, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !184

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !148, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !186

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !155, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !156, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !161, metadata !DIExpression()), !dbg !208

  //   %8 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !123
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !163, metadata !DIExpression()), !dbg !208

  //   %conv22 = trunc i64 %8 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !160, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !165, metadata !DIExpression()), !dbg !211

  //   %9 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !126
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !167, metadata !DIExpression()), !dbg !211

  //   %conv26 = trunc i64 %9 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !164, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !169, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !170, metadata !DIExpression()), !dbg !171
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([141 x i8], [141 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !134
