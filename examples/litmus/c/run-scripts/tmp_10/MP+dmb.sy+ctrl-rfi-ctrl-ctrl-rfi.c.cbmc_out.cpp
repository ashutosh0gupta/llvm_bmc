...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !93), !dbg !99
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !94), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !67, metadata !DIExpression()), !dbg !111
...
T2BLOCK7:
  ...
  //   %tobool12 = icmp ne i32 %conv11, 0, !dbg !104

  //   br i1 %tobool12, label %if.then13, label %if.else14, !dbg !106
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !96), !dbg !128

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !129

  //   call void @llvm.dbg.value(metadata i64 1, metadata !76, metadata !DIExpression()), !dbg !129

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !131

  //   %conv20 = trunc i64 %3 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !77, metadata !DIExpression()), !dbg !97

  //   %cmp = icmp eq i32 %conv, 1, !dbg !115

  //   %conv21 = zext i1 %cmp to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !81, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !82, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !85, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !86, metadata !DIExpression()), !dbg !138
  ...
  //   %cmp30 = icmp eq i32 %conv20, 1, !dbg !121

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !89, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !90, metadata !DIExpression()), !dbg !141

  //   %6 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %6, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !123
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !176, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !203, metadata !DIExpression()), !dbg !258
