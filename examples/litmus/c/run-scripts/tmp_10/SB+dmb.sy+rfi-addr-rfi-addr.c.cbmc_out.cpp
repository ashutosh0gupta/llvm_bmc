...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !85, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx11, metadata !87, metadata !DIExpression()), !dbg !110

  //   %2 = load atomic i64, i64* %arrayidx11 monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   %conv14 = trunc i64 %2 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !86, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !84
  creg__r1__1_ = max(0,creg_r1);

  //   %conv15 = zext i1 %cmp to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !90, metadata !DIExpression()), !dbg !94

  //   store i32 %conv15, i32* @atom_1_X2_1, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !91, metadata !DIExpression()), !dbg !94

  //   store i32 %conv17, i32* @atom_1_X6_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv14, 0, !dbg !92
  creg__r9__0_ = max(0,creg_r9);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !92, metadata !DIExpression()), !dbg !94

  //   store i32 %conv19, i32* @atom_1_X8_0, align 4, !dbg !93, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !142, metadata !DIExpression()), !dbg !191
