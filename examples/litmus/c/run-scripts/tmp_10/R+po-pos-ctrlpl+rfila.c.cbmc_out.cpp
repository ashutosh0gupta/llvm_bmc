...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !48, metadata !DIExpression()), !dbg !72
...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !51, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !55, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !59, metadata !DIExpression()), !dbg !87

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !61, metadata !DIExpression()), !dbg !87

  //   store atomic i64 %3, i64* @atom_0_X6_2 seq_cst, align 8, !dbg !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !151, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !154, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !157, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !161, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !163, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !164, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !166, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !168, metadata !DIExpression()), !dbg !209

  //   %conv16 = trunc i64 %5 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !165, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !170, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !172, metadata !DIExpression()), !dbg !212

  //   %conv20 = trunc i64 %6 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !169, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !174, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !176, metadata !DIExpression()), !dbg !215

  //   %conv24 = trunc i64 %7 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !173, metadata !DIExpression()), !dbg !180
