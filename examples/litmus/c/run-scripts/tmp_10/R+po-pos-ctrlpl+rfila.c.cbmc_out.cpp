...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !48, metadata !DIExpression()), !dbg !69
...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !51, metadata !DIExpression()), !dbg !78
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !55, metadata !DIExpression()), !dbg !80
  ...
  //   store i32 %conv11, i32* @atom_0_X6_2, align 4, !dbg !84, !tbaa !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_2, metadata !143, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_3, metadata !147, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !150, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !156, metadata !DIExpression()), !dbg !187

  //   %conv = trunc i64 %4 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !153, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !157, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !158, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !162, metadata !DIExpression()), !dbg !164

  //   %and14 = and i32 %conv12, %and13, !dbg !112
  creg_r14 = max(creg__r8__3_,creg_r13);
  r14 = (r8==3) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !163, metadata !DIExpression()), !dbg !164
