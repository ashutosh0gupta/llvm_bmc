...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !75, metadata !DIExpression()), !dbg !94

  //   %add7 = add nsw i32 0, %xor5, !dbg !88
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !88

  //   %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !88
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !77, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !110
  ...
  //   %cmp24 = icmp eq i32 %conv12, 0, !dbg !105
  ...
  //   store i32 %conv25, i32* @atom_1_X7_0, align 4, !dbg !106, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !175, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !178, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !230

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X7_0, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X9_0, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
