...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !74, metadata !DIExpression()), !dbg !119

  //   %conv15 = trunc i64 %3 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !71, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !78, metadata !DIExpression()), !dbg !122

  //   %conv19 = trunc i64 %4 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !75, metadata !DIExpression()), !dbg !94
  ...
  //   %cmp22 = icmp eq i32 %conv15, 0, !dbg !109

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !83, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !84, metadata !DIExpression()), !dbg !129

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !86, metadata !DIExpression()), !dbg !129
  ...
  //   %cmp27 = icmp eq i32 %conv19, 1, !dbg !112

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !87, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !88, metadata !DIExpression()), !dbg !132

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !90, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %7, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !114
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !172, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !175, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !222

  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !178, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !181, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !192, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !196, metadata !DIExpression()), !dbg !250

  //   %9 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !138
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !200, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !202, metadata !DIExpression()), !dbg !253

  //   %conv34 = trunc i64 %10 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !199, metadata !DIExpression()), !dbg !207
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !150
