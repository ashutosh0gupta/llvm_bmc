...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !74, metadata !DIExpression()), !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X5_0, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv19, 1, !dbg !105
  ...
  //   store i32 %conv24, i32* @atom_1_X7_1, align 4, !dbg !106, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !154, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !155, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !164, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !168, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i32 0, metadata !170, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !171, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i32 0, metadata !173, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !175, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !174, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !178, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !182, metadata !DIExpression()), !dbg !225

  //   %conv20 = trunc i64 %7 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !179, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !183, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !186, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !188, metadata !DIExpression()), !dbg !191

  //   %and24 = and i32 %conv22, %and23, !dbg !133
  creg_r16 = max(creg__r10__1_,creg_r15);
  r16 = (r10==1) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !189, metadata !DIExpression()), !dbg !191

  //   %and25 = and i32 %conv16, %and24, !dbg !134
  creg_r17 = max(creg__r9__2_,creg_r16);
  r17 = (r9==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !190, metadata !DIExpression()), !dbg !191
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
