...
T2BLOCK1:
  ...
  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !66
  // ST: Guess
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !70
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !85, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !89, metadata !DIExpression()), !dbg !92

  //   store i32 %conv9, i32* @atom_1_X6_2, align 4, !dbg !76, !tbaa !77
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !90, metadata !DIExpression()), !dbg !92
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !132, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !136, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !138, metadata !DIExpression()), !dbg !170

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !139, metadata !DIExpression()), !dbg !172
  ...
  //   %7 = load i32, i32* @atom_1_X6_2, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
