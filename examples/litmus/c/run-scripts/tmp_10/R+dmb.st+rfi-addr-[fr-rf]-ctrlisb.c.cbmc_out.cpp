...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv8, 0, !dbg !83
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !86), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !109

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   store i32 %conv15, i32* @atom_1_X4_0, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  ...
  //   store i32 %conv17, i32* @atom_1_X6_1, align 4, !dbg !102, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !166, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !169, metadata !DIExpression()), !dbg !217
