...
T1BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !46
  // ST: Guess
  //   : Release
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !53, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64 2, metadata !55, metadata !DIExpression()), !dbg !69

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !52
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X1_0, metadata !62, metadata !DIExpression()), !dbg !75

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !64, metadata !DIExpression()), !dbg !75

  //   store atomic i64 %1, i64* @atom_1_X1_0 seq_cst, align 8, !dbg !58
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X1_0, metadata !98, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64 0, metadata !100, metadata !DIExpression()), !dbg !120

  //   store atomic i64 0, i64* @atom_1_X1_0 monotonic, align 8, !dbg !74
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !102, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X1_0, metadata !107, metadata !DIExpression()), !dbg !136

  //   %5 = load atomic i64, i64* @atom_1_X1_0 seq_cst, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(0,2);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 51, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !96
