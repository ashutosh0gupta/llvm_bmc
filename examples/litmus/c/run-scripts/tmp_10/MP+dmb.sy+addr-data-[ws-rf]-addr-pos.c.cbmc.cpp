...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !70, metadata !DIExpression()), !dbg !105

  //   %add6 = add nsw i32 %xor5, 1, !dbg !97
  creg_r6 = max(creg_r5,0);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !71, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !72, metadata !DIExpression()), !dbg !117

  //   %conv7 = sext i32 %add6 to i64, !dbg !99

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !74, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !76, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !119

  //   %conv11 = trunc i64 %2 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !75, metadata !DIExpression()), !dbg !105

  //   %xor12 = xor i32 %conv11, %conv11, !dbg !103
  creg_r8 = max(creg_r7,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !79, metadata !DIExpression()), !dbg !105

  //   %add14 = add nsw i32 0, %xor12, !dbg !104
  creg_r9 = max(0,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = 0 + r8;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !104

  //   %arrayidx16 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !104
  r10 = 0+r9*1;
  ASSUME(creg_r10 >= 0);
  ASSUME(creg_r10 >= creg_r9);
  ASSUME(active[creg_r10] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !81, metadata !DIExpression()), !dbg !124

  //   %3 = load atomic i64, i64* %arrayidx16 monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !83, metadata !DIExpression()), !dbg !124

  //   %conv19 = trunc i64 %3 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !80, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !87, metadata !DIExpression()), !dbg !126

  //   %conv23 = trunc i64 %4 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !84, metadata !DIExpression()), !dbg !105

  //   %cmp = icmp eq i32 %conv, 1, !dbg !110

  //   %conv24 = zext i1 %cmp to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !88, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !89, metadata !DIExpression()), !dbg !130

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !130
  ...
  //   %cmp28 = icmp eq i32 %conv11, 2, !dbg !113

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !92, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !93, metadata !DIExpression()), !dbg !133

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %6, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv19, 0, !dbg !116

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !96, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !97, metadata !DIExpression()), !dbg !136

  //   %7 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !136
  ...
  //   %cmp38 = icmp eq i32 %conv23, 0, !dbg !119

  //   %conv39 = zext i1 %cmp38 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv39, metadata !100, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !101, metadata !DIExpression()), !dbg !139

  //   %8 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !103, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %8, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !185, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !248

  //   store atomic i64 0, i64* @atom_1_X7_2 monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !188, metadata !DIExpression()), !dbg !250
  ...
  //   %cmp = icmp eq i32 %conv, 2, !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !214, metadata !DIExpression()), !dbg !282

  //   %10 = load atomic i64, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !218, metadata !DIExpression()), !dbg !285
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 95, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
