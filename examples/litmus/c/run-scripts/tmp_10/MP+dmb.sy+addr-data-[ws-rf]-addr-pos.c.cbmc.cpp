...
T2BLOCK1:
  ...
  //   %xor12 = xor i32 %conv11, %conv11, !dbg !91
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !79, metadata !DIExpression()), !dbg !93

  //   %add14 = add nsw i32 0, %xor12, !dbg !92
  creg_r9 = max(0,creg_r8);
  r9 = 0 + r8;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !92

  //   %arrayidx16 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !92
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !81, metadata !DIExpression()), !dbg !112

  //   %3 = load atomic i64, i64* %arrayidx16 monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,r10);
  cr(2,r10) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l38_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !83, metadata !DIExpression()), !dbg !112

  //   %conv19 = trunc i64 %3 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !80, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !114

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp25 = icmp eq i32 %conv11, 2, !dbg !104
  ...
  //   store i32 %conv26, i32* @atom_1_X7_2, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv19, 0, !dbg !106
  ...
  //   store i32 %conv28, i32* @atom_1_X9_0, align 4, !dbg !107, !tbaa !100
  // ST: Guess
  ...
  //   store i32 %conv30, i32* @atom_1_X11_0, align 4, !dbg !109, !tbaa !100
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_2, metadata !174, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !225

  //   store atomic i32 0, i32* @atom_1_X7_2 monotonic, align 4, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !177, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !179, metadata !DIExpression()), !dbg !227

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X7_2, align 4, !dbg !153, !tbaa !151
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %11 = load i32, i32* @atom_1_X9_0, align 4, !dbg !154, !tbaa !151
  // LD: Guess
  old_cr = cr(0,6);
