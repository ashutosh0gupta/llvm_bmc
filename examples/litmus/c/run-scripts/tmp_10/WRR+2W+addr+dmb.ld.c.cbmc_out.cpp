...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !49, metadata !DIExpression()), !dbg !69
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !54, metadata !DIExpression()), !dbg !72

  //   %conv = trunc i64 %0 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !50, metadata !DIExpression()), !dbg !69
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !57, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !56, metadata !DIExpression()), !dbg !69

  //   %cmp = icmp eq i32 %conv, 2, !dbg !66

  //   %conv5 = zext i1 %cmp to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !60, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !61, metadata !DIExpression()), !dbg !80

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !63, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !64, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !65, metadata !DIExpression()), !dbg !83

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !67, metadata !DIExpression()), !dbg !83

  //   store atomic i64 %3, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !71
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !119, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !123, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !126, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !129, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64 0, metadata !131, metadata !DIExpression()), !dbg !160

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !135, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !138, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !140, metadata !DIExpression()), !dbg !179

  //   %conv16 = trunc i64 %7 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !137, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !142, metadata !DIExpression()), !dbg !182

  //   %8 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(0,3);
