...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !84, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !86, metadata !DIExpression()), !dbg !100

  //   %conv = trunc i64 %0 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !83, metadata !DIExpression()), !dbg !97

  //   %cmp = icmp eq i32 %conv, 0, !dbg !58

  //   %conv1 = zext i1 %cmp to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !87, metadata !DIExpression()), !dbg !97
...
T3BLOCK2:
  //   br label %lbl_label121, !dbg !62
  goto T3BLOCK4;

T3BLOCK3:
  //   br label %lbl_label121, !dbg !63
  goto T3BLOCK4;

T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !96), !dbg !109

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !88, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !91, metadata !DIExpression()), !dbg !97
