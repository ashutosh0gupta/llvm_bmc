...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !81), !dbg !86
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !82), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !99

  //   %conv8 = trunc i64 %2 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !69, metadata !DIExpression()), !dbg !84

  //   %tobool9 = icmp ne i32 %conv8, 0, !dbg !83
  creg__r2__0_ = max(0,creg_r2);

  //   br i1 %tobool9, label %if.then10, label %if.else11, !dbg !85
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK5:
  //   br label %lbl_LC01, !dbg !86
  goto T2BLOCK7;

T2BLOCK6:
  //   br label %lbl_LC01, !dbg !87
  goto T2BLOCK7;
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !109

  //   %conv15 = trunc i64 %3 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !73, metadata !DIExpression()), !dbg !84

  //   %cmp = icmp eq i32 %conv, 1, !dbg !93
  creg__r0__1_ = max(0,creg_r0);

  //   %conv16 = zext i1 %cmp to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !77, metadata !DIExpression()), !dbg !84

  //   store i32 %conv16, i32* @atom_1_X0_1, align 4, !dbg !94, !tbaa !95
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 0, !dbg !99
  creg__r1__0_ = max(0,creg_r1);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !78, metadata !DIExpression()), !dbg !84

  //   store i32 %conv18, i32* @atom_1_X2_0, align 4, !dbg !100, !tbaa !95
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv8, 1, !dbg !101
  creg__r2__1_ = max(0,creg_r2);

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !79, metadata !DIExpression()), !dbg !84

  //   store i32 %conv20, i32* @atom_1_X4_1, align 4, !dbg !102, !tbaa !95
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 0, !dbg !103
  creg__r3__0_ = max(0,creg_r3);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !80, metadata !DIExpression()), !dbg !84

  //   store i32 %conv22, i32* @atom_1_X5_0, align 4, !dbg !104, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !166, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !169, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !172, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !219

  //   store atomic i32 0, i32* @atom_1_X5_0 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X5_0, align 4, !dbg !150, !tbaa !146
  // LD: Guess
  old_cr = cr(0,6);
