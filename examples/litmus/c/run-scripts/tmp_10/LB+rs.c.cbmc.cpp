...
T1BLOCK1:
  ...
  //   %add = add nsw i32 %conv, 0, !dbg !57
  creg_r1 = max(0,creg_r0);
  r1 = r0 + 0;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !44, metadata !DIExpression()), !dbg !51

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !45, metadata !DIExpression()), !dbg !58
  ...
  //   store i32 1, i32* @atom_0_X0_1, align 4, !dbg !60, !tbaa !61
  // ST: Guess
  ...
  //   store i32 %conv1, i32* @atom_0_X2_2, align 4, !dbg !66, !tbaa !61
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !84
  ...
  //   %add = add nsw i32 %conv, 1, !dbg !56
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !75, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !88

  //   %conv1 = sext i32 %add to i64, !dbg !58

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !78, metadata !DIExpression()), !dbg !88

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !58
  // ST: Guess
  ...
  //   %cmp = icmp eq i32 %add, 2, !dbg !59
  creg__r3__2_ = max(0,creg_r3);

  //   %conv2 = zext i1 %cmp to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !79, metadata !DIExpression()), !dbg !81

  //   store i32 %conv2, i32* @atom_1_X2_2, align 4, !dbg !60, !tbaa !61
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !100, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !101, metadata !DIExpression()), !dbg !140

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !102, metadata !DIExpression()), !dbg !142

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !106, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !107, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i64 0, metadata !109, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64 0, metadata !112, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !113, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i32 0, metadata !116, metadata !DIExpression()), !dbg !149

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !92
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l47_c3
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l47_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_2, metadata !117, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i32 0, metadata !119, metadata !DIExpression()), !dbg !151

  //   store atomic i32 0, i32* @atom_0_X2_2 monotonic, align 4, !dbg !94
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l48_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l48_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !120, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i32 0, metadata !122, metadata !DIExpression()), !dbg !153
  ...
  //   %4 = load i32, i32* @atom_0_X0_1, align 4, !dbg !107, !tbaa !108
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l57_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !123, metadata !DIExpression()), !dbg !140

  //   %5 = load i32, i32* @atom_0_X2_2, align 4, !dbg !110, !tbaa !108
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l58_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !124, metadata !DIExpression()), !dbg !140

  //   %6 = load i32, i32* @atom_1_X2_2, align 4, !dbg !111, !tbaa !108
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l59_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !125, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !127, metadata !DIExpression()), !dbg !166

  //   %7 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !129, metadata !DIExpression()), !dbg !166

  //   %conv = trunc i64 %7 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !126, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !130, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !132, metadata !DIExpression()), !dbg !170

  //   %8 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !134, metadata !DIExpression()), !dbg !170

  //   %conv16 = trunc i64 %8 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !131, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !135, metadata !DIExpression()), !dbg !140

  //   %and = and i32 %conv12, %conv18, !dbg !120
  creg_r12 = max(creg__r10__1_,creg__r11__2_);
  r12 = (r10==1) & (r11==2);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !136, metadata !DIExpression()), !dbg !140

  //   %and19 = and i32 %6, %and, !dbg !121
  creg_r13 = max(creg_r12,creg_r9);
  r13 = r9 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !137, metadata !DIExpression()), !dbg !140

  //   %and20 = and i32 %5, %and19, !dbg !122
  creg_r14 = max(creg_r13,creg_r8);
  r14 = r8 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !138, metadata !DIExpression()), !dbg !140

  //   %and21 = and i32 %4, %and20, !dbg !123
  creg_r15 = max(creg_r14,creg_r7);
  r15 = r7 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !139, metadata !DIExpression()), !dbg !140
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !127
