...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !74, metadata !DIExpression()), !dbg !87
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !110, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64 0, metadata !112, metadata !DIExpression()), !dbg !134

  //   store atomic i64 0, i64* @atom_0_X2_0 monotonic, align 8, !dbg !78
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !113, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !117, metadata !DIExpression()), !dbg !148

  //   %4 = load atomic i64, i64* @atom_0_X2_0 seq_cst, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !121, metadata !DIExpression()), !dbg !151
