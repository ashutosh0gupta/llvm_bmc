...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !131, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !132, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 1, metadata !134, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_4, metadata !135, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_1, metadata !142, metadata !DIExpression()), !dbg !167
