...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !40, metadata !DIExpression()), !dbg !55
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !41, metadata !DIExpression()), !dbg !58

  //   call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !58

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !59
  // ST: Guess
  iw(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l22_c3
  old_cw = cw(1,0+3*1);
  cw(1,0+3*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l22_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !45, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64 2, metadata !47, metadata !DIExpression()), !dbg !60

  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !61
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !48, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64 3, metadata !50, metadata !DIExpression()), !dbg !63

  //   store atomic i64 3, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !64
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !51, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64 4, metadata !53, metadata !DIExpression()), !dbg !65

  //   store atomic i64 4, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !66
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !70, metadata !DIExpression()), !dbg !92
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !95

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !67
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !74, metadata !DIExpression()), !dbg !95

  //   %conv = trunc i64 %0 to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !71, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !98

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !70
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !78, metadata !DIExpression()), !dbg !98

  //   %conv4 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !75, metadata !DIExpression()), !dbg !92

  //   call void (...) @dmbld(), !dbg !72
  // dumbld: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !80, metadata !DIExpression()), !dbg !102

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !74
  // LD: Guess
  old_cr = cr(2,0+3*1);
  cr(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l35_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !82, metadata !DIExpression()), !dbg !102

  //   %conv8 = trunc i64 %2 to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !79, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !84, metadata !DIExpression()), !dbg !105

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !77
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !86, metadata !DIExpression()), !dbg !105

  //   %conv12 = trunc i64 %3 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !83, metadata !DIExpression()), !dbg !92

  //   %cmp = icmp eq i32 %conv, 3, !dbg !79
  creg__r0__3_ = max(0,creg_r0);

  //   %conv13 = zext i1 %cmp to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !87, metadata !DIExpression()), !dbg !92

  //   store i32 %conv13, i32* @atom_1_X0_3, align 4, !dbg !80, !tbaa !81
  // ST: Guess
  iw(2,4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l38_c15
  old_cw = cw(2,4);
  cw(2,4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l38_c15
  // Check
  ASSUME(active[iw(2,4)] == 2);
  ASSUME(active[cw(2,4)] == 2);
  ASSUME(sforbid(4,cw(2,4))== 0);
  ASSUME(iw(2,4) >= creg__r0__3_);
  ASSUME(iw(2,4) >= 0);
  ...
  //   %cmp14 = icmp eq i32 %conv8, 0, !dbg !85
  creg__r2__0_ = max(0,creg_r2);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !88, metadata !DIExpression()), !dbg !92

  //   store i32 %conv15, i32* @atom_1_X4_0, align 4, !dbg !86, !tbaa !81
  // ST: Guess
  iw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l40_c15
  old_cw = cw(2,5);
  cw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l40_c15
  // Check
  ...
  //   %cmp16 = icmp eq i32 %conv12, 0, !dbg !87
  creg__r3__0_ = max(0,creg_r3);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !89, metadata !DIExpression()), !dbg !92

  //   store i32 %conv17, i32* @atom_1_X6_0, align 4, !dbg !88, !tbaa !81
  // ST: Guess
  iw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l42_c15
  old_cw = cw(2,6);
  cw(2,6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l42_c15
  // Check
  ...
  //   %cmp18 = icmp eq i32 %conv4, 4, !dbg !89
  creg__r1__4_ = max(0,creg_r1);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !90, metadata !DIExpression()), !dbg !92

  //   store i32 %conv19, i32* @atom_1_X2_4, align 4, !dbg !90, !tbaa !81
  // ST: Guess
  iw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l44_c15
  old_cw = cw(2,7);
  cw(2,7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l44_c15
  // Check
  ASSUME(active[iw(2,7)] == 2);
  ASSUME(active[cw(2,7)] == 2);
  ASSUME(sforbid(7,cw(2,7))== 0);
  ASSUME(iw(2,7) >= creg__r1__4_);
  ASSUME(iw(2,7) >= 0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !128, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !129, metadata !DIExpression()), !dbg !175

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !130, metadata !DIExpression()), !dbg !177

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !134, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !135, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64 0, metadata !137, metadata !DIExpression()), !dbg !180

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !182

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !141, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !184

  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !144, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64 0, metadata !146, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_3, metadata !147, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !188

  //   store atomic i32 0, i32* @atom_1_X0_3 monotonic, align 4, !dbg !105
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l56_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l56_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !151, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i32 0, metadata !153, metadata !DIExpression()), !dbg !190

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !107
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l57_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l57_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !154, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !192

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !109
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l58_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l58_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_4, metadata !157, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !194

  //   store atomic i32 0, i32* @atom_1_X2_4 monotonic, align 4, !dbg !111
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l59_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l59_c3
  // Check
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !112
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !113
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !114, !tbaa !115
  r5 = local_mem[0];

  //   %call16 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !119
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !120, !tbaa !115
  r6 = local_mem[1];

  //   %call17 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !121
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i32, i32* @atom_1_X0_3, align 4, !dbg !122, !tbaa !123
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !160, metadata !DIExpression()), !dbg !175

  //   %5 = load i32, i32* @atom_1_X4_0, align 4, !dbg !125, !tbaa !123
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !161, metadata !DIExpression()), !dbg !175

  //   %6 = load i32, i32* @atom_1_X0_3, align 4, !dbg !126, !tbaa !123
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !162, metadata !DIExpression()), !dbg !175

  //   %7 = load i32, i32* @atom_1_X6_0, align 4, !dbg !127, !tbaa !123
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !163, metadata !DIExpression()), !dbg !175

  //   %8 = load i32, i32* @atom_1_X2_4, align 4, !dbg !128, !tbaa !123
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l71_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !164, metadata !DIExpression()), !dbg !175

  //   %9 = load i32, i32* @atom_1_X4_0, align 4, !dbg !129, !tbaa !123
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !165, metadata !DIExpression()), !dbg !175

  //   %10 = load i32, i32* @atom_1_X2_4, align 4, !dbg !130, !tbaa !123
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l73_c13
  // Check
  ASSUME(active[cr(0,7)] == 0);
  ASSUME(cr(0,7) >= iw(0,7));
  ASSUME(cr(0,7) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !166, metadata !DIExpression()), !dbg !175

  //   %11 = load i32, i32* @atom_1_X6_0, align 4, !dbg !131, !tbaa !123
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l74_c13
  // Check
  ASSUME(active[cr(0,6)] == 0);
  ASSUME(cr(0,6) >= iw(0,6));
  ASSUME(cr(0,6) >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !167, metadata !DIExpression()), !dbg !175

  //   %and = and i32 %10, %11, !dbg !132
  creg_r15 = max(creg_r13,creg_r14);
  r15 = r13 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !168, metadata !DIExpression()), !dbg !175

  //   %or = or i32 %9, %and, !dbg !133
  creg_r16 = max(creg_r12,creg_r15);
  r16 = r12 | r15;

  //   call void @llvm.dbg.value(metadata i32 %or, metadata !169, metadata !DIExpression()), !dbg !175

  //   %and18 = and i32 %8, %or, !dbg !134
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !170, metadata !DIExpression()), !dbg !175

  //   %or19 = or i32 %7, %and18, !dbg !135
  creg_r18 = max(creg_r10,creg_r17);
  r18 = r10 | r17;

  //   call void @llvm.dbg.value(metadata i32 %or19, metadata !171, metadata !DIExpression()), !dbg !175

  //   %and20 = and i32 %6, %or19, !dbg !136
  creg_r19 = max(creg_r18,creg_r9);
  r19 = r9 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !172, metadata !DIExpression()), !dbg !175

  //   %or21 = or i32 %5, %and20, !dbg !137
  creg_r20 = max(creg_r19,creg_r8);
  r20 = r8 | r19;

  //   call void @llvm.dbg.value(metadata i32 %or21, metadata !173, metadata !DIExpression()), !dbg !175

  //   %and22 = and i32 %4, %or21, !dbg !138
  creg_r21 = max(creg_r20,creg_r7);
  r21 = r7 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !174, metadata !DIExpression()), !dbg !175

  //   %cmp = icmp eq i32 %and22, 1, !dbg !139
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !142
...
T0BLOCK2:
  //   %12 = bitcast i64* %thr1 to i8*, !dbg !145

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #6, !dbg !145

  //   %13 = bitcast i64* %thr0 to i8*, !dbg !145

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #6, !dbg !145
