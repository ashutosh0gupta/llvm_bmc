...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !101, metadata !DIExpression()), !dbg !112
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !143, metadata !DIExpression()), !dbg !155
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !145, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !147, metadata !DIExpression()), !dbg !158

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !144, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !162

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(5,0+1*1);
  cr(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l64_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !151, metadata !DIExpression()), !dbg !162

  //   %conv4 = trunc i64 %1 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !148, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !152, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !153, metadata !DIExpression()), !dbg !155
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !180
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !190, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !191, metadata !DIExpression()), !dbg !246

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !192, metadata !DIExpression()), !dbg !248

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !196, metadata !DIExpression()), !dbg !250

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !197, metadata !DIExpression()), !dbg !252

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !198, metadata !DIExpression()), !dbg !254

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !199, metadata !DIExpression()), !dbg !256

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !200, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !201, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !204, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !207, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !210, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !213, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !216, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i32 0, metadata !219, metadata !DIExpression()), !dbg !269

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !128
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l91_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l91_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X2_0, metadata !220, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i32 0, metadata !222, metadata !DIExpression()), !dbg !271

  //   store atomic i32 0, i32* @atom_4_X2_0 monotonic, align 4, !dbg !130
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l92_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l92_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !223, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i32 0, metadata !225, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !226, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i32 0, metadata !228, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !229, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i32 0, metadata !231, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X0_1, metadata !232, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i32 0, metadata !234, metadata !DIExpression()), !dbg !279
  ...
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l112_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !235, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !236, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !238, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !239, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !240, metadata !DIExpression()), !dbg !246

  //   %and = and i32 %16, %17, !dbg !169
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !241, metadata !DIExpression()), !dbg !246

  //   %and32 = and i32 %15, %and, !dbg !170
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !242, metadata !DIExpression()), !dbg !246

  //   %and33 = and i32 %14, %and32, !dbg !171
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !243, metadata !DIExpression()), !dbg !246

  //   %and34 = and i32 %13, %and33, !dbg !172
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !244, metadata !DIExpression()), !dbg !246

  //   %and35 = and i32 %12, %and34, !dbg !173
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !245, metadata !DIExpression()), !dbg !246
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 123, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
