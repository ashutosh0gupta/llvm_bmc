...
T2BLOCK4:
  ...
  //   %cmp20 = icmp eq i32 %conv4, 1, !dbg !105
  ...
  //   store i32 %conv21, i32* @atom_1_X4_1, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv10, 2, !dbg !107
  ...
  //   store i32 %conv23, i32* @atom_1_X8_2, align 4, !dbg !108, !tbaa !101
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !134, metadata !DIExpression()), !dbg !141
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !175, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_2, metadata !178, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !234

  //   store atomic i32 0, i32* @atom_1_X8_2 monotonic, align 4, !dbg !128
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X8_2, align 4, !dbg !164, !tbaa !161
  // LD: Guess
  old_cr = cr(0,6);
