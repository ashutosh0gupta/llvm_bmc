...
T1BLOCK1:
  ...
  if(cr(1,0+5*1) < cw(1,0+5*1)) {
    ...
    ASSUME((!(( (cw(1,0+5*1) < 5) && (5 < crmax(1,0+5*1)) )))||(sforbid(0+5*1,5)> 0));
    ASSUME((!(( (cw(1,0+5*1) < 6) && (6 < crmax(1,0+5*1)) )))||(sforbid(0+5*1,6)> 0));
    ASSUME((!(( (cw(1,0+5*1) < 7) && (7 < crmax(1,0+5*1)) )))||(sforbid(0+5*1,7)> 0));
    ASSUME((!(( (cw(1,0+5*1) < 8) && (8 < crmax(1,0+5*1)) )))||(sforbid(0+5*1,8)> 0));
    ASSUME((!(( (cw(1,0+5*1) < 9) && (9 < crmax(1,0+5*1)) )))||(sforbid(0+5*1,9)> 0));
  } else {
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !164, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !165, metadata !DIExpression()), !dbg !221

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !166, metadata !DIExpression()), !dbg !223

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !170, metadata !DIExpression()), !dbg !225

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !171, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !172, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !228

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !175, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !230

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !178, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !232

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !181, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !234

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !184, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !236

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !187, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !238

  //   store atomic i64 0, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !190, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i32 0, metadata !193, metadata !DIExpression()), !dbg !240

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_0, metadata !194, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i32 0, metadata !196, metadata !DIExpression()), !dbg !242

  //   store atomic i32 0, i32* @atom_0_X5_0 monotonic, align 4, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X7_1, metadata !197, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i32 0, metadata !199, metadata !DIExpression()), !dbg !244

  //   store atomic i32 0, i32* @atom_0_X7_1 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_1, metadata !200, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i32 0, metadata !202, metadata !DIExpression()), !dbg !246

  //   store atomic i32 0, i32* @atom_0_X3_1 monotonic, align 4, !dbg !129
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l75_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l75_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !203, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i32 0, metadata !205, metadata !DIExpression()), !dbg !248

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !131
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l76_c3
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l76_c3
  // Check
  ...
  //   %call21 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !133
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call22 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !134
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call23 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call24 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call25 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !144
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i32, i32* @atom_0_X0_1, align 4, !dbg !145, !tbaa !146
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !206, metadata !DIExpression()), !dbg !221

  //   %7 = load i32, i32* @atom_0_X5_0, align 4, !dbg !148, !tbaa !146
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !207, metadata !DIExpression()), !dbg !221

  //   %8 = load i32, i32* @atom_0_X7_1, align 4, !dbg !149, !tbaa !146
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !208, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !210, metadata !DIExpression()), !dbg !264

  //   %9 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !212, metadata !DIExpression()), !dbg !264

  //   %conv = trunc i64 %9 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !209, metadata !DIExpression()), !dbg !221

  //   %cmp = icmp eq i32 %conv, 2, !dbg !153
  creg__r12__2_ = max(0,creg_r12);

  //   %conv26 = zext i1 %cmp to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !213, metadata !DIExpression()), !dbg !221

  //   %10 = load i32, i32* @atom_0_X3_1, align 4, !dbg !154, !tbaa !146
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !214, metadata !DIExpression()), !dbg !221

  //   %11 = load i32, i32* @atom_1_X2_1, align 4, !dbg !155, !tbaa !146
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !215, metadata !DIExpression()), !dbg !221

  //   %or = or i32 %10, %11, !dbg !156
  creg_r15 = max(creg_r13,creg_r14);
  r15 = r13 | r14;

  //   call void @llvm.dbg.value(metadata i32 %or, metadata !216, metadata !DIExpression()), !dbg !221

  //   %and = and i32 %conv26, %or, !dbg !157
  creg_r16 = max(creg__r12__2_,creg_r15);
  r16 = (r12==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !217, metadata !DIExpression()), !dbg !221

  //   %and27 = and i32 %8, %and, !dbg !158
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !218, metadata !DIExpression()), !dbg !221

  //   %and28 = and i32 %7, %and27, !dbg !159
  creg_r18 = max(creg_r10,creg_r17);
  r18 = r10 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !219, metadata !DIExpression()), !dbg !221

  //   %and29 = and i32 %6, %and28, !dbg !160
  creg_r19 = max(creg_r18,creg_r9);
  r19 = r9 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !220, metadata !DIExpression()), !dbg !221

  //   %cmp30 = icmp eq i32 %and29, 1, !dbg !161
  creg__r19__1_ = max(0,creg_r19);

  //   br i1 %cmp30, label %if.then, label %if.end, !dbg !163
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 98, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !164
...
T0BLOCK2:
  //   %12 = bitcast i64* %thr2 to i8*, !dbg !167

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !167

  //   %13 = bitcast i64* %thr1 to i8*, !dbg !167

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !167

  //   %14 = bitcast i64* %thr0 to i8*, !dbg !167

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %14) #7, !dbg !167
