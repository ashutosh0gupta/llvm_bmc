...
T2BLOCK1:
  ...
  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // ST: Guess
  iw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0+1*1);
  cw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !129, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !132, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !150, metadata !DIExpression()), !dbg !192
