...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !110
  ...
  //   %conv11 = trunc i64 %2 to i32, !dbg !93
  ...
  //   store i32 %conv18, i32* @atom_1_X4_1, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv11, 0, !dbg !105
  ...
  //   store i32 %conv20, i32* @atom_1_X5_0, align 4, !dbg !106, !tbaa !99
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 1, !dbg !107
  ...
  //   store i32 %conv22, i32* @atom_1_X7_1, align 4, !dbg !108, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !173, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !176, metadata !DIExpression()), !dbg !223
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
