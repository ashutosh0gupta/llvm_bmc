...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !56, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !66, metadata !DIExpression()), !dbg !83

  //   %add6 = add nsw i32 0, %xor5, !dbg !75
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom7 = sext i32 %add6 to i64, !dbg !75

  //   %arrayidx8 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom7, !dbg !75
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx8, metadata !67, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64 1, metadata !69, metadata !DIExpression()), !dbg !95

  //   store atomic i64 1, i64* %arrayidx8 monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !96
  ...
  //   %conv12 = trunc i64 %2 to i32, !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !74, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !75, metadata !DIExpression()), !dbg !100

  //   %3 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !100

  //   store atomic i64 %3, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !82
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv12, 1, !dbg !83

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !78, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !79, metadata !DIExpression()), !dbg !103

  //   %4 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !103

  //   store atomic i64 %4, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !129, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !132, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !150, metadata !DIExpression()), !dbg !192
