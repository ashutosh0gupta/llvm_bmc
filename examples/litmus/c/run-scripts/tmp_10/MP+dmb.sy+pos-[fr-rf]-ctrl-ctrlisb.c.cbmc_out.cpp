...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !74, metadata !DIExpression()), !dbg !106

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !106

  //   %conv12 = trunc i64 %3 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !73, metadata !DIExpression()), !dbg !88

  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !90
  creg__r3__0_ = max(0,creg_r3);

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !92
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   %cmp21 = icmp eq i32 %conv4, 1, !dbg !106
  ...
  //   store i32 %conv22, i32* @atom_1_X2_1, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv8, 2, !dbg !108
  ...
  //   store i32 %conv24, i32* @atom_1_X3_2, align 4, !dbg !109, !tbaa !102
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv19, 0, !dbg !110
  ...
  //   store i32 %conv26, i32* @atom_1_X6_0, align 4, !dbg !111, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !173, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !176, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !179, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !220

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X6_0, align 4, !dbg !140, !tbaa !136
  // LD: Guess
  old_cr = cr(0,6);
