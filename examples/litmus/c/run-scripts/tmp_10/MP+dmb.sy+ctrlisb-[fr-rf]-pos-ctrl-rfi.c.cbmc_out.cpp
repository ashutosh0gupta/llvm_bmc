...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !107

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,0+2*1);
...
T2BLOCK7:
  ...
  //   %cmp21 = icmp eq i32 %conv4, 0, !dbg !114
  ...
  //   store i32 %conv22, i32* @atom_1_X2_0, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   store i32 %conv24, i32* @atom_1_X4_1, align 4, !dbg !117, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !183, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !237

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !186, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i32 0, metadata !188, metadata !DIExpression()), !dbg !239

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X2_0, align 4, !dbg !157, !tbaa !155
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X4_1, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
