...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !49, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !53, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64 1, metadata !55, metadata !DIExpression()), !dbg !80

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !81
  // ST: Guess
  //   : Release
  iw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !57, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !56, metadata !DIExpression()), !dbg !69

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !85

  //   %conv11 = zext i1 %cmp to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !60, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !61, metadata !DIExpression()), !dbg !86

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !63, metadata !DIExpression()), !dbg !86

  //   store atomic i64 %3, i64* @atom_0_X6_2 seq_cst, align 8, !dbg !87
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv, 3, !dbg !88

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !64, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !65, metadata !DIExpression()), !dbg !89

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !67, metadata !DIExpression()), !dbg !89

  //   store atomic i64 %4, i64* @atom_0_X2_3 seq_cst, align 8, !dbg !90
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !118
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !153, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !156, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !159, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !162, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !175, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !179, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !183, metadata !DIExpression()), !dbg !230
