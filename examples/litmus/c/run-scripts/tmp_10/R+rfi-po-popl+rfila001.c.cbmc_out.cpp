...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !50, metadata !DIExpression()), !dbg !71
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !49, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !53, metadata !DIExpression()), !dbg !74

  //   call void @llvm.dbg.value(metadata i64 1, metadata !55, metadata !DIExpression()), !dbg !74

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !75
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !57, metadata !DIExpression()), !dbg !76

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !77
  // LD: Guess
  old_cr = cr(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !59, metadata !DIExpression()), !dbg !76

  //   %conv10 = trunc i64 %2 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !56, metadata !DIExpression()), !dbg !63
  ...
  //   store i32 %conv11, i32* @atom_0_X6_2, align 4, !dbg !80, !tbaa !81
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv, 3, !dbg !85
  creg__r0__3_ = max(0,creg_r0);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !61, metadata !DIExpression()), !dbg !63

  //   store i32 %conv13, i32* @atom_0_X2_3, align 4, !dbg !86, !tbaa !81
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !91, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !99, metadata !DIExpression()), !dbg !113
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !128, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !129, metadata !DIExpression()), !dbg !167

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !130, metadata !DIExpression()), !dbg !169

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !134, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !135, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64 0, metadata !137, metadata !DIExpression()), !dbg !172
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !138, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_2, metadata !141, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i32 0, metadata !144, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_3, metadata !145, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i32 0, metadata !147, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_3, metadata !148, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !151, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !153, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !155, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !157, metadata !DIExpression()), !dbg !192

  //   %conv = trunc i64 %4 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !154, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !158, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !159, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !160, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !161, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !162, metadata !DIExpression()), !dbg !167

  //   %and = and i32 %7, %8, !dbg !120
  creg_r13 = max(creg_r11,creg_r12);
  r13 = r11 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !163, metadata !DIExpression()), !dbg !167

  //   %and15 = and i32 %6, %and, !dbg !121
  creg_r14 = max(creg_r10,creg_r13);
  r14 = r10 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !164, metadata !DIExpression()), !dbg !167

  //   %and16 = and i32 %5, %and15, !dbg !122
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !165, metadata !DIExpression()), !dbg !167

  //   %and17 = and i32 %conv14, %and16, !dbg !123
  creg_r16 = max(creg__r8__3_,creg_r15);
  r16 = (r8==3) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !166, metadata !DIExpression()), !dbg !167
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !127
