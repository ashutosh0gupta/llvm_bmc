...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !37, metadata !DIExpression()), !dbg !53
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !56

  //   call void @llvm.dbg.value(metadata i64 1, metadata !43, metadata !DIExpression()), !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !45, metadata !DIExpression()), !dbg !58
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !47, metadata !DIExpression()), !dbg !58
  ...
  //   %conv3 = zext i1 %cmp to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !48, metadata !DIExpression()), !dbg !50

  //   store i32 %conv3, i32* @atom_0_X2_2, align 4, !dbg !62, !tbaa !63
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64 2, metadata !73, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !78, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !81, metadata !DIExpression()), !dbg !83

  //   store i32 %conv3, i32* @atom_1_X2_2, align 4, !dbg !62, !tbaa !63
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !104, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !105, metadata !DIExpression()), !dbg !127

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !106, metadata !DIExpression()), !dbg !129

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !110, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !111, metadata !DIExpression()), !dbg !132

  //   call void @llvm.dbg.value(metadata i64 0, metadata !113, metadata !DIExpression()), !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !114, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_2, metadata !117, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i32 0, metadata !120, metadata !DIExpression()), !dbg !136

  //   store atomic i32 0, i32* @atom_0_X2_2 monotonic, align 4, !dbg !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !121, metadata !DIExpression()), !dbg !138

  //   call void @llvm.dbg.value(metadata i32 0, metadata !123, metadata !DIExpression()), !dbg !138

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !75
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !76
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call7 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !77
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i32, i32* @atom_0_X2_2, align 4, !dbg !86, !tbaa !87
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l55_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !124, metadata !DIExpression()), !dbg !127

  //   %5 = load i32, i32* @atom_1_X2_2, align 4, !dbg !89, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l56_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !125, metadata !DIExpression()), !dbg !127

  //   %and = and i32 %4, %5, !dbg !90
  creg_r7 = max(creg_r5,creg_r6);
  r7 = r5 & r6;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !126, metadata !DIExpression()), !dbg !127
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i64 0, i64 0), i32 noundef 58, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !94
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %6) #6, !dbg !97

  //   %7 = bitcast i64* %thr0 to i8*, !dbg !97

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %7) #6, !dbg !97
