...
T2BLOCK1:
  ...
  //   %xor10 = xor i32 %conv9, %conv9, !dbg !100
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor10, metadata !78, metadata !DIExpression()), !dbg !103

  //   %add12 = add nsw i32 0, %xor10, !dbg !101
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add12 to i64, !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !79, metadata !DIExpression()), !dbg !121
  ...
  //   %cmp27 = icmp eq i32 %conv9, 1, !dbg !112
