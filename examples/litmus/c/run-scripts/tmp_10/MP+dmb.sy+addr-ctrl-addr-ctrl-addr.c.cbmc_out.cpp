...
T2BLOCK7:
  ...
  //   %xor24 = xor i32 %conv23, %conv23, !dbg !108
  creg_r11 = max(creg_r10,creg_r10);
  ASSUME(active[creg_r11] == 2);
  r11 = r10 ^ r10;

  //   call void @llvm.dbg.value(metadata i32 %xor24, metadata !79, metadata !DIExpression()), !dbg !95

  //   %add26 = add nsw i32 0, %xor24, !dbg !109
  creg_r12 = max(0,creg_r11);
  ASSUME(active[creg_r12] == 2);
  r12 = 0 + r11;

  //   %idxprom27 = sext i32 %add26 to i64, !dbg !109

  //   %arrayidx28 = getelementptr inbounds [6 x i64], [6 x i64]* @vars, i64 0, i64 %idxprom27, !dbg !109
  r13 = 0+r12*1;
  ASSUME(creg_r13 >= 0);
  ASSUME(creg_r13 >= creg_r12);
  ASSUME(active[creg_r13] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx28, metadata !81, metadata !DIExpression()), !dbg !129

  //   %5 = load atomic i64, i64* %arrayidx28 monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(2,r13);
  ...
  //   %conv31 = trunc i64 %5 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !80, metadata !DIExpression()), !dbg !95

  //   %cmp = icmp eq i32 %conv, 1, !dbg !112

  //   %conv32 = zext i1 %cmp to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !84, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !85, metadata !DIExpression()), !dbg !132

  //   %6 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !87, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !114
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv31, 0, !dbg !115

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !88, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X13_0, metadata !89, metadata !DIExpression()), !dbg !135

  //   %7 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !91, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %7, i64* @atom_1_X13_0 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !152, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !155, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !158, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !167, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X13_0, metadata !173, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !216

  //   store atomic i64 0, i64* @atom_1_X13_0 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !180, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !182, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !185, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !187, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X13_0, metadata !191, metadata !DIExpression()), !dbg !239

  //   %7 = load atomic i64, i64* @atom_1_X13_0 seq_cst, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !193, metadata !DIExpression()), !dbg !239
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
