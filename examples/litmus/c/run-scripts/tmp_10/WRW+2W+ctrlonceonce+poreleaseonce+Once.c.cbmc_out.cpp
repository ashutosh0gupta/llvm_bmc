...
T1BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !43
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !47, metadata !DIExpression()), !dbg !63
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !50, metadata !DIExpression()), !dbg !66
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !52, metadata !DIExpression()), !dbg !66
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !53, metadata !DIExpression()), !dbg !63
...
T2BLOCK2:
  //   br label %lbl_label191, !dbg !60
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label191, !dbg !61
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !62), !dbg !75

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !54, metadata !DIExpression()), !dbg !76
  ...
  //   %cmp2 = icmp eq i32 %conv, 2, !dbg !65

  //   %conv3 = zext i1 %cmp2 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !57, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !58, metadata !DIExpression()), !dbg !79

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !60, metadata !DIExpression()), !dbg !79
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !107, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !108, metadata !DIExpression()), !dbg !140

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !109, metadata !DIExpression()), !dbg !142

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !113, metadata !DIExpression()), !dbg !144

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !114, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !121, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64 0, metadata !123, metadata !DIExpression()), !dbg !151

  //   store atomic i64 0, i64* @atom_1_X0_2 monotonic, align 8, !dbg !83
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !125, metadata !DIExpression()), !dbg !166

  //   %6 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !127, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !130, metadata !DIExpression()), !dbg !170

  //   %7 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !102
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !132, metadata !DIExpression()), !dbg !170

  //   %conv14 = trunc i64 %7 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !129, metadata !DIExpression()), !dbg !140

  //   %cmp15 = icmp eq i32 %conv14, 2, !dbg !104

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !133, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !135, metadata !DIExpression()), !dbg !174

  //   %8 = load atomic i64, i64* @atom_1_X0_2 seq_cst, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !137, metadata !DIExpression()), !dbg !174

  //   %conv20 = trunc i64 %8 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !134, metadata !DIExpression()), !dbg !140

  //   %and = and i32 %conv16, %conv20, !dbg !108
  ...
  //   %and21 = and i32 %conv10, %and, !dbg !109
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !113
