...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !73, metadata !DIExpression()), !dbg !101

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !85
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !77, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !106

  //   %conv11 = sext i32 %add to i64, !dbg !88

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !80, metadata !DIExpression()), !dbg !106

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !88
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !108
  ...
  //   %conv15 = trunc i64 %3 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !81, metadata !DIExpression()), !dbg !90

  //   %cmp = icmp eq i32 %conv, 1, !dbg !92
  creg__r0__1_ = max(0,creg_r0);

  //   %conv16 = zext i1 %cmp to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !85, metadata !DIExpression()), !dbg !90

  //   store i32 %conv16, i32* @atom_1_X0_1, align 4, !dbg !93, !tbaa !94
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 1, !dbg !98
  creg__r1__1_ = max(0,creg_r1);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !86, metadata !DIExpression()), !dbg !90

  //   store i32 %conv18, i32* @atom_1_X2_1, align 4, !dbg !99, !tbaa !94
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv8, 2, !dbg !100
  creg__r2__2_ = max(0,creg_r2);

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !87, metadata !DIExpression()), !dbg !90

  //   store i32 %conv20, i32* @atom_1_X4_2, align 4, !dbg !101, !tbaa !94
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 1, !dbg !102
  creg__r5__1_ = max(0,creg_r5);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !88, metadata !DIExpression()), !dbg !90

  //   store i32 %conv22, i32* @atom_1_X7_1, align 4, !dbg !103, !tbaa !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !131, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !132, metadata !DIExpression()), !dbg !176

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !133, metadata !DIExpression()), !dbg !178

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !137, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !140, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !141, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !144, metadata !DIExpression()), !dbg !185

  //   call void @llvm.dbg.value(metadata i32 0, metadata !147, metadata !DIExpression()), !dbg !185

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !99
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l55_c3
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l55_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !148, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i32 0, metadata !150, metadata !DIExpression()), !dbg !187

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !151, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i32 0, metadata !153, metadata !DIExpression()), !dbg !189

  //   store atomic i32 0, i32* @atom_1_X4_2 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !154, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !191

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !158, metadata !DIExpression()), !dbg !201

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l66_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !160, metadata !DIExpression()), !dbg !201

  //   %conv = trunc i64 %4 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !157, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !161, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !205

  //   %5 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l68_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !165, metadata !DIExpression()), !dbg !205

  //   %conv18 = trunc i64 %5 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !162, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !166, metadata !DIExpression()), !dbg !176

  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !124, !tbaa !125
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l70_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !167, metadata !DIExpression()), !dbg !176

  //   %7 = load i32, i32* @atom_1_X2_1, align 4, !dbg !127, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l71_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !168, metadata !DIExpression()), !dbg !176

  //   %8 = load i32, i32* @atom_1_X4_2, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
  cr(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l72_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !169, metadata !DIExpression()), !dbg !176

  //   %9 = load i32, i32* @atom_1_X7_1, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l73_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !170, metadata !DIExpression()), !dbg !176

  //   %and = and i32 %8, %9, !dbg !130
  creg_r15 = max(creg_r13,creg_r14);
  r15 = r13 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !171, metadata !DIExpression()), !dbg !176

  //   %and21 = and i32 %7, %and, !dbg !131
  creg_r16 = max(creg_r12,creg_r15);
  r16 = r12 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !172, metadata !DIExpression()), !dbg !176

  //   %and22 = and i32 %6, %and21, !dbg !132
  creg_r17 = max(creg_r11,creg_r16);
  r17 = r11 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !173, metadata !DIExpression()), !dbg !176

  //   %and23 = and i32 %conv20, %and22, !dbg !133
  creg_r18 = max(creg__r10__2_,creg_r17);
  r18 = (r10==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !174, metadata !DIExpression()), !dbg !176

  //   %and24 = and i32 %conv14, %and23, !dbg !134
  creg_r19 = max(creg__r9__2_,creg_r18);
  r19 = (r9==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !175, metadata !DIExpression()), !dbg !176
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
