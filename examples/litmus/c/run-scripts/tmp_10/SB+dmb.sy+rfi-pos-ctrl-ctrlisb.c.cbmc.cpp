...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !94), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !85, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !89, metadata !DIExpression()), !dbg !95

  //   store i32 %conv16, i32* @atom_1_X2_1, align 4, !dbg !98, !tbaa !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !90, metadata !DIExpression()), !dbg !95

  //   store i32 %conv18, i32* @atom_1_X3_1, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !91, metadata !DIExpression()), !dbg !95

  //   store i32 %conv20, i32* @atom_1_X6_0, align 4, !dbg !106, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !155, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_1, metadata !162, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !165, metadata !DIExpression()), !dbg !204
  ...
  //   %9 = load i32, i32* @atom_1_X6_0, align 4, !dbg !134, !tbaa !130
  // LD: Guess
  old_cr = cr(0,6);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !143
