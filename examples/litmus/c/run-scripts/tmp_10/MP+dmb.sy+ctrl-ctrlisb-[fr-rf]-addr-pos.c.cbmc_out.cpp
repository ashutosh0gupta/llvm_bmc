...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !110), !dbg !131
  ...
  //   %cmp26 = icmp eq i32 %conv11, 0, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !93, metadata !DIExpression()), !dbg !150

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %7, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !132
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv15, 1, !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !97, metadata !DIExpression()), !dbg !153

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !99, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %8, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !135
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !205, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !208, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !218, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !223, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !228, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !237, metadata !DIExpression()), !dbg !312
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !241, metadata !DIExpression()), !dbg !315
