...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64 4, metadata !74, metadata !DIExpression()), !dbg !103

  //   store atomic i64 4, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !72
  // ST: Guess
  //   : Release
...
T2BLOCK4:
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !85
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !91, metadata !DIExpression()), !dbg !123

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !93, metadata !DIExpression()), !dbg !123

  //   store atomic i64 %3, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !95, metadata !DIExpression()), !dbg !126

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !97, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %4, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_4, metadata !149, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !152, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !155, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_4, metadata !164, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !168, metadata !DIExpression()), !dbg !210
