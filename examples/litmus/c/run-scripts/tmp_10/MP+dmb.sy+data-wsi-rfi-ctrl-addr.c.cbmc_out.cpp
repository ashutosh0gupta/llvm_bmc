...
T2BLOCK4:
  ...
  //   %xor12 = xor i32 %conv11, %conv11, !dbg !94
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !79, metadata !DIExpression()), !dbg !89

  //   %add14 = add nsw i32 0, %xor12, !dbg !95
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add14 to i64, !dbg !95
