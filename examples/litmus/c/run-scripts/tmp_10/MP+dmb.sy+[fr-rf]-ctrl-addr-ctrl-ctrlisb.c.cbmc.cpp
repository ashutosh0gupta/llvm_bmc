...
T2BLOCK7:
  ...
  //   %tobool20 = icmp ne i32 %conv19, 0, !dbg !112

  //   br i1 %tobool20, label %if.then21, label %if.else22, !dbg !114
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !83, metadata !DIExpression()), !dbg !138

  //   %conv26 = trunc i64 %5 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !80, metadata !DIExpression()), !dbg !100

  //   %cmp = icmp eq i32 %conv, 1, !dbg !122

  //   %conv27 = zext i1 %cmp to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !84, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !85, metadata !DIExpression()), !dbg !142

  //   %6 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !87, metadata !DIExpression()), !dbg !142
  ...
  //   %cmp29 = icmp eq i32 %conv4, 2, !dbg !125

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !88, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !89, metadata !DIExpression()), !dbg !145

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !91, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %7, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv26, 0, !dbg !128

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !92, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !93, metadata !DIExpression()), !dbg !148

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !95, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %8, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !154, metadata !DIExpression()), !dbg !161
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !171, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !172, metadata !DIExpression()), !dbg !229

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !173, metadata !DIExpression()), !dbg !231

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !177, metadata !DIExpression()), !dbg !233

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !178, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !179, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !182, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !185, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !188, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !191, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !194, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !197, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !200, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !250

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !204, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !206, metadata !DIExpression()), !dbg !265

  //   %conv = trunc i64 %6 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !203, metadata !DIExpression()), !dbg !229

  //   %cmp = icmp eq i32 %conv, 1, !dbg !139

  //   %conv20 = zext i1 %cmp to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !207, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !209, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !211, metadata !DIExpression()), !dbg !269

  //   %conv24 = trunc i64 %7 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !208, metadata !DIExpression()), !dbg !229

  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !143

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !212, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !214, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !216, metadata !DIExpression()), !dbg !273

  //   %conv30 = trunc i64 %8 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !213, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !218, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !220, metadata !DIExpression()), !dbg !276

  //   %conv34 = trunc i64 %9 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !217, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !222, metadata !DIExpression()), !dbg !279

  //   %10 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !224, metadata !DIExpression()), !dbg !279

  //   %conv38 = trunc i64 %10 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !221, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !225, metadata !DIExpression()), !dbg !229
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
