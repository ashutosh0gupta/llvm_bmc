...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !84, metadata !DIExpression()), !dbg !115
  ...
  //   %conv16 = zext i1 %cmp to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !85, metadata !DIExpression()), !dbg !91

  //   store i32 %conv16, i32* @atom_1_X0_1, align 4, !dbg !100, !tbaa !101
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv4, 2, !dbg !105
  creg__r1__2_ = max(0,creg_r1);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !86, metadata !DIExpression()), !dbg !91

  //   store i32 %conv18, i32* @atom_1_X3_2, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv11, 2, !dbg !107
  ...
  //   store i32 %conv20, i32* @atom_1_X6_2, align 4, !dbg !108, !tbaa !101
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv15, 0, !dbg !109
  ...
  //   store i32 %conv22, i32* @atom_1_X7_0, align 4, !dbg !110, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !206

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !208

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !210

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !158, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !168, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !172, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !175, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !178, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !184, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !185, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !189, metadata !DIExpression()), !dbg !242

  //   %conv22 = trunc i64 %7 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !186, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !190, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !192, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !194, metadata !DIExpression()), !dbg !246

  //   %conv28 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !191, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !195, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !201, metadata !DIExpression()), !dbg !206

  //   %and32 = and i32 %9, %and31, !dbg !153
  creg_r19 = max(creg_r13,creg_r18);
  r19 = r13 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !202, metadata !DIExpression()), !dbg !206

  //   %and33 = and i32 %conv30, %and32, !dbg !154
  creg_r20 = max(creg__r12__2_,creg_r19);
  r20 = (r12==2) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !203, metadata !DIExpression()), !dbg !206
