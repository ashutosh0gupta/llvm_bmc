...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !99

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !67
  // LD: Guess
  old_cr = cr(2,r6);
  cr(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l34_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !79, metadata !DIExpression()), !dbg !99
...
T2BLOCK4:
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !77
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   store i32 %conv9, i32* @atom_1_X0_1, align 4, !dbg !82, !tbaa !83
  // ST: Guess
  ...
  //   store i32 %conv11, i32* @atom_1_X5_0, align 4, !dbg !88, !tbaa !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !140, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !144, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_0, metadata !147, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !151, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !153, metadata !DIExpression()), !dbg !192

  //   %conv = trunc i64 %4 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !150, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !154, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !156, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !158, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !159, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !164, metadata !DIExpression()), !dbg !167

  //   %and22 = and i32 %conv20, %and21, !dbg !127
  creg_r19 = max(creg__r13__1_,creg_r18);
  r19 = (r13==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !165, metadata !DIExpression()), !dbg !167

  //   %and23 = and i32 %conv14, %and22, !dbg !128
  creg_r20 = max(creg__r12__1_,creg_r19);
  r20 = (r12==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !166, metadata !DIExpression()), !dbg !167
