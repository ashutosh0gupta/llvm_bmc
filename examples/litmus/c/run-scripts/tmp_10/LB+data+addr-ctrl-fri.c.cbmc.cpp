...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !76, metadata !DIExpression()), !dbg !97
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !83, metadata !DIExpression()), !dbg !113

  //   %conv8 = trunc i64 %2 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !80, metadata !DIExpression()), !dbg !97
  ...
  //   store atomic i64 %3, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !89
  // ST: Guess
  ...
  //   store atomic i64 %4, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !148, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !194

  //   store atomic i64 0, i64* @atom_0_X0_1 monotonic, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !151, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64 0, metadata !153, metadata !DIExpression()), !dbg !196

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !168, metadata !DIExpression()), !dbg !218

  //   %6 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !172, metadata !DIExpression()), !dbg !221

  //   %7 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
