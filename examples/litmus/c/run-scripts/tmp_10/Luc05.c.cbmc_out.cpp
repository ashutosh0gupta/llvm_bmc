...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !131, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !135, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i32 0, metadata !137, metadata !DIExpression()), !dbg !165

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_2, metadata !138, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i32 0, metadata !140, metadata !DIExpression()), !dbg !167

  //   store atomic i32 0, i32* @atom_2_X0_2 monotonic, align 4, !dbg !93
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !114, !tbaa !112
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %9 = load i32, i32* @atom_2_X0_2, align 4, !dbg !115, !tbaa !112
  // LD: Guess
  old_cr = cr(0,4);
