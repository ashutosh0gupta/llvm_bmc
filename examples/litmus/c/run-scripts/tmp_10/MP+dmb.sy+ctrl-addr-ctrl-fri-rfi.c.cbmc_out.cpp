...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !72, metadata !DIExpression()), !dbg !89
  ...
  //   store i32 %conv22, i32* @atom_1_X7_0, align 4, !dbg !110, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !163, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !165, metadata !DIExpression()), !dbg !201

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X7_0, align 4, !dbg !128, !tbaa !126
  // LD: Guess
  old_cr = cr(0,5);
