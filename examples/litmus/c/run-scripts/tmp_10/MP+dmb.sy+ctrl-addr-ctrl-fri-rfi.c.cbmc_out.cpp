...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !123

  //   %conv15 = trunc i64 %3 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !72, metadata !DIExpression()), !dbg !98
  ...
  //   %cmp24 = icmp eq i32 %conv15, 0, !dbg !115

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !87, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !88, metadata !DIExpression()), !dbg !135
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !170, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !191, metadata !DIExpression()), !dbg !242
