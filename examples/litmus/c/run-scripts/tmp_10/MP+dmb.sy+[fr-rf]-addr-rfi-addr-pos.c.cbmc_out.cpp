...
T2BLOCK1:
  ...
  //   %xor9 = xor i32 %conv8, %conv8, !dbg !90
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !79, metadata !DIExpression()), !dbg !94

  //   %add11 = add nsw i32 0, %xor9, !dbg !91
  creg_r7 = max(0,creg_r6);
  r7 = 0 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !91

  //   %arrayidx13 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !91
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !81, metadata !DIExpression()), !dbg !111

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !83, metadata !DIExpression()), !dbg !111

  //   %conv16 = trunc i64 %3 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !80, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !113

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l38_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !87, metadata !DIExpression()), !dbg !113
  ...
  //   %cmp26 = icmp eq i32 %conv16, 0, !dbg !107
  ...
  //   store i32 %conv27, i32* @atom_1_X8_0, align 4, !dbg !108, !tbaa !99
  // ST: Guess
  ...
  //   store i32 %conv29, i32* @atom_1_X10_0, align 4, !dbg !110, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !178, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !230

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !181, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !232

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !128
  // ST: Guess
  ...
  //   %12 = load i32, i32* @atom_1_X8_0, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %13 = load i32, i32* @atom_1_X10_0, align 4, !dbg !160, !tbaa !155
  // LD: Guess
  old_cr = cr(0,7);
