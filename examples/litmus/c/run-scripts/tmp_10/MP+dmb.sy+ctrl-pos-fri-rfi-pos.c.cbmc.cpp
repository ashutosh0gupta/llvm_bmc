...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !68, metadata !DIExpression()), !dbg !105
  ...
  //   %cmp18 = icmp eq i32 %conv4, 0, !dbg !106
  ...
  //   store i32 %conv19, i32* @atom_1_X2_0, align 4, !dbg !107, !tbaa !102
  // ST: Guess
  ...
  //   store i32 %conv21, i32* @atom_1_X4_0, align 4, !dbg !109, !tbaa !102
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !158, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !202

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !161, metadata !DIExpression()), !dbg !204
  ...
  //   %7 = load i32, i32* @atom_1_X2_0, align 4, !dbg !136, !tbaa !134
  // LD: Guess
  old_cr = cr(0,3);
