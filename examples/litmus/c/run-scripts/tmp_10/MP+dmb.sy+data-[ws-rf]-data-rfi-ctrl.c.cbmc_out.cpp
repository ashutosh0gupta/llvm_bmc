...
T2BLOCK1:
  ...
  //   %add7 = add nsw i32 %xor6, 1, !dbg !88
  creg_r5 = max(0,creg_r4);
  r5 = r4 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add7, metadata !75, metadata !DIExpression()), !dbg !93
  ...
  //   %conv10 = sext i32 %add7 to i64, !dbg !90

  //   call void @llvm.dbg.value(metadata i64 %conv10, metadata !78, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %conv10, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !90
  // ST: Guess
  iw(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l37_c3
  old_cw = cw(2,0+3*1);
  cw(2,0+3*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l37_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !82, metadata !DIExpression()), !dbg !110

  //   %conv14 = trunc i64 %2 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !79, metadata !DIExpression()), !dbg !93

  //   %tobool = icmp ne i32 %conv14, 0, !dbg !94
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !86, metadata !DIExpression()), !dbg !119

  //   %conv18 = trunc i64 %3 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !83, metadata !DIExpression()), !dbg !93

  //   %cmp = icmp eq i32 %conv, 1, !dbg !103
  creg__r0__1_ = max(0,creg_r0);

  //   %conv19 = zext i1 %cmp to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !87, metadata !DIExpression()), !dbg !93

  //   store i32 %conv19, i32* @atom_1_X0_1, align 4, !dbg !104, !tbaa !105
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv5, 2, !dbg !109
  creg__r3__2_ = max(0,creg_r3);

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !88, metadata !DIExpression()), !dbg !93

  //   store i32 %conv21, i32* @atom_1_X4_2, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv14, 1, !dbg !111
  creg__r6__1_ = max(0,creg_r6);

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !89, metadata !DIExpression()), !dbg !93

  //   store i32 %conv23, i32* @atom_1_X7_1, align 4, !dbg !112, !tbaa !105
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv18, 0, !dbg !113
  creg__r7__0_ = max(0,creg_r7);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !90, metadata !DIExpression()), !dbg !93

  //   store i32 %conv25, i32* @atom_1_X8_0, align 4, !dbg !114, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !155, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !156, metadata !DIExpression()), !dbg !219

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !157, metadata !DIExpression()), !dbg !221

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !161, metadata !DIExpression()), !dbg !223

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !162, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !163, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !166, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !169, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !172, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !175, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i32 0, metadata !178, metadata !DIExpression()), !dbg !234

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !179, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i32 0, metadata !181, metadata !DIExpression()), !dbg !236

  //   store atomic i32 0, i32* @atom_1_X4_2 monotonic, align 4, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !182, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !184, metadata !DIExpression()), !dbg !238

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !185, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !240

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !130
  // ST: Guess
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !132
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !133
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !139
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call18 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !141
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call19 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !143
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !189, metadata !DIExpression()), !dbg !253

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !191, metadata !DIExpression()), !dbg !253

  //   %conv = trunc i64 %6 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !188, metadata !DIExpression()), !dbg !219

  //   %cmp = icmp eq i32 %conv, 1, !dbg !147
  creg__r12__1_ = max(0,creg_r12);

  //   %conv20 = zext i1 %cmp to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !192, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !257

  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !149
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !196, metadata !DIExpression()), !dbg !257

  //   %conv24 = trunc i64 %7 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !193, metadata !DIExpression()), !dbg !219

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !151
  creg__r13__1_ = max(0,creg_r13);

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !197, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !199, metadata !DIExpression()), !dbg !261

  //   %8 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !153
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !201, metadata !DIExpression()), !dbg !261

  //   %conv30 = trunc i64 %8 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !198, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !202, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !204, metadata !DIExpression()), !dbg !265

  //   %9 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !206, metadata !DIExpression()), !dbg !265

  //   %conv36 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !203, metadata !DIExpression()), !dbg !219

  //   %cmp37 = icmp eq i32 %conv36, 2, !dbg !159
  creg__r15__2_ = max(0,creg_r15);

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !207, metadata !DIExpression()), !dbg !219

  //   %10 = load i32, i32* @atom_1_X0_1, align 4, !dbg !160, !tbaa !161
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X4_2, align 4, !dbg !163, !tbaa !161
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %12 = load i32, i32* @atom_1_X7_1, align 4, !dbg !164, !tbaa !161
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %13 = load i32, i32* @atom_1_X8_0, align 4, !dbg !165, !tbaa !161
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %and39 = and i32 %11, %and, !dbg !167
  creg_r21 = max(creg_r17,creg_r20);
  r21 = r17 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !213, metadata !DIExpression()), !dbg !219

  //   %and40 = and i32 %10, %and39, !dbg !168
  creg_r22 = max(creg_r16,creg_r21);
  r22 = r16 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !214, metadata !DIExpression()), !dbg !219

  //   %and41 = and i32 %conv38, %and40, !dbg !169
  creg_r23 = max(creg__r15__2_,creg_r22);
  r23 = (r15==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !215, metadata !DIExpression()), !dbg !219

  //   %and42 = and i32 %conv32, %and41, !dbg !170
  creg_r24 = max(creg__r14__1_,creg_r23);
  r24 = (r14==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !216, metadata !DIExpression()), !dbg !219

  //   %and43 = and i32 %conv26, %and42, !dbg !171
  creg_r25 = max(creg__r13__1_,creg_r24);
  r25 = (r13==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !217, metadata !DIExpression()), !dbg !219

  //   %and44 = and i32 %conv20, %and43, !dbg !172
  creg_r26 = max(creg__r12__1_,creg_r25);
  r26 = (r12==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !218, metadata !DIExpression()), !dbg !219

  //   %cmp45 = icmp eq i32 %and44, 1, !dbg !173
  creg__r26__1_ = max(0,creg_r26);

  //   br i1 %cmp45, label %if.then, label %if.end, !dbg !175
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 100, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !176
