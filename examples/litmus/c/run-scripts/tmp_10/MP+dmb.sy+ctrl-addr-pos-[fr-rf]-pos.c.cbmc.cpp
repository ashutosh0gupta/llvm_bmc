...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !73, metadata !DIExpression()), !dbg !127
  ...
  //   %cmp23 = icmp eq i32 %conv8, 0, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !93, metadata !DIExpression()), !dbg !142
  ...
  //   %cmp28 = icmp eq i32 %conv12, 0, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !97, metadata !DIExpression()), !dbg !145

  //   %8 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !99, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %8, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv16, 1, !dbg !128
  ...
  //   %cmp38 = icmp eq i32 %conv20, 1, !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !105, metadata !DIExpression()), !dbg !151

  //   %10 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !107, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %10, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !133
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !194, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !197, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !259

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !132
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !200, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !203, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !221, metadata !DIExpression()), !dbg !289

  //   %9 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !162
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !225, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !229, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !233, metadata !DIExpression()), !dbg !298
