...
T3BLOCK2:
  //   br label %lbl_LC01, !dbg !57
  goto T3BLOCK4;

T3BLOCK3:
  //   br label %lbl_LC01, !dbg !58
  goto T3BLOCK4;
...
T0BLOCK0:
  ...
  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !129, metadata !DIExpression()), !dbg !162

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !133, metadata !DIExpression()), !dbg !164

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #6, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !134, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !135, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !138, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !141, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !144, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !148, metadata !DIExpression()), !dbg !175
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !90
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !91
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #6, !dbg !92
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !154, metadata !DIExpression()), !dbg !188

  //   %conv = trunc i64 %6 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !151, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !155, metadata !DIExpression()), !dbg !160

  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !107, !tbaa !108
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l71_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !159, metadata !DIExpression()), !dbg !160
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !116
