...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !65, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !70, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !71, metadata !DIExpression()), !dbg !100

  //   %3 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !73, metadata !DIExpression()), !dbg !100
  ...
  //   %cmp11 = icmp eq i32 %conv8, 0, !dbg !83

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !75, metadata !DIExpression()), !dbg !103

  //   %4 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !77, metadata !DIExpression()), !dbg !103

  //   store atomic i64 %4, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !85
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
