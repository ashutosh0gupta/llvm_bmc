...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !68, metadata !DIExpression()), !dbg !86

  //   %add = add nsw i32 0, %xor, !dbg !76
  creg_r2 = max(0,creg_r1);
  r2 = 0 + r1;

  //   %idxprom = sext i32 %add to i64, !dbg !76

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !76
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !70, metadata !DIExpression()), !dbg !96
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !69, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !98

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !80
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !76, metadata !DIExpression()), !dbg !98

  //   %conv8 = trunc i64 %2 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !73, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !101

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !101

  //   %conv12 = trunc i64 %3 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !77, metadata !DIExpression()), !dbg !86

  //   %cmp = icmp eq i32 %conv, 2, !dbg !85
  creg__r0__2_ = max(0,creg_r0);

  //   %conv13 = zext i1 %cmp to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !81, metadata !DIExpression()), !dbg !86

  //   store i32 %conv13, i32* @atom_1_X2_2, align 4, !dbg !86, !tbaa !87
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 0, !dbg !91
  creg__r4__0_ = max(0,creg_r4);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !82, metadata !DIExpression()), !dbg !86

  //   store i32 %conv15, i32* @atom_1_X4_0, align 4, !dbg !92, !tbaa !87
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 1, !dbg !93
  creg__r5__1_ = max(0,creg_r5);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !83, metadata !DIExpression()), !dbg !86

  //   store i32 %conv17, i32* @atom_1_X6_1, align 4, !dbg !94, !tbaa !87
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv12, 1, !dbg !95
  creg__r6__1_ = max(0,creg_r6);

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !84, metadata !DIExpression()), !dbg !86

  //   store i32 %conv19, i32* @atom_1_X7_1, align 4, !dbg !96, !tbaa !87
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !120, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 1, metadata !122, metadata !DIExpression()), !dbg !127

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !50
  // ST: Guess
  iw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l49_c3
  old_cw = cw(3,0);
  cw(3,0) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l49_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !144, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !145, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !151, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !194

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !102
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l60_c3
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l60_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !155, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !196

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !158, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !198

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !161, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !200

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !168, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !172, metadata !DIExpression()), !dbg !217

  //   %conv20 = trunc i64 %7 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !169, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !173, metadata !DIExpression()), !dbg !183

  //   %8 = load i32, i32* @atom_1_X2_2, align 4, !dbg !130, !tbaa !131
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l77_c13
  // Check
  ...
  //   %9 = load i32, i32* @atom_1_X4_0, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %10 = load i32, i32* @atom_1_X6_1, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X7_1, align 4, !dbg !135, !tbaa !131
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !144
