...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !169, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !221

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !194, metadata !DIExpression()), !dbg !252

  //   %10 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,4);
