...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !59, metadata !DIExpression()), !dbg !100
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !103

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !64, metadata !DIExpression()), !dbg !103

  //   %conv = trunc i64 %0 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !60, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !66, metadata !DIExpression()), !dbg !106

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !65, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !109

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !69, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !73, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !100

  //   %tobool = icmp ne i32 %conv12, 0, !dbg !97
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !99), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !123
  ...
  //   %conv16 = trunc i64 %4 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !78, metadata !DIExpression()), !dbg !100

  //   %cmp = icmp eq i32 %conv, 1, !dbg !107

  //   %conv17 = zext i1 %cmp to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !82, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !83, metadata !DIExpression()), !dbg !127

  //   %5 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !85, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !86, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !87, metadata !DIExpression()), !dbg !130

  //   %6 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %6, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !112
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 2, !dbg !113

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !90, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !91, metadata !DIExpression()), !dbg !133

  //   %7 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %7, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !94, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !95, metadata !DIExpression()), !dbg !136

  //   %8 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %8, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !118
  // ST: Guess
...
T0BLOCK0:
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !176, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !179, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !234

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !182, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !236

  //   store atomic i64 0, i64* @atom_1_X3_2 monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !185, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !238

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !124
  // ST: Guess
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !126
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !127
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !133
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !135
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !137
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !253

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !139
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !192, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !257

  //   %7 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !143
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   %conv22 = trunc i64 %7 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !193, metadata !DIExpression()), !dbg !219

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !145
  ...
  //   %8 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %conv28 = trunc i64 %8 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !198, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !203, metadata !DIExpression()), !dbg !264

  //   %9 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !150
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !205, metadata !DIExpression()), !dbg !264

  //   %conv32 = trunc i64 %9 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !202, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !207, metadata !DIExpression()), !dbg !267

  //   %10 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !153
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !209, metadata !DIExpression()), !dbg !267

  //   %conv36 = trunc i64 %10 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !206, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !211, metadata !DIExpression()), !dbg !270

  //   %11 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !156
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !213, metadata !DIExpression()), !dbg !270

  //   %conv40 = trunc i64 %11 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !210, metadata !DIExpression()), !dbg !219

  //   %and = and i32 %conv36, %conv40, !dbg !158
  ...
  //   %and41 = and i32 %conv32, %and, !dbg !159
  ...
  //   %and42 = and i32 %conv28, %and41, !dbg !160
  ...
  //   %and43 = and i32 %conv24, %and42, !dbg !161
  ...
  //   %and44 = and i32 %conv18, %and43, !dbg !162
  ...
  //   %cmp45 = icmp eq i32 %and44, 1, !dbg !163

  //   br i1 %cmp45, label %if.then, label %if.end, !dbg !165
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
