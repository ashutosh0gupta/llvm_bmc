...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !49, metadata !DIExpression()), !dbg !67
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !55, metadata !DIExpression()), !dbg !69

  //   %conv = trunc i64 %0 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !52, metadata !DIExpression()), !dbg !58
  ...
  //   store i32 %conv7, i32* @atom_0_X6_2, align 4, !dbg !73, !tbaa !74
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !99
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X6_2, metadata !132, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_3, metadata !136, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !139, metadata !DIExpression()), !dbg !172
  ...
  //   %8 = load i32, i32* @atom_1_X2_2, align 4, !dbg !119, !tbaa !116
  // LD: Guess
  old_cr = cr(0,4);
