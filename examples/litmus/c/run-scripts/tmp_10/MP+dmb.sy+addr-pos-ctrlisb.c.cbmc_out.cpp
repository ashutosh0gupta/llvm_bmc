...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !70, metadata !DIExpression()), !dbg !84

  //   %cmp = icmp eq i32 %conv, 1, !dbg !88

  //   %conv13 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !74, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !75, metadata !DIExpression()), !dbg !108

  //   %4 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !77, metadata !DIExpression()), !dbg !108

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !90
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv12, 0, !dbg !91

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !78, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !79, metadata !DIExpression()), !dbg !111

  //   %5 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !81, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %5, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !137, metadata !DIExpression()), !dbg !175
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([111 x i8], [111 x i8]* @.str.1, i64 0, i64 0), i32 noundef 68, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !128
