...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !80, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !107

  //   %conv5 = sext i32 %add to i64, !dbg !77

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !83, metadata !DIExpression()), !dbg !107

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !77
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !92, metadata !DIExpression()), !dbg !115

  //   %3 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !94, metadata !DIExpression()), !dbg !115

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !85
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_2, metadata !138, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !144, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_2, metadata !158, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !166, metadata !DIExpression()), !dbg !212
