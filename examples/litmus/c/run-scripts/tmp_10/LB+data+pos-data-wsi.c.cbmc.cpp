...
T1BLOCK1:
  ...
  //   store i32 %conv2, i32* @atom_0_X0_2, align 4, !dbg !62, !tbaa !63
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !96

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !66
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !78, metadata !DIExpression()), !dbg !96

  //   %conv4 = trunc i64 %1 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !75, metadata !DIExpression()), !dbg !90

  //   %xor = xor i32 %conv4, %conv4, !dbg !68
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !80, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !101

  //   %conv5 = sext i32 %add to i64, !dbg !71

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !83, metadata !DIExpression()), !dbg !101

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !73
  // ST: Guess
  ...
  //   %cmp9 = icmp eq i32 %conv4, 1, !dbg !80
  ...
  //   store i32 %conv10, i32* @atom_1_X2_1, align 4, !dbg !81, !tbaa !76
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_2, metadata !130, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !166

  //   store atomic i32 0, i32* @atom_0_X0_2 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !137, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !139, metadata !DIExpression()), !dbg !170

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !96
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X0_2, align 4, !dbg !115, !tbaa !116
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %8 = load i32, i32* @atom_1_X2_1, align 4, !dbg !119, !tbaa !116
  // LD: Guess
  old_cr = cr(0,4);
