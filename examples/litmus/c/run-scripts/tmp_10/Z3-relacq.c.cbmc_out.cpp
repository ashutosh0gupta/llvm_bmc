...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !38, metadata !DIExpression()), !dbg !53

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !54
  // LD: Guess
  //   : Acquire
  old_cr = cr(1,0+1*1);
  cr(1,0+1*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN LDCOM _l20_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !41, metadata !DIExpression()), !dbg !53

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !37, metadata !DIExpression()), !dbg !50

  //   %and = and i32 %conv, 8, !dbg !56
  creg_r1 = max(0,creg_r0);
  r1 = r0 & 8;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !42, metadata !DIExpression()), !dbg !50

  //   %add = add nsw i32 0, %and, !dbg !57
  creg_r2 = max(0,creg_r1);
  r2 = 0 + r1;

  //   %1 = zext i32 %add to i64

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %1, !dbg !57
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !44, metadata !DIExpression()), !dbg !58

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !57
  // LD: Guess
  old_cr = cr(1,r3);
  ...
  //   %conv4 = trunc i64 %2 to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !43, metadata !DIExpression()), !dbg !50
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !47, metadata !DIExpression()), !dbg !50

  //   store i32 %conv5, i32* @atom_0_X0_1, align 4, !dbg !61, !tbaa !62
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !48, metadata !DIExpression()), !dbg !50

  //   store i32 %conv7, i32* @atom_0_X3_0, align 4, !dbg !67, !tbaa !62
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !71, metadata !DIExpression()), !dbg !79
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !82

  //   call void @llvm.dbg.value(metadata i64 1, metadata !74, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !84
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !93, metadata !DIExpression()), !dbg !102
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !112, metadata !DIExpression()), !dbg !145

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !113, metadata !DIExpression()), !dbg !145

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !114, metadata !DIExpression()), !dbg !147

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !118, metadata !DIExpression()), !dbg !149

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !119, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !120, metadata !DIExpression()), !dbg !152
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !123, metadata !DIExpression()), !dbg !154
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !126, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !129, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i32 0, metadata !132, metadata !DIExpression()), !dbg !158

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_0, metadata !133, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i32 0, metadata !135, metadata !DIExpression()), !dbg !160

  //   store atomic i32 0, i32* @atom_0_X3_0 monotonic, align 4, !dbg !89
  // ST: Guess
  ...
  //   %call9 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !91
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call10 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !92
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call11 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !98
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call12 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !100
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !102
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l63_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !139, metadata !DIExpression()), !dbg !173
  ...
  //   %conv14 = zext i1 %cmp to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !140, metadata !DIExpression()), !dbg !145

  //   %7 = load i32, i32* @atom_0_X0_1, align 4, !dbg !107, !tbaa !108
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_0_X3_0, align 4, !dbg !110, !tbaa !108
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %and15 = and i32 %conv14, %and, !dbg !112
  creg_r13 = max(creg__r9__2_,creg_r12);
  r13 = (r9==2) & r12;

  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !144, metadata !DIExpression()), !dbg !145

  //   %cmp16 = icmp eq i32 %and15, 1, !dbg !113
  creg__r13__1_ = max(0,creg_r13);

  //   br i1 %cmp16, label %if.then, label %if.end, !dbg !115
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
