...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !38, metadata !DIExpression()), !dbg !59

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !60
  // LD: Guess
  //   : Acquire
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !41, metadata !DIExpression()), !dbg !59

  //   %conv = trunc i64 %0 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !36, metadata !DIExpression()), !dbg !56

  //   %and = and i32 %conv, 8, !dbg !62
  creg_r1 = max(creg_r0,0);
  ASSUME(active[creg_r1] == 1);
  r1 = r0 & 8;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !42, metadata !DIExpression()), !dbg !56

  //   %add = add nsw i32 0, %and, !dbg !63
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %1, !dbg !63
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ASSUME(creg_r3 >= creg_r2);
  ASSUME(active[creg_r3] == 1);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !44, metadata !DIExpression()), !dbg !64

  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(1,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !46, metadata !DIExpression()), !dbg !64

  //   %conv4 = trunc i64 %2 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !43, metadata !DIExpression()), !dbg !56

  //   %cmp = icmp eq i32 %conv, 1, !dbg !66

  //   %conv5 = zext i1 %cmp to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !47, metadata !DIExpression()), !dbg !56

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !48, metadata !DIExpression()), !dbg !67

  //   %3 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !50, metadata !DIExpression()), !dbg !67

  //   store atomic i64 %3, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !51, metadata !DIExpression()), !dbg !56

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_0, metadata !52, metadata !DIExpression()), !dbg !70

  //   %4 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !54, metadata !DIExpression()), !dbg !70

  //   store atomic i64 %4, i64* @atom_0_X3_0 seq_cst, align 8, !dbg !71
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !86
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !97, metadata !DIExpression()), !dbg !106
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !123, metadata !DIExpression()), !dbg !160
  ...
  //   store atomic i64 0, i64* @atom_0_X0_1 monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_0, metadata !136, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64 0, metadata !138, metadata !DIExpression()), !dbg !169

  //   store atomic i64 0, i64* @atom_0_X3_0 monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !140, metadata !DIExpression()), !dbg !184

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !142, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !145, metadata !DIExpression()), !dbg !188

  //   %7 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !147, metadata !DIExpression()), !dbg !188

  //   %conv18 = trunc i64 %7 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !144, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_0, metadata !149, metadata !DIExpression()), !dbg !191

  //   %8 = load atomic i64, i64* @atom_0_X3_0 seq_cst, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !148, metadata !DIExpression()), !dbg !154
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
