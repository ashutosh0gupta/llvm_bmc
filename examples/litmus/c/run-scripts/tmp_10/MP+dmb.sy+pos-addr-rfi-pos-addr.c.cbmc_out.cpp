...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !138, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !139, metadata !DIExpression()), !dbg !197

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !140, metadata !DIExpression()), !dbg !199

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !144, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !145, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !151, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64 0, metadata !153, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !154, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !208

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !117
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l59_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l59_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !158, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !210

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !119
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l60_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l60_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !161, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !212

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !164, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !214

  //   store atomic i32 0, i32* @atom_1_X7_1 monotonic, align 4, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !167, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !216

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !171, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !173, metadata !DIExpression()), !dbg !226

  //   %conv = trunc i64 %4 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !170, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !174, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !176, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !178, metadata !DIExpression()), !dbg !230

  //   %conv22 = trunc i64 %5 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !175, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !179, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !181, metadata !DIExpression()), !dbg !234

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l75_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !183, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !184, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !185, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !186, metadata !DIExpression()), !dbg !197

  //   %9 = load i32, i32* @atom_1_X6_1, align 4, !dbg !152, !tbaa !149
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !187, metadata !DIExpression()), !dbg !197

  //   %10 = load i32, i32* @atom_1_X7_1, align 4, !dbg !153, !tbaa !149
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l80_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !188, metadata !DIExpression()), !dbg !197

  //   %11 = load i32, i32* @atom_1_X9_0, align 4, !dbg !154, !tbaa !149
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l81_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !189, metadata !DIExpression()), !dbg !197

  //   %and = and i32 %10, %11, !dbg !155
  creg_r22 = max(creg_r20,creg_r21);
  r22 = r20 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !190, metadata !DIExpression()), !dbg !197

  //   %and31 = and i32 %9, %and, !dbg !156
  creg_r23 = max(creg_r19,creg_r22);
  r23 = r19 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !191, metadata !DIExpression()), !dbg !197

  //   %and32 = and i32 %8, %and31, !dbg !157
  creg_r24 = max(creg_r18,creg_r23);
  r24 = r18 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !192, metadata !DIExpression()), !dbg !197

  //   %and33 = and i32 %7, %and32, !dbg !158
  creg_r25 = max(creg_r17,creg_r24);
  r25 = r17 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !193, metadata !DIExpression()), !dbg !197

  //   %and34 = and i32 %conv30, %and33, !dbg !159
  creg_r26 = max(creg__r16__1_,creg_r25);
  r26 = (r16==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !194, metadata !DIExpression()), !dbg !197

  //   %and35 = and i32 %conv24, %and34, !dbg !160
  creg_r27 = max(creg__r15__1_,creg_r26);
  r27 = (r15==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !195, metadata !DIExpression()), !dbg !197

  //   %and36 = and i32 %conv18, %and35, !dbg !161
  creg_r28 = max(creg__r14__1_,creg_r27);
  r28 = (r14==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !196, metadata !DIExpression()), !dbg !197
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 89, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !165
