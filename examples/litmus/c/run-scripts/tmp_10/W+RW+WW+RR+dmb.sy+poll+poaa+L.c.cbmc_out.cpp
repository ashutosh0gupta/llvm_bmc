...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !46

  //   call void @llvm.dbg.value(metadata i64 1, metadata !41, metadata !DIExpression()), !dbg !46

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !47
  // ST: Guess
  //   : Release
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !54, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !57, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64 1, metadata !59, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !61, metadata !DIExpression()), !dbg !75
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !80, metadata !DIExpression()), !dbg !88
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !81, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64 2, metadata !83, metadata !DIExpression()), !dbg !91

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !50
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !84, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64 1, metadata !86, metadata !DIExpression()), !dbg !93

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !52
  // ST: Guess
  //   : Release
  ...
  ASSUME(cw(3,0+2*1) >= cr(3,3+0));
  ASSUME(cw(3,0+2*1) >= cr(3,4+0));
  ...
  ASSUME(cw(3,0+2*1) >= cw(3,3+0));
  ASSUME(cw(3,0+2*1) >= cw(3,4+0));
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !98, metadata !DIExpression()), !dbg !116
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !100, metadata !DIExpression()), !dbg !119

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !61
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+2*1);
  ...
  ASSUME(cr(4,0+2*1) >= cs(4,3+0));
  ASSUME(cr(4,0+2*1) >= cs(4,4+0));
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !102, metadata !DIExpression()), !dbg !119

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !99, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !104, metadata !DIExpression()), !dbg !122

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !64
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !106, metadata !DIExpression()), !dbg !122

  //   %conv4 = trunc i64 %1 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !103, metadata !DIExpression()), !dbg !116

  //   %cmp = icmp eq i32 %conv, 1, !dbg !66

  //   %conv5 = zext i1 %cmp to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !107, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !108, metadata !DIExpression()), !dbg !126

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !110, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %2, i64* @atom_3_X0_1 seq_cst, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !111, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !112, metadata !DIExpression()), !dbg !129

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !114, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %3, i64* @atom_3_X2_0 seq_cst, align 8, !dbg !71
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !139, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !140, metadata !DIExpression()), !dbg !186

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !141, metadata !DIExpression()), !dbg !188

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !145, metadata !DIExpression()), !dbg !190

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !146, metadata !DIExpression()), !dbg !192

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !147, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !148, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !154, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !157, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !160, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !203

  //   store atomic i64 0, i64* @atom_3_X0_1 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !163, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64 0, metadata !165, metadata !DIExpression()), !dbg !205

  //   store atomic i64 0, i64* @atom_3_X2_0 monotonic, align 8, !dbg !109
  // ST: Guess
  ...
  //   %call12 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !112
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !113
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !123
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !125
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !127
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !169, metadata !DIExpression()), !dbg !223

  //   %conv = trunc i64 %8 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !166, metadata !DIExpression()), !dbg !186

  //   %cmp = icmp eq i32 %conv, 2, !dbg !129

  //   %conv18 = zext i1 %cmp to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !170, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !172, metadata !DIExpression()), !dbg !227

  //   %9 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !174, metadata !DIExpression()), !dbg !227

  //   %conv22 = trunc i64 %9 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !171, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !176, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !178, metadata !DIExpression()), !dbg !230

  //   %conv26 = trunc i64 %10 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !175, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !180, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !182, metadata !DIExpression()), !dbg !233

  //   %conv30 = trunc i64 %11 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !179, metadata !DIExpression()), !dbg !186

  //   %and = and i32 %conv26, %conv30, !dbg !139
  creg_r12 = max(creg_r10,creg_r11);
  ASSUME(active[creg_r12] == 0);
  r12 = r10 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !183, metadata !DIExpression()), !dbg !186

  //   %and31 = and i32 %conv22, %and, !dbg !140
  creg_r13 = max(creg_r9,creg_r12);
  ASSUME(active[creg_r13] == 0);
  r13 = r9 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !184, metadata !DIExpression()), !dbg !186

  //   %and32 = and i32 %conv18, %and31, !dbg !141
  creg_r14 = max(max(creg_r8,0),creg_r13);
  ASSUME(active[creg_r14] == 0);
  r14 = (r8==2) & r13;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !185, metadata !DIExpression()), !dbg !186

  //   %cmp33 = icmp eq i32 %and32, 1, !dbg !142

  //   br i1 %cmp33, label %if.then, label %if.end, !dbg !144
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 84, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !145
