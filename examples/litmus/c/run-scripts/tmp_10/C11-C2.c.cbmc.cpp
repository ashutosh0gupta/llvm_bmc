...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !40, metadata !DIExpression()), !dbg !45
...
T3BLOCK1:
  ...
  // ST: Guess
  iw(3,2) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l37_c15
  old_cw = cw(3,2);
  cw(3,2) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l37_c15
  // Check
  ...
  //   %cmp6 = icmp eq i32 %conv4, 3, !dbg !69
  ...
  //   store i32 %conv7, i32* @atom_2_X4_3, align 4, !dbg !70, !tbaa !65
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !124, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i32 0, metadata !127, metadata !DIExpression()), !dbg !151

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !82
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X4_3, metadata !128, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i32 0, metadata !130, metadata !DIExpression()), !dbg !153

  //   store atomic i32 0, i32* @atom_2_X4_3 monotonic, align 4, !dbg !84
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_2_X0_1, align 4, !dbg !102, !tbaa !103
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %8 = load i32, i32* @atom_2_X4_3, align 4, !dbg !105, !tbaa !103
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([91 x i8], [91 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
