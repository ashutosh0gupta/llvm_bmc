...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !131, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i32 0, metadata !134, metadata !DIExpression()), !dbg !157

  //   store atomic i32 0, i32* @atom_1_X0_2 monotonic, align 4, !dbg !83
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !135, metadata !DIExpression()), !dbg !159
  ...
  //   %6 = load i32, i32* @atom_1_X0_2, align 4, !dbg !101, !tbaa !102
  // LD: Guess
  old_cr = cr(0,2);
