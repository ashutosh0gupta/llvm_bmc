...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !68, metadata !DIExpression()), !dbg !102
  ...
  // ST: Guess
  iw(2,r3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l33_c3
  old_cw = cw(2,r3);
  cw(2,r3) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l33_c3
  // Check
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !74, metadata !DIExpression()), !dbg !103

  //   %conv4 = trunc i64 %1 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !71, metadata !DIExpression()), !dbg !94
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !103
  ...
  //   store i32 %conv23, i32* @atom_1_X5_1, align 4, !dbg !104, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !172, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !226

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !122
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X5_1, align 4, !dbg !157, !tbaa !155
  // LD: Guess
  old_cr = cr(0,4);
