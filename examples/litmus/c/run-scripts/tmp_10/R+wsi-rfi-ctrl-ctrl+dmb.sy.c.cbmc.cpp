...
T1BLOCK1:
  //   call void @llvm.dbg.label(metadata !56), !dbg !61
...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !48, metadata !DIExpression()), !dbg !59

  //   %tobool7 = icmp ne i32 %conv6, 0, !dbg !78
  creg__r1__0_ = max(0,creg_r1);

  //   br i1 %tobool7, label %if.then8, label %if.else9, !dbg !80
  old_cctrl = cctrl[1];
  cctrl[1] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[1] >= old_cctrl);
...
T1BLOCK7:
  //   call void @llvm.dbg.label(metadata !58), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !52, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64 1, metadata !54, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !55, metadata !DIExpression()), !dbg !59

  //   store i32 %conv12, i32* @atom_0_X3_2, align 4, !dbg !87, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_2, metadata !140, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !144, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !153, metadata !DIExpression()), !dbg !189
