...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !92, metadata !DIExpression()), !dbg !110
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !141, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 0, metadata !143, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !144, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64 0, metadata !146, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !147, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !151, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !150, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !155, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !154, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !159, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !161, metadata !DIExpression()), !dbg !200

  //   %conv21 = trunc i64 %8 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !158, metadata !DIExpression()), !dbg !164
