...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !40, metadata !DIExpression()), !dbg !54
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !57

  //   call void @llvm.dbg.value(metadata i64 2, metadata !44, metadata !DIExpression()), !dbg !57

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !58
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !45, metadata !DIExpression()), !dbg !59

  //   call void @llvm.dbg.value(metadata i64 1, metadata !47, metadata !DIExpression()), !dbg !59

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !60
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !49, metadata !DIExpression()), !dbg !61
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !51, metadata !DIExpression()), !dbg !61

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !48, metadata !DIExpression()), !dbg !54

  //   %cmp = icmp eq i32 %conv, 2, !dbg !64
  creg__r0__2_ = max(0,creg_r0);

  //   %conv3 = zext i1 %cmp to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !52, metadata !DIExpression()), !dbg !54

  //   store i32 %conv3, i32* @atom_0_X4_2, align 4, !dbg !65, !tbaa !66
  // ST: Guess
  iw(1,2) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l26_c15
  old_cw = cw(1,2);
  cw(1,2) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l26_c15
  // Check
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !73, metadata !DIExpression()), !dbg !96
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !74, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 2, metadata !76, metadata !DIExpression()), !dbg !99

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !68
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !101

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !70
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !103

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !72
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !80, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !106

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !75
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !87, metadata !DIExpression()), !dbg !106

  //   %conv6 = trunc i64 %1 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !84, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !109

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !91, metadata !DIExpression()), !dbg !109

  //   %conv10 = trunc i64 %2 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !88, metadata !DIExpression()), !dbg !96

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !80
  creg__r3__2_ = max(0,creg_r3);

  //   %conv11 = zext i1 %cmp to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !92, metadata !DIExpression()), !dbg !96

  //   store i32 %conv11, i32* @atom_1_X6_2, align 4, !dbg !81, !tbaa !82
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv, 1, !dbg !86
  creg__r1__1_ = max(0,creg_r1);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !93, metadata !DIExpression()), !dbg !96

  //   store i32 %conv13, i32* @atom_1_X4_1, align 4, !dbg !87, !tbaa !82
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv6, 1, !dbg !88
  creg__r2__1_ = max(0,creg_r2);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !94, metadata !DIExpression()), !dbg !96

  //   store i32 %conv15, i32* @atom_1_X5_1, align 4, !dbg !89, !tbaa !82
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !126, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !127, metadata !DIExpression()), !dbg !171

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !128, metadata !DIExpression()), !dbg !173

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !132, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !133, metadata !DIExpression()), !dbg !176

  //   call void @llvm.dbg.value(metadata i64 0, metadata !135, metadata !DIExpression()), !dbg !176

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !136, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 0, metadata !138, metadata !DIExpression()), !dbg !178

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_2, metadata !139, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !142, metadata !DIExpression()), !dbg !180

  //   store atomic i32 0, i32* @atom_0_X4_2 monotonic, align 4, !dbg !99
  // ST: Guess
  iw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l52_c3
  old_cw = cw(0,2);
  cw(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l52_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_2, metadata !143, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !145, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_1_X6_2 monotonic, align 4, !dbg !101
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l53_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l53_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !146, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !103
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l54_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l54_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !149, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !186

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !105
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l55_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l55_c3
  // Check
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !107
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !108, !tbaa !109
  r5 = local_mem[0];

  //   %call12 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !113
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !114, !tbaa !109
  r6 = local_mem[1];
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !153, metadata !DIExpression()), !dbg !196

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,0);
  cr(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l63_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !155, metadata !DIExpression()), !dbg !196

  //   %conv = trunc i64 %4 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !152, metadata !DIExpression()), !dbg !171

  //   %cmp = icmp eq i32 %conv, 2, !dbg !119
  creg__r7__2_ = max(0,creg_r7);

  //   %conv14 = zext i1 %cmp to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !156, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !158, metadata !DIExpression()), !dbg !200

  //   %5 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l65_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !160, metadata !DIExpression()), !dbg !200

  //   %conv18 = trunc i64 %5 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !157, metadata !DIExpression()), !dbg !171

  //   %cmp19 = icmp eq i32 %conv18, 2, !dbg !123
  creg__r8__2_ = max(0,creg_r8);

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !161, metadata !DIExpression()), !dbg !171

  //   %6 = load i32, i32* @atom_0_X4_2, align 4, !dbg !124, !tbaa !125
  // LD: Guess
  old_cr = cr(0,2);
  cr(0,2) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l67_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !162, metadata !DIExpression()), !dbg !171

  //   %7 = load i32, i32* @atom_1_X6_2, align 4, !dbg !127, !tbaa !125
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !163, metadata !DIExpression()), !dbg !171

  //   %8 = load i32, i32* @atom_1_X4_1, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !164, metadata !DIExpression()), !dbg !171

  //   %9 = load i32, i32* @atom_1_X5_1, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !165, metadata !DIExpression()), !dbg !171

  //   %and = and i32 %8, %9, !dbg !130
  creg_r13 = max(creg_r11,creg_r12);
  r13 = r11 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !166, metadata !DIExpression()), !dbg !171

  //   %and21 = and i32 %7, %and, !dbg !131
  creg_r14 = max(creg_r10,creg_r13);
  r14 = r10 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !167, metadata !DIExpression()), !dbg !171

  //   %and22 = and i32 %6, %and21, !dbg !132
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !168, metadata !DIExpression()), !dbg !171

  //   %and23 = and i32 %conv20, %and22, !dbg !133
  creg_r16 = max(creg__r8__2_,creg_r15);
  r16 = (r8==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !169, metadata !DIExpression()), !dbg !171

  //   %and24 = and i32 %conv14, %and23, !dbg !134
  creg_r17 = max(creg__r7__2_,creg_r16);
  r17 = (r7==2) & r16;

  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !170, metadata !DIExpression()), !dbg !171

  //   %cmp25 = icmp eq i32 %and24, 1, !dbg !135
  creg__r17__1_ = max(0,creg_r17);

  //   br i1 %cmp25, label %if.then, label %if.end, !dbg !137
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
...
T0BLOCK2:
  //   %10 = bitcast i64* %thr1 to i8*, !dbg !141

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %10) #7, !dbg !141

  //   %11 = bitcast i64* %thr0 to i8*, !dbg !141
