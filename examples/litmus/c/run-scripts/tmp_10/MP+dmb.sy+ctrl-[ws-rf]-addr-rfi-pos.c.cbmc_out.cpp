...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !101), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !79, metadata !DIExpression()), !dbg !122

  //   %conv10 = trunc i64 %2 to i32, !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !89, metadata !DIExpression()), !dbg !132
  ...
  //   %cmp24 = icmp eq i32 %conv10, 1, !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !93, metadata !DIExpression()), !dbg !135
  ...
  //   %cmp29 = icmp eq i32 %conv14, 1, !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !97, metadata !DIExpression()), !dbg !138

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %7, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !120
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !184, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !187, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !214, metadata !DIExpression()), !dbg !279

  //   %11 = load atomic i64, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !163
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !218, metadata !DIExpression()), !dbg !282
