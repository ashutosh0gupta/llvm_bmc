...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !107

  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !89
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !107

  //   %conv12 = trunc i64 %3 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !94

  //   %xor13 = xor i32 %conv12, %conv12, !dbg !91
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !80, metadata !DIExpression()), !dbg !94

  //   %add14 = add nsw i32 0, %xor13, !dbg !92
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !92

  //   %arrayidx16 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !92
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !81, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64 1, metadata !83, metadata !DIExpression()), !dbg !112

  //   store atomic i64 1, i64* %arrayidx16 monotonic, align 8, !dbg !92
  // ST: Guess
  iw(2,r9) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l37_c3
  old_cw = cw(2,r9);
  cw(2,r9) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l37_c3
  // Check
  ...
  //   store i32 %conv27, i32* @atom_1_X6_1, align 4, !dbg !108, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !178, metadata !DIExpression()), !dbg !230
