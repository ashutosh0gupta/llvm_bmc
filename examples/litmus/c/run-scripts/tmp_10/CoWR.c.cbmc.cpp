...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !35, metadata !DIExpression()), !dbg !48

  //   call void @llvm.dbg.value(metadata i64 1, metadata !38, metadata !DIExpression()), !dbg !48

  //   store atomic i64 1, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !49
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !50

  //   %0 = load atomic i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !51
  // LD: Guess
  old_cr = cr(1,0);
  ...
  //   store i32 %conv1, i32* @atom_0_X2_2, align 4, !dbg !54, !tbaa !55
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_2, metadata !90, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i32 0, metadata !93, metadata !DIExpression()), !dbg !108

  //   store atomic i32 0, i32* @atom_0_X2_2 monotonic, align 4, !dbg !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !118

  //   %4 = load atomic i64, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !97, metadata !DIExpression()), !dbg !118

  //   %conv = trunc i64 %4 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !94, metadata !DIExpression()), !dbg !101

  //   %cmp = icmp eq i32 %conv, 1, !dbg !81
  creg__r4__1_ = max(0,creg_r4);

  //   %conv6 = zext i1 %cmp to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !98, metadata !DIExpression()), !dbg !101

  //   %5 = load i32, i32* @atom_0_X2_2, align 4, !dbg !82, !tbaa !83
  // LD: Guess
  old_cr = cr(0,1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !99, metadata !DIExpression()), !dbg !101

  //   %and = and i32 %conv6, %5, !dbg !85
  creg_r6 = max(creg__r4__1_,creg_r5);
  r6 = (r4==1) & r5;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 49, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !89
