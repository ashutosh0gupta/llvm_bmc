...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !46, metadata !DIExpression()), !dbg !58

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !50, metadata !DIExpression()), !dbg !61

  //   call void @llvm.dbg.value(metadata i64 1, metadata !52, metadata !DIExpression()), !dbg !61

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !62
  // ST: Guess
  //   : Release
  ...
  // ST: Guess
  iw(1,5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l27_c15
  old_cw = cw(1,5);
  cw(1,5) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l27_c15
  // Check
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !85

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !59
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !77, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64 1, metadata !79, metadata !DIExpression()), !dbg !88

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !62
  // ST: Guess
  //   : Release
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !97, metadata !DIExpression()), !dbg !108

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !59
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !100, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64 1, metadata !102, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !62
  // ST: Guess
  //   : Release
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !120, metadata !DIExpression()), !dbg !131

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) acquire, align 8, !dbg !59
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !123, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64 1, metadata !125, metadata !DIExpression()), !dbg !134

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) release, align 8, !dbg !62
  // ST: Guess
  //   : Release
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !141, metadata !DIExpression()), !dbg !153
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !143, metadata !DIExpression()), !dbg !156

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) acquire, align 8, !dbg !61
  // LD: Guess
  //   : Acquire
  old_cr = cr(5,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !145, metadata !DIExpression()), !dbg !156

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !142, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !147, metadata !DIExpression()), !dbg !159

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !64
  // LD: Guess
  old_cr = cr(5,0+1*1);
  cr(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l61_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !149, metadata !DIExpression()), !dbg !159

  //   %conv4 = trunc i64 %1 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !146, metadata !DIExpression()), !dbg !153

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !66
  creg__r5__0_ = max(0,creg_r5);

  //   %conv5 = zext i1 %cmp to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !150, metadata !DIExpression()), !dbg !153

  //   store i32 %conv5, i32* @atom_4_X2_0, align 4, !dbg !67, !tbaa !68
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv, 1, !dbg !72
  creg__r4__1_ = max(0,creg_r4);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !151, metadata !DIExpression()), !dbg !153

  //   store i32 %conv7, i32* @atom_4_X0_1, align 4, !dbg !73, !tbaa !68
  // ST: Guess
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !169, metadata !DIExpression()), !dbg !174

  //   br label %label_6, !dbg !51
  goto T6BLOCK1;

T6BLOCK1:
  //   call void @llvm.dbg.label(metadata !173), !dbg !176

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !177
  ...
  // ST: Guess
  iw(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l71_c3
  old_cw = cw(6,0+1*1);
  cw(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l71_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !187, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !188, metadata !DIExpression()), !dbg !243

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !189, metadata !DIExpression()), !dbg !245

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !193, metadata !DIExpression()), !dbg !247

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !194, metadata !DIExpression()), !dbg !249

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !195, metadata !DIExpression()), !dbg !251

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !196, metadata !DIExpression()), !dbg !253

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !197, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !198, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !256

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !118
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l83_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l83_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !201, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !258

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !120
  // ST: Guess
  iw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l84_c3
  old_cw = cw(0,0+3*1);
  cw(0,0+3*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l84_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !204, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !260

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !122
  // ST: Guess
  iw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l85_c3
  old_cw = cw(0,0+2*1);
  cw(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l85_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !207, metadata !DIExpression()), !dbg !262

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !262

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !124
  // ST: Guess
  iw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l86_c3
  old_cw = cw(0,0+1*1);
  cw(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l86_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !210, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !264

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !126
  // ST: Guess
  iw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l87_c3
  old_cw = cw(0,0);
  cw(0,0) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l87_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !213, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i32 0, metadata !216, metadata !DIExpression()), !dbg !266

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !128
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l88_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l88_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X2_0, metadata !217, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i32 0, metadata !219, metadata !DIExpression()), !dbg !268

  //   store atomic i32 0, i32* @atom_4_X2_0 monotonic, align 4, !dbg !130
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l89_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l89_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !220, metadata !DIExpression()), !dbg !270

  //   call void @llvm.dbg.value(metadata i32 0, metadata !222, metadata !DIExpression()), !dbg !270

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !132
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l90_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l90_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !223, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i32 0, metadata !225, metadata !DIExpression()), !dbg !272

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !134
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l91_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l91_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !226, metadata !DIExpression()), !dbg !274

  //   call void @llvm.dbg.value(metadata i32 0, metadata !228, metadata !DIExpression()), !dbg !274

  //   store atomic i32 0, i32* @atom_3_X0_1 monotonic, align 4, !dbg !136
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l92_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l92_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X0_1, metadata !229, metadata !DIExpression()), !dbg !276

  //   call void @llvm.dbg.value(metadata i32 0, metadata !231, metadata !DIExpression()), !dbg !276

  //   store atomic i32 0, i32* @atom_4_X0_1 monotonic, align 4, !dbg !138
  // ST: Guess
  iw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l93_c3
  old_cw = cw(0,10);
  cw(0,10) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l93_c3
  // Check
  ...
  //   %call21 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call22 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !141
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call23 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !142
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call24 = call i32 @pthread_create(i64* noundef %thr4, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t4, i8* noundef null) #7, !dbg !143
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call25 = call i32 @pthread_create(i64* noundef %thr5, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t5, i8* noundef null) #7, !dbg !144
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i64, i64* %thr0, align 8, !dbg !145, !tbaa !146
  r7 = local_mem[0];

  //   %call26 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !150
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr1, align 8, !dbg !151, !tbaa !146
  r8 = local_mem[1];

  //   %call27 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !152
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load i64, i64* %thr2, align 8, !dbg !153, !tbaa !146
  r9 = local_mem[2];

  //   %call28 = call i32 @pthread_join(i64 noundef %8, i8** noundef null), !dbg !154
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %9 = load i64, i64* %thr3, align 8, !dbg !155, !tbaa !146
  r10 = local_mem[3];

  //   %call29 = call i32 @pthread_join(i64 noundef %9, i8** noundef null), !dbg !156
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %10 = load i64, i64* %thr4, align 8, !dbg !157, !tbaa !146
  r11 = local_mem[4];

  //   %call30 = call i32 @pthread_join(i64 noundef %10, i8** noundef null), !dbg !158
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %11 = load i64, i64* %thr5, align 8, !dbg !159, !tbaa !146
  r12 = local_mem[5];

  //   %call31 = call i32 @pthread_join(i64 noundef %11, i8** noundef null), !dbg !160
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %12 = load i32, i32* @atom_0_X0_1, align 4, !dbg !161, !tbaa !162
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l109_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !232, metadata !DIExpression()), !dbg !243

  //   %13 = load i32, i32* @atom_4_X2_0, align 4, !dbg !164, !tbaa !162
  // LD: Guess
  old_cr = cr(0,9);
  cr(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l110_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !233, metadata !DIExpression()), !dbg !243

  //   %14 = load i32, i32* @atom_1_X0_1, align 4, !dbg !165, !tbaa !162
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l111_c13
  // Check
  ...
  //   %15 = load i32, i32* @atom_2_X0_1, align 4, !dbg !166, !tbaa !162
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l112_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !235, metadata !DIExpression()), !dbg !243

  //   %16 = load i32, i32* @atom_3_X0_1, align 4, !dbg !167, !tbaa !162
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l113_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !236, metadata !DIExpression()), !dbg !243

  //   %17 = load i32, i32* @atom_4_X0_1, align 4, !dbg !168, !tbaa !162
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !237, metadata !DIExpression()), !dbg !243

  //   %and = and i32 %16, %17, !dbg !169
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !238, metadata !DIExpression()), !dbg !243

  //   %and32 = and i32 %15, %and, !dbg !170
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !239, metadata !DIExpression()), !dbg !243

  //   %and33 = and i32 %14, %and32, !dbg !171
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !240, metadata !DIExpression()), !dbg !243

  //   %and34 = and i32 %13, %and33, !dbg !172
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !241, metadata !DIExpression()), !dbg !243

  //   %and35 = and i32 %12, %and34, !dbg !173
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !242, metadata !DIExpression()), !dbg !243

  //   %cmp = icmp eq i32 %and35, 1, !dbg !174
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 120, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
