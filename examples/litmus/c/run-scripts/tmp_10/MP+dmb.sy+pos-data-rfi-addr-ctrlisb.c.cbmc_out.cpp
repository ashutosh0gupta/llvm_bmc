...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !166, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i32 0, metadata !168, metadata !DIExpression()), !dbg !215

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X2_1, align 4, !dbg !147, !tbaa !145
  // LD: Guess
  old_cr = cr(0,5);
