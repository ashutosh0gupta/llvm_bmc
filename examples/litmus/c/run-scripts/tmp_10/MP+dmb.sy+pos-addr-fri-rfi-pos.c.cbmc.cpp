...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !171, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !229

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !199, metadata !DIExpression()), !dbg !259

  //   %8 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !154
  // LD: Guess
  old_cr = cr(0,4);
