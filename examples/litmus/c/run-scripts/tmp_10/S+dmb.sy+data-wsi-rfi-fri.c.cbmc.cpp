...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !129, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i32 0, metadata !131, metadata !DIExpression()), !dbg !152

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !81
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_1_X5_2, align 4, !dbg !99, !tbaa !97
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 63, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !105
