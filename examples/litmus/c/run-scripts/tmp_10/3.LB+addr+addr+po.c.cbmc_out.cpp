...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !95, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !98, metadata !DIExpression()), !dbg !109
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !121, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !122, metadata !DIExpression()), !dbg !153

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !75

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !75

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !123, metadata !DIExpression()), !dbg !155

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !127, metadata !DIExpression()), !dbg !157

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !128, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !129, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !132, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !135, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !138, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i32 0, metadata !141, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !142, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i32 0, metadata !144, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !145, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !147, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !150, metadata !DIExpression()), !dbg !153
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
