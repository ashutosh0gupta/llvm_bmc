...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !58, metadata !DIExpression()), !dbg !86

  //   br label %label_2, !dbg !68
  goto T2BLOCK1;

T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !83), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !62, metadata !DIExpression()), !dbg !89

  //   %conv = trunc i64 %0 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !59, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !66, metadata !DIExpression()), !dbg !92

  //   %conv4 = trunc i64 %1 to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !63, metadata !DIExpression()), !dbg !86
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !84), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !101

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !83
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !70, metadata !DIExpression()), !dbg !101

  //   %conv8 = trunc i64 %2 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !67, metadata !DIExpression()), !dbg !86

  //   %xor = xor i32 %conv8, %conv8, !dbg !85
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !71, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !106

  //   %conv12 = trunc i64 %3 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !72, metadata !DIExpression()), !dbg !86

  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !89
  creg__r6__0_ = max(0,creg_r6);

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !91
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !85), !dbg !113

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !114
  ...
  //   %conv19 = trunc i64 %4 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !76, metadata !DIExpression()), !dbg !86

  //   %cmp = icmp eq i32 %conv, 1, !dbg !98
  creg__r0__1_ = max(0,creg_r0);

  //   %conv20 = zext i1 %cmp to i32, !dbg !98

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !80, metadata !DIExpression()), !dbg !86

  //   store i32 %conv20, i32* @atom_1_X0_1, align 4, !dbg !99, !tbaa !100
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv4, 2, !dbg !104
  creg__r1__2_ = max(0,creg_r1);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !81, metadata !DIExpression()), !dbg !86

  //   store i32 %conv22, i32* @atom_1_X2_2, align 4, !dbg !105, !tbaa !100
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv19, 0, !dbg !106
  creg__r7__0_ = max(0,creg_r7);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !82, metadata !DIExpression()), !dbg !86

  //   store i32 %conv24, i32* @atom_1_X8_0, align 4, !dbg !107, !tbaa !100
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !131, metadata !DIExpression()), !dbg !138
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !148, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !149, metadata !DIExpression()), !dbg !195

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !150, metadata !DIExpression()), !dbg !197

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !154, metadata !DIExpression()), !dbg !199

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !155, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !156, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !159, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !162, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !165, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !168, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i32 0, metadata !171, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !172, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i32 0, metadata !174, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !175, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !214

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !179, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !181, metadata !DIExpression()), !dbg !227

  //   %conv = trunc i64 %6 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !178, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !182, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !184, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !186, metadata !DIExpression()), !dbg !231

  //   %conv22 = trunc i64 %7 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !183, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !187, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !188, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !189, metadata !DIExpression()), !dbg !195

  //   %10 = load i32, i32* @atom_1_X8_0, align 4, !dbg !135, !tbaa !132
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !190, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !192, metadata !DIExpression()), !dbg !195

  //   %and26 = and i32 %conv24, %and25, !dbg !138
  creg_r19 = max(creg__r13__2_,creg_r18);
  r19 = (r13==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !193, metadata !DIExpression()), !dbg !195

  //   %and27 = and i32 %conv18, %and26, !dbg !139
  creg_r20 = max(creg__r12__1_,creg_r19);
  r20 = (r12==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !194, metadata !DIExpression()), !dbg !195
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
