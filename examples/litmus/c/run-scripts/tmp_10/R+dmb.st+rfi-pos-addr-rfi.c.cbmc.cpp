...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !70, metadata !DIExpression()), !dbg !82

  //   %add = add nsw i32 0, %xor, !dbg !75
  creg_r3 = max(0,creg_r2);
  r3 = 0 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !75

  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !75
  r4 = 0+r3*1;
  creg_r4 = creg_r3;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64 1, metadata !73, metadata !DIExpression()), !dbg !95
  ...
  //   %cmp12 = icmp eq i32 %conv4, 2, !dbg !86
  ...
  //   store i32 %conv13, i32* @atom_1_X3_2, align 4, !dbg !87, !tbaa !82
  // ST: Guess
