...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !66, metadata !DIExpression()), !dbg !78

  //   %add6 = add nsw i32 %xor5, 1, !dbg !70
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !67, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !68, metadata !DIExpression()), !dbg !90

  //   %conv7 = sext i32 %add6 to i64, !dbg !72

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !70, metadata !DIExpression()), !dbg !90

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !72
  // ST: Guess
  ...
  //   %conv11 = trunc i64 %2 to i32, !dbg !75

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !71, metadata !DIExpression()), !dbg !78

  //   %cmp = icmp eq i32 %conv, 1, !dbg !76
  creg__r0__1_ = max(0,creg_r0);

  //   %conv12 = zext i1 %cmp to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !78

  //   store i32 %conv12, i32* @atom_1_X0_1, align 4, !dbg !77, !tbaa !78
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv11, 1, !dbg !82
  creg__r7__1_ = max(0,creg_r7);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !76, metadata !DIExpression()), !dbg !78

  //   store i32 %conv14, i32* @atom_1_X7_1, align 4, !dbg !83, !tbaa !78
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !127, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !131, metadata !DIExpression()), !dbg !162
