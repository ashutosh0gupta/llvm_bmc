...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !66, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !67, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !68, metadata !DIExpression()), !dbg !96

  //   %conv7 = sext i32 %add6 to i64, !dbg !78

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !70, metadata !DIExpression()), !dbg !96

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !78
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !134, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64 0, metadata !136, metadata !DIExpression()), !dbg !171

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !152, metadata !DIExpression()), !dbg !194

  //   %7 = load atomic i64, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,4);
