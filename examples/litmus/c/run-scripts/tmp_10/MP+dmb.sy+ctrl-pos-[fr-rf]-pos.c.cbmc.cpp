...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !167, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !213

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !173, metadata !DIExpression()), !dbg !217
  ...
  //   %9 = load i32, i32* @atom_1_X2_0, align 4, !dbg !142, !tbaa !140
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %11 = load i32, i32* @atom_1_X5_1, align 4, !dbg !144, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
