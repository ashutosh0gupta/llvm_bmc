...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !123

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !75, metadata !DIExpression()), !dbg !123

  //   %conv11 = trunc i64 %2 to i32, !dbg !106
  ...
  //   %cmp25 = icmp eq i32 %conv11, 0, !dbg !116

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !88, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !89, metadata !DIExpression()), !dbg !136
  ...
  //   %cmp30 = icmp eq i32 %conv15, 1, !dbg !119

  //   %conv31 = zext i1 %cmp30 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !92, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !93, metadata !DIExpression()), !dbg !139
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !215, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !219, metadata !DIExpression()), !dbg !283
