...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !109), !dbg !113
  ...
  //   %xor = xor i32 %conv, %conv, !dbg !98
  creg_r1 = max(creg_r0,creg_r0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !67, metadata !DIExpression()), !dbg !111

  //   %add = add nsw i32 %xor, 1, !dbg !99
  creg_r2 = max(creg_r1,0);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !68, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !119

  //   %conv1 = sext i32 %add to i64, !dbg !101

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !71, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   %conv5 = trunc i64 %1 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !72, metadata !DIExpression()), !dbg !111

  //   %xor6 = xor i32 %conv5, %conv5, !dbg !105
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !76, metadata !DIExpression()), !dbg !111

  //   %add8 = add nsw i32 3, %xor6, !dbg !106
  creg_r5 = max(0,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = 3 + r4;

  //   %idxprom = sext i32 %add8 to i64, !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !80, metadata !DIExpression()), !dbg !126

  //   %conv11 = trunc i64 %2 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !77, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !82, metadata !DIExpression()), !dbg !128

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   %conv15 = trunc i64 %3 to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !81, metadata !DIExpression()), !dbg !111

  //   %tobool = icmp ne i32 %conv15, 0, !dbg !112
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !110), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !138

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !88, metadata !DIExpression()), !dbg !138

  //   %conv19 = trunc i64 %4 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !85, metadata !DIExpression()), !dbg !111

  //   %cmp = icmp eq i32 %conv, 1, !dbg !122

  //   %conv20 = zext i1 %cmp to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !89, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !90, metadata !DIExpression()), !dbg !142
  ...
  //   %cmp24 = icmp eq i32 %conv5, 1, !dbg !125

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !93, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !94, metadata !DIExpression()), !dbg !145
  ...
  //   %cmp29 = icmp eq i32 %conv11, 0, !dbg !128

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !97, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !98, metadata !DIExpression()), !dbg !148

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %7, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv15, 1, !dbg !131

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !101, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !102, metadata !DIExpression()), !dbg !151

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !104, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %8, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !105, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !106, metadata !DIExpression()), !dbg !154

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !108, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %9, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !136
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !159, metadata !DIExpression()), !dbg !164
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !160, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64 1, metadata !162, metadata !DIExpression()), !dbg !167
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !177, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !178, metadata !DIExpression()), !dbg !260

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !179, metadata !DIExpression()), !dbg !262

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !183, metadata !DIExpression()), !dbg !264

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !184, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !185, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !191, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !194, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !196, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !197, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !200, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !277

  //   store atomic i64 0, i64* @atom_1_X4_1 monotonic, align 8, !dbg !147
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !203, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i64 0, metadata !205, metadata !DIExpression()), !dbg !279

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !149
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !206, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !209, metadata !DIExpression()), !dbg !283

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !283

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !153
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !213, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !215, metadata !DIExpression()), !dbg !298

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !212, metadata !DIExpression()), !dbg !260

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !216, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !218, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !220, metadata !DIExpression()), !dbg !302

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !217, metadata !DIExpression()), !dbg !260

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !221, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !223, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !225, metadata !DIExpression()), !dbg !306

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !222, metadata !DIExpression()), !dbg !260

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !226, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !228, metadata !DIExpression()), !dbg !310
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !230, metadata !DIExpression()), !dbg !310

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !227, metadata !DIExpression()), !dbg !260

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !231, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !233, metadata !DIExpression()), !dbg !314
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !235, metadata !DIExpression()), !dbg !314

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !232, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !237, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !239, metadata !DIExpression()), !dbg !317

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !236, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !241, metadata !DIExpression()), !dbg !320
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !243, metadata !DIExpression()), !dbg !320

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !240, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !245, metadata !DIExpression()), !dbg !323
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !247, metadata !DIExpression()), !dbg !323

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !244, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !249, metadata !DIExpression()), !dbg !326
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !251, metadata !DIExpression()), !dbg !326

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !248, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !253, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !254, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !255, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !256, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !257, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !258, metadata !DIExpression()), !dbg !260

  //   %and67 = and i32 %conv22, %and66, !dbg !205
  creg_r30 = max(max(creg_r14,0),creg_r29);
  ASSUME(active[creg_r30] == 0);
  r30 = (r14==1) & r29;

  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !259, metadata !DIExpression()), !dbg !260
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 106, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
