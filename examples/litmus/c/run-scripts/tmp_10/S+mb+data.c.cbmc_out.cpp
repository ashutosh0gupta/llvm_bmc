...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !59, metadata !DIExpression()), !dbg !69

  //   %add = add nsw i32 %and, 1, !dbg !57
  ...
  //   %2 = zext i32 %conv2 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !67, metadata !DIExpression()), !dbg !80

  //   store atomic i64 %2, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !62
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([94 x i8], [94 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !96
