...
T2BLOCK7:
  ...
  //   %cmp23 = icmp eq i32 %conv8, 2, !dbg !115
  ...
  //   store i32 %conv24, i32* @atom_1_X5_2, align 4, !dbg !116, !tbaa !109
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !185, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !238

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X5_2, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
