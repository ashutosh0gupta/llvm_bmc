...
T2BLOCK1:
  ...
  //   %cmp28 = icmp eq i32 %conv4, 1, !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !93, metadata !DIExpression()), !dbg !133
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !171, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !232

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !174, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !234

  //   store atomic i64 0, i64* @atom_1_X8_1 monotonic, align 8, !dbg !130
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !177, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !236

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !132
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !200, metadata !DIExpression()), !dbg !263

  //   %8 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !159
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !204, metadata !DIExpression()), !dbg !266

  //   %9 = load atomic i64, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !162
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !208, metadata !DIExpression()), !dbg !269

  //   %10 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,7);
