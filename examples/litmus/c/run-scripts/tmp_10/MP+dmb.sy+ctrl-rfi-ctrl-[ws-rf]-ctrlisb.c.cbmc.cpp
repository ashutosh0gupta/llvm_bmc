...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !126

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !82, metadata !DIExpression()), !dbg !126
  ...
  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !111, !tbaa !112
  // ST: Guess
  ...
  //   store i32 %conv23, i32* @atom_1_X4_1, align 4, !dbg !117, !tbaa !112
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv13, 2, !dbg !118
  creg__r2__2_ = max(0,creg_r2);

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !85, metadata !DIExpression()), !dbg !91

  //   store i32 %conv25, i32* @atom_1_X7_2, align 4, !dbg !119, !tbaa !112
  // ST: Guess
  ...
  //   %cmp26 = icmp eq i32 %conv20, 0, !dbg !120
  creg__r3__0_ = max(0,creg_r3);

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !86, metadata !DIExpression()), !dbg !91

  //   store i32 %conv27, i32* @atom_1_X8_0, align 4, !dbg !121, !tbaa !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !162, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !163, metadata !DIExpression()), !dbg !226

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !164, metadata !DIExpression()), !dbg !228

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !168, metadata !DIExpression()), !dbg !230

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !169, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !170, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !173, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !176, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !179, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !182, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !186, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_2, metadata !189, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !192, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !196, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !198, metadata !DIExpression()), !dbg !260

  //   %conv = trunc i64 %6 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !195, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !199, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !201, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !203, metadata !DIExpression()), !dbg !264

  //   %conv24 = trunc i64 %7 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !200, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !204, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !206, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !208, metadata !DIExpression()), !dbg !268

  //   %conv30 = trunc i64 %8 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !205, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !209, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !211, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !213, metadata !DIExpression()), !dbg !272

  //   %conv36 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !210, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !214, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !215, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !216, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !217, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !218, metadata !DIExpression()), !dbg !226

  //   %and = and i32 %12, %13, !dbg !166
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !219, metadata !DIExpression()), !dbg !226

  //   %and39 = and i32 %11, %and, !dbg !167
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !220, metadata !DIExpression()), !dbg !226

  //   %and40 = and i32 %10, %and39, !dbg !168
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !221, metadata !DIExpression()), !dbg !226

  //   %and41 = and i32 %conv38, %and40, !dbg !169
  creg_r19 = max(creg__r11__1_,creg_r18);
  r19 = (r11==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !222, metadata !DIExpression()), !dbg !226

  //   %and42 = and i32 %conv32, %and41, !dbg !170
  creg_r20 = max(creg__r10__1_,creg_r19);
  r20 = (r10==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !223, metadata !DIExpression()), !dbg !226

  //   %and43 = and i32 %conv26, %and42, !dbg !171
  creg_r21 = max(creg__r9__1_,creg_r20);
  r21 = (r9==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !224, metadata !DIExpression()), !dbg !226

  //   %and44 = and i32 %conv20, %and43, !dbg !172
  creg_r22 = max(creg__r8__2_,creg_r21);
  r22 = (r8==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !225, metadata !DIExpression()), !dbg !226
