...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !43, metadata !DIExpression()), !dbg !54

  //   call void @llvm.dbg.value(metadata i64 3, metadata !46, metadata !DIExpression()), !dbg !54

  //   store atomic i64 3, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !55
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !47, metadata !DIExpression()), !dbg !56

  //   call void @llvm.dbg.value(metadata i64 1, metadata !49, metadata !DIExpression()), !dbg !56

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !57
  // ST: Guess
  //   : Release
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !61, metadata !DIExpression()), !dbg !71
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !63, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !62, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64 1, metadata !68, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !69, metadata !DIExpression()), !dbg !71

  //   store i32 %conv1, i32* @atom_1_X0_1, align 4, !dbg !62, !tbaa !63
  // ST: Guess
  iw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l33_c15
  old_cw = cw(2,5);
  cw(2,5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l33_c15
  // Check
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !90, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !92, metadata !DIExpression()), !dbg !101

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !89, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !93, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64 1, metadata !95, metadata !DIExpression()), !dbg !104

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !60
  // ST: Guess
  //   : Release
  iw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l40_c3
  old_cw = cw(3,0+3*1);
  cw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l40_c3
  // Check
  ...
  // ST: Guess
  iw(3,6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l42_c15
  old_cw = cw(3,6);
  cw(3,6) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l42_c15
  // Check
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !113, metadata !DIExpression()), !dbg !124

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) acquire, align 8, !dbg !57
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+3*1);
  cr(4,0+3*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l48_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !115, metadata !DIExpression()), !dbg !124

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !112, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !116, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 1, metadata !118, metadata !DIExpression()), !dbg !127

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) release, align 8, !dbg !60
  // ST: Guess
  //   : Release
  iw(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l49_c3
  old_cw = cw(4,0+4*1);
  cw(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l49_c3
  // Check
  ...
  // ST: Guess
  iw(4,7) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l51_c15
  old_cw = cw(4,7);
  cw(4,7) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l51_c15
  // Check
  ASSUME(active[iw(4,7)] == 4);
  ASSUME(active[cw(4,7)] == 4);
  ASSUME(sforbid(7,cw(4,7))== 0);
  ASSUME(iw(4,7) >= creg__r2__1_);
  ASSUME(iw(4,7) >= 0);
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !136, metadata !DIExpression()), !dbg !149

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) acquire, align 8, !dbg !59
  // LD: Guess
  //   : Acquire
  old_cr = cr(5,0+4*1);
  cr(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l57_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !140, metadata !DIExpression()), !dbg !152

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !62
  // LD: Guess
  old_cr = cr(5,0+1*1);
  cr(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l58_c16
  // Check
  ...
  //   %cmp = icmp eq i32 %conv4, 0, !dbg !64
  ...
  //   store i32 %conv5, i32* @atom_4_X2_0, align 4, !dbg !65, !tbaa !66
  // ST: Guess
  iw(5,8) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l60_c15
  old_cw = cw(5,8);
  cw(5,8) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l60_c15
  // Check
  ASSUME(active[iw(5,8)] == 5);
  ASSUME(active[cw(5,8)] == 5);
  ASSUME(sforbid(8,cw(5,8))== 0);
  ASSUME(iw(5,8) >= creg__r4__0_);
  ASSUME(iw(5,8) >= 0);
  ...
  //   %cmp6 = icmp eq i32 %conv, 1, !dbg !70
  creg__r3__1_ = max(0,creg_r3);

  //   %conv7 = zext i1 %cmp6 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !144, metadata !DIExpression()), !dbg !146

  //   store i32 %conv7, i32* @atom_4_X0_1, align 4, !dbg !71, !tbaa !66
  // ST: Guess
  iw(5,9) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l62_c15
  old_cw = cw(5,9);
  cw(5,9) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l62_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !167, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !168, metadata !DIExpression()), !dbg !217

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !169, metadata !DIExpression()), !dbg !219

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !173, metadata !DIExpression()), !dbg !221

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !174, metadata !DIExpression()), !dbg !223

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !175, metadata !DIExpression()), !dbg !225

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !176, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !177, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !180, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !183, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64 0, metadata !185, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !189, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X2_0, metadata !192, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !238

  //   store atomic i32 0, i32* @atom_4_X2_0 monotonic, align 4, !dbg !118
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l78_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l78_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !196, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !199, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i32 0, metadata !201, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !202, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X0_1, metadata !205, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i32 0, metadata !207, metadata !DIExpression()), !dbg !246

  //   store atomic i32 0, i32* @atom_4_X0_1 monotonic, align 4, !dbg !126
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l82_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l82_c3
  // Check
  ...
  //   %10 = load i32, i32* @atom_4_X2_0, align 4, !dbg !146, !tbaa !147
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !208, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !209, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !210, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !211, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !212, metadata !DIExpression()), !dbg !217

  //   %and = and i32 %13, %14, !dbg !153
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !213, metadata !DIExpression()), !dbg !217

  //   %and28 = and i32 %12, %and, !dbg !154
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !214, metadata !DIExpression()), !dbg !217

  //   %and29 = and i32 %11, %and28, !dbg !155
  creg_r18 = max(creg_r12,creg_r17);
  r18 = r12 & r17;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !215, metadata !DIExpression()), !dbg !217

  //   %and30 = and i32 %10, %and29, !dbg !156
  creg_r19 = max(creg_r11,creg_r18);
  r19 = r11 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !216, metadata !DIExpression()), !dbg !217
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 105, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
