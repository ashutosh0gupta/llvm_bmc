...
T2BLOCK7:
  ...
  //   %xor16 = xor i32 %conv15, %conv15, !dbg !93
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor16, metadata !74, metadata !DIExpression()), !dbg !84

  //   %add18 = add nsw i32 0, %xor16, !dbg !94
  creg_r8 = max(0,creg_r7);
  r8 = 0 + r7;

  //   %idxprom19 = sext i32 %add18 to i64, !dbg !94

  //   %arrayidx20 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom19, !dbg !94
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx20, metadata !76, metadata !DIExpression()), !dbg !114

  //   %4 = load atomic i64, i64* %arrayidx20 monotonic, align 8, !dbg !94
  // LD: Guess
  old_cr = cr(2,r9);
