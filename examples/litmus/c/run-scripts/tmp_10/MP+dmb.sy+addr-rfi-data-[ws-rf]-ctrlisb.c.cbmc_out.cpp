...
T2BLOCK4:
  ...
  //   store i32 %conv20, i32* @atom_1_X5_1, align 4, !dbg !109, !tbaa !104
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv13, 2, !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X8_2, align 4, !dbg !111, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !154, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !155, metadata !DIExpression()), !dbg !218

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !156, metadata !DIExpression()), !dbg !220

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !160, metadata !DIExpression()), !dbg !222

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !161, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !162, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !165, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !174, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !178, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_2, metadata !181, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !184, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !188, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !191, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !193, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !192, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !196, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !198, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !197, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !203, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !202, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !206, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !212, metadata !DIExpression()), !dbg !218

  //   %and40 = and i32 %10, %and39, !dbg !168
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !213, metadata !DIExpression()), !dbg !218
