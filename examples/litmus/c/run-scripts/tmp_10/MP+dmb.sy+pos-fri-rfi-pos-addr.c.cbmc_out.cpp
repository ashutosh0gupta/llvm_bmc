...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !79, metadata !DIExpression()), !dbg !122

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !82, metadata !DIExpression()), !dbg !108
  ...
  //   %arrayidx = getelementptr inbounds [2 x i64], [2 x i64]* @vars, i64 0, i64 %idxprom, !dbg !107
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !100, metadata !DIExpression()), !dbg !139

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !102, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %8, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp36 = icmp eq i32 %conv16, 0, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !104, metadata !DIExpression()), !dbg !142

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !106, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %9, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !171, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !229

  //   store atomic i64 0, i64* @atom_1_X4_2 monotonic, align 8, !dbg !124
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !174, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !177, metadata !DIExpression()), !dbg !233
  ...
  //   %cmp21 = icmp eq i32 %conv20, 2, !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !199, metadata !DIExpression()), !dbg !259

  //   %8 = load atomic i64, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !154
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !203, metadata !DIExpression()), !dbg !262

  //   %9 = load atomic i64, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !207, metadata !DIExpression()), !dbg !265
