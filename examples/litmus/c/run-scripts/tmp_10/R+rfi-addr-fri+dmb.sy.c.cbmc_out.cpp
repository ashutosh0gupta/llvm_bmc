...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !52, metadata !DIExpression()), !dbg !76
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !55, metadata !DIExpression()), !dbg !64

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !56, metadata !DIExpression()), !dbg !79

  //   %2 = zext i32 %conv7 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !58, metadata !DIExpression()), !dbg !79

  //   store atomic i64 %2, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !59, metadata !DIExpression()), !dbg !64

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !60, metadata !DIExpression()), !dbg !82

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !62, metadata !DIExpression()), !dbg !82

  //   store atomic i64 %3, i64* @atom_0_X4_0 seq_cst, align 8, !dbg !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !133, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !136, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !139, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !153, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !157, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !161, metadata !DIExpression()), !dbg !207
