...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !49, metadata !DIExpression()), !dbg !68
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !51, metadata !DIExpression()), !dbg !68

  //   %conv4 = trunc i64 %1 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !48, metadata !DIExpression()), !dbg !58

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !52, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64 1, metadata !54, metadata !DIExpression()), !dbg !70

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !55, metadata !DIExpression()), !dbg !58

  //   store i32 %conv7, i32* @atom_0_X2_1, align 4, !dbg !73, !tbaa !74
  // ST: Guess
  ...
  //   %cmp8 = icmp eq i32 %conv4, 0, !dbg !78
  creg__r4__0_ = max(0,creg_r4);

  //   %conv9 = zext i1 %cmp8 to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !56, metadata !DIExpression()), !dbg !58

  //   store i32 %conv9, i32* @atom_0_X4_0, align 4, !dbg !79, !tbaa !74
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !88, metadata !DIExpression()), !dbg !99
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_1, metadata !125, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X4_0, metadata !129, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i32 0, metadata !131, metadata !DIExpression()), !dbg !163

  //   store atomic i32 0, i32* @atom_0_X4_0 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !132, metadata !DIExpression()), !dbg !165
  ...
  //   %7 = load i32, i32* @atom_0_X4_0, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
