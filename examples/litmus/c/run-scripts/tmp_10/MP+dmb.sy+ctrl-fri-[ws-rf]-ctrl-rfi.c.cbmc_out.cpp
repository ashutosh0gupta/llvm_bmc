...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !102

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,0+2*1);
...
T2BLOCK7:
  ...
  //   store i32 %conv20, i32* @atom_1_X2_0, align 4, !dbg !109, !tbaa !104
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv8, 2, !dbg !110
  ...
  //   store i32 %conv22, i32* @atom_1_X5_2, align 4, !dbg !111, !tbaa !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !175, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !224

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !178, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !226

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X2_0, align 4, !dbg !148, !tbaa !146
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X5_2, align 4, !dbg !149, !tbaa !146
  // LD: Guess
  old_cr = cr(0,5);
