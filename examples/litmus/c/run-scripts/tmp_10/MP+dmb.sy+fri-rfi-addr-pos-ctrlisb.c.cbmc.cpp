...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !113
  ...
  //   %cmp18 = icmp eq i32 %conv4, 2, !dbg !103
  ...
  //   store i32 %conv19, i32* @atom_1_X3_2, align 4, !dbg !104, !tbaa !99
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv16, 0, !dbg !105
  ...
  //   store i32 %conv21, i32* @atom_1_X8_0, align 4, !dbg !106, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !134, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !135, metadata !DIExpression()), !dbg !177

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !136, metadata !DIExpression()), !dbg !179

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !140, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !144, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !147, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !150, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !154, metadata !DIExpression()), !dbg !190

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !157, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i32 0, metadata !159, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !160, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !164, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !165, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !169, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !170, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !171, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !172, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !174, metadata !DIExpression()), !dbg !177

  //   %and22 = and i32 %conv20, %and21, !dbg !127
  creg_r18 = max(creg__r12__2_,creg_r17);
  r18 = (r12==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !175, metadata !DIExpression()), !dbg !177

  //   %and23 = and i32 %conv14, %and22, !dbg !128
  creg_r19 = max(creg__r11__1_,creg_r18);
  r19 = (r11==1) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !176, metadata !DIExpression()), !dbg !177
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !132
