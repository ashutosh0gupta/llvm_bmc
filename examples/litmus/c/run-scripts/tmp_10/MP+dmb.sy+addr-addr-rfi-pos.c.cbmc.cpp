...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !65, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !84

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !75
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !68, metadata !DIExpression()), !dbg !84

  //   %add6 = add nsw i32 0, %xor5, !dbg !76
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom7 = sext i32 %add6 to i64, !dbg !76

  //   %arrayidx8 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom7, !dbg !76
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx8, metadata !69, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64 1, metadata !71, metadata !DIExpression()), !dbg !96

  //   store atomic i64 1, i64* %arrayidx8 monotonic, align 8, !dbg !76
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !97
  ...
  //   %conv12 = trunc i64 %2 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !72, metadata !DIExpression()), !dbg !84
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !79, metadata !DIExpression()), !dbg !100

  //   %conv16 = trunc i64 %3 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !76, metadata !DIExpression()), !dbg !84
  ...
  //   store i32 %conv19, i32* @atom_1_X8_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv16, 1, !dbg !92
  creg__r9__1_ = max(0,creg_r9);

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !82, metadata !DIExpression()), !dbg !84

  //   store i32 %conv21, i32* @atom_1_X9_1, align 4, !dbg !93, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !137, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !141, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !177

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X8_1, align 4, !dbg !123, !tbaa !121
  // LD: Guess
  old_cr = cr(0,4);
