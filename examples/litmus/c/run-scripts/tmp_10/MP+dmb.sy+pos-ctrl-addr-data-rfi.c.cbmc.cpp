...
T2BLOCK4:
  ...
  //   %add14 = add nsw i32 %xor13, 1, !dbg !103
  creg_r8 = max(creg_r7,0);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add14, metadata !77, metadata !DIExpression()), !dbg !99
  ...
  //   %conv15 = sext i32 %add14 to i64, !dbg !105

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !80, metadata !DIExpression()), !dbg !123

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !105
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv4, 1, !dbg !112
  ...
  //   store atomic i64 %6, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !114
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !170, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !216

  //   store atomic i64 0, i64* @atom_1_X10_1 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !192, metadata !DIExpression()), !dbg !242

  //   %8 = load atomic i64, i64* @atom_1_X10_1 seq_cst, align 8, !dbg !140
  // LD: Guess
  old_cr = cr(0,6);
