...
T1BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !48
  // ST: Guess
  //   : Release
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !70

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !58
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+1*1);
  ...
  //   store i32 %conv5, i32* @atom_1_X0_1, align 4, !dbg !61, !tbaa !62
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !84, metadata !DIExpression()), !dbg !92
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !85, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64 1, metadata !87, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !88, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64 1, metadata !90, metadata !DIExpression()), !dbg !97

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !53
  // ST: Guess
  //   : Release
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l39_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l39_c3
  // Check
...
T4BLOCK1:
  ...
  //   : Acquire
  old_cr = cr(4,0);
  cr(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l47_c15
  // Check
  ...
  //   store i32 %conv1, i32* @atom_3_X2_0, align 4, !dbg !59, !tbaa !60
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X2_0, metadata !156, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !189

  //   store atomic i32 0, i32* @atom_3_X2_0 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !160, metadata !DIExpression()), !dbg !205

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !119
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   %9 = load i32, i32* @atom_1_X0_1, align 4, !dbg !122, !tbaa !123
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %11 = load i32, i32* @atom_3_X2_0, align 4, !dbg !126, !tbaa !123
  // LD: Guess
  old_cr = cr(0,5);
