...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !145, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !152, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_2, metadata !155, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !194

  //   store atomic i32 0, i32* @atom_0_X3_2 monotonic, align 4, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !159, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X3_0, metadata !165, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !167, metadata !DIExpression()), !dbg !200

  //   store atomic i32 0, i32* @atom_2_X3_0 monotonic, align 4, !dbg !107
  // ST: Guess
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !110
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !116
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !118
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !120
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !169, metadata !DIExpression()), !dbg !213

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !122
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !171, metadata !DIExpression()), !dbg !213

  //   %conv = trunc i64 %6 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !168, metadata !DIExpression()), !dbg !181

  //   %cmp = icmp eq i32 %conv, 2, !dbg !124
  creg__r14__2_ = max(0,creg_r14);

  //   %conv18 = zext i1 %cmp to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !172, metadata !DIExpression()), !dbg !181

  //   %7 = load i32, i32* @atom_0_X3_2, align 4, !dbg !125, !tbaa !126
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X0_1, align 4, !dbg !128, !tbaa !126
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_2_X0_1, align 4, !dbg !129, !tbaa !126
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_2_X3_0, align 4, !dbg !130, !tbaa !126
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %and19 = and i32 %8, %and, !dbg !132
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !178, metadata !DIExpression()), !dbg !181

  //   %and20 = and i32 %7, %and19, !dbg !133
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and20, metadata !179, metadata !DIExpression()), !dbg !181

  //   %and21 = and i32 %conv18, %and20, !dbg !134
  creg_r22 = max(creg__r14__2_,creg_r21);
  r22 = (r14==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !180, metadata !DIExpression()), !dbg !181

  //   %cmp22 = icmp eq i32 %and21, 1, !dbg !135
  creg__r22__1_ = max(0,creg_r22);

  //   br i1 %cmp22, label %if.then, label %if.end, !dbg !137
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 84, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !138
