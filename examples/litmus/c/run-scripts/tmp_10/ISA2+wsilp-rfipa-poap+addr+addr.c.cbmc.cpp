...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !39, metadata !DIExpression()), !dbg !60
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64 1, metadata !43, metadata !DIExpression()), !dbg !63

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !64
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !46, metadata !DIExpression()), !dbg !65

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !66
  // ST: Guess
  iw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0);
  cw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !49, metadata !DIExpression()), !dbg !67

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !68
  // LD: Guess
  //   : Acquire
  old_cr = cr(1,0);
  ...
  ASSUME(cr(1,0) >= cdl[1]);
  ASSUME(cr(1,0) >= cl[1]);
  ASSUME(cr(1,0) >= cx(1,0));
  ASSUME(cr(1,0) >= cs(1,0+0));
  ASSUME(cr(1,0) >= cs(1,0+1));
  ASSUME(cr(1,0) >= cs(1,0+2));
  ASSUME(cr(1,0) >= cs(1,3+0));
  ASSUME(cr(1,0) >= cs(1,4+0));
  ASSUME(cr(1,0) >= cs(1,5+0));
  ASSUME(cr(1,0) >= cs(1,6+0));
  ASSUME(cr(1,0) >= cs(1,7+0));
  ASSUME(cr(1,0) >= cs(1,8+0));
  ASSUME(cr(1,0) >= cs(1,9+0));
  // Update
  creg_r0 = cr(1,0);
  ...
  cl[1] = max(cl[1],cr(1,0));
  ASSUME(creturn[1] >= cr(1,0));

  //   call void @llvm.dbg.value(metadata i64 %0, metadata !51, metadata !DIExpression()), !dbg !67

  //   %conv = trunc i64 %0 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !47, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !52, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64 1, metadata !54, metadata !DIExpression()), !dbg !70

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  //   %cmp = icmp eq i32 %conv, 2, !dbg !72

  //   %conv5 = zext i1 %cmp to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !55, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !56, metadata !DIExpression()), !dbg !73

  //   %1 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !58, metadata !DIExpression()), !dbg !73

  //   store atomic i64 %1, i64* @atom_0_X3_2 seq_cst, align 8, !dbg !74
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !78, metadata !DIExpression()), !dbg !92
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !80, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !82, metadata !DIExpression()), !dbg !95

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !79, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !83, metadata !DIExpression()), !dbg !92

  //   %add = add nsw i32 2, %xor, !dbg !62
  creg_r3 = max(0,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = 2 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !62

  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !62
  r4 = 0+r3*1;
  ASSUME(creg_r4 >= 0);
  ASSUME(creg_r4 >= creg_r3);
  ASSUME(active[creg_r4] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !84, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64 1, metadata !86, metadata !DIExpression()), !dbg !100

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !62
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !102

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !90, metadata !DIExpression()), !dbg !102
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !107, metadata !DIExpression()), !dbg !126
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !109, metadata !DIExpression()), !dbg !129

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !64
  // LD: Guess
  old_cr = cr(3,0+2*1);
  ...
  if(cr(3,0+2*1) < cw(3,0+2*1)) {
    ...
    r5 = mem(0+2*1,cr(3,0+2*1));
  }
  ASSUME(creturn[3] >= cr(3,0+2*1));

  //   call void @llvm.dbg.value(metadata i64 %0, metadata !111, metadata !DIExpression()), !dbg !129

  //   %conv = trunc i64 %0 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !108, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !112, metadata !DIExpression()), !dbg !126

  //   %add = add nsw i32 0, %xor, !dbg !67
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !67
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 3);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !114, metadata !DIExpression()), !dbg !134

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !67
  // LD: Guess
  old_cr = cr(3,r8);
  cr(3,r8) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM 
  // Check
  ASSUME(active[cr(3,r8)] == 3);
  ASSUME(cr(3,r8) >= iw(3,r8));
  ASSUME(cr(3,r8) >= creg_r8);
  ASSUME(cr(3,r8) >= cdy[3]);
  ASSUME(cr(3,r8) >= cisb[3]);
  ASSUME(cr(3,r8) >= cdl[3]);
  ASSUME(cr(3,r8) >= cl[3]);
  // Update
  creg_r9 = cr(3,r8);
  crmax(3,r8) = max(crmax(3,r8),cr(3,r8));
  caddr[3] = max(caddr[3],creg_r8);
  if(cr(3,r8) < cw(3,r8)) {
    r9 = buff(3,r8);
    ASSUME((!(( (cw(3,r8) < 1) && (1 < crmax(3,r8)) )))||(sforbid(r8,1)> 0));
    ASSUME((!(( (cw(3,r8) < 2) && (2 < crmax(3,r8)) )))||(sforbid(r8,2)> 0));
    ASSUME((!(( (cw(3,r8) < 3) && (3 < crmax(3,r8)) )))||(sforbid(r8,3)> 0));
    ASSUME((!(( (cw(3,r8) < 4) && (4 < crmax(3,r8)) )))||(sforbid(r8,4)> 0));
    ASSUME((!(( (cw(3,r8) < 5) && (5 < crmax(3,r8)) )))||(sforbid(r8,5)> 0));
    ASSUME((!(( (cw(3,r8) < 6) && (6 < crmax(3,r8)) )))||(sforbid(r8,6)> 0));
    ASSUME((!(( (cw(3,r8) < 7) && (7 < crmax(3,r8)) )))||(sforbid(r8,7)> 0));
    ASSUME((!(( (cw(3,r8) < 8) && (8 < crmax(3,r8)) )))||(sforbid(r8,8)> 0));
    ASSUME((!(( (cw(3,r8) < 9) && (9 < crmax(3,r8)) )))||(sforbid(r8,9)> 0));
  } else {
    if(pw(3,r8) != co(r8,cr(3,r8))) {
      ASSUME(cr(3,r8) >= old_cr);
    }
    pw(3,r8) = co(r8,cr(3,r8));
    r9 = mem(r8,cr(3,r8));
  }
  ASSUME(creturn[3] >= cr(3,r8));

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !116, metadata !DIExpression()), !dbg !134

  //   %conv4 = trunc i64 %1 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !113, metadata !DIExpression()), !dbg !126

  //   %cmp = icmp eq i32 %conv, 1, !dbg !70

  //   %conv5 = zext i1 %cmp to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !117, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !118, metadata !DIExpression()), !dbg !137

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !120, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %2, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !72
  // ST: Guess
  ...
  //   %cmp7 = icmp eq i32 %conv4, 0, !dbg !73

  //   %conv8 = zext i1 %cmp7 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !121, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !122, metadata !DIExpression()), !dbg !140

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !124, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %3, i64* @atom_2_X3_0 seq_cst, align 8, !dbg !75
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !150, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !151, metadata !DIExpression()), !dbg !204

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !152, metadata !DIExpression()), !dbg !206

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !156, metadata !DIExpression()), !dbg !208

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !157, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !158, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !211

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !213

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !164, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !215

  //   store atomic i64 0, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !167, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !169, metadata !DIExpression()), !dbg !217

  //   store atomic i64 0, i64* @atom_0_X3_2 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !170, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !219

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !173, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !221

  //   store atomic i64 0, i64* @atom_2_X0_1 monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !176, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !223

  //   store atomic i64 0, i64* @atom_2_X3_0 monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !120
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call14 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !121
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !122, !tbaa !123
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %call15 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !127
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !128, !tbaa !123
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   %call16 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !129
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !130, !tbaa !123
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call17 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !131
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !180, metadata !DIExpression()), !dbg !238

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !133
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !182, metadata !DIExpression()), !dbg !238

  //   %conv = trunc i64 %6 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !179, metadata !DIExpression()), !dbg !204

  //   %cmp = icmp eq i32 %conv, 2, !dbg !135

  //   %conv18 = zext i1 %cmp to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !183, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !185, metadata !DIExpression()), !dbg !242

  //   %7 = load atomic i64, i64* @atom_0_X3_2 seq_cst, align 8, !dbg !137
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !187, metadata !DIExpression()), !dbg !242

  //   %conv22 = trunc i64 %7 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !184, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !189, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !191, metadata !DIExpression()), !dbg !245

  //   %conv26 = trunc i64 %8 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !188, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !193, metadata !DIExpression()), !dbg !248

  //   %9 = load atomic i64, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !143
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !195, metadata !DIExpression()), !dbg !248

  //   %conv30 = trunc i64 %9 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !192, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X3_0, metadata !197, metadata !DIExpression()), !dbg !251

  //   %10 = load atomic i64, i64* @atom_2_X3_0 seq_cst, align 8, !dbg !146
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !199, metadata !DIExpression()), !dbg !251

  //   %conv34 = trunc i64 %10 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !196, metadata !DIExpression()), !dbg !204

  //   %and = and i32 %conv30, %conv34, !dbg !148
  ...
  //   %and35 = and i32 %conv26, %and, !dbg !149
  creg_r20 = max(creg_r16,creg_r19);
  ASSUME(active[creg_r20] == 0);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !201, metadata !DIExpression()), !dbg !204

  //   %and36 = and i32 %conv22, %and35, !dbg !150
  creg_r21 = max(creg_r15,creg_r20);
  ASSUME(active[creg_r21] == 0);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !202, metadata !DIExpression()), !dbg !204

  //   %and37 = and i32 %conv18, %and36, !dbg !151
  creg_r22 = max(max(creg_r14,0),creg_r21);
  ASSUME(active[creg_r22] == 0);
  r22 = (r14==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !203, metadata !DIExpression()), !dbg !204

  //   %cmp38 = icmp eq i32 %and37, 1, !dbg !152

  //   br i1 %cmp38, label %if.then, label %if.end, !dbg !154
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 84, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
