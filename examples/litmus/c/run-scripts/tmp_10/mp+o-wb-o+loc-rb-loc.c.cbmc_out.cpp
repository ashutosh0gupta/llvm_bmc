...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64 9, metadata !110, metadata !DIExpression()), !dbg !129

  //   store atomic i64 9, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !69
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !114, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !118, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i32 0, metadata !120, metadata !DIExpression()), !dbg !135

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !75
  // ST: Guess
  ...
  //   %5 = load i32, i32* @atom_1_X4_0, align 4, !dbg !89, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([105 x i8], [105 x i8]* @.str.1, i64 0, i64 0), i32 noundef 57, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !94
