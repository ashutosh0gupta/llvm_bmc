...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv10, 0, !dbg !100
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !101), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !126
  ...
  //   %conv14 = trunc i64 %3 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !80, metadata !DIExpression()), !dbg !102

  //   %cmp = icmp eq i32 %conv, 1, !dbg !110

  //   %conv15 = zext i1 %cmp to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !84, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !85, metadata !DIExpression()), !dbg !130

  //   %4 = zext i32 %conv15 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !87, metadata !DIExpression()), !dbg !130
  ...
  //   %cmp19 = icmp eq i32 %conv4, 2, !dbg !113

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !88, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !89, metadata !DIExpression()), !dbg !133

  //   %5 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %5, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv10, 1, !dbg !116

  //   %conv25 = zext i1 %cmp24 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !92, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !93, metadata !DIExpression()), !dbg !136

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !136
  ...
  //   %cmp29 = icmp eq i32 %conv14, 0, !dbg !119

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !96, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !97, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %7, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !149, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !150, metadata !DIExpression()), !dbg !214

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !151, metadata !DIExpression()), !dbg !216

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !155, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !162, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !165, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !168, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !227

  //   store atomic i64 0, i64* @atom_1_X3_2 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !171, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !229

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !174, metadata !DIExpression()), !dbg !231
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !129
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !180, metadata !DIExpression()), !dbg !243

  //   %conv = trunc i64 %4 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !177, metadata !DIExpression()), !dbg !214

  //   %cmp = icmp eq i32 %conv, 1, !dbg !141

  //   %conv16 = zext i1 %cmp to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !181, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !185, metadata !DIExpression()), !dbg !247

  //   %conv20 = trunc i64 %5 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !182, metadata !DIExpression()), !dbg !214

  //   %cmp21 = icmp eq i32 %conv20, 2, !dbg !145

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !186, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !188, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !187, metadata !DIExpression()), !dbg !214

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !149

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !191, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !193, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !192, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !197, metadata !DIExpression()), !dbg !258

  //   %8 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !154
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !196, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !201, metadata !DIExpression()), !dbg !261

  //   %9 = load atomic i64, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !200, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !205, metadata !DIExpression()), !dbg !264

  //   %10 = load atomic i64, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !160
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !207, metadata !DIExpression()), !dbg !264

  //   %conv44 = trunc i64 %10 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !204, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !209, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !210, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !211, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !212, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i32 %and49, metadata !213, metadata !DIExpression()), !dbg !214
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !171
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %11) #6, !dbg !174

  //   %12 = bitcast i64* %thr0 to i8*, !dbg !174

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #6, !dbg !174
