...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !54, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !57, metadata !DIExpression()), !dbg !71
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !58, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !59, metadata !DIExpression()), !dbg !74
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !103, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !104, metadata !DIExpression()), !dbg !136

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !72

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !72

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !105, metadata !DIExpression()), !dbg !138

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !109, metadata !DIExpression()), !dbg !140

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !110, metadata !DIExpression()), !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !117, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !121, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !123, metadata !DIExpression()), !dbg !162

  //   %conv = trunc i64 %6 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !120, metadata !DIExpression()), !dbg !136

  //   %cmp = icmp eq i32 %conv, 2, !dbg !100

  //   %conv10 = zext i1 %cmp to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !124, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !128, metadata !DIExpression()), !dbg !166

  //   %conv14 = trunc i64 %7 to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !125, metadata !DIExpression()), !dbg !136

  //   %cmp15 = icmp eq i32 %conv14, 2, !dbg !104

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !129, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !131, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !133, metadata !DIExpression()), !dbg !170

  //   %conv20 = trunc i64 %8 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !130, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !135, metadata !DIExpression()), !dbg !136
