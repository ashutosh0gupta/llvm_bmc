...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_0, metadata !147, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !149, metadata !DIExpression()), !dbg !180

  //   store atomic i32 0, i32* @atom_0_X5_0 monotonic, align 4, !dbg !95
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_0_X5_0, align 4, !dbg !117, !tbaa !115
  // LD: Guess
  old_cr = cr(0,3);
