...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !174, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i32 0, metadata !176, metadata !DIExpression()), !dbg !223

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X2_0, align 4, !dbg !147, !tbaa !145
  // LD: Guess
  old_cr = cr(0,5);
