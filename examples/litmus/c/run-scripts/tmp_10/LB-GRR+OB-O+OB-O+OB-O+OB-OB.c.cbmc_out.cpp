...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !147, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !151, metadata !DIExpression()), !dbg !164

  //   %1 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(5,0+5*1);
  cr(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l66_c16
  // Check
  ...
  // ST: Guess
  iw(5,11) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l70_c15
  old_cw = cw(5,11);
  cw(5,11) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l70_c15
  // Check
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !174, metadata !DIExpression()), !dbg !182

  //   br label %label_6, !dbg !54
  goto T6BLOCK1;

T6BLOCK1:
  //   call void @llvm.dbg.label(metadata !181), !dbg !184

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !175, metadata !DIExpression()), !dbg !185
  ...
  // ST: Guess
  iw(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l76_c3
  old_cw = cw(6,0+5*1);
  cw(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l76_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !178, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64 1, metadata !180, metadata !DIExpression()), !dbg !188

  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !60
  // ST: Guess
  iw(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l78_c3
  old_cw = cw(6,0+1*1);
  cw(6,0+1*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l78_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !231, metadata !DIExpression()), !dbg !284
  ...
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l97_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l97_c3
  // Check
  ...
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l98_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l98_c3
  // Check
  ...
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l99_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l99_c3
  // Check
  ...
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l100_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l100_c3
  // Check
