...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !76, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !75, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !83, metadata !DIExpression()), !dbg !109

  //   %conv8 = trunc i64 %2 to i32, !dbg !79

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !80, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !84, metadata !DIExpression()), !dbg !98

  //   %add10 = add nsw i32 %xor9, 1, !dbg !81
  creg_r10 = max(creg_r9,0);
  ASSUME(active[creg_r10] == 2);
  r10 = r9 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !85, metadata !DIExpression()), !dbg !98
  ...
  //   %conv11 = sext i32 %add10 to i64, !dbg !83

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !88, metadata !DIExpression()), !dbg !113

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !83
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !89, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !90, metadata !DIExpression()), !dbg !116

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !92, metadata !DIExpression()), !dbg !116

  //   store atomic i64 %3, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !93, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !94, metadata !DIExpression()), !dbg !119

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !96, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %4, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !89
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !145, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !148, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !151, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !165, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !169, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !173, metadata !DIExpression()), !dbg !221
