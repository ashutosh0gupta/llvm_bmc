...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !60, metadata !DIExpression()), !dbg !96

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %and = and i32 %conv, 128, !dbg !80
  creg_r1 = max(creg_r0,0);
  ASSUME(active[creg_r1] == 2);
  r1 = r0 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !63, metadata !DIExpression()), !dbg !93

  //   %add = add nsw i32 %and, 1, !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !70, metadata !DIExpression()), !dbg !103

  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !85
  // ST: Guess
  iw(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW 
  old_cw = cw(2,0+2*1);
  cw(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM 
  ...
  //   %conv7 = trunc i64 %2 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !71, metadata !DIExpression()), !dbg !93

  //   %and8 = and i32 %conv7, 128, !dbg !89
  creg_r4 = max(creg_r3,0);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and8, metadata !75, metadata !DIExpression()), !dbg !93

  //   %add10 = add nsw i32 1, %and8, !dbg !90
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %3, !dbg !90
  r6 = 0+r5*1;
  ASSUME(creg_r6 >= 0);
  ...
  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !79, metadata !DIExpression()), !dbg !110

  //   %conv13 = trunc i64 %4 to i32, !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !83, metadata !DIExpression()), !dbg !113

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !95
  // ST: Guess
  ...
  //   %6 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !87, metadata !DIExpression()), !dbg !116

  //   store atomic i64 %6, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !89, metadata !DIExpression()), !dbg !119

  //   %7 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !91, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %7, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !150, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !156, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !162, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !203

  //   store atomic i64 0, i64* @atom_1_X4_2 monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !165, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !205

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !169, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !178, metadata !DIExpression()), !dbg !227

  //   %8 = load atomic i64, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !180, metadata !DIExpression()), !dbg !227

  //   %conv24 = trunc i64 %8 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !177, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !182, metadata !DIExpression()), !dbg !230

  //   %9 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !184, metadata !DIExpression()), !dbg !230
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !139
