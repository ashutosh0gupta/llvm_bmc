...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !93, metadata !DIExpression()), !dbg !106
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !95, metadata !DIExpression()), !dbg !109

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !60
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !97, metadata !DIExpression()), !dbg !109

  //   %conv = trunc i64 %0 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !94, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !98, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64 2, metadata !100, metadata !DIExpression()), !dbg !112

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !63
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !101, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64 1, metadata !103, metadata !DIExpression()), !dbg !114

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !65
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !104, metadata !DIExpression()), !dbg !106

  //   store i32 %conv3, i32* @atom_2_X0_1, align 4, !dbg !67, !tbaa !68
  // ST: Guess
  iw(3,7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l45_c15
  old_cw = cw(3,7);
  cw(3,7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l45_c15
  // Check
...
T4BLOCK1:
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) acquire, align 8, !dbg !57
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+3*1);
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) release, align 8, !dbg !60
  // ST: Guess
  //   : Release
  ...
  //   store i32 %conv1, i32* @atom_3_X0_1, align 4, !dbg !62, !tbaa !63
  // ST: Guess
