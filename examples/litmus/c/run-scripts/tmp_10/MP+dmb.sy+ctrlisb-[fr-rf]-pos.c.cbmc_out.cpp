...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv, 0, !dbg !70
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !82), !dbg !94

  //   call void (...) @isb(), !dbg !76
  // isb: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !66, metadata !DIExpression()), !dbg !96

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !78
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !81
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp14 = icmp eq i32 %conv4, 0, !dbg !92
  ...
  //   store i32 %conv15, i32* @atom_1_X2_0, align 4, !dbg !93, !tbaa !88
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 1, !dbg !94
  ...
  //   store i32 %conv17, i32* @atom_1_X4_1, align 4, !dbg !95, !tbaa !88
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv12, 1, !dbg !96
  ...
  //   store i32 %conv19, i32* @atom_1_X5_1, align 4, !dbg !97, !tbaa !88
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !121, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i64 1, metadata !123, metadata !DIExpression()), !dbg !128
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !156, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !197

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !159, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !199

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !162, metadata !DIExpression()), !dbg !201

  //   call void @llvm.dbg.value(metadata i32 0, metadata !164, metadata !DIExpression()), !dbg !201

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X2_0, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %10 = load i32, i32* @atom_1_X4_1, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X5_1, align 4, !dbg !135, !tbaa !131
  // LD: Guess
  old_cr = cr(0,5);
