...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !35, metadata !DIExpression()), !dbg !46

  //   call void @llvm.dbg.value(metadata i64 3, metadata !38, metadata !DIExpression()), !dbg !46

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !47
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !39, metadata !DIExpression()), !dbg !49
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !56, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !64, metadata !DIExpression()), !dbg !79

  //   call void @llvm.dbg.value(metadata i64 2, metadata !66, metadata !DIExpression()), !dbg !79
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !95, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !96, metadata !DIExpression()), !dbg !119

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !63

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !63

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !97, metadata !DIExpression()), !dbg !121

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !65

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !65

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !101, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !102, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i64 0, metadata !104, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !108, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i32 0, metadata !111, metadata !DIExpression()), !dbg !128

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !72
  // ST: Guess
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #7, !dbg !73
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call5 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !74
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %2 = load i64, i64* %thr0, align 8, !dbg !75, !tbaa !76
  r4 = local_mem[0];

  //   %call6 = call i32 @pthread_join(i64 noundef %2, i8** noundef null), !dbg !80
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr1, align 8, !dbg !81, !tbaa !76
  r5 = local_mem[1];

  //   %call7 = call i32 @pthread_join(i64 noundef %3, i8** noundef null), !dbg !82
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !113, metadata !DIExpression()), !dbg !138

  //   %4 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(0,0+1*1);
  cr(0,0+1*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l51_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !115, metadata !DIExpression()), !dbg !138

  //   %conv = trunc i64 %4 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !112, metadata !DIExpression()), !dbg !119

  //   %cmp = icmp eq i32 %conv, 3, !dbg !86
  creg__r6__3_ = max(0,creg_r6);

  //   %conv8 = zext i1 %cmp to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !116, metadata !DIExpression()), !dbg !119

  //   %5 = load i32, i32* @atom_1_X0_1, align 4, !dbg !87, !tbaa !88
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %and = and i32 %conv8, %5, !dbg !90
  creg_r8 = max(creg__r6__3_,creg_r7);
  r8 = (r6==3) & r7;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !118, metadata !DIExpression()), !dbg !119

  //   %cmp9 = icmp eq i32 %and, 1, !dbg !91
  creg__r8__1_ = max(0,creg_r8);

  //   br i1 %cmp9, label %if.then, label %if.end, !dbg !93
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 55, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
