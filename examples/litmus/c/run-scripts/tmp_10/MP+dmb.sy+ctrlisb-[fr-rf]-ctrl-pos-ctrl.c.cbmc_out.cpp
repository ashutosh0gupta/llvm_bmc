...
T2BLOCK10:
  ...
  //   %cmp28 = icmp eq i32 %conv4, 0, !dbg !120
  ...
  //   store i32 %conv29, i32* @atom_1_X2_0, align 4, !dbg !121, !tbaa !116
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv8, 1, !dbg !122
  ...
  //   store i32 %conv31, i32* @atom_1_X4_1, align 4, !dbg !123, !tbaa !116
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !190, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !193, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !200, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !205, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !210, metadata !DIExpression()), !dbg !266
