...
T1BLOCK1:
  ...
  //   store i32 %conv1, i32* @atom_0_X2_0, align 4, !dbg !56, !tbaa !57
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !79
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !105, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i32 0, metadata !108, metadata !DIExpression()), !dbg !124

  //   store atomic i32 0, i32* @atom_0_X2_0 monotonic, align 4, !dbg !73
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_0_X2_0, align 4, !dbg !86, !tbaa !87
  // LD: Guess
  old_cr = cr(0,2);
