...
T2BLOCK4:
  ...
  //   %conv21 = zext i1 %cmp to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !84, metadata !DIExpression()), !dbg !89

  //   store i32 %conv21, i32* @atom_1_X0_1, align 4, !dbg !100, !tbaa !101
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 2, !dbg !105
  ...
  //   store i32 %conv23, i32* @atom_1_X5_2, align 4, !dbg !106, !tbaa !101
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv20, 0, !dbg !107
  ...
  //   store i32 %conv25, i32* @atom_1_X10_0, align 4, !dbg !108, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !173, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !176, metadata !DIExpression()), !dbg !221
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !154
