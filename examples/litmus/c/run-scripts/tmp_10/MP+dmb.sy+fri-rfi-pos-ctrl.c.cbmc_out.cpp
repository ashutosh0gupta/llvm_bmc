...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !92

  //   call void @llvm.dbg.value(metadata i64 2, metadata !67, metadata !DIExpression()), !dbg !92

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !74
  // ST: Guess
...
T2BLOCK4:
  ...
  //   store i32 %conv15, i32* @atom_1_X3_2, align 4, !dbg !97, !tbaa !92
  // ST: Guess
