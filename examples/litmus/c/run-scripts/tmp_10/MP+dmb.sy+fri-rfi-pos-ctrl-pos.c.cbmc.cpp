...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !158, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !202

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X3_2, align 4, !dbg !136, !tbaa !134
  // LD: Guess
  old_cr = cr(0,3);
