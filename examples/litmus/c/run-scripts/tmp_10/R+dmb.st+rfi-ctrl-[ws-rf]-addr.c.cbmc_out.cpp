...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !58, metadata !DIExpression()), !dbg !83
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64 2, metadata !61, metadata !DIExpression()), !dbg !86

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !68
  // ST: Guess
  iw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l29_c3
  old_cw = cw(2,0+1*1);
  cw(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l29_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !63, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !62, metadata !DIExpression()), !dbg !83
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !82), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !69, metadata !DIExpression()), !dbg !83

  //   %xor = xor i32 %conv6, %conv6, !dbg !83
  creg_r2 = creg_r1;
  r2 = r1 ^ r1;
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !104
  ...
  //   %conv10 = trunc i64 %2 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !74, metadata !DIExpression()), !dbg !83
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !78, metadata !DIExpression()), !dbg !83

  //   store i32 %conv11, i32* @atom_1_X2_2, align 4, !dbg !88, !tbaa !89
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv6, 2, !dbg !93
  creg__r1__2_ = max(0,creg_r1);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !79, metadata !DIExpression()), !dbg !83

  //   store i32 %conv13, i32* @atom_1_X5_2, align 4, !dbg !94, !tbaa !89
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv10, 0, !dbg !95
  creg__r5__0_ = max(0,creg_r5);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !80, metadata !DIExpression()), !dbg !83

  //   store i32 %conv15, i32* @atom_1_X7_0, align 4, !dbg !96, !tbaa !89
  // ST: Guess
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !119, metadata !DIExpression()), !dbg !124
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !120, metadata !DIExpression()), !dbg !127

  //   call void @llvm.dbg.value(metadata i64 2, metadata !122, metadata !DIExpression()), !dbg !127

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !48
  // ST: Guess
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l48_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l48_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !137, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !138, metadata !DIExpression()), !dbg !187

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !139, metadata !DIExpression()), !dbg !189

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !143, metadata !DIExpression()), !dbg !191

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !144, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !145, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !151, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !154, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !200

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !158, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !202

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !108
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !161, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !204

  //   store atomic i32 0, i32* @atom_1_X7_0 monotonic, align 4, !dbg !110
  // ST: Guess
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !114, !tbaa !115
  r7 = local_mem[1];
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !120, !tbaa !115
  r8 = local_mem[2];
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !122, !tbaa !115
  r9 = local_mem[0];
  ...
  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !125
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !167, metadata !DIExpression()), !dbg !217

  //   %conv = trunc i64 %6 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !164, metadata !DIExpression()), !dbg !187

  //   %cmp = icmp eq i32 %conv, 1, !dbg !127
  creg__r10__1_ = max(0,creg_r10);

  //   %conv16 = zext i1 %cmp to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !168, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !221

  //   %7 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !172, metadata !DIExpression()), !dbg !221

  //   %conv20 = trunc i64 %7 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !169, metadata !DIExpression()), !dbg !187

  //   %cmp21 = icmp eq i32 %conv20, 2, !dbg !131
  creg__r11__2_ = max(0,creg_r11);

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !173, metadata !DIExpression()), !dbg !187

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !175, metadata !DIExpression()), !dbg !225

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !133
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !177, metadata !DIExpression()), !dbg !225

  //   %conv26 = trunc i64 %8 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !174, metadata !DIExpression()), !dbg !187

  //   %cmp27 = icmp eq i32 %conv26, 2, !dbg !135
  creg__r12__2_ = max(0,creg_r12);

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !178, metadata !DIExpression()), !dbg !187

  //   %9 = load i32, i32* @atom_1_X2_2, align 4, !dbg !136, !tbaa !137
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !179, metadata !DIExpression()), !dbg !187

  //   %10 = load i32, i32* @atom_1_X5_2, align 4, !dbg !139, !tbaa !137
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !180, metadata !DIExpression()), !dbg !187

  //   %11 = load i32, i32* @atom_1_X7_0, align 4, !dbg !140, !tbaa !137
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !181, metadata !DIExpression()), !dbg !187

  //   %and = and i32 %10, %11, !dbg !141
  creg_r16 = max(creg_r14,creg_r15);
  r16 = r14 & r15;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !182, metadata !DIExpression()), !dbg !187

  //   %and29 = and i32 %9, %and, !dbg !142
  creg_r17 = max(creg_r13,creg_r16);
  r17 = r13 & r16;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !183, metadata !DIExpression()), !dbg !187

  //   %and30 = and i32 %conv28, %and29, !dbg !143
  creg_r18 = max(creg__r12__2_,creg_r17);
  r18 = (r12==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !184, metadata !DIExpression()), !dbg !187

  //   %and31 = and i32 %conv22, %and30, !dbg !144
  ...
  //   %and32 = and i32 %conv16, %and31, !dbg !145
  ...
  //   %cmp33 = icmp eq i32 %and32, 1, !dbg !146
  creg__r20__1_ = max(0,creg_r20);

  //   br i1 %cmp33, label %if.then, label %if.end, !dbg !148
  old_cctrl = cctrl[0];
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
