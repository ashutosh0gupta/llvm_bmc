...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !63, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64 2, metadata !65, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !67, metadata !DIExpression()), !dbg !92
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !74, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !84

  //   %cmp = icmp eq i32 %conv, 1, !dbg !89
  creg__r0__1_ = max(0,creg_r0);

  //   %conv13 = zext i1 %cmp to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !79, metadata !DIExpression()), !dbg !84

  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !90, !tbaa !91
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 2, !dbg !95
  creg__r1__2_ = max(0,creg_r1);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !80, metadata !DIExpression()), !dbg !84

  //   store i32 %conv15, i32* @atom_1_X3_2, align 4, !dbg !96, !tbaa !91
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv12, 0, !dbg !97
  creg__r6__0_ = max(0,creg_r6);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !81, metadata !DIExpression()), !dbg !84

  //   store i32 %conv17, i32* @atom_1_X7_0, align 4, !dbg !98, !tbaa !91
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !142, metadata !DIExpression()), !dbg !180
  ...
  //   %6 = load i32, i32* @atom_1_X0_1, align 4, !dbg !120, !tbaa !121
  // LD: Guess
  old_cr = cr(0,3);
