...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !69, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !71, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !70, metadata !DIExpression()), !dbg !103

  //   %tobool = icmp ne i32 %conv8, 0, !dbg !97
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !102), !dbg !121

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !122

  //   call void @llvm.dbg.value(metadata i64 1, metadata !76, metadata !DIExpression()), !dbg !122
