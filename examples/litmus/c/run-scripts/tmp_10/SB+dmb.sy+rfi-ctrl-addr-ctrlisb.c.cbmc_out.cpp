...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !78, metadata !DIExpression()), !dbg !113

  //   %conv4 = trunc i64 %1 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !75, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !83, metadata !DIExpression()), !dbg !118
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !84, metadata !DIExpression()), !dbg !99

  //   %cmp = icmp eq i32 %conv, 1, !dbg !102

  //   %conv16 = zext i1 %cmp to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !88, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !89, metadata !DIExpression()), !dbg !131

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !91, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %4, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !104
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv15, 0, !dbg !105

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !92, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !93, metadata !DIExpression()), !dbg !134

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !95, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %5, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !107
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !163, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !183, metadata !DIExpression()), !dbg !235
