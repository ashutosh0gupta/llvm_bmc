...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !38, metadata !DIExpression()), !dbg !49
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !42, metadata !DIExpression()), !dbg !51
...
T2BLOCK1:
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) acquire, align 8, !dbg !56
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !62, metadata !DIExpression()), !dbg !76

  //   call void @llvm.dbg.value(metadata i64 2, metadata !64, metadata !DIExpression()), !dbg !76

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !59
  // ST: Guess
  //   : Release
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !84, metadata !DIExpression()), !dbg !102
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !86, metadata !DIExpression()), !dbg !105
  ...
  ASSUME(cr(3,0) >= cs(3,2+0));
  ASSUME(cr(3,0) >= cs(3,3+0));
  ASSUME(cr(3,0) >= cs(3,4+0));
  ASSUME(cr(3,0) >= cs(3,5+0));
  ASSUME(cr(3,0) >= cs(3,6+0));
  ASSUME(cr(3,0) >= cs(3,7+0));
  // Update
  creg_r1 = cr(3,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !88, metadata !DIExpression()), !dbg !105

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !85, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !90, metadata !DIExpression()), !dbg !108

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !64
  // LD: Guess
  old_cr = cr(3,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !92, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_2, metadata !94, metadata !DIExpression()), !dbg !112

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !96, metadata !DIExpression()), !dbg !112

  //   store atomic i64 %2, i64* @atom_2_X0_2 seq_cst, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !98, metadata !DIExpression()), !dbg !115

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !100, metadata !DIExpression()), !dbg !115
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !132, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !133, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !136, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !139, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64 0, metadata !141, metadata !DIExpression()), !dbg !179

  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_2, metadata !142, metadata !DIExpression()), !dbg !181

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !181

  //   store atomic i64 0, i64* @atom_2_X0_2 monotonic, align 8, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !145, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64 0, metadata !147, metadata !DIExpression()), !dbg !183

  //   store atomic i64 0, i64* @atom_2_X2_0 monotonic, align 8, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !149, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !151, metadata !DIExpression()), !dbg !198

  //   %conv = trunc i64 %6 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !148, metadata !DIExpression()), !dbg !168

  //   %cmp = icmp eq i32 %conv, 2, !dbg !118

  //   %conv14 = zext i1 %cmp to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !152, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !154, metadata !DIExpression()), !dbg !202

  //   %7 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !156, metadata !DIExpression()), !dbg !202

  //   %conv18 = trunc i64 %7 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !153, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_2, metadata !158, metadata !DIExpression()), !dbg !205

  //   %8 = load atomic i64, i64* @atom_2_X0_2 seq_cst, align 8, !dbg !123
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !160, metadata !DIExpression()), !dbg !205

  //   %conv22 = trunc i64 %8 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !157, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !162, metadata !DIExpression()), !dbg !208

  //   %9 = load atomic i64, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !126
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !164, metadata !DIExpression()), !dbg !208

  //   %conv26 = trunc i64 %9 to i32, !dbg !127

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !161, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !166, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !167, metadata !DIExpression()), !dbg !168
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !134
