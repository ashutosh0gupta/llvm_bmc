...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !72, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !110

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !90
  // ST: Guess
  iw(2,r4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l36_c3
  old_cw = cw(2,r4);
  cw(2,r4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l36_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !77, metadata !DIExpression()), !dbg !111

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !79, metadata !DIExpression()), !dbg !111

  //   %conv10 = trunc i64 %2 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !76, metadata !DIExpression()), !dbg !91

  //   %tobool11 = icmp ne i32 %conv10, 0, !dbg !95
  creg__r5__0_ = max(0,creg_r5);

  //   br i1 %tobool11, label %if.then12, label %if.else13, !dbg !97
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !90), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !121
  ...
  //   %conv17 = trunc i64 %3 to i32, !dbg !104
  ...
  //   store i32 %conv20, i32* @atom_1_X4_2, align 4, !dbg !112, !tbaa !107
  // ST: Guess
  ...
  //   %cmp21 = icmp eq i32 %conv10, 1, !dbg !113
  ...
  //   store i32 %conv22, i32* @atom_1_X8_1, align 4, !dbg !114, !tbaa !107
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv17, 0, !dbg !115
  ...
  //   store i32 %conv24, i32* @atom_1_X9_0, align 4, !dbg !116, !tbaa !107
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !140, metadata !DIExpression()), !dbg !147
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !164, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !165, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !168, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !171, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !174, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !177, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !181, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !184, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !187, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !191, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !193, metadata !DIExpression()), !dbg !255

  //   %conv = trunc i64 %6 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !190, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !194, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !196, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !198, metadata !DIExpression()), !dbg !259

  //   %conv24 = trunc i64 %7 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !195, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !199, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !201, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !203, metadata !DIExpression()), !dbg !263

  //   %conv30 = trunc i64 %8 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !200, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !204, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !206, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !208, metadata !DIExpression()), !dbg !267

  //   %conv36 = trunc i64 %9 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !205, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !209, metadata !DIExpression()), !dbg !221
  ...
  //   %12 = load i32, i32* @atom_1_X8_1, align 4, !dbg !164, !tbaa !161
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !215, metadata !DIExpression()), !dbg !221

  //   %and40 = and i32 %10, %and39, !dbg !168
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !216, metadata !DIExpression()), !dbg !221

  //   %and41 = and i32 %conv38, %and40, !dbg !169
  creg_r22 = max(creg__r14__2_,creg_r21);
  r22 = (r14==2) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !217, metadata !DIExpression()), !dbg !221

  //   %and42 = and i32 %conv32, %and41, !dbg !170
  creg_r23 = max(creg__r13__1_,creg_r22);
  r23 = (r13==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !218, metadata !DIExpression()), !dbg !221

  //   %and43 = and i32 %conv26, %and42, !dbg !171
  creg_r24 = max(creg__r12__1_,creg_r23);
  r24 = (r12==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !219, metadata !DIExpression()), !dbg !221

  //   %and44 = and i32 %conv20, %and43, !dbg !172
  creg_r25 = max(creg__r11__1_,creg_r24);
  r25 = (r11==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !220, metadata !DIExpression()), !dbg !221
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 100, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !176
