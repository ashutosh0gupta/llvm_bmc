...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !133, metadata !DIExpression()), !dbg !170
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !139, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !142, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !145, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X3_1, metadata !149, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !152, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !154, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !155, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !103
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l57_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l57_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !158, metadata !DIExpression()), !dbg !165

  //   %5 = load i32, i32* @atom_0_X3_1, align 4, !dbg !117, !tbaa !115
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %6 = load i32, i32* @atom_1_X2_1, align 4, !dbg !118, !tbaa !115
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %7 = load i32, i32* @atom_1_X0_1, align 4, !dbg !119, !tbaa !115
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %and18 = and i32 %5, %and, !dbg !121
  creg_r12 = max(creg_r11,creg_r8);
  r12 = r8 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !163, metadata !DIExpression()), !dbg !165

  //   %and19 = and i32 %4, %and18, !dbg !122
  creg_r13 = max(creg_r12,creg_r7);
  r13 = r7 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !164, metadata !DIExpression()), !dbg !165

  //   %cmp = icmp eq i32 %and19, 1, !dbg !123
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
