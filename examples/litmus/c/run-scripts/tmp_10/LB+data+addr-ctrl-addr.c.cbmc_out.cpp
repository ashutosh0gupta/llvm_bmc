...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !68, metadata !DIExpression()), !dbg !89
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !92

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !62
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !72, metadata !DIExpression()), !dbg !92

  //   %conv = trunc i64 %0 to i32, !dbg !63

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !69, metadata !DIExpression()), !dbg !89
  ...
  //   %add = add nsw i32 2, %xor, !dbg !65
  creg_r5 = max(0,creg_r4);
  r5 = 2 + r4;

  //   %idxprom = sext i32 %add to i64, !dbg !65

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !65
  r6 = 0+r5*1;
  creg_r6 = creg_r5;
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !77, metadata !DIExpression()), !dbg !97

  //   %conv4 = trunc i64 %1 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !74, metadata !DIExpression()), !dbg !89

  //   %tobool = icmp ne i32 %conv4, 0, !dbg !68
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !79, metadata !DIExpression()), !dbg !105

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !75
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !81, metadata !DIExpression()), !dbg !105

  //   %conv8 = trunc i64 %2 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !78, metadata !DIExpression()), !dbg !89

  //   %xor9 = xor i32 %conv8, %conv8, !dbg !77
  creg_r9 = creg_r8;
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !82, metadata !DIExpression()), !dbg !89

  //   %add10 = add nsw i32 0, %xor9, !dbg !78
  creg_r10 = max(0,creg_r9);
  r10 = 0 + r9;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !78

  //   %arrayidx12 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !78
  r11 = 0+r10*1;
  creg_r11 = creg_r10;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !83, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 1, metadata !85, metadata !DIExpression()), !dbg !110

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !78
  // ST: Guess
  iw(2,r11) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l38_c3
  old_cw = cw(2,r11);
  cw(2,r11) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l38_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !86, metadata !DIExpression()), !dbg !89
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !121, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !122, metadata !DIExpression()), !dbg !162

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !123, metadata !DIExpression()), !dbg !164

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !127, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !128, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i64 0, metadata !130, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !131, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64 0, metadata !133, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !134, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64 0, metadata !136, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !137, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64 0, metadata !139, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !140, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !175
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !144, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i32 0, metadata !146, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !148, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !150, metadata !DIExpression()), !dbg !187

  //   %conv = trunc i64 %4 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !147, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !151, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !155, metadata !DIExpression()), !dbg !191

  //   %conv18 = trunc i64 %5 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !152, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !156, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !157, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !158, metadata !DIExpression()), !dbg !162

  //   %and = and i32 %6, %7, !dbg !120
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !159, metadata !DIExpression()), !dbg !162

  //   %and21 = and i32 %conv20, %and, !dbg !121
  creg_r20 = max(creg__r16__1_,creg_r19);
  r20 = (r16==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !160, metadata !DIExpression()), !dbg !162

  //   %and22 = and i32 %conv14, %and21, !dbg !122
  creg_r21 = max(creg__r15__1_,creg_r20);
  r21 = (r15==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !161, metadata !DIExpression()), !dbg !162
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !126
