...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !114, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i32 0, metadata !117, metadata !DIExpression()), !dbg !133

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !118, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i32 0, metadata !120, metadata !DIExpression()), !dbg !135

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !75
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_1_X0_1, align 4, !dbg !86, !tbaa !87
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %5 = load i32, i32* @atom_1_X2_0, align 4, !dbg !89, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
