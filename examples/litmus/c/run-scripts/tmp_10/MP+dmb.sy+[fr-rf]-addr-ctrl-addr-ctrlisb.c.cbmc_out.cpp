...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !71, metadata !DIExpression()), !dbg !102
...
T2BLOCK4:
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   %xor13 = xor i32 %conv12, %conv12, !dbg !94
  creg_r7 = creg_r6;
  r7 = r6 ^ r6;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !76, metadata !DIExpression()), !dbg !91

  //   %add15 = add nsw i32 4, %xor13, !dbg !95
  creg_r8 = max(0,creg_r7);
  r8 = 4 + r7;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !95

  //   %arrayidx17 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !95
  r9 = 0+r8*1;
  creg_r9 = creg_r8;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !78, metadata !DIExpression()), !dbg !115

  //   %4 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,r9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !80, metadata !DIExpression()), !dbg !115

  //   %conv20 = trunc i64 %4 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !77, metadata !DIExpression()), !dbg !91

  //   %tobool21 = icmp ne i32 %conv20, 0, !dbg !98
  creg__r10__0_ = max(0,creg_r10);

  //   br i1 %tobool21, label %if.then22, label %if.else23, !dbg !100
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !106
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv27 = trunc i64 %5 to i32, !dbg !107
  ...
  //   %conv28 = zext i1 %cmp to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !85, metadata !DIExpression()), !dbg !91

  //   store i32 %conv28, i32* @atom_1_X0_1, align 4, !dbg !109, !tbaa !110
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv4, 2, !dbg !114
  ...
  //   store i32 %conv30, i32* @atom_1_X2_2, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv27, 0, !dbg !116
  creg__r11__0_ = max(0,creg_r11);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !87, metadata !DIExpression()), !dbg !91

  //   store i32 %conv32, i32* @atom_1_X11_0, align 4, !dbg !117, !tbaa !110
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !141, metadata !DIExpression()), !dbg !148
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !208

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !210

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !212

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !165, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !166, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !169, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !172, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !181, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !185, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i32 0, metadata !187, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !188, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !192, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !194, metadata !DIExpression()), !dbg !242

  //   %conv = trunc i64 %6 to i32, !dbg !130

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !191, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !195, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !197, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !199, metadata !DIExpression()), !dbg !246

  //   %conv24 = trunc i64 %7 to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !196, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !200, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !201, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !202, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !203, metadata !DIExpression()), !dbg !208

  //   %and = and i32 %9, %10, !dbg !141
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !204, metadata !DIExpression()), !dbg !208

  //   %and27 = and i32 %8, %and, !dbg !142
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !205, metadata !DIExpression()), !dbg !208

  //   %and28 = and i32 %conv26, %and27, !dbg !143
  creg_r23 = max(creg__r17__2_,creg_r22);
  r23 = (r17==2) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and28, metadata !206, metadata !DIExpression()), !dbg !208

  //   %and29 = and i32 %conv20, %and28, !dbg !144
  creg_r24 = max(creg__r16__1_,creg_r23);
  r24 = (r16==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and29, metadata !207, metadata !DIExpression()), !dbg !208
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !148
