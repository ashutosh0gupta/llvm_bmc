...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !88, metadata !DIExpression()), !dbg !137
  ...
  //   %cmp30 = icmp eq i32 %conv4, 2, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !90, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !92, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv27, 0, !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !94, metadata !DIExpression()), !dbg !143

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %8, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !125
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !149, metadata !DIExpression()), !dbg !156
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !166, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !167, metadata !DIExpression()), !dbg !224

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !168, metadata !DIExpression()), !dbg !226

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !172, metadata !DIExpression()), !dbg !228

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !105

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !105

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !173, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !174, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !177, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !180, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !186, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !189, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !192, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !195, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !199, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !201, metadata !DIExpression()), !dbg !260

  //   %conv = trunc i64 %6 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !198, metadata !DIExpression()), !dbg !224

  //   %cmp = icmp eq i32 %conv, 1, !dbg !139

  //   %conv20 = zext i1 %cmp to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !202, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !204, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !206, metadata !DIExpression()), !dbg !264

  //   %conv24 = trunc i64 %7 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !203, metadata !DIExpression()), !dbg !224

  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !143

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !207, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !209, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !211, metadata !DIExpression()), !dbg !268

  //   %conv30 = trunc i64 %8 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !208, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !213, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !215, metadata !DIExpression()), !dbg !271

  //   %conv34 = trunc i64 %9 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !212, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !217, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !219, metadata !DIExpression()), !dbg !274

  //   %conv38 = trunc i64 %10 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !216, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !220, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !221, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !222, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !223, metadata !DIExpression()), !dbg !224
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
