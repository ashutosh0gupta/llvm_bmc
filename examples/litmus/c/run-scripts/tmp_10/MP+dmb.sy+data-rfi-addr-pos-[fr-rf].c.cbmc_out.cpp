...
T2BLOCK1:
  ...
  //   %xor6 = xor i32 %conv5, %conv5, !dbg !104
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !76, metadata !DIExpression()), !dbg !110

  //   %add8 = add nsw i32 0, %xor6, !dbg !105
  creg_r5 = max(0,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = 0 + r4;

  //   %idxprom = sext i32 %add8 to i64, !dbg !105
  ...
  //   %2 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,r6);
  ...
  //   %conv11 = trunc i64 %2 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !77, metadata !DIExpression()), !dbg !110
  ...
  //   %cmp29 = icmp eq i32 %conv11, 0, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !98, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !102, metadata !DIExpression()), !dbg !143
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !192, metadata !DIExpression()), !dbg !260

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !260

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !195, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !221, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !225, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !229, metadata !DIExpression()), !dbg !300
