...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !99), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !120
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp19 = icmp eq i32 %conv4, 2, !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !87, metadata !DIExpression()), !dbg !129

  //   %6 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !89, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %6, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !111
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv12, 0, !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !91, metadata !DIExpression()), !dbg !132

  //   %7 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %7, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !95, metadata !DIExpression()), !dbg !135

  //   %8 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %8, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !178, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !181, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !235

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !122
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !184, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !202, metadata !DIExpression()), !dbg !263

  //   %9 = load atomic i64, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !150
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !206, metadata !DIExpression()), !dbg !266

  //   %10 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !153
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !210, metadata !DIExpression()), !dbg !269
