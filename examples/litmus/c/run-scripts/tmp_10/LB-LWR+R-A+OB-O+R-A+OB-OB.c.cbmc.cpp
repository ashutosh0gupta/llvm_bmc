...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !94, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !98, metadata !DIExpression()), !dbg !111
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !146, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !150, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !152, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X2_0, metadata !154, metadata !DIExpression()), !dbg !173

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !156, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !158, metadata !DIExpression()), !dbg !176

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !160, metadata !DIExpression()), !dbg !176
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X2_0, metadata !211, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X2_0, metadata !227, metadata !DIExpression()), !dbg !300
