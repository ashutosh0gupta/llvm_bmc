...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !50, metadata !DIExpression()), !dbg !67

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !68
  // ST: Guess
  //   : Release
  ...
  //   %cmp = icmp eq i32 %conv8, 3, !dbg !72
  ...
  //   store i32 %conv9, i32* @atom_0_X7_3, align 4, !dbg !73, !tbaa !74
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !84, metadata !DIExpression()), !dbg !94
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X7_3, metadata !125, metadata !DIExpression()), !dbg !158
