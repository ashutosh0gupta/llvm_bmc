...
T2BLOCK1:
  ...
  //   %xor8 = xor i32 %conv7, %conv7, !dbg !80
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor8, metadata !75, metadata !DIExpression()), !dbg !84

  //   %add10 = add nsw i32 0, %xor8, !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !79, metadata !DIExpression()), !dbg !101
  ...
  //   store i32 %conv16, i32* @atom_1_X5_2, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   store i32 %conv18, i32* @atom_1_X7_0, align 4, !dbg !93, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !137, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !141, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !183

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !144, metadata !DIExpression()), !dbg !185
  ...
  //   %8 = load i32, i32* @atom_1_X5_2, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X7_0, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 77, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
