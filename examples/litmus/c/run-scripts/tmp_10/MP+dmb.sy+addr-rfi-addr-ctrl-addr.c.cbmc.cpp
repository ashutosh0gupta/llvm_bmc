...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !64, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64 1, metadata !66, metadata !DIExpression()), !dbg !107

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !108

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !99

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !92
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !71, metadata !DIExpression()), !dbg !99

  //   %add7 = add nsw i32 3, %xor5, !dbg !93
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 3 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !93

  //   %arrayidx9 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !93
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !73, metadata !DIExpression()), !dbg !113

  //   %2 = load atomic i64, i64* %arrayidx9 monotonic, align 8, !dbg !93
  // LD: Guess
  old_cr = cr(2,r7);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !145, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !146, metadata !DIExpression()), !dbg !208

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !147, metadata !DIExpression()), !dbg !210

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !151, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !152, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !155, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !158, metadata !DIExpression()), !dbg !217

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !164, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !167, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !170, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !225

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !173, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !227

  //   store atomic i64 0, i64* @atom_1_X12_0 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !179, metadata !DIExpression()), !dbg !239

  //   %conv = trunc i64 %4 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !176, metadata !DIExpression()), !dbg !208

  //   %cmp = icmp eq i32 %conv, 1, !dbg !139

  //   %conv18 = zext i1 %cmp to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !180, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !182, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !184, metadata !DIExpression()), !dbg !243

  //   %conv22 = trunc i64 %5 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !181, metadata !DIExpression()), !dbg !208

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !143

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !185, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !187, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !189, metadata !DIExpression()), !dbg !247

  //   %conv28 = trunc i64 %6 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !186, metadata !DIExpression()), !dbg !208

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !147

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !190, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !192, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !194, metadata !DIExpression()), !dbg !251

  //   %conv34 = trunc i64 %7 to i32, !dbg !150

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !191, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !196, metadata !DIExpression()), !dbg !254

  //   %8 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !198, metadata !DIExpression()), !dbg !254

  //   %conv38 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !195, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !200, metadata !DIExpression()), !dbg !257

  //   %9 = load atomic i64, i64* @atom_1_X12_0 seq_cst, align 8, !dbg !155
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !202, metadata !DIExpression()), !dbg !257

  //   %conv42 = trunc i64 %9 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !199, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !203, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !204, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !205, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !206, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !207, metadata !DIExpression()), !dbg !208
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([118 x i8], [118 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !165
