...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !89
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !73, metadata !DIExpression()), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !76, metadata !DIExpression()), !dbg !103
  ...
  //   store i32 %conv12, i32* @atom_1_X2_2, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv4, 2, !dbg !92
  ...
  //   store i32 %conv14, i32* @atom_1_X3_2, align 4, !dbg !93, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !141, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i32 0, metadata !143, metadata !DIExpression()), !dbg !172

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X3_2, align 4, !dbg !114, !tbaa !112
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !121
