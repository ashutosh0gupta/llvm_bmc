...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !64, metadata !DIExpression()), !dbg !106

  //   %conv4 = trunc i64 %1 to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !61, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !66, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !68, metadata !DIExpression()), !dbg !109

  //   %conv8 = trunc i64 %2 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !65, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !70, metadata !DIExpression()), !dbg !94
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !77, metadata !DIExpression()), !dbg !122

  //   %conv19 = trunc i64 %4 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !74, metadata !DIExpression()), !dbg !94
...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !81, metadata !DIExpression()), !dbg !132

  //   %conv26 = trunc i64 %5 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !78, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !116

  //   %conv27 = zext i1 %cmp to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !82, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !83, metadata !DIExpression()), !dbg !136

  //   %6 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !85, metadata !DIExpression()), !dbg !136
  ...
  //   %cmp29 = icmp eq i32 %conv26, 0, !dbg !119

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !86, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !87, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !89, metadata !DIExpression()), !dbg !139
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !149, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !150, metadata !DIExpression()), !dbg !198

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !151, metadata !DIExpression()), !dbg !200

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !155, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !156, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64 0, metadata !158, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !159, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64 0, metadata !161, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !162, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !165, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !168, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64 0, metadata !170, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !171, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !174, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !215

  //   store atomic i64 0, i64* @atom_1_X10_0 monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !109
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !180, metadata !DIExpression()), !dbg !227

  //   %conv = trunc i64 %4 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !177, metadata !DIExpression()), !dbg !198

  //   %cmp = icmp eq i32 %conv, 1, !dbg !121

  //   %conv16 = zext i1 %cmp to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !181, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !185, metadata !DIExpression()), !dbg !231

  //   %conv20 = trunc i64 %5 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !182, metadata !DIExpression()), !dbg !198

  //   %cmp21 = icmp eq i32 %conv20, 1, !dbg !125

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !186, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !188, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !190, metadata !DIExpression()), !dbg !235

  //   %conv26 = trunc i64 %6 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !187, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !192, metadata !DIExpression()), !dbg !238

  //   %7 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !130
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !194, metadata !DIExpression()), !dbg !238

  //   %conv30 = trunc i64 %7 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !191, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !195, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !196, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !197, metadata !DIExpression()), !dbg !198
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !138
...
T0BLOCK2:
  ...
  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %8) #6, !dbg !141

  //   %9 = bitcast i64* %thr0 to i8*, !dbg !141

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %9) #6, !dbg !141
