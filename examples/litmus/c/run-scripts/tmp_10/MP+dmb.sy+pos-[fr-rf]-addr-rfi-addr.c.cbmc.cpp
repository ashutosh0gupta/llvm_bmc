...
T2BLOCK1:
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !87
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !75, metadata !DIExpression()), !dbg !94
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !88
  r5 = 0+r4*1;
  creg_r5 = creg_r4;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !108

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !88
  // ST: Guess
  iw(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l35_c3
  old_cw = cw(2,r5);
  cw(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l35_c3
  // Check
  ...
  //   %cmp24 = icmp eq i32 %conv8, 2, !dbg !105
  ...
  //   store i32 %conv25, i32* @atom_1_X3_2, align 4, !dbg !106, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !175, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !177, metadata !DIExpression()), !dbg !228

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !124
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X3_2, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
