...
T2BLOCK7:
  ...
  //   %cmp25 = icmp eq i32 %conv16, 1, !dbg !112
  ...
  //   store i32 %conv26, i32* @atom_1_X10_1, align 4, !dbg !113, !tbaa !108
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !169, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !176, metadata !DIExpression()), !dbg !227

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,0+4*1);
  cr(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l70_c13
  // Check
