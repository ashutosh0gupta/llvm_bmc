...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !133

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv17 = trunc i64 %3 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !80, metadata !DIExpression()), !dbg !103

  //   %cmp = icmp eq i32 %conv, 1, !dbg !117

  //   %conv18 = zext i1 %cmp to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !84, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !85, metadata !DIExpression()), !dbg !137

  //   %4 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !87, metadata !DIExpression()), !dbg !137

  //   store atomic i64 %4, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !119
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 1, !dbg !120

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !88, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !89, metadata !DIExpression()), !dbg !140

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %5, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv10, 2, !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !93, metadata !DIExpression()), !dbg !143

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %6, i64* @atom_1_X8_2 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv17, 0, !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !97, metadata !DIExpression()), !dbg !146

  //   %7 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %7, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !128
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !244

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !246

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !248

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !177, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !180, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !186, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !192, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !195, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !198, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !202, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !204, metadata !DIExpression()), !dbg !280

  //   %conv = trunc i64 %6 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !201, metadata !DIExpression()), !dbg !244

  //   %cmp = icmp eq i32 %conv, 2, !dbg !158

  //   %conv20 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !205, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !207, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !209, metadata !DIExpression()), !dbg !284

  //   %conv24 = trunc i64 %7 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !206, metadata !DIExpression()), !dbg !244

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !162

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !210, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !212, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !214, metadata !DIExpression()), !dbg !288

  //   %conv30 = trunc i64 %8 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !211, metadata !DIExpression()), !dbg !244

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !166

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !215, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !217, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !219, metadata !DIExpression()), !dbg !292

  //   %conv36 = trunc i64 %9 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !216, metadata !DIExpression()), !dbg !244

  //   %cmp37 = icmp eq i32 %conv36, 1, !dbg !170

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !220, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !222, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !224, metadata !DIExpression()), !dbg !296

  //   %conv42 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !221, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !226, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !228, metadata !DIExpression()), !dbg !299

  //   %conv46 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !225, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !230, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !232, metadata !DIExpression()), !dbg !302

  //   %conv50 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !229, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !234, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !236, metadata !DIExpression()), !dbg !305

  //   %conv54 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !233, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !237, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !238, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !239, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !240, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !241, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !242, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !243, metadata !DIExpression()), !dbg !244
