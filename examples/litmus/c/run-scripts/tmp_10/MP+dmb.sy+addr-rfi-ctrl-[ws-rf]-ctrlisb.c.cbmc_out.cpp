...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !89), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !73, metadata !DIExpression()), !dbg !109

  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !109

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !91
  // ST: Guess
...
T2BLOCK7:
  ...
  //   store i32 %conv20, i32* @atom_1_X5_1, align 4, !dbg !112, !tbaa !107
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !181, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_2, metadata !184, metadata !DIExpression()), !dbg !240
