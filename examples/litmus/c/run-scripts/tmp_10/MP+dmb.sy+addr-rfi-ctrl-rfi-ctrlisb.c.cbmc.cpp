...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !144, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !145, metadata !DIExpression()), !dbg !207

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !146, metadata !DIExpression()), !dbg !209

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !150, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !151, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64 0, metadata !153, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !154, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64 0, metadata !156, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !157, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64 0, metadata !159, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !163, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !167, metadata !DIExpression()), !dbg !222

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !222

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !170, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i32 0, metadata !172, metadata !DIExpression()), !dbg !224

  //   store atomic i32 0, i32* @atom_1_X8_1 monotonic, align 4, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !173, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !175, metadata !DIExpression()), !dbg !226

  //   store atomic i32 0, i32* @atom_1_X9_0 monotonic, align 4, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !177, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !179, metadata !DIExpression()), !dbg !236

  //   %conv = trunc i64 %4 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !176, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !180, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !184, metadata !DIExpression()), !dbg !240

  //   %conv22 = trunc i64 %5 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !181, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !185, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !186, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !190, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !191, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !195, metadata !DIExpression()), !dbg !207
  ...
  //   %9 = load i32, i32* @atom_1_X5_1, align 4, !dbg !157, !tbaa !155
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X8_1, align 4, !dbg !158, !tbaa !155
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %11 = load i32, i32* @atom_1_X9_0, align 4, !dbg !159, !tbaa !155
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !201, metadata !DIExpression()), !dbg !207

  //   %and38 = and i32 %8, %and37, !dbg !162
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !202, metadata !DIExpression()), !dbg !207

  //   %and39 = and i32 %conv36, %and38, !dbg !163
  creg_r21 = max(creg__r13__1_,creg_r20);
  r21 = (r13==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !203, metadata !DIExpression()), !dbg !207

  //   %and40 = and i32 %conv30, %and39, !dbg !164
  creg_r22 = max(creg__r12__1_,creg_r21);
  r22 = (r12==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !204, metadata !DIExpression()), !dbg !207

  //   %and41 = and i32 %conv24, %and40, !dbg !165
  creg_r23 = max(creg__r11__1_,creg_r22);
  r23 = (r11==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !205, metadata !DIExpression()), !dbg !207

  //   %and42 = and i32 %conv18, %and41, !dbg !166
  creg_r24 = max(creg__r10__1_,creg_r23);
  r24 = (r10==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !206, metadata !DIExpression()), !dbg !207
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !170
