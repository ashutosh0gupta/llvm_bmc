...
T2BLOCK7:
  ...
  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !121

  //   %conv19 = trunc i64 %4 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !93
  ...
  //   %cmp25 = icmp eq i32 %conv4, 2, !dbg !114
  ...
  //   store i32 %conv26, i32* @atom_1_X2_2, align 4, !dbg !115, !tbaa !110
  // ST: Guess
  ...
  //   store i32 %conv28, i32* @atom_1_X8_0, align 4, !dbg !117, !tbaa !110
  // ST: Guess
  ...
  //   store i32 %conv30, i32* @atom_1_X10_0, align 4, !dbg !119, !tbaa !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !184, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i32 0, metadata !186, metadata !DIExpression()), !dbg !229

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !187, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !231

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !116
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !190, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !233

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !118
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X2_2, align 4, !dbg !143, !tbaa !141
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X8_0, align 4, !dbg !144, !tbaa !141
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %11 = load i32, i32* @atom_1_X10_0, align 4, !dbg !145, !tbaa !141
  // LD: Guess
  old_cr = cr(0,7);
