...
T2BLOCK4:
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp16 = icmp eq i32 %conv12, 0, !dbg !98
  ...
  //   store i32 %conv17, i32* @atom_1_X7_0, align 4, !dbg !99, !tbaa !92
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !143, metadata !DIExpression()), !dbg !181
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !132
