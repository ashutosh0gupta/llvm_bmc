...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !123

  //   %conv16 = sext i32 %add to i64, !dbg !105

  //   call void @llvm.dbg.value(metadata i64 %conv16, metadata !81, metadata !DIExpression()), !dbg !123

  //   store atomic i64 %conv16, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !105
  // ST: Guess
  iw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l41_c3
  old_cw = cw(2,0);
  cw(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l41_c3
  // Check
  ...
  //   %cmp22 = icmp eq i32 %conv4, 0, !dbg !115
  ...
  //   store i32 %conv23, i32* @atom_1_X2_0, align 4, !dbg !116, !tbaa !111
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv8, 1, !dbg !117
  ...
  //   store i32 %conv25, i32* @atom_1_X4_1, align 4, !dbg !118, !tbaa !111
  // ST: Guess
