...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !88, metadata !DIExpression()), !dbg !95

  //   %add = add nsw i32 %xor, 1, !dbg !56
  creg_r3 = max(0,creg_r2);
  r3 = r2 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !89, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !92, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !93, metadata !DIExpression()), !dbg !95
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !115, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !116, metadata !DIExpression()), !dbg !148

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !117, metadata !DIExpression()), !dbg !150

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !121, metadata !DIExpression()), !dbg !152

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !122, metadata !DIExpression()), !dbg !154

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !123, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !132, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i32 0, metadata !135, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !136, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !140, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !142, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !143, metadata !DIExpression()), !dbg !148
  ...
  //   call void @llvm.dbg.value(metadata i32 %8, metadata !145, metadata !DIExpression()), !dbg !148
