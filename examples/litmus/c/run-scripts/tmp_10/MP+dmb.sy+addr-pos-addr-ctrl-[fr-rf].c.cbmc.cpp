...
T2BLOCK1:
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !78
  r3 = 0+r2*1;
  creg_r3 = creg_r2;
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !69, metadata !DIExpression()), !dbg !100

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !82
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l32_c16
  // Check
  ...
  //   %xor9 = xor i32 %conv8, %conv8, !dbg !84
  creg_r6 = creg_r5;
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor9, metadata !72, metadata !DIExpression()), !dbg !90

  //   %add11 = add nsw i32 3, %xor9, !dbg !85
  creg_r7 = max(0,creg_r6);
  r7 = 3 + r6;

  //   %idxprom12 = sext i32 %add11 to i64, !dbg !85

  //   %arrayidx13 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !85
  r8 = 0+r7*1;
  creg_r8 = creg_r7;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !74, metadata !DIExpression()), !dbg !105

  //   %3 = load atomic i64, i64* %arrayidx13 monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,r8);
  cr(2,r8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l34_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !76, metadata !DIExpression()), !dbg !105

  //   %conv16 = trunc i64 %3 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !73, metadata !DIExpression()), !dbg !90

  //   %tobool = icmp ne i32 %conv16, 0, !dbg !88
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !113
