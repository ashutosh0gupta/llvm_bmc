...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !78, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !81, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !82, metadata !DIExpression()), !dbg !103
  ...
  //   %cmp16 = icmp eq i32 %conv7, 1, !dbg !96

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !94, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !95, metadata !DIExpression()), !dbg !125
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !157, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64 0, metadata !159, metadata !DIExpression()), !dbg !207

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !182, metadata !DIExpression()), !dbg !235
