...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !41, metadata !DIExpression()), !dbg !54

  //   call void @llvm.dbg.value(metadata i64 2, metadata !44, metadata !DIExpression()), !dbg !54
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !46, metadata !DIExpression()), !dbg !57
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !70, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64 1, metadata !72, metadata !DIExpression()), !dbg !97

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !70
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !78, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !104

  //   %conv3 = sext i32 %add to i64, !dbg !77

  //   call void @llvm.dbg.value(metadata i64 %conv3, metadata !81, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !106

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !79
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !85, metadata !DIExpression()), !dbg !106

  //   %conv7 = trunc i64 %1 to i32, !dbg !80

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !82, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !87, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !89, metadata !DIExpression()), !dbg !109

  //   %conv11 = trunc i64 %2 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !86, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !90, metadata !DIExpression()), !dbg !94

  //   store i32 %conv12, i32* @atom_1_X2_1, align 4, !dbg !85, !tbaa !86
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv7, 1, !dbg !90
  creg__r4__1_ = max(0,creg_r4);

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !91, metadata !DIExpression()), !dbg !94

  //   store i32 %conv14, i32* @atom_1_X5_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv11, 1, !dbg !92
  creg__r5__1_ = max(0,creg_r5);

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !92, metadata !DIExpression()), !dbg !94

  //   store i32 %conv16, i32* @atom_1_X6_1, align 4, !dbg !93, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !139, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i32 0, metadata !142, metadata !DIExpression()), !dbg !180

  //   store atomic i32 0, i32* @atom_0_X2_0 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !143, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !146, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !149, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !151, metadata !DIExpression()), !dbg !186

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !105
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv18, 1, !dbg !123
  ...
  //   %6 = load i32, i32* @atom_0_X2_0, align 4, !dbg !124, !tbaa !125
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %8 = load i32, i32* @atom_1_X5_1, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %9 = load i32, i32* @atom_1_X6_1, align 4, !dbg !129, !tbaa !125
  // LD: Guess
  old_cr = cr(0,5);
