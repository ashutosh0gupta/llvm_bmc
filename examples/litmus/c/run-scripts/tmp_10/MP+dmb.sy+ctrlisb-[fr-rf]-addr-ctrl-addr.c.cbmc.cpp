...
T2BLOCK4:
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !94
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !73, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 3, %xor, !dbg !95
  creg_r4 = max(0,creg_r3);
  r4 = 3 + r3;

  //   %idxprom = sext i32 %add to i64, !dbg !95

  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !95
  r5 = 0+r4*1;
  creg_r5 = creg_r4;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !75, metadata !DIExpression()), !dbg !115

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(2,r5);
  cr(2,r5) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l37_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !115

  //   %conv12 = trunc i64 %3 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !94

  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !98
  creg__r6__0_ = max(0,creg_r6);

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !100
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !93), !dbg !122

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !79, metadata !DIExpression()), !dbg !123

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !105
  // LD: Guess
  old_cr = cr(2,0+4*1);
  cr(2,0+4*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l40_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !81, metadata !DIExpression()), !dbg !123

  //   %conv19 = trunc i64 %4 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !94

  //   %xor20 = xor i32 %conv19, %conv19, !dbg !107
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor20, metadata !82, metadata !DIExpression()), !dbg !94

  //   %add22 = add nsw i32 0, %xor20, !dbg !108
  creg_r9 = max(0,creg_r8);
  r9 = 0 + r8;

  //   %idxprom23 = sext i32 %add22 to i64, !dbg !108

  //   %arrayidx24 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom23, !dbg !108
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx24, metadata !84, metadata !DIExpression()), !dbg !128

  //   %5 = load atomic i64, i64* %arrayidx24 monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,r10);
  cr(2,r10) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l42_c17
  // Check
  ...
  //   %conv27 = trunc i64 %5 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !83, metadata !DIExpression()), !dbg !94

  //   %cmp = icmp eq i32 %conv, 1, !dbg !111
  creg__r0__1_ = max(0,creg_r0);

  //   %conv28 = zext i1 %cmp to i32, !dbg !111

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !87, metadata !DIExpression()), !dbg !94

  //   store i32 %conv28, i32* @atom_1_X0_1, align 4, !dbg !112, !tbaa !113
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv4, 0, !dbg !117
  creg__r1__0_ = max(0,creg_r1);

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !88, metadata !DIExpression()), !dbg !94

  //   store i32 %conv30, i32* @atom_1_X2_0, align 4, !dbg !118, !tbaa !113
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv8, 1, !dbg !119
  creg__r2__1_ = max(0,creg_r2);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !89, metadata !DIExpression()), !dbg !94

  //   store i32 %conv32, i32* @atom_1_X4_1, align 4, !dbg !120, !tbaa !113
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv27, 0, !dbg !121
  creg__r11__0_ = max(0,creg_r11);

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !90, metadata !DIExpression()), !dbg !94

  //   store i32 %conv34, i32* @atom_1_X11_0, align 4, !dbg !122, !tbaa !113
  // ST: Guess
  iw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l50_c16
  old_cw = cw(2,8);
  cw(2,8) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l50_c16
  // Check
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !145, metadata !DIExpression()), !dbg !150

  //   br label %label_3, !dbg !47
  goto T3BLOCK1;

T3BLOCK1:
  //   call void @llvm.dbg.label(metadata !149), !dbg !152

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !146, metadata !DIExpression()), !dbg !153

  //   call void @llvm.dbg.value(metadata i64 1, metadata !148, metadata !DIExpression()), !dbg !153
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !163, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !164, metadata !DIExpression()), !dbg !224

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !165, metadata !DIExpression()), !dbg !226

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !169, metadata !DIExpression()), !dbg !228

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !170, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !171, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !173, metadata !DIExpression()), !dbg !231

  //   store atomic i64 0, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !113
  // ST: Guess
  iw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l65_c3
  old_cw = cw(0,0+4*1);
  cw(0,0+4*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l65_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !174, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !176, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !177, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !183, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !185, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !186, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !190, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i32 0, metadata !192, metadata !DIExpression()), !dbg !243

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !125
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l71_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l71_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !193, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !195, metadata !DIExpression()), !dbg !245

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !127
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l72_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l72_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !196, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !198, metadata !DIExpression()), !dbg !247

  //   store atomic i32 0, i32* @atom_1_X11_0 monotonic, align 4, !dbg !129
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l73_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l73_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !200, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !202, metadata !DIExpression()), !dbg !260

  //   %conv = trunc i64 %6 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !199, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !203, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !205, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !207, metadata !DIExpression()), !dbg !264

  //   %conv26 = trunc i64 %7 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !204, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !208, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !210, metadata !DIExpression()), !dbg !268

  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !152
  // LD: Guess
  old_cr = cr(0,0+2*1);
  cr(0,0+2*1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l87_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !212, metadata !DIExpression()), !dbg !268

  //   %conv32 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !209, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !213, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !214, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !215, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !216, metadata !DIExpression()), !dbg !224

  //   %12 = load i32, i32* @atom_1_X11_0, align 4, !dbg !160, !tbaa !156
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l92_c13
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !217, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !219, metadata !DIExpression()), !dbg !224

  //   %and36 = and i32 %9, %and35, !dbg !163
  creg_r25 = max(creg_r19,creg_r24);
  r25 = r19 & r24;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !220, metadata !DIExpression()), !dbg !224

  //   %and37 = and i32 %conv34, %and36, !dbg !164
  creg_r26 = max(creg__r18__1_,creg_r25);
  r26 = (r18==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !221, metadata !DIExpression()), !dbg !224

  //   %and38 = and i32 %conv28, %and37, !dbg !165
  creg_r27 = max(creg__r17__1_,creg_r26);
  r27 = (r17==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !222, metadata !DIExpression()), !dbg !224

  //   %and39 = and i32 %conv22, %and38, !dbg !166
  creg_r28 = max(creg__r16__1_,creg_r27);
  r28 = (r16==1) & r27;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !223, metadata !DIExpression()), !dbg !224

  //   %cmp40 = icmp eq i32 %and39, 1, !dbg !167
  creg__r28__1_ = max(0,creg_r28);

  //   br i1 %cmp40, label %if.then, label %if.end, !dbg !169
  old_cctrl = cctrl[0];
  cctrl[0] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[0] >= old_cctrl);
  ASSUME(cctrl[0] >= creg__r28__1_);
  if((r28==1)) {
    goto T0BLOCK1;
  } else {
    goto T0BLOCK2;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !170
