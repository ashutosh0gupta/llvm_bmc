...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !57), !dbg !72
...
T1BLOCK7:
  //   call void @llvm.dbg.label(metadata !58), !dbg !81

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !49, metadata !DIExpression()), !dbg !82

  //   call void @llvm.dbg.value(metadata i64 1, metadata !51, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !53, metadata !DIExpression()), !dbg !85

  //   %2 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !55, metadata !DIExpression()), !dbg !85

  //   store atomic i64 %2, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !139, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !156, metadata !DIExpression()), !dbg !199
