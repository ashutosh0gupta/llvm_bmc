...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !98
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !72, metadata !DIExpression()), !dbg !107
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !88), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !79, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !83, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !84, metadata !DIExpression()), !dbg !89

  //   store i32 %conv22, i32* @atom_1_X5_2, align 4, !dbg !111, !tbaa !106
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv19, 0, !dbg !112
  creg__r7__0_ = max(0,creg_r7);

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !85, metadata !DIExpression()), !dbg !89

  //   store i32 %conv24, i32* @atom_1_X9_0, align 4, !dbg !113, !tbaa !106
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !154, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !155, metadata !DIExpression()), !dbg !207

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !156, metadata !DIExpression()), !dbg !209

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !160, metadata !DIExpression()), !dbg !211

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !161, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !162, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !165, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !168, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !171, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !174, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_2, metadata !178, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i32 0, metadata !180, metadata !DIExpression()), !dbg !224

  //   store atomic i32 0, i32* @atom_1_X5_2 monotonic, align 4, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !181, metadata !DIExpression()), !dbg !226

  //   call void @llvm.dbg.value(metadata i32 0, metadata !183, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !188, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !192, metadata !DIExpression()), !dbg !243

  //   %conv22 = trunc i64 %7 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !189, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !195, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !197, metadata !DIExpression()), !dbg !247

  //   %conv28 = trunc i64 %8 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !194, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !198, metadata !DIExpression()), !dbg !207
  ...
  //   %10 = load i32, i32* @atom_1_X5_2, align 4, !dbg !144, !tbaa !142
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !203, metadata !DIExpression()), !dbg !207

  //   %and32 = and i32 %conv30, %and31, !dbg !148
  creg_r20 = max(creg__r14__2_,creg_r19);
  r20 = (r14==2) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !204, metadata !DIExpression()), !dbg !207

  //   %and33 = and i32 %conv24, %and32, !dbg !149
  creg_r21 = max(creg__r13__1_,creg_r20);
  r21 = (r13==1) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !205, metadata !DIExpression()), !dbg !207

  //   %and34 = and i32 %conv18, %and33, !dbg !150
  creg_r22 = max(creg__r12__1_,creg_r21);
  r22 = (r12==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !206, metadata !DIExpression()), !dbg !207
