...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !94
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !85), !dbg !102
  ...
  //   %cmp14 = icmp eq i32 %conv4, 2, !dbg !97
  ...
  //   store i32 %conv15, i32* @atom_1_X3_2, align 4, !dbg !98, !tbaa !93
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 0, !dbg !99
  ...
  //   store i32 %conv17, i32* @atom_1_X4_0, align 4, !dbg !100, !tbaa !93
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_2, metadata !161, metadata !DIExpression()), !dbg !202

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !202

  //   store atomic i32 0, i32* @atom_1_X3_2 monotonic, align 4, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !164, metadata !DIExpression()), !dbg !204
  ...
  //   %9 = load i32, i32* @atom_1_X3_2, align 4, !dbg !133, !tbaa !131
  // LD: Guess
  old_cr = cr(0,3);
