...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !59, metadata !DIExpression()), !dbg !98
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !60, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64 2, metadata !62, metadata !DIExpression()), !dbg !101

  //   store atomic i64 2, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !83
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !103

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !85
  // LD: Guess
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !67, metadata !DIExpression()), !dbg !103

  //   %conv = trunc i64 %0 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !63, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !106

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !68, metadata !DIExpression()), !dbg !98
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !116

  //   %2 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !72, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !119

  //   %3 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !98

  //   %cmp = icmp eq i32 %conv, 2, !dbg !103

  //   %conv13 = zext i1 %cmp to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !80, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !81, metadata !DIExpression()), !dbg !123

  //   %4 = zext i32 %conv13 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !123

  //   store atomic i64 %4, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !105
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !85, metadata !DIExpression()), !dbg !126

  //   %5 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !87, metadata !DIExpression()), !dbg !126

  //   store atomic i64 %5, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !108
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv8, 0, !dbg !109

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !88, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !89, metadata !DIExpression()), !dbg !129

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %6, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !111
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv12, 1, !dbg !112

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !92, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !93, metadata !DIExpression()), !dbg !132

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %7, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !114
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !155, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !156, metadata !DIExpression()), !dbg !212

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !157, metadata !DIExpression()), !dbg !214

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !161, metadata !DIExpression()), !dbg !216

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !162, metadata !DIExpression()), !dbg !218

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !163, metadata !DIExpression()), !dbg !219
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !166, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !169, metadata !DIExpression()), !dbg !223

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !223

  //   store atomic i64 0, i64* @atom_1_X2_2 monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !172, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !225

  //   store atomic i64 0, i64* @atom_1_X3_2 monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !175, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !227

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !178, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !182, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !184, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !185, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !189, metadata !DIExpression()), !dbg !248

  //   %conv20 = trunc i64 %7 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !186, metadata !DIExpression()), !dbg !212

  //   %cmp21 = icmp eq i32 %conv20, 2, !dbg !140

  //   %conv22 = zext i1 %cmp21 to i32, !dbg !140

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !190, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !194, metadata !DIExpression()), !dbg !252

  //   %conv26 = trunc i64 %8 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !191, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !196, metadata !DIExpression()), !dbg !255

  //   %9 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !145
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !198, metadata !DIExpression()), !dbg !255

  //   %conv30 = trunc i64 %9 to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !195, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !200, metadata !DIExpression()), !dbg !258

  //   %10 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !202, metadata !DIExpression()), !dbg !258

  //   %conv34 = trunc i64 %10 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !199, metadata !DIExpression()), !dbg !212

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !204, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !206, metadata !DIExpression()), !dbg !261

  //   %conv38 = trunc i64 %11 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !203, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !208, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !209, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %and41, metadata !210, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !211, metadata !DIExpression()), !dbg !212
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !161
