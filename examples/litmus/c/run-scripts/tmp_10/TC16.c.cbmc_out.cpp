...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([1 x i64], [1 x i64]* @vars, i64 0, i64 0), metadata !99, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_2, metadata !102, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i32 0, metadata !105, metadata !DIExpression()), !dbg !119

  //   store atomic i32 0, i32* @atom_0_X0_2 monotonic, align 4, !dbg !68
  // ST: Guess
  iw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l41_c3
  old_cw = cw(0,1);
  cw(0,1) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l41_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !106, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i32 0, metadata !108, metadata !DIExpression()), !dbg !121

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !70
  // ST: Guess
  ...
  //   %4 = load i32, i32* @atom_0_X0_2, align 4, !dbg !81, !tbaa !82
  // LD: Guess
  old_cr = cr(0,1);
  ...
  //   %5 = load i32, i32* @atom_1_X0_1, align 4, !dbg !84, !tbaa !82
  // LD: Guess
  old_cr = cr(0,2);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([89 x i8], [89 x i8]* @.str.1, i64 0, i64 0), i32 noundef 53, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !89
