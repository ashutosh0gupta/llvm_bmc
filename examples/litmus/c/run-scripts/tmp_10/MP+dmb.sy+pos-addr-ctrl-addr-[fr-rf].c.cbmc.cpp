...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !104), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !78, metadata !DIExpression()), !dbg !105
  ...
  //   %arrayidx17 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !109
  r9 = 0+r8*1;
  ASSUME(creg_r9 >= 0);
  ASSUME(creg_r9 >= creg_r8);
  ASSUME(active[creg_r9] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !80, metadata !DIExpression()), !dbg !129
  ...
  //   %conv24 = trunc i64 %5 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !83, metadata !DIExpression()), !dbg !105

  //   %cmp = icmp eq i32 %conv, 1, !dbg !115

  //   %conv25 = zext i1 %cmp to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !87, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !135

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !117
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv4, 1, !dbg !118

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !91, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !92, metadata !DIExpression()), !dbg !138

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %7, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !120
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv20, 0, !dbg !121

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !95, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !96, metadata !DIExpression()), !dbg !141

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %8, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !123
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv24, 1, !dbg !124

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !99, metadata !DIExpression()), !dbg !105

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !100, metadata !DIExpression()), !dbg !144

  //   %9 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %9, i64* @atom_1_X11_1 seq_cst, align 8, !dbg !126
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !150, metadata !DIExpression()), !dbg !157
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !190, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !193, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !249

  //   store atomic i64 0, i64* @atom_1_X9_0 monotonic, align 8, !dbg !127
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !196, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !251

  //   store atomic i64 0, i64* @atom_1_X11_1 monotonic, align 8, !dbg !129
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !200, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !202, metadata !DIExpression()), !dbg !266

  //   %conv = trunc i64 %6 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !199, metadata !DIExpression()), !dbg !230

  //   %cmp = icmp eq i32 %conv, 2, !dbg !146

  //   %conv20 = zext i1 %cmp to i32, !dbg !146

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !203, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !205, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !207, metadata !DIExpression()), !dbg !270

  //   %conv24 = trunc i64 %7 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !204, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !212, metadata !DIExpression()), !dbg !274

  //   %conv30 = trunc i64 %8 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !209, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !214, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !216, metadata !DIExpression()), !dbg !277

  //   %conv34 = trunc i64 %9 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !213, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !218, metadata !DIExpression()), !dbg !280

  //   %10 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !158
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !220, metadata !DIExpression()), !dbg !280

  //   %conv38 = trunc i64 %10 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !217, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !222, metadata !DIExpression()), !dbg !283

  //   %11 = load atomic i64, i64* @atom_1_X11_1 seq_cst, align 8, !dbg !161
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !224, metadata !DIExpression()), !dbg !283

  //   %conv42 = trunc i64 %11 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !221, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !226, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !227, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !228, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !229, metadata !DIExpression()), !dbg !230
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 92, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
