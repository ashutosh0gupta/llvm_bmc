...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !59, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64 2, metadata !61, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !63, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !65, metadata !DIExpression()), !dbg !87

  //   %conv = trunc i64 %0 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !62, metadata !DIExpression()), !dbg !82

  //   %xor = xor i32 %conv, %conv, !dbg !71
  creg_r1 = creg_r0;
  r1 = r0 ^ r0;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !66, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !68, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !82

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !71, metadata !DIExpression()), !dbg !94
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !74, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !78, metadata !DIExpression()), !dbg !82

  //   store i32 %conv11, i32* @atom_1_X2_2, align 4, !dbg !81, !tbaa !82
  // ST: Guess
  ...
  //   %cmp12 = icmp eq i32 %conv4, 0, !dbg !86
  creg__r4__0_ = max(0,creg_r4);

  //   %conv13 = zext i1 %cmp12 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !79, metadata !DIExpression()), !dbg !82

  //   store i32 %conv13, i32* @atom_1_X4_0, align 4, !dbg !87, !tbaa !82
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv10, 1, !dbg !88
  creg__r5__1_ = max(0,creg_r5);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !80, metadata !DIExpression()), !dbg !82

  //   store i32 %conv15, i32* @atom_1_X7_1, align 4, !dbg !89, !tbaa !82
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !130, metadata !DIExpression()), !dbg !166

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !166

  //   store atomic i32 0, i32* @atom_1_X2_2 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !134, metadata !DIExpression()), !dbg !168
  ...
  //   %6 = load i32, i32* @atom_1_X2_2, align 4, !dbg !115, !tbaa !116
  // LD: Guess
  old_cr = cr(0,2);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([110 x i8], [110 x i8]* @.str.1, i64 0, i64 0), i32 noundef 71, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !127
