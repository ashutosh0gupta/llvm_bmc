...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !55
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !46, metadata !DIExpression()), !dbg !59

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !48, metadata !DIExpression()), !dbg !59

  //   store atomic i64 %1, i64* @atom_0_X2_0 seq_cst, align 8, !dbg !60
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !65, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !73, metadata !DIExpression()), !dbg !86
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !109, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !112, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !116, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !120, metadata !DIExpression()), !dbg !150
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([93 x i8], [93 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !101
