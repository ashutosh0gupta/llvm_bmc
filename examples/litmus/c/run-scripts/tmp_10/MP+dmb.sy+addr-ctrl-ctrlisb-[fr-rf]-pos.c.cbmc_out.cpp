...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !91), !dbg !108

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !109

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !91
  // LD: Guess
  old_cr = cr(2,0+3*1);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !74, metadata !DIExpression()), !dbg !93
  ...
  //   %cmp25 = icmp eq i32 %conv15, 0, !dbg !115
  ...
  //   store i32 %conv26, i32* @atom_1_X7_0, align 4, !dbg !116, !tbaa !111
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv19, 1, !dbg !117
  ...
  //   store i32 %conv28, i32* @atom_1_X9_1, align 4, !dbg !118, !tbaa !111
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_0, metadata !185, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !188, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !232

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !116
  // ST: Guess
  ...
  //   %9 = load i32, i32* @atom_1_X7_0, align 4, !dbg !143, !tbaa !141
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X9_1, align 4, !dbg !144, !tbaa !141
  // LD: Guess
  old_cr = cr(0,6);
