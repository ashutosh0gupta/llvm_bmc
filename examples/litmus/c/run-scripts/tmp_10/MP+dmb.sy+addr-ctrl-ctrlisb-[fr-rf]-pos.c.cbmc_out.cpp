...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !103), !dbg !120

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !71, metadata !DIExpression()), !dbg !121

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !73, metadata !DIExpression()), !dbg !121
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !74, metadata !DIExpression()), !dbg !105
  ...
  //   %cmp26 = icmp eq i32 %conv15, 0, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !91, metadata !DIExpression()), !dbg !144

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !93, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !126
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv19, 1, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !95, metadata !DIExpression()), !dbg !147

  //   %8 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !97, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %8, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !129
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !196, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !253

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !199, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !220, metadata !DIExpression()), !dbg !283

  //   %9 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !155
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !224, metadata !DIExpression()), !dbg !286

  //   %10 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !158
  // LD: Guess
  old_cr = cr(0,6);
