...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !90, metadata !DIExpression()), !dbg !101
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !94, metadata !DIExpression()), !dbg !104

  //   %conv = trunc i64 %0 to i32, !dbg !55

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !91, metadata !DIExpression()), !dbg !101

  //   %xor = xor i32 %conv, %conv, !dbg !56
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !95, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !96, metadata !DIExpression()), !dbg !109
  ...
  // ST: Guess
  iw(3,r5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l42_c3
  old_cw = cw(3,r5);
  cw(3,r5) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l42_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !137, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !141, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !144, metadata !DIExpression()), !dbg !169
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
