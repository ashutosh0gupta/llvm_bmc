...
T2BLOCK10:
  ...
  //   %cmp29 = icmp eq i32 %conv11, 0, !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !92, metadata !DIExpression()), !dbg !155

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %7, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !137
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv15, 1, !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !96, metadata !DIExpression()), !dbg !158

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !158

  //   store atomic i64 %8, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !140
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv19, 1, !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !100, metadata !DIExpression()), !dbg !161

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !161

  //   store atomic i64 %9, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !143
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !170, metadata !DIExpression()), !dbg !177
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !210, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !213, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !216, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !223, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !228, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !233, metadata !DIExpression()), !dbg !310
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !242, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !246, metadata !DIExpression()), !dbg !320
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !250, metadata !DIExpression()), !dbg !323
