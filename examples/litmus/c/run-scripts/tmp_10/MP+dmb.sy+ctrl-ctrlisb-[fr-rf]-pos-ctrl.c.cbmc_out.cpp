...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !133

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !115
  // LD: Guess
  old_cr = cr(2,0);
  cr(2,0) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l43_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !133
  ...
  // ST: Guess
  iw(2,4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l45_c15
  old_cw = cw(2,4);
  cw(2,4) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l45_c15
  // Check
  ...
  //   %cmp32 = icmp eq i32 %conv19, 1, !dbg !127
  ...
  //   store i32 %conv33, i32* @atom_1_X7_1, align 4, !dbg !128, !tbaa !119
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv26, 0, !dbg !129
  creg__r5__0_ = max(0,creg_r5);

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !91, metadata !DIExpression()), !dbg !96

  //   store i32 %conv35, i32* @atom_1_X8_0, align 4, !dbg !130, !tbaa !119
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !154, metadata !DIExpression()), !dbg !161
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !171, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !172, metadata !DIExpression()), !dbg !234

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !173, metadata !DIExpression()), !dbg !236

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !177, metadata !DIExpression()), !dbg !238

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !178, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !179, metadata !DIExpression()), !dbg !241

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !182, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !185, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !188, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !191, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i32 0, metadata !194, metadata !DIExpression()), !dbg !249

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !125
  // ST: Guess
  iw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l72_c3
  old_cw = cw(0,4);
  cw(0,4) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l72_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !195, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !197, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !198, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i32 0, metadata !200, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !201, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i32 0, metadata !203, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !204, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i32 0, metadata !206, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !208, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !210, metadata !DIExpression()), !dbg !270

  //   %conv = trunc i64 %6 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !207, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !211, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !213, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !215, metadata !DIExpression()), !dbg !274

  //   %conv26 = trunc i64 %7 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !212, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !216, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !218, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !220, metadata !DIExpression()), !dbg !278

  //   %conv32 = trunc i64 %8 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !217, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !221, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !222, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !223, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !224, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !225, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !226, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !228, metadata !DIExpression()), !dbg !234

  //   %and36 = and i32 %10, %and35, !dbg !168
  creg_r20 = max(creg_r14,creg_r19);
  r20 = r14 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !229, metadata !DIExpression()), !dbg !234

  //   %and37 = and i32 %9, %and36, !dbg !169
  creg_r21 = max(creg_r13,creg_r20);
  r21 = r13 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !230, metadata !DIExpression()), !dbg !234

  //   %and38 = and i32 %conv34, %and37, !dbg !170
  creg_r22 = max(creg__r12__1_,creg_r21);
  r22 = (r12==1) & r21;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !231, metadata !DIExpression()), !dbg !234

  //   %and39 = and i32 %conv28, %and38, !dbg !171
  creg_r23 = max(creg__r11__1_,creg_r22);
  r23 = (r11==1) & r22;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !232, metadata !DIExpression()), !dbg !234

  //   %and40 = and i32 %conv22, %and39, !dbg !172
  creg_r24 = max(creg__r10__1_,creg_r23);
  r24 = (r10==1) & r23;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !233, metadata !DIExpression()), !dbg !234
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 104, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !176
