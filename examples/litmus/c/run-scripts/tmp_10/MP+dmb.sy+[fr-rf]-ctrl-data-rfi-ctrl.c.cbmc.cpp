...
T2BLOCK4:
  ...
  //   %add = add nsw i32 %xor, 1, !dbg !105
  creg_r4 = max(creg_r3,0);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !74, metadata !DIExpression()), !dbg !105
  ...
  //   %conv9 = sext i32 %add to i64, !dbg !107

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !77, metadata !DIExpression()), !dbg !125

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !107
  // ST: Guess
...
T2BLOCK7:
  ...
  //   %cmp25 = icmp eq i32 %conv4, 2, !dbg !123
  ...
  //   store atomic i64 %6, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv13, 1, !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !95, metadata !DIExpression()), !dbg !146

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %7, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !128
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv20, 0, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !99, metadata !DIExpression()), !dbg !149

  //   %8 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %8, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !131
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !195, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !198, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !201, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !224, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !228, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !232, metadata !DIExpression()), !dbg !298
