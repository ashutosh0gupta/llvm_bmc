...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !164, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !214

  //   store atomic i32 0, i32* @atom_1_X8_0 monotonic, align 4, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !167, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i32 0, metadata !169, metadata !DIExpression()), !dbg !216

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !125
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X8_0, align 4, !dbg !153, !tbaa !149
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %11 = load i32, i32* @atom_1_X10_0, align 4, !dbg !154, !tbaa !149
  // LD: Guess
  old_cr = cr(0,7);
