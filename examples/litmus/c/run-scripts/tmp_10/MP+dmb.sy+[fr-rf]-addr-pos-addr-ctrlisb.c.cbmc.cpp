...
T3BLOCK1:
  ...
  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !47
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !159, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !160, metadata !DIExpression()), !dbg !214

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !161, metadata !DIExpression()), !dbg !216

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !165, metadata !DIExpression()), !dbg !218

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !166, metadata !DIExpression()), !dbg !220

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !167, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !170, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !173, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !176, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !179, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !182, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !231

  //   store atomic i64 0, i64* @atom_1_X2_2 monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !185, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !191, metadata !DIExpression()), !dbg !248

  //   %conv = trunc i64 %6 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !188, metadata !DIExpression()), !dbg !214

  //   %cmp = icmp eq i32 %conv, 1, !dbg !134

  //   %conv18 = zext i1 %cmp to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !192, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !252

  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !136
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !196, metadata !DIExpression()), !dbg !252

  //   %conv22 = trunc i64 %7 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !193, metadata !DIExpression()), !dbg !214

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !138

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !197, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !201, metadata !DIExpression()), !dbg !256

  //   %conv28 = trunc i64 %8 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !198, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !203, metadata !DIExpression()), !dbg !259

  //   %9 = load atomic i64, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !143
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !205, metadata !DIExpression()), !dbg !259

  //   %conv32 = trunc i64 %9 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !202, metadata !DIExpression()), !dbg !214

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !207, metadata !DIExpression()), !dbg !262

  //   %10 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !146
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !209, metadata !DIExpression()), !dbg !262
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 87, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155
