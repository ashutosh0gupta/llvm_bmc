...
T2BLOCK1:
  ...
  //   %arrayidx = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom, !dbg !79
  r3 = 0+r2*1;
  creg_r3 = creg_r2;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !65, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !67, metadata !DIExpression()), !dbg !99

  //   %conv4 = trunc i64 %1 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !91

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !82
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !68, metadata !DIExpression()), !dbg !91

  //   %add6 = add nsw i32 %xor5, 1, !dbg !83
  creg_r6 = max(0,creg_r5);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !69, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !70, metadata !DIExpression()), !dbg !103

  //   %conv7 = sext i32 %add6 to i64, !dbg !85

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !72, metadata !DIExpression()), !dbg !103

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !85
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !105

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !87
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !76, metadata !DIExpression()), !dbg !105

  //   %conv11 = trunc i64 %2 to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !73, metadata !DIExpression()), !dbg !91

  //   %xor12 = xor i32 %conv11, %conv11, !dbg !89
  creg_r8 = creg_r7;
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !77, metadata !DIExpression()), !dbg !91

  //   %add14 = add nsw i32 4, %xor12, !dbg !90
  creg_r9 = max(0,creg_r8);
  r9 = 4 + r8;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !90

  //   %arrayidx16 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !90
  r10 = 0+r9*1;
  creg_r10 = creg_r9;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !79, metadata !DIExpression()), !dbg !110

  //   %3 = load atomic i64, i64* %arrayidx16 monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,r10);
  cr(2,r10) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l37_c16
  // Check
  ...
  //   %conv19 = trunc i64 %3 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !91

  //   %tobool = icmp ne i32 %conv19, 0, !dbg !93
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !119

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv23 = trunc i64 %4 to i32, !dbg !102
  ...
  //   %conv24 = zext i1 %cmp to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !86, metadata !DIExpression()), !dbg !91

  //   store i32 %conv24, i32* @atom_1_X0_1, align 4, !dbg !104, !tbaa !105
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv11, 2, !dbg !109
  ...
  //   store i32 %conv26, i32* @atom_1_X7_2, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv23, 0, !dbg !111
  ...
  //   store i32 %conv28, i32* @atom_1_X11_0, align 4, !dbg !112, !tbaa !105
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !136, metadata !DIExpression()), !dbg !143
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !153, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !154, metadata !DIExpression()), !dbg !209

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !155, metadata !DIExpression()), !dbg !211

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !159, metadata !DIExpression()), !dbg !213

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !160, metadata !DIExpression()), !dbg !215

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !161, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !164, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !167, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !170, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !173, metadata !DIExpression()), !dbg !224

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !176, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_2, metadata !180, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i32 0, metadata !182, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X11_0, metadata !183, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i32 0, metadata !185, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !186, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !190, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !191, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !195, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !196, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !200, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !201, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !202, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !203, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !205, metadata !DIExpression()), !dbg !209

  //   %and34 = and i32 %conv32, %and33, !dbg !153
  creg_r25 = max(creg__r19__1_,creg_r24);
  r25 = (r19==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !206, metadata !DIExpression()), !dbg !209

  //   %and35 = and i32 %conv26, %and34, !dbg !154
  creg_r26 = max(creg__r18__1_,creg_r25);
  r26 = (r18==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !207, metadata !DIExpression()), !dbg !209

  //   %and36 = and i32 %conv20, %and35, !dbg !155
  creg_r27 = max(creg__r17__2_,creg_r26);
  r27 = (r17==2) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !208, metadata !DIExpression()), !dbg !209
