...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !65, metadata !DIExpression()), !dbg !108

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !67, metadata !DIExpression()), !dbg !108

  //   %conv4 = trunc i64 %1 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !64, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !68, metadata !DIExpression()), !dbg !100

  //   %add6 = add nsw i32 %xor5, 1, !dbg !92
  creg_r6 = max(creg_r5,0);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !69, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !70, metadata !DIExpression()), !dbg !112

  //   %conv7 = sext i32 %add6 to i64, !dbg !94

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !72, metadata !DIExpression()), !dbg !112

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !74, metadata !DIExpression()), !dbg !114

  //   %2 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !96
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   %xor12 = xor i32 %conv11, %conv11, !dbg !98
  creg_r8 = max(creg_r7,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !77, metadata !DIExpression()), !dbg !100

  //   %add14 = add nsw i32 4, %xor12, !dbg !99
  creg_r9 = max(0,creg_r8);
  ASSUME(active[creg_r9] == 2);
  r9 = 4 + r8;

  //   %idxprom15 = sext i32 %add14 to i64, !dbg !99

  //   %arrayidx16 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom15, !dbg !99
  r10 = 0+r9*1;
  ASSUME(creg_r10 >= 0);
  ASSUME(creg_r10 >= creg_r9);
  ASSUME(active[creg_r10] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !79, metadata !DIExpression()), !dbg !119

  //   %3 = load atomic i64, i64* %arrayidx16 monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,r10);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !81, metadata !DIExpression()), !dbg !119

  //   %conv19 = trunc i64 %3 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !78, metadata !DIExpression()), !dbg !100

  //   %tobool = icmp ne i32 %conv19, 0, !dbg !102

  //   br i1 %tobool, label %if.then, label %if.else, !dbg !104
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
  ASSUME(cctrl[2] >= creg_r11);
  ASSUME(cctrl[2] >= 0);
  if((r11!=0)) {
    goto T2BLOCK2;
  } else {
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !99), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !128

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !110
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv23 = trunc i64 %4 to i32, !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !87, metadata !DIExpression()), !dbg !132

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !132
  ...
  //   %cmp28 = icmp eq i32 %conv11, 2, !dbg !115

  //   %conv29 = zext i1 %cmp28 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !90, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !91, metadata !DIExpression()), !dbg !135

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %6, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !117
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv23, 0, !dbg !118

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !94, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !95, metadata !DIExpression()), !dbg !138

  //   %7 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %7, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !120
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !144, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i64 2, metadata !146, metadata !DIExpression()), !dbg !151

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !47
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !161, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !162, metadata !DIExpression()), !dbg !225

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !107

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !107

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !163, metadata !DIExpression()), !dbg !227

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !109

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !109

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !167, metadata !DIExpression()), !dbg !229

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !168, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !169, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !172, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !174, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !175, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64 0, metadata !177, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !178, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i64 0, metadata !180, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !181, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !184, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !187, metadata !DIExpression()), !dbg !244

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !244

  //   store atomic i64 0, i64* @atom_1_X7_2 monotonic, align 8, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !190, metadata !DIExpression()), !dbg !246

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !194, metadata !DIExpression()), !dbg !261

  //   %6 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) seq_cst, align 8, !dbg !143
  // LD: Guess
  old_cr = cr(0,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !196, metadata !DIExpression()), !dbg !261

  //   %conv = trunc i64 %6 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !193, metadata !DIExpression()), !dbg !225

  //   %cmp = icmp eq i32 %conv, 2, !dbg !145

  //   %conv20 = zext i1 %cmp to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !197, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !199, metadata !DIExpression()), !dbg !265

  //   %7 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !201, metadata !DIExpression()), !dbg !265

  //   %conv24 = trunc i64 %7 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !198, metadata !DIExpression()), !dbg !225

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !149

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !202, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !204, metadata !DIExpression()), !dbg !269

  //   %8 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !151
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !206, metadata !DIExpression()), !dbg !269

  //   %conv30 = trunc i64 %8 to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !203, metadata !DIExpression()), !dbg !225

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !153

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !207, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !209, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !211, metadata !DIExpression()), !dbg !273

  //   %conv36 = trunc i64 %9 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !208, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !213, metadata !DIExpression()), !dbg !276

  //   %10 = load atomic i64, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !158
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !215, metadata !DIExpression()), !dbg !276

  //   %conv40 = trunc i64 %10 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !212, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !217, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !219, metadata !DIExpression()), !dbg !279

  //   %conv44 = trunc i64 %11 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !216, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !221, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !222, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %and47, metadata !223, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %and48, metadata !224, metadata !DIExpression()), !dbg !225
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([125 x i8], [125 x i8]* @.str.1, i64 0, i64 0), i32 noundef 93, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !171
