...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !113, metadata !DIExpression()), !dbg !125
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !115, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !117, metadata !DIExpression()), !dbg !128

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !114, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !119, metadata !DIExpression()), !dbg !132

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(4,0+4*1);
  cr(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l52_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !121, metadata !DIExpression()), !dbg !132

  //   %conv4 = trunc i64 %1 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !118, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !122, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !123, metadata !DIExpression()), !dbg !125
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !143, metadata !DIExpression()), !dbg !155
  ...
  // ST: Guess
  iw(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l62_c3
  old_cw = cw(5,0+4*1);
  cw(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l62_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !147, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !146, metadata !DIExpression()), !dbg !152
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X2_0, metadata !196, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X1_0, metadata !200, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !203, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !206, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !209, metadata !DIExpression()), !dbg !250
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 109, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
