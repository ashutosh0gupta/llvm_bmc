...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !120, metadata !DIExpression()), !dbg !133
  ...
  // LD: Guess
  old_cr = cr(4,0+4*1);
  cr(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l54_c16
  // Check
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !147, metadata !DIExpression()), !dbg !155
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !148, metadata !DIExpression()), !dbg !158
  ...
  // ST: Guess
  iw(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l64_c3
  old_cw = cw(5,0+4*1);
  cw(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l64_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !151, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 1, metadata !153, metadata !DIExpression()), !dbg !161

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !58
  // ST: Guess
  iw(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l66_c3
  old_cw = cw(5,0+1*1);
  cw(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l66_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !200, metadata !DIExpression()), !dbg !244
