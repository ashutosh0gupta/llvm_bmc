...
T2BLOCK1:
  ...
  //   %xor13 = xor i32 %conv12, %conv12, !dbg !87
  creg_r9 = creg_r8;
  r9 = r8 ^ r8;

  //   call void @llvm.dbg.value(metadata i32 %xor13, metadata !76, metadata !DIExpression()), !dbg !90

  //   %add15 = add nsw i32 4, %xor13, !dbg !88
  creg_r10 = max(0,creg_r9);
  r10 = 4 + r9;

  //   %idxprom16 = sext i32 %add15 to i64, !dbg !88

  //   %arrayidx17 = getelementptr inbounds [5 x i64], [5 x i64]* @vars, i64 0, i64 %idxprom16, !dbg !88
  r11 = 0+r10*1;
  creg_r11 = creg_r10;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx17, metadata !78, metadata !DIExpression()), !dbg !108

  //   %3 = load atomic i64, i64* %arrayidx17 monotonic, align 8, !dbg !88
  // LD: Guess
  old_cr = cr(2,r11);
  cr(2,r11) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l36_c17
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !108

  //   %conv20 = trunc i64 %3 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !77, metadata !DIExpression()), !dbg !90

  //   %tobool = icmp ne i32 %conv20, 0, !dbg !91
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !89), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !82, metadata !DIExpression()), !dbg !116

  //   %4 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !116
