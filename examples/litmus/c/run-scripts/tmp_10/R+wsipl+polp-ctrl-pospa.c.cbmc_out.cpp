...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !140, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i32 0, metadata !142, metadata !DIExpression()), !dbg !168

  //   store atomic i32 0, i32* @atom_1_X4_0 monotonic, align 4, !dbg !88
  // ST: Guess
  ...
  //   %6 = load i32, i32* @atom_1_X4_0, align 4, !dbg !108, !tbaa !106
  // LD: Guess
  old_cr = cr(0,3);
