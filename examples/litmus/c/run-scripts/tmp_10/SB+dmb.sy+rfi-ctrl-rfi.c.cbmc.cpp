...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !67, metadata !DIExpression()), !dbg !86
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !68, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !74, metadata !DIExpression()), !dbg !91
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !78, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !82, metadata !DIExpression()), !dbg !86

  //   store i32 %conv7, i32* @atom_1_X2_1, align 4, !dbg !78, !tbaa !79
  // ST: Guess
  ...
  //   %cmp8 = icmp eq i32 %conv6, 1, !dbg !83
  creg__r2__1_ = max(0,creg_r2);

  //   %conv9 = zext i1 %cmp8 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !83, metadata !DIExpression()), !dbg !86

  //   store i32 %conv9, i32* @atom_1_X5_1, align 4, !dbg !84, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !134, metadata !DIExpression()), !dbg !168

  //   call void @llvm.dbg.value(metadata i32 0, metadata !136, metadata !DIExpression()), !dbg !168

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !137, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i32 0, metadata !139, metadata !DIExpression()), !dbg !170

  //   store atomic i32 0, i32* @atom_1_X5_1 monotonic, align 4, !dbg !96
  // ST: Guess
  ...
  //   %7 = load i32, i32* @atom_1_X2_1, align 4, !dbg !118, !tbaa !116
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %8 = load i32, i32* @atom_1_X5_1, align 4, !dbg !119, !tbaa !116
  // LD: Guess
  old_cr = cr(0,4);
