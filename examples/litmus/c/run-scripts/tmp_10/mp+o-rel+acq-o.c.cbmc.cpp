...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 4, metadata !43, metadata !DIExpression()), !dbg !50

  //   store atomic i64 4, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !51
  // ST: Guess
  //   : Release
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !57, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !61, metadata !DIExpression()), !dbg !73
  ...
  //   store i32 %conv5, i32* @atom_1_X0_4, align 4, !dbg !59, !tbaa !60
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv4, 1, !dbg !64
  ...
  //   store i32 %conv7, i32* @atom_1_X2_1, align 4, !dbg !65, !tbaa !60
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !92, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !93, metadata !DIExpression()), !dbg !115

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !64

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !64

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !94, metadata !DIExpression()), !dbg !117

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !66

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !66

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !98, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !101, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_4, metadata !105, metadata !DIExpression()), !dbg !124

  //   call void @llvm.dbg.value(metadata i32 0, metadata !108, metadata !DIExpression()), !dbg !124

  //   store atomic i32 0, i32* @atom_1_X0_4 monotonic, align 4, !dbg !73
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !109, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i32 0, metadata !111, metadata !DIExpression()), !dbg !126

  //   store atomic i32 0, i32* @atom_1_X2_1 monotonic, align 4, !dbg !75
  // ST: Guess
  iw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l43_c3
  old_cw = cw(0,3);
  cw(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l43_c3
  // Check
  ...
  //   %4 = load i32, i32* @atom_1_X0_4, align 4, !dbg !86, !tbaa !87
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %5 = load i32, i32* @atom_1_X2_1, align 4, !dbg !89, !tbaa !87
  // LD: Guess
  old_cr = cr(0,3);
  cr(0,3) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l52_c12
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !113, metadata !DIExpression()), !dbg !115

  //   %and = and i32 %4, %5, !dbg !90
  creg_r7 = max(creg_r5,creg_r6);
  r7 = r5 & r6;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !114, metadata !DIExpression()), !dbg !115
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !94
