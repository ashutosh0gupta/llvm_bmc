...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 4, metadata !42, metadata !DIExpression()), !dbg !49

  //   store atomic i64 4, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !50
  // ST: Guess
  //   : Release
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !59, metadata !DIExpression()), !dbg !76

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !55, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !61, metadata !DIExpression()), !dbg !79
  ...
  //   %cmp = icmp eq i32 %conv, 4, !dbg !64

  //   %conv5 = zext i1 %cmp to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !64, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_4, metadata !65, metadata !DIExpression()), !dbg !83

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !67, metadata !DIExpression()), !dbg !83

  //   store atomic i64 %2, i64* @atom_1_X0_4 seq_cst, align 8, !dbg !66
  // ST: Guess
  ...
  //   %cmp7 = icmp eq i32 %conv4, 1, !dbg !67

  //   %conv8 = zext i1 %cmp7 to i32, !dbg !67

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !68, metadata !DIExpression()), !dbg !73

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !69, metadata !DIExpression()), !dbg !86

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !71, metadata !DIExpression()), !dbg !86

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !69
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !108, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_4, metadata !109, metadata !DIExpression()), !dbg !133

  //   call void @llvm.dbg.value(metadata i64 0, metadata !111, metadata !DIExpression()), !dbg !133

  //   store atomic i64 0, i64* @atom_1_X0_4 monotonic, align 8, !dbg !78
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !112, metadata !DIExpression()), !dbg !135

  //   call void @llvm.dbg.value(metadata i64 0, metadata !114, metadata !DIExpression()), !dbg !135

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_4, metadata !116, metadata !DIExpression()), !dbg !147

  //   %4 = load atomic i64, i64* @atom_1_X0_4 seq_cst, align 8, !dbg !92
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !120, metadata !DIExpression()), !dbg !150

  //   %5 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !95
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([99 x i8], [99 x i8]* @.str.1, i64 0, i64 0), i32 noundef 54, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !101
