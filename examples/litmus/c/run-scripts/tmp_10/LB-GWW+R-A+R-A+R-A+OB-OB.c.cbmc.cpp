...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !118, metadata !DIExpression()), !dbg !130

  //   call void @llvm.dbg.value(metadata i64 1, metadata !120, metadata !DIExpression()), !dbg !130
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !137, metadata !DIExpression()), !dbg !147
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !139, metadata !DIExpression()), !dbg !150
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !141, metadata !DIExpression()), !dbg !150

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !138, metadata !DIExpression()), !dbg !147
  ...
  // ST: Guess
  iw(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l61_c3
  old_cw = cw(5,0+5*1);
  cw(5,0+5*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l61_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !145, metadata !DIExpression()), !dbg !147
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !161, metadata !DIExpression()), !dbg !173
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !163, metadata !DIExpression()), !dbg !176

  //   %0 = load atomic i64, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5) monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(6,0+5*1);
  cr(6,0+5*1) = get_rng(0,NCONTEXT-1);// 6 ASSIGN LDCOM _l69_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !165, metadata !DIExpression()), !dbg !176

  //   %conv = trunc i64 %0 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !162, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !167, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !169, metadata !DIExpression()), !dbg !180

  //   %conv4 = trunc i64 %1 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !166, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !170, metadata !DIExpression()), !dbg !173

  //   store i32 %conv5, i32* @atom_5_X0_1, align 4, !dbg !68, !tbaa !69
  // ST: Guess
  iw(6,10) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l73_c15
  old_cw = cw(6,10);
  cw(6,10) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l73_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !171, metadata !DIExpression()), !dbg !173

  //   store i32 %conv7, i32* @atom_5_X2_0, align 4, !dbg !74, !tbaa !69
  // ST: Guess
  iw(6,11) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STIW _l75_c15
  old_cw = cw(6,11);
  cw(6,11) = get_rng(0,NCONTEXT-1);// 6 ASSIGN STCOM _l75_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !195, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !196, metadata !DIExpression()), !dbg !254

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !197, metadata !DIExpression()), !dbg !256

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !201, metadata !DIExpression()), !dbg !258

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !202, metadata !DIExpression()), !dbg !260

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !203, metadata !DIExpression()), !dbg !262

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !204, metadata !DIExpression()), !dbg !264

  //   %5 = bitcast i64* %thr5 to i8*, !dbg !118

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %5) #7, !dbg !118

  //   call void @llvm.dbg.declare(metadata i64* %thr5, metadata !205, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !206, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !208, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !209, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !211, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 3), metadata !212, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !214, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2), metadata !215, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !217, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !218, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !220, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 0), metadata !221, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !223, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X0_1, metadata !224, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i32 0, metadata !227, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_5_X2_0, metadata !228, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i32 0, metadata !230, metadata !DIExpression()), !dbg !281

  //   store atomic i32 0, i32* @atom_5_X2_0 monotonic, align 4, !dbg !135
  // ST: Guess
  iw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l94_c3
  old_cw = cw(0,11);
  cw(0,11) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l94_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !231, metadata !DIExpression()), !dbg !283

  //   call void @llvm.dbg.value(metadata i32 0, metadata !233, metadata !DIExpression()), !dbg !283

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !137
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l95_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l95_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !234, metadata !DIExpression()), !dbg !285

  //   call void @llvm.dbg.value(metadata i32 0, metadata !236, metadata !DIExpression()), !dbg !285

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !139
  // ST: Guess
  iw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l96_c3
  old_cw = cw(0,7);
  cw(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l96_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !237, metadata !DIExpression()), !dbg !287

  //   call void @llvm.dbg.value(metadata i32 0, metadata !239, metadata !DIExpression()), !dbg !287

  //   store atomic i32 0, i32* @atom_3_X0_1 monotonic, align 4, !dbg !141
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l97_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l97_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X0_1, metadata !240, metadata !DIExpression()), !dbg !289

  //   call void @llvm.dbg.value(metadata i32 0, metadata !242, metadata !DIExpression()), !dbg !289

  //   store atomic i32 0, i32* @atom_4_X0_1 monotonic, align 4, !dbg !143
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l98_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l98_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %12, metadata !243, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !244, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %14, metadata !245, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %15, metadata !246, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %16, metadata !247, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i32 %17, metadata !248, metadata !DIExpression()), !dbg !254

  //   %and = and i32 %16, %17, !dbg !174
  creg_r19 = max(creg_r17,creg_r18);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !249, metadata !DIExpression()), !dbg !254

  //   %and34 = and i32 %15, %and, !dbg !175
  creg_r20 = max(creg_r16,creg_r19);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !250, metadata !DIExpression()), !dbg !254

  //   %and35 = and i32 %14, %and34, !dbg !176
  creg_r21 = max(creg_r15,creg_r20);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !251, metadata !DIExpression()), !dbg !254

  //   %and36 = and i32 %13, %and35, !dbg !177
  creg_r22 = max(creg_r14,creg_r21);
  r22 = r14 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !252, metadata !DIExpression()), !dbg !254

  //   %and37 = and i32 %12, %and36, !dbg !178
  creg_r23 = max(creg_r13,creg_r22);
  r23 = r13 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !253, metadata !DIExpression()), !dbg !254
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 125, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
