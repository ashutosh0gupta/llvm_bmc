...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !75, metadata !DIExpression()), !dbg !87

  //   store atomic i64 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !61
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !79, metadata !DIExpression()), !dbg !81
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !98, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !101, metadata !DIExpression()), !dbg !112
