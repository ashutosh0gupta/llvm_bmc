...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !74, metadata !DIExpression()), !dbg !109
  ...
  //   %cmp18 = icmp eq i32 %conv8, 0, !dbg !105
  ...
  //   store i32 %conv19, i32* @atom_1_X6_0, align 4, !dbg !106, !tbaa !99
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !173, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i32 0, metadata !175, metadata !DIExpression()), !dbg !221

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !117
  // ST: Guess
  ...
  //   %11 = load i32, i32* @atom_1_X6_0, align 4, !dbg !149, !tbaa !146
  // LD: Guess
  old_cr = cr(0,5);
