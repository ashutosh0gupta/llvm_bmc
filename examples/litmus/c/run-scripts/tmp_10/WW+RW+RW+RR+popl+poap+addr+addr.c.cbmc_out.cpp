...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !53

  //   call void @llvm.dbg.value(metadata i64 1, metadata !46, metadata !DIExpression()), !dbg !53
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !58, metadata !DIExpression()), !dbg !72
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !61, metadata !DIExpression()), !dbg !75

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !58
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !59, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64 1, metadata !66, metadata !DIExpression()), !dbg !78

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !61
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !68, metadata !DIExpression()), !dbg !81

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !81
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !86, metadata !DIExpression()), !dbg !100
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !88, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !90, metadata !DIExpression()), !dbg !103

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !87, metadata !DIExpression()), !dbg !100

  //   %xor = xor i32 %conv, %conv, !dbg !61
  creg_r2 = max(creg_r1,creg_r1);
  ASSUME(active[creg_r2] == 3);
  r2 = r1 ^ r1;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !91, metadata !DIExpression()), !dbg !100

  //   %add = add nsw i32 3, %xor, !dbg !62
  creg_r3 = max(0,creg_r2);
  ASSUME(active[creg_r3] == 3);
  r3 = 3 + r2;

  //   %idxprom = sext i32 %add to i64, !dbg !62

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !62
  r4 = 0+r3*1;
  ASSUME(creg_r4 >= 0);
  ASSUME(creg_r4 >= creg_r3);
  ASSUME(active[creg_r4] == 3);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !92, metadata !DIExpression()), !dbg !108

  //   call void @llvm.dbg.value(metadata i64 1, metadata !94, metadata !DIExpression()), !dbg !108

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !62
  // ST: Guess
  iw(3,r4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW 
  old_cw = cw(3,r4);
  cw(3,r4) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !96, metadata !DIExpression()), !dbg !110
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !115, metadata !DIExpression()), !dbg !134
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !117, metadata !DIExpression()), !dbg !137

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !64
  // LD: Guess
  old_cr = cr(4,0+3*1);
  ...
  if(cr(4,0+3*1) < cw(4,0+3*1)) {
    ...
    r5 = mem(0+3*1,cr(4,0+3*1));
  }
  ASSUME(creturn[4] >= cr(4,0+3*1));

  //   call void @llvm.dbg.value(metadata i64 %0, metadata !119, metadata !DIExpression()), !dbg !137

  //   %conv = trunc i64 %0 to i32, !dbg !65

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !116, metadata !DIExpression()), !dbg !134

  //   %xor = xor i32 %conv, %conv, !dbg !66
  creg_r6 = max(creg_r5,creg_r5);
  ASSUME(active[creg_r6] == 4);
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !120, metadata !DIExpression()), !dbg !134

  //   %add = add nsw i32 0, %xor, !dbg !67
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 4);
  r7 = 0 + r6;
  ...
  ASSUME(active[creg_r8] == 4);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !122, metadata !DIExpression()), !dbg !142

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !67
  // LD: Guess
  old_cr = cr(4,r8);
  cr(4,r8) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM 
  // Check
  ASSUME(active[cr(4,r8)] == 4);
  ASSUME(cr(4,r8) >= iw(4,r8));
  ASSUME(cr(4,r8) >= creg_r8);
  ASSUME(cr(4,r8) >= cdy[4]);
  ASSUME(cr(4,r8) >= cisb[4]);
  ASSUME(cr(4,r8) >= cdl[4]);
  ASSUME(cr(4,r8) >= cl[4]);
  // Update
  creg_r9 = cr(4,r8);
  crmax(4,r8) = max(crmax(4,r8),cr(4,r8));
  caddr[4] = max(caddr[4],creg_r8);
  if(cr(4,r8) < cw(4,r8)) {
    r9 = buff(4,r8);
    ASSUME((!(( (cw(4,r8) < 1) && (1 < crmax(4,r8)) )))||(sforbid(r8,1)> 0));
    ASSUME((!(( (cw(4,r8) < 2) && (2 < crmax(4,r8)) )))||(sforbid(r8,2)> 0));
    ASSUME((!(( (cw(4,r8) < 3) && (3 < crmax(4,r8)) )))||(sforbid(r8,3)> 0));
    ASSUME((!(( (cw(4,r8) < 4) && (4 < crmax(4,r8)) )))||(sforbid(r8,4)> 0));
    ASSUME((!(( (cw(4,r8) < 5) && (5 < crmax(4,r8)) )))||(sforbid(r8,5)> 0));
    ASSUME((!(( (cw(4,r8) < 6) && (6 < crmax(4,r8)) )))||(sforbid(r8,6)> 0));
    ASSUME((!(( (cw(4,r8) < 7) && (7 < crmax(4,r8)) )))||(sforbid(r8,7)> 0));
    ASSUME((!(( (cw(4,r8) < 8) && (8 < crmax(4,r8)) )))||(sforbid(r8,8)> 0));
    ASSUME((!(( (cw(4,r8) < 9) && (9 < crmax(4,r8)) )))||(sforbid(r8,9)> 0));
  } else {
    if(pw(4,r8) != co(r8,cr(4,r8))) {
      ASSUME(cr(4,r8) >= old_cr);
    }
    pw(4,r8) = co(r8,cr(4,r8));
    r9 = mem(r8,cr(4,r8));
  }
  ASSUME(creturn[4] >= cr(4,r8));

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !124, metadata !DIExpression()), !dbg !142

  //   %conv4 = trunc i64 %1 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !121, metadata !DIExpression()), !dbg !134

  //   %cmp = icmp eq i32 %conv, 1, !dbg !70

  //   %conv5 = zext i1 %cmp to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !125, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !126, metadata !DIExpression()), !dbg !145

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !128, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %2, i64* @atom_3_X0_1 seq_cst, align 8, !dbg !72
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !129, metadata !DIExpression()), !dbg !134

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X3_0, metadata !130, metadata !DIExpression()), !dbg !148

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !132, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %3, i64* @atom_3_X3_0 seq_cst, align 8, !dbg !75
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !210

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !212

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !214

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !101

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !101

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !165, metadata !DIExpression()), !dbg !216

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !103

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !103

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !166, metadata !DIExpression()), !dbg !218
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !108
  // ST: Guess
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   store atomic i64 0, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !179, metadata !DIExpression()), !dbg !227

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !182, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !185, metadata !DIExpression()), !dbg !231

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !231

  //   store atomic i64 0, i64* @atom_3_X0_1 monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X3_0, metadata !188, metadata !DIExpression()), !dbg !233

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !233

  //   store atomic i64 0, i64* @atom_3_X3_0 monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   %call17 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !124
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr0, align 8, !dbg !125, !tbaa !126
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   %call18 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !130
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr1, align 8, !dbg !131, !tbaa !126
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   %call19 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !132
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i64, i64* %thr2, align 8, !dbg !133, !tbaa !126
  // LD: Guess
  old_cr = cr(0,10);
  ...
  //   %call20 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !134
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr3, align 8, !dbg !135, !tbaa !126
  // LD: Guess
  old_cr = cr(0,11);
  ...
  //   %call21 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !136
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !138
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !194, metadata !DIExpression()), !dbg !251

  //   %conv = trunc i64 %8 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !191, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !196, metadata !DIExpression()), !dbg !254

  //   %9 = load atomic i64, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !198, metadata !DIExpression()), !dbg !254

  //   %conv25 = trunc i64 %9 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !195, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !200, metadata !DIExpression()), !dbg !257

  //   %10 = load atomic i64, i64* @atom_3_X0_1 seq_cst, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !202, metadata !DIExpression()), !dbg !257

  //   %conv29 = trunc i64 %10 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !199, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X3_0, metadata !204, metadata !DIExpression()), !dbg !260

  //   %11 = load atomic i64, i64* @atom_3_X3_0 seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !206, metadata !DIExpression()), !dbg !260

  //   %conv33 = trunc i64 %11 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !203, metadata !DIExpression()), !dbg !210

  //   %and = and i32 %conv29, %conv33, !dbg !149
  creg_r19 = max(creg_r17,creg_r18);
  ASSUME(active[creg_r19] == 0);
  r19 = r17 & r18;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !207, metadata !DIExpression()), !dbg !210

  //   %and34 = and i32 %conv25, %and, !dbg !150
  creg_r20 = max(creg_r16,creg_r19);
  ASSUME(active[creg_r20] == 0);
  r20 = r16 & r19;

  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !208, metadata !DIExpression()), !dbg !210

  //   %and35 = and i32 %conv, %and34, !dbg !151
  creg_r21 = max(creg_r15,creg_r20);
  ASSUME(active[creg_r21] == 0);
  r21 = r15 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !209, metadata !DIExpression()), !dbg !210

  //   %cmp = icmp eq i32 %and35, 1, !dbg !152
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !155

  //   unreachable, !dbg !155
  r22 = 1;

T0BLOCK2:
  //   %12 = bitcast i64* %thr3 to i8*, !dbg !158

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !158

  //   %13 = bitcast i64* %thr2 to i8*, !dbg !158

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !158

  //   %14 = bitcast i64* %thr1 to i8*, !dbg !158

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %14) #7, !dbg !158

  //   %15 = bitcast i64* %thr0 to i8*, !dbg !158
