...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !40, metadata !DIExpression()), !dbg !53
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !56

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !57
  // LD: Guess
  old_cr = cr(1,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !45, metadata !DIExpression()), !dbg !56

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !41, metadata !DIExpression()), !dbg !53

  //   call void (...) @dmbld(), !dbg !59
  // dumbld: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !47, metadata !DIExpression()), !dbg !60

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !49, metadata !DIExpression()), !dbg !60

  //   %conv4 = trunc i64 %1 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !46, metadata !DIExpression()), !dbg !53
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !50, metadata !DIExpression()), !dbg !53

  //   store i32 %conv5, i32* @atom_0_X0_1, align 4, !dbg !64, !tbaa !65
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !51, metadata !DIExpression()), !dbg !53

  //   store i32 %conv7, i32* @atom_0_X2_0, align 4, !dbg !70, !tbaa !65
  // ST: Guess
  iw(1,3) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW _l28_c15
  old_cw = cw(1,3);
  cw(1,3) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM _l28_c15
  // Check
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !74, metadata !DIExpression()), !dbg !86
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !78, metadata !DIExpression()), !dbg !89

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !75, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !80, metadata !DIExpression()), !dbg !93

  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !61
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l36_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !82, metadata !DIExpression()), !dbg !93

  //   %conv4 = trunc i64 %1 to i32, !dbg !62

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !79, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !83, metadata !DIExpression()), !dbg !86
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !103, metadata !DIExpression()), !dbg !108
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !104, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64 1, metadata !106, metadata !DIExpression()), !dbg !111

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !50
  // ST: Guess
  iw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l46_c3
  old_cw = cw(3,0+1*1);
  cw(3,0+1*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l46_c3
  // Check
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !117, metadata !DIExpression()), !dbg !124
  ...
  // ST: Guess
  iw(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l52_c3
  old_cw = cw(4,0);
  cw(4,0) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l52_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !134, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !135, metadata !DIExpression()), !dbg !169

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !136, metadata !DIExpression()), !dbg !171

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !140, metadata !DIExpression()), !dbg !173

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !141, metadata !DIExpression()), !dbg !175

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !142, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !143, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !178

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !146, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64 0, metadata !148, metadata !DIExpression()), !dbg !180

  //   store atomic i64 0, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_1, metadata !149, metadata !DIExpression()), !dbg !182

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !182

  //   store atomic i32 0, i32* @atom_0_X0_1 monotonic, align 4, !dbg !93
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X2_0, metadata !153, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_0_X2_0 monotonic, align 4, !dbg !95
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !156, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !158, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !159, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !188

  //   store atomic i32 0, i32* @atom_1_X2_0 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !101
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call12 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !102
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call13 = call i32 @pthread_create(i64* noundef %thr3, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t3, i8* noundef null) #7, !dbg !103
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %4 = load i64, i64* %thr0, align 8, !dbg !104, !tbaa !105
  r5 = local_mem[1];

  //   %call14 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !109
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr1, align 8, !dbg !110, !tbaa !105
  r6 = local_mem[2];

  //   %call15 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !111
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i64, i64* %thr2, align 8, !dbg !112, !tbaa !105
  r7 = local_mem[0];

  //   %call16 = call i32 @pthread_join(i64 noundef %6, i8** noundef null), !dbg !113
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %7 = load i64, i64* %thr3, align 8, !dbg !114, !tbaa !105
  r8 = local_mem[3];

  //   %call17 = call i32 @pthread_join(i64 noundef %7, i8** noundef null), !dbg !115
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %8 = load i32, i32* @atom_0_X0_1, align 4, !dbg !116, !tbaa !117
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %9 = load i32, i32* @atom_0_X2_0, align 4, !dbg !119, !tbaa !117
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %10 = load i32, i32* @atom_1_X0_1, align 4, !dbg !120, !tbaa !117
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !164, metadata !DIExpression()), !dbg !169

  //   %11 = load i32, i32* @atom_1_X2_0, align 4, !dbg !121, !tbaa !117
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !165, metadata !DIExpression()), !dbg !169

  //   %and = and i32 %10, %11, !dbg !122
  creg_r13 = max(creg_r11,creg_r12);
  r13 = r11 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !166, metadata !DIExpression()), !dbg !169

  //   %and18 = and i32 %9, %and, !dbg !123
  creg_r14 = max(creg_r10,creg_r13);
  r14 = r10 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and18, metadata !167, metadata !DIExpression()), !dbg !169

  //   %and19 = and i32 %8, %and18, !dbg !124
  creg_r15 = max(creg_r14,creg_r9);
  r15 = r9 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and19, metadata !168, metadata !DIExpression()), !dbg !169

  //   %cmp = icmp eq i32 %and19, 1, !dbg !125
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 86, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
...
T0BLOCK2:
  //   %12 = bitcast i64* %thr3 to i8*, !dbg !131

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %12) #7, !dbg !131

  //   %13 = bitcast i64* %thr2 to i8*, !dbg !131

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %13) #7, !dbg !131

  //   %14 = bitcast i64* %thr1 to i8*, !dbg !131

  //   call void @llvm.lifetime.end.p0i8(i64 8, i8* %14) #7, !dbg !131

  //   %15 = bitcast i64* %thr0 to i8*, !dbg !131
