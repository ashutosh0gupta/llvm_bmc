...
T2BLOCK1:
  ...
  //   store i32 %conv31, i32* @atom_1_X12_0, align 4, !dbg !107, !tbaa !98
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !135, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !136, metadata !DIExpression()), !dbg !192

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !137, metadata !DIExpression()), !dbg !194

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !141, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !142, metadata !DIExpression()), !dbg !197

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !145, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !154, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i32 0, metadata !157, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !158, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !161, metadata !DIExpression()), !dbg !209

  //   call void @llvm.dbg.value(metadata i32 0, metadata !163, metadata !DIExpression()), !dbg !209

  //   store atomic i32 0, i32* @atom_1_X10_0 monotonic, align 4, !dbg !119
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X12_0, metadata !164, metadata !DIExpression()), !dbg !211

  //   call void @llvm.dbg.value(metadata i32 0, metadata !166, metadata !DIExpression()), !dbg !211

  //   store atomic i32 0, i32* @atom_1_X12_0 monotonic, align 4, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !168, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !170, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !173, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !175, metadata !DIExpression()), !dbg !225

  //   %conv22 = trunc i64 %5 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !172, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !178, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !180, metadata !DIExpression()), !dbg !229

  //   %conv28 = trunc i64 %6 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !177, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !181, metadata !DIExpression()), !dbg !192
  ...
  //   %8 = load i32, i32* @atom_1_X8_1, align 4, !dbg !147, !tbaa !145
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %9 = load i32, i32* @atom_1_X10_0, align 4, !dbg !148, !tbaa !145
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   %10 = load i32, i32* @atom_1_X12_0, align 4, !dbg !149, !tbaa !145
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and31, metadata !187, metadata !DIExpression()), !dbg !192

  //   %and32 = and i32 %7, %and31, !dbg !152
  creg_r26 = max(creg_r20,creg_r25);
  r26 = r20 & r25;

  //   call void @llvm.dbg.value(metadata i32 %and32, metadata !188, metadata !DIExpression()), !dbg !192
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !159
