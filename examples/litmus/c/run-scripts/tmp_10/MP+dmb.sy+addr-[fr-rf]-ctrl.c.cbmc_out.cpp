...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !82), !dbg !86
  ...
  //   %tobool = icmp ne i32 %conv8, 0, !dbg !78
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !83), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !75, metadata !DIExpression()), !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !77, metadata !DIExpression()), !dbg !103

  //   %conv12 = trunc i64 %3 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !84
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !78, metadata !DIExpression()), !dbg !84

  //   store i32 %conv13, i32* @atom_1_X0_1, align 4, !dbg !88, !tbaa !89
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv4, 0, !dbg !93
  creg__r4__0_ = max(0,creg_r4);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !79, metadata !DIExpression()), !dbg !84

  //   store i32 %conv15, i32* @atom_1_X3_0, align 4, !dbg !94, !tbaa !89
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv8, 1, !dbg !95
  creg__r5__1_ = max(0,creg_r5);

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !80, metadata !DIExpression()), !dbg !84

  //   store i32 %conv17, i32* @atom_1_X5_1, align 4, !dbg !96, !tbaa !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !81, metadata !DIExpression()), !dbg !84

  //   store i32 %conv19, i32* @atom_1_X6_0, align 4, !dbg !98, !tbaa !89
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !163, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !166, metadata !DIExpression()), !dbg !213
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
