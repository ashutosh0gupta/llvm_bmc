...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !76, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !77, metadata !DIExpression()), !dbg !98

  //   %conv1 = sext i32 %add to i64, !dbg !68

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !79, metadata !DIExpression()), !dbg !98

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !68
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !81, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !83, metadata !DIExpression()), !dbg !100

  //   %conv5 = trunc i64 %1 to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !80, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !84, metadata !DIExpression()), !dbg !103
  ...
  //   %cmp9 = icmp eq i32 %conv5, 1, !dbg !80
  ...
  //   store i32 %conv10, i32* @atom_1_X4_1, align 4, !dbg !81, !tbaa !76
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !117, metadata !DIExpression()), !dbg !151

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !118, metadata !DIExpression()), !dbg !151

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !77

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !77

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !119, metadata !DIExpression()), !dbg !153

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !123, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !124, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64 0, metadata !126, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !158

  //   call void @llvm.dbg.value(metadata i64 0, metadata !129, metadata !DIExpression()), !dbg !158
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X0_2, metadata !130, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !160

  //   store atomic i32 0, i32* @atom_0_X0_2 monotonic, align 4, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !134, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i32 0, metadata !136, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !137, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i32 0, metadata !139, metadata !DIExpression()), !dbg !164

  //   store atomic i32 0, i32* @atom_1_X4_1 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !141, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !143, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !144, metadata !DIExpression()), !dbg !151

  //   %5 = load i32, i32* @atom_0_X0_2, align 4, !dbg !105, !tbaa !106
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !145, metadata !DIExpression()), !dbg !151
  ...
  //   call void @llvm.dbg.value(metadata i32 %6, metadata !146, metadata !DIExpression()), !dbg !151

  //   %7 = load i32, i32* @atom_1_X4_1, align 4, !dbg !109, !tbaa !106
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %7, metadata !147, metadata !DIExpression()), !dbg !151

  //   %and = and i32 %6, %7, !dbg !110
  creg_r14 = max(creg_r12,creg_r13);
  r14 = r12 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !148, metadata !DIExpression()), !dbg !151

  //   %and13 = and i32 %5, %and, !dbg !111
  creg_r15 = max(creg_r11,creg_r14);
  r15 = r11 & r14;

  //   call void @llvm.dbg.value(metadata i32 %and13, metadata !149, metadata !DIExpression()), !dbg !151

  //   %and14 = and i32 %conv12, %and13, !dbg !112
  creg_r16 = max(creg__r10__2_,creg_r15);
  r16 = (r10==2) & r15;

  //   call void @llvm.dbg.value(metadata i32 %and14, metadata !150, metadata !DIExpression()), !dbg !151
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([137 x i8], [137 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
