...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !67, metadata !DIExpression()), !dbg !83

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !65
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %conv5 = trunc i64 %2 to i32, !dbg !66
  ...
  //   %cmp7 = icmp eq i32 %conv5, 0, !dbg !73
  ...
  //   store i32 %conv8, i32* @atom_1_X4_0, align 4, !dbg !74, !tbaa !69
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !102, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !103, metadata !DIExpression()), !dbg !128

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !67

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !67

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !104, metadata !DIExpression()), !dbg !130

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !69

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !69

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !108, metadata !DIExpression()), !dbg !132

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !109, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !112, metadata !DIExpression()), !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !115, metadata !DIExpression()), !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !118, metadata !DIExpression()), !dbg !139

  //   call void @llvm.dbg.value(metadata i32 0, metadata !121, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !122, metadata !DIExpression()), !dbg !141

  //   call void @llvm.dbg.value(metadata i32 0, metadata !124, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i32 %4, metadata !125, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i32 %5, metadata !126, metadata !DIExpression()), !dbg !128
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 59, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !99
