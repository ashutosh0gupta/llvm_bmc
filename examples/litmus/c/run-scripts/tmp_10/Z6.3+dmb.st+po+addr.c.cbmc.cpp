...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !60, metadata !DIExpression()), !dbg !69

  //   call void @llvm.dbg.value(metadata i64 1, metadata !62, metadata !DIExpression()), !dbg !69
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !81, metadata !DIExpression()), !dbg !95

  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !57
  // LD: Guess
  old_cr = cr(3,r3);
  cr(3,r3) = get_rng(0,NCONTEXT-1);// 3 ASSIGN LDCOM _l37_c15
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !80, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !84, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !85, metadata !DIExpression()), !dbg !87
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !113, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !114, metadata !DIExpression()), !dbg !146

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !74

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !74

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !115, metadata !DIExpression()), !dbg !148

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !76

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !76

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !119, metadata !DIExpression()), !dbg !150

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !78

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !78

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !120, metadata !DIExpression()), !dbg !152

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !121, metadata !DIExpression()), !dbg !153
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !124, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !127, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !130, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i32 0, metadata !133, metadata !DIExpression()), !dbg !159
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X3_0, metadata !134, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i32 0, metadata !136, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !140, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !141, metadata !DIExpression()), !dbg !146
  ...
  //   call void @llvm.dbg.value(metadata i32 %and15, metadata !145, metadata !DIExpression()), !dbg !146
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([104 x i8], [104 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
