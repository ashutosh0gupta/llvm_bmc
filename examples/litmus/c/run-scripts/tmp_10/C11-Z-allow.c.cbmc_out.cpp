...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !152, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !155, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_0_X5_1, metadata !158, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i32 0, metadata !161, metadata !DIExpression()), !dbg !189

  //   store atomic i32 0, i32* @atom_0_X5_1 monotonic, align 4, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X4_3, metadata !162, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i32 0, metadata !164, metadata !DIExpression()), !dbg !191

  //   store atomic i32 0, i32* @atom_2_X4_3 monotonic, align 4, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_4, metadata !165, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i32 0, metadata !167, metadata !DIExpression()), !dbg !193

  //   store atomic i32 0, i32* @atom_1_X2_4 monotonic, align 4, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !168, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i32 0, metadata !170, metadata !DIExpression()), !dbg !195
  ...
  //   %call11 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #7, !dbg !98
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call12 = call i32 @pthread_create(i64* noundef %thr2, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t2, i8* noundef null) #7, !dbg !99
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %3 = load i64, i64* %thr0, align 8, !dbg !100, !tbaa !101
  r5 = local_mem[2];
  ...
  //   %4 = load i64, i64* %thr1, align 8, !dbg !106, !tbaa !101
  r6 = local_mem[0];

  //   %call14 = call i32 @pthread_join(i64 noundef %4, i8** noundef null), !dbg !107
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %5 = load i64, i64* %thr2, align 8, !dbg !108, !tbaa !101
  r7 = local_mem[1];

  //   %call15 = call i32 @pthread_join(i64 noundef %5, i8** noundef null), !dbg !109
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %6 = load i32, i32* @atom_0_X5_1, align 4, !dbg !110, !tbaa !111
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %7 = load i32, i32* @atom_2_X4_3, align 4, !dbg !113, !tbaa !111
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %8 = load i32, i32* @atom_1_X2_4, align 4, !dbg !114, !tbaa !111
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   %9 = load i32, i32* @atom_1_X4_1, align 4, !dbg !115, !tbaa !111
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !174, metadata !DIExpression()), !dbg !178
  ...
  //   %and16 = and i32 %7, %and, !dbg !117
  creg_r13 = max(creg_r12,creg_r9);
  r13 = r9 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and16, metadata !176, metadata !DIExpression()), !dbg !178

  //   %and17 = and i32 %6, %and16, !dbg !118
  creg_r14 = max(creg_r13,creg_r8);
  r14 = r8 & r13;

  //   call void @llvm.dbg.value(metadata i32 %and17, metadata !177, metadata !DIExpression()), !dbg !178

  //   %cmp = icmp eq i32 %and17, 1, !dbg !119
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([96 x i8], [96 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !122
