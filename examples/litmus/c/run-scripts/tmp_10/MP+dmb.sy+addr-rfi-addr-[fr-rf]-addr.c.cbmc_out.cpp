...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !68, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64 1, metadata !70, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !119

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !74, metadata !DIExpression()), !dbg !119

  //   %conv4 = trunc i64 %1 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !71, metadata !DIExpression()), !dbg !110

  //   %xor5 = xor i32 %conv4, %conv4, !dbg !103
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !75, metadata !DIExpression()), !dbg !110

  //   %add7 = add nsw i32 3, %xor5, !dbg !104
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 3 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !104

  //   %arrayidx9 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !104
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !77, metadata !DIExpression()), !dbg !124

  //   %2 = load atomic i64, i64* %arrayidx9 monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !79, metadata !DIExpression()), !dbg !124

  //   %conv12 = trunc i64 %2 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !76, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !81, metadata !DIExpression()), !dbg !126

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !80, metadata !DIExpression()), !dbg !110

  //   %xor17 = xor i32 %conv16, %conv16, !dbg !110
  creg_r10 = max(creg_r9,creg_r9);
  ASSUME(active[creg_r10] == 2);
  r10 = r9 ^ r9;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !84, metadata !DIExpression()), !dbg !110

  //   %add19 = add nsw i32 0, %xor17, !dbg !111
  creg_r11 = max(0,creg_r10);
  ASSUME(active[creg_r11] == 2);
  r11 = 0 + r10;

  //   %idxprom20 = sext i32 %add19 to i64, !dbg !111

  //   %arrayidx21 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom20, !dbg !111
  r12 = 0+r11*1;
  ASSUME(creg_r12 >= 0);
  ASSUME(creg_r12 >= creg_r11);
  ASSUME(active[creg_r12] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx21, metadata !86, metadata !DIExpression()), !dbg !131

  //   %4 = load atomic i64, i64* %arrayidx21 monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,r12);
  ...
  //   %conv24 = trunc i64 %4 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !85, metadata !DIExpression()), !dbg !110

  //   %cmp = icmp eq i32 %conv, 1, !dbg !114

  //   %conv25 = zext i1 %cmp to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv25, metadata !89, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !90, metadata !DIExpression()), !dbg !134
  ...
  //   %cmp29 = icmp eq i32 %conv4, 1, !dbg !117

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !93, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !94, metadata !DIExpression()), !dbg !137
  ...
  //   %cmp34 = icmp eq i32 %conv12, 0, !dbg !120

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !97, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !98, metadata !DIExpression()), !dbg !140

  //   %7 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !140

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !122
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv16, 1, !dbg !123

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !101, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !102, metadata !DIExpression()), !dbg !143

  //   %8 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !104, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %8, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp44 = icmp eq i32 %conv24, 0, !dbg !126

  //   %conv45 = zext i1 %cmp44 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv45, metadata !105, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !106, metadata !DIExpression()), !dbg !146

  //   %9 = zext i32 %conv45 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !108, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %9, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !128
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !252

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !254

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !256

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !177, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !179, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !180, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !183, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !185, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !186, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !188, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !189, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !192, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !269

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !147
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !195, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !271

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !149
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !198, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !273

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !151
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !201, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !275

  //   store atomic i64 0, i64* @atom_1_X11_0 monotonic, align 8, !dbg !153
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !205, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !207, metadata !DIExpression()), !dbg !290

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !204, metadata !DIExpression()), !dbg !252

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !208, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !210, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !212, metadata !DIExpression()), !dbg !294

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !209, metadata !DIExpression()), !dbg !252

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !213, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !215, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !217, metadata !DIExpression()), !dbg !298

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !214, metadata !DIExpression()), !dbg !252

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !218, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !220, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !222, metadata !DIExpression()), !dbg !302

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !219, metadata !DIExpression()), !dbg !252

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !223, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !225, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !227, metadata !DIExpression()), !dbg !306

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !224, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !229, metadata !DIExpression()), !dbg !309

  //   %11 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !187
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !231, metadata !DIExpression()), !dbg !309

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !228, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !233, metadata !DIExpression()), !dbg !312

  //   %12 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !190
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !235, metadata !DIExpression()), !dbg !312

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !232, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !237, metadata !DIExpression()), !dbg !315

  //   %13 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !193
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !239, metadata !DIExpression()), !dbg !315

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !236, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_0, metadata !241, metadata !DIExpression()), !dbg !318

  //   %14 = load atomic i64, i64* @atom_1_X11_0 seq_cst, align 8, !dbg !196
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !243, metadata !DIExpression()), !dbg !318

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !240, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !244, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !245, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !246, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !247, metadata !DIExpression()), !dbg !252

  //   %and64 = and i32 %conv40, %and63, !dbg !202
  creg_r31 = max(max(creg_r21,0),creg_r30);
  ASSUME(active[creg_r31] == 0);
  r31 = (r21==1) & r30;

  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !248, metadata !DIExpression()), !dbg !252

  //   %and65 = and i32 %conv34, %and64, !dbg !203
  creg_r32 = max(max(creg_r20,0),creg_r31);
  ASSUME(active[creg_r32] == 0);
  r32 = (r20==1) & r31;

  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !249, metadata !DIExpression()), !dbg !252

  //   %and66 = and i32 %conv28, %and65, !dbg !204
  creg_r33 = max(max(creg_r19,0),creg_r32);
  ASSUME(active[creg_r33] == 0);
  r33 = (r19==1) & r32;

  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !250, metadata !DIExpression()), !dbg !252

  //   %and67 = and i32 %conv22, %and66, !dbg !205
  creg_r34 = max(max(creg_r18,0),creg_r33);
  ASSUME(active[creg_r34] == 0);
  r34 = (r18==1) & r33;

  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !251, metadata !DIExpression()), !dbg !252
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 103, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
