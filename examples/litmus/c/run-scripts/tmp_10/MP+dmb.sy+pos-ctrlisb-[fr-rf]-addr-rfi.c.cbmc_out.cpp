...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !93), !dbg !108
  ...
  //   %xor = xor i32 %conv12, %conv12, !dbg !97
  creg_r4 = creg_r3;
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !79, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 0, %xor, !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !80, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64 1, metadata !82, metadata !DIExpression()), !dbg !118

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !98
  // ST: Guess
  iw(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STIW _l39_c3
  old_cw = cw(2,r6);
  cw(2,r6) = get_rng(0,NCONTEXT-1);// 2 ASSIGN STCOM _l39_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !119

  //   %4 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !101
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp18 = icmp eq i32 %conv4, 1, !dbg !109
  ...
  //   store i32 %conv19, i32* @atom_1_X2_1, align 4, !dbg !110, !tbaa !105
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv8, 0, !dbg !111
  ...
  //   store i32 %conv21, i32* @atom_1_X3_0, align 4, !dbg !112, !tbaa !105
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv12, 1, !dbg !113
  ...
  //   store i32 %conv23, i32* @atom_1_X5_1, align 4, !dbg !114, !tbaa !105
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv16, 1, !dbg !115
  ...
  //   store i32 %conv25, i32* @atom_1_X9_1, align 4, !dbg !116, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !178, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !181, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !184, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !187, metadata !DIExpression()), !dbg !238

  //   call void @llvm.dbg.value(metadata i32 0, metadata !189, metadata !DIExpression()), !dbg !238

  //   store atomic i32 0, i32* @atom_1_X9_1 monotonic, align 4, !dbg !128
  // ST: Guess
  ...
  //   %13 = load i32, i32* @atom_1_X9_1, align 4, !dbg !160, !tbaa !155
  // LD: Guess
  old_cr = cr(0,7);
  ...
  creg_r26 = max(creg__r12__2_,creg_r25);
  r26 = (r12==2) & r25;
