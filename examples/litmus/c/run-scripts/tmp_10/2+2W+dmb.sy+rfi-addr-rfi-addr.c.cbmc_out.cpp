...
T2BLOCK1:
  ...
  //   %xor7 = xor i32 %conv6, %conv6, !dbg !74
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !72, metadata !DIExpression()), !dbg !79

  //   %add9 = add nsw i32 0, %xor7, !dbg !75
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom10 = sext i32 %add9 to i64, !dbg !75

  //   %arrayidx11 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom10, !dbg !75
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx11, metadata !73, metadata !DIExpression()), !dbg !95

  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !95

  //   store atomic i64 1, i64* %arrayidx11 monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   store i32 %conv13, i32* @atom_1_X2_2, align 4, !dbg !78, !tbaa !79
  // ST: Guess
  ...
  //   %cmp14 = icmp eq i32 %conv6, 1, !dbg !83
  creg__r4__1_ = max(0,creg_r4);

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !83

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !77, metadata !DIExpression()), !dbg !79

  //   store i32 %conv15, i32* @atom_1_X6_1, align 4, !dbg !84, !tbaa !79
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !112, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !113, metadata !DIExpression()), !dbg !156

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !114, metadata !DIExpression()), !dbg !158

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !118, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !119, metadata !DIExpression()), !dbg !161

  //   call void @llvm.dbg.value(metadata i64 0, metadata !121, metadata !DIExpression()), !dbg !161
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !122, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 0, metadata !124, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !125, metadata !DIExpression()), !dbg !165

  //   call void @llvm.dbg.value(metadata i64 0, metadata !127, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !128, metadata !DIExpression()), !dbg !167

  //   call void @llvm.dbg.value(metadata i32 0, metadata !131, metadata !DIExpression()), !dbg !167
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !132, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i32 0, metadata !134, metadata !DIExpression()), !dbg !169

  //   store atomic i32 0, i32* @atom_1_X6_1 monotonic, align 4, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !136, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !138, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !139, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !143, metadata !DIExpression()), !dbg !183

  //   %conv16 = trunc i64 %5 to i32, !dbg !115

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !140, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !144, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !146, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !148, metadata !DIExpression()), !dbg !187

  //   %conv22 = trunc i64 %6 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !145, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !149, metadata !DIExpression()), !dbg !156
  ...
  //   %8 = load i32, i32* @atom_1_X6_1, align 4, !dbg !124, !tbaa !122
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i32 %and25, metadata !153, metadata !DIExpression()), !dbg !156

  //   %and26 = and i32 %conv18, %and25, !dbg !127
  creg_r18 = max(creg__r12__2_,creg_r17);
  r18 = (r12==2) & r17;

  //   call void @llvm.dbg.value(metadata i32 %and26, metadata !154, metadata !DIExpression()), !dbg !156

  //   %and27 = and i32 %conv12, %and26, !dbg !128
  creg_r19 = max(creg__r11__2_,creg_r18);
  r19 = (r11==2) & r18;

  //   call void @llvm.dbg.value(metadata i32 %and27, metadata !155, metadata !DIExpression()), !dbg !156
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 70, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !132
