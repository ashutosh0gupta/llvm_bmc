...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !117

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !99
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv19, 1, !dbg !111
  ...
  //   store i32 %conv24, i32* @atom_1_X10_1, align 4, !dbg !112, !tbaa !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_1, metadata !163, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_1, metadata !166, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i32 0, metadata !168, metadata !DIExpression()), !dbg !203

  //   store atomic i32 0, i32* @atom_1_X10_1 monotonic, align 4, !dbg !106
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X10_1, align 4, !dbg !129, !tbaa !126
  // LD: Guess
  old_cr = cr(0,6);
