...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !102, metadata !DIExpression()), !dbg !116
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !126, metadata !DIExpression()), !dbg !145

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) acquire, align 8, !dbg !65
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !130, metadata !DIExpression()), !dbg !148
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !168
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !178, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !179, metadata !DIExpression()), !dbg !239

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !180, metadata !DIExpression()), !dbg !241

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !184, metadata !DIExpression()), !dbg !243

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !185, metadata !DIExpression()), !dbg !245

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !186, metadata !DIExpression()), !dbg !247

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !116

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !116

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !187, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !188, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !191, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !194, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !197, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !200, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !203, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !206, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !209, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !212, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !216, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !218, metadata !DIExpression()), !dbg !287

  //   %conv = trunc i64 %10 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !215, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !220, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !222, metadata !DIExpression()), !dbg !290

  //   %conv29 = trunc i64 %11 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv29, metadata !219, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !226, metadata !DIExpression()), !dbg !293

  //   %conv33 = trunc i64 %12 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !223, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !228, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !230, metadata !DIExpression()), !dbg !296

  //   %conv37 = trunc i64 %13 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv37, metadata !227, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !232, metadata !DIExpression()), !dbg !299
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !234, metadata !DIExpression()), !dbg !299

  //   %conv41 = trunc i64 %14 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv41, metadata !231, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %and42, metadata !236, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !237, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !238, metadata !DIExpression()), !dbg !239
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 103, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !177
