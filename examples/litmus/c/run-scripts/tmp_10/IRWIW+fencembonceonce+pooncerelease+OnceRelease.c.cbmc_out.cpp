...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !96, metadata !DIExpression()), !dbg !107
  ...
  // ST: Guess
  iw(4,3) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW _l45_c15
  old_cw = cw(4,3);
  cw(4,3) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM _l45_c15
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !126, metadata !DIExpression()), !dbg !162

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !127, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !128, metadata !DIExpression()), !dbg !165
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_2, metadata !134, metadata !DIExpression()), !dbg !169
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_2, metadata !138, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !142, metadata !DIExpression()), !dbg !187
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([132 x i8], [132 x i8]* @.str.1, i64 0, i64 0), i32 noundef 79, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
