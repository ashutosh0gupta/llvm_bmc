...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !76, metadata !DIExpression()), !dbg !110

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !80, metadata !DIExpression()), !dbg !112
  ...
  //   store i32 %conv20, i32* @atom_1_X7_1, align 4, !dbg !108, !tbaa !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !161, metadata !DIExpression()), !dbg !207
