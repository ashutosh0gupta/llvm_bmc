...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !68, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !70, metadata !DIExpression()), !dbg !97
  ...
  //   store i32 %conv17, i32* @atom_1_X2_2, align 4, !dbg !88, !tbaa !89
  // ST: Guess
  ...
  //   store i32 %conv19, i32* @atom_1_X4_0, align 4, !dbg !94, !tbaa !89
  // ST: Guess
  ...
  //   %cmp20 = icmp eq i32 %conv8, 1, !dbg !95
  ...
  //   store i32 %conv21, i32* @atom_1_X6_1, align 4, !dbg !96, !tbaa !89
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_2, metadata !156, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_0, metadata !160, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_1, metadata !163, metadata !DIExpression()), !dbg !211
  ...
  //   %10 = load i32, i32* @atom_1_X4_0, align 4, !dbg !148, !tbaa !146
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %11 = load i32, i32* @atom_1_X6_1, align 4, !dbg !149, !tbaa !146
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([115 x i8], [115 x i8]* @.str.1, i64 0, i64 0), i32 noundef 91, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !160
