...
T2BLOCK2:
  //   br label %lbl_label65, !dbg !59
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label65, !dbg !60
  goto T2BLOCK4;
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X1_0, metadata !132, metadata !DIExpression()), !dbg !157

  //   call void @llvm.dbg.value(metadata i32 0, metadata !134, metadata !DIExpression()), !dbg !157

  //   store atomic i32 0, i32* @atom_2_X1_0 monotonic, align 4, !dbg !84
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_2_X1_0, align 4, !dbg !105, !tbaa !103
  // LD: Guess
  old_cr = cr(0,3);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([129 x i8], [129 x i8]* @.str.1, i64 0, i64 0), i32 noundef 69, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !111
