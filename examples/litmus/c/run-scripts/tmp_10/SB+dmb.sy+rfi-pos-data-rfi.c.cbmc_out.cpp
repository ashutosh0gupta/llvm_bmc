...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !78, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !80, metadata !DIExpression()), !dbg !102

  //   %conv4 = trunc i64 %1 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !77, metadata !DIExpression()), !dbg !94

  //   %xor = xor i32 %conv4, %conv4, !dbg !77
  creg_r3 = creg_r2;
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !94

  //   %add = add nsw i32 %xor, 1, !dbg !78
  creg_r4 = max(0,creg_r3);
  r4 = r3 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !82, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !107

  //   %conv7 = sext i32 %add to i64, !dbg !80

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !85, metadata !DIExpression()), !dbg !107

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv4, 1, !dbg !90
  ...
  //   store i32 %conv14, i32* @atom_1_X3_1, align 4, !dbg !91, !tbaa !86
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_1, metadata !146, metadata !DIExpression()), !dbg !184

  //   call void @llvm.dbg.value(metadata i32 0, metadata !148, metadata !DIExpression()), !dbg !184

  //   store atomic i32 0, i32* @atom_1_X3_1 monotonic, align 4, !dbg !103
  // ST: Guess
  ...
  //   %8 = load i32, i32* @atom_1_X3_1, align 4, !dbg !128, !tbaa !125
  // LD: Guess
  old_cr = cr(0,4);
