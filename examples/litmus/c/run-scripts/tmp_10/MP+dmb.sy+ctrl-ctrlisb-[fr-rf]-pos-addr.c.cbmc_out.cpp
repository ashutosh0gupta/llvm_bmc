...
T2BLOCK7:
  ...
  //   %xor = xor i32 %conv19, %conv19, !dbg !108
  creg_r5 = creg_r4;
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !83, metadata !DIExpression()), !dbg !96

  //   %add = add nsw i32 0, %xor, !dbg !109
  creg_r6 = max(0,creg_r5);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add to i64, !dbg !109

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !109
  r7 = 0+r6*1;
  creg_r7 = creg_r6;

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !85, metadata !DIExpression()), !dbg !129

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(2,r7);
  cr(2,r7) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM _l42_c16
  // Check
  ...
  //   %cmp29 = icmp eq i32 %conv19, 1, !dbg !122
  ...
  //   store i32 %conv30, i32* @atom_1_X7_1, align 4, !dbg !123, !tbaa !114
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !196, metadata !DIExpression()), !dbg !250
