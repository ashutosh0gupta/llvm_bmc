...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !63, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64 1, metadata !65, metadata !DIExpression()), !dbg !110

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !92
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !98

  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !96

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !98
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   %conv11 = trunc i64 %2 to i32, !dbg !104

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !70, metadata !DIExpression()), !dbg !98
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !170, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !177, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !182, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !187, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !196, metadata !DIExpression()), !dbg !252
