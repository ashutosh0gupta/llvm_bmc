...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !140, metadata !DIExpression()), !dbg !192

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !141, metadata !DIExpression()), !dbg !192

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !142, metadata !DIExpression()), !dbg !194

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !146, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !147, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !150, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !153, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !163, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !166, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !180, metadata !DIExpression()), !dbg !227
