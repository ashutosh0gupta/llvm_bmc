...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !68, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !70, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !86, metadata !DIExpression()), !dbg !120

  //   %5 = zext i32 %conv18 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !88, metadata !DIExpression()), !dbg !120

  //   store atomic i64 %5, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !90, metadata !DIExpression()), !dbg !123

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !92, metadata !DIExpression()), !dbg !123

  //   store atomic i64 %6, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !105
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !166, metadata !DIExpression()), !dbg !219

  //   call void @llvm.dbg.value(metadata i64 0, metadata !168, metadata !DIExpression()), !dbg !219

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !115
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !169, metadata !DIExpression()), !dbg !221

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !221

  //   store atomic i64 0, i64* @atom_1_X6_0 monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !190, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !194, metadata !DIExpression()), !dbg !252

  //   %10 = load atomic i64, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !148
  // LD: Guess
  old_cr = cr(0,4);
