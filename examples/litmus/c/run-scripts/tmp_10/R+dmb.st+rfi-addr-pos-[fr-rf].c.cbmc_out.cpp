...
T2BLOCK1:
  ...
  //   %cmp16 = icmp eq i32 %conv8, 0, !dbg !93
  ...
  //   store i32 %conv17, i32* @atom_1_X6_0, align 4, !dbg !94, !tbaa !87
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !158, metadata !DIExpression()), !dbg !198

  //   call void @llvm.dbg.value(metadata i32 0, metadata !160, metadata !DIExpression()), !dbg !198

  //   store atomic i32 0, i32* @atom_1_X6_0 monotonic, align 4, !dbg !106
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_1_X6_0, align 4, !dbg !134, !tbaa !131
  // LD: Guess
  old_cr = cr(0,4);
