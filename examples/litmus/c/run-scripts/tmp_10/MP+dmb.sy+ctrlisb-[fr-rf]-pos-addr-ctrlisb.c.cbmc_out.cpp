...
T2BLOCK7:
  ...
  //   %cmp26 = icmp eq i32 %conv4, 0, !dbg !131
  ...
  //   %cmp31 = icmp eq i32 %conv8, 1, !dbg !134
  ...
  //   %cmp36 = icmp eq i32 %conv12, 1, !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !101, metadata !DIExpression()), !dbg !157

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !103, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %9, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !139
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !206, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !209, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !212, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !219, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !224, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !229, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !238, metadata !DIExpression()), !dbg !313
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !242, metadata !DIExpression()), !dbg !316
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !246, metadata !DIExpression()), !dbg !319
