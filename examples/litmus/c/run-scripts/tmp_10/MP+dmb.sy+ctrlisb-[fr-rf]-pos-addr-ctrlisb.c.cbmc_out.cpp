...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !129

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !87, metadata !DIExpression()), !dbg !129

  //   %conv23 = trunc i64 %5 to i32, !dbg !112
  ...
  //   %conv24 = zext i1 %cmp to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !88, metadata !DIExpression()), !dbg !96

  //   store i32 %conv24, i32* @atom_1_X0_1, align 4, !dbg !114, !tbaa !115
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv4, 0, !dbg !119
  ...
  //   store i32 %conv26, i32* @atom_1_X2_0, align 4, !dbg !120, !tbaa !115
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv8, 1, !dbg !121
  ...
  //   store i32 %conv28, i32* @atom_1_X4_1, align 4, !dbg !122, !tbaa !115
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv12, 1, !dbg !123
  creg__r3__1_ = max(0,creg_r3);

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !123

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !91, metadata !DIExpression()), !dbg !96

  //   store i32 %conv30, i32* @atom_1_X5_1, align 4, !dbg !124, !tbaa !115
  // ST: Guess
  ...
  //   %cmp31 = icmp eq i32 %conv23, 0, !dbg !125
  creg__r8__0_ = max(0,creg_r8);

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !92, metadata !DIExpression()), !dbg !96

  //   store i32 %conv32, i32* @atom_1_X9_0, align 4, !dbg !126, !tbaa !115
  // ST: Guess
...
T3BLOCK1:
  ...
  // ST: Guess
  iw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW _l59_c3
  old_cw = cw(3,0+2*1);
  cw(3,0+2*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM _l59_c3
  // Check
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !167, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !168, metadata !DIExpression()), !dbg !230

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !110

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !110

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !169, metadata !DIExpression()), !dbg !232

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !112

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !112

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !173, metadata !DIExpression()), !dbg !234

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !114

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !114

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !174, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !175, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !178, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !181, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !184, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !187, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !190, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X2_0, metadata !191, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !193, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_1, metadata !194, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i32 0, metadata !196, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X5_1, metadata !197, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !199, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_0, metadata !200, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i32 0, metadata !202, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !204, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !206, metadata !DIExpression()), !dbg !266

  //   %conv = trunc i64 %6 to i32, !dbg !149

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !203, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !207, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !209, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !211, metadata !DIExpression()), !dbg !270

  //   %conv26 = trunc i64 %7 to i32, !dbg !153

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !208, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !212, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !214, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !216, metadata !DIExpression()), !dbg !274

  //   %conv32 = trunc i64 %8 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !213, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !217, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %9, metadata !218, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %10, metadata !219, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %11, metadata !220, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i32 %13, metadata !222, metadata !DIExpression()), !dbg !230

  //   %and = and i32 %12, %13, !dbg !166
  creg_r21 = max(creg_r19,creg_r20);
  r21 = r19 & r20;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !223, metadata !DIExpression()), !dbg !230

  //   %and35 = and i32 %11, %and, !dbg !167
  creg_r22 = max(creg_r18,creg_r21);
  r22 = r18 & r21;

  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !224, metadata !DIExpression()), !dbg !230

  //   %and36 = and i32 %10, %and35, !dbg !168
  creg_r23 = max(creg_r17,creg_r22);
  r23 = r17 & r22;

  //   call void @llvm.dbg.value(metadata i32 %and36, metadata !225, metadata !DIExpression()), !dbg !230

  //   %and37 = and i32 %9, %and36, !dbg !169
  creg_r24 = max(creg_r16,creg_r23);
  r24 = r16 & r23;

  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !226, metadata !DIExpression()), !dbg !230

  //   %and38 = and i32 %conv34, %and37, !dbg !170
  creg_r25 = max(creg__r15__1_,creg_r24);
  r25 = (r15==1) & r24;

  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !227, metadata !DIExpression()), !dbg !230

  //   %and39 = and i32 %conv28, %and38, !dbg !171
  creg_r26 = max(creg__r14__1_,creg_r25);
  r26 = (r14==1) & r25;

  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !228, metadata !DIExpression()), !dbg !230

  //   %and40 = and i32 %conv22, %and39, !dbg !172
  creg_r27 = max(creg__r13__1_,creg_r26);
  r27 = (r13==1) & r26;

  //   call void @llvm.dbg.value(metadata i32 %and40, metadata !229, metadata !DIExpression()), !dbg !230
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 104, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !176
