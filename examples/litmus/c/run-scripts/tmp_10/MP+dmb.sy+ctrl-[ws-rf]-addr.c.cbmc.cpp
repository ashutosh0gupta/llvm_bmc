...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !78), !dbg !82
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !79), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !70, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !72, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !75, metadata !DIExpression()), !dbg !80
  ...
  //   store i32 %conv11, i32* @atom_1_X4_2, align 4, !dbg !89, !tbaa !84
  // ST: Guess
  ...
  //   store i32 %conv13, i32* @atom_1_X6_0, align 4, !dbg !91, !tbaa !84
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X4_2, metadata !153, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X6_0, metadata !156, metadata !DIExpression()), !dbg !199
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([112 x i8], [112 x i8]* @.str.1, i64 0, i64 0), i32 noundef 85, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !149
