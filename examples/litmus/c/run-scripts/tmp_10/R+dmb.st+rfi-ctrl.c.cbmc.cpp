...
T2BLOCK4:
  ...
  //   store i32 %conv5, i32* @atom_1_X2_2, align 4, !dbg !71, !tbaa !72
  // ST: Guess
  ...
  //   %cmp6 = icmp eq i32 %conv4, 0, !dbg !76
  ...
  //   store i32 %conv7, i32* @atom_1_X3_0, align 4, !dbg !77, !tbaa !72
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X3_0, metadata !122, metadata !DIExpression()), !dbg !151
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 64, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !116
