...
T2BLOCK1:
  ...
  //   %and = and i32 %conv, 128, !dbg !58
  creg_r2 = max(creg_r1,0);
  ASSUME(active[creg_r2] == 2);
  r2 = r1 & 128;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !70, metadata !DIExpression()), !dbg !80

  //   %add = add nsw i32 %and, 1, !dbg !59
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !78, metadata !DIExpression()), !dbg !91

  //   store atomic i64 %2, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !64
  // ST: Guess
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i64 0, i64 0), i32 noundef 57, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !101
