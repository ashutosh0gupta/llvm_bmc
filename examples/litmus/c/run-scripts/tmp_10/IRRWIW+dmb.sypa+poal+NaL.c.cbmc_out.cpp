...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !89, metadata !DIExpression()), !dbg !94
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !90, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64 1, metadata !92, metadata !DIExpression()), !dbg !97

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !47
  // ST: Guess
  //   : Release
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !102, metadata !DIExpression()), !dbg !115
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !104, metadata !DIExpression()), !dbg !118

  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !56
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !103, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !107, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !110, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !111, metadata !DIExpression()), !dbg !124
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !142, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !143, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_2, metadata !149, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !152, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !155, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !159, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !161, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !166, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !170, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !172, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !174, metadata !DIExpression()), !dbg !223
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !140
