...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !59, metadata !DIExpression()), !dbg !79

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !67
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !61, metadata !DIExpression()), !dbg !82

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !63, metadata !DIExpression()), !dbg !82
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !89, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !101, metadata !DIExpression()), !dbg !119
