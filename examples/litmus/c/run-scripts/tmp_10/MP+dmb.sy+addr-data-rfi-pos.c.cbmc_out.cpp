...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add6, metadata !69, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !97

  //   %conv7 = sext i32 %add6 to i64, !dbg !79

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !72, metadata !DIExpression()), !dbg !97

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !79
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !73, metadata !DIExpression()), !dbg !85
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !84
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !102

  //   %conv15 = trunc i64 %3 to i32, !dbg !85

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !77, metadata !DIExpression()), !dbg !85

  //   %cmp = icmp eq i32 %conv, 1, !dbg !86
  creg__r0__1_ = max(0,creg_r0);

  //   %conv16 = zext i1 %cmp to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !81, metadata !DIExpression()), !dbg !85

  //   store i32 %conv16, i32* @atom_1_X0_1, align 4, !dbg !87, !tbaa !88
  // ST: Guess
  ...
  //   %cmp17 = icmp eq i32 %conv11, 1, !dbg !92
  creg__r7__1_ = max(0,creg_r7);

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !82, metadata !DIExpression()), !dbg !85

  //   store i32 %conv18, i32* @atom_1_X7_1, align 4, !dbg !93, !tbaa !88
  // ST: Guess
  ...
  //   %cmp19 = icmp eq i32 %conv15, 1, !dbg !94
  creg__r8__1_ = max(0,creg_r8);

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !94

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !83, metadata !DIExpression()), !dbg !85

  //   store i32 %conv20, i32* @atom_1_X8_1, align 4, !dbg !95, !tbaa !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X7_1, metadata !143, metadata !DIExpression()), !dbg !179
