...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !73, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !74, metadata !DIExpression()), !dbg !104

  //   %conv11 = sext i32 %add10 to i64, !dbg !86

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !76, metadata !DIExpression()), !dbg !104

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !86
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !77, metadata !DIExpression()), !dbg !89
  ...
  //   store i32 %conv22, i32* @atom_1_X8_1, align 4, !dbg !100, !tbaa !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !130, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !131, metadata !DIExpression()), !dbg !173

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !86

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !86

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !132, metadata !DIExpression()), !dbg !175

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !88

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !88

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !136, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !137, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !140, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !143, metadata !DIExpression()), !dbg !182
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !146, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_1, metadata !150, metadata !DIExpression()), !dbg !186

  //   call void @llvm.dbg.value(metadata i32 0, metadata !152, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X9_1, metadata !153, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !155, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !159, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !160, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !164, metadata !DIExpression()), !dbg !202

  //   %conv18 = trunc i64 %5 to i32, !dbg !118

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !161, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !165, metadata !DIExpression()), !dbg !173
  ...
  //   call void @llvm.dbg.value(metadata i32 %and21, metadata !170, metadata !DIExpression()), !dbg !173

  //   %and22 = and i32 %conv20, %and21, !dbg !127
  creg_r20 = max(creg__r14__1_,creg_r19);
  r20 = (r14==1) & r19;

  //   call void @llvm.dbg.value(metadata i32 %and22, metadata !171, metadata !DIExpression()), !dbg !173

  //   %and23 = and i32 %conv14, %and22, !dbg !128
  creg_r21 = max(creg__r13__2_,creg_r20);
  r21 = (r13==2) & r20;

  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !172, metadata !DIExpression()), !dbg !173
