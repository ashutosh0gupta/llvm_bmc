...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !114, metadata !DIExpression()), !dbg !126
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !116, metadata !DIExpression()), !dbg !129

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !59
  // LD: Guess
  old_cr = cr(4,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !118, metadata !DIExpression()), !dbg !129

  //   %conv = trunc i64 %0 to i32, !dbg !60

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !115, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !120, metadata !DIExpression()), !dbg !133

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !63
  // LD: Guess
  old_cr = cr(4,0+4*1);
  cr(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN LDCOM _l53_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !122, metadata !DIExpression()), !dbg !133

  //   %conv4 = trunc i64 %1 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !119, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !123, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !124, metadata !DIExpression()), !dbg !126
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !144, metadata !DIExpression()), !dbg !156

  //   call void @llvm.dbg.value(metadata i64 1, metadata !146, metadata !DIExpression()), !dbg !156

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !57
  // ST: Guess
  iw(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW _l63_c3
  old_cw = cw(5,0+4*1);
  cw(5,0+4*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM _l63_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !148, metadata !DIExpression()), !dbg !159

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !60
  // LD: Guess
  old_cr = cr(5,0+1*1);
  cr(5,0+1*1) = get_rng(0,NCONTEXT-1);// 5 ASSIGN LDCOM _l65_c16
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !150, metadata !DIExpression()), !dbg !159

  //   %conv = trunc i64 %0 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !147, metadata !DIExpression()), !dbg !153

  //   %cmp = icmp eq i32 %conv, 0, !dbg !62
  ...
  //   store i32 %conv1, i32* @atom_4_X1_0, align 4, !dbg !63, !tbaa !64
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X2_0, metadata !197, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i32 0, metadata !200, metadata !DIExpression()), !dbg !243

  //   store atomic i32 0, i32* @atom_3_X2_0 monotonic, align 4, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_4_X1_0, metadata !201, metadata !DIExpression()), !dbg !245

  //   call void @llvm.dbg.value(metadata i32 0, metadata !203, metadata !DIExpression()), !dbg !245

  //   store atomic i32 0, i32* @atom_4_X1_0 monotonic, align 4, !dbg !120
  // ST: Guess
  iw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l84_c3
  old_cw = cw(0,9);
  cw(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l84_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X0_1, metadata !204, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i32 0, metadata !206, metadata !DIExpression()), !dbg !247

  //   store atomic i32 0, i32* @atom_1_X0_1 monotonic, align 4, !dbg !122
  // ST: Guess
  iw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l85_c3
  old_cw = cw(0,5);
  cw(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l85_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X0_1, metadata !207, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i32 0, metadata !209, metadata !DIExpression()), !dbg !249

  //   store atomic i32 0, i32* @atom_2_X0_1 monotonic, align 4, !dbg !124
  // ST: Guess
  iw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l86_c3
  old_cw = cw(0,6);
  cw(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l86_c3
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_3_X0_1, metadata !210, metadata !DIExpression()), !dbg !251

  //   call void @llvm.dbg.value(metadata i32 0, metadata !212, metadata !DIExpression()), !dbg !251

  //   store atomic i32 0, i32* @atom_3_X0_1 monotonic, align 4, !dbg !126
  // ST: Guess
  iw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STIW _l87_c3
  old_cw = cw(0,8);
  cw(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN STCOM _l87_c3
  // Check
  ...
  //   %10 = load i32, i32* @atom_3_X2_0, align 4, !dbg !146, !tbaa !147
  // LD: Guess
  old_cr = cr(0,7);
  cr(0,7) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l101_c13
  // Check
  ...
  //   %11 = load i32, i32* @atom_4_X1_0, align 4, !dbg !149, !tbaa !147
  // LD: Guess
  old_cr = cr(0,9);
  cr(0,9) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l102_c13
  // Check
  ...
  //   %12 = load i32, i32* @atom_1_X0_1, align 4, !dbg !150, !tbaa !147
  // LD: Guess
  old_cr = cr(0,5);
  cr(0,5) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l103_c13
  // Check
  ...
  //   %13 = load i32, i32* @atom_2_X0_1, align 4, !dbg !151, !tbaa !147
  // LD: Guess
  old_cr = cr(0,6);
  cr(0,6) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l104_c13
  // Check
  ...
  //   %14 = load i32, i32* @atom_3_X0_1, align 4, !dbg !152, !tbaa !147
  // LD: Guess
  old_cr = cr(0,8);
  cr(0,8) = get_rng(0,NCONTEXT-1);// 0 ASSIGN LDCOM _l105_c13
  // Check
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([107 x i8], [107 x i8]* @.str.1, i64 0, i64 0), i32 noundef 110, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !160
