...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !118, metadata !DIExpression()), !dbg !136
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !120, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !122, metadata !DIExpression()), !dbg !139

  //   %conv = trunc i64 %0 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !119, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !124, metadata !DIExpression()), !dbg !143
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !126, metadata !DIExpression()), !dbg !143

  //   %conv4 = trunc i64 %1 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !123, metadata !DIExpression()), !dbg !136

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !71

  //   %conv5 = zext i1 %cmp to i32, !dbg !71

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !127, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !128, metadata !DIExpression()), !dbg !147

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !130, metadata !DIExpression()), !dbg !147
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !131, metadata !DIExpression()), !dbg !136

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !132, metadata !DIExpression()), !dbg !150

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !134, metadata !DIExpression()), !dbg !150
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !156, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !160, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !162, metadata !DIExpression()), !dbg !174

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !159, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X1_0, metadata !164, metadata !DIExpression()), !dbg !178
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X1_0, metadata !216, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X1_0, metadata !233, metadata !DIExpression()), !dbg !305
