...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X8_0, metadata !154, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_1_X10_0, metadata !157, metadata !DIExpression()), !dbg !202
  ...
  //   %9 = load i32, i32* @atom_1_X8_0, align 4, !dbg !143, !tbaa !140
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   %10 = load i32, i32* @atom_1_X10_0, align 4, !dbg !144, !tbaa !140
  // LD: Guess
  old_cr = cr(0,6);
