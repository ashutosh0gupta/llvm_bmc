...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !80, metadata !DIExpression()), !dbg !90
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !81, metadata !DIExpression()), !dbg !93

  //   call void @llvm.dbg.value(metadata i64 2, metadata !83, metadata !DIExpression()), !dbg !93

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !53
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !85, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !87, metadata !DIExpression()), !dbg !95

  //   %conv = trunc i64 %0 to i32, !dbg !56

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !84, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !88, metadata !DIExpression()), !dbg !90
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32* @atom_2_X2_0, metadata !154, metadata !DIExpression()), !dbg !188

  //   call void @llvm.dbg.value(metadata i32 0, metadata !156, metadata !DIExpression()), !dbg !188

  //   store atomic i32 0, i32* @atom_2_X2_0 monotonic, align 4, !dbg !99
  // ST: Guess
  ...
  //   %10 = load i32, i32* @atom_2_X2_0, align 4, !dbg !125, !tbaa !123
  // LD: Guess
  old_cr = cr(0,4);
