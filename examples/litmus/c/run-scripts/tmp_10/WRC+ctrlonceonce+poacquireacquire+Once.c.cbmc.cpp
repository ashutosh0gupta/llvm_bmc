...
T2BLOCK2:
  //   br label %lbl_label34, !dbg !64
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label34, !dbg !65
  goto T2BLOCK4;
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([123 x i8], [123 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
