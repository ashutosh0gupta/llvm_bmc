...
T2BLOCK4:
  ...
  //   %cmp15 = icmp eq i32 %conv8, 0, !dbg !96

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !80, metadata !DIExpression()), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !81, metadata !DIExpression()), !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !85, metadata !DIExpression()), !dbg !119

  //   %6 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !87, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %6, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !101
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !148, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !151, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !169, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !173, metadata !DIExpression()), !dbg !221
