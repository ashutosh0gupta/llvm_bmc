...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv7, 0, !dbg !99
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !94, metadata !DIExpression()), !dbg !138

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !96, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %6, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !120
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv15, 1, !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !98, metadata !DIExpression()), !dbg !141
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !184, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !187, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !190, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !213, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !217, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !221, metadata !DIExpression()), !dbg !285
