...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !70, metadata !DIExpression()), !dbg !100

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !71, metadata !DIExpression()), !dbg !111

  //   %conv5 = sext i32 %add to i64, !dbg !93

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !73, metadata !DIExpression()), !dbg !111

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !93
  // ST: Guess
  ...
  //   %xor10 = xor i32 %conv9, %conv9, !dbg !97
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor10, metadata !78, metadata !DIExpression()), !dbg !100

  //   %add12 = add nsw i32 0, %xor10, !dbg !98
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add12 to i64, !dbg !98
  ...
  //   %cmp20 = icmp eq i32 %conv4, 1, !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !88, metadata !DIExpression()), !dbg !124

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %5, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv9, 2, !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !92, metadata !DIExpression()), !dbg !127

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %6, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !109
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !96, metadata !DIExpression()), !dbg !130

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !112
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !173, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !176, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !179, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !202, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !206, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !210, metadata !DIExpression()), !dbg !274
