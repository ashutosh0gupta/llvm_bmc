...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !72, metadata !DIExpression()), !dbg !118

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !100
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   %tobool = icmp ne i32 %conv8, 0, !dbg !102
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !107), !dbg !126
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !95, metadata !DIExpression()), !dbg !148

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %7, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !197, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !200, metadata !DIExpression()), !dbg !268

  //   call void @llvm.dbg.value(metadata i64 0, metadata !202, metadata !DIExpression()), !dbg !268

  //   store atomic i64 0, i64* @atom_1_X3_2 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !229, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !233, metadata !DIExpression()), !dbg !305

  //   %11 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !175
  // LD: Guess
  old_cr = cr(0,5);
