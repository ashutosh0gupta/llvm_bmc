...
T2BLOCK1:
  ...
  //   %add10 = add nsw i32 0, %and8, !dbg !90
  ...
  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !101
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !127, metadata !DIExpression()), !dbg !132

  //   store atomic i64 3, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !47
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_3, metadata !162, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64 0, metadata !164, metadata !DIExpression()), !dbg !203

  //   store atomic i64 0, i64* @atom_1_X5_3 monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !165, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !205

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_3, metadata !178, metadata !DIExpression()), !dbg !227

  //   %8 = load atomic i64, i64* @atom_1_X5_3 seq_cst, align 8, !dbg !128
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !182, metadata !DIExpression()), !dbg !230

  //   %9 = load atomic i64, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,5);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 80, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !139
