...
T2BLOCK1:
  ...
  //   %xor8 = xor i32 %conv7, %conv7, !dbg !92
  creg_r4 = max(creg_r3,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 ^ r3;

  //   call void @llvm.dbg.value(metadata i32 %xor8, metadata !75, metadata !DIExpression()), !dbg !96

  //   %add10 = add nsw i32 0, %xor8, !dbg !93
  creg_r5 = max(0,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = 0 + r4;

  //   %idxprom = sext i32 %add10 to i64, !dbg !93
  ...
  //   %cmp20 = icmp eq i32 %conv7, 2, !dbg !101

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !101

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !87, metadata !DIExpression()), !dbg !96

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !88, metadata !DIExpression()), !dbg !121
