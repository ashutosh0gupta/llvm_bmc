...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !108), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !92, metadata !DIExpression()), !dbg !141

  //   %6 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %6, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !123
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !96, metadata !DIExpression()), !dbg !144
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !193, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !196, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !225, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !229, metadata !DIExpression()), !dbg !301
