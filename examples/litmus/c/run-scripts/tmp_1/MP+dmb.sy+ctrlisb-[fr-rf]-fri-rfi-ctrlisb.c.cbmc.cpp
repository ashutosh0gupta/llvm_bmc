...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !122

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !104
  // LD: Guess
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !125

  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !107
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !128

  //   call void @llvm.dbg.value(metadata i64 2, metadata !77, metadata !DIExpression()), !dbg !128

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !110
  // ST: Guess
...
T2BLOCK7:
  ...
  //   %cmp24 = icmp eq i32 %conv4, 0, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !91, metadata !DIExpression()), !dbg !147

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !129
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv8, 1, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !95, metadata !DIExpression()), !dbg !150

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !132
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv12, 2, !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !99, metadata !DIExpression()), !dbg !153

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %8, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !135
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !199, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !202, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !205, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !231, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !235, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !239, metadata !DIExpression()), !dbg !310
