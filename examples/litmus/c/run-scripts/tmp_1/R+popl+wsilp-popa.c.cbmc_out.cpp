...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !81, metadata !DIExpression()), !dbg !96
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !119, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64 0, metadata !121, metadata !DIExpression()), !dbg !155

  //   store atomic i64 0, i64* @atom_0_X4_2 monotonic, align 8, !dbg !90
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !122, metadata !DIExpression()), !dbg !157
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !136, metadata !DIExpression()), !dbg !177

  //   %6 = load atomic i64, i64* @atom_0_X4_2 seq_cst, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !140, metadata !DIExpression()), !dbg !180
