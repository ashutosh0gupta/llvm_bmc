...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !82, metadata !DIExpression()), !dbg !104
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !85, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !87, metadata !DIExpression()), !dbg !109
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !89, metadata !DIExpression()), !dbg !109
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !91, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !93, metadata !DIExpression()), !dbg !118
  ...
  //   %conv5 = zext i1 %cmp to i32, !dbg !78

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !94, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !95, metadata !DIExpression()), !dbg !122

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !97, metadata !DIExpression()), !dbg !122

  //   store atomic i64 %2, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !80
  // ST: Guess
  ...
  //   %cmp9 = icmp eq i32 %conv4, 0, !dbg !81

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !98, metadata !DIExpression()), !dbg !104

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !99, metadata !DIExpression()), !dbg !125

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !101, metadata !DIExpression()), !dbg !125

  //   store atomic i64 %3, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !151, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !154, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !157, metadata !DIExpression()), !dbg !201
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !171, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !175, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !179, metadata !DIExpression()), !dbg !227
