...
T2BLOCK4:
  ...
  //   %tobool7 = icmp ne i32 %conv6, 0, !dbg !94

  //   br i1 %tobool7, label %if.then8, label %if.else9, !dbg !96
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !87, metadata !DIExpression()), !dbg !128

  //   %conv13 = trunc i64 %2 to i32, !dbg !102

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !84, metadata !DIExpression()), !dbg !103

  //   %cmp = icmp eq i32 %conv, 1, !dbg !103

  //   %conv14 = zext i1 %cmp to i32, !dbg !103

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !88, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !89, metadata !DIExpression()), !dbg !132

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !91, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %3, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !105
  // ST: Guess
  ...
  //   %cmp18 = icmp eq i32 %conv6, 1, !dbg !106

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !106

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !92, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !93, metadata !DIExpression()), !dbg !135

  //   %4 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !95, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %4, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !108
  // ST: Guess
  ...
  //   %cmp23 = icmp eq i32 %conv13, 0, !dbg !109

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !96, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !97, metadata !DIExpression()), !dbg !138

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !99, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %5, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !111
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !164, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_0, metadata !192, metadata !DIExpression()), !dbg !254
