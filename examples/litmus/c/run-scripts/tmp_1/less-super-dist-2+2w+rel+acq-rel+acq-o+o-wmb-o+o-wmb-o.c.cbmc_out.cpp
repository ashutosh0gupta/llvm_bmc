...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !110, metadata !DIExpression()), !dbg !118
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !153, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !157, metadata !DIExpression()), !dbg !211

  //   %9 = load atomic i64, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   %conv19 = trunc i64 %9 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !156, metadata !DIExpression()), !dbg !173

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !214

  //   %10 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !127
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !163, metadata !DIExpression()), !dbg !214

  //   %conv23 = trunc i64 %10 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !160, metadata !DIExpression()), !dbg !173

  //   %cmp = icmp eq i32 %conv23, 2, !dbg !129

  //   %conv24 = zext i1 %cmp to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !164, metadata !DIExpression()), !dbg !173
  ...
  //   %11 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   %conv28 = trunc i64 %11 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !165, metadata !DIExpression()), !dbg !173

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !133

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !169, metadata !DIExpression()), !dbg !173

  //   %and = and i32 %conv24, %conv30, !dbg !134
  creg_r11 = max(max(creg_r9,0),max(creg_r10,0));
  ASSUME(active[creg_r11] == 0);
  r11 = (r9==2) & (r10==1);

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !170, metadata !DIExpression()), !dbg !173

  //   %and31 = and i32 %conv19, %and, !dbg !135
  ...
  //   %and32 = and i32 %conv, %and31, !dbg !136
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([139 x i8], [139 x i8]* @.str.1, i64 0, i64 0), i32 noundef 81, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !140
