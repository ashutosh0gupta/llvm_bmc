...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !83, metadata !DIExpression()), !dbg !145

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !127
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !145

  //   %conv22 = trunc i64 %4 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !82, metadata !DIExpression()), !dbg !110

  //   %cmp = icmp eq i32 %conv, 1, !dbg !129

  //   %conv23 = zext i1 %cmp to i32, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %5, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !131
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv4, 1, !dbg !132

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !90, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !91, metadata !DIExpression()), !dbg !152

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %6, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv11, 0, !dbg !135

  //   %conv33 = zext i1 %cmp32 to i32, !dbg !135

  //   call void @llvm.dbg.value(metadata i32 %conv33, metadata !94, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !95, metadata !DIExpression()), !dbg !155

  //   %7 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !137
  // ST: Guess
  ...
  //   %cmp37 = icmp eq i32 %conv15, 1, !dbg !138

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !98, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !99, metadata !DIExpression()), !dbg !158

  //   %8 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !158

  //   store atomic i64 %8, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !140
  // ST: Guess
  ...
  //   %cmp42 = icmp eq i32 %conv22, 0, !dbg !141

  //   %conv43 = zext i1 %cmp42 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv43, metadata !102, metadata !DIExpression()), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !103, metadata !DIExpression()), !dbg !161

  //   %9 = zext i32 %conv43 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !161

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !143
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !167, metadata !DIExpression()), !dbg !174
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !184, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !185, metadata !DIExpression()), !dbg !267

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !130

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !130

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !186, metadata !DIExpression()), !dbg !269

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !132

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !132

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !190, metadata !DIExpression()), !dbg !271

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !134

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !134

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !191, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !192, metadata !DIExpression()), !dbg !274

  //   call void @llvm.dbg.value(metadata i64 0, metadata !194, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !195, metadata !DIExpression()), !dbg !276

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !198, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !201, metadata !DIExpression()), !dbg !280

  //   call void @llvm.dbg.value(metadata i64 0, metadata !203, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !204, metadata !DIExpression()), !dbg !282

  //   call void @llvm.dbg.value(metadata i64 0, metadata !206, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !207, metadata !DIExpression()), !dbg !284

  //   call void @llvm.dbg.value(metadata i64 0, metadata !209, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !210, metadata !DIExpression()), !dbg !286

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !213, metadata !DIExpression()), !dbg !288

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !216, metadata !DIExpression()), !dbg !290

  //   call void @llvm.dbg.value(metadata i64 0, metadata !218, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !220, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !222, metadata !DIExpression()), !dbg !305

  //   %conv = trunc i64 %6 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !219, metadata !DIExpression()), !dbg !267

  //   %cmp = icmp eq i32 %conv, 1, !dbg !170

  //   %conv22 = zext i1 %cmp to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !223, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !225, metadata !DIExpression()), !dbg !309
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !227, metadata !DIExpression()), !dbg !309

  //   %conv26 = trunc i64 %7 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !224, metadata !DIExpression()), !dbg !267

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !174

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !228, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !230, metadata !DIExpression()), !dbg !313
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !232, metadata !DIExpression()), !dbg !313

  //   %conv32 = trunc i64 %8 to i32, !dbg !177

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !229, metadata !DIExpression()), !dbg !267

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !178

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !233, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !235, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !237, metadata !DIExpression()), !dbg !317

  //   %conv38 = trunc i64 %9 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !234, metadata !DIExpression()), !dbg !267

  //   %cmp39 = icmp eq i32 %conv38, 1, !dbg !182

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !238, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !242, metadata !DIExpression()), !dbg !321

  //   %conv44 = trunc i64 %10 to i32, !dbg !185

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !239, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !244, metadata !DIExpression()), !dbg !324
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !246, metadata !DIExpression()), !dbg !324

  //   %conv48 = trunc i64 %11 to i32, !dbg !188

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !243, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !248, metadata !DIExpression()), !dbg !327
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !250, metadata !DIExpression()), !dbg !327

  //   %conv52 = trunc i64 %12 to i32, !dbg !191

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !247, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !252, metadata !DIExpression()), !dbg !330
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !254, metadata !DIExpression()), !dbg !330

  //   %conv56 = trunc i64 %13 to i32, !dbg !194

  //   call void @llvm.dbg.value(metadata i32 %conv56, metadata !251, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !256, metadata !DIExpression()), !dbg !333
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !258, metadata !DIExpression()), !dbg !333

  //   %conv60 = trunc i64 %14 to i32, !dbg !197

  //   call void @llvm.dbg.value(metadata i32 %conv60, metadata !255, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !259, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i32 %and61, metadata !260, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i32 %and62, metadata !261, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i32 %and63, metadata !262, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i32 %and64, metadata !263, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i32 %and65, metadata !264, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i32 %and66, metadata !265, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i32 %and67, metadata !266, metadata !DIExpression()), !dbg !267
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([121 x i8], [121 x i8]* @.str.1, i64 0, i64 0), i32 noundef 106, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
