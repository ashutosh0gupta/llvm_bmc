...
T2BLOCK1:
  ...
  //   %cmp29 = icmp eq i32 %conv12, 2, !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !92, metadata !DIExpression()), !dbg !131

  //   %6 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %6, i64* @atom_1_X8_2 seq_cst, align 8, !dbg !113
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !183, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !189, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !191, metadata !DIExpression()), !dbg !250

  //   store atomic i64 0, i64* @atom_1_X12_0 monotonic, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !212, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X12_0, metadata !220, metadata !DIExpression()), !dbg !286

  //   %12 = load atomic i64, i64* @atom_1_X12_0 seq_cst, align 8, !dbg !171
  // LD: Guess
  old_cr = cr(0,7);
