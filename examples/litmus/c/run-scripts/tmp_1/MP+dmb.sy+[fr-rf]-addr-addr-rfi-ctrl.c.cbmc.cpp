...
T2BLOCK1:
  ...
  //   %add10 = add nsw i32 3, %xor9, !dbg !99
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 3 + r6;

  //   %idxprom11 = sext i32 %add10 to i64, !dbg !99

  //   %arrayidx12 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom11, !dbg !99
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx12, metadata !75, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !119

  //   store atomic i64 1, i64* %arrayidx12 monotonic, align 8, !dbg !99
  // ST: Guess
...
T2BLOCK4:
  ...
  //   %cmp30 = icmp eq i32 %conv16, 1, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !95, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %7, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !191, metadata !DIExpression()), !dbg !253
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !221, metadata !DIExpression()), !dbg !288
