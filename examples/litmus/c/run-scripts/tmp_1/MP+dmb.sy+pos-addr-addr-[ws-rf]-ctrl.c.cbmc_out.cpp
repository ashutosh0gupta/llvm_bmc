...
T2BLOCK4:
  ...
  //   %cmp30 = icmp eq i32 %conv16, 2, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_2, metadata !95, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %7, i64* @atom_1_X9_2 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_2, metadata !191, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64 0, metadata !193, metadata !DIExpression()), !dbg !253

  //   store atomic i64 0, i64* @atom_1_X9_2 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_2, metadata !221, metadata !DIExpression()), !dbg !288

  //   %11 = load atomic i64, i64* @atom_1_X9_2 seq_cst, align 8, !dbg !168
  // LD: Guess
  old_cr = cr(0,6);
