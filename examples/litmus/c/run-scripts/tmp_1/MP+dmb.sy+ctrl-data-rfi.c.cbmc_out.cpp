...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !66, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !67, metadata !DIExpression()), !dbg !101

  //   %conv5 = sext i32 %add to i64, !dbg !83

  //   call void @llvm.dbg.value(metadata i64 %conv5, metadata !69, metadata !DIExpression()), !dbg !101

  //   store atomic i64 %conv5, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !83
  // ST: Guess
  ...
  //   %conv9 = trunc i64 %2 to i32, !dbg !86

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !70, metadata !DIExpression()), !dbg !84

  //   %cmp = icmp eq i32 %conv, 1, !dbg !87

  //   %conv10 = zext i1 %cmp to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !74, metadata !DIExpression()), !dbg !84
  ...
  //   %cmp14 = icmp eq i32 %conv9, 1, !dbg !90

  //   %conv15 = zext i1 %cmp14 to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !78, metadata !DIExpression()), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !79, metadata !DIExpression()), !dbg !110
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !139, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !157, metadata !DIExpression()), !dbg !199
