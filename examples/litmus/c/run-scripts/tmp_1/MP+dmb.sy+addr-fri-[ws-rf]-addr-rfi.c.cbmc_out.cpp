...
T2BLOCK1:
  ...
  //   %1 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !90
  // LD: Guess
  old_cr = cr(2,r3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !69, metadata !DIExpression()), !dbg !110

  //   %conv4 = trunc i64 %1 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !66, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !70, metadata !DIExpression()), !dbg !112
  ...
  //   %cmp23 = icmp eq i32 %conv4, 0, !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !90, metadata !DIExpression()), !dbg !127
