...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !105, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !109, metadata !DIExpression()), !dbg !126
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !185, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !230

  //   store atomic i64 0, i64* @atom_2_X2_0 monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !201, metadata !DIExpression()), !dbg !257

  //   %11 = load atomic i64, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,7);
