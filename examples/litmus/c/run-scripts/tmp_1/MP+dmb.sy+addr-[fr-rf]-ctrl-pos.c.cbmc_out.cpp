...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !105), !dbg !124
  ...
  //   %cmp24 = icmp eq i32 %conv8, 1, !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !93, metadata !DIExpression()), !dbg !138

  //   %7 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !138

  //   store atomic i64 %7, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !120
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv12, 0, !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !97, metadata !DIExpression()), !dbg !141
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !101, metadata !DIExpression()), !dbg !144

  //   %9 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !103, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %9, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !126
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !190, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !193, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !196, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !223, metadata !DIExpression()), !dbg !295
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !227, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !231, metadata !DIExpression()), !dbg !301
