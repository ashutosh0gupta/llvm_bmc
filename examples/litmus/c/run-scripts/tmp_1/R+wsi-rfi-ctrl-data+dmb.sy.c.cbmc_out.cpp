...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64 2, metadata !42, metadata !DIExpression()), !dbg !68

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !69
  // ST: Guess
  iw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0);
  cw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !45, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !47, metadata !DIExpression()), !dbg !70
...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !48, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !52, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !53, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !57, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !58, metadata !DIExpression()), !dbg !87

  //   %2 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !60, metadata !DIExpression()), !dbg !87

  //   store atomic i64 %2, i64* @atom_0_X3_2 seq_cst, align 8, !dbg !88
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !141, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !158, metadata !DIExpression()), !dbg !201
