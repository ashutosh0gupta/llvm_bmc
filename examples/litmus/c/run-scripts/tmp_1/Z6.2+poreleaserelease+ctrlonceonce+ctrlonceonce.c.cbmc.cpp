...
T2BLOCK2:
  //   br label %lbl_label206, !dbg !62
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label206, !dbg !63
  goto T2BLOCK4;
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !96, metadata !DIExpression()), !dbg !106
...
T3BLOCK2:
  //   br label %lbl_label207, !dbg !62
  goto T3BLOCK4;

T3BLOCK3:
  //   br label %lbl_label207, !dbg !63
  goto T3BLOCK4;

T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !105), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !97, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !100, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !101, metadata !DIExpression()), !dbg !122

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !103, metadata !DIExpression()), !dbg !122
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !132, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !133, metadata !DIExpression()), !dbg !170

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !79

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !79

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !134, metadata !DIExpression()), !dbg !172

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !81

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !81

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !138, metadata !DIExpression()), !dbg !174

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !139, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !146, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !158, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !159, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !161, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !163, metadata !DIExpression()), !dbg !204

  //   %conv18 = trunc i64 %7 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !160, metadata !DIExpression()), !dbg !170

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !165, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !167, metadata !DIExpression()), !dbg !207

  //   %conv22 = trunc i64 %8 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !164, metadata !DIExpression()), !dbg !170
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([132 x i8], [132 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
