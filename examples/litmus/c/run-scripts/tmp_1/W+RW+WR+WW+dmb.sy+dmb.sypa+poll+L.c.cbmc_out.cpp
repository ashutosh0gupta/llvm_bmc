...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !79, metadata !DIExpression()), !dbg !94

  //   call void @llvm.dbg.value(metadata i64 2, metadata !81, metadata !DIExpression()), !dbg !94

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !54
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !87, metadata !DIExpression()), !dbg !101

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !89, metadata !DIExpression()), !dbg !101

  //   store atomic i64 %1, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !61
  // ST: Guess
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !107, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64 1, metadata !109, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 1, metadata !112, metadata !DIExpression()), !dbg !119
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !150, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64 0, metadata !152, metadata !DIExpression()), !dbg !191

  //   store atomic i64 0, i64* @atom_2_X2_0 monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !168, metadata !DIExpression()), !dbg !220

  //   %11 = load atomic i64, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
