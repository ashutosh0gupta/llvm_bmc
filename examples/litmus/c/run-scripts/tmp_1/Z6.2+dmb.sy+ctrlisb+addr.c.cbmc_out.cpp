...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !96, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !97, metadata !DIExpression()), !dbg !113
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([109 x i8], [109 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
