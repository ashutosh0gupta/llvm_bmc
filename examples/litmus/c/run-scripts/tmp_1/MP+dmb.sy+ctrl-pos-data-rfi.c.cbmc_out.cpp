...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !100
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !73, metadata !DIExpression()), !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !74, metadata !DIExpression()), !dbg !88
  ...
  //   %cmp18 = icmp eq i32 %conv13, 1, !dbg !97

  //   %conv19 = zext i1 %cmp18 to i32, !dbg !97

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !82, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !83, metadata !DIExpression()), !dbg !117
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !143, metadata !DIExpression()), !dbg !181
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !146, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !155, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !164, metadata !DIExpression()), !dbg !206
