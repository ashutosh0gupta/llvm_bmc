...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !48, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !50, metadata !DIExpression()), !dbg !82

  //   %conv4 = trunc i64 %1 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !47, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !51, metadata !DIExpression()), !dbg !85

  //   call void @llvm.dbg.value(metadata i64 1, metadata !53, metadata !DIExpression()), !dbg !85

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !86
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !55, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !54, metadata !DIExpression()), !dbg !68

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !90

  //   %conv11 = zext i1 %cmp to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !58, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !59, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !62, metadata !DIExpression()), !dbg !68

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !63, metadata !DIExpression()), !dbg !94

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !65, metadata !DIExpression()), !dbg !94

  //   store atomic i64 %4, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !95
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !108, metadata !DIExpression()), !dbg !121
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !147, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !167, metadata !DIExpression()), !dbg !217
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !144
