...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !146, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !147, metadata !DIExpression()), !dbg !207

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !104

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !104

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !148, metadata !DIExpression()), !dbg !209

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !106

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !106

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !152, metadata !DIExpression()), !dbg !211

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !108

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !108

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !153, metadata !DIExpression()), !dbg !213

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !154, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !157, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !160, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !163, metadata !DIExpression()), !dbg !220
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !166, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !169, metadata !DIExpression()), !dbg !224
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !172, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !176, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !178, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !179, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !181, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !183, metadata !DIExpression()), !dbg !245

  //   %conv22 = trunc i64 %7 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !180, metadata !DIExpression()), !dbg !207

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !144

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !184, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !186, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !188, metadata !DIExpression()), !dbg !249

  //   %conv28 = trunc i64 %8 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !185, metadata !DIExpression()), !dbg !207

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !148

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !148

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !189, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !193, metadata !DIExpression()), !dbg !253

  //   %conv34 = trunc i64 %9 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !190, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !195, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !197, metadata !DIExpression()), !dbg !256

  //   %conv38 = trunc i64 %10 to i32, !dbg !154

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !194, metadata !DIExpression()), !dbg !207

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !199, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !201, metadata !DIExpression()), !dbg !259

  //   %conv42 = trunc i64 %11 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !198, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %and43, metadata !203, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !204, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !205, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !206, metadata !DIExpression()), !dbg !207
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([117 x i8], [117 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
