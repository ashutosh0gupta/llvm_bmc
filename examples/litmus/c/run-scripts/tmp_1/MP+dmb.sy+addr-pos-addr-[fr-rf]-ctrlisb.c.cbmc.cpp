...
T2BLOCK4:
  ...
  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp27 = icmp eq i32 %conv16, 0, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !92, metadata !DIExpression()), !dbg !139

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %7, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !121
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv20, 1, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !96, metadata !DIExpression()), !dbg !142

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !142

  //   store atomic i64 %8, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !124
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !191, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !194, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !220, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !224, metadata !DIExpression()), !dbg !291
