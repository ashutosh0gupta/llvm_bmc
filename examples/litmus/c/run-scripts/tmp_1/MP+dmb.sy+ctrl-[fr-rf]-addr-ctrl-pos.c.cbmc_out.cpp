...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !77, metadata !DIExpression()), !dbg !131

  //   %3 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,r5);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !110), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !139

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !139
