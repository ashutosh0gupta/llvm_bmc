...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_2, metadata !89, metadata !DIExpression()), !dbg !131

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !91, metadata !DIExpression()), !dbg !131

  //   store atomic i64 %6, i64* @atom_1_X9_2 seq_cst, align 8, !dbg !113
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_2, metadata !180, metadata !DIExpression()), !dbg !235

  //   call void @llvm.dbg.value(metadata i64 0, metadata !182, metadata !DIExpression()), !dbg !235

  //   store atomic i64 0, i64* @atom_1_X9_2 monotonic, align 8, !dbg !121
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_2, metadata !206, metadata !DIExpression()), !dbg !267

  //   %10 = load atomic i64, i64* @atom_1_X9_2 seq_cst, align 8, !dbg !153
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !210, metadata !DIExpression()), !dbg !270
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([124 x i8], [124 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !166
