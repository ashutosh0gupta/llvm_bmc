...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !48, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !49, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !53, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i32 %add8, metadata !54, metadata !DIExpression()), !dbg !63

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !55, metadata !DIExpression()), !dbg !79

  //   %conv11 = sext i32 %add8 to i64, !dbg !80

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !57, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !59, metadata !DIExpression()), !dbg !82

  //   %2 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !61, metadata !DIExpression()), !dbg !82

  //   store atomic i64 %2, i64* @atom_0_X3_2 seq_cst, align 8, !dbg !83
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !136, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_2, metadata !153, metadata !DIExpression()), !dbg !196
