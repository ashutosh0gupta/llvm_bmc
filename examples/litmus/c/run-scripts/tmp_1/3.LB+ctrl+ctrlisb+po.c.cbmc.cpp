...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !117, metadata !DIExpression()), !dbg !130
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !157, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !160, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !163, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !167, metadata !DIExpression()), !dbg !212
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !166, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !171, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !170, metadata !DIExpression()), !dbg !180

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !175, metadata !DIExpression()), !dbg !218
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !177, metadata !DIExpression()), !dbg !218

  //   %conv23 = trunc i64 %8 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !174, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !178, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i32 %and24, metadata !179, metadata !DIExpression()), !dbg !180
