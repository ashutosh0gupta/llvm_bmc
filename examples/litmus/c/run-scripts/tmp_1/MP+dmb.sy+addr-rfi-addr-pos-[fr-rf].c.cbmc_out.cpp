...
T2BLOCK1:
  ...
  //   %xor5 = xor i32 %conv4, %conv4, !dbg !102
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !75, metadata !DIExpression()), !dbg !109

  //   %add7 = add nsw i32 0, %xor5, !dbg !103
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !103

  //   %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !103
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !77, metadata !DIExpression()), !dbg !123

  //   %2 = load atomic i64, i64* %arrayidx9 monotonic, align 8, !dbg !103
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   %conv12 = trunc i64 %2 to i32, !dbg !105
  ...
  //   %cmp30 = icmp eq i32 %conv12, 0, !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !97, metadata !DIExpression()), !dbg !138
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !101, metadata !DIExpression()), !dbg !141
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !190, metadata !DIExpression()), !dbg !258

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !258

  //   store atomic i64 0, i64* @atom_1_X7_0 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !193, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !223, metadata !DIExpression()), !dbg !295
  ...
  //   %12 = load atomic i64, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !178
  // LD: Guess
  old_cr = cr(0,6);
