...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !131, metadata !DIExpression()), !dbg !145
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !155, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !159, metadata !DIExpression()), !dbg !177
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !189, metadata !DIExpression()), !dbg !197
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !190, metadata !DIExpression()), !dbg !200

  //   call void @llvm.dbg.value(metadata i64 1, metadata !192, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !193, metadata !DIExpression()), !dbg !203

  //   call void @llvm.dbg.value(metadata i64 1, metadata !195, metadata !DIExpression()), !dbg !203
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !245, metadata !DIExpression()), !dbg !316
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !265, metadata !DIExpression()), !dbg !351
