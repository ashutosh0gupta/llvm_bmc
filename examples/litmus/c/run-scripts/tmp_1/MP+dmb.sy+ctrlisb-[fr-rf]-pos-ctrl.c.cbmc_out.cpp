...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !134
  ...
  //   %cmp22 = icmp eq i32 %conv4, 0, !dbg !121

  //   %conv23 = zext i1 %cmp22 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !87, metadata !DIExpression()), !dbg !106

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !88, metadata !DIExpression()), !dbg !141

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !141

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !123
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv8, 1, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !92, metadata !DIExpression()), !dbg !144

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !126
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !96, metadata !DIExpression()), !dbg !147

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !147
  ...
  //   %cmp37 = icmp eq i32 %conv19, 0, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !100, metadata !DIExpression()), !dbg !150

  //   %9 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %9, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !132
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !156, metadata !DIExpression()), !dbg !163
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !173, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !174, metadata !DIExpression()), !dbg !247

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !175, metadata !DIExpression()), !dbg !249

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !123

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !123

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !179, metadata !DIExpression()), !dbg !251

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !125

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !125

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !180, metadata !DIExpression()), !dbg !253

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !181, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !184, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !187, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !193, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !196, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !199, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !202, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !206, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !208, metadata !DIExpression()), !dbg !283

  //   %conv = trunc i64 %6 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !205, metadata !DIExpression()), !dbg !247

  //   %cmp = icmp eq i32 %conv, 1, !dbg !159

  //   %conv20 = zext i1 %cmp to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !209, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !211, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !213, metadata !DIExpression()), !dbg !287

  //   %conv24 = trunc i64 %7 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !210, metadata !DIExpression()), !dbg !247

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !163

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !214, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !216, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !218, metadata !DIExpression()), !dbg !291

  //   %conv30 = trunc i64 %8 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !215, metadata !DIExpression()), !dbg !247

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !167

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !219, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !223, metadata !DIExpression()), !dbg !295

  //   %conv36 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !220, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !225, metadata !DIExpression()), !dbg !298
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !224, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !229, metadata !DIExpression()), !dbg !301
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !228, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !233, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !232, metadata !DIExpression()), !dbg !247

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !237, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !236, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !240, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !241, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !242, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !243, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !244, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !245, metadata !DIExpression()), !dbg !247
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !246, metadata !DIExpression()), !dbg !247
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([119 x i8], [119 x i8]* @.str.1, i64 0, i64 0), i32 noundef 100, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !193
