...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !138

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp25 = icmp eq i32 %conv4, 1, !dbg !125

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !87, metadata !DIExpression()), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !88, metadata !DIExpression()), !dbg !145

  //   %5 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %5, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv13, 2, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !92, metadata !DIExpression()), !dbg !148

  //   %6 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %6, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   %cmp35 = icmp eq i32 %conv20, 0, !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !96, metadata !DIExpression()), !dbg !151

  //   %7 = zext i32 %conv36 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %7, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !133
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !157, metadata !DIExpression()), !dbg !164
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !174, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !175, metadata !DIExpression()), !dbg !249

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !176, metadata !DIExpression()), !dbg !251

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !180, metadata !DIExpression()), !dbg !253

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !181, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !182, metadata !DIExpression()), !dbg !256

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !185, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !188, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !191, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !200, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !203, metadata !DIExpression()), !dbg !270
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !207, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !209, metadata !DIExpression()), !dbg !285

  //   %conv = trunc i64 %6 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !206, metadata !DIExpression()), !dbg !249

  //   %cmp = icmp eq i32 %conv, 2, !dbg !158

  //   %conv20 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !210, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !212, metadata !DIExpression()), !dbg !289
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !214, metadata !DIExpression()), !dbg !289

  //   %conv24 = trunc i64 %7 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !211, metadata !DIExpression()), !dbg !249

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !162

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !215, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !217, metadata !DIExpression()), !dbg !293
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !219, metadata !DIExpression()), !dbg !293

  //   %conv30 = trunc i64 %8 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !216, metadata !DIExpression()), !dbg !249

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !166

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !220, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !222, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !224, metadata !DIExpression()), !dbg !297

  //   %conv36 = trunc i64 %9 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !221, metadata !DIExpression()), !dbg !249

  //   %cmp37 = icmp eq i32 %conv36, 1, !dbg !170

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !225, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !229, metadata !DIExpression()), !dbg !301

  //   %conv42 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !226, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !231, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !233, metadata !DIExpression()), !dbg !304

  //   %conv46 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !230, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !235, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !237, metadata !DIExpression()), !dbg !307

  //   %conv50 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !234, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !239, metadata !DIExpression()), !dbg !310
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !241, metadata !DIExpression()), !dbg !310

  //   %conv54 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !238, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !243, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !244, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !245, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !246, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !247, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !248, metadata !DIExpression()), !dbg !249
