...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !96, metadata !DIExpression()), !dbg !143

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !98, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %7, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !125
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !195, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !263

  //   store atomic i64 0, i64* @atom_1_X6_2 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !228, metadata !DIExpression()), !dbg !300

  //   %11 = load atomic i64, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !175
  // LD: Guess
  old_cr = cr(0,5);
