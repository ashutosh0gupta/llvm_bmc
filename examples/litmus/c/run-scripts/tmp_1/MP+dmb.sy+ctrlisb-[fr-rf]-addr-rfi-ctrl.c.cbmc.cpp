...
T2BLOCK4:
  ...
  //   %add = add nsw i32 3, %xor, !dbg !111
  creg_r4 = max(0,creg_r3);
  ASSUME(active[creg_r4] == 2);
  r4 = 3 + r3;

  //   %idxprom = sext i32 %add to i64, !dbg !111

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !111
  r5 = 0+r4*1;
  ASSUME(creg_r5 >= 0);
  ASSUME(creg_r5 >= creg_r4);
  ASSUME(active[creg_r5] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !76, metadata !DIExpression()), !dbg !131

  //   call void @llvm.dbg.value(metadata i64 1, metadata !78, metadata !DIExpression()), !dbg !131

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !111
  // ST: Guess
