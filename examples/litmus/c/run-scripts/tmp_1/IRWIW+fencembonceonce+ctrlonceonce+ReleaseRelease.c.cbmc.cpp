...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !93, metadata !DIExpression()), !dbg !109
...
T4BLOCK2:
  //   br label %lbl_label155, !dbg !62
  goto T4BLOCK4;

T4BLOCK3:
  //   br label %lbl_label155, !dbg !63
  goto T4BLOCK4;
...
T4BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_2, metadata !101, metadata !DIExpression()), !dbg !122
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([134 x i8], [134 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !135
