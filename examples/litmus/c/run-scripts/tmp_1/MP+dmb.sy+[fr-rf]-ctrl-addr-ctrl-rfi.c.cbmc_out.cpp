...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !88, metadata !DIExpression()), !dbg !135

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %6, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !161, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !162, metadata !DIExpression()), !dbg !216

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !98

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !98

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !163, metadata !DIExpression()), !dbg !218

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !100

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !100

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !167, metadata !DIExpression()), !dbg !220

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !102

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !102

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !168, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !172, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !175, metadata !DIExpression()), !dbg !227
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !178, metadata !DIExpression()), !dbg !229
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !181, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !184, metadata !DIExpression()), !dbg !233
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !187, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !191, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !193, metadata !DIExpression()), !dbg !250

  //   %conv = trunc i64 %6 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !190, metadata !DIExpression()), !dbg !216

  //   %cmp = icmp eq i32 %conv, 2, !dbg !134

  //   %conv18 = zext i1 %cmp to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !194, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !196, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !198, metadata !DIExpression()), !dbg !254

  //   %conv22 = trunc i64 %7 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !195, metadata !DIExpression()), !dbg !216

  //   %cmp23 = icmp eq i32 %conv22, 2, !dbg !138

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !138

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !199, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !201, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !203, metadata !DIExpression()), !dbg !258

  //   %conv28 = trunc i64 %8 to i32, !dbg !141

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !200, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !205, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !207, metadata !DIExpression()), !dbg !261

  //   %conv32 = trunc i64 %9 to i32, !dbg !144

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !204, metadata !DIExpression()), !dbg !216

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_1, metadata !209, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !211, metadata !DIExpression()), !dbg !264

  //   %conv36 = trunc i64 %10 to i32, !dbg !147

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !208, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !212, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %and37, metadata !213, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %and38, metadata !214, metadata !DIExpression()), !dbg !216
  ...
  //   call void @llvm.dbg.value(metadata i32 %and39, metadata !215, metadata !DIExpression()), !dbg !216
