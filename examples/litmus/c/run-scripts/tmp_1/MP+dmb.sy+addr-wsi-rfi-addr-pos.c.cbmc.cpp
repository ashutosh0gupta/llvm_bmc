...
T2BLOCK1:
  ...
  //   %xor7 = xor i32 %conv6, %conv6, !dbg !97
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor7, metadata !76, metadata !DIExpression()), !dbg !102

  //   %add9 = add nsw i32 0, %xor7, !dbg !98
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom10 = sext i32 %add9 to i64, !dbg !98

  //   %arrayidx11 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom10, !dbg !98
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx11, metadata !78, metadata !DIExpression()), !dbg !118

  //   %2 = load atomic i64, i64* %arrayidx11 monotonic, align 8, !dbg !98
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   %cmp28 = icmp eq i32 %conv14, 0, !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !94, metadata !DIExpression()), !dbg !130

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !96, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %6, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !98, metadata !DIExpression()), !dbg !133
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !165, metadata !DIExpression()), !dbg !223
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !168, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !195, metadata !DIExpression()), !dbg !255

  //   %9 = load atomic i64, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !199, metadata !DIExpression()), !dbg !258

  //   %10 = load atomic i64, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !160
  // LD: Guess
  old_cr = cr(0,6);
