...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !58, metadata !DIExpression()), !dbg !91
  ...
  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !71, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !75, metadata !DIExpression()), !dbg !88
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !80, metadata !DIExpression()), !dbg !109
  ...
  //   %cmp20 = icmp eq i32 %conv15, 1, !dbg !92

  //   %conv21 = zext i1 %cmp20 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !83, metadata !DIExpression()), !dbg !88

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !84, metadata !DIExpression()), !dbg !112

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !112

  //   store atomic i64 %5, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !138, metadata !DIExpression()), !dbg !176
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !141, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !159, metadata !DIExpression()), !dbg !201
