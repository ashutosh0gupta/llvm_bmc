...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !37, metadata !DIExpression()), !dbg !67
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !38, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64 1, metadata !41, metadata !DIExpression()), !dbg !70

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !71
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !44, metadata !DIExpression()), !dbg !72

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !73
  // LD: Guess
  old_cr = cr(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !46, metadata !DIExpression()), !dbg !72

  //   %conv = trunc i64 %0 to i32, !dbg !74

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !42, metadata !DIExpression()), !dbg !67
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !66), !dbg !80

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !47, metadata !DIExpression()), !dbg !81

  //   call void @llvm.dbg.value(metadata i64 1, metadata !49, metadata !DIExpression()), !dbg !81

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !82
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !50, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64 1, metadata !52, metadata !DIExpression()), !dbg !83

  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !84
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !54, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !56, metadata !DIExpression()), !dbg !85

  //   %conv8 = trunc i64 %1 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !53, metadata !DIExpression()), !dbg !67

  //   %cmp = icmp eq i32 %conv8, 2, !dbg !88

  //   %conv9 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !57, metadata !DIExpression()), !dbg !67

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !58, metadata !DIExpression()), !dbg !89

  //   %2 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !60, metadata !DIExpression()), !dbg !89

  //   store atomic i64 %2, i64* @atom_0_X7_2 seq_cst, align 8, !dbg !90
  // ST: Guess
  ...
  //   %cmp13 = icmp eq i32 %conv, 1, !dbg !91

  //   %conv14 = zext i1 %cmp13 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !61, metadata !DIExpression()), !dbg !67
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !145, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !148, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_2, metadata !170, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !174, metadata !DIExpression()), !dbg !228
