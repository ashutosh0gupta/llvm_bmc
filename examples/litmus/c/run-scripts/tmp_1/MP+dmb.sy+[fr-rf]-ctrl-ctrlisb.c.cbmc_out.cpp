...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !80, metadata !DIExpression()), !dbg !122
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !168, metadata !DIExpression()), !dbg !215
  ...
  //   store atomic i64 0, i64* @atom_1_X5_0 monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !189, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !193, metadata !DIExpression()), !dbg !246

  //   %10 = load atomic i64, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !141
  // LD: Guess
  old_cr = cr(0,5);
