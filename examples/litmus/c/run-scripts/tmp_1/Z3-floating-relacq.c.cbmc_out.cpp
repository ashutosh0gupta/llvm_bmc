...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !40, metadata !DIExpression()), !dbg !69

  //   %0 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !70
  // LD: Guess
  //   : Acquire
  old_cr = cr(1,0+2*1);
  ...
  ASSUME(cr(1,0+2*1) >= cs(1,4+0));
  ASSUME(cr(1,0+2*1) >= cs(1,6+0));
  ASSUME(cr(1,0+2*1) >= cs(1,7+0));
  ASSUME(cr(1,0+2*1) >= cs(1,3+0));
  ...
  //   %and = and i32 %conv, 8, !dbg !72
  creg_r1 = max(creg_r0,0);
  ASSUME(active[creg_r1] == 1);
  r1 = r0 & 8;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !44, metadata !DIExpression()), !dbg !66

  //   %add = add nsw i32 1, %and, !dbg !73
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %1, !dbg !73
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !48, metadata !DIExpression()), !dbg !74

  //   %conv4 = trunc i64 %2 to i32, !dbg !75
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !77
  // LD: Guess
  old_cr = cr(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !52, metadata !DIExpression()), !dbg !76

  //   %conv8 = trunc i64 %3 to i32, !dbg !78
  ...
  //   %4 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !56, metadata !DIExpression()), !dbg !80

  //   store atomic i64 %4, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !81
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !60, metadata !DIExpression()), !dbg !83

  //   store atomic i64 %5, i64* @atom_0_X3_0 seq_cst, align 8, !dbg !84
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !62, metadata !DIExpression()), !dbg !86

  //   %6 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !64, metadata !DIExpression()), !dbg !86

  //   store atomic i64 %6, i64* @atom_0_X5_1 seq_cst, align 8, !dbg !87
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !95, metadata !DIExpression()), !dbg !104
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !112, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !113, metadata !DIExpression()), !dbg !122
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !149, metadata !DIExpression()), !dbg !191
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_0, metadata !152, metadata !DIExpression()), !dbg !193
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !155, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !195

  //   store atomic i64 0, i64* @atom_0_X5_1 monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !159, metadata !DIExpression()), !dbg !210

  //   %6 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !161, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !162, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !164, metadata !DIExpression()), !dbg !214
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !166, metadata !DIExpression()), !dbg !214

  //   %conv20 = trunc i64 %7 to i32, !dbg !126

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !163, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_0, metadata !168, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !170, metadata !DIExpression()), !dbg !217

  //   %conv24 = trunc i64 %8 to i32, !dbg !129

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !167, metadata !DIExpression()), !dbg !178

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !172, metadata !DIExpression()), !dbg !220

  //   %9 = load atomic i64, i64* @atom_0_X5_1 seq_cst, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !174, metadata !DIExpression()), !dbg !220
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([103 x i8], [103 x i8]* @.str.1, i64 0, i64 0), i32 noundef 76, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !139
