...
T2BLOCK7:
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp34 = icmp eq i32 %conv15, 0, !dbg !132
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !99, metadata !DIExpression()), !dbg !152

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !101, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %8, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !134
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv19, 1, !dbg !135
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !103, metadata !DIExpression()), !dbg !155

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %9, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !137
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !161, metadata !DIExpression()), !dbg !168
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !204, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !207, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !238, metadata !DIExpression()), !dbg !309
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !242, metadata !DIExpression()), !dbg !312
