...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !39, metadata !DIExpression()), !dbg !44

  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !45
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !49, metadata !DIExpression()), !dbg !57
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !50, metadata !DIExpression()), !dbg !60

  //   call void @llvm.dbg.value(metadata i64 2, metadata !52, metadata !DIExpression()), !dbg !60
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64 1, metadata !55, metadata !DIExpression()), !dbg !62
...
T3BLOCK1:
  ...
  //   %0 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !62
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !68, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !97
  ...
  //   %cmp9 = icmp eq i32 %conv4, 3, !dbg !72

  //   %conv10 = zext i1 %cmp9 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !84, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X4_3, metadata !85, metadata !DIExpression()), !dbg !104

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !87, metadata !DIExpression()), !dbg !104

  //   store atomic i64 %3, i64* @atom_2_X4_3 seq_cst, align 8, !dbg !74
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !121, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !122, metadata !DIExpression()), !dbg !156
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !125, metadata !DIExpression()), !dbg !158
  ...
  //   store atomic i64 0, i64* @atom_2_X0_1 monotonic, align 8, !dbg !87
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X4_3, metadata !131, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64 0, metadata !133, metadata !DIExpression()), !dbg !162

  //   store atomic i64 0, i64* @atom_2_X4_3 monotonic, align 8, !dbg !89
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !137, metadata !DIExpression()), !dbg !177
  ...
  //   %7 = load atomic i64, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !108
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !142, metadata !DIExpression()), !dbg !181

  //   %conv16 = trunc i64 %7 to i32, !dbg !109

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !139, metadata !DIExpression()), !dbg !149

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X4_3, metadata !144, metadata !DIExpression()), !dbg !184

  //   %8 = load atomic i64, i64* @atom_2_X4_3 seq_cst, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !146, metadata !DIExpression()), !dbg !184
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([91 x i8], [91 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !118
