...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !70, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !72, metadata !DIExpression()), !dbg !127

  //   %conv11 = trunc i64 %2 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !69, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !79, metadata !DIExpression()), !dbg !135

  //   %conv16 = sext i32 %add to i64, !dbg !117

  //   call void @llvm.dbg.value(metadata i64 %conv16, metadata !81, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %conv16, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !117
  // ST: Guess
  ...
  //   %cmp25 = icmp eq i32 %conv11, 0, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !91, metadata !DIExpression()), !dbg !144

  //   %6 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !144

  //   store atomic i64 %6, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !126
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv15, 1, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !95, metadata !DIExpression()), !dbg !147

  //   %7 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %7, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !129
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !196, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !259

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !199, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !261

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !225, metadata !DIExpression()), !dbg !293

  //   %10 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !229, metadata !DIExpression()), !dbg !296

  //   %11 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !168
  // LD: Guess
  old_cr = cr(0,6);
