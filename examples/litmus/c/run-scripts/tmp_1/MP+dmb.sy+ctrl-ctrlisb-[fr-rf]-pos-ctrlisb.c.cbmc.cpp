...
T2BLOCK4:
  ...
  //   %tobool5 = icmp ne i32 %conv4, 0, !dbg !107

  //   br i1 %tobool5, label %if.then6, label %if.else7, !dbg !109
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !109), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !72, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !133

  //   %conv11 = trunc i64 %2 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !71, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !76, metadata !DIExpression()), !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !136

  //   %conv15 = trunc i64 %3 to i32, !dbg !119

  //   call void @llvm.dbg.value(metadata i32 %conv15, metadata !75, metadata !DIExpression()), !dbg !111
...
T2BLOCK10:
  ...
  //   %cmp29 = icmp eq i32 %conv11, 0, !dbg !136
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !92, metadata !DIExpression()), !dbg !156

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !156

  //   store atomic i64 %7, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !138
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv15, 1, !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !96, metadata !DIExpression()), !dbg !159

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !159

  //   store atomic i64 %8, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !141
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv19, 1, !dbg !142
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !100, metadata !DIExpression()), !dbg !162

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !162

  //   store atomic i64 %9, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !144
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !171, metadata !DIExpression()), !dbg !178
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !211, metadata !DIExpression()), !dbg !282

  //   call void @llvm.dbg.value(metadata i64 0, metadata !213, metadata !DIExpression()), !dbg !282

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !141
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !214, metadata !DIExpression()), !dbg !284

  //   call void @llvm.dbg.value(metadata i64 0, metadata !216, metadata !DIExpression()), !dbg !284

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !143
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !217, metadata !DIExpression()), !dbg !286

  //   call void @llvm.dbg.value(metadata i64 0, metadata !219, metadata !DIExpression()), !dbg !286

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !145
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !224, metadata !DIExpression()), !dbg !303
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !229, metadata !DIExpression()), !dbg !307
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !234, metadata !DIExpression()), !dbg !311
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !243, metadata !DIExpression()), !dbg !318

  //   %10 = load atomic i64, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !177
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !247, metadata !DIExpression()), !dbg !321

  //   %11 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !180
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !251, metadata !DIExpression()), !dbg !324

  //   %12 = load atomic i64, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !183
  // LD: Guess
  old_cr = cr(0,7);
