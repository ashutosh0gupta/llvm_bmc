...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !61), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv6, metadata !48, metadata !DIExpression()), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !52, metadata !DIExpression()), !dbg !62
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !55, metadata !DIExpression()), !dbg !83
