...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !45, metadata !DIExpression()), !dbg !75

  //   call void @llvm.dbg.value(metadata i64 1, metadata !47, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !50, metadata !DIExpression()), !dbg !77

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !78
  // ST: Guess
  //   : Release
  iw(1,0+2*1) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !52, metadata !DIExpression()), !dbg !79
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_3, metadata !56, metadata !DIExpression()), !dbg !83

  //   %2 = zext i32 %conv9 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !58, metadata !DIExpression()), !dbg !83

  //   store atomic i64 %2, i64* @atom_0_X7_3 seq_cst, align 8, !dbg !84
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 3, metadata !91, metadata !DIExpression()), !dbg !104
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_3, metadata !136, metadata !DIExpression()), !dbg !174
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X7_3, metadata !153, metadata !DIExpression()), !dbg !196
