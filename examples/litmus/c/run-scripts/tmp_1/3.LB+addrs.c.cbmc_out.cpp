...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !37, metadata !DIExpression()), !dbg !53
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !40, metadata !DIExpression()), !dbg !56
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !43, metadata !DIExpression()), !dbg !56

  //   %conv = trunc i64 %0 to i32, !dbg !58

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !38, metadata !DIExpression()), !dbg !53
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !44, metadata !DIExpression()), !dbg !53
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !45, metadata !DIExpression()), !dbg !61

  //   call void @llvm.dbg.value(metadata i64 1, metadata !47, metadata !DIExpression()), !dbg !61
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !48, metadata !DIExpression()), !dbg !53

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !49, metadata !DIExpression()), !dbg !63

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !51, metadata !DIExpression()), !dbg !63
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !97, metadata !DIExpression()), !dbg !111
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !98, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !102, metadata !DIExpression()), !dbg !111

  //   %add = add nsw i32 0, %xor, !dbg !60
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !103, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 1, metadata !105, metadata !DIExpression()), !dbg !119

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !60
  // ST: Guess
  iw(3,r11) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW 
  old_cw = cw(3,r11);
  cw(3,r11) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM 
  // Check
  ASSUME(active[iw(3,r11)] == 3);
  ASSUME(active[cw(3,r11)] == 3);
  ASSUME(sforbid(r11,cw(3,r11))== 0);
  ASSUME(iw(3,r11) >= 0);
  ASSUME(iw(3,r11) >= creg_r11);
  ASSUME(cw(3,r11) >= iw(3,r11));
  ASSUME(cw(3,r11) >= old_cw);
  ASSUME(cw(3,r11) >= cr(3,r11));
  ASSUME(cw(3,r11) >= cl[3]);
  ASSUME(cw(3,r11) >= cisb[3]);
  ASSUME(cw(3,r11) >= cdy[3]);
  ASSUME(cw(3,r11) >= cdl[3]);
  ASSUME(cw(3,r11) >= cds[3]);
  ASSUME(cw(3,r11) >= cctrl[3]);
  ASSUME(cw(3,r11) >= caddr[3]);
  // Update
  caddr[3] = max(caddr[3],creg_r11);
  buff(3,r11) = 1;
  mem(r11,cw(3,r11)) = 1;
  co(r11,cw(3,r11))+=1;
  delta(r11,cw(3,r11)) = -1;
  ASSUME(creturn[3] >= cw(3,r11));
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !131, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !132, metadata !DIExpression()), !dbg !171

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !83

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !83

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !133, metadata !DIExpression()), !dbg !173

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !85

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !85

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !137, metadata !DIExpression()), !dbg !175

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !87

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !87

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !138, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !148, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !151, metadata !DIExpression()), !dbg !186
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !154, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !158, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !162, metadata !DIExpression()), !dbg !206
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !161, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !166, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !168, metadata !DIExpression()), !dbg !209

  //   %conv23 = trunc i64 %8 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv23, metadata !165, metadata !DIExpression()), !dbg !171
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([95 x i8], [95 x i8]* @.str.1, i64 0, i64 0), i32 noundef 74, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
