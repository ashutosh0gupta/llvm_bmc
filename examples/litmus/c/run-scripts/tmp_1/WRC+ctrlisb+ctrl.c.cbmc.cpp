...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !93, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !95, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !97, metadata !DIExpression()), !dbg !122

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !99, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !101, metadata !DIExpression()), !dbg !125

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !103, metadata !DIExpression()), !dbg !125
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !135, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !136, metadata !DIExpression()), !dbg !172

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !80

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !80

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !137, metadata !DIExpression()), !dbg !174

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !82

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !82

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !141, metadata !DIExpression()), !dbg !176

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !84

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !84

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !142, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !149, metadata !DIExpression()), !dbg !183
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !152, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !155, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !163, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !162, metadata !DIExpression()), !dbg !172

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !167, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !169, metadata !DIExpression()), !dbg !208

  //   %conv21 = trunc i64 %8 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !166, metadata !DIExpression()), !dbg !172
