...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !76, metadata !DIExpression()), !dbg !101
  ...
  //   %cmp24 = icmp eq i32 %conv10, 1, !dbg !108
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !93, metadata !DIExpression()), !dbg !128

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !128

  //   store atomic i64 %6, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !160, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !162, metadata !DIExpression()), !dbg !210

  //   store atomic i64 0, i64* @atom_1_X7_1 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !185, metadata !DIExpression()), !dbg !238

  //   %8 = load atomic i64, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,4);
