...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !95
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !82), !dbg !103

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !65, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !69, metadata !DIExpression()), !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !73, metadata !DIExpression()), !dbg !110

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !75, metadata !DIExpression()), !dbg !110

  //   store atomic i64 %3, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !92
  // ST: Guess
  ...
  //   %cmp16 = icmp eq i32 %conv11, 1, !dbg !93

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !76, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !77, metadata !DIExpression()), !dbg !113
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !139, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !142, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64 0, metadata !144, metadata !DIExpression()), !dbg !179

  //   store atomic i64 0, i64* @atom_1_X6_1 monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !160, metadata !DIExpression()), !dbg !202

  //   %7 = load atomic i64, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !120
  // LD: Guess
  old_cr = cr(0,4);
