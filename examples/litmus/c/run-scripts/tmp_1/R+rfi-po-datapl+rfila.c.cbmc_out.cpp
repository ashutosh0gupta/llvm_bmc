...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !53, metadata !DIExpression()), !dbg !71
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !54, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !55, metadata !DIExpression()), !dbg !84

  //   %conv7 = sext i32 %add to i64, !dbg !85

  //   call void @llvm.dbg.value(metadata i64 %conv7, metadata !57, metadata !DIExpression()), !dbg !84

  //   store atomic i64 %conv7, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !85
  // ST: Guess
  //   : Release
  iw(1,0) = get_rng(0,NCONTEXT-1);// 1 ASSIGN STIW 
  old_cw = cw(1,0);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !59, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !58, metadata !DIExpression()), !dbg !71

  //   %cmp = icmp eq i32 %conv11, 2, !dbg !89

  //   %conv12 = zext i1 %cmp to i32, !dbg !89

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !62, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !63, metadata !DIExpression()), !dbg !90

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !65, metadata !DIExpression()), !dbg !90
  ...
  //   %cmp16 = icmp eq i32 %conv, 3, !dbg !92

  //   %conv17 = zext i1 %cmp16 to i32, !dbg !92

  //   call void @llvm.dbg.value(metadata i32 %conv17, metadata !66, metadata !DIExpression()), !dbg !71

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !67, metadata !DIExpression()), !dbg !93

  //   %4 = zext i32 %conv17 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !69, metadata !DIExpression()), !dbg !93

  //   store atomic i64 %4, i64* @atom_0_X2_3 seq_cst, align 8, !dbg !94
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !98, metadata !DIExpression()), !dbg !119
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64 2, metadata !101, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !103, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !105, metadata !DIExpression()), !dbg !124

  //   %conv = trunc i64 %0 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !102, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !107, metadata !DIExpression()), !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !109, metadata !DIExpression()), !dbg !127

  //   %conv4 = trunc i64 %1 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !106, metadata !DIExpression()), !dbg !119

  //   %cmp = icmp eq i32 %conv4, 3, !dbg !73

  //   %conv5 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !110, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !111, metadata !DIExpression()), !dbg !131

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !113, metadata !DIExpression()), !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !114, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !115, metadata !DIExpression()), !dbg !134

  //   %3 = zext i32 %conv10 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !117, metadata !DIExpression()), !dbg !134
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !157, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !160, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !163, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !166, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_3, metadata !179, metadata !DIExpression()), !dbg !228
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_3, metadata !183, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !187, metadata !DIExpression()), !dbg !234
