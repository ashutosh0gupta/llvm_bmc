...
T2BLOCK4:
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !111
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !79, metadata !DIExpression()), !dbg !129

  //   %conv9 = trunc i64 %2 to i32, !dbg !112
  ...
  //   %cmp27 = icmp eq i32 %conv9, 0, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !97, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !101, metadata !DIExpression()), !dbg !148

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !103, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %8, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !197, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !200, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !230, metadata !DIExpression()), !dbg !302
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !234, metadata !DIExpression()), !dbg !305
