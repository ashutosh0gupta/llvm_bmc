...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !145, metadata !DIExpression()), !dbg !197
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !148, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !199

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !170, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !174, metadata !DIExpression()), !dbg !228

  //   %8 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,4);
