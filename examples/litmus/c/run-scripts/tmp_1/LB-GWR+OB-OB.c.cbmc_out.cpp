...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !68, metadata !DIExpression()), !dbg !87
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !72, metadata !DIExpression()), !dbg !90
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X1_0, metadata !104, metadata !DIExpression()), !dbg !118
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X1_0, metadata !148, metadata !DIExpression()), !dbg !183

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !183

  //   store atomic i64 0, i64* @atom_2_X1_0 monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X1_0, metadata !159, metadata !DIExpression()), !dbg !203

  //   %7 = load atomic i64, i64* @atom_2_X1_0 seq_cst, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(0,4);
