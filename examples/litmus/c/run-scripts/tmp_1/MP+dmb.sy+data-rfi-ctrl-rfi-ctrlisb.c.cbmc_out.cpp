...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !158, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !159, metadata !DIExpression()), !dbg !232

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !160, metadata !DIExpression()), !dbg !234

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !164, metadata !DIExpression()), !dbg !236

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !165, metadata !DIExpression()), !dbg !237

  //   call void @llvm.dbg.value(metadata i64 0, metadata !167, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !168, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !171, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !174, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !183, metadata !DIExpression()), !dbg !249
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !186, metadata !DIExpression()), !dbg !251
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !190, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !192, metadata !DIExpression()), !dbg !263

  //   %conv = trunc i64 %4 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !189, metadata !DIExpression()), !dbg !232

  //   %cmp = icmp eq i32 %conv, 1, !dbg !152

  //   %conv18 = zext i1 %cmp to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !193, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !197, metadata !DIExpression()), !dbg !267

  //   %conv22 = trunc i64 %5 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !194, metadata !DIExpression()), !dbg !232

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !156

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !198, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !202, metadata !DIExpression()), !dbg !271

  //   %conv28 = trunc i64 %6 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !199, metadata !DIExpression()), !dbg !232

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !160

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !203, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !207, metadata !DIExpression()), !dbg !275

  //   %conv34 = trunc i64 %7 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !204, metadata !DIExpression()), !dbg !232

  //   %cmp35 = icmp eq i32 %conv34, 1, !dbg !164

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !208, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !212, metadata !DIExpression()), !dbg !279

  //   %conv40 = trunc i64 %8 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !209, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !214, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !216, metadata !DIExpression()), !dbg !282

  //   %conv44 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !213, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !218, metadata !DIExpression()), !dbg !285
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !220, metadata !DIExpression()), !dbg !285

  //   %conv48 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !217, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !222, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !224, metadata !DIExpression()), !dbg !288

  //   %conv52 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !221, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !226, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !227, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !228, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !229, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !230, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !231, metadata !DIExpression()), !dbg !232
