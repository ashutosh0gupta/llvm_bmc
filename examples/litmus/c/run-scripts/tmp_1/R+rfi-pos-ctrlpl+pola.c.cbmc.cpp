...
T1BLOCK1:
  //   call void @llvm.dbg.label(metadata !72), !dbg !76
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !73), !dbg !90

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !53, metadata !DIExpression()), !dbg !91

  //   call void @llvm.dbg.value(metadata i64 1, metadata !55, metadata !DIExpression()), !dbg !91

  //   store atomic i64 1, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !92
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !57, metadata !DIExpression()), !dbg !93
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !59, metadata !DIExpression()), !dbg !93

  //   %conv10 = trunc i64 %2 to i32, !dbg !95

  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !56, metadata !DIExpression()), !dbg !74

  //   %cmp = icmp eq i32 %conv10, 2, !dbg !96

  //   %conv11 = zext i1 %cmp to i32, !dbg !96

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !60, metadata !DIExpression()), !dbg !74

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !61, metadata !DIExpression()), !dbg !97

  //   %3 = zext i32 %conv11 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !63, metadata !DIExpression()), !dbg !97

  //   store atomic i64 %3, i64* @atom_0_X6_2 seq_cst, align 8, !dbg !98
  // ST: Guess
  ...
  //   %cmp15 = icmp eq i32 %conv, 1, !dbg !99

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !99

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !64, metadata !DIExpression()), !dbg !74

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X2_1, metadata !65, metadata !DIExpression()), !dbg !100

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !67, metadata !DIExpression()), !dbg !100

  //   store atomic i64 %4, i64* @atom_0_X2_1 seq_cst, align 8, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv21, metadata !68, metadata !DIExpression()), !dbg !74

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !69, metadata !DIExpression()), !dbg !103

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !71, metadata !DIExpression()), !dbg !103

  //   store atomic i64 %5, i64* @atom_0_X3_1 seq_cst, align 8, !dbg !104
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !109, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !113, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !117, metadata !DIExpression()), !dbg !130
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !153, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !159, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X6_2, metadata !176, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !184, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !188, metadata !DIExpression()), !dbg !240
