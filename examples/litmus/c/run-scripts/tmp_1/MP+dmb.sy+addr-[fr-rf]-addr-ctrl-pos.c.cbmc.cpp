...
T2BLOCK1:
  ...
  //   %add11 = add nsw i32 3, %xor9, !dbg !106
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx13, metadata !78, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !80, metadata !DIExpression()), !dbg !126

  //   %conv16 = trunc i64 %3 to i32, !dbg !108

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !77, metadata !DIExpression()), !dbg !111

  //   %tobool = icmp ne i32 %conv16, 0, !dbg !109
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !110), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !84, metadata !DIExpression()), !dbg !134
  ...
  //   %cmp32 = icmp eq i32 %conv8, 1, !dbg !127
  ...
  //   store atomic i64 %8, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !129
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !202, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !272

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !143
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !235, metadata !DIExpression()), !dbg !309

  //   %11 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !180
  // LD: Guess
  old_cr = cr(0,6);
