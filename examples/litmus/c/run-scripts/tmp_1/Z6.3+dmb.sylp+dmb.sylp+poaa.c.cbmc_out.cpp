...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !85, metadata !DIExpression()), !dbg !103

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !87, metadata !DIExpression()), !dbg !103

  //   store atomic i64 %2, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !66
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !89, metadata !DIExpression()), !dbg !106

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !91, metadata !DIExpression()), !dbg !106

  //   store atomic i64 %3, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !69
  // ST: Guess
