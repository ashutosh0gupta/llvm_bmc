...
T2BLOCK1:
  ...
  //   %add10 = add nsw i32 %xor9, 1, !dbg !105
  creg_r7 = max(creg_r6,0);
  ASSUME(active[creg_r7] == 2);
  r7 = r6 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add10, metadata !77, metadata !DIExpression()), !dbg !110
  ...
  //   %conv11 = sext i32 %add10 to i64, !dbg !107

  //   call void @llvm.dbg.value(metadata i64 %conv11, metadata !80, metadata !DIExpression()), !dbg !125

  //   store atomic i64 %conv11, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !107
  // ST: Guess
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   %cmp29 = icmp eq i32 %conv8, 1, !dbg !120
  ...
  //   %cmp34 = icmp eq i32 %conv15, 1, !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !102, metadata !DIExpression()), !dbg !143

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !104, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %8, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv19, 1, !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !106, metadata !DIExpression()), !dbg !146

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !108, metadata !DIExpression()), !dbg !146

  //   store atomic i64 %9, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !128
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !169, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !170, metadata !DIExpression()), !dbg !243

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !171, metadata !DIExpression()), !dbg !245

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !123

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !123

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !175, metadata !DIExpression()), !dbg !247

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !125

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !125

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !176, metadata !DIExpression()), !dbg !249

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !177, metadata !DIExpression()), !dbg !250
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !180, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !183, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !189, metadata !DIExpression()), !dbg !258
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !192, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !195, metadata !DIExpression()), !dbg !262

  //   call void @llvm.dbg.value(metadata i64 0, metadata !197, metadata !DIExpression()), !dbg !262

  //   store atomic i64 0, i64* @atom_1_X8_1 monotonic, align 8, !dbg !140
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !198, metadata !DIExpression()), !dbg !264

  //   call void @llvm.dbg.value(metadata i64 0, metadata !200, metadata !DIExpression()), !dbg !264

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !142
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !202, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !204, metadata !DIExpression()), !dbg !279

  //   %conv = trunc i64 %6 to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !201, metadata !DIExpression()), !dbg !243

  //   %cmp = icmp eq i32 %conv, 2, !dbg !159

  //   %conv20 = zext i1 %cmp to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !205, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !207, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !209, metadata !DIExpression()), !dbg !283

  //   %conv24 = trunc i64 %7 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !206, metadata !DIExpression()), !dbg !243

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !163

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !210, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !212, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !214, metadata !DIExpression()), !dbg !287

  //   %conv30 = trunc i64 %8 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !211, metadata !DIExpression()), !dbg !243

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !167

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !215, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !219, metadata !DIExpression()), !dbg !291

  //   %conv36 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !216, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !221, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !223, metadata !DIExpression()), !dbg !294

  //   %conv40 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !220, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !225, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !227, metadata !DIExpression()), !dbg !297

  //   %conv44 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !224, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !229, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !231, metadata !DIExpression()), !dbg !300

  //   %conv48 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !228, metadata !DIExpression()), !dbg !243

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !233, metadata !DIExpression()), !dbg !303

  //   %13 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !181
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !235, metadata !DIExpression()), !dbg !303

  //   %conv52 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !232, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !237, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !238, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !239, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !240, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !241, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !242, metadata !DIExpression()), !dbg !243
