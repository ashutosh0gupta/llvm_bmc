...
T2BLOCK7:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !93, metadata !DIExpression()), !dbg !150

  //   %7 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !95, metadata !DIExpression()), !dbg !150

  //   store atomic i64 %7, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !132
  // ST: Guess
  ...
  //   store atomic i64 %8, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !135
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !101, metadata !DIExpression()), !dbg !156

  //   %9 = zext i32 %conv37 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !103, metadata !DIExpression()), !dbg !156

  //   store atomic i64 %9, i64* @atom_1_X6_1 seq_cst, align 8, !dbg !138
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !205, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !208, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !211, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !237, metadata !DIExpression()), !dbg !312
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !241, metadata !DIExpression()), !dbg !315
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !245, metadata !DIExpression()), !dbg !318
