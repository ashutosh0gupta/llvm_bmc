...
T2BLOCK7:
  ...
  //   %cmp39 = icmp eq i32 %conv19, 1, !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !103, metadata !DIExpression()), !dbg !154

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !105, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %9, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !136
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !160, metadata !DIExpression()), !dbg !167
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !206, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !241, metadata !DIExpression()), !dbg !311
