...
T2BLOCK1:
  ...
  //   %xor12 = xor i32 %conv11, %conv11, !dbg !96
  creg_r8 = max(creg_r7,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 ^ r7;

  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !77, metadata !DIExpression()), !dbg !98

  //   %add14 = add nsw i32 0, %xor12, !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx16, metadata !78, metadata !DIExpression()), !dbg !117

  //   call void @llvm.dbg.value(metadata i64 1, metadata !80, metadata !DIExpression()), !dbg !117
  ...
  //   %cmp26 = icmp eq i32 %conv11, 1, !dbg !105

  //   %conv27 = zext i1 %cmp26 to i32, !dbg !105

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !89, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !90, metadata !DIExpression()), !dbg !125
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !163, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !190, metadata !DIExpression()), !dbg !245
