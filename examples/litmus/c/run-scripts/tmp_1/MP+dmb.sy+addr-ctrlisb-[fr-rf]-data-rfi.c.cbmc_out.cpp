...
T2BLOCK4:
  ...
  //   %add14 = add nsw i32 %xor13, 1, !dbg !110
  creg_r8 = max(creg_r7,0);
  ASSUME(active[creg_r8] == 2);
  r8 = r7 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add14, metadata !79, metadata !DIExpression()), !dbg !105
  ...
  //   %conv15 = sext i32 %add14 to i64, !dbg !112

  //   call void @llvm.dbg.value(metadata i64 %conv15, metadata !82, metadata !DIExpression()), !dbg !130

  //   store atomic i64 %conv15, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !112
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !92, metadata !DIExpression()), !dbg !139

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %6, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !191, metadata !DIExpression()), !dbg !254
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !194, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !220, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !224, metadata !DIExpression()), !dbg !291
