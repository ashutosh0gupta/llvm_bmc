...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !123
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !134

  //   %conv13 = sext i32 %add to i64, !dbg !116

  //   call void @llvm.dbg.value(metadata i64 %conv13, metadata !83, metadata !DIExpression()), !dbg !134

  //   store atomic i64 %conv13, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !116
  // ST: Guess
  ...
  //   %cmp22 = icmp eq i32 %conv4, 0, !dbg !123
  ...
  //   %cmp27 = icmp eq i32 %conv8, 1, !dbg !126
  ...
  //   %cmp32 = icmp eq i32 %conv12, 1, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !101, metadata !DIExpression()), !dbg !149
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !195, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !198, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !201, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !227, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !231, metadata !DIExpression()), !dbg !303
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !235, metadata !DIExpression()), !dbg !306
