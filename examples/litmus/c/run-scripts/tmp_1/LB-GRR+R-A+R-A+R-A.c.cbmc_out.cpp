...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !124, metadata !DIExpression()), !dbg !142
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !126, metadata !DIExpression()), !dbg !145

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) acquire, align 8, !dbg !65
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !128, metadata !DIExpression()), !dbg !145

  //   %conv = trunc i64 %0 to i32, !dbg !66

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !125, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !130, metadata !DIExpression()), !dbg !148

  //   %1 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !68
  // LD: Guess
  old_cr = cr(4,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !132, metadata !DIExpression()), !dbg !148

  //   %conv4 = trunc i64 %1 to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !129, metadata !DIExpression()), !dbg !142

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !70

  //   %conv5 = zext i1 %cmp to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !133, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !134, metadata !DIExpression()), !dbg !152

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !136, metadata !DIExpression()), !dbg !152

  //   store atomic i64 %2, i64* @atom_3_X2_0 seq_cst, align 8, !dbg !72
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !137, metadata !DIExpression()), !dbg !142

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !138, metadata !DIExpression()), !dbg !155

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !140, metadata !DIExpression()), !dbg !155

  //   store atomic i64 %3, i64* @atom_3_X0_1 seq_cst, align 8, !dbg !75
  // ST: Guess
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !160, metadata !DIExpression()), !dbg !168
...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !161, metadata !DIExpression()), !dbg !171

  //   call void @llvm.dbg.value(metadata i64 1, metadata !163, metadata !DIExpression()), !dbg !171
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !174

  //   call void @llvm.dbg.value(metadata i64 1, metadata !166, metadata !DIExpression()), !dbg !174
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !209, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !225, metadata !DIExpression()), !dbg !298
