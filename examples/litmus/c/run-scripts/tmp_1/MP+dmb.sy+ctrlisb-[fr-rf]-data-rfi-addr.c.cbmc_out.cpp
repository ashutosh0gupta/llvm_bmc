...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !110), !dbg !122
  ...
  //   %xor = xor i32 %conv8, %conv8, !dbg !111
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !75, metadata !DIExpression()), !dbg !111

  //   %add = add nsw i32 %xor, 1, !dbg !112
  creg_r4 = max(creg_r3,0);
  ASSUME(active[creg_r4] == 2);
  r4 = r3 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add, metadata !76, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !77, metadata !DIExpression()), !dbg !132

  //   %conv9 = sext i32 %add to i64, !dbg !114

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !79, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !116
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !83, metadata !DIExpression()), !dbg !134

  //   %conv13 = trunc i64 %3 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv13, metadata !80, metadata !DIExpression()), !dbg !111

  //   %xor14 = xor i32 %conv13, %conv13, !dbg !118
  creg_r6 = max(creg_r5,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = r5 ^ r5;

  //   call void @llvm.dbg.value(metadata i32 %xor14, metadata !84, metadata !DIExpression()), !dbg !111

  //   %add16 = add nsw i32 0, %xor14, !dbg !119
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 0 + r6;

  //   %idxprom = sext i32 %add16 to i64, !dbg !119

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !119
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !86, metadata !DIExpression()), !dbg !139
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !94, metadata !DIExpression()), !dbg !145
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !98, metadata !DIExpression()), !dbg !148

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !130
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv13, 1, !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !102, metadata !DIExpression()), !dbg !151

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !104, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %8, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !133
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !160, metadata !DIExpression()), !dbg !167
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !200, metadata !DIExpression()), !dbg !277
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !203, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !206, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !237, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !241, metadata !DIExpression()), !dbg !320
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !245, metadata !DIExpression()), !dbg !323
