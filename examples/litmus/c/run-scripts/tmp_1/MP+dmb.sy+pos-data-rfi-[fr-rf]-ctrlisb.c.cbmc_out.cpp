...
T2BLOCK4:
  ...
  //   %cmp32 = icmp eq i32 %conv13, 2, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !101, metadata !DIExpression()), !dbg !149

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !103, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %8, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !131
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !158, metadata !DIExpression()), !dbg !165
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !195, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !201, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !227, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !235, metadata !DIExpression()), !dbg !306
