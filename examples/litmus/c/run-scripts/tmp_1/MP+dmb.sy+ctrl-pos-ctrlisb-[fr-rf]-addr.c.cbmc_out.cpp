...
T2BLOCK7:
  ...
  //   %xor = xor i32 %conv19, %conv19, !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !83, metadata !DIExpression()), !dbg !138

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(2,r7);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !91, metadata !DIExpression()), !dbg !144
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !196, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !225, metadata !DIExpression()), !dbg !293
