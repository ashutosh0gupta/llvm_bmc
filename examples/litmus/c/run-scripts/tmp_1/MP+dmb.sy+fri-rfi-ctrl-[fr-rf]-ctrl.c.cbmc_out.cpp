...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !67, metadata !DIExpression()), !dbg !115

  //   call void @llvm.dbg.value(metadata i64 2, metadata !69, metadata !DIExpression()), !dbg !115

  //   store atomic i64 2, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !97
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !71, metadata !DIExpression()), !dbg !117

  //   %1 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !99
  // LD: Guess
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !73, metadata !DIExpression()), !dbg !117
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !107), !dbg !125
...
T2BLOCK7:
  ...
  //   %cmp24 = icmp eq i32 %conv4, 2, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !91, metadata !DIExpression()), !dbg !145

  //   %6 = zext i32 %conv25 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %6, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !127
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !197, metadata !DIExpression()), !dbg !266

  //   call void @llvm.dbg.value(metadata i64 0, metadata !199, metadata !DIExpression()), !dbg !266

  //   store atomic i64 0, i64* @atom_1_X3_2 monotonic, align 8, !dbg !136
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !200, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !203, metadata !DIExpression()), !dbg !270
  ...
  //   %cmp25 = icmp eq i32 %conv24, 2, !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !229, metadata !DIExpression()), !dbg !302

  //   %10 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !172
  // LD: Guess
  old_cr = cr(0,4);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !233, metadata !DIExpression()), !dbg !305
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !237, metadata !DIExpression()), !dbg !308
