...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !96, metadata !DIExpression()), !dbg !114
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !98, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !100, metadata !DIExpression()), !dbg !117

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !97, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !102, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !104, metadata !DIExpression()), !dbg !121

  //   %conv4 = trunc i64 %1 to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !101, metadata !DIExpression()), !dbg !114

  //   %cmp = icmp eq i32 %conv4, 0, !dbg !69

  //   %conv5 = zext i1 %cmp to i32, !dbg !69

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !105, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !106, metadata !DIExpression()), !dbg !125

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !108, metadata !DIExpression()), !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !109, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !110, metadata !DIExpression()), !dbg !128

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !112, metadata !DIExpression()), !dbg !128
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !133, metadata !DIExpression()), !dbg !141
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !134, metadata !DIExpression()), !dbg !144

  //   call void @llvm.dbg.value(metadata i64 1, metadata !136, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !137, metadata !DIExpression()), !dbg !147

  //   call void @llvm.dbg.value(metadata i64 1, metadata !139, metadata !DIExpression()), !dbg !147
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !178, metadata !DIExpression()), !dbg !226
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !191, metadata !DIExpression()), !dbg !250
