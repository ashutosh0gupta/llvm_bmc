...
T2BLOCK1:
  ...
  //   %tobool = icmp ne i32 %conv5, 0, !dbg !105
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !110), !dbg !129
  ...
  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !113
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !79, metadata !DIExpression()), !dbg !131

  //   %conv9 = trunc i64 %2 to i32, !dbg !114

  //   call void @llvm.dbg.value(metadata i32 %conv9, metadata !76, metadata !DIExpression()), !dbg !111
  ...
  //   %cmp29 = icmp eq i32 %conv9, 0, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !98, metadata !DIExpression()), !dbg !148

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !100, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %7, i64* @atom_1_X5_0 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !203, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !241, metadata !DIExpression()), !dbg !320
