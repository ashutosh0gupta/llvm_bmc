...
T2BLOCK4:
  ...
  //   %conv13 = trunc i64 %3 to i32, !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !85, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %5, i64* @atom_1_X2_2 seq_cst, align 8, !dbg !111
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !91, metadata !DIExpression()), !dbg !132

  //   %6 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !132
  ...
  //   %cmp28 = icmp eq i32 %conv13, 0, !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !95, metadata !DIExpression()), !dbg !135

  //   %7 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !135

  //   store atomic i64 %7, i64* @atom_1_X6_0 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !178, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !181, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !184, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !207, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !211, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_0, metadata !215, metadata !DIExpression()), !dbg !279
