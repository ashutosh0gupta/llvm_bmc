...
T1BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !45
  // ST: Guess
  //   : Release
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !59, metadata !DIExpression()), !dbg !73

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !61, metadata !DIExpression()), !dbg !73

  //   store atomic i64 %1, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !61
  // ST: Guess
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !105, metadata !DIExpression()), !dbg !119

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !107, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %1, i64* @atom_3_X2_0 seq_cst, align 8, !dbg !61
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !147, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !150, metadata !DIExpression()), !dbg !191

  //   call void @llvm.dbg.value(metadata i64 0, metadata !152, metadata !DIExpression()), !dbg !191

  //   store atomic i64 0, i64* @atom_3_X2_0 monotonic, align 8, !dbg !103
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !154, metadata !DIExpression()), !dbg !209

  //   %8 = load atomic i64, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !164, metadata !DIExpression()), !dbg !217

  //   %10 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X2_0, metadata !168, metadata !DIExpression()), !dbg !220

  //   %11 = load atomic i64, i64* @atom_3_X2_0 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
