...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !81, metadata !DIExpression()), !dbg !125
  ...
  //   %cmp19 = icmp eq i32 %conv4, 2, !dbg !112

  //   %conv20 = zext i1 %cmp19 to i32, !dbg !112

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !88, metadata !DIExpression()), !dbg !102

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !89, metadata !DIExpression()), !dbg !132

  //   %5 = zext i32 %conv20 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !91, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %5, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !114
  // ST: Guess
  ...
  //   %cmp24 = icmp eq i32 %conv10, 2, !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !93, metadata !DIExpression()), !dbg !135
  ...
  //   %cmp29 = icmp eq i32 %conv14, 0, !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !97, metadata !DIExpression()), !dbg !138
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !181, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !184, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !187, metadata !DIExpression()), !dbg !246
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !210, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !214, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !218, metadata !DIExpression()), !dbg !282
