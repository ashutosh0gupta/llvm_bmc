...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !61, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !62, metadata !DIExpression()), !dbg !78

  //   call void @llvm.dbg.value(metadata i64 1, metadata !64, metadata !DIExpression()), !dbg !78
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !86, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !90, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !91, metadata !DIExpression()), !dbg !107

  //   call void @llvm.dbg.value(metadata i64 1, metadata !93, metadata !DIExpression()), !dbg !107
