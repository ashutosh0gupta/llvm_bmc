...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !65, metadata !DIExpression()), !dbg !100

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !67, metadata !DIExpression()), !dbg !100

  //   store atomic i64 %4, i64* @atom_0_X3_1 seq_cst, align 8, !dbg !101
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !69, metadata !DIExpression()), !dbg !103

  //   %5 = zext i32 %conv21 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !71, metadata !DIExpression()), !dbg !103

  //   store atomic i64 %5, i64* @atom_0_X4_0 seq_cst, align 8, !dbg !104
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !157, metadata !DIExpression()), !dbg !208
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !160, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !181, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_0, metadata !185, metadata !DIExpression()), !dbg !238
