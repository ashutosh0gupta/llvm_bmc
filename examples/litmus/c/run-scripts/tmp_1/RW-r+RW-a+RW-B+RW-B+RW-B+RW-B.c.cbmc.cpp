...
T2BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !65
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !245, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !248, metadata !DIExpression()), !dbg !319
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !251, metadata !DIExpression()), !dbg !321
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !254, metadata !DIExpression()), !dbg !323
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !257, metadata !DIExpression()), !dbg !325
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !260, metadata !DIExpression()), !dbg !327
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !264, metadata !DIExpression()), !dbg !351
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !268, metadata !DIExpression()), !dbg !354
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !272, metadata !DIExpression()), !dbg !357
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !276, metadata !DIExpression()), !dbg !360
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !280, metadata !DIExpression()), !dbg !363
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !284, metadata !DIExpression()), !dbg !366
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([114 x i8], [114 x i8]* @.str.1, i64 0, i64 0), i32 noundef 126, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !209
