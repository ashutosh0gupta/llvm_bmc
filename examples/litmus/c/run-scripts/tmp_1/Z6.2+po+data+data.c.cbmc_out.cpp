...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !40, metadata !DIExpression()), !dbg !49
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !54, metadata !DIExpression()), !dbg !70
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !57, metadata !DIExpression()), !dbg !73
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !59, metadata !DIExpression()), !dbg !73

  //   %conv = trunc i64 %0 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !55, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !60, metadata !DIExpression()), !dbg !70
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !61, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !78

  //   %conv1 = sext i32 %add to i64, !dbg !61

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !64, metadata !DIExpression()), !dbg !78

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !61
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !65, metadata !DIExpression()), !dbg !70

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !66, metadata !DIExpression()), !dbg !81
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !86, metadata !DIExpression()), !dbg !101
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !88, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !91, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !92, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !93, metadata !DIExpression()), !dbg !109

  //   %conv1 = sext i32 %add to i64, !dbg !61

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !95, metadata !DIExpression()), !dbg !109

  //   store atomic i64 %conv1, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !61
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !96, metadata !DIExpression()), !dbg !101

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !97, metadata !DIExpression()), !dbg !112
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !129, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !148, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !153, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !157, metadata !DIExpression()), !dbg !197

  //   %conv22 = trunc i64 %8 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !154, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i32 %and23, metadata !159, metadata !DIExpression()), !dbg !160
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([102 x i8], [102 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
