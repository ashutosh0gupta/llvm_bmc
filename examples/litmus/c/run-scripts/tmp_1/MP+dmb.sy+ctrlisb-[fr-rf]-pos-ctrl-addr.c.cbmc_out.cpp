...
T2BLOCK7:
  ...
  //   %xor = xor i32 %conv19, %conv19, !dbg !123
  ...
  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !124
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !85, metadata !DIExpression()), !dbg !144

  //   %5 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !124
  // LD: Guess
  old_cr = cr(2,r7);
