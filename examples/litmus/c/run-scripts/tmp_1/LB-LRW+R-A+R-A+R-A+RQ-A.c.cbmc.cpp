...
T3BLOCK1:
  ...
  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !63
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !106, metadata !DIExpression()), !dbg !119

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !108, metadata !DIExpression()), !dbg !119

  //   store atomic i64 %1, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !66
  // ST: Guess
...
T4BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !124, metadata !DIExpression()), !dbg !140
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !126, metadata !DIExpression()), !dbg !143

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) acquire, align 8, !dbg !63
  // LD: Guess
  //   : Acquire
  old_cr = cr(4,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !128, metadata !DIExpression()), !dbg !143

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !125, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !129, metadata !DIExpression()), !dbg !146

  //   call void @llvm.dbg.value(metadata i64 2, metadata !131, metadata !DIExpression()), !dbg !146

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) release, align 8, !dbg !66
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !132, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64 1, metadata !134, metadata !DIExpression()), !dbg !148

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) monotonic, align 8, !dbg !68
  // ST: Guess
  iw(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STIW 
  old_cw = cw(4,0+4*1);
  cw(4,0+4*1) = get_rng(0,NCONTEXT-1);// 4 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !135, metadata !DIExpression()), !dbg !140

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !136, metadata !DIExpression()), !dbg !151
