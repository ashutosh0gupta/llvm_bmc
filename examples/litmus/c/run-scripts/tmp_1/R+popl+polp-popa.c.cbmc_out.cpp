...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !79, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !81, metadata !DIExpression()), !dbg !96
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !106, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !107, metadata !DIExpression()), !dbg !155

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !90

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !90

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !108, metadata !DIExpression()), !dbg !157

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !92

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !92

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !112, metadata !DIExpression()), !dbg !159

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !113, metadata !DIExpression()), !dbg !160

  //   call void @llvm.dbg.value(metadata i64 0, metadata !115, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !116, metadata !DIExpression()), !dbg !162

  //   call void @llvm.dbg.value(metadata i64 0, metadata !118, metadata !DIExpression()), !dbg !162
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !119, metadata !DIExpression()), !dbg !164

  //   call void @llvm.dbg.value(metadata i64 0, metadata !121, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !122, metadata !DIExpression()), !dbg !166
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !125, metadata !DIExpression()), !dbg !168
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !129, metadata !DIExpression()), !dbg !180
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !131, metadata !DIExpression()), !dbg !180

  //   %conv = trunc i64 %4 to i32, !dbg !116

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !128, metadata !DIExpression()), !dbg !155

  //   %cmp = icmp eq i32 %conv, 1, !dbg !117

  //   %conv12 = zext i1 %cmp to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !132, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !134, metadata !DIExpression()), !dbg !184
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !136, metadata !DIExpression()), !dbg !184

  //   %conv16 = trunc i64 %5 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !133, metadata !DIExpression()), !dbg !155

  //   %cmp17 = icmp eq i32 %conv16, 2, !dbg !121

  //   %conv18 = zext i1 %cmp17 to i32, !dbg !121

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !137, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !141, metadata !DIExpression()), !dbg !188

  //   %conv22 = trunc i64 %6 to i32, !dbg !124

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !138, metadata !DIExpression()), !dbg !155

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !125

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !125

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !142, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_2, metadata !144, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !146, metadata !DIExpression()), !dbg !192

  //   %conv28 = trunc i64 %7 to i32, !dbg !128

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !143, metadata !DIExpression()), !dbg !155

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !148, metadata !DIExpression()), !dbg !195
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !150, metadata !DIExpression()), !dbg !195

  //   %conv32 = trunc i64 %8 to i32, !dbg !131

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !147, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %and33, metadata !152, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %and34, metadata !153, metadata !DIExpression()), !dbg !155
  ...
  //   call void @llvm.dbg.value(metadata i32 %and35, metadata !154, metadata !DIExpression()), !dbg !155
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 66, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !139
