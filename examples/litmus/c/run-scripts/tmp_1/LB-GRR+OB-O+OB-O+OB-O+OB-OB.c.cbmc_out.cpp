...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !159, metadata !DIExpression()), !dbg !178
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !163, metadata !DIExpression()), !dbg !182
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !194, metadata !DIExpression()), !dbg !202
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !195, metadata !DIExpression()), !dbg !205

  //   call void @llvm.dbg.value(metadata i64 1, metadata !197, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !198, metadata !DIExpression()), !dbg !208

  //   call void @llvm.dbg.value(metadata i64 1, metadata !200, metadata !DIExpression()), !dbg !208
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !250, metadata !DIExpression()), !dbg !321
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !270, metadata !DIExpression()), !dbg !356
