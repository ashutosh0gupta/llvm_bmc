...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !111, metadata !DIExpression()), !dbg !126

  //   call void @llvm.dbg.value(metadata i64 1, metadata !113, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !115, metadata !DIExpression()), !dbg !129

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !117, metadata !DIExpression()), !dbg !129
