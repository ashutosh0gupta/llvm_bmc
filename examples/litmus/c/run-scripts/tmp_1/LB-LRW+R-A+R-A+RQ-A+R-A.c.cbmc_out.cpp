...
T1BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !41, metadata !DIExpression()), !dbg !56
...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !44, metadata !DIExpression()), !dbg !59
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !47, metadata !DIExpression()), !dbg !59

  //   %conv = trunc i64 %0 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !42, metadata !DIExpression()), !dbg !56

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !48, metadata !DIExpression()), !dbg !62

  //   call void @llvm.dbg.value(metadata i64 1, metadata !50, metadata !DIExpression()), !dbg !62

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0) release, align 8, !dbg !63
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !51, metadata !DIExpression()), !dbg !56

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !52, metadata !DIExpression()), !dbg !65

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !54, metadata !DIExpression()), !dbg !65

  //   store atomic i64 %1, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !66
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !70, metadata !DIExpression()), !dbg !83
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !72, metadata !DIExpression()), !dbg !86
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !74, metadata !DIExpression()), !dbg !86

  //   %conv = trunc i64 %0 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !71, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !75, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !89

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) release, align 8, !dbg !63
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !78, metadata !DIExpression()), !dbg !83

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !79, metadata !DIExpression()), !dbg !92

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !81, metadata !DIExpression()), !dbg !92
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !97, metadata !DIExpression()), !dbg !113
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !99, metadata !DIExpression()), !dbg !116

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !63
  // LD: Guess
  //   : Acquire
  old_cr = cr(3,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !101, metadata !DIExpression()), !dbg !116

  //   %conv = trunc i64 %0 to i32, !dbg !64

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !98, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !102, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64 2, metadata !104, metadata !DIExpression()), !dbg !119

  //   store atomic i64 2, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) release, align 8, !dbg !66
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !105, metadata !DIExpression()), !dbg !121

  //   call void @llvm.dbg.value(metadata i64 1, metadata !107, metadata !DIExpression()), !dbg !121

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !68
  // ST: Guess
  iw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW 
  old_cw = cw(3,0+3*1);
  cw(3,0+3*1) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM 
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !108, metadata !DIExpression()), !dbg !113

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !109, metadata !DIExpression()), !dbg !124

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !111, metadata !DIExpression()), !dbg !124
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !134, metadata !DIExpression()), !dbg !148

  //   call void @llvm.dbg.value(metadata i64 1, metadata !136, metadata !DIExpression()), !dbg !148

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) release, align 8, !dbg !63
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !138, metadata !DIExpression()), !dbg !151

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !140, metadata !DIExpression()), !dbg !151
...
T5BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !156, metadata !DIExpression()), !dbg !169

  //   br label %label_5, !dbg !57
  goto T5BLOCK1;

T5BLOCK1:
  //   call void @llvm.dbg.label(metadata !168), !dbg !171

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !158, metadata !DIExpression()), !dbg !172

  //   %0 = load atomic i64, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4) acquire, align 8, !dbg !60
  // LD: Guess
  //   : Acquire
  old_cr = cr(5,0+4*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !160, metadata !DIExpression()), !dbg !172

  //   %conv = trunc i64 %0 to i32, !dbg !61

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !157, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !175

  //   call void @llvm.dbg.value(metadata i64 1, metadata !163, metadata !DIExpression()), !dbg !175

  //   store atomic i64 1, i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1) monotonic, align 8, !dbg !63
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !164, metadata !DIExpression()), !dbg !169

  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !165, metadata !DIExpression()), !dbg !178

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !167, metadata !DIExpression()), !dbg !178

  //   store atomic i64 %1, i64* @atom_4_X0_1 seq_cst, align 8, !dbg !66
  // ST: Guess
  iw(5,9) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STIW 
  old_cw = cw(5,9);
  cw(5,9) = get_rng(0,NCONTEXT-1);// 5 ASSIGN STCOM 
  // Check
  ASSUME(active[iw(5,9)] == 5);
  ASSUME(active[cw(5,9)] == 5);
  ASSUME(sforbid(9,cw(5,9))== 0);
  ASSUME(iw(5,9) >= max(creg_r4,0));
  ASSUME(iw(5,9) >= 0);
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !188, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !189, metadata !DIExpression()), !dbg !252

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !111

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !111

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !190, metadata !DIExpression()), !dbg !254

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !113

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !113

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !194, metadata !DIExpression()), !dbg !256

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !115

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !115

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !195, metadata !DIExpression()), !dbg !258

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !117

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !117

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !196, metadata !DIExpression()), !dbg !260

  //   %4 = bitcast i64* %thr4 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %4) #7, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr4, metadata !197, metadata !DIExpression()), !dbg !262

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 4), metadata !198, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 3), metadata !201, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 2), metadata !204, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 1), metadata !207, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([5 x i64], [5 x i64]* @vars, i64 0, i64 0), metadata !210, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64 0, metadata !212, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !213, metadata !DIExpression()), !dbg !273

  //   call void @llvm.dbg.value(metadata i64 0, metadata !215, metadata !DIExpression()), !dbg !273

  //   store atomic i64 0, i64* @atom_0_X0_1 monotonic, align 8, !dbg !132
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !216, metadata !DIExpression()), !dbg !275

  //   call void @llvm.dbg.value(metadata i64 0, metadata !218, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !219, metadata !DIExpression()), !dbg !277

  //   call void @llvm.dbg.value(metadata i64 0, metadata !221, metadata !DIExpression()), !dbg !277

  //   store atomic i64 0, i64* @atom_2_X0_1 monotonic, align 8, !dbg !136
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !222, metadata !DIExpression()), !dbg !279

  //   call void @llvm.dbg.value(metadata i64 0, metadata !224, metadata !DIExpression()), !dbg !279

  //   store atomic i64 0, i64* @atom_3_X0_1 monotonic, align 8, !dbg !138
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !225, metadata !DIExpression()), !dbg !281

  //   call void @llvm.dbg.value(metadata i64 0, metadata !227, metadata !DIExpression()), !dbg !281

  //   store atomic i64 0, i64* @atom_4_X0_1 monotonic, align 8, !dbg !140
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !229, metadata !DIExpression()), !dbg !302

  //   %10 = load atomic i64, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !161
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !231, metadata !DIExpression()), !dbg !302

  //   %conv = trunc i64 %10 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !228, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !233, metadata !DIExpression()), !dbg !305

  //   %11 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !164
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !235, metadata !DIExpression()), !dbg !305

  //   %conv31 = trunc i64 %11 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv31, metadata !232, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !237, metadata !DIExpression()), !dbg !308

  //   %12 = load atomic i64, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !167
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !239, metadata !DIExpression()), !dbg !308

  //   %conv35 = trunc i64 %12 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !236, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !241, metadata !DIExpression()), !dbg !311

  //   %13 = load atomic i64, i64* @atom_3_X0_1 seq_cst, align 8, !dbg !170
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !243, metadata !DIExpression()), !dbg !311

  //   %conv39 = trunc i64 %13 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv39, metadata !240, metadata !DIExpression()), !dbg !252

  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !245, metadata !DIExpression()), !dbg !314

  //   %14 = load atomic i64, i64* @atom_4_X0_1 seq_cst, align 8, !dbg !173
  // LD: Guess
  old_cr = cr(0,9);
  ...
  //   call void @llvm.dbg.value(metadata i64 %14, metadata !247, metadata !DIExpression()), !dbg !314

  //   %conv43 = trunc i64 %14 to i32, !dbg !174

  //   call void @llvm.dbg.value(metadata i32 %conv43, metadata !244, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !248, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and44, metadata !249, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and45, metadata !250, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i32 %and46, metadata !251, metadata !DIExpression()), !dbg !252
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([108 x i8], [108 x i8]* @.str.1, i64 0, i64 0), i32 noundef 106, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !182
