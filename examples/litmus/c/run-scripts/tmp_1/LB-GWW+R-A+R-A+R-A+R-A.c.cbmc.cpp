...
T5BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 4), metadata !146, metadata !DIExpression()), !dbg !160
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !149, metadata !DIExpression()), !dbg !163

  //   call void @llvm.dbg.value(metadata i64 1, metadata !151, metadata !DIExpression()), !dbg !163
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_4_X0_1, metadata !153, metadata !DIExpression()), !dbg !166

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !155, metadata !DIExpression()), !dbg !166
...
T6BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !171, metadata !DIExpression()), !dbg !189
...
T6BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 5), metadata !173, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !175, metadata !DIExpression()), !dbg !192

  //   %conv = trunc i64 %0 to i32, !dbg !68

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !172, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([6 x i64], [6 x i64]* @vars, i64 0, i64 1), metadata !177, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !179, metadata !DIExpression()), !dbg !196

  //   %conv4 = trunc i64 %1 to i32, !dbg !72

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !176, metadata !DIExpression()), !dbg !189

  //   %cmp = icmp eq i32 %conv, 1, !dbg !73

  //   %conv5 = zext i1 %cmp to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv5, metadata !180, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* @atom_5_X0_1, metadata !181, metadata !DIExpression()), !dbg !200

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !183, metadata !DIExpression()), !dbg !200
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !184, metadata !DIExpression()), !dbg !189

  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !185, metadata !DIExpression()), !dbg !203

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !187, metadata !DIExpression()), !dbg !203
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !245, metadata !DIExpression()), !dbg !316
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_5_X2_0, metadata !265, metadata !DIExpression()), !dbg !351
