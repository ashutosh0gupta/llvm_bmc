...
T2BLOCK10:
  ...
  //   %cmp27 = icmp eq i32 %conv4, 2, !dbg !120

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !120

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !86, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !87, metadata !DIExpression()), !dbg !140
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !189, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !201, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !206, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !215, metadata !DIExpression()), !dbg !276
