...
T2BLOCK1:
  ...
  //   %xor17 = xor i32 %conv16, %conv16, !dbg !103
  creg_r10 = max(creg_r9,creg_r9);
  ASSUME(active[creg_r10] == 2);
  r10 = r9 ^ r9;

  //   call void @llvm.dbg.value(metadata i32 %xor17, metadata !79, metadata !DIExpression()), !dbg !105

  //   %add18 = add nsw i32 %xor17, 1, !dbg !104
  creg_r11 = max(creg_r10,0);
  ASSUME(active[creg_r11] == 2);
  r11 = r10 + 1;

  //   call void @llvm.dbg.value(metadata i32 %add18, metadata !80, metadata !DIExpression()), !dbg !105
  ...
  //   %conv19 = sext i32 %add18 to i64, !dbg !106

  //   call void @llvm.dbg.value(metadata i64 %conv19, metadata !83, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %conv19, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !106
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv4, 0, !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !93, metadata !DIExpression()), !dbg !133

  //   %6 = zext i32 %conv29 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !95, metadata !DIExpression()), !dbg !133

  //   store atomic i64 %6, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !115
  // ST: Guess
  ...
  //   %cmp33 = icmp eq i32 %conv8, 1, !dbg !116
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !97, metadata !DIExpression()), !dbg !136

  //   %7 = zext i32 %conv34 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !99, metadata !DIExpression()), !dbg !136

  //   store atomic i64 %7, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !118
  // ST: Guess
  ...
  //   %cmp38 = icmp eq i32 %conv23, 1, !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !101, metadata !DIExpression()), !dbg !139

  //   %8 = zext i32 %conv39 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !103, metadata !DIExpression()), !dbg !139

  //   store atomic i64 %8, i64* @atom_1_X11_1 seq_cst, align 8, !dbg !121
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !145, metadata !DIExpression()), !dbg !152
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !185, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !248

  //   store atomic i64 0, i64* @atom_1_X3_0 monotonic, align 8, !dbg !131
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !188, metadata !DIExpression()), !dbg !250

  //   call void @llvm.dbg.value(metadata i64 0, metadata !190, metadata !DIExpression()), !dbg !250

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !133
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !191, metadata !DIExpression()), !dbg !252
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !195, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !200, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !205, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_0, metadata !214, metadata !DIExpression()), !dbg !282

  //   %10 = load atomic i64, i64* @atom_1_X3_0 seq_cst, align 8, !dbg !165
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !218, metadata !DIExpression()), !dbg !285

  //   %11 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !168
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X11_1, metadata !222, metadata !DIExpression()), !dbg !288
