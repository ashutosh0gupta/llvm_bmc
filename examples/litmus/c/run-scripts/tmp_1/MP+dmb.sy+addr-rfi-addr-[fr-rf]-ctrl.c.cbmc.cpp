...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !85, metadata !DIExpression()), !dbg !135
  ...
  //   %cmp25 = icmp eq i32 %conv4, 1, !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !93, metadata !DIExpression()), !dbg !142
  ...
  //   %cmp30 = icmp eq i32 %conv12, 0, !dbg !125
  ...
  //   %cmp35 = icmp eq i32 %conv16, 1, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !101, metadata !DIExpression()), !dbg !148
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !197, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !200, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !203, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !234, metadata !DIExpression()), !dbg !314
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !238, metadata !DIExpression()), !dbg !317
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !242, metadata !DIExpression()), !dbg !320
