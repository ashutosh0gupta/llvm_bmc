...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !62, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64 1, metadata !64, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !66, metadata !DIExpression()), !dbg !80
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !87, metadata !DIExpression()), !dbg !101
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !89, metadata !DIExpression()), !dbg !101

  //   %conv = trunc i64 %0 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !86, metadata !DIExpression()), !dbg !98
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !92, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !94, metadata !DIExpression()), !dbg !108
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !115, metadata !DIExpression()), !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !118, metadata !DIExpression()), !dbg !133
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !146, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !147, metadata !DIExpression()), !dbg !196

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !93

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !93

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !148, metadata !DIExpression()), !dbg !198

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !95

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !95

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !152, metadata !DIExpression()), !dbg !200

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !97

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !97

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !153, metadata !DIExpression()), !dbg !202

  //   %3 = bitcast i64* %thr3 to i8*, !dbg !99

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %3) #7, !dbg !99

  //   call void @llvm.dbg.declare(metadata i64* %thr3, metadata !154, metadata !DIExpression()), !dbg !204

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !155, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !158, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !161, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !164, metadata !DIExpression()), !dbg !211
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !167, metadata !DIExpression()), !dbg !213
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !170, metadata !DIExpression()), !dbg !215
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !173, metadata !DIExpression()), !dbg !217
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !179, metadata !DIExpression()), !dbg !235

  //   %conv = trunc i64 %8 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !176, metadata !DIExpression()), !dbg !196

  //   %cmp = icmp eq i32 %conv, 3, !dbg !134

  //   %conv20 = zext i1 %cmp to i32, !dbg !134

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !180, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !184, metadata !DIExpression()), !dbg !239

  //   %conv24 = trunc i64 %9 to i32, !dbg !137

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !181, metadata !DIExpression()), !dbg !196

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !186, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !188, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X0_1, metadata !190, metadata !DIExpression()), !dbg !245
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !192, metadata !DIExpression()), !dbg !245

  //   %conv32 = trunc i64 %11 to i32, !dbg !143

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !189, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !193, metadata !DIExpression()), !dbg !196
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([106 x i8], [106 x i8]* @.str.1, i64 0, i64 0), i32 noundef 88, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !150
