...
T2BLOCK4:
  ...
  //   %xor14 = xor i32 %conv13, %conv13, !dbg !117
  ...
  //   %add16 = add nsw i32 0, %xor14, !dbg !118
  creg_r7 = max(0,creg_r6);
  ASSUME(active[creg_r7] == 2);
  r7 = 0 + r6;

  //   %idxprom = sext i32 %add16 to i64, !dbg !118

  //   %arrayidx = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom, !dbg !118
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ASSUME(creg_r8 >= creg_r7);
  ASSUME(active[creg_r8] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !86, metadata !DIExpression()), !dbg !138

  //   %4 = load atomic i64, i64* %arrayidx monotonic, align 8, !dbg !118
  // LD: Guess
  old_cr = cr(2,r8);
  ...
  //   %cmp29 = icmp eq i32 %conv9, 0, !dbg !127
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !98, metadata !DIExpression()), !dbg !147
  ...
  //   %cmp34 = icmp eq i32 %conv13, 1, !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !102, metadata !DIExpression()), !dbg !150
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !202, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !205, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !240, metadata !DIExpression()), !dbg !319
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !244, metadata !DIExpression()), !dbg !322
