...
T2BLOCK1:
  ...
  //   %add11 = add nsw i32 3, %xor9, !dbg !99
  ...
  //   %arrayidx13 = getelementptr inbounds [4 x i64], [4 x i64]* @vars, i64 0, i64 %idxprom12, !dbg !99
  r8 = 0+r7*1;
  ASSUME(creg_r8 >= 0);
  ...
  //   %tobool = icmp ne i32 %conv16, 0, !dbg !102
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !81, metadata !DIExpression()), !dbg !127

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !109
  // ST: Guess
