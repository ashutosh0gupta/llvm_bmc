...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !73, metadata !DIExpression()), !dbg !89

  //   call void @llvm.dbg.value(metadata i64 1, metadata !75, metadata !DIExpression()), !dbg !89
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !98, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !97, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !101, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !102, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !103, metadata !DIExpression()), !dbg !119

  //   %conv1 = sext i32 %add to i64, !dbg !63

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !105, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !106, metadata !DIExpression()), !dbg !111
