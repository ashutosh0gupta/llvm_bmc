...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !101, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !102, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64 1, metadata !104, metadata !DIExpression()), !dbg !118

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !60
  // ST: Guess
  iw(3,r8) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW 
  old_cw = cw(3,r8);
  cw(3,r8) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM 
  // Check
