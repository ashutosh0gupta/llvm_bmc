...
T2BLOCK7:
  ...
  //   %cmp29 = icmp eq i32 %conv12, 2, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !94, metadata !DIExpression()), !dbg !145

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !96, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %7, i64* @atom_1_X8_2 seq_cst, align 8, !dbg !127
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !197, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !223, metadata !DIExpression()), !dbg !291
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_2, metadata !227, metadata !DIExpression()), !dbg !294
