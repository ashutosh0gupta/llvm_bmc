...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !73, metadata !DIExpression()), !dbg !95
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !77, metadata !DIExpression()), !dbg !98
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !103, metadata !DIExpression()), !dbg !118
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !105, metadata !DIExpression()), !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !104, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !108, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !109, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !126

  //   %conv1 = sext i32 %add to i64, !dbg !63

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !112, metadata !DIExpression()), !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !113, metadata !DIExpression()), !dbg !118

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !114, metadata !DIExpression()), !dbg !129

  //   %1 = zext i32 %conv2 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !116, metadata !DIExpression()), !dbg !129
