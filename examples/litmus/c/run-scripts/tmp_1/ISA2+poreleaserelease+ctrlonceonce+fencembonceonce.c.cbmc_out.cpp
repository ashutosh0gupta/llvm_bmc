...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !59, metadata !DIExpression()), !dbg !75
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !62, metadata !DIExpression()), !dbg !72
...
T2BLOCK2:
  //   br label %lbl_label138, !dbg !64
  goto T2BLOCK4;

T2BLOCK3:
  //   br label %lbl_label138, !dbg !65
  goto T2BLOCK4;

T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !71), !dbg !84

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !63, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !66, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !67, metadata !DIExpression()), !dbg !88

  //   %1 = zext i32 %conv3 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !69, metadata !DIExpression()), !dbg !88
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !93, metadata !DIExpression()), !dbg !111
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !95, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !97, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !99, metadata !DIExpression()), !dbg !118
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !103, metadata !DIExpression()), !dbg !122

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !105, metadata !DIExpression()), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !106, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !107, metadata !DIExpression()), !dbg !125

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !109, metadata !DIExpression()), !dbg !125
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !152, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !155, metadata !DIExpression()), !dbg !190
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !158, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !162, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !166, metadata !DIExpression()), !dbg !210
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !170, metadata !DIExpression()), !dbg !213
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([135 x i8], [135 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
