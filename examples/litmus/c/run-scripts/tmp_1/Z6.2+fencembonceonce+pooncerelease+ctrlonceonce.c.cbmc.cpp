...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv1, metadata !88, metadata !DIExpression()), !dbg !98
...
T3BLOCK2:
  //   br label %lbl_label240, !dbg !62
  goto T3BLOCK4;

T3BLOCK3:
  //   br label %lbl_label240, !dbg !63
  goto T3BLOCK4;

T3BLOCK4:
  //   call void @llvm.dbg.label(metadata !97), !dbg !110

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !89, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv3, metadata !92, metadata !DIExpression()), !dbg !98
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([132 x i8], [132 x i8]* @.str.1, i64 0, i64 0), i32 noundef 72, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !123
