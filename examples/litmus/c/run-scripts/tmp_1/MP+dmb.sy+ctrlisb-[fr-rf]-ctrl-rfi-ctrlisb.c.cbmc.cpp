...
T2BLOCK10:
  ...
  //   %cmp27 = icmp eq i32 %conv4, 0, !dbg !134
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !91, metadata !DIExpression()), !dbg !154

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !93, metadata !DIExpression()), !dbg !154

  //   store atomic i64 %6, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !136
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv8, 1, !dbg !137
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !95, metadata !DIExpression()), !dbg !157

  //   %7 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !157

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !139
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !169, metadata !DIExpression()), !dbg !176
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !246, metadata !DIExpression()), !dbg !326
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !250, metadata !DIExpression()), !dbg !329
