...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor6, metadata !84, metadata !DIExpression()), !dbg !97

  //   %add8 = add nsw i32 0, %xor6, !dbg !80
  creg_r8 = max(0,creg_r7);
  ASSUME(active[creg_r8] == 2);
  r8 = 0 + r7;

  //   %idxprom = sext i32 %add8 to i64, !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !85, metadata !DIExpression()), !dbg !112

  //   call void @llvm.dbg.value(metadata i64 1, metadata !87, metadata !DIExpression()), !dbg !112
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !149, metadata !DIExpression()), !dbg !199
