...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !151, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !152, metadata !DIExpression()), !dbg !225

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !119

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #6, !dbg !119

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !153, metadata !DIExpression()), !dbg !227

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !121

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #6, !dbg !121

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !157, metadata !DIExpression()), !dbg !229

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !158, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64 0, metadata !160, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !161, metadata !DIExpression()), !dbg !232

  //   call void @llvm.dbg.value(metadata i64 0, metadata !163, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !164, metadata !DIExpression()), !dbg !234

  //   call void @llvm.dbg.value(metadata i64 0, metadata !166, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !167, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !170, metadata !DIExpression()), !dbg !238
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !173, metadata !DIExpression()), !dbg !240

  //   call void @llvm.dbg.value(metadata i64 0, metadata !175, metadata !DIExpression()), !dbg !240

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !134
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !176, metadata !DIExpression()), !dbg !242

  //   call void @llvm.dbg.value(metadata i64 0, metadata !178, metadata !DIExpression()), !dbg !242

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !136
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !179, metadata !DIExpression()), !dbg !244
  ...
  //   %call = call i32 @pthread_create(i64* noundef %thr0, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t0, i8* noundef null) #6, !dbg !139
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   %call15 = call i32 @pthread_create(i64* noundef %thr1, %union.pthread_attr_t* noundef null, i8* (i8*)* noundef @t1, i8* noundef null) #6, !dbg !140
  // dumbsy: Guess
  old_cdy = cdy[0];
  cdy[0] = get_rng(0,NCONTEXT-1);
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !183, metadata !DIExpression()), !dbg !256
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !185, metadata !DIExpression()), !dbg !256

  //   %conv = trunc i64 %4 to i32, !dbg !151

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !182, metadata !DIExpression()), !dbg !225

  //   %cmp = icmp eq i32 %conv, 1, !dbg !152

  //   %conv18 = zext i1 %cmp to i32, !dbg !152

  //   call void @llvm.dbg.value(metadata i32 %conv18, metadata !186, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !188, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !190, metadata !DIExpression()), !dbg !260

  //   %conv22 = trunc i64 %5 to i32, !dbg !155

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !187, metadata !DIExpression()), !dbg !225

  //   %cmp23 = icmp eq i32 %conv22, 1, !dbg !156

  //   %conv24 = zext i1 %cmp23 to i32, !dbg !156

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !191, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !193, metadata !DIExpression()), !dbg !264
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !195, metadata !DIExpression()), !dbg !264

  //   %conv28 = trunc i64 %6 to i32, !dbg !159

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !192, metadata !DIExpression()), !dbg !225

  //   %cmp29 = icmp eq i32 %conv28, 1, !dbg !160

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !160

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !196, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !198, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !200, metadata !DIExpression()), !dbg !268

  //   %conv34 = trunc i64 %7 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !197, metadata !DIExpression()), !dbg !225

  //   %cmp35 = icmp eq i32 %conv34, 1, !dbg !164

  //   %conv36 = zext i1 %cmp35 to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !201, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !205, metadata !DIExpression()), !dbg !272

  //   %conv40 = trunc i64 %8 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !202, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !207, metadata !DIExpression()), !dbg !275
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !209, metadata !DIExpression()), !dbg !275

  //   %conv44 = trunc i64 %9 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv44, metadata !206, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !211, metadata !DIExpression()), !dbg !278

  //   %10 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !172
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !213, metadata !DIExpression()), !dbg !278

  //   %conv48 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv48, metadata !210, metadata !DIExpression()), !dbg !225

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !215, metadata !DIExpression()), !dbg !281
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !217, metadata !DIExpression()), !dbg !281

  //   %conv52 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv52, metadata !214, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %and53, metadata !219, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %and54, metadata !220, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !221, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !222, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !223, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !224, metadata !DIExpression()), !dbg !225
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([120 x i8], [120 x i8]* @.str.1, i64 0, i64 0), i32 noundef 90, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #7, !dbg !187
