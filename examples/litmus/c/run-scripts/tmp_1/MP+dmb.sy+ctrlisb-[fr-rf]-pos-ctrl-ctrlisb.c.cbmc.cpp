...
T2BLOCK1:
  //   call void @llvm.dbg.label(metadata !107), !dbg !113
  ...
  //   %tobool = icmp ne i32 %conv, 0, !dbg !98
...
T2BLOCK4:
  //   call void @llvm.dbg.label(metadata !108), !dbg !122
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !68, metadata !DIExpression()), !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !70, metadata !DIExpression()), !dbg !124

  //   %conv4 = trunc i64 %1 to i32, !dbg !107

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !67, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !72, metadata !DIExpression()), !dbg !127

  //   %2 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !109
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !74, metadata !DIExpression()), !dbg !127

  //   %conv8 = trunc i64 %2 to i32, !dbg !110

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !71, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !76, metadata !DIExpression()), !dbg !130

  //   %3 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) monotonic, align 8, !dbg !112
  // LD: Guess
  old_cr = cr(2,0+2*1);
  cr(2,0+2*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  // Check
  ...
  //   call void @llvm.dbg.value(metadata i64 %3, metadata !78, metadata !DIExpression()), !dbg !130

  //   %conv12 = trunc i64 %3 to i32, !dbg !113

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !75, metadata !DIExpression()), !dbg !111

  //   %tobool13 = icmp ne i32 %conv12, 0, !dbg !114

  //   br i1 %tobool13, label %if.then14, label %if.else15, !dbg !116
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !109), !dbg !138

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !80, metadata !DIExpression()), !dbg !139

  //   %4 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !121
  // LD: Guess
  old_cr = cr(2,0+3*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !139

  //   %conv19 = trunc i64 %4 to i32, !dbg !122

  //   call void @llvm.dbg.value(metadata i32 %conv19, metadata !79, metadata !DIExpression()), !dbg !111

  //   %tobool20 = icmp ne i32 %conv19, 0, !dbg !123

  //   br i1 %tobool20, label %if.then21, label %if.else22, !dbg !125
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK8:
  //   br label %lbl_LC02, !dbg !126
  goto T2BLOCK10;

T2BLOCK9:
  //   br label %lbl_LC02, !dbg !127
  goto T2BLOCK10;

T2BLOCK10:
  //   call void @llvm.dbg.label(metadata !110), !dbg !147

  //   call void (...) @isb(), !dbg !129
  // isb: Guess
  cisb[2] = get_rng(0,NCONTEXT-1);
  // Check
  ASSUME(cisb[2] >= cdy[2]);
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !84, metadata !DIExpression()), !dbg !149

  //   %5 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !131
  // LD: Guess
  old_cr = cr(2,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !149

  //   %conv26 = trunc i64 %5 to i32, !dbg !132

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !83, metadata !DIExpression()), !dbg !111

  //   %cmp = icmp eq i32 %conv, 1, !dbg !133

  //   %conv27 = zext i1 %cmp to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv27, metadata !87, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !88, metadata !DIExpression()), !dbg !153

  //   %6 = zext i32 %conv27 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !153

  //   store atomic i64 %6, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !135
  // ST: Guess
  ...
  //   %cmp29 = icmp eq i32 %conv4, 0, !dbg !136

  //   %conv30 = zext i1 %cmp29 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !91, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !92, metadata !DIExpression()), !dbg !156

  //   %7 = zext i32 %conv30 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !156

  //   store atomic i64 %7, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !138
  // ST: Guess
  ...
  //   %cmp34 = icmp eq i32 %conv8, 1, !dbg !139

  //   %conv35 = zext i1 %cmp34 to i32, !dbg !139

  //   call void @llvm.dbg.value(metadata i32 %conv35, metadata !95, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !96, metadata !DIExpression()), !dbg !159

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !159

  //   store atomic i64 %8, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !141
  // ST: Guess
  ...
  //   %cmp39 = icmp eq i32 %conv12, 1, !dbg !142

  //   %conv40 = zext i1 %cmp39 to i32, !dbg !142

  //   call void @llvm.dbg.value(metadata i32 %conv40, metadata !99, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !100, metadata !DIExpression()), !dbg !162

  //   %9 = zext i32 %conv40 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !162

  //   store atomic i64 %9, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !144
  // ST: Guess
  ...
  //   %cmp44 = icmp eq i32 %conv26, 0, !dbg !145

  //   %conv45 = zext i1 %cmp44 to i32, !dbg !145

  //   call void @llvm.dbg.value(metadata i32 %conv45, metadata !103, metadata !DIExpression()), !dbg !111

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !104, metadata !DIExpression()), !dbg !165

  //   %10 = zext i32 %conv45 to i64

  //   call void @llvm.dbg.value(metadata i64 %10, metadata !106, metadata !DIExpression()), !dbg !165

  //   store atomic i64 %10, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !147
  // ST: Guess
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !171, metadata !DIExpression()), !dbg !178
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !188, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !189, metadata !DIExpression()), !dbg !265

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !190, metadata !DIExpression()), !dbg !267

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !126

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !126

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !194, metadata !DIExpression()), !dbg !269

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !128

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !128

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !195, metadata !DIExpression()), !dbg !271

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !196, metadata !DIExpression()), !dbg !272

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !272
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !199, metadata !DIExpression()), !dbg !274

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !202, metadata !DIExpression()), !dbg !276

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !205, metadata !DIExpression()), !dbg !278

  //   call void @llvm.dbg.value(metadata i64 0, metadata !207, metadata !DIExpression()), !dbg !278
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !208, metadata !DIExpression()), !dbg !280

  //   call void @llvm.dbg.value(metadata i64 0, metadata !210, metadata !DIExpression()), !dbg !280
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !211, metadata !DIExpression()), !dbg !282

  //   call void @llvm.dbg.value(metadata i64 0, metadata !213, metadata !DIExpression()), !dbg !282

  //   store atomic i64 0, i64* @atom_1_X2_0 monotonic, align 8, !dbg !141
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !214, metadata !DIExpression()), !dbg !284

  //   call void @llvm.dbg.value(metadata i64 0, metadata !216, metadata !DIExpression()), !dbg !284

  //   store atomic i64 0, i64* @atom_1_X4_1 monotonic, align 8, !dbg !143
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !217, metadata !DIExpression()), !dbg !286

  //   call void @llvm.dbg.value(metadata i64 0, metadata !219, metadata !DIExpression()), !dbg !286

  //   store atomic i64 0, i64* @atom_1_X5_1 monotonic, align 8, !dbg !145
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !220, metadata !DIExpression()), !dbg !288

  //   call void @llvm.dbg.value(metadata i64 0, metadata !222, metadata !DIExpression()), !dbg !288

  //   store atomic i64 0, i64* @atom_1_X8_0 monotonic, align 8, !dbg !147
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !224, metadata !DIExpression()), !dbg !303

  //   %6 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) seq_cst, align 8, !dbg !162
  // LD: Guess
  old_cr = cr(0,0);
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !226, metadata !DIExpression()), !dbg !303

  //   %conv = trunc i64 %6 to i32, !dbg !163

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !223, metadata !DIExpression()), !dbg !265

  //   %cmp = icmp eq i32 %conv, 1, !dbg !164

  //   %conv22 = zext i1 %cmp to i32, !dbg !164

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !227, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !229, metadata !DIExpression()), !dbg !307

  //   %7 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !166
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !231, metadata !DIExpression()), !dbg !307

  //   %conv26 = trunc i64 %7 to i32, !dbg !167

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !228, metadata !DIExpression()), !dbg !265

  //   %cmp27 = icmp eq i32 %conv26, 1, !dbg !168

  //   %conv28 = zext i1 %cmp27 to i32, !dbg !168

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !232, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !234, metadata !DIExpression()), !dbg !311

  //   %8 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) seq_cst, align 8, !dbg !170
  // LD: Guess
  old_cr = cr(0,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !236, metadata !DIExpression()), !dbg !311

  //   %conv32 = trunc i64 %8 to i32, !dbg !171

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !233, metadata !DIExpression()), !dbg !265

  //   %cmp33 = icmp eq i32 %conv32, 1, !dbg !172

  //   %conv34 = zext i1 %cmp33 to i32, !dbg !172

  //   call void @llvm.dbg.value(metadata i32 %conv34, metadata !237, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !239, metadata !DIExpression()), !dbg !315
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !241, metadata !DIExpression()), !dbg !315

  //   %conv38 = trunc i64 %9 to i32, !dbg !175

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !238, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !243, metadata !DIExpression()), !dbg !318

  //   %10 = load atomic i64, i64* @atom_1_X2_0 seq_cst, align 8, !dbg !177
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !245, metadata !DIExpression()), !dbg !318

  //   %conv42 = trunc i64 %10 to i32, !dbg !178

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !242, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !247, metadata !DIExpression()), !dbg !321

  //   %11 = load atomic i64, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !180
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !249, metadata !DIExpression()), !dbg !321

  //   %conv46 = trunc i64 %11 to i32, !dbg !181

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !246, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_1, metadata !251, metadata !DIExpression()), !dbg !324

  //   %12 = load atomic i64, i64* @atom_1_X5_1 seq_cst, align 8, !dbg !183
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !253, metadata !DIExpression()), !dbg !324

  //   %conv50 = trunc i64 %12 to i32, !dbg !184

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !250, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !255, metadata !DIExpression()), !dbg !327

  //   %13 = load atomic i64, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !186
  // LD: Guess
  old_cr = cr(0,8);
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !257, metadata !DIExpression()), !dbg !327

  //   %conv54 = trunc i64 %13 to i32, !dbg !187

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !254, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and, metadata !258, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !259, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !260, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !261, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !262, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !263, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !264, metadata !DIExpression()), !dbg !265
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([127 x i8], [127 x i8]* @.str.1, i64 0, i64 0), i32 noundef 105, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !198
