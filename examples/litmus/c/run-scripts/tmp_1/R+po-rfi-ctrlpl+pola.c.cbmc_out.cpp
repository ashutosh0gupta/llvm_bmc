...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64 1, metadata !44, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !47, metadata !DIExpression()), !dbg !74
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !49, metadata !DIExpression()), !dbg !74

  //   %conv = trunc i64 %0 to i32, !dbg !76

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !45, metadata !DIExpression()), !dbg !67
...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !66), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_1, metadata !62, metadata !DIExpression()), !dbg !92
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_1, metadata !148, metadata !DIExpression()), !dbg !199

  //   call void @llvm.dbg.value(metadata i64 0, metadata !150, metadata !DIExpression()), !dbg !199

  //   store atomic i64 0, i64* @atom_0_X4_1 monotonic, align 8, !dbg !113
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X4_1, metadata !174, metadata !DIExpression()), !dbg !228

  //   %8 = load atomic i64, i64* @atom_0_X4_1 seq_cst, align 8, !dbg !142
  // LD: Guess
  old_cr = cr(0,4);
