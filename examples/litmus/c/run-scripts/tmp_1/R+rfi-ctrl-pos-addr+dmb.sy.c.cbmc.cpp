...
T1BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !46, metadata !DIExpression()), !dbg !77
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !50, metadata !DIExpression()), !dbg !80
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !52, metadata !DIExpression()), !dbg !80

  //   %conv8 = trunc i64 %2 to i32, !dbg !82

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !49, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !53, metadata !DIExpression()), !dbg !63
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !54, metadata !DIExpression()), !dbg !85
