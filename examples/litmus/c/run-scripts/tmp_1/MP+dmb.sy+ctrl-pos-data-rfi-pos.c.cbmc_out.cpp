...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !64, metadata !DIExpression()), !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !72, metadata !DIExpression()), !dbg !98

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !73, metadata !DIExpression()), !dbg !118

  //   %conv9 = sext i32 %add to i64, !dbg !100

  //   call void @llvm.dbg.value(metadata i64 %conv9, metadata !75, metadata !DIExpression()), !dbg !118

  //   store atomic i64 %conv9, i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !100
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !77, metadata !DIExpression()), !dbg !120
  ...
  //   %conv13 = trunc i64 %3 to i32, !dbg !103
  ...
  //   %cmp22 = icmp eq i32 %conv13, 1, !dbg !110
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !143, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !144, metadata !DIExpression()), !dbg !194

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !94

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !94

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !145, metadata !DIExpression()), !dbg !196

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !96

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !96

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !149, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !159, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !162, metadata !DIExpression()), !dbg !207
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !165, metadata !DIExpression()), !dbg !209
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !171, metadata !DIExpression()), !dbg !221
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !172, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !176, metadata !DIExpression()), !dbg !225
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !177, metadata !DIExpression()), !dbg !194
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !183, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !185, metadata !DIExpression()), !dbg !232

  //   %conv28 = trunc i64 %7 to i32, !dbg !133

  //   call void @llvm.dbg.value(metadata i32 %conv28, metadata !182, metadata !DIExpression()), !dbg !194

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !187, metadata !DIExpression()), !dbg !235
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !189, metadata !DIExpression()), !dbg !235

  //   %conv32 = trunc i64 %8 to i32, !dbg !136

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !186, metadata !DIExpression()), !dbg !194
