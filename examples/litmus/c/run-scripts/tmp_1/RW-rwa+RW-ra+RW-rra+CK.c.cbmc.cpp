...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !96, metadata !DIExpression()), !dbg !114
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !100, metadata !DIExpression()), !dbg !117

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !102, metadata !DIExpression()), !dbg !117

  //   store atomic i64 %3, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !73
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !182, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !184, metadata !DIExpression()), !dbg !228

  //   store atomic i64 0, i64* @atom_2_X2_0 monotonic, align 8, !dbg !118
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X1_0, metadata !185, metadata !DIExpression()), !dbg !230

  //   call void @llvm.dbg.value(metadata i64 0, metadata !187, metadata !DIExpression()), !dbg !230

  //   store atomic i64 0, i64* @atom_3_X1_0 monotonic, align 8, !dbg !120
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !197, metadata !DIExpression()), !dbg !254

  //   %10 = load atomic i64, i64* @atom_2_X2_0 seq_cst, align 8, !dbg !144
  // LD: Guess
  old_cr = cr(0,6);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X1_0, metadata !201, metadata !DIExpression()), !dbg !257

  //   %11 = load atomic i64, i64* @atom_3_X1_0 seq_cst, align 8, !dbg !147
  // LD: Guess
  old_cr = cr(0,7);
