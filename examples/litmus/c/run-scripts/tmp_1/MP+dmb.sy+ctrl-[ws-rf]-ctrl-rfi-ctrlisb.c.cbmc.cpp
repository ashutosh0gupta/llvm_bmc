...
T2BLOCK10:
  ...
  //   %cmp25 = icmp eq i32 %conv4, 2, !dbg !125
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !88, metadata !DIExpression()), !dbg !145

  //   %5 = zext i32 %conv26 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !90, metadata !DIExpression()), !dbg !145

  //   store atomic i64 %5, i64* @atom_1_X4_2 seq_cst, align 8, !dbg !127
  // ST: Guess
  ...
  //   %cmp30 = icmp eq i32 %conv13, 1, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !92, metadata !DIExpression()), !dbg !148

  //   %6 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !148

  //   store atomic i64 %6, i64* @atom_1_X7_1 seq_cst, align 8, !dbg !130
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !197, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !200, metadata !DIExpression()), !dbg !268
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_2, metadata !231, metadata !DIExpression()), !dbg !304
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_1, metadata !235, metadata !DIExpression()), !dbg !307
