...
T1BLOCK1:
  ...
  //   store atomic i64 3, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !46
  // ST: Guess
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !63, metadata !DIExpression()), !dbg !80

  //   call void @llvm.dbg.value(metadata i64 2, metadata !65, metadata !DIExpression()), !dbg !80
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !106, metadata !DIExpression()), !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !110, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !112, metadata !DIExpression()), !dbg !140

  //   %conv = trunc i64 %4 to i32, !dbg !87

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !109, metadata !DIExpression()), !dbg !119

  //   %cmp = icmp eq i32 %conv, 3, !dbg !88

  //   %conv8 = zext i1 %cmp to i32, !dbg !88

  //   call void @llvm.dbg.value(metadata i32 %conv8, metadata !113, metadata !DIExpression()), !dbg !119

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !115, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !117, metadata !DIExpression()), !dbg !144

  //   %conv12 = trunc i64 %5 to i32, !dbg !91

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !114, metadata !DIExpression()), !dbg !119
