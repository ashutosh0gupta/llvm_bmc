...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !75, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !82, metadata !DIExpression()), !dbg !95
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !102, metadata !DIExpression()), !dbg !116
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !149, metadata !DIExpression()), !dbg !185
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !152, metadata !DIExpression()), !dbg !187
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !155, metadata !DIExpression()), !dbg !189
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !159, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !167, metadata !DIExpression()), !dbg !210
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([100 x i8], [100 x i8]* @.str.1, i64 0, i64 0), i32 noundef 73, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
