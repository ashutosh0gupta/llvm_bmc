...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !170, metadata !DIExpression()), !dbg !228

  //   call void @llvm.dbg.value(metadata i64 0, metadata !172, metadata !DIExpression()), !dbg !228

  //   store atomic i64 0, i64* @atom_1_X8_1 monotonic, align 8, !dbg !125
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !173, metadata !DIExpression()), !dbg !230
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !200, metadata !DIExpression()), !dbg !260

  //   %9 = load atomic i64, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !157
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !204, metadata !DIExpression()), !dbg !263
