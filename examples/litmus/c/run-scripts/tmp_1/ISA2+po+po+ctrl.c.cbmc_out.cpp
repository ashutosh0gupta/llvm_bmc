...
T3BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !90, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !92, metadata !DIExpression()), !dbg !115
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !94, metadata !DIExpression()), !dbg !119

  //   %2 = zext i32 %conv5 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !96, metadata !DIExpression()), !dbg !119
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X2_0, metadata !98, metadata !DIExpression()), !dbg !122

  //   %3 = zext i32 %conv8 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !100, metadata !DIExpression()), !dbg !122
