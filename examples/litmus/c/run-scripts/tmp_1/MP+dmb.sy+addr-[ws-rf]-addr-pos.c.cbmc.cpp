...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !73, metadata !DIExpression()), !dbg !99

  //   %add7 = add nsw i32 0, %xor5, !dbg !93
  ...
  //   %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !93
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !75, metadata !DIExpression()), !dbg !113
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !74, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !87, metadata !DIExpression()), !dbg !122

  //   %5 = zext i32 %conv22 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !89, metadata !DIExpression()), !dbg !122

  //   store atomic i64 %5, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !95, metadata !DIExpression()), !dbg !128

  //   %7 = zext i32 %conv32 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !97, metadata !DIExpression()), !dbg !128

  //   store atomic i64 %7, i64* @atom_1_X9_0 seq_cst, align 8, !dbg !110
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !171, metadata !DIExpression()), !dbg !232
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !174, metadata !DIExpression()), !dbg !234
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !177, metadata !DIExpression()), !dbg !236
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !200, metadata !DIExpression()), !dbg !266
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !204, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_0, metadata !208, metadata !DIExpression()), !dbg !272
