...
T2BLOCK4:
  ...
  //   %tobool9 = icmp ne i32 %conv8, 0, !dbg !109

  //   br i1 %tobool9, label %if.then10, label %if.else11, !dbg !111
  old_cctrl = cctrl[2];
  cctrl[2] = get_rng(0,NCONTEXT-1);
  ASSUME(cctrl[2] >= old_cctrl);
...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !108), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 1, metadata !77, metadata !DIExpression()), !dbg !134

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !116
  // ST: Guess
