...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !67, metadata !DIExpression()), !dbg !82
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 1), metadata !69, metadata !DIExpression()), !dbg !85
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !71, metadata !DIExpression()), !dbg !85

  //   %conv = trunc i64 %0 to i32, !dbg !59

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !68, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !72, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !73, metadata !DIExpression()), !dbg !82
  ...
  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !76, metadata !DIExpression()), !dbg !90
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !77, metadata !DIExpression()), !dbg !82

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !78, metadata !DIExpression()), !dbg !93
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !98, metadata !DIExpression()), !dbg !112
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !99, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !103, metadata !DIExpression()), !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !104, metadata !DIExpression()), !dbg !120

  //   call void @llvm.dbg.value(metadata i64 1, metadata !106, metadata !DIExpression()), !dbg !120

  //   store atomic i64 1, i64* %arrayidx monotonic, align 8, !dbg !60
  // ST: Guess
  iw(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STIW 
  old_cw = cw(3,r7);
  cw(3,r7) = get_rng(0,NCONTEXT-1);// 3 ASSIGN STCOM 
  // Check
