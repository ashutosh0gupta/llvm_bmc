...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !81, metadata !DIExpression()), !dbg !92
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !85, metadata !DIExpression()), !dbg !96

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !87, metadata !DIExpression()), !dbg !96

  //   store atomic i64 %1, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !57
  // ST: Guess
...
T4BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X1_0, metadata !110, metadata !DIExpression()), !dbg !124

  //   %1 = zext i32 %conv1 to i64

  //   call void @llvm.dbg.value(metadata i64 %1, metadata !112, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %1, i64* @atom_3_X1_0 seq_cst, align 8, !dbg !63
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !152, metadata !DIExpression()), !dbg !193

  //   call void @llvm.dbg.value(metadata i64 0, metadata !154, metadata !DIExpression()), !dbg !193

  //   store atomic i64 0, i64* @atom_2_X0_1 monotonic, align 8, !dbg !102
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X1_0, metadata !155, metadata !DIExpression()), !dbg !195

  //   call void @llvm.dbg.value(metadata i64 0, metadata !157, metadata !DIExpression()), !dbg !195

  //   store atomic i64 0, i64* @atom_3_X1_0 monotonic, align 8, !dbg !104
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !159, metadata !DIExpression()), !dbg !213

  //   %8 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) seq_cst, align 8, !dbg !122
  // LD: Guess
  old_cr = cr(0,0+1*1);
  ...
  //   %9 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !126
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   %10 = load atomic i64, i64* @atom_2_X0_1 seq_cst, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_3_X1_0, metadata !172, metadata !DIExpression()), !dbg !223

  //   %11 = load atomic i64, i64* @atom_3_X1_0 seq_cst, align 8, !dbg !132
  // LD: Guess
  old_cr = cr(0,4);
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([90 x i8], [90 x i8]* @.str.1, i64 0, i64 0), i32 noundef 82, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !140
