...
T2BLOCK7:
  //   call void @llvm.dbg.label(metadata !105), !dbg !129

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !76, metadata !DIExpression()), !dbg !130
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !80, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 %4, metadata !82, metadata !DIExpression()), !dbg !133
  ...
  //   call void @llvm.dbg.value(metadata i64 %5, metadata !86, metadata !DIExpression()), !dbg !137
  ...
  //   %cmp22 = icmp eq i32 %conv4, 0, !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !88, metadata !DIExpression()), !dbg !140

  //   %6 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !90, metadata !DIExpression()), !dbg !140
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !92, metadata !DIExpression()), !dbg !143

  //   %7 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %7, metadata !94, metadata !DIExpression()), !dbg !143

  //   store atomic i64 %7, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !125
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv15, 0, !dbg !126
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !96, metadata !DIExpression()), !dbg !146

  //   %8 = zext i32 %conv33 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !98, metadata !DIExpression()), !dbg !146
  ...
  //   %cmp37 = icmp eq i32 %conv19, 0, !dbg !129
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !100, metadata !DIExpression()), !dbg !149

  //   %9 = zext i32 %conv38 to i64

  //   call void @llvm.dbg.value(metadata i64 %9, metadata !102, metadata !DIExpression()), !dbg !149

  //   store atomic i64 %9, i64* @atom_1_X7_0 seq_cst, align 8, !dbg !131
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !192, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !195, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !198, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_0, metadata !201, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !224, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !228, metadata !DIExpression()), !dbg !300
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_0, metadata !232, metadata !DIExpression()), !dbg !303
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([116 x i8], [116 x i8]* @.str.1, i64 0, i64 0), i32 noundef 99, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !193
