...
T2BLOCK7:
  ...
  //   %cmp26 = icmp eq i32 %conv4, 0, !dbg !125
  ...
  //   %cmp31 = icmp eq i32 %conv8, 1, !dbg !128
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !197, metadata !DIExpression()), !dbg !260
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !200, metadata !DIExpression()), !dbg !262
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !207, metadata !DIExpression()), !dbg !279
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !212, metadata !DIExpression()), !dbg !283
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !217, metadata !DIExpression()), !dbg !287
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !226, metadata !DIExpression()), !dbg !294
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !230, metadata !DIExpression()), !dbg !297
