...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !81, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !94, metadata !DIExpression()), !dbg !121

  //   %4 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !96, metadata !DIExpression()), !dbg !121

  //   store atomic i64 %4, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !91
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !98, metadata !DIExpression()), !dbg !124

  //   %5 = zext i32 %conv19 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !100, metadata !DIExpression()), !dbg !124

  //   store atomic i64 %5, i64* @atom_1_X4_0 seq_cst, align 8, !dbg !94
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !153, metadata !DIExpression()), !dbg !203
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !156, metadata !DIExpression()), !dbg !205
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !178, metadata !DIExpression()), !dbg !231
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !182, metadata !DIExpression()), !dbg !234
