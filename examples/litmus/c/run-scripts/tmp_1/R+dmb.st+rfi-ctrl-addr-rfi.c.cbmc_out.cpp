...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv10, metadata !72, metadata !DIExpression()), !dbg !86

  //   %cmp = icmp eq i32 %conv, 2, !dbg !90

  //   %conv11 = zext i1 %cmp to i32, !dbg !90

  //   call void @llvm.dbg.value(metadata i32 %conv11, metadata !76, metadata !DIExpression()), !dbg !86
  ...
  //   %cmp15 = icmp eq i32 %conv10, 1, !dbg !93

  //   %conv16 = zext i1 %cmp15 to i32, !dbg !93

  //   call void @llvm.dbg.value(metadata i32 %conv16, metadata !80, metadata !DIExpression()), !dbg !86

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !81, metadata !DIExpression()), !dbg !113

  //   %4 = zext i32 %conv16 to i64

  //   call void @llvm.dbg.value(metadata i64 %4, metadata !83, metadata !DIExpression()), !dbg !113

  //   store atomic i64 %4, i64* @atom_1_X8_1 seq_cst, align 8, !dbg !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !139, metadata !DIExpression()), !dbg !177
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !142, metadata !DIExpression()), !dbg !179
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_2, metadata !156, metadata !DIExpression()), !dbg !199
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_1, metadata !160, metadata !DIExpression()), !dbg !202
