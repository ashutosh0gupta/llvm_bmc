...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !42, metadata !DIExpression()), !dbg !51
...
T2BLOCK4:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1), metadata !62, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64 2, metadata !64, metadata !DIExpression()), !dbg !99
  ...
  //   %1 = load atomic i64, i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !84
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+1*1);
  cr(2,0+1*1) = get_rng(0,NCONTEXT-1);// 2 ASSIGN LDCOM 
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([2 x i64], [2 x i64]* @vars, i64 0, i64 0), metadata !70, metadata !DIExpression()), !dbg !104
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !78, metadata !DIExpression()), !dbg !111
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !82, metadata !DIExpression()), !dbg !114
...
T0BLOCK0:
  ...
  //   store atomic i64 0, i64* @atom_1_X0_1 monotonic, align 8, !dbg !94
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !140, metadata !DIExpression()), !dbg !177

  //   call void @llvm.dbg.value(metadata i64 0, metadata !142, metadata !DIExpression()), !dbg !177

  //   store atomic i64 0, i64* @atom_1_X3_2 monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !143, metadata !DIExpression()), !dbg !179

  //   call void @llvm.dbg.value(metadata i64 0, metadata !145, metadata !DIExpression()), !dbg !179

  //   store atomic i64 0, i64* @atom_1_X4_0 monotonic, align 8, !dbg !98
  // ST: Guess
  ...
  //   %5 = load atomic i64, i64* @atom_1_X0_1 seq_cst, align 8, !dbg !114
  // LD: Guess
  old_cr = cr(0,2);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !156, metadata !DIExpression()), !dbg !198

  //   %6 = load atomic i64, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !117
  // LD: Guess
  old_cr = cr(0,3);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_0, metadata !160, metadata !DIExpression()), !dbg !201
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([91 x i8], [91 x i8]* @.str.1, i64 0, i64 0), i32 noundef 67, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !128
