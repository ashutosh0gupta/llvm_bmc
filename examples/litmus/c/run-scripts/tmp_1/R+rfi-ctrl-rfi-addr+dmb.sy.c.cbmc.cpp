...
T1BLOCK4:
  //   call void @llvm.dbg.label(metadata !67), !dbg !81
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !55, metadata !DIExpression()), !dbg !89
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !63, metadata !DIExpression()), !dbg !94

  //   %3 = zext i32 %conv14 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !65, metadata !DIExpression()), !dbg !94

  //   store atomic i64 %3, i64* @atom_0_X5_1 seq_cst, align 8, !dbg !95
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !151, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X5_1, metadata !177, metadata !DIExpression()), !dbg !231
