...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !60, metadata !DIExpression()), !dbg !69

  //   %add = add nsw i32 2, %xor, !dbg !58
  ...
  //   %arrayidx = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom, !dbg !58
  r3 = 0+r2*1;
  ASSUME(creg_r3 >= 0);
  ASSUME(creg_r3 >= creg_r2);
  ASSUME(active[creg_r3] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !61, metadata !DIExpression()), !dbg !77

  //   call void @llvm.dbg.value(metadata i64 1, metadata !63, metadata !DIExpression()), !dbg !77
...
T3BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !84, metadata !DIExpression()), !dbg !99
...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 2), metadata !86, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !88, metadata !DIExpression()), !dbg !102

  //   %conv = trunc i64 %0 to i32, !dbg !57

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !85, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !89, metadata !DIExpression()), !dbg !99
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !90, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !91, metadata !DIExpression()), !dbg !107

  //   %conv1 = sext i32 %add to i64, !dbg !61

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !93, metadata !DIExpression()), !dbg !107
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !94, metadata !DIExpression()), !dbg !99

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !95, metadata !DIExpression()), !dbg !110
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !127, metadata !DIExpression()), !dbg !164
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !146, metadata !DIExpression()), !dbg !188
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !151, metadata !DIExpression()), !dbg !192
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !155, metadata !DIExpression()), !dbg !195

  //   %conv22 = trunc i64 %8 to i32, !dbg !117

  //   call void @llvm.dbg.value(metadata i32 %conv22, metadata !152, metadata !DIExpression()), !dbg !158
