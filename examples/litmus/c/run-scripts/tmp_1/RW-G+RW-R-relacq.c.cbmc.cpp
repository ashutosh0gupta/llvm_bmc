...
T1BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !46, metadata !DIExpression()), !dbg !72

  //   call void @llvm.dbg.value(metadata i64 1, metadata !48, metadata !DIExpression()), !dbg !72
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !50, metadata !DIExpression()), !dbg !75

  //   %1 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) acquire, align 8, !dbg !76
  // LD: Guess
  //   : Acquire
  old_cr = cr(1,0+1*1);
  ...
  ASSUME(cr(1,0+1*1) >= cs(1,7+0));
  ASSUME(cr(1,0+1*1) >= cs(1,4+0));
  ASSUME(cr(1,0+1*1) >= cs(1,6+0));
  ASSUME(cr(1,0+1*1) >= cs(1,5+0));
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !53, metadata !DIExpression()), !dbg !79

  //   call void @llvm.dbg.value(metadata i64 1, metadata !55, metadata !DIExpression()), !dbg !79

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0) monotonic, align 8, !dbg !80
  // ST: Guess
  ...
  //   %conv7 = zext i1 %cmp to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !56, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !57, metadata !DIExpression()), !dbg !82

  //   %2 = zext i32 %conv7 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !59, metadata !DIExpression()), !dbg !82

  //   store atomic i64 %2, i64* @atom_0_X0_1 seq_cst, align 8, !dbg !83
  // ST: Guess
  ...
  //   %cmp11 = icmp eq i32 %conv4, 1, !dbg !84

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !84

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !60, metadata !DIExpression()), !dbg !65

  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !61, metadata !DIExpression()), !dbg !85

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !63, metadata !DIExpression()), !dbg !85

  //   store atomic i64 %3, i64* @atom_0_X3_1 seq_cst, align 8, !dbg !86
  // ST: Guess
...
T2BLOCK0:
  //   call void @llvm.dbg.value(metadata i8* %arg, metadata !90, metadata !DIExpression()), !dbg !114
...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !92, metadata !DIExpression()), !dbg !117

  //   %0 = load atomic i64, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2) acquire, align 8, !dbg !69
  // LD: Guess
  //   : Acquire
  old_cr = cr(2,0+2*1);
  ...
  //   call void @llvm.dbg.value(metadata i64 %0, metadata !94, metadata !DIExpression()), !dbg !117

  //   %conv = trunc i64 %0 to i32, !dbg !70

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !91, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !96, metadata !DIExpression()), !dbg !120
  ...
  //   call void @llvm.dbg.value(metadata i64 %1, metadata !98, metadata !DIExpression()), !dbg !120

  //   %conv4 = trunc i64 %1 to i32, !dbg !73

  //   call void @llvm.dbg.value(metadata i32 %conv4, metadata !95, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !99, metadata !DIExpression()), !dbg !123

  //   call void @llvm.dbg.value(metadata i64 1, metadata !101, metadata !DIExpression()), !dbg !123

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3) monotonic, align 8, !dbg !75
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !102, metadata !DIExpression()), !dbg !125

  //   call void @llvm.dbg.value(metadata i64 1, metadata !104, metadata !DIExpression()), !dbg !125

  //   store atomic i64 1, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1) release, align 8, !dbg !77
  // ST: Guess
  //   : Release
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv7, metadata !105, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !106, metadata !DIExpression()), !dbg !128

  //   %2 = zext i32 %conv7 to i64

  //   call void @llvm.dbg.value(metadata i64 %2, metadata !108, metadata !DIExpression()), !dbg !128
  ...
  //   %cmp11 = icmp eq i32 %conv, 1, !dbg !81

  //   %conv12 = zext i1 %cmp11 to i32, !dbg !81

  //   call void @llvm.dbg.value(metadata i32 %conv12, metadata !109, metadata !DIExpression()), !dbg !114

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !110, metadata !DIExpression()), !dbg !131

  //   %3 = zext i32 %conv12 to i64

  //   call void @llvm.dbg.value(metadata i64 %3, metadata !112, metadata !DIExpression()), !dbg !131
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !148, metadata !DIExpression()), !dbg !196
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !151, metadata !DIExpression()), !dbg !198
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !157, metadata !DIExpression()), !dbg !202
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !160, metadata !DIExpression()), !dbg !204
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !163, metadata !DIExpression()), !dbg !206

  //   call void @llvm.dbg.value(metadata i64 0, metadata !165, metadata !DIExpression()), !dbg !206

  //   store atomic i64 0, i64* @atom_1_X2_1 monotonic, align 8, !dbg !110
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !169, metadata !DIExpression()), !dbg !210

  //   call void @llvm.dbg.value(metadata i64 0, metadata !171, metadata !DIExpression()), !dbg !210

  //   store atomic i64 0, i64* @atom_0_X3_1 monotonic, align 8, !dbg !114
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X0_1, metadata !173, metadata !DIExpression()), !dbg !222
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_1, metadata !177, metadata !DIExpression()), !dbg !225

  //   %5 = load atomic i64, i64* @atom_1_X2_1 seq_cst, align 8, !dbg !129
  // LD: Guess
  old_cr = cr(0,5);
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_0_X3_1, metadata !185, metadata !DIExpression()), !dbg !231

  //   %7 = load atomic i64, i64* @atom_0_X3_1 seq_cst, align 8, !dbg !135
  // LD: Guess
  old_cr = cr(0,7);
  ...
  //   %or = or i32 %conv25, %conv29, !dbg !137
  creg_r11 = max(creg_r9,creg_r10);
  ASSUME(active[creg_r11] == 0);
  r11 = r9 | r10;

  //   call void @llvm.dbg.value(metadata i32 %or, metadata !188, metadata !DIExpression()), !dbg !191

  //   %and = and i32 %conv21, %or, !dbg !138
  creg_r12 = max(creg_r8,creg_r11);
  ASSUME(active[creg_r12] == 0);
  r12 = r8 & r11;

  //   call void @llvm.dbg.value(metadata i32 %and, metadata !189, metadata !DIExpression()), !dbg !191

  //   %and30 = and i32 %conv, %and, !dbg !139
  creg_r13 = max(creg_r7,creg_r12);
  ASSUME(active[creg_r13] == 0);
  r13 = r7 & r12;

  //   call void @llvm.dbg.value(metadata i32 %and30, metadata !190, metadata !DIExpression()), !dbg !191

  //   %cmp = icmp eq i32 %and30, 1, !dbg !140
...
T0BLOCK1:
  //   call void @__assert_fail(i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i8* noundef getelementptr inbounds ([101 x i8], [101 x i8]* @.str.1, i64 0, i64 0), i32 noundef 75, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #8, !dbg !143
