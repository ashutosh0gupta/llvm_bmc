...
T2BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor5, metadata !73, metadata !DIExpression()), !dbg !102

  //   %add7 = add nsw i32 0, %xor5, !dbg !96
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom8 = sext i32 %add7 to i64, !dbg !96

  //   %arrayidx9 = getelementptr inbounds [3 x i64], [3 x i64]* @vars, i64 0, i64 %idxprom8, !dbg !96
  r7 = 0+r6*1;
  ASSUME(creg_r7 >= 0);
  ASSUME(creg_r7 >= creg_r6);
  ASSUME(active[creg_r7] == 2);

  //   call void @llvm.dbg.value(metadata i64* %arrayidx9, metadata !74, metadata !DIExpression()), !dbg !116

  //   call void @llvm.dbg.value(metadata i64 1, metadata !76, metadata !DIExpression()), !dbg !116

  //   store atomic i64 1, i64* %arrayidx9 monotonic, align 8, !dbg !96
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !78, metadata !DIExpression()), !dbg !117
  ...
  //   call void @llvm.dbg.value(metadata i64 %2, metadata !80, metadata !DIExpression()), !dbg !117

  //   %conv14 = trunc i64 %2 to i32, !dbg !100

  //   call void @llvm.dbg.value(metadata i32 %conv14, metadata !77, metadata !DIExpression()), !dbg !102
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !90, metadata !DIExpression()), !dbg !127

  //   %5 = zext i32 %conv24 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !92, metadata !DIExpression()), !dbg !127

  //   store atomic i64 %5, i64* @atom_1_X5_2 seq_cst, align 8, !dbg !109
  // ST: Guess
  ...
  //   %cmp28 = icmp eq i32 %conv14, 1, !dbg !110
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !94, metadata !DIExpression()), !dbg !130
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !176, metadata !DIExpression()), !dbg !237
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !179, metadata !DIExpression()), !dbg !239

  //   call void @llvm.dbg.value(metadata i64 0, metadata !181, metadata !DIExpression()), !dbg !239

  //   store atomic i64 0, i64* @atom_1_X9_1 monotonic, align 8, !dbg !128
  // ST: Guess
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X5_2, metadata !205, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X9_1, metadata !209, metadata !DIExpression()), !dbg !274

  //   %11 = load atomic i64, i64* @atom_1_X9_1 seq_cst, align 8, !dbg !163
  // LD: Guess
  old_cr = cr(0,5);
