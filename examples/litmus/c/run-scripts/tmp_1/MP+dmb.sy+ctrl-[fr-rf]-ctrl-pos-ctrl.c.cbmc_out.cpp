...
T2BLOCK10:
  ...
  //   %cmp29 = icmp eq i32 %conv4, 0, !dbg !128
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !90, metadata !DIExpression()), !dbg !148
  ...
  //   %cmp34 = icmp eq i32 %conv8, 1, !dbg !131
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !94, metadata !DIExpression()), !dbg !151

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !96, metadata !DIExpression()), !dbg !151

  //   store atomic i64 %8, i64* @atom_1_X4_1 seq_cst, align 8, !dbg !133
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !200, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !203, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !210, metadata !DIExpression()), !dbg !282
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !215, metadata !DIExpression()), !dbg !286
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !220, metadata !DIExpression()), !dbg !290
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X2_0, metadata !229, metadata !DIExpression()), !dbg !297
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !233, metadata !DIExpression()), !dbg !300
