...
T3BLOCK1:
  ...
  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !87, metadata !DIExpression()), !dbg !97
  ...
  //   call void @llvm.dbg.value(metadata i32 %add, metadata !88, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([3 x i64], [3 x i64]* @vars, i64 0, i64 0), metadata !89, metadata !DIExpression()), !dbg !105

  //   %conv1 = sext i32 %add to i64, !dbg !61

  //   call void @llvm.dbg.value(metadata i64 %conv1, metadata !91, metadata !DIExpression()), !dbg !105
  ...
  //   call void @llvm.dbg.value(metadata i32 %conv2, metadata !92, metadata !DIExpression()), !dbg !97

  //   call void @llvm.dbg.value(metadata i64* @atom_2_X0_1, metadata !93, metadata !DIExpression()), !dbg !108
