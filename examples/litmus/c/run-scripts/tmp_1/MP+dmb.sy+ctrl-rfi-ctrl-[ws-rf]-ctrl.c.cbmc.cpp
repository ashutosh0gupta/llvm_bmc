...
T2BLOCK10:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !92, metadata !DIExpression()), !dbg !147

  //   %6 = zext i32 %conv31 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !94, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %6, i64* @atom_1_X7_2 seq_cst, align 8, !dbg !129
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i32 %argc, metadata !173, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i8** %argv, metadata !174, metadata !DIExpression()), !dbg !248

  //   %0 = bitcast i64* %thr0 to i8*, !dbg !120

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %0) #7, !dbg !120

  //   call void @llvm.dbg.declare(metadata i64* %thr0, metadata !175, metadata !DIExpression()), !dbg !250

  //   %1 = bitcast i64* %thr1 to i8*, !dbg !122

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %1) #7, !dbg !122

  //   call void @llvm.dbg.declare(metadata i64* %thr1, metadata !179, metadata !DIExpression()), !dbg !252

  //   %2 = bitcast i64* %thr2 to i8*, !dbg !124

  //   call void @llvm.lifetime.start.p0i8(i64 8, i8* %2) #7, !dbg !124

  //   call void @llvm.dbg.declare(metadata i64* %thr2, metadata !180, metadata !DIExpression()), !dbg !254

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !181, metadata !DIExpression()), !dbg !255

  //   call void @llvm.dbg.value(metadata i64 0, metadata !183, metadata !DIExpression()), !dbg !255
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !184, metadata !DIExpression()), !dbg !257

  //   call void @llvm.dbg.value(metadata i64 0, metadata !186, metadata !DIExpression()), !dbg !257
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !187, metadata !DIExpression()), !dbg !259

  //   call void @llvm.dbg.value(metadata i64 0, metadata !189, metadata !DIExpression()), !dbg !259
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !190, metadata !DIExpression()), !dbg !261

  //   call void @llvm.dbg.value(metadata i64 0, metadata !192, metadata !DIExpression()), !dbg !261
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X0_1, metadata !193, metadata !DIExpression()), !dbg !263

  //   call void @llvm.dbg.value(metadata i64 0, metadata !195, metadata !DIExpression()), !dbg !263
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X4_1, metadata !196, metadata !DIExpression()), !dbg !265

  //   call void @llvm.dbg.value(metadata i64 0, metadata !198, metadata !DIExpression()), !dbg !265
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !199, metadata !DIExpression()), !dbg !267

  //   call void @llvm.dbg.value(metadata i64 0, metadata !201, metadata !DIExpression()), !dbg !267
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !202, metadata !DIExpression()), !dbg !269

  //   call void @llvm.dbg.value(metadata i64 0, metadata !204, metadata !DIExpression()), !dbg !269
  ...
  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 3), metadata !206, metadata !DIExpression()), !dbg !284
  ...
  //   call void @llvm.dbg.value(metadata i64 %6, metadata !208, metadata !DIExpression()), !dbg !284

  //   %conv = trunc i64 %6 to i32, !dbg !157

  //   call void @llvm.dbg.value(metadata i32 %conv, metadata !205, metadata !DIExpression()), !dbg !248

  //   %cmp = icmp eq i32 %conv, 2, !dbg !158

  //   %conv20 = zext i1 %cmp to i32, !dbg !158

  //   call void @llvm.dbg.value(metadata i32 %conv20, metadata !209, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 0), metadata !211, metadata !DIExpression()), !dbg !288
  ...
  //   call void @llvm.dbg.value(metadata i64 %7, metadata !213, metadata !DIExpression()), !dbg !288

  //   %conv24 = trunc i64 %7 to i32, !dbg !161

  //   call void @llvm.dbg.value(metadata i32 %conv24, metadata !210, metadata !DIExpression()), !dbg !248

  //   %cmp25 = icmp eq i32 %conv24, 1, !dbg !162

  //   %conv26 = zext i1 %cmp25 to i32, !dbg !162

  //   call void @llvm.dbg.value(metadata i32 %conv26, metadata !214, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 1), metadata !216, metadata !DIExpression()), !dbg !292
  ...
  //   call void @llvm.dbg.value(metadata i64 %8, metadata !218, metadata !DIExpression()), !dbg !292

  //   %conv30 = trunc i64 %8 to i32, !dbg !165

  //   call void @llvm.dbg.value(metadata i32 %conv30, metadata !215, metadata !DIExpression()), !dbg !248

  //   %cmp31 = icmp eq i32 %conv30, 1, !dbg !166

  //   %conv32 = zext i1 %cmp31 to i32, !dbg !166

  //   call void @llvm.dbg.value(metadata i32 %conv32, metadata !219, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* getelementptr inbounds ([4 x i64], [4 x i64]* @vars, i64 0, i64 2), metadata !221, metadata !DIExpression()), !dbg !296
  ...
  //   call void @llvm.dbg.value(metadata i64 %9, metadata !223, metadata !DIExpression()), !dbg !296

  //   %conv36 = trunc i64 %9 to i32, !dbg !169

  //   call void @llvm.dbg.value(metadata i32 %conv36, metadata !220, metadata !DIExpression()), !dbg !248

  //   %cmp37 = icmp eq i32 %conv36, 1, !dbg !170

  //   %conv38 = zext i1 %cmp37 to i32, !dbg !170

  //   call void @llvm.dbg.value(metadata i32 %conv38, metadata !224, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %10, metadata !228, metadata !DIExpression()), !dbg !300

  //   %conv42 = trunc i64 %10 to i32, !dbg !173

  //   call void @llvm.dbg.value(metadata i32 %conv42, metadata !225, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i64 %11, metadata !232, metadata !DIExpression()), !dbg !303

  //   %conv46 = trunc i64 %11 to i32, !dbg !176

  //   call void @llvm.dbg.value(metadata i32 %conv46, metadata !229, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X7_2, metadata !234, metadata !DIExpression()), !dbg !306
  ...
  //   call void @llvm.dbg.value(metadata i64 %12, metadata !236, metadata !DIExpression()), !dbg !306

  //   %conv50 = trunc i64 %12 to i32, !dbg !179

  //   call void @llvm.dbg.value(metadata i32 %conv50, metadata !233, metadata !DIExpression()), !dbg !248

  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !238, metadata !DIExpression()), !dbg !309
  ...
  //   call void @llvm.dbg.value(metadata i64 %13, metadata !240, metadata !DIExpression()), !dbg !309

  //   %conv54 = trunc i64 %13 to i32, !dbg !182

  //   call void @llvm.dbg.value(metadata i32 %conv54, metadata !237, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and55, metadata !242, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and56, metadata !243, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and57, metadata !244, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and58, metadata !245, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and59, metadata !246, metadata !DIExpression()), !dbg !248
  ...
  //   call void @llvm.dbg.value(metadata i32 %and60, metadata !247, metadata !DIExpression()), !dbg !248
