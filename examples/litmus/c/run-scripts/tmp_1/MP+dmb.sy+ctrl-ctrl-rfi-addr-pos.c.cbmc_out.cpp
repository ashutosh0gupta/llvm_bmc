...
T2BLOCK7:
  ...
  //   %xor = xor i32 %conv11, %conv11, !dbg !111
  creg_r3 = max(creg_r2,creg_r2);
  ASSUME(active[creg_r3] == 2);
  r3 = r2 ^ r2;

  //   call void @llvm.dbg.value(metadata i32 %xor, metadata !76, metadata !DIExpression()), !dbg !104

  //   %add = add nsw i32 0, %xor, !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* %arrayidx, metadata !78, metadata !DIExpression()), !dbg !132
  ...
  //   %cmp24 = icmp eq i32 %conv11, 1, !dbg !121
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !90, metadata !DIExpression()), !dbg !141
  ...
  //   %cmp29 = icmp eq i32 %conv15, 0, !dbg !124
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !94, metadata !DIExpression()), !dbg !144
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !98, metadata !DIExpression()), !dbg !147

  //   %8 = zext i32 %conv35 to i64

  //   call void @llvm.dbg.value(metadata i64 %8, metadata !100, metadata !DIExpression()), !dbg !147

  //   store atomic i64 %8, i64* @atom_1_X10_0 seq_cst, align 8, !dbg !129
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !179, metadata !DIExpression()), !dbg !240
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !182, metadata !DIExpression()), !dbg !242
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !185, metadata !DIExpression()), !dbg !244
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_1, metadata !208, metadata !DIExpression()), !dbg !271
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !212, metadata !DIExpression()), !dbg !274
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X10_0, metadata !216, metadata !DIExpression()), !dbg !277
