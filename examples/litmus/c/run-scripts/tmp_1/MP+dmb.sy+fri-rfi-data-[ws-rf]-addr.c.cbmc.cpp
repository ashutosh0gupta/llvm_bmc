...
T2BLOCK1:
  ...
  //   %xor12 = xor i32 %conv11, %conv11, !dbg !102
  creg_r5 = max(creg_r4,creg_r4);
  ASSUME(active[creg_r5] == 2);
  r5 = r4 ^ r4;

  //   call void @llvm.dbg.value(metadata i32 %xor12, metadata !81, metadata !DIExpression()), !dbg !103

  //   %add14 = add nsw i32 0, %xor12, !dbg !103
  creg_r6 = max(0,creg_r5);
  ASSUME(active[creg_r6] == 2);
  r6 = 0 + r5;

  //   %idxprom = sext i32 %add14 to i64, !dbg !103
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !91, metadata !DIExpression()), !dbg !129

  //   %5 = zext i32 %conv23 to i64

  //   call void @llvm.dbg.value(metadata i64 %5, metadata !93, metadata !DIExpression()), !dbg !129

  //   store atomic i64 %5, i64* @atom_1_X3_2 seq_cst, align 8, !dbg !111
  // ST: Guess
  ...
  //   %cmp27 = icmp eq i32 %conv11, 2, !dbg !112
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !95, metadata !DIExpression()), !dbg !132

  //   %6 = zext i32 %conv28 to i64

  //   call void @llvm.dbg.value(metadata i64 %6, metadata !97, metadata !DIExpression()), !dbg !132

  //   store atomic i64 %6, i64* @atom_1_X6_2 seq_cst, align 8, !dbg !114
  // ST: Guess
  ...
  //   %cmp32 = icmp eq i32 %conv17, 0, !dbg !115
  ...
  //   store atomic i64 %7, i64* @atom_1_X8_0 seq_cst, align 8, !dbg !117
  // ST: Guess
...
T0BLOCK0:
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !178, metadata !DIExpression()), !dbg !239
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !181, metadata !DIExpression()), !dbg !241
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !184, metadata !DIExpression()), !dbg !243
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X3_2, metadata !207, metadata !DIExpression()), !dbg !273
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X6_2, metadata !211, metadata !DIExpression()), !dbg !276
  ...
  //   call void @llvm.dbg.value(metadata i64* @atom_1_X8_0, metadata !215, metadata !DIExpression()), !dbg !279
