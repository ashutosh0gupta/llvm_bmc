...
lbl_LC02:;
  ...
  long v28 = (v9_W7 == 2);
  atomic_store_explicit(&atom_1_X7_2, v28, memory_order_seq_cst);
  long v29 = (v12_W8 == 0);
  atomic_store_explicit(&atom_1_X8_0, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v20 = atomic_load_explicit(&atom_1_X7_2, memory_order_seq_cst);
