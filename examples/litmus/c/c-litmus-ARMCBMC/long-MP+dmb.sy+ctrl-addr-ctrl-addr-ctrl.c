...
lbl_LC01:;
  ...
  long v17_W10 = atomic_load_explicit(&vars[5+v14_W9], memory_order_relaxed);
  if (v17_W10) goto lbl_LC02; else goto lbl_LC02;
lbl_LC02:;
  long v20_W12 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v30 = (v3_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v26 = atomic_load_explicit(&atom_1_X12_0, memory_order_seq_cst);
