...
lbl_LC01:;
  ...
  int v6_W9 = v5_W7 ^ v5_W7;
  atomic_store_explicit(&vars[0+v6_W9], 1, memory_order_relaxed);
  int v7_W12 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v17 = (v1_W0 == 1);
  atom_1_X0_1 = v17;
  int v18 = (v7_W12 == 1);
  atom_1_X12_1 = v18;
