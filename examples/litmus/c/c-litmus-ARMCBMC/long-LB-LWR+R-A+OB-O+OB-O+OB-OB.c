...
void *t3(void *arg){
label_4:;
  long v9_W0 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  dmbsy();
  atomic_store_explicit(&vars[4], 1, memory_order_relaxed);
  long v28 = (v9_W0 == 1);
  atomic_store_explicit(&atom_3_X0_1, v28, memory_order_seq_cst);
  return NULL;
}

void *t4(void *arg){
label_5:;
  long v12_W0 = atomic_load_explicit(&vars[4], memory_order_relaxed);
  dmbsy();
  long v15_W2 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v25 = (v15_W2 == 0);
  atomic_store_explicit(&atom_4_X2_0, v25, memory_order_seq_cst);
  long v29 = (v12_W0 == 1);
  atomic_store_explicit(&atom_4_X0_1, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v16 = atomic_load_explicit(&atom_4_X2_0, memory_order_seq_cst);
  ...
  long v19 = atomic_load_explicit(&atom_3_X0_1, memory_order_seq_cst);
  long v20 = atomic_load_explicit(&atom_4_X0_1, memory_order_seq_cst);
