...
label_3:;
  ...
  long v13_W2 = v12_W0 ^ v12_W0;
  long v14_W2 = v13_W2 + 1;
  atomic_store_explicit(&vars[4], v14_W2, memory_order_relaxed);
  long v17_W4 = atomic_load_explicit(&vars[5], memory_order_relaxed);
  long v18_W6 = v17_W4 ^ v17_W4;
...
int main(int argc, char *argv[]){
  ...
  long v22 = (v21 == 2);
  long v23 = atomic_load_explicit(&atom_0_X0_1, memory_order_seq_cst);
  long v24 = atomic_load_explicit(&atom_0_X4_1, memory_order_seq_cst);
  long v25 = atomic_load_explicit(&atom_2_X0_1, memory_order_seq_cst);
  long v26 = atomic_load_explicit(&atom_2_X4_1, memory_order_seq_cst);
