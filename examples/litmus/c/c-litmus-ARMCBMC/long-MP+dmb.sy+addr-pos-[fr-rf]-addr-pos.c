...
label_2:;
  ...
  long v14_W7 = v13_W6 ^ v13_W6;
  long v17_W8 = atomic_load_explicit(&vars[0+v14_W7], memory_order_relaxed);
  long v20_W10 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v41 = (v3_W0 == 1);
