...
lbl_LC00:;
  ...
  long v15_W6 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  long v16_W7 = v15_W6 ^ v15_W6;
  long v19_W8 = atomic_load_explicit(&vars[0+v16_W7], memory_order_relaxed);
  long v40 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v40, memory_order_seq_cst);
  long v41 = (v6_W2 == 1);
  atomic_store_explicit(&atom_1_X2_1, v41, memory_order_seq_cst);
  long v42 = (v9_W3 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v27 = atomic_load_explicit(&atom_1_X2_1, memory_order_seq_cst);
  long v28 = atomic_load_explicit(&atom_1_X3_0, memory_order_seq_cst);
  long v29 = atomic_load_explicit(&atom_1_X5_1, memory_order_seq_cst);
  long v30 = atomic_load_explicit(&atom_1_X6_1, memory_order_seq_cst);
  long v31 = atomic_load_explicit(&atom_1_X8_0, memory_order_seq_cst);
