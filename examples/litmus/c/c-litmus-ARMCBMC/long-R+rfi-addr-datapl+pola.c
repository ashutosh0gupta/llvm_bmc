...
label_1:;
  ...
  long v12_W8 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  long v27 = (v12_W8 == 2);
...
int main(int argc, char *argv[]){
  ...
  long v19 = (v18 == 2);
  long v20 = atomic_load_explicit(&atom_0_X8_2, memory_order_seq_cst);
  long v21 = atomic_load_explicit(&atom_0_X2_1, memory_order_seq_cst);
