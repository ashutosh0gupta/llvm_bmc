...
label_1:;
  ...
  int v20 = (v3_W3 == 3);
  atomic_store_explicit(&atom_0_X3_3, v20, memory_order_seq_cst);
  return NULL;
}
...
lbl_LC00:;
  int v13_W7 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v21 = (v13_W7 == 0);
  atomic_store_explicit(&atom_1_X7_0, v21, memory_order_seq_cst);
  return NULL;
}
