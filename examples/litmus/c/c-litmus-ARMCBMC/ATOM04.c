...
label_1:;
  ...
  int v1_W4 = ldx(&vars[2]);
  int v2_W5 = stx(&vars[2], 1);
  if (v2_W5) goto lbl_Fail0; else goto label_2;
label_2:;
  goto lbl_Exit0;
lbl_Fail0:;
...
void *t1(void *arg){
label_3:;
  int v3_W2 = ldx(&vars[2]);
  int v4_W3 = stx(&vars[2], 2);
  if (v4_W3) goto lbl_Fail1; else goto label_4;
label_4:;
  int v5_W4 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  goto lbl_Exit1;
lbl_Fail1:;
  atomic_store_explicit(&vars[0], 0, memory_order_relaxed);
