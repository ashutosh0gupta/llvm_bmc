...
label_1:;
  ...
  long v31 = (v3_W2 == 0);
  atomic_store_explicit(&atom_0_X2_0, v31, memory_order_seq_cst);
  return NULL;
}
...
lbl_LC00:;
  long v12_W4 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v15_W6 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v32 = (v6_W2 == 1);
  atomic_store_explicit(&atom_1_X2_1, v32, memory_order_seq_cst);
  long v33 = (v9_W3 == 1);
  atomic_store_explicit(&atom_1_X3_1, v33, memory_order_seq_cst);
  long v34 = (v12_W4 == 0);
  atomic_store_explicit(&atom_1_X4_0, v34, memory_order_seq_cst);
  long v35 = (v15_W6 == 0);
  atomic_store_explicit(&atom_1_X6_0, v35, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v23 = atomic_load_explicit(&atom_1_X4_0, memory_order_seq_cst);
