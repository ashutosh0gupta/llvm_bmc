...
label_1:;
  ...
  if (v4_cmpeq)  goto lbl_label101; else goto lbl_label101;
lbl_label101:;
...
void *t1(void *arg){
label_2:;
  long v7_W0 = atomic_load_explicit(&vars[0], memory_order_acquire);
...
void *t2(void *arg){
label_3:;
  long v10_W0 = atomic_load_explicit(&vars[2], memory_order_acquire);
