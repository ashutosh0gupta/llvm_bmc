...
label_1:;
  ...
  int v1_W4 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  if (v1_W4) goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  atomic_store_explicit(&vars[0], 1, memory_order_release);
  int v2_W7 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v16 = (v2_W7 == 2);
  atom_0_X7_2 = v16;
  return NULL;
}
