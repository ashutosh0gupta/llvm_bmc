...
lbl_LC01:;
  ...
  long v36 = (v9_W4 == 0);
  atomic_store_explicit(&atom_1_X4_0, v36, memory_order_seq_cst);
  long v37 = (v12_W6 == 2);
  atomic_store_explicit(&atom_1_X6_2, v37, memory_order_seq_cst);
  long v38 = (v15_W7 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v23 = atomic_load_explicit(&atom_1_X2_0, memory_order_seq_cst);
  long v24 = atomic_load_explicit(&atom_1_X4_0, memory_order_seq_cst);
