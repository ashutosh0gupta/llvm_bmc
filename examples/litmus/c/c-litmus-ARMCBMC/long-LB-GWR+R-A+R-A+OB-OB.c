...
label_4:;
  ...
  dmbsy();
  long v12_W2 = atomic_load_explicit(&vars[4], memory_order_relaxed);
  long v25 = (v12_W2 == 0);
...
label_5:;
  ...
  dmbsy();
  long v15_W1 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v26 = (v15_W1 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v17 = atomic_load_explicit(&atom_4_X1_0, memory_order_seq_cst);
