...
label_2:;
  ...
  long v19 = (v3_W0 == 2);
  atomic_store_explicit(&atom_1_X0_2, v19, memory_order_seq_cst);
  long v20 = (v6_W2 == 0);
...
void *t3(void *arg){
label_4:;
  long v9_W0 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v10_cmpeq = (v9_W0 == 0);
  if (v10_cmpeq)  goto lbl_label60; else goto lbl_label60;
lbl_label60:;
  atomic_store_explicit(&vars[0], 1, memory_order_relaxed);
  long v21 = (v9_W0 == 1);
  atomic_store_explicit(&atom_3_X0_1, v21, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v12 = (v11 == 2);
  long v13 = atomic_load_explicit(&atom_1_X0_2, memory_order_seq_cst);
