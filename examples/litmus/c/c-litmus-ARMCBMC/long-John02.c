...
lbl_LC00:;
  ...
  long v6_W4 = atomic_load_explicit(&vars[2], memory_order_acquire);
  long v9_W5 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v15 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v15, memory_order_seq_cst);
  long v16 = (v6_W4 == 1);
  atomic_store_explicit(&atom_1_X4_1, v16, memory_order_seq_cst);
  long v17 = (v9_W5 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v11 = atomic_load_explicit(&atom_1_X4_1, memory_order_seq_cst);
  long v12 = atomic_load_explicit(&atom_1_X5_0, memory_order_seq_cst);
