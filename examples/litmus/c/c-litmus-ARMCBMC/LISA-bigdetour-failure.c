...
label_2:;
  ...
  int v4_W2 = v3_W0 & 8;
  int v7_W3 = atomic_load_explicit(&vars[3+v4_W2], memory_order_relaxed);
  int v10_W5 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  int v11_W7 = v10_W5 & 8;
  int v14_W8 = atomic_load_explicit(&vars[1+v11_W7], memory_order_relaxed);
  int v27 = (v3_W0 == 1);
...
void *t3(void *arg){
label_4:;
  int v17_W0 = atomic_load_explicit(&vars[3], memory_order_relaxed);
