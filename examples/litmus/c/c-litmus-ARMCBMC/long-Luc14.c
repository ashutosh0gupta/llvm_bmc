...
label_2:;
  ...
  long v4_W2 = v3_W0 & 16;
  long v7_W3 = atomic_load_explicit(&vars[3+v4_W2], memory_order_relaxed);
  long v10_W5 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  long v11_W7 = v10_W5 & 16;
  long v14_W8 = atomic_load_explicit(&vars[1+v11_W7], memory_order_relaxed);
  long v22 = (v3_W0 == 1);
