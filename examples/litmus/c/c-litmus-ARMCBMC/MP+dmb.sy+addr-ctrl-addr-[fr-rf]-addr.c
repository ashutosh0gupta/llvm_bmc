...
lbl_LC00:;
  ...
  int v7_W10 = atomic_load_explicit(&vars[4], memory_order_relaxed);
  int v8_W11 = v7_W10 ^ v7_W10;
  int v9_W12 = atomic_load_explicit(&vars[0+v8_W11], memory_order_relaxed);
  int v26 = (v1_W0 == 1);
  atom_1_X0_1 = v26;
  int v27 = (v6_W8 == 0);
  atom_1_X8_0 = v27;
