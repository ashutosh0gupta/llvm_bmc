...
lbl_LC01:;
  long v13_W7 = atomic_load_explicit(&vars[4], memory_order_relaxed);
  long v14_W9 = v13_W7 ^ v13_W7;
  long v15_W9 = v14_W9 + 1;
  atomic_store_explicit(&vars[0], v15_W9, memory_order_relaxed);
  long v18_W11 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v28 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v28, memory_order_seq_cst);
  long v29 = (v18_W11 == 1);
  atomic_store_explicit(&atom_1_X11_1, v29, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v24 = atomic_load_explicit(&atom_1_X11_1, memory_order_seq_cst);
