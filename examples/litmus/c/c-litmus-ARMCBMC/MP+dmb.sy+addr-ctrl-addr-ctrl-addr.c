...
lbl_LC01:;
  int v7_W10 = atomic_load_explicit(&vars[5], memory_order_relaxed);
  int v8_W12 = v7_W10 ^ v7_W10;
  int v9_W13 = atomic_load_explicit(&vars[0+v8_W12], memory_order_relaxed);
  int v19 = (v1_W0 == 1);
  atom_1_X0_1 = v19;
  int v20 = (v9_W13 == 0);
  atom_1_X13_0 = v20;
