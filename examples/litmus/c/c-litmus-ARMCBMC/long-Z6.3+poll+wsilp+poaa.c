...
label_1:;
  ...
  long v15 = (v3_W4 == 2);
  atomic_store_explicit(&atom_0_X4_2, v15, memory_order_seq_cst);
  return NULL;
}
...
label_3:;
  ...
  long v16 = (v6_W0 == 3);
  atomic_store_explicit(&atom_2_X0_3, v16, memory_order_seq_cst);
  long v17 = (v9_W2 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v10 = atomic_load_explicit(&atom_0_X4_2, memory_order_seq_cst);
  long v11 = atomic_load_explicit(&atom_2_X0_3, memory_order_seq_cst);
