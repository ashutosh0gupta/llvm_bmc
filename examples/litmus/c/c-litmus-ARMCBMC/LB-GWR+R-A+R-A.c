...
label_3:;
  ...
  int v9_W2 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  int v20 = (v9_W2 == 0);
...
label_4:;
  ...
  dmbsy();
  int v12_W1 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  int v21 = (v12_W1 == 0);
...
int main(int argc, char *argv[]){
  ...
  int v14 = atomic_load_explicit(&atom_3_X1_0, memory_order_seq_cst);
