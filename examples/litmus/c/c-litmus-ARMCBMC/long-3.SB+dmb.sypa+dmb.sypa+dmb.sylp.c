...
label_1:;
  ...
  dmbsy();
  long v3_W2 = atomic_load_explicit(&vars[1], memory_order_acquire);
  long v15 = (v3_W2 == 0);
  atomic_store_explicit(&atom_0_X2_0, v15, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v10 = atomic_load_explicit(&atom_0_X2_0, memory_order_seq_cst);
