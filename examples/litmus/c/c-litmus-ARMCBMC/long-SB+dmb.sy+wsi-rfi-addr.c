...
label_1:;
  ...
  long v22 = (v3_W2 == 0);
  atomic_store_explicit(&atom_0_X2_0, v22, memory_order_seq_cst);
  return NULL;
}
...
label_2:;
  ...
  long v23 = (v6_W3 == 2);
  atomic_store_explicit(&atom_1_X3_2, v23, memory_order_seq_cst);
  long v24 = (v10_W5 == 0);
  atomic_store_explicit(&atom_1_X5_0, v24, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v14 = (v13 == 2);
  long v15 = atomic_load_explicit(&atom_0_X2_0, memory_order_seq_cst);
  long v16 = atomic_load_explicit(&atom_1_X3_2, memory_order_seq_cst);
  long v17 = atomic_load_explicit(&atom_1_X5_0, memory_order_seq_cst);
  long v18_conj = v16 & v17;
  long v19_conj = v15 & v18_conj;
  long v20_conj = v14 & v19_conj;
  long v21_conj = v12 & v20_conj;
