...
void *t1(void *arg){
label_2:;
  long v8_W0 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v9_W2 = v8_W0 ^ v8_W0;
  long v10_W2 = v9_W2 + 1;
  atomic_store_explicit(&vars[1], v10_W2, memory_order_relaxed);
  long v13_W4 = atomic_load_explicit(&vars[1], memory_order_relaxed);
...
int main(int argc, char *argv[]){
  ...
  long v15 = (v14 == 2);
  long v16 = atomic_load_explicit(&atom_0_X0_2, memory_order_seq_cst);
