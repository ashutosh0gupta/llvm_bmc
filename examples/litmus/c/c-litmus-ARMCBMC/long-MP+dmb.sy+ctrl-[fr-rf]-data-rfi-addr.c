...
lbl_LC00:;
  ...
  long v42 = (v9_W4 == 1);
  atomic_store_explicit(&atom_1_X4_1, v42, memory_order_seq_cst);
  long v43 = (v14_W7 == 1);
  atomic_store_explicit(&atom_1_X7_1, v43, memory_order_seq_cst);
  long v44 = (v18_W9 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v28 = atomic_load_explicit(&atom_1_X2_0, memory_order_seq_cst);
  long v29 = atomic_load_explicit(&atom_1_X4_1, memory_order_seq_cst);
  long v30 = atomic_load_explicit(&atom_1_X7_1, memory_order_seq_cst);
