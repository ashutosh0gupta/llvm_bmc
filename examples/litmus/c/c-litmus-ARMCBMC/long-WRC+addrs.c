...
label_3:;
  ...
  long v11_W3 = atomic_load_explicit(&vars[0+v8_W2], memory_order_relaxed);
  long v18 = (v7_W0 == 1);
  atomic_store_explicit(&atom_2_X0_1, v18, memory_order_seq_cst);
  long v19 = (v11_W3 == 0);
  atomic_store_explicit(&atom_2_X3_0, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v14 = atomic_load_explicit(&atom_2_X3_0, memory_order_seq_cst);
