...
lbl_LC00:;
  ...
  long v10_W9 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  long v25 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v25, memory_order_seq_cst);
  long v26 = (v6_W5 == 2);
  atomic_store_explicit(&atom_1_X5_2, v26, memory_order_seq_cst);
  long v27 = (v10_W9 == 1);
  atomic_store_explicit(&atom_1_X9_1, v27, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v19 = atomic_load_explicit(&atom_1_X9_1, memory_order_seq_cst);
