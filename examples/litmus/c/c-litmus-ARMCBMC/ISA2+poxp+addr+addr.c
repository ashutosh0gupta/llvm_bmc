...
label_3:;
  ...
  atomic_store_explicit(&vars[3+v4_W2], 1, memory_order_relaxed);
  int v22 = (v3_W0 == 1);
  atom_1_X0_1 = v22;
  return NULL;
}
...
void *t2(void *arg){
label_4:;
  int v5_W0 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  int v6_W2 = v5_W0 ^ v5_W0;
  int v7_W3 = atomic_load_explicit(&vars[1+v6_W2], memory_order_relaxed);
  int v23 = (v5_W0 == 1);
  atom_2_X0_1 = v23;
  int v24 = (v7_W3 == 0);
  atom_2_X3_0 = v24;
