...
label_2:;
  ...
  long v18 = (v7_W5 == 1);
  atomic_store_explicit(&atom_1_X5_1, v18, memory_order_seq_cst);
  long v19 = (v11_W7 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v13 = atomic_load_explicit(&atom_1_X5_1, memory_order_seq_cst);
  long v14 = atomic_load_explicit(&atom_1_X7_0, memory_order_seq_cst);
