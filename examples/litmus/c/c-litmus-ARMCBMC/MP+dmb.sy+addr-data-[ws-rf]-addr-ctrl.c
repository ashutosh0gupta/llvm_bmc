...
label_2:;
  ...
  int v8_W9 = atomic_load_explicit(&vars[4+v7_W8], memory_order_relaxed);
  if (v8_W9) goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  int v9_W11 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v24 = (v1_W0 == 1);
  atom_1_X0_1 = v24;
  int v25 = (v6_W7 == 2);
  atom_1_X7_2 = v25;
