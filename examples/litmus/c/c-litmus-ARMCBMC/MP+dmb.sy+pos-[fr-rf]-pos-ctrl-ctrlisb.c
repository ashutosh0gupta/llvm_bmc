...
lbl_LC00:;
  int v15_W5 = atomic_load_explicit(&vars[2], memory_order_relaxed);
...
lbl_LC01:;
  ...
  int v37 = (v12_W4 == 2);
  atomic_store_explicit(&atom_1_X4_2, v37, memory_order_seq_cst);
  int v38 = (v18_W7 == 0);
...
int main(int argc, char *argv[]){
  ...
  int v27 = atomic_load_explicit(&atom_1_X7_0, memory_order_seq_cst);
