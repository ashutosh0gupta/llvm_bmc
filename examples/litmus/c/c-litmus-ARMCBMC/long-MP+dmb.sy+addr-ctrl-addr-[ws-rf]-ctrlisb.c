...
lbl_LC00:;
  ...
  long v14_W10 = atomic_load_explicit(&vars[4], memory_order_relaxed);
...
lbl_LC01:;
  ...
  long v33 = (v14_W10 == 2);
  atomic_store_explicit(&atom_1_X10_2, v33, memory_order_seq_cst);
  long v34 = (v17_W11 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v18 = atomic_load_explicit(&vars[4], memory_order_seq_cst);
  long v19 = (v18 == 2);
  ...
  long v25 = atomic_load_explicit(&atom_1_X10_2, memory_order_seq_cst);
