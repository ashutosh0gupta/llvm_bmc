...
label_2:;
  ...
  long v8_W4 = atomic_load_explicit(&vars[2], memory_order_acquire);
  long v11_W5 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v17 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v17, memory_order_seq_cst);
  long v18 = (v8_W4 == 1);
  atomic_store_explicit(&atom_1_X4_1, v18, memory_order_seq_cst);
  long v19 = (v11_W5 == 0);
  atomic_store_explicit(&atom_1_X5_0, v19, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v13 = atomic_load_explicit(&atom_1_X4_1, memory_order_seq_cst);
