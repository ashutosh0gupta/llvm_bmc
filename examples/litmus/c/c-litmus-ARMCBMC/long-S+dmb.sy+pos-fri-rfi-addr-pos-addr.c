...
label_2:;
  ...
  long v13_W6 = atomic_load_explicit(&vars[2+v10_W5], memory_order_relaxed);
  long v16_W8 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  long v17_W9 = v16_W8 ^ v16_W8;
  atomic_store_explicit(&vars[0+v17_W9], 1, memory_order_relaxed);
  long v29 = (v3_W0 == 1);
