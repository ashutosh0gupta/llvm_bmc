...
label_2:;
  ...
  long v22 = (v12_W3 == 4);
  atomic_store_explicit(&atom_1_X3_4, v22, memory_order_seq_cst);
  long v23 = (v9_W2 == 3);
...
int main(int argc, char *argv[]){
  ...
  long v14 = (v13 == 4);
  long v15 = atomic_load_explicit(&atom_0_X6_3, memory_order_seq_cst);
  long v16 = atomic_load_explicit(&atom_1_X3_4, memory_order_seq_cst);
