...
label_2:;
  ...
  long v11_W2 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v12_W3 = v11_W2 ^ v11_W2;
  long v15_W4 = atomic_load_explicit(&vars[2+v12_W3], memory_order_relaxed);
  long v16_W6 = v15_W4 ^ v15_W4;
  long v17_W6 = v16_W6 + 1;
  atomic_store_explicit(&vars[0], v17_W6, memory_order_relaxed);
  long v30 = (v8_W0 == 1);
