...
label_2:;
  ...
  atomic_store_explicit(&vars[3+v5_W5], 1, memory_order_relaxed);
  int v6_W8 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  int v7_W9 = v6_W8 ^ v6_W8;
  int v8_W10 = atomic_load_explicit(&vars[0+v7_W9], memory_order_relaxed);
  int v28 = (v1_W0 == 1);
  atom_1_X0_1 = v28;
  int v29 = (v4_W4 == 1);
  atom_1_X4_1 = v29;
...
int main(int argc, char *argv[]){
  ...
  int v18 = atom_1_X4_1;
  int v19 = atom_1_X8_2;
  int v20 = atom_1_X10_0;
  int v21_conj = v19 & v20;
  int v22_conj = v18 & v21_conj;
  int v23_conj = v17 & v22_conj;
  int v24_conj = v16 & v23_conj;
  int v25_conj = v14 & v24_conj;
  int v26_conj = v12 & v25_conj;
  int v27_conj = v10 & v26_conj;
