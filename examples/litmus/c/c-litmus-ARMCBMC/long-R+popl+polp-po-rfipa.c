...
label_2:;
  ...
  long v25 = (v12_W7 == 2);
  atomic_store_explicit(&atom_1_X7_2, v25, memory_order_seq_cst);
  long v26 = (v9_W6 == 1);
  atomic_store_explicit(&atom_1_X6_1, v26, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v18 = atomic_load_explicit(&atom_1_X7_2, memory_order_seq_cst);
  long v19 = atomic_load_explicit(&atom_1_X6_1, memory_order_seq_cst);
