...
label_1:;
  ...
  long v3_W4 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  atomic_store_explicit(&vars[3], 1, memory_order_release);
  long v6_W8 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  long v22 = (v6_W8 == 2);
...
int main(int argc, char *argv[]){
  ...
  long v10 = atomic_load_explicit(&vars[3], memory_order_seq_cst);
  long v11 = (v10 == 2);
  long v12 = atomic_load_explicit(&vars[0], memory_order_seq_cst);
  long v13 = (v12 == 1);
  long v14 = atomic_load_explicit(&vars[1], memory_order_seq_cst);
  long v15 = (v14 == 1);
  long v16 = atomic_load_explicit(&atom_0_X8_2, memory_order_seq_cst);
