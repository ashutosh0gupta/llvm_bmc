...
label_3:;
  ...
  long v12_W2 = v11_W0 ^ v11_W0;
  atomic_store_explicit(&vars[0+v12_W2], 1, memory_order_relaxed);
  long v20 = (v11_W0 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v15 = atomic_load_explicit(&atom_2_X0_1, memory_order_seq_cst);
