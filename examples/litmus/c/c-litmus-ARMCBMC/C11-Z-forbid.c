...
label_2:;
  ...
  int v6_W4 = atomic_load_explicit(&vars[1], memory_order_acquire);
  int v16 = (v3_W2 == 4);
...
int main(int argc, char *argv[]){
  ...
  int v10 = atomic_load_explicit(&atom_2_X4_2, memory_order_seq_cst);
  int v11 = atomic_load_explicit(&atom_1_X2_4, memory_order_seq_cst);
