...
label_2:;
  ...
  int v15_W12 = atomic_load_explicit(&vars[0], memory_order_relaxed);
  int v30 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v30, memory_order_seq_cst);
  int v31 = (v11_W8 == 2);
  atomic_store_explicit(&atom_1_X8_2, v31, memory_order_seq_cst);
  int v32 = (v15_W12 == 1);
...
int main(int argc, char *argv[]){
  ...
  int v23 = atomic_load_explicit(&atom_1_X8_2, memory_order_seq_cst);
  int v24 = atomic_load_explicit(&atom_1_X12_1, memory_order_seq_cst);
