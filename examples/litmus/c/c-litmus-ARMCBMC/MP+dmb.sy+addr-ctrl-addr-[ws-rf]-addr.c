...
lbl_LC00:;
  ...
  atomic_store_explicit(&vars[4+v5_W7], 1, memory_order_relaxed);
  int v6_W10 = atomic_load_explicit(&vars[4], memory_order_relaxed);
  int v7_W11 = v6_W10 ^ v6_W10;
  int v8_W12 = atomic_load_explicit(&vars[0+v7_W11], memory_order_relaxed);
  int v23 = (v1_W0 == 1);
  atom_1_X0_1 = v23;
  int v24 = (v6_W10 == 2);
  atom_1_X10_2 = v24;
...
int main(int argc, char *argv[]){
  ...
  int v14 = (v13 == 1);
  int v15 = atom_1_X0_1;
  int v16 = atom_1_X10_2;
  int v17 = atom_1_X12_0;
