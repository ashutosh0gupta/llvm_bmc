...
int main(int argc, char *argv[]){
  ...
  long v21 = atomic_load_explicit(&atom_2_X0_1, memory_order_seq_cst);
  long v22 = atomic_load_explicit(&atom_3_X0_1, memory_order_seq_cst);
  long v23 = atomic_load_explicit(&atom_4_X0_1, memory_order_seq_cst);
  long v24 = atomic_load_explicit(&atom_5_X0_1, memory_order_seq_cst);
