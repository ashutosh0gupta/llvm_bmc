...
label_2:;
  ...
  long v11_W6 = v10_W5 & 128;
  long v14_W7 = atomic_load_explicit(&vars[1+v11_W6], memory_order_relaxed);
  long v22 = (v3_W0 == 1);
  atomic_store_explicit(&atom_1_X0_1, v22, memory_order_seq_cst);
  long v23 = (v14_W7 == 0);
  atomic_store_explicit(&atom_1_X7_0, v23, memory_order_seq_cst);
  long v24 = (v7_W3 == 0);
  atomic_store_explicit(&atom_1_X3_0, v24, memory_order_seq_cst);
  long v25 = (v10_W5 == 1);
...
int main(int argc, char *argv[]){
  ...
  long v16 = atomic_load_explicit(&atom_1_X7_0, memory_order_seq_cst);
