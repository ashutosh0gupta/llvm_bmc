...
lbl_LC01:;
  ...
  long v43 = (v15_W6 == 0);
  atomic_store_explicit(&atom_1_X6_0, v43, memory_order_seq_cst);
  long v44 = (v18_W8 == 0);
  atomic_store_explicit(&atom_1_X8_0, v44, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v26 = atomic_load_explicit(&atom_1_X2_0, memory_order_seq_cst);
  long v27 = atomic_load_explicit(&atom_1_X4_1, memory_order_seq_cst);
  long v28 = atomic_load_explicit(&atom_1_X5_1, memory_order_seq_cst);
  ...
  long v36_conj = v24 & v35_conj;
  long v37_conj = v22 & v36_conj;
  long v38_conj = v20 & v37_conj;
