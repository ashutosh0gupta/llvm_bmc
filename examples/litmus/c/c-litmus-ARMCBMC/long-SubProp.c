...
atomic_long atom_2_X4_2; 
atomic_long atom_2_X5_1; 
atomic_long atom_2_X6_0; 
...
label_2:;
  atomic_store_explicit(&vars[1], 0, memory_order_release);
  long v3_W5 = atomic_load_explicit(&vars[2], memory_order_relaxed);
  long v4_W7 = v3_W5 ^ v3_W5;
...
void *t2(void *arg){
label_3:;
  long v7_W4 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v8_W7 = v7_W4 ^ v7_W4;
  long v11_W5 = atomic_load_explicit(&vars[3+v8_W7], memory_order_relaxed);
  long v12_W8 = v11_W5 ^ v11_W5;
  long v15_W6 = atomic_load_explicit(&vars[0+v12_W8], memory_order_relaxed);
  long v27 = (v7_W4 == 2);
...
int main(int argc, char *argv[]){
  ...
  long v19 = atomic_load_explicit(&atom_2_X4_2, memory_order_seq_cst);
  long v20 = atomic_load_explicit(&atom_2_X5_1, memory_order_seq_cst);
  long v21 = atomic_load_explicit(&atom_2_X6_0, memory_order_seq_cst);
