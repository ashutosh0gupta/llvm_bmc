...
label_2:;
  ...
  long v31 = (v11_W9 == 2);
  atomic_store_explicit(&atom_1_X9_2, v31, memory_order_seq_cst);
  long v32 = (v15_W11 == 0);
  atomic_store_explicit(&atom_1_X11_0, v32, memory_order_seq_cst);
  return NULL;
}
...
int main(int argc, char *argv[]){
  ...
  long v23 = atomic_load_explicit(&atom_1_X9_2, memory_order_seq_cst);
  long v24 = atomic_load_explicit(&atom_1_X11_0, memory_order_seq_cst);
