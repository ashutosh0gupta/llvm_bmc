...
label_2:;
  ...
  if (v4_cmpeq)  goto lbl_label134; else goto lbl_label134;
lbl_label134:;
...
label_3:;
  ...
  dmbsy();
  long v7_W1 = atomic_load_explicit(&vars[1], memory_order_relaxed);
  long v15 = (v7_W1 == 0);
...
int main(int argc, char *argv[]){
  ...
  long v8 = atomic_load_explicit(&vars[2], memory_order_seq_cst);
  long v9 = (v8 == 2);
