...
label_2:;
  ...
  if (v5_W5) goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  int v6_W6 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  int v7_W8 = v6_W6 ^ v6_W6;
  int v8_W9 = atomic_load_explicit(&vars[0+v7_W8], memory_order_relaxed);
  int v25 = (v1_W0 == 1);
  atom_1_X0_1 = v25;
  int v26 = (v2_W2 == 2);
  atom_1_X2_2 = v26;
