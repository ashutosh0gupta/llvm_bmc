...
label_2:;
  ...
  atomic_store_explicit(&vars[3+v4_W6], 1, memory_order_relaxed);
  int v5_W9 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  int v6_W10 = v5_W9 ^ v5_W9;
  int v7_W11 = atomic_load_explicit(&vars[0+v6_W10], memory_order_relaxed);
  int v27 = (v1_W0 == 1);
  atom_1_X0_1 = v27;
  int v28 = (v3_W5 == 2);
  atom_1_X5_2 = v28;
