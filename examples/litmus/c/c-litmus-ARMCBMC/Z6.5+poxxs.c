...
void *t1(void *arg){
label_4:;
  int v5_W2 = ldx(&vars[2]);
  int v6_W3 = stx(&vars[2], 2);
  if (v6_W3) goto lbl_Fail1; else goto label_5;
label_5:;
  int v7_W6 = ldx(&vars[3]);
  int v8_W3 = stx(&vars[3], 1);
  if (v8_W3) goto lbl_Fail1; else goto label_6;
label_6:;
  goto lbl_Exit1;
lbl_Fail1:;
  atomic_store_explicit(&vars[0], 0, memory_order_relaxed);
...
void *t2(void *arg){
label_7:;
  int v9_W2 = ldx(&vars[3]);
  int v10_W3 = stx(&vars[3], 2);
  if (v10_W3) goto lbl_Fail2; else goto label_8;
label_8:;
  int v11_W5 = ldx(&vars[1]);
  int v12_W3 = stx(&vars[1], v11_W5);
  if (v12_W3) goto lbl_Fail2; else goto label_9;
label_9:;
  goto lbl_Exit2;
lbl_Fail2:;
  atomic_store_explicit(&vars[0], 0, memory_order_relaxed);
