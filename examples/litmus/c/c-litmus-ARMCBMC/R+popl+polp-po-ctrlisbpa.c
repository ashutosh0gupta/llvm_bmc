...
label_2:;
  ...
  int v2_W4 = atomic_load_explicit(&vars[3], memory_order_relaxed);
  if (v2_W4) goto lbl_LC00; else goto lbl_LC00;
lbl_LC00:;
  isb();
  int v3_W6 = atomic_load_explicit(&vars[0], memory_order_acquire);
  int v17 = (v3_W6 == 0);
  atom_1_X6_0 = v17;
  return NULL;
}
