...
@main__combinederrorflag = global i16 0
...
@minor_cycle__maj2minc = global i16 undef
@minor_cycle__maj2min = global i16 undef
...
entry:
  store i16 4369, i16* @minor_cycle__maj2min, align 2
  store i16 -4370, i16* @minor_cycle__maj2minc, align 2
  ret void
}
...
entry:
  %0 = load i16, i16* @minor_cycle__maj2min, align 2
  %1 = load i16, i16* @minor_cycle__maj2minc, align 2
  %2 = add i16 %0, %1
  %3 = icmp ne i16 %2, -1
  br i1 %3, label %"3", label %return

"3":                                              ; preds = %entry
  %4 = load i16, i16* @main__combinederrorflag, align 2
  %5 = zext i16 %4 to i32
  %6 = call zeroext i16 @obclib__bit_or(i16 zeroext %4, i16 zeroext 2)
  store i16 %6, i16* @main__combinederrorflag, align 2
  br label %return
