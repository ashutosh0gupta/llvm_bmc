...
@main__majorcnt = global i16 0
@main__minorcnt = global i16 0
@main__microcnt = global i16 0
@main_E = unnamed_addr global i16 0
@major_cycle_E = unnamed_addr global i16 0
@minor_cycle_E = unnamed_addr global i16 0
@micro_cycle_E = unnamed_addr global i16 0
...
; Function Attrs: uwtable
define void @main__guid_micro() unnamed_addr #0 align 2 {
entry:
  call void @micro_cycle__stage3_micro()
  ret void
}
...
entry:
  %0 = load i16, i16* @main__majorcnt, align 2
  %1 = icmp ule i16 %0, 1
  br i1 %1, label %"3", label %"4"

"3":                                              ; preds = %entry
  %2 = add i16 %0, 1
  store i16 %2, i16* @main__majorcnt, align 2
  br label %return

"4":                                              ; preds = %entry
  store i16 1, i16* @main__majorcnt, align 2
  br label %return
...
entry:
  %0 = load i16, i16* @main__minorcnt, align 2
  %1 = icmp ule i16 %0, 49
  br i1 %1, label %"3", label %"4"

"3":                                              ; preds = %entry
  %2 = add i16 %0, 1
  store i16 %2, i16* @main__minorcnt, align 2
  br label %return

"4":                                              ; preds = %entry
  store i16 1, i16* @main__minorcnt, align 2
  br label %return
...
; Function Attrs: uwtable
define void @micro_cycle__stage3_micro() #0 align 2 {
entry:
  %0 = load i16, i16* @main__microcnt, align 2
  %1 = icmp ule i16 %0, 99
  br i1 %1, label %"3", label %"4"

"3":                                              ; preds = %entry
  %2 = add i16 %0, 1
  store i16 %2, i16* @main__microcnt, align 2
  br label %return

"4":                                              ; preds = %entry
  store i16 1, i16* @main__microcnt, align 2
  br label %return
