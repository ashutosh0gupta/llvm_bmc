...
"16":                                             ; preds = %"15", %"14"
  ...
  br i1 %or.cond8, label %"19", label %"26"
...
"19":                                             ; preds = %"16"
  ...
  %38 = icmp ugt i16 %37, 4999
  br i1 %38, label %"20", label %"21"

"20":                                             ; preds = %"19"
  store i16 4999, i16* @synchronization__time_stamp, align 2
  br label %"21"

"21":                                             ; preds = %"20", %"19"
  %39 = load i16, i16* @synchronization__time_stamp, align 2
  %40 = sub i16 4999, %39
  store i16 %40, i16* @synchronization__time_stamp, align 2
  %41 = zext i16 %40 to i32
  %42 = call signext i16 @obclib__u16tos16(i16 zeroext %40)
  %43 = icmp slt i16 %42, -32392
...
"23":                                             ; preds = %"21"
  %44 = sub nsw i16 375, %42
  store i16 %44, i16* @synchronization__temp_skew, align 2
...
"25":                                             ; preds = %"23"
  %neg1 = sub i16 0, %44
  %abscond2 = icmp sge i16 %44, 0
  %abs3 = select i1 %abscond2, i16 %44, i16 %neg1
  store i16 %abs3, i16* @synchronization__absskew, align 2
  call void @synchronization__rtime_process() #0
  br label %"29"

"26":                                             ; preds = %"16"
  %46 = load i16, i16* @synchronization__other_ngcp_sync_err_cnt, align 2
  %47 = add i16 %46, 1
  store i16 %47, i16* @synchronization__other_ngcp_sync_err_cnt, align 2
  %48 = icmp ugt i16 %47, 14
  br i1 %48, label %"27", label %"29"

"27":                                             ; preds = %"26"
  store i16 -21846, i16* @synchronization__sync_disable_flg, align 2
  %49 = load i16, i16* @synchronization__syncflg, align 2
  %50 = zext i16 %49 to i32
  %51 = call zeroext i16 @obclib__bit_or(i16 zeroext %49, i16 zeroext 256)
  store i16 %51, i16* @synchronization__syncflg, align 2
  br label %"29"

"29":                                             ; preds = %"27", %"26", %"25", %"13", %"11"
  %52 = load i16, i16* @synchronization__syncflg, align 2
  store i16 %52, i16* @synchronization__syncflag, align 2
  ret void
}
...
entry:
  ...
  store i16 4609, i16* @synchronization__time_stamp, align 2
