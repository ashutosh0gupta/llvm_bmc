...
std::string getDT(std::string);
std::string balanceUtil(int, std::string);
std::string balanceOrAnd(std::string);
std::string balancehelper(std::string);
void dumpmodel(std::string, std::string, std::string);
std::vector<std::string> tokenize_boolector(std::string, std::string);
std::vector<std::string> tokenize_cvc5(std::string, std::string);
std::vector<std::vector<std::string>> getExpressions(std::string, std::string);
void Z3compatible(std::string, std::string);
void dump_model(model, std::string, std::string);
int binToInt(std::string);
int cleancvc5(std::string, std::string);
void check_cvc5(solver &, std::string, bool);
