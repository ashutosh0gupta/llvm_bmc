#ifndef BMC_INSERT_MONITOR_H
#define BMC_INSERT_MONITOR_H
...
class insert_monitor_pass : public llvm::FunctionPass {
...
public:
  insert_monitor_pass(llvm::Module &m, options& o, bmc& b);
  ~insert_monitor_pass();
